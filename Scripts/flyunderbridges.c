			...
			if (player::is_player_playing(player::player_id())) {
				...
				case 0:
					if (!ped::is_ped_injured(player::player_ped_id())) {
						if (system::vdist2(entity::get_entity_coords(player::player_ped_id(), 0),
										   vLocal_39[iLocal_31 /*3*/]) < fLocal_250) {
							if (ped::is_ped_in_any_heli(player::player_ped_id()) ||
								ped::is_ped_in_any_plane(player::player_ped_id())) {
								if (iLocal_31 == 33 || iLocal_31 == 34 || iLocal_31 == 35 || iLocal_31 == 36 ||
									iLocal_31 == 50 || iLocal_31 == 51 || iLocal_31 == 52 || iLocal_31 == 53 ||
									iLocal_31 == 54 || iLocal_31 == 55 || iLocal_31 == 56 || iLocal_31 == 57 ||
									iLocal_31 == 58 || iLocal_31 == 59 || iLocal_31 == 60) {
									bLocal_38 = true;
								}
								else {
									bLocal_38 = false;
								...
								if (vehicle::is_vehicle_driveable(
									...
									if (func_14()) {
										if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_251,
																			 vLocal_254, fLocal_263, 0, 1, 0)) {
											bLocal_33 = true;
											iLocal_27 = 1;
										}
										if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_257,
																			 vLocal_260, fLocal_263, 0, 1, 0)) {
											bLocal_34 = true;
											iLocal_27 = 1;
										}
									}
				...
				case 1:
					if (!ped::is_ped_injured(player::player_ped_id())) {
						...
						else if (!vehicle::is_vehicle_driveable(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0),
																0)) {
							func_13();
						}
						...
						if (bLocal_33) {
							if (iLocal_37) {
								if (iLocal_36) {
									if (!entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_251,
																		  vLocal_254, fLocal_263, 0, 1, 0) &&
										!entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_257,
																		  vLocal_260, fLocal_263, 0, 1, 0)) {
										func_13();
										func_1();
								...
								else if (!entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_251,
																		   vLocal_254, fLocal_263, 0, 1, 0) &&
										 entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_257,
																		  vLocal_260, fLocal_263, 0, 1, 0)) {
									iLocal_36 = 1;
							...
							else if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_251, vLocal_254,
																	  fLocal_263, 0, 1, 0) &&
									 entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_257, vLocal_260,
																	  fLocal_263, 0, 1, 0)) {
								iLocal_37 = 1;
							}
							else if (!entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_251, vLocal_254,
...
void func_1() {
	...
	if (iLocal_31 < 32) {
		bVar0 = gameplay::is_bit_set(Global_101700.f_9008.f_96, iLocal_31);
	}
	else if (iLocal_31 < 64) {
		bVar0 = gameplay::is_bit_set(Global_101700.f_9008.f_97, iLocal_31 - 32);
	}
	else {
		bVar0 = gameplay::is_bit_set(Global_101700.f_9008.f_98, iLocal_31 - 64);
	}
	if (bVar0) {
	}
	else {
		...
		if (iLocal_31 < 32) {
			gameplay::set_bit(&Global_101700.f_9008.f_96, iLocal_31);
		}
		else if (iLocal_31 < 64) {
			gameplay::set_bit(&Global_101700.f_9008.f_97, iLocal_31 - 32);
		}
		else {
			gameplay::set_bit(&Global_101700.f_9008.f_98, iLocal_31 - 64);
		}
		Global_88269 = 1;
		func_29();
		iLocal_29 = 1;
...
bool func_14() {
	if (bLocal_38) {
		if (ped::is_ped_in_any_plane(player::player_ped_id())) {
			if (entity::get_entity_upright_value(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0)) > -0.6f &&
				entity::get_entity_upright_value(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0)) < 0.6f) {
				return true;
			}
		}
	}
...
void func_15() {
	if (gameplay::get_game_timer() - iLocal_268 > 500) {
		if (iLocal_31 == 29) {
			if (gameplay::is_bit_set(Global_101700.f_9008.f_96, iLocal_31)) {
				iLocal_267 = 1;
			}
		}
...
void func_16() {
	...
	case 1:
		if (system::timerb() > 3750 || cam::is_screen_faded_out() || !player::is_player_playing(player::player_id()) ||
			func_22() || !player::is_player_control_on(player::player_id()) || func_20() || func_19()) {
...
void func_25() {
	...
	if (iLocal_31 < 32) {
		...
		if (gameplay::is_bit_set(Global_101700.f_9008.f_97, iLocal_31 - 32)) {
			iLocal_267 = 1;
		}
	}
	else if (gameplay::is_bit_set(Global_101700.f_9008.f_98, iLocal_31 - 64)) {
		iLocal_267 = 1;
	}
	if (iLocal_267) {
	}
...
// Position - 0x26D7
bool func_27(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
// Position - 0x303A
bool func_34(var *uParam0, int iParam1) { return (*uParam0)[iParam1] == 70; }
...
// Position - 0x307F
void func_36(var *uParam0, int iParam1) { (*uParam0)[iParam1] = 70; }
...
// Position - 0x30AC
float func_38(var *uParam0) { return uParam0->f_72; }

// Position - 0x30B8
bool func_39(var *uParam0, int iParam1) { return func_40(uParam0, iParam1) != -1; }
...
// Position - 0x30F7
bool func_41(var *uParam0) { return uParam0->f_71 == 1; }
...
int func_48() {
	...
	iVar1 = 0;
	while (iVar1 < 32) {
		if (gameplay::is_bit_set(Global_101700.f_9008.f_96, iVar1)) {
			if (func_49(iVar1)) {
				iVar0++;
			}
		}
		if (gameplay::is_bit_set(Global_101700.f_9008.f_97, iVar1)) {
			if (func_49(iVar1 + 32)) {
				iVar0++;
			}
		}
		if (gameplay::is_bit_set(Global_101700.f_9008.f_98, iVar1)) {
			if (func_49(iVar1 + 64)) {
				iVar0++;
			}
		}
...
// Position - 0x3C8F
bool func_52(int iParam0) { return Global_35781 == iParam0; }
