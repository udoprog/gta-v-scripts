...
void __EntryFunction__() {
	...
	if (func_407()) {
		...
		func_406(vLocal_106, fLocal_109, 1, 0);
	...
	if (func_407()) {
		...
		func_324(&uLocal_86, -1100.04f, 280.6f, 63.53f, 267.48f, 0, 0, 1, 1, 0, joaat("asterope"), 0, 145, 1);
	...
	while (true) {
		...
		switch (iLocal_87) {
		case 0: func_293(); break;

		case 1: func_256(); break;
...
void func_2() {
	if (func_393(player::player_ped_id())) {
		...
		audio::trigger_music_event("JOSH4_COPS_LOST");
		func_441("Player is somehow not alive when passing the mission - "
				 "starting 'JOSH4_COPS_LOST'");
	}
	func_3(91, 1);
	func_408();
}
...
// Position - 0x25E96
float func_207(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
...
void func_208() {
	if (iLocal_528 == 0) {
		if (!entity::is_entity_in_angled_area(player::player_ped_id(), -1208.581f, 309.8494f, 80.69189f, -1041.645f,
											  319.5811f, 60.40263f, 178.5f, 0, 1, 0)) {
			while (func_205()) {
				func_223();
				system::wait(0);
			}
...
void func_225() {
		...
		if (iLocal_101 == 3) {
			if (func_393(Local_443.f_28[0])) {
				...
				if (func_203(iLocal_508)) {
					if (gameplay::is_position_occupied(-1138.421f, 298.0307f, 65.90032f, 4f, 0, 1, 0, 0, 0, iLocal_508,
													   0)) {
						func_441("Back gate blocked");
						vLocal_110 = {-1130.35f, 307.92f, 65.19f};
						ai::open_sequence_task(&iLocal_506);
						...
						ai::close_sequence_task(iLocal_506);
						ped::set_ped_keep_task(Local_443.f_28[0], 1);
						ai::task_perform_sequence(Local_443.f_28[0], iLocal_506);
					}
					else {
						func_441("Back gate clear");
						ai::open_sequence_task(&iLocal_506);
						if (func_203(iLocal_508)) {
							ai::task_vehicle_mission_ped_target(0, iLocal_508, player::player_ped_id(), 8, 30f, 786469,
																500f, 0.1f, 1);
						}
						else {
							ai::task_smart_flee_ped(0, player::player_ped_id(), 500f, -1, 0, 0);
					...
					ai::task_follow_nav_mesh_to_coord(0, vLocal_110, 2f, 20000, 1f, 1, 1193033728);
					if (func_203(iLocal_508)) {
						ai::task_enter_vehicle(0, iLocal_508, 20000, -1, 2f, 1, 0);
						ai::task_vehicle_mission_ped_target(0, iLocal_508, player::player_ped_id(), 8, 30f, 786469,
															500f, 0.1f, 1);
					}
					else {
				...
				ai::clear_sequence_task(&iLocal_506);
			}
	...
	case 1:
		if (func_393(Local_443.f_28[0])) {
			...
			if (func_393(player::player_ped_id()) && func_393(Local_443.f_28[0])) {
				if (iLocal_529 < 3) {
...
void func_231() {
	...
	case 0:
		iLocal_510 = 0;
		while (iLocal_510 <= 4) {
			if (entity::is_entity_in_angled_area(player::player_ped_id(), Local_534[iLocal_510 /*7*/],
												 Local_534[iLocal_510 /*7*/].f_3, Local_534[iLocal_510 /*7*/].f_6, 0, 1,
												 2)) {
				...
				switch (iLocal_510) {
				case 0: Local_89.f_9 = 0; break;

				case 1: Local_89.f_9 = 1; break;

				case 2: Local_89.f_9 = 2; break;

				case 3: Local_89.f_9 = 3; break;

				case 4: Local_89.f_9 = 4; break;
				}
				...
				while (!vehicle::has_vehicle_recording_been_loaded(Local_89.f_9, Local_89.f_10) ||
					   !streaming::has_model_loaded(iLocal_85) || !streaming::has_model_loaded(iLocal_84)) {
					system::wait(0);
				}
	...
	case 1:
		if (!entity::does_entity_exist(Local_89.f_7)) {
			Local_89.f_7 = vehicle::create_vehicle(iLocal_85, Local_89, 0f, 1, 1);
		...
		if (func_203(Local_89.f_7)) {
			if (func_393(Local_89.f_8)) {
				if (ped::is_ped_in_any_vehicle(Local_89.f_8, 0)) {
					...
					switch (Local_89.f_9) {
					case 0: vehicle::set_playback_speed(Local_89.f_7, 1.5f); break;

					case 1: vehicle::set_playback_speed(Local_89.f_7, 1f); break;

					case 2: vehicle::set_playback_speed(Local_89.f_7, 1.4f); break;

					case 3: vehicle::set_playback_speed(Local_89.f_7, 1.5f); break;

					case 4: vehicle::set_playback_speed(Local_89.f_7, 1.5f); break;
					}
...
void func_233() {
	...
	case 1: iLocal_101 = 2; break;

	case 2:
		if (gameplay::get_game_timer() - iLocal_511 > 20000) {
			func_441("************************************** TIMEOUT - ARREST "
					 "next frame");
			if (func_393(Local_443.f_28[1])) {
		...
		while (iVar0 <= Local_443.f_28 - 1) {
			if (func_393(Local_443.f_28[iVar0])) {
				if (func_209(Local_443.f_28[iVar0], player::player_ped_id(), 0) > 12f) {
					...
					func_441("************************************** THREAT "
							 "DURING ARREST - ATTACK next frame");
					iLocal_101 = 3;
					iLocal_511 = gameplay::get_game_timer();
				}
			}
		...
		if (!iLocal_518) {
			...
			while (iVar0 <= Local_443.f_28 - 1) {
				if (func_393(Local_443.f_28[iVar0])) {
					...
					ai::close_sequence_task(iLocal_506);
					ai::task_perform_sequence(Local_443.f_28[iVar0], iLocal_506);
					ai::clear_sequence_task(&iLocal_506);
				}
				iVar0++;
			}
		...
		while (iVar0 <= Local_443.f_28 - 1) {
			if (func_393(Local_443.f_28[iVar0])) {
				...
				if (func_234(Local_443.f_28[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0)) {
					func_441("************************************** "
							 "ATTACKED/THREATENED - ATTACK now");
					iLocal_101 = 3;
				}
				if (iLocal_101 != 4) {
...
// Position - 0x27750
bool func_234(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6,
			  int iParam7) {
	vector3 vVar0;

	if (func_393(player::player_ped_id()) && func_393(iParam0)) {
		if (entity::has_entity_been_damaged_by_entity(iParam0, player::player_ped_id(), 1)) {
			return true;
		}
		if (func_248(iParam0, iParam1, iParam5, iParam6, iParam7)) {
			return true;
		}
...
// Position - 0x27881
bool func_236(int iParam0, float fParam1) { return func_237(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_237(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_238(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0x2795A
int func_238(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
...
int func_241(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_243(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
...
// Position - 0x27D4F
bool func_248(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) {
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_393(player::player_ped_id()) && func_393(iParam0)) {
		...
		if (!bParam2) {
			if (func_252(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
...
// Position - 0x27E4A
bool func_249(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
// Position - 0x28079
bool func_252(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
	...
	case 1:
		...
		case 0:
			if (func_284(1, 1093140480, 0)) {
				...
				if (func_203(iVar0)) {
					...
					else if (entity::is_entity_in_angled_area(iVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f,
															  285.1346f, 66.34669f, 33f, 0, 1, 0)) {
				...
				if (func_203(iVar0)) {
					if (vehicle::is_this_model_a_heli(entity::get_entity_model(iVar0))) {
						func_274(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar4,
								 50f, 50f, 50f, 1, 1, 1, 0, 0);
					}
					else {
						func_274(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar4,
								 func_273(), 1, 1, 1, 0, 0);
		...
		case 2:
			if (streaming::has_anim_dict_loaded("rcmjosh4") &&
				streaming::has_anim_dict_loaded("combat@gestures@pistol@halt") &&
				streaming::has_anim_dict_loaded("combat@gestures@pistol@glances") &&
				streaming::has_model_loaded(iLocal_509)) {
				iLocal_527++;
			}
			break;
		...
		default: iLocal_527 = 0; break;
		}
		break;

	case 2: func_290(2); break;
	}
}
	...
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_263(player::player_id()) &&
				!func_261(player::player_id(), 0) && !func_260()) {
...
// Position - 0x288B9
bool func_260() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x289A4
bool func_264() { return gameplay::is_bit_set(Global_2359301, 3); }
...
void func_267() {
	...
	if (cutscene::can_set_exit_state_for_registered_entity("Cop_standing_idle", 0)) {
		if (func_393(Local_443.f_28[1])) {
			...
			ai::close_sequence_task(iLocal_506);
			ai::task_perform_sequence(Local_443.f_28[1], iLocal_506);
			ai::clear_sequence_task(&iLocal_506);
	...
	if (cutscene::can_set_exit_state_for_registered_entity("Cop_with_notepad", 0)) {
		if (func_393(Local_443.f_28[2])) {
			...
			ai::open_sequence_task(&iLocal_506);
			ai::task_look_at_entity(0, player::player_ped_id(), -1, 1026, 2);
			ai::task_go_to_coord_while_aiming_at_entity(0, -1103.72f, 289.46f, 63.23f, player::player_ped_id(), 1f, 0,
														0.1f, 1082130432, 1, 0, 1, -957453492, 20000);
			ai::task_go_to_coord_while_aiming_at_entity(0, -1106.08f, 288.55f, 63.31f, player::player_ped_id(), 1f, 0,
														0.1f, 1082130432, 1, 0, 1, -957453492, 20000);
			ai::task_aim_gun_at_entity(0, player::player_ped_id(), -1, 1);
			ai::close_sequence_task(iLocal_506);
			ai::task_perform_sequence(Local_443.f_28[2], iLocal_506);
			ai::clear_sequence_task(&iLocal_506);
...
// Position - 0x28CA6
void func_269(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8,
...
// Position - 0x28EA0
Vector3 func_271(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }
...
// Position - 0x28EEF
Vector3 func_273() { return 2.55f, 5.665f, 2.55f; }

// Position - 0x28F06
void func_274(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
			  int iParam14, int iParam15, int iParam16, int iParam17, int iParam18) {
	func_275(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

// Position - 0x28F30
void func_275(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
...
// Position - 0x293BD
bool func_278(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
// Position - 0x2949D
bool func_279(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	vector3 vVar9;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (func_280(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_280(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_280(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_280(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_280(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_280(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_280(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_280(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_280(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_280(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_280(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_280(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_280(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_280(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_280(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_280(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x29793
int func_280(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
void func_283() {
	...
	if (func_393(Local_443.f_28[1])) {
		iLocal_504 = weapon::create_weapon_object(
			joaat("weapon_pistol"), -1, entity::get_entity_coords(Local_443.f_28[1], 1), 1, 1065353216, 0, 0, 1);
		cutscene::register_entity_for_cutscene(Local_443.f_28[1], "Cop_standing_idle", 0, 0, 0);
		func_441("*** Registered Cop standing");
	}
	if (func_393(Local_443.f_28[2])) {
		iLocal_505 = weapon::create_weapon_object(
			joaat("weapon_pistol"), -1, entity::get_entity_coords(Local_443.f_28[2], 1), 1, 1065353216, 0, 0, 1);
...
// Position - 0x29A0E
bool func_284(int iParam0, float fParam1, int iParam2) {
	int iVar0;
...
// Position - 0x29B89
bool func_288(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
void func_291(int iParam0) {
	...
	streaming::request_anim_dict("combat@gestures@pistol@glances");
	streaming::request_model(iLocal_509);
	while (!streaming::has_anim_dict_loaded("combat@gestures@pistol@halt") ||
		   !streaming::has_anim_dict_loaded("combat@gestures@pistol@glances") ||
		   !streaming::has_model_loaded(iLocal_509)) {
		system::wait(0);
	}
	...
	if (object::does_object_of_type_exist_at_coords(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), 0)) {
		object::set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, 0, 0f,
												  0);
	}
	if (func_393(Local_443.f_28[0])) {
		if (iParam0 == 1) {
...
void func_293() {
	...
	switch (iLocal_88) {
	case 0:
		if (!func_5(0) && entity::is_entity_in_angled_area(player::player_ped_id(), -1107.353f, 281.626f, 61.46451f,
														   -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0)) {
	...
	case 1:
		if (!func_5(0) && entity::is_entity_in_angled_area(player::player_ped_id(), -1107.353f, 281.626f, 61.46451f,
														   -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0)) {
			if (func_393(player::player_ped_id()) && func_258(Local_443.f_28[0])) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), -1105.571f, 290.008f, 62.87176f,
													 -1100.577f, 290.4298f, 66.45212f, 4.5f, 0, 1, 0)) {
					if (!func_294()) {
			...
			if (!iLocal_519) {
				if (func_258(Local_443.f_28[0])) {
					if (entity::is_entity_playing_anim(Local_443.f_28[0], "rcmjosh4", "beckon_a_josh", 3) &&
						!func_205()) {
						ai::task_play_anim(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 2f, -8f, -1, 2, 0, 0, 0,
										   0);
						func_441("Done Josh leadin anim");
						if (func_258(Local_443.f_28[2])) {
							ai::task_play_anim(Local_443.f_28[2], "rcmjosh4", "josh_4_leadin_cop_a", 8f, -8f, -1, 2, 0,
											   0, 0, 0);
							func_441("Done Notepad cop leadin anim");
						}
						if (func_258(Local_443.f_28[1])) {
							ai::task_play_anim(Local_443.f_28[1], "rcmjosh4", "josh_4_leadin_cop_b", 8f, -8f, -1, 2, 0,
											   0, 0, 0);
				...
				if (func_393(player::player_ped_id()) && func_258(Local_443.f_28[0]) && !func_294()) {
					if (!func_287(player::player_ped_id(), -875674219)) {
						ai::task_turn_ped_to_face_entity(player::player_ped_id(), Local_443.f_28[0], 0);
					}
				}
				if (func_258(Local_443.f_28[0])) {
					if (entity::is_entity_playing_anim(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3)) {
						if (entity::get_entity_anim_current_time(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh") >
							0.276f) {
							if (iLocal_520 == 0) {
						...
						if (func_209(player::player_ped_id(), Local_443.f_28[0], 1) <= 2f) {
							...
							func_441("Player too close to Josh, starting "
									 "cutscene early");
							func_290(1);
						}
					}
...
struct<2> func_303(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_311(iParam0)}; break;
	...
	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_310(iParam2)}; break;

		case 8: Var0 = {func_309(iParam2)}; break;

		case 7: Var0 = {func_308(iParam2)}; break;

		case 10: Var0 = {func_307(iParam2)}; break;

		case 5: Var0 = {func_306(iParam2)}; break;

		case 4: Var0 = {func_305(iParam2)}; break;

		default: StringCopy(&Var0, func_304(iVar2), 8); break;
		}
		break;
...
//Position - 0x2AD16
bool func_312(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (!func_314(0) || G_TextMessageConfig || Global_69960 == 1 || !cam::is_screen_faded_in()) {
		return false;
	}
	switch (Global_69956) {
	case 0:
...
// Position - 0x2AE7A
bool func_315(int iParam0) { return func_316(iParam0, Global_35781); }
...
void func_317() {
	...
	if (!func_323()) {
		func_322(player::player_ped_id(), vLocal_106, fLocal_109, 1, 1);
		cam::set_gameplay_cam_relative_pitch(0f, 1065353216);
		cam::set_gameplay_cam_relative_heading(0f);
	}
	func_291(1);
...
// Position - 0x2B473
bool func_323() { return gameplay::is_bit_set(Global_91491.f_20, 13); }
...
int func_338(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_277(iParam0, 0, 0) ||
		func_277(iParam0, 1, 0) || func_277(iParam0, 2, 0) || func_352(iParam0) != 145 || func_351(iParam0) ||
...
int func_395(var *uParam0) {
	...
	case 3:
		if (object::does_object_of_type_exist_at_coords(-1138.32f, 299.69f, 65.94f, 5f, joaat("prop_lrggate_01c_l"),
														0)) {
			object::set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, 1, 0f,
													  0);
		}
		if (object::does_object_of_type_exist_at_coords(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"),
														0)) {
			object::set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, 1,
													  0f, 0);
		}
		iVar5 = 0;
		while (iVar5 <= iVar0 - 1) {
...
void func_396(var *uParam0, int iParam1) {
	...
	func_397(uParam0, iLocal_81, vVar0, fVar3);
...
// Position - 0x34488
void func_397(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_226(uParam0);
...
// Position - 0x344C8
void func_398(var *uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	func_227(uParam0);
	*uParam0 = ped::create_ped(iParam6, iParam1, vParam2, fParam5, 0, 0);
}

// Position - 0x344E9
bool func_399(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
	if (func_400(uParam0, iParam1, vParam2, fParam5, 1)) {
		if (entity::does_entity_exist(*uParam0)) {
...
// Position - 0x34545
bool func_400(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	int iVar0;
...
void func_408() {
	...
	ui::clear_prints();
	if (func_418()) {
		func_441("...Random Character Script was triggered so additional "
				 "cleanup required");
	}
	iVar0 = 1;
	while (iVar0 <= Local_443.f_28 - 1) {
...
// Position - 0x34880
void func_410(var *uParam0, bool bParam1) { func_411(&uParam0->f_41, bParam1); }
...
// Position - 0x34936
void func_414(var *uParam0, bool bParam1) { func_415(&uParam0->f_35, bParam1); }
...
// Position - 0x34985
void func_416(var *uParam0, int iParam1) { func_417(&uParam0->f_28, iParam1); }
...
void func_419(int iParam0) {
	...
	if (!func_436()) {
		...
		if (iParam0) {
			func_159(iVar0, 1, 0);
			func_420(script::get_this_script_name(), iVar0);
		}
		else {
			if (Global_100787[iVar0 /*10*/].f_9 == -1) {
			}
...
// Position - 0x34F2B
void func_431() { Global_17151.f_5 = 1; }

// Position - 0x34F39
void func_432() { Global_17151.f_5 = 0; }
...
// Position - 0x35184
void func_441(char *sParam0) { sParam0 = sParam0; }
