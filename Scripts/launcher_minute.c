...
void __EntryFunction__() {
	...
	if (player::has_force_cleanup_occurred(83)) {
		...
		if (Var0 != -1) {
			if (Global_100787[Var0 /*10*/].f_9 != -1) {
				...
				func_272(&Global_100787[Var0 /*10*/].f_9);
			}
		}
		func_256(&Var0, 1);
	}
	if (!func_253(&iVar64, &Var0, vVar61, 1f)) {
		func_252();
	...
	if (Var0 == 32) {
		vehicle::set_all_vehicle_generators_active_in_area(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f),
														   Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0, 1);
		vehicle::remove_vehicles_from_generators_in_area(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f),
														 Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0);
	...
	while (true) {
		...
		if (Var0 == 32) {
			...
			if (func_191(Var0.f_35[1])) {
				if (!func_190(329.513f, 3402.691f, 36.258f, entity::get_entity_coords(Var0.f_35[1], 1), 1056964608)) {
		...
		func_186(Var0);
		func_179(&iLocal_96, &Var0.f_9, vVar61);
		if (Var0 == 32) {
			func_175(&Var0, vVar61, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &iLocal_99);
		}
		else if (Var0 == 34) {
			func_170(&Var0, vVar61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_156(&Var0, 0)) {
			if (func_155(Var0)) {
				func_152(Var0, &iLocal_98);
			}
			if (!func_2(&Var0)) {
				func_256(&Var0, 1);
			}
...
int func_2(int iParam0) {
	...
	if (!func_151()) {
		while (!func_142(*iParam0)) {
			...
			if (!func_193(iParam0, *iParam0 != 2)) {
				func_273("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() "
						 "[TERMINATING]");
				return 0;
			}
			system::wait(0);
	...
	if (!func_98(iParam0)) {
		func_273("STEP_7_COMMON_LaunchMission - Trying to launch a null script "
				 "string name");
		return 0;
	}
...
int func_98(int iParam0) {
	...
	if (func_128(&uParam0->f_1)) {
		...
		if (cutscene::has_cutscene_loaded()) {
			...
			func_273("Initial cutscene wasn't loaded in time to pass to RC "
					 "mission.");
					...
					if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
						...
						if (func_161(2)) {
							if (func_160(iParam0->f_27)) {
								...
								func_273("ARE_RC_TRIGGER_CONDITIONS_MET: "
		...
		if (*iParam0 == 6) {
			...
			if (ai::get_ped_desired_move_blend_ratio(player::player_ped_id()) >= 2f) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 245.8885f, 371.9034f, 103.9884f,
					...
					if (func_161(2)) {
						if (func_160(iParam0->f_27)) {
							func_159(iParam0->f_27, *iParam0);
							func_273("RC5_IN_ACTIVATION_RANGE: "
			...
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 2728.948f, 4143.44f, 42.29295f, 2722.213f,
				...
				if (func_161(2)) {
					if (func_160(1)) {
						func_159(1, *iParam0);
						func_273("RC_IN_ACTIVATION_RANGE: "
	...
	if (iParam0 == 1) {
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			...
			if (ped::is_ped_in_any_heli(player::player_ped_id()) || ped::is_ped_in_any_plane(player::player_ped_id())) {
				func_273("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for "
						 "plane or helicopter.");
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						func_164() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						func_164() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5 || LastDispatchedMessageOrCall != -1) {
						return false;
					}
					break;
				...
				case 4:
					if (func_169() || player::get_player_wanted_level(player::player_id()) > 0 || func_167(8, -1) ||
						func_164() || func_163() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						func_163() || func_164() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
...
int func_170(int iParam0, vector3 vParam1, char[4] cParam4, char *sParam5, int iParam6, char *sParam7, int iParam8,
	...
	if (func_112(player::player_ped_id()) && func_112(iParam0->f_28[0]) && !func_131() &&
		...
		func_174(player::player_ped_id(), vParam1, 1) < fParam9) {
		uVar0 = 16;
...
// Position - 0xB7FE
float func_174(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
...
// Position - 0xB838
int func_175(int iParam0, vector3 vParam1, char[4] cParam4, char *sParam5, int iParam6, char *sParam7, int iParam8,
		...
		if (func_161(2)) {
			if (!func_131()) {
				if (func_112(player::player_ped_id()) && func_112(iParam0->f_28[0]) && func_112(iParam0->f_28[1]) &&
					func_174(player::player_ped_id(), vParam1, 1) < 20f) {
			...
			else if (func_177(sParam5) && *iParam10 != 1 && func_112(player::player_ped_id()) &&
					 func_174(player::player_ped_id(), vParam1, 1) >= 20f) {
				func_273("pause conversation");
				func_176(1);
				*iParam10 = 1;
			}
			if (func_174(player::player_ped_id(), vParam1, 1) < 20f && *iParam10 == 1) {
...
// Position - 0xB983
void func_176(int iParam0) { Global_16756 = iParam0; }
	...
	if (player::is_player_playing(player::player_id())) {
		if (!gameplay::is_string_null_or_empty(sParam1)) {
			if (Global_35781 == 17) {
				...
				if (func_174(player::player_ped_id(), vParam2, 1) <= 100f) {
					func_182(iParam0, 1);
				}
			}
			else {
				...
				if (func_174(player::player_ped_id(), vParam2, 1) > 120f) {
					func_184(iParam0);
				}
			}
		}
...
// Position - 0xBBD8
bool func_183() { return Global_89133; }
	...
	if (func_112(player::player_ped_id())) {
		...
		while (iVar0 <= uParam0->f_28 - 1) {
			if (func_111(uParam0->f_28[iVar0])) {
				...
				switch (*uParam0) {
				case 19: func_188(uParam0->f_28[iVar0]); break;
...
int func_193(var *uParam0, int iParam1) {
	...
	if (Global_69702) {
		func_273("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer "
				 "[TERMINATING]");
		return 0;
	}
	...
	if (func_221(*uParam0)) {
		...
		func_273("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1) {
	...
	if (*uParam0 == 10) {
		if (fire::is_explosion_in_sphere(-1, uParam0->f_17[0 /*3*/], 8f)) {
			func_273("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission "
					 "trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17) {
		if (!gameplay::is_bit_set(Var0.f_26, func_90())) {
			func_273("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player "
					 "character to launch mission");
			return 0;
		}
	}
	if (func_197(&uParam0->f_48) && iParam1) {
		...
		while (iVar0 <= iVar1) {
			if (entity::does_entity_exist(uParam0->f_35[iVar0])) {
				if (entity::is_entity_dead(uParam0->f_35[iVar0], 0)) {
					func_273("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (!ped::is_ped_injured(uParam0->f_28[iVar0])) {
					if (ped::is_ped_sitting_in_any_vehicle(player::player_ped_id())) {
						if (entity::is_entity_touching_entity(player::player_ped_id(), uParam0->f_28[iVar0])) {
							...
							func_273("STEP_5_COMMON_RCfineAndInRange - Random "
					...
					if (func_220(*uParam0)) {
						...
						if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(uParam0->f_28[iVar0], 1), 15f)) {
							...
							func_273("STEP_5_COMMON_RCfineAndInRange - There "
					...
					if (!func_202(*uParam0)) {
						...
						if (player::get_player_wanted_level(player::player_id()) > 0) {
							...
							func_273("STEP_5_COMMON_RCfineAndInRange - Player "
...
// Position - 0xCD6D
bool func_204(int iParam0, float fParam1) { return func_205(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_205(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_206(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0xCE46
int func_206(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
...
int func_209(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_211(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
...
// Position - 0xD2EF
bool func_216(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
// Position - 0xD490
bool func_218(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = {func_211(vParam1 - entity::get_entity_coords(iParam0, 1))};
...
// Position - 0xD764
var func_228() { return ped::add_scenario_blocking_area(-309.1f, 6205.4f, 30f, -279.33f, 6217.98f, 40f, 0, 1, 1, 1); }
...
// Position - 0xDBED
bool func_233(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
...
int func_241(var *uParam0) {
	...
	case 1:
		gameplay::clear_area(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
		if (!func_238(&iVar0) || !streaming::has_anim_dict_loaded("rcmminute1")) {
			return 0;
		}
		iLocal_91 = 2;
		break;
...
int func_244(int iParam0) {
	...
	if (Global_69702) {
		func_273("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is "
				 "running [TERMINATING]");
		return 0;
	}
	if (!Global_101700.f_8044 && !func_93(1)) {
		func_273("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not "
				 "active");
		return 0;
	}
	if (!func_245(iParam0)) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_273("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (Global_91491.f_11 == 6) {
		if (Global_91491 < 9) {
			...
			if (gameplay::are_strings_equal(&Global_91491.f_3, sVar0)) {
				func_273("STEP_3_COMMON_CanRCLaunch - Script denied as a "
	...
	if (script::_get_number_of_instances_of_script_with_name_hash(joaat("candidate_controller")) == 0) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_273("STEP_3_COMMON_CanRCLaunch - Script denied as "
...
// Position - 0xE653
int func_253(int iParam0, int iParam1, vector3 vParam2, float fParam5) {
	int iVar0;

	if (*iParam0 == 1) {
		if (func_254((*iParam0)[0], vParam2, fParam5, iParam1)) {
			return 1;
		}
	}
	else {
		iVar0 = 0;
		while (iVar0 < *iParam0) {
			if (func_254((*iParam0)[iVar0], vParam2, fParam5, iParam1)) {
				iVar0 = *iParam0;
				return 1;
			}
			iVar0++;
	...
	func_273("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch "
			 "[TERMINATING]");
	return 0;
}

// Position - 0xE6B8
bool func_254(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	int iVar0;
	struct<7> Var1;

	iVar0 = 0;
	func_95(iParam0, &Var1);
	if (func_255(Var1.f_6, vParam1, fParam4, 0)) {
...
// Position - 0xE736
bool func_255(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
void func_256(int iParam0, int iParam1) {
	...
	if (*iParam0 == 32) {
		vehicle::set_all_vehicle_generators_active_in_area(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f),
														   Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 1, 1);
	}
	else if (*iParam0 == 34) {
	...
	switch (*iParam0) {
	case 32: sVar0 = "MIN1_AMB"; break;

	case 34: sVar0 = "MIN3_AMB"; break;
	}
	func_257(sVar0);
	if (iParam1) {
		func_186(*iParam0);
...
// Position - 0xE944
void func_262(var *uParam0, bool bParam1) { func_263(&uParam0->f_41, bParam1); }
...
// Position - 0xE9CF
void func_265(var *uParam0, bool bParam1) { func_266(&uParam0->f_35, bParam1); }
...
// Position - 0xEA56
void func_268(var *uParam0, int iParam1) { func_269(&uParam0->f_28, iParam1); }
