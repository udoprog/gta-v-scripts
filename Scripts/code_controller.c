...
void func_236() {
	if (!gameplay::is_bit_set(Global_101700.f_6647.f_923, 3)) {
		gameplay::set_bit(&Global_101700.f_6647.f_923, 3);
	}
	else if (!gameplay::is_bit_set(Global_101700.f_6647.f_923, 4)) {
		gameplay::set_bit(&Global_101700.f_6647.f_923, 4);
	}
	else if (!gameplay::is_bit_set(Global_101700.f_6647.f_923, 5)) {
		gameplay::set_bit(&Global_101700.f_6647.f_923, 5);
	}
}
...
void func_237() {
	if (!gameplay::is_bit_set(Global_101700.f_6647.f_923, 0)) {
		gameplay::set_bit(&Global_101700.f_6647.f_923, 0);
	}
	else if (!gameplay::is_bit_set(Global_101700.f_6647.f_923, 1)) {
		gameplay::set_bit(&Global_101700.f_6647.f_923, 1);
	}
	else if (!gameplay::is_bit_set(Global_101700.f_6647.f_923, 2)) {
		gameplay::set_bit(&Global_101700.f_6647.f_923, 2);
	}
}
...
void func_240() {
	...
	if (iVar0 != -1) {
		Global_101700.f_6647[iVar0 /*15*/].f_4 = gameplay::get_game_timer() + 100000;
	}
