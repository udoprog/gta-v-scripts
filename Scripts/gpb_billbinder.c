...
void func_51(int iParam0, char *sParam1, char *sParam2) {
	...
	switch (iParam0) {
	case 1: StringCopy(sParam2, "Bill_ig_1_A_01_IHearWhatYourSayin", 64); break;

	case 2: StringCopy(sParam2, "Bill_ig_1_A_03_OhIKnowWhatYouAreThinking", 64); break;

	case 3: StringCopy(sParam2, "Bill_ig_1_A_04_TheWholePlaceIsAGoddamPonzieScheme", 64); break;

	case 4: StringCopy(sParam2, "Bill_ig_1_B_01_ImOfferingIronClad", 64); break;

	case 5: StringCopy(sParam2, "Bill_ig_1_B_02_IKnowWhatYouAreThinking", 64); break;

	case 6: StringCopy(sParam2, "Bill_ig_1_C_01_DontBeAFool", 64); break;

	case 7: StringCopy(sParam2, "Bill_ig_1_C_02_YesItsADogEatDog", 64); break;

	case 8: StringCopy(sParam2, "Bill_ig_1_C_03_ILikeSharingInformation", 64); break;
	}
}
