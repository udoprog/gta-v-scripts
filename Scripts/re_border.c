			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						func_114() || Global_101700.f_6647.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						func_114() || Global_101700.f_6647.f_919[iVar0] == 5 || Global_36328 != -1) {
						return 0;
					}
					break;
				...
				case 4:
					if (func_119() || player::get_player_wanted_level(player::player_id()) > 0 || func_43(8, -1) ||
						func_114() || func_113() || Global_101700.f_6647.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						func_113() || func_114() || Global_101700.f_6647.f_919[iVar0] == 5) {
						return 0;
					}
					break;
