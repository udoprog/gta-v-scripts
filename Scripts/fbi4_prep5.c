...
void __EntryFunction__() {
	...
	while (true) {
		...
		if (func_197(player::player_ped_id())) {
			...
			func_184();
			switch (iLocal_84) {
			case 0: func_104(); break;

			case 1: func_94(); break;
...
void func_6(var *uParam0, int iParam1) {
	...
	while (iVar0 < 3) {
		...
		if (iVar1 == 8 || iVar1 == 9 || iVar1 == 10 || iVar1 == 11 || iVar1 == 34 || iVar1 == 72 || iVar1 == 73)
			...
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_8(Global_101700.f_17492[iVar0], &vVar2, &fVar5)) {
...
// Position - 0x5AB
void func_7(int *iParam0) { *iParam0 = -15; }
...
int func_8(int iParam0, var *uParam1, float *fParam2) {
	...
	case 9: return func_8(8, uParam1, fParam2);

	case 10: return func_8(8, uParam1, fParam2);
...
// Position - 0x126B
void func_20() { func_21(&iLocal_200); }
...
void func_22() {
	switch (iLocal_85) {
	case 0:
		if (func_89(iLocal_84, iLocal_28)) {
	...
	case 2:
		...
		if (gameplay::get_game_timer() - iLocal_379 > 2000) {
			func_21(&iLocal_200);
			if (func_44(&iLocal_86, &cLocal_375, &uLocal_210)) {
				func_39();
			}
		}
		break;
	...
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_32(player::player_id()) &&
				!func_29(player::player_id(), 0) && !func_28()) {
...
// Position - 0x15AF
bool func_28() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x1734
void func_37(int iParam0, vector3 vParam1, float fParam4) {
	if (func_197(iParam0)) {
...
// Position - 0x175A
int func_38(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	bool bVar0;
	float fVar1;
...
// Position - 0x194F
bool func_44(int *iParam0, char *sParam1, var *uParam2) {
	switch (*iParam0) {
	case 0:
		if (func_77()) {
			if (func_76(74) || func_76(75))
				&&func_75() {
					if (func_11() == 0) {
						func_74(1);
						func_73(46, 1);
...
// Position - 0x1FD4
int func_56() { return Global_69964; }
...
//Position - 0x210E
bool func_61(var* uParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	func_69(uParam0, iParam1, sParam3, iParam7, iParam8, 0);
	Global_1631 = iParam2;
	Global_15793 = 0;
	Global_15752 = 1;
	Global_15759 = 0;
	...
	Global_2621441 = 0;
	return func_62(sParam4, iParam5, iParam9);
}
...
// Position - 0x2B3E
bool func_81(int iParam0) { return func_82(iParam0, 5, 1); }
...
int func_83(int iParam0, int iParam1, int iParam2) {
	...
	iVar0 = Global_2503826[iParam0 /*3*/][func_84(iParam1)];
...
// Position - 0x302F
int func_91(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
// Position - 0x30AA
void func_92() { func_93(&uLocal_210); }
...
void func_94() {
	...
	case 0:
		if (func_89(iLocal_84, iLocal_28)) {
			...
			if (ui::does_blip_exist(iLocal_200)) {
				ui::set_blip_colour(iLocal_200, 2);
				ui::set_blip_route_colour(iLocal_200, 2);
			}
...
// Position - 0x362B
bool func_98(int iParam0) { return func_82(iParam0, 6, 1); }

// Position - 0x363B
bool func_99(int iParam0, vector3 vParam1, float fParam4) {
...
// Position - 0x36C4
void func_102(int *iParam0, vector3 vParam1, int iParam4, int iParam5, char *sParam6) {
	if (!ui::does_blip_exist(*iParam0)) {
		*iParam0 = func_103(vParam1, 5, iParam4);
		if (iParam5) {
			ui::set_blip_name_from_text_file(*iParam0, sParam6);
		}
	}
}

// Position - 0x36F3
int func_103(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
...
// Position - 0x388B
bool func_106(int iParam0) { return func_82(iParam0, 0, 1); }
...
// Position - 0x3988
var func_109() { return gameplay::is_bit_set(Global_91491.f_20, 13); }

// Position - 0x399C
void func_110(var *uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8,
	...
	if (iVar0 == 1) {
		...
		*uParam0 = func_163(vParam1, fParam4);
	}
	else if (iParam9 == 1) {
...
// Position - 0x3B2F
int func_111(int *iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7) {
	int iVar0;
	var *uVar1;
	struct<97> Var5;
	int iVar103;
		...
		if (Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/] == Var5) {
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/],
				...
				func_145(iParam0, &Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/].f_31,
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/],
				...
				func_145(iParam0, &Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/].f_31,
...
void func_112(int iParam0, var *uParam1, int iParam2, int iParam3) {
	...
	if (func_14(iParam0) && entity::does_entity_exist(*uParam1) && vehicle::is_vehicle_driveable(*uParam1, 0)) {
		...
		if (vehicle::get_vehicle_mod_kit(*uParam1) >= 0 && vehicle::get_vehicle_mod_kit(*uParam1) < 255 &&
			func_117(*uParam1, 0, &iVar0)) {
			func_116(uParam1, &Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_31,
			...
			if (iParam3) {
				...
				Global_101700.f_19077[iParam0 /*43*/].f_31 = func_115(*uParam1);
				...
				func_113(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_5,
				...
				func_113(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0,
...
// Position - 0x5604
bool func_114(int iParam0, char *sParam1, int *iParam2, int *iParam3, int *iParam4) {
	*iParam2 = -1;
	*iParam3 = -1;
	*iParam4 = -1;
	switch (iParam0) {
...
int func_117(int iParam0, int iParam1, int *iParam2) {
	...
	*iParam2 = 0;
	...
	if (!func_119(iVar0, iParam1, iParam2)) {
		return 0;
	}
	...
	if (!network::network_is_game_in_progress()) {
		if (func_118(iParam0) && entity::get_entity_model(iParam0) != joaat("sentinel2") &&
		...
		*uParam1 = vehicle::get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11) {
			if (vehicle::is_vehicle_extra_turned_on(iParam0, iVar0 + 1)) {
				gameplay::set_bit(&uParam1->f_77, func_123(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_125(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_140(iParam0, 0, 0) ||
		func_140(iParam0, 1, 0) || func_140(iParam0, 2, 0) || func_139(iParam0) != 145 || func_138(iParam0) ||
		func_137(iParam0) || func_118(iParam0) || func_136(iParam0) || !func_126(entity::get_entity_model(iParam0))) {
		if (func_137(iParam0)) {
		}
		if (func_137(iParam0)) {
		}
...
// Position - 0x89B0
int func_131() { return 0; }

// Position - 0x89B9
int func_132() { return 1; }

// Position - 0x89C2
int func_133() { return 1; }
...
// Position - 0x8D1D
bool func_141(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
// Position - 0x8EA2
bool func_144(int iParam0) { return vehicle::is_vehicle_extra_turned_on(iParam0, 5); }
...
int func_145(int iParam0, var *uParam1, var *uParam2) {
	...
	if (func_148(entity::get_entity_model(*iParam0), 1) &&
		vehicle::get_vehicle_mod(*iParam0, 24) != func_147(*iParam0, (*uParam1)[38] - 1)) {
		vehicle::set_vehicle_mod(*iParam0, 24, func_147(*iParam0, (*uParam1)[38] - 1), 0);
	}
	if (func_146(*iParam0)) {
	...
	while (iVar0 < 9) {
		if (entity::does_entity_exist(Global_89155[iVar0])) {
			if (iParam0 == 145 || Global_89165[iVar0] == iParam0) {
				if (iParam1 == 0 || entity::get_entity_model(Global_89155[iVar0]) == func_152(iParam0, iParam1)) {
...
// Position - 0x978C
void func_153(vector3 vParam0, float fParam3, int iParam4) {
	int iVar0;
...
void func_154(int iParam0) {
	...
	if (func_161(&Global_68531.f_555[0 /*21*/], iParam0)) {
		...
		if (gameplay::is_bit_set(Global_68531.f_555[0 /*21*/].f_9, 13)) {
			if (iParam0 == 24 && func_160(iParam0, 0) && Global_69440.f_66 == 0 &&
				Global_101700.f_31389.f_1958[Global_68531.f_555[0 /*21*/].f_14] != 0 &&
				Global_101700.f_31389.f_1958[Global_68531.f_555[0 /*21*/].f_14] > 3 &&
				(!func_158(0, Global_68531.f_555[0 /*21*/].f_12) || !func_158(1, Global_68531.f_555[0 /*21*/].f_12))) {
...
// Position - 0x9B24
int func_159(var *uParam0) { return *uParam0; }
...
// Position - 0xB290
int func_163(vector3 vParam0, float fParam3) { return func_164(&Global_96040.f_2311, vParam0, fParam3, 0); }

// Position - 0xB2AA
int func_164(var *uParam0, vector3 vParam1, float fParam4, int iParam5) {
	int iVar0;
	vector3 vVar1;
	bool bVar4;
	var uVar5;
	...
	if (func_173(uParam0)) {
		...
		if (func_172(uParam0)) {
			...
			if (entity::does_entity_exist(iVar0)) {
				...
				else if (!func_166(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10 &&
...
// Position - 0xB61E
int func_166(int iParam0, vector3 vParam1, bool bParam4) {
	int iVar0;
	var uVar1[3];
	int iVar5;
	int iVar6;
	...
	case joaat("cuban800"):
		...
		iVar6 = 0;
		while (iVar6 <= iVar5 - 1) {
			if (func_167(iParam0, uVar1[iVar6], 1) &&
				func_91(entity::get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)) {
...
void func_168(int iParam0, var *uParam1, int iParam2, int iParam3) {
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (uParam1->f_66 == joaat("sovereign")) {
			...
			iVar0 = 1;
			if (gameplay::is_bit_set(uParam1->f_77, func_123(iVar0 + 1))) {
			}
			else {
				gameplay::set_bit(&uParam1->f_77, func_123(iVar0 + 1));
			}
			...
			iVar1 = 1;
			if (gameplay::is_bit_set(uParam1->f_77, func_123(iVar1 + 1))) {
			}
			else {
				gameplay::set_bit(&uParam1->f_77, func_123(iVar1 + 1));
			}
		}
		...
		if (gameplay::is_bit_set(uParam1->f_77, 15) || func_171(iParam0) ||
		...
		if (!vehicle::is_this_model_a_heli(uParam1->f_66) && !vehicle::is_this_model_a_boat(uParam1->f_66)) {
			iVar2 = 0;
			while (iVar2 <= 11) {
				if (gameplay::is_bit_set(uParam1->f_77, func_123(iVar2 + 1))) {
...
// Position - 0xBD9A
var func_170() { return dlc2::is_dlc_present(-1691188696); }
...
// Position - 0xBE8A
int func_174() { return func_172(&Global_96040.f_2311); }

// Position - 0xBE9D
void func_175() { func_176(&Global_96040.f_2311); }
...
// Position - 0xC052
int func_180() { return func_173(&Global_96040.f_2311); }

// Position - 0xC065
bool func_181(vector3 vParam0, int iParam3) { return func_182(Global_96040.f_2311.f_12.f_66, vParam0, iParam3); }

// Position - 0xC082
int func_182(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
	vector3 vVar3;
...
// Position - 0xC0EC
Vector3 func_183() { return 2.55f, 5.665f, 2.55f; }

// Position - 0xC103
void func_184() {
	if (!iLocal_28 && iLocal_84 != 3) {
		if (iLocal_84 > 0) {
			if (!bLocal_196) {
				if (!func_106(28)) {
					func_191(1);
			...
			if (!bLocal_196) {
				if (!func_99(player::player_ped_id(), vLocal_205, 150f)) {
					...
					if (!iLocal_208) {
						ui::clear_prints();
						func_185("PRE_RETSHOP", &iLocal_208);
					}
				}
			}
		}
...
// Position - 0xC275
int func_189(int iParam0) { return Global_52996[iParam0]; }

// Position - 0xC284
bool func_190(int iParam0) { return func_82(iParam0, 1, 1); }
...
void func_191(int iParam0) {
	...
	case 1: sLocal_192 = "PRE_FKICKOFF"; break;

	case 2: sLocal_192 = "PRE_FLEFT"; break;

	case 3: sLocal_192 = "PRE_CASH"; break;

	case 4: sLocal_192 = "PRE_COPS"; break;
	}
	iLocal_84 = 3;
	iLocal_85 = 0;
}
...
// Position - 0xC4F3
void func_194(char *sParam0, char *sParam1, char *sParam2) {
...
int func_200(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	case 0:
		...
		case 1: func_223(joaat("sp1_money_total_spent"), iParam3); break;

		case 2: func_223(joaat("sp2_money_total_spent"), iParam3); break;
		}
		func_208(0);
		switch (iParam2) {
		case 126:
		...
		case 68:
			switch (iParam0) {
			case 0: func_223(joaat("sp0_money_spent_on_tattoos"), iParam3); break;

			case 1: func_223(joaat("sp1_money_spent_on_tattoos"), iParam3); break;

			case 2: func_223(joaat("sp2_money_spent_on_tattoos"), iParam3); break;
			}
			if (func_207(1)) {
				fVar0 = 0f;
				iVar1 = 1;
		...
		case 21:
			switch (iParam0) {
			case 0: func_223(joaat("sp0_money_spent_on_taxis"), iParam3); break;

			case 1: func_223(joaat("sp1_money_spent_on_taxis"), iParam3); break;

			case 2: func_223(joaat("sp2_money_spent_on_taxis"), iParam3); break;
			}
			break;

		case 25:
			switch (iParam0) {
			case 0: func_223(joaat("sp0_money_spent_in_strip_clubs"), iParam3); break;

			case 1: func_223(joaat("sp1_money_spent_in_strip_clubs"), iParam3); break;

			case 2: func_223(joaat("sp2_money_spent_in_strip_clubs"), iParam3); break;
			}
			break;
		...
		case 112:
			switch (iParam0) {
			case 0: func_223(joaat("sp0_money_spent_property"), iParam3); break;

			case 1: func_223(joaat("sp1_money_spent_property"), iParam3); break;

			case 2: func_223(joaat("sp2_money_spent_property"), iParam3); break;
			}
			break;
		...
		default:
			...
			case joaat("clothes_shop_sp"):
				switch (iParam0) {
				case 0: func_223(joaat("sp0_money_spent_in_clothes"), iParam3); break;

				case 1: func_223(joaat("sp1_money_spent_in_clothes"), iParam3); break;

				case 2: func_223(joaat("sp2_money_spent_in_clothes"), iParam3); break;
				}
				break;

			case joaat("hairdo_shop_sp"):
				switch (iParam0) {
				case 0: func_223(joaat("sp0_money_spent_on_hairdos"), iParam3); break;

				case 1: func_223(joaat("sp1_money_spent_on_hairdos"), iParam3); break;

				case 2: func_223(joaat("sp2_money_spent_on_hairdos"), iParam3); break;
				}
				if (func_207(0)) {
					fVar0 = 0f;
					iVar1 = 0;
			...
			case joaat("gunclub_shop"):
				switch (iParam0) {
				case 0: func_223(joaat("sp0_money_spent_in_buying_guns"), iParam3); break;

				case 1: func_223(joaat("sp1_money_spent_in_buying_guns"), iParam3); break;

				case 2: func_223(joaat("sp2_money_spent_in_buying_guns"), iParam3); break;
				}
				break;

			case joaat("carmod_shop"):
				switch (iParam0) {
				case 0: func_223(joaat("sp0_money_spent_car_mods"), iParam3); break;

				case 1: func_223(joaat("sp1_money_spent_car_mods"), iParam3); break;

				case 2: func_223(joaat("sp2_money_spent_car_mods"), iParam3); break;
				}
				func_206(iParam3);
				break;
			}
	...
	case 1:
		switch (iParam0) {
		case 0: func_224(95, iParam3); break;

		case 1: func_224(97, iParam3); break;

		case 2: func_224(96, iParam3); break;
		}
		func_224(98, iParam3);
		break;
	}
	...
	case 1:
		...
		switch (iParam0) {
		case 0: func_223(joaat("sp0_total_cash_earned"), iParam3); break;

		case 1: func_223(joaat("sp1_total_cash_earned"), iParam3); break;

		case 2: func_223(joaat("sp2_total_cash_earned"), iParam3); break;
		}
		break;
	...
	if (!network::network_is_game_in_progress()) {
		if (gameplay::is_bit_set(Global_101700.f_19523.f_471, iParam0)) {
			...
			gameplay::clear_bit(&Global_101700.f_19523.f_471, iParam0);
			 ...
			 gameplay::is_bit_set(Global_2097152[func_205() /*10758*/].f_7546.f_10, iParam0)) {
		bVar0 = true;
		gameplay::clear_bit(&Global_101700.f_19523.f_471, iParam0);
		gameplay::clear_bit(&Global_2097152[func_205() /*10758*/].f_7546.f_10, iParam0);
	}
	if (bVar0) {
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		ui::_set_notification_text_entry("COUP_RED");
		ui::add_text_component_substring_text_label(func_204(iParam0));
...
bool func_207(int iParam0) {
	...
	return gameplay::is_bit_set(Global_2097152[func_205() /*10758*/].f_7546.f_10, iParam0);
}
...
// Position - 0xD3F2
bool func_213(var *uParam0, int iParam1) { return (*uParam0)[iParam1] == 70; }
...
// Position - 0xD437
void func_215(var *uParam0, int iParam1) { (*uParam0)[iParam1] = 70; }
...
// Position - 0xD464
float func_217(var *uParam0) { return uParam0->f_72; }

// Position - 0xD470
bool func_218(var *uParam0, int iParam1) { return func_219(uParam0, iParam1) != -1; }
...
// Position - 0xD4AF
bool func_220(var *uParam0) { return uParam0->f_71 == 1; }
...
void func_227(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam2) {
		...
		if (func_86() == 0) {
			...
			func_228(func_85(iParam0), iVar0, -1, 1, 0);
		}
	}
	else {
...
// Position - 0xDB0D
void func_235(vector3 vParam0, float fParam3, int iParam4, int iParam5) {
	if (func_236()) {
...
void func_237(int iParam0) {
	func_238(joaat("player_zero"), 12, 20, iParam0);
	func_238(joaat("player_zero"), 12, 21, iParam0);
	func_238(joaat("player_zero"), 12, 22, iParam0);
	func_238(joaat("player_one"), 12, 13, iParam0);
	func_238(joaat("player_one"), 12, 14, iParam0);
	func_238(joaat("player_one"), 12, 15, iParam0);
	func_238(joaat("player_two"), 12, 17, iParam0);
	func_238(joaat("player_two"), 12, 18, iParam0);
	func_238(joaat("player_two"), 12, 19, iParam0);
}
...
int func_238(int iParam0, int iParam1, int iParam2, bool bParam3) {
	...
	if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0) && !gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 6)) {
		if (bParam3) {
			func_239(iParam1, Global_69523[1 /*14*/].f_5, Global_69523[1 /*14*/].f_2, 0, Global_69523[1 /*14*/].f_1, 1,
					 0);
		}
		else {
			func_239(iParam1, Global_69523[1 /*14*/].f_5, Global_69523[1 /*14*/].f_2, 0, Global_69523[1 /*14*/].f_1, 0,
					 1);
		}
		return 1;
	}
	...
	*uParam0 = iParam9;
	...
	if (iParam10) {
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 ||
			...
			iVar0 = func_83(func_246(iParam1, uParam0->f_2), Global_69521, 0);
...
void func_250(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 == 12) {
		...
		iVar59 = 0;
		iVar60 = dlc1::_get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_251(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60) {
...
void func_309(var *uParam0, var *uParam1, float fParam2) {
	...
	while (iVar1 < uParam1->f_46) {
		...
		if (func_310(uParam1, (*uParam1)[iVar1 /*3*/] + vVar9)) {
			vVar9 = {-vVar9};
		}
...
// Position - 0x23C61
void func_326() { func_231(21, 1, 0); }

// Position - 0x23C71
void func_327() { Global_87679 = 0; }
