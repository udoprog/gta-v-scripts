		...
		if (iLocal_290 != -1) {
			if (!func_203()) {
				*uParam0 = func_202(iLocal_290);
				...
				gameplay::set_bit(&Global_101700.f_17533[*uParam0 /*6*/], 0);
				gameplay::set_bit(&Global_101700.f_17533[*uParam0 /*6*/], 2);
				gameplay::clear_bit(&Global_101700.f_17533[*uParam0 /*6*/], 3);
...
int func_5(var *uParam0) {
	...
	if (!func_191()) {
		while (!func_186(*uParam0)) {
			...
			if (!func_133(uParam0, *uParam0 != 2)) {
				func_338("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() "
						 "[TERMINATING]");
				return 0;
			}
			system::wait(0);
	...
	if (!func_99(uParam0)) {
		func_338("STEP_7_COMMON_LaunchMission - Trying to launch a null script "
				 "string name");
		return 0;
	}
...
void func_9(int iParam0) {
	...
	case 8: func_10(749); return;

	case 12: func_10(750); return;
	...
	case 20: func_10(762); return;

	case 21: func_10(763); return;
...
// Position - 0x2ED2
bool func_39(int iParam0) { return iParam0 < 3; }
...
// Position - 0x33C5
bool func_44(int iParam0, var *uParam1, int iParam2, int iParam3) {
	char *sVar0;
...
// Position - 0x38ED
void func_54(int iParam0, int iParam1, int *iParam2, int *iParam3, int iParam4, int iParam5) {
	int iVar0;
...
// Position - 0x3E35
void func_55(int iParam0, int iParam1, int *iParam2, int *iParam3, var *uParam4, int iParam5, int iParam6) {
	int iVar0;
...
void func_60(int iParam0, var *uParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		while (iVar0 <= 44 - 1) {
			iVar3 = func_64(iVar0);
			if (iVar3 != 0) {
				vVar4.x = weapon::get_ped_weapontype_in_slot(iParam0, func_64(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		iVar7 = 0;
		while (iVar7 < iVar8) {
			if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_61(Var9.f_1) && iVar70 < 50) {
...
// Position - 0x59D7
bool func_68(int iParam0, var *uParam1, float *fParam2) {
	*uParam1 = {0f, 0f, 0f};
	*fParam2 = 0f;
	switch (iParam0) {
	case 0:
...
// Position - 0x6066
bool func_69(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
bool func_70(int *iParam0) {
	if (!entity::is_entity_dead(player::player_ped_id(), 0) && !ped::is_ped_injured(player::player_ped_id())) {
		if (func_81()) {
			*iParam0 = func_76(entity::get_entity_coords(player::player_ped_id(), 0), 6, -1, 0, 1, -1);
...
// Position - 0x6108
int func_71(int iParam0) { return func_72(iParam0, 0, 1); }
...
// Position - 0x644A
int func_75(int iParam0) { return func_72(iParam0, 5, 1); }

// Position - 0x645A
int func_76(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
...
Vector3 func_77(int iParam0, int iParam1) {
	...
	case 45: return func_78(Global_93004);
	}
...
// Position - 0x6B2C
int func_79(int iParam0) { return func_72(iParam0, 0, 0); }
...
// Position - 0x6DAF
bool func_81() { return Global_91543.f_303 > 0; }

// Position - 0x6DC0
var func_82() {
	int *iVar0;

	func_92(&iVar0, time::get_clock_seconds());
	func_91(&iVar0, time::get_clock_minutes());
	func_90(&iVar0, time::get_clock_hours());
	func_85(&iVar0, time::get_clock_day_of_month());
	func_84(&iVar0, time::get_clock_month());
	func_83(&iVar0, time::get_clock_year());
	return iVar0;
}
...
var func_87(int iParam0) {
	return (system::shift_right(iParam0, 26) & 31) * func_88(gameplay::is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
// Position - 0x6FEE
int func_89(int iParam0) { return iParam0 & 15; }
...
void func_94(char *sParam0, int iParam1, int iParam2) {
	...
	stats::playstats_mission_started(sParam0, iParam1, iParam2, func_200(0));
}
...
void func_96(int iParam0, var* uParam1)
{
	switch (iParam0) {
	case 0:
		func_97(uParam1, "Abigail1", func_12(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				"ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_98(iParam0), 1, 0);
		break;

	case 1:
		func_97(uParam1, "Abigail2", func_12(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				-1, 4, 1, 0, 2359, func_98(iParam0), 1, 0);
		break;

	case 2:
		func_97(uParam1, "Barry1", func_12(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				4, 1, 0, 2359, func_98(iParam0), 1, 0);
		break;

	case 3:
		func_97(uParam1, "Barry2", func_12(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				4, 4, 0, 2359, func_98(iParam0), 1, 1);
		break;

	case 4:
		func_97(uParam1, "Barry3", func_12(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2, 0,
				2359, func_98(iParam0), 0, 0);
		break;

	case 5:
		func_97(uParam1, "Barry3A", func_12(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0, "",
				166, 0, 7, 4, 2, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 6:
		func_97(uParam1, "Barry3C", func_12(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				7, 4, 2, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 7:
		func_97(uParam1, "Barry4", func_12(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4",
				0, 0, -1, 4, 2, 800, 2000, func_98(iParam0), 0, 0);
		break;

	case 8:
		func_97(uParam1, "Dreyfuss1", func_12(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				0, "", 0, 0, -1, 4, 2, 0, 2359, func_98(iParam0), 0, 0);
		break;

	case 9:
		func_97(uParam1, "Epsilon1", func_12(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1, 10,
				4, 1, 0, 2359, func_98(iParam0), 0, 0);
		break;

	case 10:
		func_97(uParam1, "Epsilon2", func_12(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0, 11,
				4, 1, 0, 2359, func_98(iParam0), 1, 0);
		break;

	case 11:
		func_97(uParam1, "Epsilon3", func_12(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				0, 0, 12, 4, 1, 0, 2359, func_98(iParam0), 0, 0);
		break;

	case 12:
		func_97(uParam1, "Epsilon4", func_12(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				"postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_98(iParam0), 0, 0);
		break;

	case 13:
		func_97(uParam1, "Epsilon5", func_12(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16, "epsRobes",
				0, 0, 14, 4, 1, 0, 2359, func_98(iParam0), 1, 0);
		break;

	case 14:
		func_97(uParam1, "Epsilon6", func_12(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				15, 4, 1, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 15:
		func_97(uParam1, "Epsilon7", func_12(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16, "epsDesert",
				0, 0, 16, 4, 1, 0, 2359, func_98(iParam0), 0, 0);
		break;

	case 16:
		func_97(uParam1, "Epsilon8", func_12(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				"epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_98(iParam0), 1, 0);
		break;

	case 17:
		func_97(uParam1, "Extreme1", func_12(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1, 18,
				4, 2, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 18:
		func_97(uParam1, "Extreme2", func_12(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171, 0,
				19, 4, 2, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 19:
		func_97(uParam1, "Extreme3", func_12(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				4, 2, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 20:
		func_97(uParam1, "Extreme4", func_12(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				-1, 4, 2, 0, 2359, func_98(iParam0), 0, 0);
		break;

	case 21:
		func_97(uParam1, "Fanatic1", func_12(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1,
				-1, 4, 1, 700, 2000, func_98(iParam0), 1, 0);
		break;

	case 22:
		func_97(uParam1, "Fanatic2", func_12(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				-1, 4, 4, 700, 2000, func_98(iParam0), 1, 0);
		break;

	case 23:
		func_97(uParam1, "Fanatic3", func_12(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1, 4,
				2, 700, 2000, func_98(iParam0), 0, 1);
		break;

	case 24:
		func_97(uParam1, "Hao1", func_12(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				"controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_98(iParam0), 0, 1);
		break;

	case 25:
		func_97(uParam1, "Hunting1", func_12(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				26, 4, 4, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 26:
		func_97(uParam1, "Hunting2", func_12(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				-1, 4, 4, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 27:
		func_97(uParam1, "Josh1", func_12(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				0, 1, 28, 4, 4, 0, 2359, func_98(iParam0), 1, 0);
		break;

	case 28:
		func_97(uParam1, "Josh2", func_12(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0, 29,
				4, 4, 0, 2359, func_98(iParam0), 1, 1);
		break;

	case 29:
		func_97(uParam1, "Josh3", func_12(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0, 30,
				4, 4, 0, 2359, func_98(iParam0), 1, 1);
		break;

	case 30:
		func_97(uParam1, "Josh4", func_12(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				4, 4, 0, 2359, func_98(iParam0), 1, 0);
		break;

	case 31:
		func_97(uParam1, "Maude1", func_12(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0, "BailBond_Launcher",
				0, 1, -1, 4, 4, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 32:
		func_97(uParam1, "Minute1", func_12(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				4, 4, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 33:
		func_97(uParam1, "Minute2", func_12(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				0, 2359, func_98(iParam0), 0, 1);
		break;

	case 34:
		func_97(uParam1, "Minute3", func_12(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				-1, 4, 4, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 35:
		func_97(uParam1, "MrsPhilips1", func_12(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				"ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_98(iParam0), 0, 0);
		break;

	case 36:
		func_97(uParam1, "MrsPhilips2", func_12(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				2359, func_98(iParam0), 0, 0);
		break;

	case 37:
		func_97(uParam1, "Nigel1", func_12(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				-1, 1, 4, 0, 2359, func_98(iParam0), 1, 0);
		break;

	case 38:
		func_97(uParam1, "Nigel1A", func_12(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0, "",
				0, 0, 42, 4, 4, 0, 2359, func_98(iParam0), 1, 1);
		break;

	case 39:
		func_97(uParam1, "Nigel1B", func_12(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				42, 4, 4, 700, 2000, func_98(iParam0), 1, 1);
		break;

	case 40:
		func_97(uParam1, "Nigel1C", func_12(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				42, 4, 4, 700, 2000, func_98(iParam0), 1, 1);
		break;

	case 41:
		func_97(uParam1, "Nigel1D", func_12(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				42, 4, 4, 700, 2000, func_98(iParam0), 1, 1);
		break;

	case 42:
		func_97(uParam1, "Nigel2", func_12(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0, 43,
				4, 4, 0, 2359, func_98(iParam0), 1, 1);
		break;

	case 43:
		func_97(uParam1, "Nigel3", func_12(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				"postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_98(iParam0), 1, 1);
		break;

	case 44:
		func_97(uParam1, "Omega1", func_12(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				"spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_98(iParam0), 0, 0);
		break;

	case 45:
		func_97(uParam1, "Omega2", func_12(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				-1, 4, 2, 0, 2359, func_98(iParam0), 0, 0);
		break;

	case 46:
		func_97(uParam1, "Paparazzo1", func_12(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				47, 4, 2, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 47:
		func_97(uParam1, "Paparazzo2", func_12(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0, 0,
				48, 4, 2, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 48:
		func_97(uParam1, "Paparazzo3", func_12(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				1, -1, 2, 2, 0, 2359, func_98(iParam0), 0, 0);
		break;

	case 49:
		func_97(uParam1, "Paparazzo3A", func_12(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102, 0,
				"", 0, 0, 51, 4, 2, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 50:
		func_97(uParam1, "Paparazzo3B", func_12(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "", 0,
				0, 51, 4, 2, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 51:
		func_97(uParam1, "Paparazzo4", func_12(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				-1, 4, 2, 0, 2359, func_98(iParam0), 0, 0);
		break;

	case 52:
		func_97(uParam1, "Rampage1", func_12(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				4, 0, 2359, func_98(iParam0), 0, 0);
		break;

	case 54:
		func_97(uParam1, "Rampage3", func_12(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				4, 4, 0, 2359, func_98(iParam0), 1, 0);
		break;

	case 55:
		func_97(uParam1, "Rampage4", func_12(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				4, 0, 2359, func_98(iParam0), 1, 0);
		break;

	case 56:
		func_97(uParam1, "Rampage5", func_12(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				53, 4, 4, 0, 2359, func_98(iParam0), 0, 0);
		break;

	case 53:
		func_97(uParam1, "Rampage2", func_12(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				"rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_98(iParam0), 1, 0);
		break;

	case 57:
		func_97(uParam1, "TheLastOne", func_12(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0,
				1, -1, 4, 2, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 58:
		func_97(uParam1, "Tonya1", func_12(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				"ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 59:
		func_97(uParam1, "Tonya2", func_12(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				"ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_98(iParam0), 0, 1);
		break;

	case 60:
		func_97(uParam1, "Tonya3", func_12(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0, 2359,
				func_98(iParam0), 0, 1);
		break;

	case 61:
		func_97(uParam1, "Tonya4", func_12(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				func_98(iParam0), 0, 1);
		break;

	case 62:
		func_97(uParam1, "Tonya5", func_12(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
...
int func_99(int iParam0) {
	...
	if (func_129(&uParam0->f_1)) {
		...
		if (cutscene::has_cutscene_loaded()) {
			...
			func_338("Initial cutscene wasn't loaded in time to pass to RC "
					 "mission.");
...
// Position - 0x8E5E
void func_106(int iParam0, int iParam1, int iParam2) { func_107(iParam0, iParam1, iParam2, 0, 0); }
...
void func_120(int iParam0, int iParam1, int iParam2, int iParam3) {
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_124(player::player_id()) &&
				!func_122(player::player_id(), 0) && !func_121()) {
				entity::set_entity_invincible(player::player_ped_id(), 0);
			}
		}
		else if (!ped::is_ped_injured(player::player_ped_id()) && !func_124(player::player_id())) {
			entity::set_entity_invincible(player::player_ped_id(), 0);
		}
...
// Position - 0x93E3
bool func_121() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x94CE
bool func_125() { return gameplay::is_bit_set(Global_2359301, 3); }

// Position - 0x94DF
int func_126(int iParam0, int iParam1, var uParam2, int iParam3) {
	int iVar0;
...
int func_133(var *uParam0, int iParam1) {
	...
	if (Global_69702) {
		func_338("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer "
				 "[TERMINATING]");
		return 0;
	}
	func_96(*uParam0, &Var0);
	...
	if (func_165(*uParam0)) {
		...
		func_338("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1) {
	...
	if (*uParam0 == 10) {
		if (fire::is_explosion_in_sphere(-1, uParam0->f_17[0 /*3*/], 8f)) {
			func_338("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission "
					 "trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17) {
		if (!gameplay::is_bit_set(Var0.f_26, func_210())) {
			func_338("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player "
					 "character to launch mission");
			return 0;
		}
	}
	if (func_137(&uParam0->f_48) && iParam1) {
...
void func_134(int iParam0, var *uParam1, int iParam2) {
	...
	if (func_113(iParam0)) {
		...
		case 2:
			if (!func_136(uParam1) || !entity::is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3)) {
				if (func_135(iParam2) && !ped::is_ped_facing_ped(iParam0, player::player_ped_id(), 25f)) {
					ai::task_turn_ped_to_face_entity(iParam0, player::player_ped_id(), 0);
					uParam1->f_3 = 5;
				}
				else if (func_136(uParam1) && uParam1->f_4 == 0 &&
		...
		case 5:
			if (!func_135(iParam2) || ped::is_ped_facing_ped(iParam0, player::player_ped_id(), 10f)) {
				if (func_69(uParam1->f_5, 0f, 0f, 0f, 0)) {
					ai::task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
				}
				else {
	...
	if (func_113(player::player_ped_id())) {
		...
		while (iVar0 <= uParam0->f_28 - 1) {
			if (func_112(uParam0->f_28[iVar0])) {
				...
				switch (*uParam0) {
				case 19: func_164(uParam0->f_28[iVar0]); break;
		...
		while (iVar0 <= iVar1) {
			if (entity::does_entity_exist(uParam0->f_35[iVar0])) {
				if (entity::is_entity_dead(uParam0->f_35[iVar0], 0)) {
					func_338("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (iParam2) {
					if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
						...
						if (*uParam0 == 16) {
							if (func_142(player::player_ped_id(), uParam0->f_35[iVar0])) {
								func_338("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (!ped::is_ped_injured(uParam0->f_28[iVar0])) {
					if (ped::is_ped_sitting_in_any_vehicle(player::player_ped_id())) {
						if (entity::is_entity_touching_entity(player::player_ped_id(), uParam0->f_28[iVar0])) {
							...
							func_338("STEP_5_COMMON_RCfineAndInRange - Random "
					...
					if (func_163(*uParam0)) {
						...
						if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(uParam0->f_28[iVar0], 1), 15f)) {
							...
							func_338("STEP_5_COMMON_RCfineAndInRange - There "
					...
					if (!func_145(*uParam0)) {
						...
						if (player::get_player_wanted_level(player::player_id()) > 0) {
							...
							func_338("STEP_5_COMMON_RCfineAndInRange - Player "
...
// Position - 0xA577
bool func_147(int iParam0, float fParam1) { return func_148(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_148(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_149(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0xA650
int func_149(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
	...
	if (*iParam0 == 0) {
		vVar1 = {func_150(iParam4, iParam7)};
		*iParam0 =
...
bool func_158(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_113(player::player_ped_id()) && func_113(iParam0)) {
		...
		if (!iParam2) {
			if (func_162(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_159(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
// Position - 0xAAF9
bool func_159(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
bool func_160(int iParam0, float fParam1) {
	...
	if (gameplay::_0x82FDE6A57EE4EE44(iParam0, joaat("weapon_grenade"), fParam1, &vVar1, &uVar0, 0) ||
		...
		if (func_161(iParam0, vVar1, 90f, 0)) {
			return true;
		}
	}
	return false;
...
// Position - 0xAC9A
bool func_161(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
// Position - 0xAD28
bool func_162(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
// Position - 0xB163
int func_171() { return func_172(script::get_this_script_name(), 0); }
...
void func_177() {
	if (player::is_player_playing(player::player_id())) {
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			if (func_178(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), 10.5f, 1, 1056964608, 0, 1, 0)) {
...
int func_192(int iParam0) {
	...
	if (Global_69702) {
		func_338("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is "
				 "running [TERMINATING]");
		return 0;
	}
	if (!Global_101700.f_8044 && !func_200(1)) {
		func_338("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not "
				 "active");
		return 0;
	}
	if (!func_193(iParam0)) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_338("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (Global_91491.f_11 == 6) {
		if (Global_91491 < 9) {
			...
			if (gameplay::are_strings_equal(&Global_91491.f_3, sVar0)) {
				func_338("STEP_3_COMMON_CanRCLaunch - Script denied as a "
	...
	if (script::_get_number_of_instances_of_script_with_name_hash(joaat("candidate_controller")) == 0) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_338("STEP_3_COMMON_CanRCLaunch - Script denied as "
...
char *func_201(int iParam0) {
	switch (iParam0) {
	case 0: return "Rampage1";

	case 1: return "Rampage3";

	case 2: return "Rampage4";

	case 3: return "Rampage5";

	case 4: return "Rampage2";
...
int func_203() {
	...
	if (player::is_player_wanted_level_greater(player::player_id(), 0)) {
	...
	else if (func_206(0) || streaming::is_player_switch_in_progress() || func_205()) {
		if (func_2("RAMP_HELP_TRIG")) {
			if (func_206(0)) {
			}
		...
		iVar0 = !controls::is_control_pressed(2, 51);
	}
	return iVar0;
}
...
int func_209(float fParam0) {
	...
	iVar0 = 0;
	while (iVar0 < 5) {
		vVar1 = {Global_25501[iLocal_288 + iVar0 /*23*/][0 /*3*/]};
		if (gameplay::get_distance_between_coords(vVar4, vVar1, 1) <= fParam0 &&
			gameplay::absf(vVar4.z - vVar1.z) < 1.5f) {
			return iVar0;
		}
		iVar0++;
	}
...
void func_211(var *uParam0, vector3 vParam1) {
	...
	iVar1[3] = 55;
	iVar1[4] = 56;
	if (!func_319(&iVar1, uParam0, vParam1, 5f)) {
	...
	while (true) {
		...
		if (*uParam0 == 52 || *uParam0 == 53) {
			if (func_113(uParam0->f_28[0])) {
				if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(uParam0->f_28[0], 1), 5.1f)) {
					if (*uParam0 == 52) {
						...
						while (iVar7 < uParam0->f_41) {
							if (entity::does_entity_exist(uParam0->f_41[iVar7])) {
								if (func_113(uParam0->f_28[0]) &&
										entity::is_entity_attached_to_entity(uParam0->f_41[iVar7], uParam0->f_28[0]) ||
									func_113(uParam0->f_28[1]) &&
										entity::is_entity_attached_to_entity(uParam0->f_41[iVar7], uParam0->f_28[1])) {
					...
					func_338("Sitting Rampage attacked with explosives, "
							 "cleaning up");
					func_323(uParam0, 1);
				}
			}
		...
		func_249(*uParam0);
		func_241(&iLocal_289, &uParam0->f_9, vParam1);
		...
		vLocal_298 = {entity::get_entity_coords(player::player_ped_id(), 1)};
		if (!(*uParam0 == 52 && vLocal_298.z > 34f) && !(*uParam0 == 53 && vLocal_298.z > 71f) &&
			!(*uParam0 == 54 && vLocal_298.z > 30f)) {
...
void func_212(var *uParam0) {
	...
	case 1:
		if (func_113(uParam0->f_28[0])) {
			if (func_223(uParam0->f_28[0], player::player_ped_id(), 1) < 30f &&
				entity::is_entity_on_screen(uParam0->f_28[0])) {
	...
	case 2:
		uLocal_117[0] = ped::create_synchronized_scene(vLocal_108, vLocal_111, 2);
		if (func_113(uParam0->f_28[0])) {
			func_213(&uLocal_121, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_1", 7, 0, 0);
			ai::task_synchronized_scene(uParam0->f_28[0], uLocal_117[0], sVar0, "hipster_post_post_irony", 8f, -8f, 513,
										0, 1148846080, 0);
		}
		ped::set_synchronized_scene_looped(uLocal_117[0], 0);
		ped::_set_synchronized_scene_occlusion_portal(uLocal_117[0], 1);
		iLocal_116++;
		break;

	case 3:
		if (ped::is_synchronized_scene_running(uLocal_117[0])) {
			if (ped::get_synchronized_scene_phase(uLocal_117[0]) >= 0.95f) {
				iLocal_116++;
			}
		}
		break;
	...
	case 4:
		uLocal_117[1] = ped::create_synchronized_scene(vLocal_108, vLocal_111, 2);
		if (func_113(uParam0->f_28[0])) {
			func_213(&uLocal_121, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_2", 7, 0, 0);
			ai::task_synchronized_scene(uParam0->f_28[0], uLocal_117[1], sVar0, "hipster_self_hating_hipster", 8f, -8f,
										513, 0, 1148846080, 0);
		}
		ped::set_synchronized_scene_looped(uLocal_117[1], 0);
		ped::_set_synchronized_scene_occlusion_portal(uLocal_117[1], 1);
		iLocal_116++;
		break;

	case 5:
		if (ped::is_synchronized_scene_running(uLocal_117[1])) {
			if (ped::get_synchronized_scene_phase(uLocal_117[1]) >= 0.95f) {
				iLocal_116++;
			}
		}
		break;
	...
	case 6:
		uLocal_117[2] = ped::create_synchronized_scene(vLocal_108, vLocal_111, 2);
		if (func_113(uParam0->f_28[0])) {
			ai::task_synchronized_scene(uParam0->f_28[0], uLocal_117[2], sVar0, "hipster_idle", 8f, -8f, 513, 0,
										1148846080, 0);
		}
		ped::set_synchronized_scene_looped(uLocal_117[2], 1);
		ped::_set_synchronized_scene_occlusion_portal(uLocal_117[2], 0);
		iLocal_116++;
		break;
...
bool func_224(var *uParam0) {
	...
	if (iLocal_115 < 0) {
		if (system::vdist2(entity::get_entity_coords(player::player_ped_id(), 1),
						   entity::get_entity_coords(uParam0->f_28[1], 1)) < 25f) {
			return true;
		}
		switch (*uParam0) {
		case 52:
		...
		if (func_113(uParam0->f_28[0])) {
			if (!func_132()) {
				if (func_213(&uLocal_121, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_3", 8, 0, 0)) {
					iLocal_287 = ped::create_synchronized_scene(vLocal_108, vLocal_111, 2);
					ai::task_synchronized_scene(uParam0->f_28[0], iLocal_287, "misstrvram_2",
												"hipster_cunts_in_america", 8f, -8f, 513, 0, 1148846080, 0);
...
bool func_228(var *uParam0, int iParam1) {
					...
					if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
						...
						if (func_233(2)) {
							if (func_232(uParam0->f_27)) {
								...
								func_338("ARE_RC_TRIGGER_CONDITIONS_MET: "
	...
	case 5:
		if (*uParam0 == 6) {
			if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
				if (func_113(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0))) {
			...
			if (ai::get_ped_desired_move_blend_ratio(player::player_ped_id()) >= 2f) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 245.8885f, 371.9034f, 103.9884f,
					...
					if (func_233(2)) {
						if (func_232(uParam0->f_27)) {
							func_231(uParam0->f_27, *uParam0);
							func_338("RC5_IN_ACTIVATION_RANGE: "
			...
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 2728.948f, 4143.44f, 42.29295f, 2722.213f,
				...
				if (func_233(2)) {
					if (func_232(1)) {
						func_231(1, *uParam0);
						func_338("RC_IN_ACTIVATION_RANGE: "
...
// Position - 0xD8C4
void func_229() { func_30(&Global_93635.f_2311, &Global_93635, 0, 1, 1, 0); }
	...
	if (iParam0 == 1) {
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			...
			if (ped::is_ped_in_any_heli(player::player_ped_id()) || ped::is_ped_in_any_plane(player::player_ped_id())) {
				func_338("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for "
						 "plane or helicopter.");
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_205() || Global_100747 ||
						Global_25192 || func_239() || func_220(8, -1) || func_81() || func_238() || func_237() ||
						func_236() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;

				case 1:
					if (player::is_player_being_arrested(player::player_id(), 1) || func_205() || Global_25192 ||
						func_239() || func_220(8, -1) || func_237() || func_81() || func_238() || func_236() ||
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						player::is_player_climbing(player::player_id()) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_205() || Global_100747 ||
						Global_25192 || func_239() || func_220(8, -1) || func_237() || func_81() || func_238() ||
						func_236() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5 || LastDispatchedMessageOrCall != -1) {
						return false;
					}
					break;
				...
				case 3:
					if (ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_205() || Global_100747 ||
						Global_25192 || func_239() || func_220(8, -1) || func_81() || func_238() || func_236() ||
						G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 4:
					if (func_205() || player::get_player_wanted_level(player::player_id()) > 0 || func_220(8, -1) ||
						func_236() || func_235() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 6:
					if (entity::does_entity_exist(player::player_ped_id())) {
						if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
							...
							player::is_player_being_arrested(player::player_id(), 1) ||
							player::is_player_climbing(player::player_id()) || func_205() || Global_25192 ||
							func_239() || func_220(8, -1) || func_238() || func_237() || func_236() ||
							G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
							return false;
						}
					}
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						entity::is_entity_in_air(player::player_ped_id()) ||
						ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) || func_205() || func_238() ||
						Global_100747 || Global_25192 || func_239() || Global_36912 || func_220(8, -1) || func_237() ||
						func_235() || func_236() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 8:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						player::is_player_being_arrested(player::player_id(), 1) ||
						player::is_player_climbing(player::player_id()) || func_205() || Global_100747 ||
						Global_25192 || func_239() || func_220(8, -1) || func_237() || func_235() || func_81() ||
						func_238() || func_236()) {
						return false;
					}
					break;
...
// Position - 0xE185
var func_234() { return Global_91530.f_1; }
...
// Position - 0xE1FD
bool func_238() { return Global_91543.f_304 > 0; }

// Position - 0xE20E
var func_239() { return Global_1315233; }
...
// Position - 0xE40F
void func_241(int *iParam0, char *sParam1, vector3 vParam2) {
	if (player::is_player_playing(player::player_id())) {
		if (!gameplay::is_string_null_or_empty(sParam1)) {
			if (Global_35781 == 17) {
				...
				if (func_245(player::player_ped_id(), vParam2, 1) <= 100f) {
					func_244(iParam0, 1);
				}
			}
			else {
				...
				if (func_245(player::player_ped_id(), vParam2, 1) > 120f) {
					func_247(iParam0);
				}
			}
		}
...
// Position - 0xE64D
bool func_246() { return Global_89133; }
...
// Position - 0xE780
bool func_250(int iParam0) { return Global_100787[iParam0 /*10*/].f_1; }
...
void func_253(var *uParam0) {
	...
	case 54: func_306(uParam0); break;
	...
	case 56: func_254(uParam0); break;
...
void func_254(var *uParam0) {
	...
	while (!streaming::has_model_loaded(iVar1) || !streaming::has_model_loaded(iVar2) ||
	...
	if (!func_255(&uParam0->f_41[0], joaat("weapon_grenadelauncher"), -1297.84f, 2505.91f, 19.34f, func_298(-0.5f))) {
		...
		entity::set_entity_heading(uParam0->f_41[0], func_298(-0.5f));
...
// Position - 0xED68
bool func_255(int *iParam0, int iParam1, vector3 vParam2, float fParam5) {
	int iVar0;
	var *uVar1;
	int iVar7;
		...
		if (streaming::has_model_loaded(iVar0)) {
			*iParam0 = weapon::create_weapon_object(iParam1, -1, vParam2, 1, 1065353216, 0, 0, 1);
			...
			if (func_297(&uVar1, iParam1, joaat("gun_root"))) {
				if (weapon::has_weapon_got_weapon_component(*iParam0,
															func_256(&uVar1, iParam1, joaat("gun_root"), 0))) {
					weapon::remove_weapon_component_from_weapon_object(*iParam0,
																	   func_256(&uVar1, iParam1, joaat("gun_root"), 0));
				}
				else if (weapon::has_weapon_got_weapon_component(*iParam0,
																 func_256(&uVar1, iParam1, joaat("gun_root"), 1))) {
					weapon::remove_weapon_component_from_weapon_object(*iParam0,
																	   func_256(&uVar1, iParam1, joaat("gun_root"), 1));
				}
			}
...
// Position - 0xEEBF
bool func_257(var *uParam0, int iParam1, int iParam2, int iParam3) {
	int iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
	...
	case joaat("weapon_pistol"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_pistol_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_pistol_clip_02"), joaat("WAPClip"), 2, 0); break;

		case 2: func_296(uParam0, joaat("component_at_pi_flsh"), joaat("WAPFlshLasr"), 1, 0); break;

		case 3: func_296(uParam0, joaat("component_at_pi_supp_02"), joaat("WAPSupp"), 1, 0); break;

		case 4: func_296(uParam0, joaat("component_pistol_varmod_luxe"), joaat("gun_root"), 1, 0); break;
		}
		break;

	case joaat("weapon_combatpistol"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_combatpistol_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_combatpistol_clip_02"), joaat("WAPClip"), 2, 0); break;

		case 2: func_296(uParam0, joaat("component_at_pi_flsh"), joaat("WAPFlshLasr"), 1, 0); break;

		case 3: func_296(uParam0, joaat("component_at_pi_supp"), joaat("WAPSupp"), 1, 0); break;

		case 4: func_296(uParam0, joaat("component_combatpistol_varmod_lowrider"), joaat("gun_root"), 1, 0); break;
		}
		break;

	case joaat("weapon_appistol"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_appistol_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_appistol_clip_02"), joaat("WAPClip"), 2, 0); break;

		case 2: func_296(uParam0, joaat("component_at_pi_flsh"), joaat("WAPFlshLasr"), 1, 0); break;

		case 3: func_296(uParam0, joaat("component_at_pi_supp"), joaat("WAPSupp"), 1, 0); break;

		case 4: func_296(uParam0, joaat("component_appistol_varmod_luxe"), joaat("gun_root"), 1, 0); break;
		}
		break;

	case joaat("weapon_microsmg"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_microsmg_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_microsmg_clip_02"), joaat("WAPClip"), 2, 0); break;

		case 2: func_296(uParam0, joaat("component_at_pi_flsh"), joaat("WAPFlshLasr"), 1, 0); break;

		case 3: func_296(uParam0, joaat("component_at_scope_macro"), joaat("WAPScop"), 1, 0); break;

		case 4: func_296(uParam0, joaat("component_at_ar_supp_02"), joaat("WAPSupp"), 1, 0); break;

		case 5: func_296(uParam0, joaat("component_microsmg_varmod_luxe"), joaat("gun_root"), 1, 0); break;
		}
		break;

	case joaat("weapon_smg"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_smg_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_smg_clip_02"), joaat("WAPClip"), 2, 0); break;

		case 2: func_296(uParam0, joaat("component_smg_clip_03"), joaat("WAPClip"), 3, 0); break;

		case 3: func_296(uParam0, joaat("component_at_ar_flsh"), joaat("WAPFlshLasr"), 1, 0); break;

		case 4: func_296(uParam0, joaat("component_at_scope_macro_02"), joaat("WAPScop"), 1, 0); break;

		case 5: func_296(uParam0, joaat("component_at_pi_supp"), joaat("WAPSupp"), 1, 0); break;

		case 6: func_296(uParam0, joaat("component_smg_varmod_luxe"), joaat("gun_root"), 1, 0); break;
		}
		break;

	case joaat("weapon_assaultrifle"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_assaultrifle_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_assaultrifle_clip_02"), joaat("WAPClip"), 2, 0); break;

		case 2: func_296(uParam0, joaat("component_assaultrifle_clip_03"), joaat("WAPClip"), 3, 0); break;

		case 3: func_296(uParam0, joaat("component_at_ar_afgrip"), joaat("WAPGrip"), 1, 0); break;

		case 4: func_296(uParam0, joaat("component_at_ar_flsh"), joaat("WAPFlshLasr"), 1, 0); break;

		case 5: func_296(uParam0, joaat("component_at_scope_macro"), joaat("WAPScop"), 1, 0); break;

		case 6: func_296(uParam0, joaat("component_at_ar_supp_02"), joaat("WAPSupp"), 1, 0); break;

		case 7: func_296(uParam0, joaat("component_assaultrifle_varmod_luxe"), joaat("gun_root"), 1, 0); break;
		}
		break;

	case joaat("weapon_carbinerifle"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_carbinerifle_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_carbinerifle_clip_02"), joaat("WAPClip"), 2, 0); break;

		case 2: func_296(uParam0, joaat("component_carbinerifle_clip_03"), joaat("WAPClip"), 3, 0); break;

		case 3: func_296(uParam0, joaat("component_at_railcover_01"), joaat("WAPRail"), 1, 0); break;

		case 4: func_296(uParam0, joaat("component_at_ar_afgrip"), joaat("WAPGrip"), 1, 0); break;

		case 5: func_296(uParam0, joaat("component_at_ar_flsh"), joaat("WAPFlshLasr"), 1, 0); break;

		case 6: func_296(uParam0, joaat("component_at_scope_medium"), joaat("WAPScop"), 1, 0); break;

		case 7: func_296(uParam0, joaat("component_at_ar_supp"), joaat("WAPSupp"), 1, 0); break;

		case 8: func_296(uParam0, joaat("component_carbinerifle_varmod_luxe"), joaat("gun_root"), 1, 0); break;
		}
		break;

	case joaat("weapon_advancedrifle"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_advancedrifle_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_advancedrifle_clip_02"), joaat("WAPClip"), 2, 0); break;

		case 2: func_296(uParam0, joaat("component_at_ar_flsh"), joaat("WAPFlshLasr"), 1, 0); break;

		case 3: func_296(uParam0, joaat("component_at_scope_small"), joaat("WAPScop"), 1, 0); break;

		case 4: func_296(uParam0, joaat("component_at_ar_supp"), joaat("WAPSupp"), 1, 0); break;

		case 5: func_296(uParam0, joaat("component_advancedrifle_varmod_luxe"), joaat("gun_root"), 1, 0); break;
		}
		break;

	case joaat("weapon_mg"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_mg_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_mg_clip_02"), joaat("WAPClip"), 2, 0); break;

		case 2: func_296(uParam0, joaat("component_at_scope_small_02"), joaat("WAPScop"), 1, 0); break;

		case 3: func_296(uParam0, joaat("component_mg_varmod_lowrider"), joaat("gun_root"), 1, 0); break;
		}
		break;

	case joaat("weapon_combatmg"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_combatmg_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_combatmg_clip_02"), joaat("WAPClip"), 2, 0); break;

		case 2: func_296(uParam0, joaat("component_at_ar_afgrip"), joaat("WAPGrip"), 1, 0); break;

		case 3: func_296(uParam0, joaat("component_at_scope_medium"), joaat("WAPScop"), 1, 0); break;

		case 4: func_296(uParam0, joaat("component_combatmg_varmod_lowrider"), joaat("gun_root"), 1, 0); break;
		}
		break;

	case joaat("weapon_pumpshotgun"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_at_ar_flsh"), joaat("WAPFlshLasr"), 1, 0); break;

		case 1: func_296(uParam0, joaat("component_at_sr_supp"), joaat("WAPSupp"), 1, 0); break;

		case 2: func_296(uParam0, joaat("component_pumpshotgun_varmod_lowrider"), joaat("gun_root"), 1, 0); break;
		}
		break;

	case joaat("weapon_assaultshotgun"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_assaultshotgun_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_assaultshotgun_clip_02"), joaat("WAPClip"), 2, 0); break;
	...
	case joaat("weapon_sniperrifle"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_sniperrifle_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_at_ar_supp_02"), joaat("WAPSupp"), 1, 0); break;

		case 2: func_296(uParam0, joaat("component_at_scope_large"), joaat("WAPScop"), 1, 1); break;

		case 3: func_296(uParam0, joaat("component_at_scope_max"), joaat("WAPScop"), 2, 0); break;

		case 4: func_296(uParam0, joaat("component_sniperrifle_varmod_luxe"), joaat("gun_root"), 1, 0); break;
		}
		break;

	case joaat("weapon_heavysniper"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_heavysniper_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_at_scope_large"), joaat("WAPScop"), 1, 1); break;

		case 2: func_296(uParam0, joaat("component_at_scope_max"), joaat("WAPScop"), 2, 0); break;
		}
		break;

	case joaat("weapon_grenadelauncher"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_at_ar_afgrip"), joaat("WAPGrip"), 1, 0); break;

		case 1: func_296(uParam0, joaat("component_at_ar_flsh"), joaat("WAPFlshLasr"), 1, 0); break;

		case 2: func_296(uParam0, joaat("component_at_scope_small"), joaat("WAPScop"), 1, 0); break;
		}
		break;

	case joaat("weapon_minigun"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_minigun_clip_01"), joaat("WAPClip"), 1, 1); break;
		}
		break;

	case joaat("weapon_assaultsmg"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_assaultsmg_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_assaultsmg_clip_02"), joaat("WAPClip"), 2, 0); break;
		...
		case 5: func_296(uParam0, joaat("component_assaultsmg_varmod_lowrider"), joaat("gun_root"), 1, 0); break;
		}
		break;
	...
	case joaat("weapon_bullpupshotgun"):
		...
		case 2: func_296(uParam0, joaat("component_at_ar_supp_02"), joaat("WAPSupp"), 1, 0); break;
		}
		break;

	case joaat("weapon_pistol50"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_pistol50_clip_01"), joaat("WAPClip"), 1, 1); break;

		case 1: func_296(uParam0, joaat("component_pistol50_clip_02"), joaat("WAPClip"), 2, 0); break;

		case 2: func_296(uParam0, joaat("component_at_pi_flsh"), joaat("WAPFlshLasr"), 1, 0); break;

		case 3: func_296(uParam0, joaat("component_at_ar_supp_02"), joaat("WAPSupp"), 1, 0); break;

		case 4: func_296(uParam0, joaat("component_pistol50_varmod_luxe"), joaat("gun_root"), 1, 0); break;
		}
		break;

	case joaat("weapon_sawnoffshotgun"):
		switch (iParam2) {
		case 0: func_296(uParam0, joaat("component_sawnoffshotgun_varmod_luxe"), joaat("gun_root"), 1, 0); break;
		}
		break;
			...
			while (iVar11 < dlc1::get_num_dlc_weapon_components(iVar10)) {
				if (dlc1::get_dlc_weapon_component_data(iVar10, iVar11, &Var51)) {
					...
					if (iVar11 == iParam2) {
						...
						func_296(uParam0, Var51.f_3, Var51, iVar0, Var51.f_1);
					}
				}
				iVar11++;
			}
...
int func_258(int iParam0, int iParam1) {
	...
	if (network::network_is_game_in_progress() && func_290()) {
		StringCopy(&Var144, func_288(iParam1, iParam0), 16);
		func_285(&sVar128, Var144, entity::get_entity_model(player::player_ped_id()), 3, 1, func_286(iParam0), -1, -1,
				 0);
...
int func_262() {
	...
	iVar0 += func_263(joaat("mpply_exploits"));
	iVar0 += func_263(joaat("mpply_vc_annoyingme"));
	iVar0 += func_263(joaat("mpply_vc_hate"));
	iVar0 += func_263(joaat("mpply_bad_crew_name"));
	iVar0 += func_263(joaat("mpply_bad_crew_motto"));
	iVar0 += func_263(joaat("mpply_bad_crew_status"));
	iVar0 += func_263(joaat("mpply_bad_crew_emblem"));
	iVar0 += func_263(joaat("mpply_playermade_title"));
	iVar0 += func_263(joaat("mpply_playermade_desc"));
	return iVar0;
}
...
// Position - 0x11CFD
bool func_265(struct<7> Param0, struct<7> Param7, int iParam14) {
	int iVar0;
	int iVar1;
...
// Position - 0x11E44
int func_267(int iParam0) { return system::shift_right(iParam0, 20) & 63; }

// Position - 0x11E57
int func_268(int iParam0) { return system::shift_right(iParam0, 14) & 63; }

// Position - 0x11E6A
int func_269(int iParam0) { return system::shift_right(iParam0, 9) & 31; }

// Position - 0x11E7D
int func_270(int iParam0) { return system::shift_right(iParam0, 4) & 31; }
...
var func_272(struct<7> Param0, int iParam7) {
	...
	if (func_275(Param0) == 0) {
		...
		iVar1 = uVar0;
		func_273(&iVar1, 0, 0, 0, iParam7, 0, 0);
		if (iParam7 == 0) {
			iVar1 = uVar0;
		}
		return iVar1;
...
// Position - 0x11FAB
void func_273(int *iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	int iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
	...
	iVar0 += iParam6;
	func_274(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
void func_274(int *iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	...
	func_84(iParam0, iParam5);
	func_85(iParam0, iParam4);
	func_83(iParam0, iParam6);
}
...
var func_276(struct<6> Param0, var uParam6) {
	...
	if (Param0 > 0) {
		func_83(&iVar0, Param0);
	}
	if (Param0.f_1 > 0) {
		func_84(&iVar0, func_277(Param0.f_1));
	}
	if (Param0.f_2 > 0) {
		func_85(&iVar0, Param0.f_2);
	}
	if (Param0.f_3 > 0) {
		func_90(&iVar0, Param0.f_3);
	}
	if (Param0.f_4 > 0) {
		func_91(&iVar0, Param0.f_4);
	}
	if (Param0.f_5 > 0) {
		func_92(&iVar0, Param0.f_5);
	}
	return iVar0;
}
...
// Position - 0x12338
var func_280(int iParam0) { return Global_1312373[iParam0]; }

// Position - 0x12348
var func_281() { return func_280(func_52() + 1); }
...
// Position - 0x126BA
int func_284(int iParam0, int iParam1) { return Global_101700.f_18106[iParam1 /*271*/].f_3[iParam0 /*12*/].f_3; }

// Position - 0x126D6
void func_285(char *sParam0, char[8] cParam1, char[4] cParam3, char[4] cParam4, int iParam5, int iParam6, int iParam7,
...
// Position - 0x12C0C
int func_286(int iParam0) { return func_287(iParam0); }
...
// Position - 0x13799
var func_289(var uParam0) { return uParam0; }
...
// Position - 0x13B61
float func_298(float fParam0) { return fParam0 * 57.29578f; }
...
// Position - 0x13B91
int func_300(int *iParam0, int iParam1, vector3 vParam2, float fParam5) {
	if (entity::does_entity_exist(*uParam0)) {
...
// Position - 0x13C09
int func_302(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	if (entity::does_entity_exist(*uParam0)) {
...
// Position - 0x13C87
Vector3 func_303(int iParam0, vector3 vParam1) {
	var uVar0;
...
// Position - 0x13CCC
var func_304() {
	return ped::add_scenario_blocking_area(-177.0628f, -1679.715f, 33.16263f, -157.0628f, -1659.715f, 37.16263f, 0, 1,
										   1, 1);
}
...
void func_306(var *uParam0) {
	...
	while (!streaming::has_model_loaded(iVar0) || !weapon::has_weapon_asset_loaded(joaat("weapon_microsmg")) ||
		   !streaming::has_anim_dict_loaded(sVar1)) {
		system::wait(0);
	}
...
// Position - 0x142D4
int func_307() { return func_308(1182.137f, -400.4787f, 66.92414f, 8f); }

// Position - 0x142F4
var func_308(vector3 vParam0, float fParam3) {
	vector3 vVar0;
...
void func_309(var *uParam0) {
	...
	func_313(&uLocal_114);
	while (!streaming::has_model_loaded(iVar0) || !streaming::has_model_loaded(iVar1) ||
		   !streaming::has_model_loaded(iVar2) || !streaming::has_anim_dict_loaded(sVar3) || !func_312(&uLocal_114)) {
		system::wait(0);
	}
	gameplay::clear_area_of_objects(1180.021f, -401.7374f, 66.8767f, 0.75f, 0);
	uParam0->f_41[2] =
		object::get_closest_object_of_type(1179.778f, -401.7374f, 66.8697f, 1f, joaat("prop_chair_01a"), 1, 0, 1);
	...
	entity::attach_entity_to_entity(uParam0->f_41[1], uParam0->f_28[0],
									ped::get_ped_bone_index(uParam0->f_28[0], iVar4), vVar8, vVar5, 1, 0, 0, 0, 2, 1);
	func_310(&uLocal_114, 0, 3);
	if (!ped::is_synchronized_scene_running(uParam0->f_59)) {
		uParam0->f_59 = ped::create_synchronized_scene(vLocal_108, vLocal_111, 2);
		if (func_113(uParam0->f_28[0])) {
			ai::task_synchronized_scene(uParam0->f_28[0], uParam0->f_59, sVar3, "hipster_idle", 8f, -8f, 513, 0,
										1148846080, 0);
		}
...
void func_310(var *uParam0, int iParam1, int iParam2) {
	...
	if (graphics::has_scaleform_movie_loaded(*uParam0)) {
		...
		graphics::draw_scaleform_movie(*uParam0, Global_14363, Global_14364, Global_14365, Global_14366, 255, 255, 255,
									   255, 0);
	}
}

// Position - 0x14670
void func_311(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_139(uParam0);
...
// Position - 0x146AE
void func_313(var *uParam0) { *uParam0 = unk_0x67D02A194A2FC2BD(func_314()); }

// Position - 0x146C1
char *func_314() { return "CELLPHONE_CUTSCENE"; }

// Position - 0x146CD
int func_315() { return func_308(911.5349f, 3642.111f, 31.64738f, 8f); }
...
void func_316(var *uParam0) {
	...
	streaming::request_anim_dict(sVar3);
	weapon::request_weapon_asset(joaat("weapon_assaultrifle"), 31, 0);
	while (!streaming::has_model_loaded(iVar11) || !streaming::has_model_loaded(iVar12) ||
		   !streaming::has_model_loaded(iVar13) || !streaming::has_anim_dict_loaded(sVar3) ||
	...
	if (func_113(uParam0->f_28[0])) {
		...
		ped::set_ped_name_debug(uParam0->f_28[0], "RAMP:PED 0");
		func_311(&uParam0->f_41[1], iVar13, vVar0, 0f);
		entity::attach_entity_to_entity(uParam0->f_41[1], uParam0->f_28[0],
										ped::get_ped_bone_index(uParam0->f_28[0], iVar4), vVar8, vVar5, 1, 1, 0, 0, 2,
										1);
	...
	if (func_113(uParam0->f_28[1])) {
		...
		ped::set_ped_name_debug(uParam0->f_28[1], "RAMP:PED 1");
		func_311(&uParam0->f_41[2], iVar13, vVar0, 0f);
		entity::attach_entity_to_entity(uParam0->f_41[2], uParam0->f_28[1],
										ped::get_ped_bone_index(uParam0->f_28[1], iVar4), vVar8, vVar5, 1, 1, 0, 0, 2,
										1);
	...
	if (!ped::is_synchronized_scene_running(uParam0->f_59)) {
		uParam0->f_59 = ped::create_synchronized_scene(910.13f, 3643.74f, 31.69f, 0f, 0f, func_298(-0.26f), 2);
		if (func_113(uParam0->f_28[0])) {
			ai::task_synchronized_scene(uParam0->f_28[0], uParam0->f_59, sVar3, "redneck_idle_a", 8f, -8f, 513, 0,
										1148846080, 0);
		}
		if (func_113(uParam0->f_28[1])) {
			ai::task_synchronized_scene(uParam0->f_28[1], uParam0->f_59, sVar3, "redneck_idle_b", 8f, -8f, 513, 0,
										1148846080, 0);
		}
		ped::set_synchronized_scene_looped(uParam0->f_59, 1);
	}
...
// Position - 0x14C93
int func_319(int iParam0, var *uParam1, vector3 vParam2, float fParam5) {
	int iVar0;

	if (*iParam0 == 1) {
		if (func_320((*iParam0)[0], vParam2, fParam5, uParam1)) {
			return 1;
		}
	}
	else {
		iVar0 = 0;
		while (iVar0 < *iParam0) {
			if (func_320((*iParam0)[iVar0], vParam2, fParam5, uParam1)) {
				iVar0 = *iParam0;
				return 1;
			}
			iVar0++;
	...
	func_338("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch "
			 "[TERMINATING]");
	return 0;
}

// Position - 0x14CF8
bool func_320(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	int iVar0;
	struct<7> Var1;

	iVar0 = 0;
	func_96(iParam0, &Var1);
	if (func_321(Var1.f_6, vParam1, fParam4, 0)) {
...
// Position - 0x14D76
bool func_321(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
// Position - 0x14FC1
void func_330(var *uParam0, bool bParam1) { func_331(&uParam0->f_35, bParam1); }
