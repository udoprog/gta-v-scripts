...
void __EntryFunction__() {
	...
	while (true) {
		...
		if (func_158()) {
			...
			if (iLocal_47 > 3) {
				if (fLocal_31 < 600f) {
					if (func_26(0) == 0 && gameplay::get_game_timer() - iLocal_81 > 2000) {
...
// Position - 0x2E9
void func_3() { func_4(&Global_93635.f_2311, &Global_93635, 0, 1, 1, 0); }
...
// Position - 0xD91
bool func_18(int iParam0, var *uParam1, int iParam2, int iParam3) {
	char *sVar0;
...
// Position - 0xF2E
bool func_20(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
void func_29(int *iParam0) {
	...
	case 3:
		if (streaming::has_model_loaded(joaat("dune"))) {
			gameplay::clear_area_of_vehicles(vLocal_55, 4f, 0, 0, 0, 0, 0);
			if (entity::does_entity_exist(iLocal_54)) {
				vehicle::delete_vehicle(&iLocal_54);
			}
			iLocal_54 = vehicle::create_vehicle(func_147(), vLocal_55, fLocal_58, 1, 1);
	...
	case 4:
		...
		if (!entity::is_entity_dead(iLocal_54, 0) && !entity::is_entity_dead(player::player_ped_id(), 0)) {
			if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
				...
				if (iVar2 == iLocal_54) {
					if (system::vdist2(vLocal_55, entity::get_entity_coords(iLocal_28, 1)) < 100f) {
						script::request_script("Traffick_Ground");
						if (entity::does_entity_exist(iLocal_29) && !entity::is_entity_dead(iLocal_29, 0)) {
							if (entity::get_entity_model(iLocal_29) != joaat("dune") &&
								entity::get_entity_model(iLocal_29) != joaat("cuban800")) {
	...
	case 6:
		if (script::has_script_loaded("Traffick_Ground")) {
			...
			if (iVar3 == 1) {
				...
				Var4.f_85 = 4;
				Var4.f_90 = 6;
				iLocal_30 = system::start_new_script_with_args("Traffick_Ground", &Var4, 97, 20500);
				func_79(16);
...
// Position - 0x18FC
int func_30(int iParam0) { return func_31(func_51(), iParam0); }
...
// Position - 0x1A1A
int func_32(int iParam0) { return system::shift_right(iParam0, 20) & 63; }

// Position - 0x1A2D
int func_33(int iParam0) { return system::shift_right(iParam0, 14) & 63; }

// Position - 0x1A40
int func_34(int iParam0) { return system::shift_right(iParam0, 9) & 31; }

// Position - 0x1A53
int func_35(int iParam0) { return system::shift_right(iParam0, 4) & 31; }

// Position - 0x1A65
int func_36(int iParam0) { return iParam0 & 15; }
...
// Position - 0x1C2C
void func_41(int *iParam0, int iParam1) { func_42(iParam0, iParam1); }

// Position - 0x1C3C
void func_42(int *iParam0, var uParam1) { *iParam0 -= (*iParam0 & uParam1); }
...
void func_44(int *iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	...
	func_47(iParam0, iParam5);
	func_46(iParam0, iParam4);
	func_45(iParam0, iParam6);
}
...
int func_51() {
	...
	func_46(&iVar0, time::get_clock_day_of_month());
	func_47(&iVar0, time::get_clock_month());
	func_45(&iVar0, time::get_clock_year());
	return iVar0;
}
...
// Position - 0x21B1
void func_61() { func_62(&Global_96040); }
...
// Position - 0x2851
void func_67(int *iParam0) { *iParam0 = -15; }
...
// Position - 0x29C2
void func_73(int iParam0, int iParam1, int iParam2) { func_74(iParam0, iParam1, iParam2, 0, 0); }
...
void func_83(var *uParam0, char *sParam1, int iParam2, char *sParam3, int iParam4, int iParam5) {
	...
	*uParam0 = func_21();
	...
	while (iVar1 < 3) {
		...
		if (iVar1 == func_92()) {
			func_85(player::player_ped_id(), &uParam0->f_616[iVar1 /*65*/], 1);
		}
		else {
			iVar0 = 0;
			while (iVar0 < 12) {
...
// Position - 0x496D
void func_90(int iParam0, int iParam1, int *iParam2, int *iParam3, int iParam4, int iParam5) {
	int iVar0;
...
// Position - 0x4EB5
void func_91(int iParam0, int iParam1, int *iParam2, int *iParam3, var *uParam4, int iParam5, int iParam6) {
	int iVar0;
...
void func_94(int iParam0, var *uParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		while (iVar0 <= 44 - 1) {
			iVar3 = func_98(iVar0);
			if (iVar3 != 0) {
				vVar4.x = weapon::get_ped_weapontype_in_slot(iParam0, func_98(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		iVar7 = 0;
		while (iVar7 < iVar8) {
			if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_95(Var9.f_1) && iVar70 < 50) {
...
// Position - 0x6904
bool func_101(vector3 vParam0, char *sParam3, vector3 vParam4) {
	int iVar0;
	int iVar1;
...
// Position - 0x6948
bool func_102(int iParam0, var *uParam1, float *fParam2) {
	*uParam1 = {0f, 0f, 0f};
	*fParam2 = 0f;
	switch (iParam0) {
	case 0:
...
// Position - 0x6FD7
bool func_103(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
bool func_104(int *iParam0) {
	if (!entity::is_entity_dead(player::player_ped_id(), 0) && !ped::is_ped_injured(player::player_ped_id())) {
		if (func_115()) {
			*iParam0 = func_110(entity::get_entity_coords(player::player_ped_id(), 0), 6, -1, 0, 1, -1);
			if (func_109(*iParam0) && !func_105(*iParam0)) {
				return true;
			}
		}
	}
...
// Position - 0x7079
int func_105(int iParam0) { return func_106(iParam0, 0, 1); }
...
int func_106(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_108() == 0) {
			return gameplay::is_bit_set(func_86(func_107(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0x73B0
int func_108() { return Global_25190; }

// Position - 0x73BB
int func_109(int iParam0) { return func_106(iParam0, 5, 1); }

// Position - 0x73CB
int func_110(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
	...
	while (iVar0 <= 45) {
		if (iParam3 == 6 || iParam3 == func_114(iVar0)) {
			if (!iParam5 || func_113(iVar0)) {
				fVar1 = gameplay::get_distance_between_coords(vParam0, func_111(iVar0, 0), 1);
...
Vector3 func_111(int iParam0, int iParam1) {
	...
	case 45: return func_112(Global_93004);
	}
...
// Position - 0x7A9D
int func_113(int iParam0) { return func_106(iParam0, 0, 0); }
...
// Position - 0x7D20
bool func_115() { return Global_91543.f_303 > 0; }
...
// Position - 0x7EB7
void func_118(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	struct<60> Var0;
	...
	if (entity::does_entity_exist(iParam0) && vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (func_103(vParam1, 0f, 0f, 0f, 0)) {
		...
		func_138(iParam5, &Var0, vParam1, fParam4, func_9(iParam0));
...
int func_121(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_19(iParam0, 0, 0) ||
		func_19(iParam0, 1, 0) || func_19(iParam0, 2, 0) || func_9(iParam0) != 145 || func_135(iParam0) ||
		func_134(iParam0) || func_133(iParam0) || func_132(iParam0) || !func_122(entity::get_entity_model(iParam0))) {
		if (func_134(iParam0)) {
		}
		if (func_134(iParam0)) {
		}
...
// Position - 0x953F
int func_127() { return 0; }

// Position - 0x9548
int func_128() { return 1; }

// Position - 0x9551
int func_129() { return 1; }
...
// Position - 0xAF26
void func_138(int iParam0, var *uParam1, vector3 vParam2, var uParam5, int iParam6) {
	if (func_137(&Global_68531.f_555[0 /*21*/], iParam0)) {
...
// Position - 0xB24D
void func_145() { Global_17151.f_6 = 1; }
...
// Position - 0xB2B5
int func_147() { return joaat("dune"); }
...
// Position - 0xB3A9
void func_150(var *uParam0, int iParam1) { func_151(uParam0, iParam1); }

// Position - 0xB3B9
void func_151(var *uParam0, var uParam1) { *uParam0 |= uParam1; }

// Position - 0xB3CA
void func_152(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8) {
	func_153(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

// Position - 0xB3EB
void func_153(char *sParam0, char *sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6,
...
// Position - 0xB6DE
bool func_155(var uParam0, int iParam1) { return (uParam0 & iParam1) != 0; }
	...
	case 3:
		...
		if (streaming::has_model_loaded(joaat("cuban800"))) {
			if (!entity::does_entity_exist(iLocal_48)) {
				gameplay::clear_area_of_vehicles(vLocal_50, 8f, 0, 0, 0, 0, 0);
				iLocal_48 = vehicle::create_vehicle(joaat("cuban800"), vLocal_50, 25.29f, 1, 1);
			...
			if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
				...
				if (iVar2 == iLocal_48) {
					...
					if (entity::does_entity_exist(iLocal_29) && !entity::is_entity_dead(iLocal_29, 0)) {
						if (entity::get_entity_model(iLocal_29) != joaat("dune") &&
							entity::get_entity_model(iLocal_29) != joaat("cuban800")) {
							if (!entity::is_entity_in_angled_area(iLocal_29, 2137.12f, 4799.97f, 39.67854f, 2116.64f,
																  4790.417f, 45.45295f, 25f, 0, 1, 0)) {
								func_118(iLocal_29, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, 0);
							}
						}
						else if (!entity::is_entity_dead(player::player_ped_id(), 0)) {
	...
	case 6:
		if (script::has_script_loaded("Traffick_Air")) {
			...
			if (iVar3 == 1) {
				...
				iLocal_30 = system::start_new_script("Traffick_Air", 20500);
				func_79(15);
	...
	case 7:
		if (!script::is_thread_active(iLocal_30)) {
			if (func_155(Global_100353, 1)) {
				...
				func_52();
				iVar4 = func_51();
				func_43(&iVar4, 0, 0, 3, 0, 0, 0);
				Global_101700.f_18942.f_11 = iVar4;
				func_1(105, 0, 0);
				Global_101700.f_18942.f_14 = 0;
				iLocal_47 = 9;
			}
...
bool func_158() {
	...
	if (script::_get_number_of_instances_of_script_with_name_hash(joaat("traffick_ground")) == 1 ||
		script::_get_number_of_instances_of_script_with_name_hash(joaat("traffick_air")) == 1) {
		return true;
	}
...
// Position - 0xBE28
bool func_161() { return Global_1315233; }
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_167() || Global_100747 ||
						Global_25192 || func_161() || func_160(8, -1) || func_115() || func_166() || func_159() ||
				...
				case 1:
					if (player::is_player_being_arrested(player::player_id(), 1) || func_167() || Global_25192 ||
						func_161() || func_160(8, -1) || func_159() || func_115() || func_166() || func_165() ||
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						player::is_player_climbing(player::player_id()) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_167() || Global_100747 ||
						Global_25192 || func_161() || func_160(8, -1) || func_159() || func_115() || func_166() ||
				...
				case 3:
					if (ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_167() || Global_100747 ||
						Global_25192 || func_161() || func_160(8, -1) || func_115() || func_166() || func_165() ||
						Global_101700.f_6647.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 4:
					if (func_167() || player::get_player_wanted_level(player::player_id()) > 0 || func_160(8, -1) ||
				...
				case 6:
					if (entity::does_entity_exist(player::player_ped_id())) {
						if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
							...
							player::is_player_being_arrested(player::player_id(), 1) ||
							player::is_player_climbing(player::player_id()) || func_167() || Global_25192 ||
							func_161() || func_160(8, -1) || func_166() || func_159() || func_165() ||
							Global_101700.f_6647.f_919[iVar0] == 5) {
							return 0;
						}
					}
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						entity::is_entity_in_air(player::player_ped_id()) ||
						ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) || func_167() || func_166() ||
						Global_100747 || Global_25192 || func_161() || Global_36912 || func_160(8, -1) || func_159() ||
				...
				case 8:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						player::is_player_being_arrested(player::player_id(), 1) ||
						player::is_player_climbing(player::player_id()) || func_167() || Global_100747 ||
						Global_25192 || func_161() || func_160(8, -1) || func_159() || func_164() || func_115() ||
						func_166() || func_165()) {
						return 0;
					}
					break;
...
void func_172() {
	if (!iLocal_80) {
		iLocal_79 =
			ped::add_scenario_blocking_area(Vector(40.073f, 4788.559f, 2157.109f) - Vector(25f, 25f, 25f),
											Vector(40.073f, 4788.559f, 2157.109f) + Vector(25f, 25f, 25f), 0, 1, 1, 1);
		iLocal_80 = 1;
	}
}
