...
void func_1() {
	if (bLocal_243) {
		...
		if (!ped::is_ped_injured(iLocal_69)) {
			if (entity::has_entity_been_damaged_by_entity(iLocal_69, player::player_ped_id(), 1) ||
				entity::has_entity_been_damaged_by_any_vehicle(iLocal_69)) {
				func_2();
			}
		}
		if (ped::is_ped_injured(iLocal_69)) {
			if (!ped::is_ped_injured(iLocal_70)) {
				...
				ai::task_perform_sequence(iLocal_70, iLocal_75);
		...
		if (ped::is_ped_injured(iLocal_70)) {
			if (!ped::is_ped_injured(iLocal_69)) {
				...
				ai::task_smart_flee_ped(0, player::player_ped_id(), 1000f, -1, 0, 0);
				ai::close_sequence_task(iLocal_75);
				ai::task_perform_sequence(iLocal_69, iLocal_75);
	...
	if (ped::is_ped_injured(iLocal_70)) {
		if (ui::does_blip_exist(iLocal_72)) {
			ui::remove_blip(&iLocal_72);
		}
	}
}

// Position - 0x301
void func_2() { func_166(); }
...
// Position - 0x4C8
void func_8(int iParam0) { Global_101686 = iParam0; }
...
void func_35() {
	if (!bLocal_243) {
		...
		if (func_50() || weapon::is_ped_armed(player::player_ped_id(), 6) ||
			!entity::is_entity_at_coord(player::player_ped_id(), entity::get_entity_coords(iLocal_70, 0), 12f, 12f, 5f,
										0, 1, 0)) {
...
bool func_50() {
	...
	if (!ped::is_ped_injured(iLocal_69) && !ped::is_ped_injured(iLocal_70)) {
		...
		if (entity::is_entity_at_entity(player::player_ped_id(), iLocal_69, 30f, 30f, 30f, 0, 1, 0) &&
			weapon::is_ped_armed(player::player_ped_id(), 6)) {
			if (player::is_player_free_aiming_at_entity(player::player_id(), iLocal_69) ||
				player::is_player_free_aiming_at_entity(player::player_id(), iLocal_70) ||
				player::is_player_targetting_entity(player::player_id(), iLocal_69) ||
				player::is_player_targetting_entity(player::player_id(), iLocal_70)) {
				if (ped::_0x6CD5A433374D4CFB(iLocal_69, player::player_ped_id()) ||
					ped::_0x6CD5A433374D4CFB(iLocal_70, player::player_ped_id())) {
					func_48();
					system::wait(0);
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			if (ped::is_ped_in_model(player::player_ped_id(), joaat("bulldozer"))) {
				if (entity::is_entity_touching_entity(player::player_ped_id(), iLocal_69) ||
					entity::is_entity_touching_entity(player::player_ped_id(), iLocal_70)) {
					return true;
				}
			}
		...
		if (ped::is_cop_ped_in_area_3d(entity::get_entity_coords(iLocal_69, 0) - vLocal_55,
									   entity::get_entity_coords(iLocal_69, 0) + vLocal_55) ||
			vehicle::is_cop_vehicle_in_area_3d(entity::get_entity_coords(iLocal_69, 0) - vLocal_55,
											   entity::get_entity_coords(iLocal_69, 0) + vLocal_55)) {
			return true;
		}
	}
	if (entity::is_entity_at_coord(player::player_ped_id(), 894.1762f, -1048.294f, 41.828f, 15f, 21.5625f, 10f, 0, 1,
								   0)) {
		func_48();
		system::wait(0);
...
// Position - 0x262A
void func_51() {
	if (entity::is_entity_at_coord(player::player_ped_id(), -734.9749f, -728.4423f, 29.4985f, 2f, 6f, 2f, 0, 1, 0) ||
		entity::is_entity_at_coord(player::player_ped_id(), -663.9312f, -725.6195f, 28.2592f, 2f, 6f, 2f, 0, 1, 0)) {
		if (!ped::is_ped_injured(iLocal_70)) {
			ai::open_sequence_task(&iLocal_75);
			ai::task_look_at_entity(0, player::player_ped_id(), -1, 2052, 2);
			ai::task_smart_flee_ped(0, player::player_ped_id(), 1000f, -1, 0, 0);
...
void func_52() {
	if (!bLocal_244) {
		if (!ped::is_ped_injured(iLocal_70)) {
			if (ai::get_script_task_status(iLocal_70, 242628503) == 7 &&
				entity::is_entity_at_entity(iLocal_70, player::player_ped_id(), 2.8f, 2.8f, 2.8f, 0, 1, 0)) {
				if (!iLocal_245) {
					iLocal_250 = 500;
					func_48();
					system::wait(0);
...
// Position - 0x35E0
bool func_67(var *uParam0, int iParam1) { return (*uParam0)[iParam1] == 70; }
...
// Position - 0x3625
void func_69(var *uParam0, int iParam1) { (*uParam0)[iParam1] = 70; }
...
// Position - 0x3652
float func_71(var *uParam0) { return uParam0->f_72; }

// Position - 0x365E
bool func_72(var *uParam0, int iParam1) { return func_73(uParam0, iParam1) != -1; }
...
// Position - 0x369D
bool func_74(var *uParam0) { return uParam0->f_71 == 1; }
...
void func_80() {
	if (!ped::is_ped_injured(iLocal_70)) {
		if (entity::is_entity_at_coord(player::player_ped_id(), 873.9561f, -1050.806f, 33.0066f, 4.75f, 1.9f, 1f, 0, 1,
									   0)) {
			if (!weapon::is_ped_armed(player::player_ped_id(), 6)) {
				...
				if (!ped::is_ped_injured(iLocal_69)) {
					...
					ai::open_sequence_task(&iLocal_75);
					ai::task_go_to_coord_while_aiming_at_entity(0, vLocal_64, player::player_ped_id(), 2f, 0, 0f, 4f, 1,
																512, 0, -957453492, 20000);
				...
				if (!ped::is_ped_injured(iLocal_70)) {
					...
					ai::close_sequence_task(iLocal_75);
					ai::task_perform_sequence(player::player_ped_id(), iLocal_75);
					ai::clear_sequence_task(&iLocal_75);
					func_81(1);
				}
				func_48();
...
int func_87(int iParam0, int iParam1, int iParam2) {
	...
	if (entity::is_entity_a_vehicle(iParam0)) {
		ui::set_blip_scale(iVar0, func_88(network::network_is_game_in_progress(), 1f, 1f));
		if (!iParam2) {
		...
		ui::set_blip_scale(iVar0, func_88(network::network_is_game_in_progress(), 0.7f, 0.7f));
		ui::set_blip_as_friendly(iVar0, iParam1);
	}
...
// Position - 0x3DA7
var func_88(bool bParam0, float fParam1, float fParam2) {
	if (bParam0) {
		return fParam1;
	}
	return fParam2;
...
void func_90() {
	if (!ped::is_ped_injured(iLocal_69)) {
		if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			if (weapon::is_ped_armed(player::player_ped_id(), 6) &&
				ped::_0x6CD5A433374D4CFB(iLocal_69, player::player_ped_id())) {
				ai::clear_ped_tasks(iLocal_69);
				ai::open_sequence_task(&iLocal_75);
				ai::task_look_at_entity(0, player::player_ped_id(), -1, 2052, 2);
				ai::task_smart_flee_ped(0, player::player_ped_id(), 1000f, -1, 0, 0);
...
void func_91() {
	if (!func_120()) {
		if (!entity::is_entity_dead(iLocal_69, 0)) {
			if (entity::is_entity_at_coord(player::player_ped_id(), vLocal_49, 65f, 60f, 60f, 0, 1, 0) ||
				Global_101695) {
				if (ui::does_blip_exist(iLocal_73)) {
					ui::remove_blip(&iLocal_73);
				}
				iLocal_71 = func_86(iLocal_69, 0, 145);
				ui::_0x75A16C3DA34F1245(iLocal_71, 0);
	...
	if (!iLocal_241) {
		if (!ped::is_ped_injured(iLocal_69)) {
			if (entity::is_entity_at_entity(player::player_ped_id(), iLocal_69, 25f, 25f, 25f, 0, 1, 0) && func_120()) {
				if (func_36(&uLocal_76, "lurinau", "lurin_help2", 4, 0, 0, 0)) {
					ai::open_sequence_task(&iLocal_75);
					ai::task_look_at_entity(0, player::player_ped_id(), -1, 2064, 2);
					ai::task_play_anim(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f,
									   -4f, -1, 49, 0, 0, 0, 0);
	...
	if (!entity::is_entity_dead(iLocal_69, 0)) {
		...
		if (entity::is_entity_at_entity(player::player_ped_id(), iLocal_69, 8f, 8f, 8f, 0, 1, 0)) {
			if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
				iLocal_242 = 1;
				if (ui::does_blip_exist(iLocal_71)) {
					ui::_0x75A16C3DA34F1245(iLocal_71, 1);
				}
				ai::clear_ped_tasks(iLocal_69);
...
void func_104() {
	...
	while (!streaming::has_model_loaded(joaat("a_f_m_skidrow_01")) ||
		   !streaming::has_model_loaded(joaat("a_m_m_tramp_01")) ||
		   !streaming::has_model_loaded(joaat("prop_ld_wallet_01_s")) ||
		   !streaming::has_anim_dict_loaded("random@mugging5") ||
		   !streaming::has_anim_dict_loaded("random@gang_intimidation@")) {
		system::wait(0);
	}
	...
	iLocal_69 = ped::create_ped(19, joaat("a_f_m_skidrow_01"), vLocal_58, 79.765f, 1, 1);
	...
	ai::task_perform_sequence(iLocal_69, iLocal_75);
	ai::clear_sequence_task(&iLocal_75);
	iLocal_70 = ped::create_ped(7, joaat("a_m_m_tramp_01"), vLocal_52, fLocal_67, 1, 1);
	...
	func_105(&uLocal_76, 0, player::player_ped_id(), "FRANKLIN", 0, 1);
...
void func_109(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_110(uParam1, "Abigail1", func_112(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				 "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_111(iParam0), 1, 0);
		break;

	case 1:
		func_110(uParam1, "Abigail2", func_112(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				 -1, 4, 1, 0, 2359, func_111(iParam0), 1, 0);
		break;

	case 2:
		func_110(uParam1, "Barry1", func_112(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				 4, 1, 0, 2359, func_111(iParam0), 1, 0);
		break;

	case 3:
		func_110(uParam1, "Barry2", func_112(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				 4, 4, 0, 2359, func_111(iParam0), 1, 1);
		break;

	case 4:
		func_110(uParam1, "Barry3", func_112(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2,
				 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 5:
		func_110(uParam1, "Barry3A", func_112(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0,
				 "", 166, 0, 7, 4, 2, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 6:
		func_110(uParam1, "Barry3C", func_112(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				 7, 4, 2, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 7:
		func_110(uParam1, "Barry4", func_112(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0,
				 "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_111(iParam0), 0, 0);
		break;

	case 8:
		func_110(uParam1, "Dreyfuss1", func_112(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				 0, "", 0, 0, -1, 4, 2, 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 9:
		func_110(uParam1, "Epsilon1", func_112(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1,
				 10, 4, 1, 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 10:
		func_110(uParam1, "Epsilon2", func_112(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0,
				 11, 4, 1, 0, 2359, func_111(iParam0), 1, 0);
		break;

	case 11:
		func_110(uParam1, "Epsilon3", func_112(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				 0, 0, 12, 4, 1, 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 12:
		func_110(uParam1, "Epsilon4", func_112(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				 "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 13:
		func_110(uParam1, "Epsilon5", func_112(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16,
				 "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_111(iParam0), 1, 0);
		break;

	case 14:
		func_110(uParam1, "Epsilon6", func_112(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 15:
		func_110(uParam1, "Epsilon7", func_112(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 16:
		func_110(uParam1, "Epsilon8", func_112(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_111(iParam0), 1, 0);
		break;

	case 17:
		func_110(uParam1, "Extreme1", func_112(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 18:
		func_110(uParam1, "Extreme2", func_112(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 19:
		func_110(uParam1, "Extreme3", func_112(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 20:
		func_110(uParam1, "Extreme4", func_112(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 21:
		func_110(uParam1, "Fanatic1", func_112(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_111(iParam0), 1, 0);
		break;

	case 22:
		func_110(uParam1, "Fanatic2", func_112(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_111(iParam0), 1, 0);
		break;

	case 23:
		func_110(uParam1, "Fanatic3", func_112(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_111(iParam0), 0, 1);
		break;

	case 24:
		func_110(uParam1, "Hao1", func_112(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_111(iParam0), 0, 1);
		break;

	case 25:
		func_110(uParam1, "Hunting1", func_112(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 26:
		func_110(uParam1, "Hunting2", func_112(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 27:
		func_110(uParam1, "Josh1", func_112(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_111(iParam0), 1, 0);
		break;

	case 28:
		func_110(uParam1, "Josh2", func_112(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_111(iParam0), 1, 1);
		break;

	case 29:
		func_110(uParam1, "Josh3", func_112(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_111(iParam0), 1, 1);
		break;

	case 30:
		func_110(uParam1, "Josh4", func_112(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_111(iParam0), 1, 0);
		break;

	case 31:
		func_110(uParam1, "Maude1", func_112(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 32:
		func_110(uParam1, "Minute1", func_112(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 33:
		func_110(uParam1, "Minute2", func_112(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 34:
		func_110(uParam1, "Minute3", func_112(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 35:
		func_110(uParam1, "MrsPhilips1", func_112(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 36:
		func_110(uParam1, "MrsPhilips2", func_112(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_111(iParam0), 0, 0);
		break;

	case 37:
		func_110(uParam1, "Nigel1", func_112(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_111(iParam0), 1, 0);
		break;

	case 38:
		func_110(uParam1, "Nigel1A", func_112(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_111(iParam0), 1, 1);
		break;

	case 39:
		func_110(uParam1, "Nigel1B", func_112(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_111(iParam0), 1, 1);
		break;

	case 40:
		func_110(uParam1, "Nigel1C", func_112(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_111(iParam0), 1, 1);
		break;

	case 41:
		func_110(uParam1, "Nigel1D", func_112(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_111(iParam0), 1, 1);
		break;

	case 42:
		func_110(uParam1, "Nigel2", func_112(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_111(iParam0), 1, 1);
		break;

	case 43:
		func_110(uParam1, "Nigel3", func_112(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_111(iParam0), 1, 1);
		break;

	case 44:
		func_110(uParam1, "Omega1", func_112(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 45:
		func_110(uParam1, "Omega2", func_112(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 46:
		func_110(uParam1, "Paparazzo1", func_112(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 47:
		func_110(uParam1, "Paparazzo2", func_112(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 48:
		func_110(uParam1, "Paparazzo3", func_112(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 49:
		func_110(uParam1, "Paparazzo3A", func_112(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 50:
		func_110(uParam1, "Paparazzo3B", func_112(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 51:
		func_110(uParam1, "Paparazzo4", func_112(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 52:
		func_110(uParam1, "Rampage1", func_112(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 54:
		func_110(uParam1, "Rampage3", func_112(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_111(iParam0), 1, 0);
		break;

	case 55:
		func_110(uParam1, "Rampage4", func_112(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_111(iParam0), 1, 0);
		break;

	case 56:
		func_110(uParam1, "Rampage5", func_112(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_111(iParam0), 0, 0);
		break;

	case 53:
		func_110(uParam1, "Rampage2", func_112(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_111(iParam0), 1, 0);
		break;

	case 57:
		func_110(uParam1, "TheLastOne", func_112(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 58:
		func_110(uParam1, "Tonya1", func_112(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 59:
		func_110(uParam1, "Tonya2", func_112(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_111(iParam0), 0, 1);
		break;

	case 60:
		func_110(uParam1, "Tonya3", func_112(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_111(iParam0), 0, 1);
		break;

	case 61:
		func_110(uParam1, "Tonya4", func_112(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_111(iParam0), 0, 1);
		break;

	case 62:
		func_110(uParam1, "Tonya5", func_112(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_111(iParam0), 0, 1);
		break;
...
// Position - 0x5E00
void func_110(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
// Position - 0x668C
bool func_115() { return Global_101418 > 0; }
...
// Position - 0x6800
bool func_124(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6) {
	int iVar0;
	vector3 vVar1;
	int iVar4;
	vector3 vVar5;
...
// Position - 0x6C02
int func_127(int iParam0) { return func_128(iParam0, 1); }
...
int func_128(int iParam0, int iParam1) {
	...
	func_129(iParam0, &iVar0, &iVar1, &iVar2, &iVar3, &iVar4, &iVar5);
...
void func_129(int iParam0, int *iParam1, int *iParam2, int *iParam3, int *iParam4, int *iParam5, int *iParam6) {
	func_130(func_141(), iParam0, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6);
}
...
// Position - 0x6F67
int func_133(int iParam0) { return system::shift_right(iParam0, 20) & 63; }

// Position - 0x6F7A
int func_134(int iParam0) { return system::shift_right(iParam0, 14) & 63; }

// Position - 0x6F8D
int func_135(int iParam0) { return system::shift_right(iParam0, 9) & 31; }

// Position - 0x6FA0
int func_136(int iParam0) { return system::shift_right(iParam0, 4) & 31; }
...
// Position - 0x6FEE
int func_139(int iParam0) { return iParam0 & 15; }
...
int func_141() {
	...
	func_147(&iVar0, time::get_clock_seconds());
	func_146(&iVar0, time::get_clock_minutes());
	func_145(&iVar0, time::get_clock_hours());
	func_144(&iVar0, time::get_clock_day_of_month());
	func_143(&iVar0, time::get_clock_month());
	func_142(&iVar0, time::get_clock_year());
	return iVar0;
}
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						Global_25192 || func_157() || func_45(8, -1) || func_156() || func_155() || func_154() ||
				...
				case 1:
					if (player::is_player_being_arrested(player::player_id(), 1) || func_158() || Global_25192 ||
						func_157() || func_45(8, -1) || func_154() || func_156() || func_155() || func_153() ||
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						player::is_player_climbing(player::player_id()) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_158() || Global_100747 ||
						Global_25192 || func_157() || func_45(8, -1) || func_154() || func_156() || func_155() ||
				...
				case 3:
					if (ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_158() || Global_100747 ||
						Global_25192 || func_157() || func_45(8, -1) || func_156() || func_155() || func_153() ||
						G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 4:
					if (func_158() || player::get_player_wanted_level(player::player_id()) > 0 || func_45(8, -1) ||
				...
				case 6:
					if (entity::does_entity_exist(player::player_ped_id())) {
						if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
							...
							func_157() || func_45(8, -1) || func_155() || func_154() || func_153() ||
							G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
							return 0;
						}
					}
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						Global_100747 || Global_25192 || func_157() || Global_36912 || func_45(8, -1) || func_154() ||
				...
				case 8:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						Global_25192 || func_157() || func_45(8, -1) || func_154() || func_152() || func_156() ||
						func_155() || func_153()) {
						return 0;
					}
					break;
...
// Position - 0x7C0E
int func_160(int iParam0) { return func_140(func_141(), iParam0); }
...
// Position - 0x8281
void func_170(int iParam0) { Global_36332 = gameplay::get_game_timer() + iParam0; }

// Position - 0x8293
void func_171(int iParam0) { func_172(iParam0, 0, func_177(iParam0)); }
...
void func_172(int iParam0, int iParam1, int iParam2) {
	...
	iVar0 = func_141();
	func_175(&iVar0, 0, 0, iParam2, iParam1, 0, 0);
	func_174(iParam0, &iVar0);
	Var1 = {func_173(&iVar0)};
}

// Position - 0x82D7
struct<16> func_173(int *iParam0) {
	struct<16> Var0;
	int iVar16;
...
void func_175(int *iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	...
	iVar0 += iParam6;
	func_176(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
