...
void __EntryFunction__() {
	...
	if (player::has_force_cleanup_occurred(83)) {
		...
		if (Var0 != -1) {
			if (Global_100787[Var0 /*10*/].f_9 != -1) {
				...
				func_265(&Global_100787[Var0 /*10*/].f_9);
			}
		}
		func_253(&Var0, 1);
	}
	if (!func_250(&iVar64, &Var0, vVar61, 5f)) {
		func_249();
	...
	while (true) {
		...
		if (Var0 == 47) {
			func_180(&Var0, vVar61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0 == 51) {
			func_180(&Var0, vVar61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_179(Var0);
		func_171(&iLocal_95, &Var0.f_9, vVar61);
		if (func_156(&Var0, 0)) {
			if (func_155(Var0)) {
				func_152(Var0, &iLocal_97);
			}
			if (!func_2(&Var0)) {
				func_253(&Var0, 1);
			}
...
int func_2(int iParam0) {
	...
	if (!func_151()) {
		while (!func_142(*iParam0)) {
			...
			if (!func_184(iParam0, *iParam0 != 2)) {
				func_266("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() "
						 "[TERMINATING]");
				return 0;
			}
			system::wait(0);
	...
	if (!func_98(iParam0)) {
		func_266("STEP_7_COMMON_LaunchMission - Trying to launch a null script "
				 "string name");
		return 0;
	}
...
int func_98(int iParam0) {
	...
	if (func_128(&uParam0->f_1)) {
		...
		if (cutscene::has_cutscene_loaded()) {
			...
			func_266("Initial cutscene wasn't loaded in time to pass to RC "
					 "mission.");
...
void func_152(int iParam0, int *iParam1) {
	switch (iParam0) {
	case 0:
		*iParam1 = func_153(-1604.668f, 5239.1f, 3.01f, 0);
		ui::set_blip_sprite(*iParam1, 66);
		ui::set_blip_colour(*iParam1, 42);
		break;

	case 1:
		*iParam1 = func_153(-1592.84f, 5214.04f, 3.01f, 0);
	...
	case 2:
	case 3:
		*iParam1 = func_153(190.26f, -956.35f, 29.63f, 0);
	...
	case 4:
		*iParam1 = func_153(414f, -761f, 29f, 0);
		if (gameplay::is_bit_set(Global_101700.f_17533[2 /*6*/], 3) ||
	...
	case 9:
		*iParam1 = func_153(-1622.89f, 4204.87f, 83.3f, 0);
		ui::set_blip_sprite(*iParam1, 66);
		ui::set_blip_colour(*iParam1, 42);
		break;
	...
	case 13:
		if (iParam0 == 11) {
			*iParam1 = func_153(1835.53f, 4705.86f, 38.1f, 0);
		}
		else if (iParam0 == 12) {
			*iParam1 = func_153(1826.13f, 4698.88f, 38.92f, 0);
		}
		else {
			*iParam1 = func_153(637.02f, 119.7093f, 89.5f, 0);
		}
	...
	case 19:
		if (iParam0 == 18) {
			*iParam1 = func_153(-954.19f, -2760.05f, 14.64f, 0);
		}
		else {
			*iParam1 = func_153(-63.8f, -809.5f, 321.8f, 0);
		}
	...
	case 23:
		if (iParam0 == 21) {
			*iParam1 = func_153(-1877.82f, -440.649f, 45.05f, 0);
		}
		else {
			*iParam1 = func_153(-915.6f, 6139.2f, 5.5f, 0);
		}
	...
	case 27:
		*iParam1 = func_153(-1104.93f, 291.25f, 64.3f, 0);
		ui::set_blip_sprite(*iParam1, 66);
		ui::set_blip_colour(*iParam1, 44);
		break;
	...
	case 34:
		*iParam1 = func_153(-303.82f, 6211.29f, 31.05f, 0);
		ui::set_blip_sprite(*iParam1, 386);
		ui::set_blip_colour(*iParam1, 44);
		break;

	case 43:
		*iParam1 = func_153(-44.75f, -1288.67f, 28.21f, 0);
		ui::set_blip_sprite(*iParam1, 149);
		ui::set_blip_colour(*iParam1, 44);
		break;

	case 46:
		*iParam1 = func_153(-149.75f, 285.81f, 93.67f, 0);
		ui::set_blip_sprite(*iParam1, 66);
		ui::set_blip_colour(*iParam1, 43);
		break;
	...
	case 48:
		if (iParam0 == 47) {
			*iParam1 = func_153(-70.71f, 301.43f, 106.79f, 0);
		}
		else {
			*iParam1 = func_153(-257.22f, 292.85f, 90.63f, 0);
		}
...
// Position - 0xA30B
int func_153(vector3 vParam0, int iParam3) {
	int iVar0;

	iVar0 = ui::add_blip_for_coord(vParam0);
	ui::set_blip_scale(iVar0, func_154(network::network_is_game_in_progress(), 1f, 1f));
	ui::set_blip_route(iVar0, iParam3);
	return iVar0;
}

// Position - 0xA337
var func_154(bool bParam0, float fParam1, float fParam2) {
	if (bParam0) {
		return fParam1;
	}
	return fParam2;
					...
					if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
						...
						if (func_162(2)) {
							if (func_160(uParam0->f_27)) {
								...
								func_266("ARE_RC_TRIGGER_CONDITIONS_MET: "
		...
		if (*uParam0 == 6) {
			...
			if (ai::get_ped_desired_move_blend_ratio(player::player_ped_id()) >= 2f) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 245.8885f, 371.9034f, 103.9884f,
					...
					if (func_162(2)) {
						if (func_160(uParam0->f_27)) {
							func_159(uParam0->f_27, *uParam0);
							func_266("RC5_IN_ACTIVATION_RANGE: "
			...
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 2728.948f, 4143.44f, 42.29295f, 2722.213f,
				...
				if (func_162(2)) {
					if (func_160(1)) {
						func_159(1, *uParam0);
						func_266("RC_IN_ACTIVATION_RANGE: "
	...
	if (iParam0 == 1) {
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			...
			if (ped::is_ped_in_any_heli(player::player_ped_id()) || ped::is_ped_in_any_plane(player::player_ped_id())) {
				func_266("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for "
						 "plane or helicopter.");
...
// Position - 0xB597
void func_171(int *iParam0, char *sParam1, vector3 vParam2) {
	if (player::is_player_playing(player::player_id())) {
		if (!gameplay::is_string_null_or_empty(sParam1)) {
			if (Global_35781 == 17) {
				...
				if (func_175(player::player_ped_id(), vParam2, 1) <= 100f) {
					func_174(iParam0, 1);
				}
			}
			else {
				...
				if (func_175(player::player_ped_id(), vParam2, 1) > 120f) {
					func_177(iParam0);
				}
			}
		}
...
// Position - 0xB79B
float func_175(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
...
// Position - 0xB7D5
bool func_176() { return Global_89133; }
...
// Position - 0xB908
int func_180(int iParam0, vector3 vParam1, char[4] cParam4, char *sParam5, int iParam6, char *sParam7, int iParam8,
			 float fParam9) {
	var *uVar0;

	if (func_112(player::player_ped_id()) && func_112(iParam0->f_28[0]) && !func_131() &&
		gameplay::get_game_timer() - iParam0->f_60 > iParam8 &&
		func_175(player::player_ped_id(), vParam1, 1) < fParam9) {
		uVar0 = 16;
...
int func_184(var *uParam0, int iParam1) {
	...
	if (Global_69702) {
		func_266("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer "
				 "[TERMINATING]");
		return 0;
	}
	...
	if (func_215(*uParam0)) {
		...
		func_266("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1) {
	...
	if (*uParam0 == 10) {
		if (fire::is_explosion_in_sphere(-1, uParam0->f_17[0 /*3*/], 8f)) {
			func_266("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission "
					 "trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17) {
		if (!gameplay::is_bit_set(Var0.f_26, func_90())) {
			func_266("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player "
	...
	if (func_112(player::player_ped_id())) {
		...
		while (iVar0 <= uParam0->f_28 - 1) {
			if (func_111(uParam0->f_28[iVar0])) {
				...
				switch (*uParam0) {
				case 19: func_214(uParam0->f_28[iVar0]); break;
		...
		while (iVar0 <= iVar1) {
			if (entity::does_entity_exist(uParam0->f_35[iVar0])) {
				if (entity::is_entity_dead(uParam0->f_35[iVar0], 0)) {
					func_266("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (iParam2) {
					if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
						...
						if (*uParam0 == 16) {
							if (func_193(player::player_ped_id(), uParam0->f_35[iVar0])) {
								func_266("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (!ped::is_ped_injured(uParam0->f_28[iVar0])) {
					if (ped::is_ped_sitting_in_any_vehicle(player::player_ped_id())) {
						if (entity::is_entity_touching_entity(player::player_ped_id(), uParam0->f_28[iVar0])) {
							...
							func_266("STEP_5_COMMON_RCfineAndInRange - Random "
					...
					if (func_213(*uParam0)) {
						...
						if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(uParam0->f_28[iVar0], 1), 15f)) {
							...
							func_266("STEP_5_COMMON_RCfineAndInRange - There "
					...
					if (!func_195(*uParam0)) {
						...
						if (player::get_player_wanted_level(player::player_id()) > 0) {
							...
							func_266("STEP_5_COMMON_RCfineAndInRange - Player "
...
// Position - 0xC9E9
bool func_197(int iParam0, float fParam1) { return func_198(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_198(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_199(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0xCAC2
int func_199(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
	...
	if (*iParam0 == 0) {
		vVar1 = {func_200(iParam4, iParam7)};
		*iParam0 =
...
int func_202(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	vVar0 = {func_204(entity::get_entity_coords(iParam1, 1) - entity::get_entity_coords(iParam0, 1))};
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_204(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
						  ped::get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_203(vVar3, vVar0);
...
// Position - 0xCE70
bool func_208(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_112(player::player_ped_id()) && func_112(iParam0)) {
		...
		if (!iParam2) {
			if (func_212(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_209(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
// Position - 0xCF6B
bool func_209(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
bool func_210(int iParam0, float fParam1) {
	...
	if (gameplay::_0x82FDE6A57EE4EE44(iParam0, joaat("weapon_grenade"), fParam1, &vVar1, &uVar0, 0) ||
		...
		if (func_211(iParam0, vVar1, 90f, 0)) {
			return true;
		}
	}
	return false;
...
// Position - 0xD10C
bool func_211(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = {func_204(vParam1 - entity::get_entity_coords(iParam0, 1))};
...
// Position - 0xD19A
bool func_212(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
int func_224(var *uParam0) {
	...
	case 1:
		if (!func_233(&iVar0) || !streaming::has_anim_dict_loaded(sVar8)) {
			return 0;
		}
		iLocal_91 = 2;
		break;
	...
	case 2:
		...
		if (!entity::does_entity_exist(uParam0->f_41[0])) {
			...
			if (func_112(uParam0->f_28[0]) && entity::does_entity_exist(uParam0->f_41[0])) {
		...
		if (!entity::does_entity_exist(uParam0->f_41[1])) {
			...
			if (func_112(uParam0->f_28[1]) && entity::does_entity_exist(uParam0->f_41[1])) {
...
// Position - 0xDB11
void func_225(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_190(uParam0);
...
// Position - 0xDB38
void func_226(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_227(uParam0);
...
// Position - 0xDC14
void func_228(var *uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	func_229(uParam0);
...
// Position - 0xDC75
bool func_230(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
	if (func_231(uParam0, iParam1, vParam2, fParam5, 1)) {
		if (entity::does_entity_exist(*uParam0)) {
...
// Position - 0xDCD1
bool func_231(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	int iVar0;
...
int func_236(var *uParam0) {
	...
	case 1:
		if (!func_233(&iVar0) || !streaming::has_anim_dict_loaded(sVar30)) {
			return 0;
		}
		iLocal_91 = 2;
		break;
	...
	case 2:
		...
		if (func_111(uParam0->f_28[0])) {
			if (!entity::does_entity_exist(uParam0->f_41[3])) {
				func_225(&uParam0->f_41[3], iVar0[1],
	...
	case 3:
		if (func_112(uParam0->f_41[0])) {
			iLocal_94 = ped::create_synchronized_scene(entity::get_entity_coords(uParam0->f_41[0], 1),
													   entity::get_entity_rotation(uParam0->f_41[0], 2), 2);
			entity::play_synchronized_entity_anim(uParam0->f_41[0], iLocal_94, "idle_closed_pap_3_rcm_dumpster", sVar30,
												  8f, -8f, 0, 1148846080);
			ped::set_synchronized_scene_looped(iLocal_94, 1);
			if (func_112(uParam0->f_28[0])) {
				ai::task_synchronized_scene(uParam0->f_28[0], iLocal_94, sVar30, "idle_closed_pap_3_rcm_beverly", 8f,
											-8f, 0, 0, 1148846080, 0);
			}
			if (func_112(uParam0->f_41[1])) {
				entity::play_synchronized_entity_anim(uParam0->f_41[1], iLocal_94, "idle_closed_pap_3_rcm_lid_l",
													  sVar30, 8f, -8f, 0, 1148846080);
			}
			if (func_112(uParam0->f_41[2])) {
				entity::play_synchronized_entity_anim(uParam0->f_41[2], iLocal_94, "idle_closed_pap_3_rcm_lid_r",
													  sVar30, 8f, -8f, 0, 1148846080);
			}
		}
		iVar31 = 0;
...
int func_237(var *uParam0) {
	...
	case 1:
		if (!func_233(&iVar0) || !streaming::has_anim_dict_loaded("rcmpaparazzo_2")) {
			return 0;
		}
		iLocal_91 = 2;
		break;
	...
	case 2:
		...
		if (func_111(uParam0->f_28[0])) {
			if (!entity::does_entity_exist(uParam0->f_41[0])) {
				func_225(&uParam0->f_41[0], iVar0[2],
						 entity::get_offset_from_entity_in_world_coords(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
				if (func_112(uParam0->f_41[0])) {
					entity::attach_entity_to_entity(uParam0->f_41[0], uParam0->f_28[0],
													ped::get_ped_bone_index(uParam0->f_28[0], 28422), 0f, 0f, 0f, 0f,
	...
	case 3:
		if (func_112(uParam0->f_28[0]) && func_112(player::player_ped_id())) {
			...
			ped::set_synchronized_scene_looped(iLocal_94, 1);
			ai::task_synchronized_scene(uParam0->f_28[0], iLocal_94, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0,
										1148846080, 0);
...
int func_238(var *uParam0) {
	...
	case 1:
		if (!func_233(&iVar0) || !streaming::has_anim_dict_loaded(sVar7)) {
			return 0;
		}
		func_239(46, 1);
		iLocal_91 = 2;
	...
	case 3:
		if (func_112(uParam0->f_28[0])) {
			if (streaming::has_anim_dict_loaded("rcmpaparazzo1beckon")) {
				...
				ai::set_sequence_to_repeat(iVar6, 1);
				ai::close_sequence_task(iVar6);
				ai::task_perform_sequence(uParam0->f_28[0], iVar6);
...
void func_239(int iParam0, int iParam1) {
	...
	case 46:
		if (iParam1) {
			vehicle::set_all_vehicle_generators_active_in_area(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f,
															   0, 1);
...
int func_241(int iParam0) {
	...
	if (Global_69702) {
		func_266("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is "
				 "running [TERMINATING]");
		return 0;
	}
	if (!Global_101700.f_8044 && !func_93(1)) {
		func_266("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not "
				 "active");
		return 0;
	}
	if (!func_242(iParam0)) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_266("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (Global_91491.f_11 == 6) {
		if (Global_91491 < 9) {
			...
			if (gameplay::are_strings_equal(&Global_91491.f_3, sVar0)) {
				func_266("STEP_3_COMMON_CanRCLaunch - Script denied as a "
	...
	if (script::_get_number_of_instances_of_script_with_name_hash(joaat("candidate_controller")) == 0) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_266("STEP_3_COMMON_CanRCLaunch - Script denied as "
...
int func_250(int iParam0, int iParam1, vector3 vParam2, float fParam5) {
	...
	func_266("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch "
			 "[TERMINATING]");
	return 0;
}

// Position - 0xEF96
bool func_251(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	int iVar0;
	struct<7> Var1;
...
// Position - 0xF014
bool func_252(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
void func_253(int iParam0, int iParam1) {
	...
	if (!iParam1) {
		if (*iParam0 == 48) {
			func_266("SCRIPT TERMINATING: Holding on to launcher until "
					 "Paparazzo 3 cleans up...");
...
// Position - 0xF253
void func_256(var *uParam0, bool bParam1) { func_257(&uParam0->f_41, bParam1); }
...
// Position - 0xF2DE
void func_259(var *uParam0, bool bParam1) { func_260(&uParam0->f_35, bParam1); }
...
// Position - 0xF365
void func_262(var *uParam0, int iParam1) { func_263(&uParam0->f_28, iParam1); }
