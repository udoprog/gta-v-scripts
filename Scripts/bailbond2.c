...
void __EntryFunction__() {
	...
	if (func_473()) {
		...
		switch (iVar0) {
		case 0:
			if (vehicle::is_this_model_a_plane(Global_96040.f_2311.f_12.f_66)) {
				func_431(&uLocal_713, 225.012f, 2310.695f, 77.257f, 218.1301f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145,
						 1);
			}
			else {
				func_431(&uLocal_713, 232.0044f, 2314.844f, 76.9871f, 173.0429f, 0, 0, 0, 0, 0, joaat("asterope"), 0,
						 145, 1);
			}
			func_430(vLocal_698, fLocal_458, 1, 0);
			iLocal_101 = 2;
			func_419(1, 0);
			break;

		case 1:
			func_431(&uLocal_713, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
			func_430(vLocal_689, 254.9762f, 0, 0);
			func_419(4, 0);
			break;
		...
		if (func_417(player::player_ped_id())) {
			func_416(player::player_ped_id(), vLocal_698, fLocal_458, 0, 0);
	...
	while (true) {
		if (!ped::is_ped_injured(player::player_ped_id())) {
			...
			func_404();
			switch (iLocal_98) {
			case 0: func_397(); break;

			case 1: func_386(); break;

			case 2: func_380(); break;

			case 3: func_374(); break;
...
void func_2() {
	...
	if (func_21(player::player_ped_id())) {
		...
		case 0:
			if (iLocal_100 == 1) {
				if (!func_69()) {
					func_18(player::player_ped_id(), vLocal_701, fLocal_459, 0, 1);
		...
		case 1:
			...
			if (iLocal_100 == 1) {
				if (!func_69()) {
					func_18(player::player_ped_id(), vLocal_704, fLocal_460, 0, 1);
					cam::set_gameplay_cam_relative_heading(0f);
					cam::set_gameplay_cam_relative_pitch(0f, 1065353216);
					if (iLocal_443 == 0) {
						if (iLocal_99 == 2) {
				...
				if (iLocal_473 > 0) {
					...
					while (iVar0 <= iLocal_473 - 1) {
						if (func_21(Local_132[iVar0 /*20*/])) {
							...
							entity::set_entity_health(Local_132[iVar0 /*20*/], 0);
						}
						iVar0++;
					}
				}
		...
		case 3:
			iLocal_437 = 1;
			if (iLocal_100 == 1) {
				func_416(Local_112.f_9, vLocal_689, 0f, 0, 0);
				if (!func_69()) {
					func_416(player::player_ped_id(), vLocal_689, 254.9762f, 0, 0);
					cam::set_gameplay_cam_relative_heading(0f);
					cam::set_gameplay_cam_relative_pitch(0f, 1065353216);
					if (iLocal_443 == 0) {
						if (iLocal_99 == 4) {
...
// Position - 0xF29
bool func_35() {
	if (func_57(vLocal_692, Local_385.f_1, 210f)) {
		if (!iLocal_452) {
		...
		if (!entity::does_entity_exist(Local_405)) {
			if (func_57(vLocal_692, Local_405.f_1, 150f)) {
		...
		if (!entity::does_entity_exist(Local_411)) {
			if (func_57(vLocal_692, Local_411.f_1, 150f)) {
	...
	case 0:
		...
		if (iLocal_102 == 4) {
			if (func_21(Local_385)) {
				...
				func_105(Local_385, 0);
				if (!audio::is_ambient_speech_playing(Local_385)) {
					if (func_104(Local_385, entity::get_entity_coords(player::player_ped_id(), 0), 35f)) {
						audio::stop_ped_speaking(Local_385, 0);
						func_102(Local_385, "GENERIC_FRIGHTENED_HIGH", "MAUDE", 3);
					}
				}
			}
			if (func_21(Local_385)) {
	...
	case 1:
		if (func_96()) {
			...
			if (!iLocal_434) {
				...
				if (iLocal_102 == 4) {
					if (func_21(Local_385)) {
						if (func_104(Local_385, vLocal_692, 35f)) {
				...
				if (!iLocal_444) {
					...
					if (!func_62(Local_385, 1805844857)) {
						if (!ped::is_ped_fleeing(Local_385)) {
							if (!entity::is_entity_playing_anim(Local_385, func_101(), func_72(), 3)) {
								func_71(&Local_385);
...
void func_113(int iParam0) {
	if (func_21(Local_132[iParam0 /*20*/])) {
		...
		if (gameplay::get_random_int_in_range(0, 2) == 0) {
			ped::set_ped_sphere_defensive_area(Local_132[iParam0 /*20*/],
											   entity::get_entity_coords(Local_132[iParam0 /*20*/], 1), 45f, 0, 0);
		}
		else {
			ped::set_ped_sphere_defensive_area(Local_132[iParam0 /*20*/],
											   entity::get_entity_coords(Local_132[iParam0 /*20*/], 1), 35f, 0, 0);
		}
...
void func_306() {
	...
	if (func_21(Local_112.f_9)) {
		...
		case 0:
			...
			func_345(&vLocal_710, vLocal_707);
		...
		case 1:
			if (!iLocal_448) {
				...
				if (Local_112.f_10 == 13 || Local_112.f_10 == 14) {
					...
					if (func_318(Local_112.f_9, vLocal_692, iVar0, 0, 1, iLocal_478)) {
						if (func_112(iLocal_476, 5000) || func_166(vLocal_710, 0f, 0f, 0f, 0) ||
							!func_57(vVar1, vLocal_710, 8.5f) && !func_57(vVar1, vLocal_707, 8.5f)) {
							func_317();
						...
						if (!iLocal_417) {
							if (!func_112(iLocal_463, 2500)) {
								if (!func_60()) {
									if (func_104(Local_112.f_9, vLocal_692, 30f)) {
							...
							if (func_112(iLocal_463, gameplay::get_random_int_in_range(5000, 12000))) {
								if (func_104(Local_112.f_9, vLocal_692, 30f)) {
						...
						func_314(Local_112.f_9, vLocal_692, iLocal_476, 925353388);
					}
				}
				else {
					func_317();
				...
				func_317();
				if (!func_104(Local_112.f_9, vLocal_692, 10f)) {
					if (!iLocal_437) {
...
void func_346() {
	...
	if (func_21(Local_112.f_9)) {
		...
		if (!ped::is_ped_performing_stealth_kill(player::player_ped_id())) {
			...
			case 0:
				if (func_104(Local_112.f_9, vLocal_692, 20f)) {
			...
			case 6:
				if (!func_104(Local_112.f_9, vLocal_692, 3.5f)) {
			...
			case 15:
				...
				if (func_94(Local_254[0 /*6*/])) {
					if (!ped::is_ped_in_vehicle(player::player_ped_id(), Local_254[0 /*6*/], 0) &&
						func_104(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f) &&
						func_353(entity::get_entity_heading(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f)) {
					...
					if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
						if (func_348()) {
							...
							if (!ped::is_ped_in_vehicle(Local_112.f_9, iVar1, 0)) {
								...
								if (fVar3 < 1.75f && func_104(Local_112.f_9, vLocal_692, 8f)) {
			...
			case 23:
				if (func_351(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_350()) {
					...
					if (!ped::is_ped_ragdoll(Local_112.f_9) && !ped::is_ped_being_stunned(Local_112.f_9, 0) &&
						...
						ai::task_look_at_entity(Local_112.f_9, player::player_ped_id(), -1, 0, 2);
						if (!func_347(Local_112.f_19, 10) && func_104(Local_112.f_9, vLocal_692, 50f) ||
							!func_112(iLocal_481, 2000)) {
							if (ped::is_ped_in_any_vehicle(Local_112.f_9, 1)) {
								ai::task_leave_any_vehicle(Local_112.f_9, 0, 0);
							}
			...
			case 24:
				if (func_351(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_350()) {
					if (!func_62(Local_112.f_9, -1519143300)) {
						...
						else if (!func_347(Local_112.f_19, 10) && func_104(Local_112.f_9, vLocal_692, 50f)) {
...
bool func_351(int iParam0, int iParam1, float fParam2, int iParam3, float fParam4, float fParam5, int iParam6) {
	...
	if (func_21(iParam0)) {
		...
		if (func_104(iParam0, vLocal_692, fParam2)) {
...
// Position - 0x292D3
void func_367() {
	if (func_57(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_689, 100f)) {
		if (!func_368()) {
		...
		if (!func_57(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_689, 120f)) {
			if (cutscene::has_cutscene_loaded()) {
				cutscene::remove_cutscene();
				iLocal_453 = 0;
			}
	...
	if (func_21(Local_112.f_9)) {
		...
		case 1:
			if (!iLocal_449) {
				...
				func_109(&Local_112.f_8);
				if (!func_104(Local_112.f_9, vLocal_692, 25f)) {
			...
			else if (func_104(Local_112.f_9, vLocal_692, 8f)) {
				...
				if (ped::is_ped_in_any_vehicle(Local_112.f_9, 0)) {
					...
					if (func_104(Local_112.f_9, vLocal_692, 25f)) {
						if (!func_312("BB2_J10", 1)) {
							if (func_112(iLocal_464, gameplay::get_random_int_in_range(2500, 5000))) {
								if (func_60()) {
									func_3();
								}
					...
					if (!func_60()) {
						if (func_112(iLocal_463, gameplay::get_random_int_in_range(3000, 6000))) {
							if (!func_104(Local_112.f_9, vLocal_692, 20f)) {
	...
	if (func_21(Local_112.f_9)) {
		...
		case 1:
			if (!iLocal_449) {
				...
				if (!func_104(Local_112.f_9, vLocal_692, 25f)) {
					...
					if (!ui::does_blip_exist(iLocal_456)) {
						if (iLocal_436) {
							iLocal_456 = func_379(vLocal_689, 5, 1);
						}
					}
					if (!iLocal_419) {
						if (!func_312(sLocal_487, 1)) {
						...
						func_370();
						func_377(&Local_385, vLocal_692, &iLocal_465, 5000, 1101004800);
					}
					...
					if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
						if (func_104(player::player_ped_id(), vLocal_689, 6.5f)) {
							iLocal_100 = 2;
						}
					}
					else if (func_104(player::player_ped_id(), vLocal_689, 2.5f)) {
						iLocal_100 = 2;
					}
				}
			}
				...
				if (func_104(Local_112.f_9, vLocal_692, 8f)) {
					if (Local_112.f_10 == 25 || Local_112.f_10 == 26) {
						Local_112.f_18 = gameplay::get_game_timer();
						Local_112.f_10 = 21;
					}
			...
			if (!iLocal_446) {
				iLocal_446 = func_375(vLocal_692, Local_103, 180f);
			}
			if (func_307(&Local_112.f_9)) {
				iLocal_454 = 1;
				iLocal_100 = 2;
		...
		case 2:
			...
			if (iLocal_454) {
				...
				if (!iLocal_446) {
					iLocal_446 = func_375(vLocal_692, Local_103, 0f);
				}
				func_123(4);
			}
			break;
...
// Position - 0x29F59
int func_375(vector3 vParam0, vector3 vParam3, float fParam6) {
	int iVar0;

	if (!func_376(vParam0, vParam3, fParam6)) {
...
// Position - 0x2A04B
bool func_376(vector3 vParam0, vector3 vParam3, float fParam6) {
	vector3 vVar0;
...
// Position - 0x2A075
int func_377(int iParam0, vector3 vParam1, int iParam4, int iParam5, float fParam6) {
	vector3 vVar0;
	var *uVar3;
	char[] cVar168[8];
	char *sVar169;
		...
		case 1:
			...
			if (!iLocal_448) {
				...
				if (Local_112.f_10 == 13 || Local_112.f_10 == 14) {
					...
					if (func_318(Local_112.f_9, vLocal_692, iVar0, 0, 1, 170)) {
						func_317();
						func_382(iLocal_473);
						Local_112.f_17 = gameplay::get_game_timer();
						func_315(&iLocal_44, 0, 0);
				...
				else if (iLocal_468 > 0 && func_104(Local_112.f_9, vLocal_692, 85f) ||
						 entity::get_entity_health(Local_112.f_9) < 200) {
					Local_112.f_10 = 13;
					Local_112.f_18 = gameplay::get_game_timer() - 5000;
					iLocal_475 = gameplay::get_game_timer();
					...
					if (func_112(iLocal_463, gameplay::get_random_int_in_range(3500, 7000))) {
						if (func_104(Local_112.f_9, vLocal_692, 30f)) {
							if (gameplay::get_random_int_in_range(0, 101) < 30) {
...
void func_383(int iParam0) {
	...
	while (iVar0 <= iParam0 - 1) {
		if (func_21(Local_132[iVar0 /*20*/])) {
			...
			case 1:
				switch (iVar0) {
				case 0: iVar2 = 250; break;

				case 1: iVar2 = gameplay::get_random_int_in_range(750, 1250); break;

				case 2: iVar2 = gameplay::get_random_int_in_range(1500, 2000); break;

				case 3: iVar2 = gameplay::get_random_int_in_range(2500, 3000); break;

				default: iVar2 = gameplay::get_random_int_in_range(500, 1500); break;
				}
		...
		case 1:
			...
			case 2:
				if (!iLocal_427) {
					...
					if (func_104(Local_112.f_9, vLocal_692, 22f) && func_396(Local_112.f_9, vLocal_692, 10f)) {
						...
						else if (func_104(Local_112.f_9, vLocal_692, 5f)) {
							iLocal_101 = 0;
						}
						else if (func_395(&Local_112.f_19)) {
							if (func_104(Local_112.f_9, vLocal_692, 22f - 1.5f)) {
								iLocal_101 = 1;
								iLocal_430 = 0;
								if (Local_112.f_10 != 3 && Local_112.f_10 != 4) {
									Local_112.f_18 = gameplay::get_game_timer() - 50000;
...
void func_390() {
	if (!iLocal_431) {
		if (!func_60()) {
			if (func_104(Local_112.f_9, vLocal_692, 22f + 5f)) {
				iLocal_457 = 0;
				if (ui::is_message_being_displayed()) {
					iLocal_457 = 1;
				}
		...
		if (!func_104(Local_112.f_9, vLocal_692, 22f + 10f)) {
			Local_683 = {func_391()};
			if (!gameplay::is_string_null_or_empty(&Local_683)) {
				iLocal_431 = 0;
				func_388();
...
//Position - 0x2B1EF
bool func_392(var* uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam5 == 0) {
		if (ui::is_message_being_displayed()) {
			if (gameplay::get_profile_setting(203) != 0) {
...
// Position - 0x2B280
bool func_394(int iParam0, int iParam1, int iParam2, float fParam3, float fParam4) {
	if (func_417(iParam0)) {
		if (!func_347(iParam1, 10)) {
			if (iParam2) {
				if (!func_104(Local_112.f_9, vLocal_692, fParam3)) {
					return false;
				}
				if (!func_396(iParam0, vLocal_692, fParam4)) {
					return false;
				}
			}
...
// Position - 0x2B300
int func_396(int iParam0, vector3 vParam1, float fParam4) {
	vector3 vVar0;
	float fVar3;
	...
	if (iLocal_98 == 0) {
		...
		if (!entity::is_entity_dead(Local_112.f_9, 0) && !ped::is_ped_injured(Local_112.f_9)) {
			if (iLocal_98 == 2 || iLocal_98 == 1 || iLocal_98 == 7) {
				if (!func_104(Local_112.f_9, vLocal_692, 150f)) {
					if (entity::is_entity_occluded(Local_112.f_9)) {
						iLocal_102 = 2;
						return;
					}
				...
				if (!func_104(Local_112.f_9, vLocal_692, 80f)) {
					if (entity::is_entity_occluded(Local_112.f_9)) {
						iLocal_102 = 2;
						return;
					}
...
bool func_407(int iParam0) {
	if (func_21(Local_385)) {
		...
		if (func_413(Local_385, 1126825984)) {
			return true;
		}
		if (func_408(Local_385, 1, 0, 0, 0)) {
			return true;
		}
...
bool func_408(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_417(player::player_ped_id()) && func_417(iParam0)) {
		...
		if (!iParam2) {
			if (func_412(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_409(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
// Position - 0x2BC39
bool func_409(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
bool func_410(int iParam0, float fParam1) {
	...
	if (gameplay::_0x82FDE6A57EE4EE44(iParam0, joaat("weapon_grenade"), fParam1, &vVar1, &uVar0, 0) ||
		...
		if (func_411(iParam0, vVar1, 90f, 0)) {
			return true;
		}
	}
	return false;
...
// Position - 0x2BDDA
bool func_411(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
bool func_413(int iParam0, float fParam1) {
	...
	if (func_417(player::player_ped_id()) && func_417(iParam0)) {
		if (func_415(iParam0) || player::is_player_targetting_entity(player::player_id(), iParam0)) {
			if (weapon::is_ped_armed(player::player_ped_id(), 6)) {
				fVar0 = 40f;
			}
			else {
...
// Position - 0x2BF26
bool func_414(int iParam0, float fParam1) { return func_359(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
// Position - 0x2BF66
void func_416(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
...
// Position - 0x2C29F
void func_425(int iParam0) { Global_89130 = iParam0; }
...
// Position - 0x2C4DD
void func_431(var *uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8,
	...
	if (iVar0 == 1) {
		...
		*uParam0 = func_453(vParam1, fParam4);
	}
	else if (iParam9 == 1) {
		if (func_166(vParam1, 0f, 0f, 0f, 0)) {
		...
		func_449(vParam1, 5f, 0);
		if (func_82(iParam12)) {
			func_448(iParam12, 0);
			while (!func_432(uParam0, iParam12, vParam1, fParam4, 1, 0)) {
				system::wait(0);
			}
		}
		else {
...
// Position - 0x2C670
int func_432(int *iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7) {
	int iVar0;
	var *uVar1;
	struct<97> Var5;
	int iVar103;
		...
		if (Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/] == Var5) {
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/],
				...
				func_443(iParam0, &Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/].f_31,
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/],
				...
				func_443(iParam0, &Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/].f_31,
	...
	if (func_82(iParam0) && entity::does_entity_exist(*uParam1) && vehicle::is_vehicle_driveable(*uParam1, 0)) {
		...
		if (vehicle::get_vehicle_mod_kit(*uParam1) >= 0 && vehicle::get_vehicle_mod_kit(*uParam1) < 255 &&
			...
			if (iParam3) {
				...
				Global_101700.f_19077[iParam0 /*43*/].f_31 = func_436(*uParam1);
				...
				func_434(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_5,
				...
				func_434(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0,
...
// Position - 0x2E144
bool func_435(int iParam0, char *sParam1, int *iParam2, int *iParam3, int *iParam4) {
	*iParam2 = -1;
	*iParam3 = -1;
	*iParam4 = -1;
	switch (iParam0) {
...
int func_437(int iParam0, int iParam1, int *iParam2) {
	...
	*iParam2 = 0;
	...
	iVar0 = entity::get_entity_model(iParam0);
	if (!func_438(iVar0, iParam1, iParam2)) {
		return 0;
	}
...
// Position - 0x2FC3A
bool func_442(int iParam0) { return vehicle::is_vehicle_extra_turned_on(iParam0, 5); }
...
int func_443(int iParam0, var *uParam1, var *uParam2) {
	...
	if (func_446(entity::get_entity_model(*iParam0), 1) &&
		vehicle::get_vehicle_mod(*iParam0, 24) != func_445(*iParam0, (*uParam1)[38] - 1)) {
		vehicle::set_vehicle_mod(*iParam0, 24, func_445(*iParam0, (*uParam1)[38] - 1), 0);
	}
	if (func_444(*iParam0)) {
...
// Position - 0x302FD
void func_449(vector3 vParam0, float fParam3, int iParam4) {
	int iVar0;
	...
	if (func_156(&Global_68531.f_555[0 /*21*/], iParam0)) {
		...
		if (gameplay::is_bit_set(Global_68531.f_555[0 /*21*/].f_9, 13)) {
			if (iParam0 == 24 && func_162(iParam0, 0) && Global_69440.f_66 == 0 &&
				...
				(!func_451(0, Global_68531.f_555[0 /*21*/].f_12) || !func_451(1, Global_68531.f_555[0 /*21*/].f_12))) {
...
// Position - 0x30531
int func_452(var *uParam0) { return *uParam0; }

// Position - 0x3053C
int func_453(vector3 vParam0, float fParam3) { return func_454(&Global_96040.f_2311, vParam0, fParam3, 0); }

// Position - 0x30556
int func_454(var *uParam0, vector3 vParam1, float fParam4, int iParam5) {
	int iVar0;
	vector3 vVar1;
	bool bVar4;
	var uVar5;
...
// Position - 0x30BAE
void func_459(int iParam0, var *uParam1, int iParam2, int iParam3) {
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (gameplay::is_bit_set(uParam1->f_77, 15) || func_462(iParam0) ||
...
// Position - 0x310C1
var func_461() { return dlc2::is_dlc_present(-1691188696); }
...
// Position - 0x311B1
int func_465() { return func_463(&Global_96040.f_2311); }

// Position - 0x311C4
void func_466() { func_467(&Global_96040.f_2311); }
...
// Position - 0x31351
int func_471() { return func_464(&Global_96040.f_2311); }
...
void func_474() {
	...
	ped::set_relationship_between_groups(5, 1862763509, iLocal_664);
	ped::set_relationship_between_groups(5, iLocal_664, 1862763509);
	vVar0 = {func_481(Local_103)};
	vVar3 = {func_480(Local_103)};
	ped::set_ped_non_creation_area(vVar0, vVar3);
	...
	while (iVar0 <= 5) {
		if (func_21(Local_132[iVar0 /*20*/])) {
			...
			if (iVar0 == 0) {
				...
				ai::set_sequence_to_repeat(iLocal_484, 1);
				ai::close_sequence_task(iLocal_484);
				ai::task_perform_sequence(Local_132[iVar0 /*20*/], iLocal_484);
				ai::clear_sequence_task(&iLocal_484);
				if (func_21(Local_132[iVar0 /*20*/])) {
...
int func_477() {
	...
	if (iLocal_470 > 0) {
		...
		while (iVar2 <= iLocal_470 - 1) {
			if (func_479(&Local_254[iVar2 /*6*/], Local_254[iVar2 /*6*/].f_5, Local_254[iVar2 /*6*/].f_1,
	...
	if (iLocal_472 > 0) {
		...
		while (iVar2 <= iLocal_472 - 1) {
			if (func_478(&Local_377[iVar2 /*7*/], Local_377[iVar2 /*7*/].f_5, Local_377[iVar2 /*7*/].f_2,
...
// Position - 0x31C0B
bool func_478(var *uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, int iParam7) {
	if (!object::does_pickup_exist(*uParam0)) {
		if (func_54(iParam6)) {
...
// Position - 0x31C7C
bool func_479(var *uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	if (!entity::does_entity_exist(*uParam0)) {
		if (func_54(iParam1)) {
...
// Position - 0x3224D
float func_483() { return 75.15f; }

// Position - 0x3225A
Vector3 func_484() { return 2727.29f, 4145.9f, 44.16f; }

// Position - 0x32271
float func_485() { return 71f; }

// Position - 0x3227E
Vector3 func_486() { return 2727.686f, 4145.715f, 44.08f; }

// Position - 0x32295
int func_487() { return 1385417869; }

// Position - 0x322A2
float func_488() { return -91.28f; }

// Position - 0x322AF
Vector3 func_489() { return 2728.35f, 4145.59f, 43.3f; }

// Position - 0x322C6
int func_490() { return -741944541; }

// Position - 0x322D3
float func_491() { return 89.19f; }

// Position - 0x322E0
Vector3 func_492() { return 2728.33f, 4145.6f, 43.89f; }
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_497() || Global_100747 ||
						Global_25192 || func_503() || func_87(8, -1) || func_502() || func_501() || func_495() ||
						func_496() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;

				case 1:
					if (player::is_player_being_arrested(player::player_id(), 1) || func_497() || Global_25192 ||
						func_503() || func_87(8, -1) || func_495() || func_502() || func_501() || func_496() ||
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						player::is_player_climbing(player::player_id()) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_497() || Global_100747 ||
						Global_25192 || func_503() || func_87(8, -1) || func_495() || func_502() || func_501() ||
						func_496() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5 || LastDispatchedMessageOrCall != -1) {
						return 0;
					}
					break;
				...
				case 3:
					if (ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_497() || Global_100747 ||
						Global_25192 || func_503() || func_87(8, -1) || func_502() || func_501() || func_496() ||
						G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 4:
					if (func_497() || player::get_player_wanted_level(player::player_id()) > 0 || func_87(8, -1) ||
						func_496() || func_500() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 6:
					if (entity::does_entity_exist(player::player_ped_id())) {
						if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
							...
							player::is_player_being_arrested(player::player_id(), 1) ||
							player::is_player_climbing(player::player_id()) || func_497() || Global_25192 ||
							func_503() || func_87(8, -1) || func_501() || func_495() || func_496() ||
							G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
							return 0;
						}
					}
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						entity::is_entity_in_air(player::player_ped_id()) ||
						ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) || func_497() || func_501() ||
						Global_100747 || Global_25192 || func_503() || Global_36912 || func_87(8, -1) || func_495() ||
						func_500() || func_496() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 8:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						player::is_player_being_arrested(player::player_id(), 1) ||
						player::is_player_climbing(player::player_id()) || func_497() || Global_100747 ||
						Global_25192 || func_503() || func_87(8, -1) || func_495() || func_500() || func_502() ||
						func_501() || func_496()) {
						return 0;
					}
					break;
...
// Position - 0x32B77
var func_499() { return Global_91530.f_1; }
...
// Position - 0x32BAB
bool func_501() { return Global_91543.f_304 > 0; }

// Position - 0x32BBC
bool func_502() { return Global_91543.f_303 > 0; }

// Position - 0x32BCD
var func_503() { return Global_1315233; }

// Position - 0x32BD9
int func_504(int iParam0) { return func_505(iParam0, Global_35781); }
...
void func_506(int iParam0) {
	...
	if (!func_530()) {
		...
		func_507(script::get_this_script_name());
	}
}
...
void func_510(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_511(uParam1, "Abigail1", func_513(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				 "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_512(iParam0), 1, 0);
		break;

	case 1:
		func_511(uParam1, "Abigail2", func_513(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				 -1, 4, 1, 0, 2359, func_512(iParam0), 1, 0);
		break;

	case 2:
		func_511(uParam1, "Barry1", func_513(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				 4, 1, 0, 2359, func_512(iParam0), 1, 0);
		break;

	case 3:
		func_511(uParam1, "Barry2", func_513(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				 4, 4, 0, 2359, func_512(iParam0), 1, 1);
		break;

	case 4:
		func_511(uParam1, "Barry3", func_513(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2,
				 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 5:
		func_511(uParam1, "Barry3A", func_513(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0,
				 "", 166, 0, 7, 4, 2, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 6:
		func_511(uParam1, "Barry3C", func_513(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				 7, 4, 2, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 7:
		func_511(uParam1, "Barry4", func_513(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0,
				 "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_512(iParam0), 0, 0);
		break;

	case 8:
		func_511(uParam1, "Dreyfuss1", func_513(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				 0, "", 0, 0, -1, 4, 2, 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 9:
		func_511(uParam1, "Epsilon1", func_513(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1,
				 10, 4, 1, 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 10:
		func_511(uParam1, "Epsilon2", func_513(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0,
				 11, 4, 1, 0, 2359, func_512(iParam0), 1, 0);
		break;

	case 11:
		func_511(uParam1, "Epsilon3", func_513(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				 0, 0, 12, 4, 1, 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 12:
		func_511(uParam1, "Epsilon4", func_513(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				 "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 13:
		func_511(uParam1, "Epsilon5", func_513(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16,
				 "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_512(iParam0), 1, 0);
		break;

	case 14:
		func_511(uParam1, "Epsilon6", func_513(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 15:
		func_511(uParam1, "Epsilon7", func_513(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 16:
		func_511(uParam1, "Epsilon8", func_513(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_512(iParam0), 1, 0);
		break;

	case 17:
		func_511(uParam1, "Extreme1", func_513(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 18:
		func_511(uParam1, "Extreme2", func_513(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 19:
		func_511(uParam1, "Extreme3", func_513(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 20:
		func_511(uParam1, "Extreme4", func_513(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 21:
		func_511(uParam1, "Fanatic1", func_513(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_512(iParam0), 1, 0);
		break;

	case 22:
		func_511(uParam1, "Fanatic2", func_513(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_512(iParam0), 1, 0);
		break;

	case 23:
		func_511(uParam1, "Fanatic3", func_513(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_512(iParam0), 0, 1);
		break;

	case 24:
		func_511(uParam1, "Hao1", func_513(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_512(iParam0), 0, 1);
		break;

	case 25:
		func_511(uParam1, "Hunting1", func_513(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 26:
		func_511(uParam1, "Hunting2", func_513(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 27:
		func_511(uParam1, "Josh1", func_513(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_512(iParam0), 1, 0);
		break;

	case 28:
		func_511(uParam1, "Josh2", func_513(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_512(iParam0), 1, 1);
		break;

	case 29:
		func_511(uParam1, "Josh3", func_513(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_512(iParam0), 1, 1);
		break;

	case 30:
		func_511(uParam1, "Josh4", func_513(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_512(iParam0), 1, 0);
		break;

	case 31:
		func_511(uParam1, "Maude1", func_513(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 32:
		func_511(uParam1, "Minute1", func_513(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 33:
		func_511(uParam1, "Minute2", func_513(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 34:
		func_511(uParam1, "Minute3", func_513(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 35:
		func_511(uParam1, "MrsPhilips1", func_513(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 36:
		func_511(uParam1, "MrsPhilips2", func_513(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_512(iParam0), 0, 0);
		break;

	case 37:
		func_511(uParam1, "Nigel1", func_513(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_512(iParam0), 1, 0);
		break;

	case 38:
		func_511(uParam1, "Nigel1A", func_513(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_512(iParam0), 1, 1);
		break;

	case 39:
		func_511(uParam1, "Nigel1B", func_513(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_512(iParam0), 1, 1);
		break;

	case 40:
		func_511(uParam1, "Nigel1C", func_513(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_512(iParam0), 1, 1);
		break;

	case 41:
		func_511(uParam1, "Nigel1D", func_513(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_512(iParam0), 1, 1);
		break;

	case 42:
		func_511(uParam1, "Nigel2", func_513(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_512(iParam0), 1, 1);
		break;

	case 43:
		func_511(uParam1, "Nigel3", func_513(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_512(iParam0), 1, 1);
		break;

	case 44:
		func_511(uParam1, "Omega1", func_513(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 45:
		func_511(uParam1, "Omega2", func_513(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 46:
		func_511(uParam1, "Paparazzo1", func_513(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 47:
		func_511(uParam1, "Paparazzo2", func_513(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 48:
		func_511(uParam1, "Paparazzo3", func_513(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 49:
		func_511(uParam1, "Paparazzo3A", func_513(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 50:
		func_511(uParam1, "Paparazzo3B", func_513(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 51:
		func_511(uParam1, "Paparazzo4", func_513(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 52:
		func_511(uParam1, "Rampage1", func_513(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 54:
		func_511(uParam1, "Rampage3", func_513(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_512(iParam0), 1, 0);
		break;

	case 55:
		func_511(uParam1, "Rampage4", func_513(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_512(iParam0), 1, 0);
		break;

	case 56:
		func_511(uParam1, "Rampage5", func_513(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_512(iParam0), 0, 0);
		break;

	case 53:
		func_511(uParam1, "Rampage2", func_513(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_512(iParam0), 1, 0);
		break;

	case 57:
		func_511(uParam1, "TheLastOne", func_513(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 58:
		func_511(uParam1, "Tonya1", func_513(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 59:
		func_511(uParam1, "Tonya2", func_513(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_512(iParam0), 0, 1);
		break;

	case 60:
		func_511(uParam1, "Tonya3", func_513(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_512(iParam0), 0, 1);
		break;

	case 61:
		func_511(uParam1, "Tonya4", func_513(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_512(iParam0), 0, 1);
		break;

	case 62:
		func_511(uParam1, "Tonya5", func_513(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_512(iParam0), 0, 1);
		break;
...
// Position - 0x341D2
void func_511(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
