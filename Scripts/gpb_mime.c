...
void func_51(int iParam0, char *sParam1, char *sParam2) {
	...
	switch (iParam0) {
	case 1: StringCopy(sParam2, "02_IG_1_R", 64); break;

	case 2: StringCopy(sParam2, "02_IG_1_CLI", 64); break;

	case 3: StringCopy(sParam2, "03_IG_1_OPEN_WIND", 64); break;

	case 4: StringCopy(sParam2, "09_IG_1_BALO", 64); break;

	case 5: StringCopy(sParam2, "10_IG_1_WA", 64); break;

	case 6: StringCopy(sParam2, "12_IG_1_BEATEN_", 64); break;

	case 7: StringCopy(sParam2, "11_IG_1_RUN_AW", 64); break;

	case 8: StringCopy(sParam2, "08_IG_1_WALL_BA", 64); break;
	}
}
