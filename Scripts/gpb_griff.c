...
void func_51(int iParam0, char *sParam1, char *sParam2) {
	...
	switch (iParam0) {
	case 1: StringCopy(sParam2, "IAmNotARacist", 64); break;

	case 2: StringCopy(sParam2, "America_is_not", 64); break;

	case 3: StringCopy(sParam2, "America_is_for_the_americans", 64); break;

	case 4: StringCopy(sParam2, "this_is_the_land", 64); break;

	case 5: StringCopy(sParam2, "this_is_the_land_opportunity", 64); break;

	case 6: StringCopy(sParam2, "keep_america_clean", 64); break;

	case 7: StringCopy(sParam2, "e_pluribus_unum", 64); break;

	case 8: StringCopy(sParam2, "let_me_be_clear", 64); break;
	}
}
...
void func_98() {
	...
	ped::set_ped_prop_index(iLocal_240, 0, 0, 0, 0);
	iLocal_448 =
		object::create_object(joaat("prop_cs_protest_sign_01"), entity::get_entity_coords(iLocal_240, 1), 1, 1, 0);
