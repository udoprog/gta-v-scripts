...
void __EntryFunction__() {
	...
	while (true) {
		...
		func_478();
		switch (iLocal_404) {
		case 0: func_417(); break;

		case 1: func_409(); break;

		case 2: func_270(); break;

		case 3: func_256(); break;

		case 4: func_227(); break;

		case 5: func_204(); break;

		case 6: func_190(); break;

		case 7: func_35(); break;
...
void func_1() {
	...
	else if (func_479(iLocal_408) && func_479(player::player_ped_id())) {
		if (entity::has_entity_been_damaged_by_entity(iLocal_408, player::player_ped_id(), 1)) {
			if (weapon::has_ped_been_damaged_by_weapon(iLocal_408, 0, 2) ||
				entity::has_entity_been_damaged_by_any_vehicle(iLocal_408)) {
				func_2(1);
			}
		}
	}
...
void func_3() {
	...
	case 0:
		...
		case 1: sVar0 = "MEA1_FAIL4"; break;

		case 2: sVar0 = "MEA1_FAIL1"; break;

		case 3: sVar0 = "MEA1_FAIL2"; break;

		case 4: sVar0 = "MEA1_FAIL3"; break;

		case 5: sVar0 = "MEA1_FAIL5"; break;
		}
		if (iLocal_406 == 0) {
			func_21(0);
		}
...
void func_4(int iParam0, int iParam1) {
	...
	if (iParam0) {
		...
		if (func_479(iLocal_408) && ped::is_ped_in_group(iLocal_408)) {
			ped::remove_ped_from_group(iLocal_408);
		}
		if (iParam1) {
			func_16(&iLocal_408, 1, 0, 1);
		}
		else if (func_479(iLocal_408) && entity::is_entity_at_coord(iLocal_408, vLocal_390, 50f, 50f, 50f, 0, 1, 0)) {
			func_11(iLocal_408);
		}
		else {
			func_16(&iLocal_408, 1, 0, 1);
...
void func_35() {
	...
	if (func_479(player::player_ped_id()) && func_479(iLocal_408)) {
		...
		case 0:
			...
			iLocal_308 = cam::create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -1392.254f, 367.9411f, 75.0046f,
													 -44.2648f, 0f, -119.873f, 48.4f, 0, 2);
			cam::set_cam_active(iLocal_308, 1);
			...
			if (func_8(iVar0)) {
				...
				ai::task_follow_nav_mesh_to_coord(0, entity::get_entity_coords(player::player_ped_id(), 1), 2f, 20000,
				...
				ai::task_perform_sequence(iLocal_408, iVar2);
			...
			if (ped::is_ped_in_any_vehicle(iLocal_408, 0) && func_8(iVar0)) {
				if (!func_51(iLocal_408, -828834893)) {
					if (vehicle::is_vehicle_stopped(iVar0)) {
						...
						ai::task_perform_sequence(iLocal_408, iVar3);
	...
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_45(player::player_id()) &&
				!func_42(player::player_id(), 0) && !func_41()) {
...
// Position - 0x2076
bool func_41() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x211F
var func_44() { return Global_1312735; }
...
// Position - 0x216D
bool func_46() { return gameplay::is_bit_set(Global_2359301, 3); }
...
// Position - 0x29DE
int func_65(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
// Position - 0x2B8E
void func_67(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9,
...
// Position - 0x2D88
Vector3 func_69(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	if (iParam1 == 12) {
				...
				if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0)) {
					if (iVar0 == 13) {
						...
						while (iVar1 <= 8) {
							...
							func_90(iParam0, Global_69523[1 /*14*/].f_12, Global_69523[1 /*14*/].f_3,
						...
						if (iParam4 == -1) {
							ped::set_ped_component_variation(iParam0, func_80(iVar0), Global_69523[1 /*14*/].f_3,
															 Global_69523[1 /*14*/].f_4,
															 ped::get_ped_palette_variation(iParam0, func_80(iVar0)));
						}
						else {
							ped::set_ped_component_variation(iParam0, func_80(iVar0), Global_69523[1 /*14*/].f_3,
		...
		if (iParam4 == -1) {
			ped::set_ped_component_variation(iParam0, func_80(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4,
											 ped::get_ped_palette_variation(iParam0, func_80(iParam1)));
		}
		else {
			ped::set_ped_component_variation(iParam0, func_80(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4, iParam4);
...
bool func_71(int iParam0, int iParam1, int *iParam2) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_63 != -99) {
		if (!func_184(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_64,
...
bool func_78(int iParam0, int iParam1, int *iParam2, int iParam3) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_60 != -99) {
		if (!func_184(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_61,
...
// Position - 0x43B0
var func_82(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
...
// Position - 0x4F63
int func_83(int iParam0, int iParam1, int iParam2, int iParam3, int *iParam4) {
	int iVar0;
...
void func_90(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == -1) {
		...
		if (iParam1 == 0) {
			...
			if (func_91(entity::get_entity_model(iParam0), 14, iVar0,
...
struct<10> func_99(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		switch (iParam1) {
		case 31: func_101(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 0: func_101(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_101(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_101(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_101(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_101(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8); break;

		case 5: func_101(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8); break;

		case 6: func_101(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_101(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_101(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_101(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8); break;

		default: func_100(&Var1, iParam0, iParam1, 10); break;
		}
		break;
	...
	case joaat("player_one"):
		...
		case 1: func_101(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8); break;

		case 2: func_101(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8); break;

		case 3: func_101(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_101(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_101(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_101(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_101(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_101(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_100(&Var1, iParam0, iParam1, 9); break;
		}
		break;
	...
	case joaat("player_two"):
		...
		case 0: func_101(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_101(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_101(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_101(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8); break;

		case 4: func_101(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8); break;

		case 5: func_101(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_101(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_101(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_101(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8); break;
	...
	case joaat("mp_m_freemode_01"):
		...
		case 0: func_101(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_101(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_101(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_101(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_101(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_101(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_101(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_101(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_101(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_101(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_101(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_101(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_101(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_101(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 14: func_101(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_101(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_101(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_101(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_101(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_101(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_101(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_101(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_101(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_101(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 24: func_101(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_100(&Var1, iParam0, iParam1, 25); break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 0: func_101(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_101(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_101(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_101(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_101(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_101(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_101(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_101(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_101(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_101(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_101(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_101(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_101(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_101(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8); break;

		case 14: func_101(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_101(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_101(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_101(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_101(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_101(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_101(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_101(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_101(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_101(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8); break;
...
// Position - 0x70DC
void func_101(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
struct<17> func_102(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		...
		case 1: func_105(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0); break;

		case 2: func_105(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8); break;

		case 3: func_105(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31); break;

		case 4: func_105(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2); break;

		case 5:
			func_105(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[0], Global_101700.f_2095.f_539.f_200[0], 6, 3, 0,
					 0, 0, -99, 0, 0, 3);
			break;

		case 6: func_105(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_105(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 8: func_105(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 9: func_105(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 10: func_105(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4); break;

		case 11: func_105(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5); break;

		case 12: func_105(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31); break;

		case 13: func_105(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 14: func_105(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6); break;

		case 15: func_105(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31); break;

		case 16: func_105(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31); break;

		case 17: func_105(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 18: func_105(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7); break;

		case 19: func_105(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 20: func_105(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 21: func_105(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_105(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 23: func_105(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31); break;

		case 24: func_105(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31); break;

		case 25: func_105(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 26: func_105(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 27: func_105(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 28: func_105(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 29: func_105(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 30: func_105(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 31: func_105(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31); break;

		case 32: func_105(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 33: func_105(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 34: func_105(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31); break;

		case 35: func_105(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 36: func_105(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 37: func_105(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 38: func_105(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 39: func_105(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 40: func_105(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 41: func_105(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_105(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_105(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_105(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 45: func_105(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 46: func_105(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_105(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 48: func_105(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31); break;

		case 49: func_105(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 50: func_105(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9); break;

		case 51: func_105(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 52: func_105(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		default: func_103(&Var1, iParam0, iParam1, 53); break;
		}
		break;

	case joaat("player_one"):
		switch (iParam1) {
		case 0: func_105(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 1: func_105(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 2:
			func_105(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[1], Global_101700.f_2095.f_539.f_200[1], 17, 2,
					 26, 0, 0, -99, 0, 45, 31);
			break;

		case 3: func_105(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1); break;

		case 4: func_105(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2); break;

		case 5: func_105(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 6: func_105(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_105(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3); break;

		case 8: func_105(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5); break;

		case 9: func_105(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 10: func_105(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 11: func_105(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 12: func_105(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 13: func_105(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 14: func_105(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 15: func_105(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 16: func_105(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 17: func_105(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 18: func_105(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31); break;

		case 19: func_105(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 20: func_105(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 21: func_105(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4); break;

		case 22: func_105(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31); break;

		case 23: func_105(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31); break;

		case 24: func_105(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31); break;

		case 25: func_105(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31); break;

		case 26: func_105(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31); break;

		case 27: func_105(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31); break;

		case 28: func_105(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31); break;

		case 29: func_105(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31); break;

		case 30: func_105(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31); break;

		case 31: func_105(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31); break;

		case 32: func_105(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31); break;

		case 33: func_105(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31); break;

		case 34: func_105(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31); break;

		case 35: func_105(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31); break;

		case 36: func_105(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31); break;

		case 37: func_105(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31); break;

		case 38: func_105(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 39: func_105(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 40: func_105(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 41: func_105(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 42: func_105(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31); break;

		case 43: func_105(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6); break;

		case 44: func_105(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 45: func_105(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8); break;

		case 46: func_105(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31); break;

		default: func_103(&Var1, iParam0, iParam1, 47); break;
		}
		break;

	case joaat("player_two"):
		switch (iParam1) {
		case 0: func_105(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 1: func_105(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8); break;

		case 2: func_105(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1); break;

		case 3: func_105(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2); break;

		case 4:
			func_105(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[2], Global_101700.f_2095.f_539.f_200[2], 8, 0, 0,
					 0, 0, -99, 0, 0, 31);
			break;

		case 5: func_105(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6); break;

		case 6: func_105(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3); break;

		case 7: func_105(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4); break;

		case 8: func_105(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31); break;

		case 9: func_105(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 10: func_105(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 11: func_105(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5); break;

		case 12: func_105(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 13: func_105(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31); break;

		case 14: func_105(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31); break;

		case 15: func_105(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 16: func_105(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 17: func_105(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 18: func_105(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 19: func_105(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 20: func_105(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 21: func_105(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_105(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 23: func_105(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 24: func_105(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 25: func_105(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 26: func_105(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 27: func_105(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 28: func_105(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 29: func_105(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 30: func_105(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 31: func_105(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 32: func_105(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 33: func_105(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 34: func_105(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 35: func_105(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 36: func_105(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 37: func_105(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 38: func_105(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 39: func_105(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 40: func_105(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 41: func_105(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_105(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_105(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_105(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31); break;

		case 45: func_105(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 46: func_105(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_105(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31); break;

		default: func_103(&Var1, iParam0, iParam1, 48); break;
		}
		break;

	case joaat("mp_m_freemode_01"):
		switch (iParam1) {
		case 0: func_105(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31); break;

		case 1: func_105(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0); break;

		case 2: func_105(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1); break;

		case 3: func_105(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2); break;

		case 4: func_105(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3); break;

		case 5: func_105(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4); break;

		case 6: func_105(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5); break;

		case 7: func_105(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6); break;

		case 8: func_105(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7); break;

		case 9: func_105(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8); break;

		case 10: func_105(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9); break;

		case 11: func_105(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10); break;

		case 12: func_105(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11); break;

		case 13: func_105(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12); break;

		case 14: func_105(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13); break;

		case 15: func_105(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14); break;

		case 16: func_105(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15); break;

		case 17: func_105(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16); break;

		case 18: func_105(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17); break;

		case 19: func_105(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18); break;

		case 20: func_105(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19); break;

		case 21: func_105(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20); break;

		case 22: func_105(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21); break;

		case 23: func_105(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22); break;

		case 24: func_105(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23); break;

		case 25: func_105(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24); break;

		default: func_103(&Var1, iParam0, iParam1, 26); break;
		}
		break;

	case joaat("mp_f_freemode_01"):
		switch (iParam1) {
		case 0: func_105(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31); break;

		case 1: func_105(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31); break;

		case 2: func_105(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0); break;

		case 3: func_105(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1); break;

		case 4: func_105(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2); break;

		case 5: func_105(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3); break;

		case 6: func_105(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4); break;

		case 7: func_105(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5); break;

		case 8: func_105(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6); break;

		case 9: func_105(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7); break;

		case 10: func_105(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8); break;

		case 11: func_105(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9); break;

		case 12: func_105(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10); break;

		case 13: func_105(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31); break;

		case 14: func_105(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11); break;

		case 15: func_105(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12); break;

		case 16: func_105(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13); break;

		case 17: func_105(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14); break;

		case 18: func_105(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15); break;

		case 19: func_105(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16); break;

		case 20: func_105(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17); break;

		case 21: func_105(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31); break;

		case 22: func_105(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18); break;

		case 23: func_105(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19); break;

		case 24: func_105(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20); break;

		case 25: func_105(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21); break;

		case 26: func_105(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22); break;

		case 27: func_105(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23); break;

		default: func_103(&Var1, iParam0, iParam1, 28); break;
		}
		break;
	}
	return Var1;
...
// Position - 0x9208
void func_105(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) {
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_92(iParam0, iParam2, 14, 3), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_92(iParam0, iParam2, 1, 3), -1842686353, 0);
			}
			break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_92(iParam0, iParam2, 14, 4), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_92(iParam0, iParam2, 1, 4), -1842686353, 0);
			}
			break;
		}
		break;
...
void func_113(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_117(iParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3)) {
...
// Position - 0x9EAC
bool func_117(int iParam0, int iParam1, int *iParam2, int *iParam3, bool bParam4, bool bParam5) {
	int iVar0;
...
// Position - 0xB09B
bool func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	if (iParam0 == 0) {
		if (iParam5 == 1) {
...
void func_121(int iParam0, int iParam1)
{
	...
	case 14: func_122(iParam1); break;
	}
}
...
void func_122(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 155); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

// Position - 0xD3C3
void func_123(var *uParam0, int iParam1, int iParam2, char *sParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	*uParam0 = iParam9;
	...
	if (iParam10) {
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 ||
			...
			iVar0 = func_116(func_126(iParam1, uParam0->f_2), Global_69521, 0);
		...
		while (iVar38 < iVar40) {
			...
			if (!dlc1::_is_dlc_data_empty(Var20)) {
				if (iVar39 == iParam1 - iParam2) {
					...
					func_123(&Global_69523[0 /*14*/], iParam0, iParam1, &Var20.f_9, Var20.f_3, Var20.f_4, Var20.f_5,
		...
		while (iVar58 < iVar60) {
			...
			if (!dlc1::_is_dlc_data_empty(Var41)) {
				if (iVar59 == iParam1 - iParam2) {
					...
					func_123(&Global_69523[0 /*14*/], iParam0, iParam1, &Var41.f_9, Var41.f_3, Var41.f_4, Var41.f_5,
...
void func_130(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 9); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_131(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 48); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_132(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 1); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_134(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 6); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_135(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 33); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_136(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 17); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_137(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 18); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_138(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 7); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_139(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 84); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_140(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 104); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_147(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 175); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_149(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 47); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_150(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 63); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_152(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 5); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_153(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 53); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_154(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 12); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_155(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 77); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_157(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 134); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_158(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 117); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_163(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 21); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_164(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 10); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_165(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_182(iParam1); break;

	case 2: func_181(iParam1); break;
...
void func_166(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 113); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_169(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 45); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_173(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 20); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_174(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 24); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_175(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 14); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_176(int iParam0) {
	...
	default: func_129(iVar10, iParam0, 99); return;
	}
	func_123(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
bool func_184(int iParam0, int iParam1, int iParam2) {
	...
	else if (Global_69523[1 /*14*/].f_3 == ped::get_ped_drawable_variation(iParam0, func_80(iParam1)) &&
			 Global_69523[1 /*14*/].f_4 == ped::get_ped_texture_variation(iParam0, func_80(iParam1))) {
		return true;
	}
	return false;
}
...
void func_190() {
	...
	if (func_479(player::player_ped_id()) && func_479(iLocal_408)) {
		...
		case 0:
			...
			iLocal_459 = -1;
			func_67(0f, 0f, 0f, 1, 1, 1, 1, 1, 1, 1, 1, 1, 0);
			iLocal_308 = cam::create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -840.7f, 185.3f, 78.4f, -14f, 0f,
													 -110.4f, 48.4f, 0, 2);
			cam::set_cam_active(iLocal_308, 1);
			cam::render_script_cams(1, 0, 3000, 1, 0, 0);
			if (func_8(iVar0)) {
			...
			if (ped::is_ped_in_any_vehicle(iLocal_408, 0) && func_8(iVar0)) {
				if (!func_51(iLocal_408, 242628503)) {
					if (vehicle::is_vehicle_stopped(iVar0)) {
						...
						ai::task_perform_sequence(iLocal_408, iVar4);
						ai::clear_sequence_task(&iVar4);
					}
				}
			}
			else if (func_50(iLocal_408, vLocal_285, 1.5f) || func_50(iLocal_408, vLocal_288, 1.5f) ||
					 func_52(&iLocal_459, 10000)) {
				if (func_191()) {
					iLocal_459 = -1;
...
// Position - 0x20121
void func_194(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
			  int iParam14, int iParam15, int iParam16, int iParam17, int iParam18) {
	func_195(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

// Position - 0x2014B
void func_195(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
...
// Position - 0x205D8
bool func_198(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
// Position - 0x206B1
bool func_199(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	vector3 vVar9;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (func_200(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_200(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_200(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_200(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_200(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_200(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_200(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_200(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_200(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_200(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_200(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_200(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_200(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_200(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_200(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_200(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x209A7
int func_200(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
// Position - 0x20AFF
Vector3 func_203() { return 2.55f, 5.665f, 2.55f; }

// Position - 0x20B16
void func_204() {
	func_226();
	func_221(&iLocal_474, &uLocal_95, "MEA1AUD", &sLocal_475, &cLocal_481);
	switch (iLocal_405) {
	case 0:
		func_34(&iLocal_407);
		if (func_479(iLocal_408)) {
	...
	case 1:
		if (func_479(player::player_ped_id()) && func_479(iLocal_408)) {
			...
			else if (func_8(iLocal_410) && ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_410, 0) &&
						 ped::is_ped_in_vehicle(iLocal_408, iLocal_410, 0) ||
					 !ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_410, 0) &&
						 !ped::is_ped_in_vehicle(iLocal_408, iLocal_410, 0)) {
				func_211();
			}
			func_209();
...
void func_205() {
	...
	if (gameplay::get_game_timer() > iLocal_370) {
		if (func_479(player::player_ped_id()) && func_479(iLocal_408) && ped::is_ped_in_any_vehicle(iLocal_408, 0) &&
			!func_208() && func_212(player::player_ped_id(), iLocal_408) < 10f) {
...
// Position - 0x20F94
void func_209() {
	if (func_9(iLocal_410) && func_479(iLocal_408) && ped::is_ped_in_vehicle(iLocal_408, iLocal_410, 0) &&
		func_212(player::player_ped_id(), iLocal_408) < 10f) {
...
// Position - 0x210B9
float func_212(int iParam0, int iParam1) { return func_213(iParam0, iParam1, 1); }
...
// Position - 0x21259
var func_220() { return player::get_player_group(player::get_player_index()); }

// Position - 0x21269
void func_221(int *iParam0, var *uParam1, char *sParam2, char *sParam3, char *sParam4) {
	switch (*iParam0) {
	case 0: break;
...
// Position - 0x2175C
void func_228() {
	if (func_479(iLocal_422) && func_212(player::player_ped_id(), iLocal_422) > 100f) {
		func_16(&iLocal_422, 0, 0, 1);
	}
	if (func_479(iLocal_416) && func_212(player::player_ped_id(), iLocal_416) > 100f) {
...
void func_229() {
	...
	if (iLocal_462 && !ui::is_message_being_displayed() && func_479(player::player_ped_id()) && func_479(iLocal_408)) {
...
void func_233() {
	...
	if (entity::is_entity_at_coord(player::player_ped_id(), vVar0, 1f, 1f, 2f, 1, 1, 0) ||
		gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1), vVar0, 1) <
			2.75f) {
		bVar3 = false;
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
...
void func_234() {
	if (iLocal_430 < 3 && func_8(iLocal_428) && func_236()) {
		if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_428, 0) &&
			ped::is_ped_in_vehicle(iLocal_408, iLocal_428, 0)) {
			if (vehicle::is_vehicle_stuck_timer_up(iLocal_428, 2, 5000) ||
				vehicle::is_vehicle_stuck_timer_up(iLocal_428, 3, 5000) ||
				vehicle::is_vehicle_stuck_timer_up(iLocal_428, 0, 5000) ||
				vehicle::is_vehicle_stuck_timer_up(iLocal_428, 1, 5000)) {
...
void func_237() {
	...
	if (func_479(player::player_ped_id()) && gameplay::get_game_timer() > iLocal_429) {
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			iVar0 = ped::get_vehicle_ped_is_in(player::player_ped_id(), 0);
			if (iVar0 != iLocal_428) {
				if (iVar0 == iLocal_410) {
...
void func_240() {
	...
	if (iLocal_337 < 3 && gameplay::get_game_timer() > iLocal_332 && func_236() &&
		ped::is_ped_in_any_vehicle(player::player_ped_id(), 0) && func_239()) {
		iVar0 = ped::get_vehicle_ped_is_in(player::player_ped_id(), 0);
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0) && !ped::is_ped_stopped(player::player_ped_id())) {
			...
			if (func_8(iVar0)) {
				if (entity::has_entity_collided_with_anything(iVar0)) {
					if (!func_208()) {
						if (iLocal_323 == 0 && func_8(iLocal_410) &&
								ped::is_ped_in_vehicle(iLocal_408, iLocal_410, 0) && func_243(iLocal_408, 0) == 2 ||
							(iLocal_323 == 1 || iLocal_323 == 2) && ped::is_ped_in_any_vehicle(iLocal_408, 0) &&
								(func_243(iLocal_408, 0) == 2 || func_243(iLocal_408, 0) == 1) ||
							iLocal_323 == 3 && ped::is_ped_in_any_police_vehicle(player::player_ped_id())) {
							func_63(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
...
// Position - 0x21FA0
void func_244() {
	if (iLocal_302 < 4 && !func_208() && func_236() && (func_239() || func_245()) &&
		ped::is_ped_group_member(iLocal_408, func_220())) {
	...
	if (iLocal_445) {
		if (func_208()) {
			if (gameplay::get_game_timer() > iLocal_448) {
				audio::play_sound_from_entity(iLocal_447, "MICHAEL_EVENT_AMANDA_REMOVE_HANDCUFFS_MASTER", iLocal_408, 0,
											  0, 0);
				iLocal_445 = 0;
			}
		}
...
bool func_251() {
	...
	if (func_479(iLocal_408)) {
		if (ped::is_ped_group_member(iLocal_408, func_220())) {
			...
			if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_410, 0) &&
				ped::is_ped_in_vehicle(iLocal_408, iLocal_410, 0)) {
				if (func_252(&uLocal_95, "MEA1AUD", "MEA1_LOSTCOP", "MEA1_LOSTCOP_1", "MEA1_LOSTCOP", "MEA1_LOSTCOP_2",
							 "MEA1_LOSTCOP", "MEA1_LOSTCOP_3", "MEA1_LOSTCOP", "MEA1_LOSTCOP_4", 7, 1, 0) ||
					func_52(&iLocal_457, 5000)) {
					func_215();
					ai::open_sequence_task(&iVar0);
					ai::task_look_at_coord(0, entity::get_offset_from_entity_in_world_coords(iLocal_410, 2f, 2f, 0f),
										   2000, 2050, 4);
					...
					ai::task_perform_sequence(iLocal_408, iVar0);
...
// Position - 0x2230F
int func_252(var *uParam0, char *sParam1, char *sParam2, char *sParam3, char *sParam4, char *sParam5, int iParam6,
			 int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12) {
	var *uVar0;
	var *uVar11;
	...
	uVar0 = 10;
	uVar11 = 10;
	func_254(4, &uVar0, &uVar11, sParam2, sParam3, sParam4, sParam5, iParam6, iParam7, iParam8, iParam9, 0, 0, 0, 0, 0,
			 0);
...
// Position - 0x226D6
void func_254(int iParam0, var *uParam1, var *uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7,
...
bool func_255(int iParam0) {
	...
	if (func_479(player::player_ped_id()) && ped::is_ped_in_any_vehicle(player::player_ped_id(), 0) &&
		func_8(iParam0)) {
		iVar0 = player::get_players_last_vehicle();
		if (func_8(iVar0)) {
			iVar1 = entity::get_entity_model(iVar0);
...
void func_256() {
	...
	case 1:
		...
		if (func_479(player::player_ped_id()) && func_479(iLocal_408)) {
			...
			else if (func_8(iLocal_410) && ped::is_ped_sitting_in_vehicle(iLocal_408, iLocal_410) &&
					 !ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_410, 0) && !func_255(iLocal_410)) {
				func_231();
				iLocal_405 = 0;
				iLocal_404 = 5;
			}
	...
	func_229();
	func_205();
	if (entity::is_entity_at_coord(player::player_ped_id(), -806.21f, 165.83f, 68.98f, 52f, 36f, 16.25f, 0, 1, 0) ||
		entity::is_entity_at_coord(iLocal_408, -806.21f, 165.83f, 68.98f, 52f, 36f, 16.25f, 0, 1, 0)) {
...
// Position - 0x2298E
void func_257() {
	if (func_479(iLocal_408) && !ped::is_ped_group_member(iLocal_408, func_220())) {
		if (func_8(iLocal_410)) {
			if (vehicle::is_vehicle_stuck_timer_up(iLocal_410, 2, 30000) ||
				vehicle::is_vehicle_stuck_timer_up(iLocal_410, 3, 30000) ||
				vehicle::is_vehicle_stuck_timer_up(iLocal_410, 0, 7000) ||
				vehicle::is_vehicle_stuck_timer_up(iLocal_410, 1, 40000)) {
				func_2(5);
			}
		}
...
// Position - 0x22A11
void func_258() {
	if (func_479(player::player_ped_id()) && func_479(iLocal_416) && !fire::is_entity_on_fire(iLocal_416) &&
		!ai::is_ped_getting_up(iLocal_416) && !ped::is_ped_prone(iLocal_416) && !ped::is_ped_ragdoll(iLocal_416)) {
...
// Position - 0x22ADC
void func_259() {
	if (iLocal_351 < 9 && !func_208() && func_236() && func_239() &&
		player::get_player_wanted_level(player::player_id()) > 0 && !func_261(player::player_ped_id())) {
		if (gameplay::get_game_timer() > iLocal_340) {
			...
			if (func_260(&uLocal_95, "MEA1AUD", "MEA1_LOSEGEN", sLocal_341[iLocal_351], "MEA1_GOTTHIS",
						 sLocal_352[iLocal_362], 7, 0, 0)) {
...
// Position - 0x22BA5
bool func_260(var *uParam0, char *sParam1, char *sParam2, var uParam3, char *sParam4, var uParam5, int iParam6,
...
void func_262() {
	if (func_479(iLocal_422) && !func_51(iLocal_422, 1805844857)) {
		if (func_264(iLocal_422, 1090519040, 1097859072) || ped::is_ped_shooting(player::player_ped_id()) ||
			func_479(iLocal_416) && ped::is_ped_shooting(iLocal_416)) {
			if (entity::is_entity_playing_anim(iLocal_422, sLocal_379, sLocal_273, 2) ||
				entity::is_entity_playing_anim(iLocal_422, sLocal_379, sLocal_277, 2)) {
...
void func_263(int iParam0) {
	if (func_479(iLocal_416) && func_479(player::player_ped_id()) && !fire::is_entity_on_fire(iLocal_416) &&
		!ai::is_ped_getting_up(iLocal_416) && !ped::is_ped_prone(iLocal_416) && !ped::is_ped_ragdoll(iLocal_416)) {
		if (func_5(iLocal_416) != joaat("weapon_pistol")) {
			ped::set_ped_can_switch_weapon(iLocal_416, 1);
			weapon::give_weapon_to_ped(iLocal_416, joaat("weapon_pistol"), -1, 0, 1);
	...
	if (func_479(iLocal_422) && !ped::is_ped_fleeing(iLocal_422) && !ped::is_ped_in_combat(iLocal_422, 0)) {
		if (entity::is_entity_playing_anim(iLocal_422, sLocal_379, sLocal_273, 2) ||
			entity::is_entity_playing_anim(iLocal_422, sLocal_379, sLocal_277, 2)) {
			entity::stop_synchronized_entity_anim(iLocal_422, -8f, 1);
		}
...
// Position - 0x22E62
bool func_265(int iParam0, float fParam1, int iParam2, int iParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
bool func_267(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	...
	if (iParam5 == 0) {
		...
		vVar3 = {func_201(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
...
void func_270() {
	...
	case 1:
		...
		func_296();
		func_292();
		if (func_479(player::player_ped_id()) && func_8(iLocal_410) &&
			entity::has_entity_been_damaged_by_entity(iLocal_410, player::player_ped_id(), 1) &&
...
// Position - 0x23343
void func_273(int iParam0) { Global_16756 = iParam0; }
...
void func_275() {
	...
	iVar0 = player::get_players_last_vehicle();
	if (ped::is_ped_injured(iLocal_416) || ped::is_ped_injured(iLocal_422) ||
		func_277(iLocal_416, 1, 1116471296, 1126825984, 0, 0, 0, 0) ||
		func_277(iLocal_422, 1, 1116471296, 1126825984, 0, 0, 0, 0) ||
		func_8(iVar0) && func_8(iLocal_410) && entity::is_entity_touching_entity(iVar0, iLocal_410) ||
		player::get_player_wanted_level(player::player_id()) > 0 &&
			gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_387,
												  1) < 30f) {
		if (!ped::is_ped_in_vehicle(iLocal_408, iLocal_410, 0)) {
			if (!ped::is_ped_group_member(iLocal_408, func_220())) {
				...
				entity::freeze_entity_position(iLocal_410, 0);
				if (func_8(iVar0) && ped::is_ped_in_vehicle(player::player_ped_id(), iVar0, 0) &&
					vehicle::is_vehicle_seat_free(iVar0, 0, 0)) {
					...
					if (!func_51(iLocal_408, 1227113341)) {
						ai::task_go_to_entity(iLocal_408, player::player_ped_id(), 20000, 7f, 2f, 1073741824, 0);
					}
				}
				else {
...
// Position - 0x235DB
int func_277(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6,
			 int iParam7) {
	vector3 vVar0;
	...
	if (func_9(player::player_ped_id()) && func_9(iParam0)) {
		...
		if (func_289(iParam0, iParam1, iParam5, iParam6, iParam7)) {
			return 1;
		}
...
bool func_280(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_281(&Local_52[iVar4 /*4*/], vVar1, iParam1, &Local_52[iVar4 /*4*/].f_3, iParam0, iParam5);
...
bool func_289(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_9(player::player_ped_id()) && func_9(iParam0)) {
		...
		if (!iParam2) {
			if (func_290(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_265(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
// Position - 0x23C75
bool func_290(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
void func_291() {
	...
	if (func_479(player::player_ped_id())) {
		...
		if (player::get_player_wanted_level(player::player_id()) < 3) {
			...
			iLocal_441 = 1;
			iLocal_457 = -1;
			if (func_479(iLocal_416) && !fire::is_entity_on_fire(iLocal_416) && !ai::is_ped_getting_up(iLocal_416) &&
				!ped::is_ped_prone(iLocal_416) && !ped::is_ped_ragdoll(iLocal_416)) {
				if (!func_51(iLocal_416, 1392476864)) {
					if (entity::is_entity_playing_anim(iLocal_416, sLocal_379, sLocal_272, 2) ||
						entity::is_entity_playing_anim(iLocal_416, sLocal_379, sLocal_276, 2)) {
					...
					ai::close_sequence_task(iVar0);
					ai::task_perform_sequence(iLocal_416, iVar0);
					ai::clear_sequence_task(&iVar0);
				}
			}
			if (func_479(iLocal_422) && !ped::is_ped_fleeing(iLocal_422)) {
				if (entity::is_entity_playing_anim(iLocal_422, sLocal_379, sLocal_273, 2) ||
					entity::is_entity_playing_anim(iLocal_422, sLocal_379, sLocal_277, 2)) {
					entity::stop_synchronized_entity_anim(iLocal_422, -8f, 1);
				}
...
void func_292() {
	...
	if (func_8(iLocal_410) && func_479(player::player_ped_id()) && func_479(iLocal_416) && func_479(iLocal_422)) {
		switch (iLocal_316) {
		case 0:
			if (func_208()) {
				Var0 = {func_225()};
				...
				if (gameplay::are_strings_equal(sVar6, "MEA1_SCENE")) {
					Local_310 = {func_295()};
					if (func_294(player::player_ped_id(), iLocal_410, 5f, 1) ||
						func_294(player::player_ped_id(), iLocal_416, 5f, 1))
						&&!gameplay::are_strings_equal(&Local_310, "MEA1_SCENE_1") &&
							!gameplay::are_strings_equal(&Local_310, "MEA1_SCENE_2") &&
							!gameplay::are_strings_equal(&Local_310, "MEA1_SCENE_3") &&
							!gameplay::are_strings_equal(&Local_310, "MEA1_SCENE_4") &&
							!gameplay::are_strings_equal(&Local_310, "MEA1_SCENE_5") &&
							!gameplay::are_strings_equal(&Local_310, "MEA1_SCENE_6") &&
							func_279(iLocal_416, 1126825984) {
...
void func_296()
{
	...
	if (func_479(player::player_ped_id()) && iLocal_261 != 5) {
		bVar0 = false;
		if (func_479(iLocal_416) && entity::is_entity_touching_entity(player::player_ped_id(), iLocal_416) ||
			func_479(iLocal_422) && entity::is_entity_touching_entity(player::player_ped_id(), iLocal_422) &&
				!(func_277(iLocal_416, 1, 1116471296, 1126825984, 0, 0, 0, 0) ||
				  func_277(iLocal_422, 1, 1116471296, 1126825984, 0, 0, 0, 0) ||
		...
		if (entity::does_entity_exist(iLocal_416) &&
				entity::has_entity_been_damaged_by_entity(iLocal_416, player::player_ped_id(), 1) ||
			entity::does_entity_exist(iLocal_416) && ped::is_ped_injured(iLocal_416) ||
			func_289(iLocal_416, 1, 0, 0, 0) || func_278(iLocal_416, 1126825984) || func_278(iLocal_422, 1126825984) ||
			entity::does_entity_exist(iLocal_422) &&
				entity::has_entity_been_damaged_by_entity(iLocal_422, player::player_ped_id(), 1) ||
			entity::does_entity_exist(iLocal_422) && ped::is_ped_injured(iLocal_422) ||
			ped::is_ped_shooting(player::player_ped_id()) || bVar0 || func_264(iLocal_422, 1090519040, 1097859072) ||
			ped::is_ped_shooting(player::player_ped_id())) {
			pathfind::disable_navmesh_in_area(vLocal_381, vLocal_384, 0);
			pathfind::set_ped_paths_in_area(vLocal_381, vLocal_384, 1, 0);
			if (bVar0) {
...
// Position - 0x24504
void func_297() {
	if (func_479(player::player_ped_id()) && func_8(iLocal_410) && func_479(iLocal_408)) {
...
// Position - 0x245B0
void func_298() {
	if (func_479(iLocal_416) && func_479(iLocal_422) && func_479(iLocal_408) && func_8(iLocal_410) &&
		streaming::has_anim_dict_loaded(sLocal_379)) {
		switch (iLocal_261) {
		case 0:
			func_299();
			iLocal_260 = ped::create_synchronized_scene(vLocal_262, vLocal_265, 2);
			ped::set_synchronized_scene_looped(iLocal_260, 1);
			ped::_set_synchronized_scene_occlusion_portal(iLocal_260, 0);
			iLocal_449 = 1;
			ai::task_synchronized_scene(iLocal_416, iLocal_260, sLocal_379, sLocal_268, 1000f, -4f, 1, 16, 1148846080,
										0);
			ai::task_synchronized_scene(iLocal_422, iLocal_260, sLocal_379, sLocal_269, 1000f, -4f, 1, 16, 1148846080,
										0);
			ai::task_synchronized_scene(iLocal_408, iLocal_260, sLocal_379, sLocal_270, 1000f, -4f, 1, 16, 1148846080,
										0);
			entity::play_synchronized_entity_anim(iLocal_410, iLocal_260, sLocal_271, sLocal_379, 1000f, -8f, 1,
												  1148846080);
			iLocal_458 = -1;
			iLocal_278 = 1;
			iLocal_261 = 2;
		...
		case 2: func_299(); break;

		case 1:
			func_299();
			iLocal_260 = ped::create_synchronized_scene(vLocal_262, vLocal_265, 2);
			ped::set_synchronized_scene_looped(iLocal_260, 0);
			ped::_set_synchronized_scene_occlusion_portal(iLocal_260, 0);
			ai::task_synchronized_scene(iLocal_416, iLocal_260, sLocal_379, sLocal_272, 1000f, -4f, 4, 16, 1148846080,
										0);
			ai::task_synchronized_scene(iLocal_422, iLocal_260, sLocal_379, sLocal_273, 1000f, -4f, 1, 16, 1148846080,
										0);
			ai::task_synchronized_scene(iLocal_408, iLocal_260, sLocal_379, sLocal_274, 1000f, -4f, 4, 16, 1148846080,
										0);
			entity::play_synchronized_entity_anim(iLocal_410, iLocal_260, sLocal_275, sLocal_379, 1000f, -8f, 1,
												  1148846080);
		...
		case 3:
			...
			if (!ped::is_synchronized_scene_running(iLocal_260)) {
				iLocal_260 = ped::create_synchronized_scene(vLocal_262, vLocal_265, 2);
				ped::set_synchronized_scene_looped(iLocal_260, 1);
				ai::task_synchronized_scene(iLocal_416, iLocal_260, sLocal_379, sLocal_276, 1000f, -4f, 1, 16,
											1148846080, 0);
				ai::task_synchronized_scene(iLocal_422, iLocal_260, sLocal_379, sLocal_277, 1000f, -4f, 1, 16,
											1148846080, 0);
...
void func_299() {
		...
		if (!func_208()) {
			...
			if (ped::is_ped_on_foot(player::player_ped_id())) {
				if (func_274(player::player_ped_id(), vLocal_262, 90f)) {
					func_63(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
					if (func_53(&uLocal_95, "MEA1AUD", "MEA1_SCENE", 7, func_293(), 0, 0) ||
						func_52(&iLocal_458, 2000)) {
						iLocal_261 = 1;
	...
	case 2:
		if (!func_208()) {
			if (func_274(player::player_ped_id(), vLocal_262, 90f) && !func_210("MEA1_02", 0, 0) &&
				!func_210("MEA1_03", 0, 0)) {
				func_63(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
...
// Position - 0x24D49
void func_301(int iParam0, char *sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14,
			  int iParam15, int iParam16) {
	int iVar0;
	int iVar1;
...
// Position - 0x24E97
void func_302(int iParam0, int iParam1) { gameplay::set_bit(&Global_1354542.f_5703[iParam0], iParam1); }

// Position - 0x24EB0
int func_303(int iParam0, int iParam1) { return gameplay::is_bit_set(Global_1354542.f_5703[iParam0], iParam1); }
...
void func_305() {
	...
	if (iLocal_440) {
		pathfind::disable_navmesh_in_area(vLocal_381, vLocal_384, 0);
		pathfind::set_ped_paths_in_area(vLocal_381, vLocal_384, 1, 0);
		if (func_479(iLocal_416) && func_8(iLocal_410) && vehicle::is_vehicle_seat_free(iLocal_410, -1, 0)) {
			func_231();
			func_63(&uLocal_95, 4, iLocal_408, "AMANDA", 1, 1);
...
// Position - 0x25007
int func_306() { return gameplay::get_game_timer(); }
...
void func_308(vector3 vParam0, float *fParam3, int iParam4, int iParam5) {
	...
	if (entity::does_entity_exist(player::get_players_last_vehicle())) {
		if (vehicle::is_vehicle_driveable(player::get_players_last_vehicle(), 0)) {
			if (func_357(24) != player::get_players_last_vehicle()) {
				if (iParam4 == 1) {
					if (func_354(entity::get_entity_coords(player::get_players_last_vehicle(), 1), iParam5, &vVar0,
								 &fVar3)) {
						vParam0 = {vVar0};
						fParam3 = fVar3;
					}
...
// Position - 0x2518D
void func_309(int iParam0, vector3 vParam1, float *fParam4, int iParam5, int iParam6) {
	struct<60> Var0;
...
int func_312(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_197(iParam0, 0, 0) ||
		func_197(iParam0, 1, 0) || func_197(iParam0, 2, 0) || func_347(iParam0) != 145 || func_326(iParam0) ||
		func_325(iParam0) || func_324(iParam0) || func_323(iParam0) || !func_313(entity::get_entity_model(iParam0))) {
		if (func_325(iParam0)) {
		}
		if (func_325(iParam0)) {
		}
...
// Position - 0x26814
int func_318() { return 0; }

// Position - 0x2681D
int func_319() { return 1; }

// Position - 0x26826
int func_320() { return 1; }
...
var func_327() {
	...
	func_337(&iVar0, time::get_clock_seconds());
	func_336(&iVar0, time::get_clock_minutes());
	func_335(&iVar0, time::get_clock_hours());
	func_330(&iVar0, time::get_clock_day_of_month());
	func_329(&iVar0, time::get_clock_month());
	func_328(&iVar0, time::get_clock_year());
	return iVar0;
}
...
// Position - 0x26D16
int func_334(var uParam0) { return uParam0 & 15; }
...
// Position - 0x28ACE
bool func_348(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
// Position - 0x29023
bool func_354(vector3 vParam0, int iParam3, var *uParam4, float *fParam5) {
	int iVar0;
...
// Position - 0x291C8
var func_356(int iParam0) { return gameplay::is_bit_set(Global_101700.f_6188[iParam0], 0); }
...
void func_358() {
	...
	fVar1 *= system::to_float(iLocal_396);
...
void func_359(int iParam0, char *sParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	...
	if (iVar0 == 1) {
		...
		iVar1 = func_406(script::get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94) {
			...
			iVar5 = func_399(script::get_this_script_name(), 1);
			if (iVar5 != -1) {
...
void func_360(int iParam0, var uParam1, int iParam2, int iParam3) {
	func_361(&Global_96040, script::get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

// Position - 0x293D4
void func_361(var *uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) {
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_28();
	...
	while (iVar1 < 3) {
		...
		if (iVar1 == func_374()) {
			func_370(player::player_ped_id(), &uParam0->f_616[iVar1 /*65*/], 1);
		}
		else {
			iVar0 = 0;
			while (iVar0 < 12) {
...
// Position - 0x2A520
bool func_369(int iParam0, var *uParam1, int iParam2, int iParam3) {
	char *sVar0;
...
bool func_371(int iParam0, int iParam1) {
	...
	iVar0 = Global_2522581[iParam0 /*3*/][func_115(iParam1)];
...
// Position - 0x2A825
void func_372(int iParam0, int iParam1, int *iParam2, int *iParam3, int iParam4, int iParam5) {
	int iVar0;
...
// Position - 0x2AD6D
void func_373(int iParam0, int iParam1, int *iParam2, int *iParam3, var *uParam4, int iParam5, int iParam6) {
	int iVar0;
...
void func_376(int iParam0, var *uParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		while (iVar0 <= 44 - 1) {
			...
			if (iVar3 != 0) {
				vVar4.x = weapon::get_ped_weapontype_in_slot(iParam0, func_380(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		iVar7 = 0;
		while (iVar7 < iVar8) {
			if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_377(Var9.f_1) && iVar70 < 50) {
...
// Position - 0x2C801
bool func_383(vector3 vParam0, char *sParam3, vector3 vParam4) {
	int iVar0;
	int iVar1;
...
// Position - 0x2C845
bool func_384(int iParam0, var *uParam1, float *fParam2) {
	*uParam1 = {0f, 0f, 0f};
	*fParam2 = 0f;
	switch (iParam0) {
	case 0:
...
bool func_385(int *iParam0) {
	if (!entity::is_entity_dead(player::player_ped_id(), 0) && !ped::is_ped_injured(player::player_ped_id())) {
		if (func_396()) {
			*iParam0 = func_391(entity::get_entity_coords(player::player_ped_id(), 0), 6, -1, 0, 1, -1);
			if (func_390(*iParam0) && !func_386(*iParam0)) {
				return true;
			}
		}
	}
...
// Position - 0x2CF2F
int func_386(int iParam0) { return func_387(iParam0, 0, 1); }
...
int func_387(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_389() == 0) {
			return gameplay::is_bit_set(func_116(func_388(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0x2D266
int func_389() { return Global_25190; }

// Position - 0x2D271
int func_390(int iParam0) { return func_387(iParam0, 5, 1); }

// Position - 0x2D281
int func_391(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
	...
	while (iVar0 <= 45) {
		if (iParam3 == 6 || iParam3 == func_395(iVar0)) {
			if (!iParam5 || func_394(iVar0)) {
				fVar1 = gameplay::get_distance_between_coords(vParam0, func_392(iVar0, 0), 1);
...
Vector3 func_392(int iParam0, int iParam1) {
	...
	case 45: return func_393(Global_93004);
	}
...
// Position - 0x2D953
int func_394(int iParam0) { return func_387(iParam0, 0, 0); }
...
// Position - 0x2DBD6
bool func_396() { return Global_91543.f_303 > 0; }
...
void func_400(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_401(uParam1, "Abigail1", func_403(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				 "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_402(iParam0), 1, 0);
		break;

	case 1:
		func_401(uParam1, "Abigail2", func_403(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				 -1, 4, 1, 0, 2359, func_402(iParam0), 1, 0);
		break;

	case 2:
		func_401(uParam1, "Barry1", func_403(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				 4, 1, 0, 2359, func_402(iParam0), 1, 0);
		break;

	case 3:
		func_401(uParam1, "Barry2", func_403(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				 4, 4, 0, 2359, func_402(iParam0), 1, 1);
		break;

	case 4:
		func_401(uParam1, "Barry3", func_403(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2,
				 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 5:
		func_401(uParam1, "Barry3A", func_403(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0,
				 "", 166, 0, 7, 4, 2, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 6:
		func_401(uParam1, "Barry3C", func_403(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				 7, 4, 2, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 7:
		func_401(uParam1, "Barry4", func_403(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0,
				 "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_402(iParam0), 0, 0);
		break;

	case 8:
		func_401(uParam1, "Dreyfuss1", func_403(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				 0, "", 0, 0, -1, 4, 2, 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 9:
		func_401(uParam1, "Epsilon1", func_403(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1,
				 10, 4, 1, 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 10:
		func_401(uParam1, "Epsilon2", func_403(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0,
				 11, 4, 1, 0, 2359, func_402(iParam0), 1, 0);
		break;

	case 11:
		func_401(uParam1, "Epsilon3", func_403(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				 0, 0, 12, 4, 1, 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 12:
		func_401(uParam1, "Epsilon4", func_403(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				 "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 13:
		func_401(uParam1, "Epsilon5", func_403(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16,
				 "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_402(iParam0), 1, 0);
		break;

	case 14:
		func_401(uParam1, "Epsilon6", func_403(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 15:
		func_401(uParam1, "Epsilon7", func_403(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 16:
		func_401(uParam1, "Epsilon8", func_403(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_402(iParam0), 1, 0);
		break;

	case 17:
		func_401(uParam1, "Extreme1", func_403(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 18:
		func_401(uParam1, "Extreme2", func_403(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 19:
		func_401(uParam1, "Extreme3", func_403(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 20:
		func_401(uParam1, "Extreme4", func_403(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 21:
		func_401(uParam1, "Fanatic1", func_403(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_402(iParam0), 1, 0);
		break;

	case 22:
		func_401(uParam1, "Fanatic2", func_403(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_402(iParam0), 1, 0);
		break;

	case 23:
		func_401(uParam1, "Fanatic3", func_403(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_402(iParam0), 0, 1);
		break;

	case 24:
		func_401(uParam1, "Hao1", func_403(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_402(iParam0), 0, 1);
		break;

	case 25:
		func_401(uParam1, "Hunting1", func_403(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 26:
		func_401(uParam1, "Hunting2", func_403(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 27:
		func_401(uParam1, "Josh1", func_403(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_402(iParam0), 1, 0);
		break;

	case 28:
		func_401(uParam1, "Josh2", func_403(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_402(iParam0), 1, 1);
		break;

	case 29:
		func_401(uParam1, "Josh3", func_403(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_402(iParam0), 1, 1);
		break;

	case 30:
		func_401(uParam1, "Josh4", func_403(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_402(iParam0), 1, 0);
		break;

	case 31:
		func_401(uParam1, "Maude1", func_403(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 32:
		func_401(uParam1, "Minute1", func_403(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 33:
		func_401(uParam1, "Minute2", func_403(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 34:
		func_401(uParam1, "Minute3", func_403(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 35:
		func_401(uParam1, "MrsPhilips1", func_403(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 36:
		func_401(uParam1, "MrsPhilips2", func_403(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_402(iParam0), 0, 0);
		break;

	case 37:
		func_401(uParam1, "Nigel1", func_403(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_402(iParam0), 1, 0);
		break;

	case 38:
		func_401(uParam1, "Nigel1A", func_403(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_402(iParam0), 1, 1);
		break;

	case 39:
		func_401(uParam1, "Nigel1B", func_403(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_402(iParam0), 1, 1);
		break;

	case 40:
		func_401(uParam1, "Nigel1C", func_403(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_402(iParam0), 1, 1);
		break;

	case 41:
		func_401(uParam1, "Nigel1D", func_403(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_402(iParam0), 1, 1);
		break;

	case 42:
		func_401(uParam1, "Nigel2", func_403(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_402(iParam0), 1, 1);
		break;

	case 43:
		func_401(uParam1, "Nigel3", func_403(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_402(iParam0), 1, 1);
		break;

	case 44:
		func_401(uParam1, "Omega1", func_403(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 45:
		func_401(uParam1, "Omega2", func_403(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 46:
		func_401(uParam1, "Paparazzo1", func_403(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 47:
		func_401(uParam1, "Paparazzo2", func_403(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 48:
		func_401(uParam1, "Paparazzo3", func_403(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 49:
		func_401(uParam1, "Paparazzo3A", func_403(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 50:
		func_401(uParam1, "Paparazzo3B", func_403(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 51:
		func_401(uParam1, "Paparazzo4", func_403(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 52:
		func_401(uParam1, "Rampage1", func_403(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 54:
		func_401(uParam1, "Rampage3", func_403(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_402(iParam0), 1, 0);
		break;

	case 55:
		func_401(uParam1, "Rampage4", func_403(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_402(iParam0), 1, 0);
		break;

	case 56:
		func_401(uParam1, "Rampage5", func_403(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_402(iParam0), 0, 0);
		break;

	case 53:
		func_401(uParam1, "Rampage2", func_403(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_402(iParam0), 1, 0);
		break;

	case 57:
		func_401(uParam1, "TheLastOne", func_403(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 58:
		func_401(uParam1, "Tonya1", func_403(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 59:
		func_401(uParam1, "Tonya2", func_403(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_402(iParam0), 0, 1);
		break;

	case 60:
		func_401(uParam1, "Tonya3", func_403(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_402(iParam0), 0, 1);
		break;

	case 61:
		func_401(uParam1, "Tonya4", func_403(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_402(iParam0), 0, 1);
		break;

	case 62:
		func_401(uParam1, "Tonya5", func_403(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_402(iParam0), 0, 1);
		break;
...
// Position - 0x2F31A
void func_401(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
int func_404(int iParam0)
{
	switch (iParam0) {
	case 69:
	case 70: return func_405(Global_101700.f_8044.f_99.f_205[10]);

	case 74:
	case 75: return func_405(Global_101700.f_8044.f_99.f_205[8]);

	case 84:
	case 85: return func_405(Global_101700.f_8044.f_99.f_205[11]);

	case 90: return func_405(Global_101700.f_8044.f_99.f_205[7]);

	case 93: return func_405(Global_101700.f_8044.f_99.f_205[9]);
	}
	return 0;
}
...
void func_409() {
	...
	case 1:
		if (func_479(player::player_ped_id())) {
			if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_387,
													  1) < 200f) {
				iLocal_405 = 2;
			}
		}
	...
	case 2:
		func_411();
		if (func_479(player::player_ped_id()) && func_479(iLocal_408) && entity::does_entity_exist(iLocal_422) &&
			entity::does_entity_exist(iLocal_416) && func_8(iLocal_410)) {
			if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_387,
													  1) < 30f) {
				iLocal_457 = -1;
				iLocal_405 = 0;
...
// Position - 0x2FCA5
void func_410() {
	if (iLocal_305 < 1 && func_479(player::player_ped_id()) && !func_208() && !func_210("MEA1_01", 0, 0) &&
		gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_387, 1) >
			30f * 3f) {
...
void func_411() {
	if (!entity::does_entity_exist(iLocal_410)) {
		if (streaming::has_model_loaded(iLocal_411)) {
			iLocal_410 = vehicle::create_vehicle(iLocal_411, vLocal_412, fLocal_415, 1, 1);
	...
	if (!entity::does_entity_exist(iLocal_416)) {
		if (streaming::has_model_loaded(iLocal_417)) {
			...
			entity::set_entity_health(iLocal_416, 110);
...
// Position - 0x2FFFD
int func_412(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	int iVar0;
...
// Position - 0x3011A
void func_416(int iParam0, vector3 vParam1, float fParam4) {
	if (ui::does_blip_exist(*iParam0)) {
...
void func_417() {
	...
	if (ui::has_additional_text_loaded(0)) {
		...
		func_476();
		if (func_33(0) && func_479(player::player_ped_id())) {
			vVar1 = {entity::get_entity_coords(player::player_ped_id(), 1)};
			fVar4 = entity::get_entity_heading(player::player_ped_id());
			func_441(&uVar0, vVar1, fVar4, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
			gameplay::clear_area_of_vehicles(vVar1, 100f, 0, 0, 0, 0, 0);
		}
		if (func_440()) {
			iVar5 = func_439();
			if (Global_86001 == 1) {
			...
			case 2:
				func_418(entity::get_entity_coords(player::player_ped_id(), 1), 1112014848, 12, 5000, 0, 0);
...
// Position - 0x304CB
void func_418(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	int iVar1;
...
// Position - 0x3053A
void func_419() { Global_17151.f_6 = 1; }
...
void func_425() {
	...
	if (func_479(player::player_ped_id())) {
		...
		if (func_8(iVar0)) {
			...
			func_441(&uVar1, -836.72f, -179.78f, 37.1f, 32.61f, 0, 1, 1, 1, 1, joaat("tailgater"), 0, 145, 1);
		}
		gameplay::clear_area_of_vehicles(-836.72f, -179.78f, 37.1f, 100f, 0, 0, 0, 0, 0);
		cam::set_gameplay_cam_relative_pitch(0f, 1065353216);
		cam::set_gameplay_cam_relative_heading(0f);
...
void func_429(int iParam0, int iParam1) {
	...
	func_67(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, iParam1, 1, 1, 1);
}
...
// Position - 0x309BA
void func_432(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	vector3 vVar0;
	float fVar3;
	...
	if (func_438() && func_433(iParam1, iParam2, iParam3, 1)) {
		vVar0 = {0f, 0f, 0f};
		fVar3 = 0f;
		func_441(uParam0, vVar0, fVar3, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
...
// Position - 0x30B4E
int func_435() { return func_436(&Global_96040.f_2311); }
...
// Position - 0x30BC0
int func_437(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
// Position - 0x30C3B
var func_438() { return Global_93635.f_2311.f_8; }
...
// Position - 0x30C9A
void func_441(var *uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8,
...
// Position - 0x30E2D
int func_442(int *iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7) {
	int iVar0;
	var *uVar1;
	struct<97> Var5;
	int iVar103;
		...
		if (Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/] == Var5) {
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/],
				...
				func_453(iParam0, &Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/].f_31,
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/],
				...
				func_453(iParam0, &Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/].f_31,
...
// Position - 0x31C6B
void func_443(int iParam0, var *uParam1, int iParam2, int iParam3) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
	...
	if (func_14(iParam0) && entity::does_entity_exist(*uParam1) && vehicle::is_vehicle_driveable(*uParam1, 0)) {
		...
		if (vehicle::get_vehicle_mod_kit(*uParam1) >= 0 && vehicle::get_vehicle_mod_kit(*uParam1) < 255 &&
			func_447(*uParam1, 0, &iVar0)) {
			func_351(uParam1, &Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_31,
			...
			if (iParam3) {
				...
				Global_101700.f_19077[iParam0 /*43*/].f_31 = func_446(*uParam1);
				...
				func_444(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_5,
				...
				func_444(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0,
...
int func_447(int iParam0, int iParam1, int *iParam2) {
	...
	*iParam2 = 0;
	...
	iVar0 = entity::get_entity_model(iParam0);
	if (!func_448(iVar0, iParam1, iParam2)) {
		return 0;
	}
	...
	if (!network::network_is_game_in_progress()) {
		if (func_324(iParam0) && entity::get_entity_model(iParam0) != joaat("sentinel2") &&
...
// Position - 0x343F8
bool func_452(int iParam0) { return vehicle::is_vehicle_extra_turned_on(iParam0, 5); }
...
int func_453(int iParam0, var *uParam1, var *uParam2) {
	...
	if (func_456(entity::get_entity_model(*iParam0), 1) &&
		vehicle::get_vehicle_mod(*iParam0, 24) != func_455(*iParam0, (*uParam1)[38] - 1)) {
		vehicle::set_vehicle_mod(*iParam0, 24, func_455(*iParam0, (*uParam1)[38] - 1), 0);
	}
	if (func_454(*iParam0)) {
	...
	while (iVar0 < 9) {
		if (entity::does_entity_exist(Global_89155[iVar0])) {
			if (iParam0 == 145 || Global_89165[iVar0] == iParam0) {
				if (iParam1 == 0 || entity::get_entity_model(Global_89155[iVar0]) == func_339(iParam0, iParam1)) {
...
// Position - 0x34A44
void func_459(vector3 vParam0, float fParam3, int iParam4) {
	int iVar0;
...
void func_460(int iParam0) {
	...
	if (func_338(&Global_68531.f_555[0 /*21*/], iParam0)) {
		...
		Global_68531[iParam0] = 1;
		if (gameplay::is_bit_set(Global_68531.f_555[0 /*21*/].f_9, 13)) {
			if (iParam0 == 24 && func_344(iParam0, 0) && Global_69440.f_66 == 0 &&
				Global_101700.f_31389.f_1958[Global_68531.f_555[0 /*21*/].f_14] != 0 &&
				Global_101700.f_31389.f_1958[Global_68531.f_555[0 /*21*/].f_14] > 3 &&
				(!func_461(0, Global_68531.f_555[0 /*21*/].f_12) || !func_461(1, Global_68531.f_555[0 /*21*/].f_12))) {
...
// Position - 0x34C78
int func_462(var *uParam0) { return *uParam0; }

// Position - 0x34C83
int func_463(vector3 vParam0, float fParam3) { return func_464(&Global_96040.f_2311, vParam0, fParam3, 0); }

// Position - 0x34C9D
int func_464(var *uParam0, vector3 vParam1, float fParam4, int iParam5) {
	int iVar0;
	vector3 vVar1;
	bool bVar4;
	var uVar5;
	...
	if (func_436(uParam0)) {
		...
		if (func_472(uParam0)) {
			...
			if (entity::does_entity_exist(iVar0)) {
				...
				else if (!func_466(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10 &&
...
// Position - 0x35011
int func_466(int iParam0, vector3 vParam1, bool bParam4) {
	int iVar0;
	var uVar1[3];
	int iVar5;
	int iVar6;
	...
	case joaat("cuban800"):
		...
		iVar6 = 0;
		while (iVar6 <= iVar5 - 1) {
			if (func_467(iParam0, uVar1[iVar6], 1) &&
				func_437(entity::get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)) {
				if (!bParam4 || func_348(vParam1, 0f, 0f, 0f, 0) ||
...
void func_468(int iParam0, var *uParam1, int iParam2, int iParam3) {
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (gameplay::is_bit_set(uParam1->f_77, 15) || func_471(iParam0) ||
...
// Position - 0x3578D
var func_470() { return dlc2::is_dlc_present(-1691188696); }
...
// Position - 0x3581E
int func_473() { return func_472(&Global_96040.f_2311); }

// Position - 0x35831
void func_474() { func_475(&Global_96040.f_2311); }
...
void func_476() {
	...
	fVar0 = func_477(player::player_ped_id(), vLocal_387, 1);
...
// Position - 0x3589F
var func_477(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
