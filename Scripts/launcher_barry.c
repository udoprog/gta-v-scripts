...
void __EntryFunction__() {
	...
	if (player::has_force_cleanup_occurred(83)) {
		...
		if (Var0 != -1) {
			if (Global_100787[Var0 /*10*/].f_9 != -1) {
				...
				func_289(&Global_100787[Var0 /*10*/].f_9);
			}
		}
		func_272(&Var0, 1);
	}
	if (!func_269(&Var0, vVar61, 1f)) {
		func_268();
	...
	while (true) {
		...
		if (!func_193(&Var0, Var0 != 2)) {
			func_272(&Var0, 1);
		}
		func_192(Var0);
		func_185(&iLocal_93, &Var0.f_9, vVar61);
		if (func_184(Var0.f_28[0])) {
			if (Var0 == 2) {
				if (func_182(&Var0, entity::get_entity_coords(Var0.f_28[0], 1), "BARY1AU", "BARY1_PRELEA", 5, "BARRY",
							 10000, 23f)) {
					func_181(&Var0, Local_97, 1, 0);
				}
			}
			else if (Var0 == 3) {
				if (func_182(&Var0, entity::get_entity_coords(Var0.f_28[0], 1), "BARY2AU", "BARY2_AMB", 3, "BARRY",
							 10000, 23f)) {
				}
			}
			else if (Var0 == 4) {
				func_171(&iLocal_105, entity::get_entity_coords(Var0.f_28[0], 1), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar64 = 0;
		if (func_170(Var0)) {
...
int func_2(int iParam0) {
	...
	if (!func_150()) {
		while (!func_141(*iParam0)) {
			...
			if (!func_193(iParam0, *iParam0 != 2)) {
				func_290("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() "
						 "[TERMINATING]");
				return 0;
			}
			system::wait(0);
	...
	if (!func_98(iParam0)) {
		func_290("STEP_7_COMMON_LaunchMission - Trying to launch a null script "
				 "string name");
		return 0;
	}
...
int func_98(int iParam0) {
	...
	if (func_127(&iParam0->f_1)) {
		...
		if (cutscene::has_cutscene_loaded()) {
			...
			func_290("Initial cutscene wasn't loaded in time to pass to RC "
					 "mission.");
...
// Position - 0xAC31
void func_156() { func_27(&Global_93635.f_2311, &Global_93635, 0, 1, 1, 0); }
	...
	if (iParam0 == 1) {
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			...
			if (ped::is_ped_in_any_heli(player::player_ped_id()) || ped::is_ped_in_any_plane(player::player_ped_id())) {
				func_290("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for "
						 "plane or helicopter.");
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_169() || Global_100747 ||
						Global_25192 || func_168() || func_167(8, -1) || func_78() || func_166() || func_165() ||
						func_164() || Global_101700.f_6647.f_919[iVar0] == 5) {
						return false;
					}
					break;

				case 1:
					if (player::is_player_being_arrested(player::player_id(), 1) || func_169() || Global_25192 ||
						func_168() || func_167(8, -1) || func_165() || func_78() || func_166() || func_164() ||
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						player::is_player_climbing(player::player_id()) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_169() || Global_100747 ||
						Global_25192 || func_168() || func_167(8, -1) || func_165() || func_78() || func_166() ||
						func_164() || Global_101700.f_6647.f_919[iVar0] == 5 || Global_36328 != -1) {
						return false;
					}
					break;
				...
				case 3:
					if (ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_169() || Global_100747 ||
						Global_25192 || func_168() || func_167(8, -1) || func_78() || func_166() || func_164() ||
						Global_101700.f_6647.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 4:
					if (func_169() || player::get_player_wanted_level(player::player_id()) > 0 || func_167(8, -1) ||
						func_164() || func_163() || Global_101700.f_6647.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 6:
					if (entity::does_entity_exist(player::player_ped_id())) {
						if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
							...
							player::is_player_being_arrested(player::player_id(), 1) ||
							player::is_player_climbing(player::player_id()) || func_169() || Global_25192 ||
							func_168() || func_167(8, -1) || func_166() || func_165() || func_164() ||
							Global_101700.f_6647.f_919[iVar0] == 5) {
							return false;
						}
					}
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						entity::is_entity_in_air(player::player_ped_id()) ||
						ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) || func_169() || func_166() ||
						Global_100747 || Global_25192 || func_168() || Global_36912 || func_167(8, -1) || func_165() ||
						func_163() || func_164() || Global_101700.f_6647.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 8:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						player::is_player_being_arrested(player::player_id(), 1) ||
						player::is_player_climbing(player::player_id()) || func_169() || Global_100747 ||
						Global_25192 || func_168() || func_167(8, -1) || func_165() || func_163() || func_78() ||
						func_166() || func_164()) {
						return false;
					}
					break;
...
// Position - 0xB51C
var func_162() { return Global_91530.f_1; }
...
// Position - 0xB594
bool func_166() { return Global_91543.f_304 > 0; }
...
// Position - 0xB5E0
var func_168() { return Global_1315233; }
...
// Position - 0xB62B
void func_171(int *iParam0, vector3 vParam1, char[4] cParam4, char *sParam5) {
	switch (*iParam0) {
	case 0:
	...
	case 1:
		if (func_180(player::player_ped_id(), vParam1, 1) <= 20f) {
	...
	case 2:
		...
		else if (func_180(player::player_ped_id(), vParam1, 1) >= 25f) {
			func_128();
			*iParam0 = 0;
		}
		break;
...
// Position - 0xB716
int func_173(char *sParam0, int iParam1, int iParam2) {
	Global_15746 = 0;
...
// Position - 0xBCCC
void func_181(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7,
			  var uParam8, int iParam9, int iParam10) {
	int iVar0;
	int iVar1;
...
// Position - 0xBD69
bool func_182(int iParam0, vector3 vParam1, char[4] cParam4, char *sParam5, int iParam6, char *sParam7, int iParam8,
			  float fParam9) {
	var *uVar0;
...
// Position - 0xC054
bool func_189() { return Global_89133; }
...
int func_193(int iParam0, bool bParam1) {
	...
	if (Global_69702) {
		func_290("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer "
				 "[TERMINATING]");
		return 0;
	}
	func_95(*iParam0, &Var0);
	...
	if (func_224(*iParam0)) {
		...
		func_290("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (iParam0->f_25 == 1) {
	...
	if (*iParam0 == 10) {
		if (fire::is_explosion_in_sphere(-1, iParam0->f_17[0 /*3*/], 8f)) {
			func_290("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission "
					 "trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17) {
		if (!gameplay::is_bit_set(Var0.f_26, func_90())) {
			func_290("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player "
	...
	if (func_184(iParam0)) {
		...
		case 2:
			if (!func_196(uParam1) || !entity::is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3)) {
				...
				else if (func_196(uParam1) && uParam1->f_4 == 0 &&
	...
	if (func_184(player::player_ped_id())) {
		...
		while (iVar0 <= uParam0->f_28 - 1) {
			if (func_111(uParam0->f_28[iVar0])) {
				...
				switch (*uParam0) {
				case 19: func_223(uParam0->f_28[iVar0]); break;
		...
		while (iVar0 <= iVar1) {
			if (entity::does_entity_exist(uParam0->f_35[iVar0])) {
				if (entity::is_entity_dead(uParam0->f_35[iVar0], 0)) {
					func_290("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (!ped::is_ped_injured(uParam0->f_28[iVar0])) {
					if (ped::is_ped_sitting_in_any_vehicle(player::player_ped_id())) {
						if (entity::is_entity_touching_entity(player::player_ped_id(), uParam0->f_28[iVar0])) {
							...
							func_290("STEP_5_COMMON_RCfineAndInRange - Random "
					...
					if (func_222(*uParam0)) {
						...
						if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(uParam0->f_28[iVar0], 1), 15f)) {
							...
							func_290("STEP_5_COMMON_RCfineAndInRange - There "
					...
					if (!func_204(*uParam0)) {
						...
						if (player::get_player_wanted_level(player::player_id()) > 0) {
							...
							func_290("STEP_5_COMMON_RCfineAndInRange - Player "
...
// Position - 0xD0B2
bool func_206(int iParam0, float fParam1) { return func_207(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_207(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_208(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0xD18B
int func_208(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
...
int func_211(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	vVar0 = {func_213(entity::get_entity_coords(iParam1, 1) - entity::get_entity_coords(iParam0, 1))};
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_213(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
...
bool func_217(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_184(player::player_ped_id()) && func_184(iParam0)) {
		...
		if (!iParam2) {
			if (func_221(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_218(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
bool func_220(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	...
	vVar0 = {func_213(vParam1 - entity::get_entity_coords(iParam0, 1))};
...
// Position - 0xD863
bool func_221(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
void func_231() {
	...
	fVar3 = 12f;
	if (func_184(player::player_ped_id())) {
		if (func_232(player::player_ped_id(), vVar0, fVar3)) {
			func_135();
		}
	}
}
...
// Position - 0xDD48
var func_236() { return ped::add_scenario_blocking_area(-564f, -1758.1f, 16.5f, -419.31f, -1649f, 23f, 0, 1, 1, 1); }
...
int func_241(var *uParam0) {
	...
	case 2:
		...
		if (!entity::does_entity_exist(uParam0->f_35[0])) {
			func_243(&uParam0->f_35[0], iVar0[0], vVar4, fVar16);
			if (entity::does_entity_exist(uParam0->f_35[0])) {
		...
		if (!entity::does_entity_exist(uParam0->f_41[0])) {
			func_242(&uParam0->f_41[0], iVar0[1], vVar4 + vVar10, 0f);
			if (entity::does_entity_exist(uParam0->f_41[0]) && entity::does_entity_exist(uParam0->f_35[0])) {
				entity::attach_entity_to_entity(uParam0->f_41[0], uParam0->f_35[0], 0, vVar10, vVar13, 0, 0, 0, 0, 2,
												1);
			}
			else {
				bVar19 = false;
		...
		if (!entity::does_entity_exist(uParam0->f_35[1])) {
			func_243(&uParam0->f_35[1], iVar0[2], vVar7, fVar17);
...
// Position - 0xE15E
void func_242(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_199(uParam0);
...
// Position - 0xE185
void func_243(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_244(uParam0);
...
int func_246(var *uParam0) {
	...
	case 2:
		bVar17 = true;
		func_243(&uParam0->f_35[0], iVar0[0], vVar5, fVar14);
		if (entity::does_entity_exist(uParam0->f_35[0])) {
			vehicle::set_vehicle_colour_combination(uParam0->f_35[0], 1);
			vehicle::set_vehicle_alarm(uParam0->f_35[0], 0);
			vehicle::set_vehicle_model_is_suppressed(iVar0[0], 1);
		...
		if (!entity::does_entity_exist(uParam0->f_41[0])) {
			func_242(&uParam0->f_41[0], iVar0[1], vVar5 + vVar8, 0f);
			if (entity::does_entity_exist(uParam0->f_41[0]) && entity::does_entity_exist(uParam0->f_35[0])) {
				entity::attach_entity_to_entity(uParam0->f_41[0], uParam0->f_35[0], 0, vVar8, 0f, 0f, 0f, 0, 0, 1, 0, 2,
												1);
			}
			else {
				bVar17 = false;
		...
		if (!entity::does_entity_exist(uParam0->f_35[1])) {
			func_243(&uParam0->f_35[1], iVar0[2], vVar11, fVar15);
		}
		if (!entity::does_entity_exist(uParam0->f_28[0])) {
			func_247(&uParam0->f_28[0], iVar0[3], vVar11, fVar15, 6);
		}
		if (!entity::does_entity_exist(uParam0->f_28[1])) {
			func_247(&uParam0->f_28[1], iVar0[3], vVar11, fVar15, 6);
		}
		if (bVar17) {
			iLocal_91 = 3;
		}
...
// Position - 0xE5E1
void func_247(var *uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	func_248(uParam0);
...
int func_249(var *uParam0) {
	...
	case 0:
		...
		func_254(&uParam0->f_48, "rcm_barry3", "bar_3_rcm_barry_standing_on_street_base",
	...
	case 2:
		bVar8 = true;
		if (!entity::does_entity_exist(uParam0->f_28[0])) {
			if (func_250(&uParam0->f_28[0], 49, vVar3, fVar6, "RC LAUNCHER: BARRY 3", 1)) {
		...
		if (!entity::does_entity_exist(uParam0->f_41[0])) {
			func_242(&uParam0->f_41[0], iVar0[1], vVar3 + Vector(0f, 0f, 5f), -115.18f);
...
// Position - 0xE838
bool func_250(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
...
// Position - 0xE894
bool func_251(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	int iVar0;
...
int func_255(var *uParam0) {
	...
	case 2:
		bVar11 = true;
		if (!entity::does_entity_exist(uParam0->f_28[0])) {
			if (func_250(&uParam0->f_28[0], 49, vVar6, fVar9, "RC LAUNCHER: BARRY 2", 1)) {
				ped::set_ped_prop_index(uParam0->f_28[0], 1, 0, 0, 0);
			}
			else {
				bVar11 = false;
...
void func_256(var *uParam0, int iParam1) {
	...
	fVar3 = 23.45f;
	func_242(uParam0, iParam1, vVar0, fVar3);
}

// Position - 0xED9C
float func_257(float fParam0) { return fParam0 * 57.29578f; }
...
int func_258(var *uParam0) {
	...
	case 2:
		bVar13 = true;
		if (!entity::does_entity_exist(uParam0->f_28[0])) {
			if (func_250(&uParam0->f_28[0], 49, vVar8, fVar11, "RC LAUNCHER: BARRY 1", 1)) {
				ped::set_ped_prop_index(uParam0->f_28[0], 1, 0, 0, 0);
			}
			else {
				bVar13 = false;
...
int func_260(int iParam0) {
	...
	if (Global_69702) {
		func_290("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is "
				 "running [TERMINATING]");
		return 0;
	}
	if (!Global_101700.f_8044 && !func_93(1)) {
		func_290("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not "
				 "active");
		return 0;
	}
	if (!func_261(iParam0)) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_290("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (Global_91491.f_11 == 6) {
		if (Global_91491 < 9) {
			...
			if (gameplay::are_strings_equal(&Global_91491.f_3, sVar0)) {
				func_290("STEP_3_COMMON_CanRCLaunch - Script denied as a "
	...
	if (script::_get_number_of_instances_of_script_with_name_hash(joaat("candidate_controller")) == 0) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_290("STEP_3_COMMON_CanRCLaunch - Script denied as "
...
// Position - 0xF618
int func_269(int iParam0, vector3 vParam1, float fParam4) {
	int iVar0[4];
	int iVar5;

	if (func_90() == 0) {
		if (func_270(2, vParam1, fParam4, iParam0)) {
			return 1;
		}
	}
	else if (func_90() == 2) {
		if (func_270(3, vParam1, fParam4, iParam0)) {
			return 1;
		}
	}
	iVar0[0] = 4;
	...
	iVar5 = 0;
	while (iVar5 < iVar0) {
		if (func_270(iVar0[iVar5], vParam1, fParam4, iParam0)) {
			iVar5 = iVar0;
			return 1;
		}
		iVar5++;
...
// Position - 0xF6A9
bool func_270(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	int iVar0;
	struct<7> Var1;
...
// Position - 0xF727
bool func_271(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
void func_279(var *uParam0, int iParam1, int iParam2, int iParam3) {
	...
	func_283(uParam0, iParam2);
	func_280(uParam0, iParam3);
}

// Position - 0xF921
void func_280(var *uParam0, bool bParam1) { func_281(&uParam0->f_41, bParam1); }
...
// Position - 0xF9AC
void func_283(var *uParam0, bool bParam1) { func_284(&uParam0->f_35, bParam1); }
...
// Position - 0xFA33
void func_286(var *uParam0, int iParam1) { func_287(&uParam0->f_28, iParam1); }
