...
void __EntryFunction__() {
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	iLocal_92 = func_496(60);
	iLocal_93 = func_496(14);
	iLocal_226 = 1;
	iLocal_236 = -1;
	iLocal_237 = -1;
	fLocal_250 = 300f;
	...
	if (func_461()) {
		...
		switch (iVar0) {
		case 0: func_448(-2907.29f, 3215.91f, 9.866f, 215.2019f, 1, 0); break;
	...
	while (true) {
		...
		switch (iLocal_190) {
		case 0: func_427(); break;

		case 1: func_424(); break;

		case 2: func_388(); break;

		case 3: func_379(); break;

		case 4: func_347(); break;

		case 5: func_23(); break;
...
void func_2() {
	...
	case 0:
		...
		switch (iLocal_264) {
		case 4: sVar0 = "EPS6_FAIL"; break;

		case 7: sVar0 = "EPS6_DEAD"; break;

		case 8: sVar0 = "EPS6_HURT"; break;

		case 5: sVar0 = "EPS6_SPOOK"; break;

		case 6: sVar0 = "EPS6_ATTACK"; break;

		case 1: sVar0 = "EPS6_04"; break;

		case 2: sVar0 = "EPS6_LEFT"; break;

		case 3: sVar0 = "EPS6_ABAND"; break;

		case 9: sVar0 = "EPS6_BUDDYDEAD"; break;

		case 10: sVar0 = "EPS6_BUDDYSPOOK"; break;

		case 11: sVar0 = "EPS6_BUDDYHURT"; break;

		case 12: sVar0 = "EPS6_STICKYB"; break;
...
// Position - 0x756
void func_8(vector3 vParam0, float fParam3) { func_9(&Global_96040.f_2311, vParam0, fParam3); }
...
// Position - 0x7B1
bool func_11(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
void func_23() {
	...
	case 1:
		...
		if (bLocal_210) {
			...
			func_234();
			if (func_233()) {
				if (func_232(player::player_ped_id(), vLocal_156.x, 1) > 300f &&
					!entity::is_entity_on_screen(vLocal_156.x)) {
					ai::open_sequence_task(&iLocal_261);
					ai::task_plane_mission(0, vLocal_156.x, 0, 0, 3891.478f, 2298.554f, 301.6707f, 4, 40f, 10f, -1f,
										   300, 30);
					ai::task_plane_mission(0, vLocal_156.x, 0, 0, 1562.099f, 2167.677f, 329.9366f, 4, 40f, 10f, -1f,
										   300, 100);
					ai::set_sequence_to_repeat(iLocal_261, 1);
					ai::close_sequence_task(iLocal_261);
					ai::task_perform_sequence(Local_174, iLocal_261);
					ai::clear_sequence_task(&iLocal_261);
					iLocal_191 = 2;
				}
				if (!func_22() && !ped::is_ped_fleeing(Local_174) && !ped::is_ped_ragdoll(Local_174) &&
					!ped::is_ped_prone(Local_174) && !ped::is_ped_injured(Local_174) &&
					!ped::is_ped_in_any_vehicle(Local_174, 0)) {
	...
	case 2:
		...
		if (!bLocal_210) {
			if (func_233()) {
				if (vehicle::get_landing_gear_state(vLocal_156.x) != 3 ||
					vehicle::get_landing_gear_state(vLocal_156.x) != 1) {
...
void func_26(int iParam0, int iParam1) {
	...
	if (Global_100787[iVar0 /*10*/].f_9 == -1) {
		...
		func_192(&Global_100787[iVar0 /*10*/].f_9);
	}
	if (iParam1) {
		if (player::is_player_playing(player::player_id())) {
			player::set_player_wanted_level(player::player_id(), 0, 0);
...
void func_30() {
	...
	if (fVar8 > 0f && system::floor(fVar8) < system::floor(Global_101700.f_9153.f_3853)) {
		func_25(13, system::floor(Global_101700.f_9153.f_3853));
	}
...
// Position - 0x168E
int func_31() { return Global_25190; }
...
// Position - 0x1BE0
void func_43() { func_44(&Global_96040); }
...
// Position - 0x2332
void func_50(int *iParam0) { *iParam0 = -15; }

// Position - 0x2340
void func_51() {
	StringCopy(&Global_93627, "", 32);
	func_44(&Global_93635);
}
...
int func_54(int iParam0, int iParam1, int iParam2) {
	...
	Global_69523[1 /*14*/] = {func_105(iVar0, iParam1, iParam2)};
	...
	if (iParam1 == 12) {
		...
		Global_69523[1 /*14*/] = {func_105(iVar0, iParam1, uVar31[iParam1])};
		if (ped::get_number_of_ped_drawable_variations(iParam0, func_97(iParam1)) > 0 &&
			ped::get_number_of_ped_texture_variations(iParam0, func_97(iParam1), Global_69523[1 /*14*/].f_3) > 0) {
			ped::set_ped_component_variation(iParam0, func_97(iParam1), Global_69523[1 /*14*/].f_3,
...
bool func_55(int iParam0, int iParam1, int *iParam2) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_63 != -99) {
		if (!func_170(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_64,
...
// Position - 0x271C
int func_57(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	if (iParam5 == 0) {
		Global_69523[1 /*14*/] = {func_105(iVar10, iParam1, iParam2)};
		if (!func_95(iParam3)) {
			Global_69522--;
			return 0;
		}
	...
	if (iParam1 == 12) {
		...
		while (iVar0 <= 14) {
			if (uVar11[iVar0] != -99) {
				Global_69523[1 /*14*/] = {func_105(iVar10, iVar0, uVar11[iVar0])};
				if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0)) {
					if (iVar0 == 13) {
						uVar28 = 9;
						if (iParam5 == 1) {
						...
						iVar1 = 0;
						while (iVar1 <= 8) {
							Global_69523[1 /*14*/] = {func_105(iVar10, 14, uVar28[iVar1])};
							func_73(iParam0, Global_69523[1 /*14*/].f_12, Global_69523[1 /*14*/].f_3,
						...
						if (iParam4 == -1) {
							ped::set_ped_component_variation(iParam0, func_97(iVar0), Global_69523[1 /*14*/].f_3,
															 Global_69523[1 /*14*/].f_4,
															 ped::get_ped_palette_variation(iParam0, func_97(iVar0)));
						}
						else {
							ped::set_ped_component_variation(iParam0, func_97(iVar0), Global_69523[1 /*14*/].f_3,
				...
				Global_69523[1 /*14*/] = {func_105(iVar10, iVar0, func_63(iParam0, iVar0, -1))};
		...
		iVar1 = 0;
		while (iVar1 <= 8) {
			Global_69523[1 /*14*/] = {func_105(iVar10, 14, uVar69[iVar1])};
		...
		if (iParam4 == -1) {
			ped::set_ped_component_variation(iParam0, func_97(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4,
											 ped::get_ped_palette_variation(iParam0, func_97(iParam1)));
		}
		else {
			ped::set_ped_component_variation(iParam0, func_97(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4, iParam4);
...
bool func_60(int iParam0, int iParam1, int iParam2) {
	Global_69523[1 /*14*/] = {func_105(iParam0, iParam1, iParam2)};
	return gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 2);
}

// Position - 0x30BA
bool func_61(int iParam0, int iParam1, int iParam2, int iParam3, var *uParam4, var *uParam5) {
	var uVar0;
	int iVar10;
...
// Position - 0x3AFF
var func_65(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
...
void func_73(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == -1) {
		...
		if (iParam1 == 0) {
			...
			if (func_74(entity::get_entity_model(iParam0), 14, iVar0,
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 14, 3), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 1, 3), -1842686353, 0);
			}
			break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 14, 4), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_75(iParam0, iParam2, 1, 4), -1842686353, 0);
			}
			break;
		}
		break;
...
void func_88(int iParam0) {
	if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 1) && !gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 6)) {
		func_94(iParam0, Global_69523[1 /*14*/].f_5, Global_69523[1 /*14*/].f_2, 2, Global_69523[1 /*14*/].f_1, 1, 0);
	}
	if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 1) && gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 6)) {
		if (iParam0 == 12) {
...
void func_89(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_93(iParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3)) {
...
bool func_96(int iParam0, int iParam1, int *iParam2, int iParam3) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_60 != -99) {
		if (!func_170(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_61,
...
struct<10> func_98(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		switch (iParam1) {
		case 31: func_100(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 0: func_100(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_100(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_100(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_100(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_100(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8); break;

		case 5: func_100(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8); break;

		case 6: func_100(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_100(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_100(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_100(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8); break;

		default: func_99(&Var1, iParam0, iParam1, 10); break;
		}
		break;
	...
	case joaat("player_one"):
		...
		case 1: func_100(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8); break;

		case 2: func_100(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8); break;

		case 3: func_100(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_100(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_100(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_100(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_100(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_100(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_99(&Var1, iParam0, iParam1, 9); break;
		}
		break;
	...
	case joaat("player_two"):
		...
		case 0: func_100(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_100(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_100(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_100(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8); break;

		case 4: func_100(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8); break;

		case 5: func_100(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_100(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_100(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_100(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8); break;
	...
	case joaat("mp_m_freemode_01"):
		...
		case 0: func_100(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_100(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_100(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_100(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_100(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_100(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_100(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_100(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_100(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_100(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_100(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_100(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_100(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_100(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 14: func_100(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_100(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_100(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_100(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_100(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_100(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_100(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_100(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_100(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_100(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 24: func_100(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_99(&Var1, iParam0, iParam1, 25); break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 0: func_100(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_100(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_100(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_100(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_100(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_100(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_100(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_100(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_100(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_100(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_100(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_100(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_100(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_100(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8); break;

		case 14: func_100(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_100(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_100(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_100(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_100(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_100(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_100(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_100(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_100(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_100(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8); break;
...
// Position - 0x97B4
void func_100(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
struct<17> func_101(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		...
		case 1: func_104(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0); break;

		case 2: func_104(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8); break;

		case 3: func_104(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31); break;

		case 4: func_104(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2); break;

		case 5:
			func_104(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[0], Global_101700.f_2095.f_539.f_200[0], 6, 3, 0,
					 0, 0, -99, 0, 0, 3);
			break;

		case 6: func_104(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_104(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 8: func_104(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 9: func_104(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 10: func_104(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4); break;

		case 11: func_104(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5); break;

		case 12: func_104(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31); break;

		case 13: func_104(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 14: func_104(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6); break;

		case 15: func_104(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31); break;

		case 16: func_104(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31); break;

		case 17: func_104(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 18: func_104(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7); break;

		case 19: func_104(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 20: func_104(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 21: func_104(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_104(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 23: func_104(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31); break;

		case 24: func_104(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31); break;

		case 25: func_104(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 26: func_104(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 27: func_104(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 28: func_104(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 29: func_104(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 30: func_104(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 31: func_104(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31); break;

		case 32: func_104(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 33: func_104(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 34: func_104(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31); break;

		case 35: func_104(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 36: func_104(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 37: func_104(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 38: func_104(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 39: func_104(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 40: func_104(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 41: func_104(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_104(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_104(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_104(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 45: func_104(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 46: func_104(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_104(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 48: func_104(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31); break;

		case 49: func_104(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 50: func_104(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9); break;

		case 51: func_104(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 52: func_104(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		default: func_102(&Var1, iParam0, iParam1, 53); break;
		}
		break;

	case joaat("player_one"):
		switch (iParam1) {
		case 0: func_104(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 1: func_104(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 2:
			func_104(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[1], Global_101700.f_2095.f_539.f_200[1], 17, 2,
					 26, 0, 0, -99, 0, 45, 31);
			break;

		case 3: func_104(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1); break;

		case 4: func_104(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2); break;

		case 5: func_104(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 6: func_104(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_104(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3); break;

		case 8: func_104(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5); break;

		case 9: func_104(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 10: func_104(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 11: func_104(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 12: func_104(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 13: func_104(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 14: func_104(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 15: func_104(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 16: func_104(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 17: func_104(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 18: func_104(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31); break;

		case 19: func_104(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 20: func_104(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 21: func_104(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4); break;

		case 22: func_104(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31); break;

		case 23: func_104(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31); break;

		case 24: func_104(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31); break;

		case 25: func_104(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31); break;

		case 26: func_104(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31); break;

		case 27: func_104(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31); break;

		case 28: func_104(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31); break;

		case 29: func_104(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31); break;

		case 30: func_104(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31); break;

		case 31: func_104(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31); break;

		case 32: func_104(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31); break;

		case 33: func_104(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31); break;

		case 34: func_104(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31); break;

		case 35: func_104(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31); break;

		case 36: func_104(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31); break;

		case 37: func_104(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31); break;

		case 38: func_104(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 39: func_104(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 40: func_104(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 41: func_104(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 42: func_104(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31); break;

		case 43: func_104(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6); break;

		case 44: func_104(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 45: func_104(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8); break;

		case 46: func_104(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31); break;

		default: func_102(&Var1, iParam0, iParam1, 47); break;
		}
		break;

	case joaat("player_two"):
		switch (iParam1) {
		case 0: func_104(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 1: func_104(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8); break;

		case 2: func_104(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1); break;

		case 3: func_104(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2); break;

		case 4:
			func_104(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[2], Global_101700.f_2095.f_539.f_200[2], 8, 0, 0,
					 0, 0, -99, 0, 0, 31);
			break;

		case 5: func_104(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6); break;

		case 6: func_104(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3); break;

		case 7: func_104(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4); break;

		case 8: func_104(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31); break;

		case 9: func_104(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 10: func_104(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 11: func_104(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5); break;

		case 12: func_104(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 13: func_104(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31); break;

		case 14: func_104(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31); break;

		case 15: func_104(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 16: func_104(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 17: func_104(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 18: func_104(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 19: func_104(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 20: func_104(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 21: func_104(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_104(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 23: func_104(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 24: func_104(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 25: func_104(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 26: func_104(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 27: func_104(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 28: func_104(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 29: func_104(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 30: func_104(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 31: func_104(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 32: func_104(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 33: func_104(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 34: func_104(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 35: func_104(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 36: func_104(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 37: func_104(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 38: func_104(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 39: func_104(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 40: func_104(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 41: func_104(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_104(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_104(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_104(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31); break;

		case 45: func_104(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 46: func_104(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_104(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31); break;

		default: func_102(&Var1, iParam0, iParam1, 48); break;
		}
		break;

	case joaat("mp_m_freemode_01"):
		switch (iParam1) {
		case 0: func_104(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31); break;

		case 1: func_104(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0); break;

		case 2: func_104(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1); break;

		case 3: func_104(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2); break;

		case 4: func_104(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3); break;

		case 5: func_104(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4); break;

		case 6: func_104(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5); break;

		case 7: func_104(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6); break;

		case 8: func_104(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7); break;

		case 9: func_104(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8); break;

		case 10: func_104(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9); break;

		case 11: func_104(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10); break;

		case 12: func_104(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11); break;

		case 13: func_104(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12); break;

		case 14: func_104(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13); break;

		case 15: func_104(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14); break;

		case 16: func_104(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15); break;

		case 17: func_104(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16); break;

		case 18: func_104(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17); break;

		case 19: func_104(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18); break;

		case 20: func_104(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19); break;

		case 21: func_104(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20); break;

		case 22: func_104(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21); break;

		case 23: func_104(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22); break;

		case 24: func_104(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23); break;

		case 25: func_104(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24); break;

		default: func_102(&Var1, iParam0, iParam1, 26); break;
		}
		break;

	case joaat("mp_f_freemode_01"):
		switch (iParam1) {
		case 0: func_104(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31); break;

		case 1: func_104(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31); break;

		case 2: func_104(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0); break;

		case 3: func_104(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1); break;

		case 4: func_104(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2); break;

		case 5: func_104(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3); break;

		case 6: func_104(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4); break;

		case 7: func_104(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5); break;

		case 8: func_104(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6); break;

		case 9: func_104(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7); break;

		case 10: func_104(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8); break;

		case 11: func_104(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9); break;

		case 12: func_104(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10); break;

		case 13: func_104(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31); break;

		case 14: func_104(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11); break;

		case 15: func_104(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12); break;

		case 16: func_104(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13); break;

		case 17: func_104(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14); break;

		case 18: func_104(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15); break;

		case 19: func_104(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16); break;

		case 20: func_104(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17); break;

		case 21: func_104(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31); break;

		case 22: func_104(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18); break;

		case 23: func_104(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19); break;

		case 24: func_104(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20); break;

		case 25: func_104(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21); break;

		case 26: func_104(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22); break;

		case 27: func_104(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23); break;

		default: func_102(&Var1, iParam0, iParam1, 28); break;
		}
		break;
	}
	return Var1;
...
// Position - 0xB8DE
void func_104(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) {
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
{
	switch (iParam0) {
	case 0: func_131(iParam1); break;

	case 2: func_130(iParam1); break;
	...
	case 14: func_107(iParam1); break;
	}
}
...
void func_107(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 155); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

// Position - 0xCD08
void func_108(var *uParam0, int iParam1, int iParam2, char *sParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	*uParam0 = iParam9;
	...
	if (iParam10) {
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 ||
			...
			iVar0 = func_92(func_111(iParam1, uParam0->f_2), Global_69521, 0);
			if (gameplay::is_bit_set(iVar0, uParam0->f_1)) {
				gameplay::set_bit(&uParam0->f_6, 1);
			}
			iVar0 = func_92(func_110(iParam1, uParam0->f_2), Global_69521, 0);
			if (gameplay::is_bit_set(iVar0, uParam0->f_1)) {
				gameplay::set_bit(&uParam0->f_6, 2);
			}
			if (func_109(iParam1, uParam0->f_2, &iVar1)) {
				iVar0 = func_92(iVar1, Global_69521, 0);
				if (!gameplay::is_bit_set(iVar0, uParam0->f_1)) {
					gameplay::set_bit(&uParam0->f_6, 4);
				}
			}
...
// Position - 0xDCD6
bool func_113(int iParam0) { return Global_35781 == iParam0; }
...
void func_115(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 == 12) {
		...
		while (iVar17 < iVar19) {
			...
			if (!dlc1::_is_dlc_data_empty(Var2)) {
				if (iVar18 == iParam1 - iParam2) {
					...
					Global_2621445 = Var2;
					func_108(&Global_69523[0 /*14*/], iParam0, iParam1, &Var2.f_7, 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
		...
		func_108(&Global_69523[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14) {
		...
		while (iVar38 < iVar40) {
			...
			if (!dlc1::_is_dlc_data_empty(Var20)) {
				if (iVar39 == iParam1 - iParam2) {
					...
					func_108(&Global_69523[0 /*14*/], iParam0, iParam1, &Var20.f_9, Var20.f_3, Var20.f_4, Var20.f_5,
		...
		iVar59 = 0;
		iVar60 = dlc1::_get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_97(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60) {
			...
			if (!dlc1::_is_dlc_data_empty(Var41)) {
				if (iVar59 == iParam1 - iParam2) {
					...
					func_108(&Global_69523[0 /*14*/], iParam0, iParam1, &Var41.f_9, Var41.f_3, Var41.f_4, Var41.f_5,
...
void func_116(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 9); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_117(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 48); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_118(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 1); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_120(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 6); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_121(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 33); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_122(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 17); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_123(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 18); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_124(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 7); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_125(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 84); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_126(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 104); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_132(int iParam0, int iParam1) {
	...
	case 3: func_145(iParam1); break;

	case 4: func_144(iParam1); break;

	case 6: func_143(iParam1); break;

	case 5: func_142(iParam1); break;

	case 8: func_141(iParam1); break;

	case 9: func_140(iParam1); break;

	case 10: func_139(iParam1); break;

	case 1: func_138(iParam1); break;

	case 7: func_137(iParam1); break;

	case 11: func_136(iParam1); break;

	case 12: func_135(iParam1); break;

	case 13: func_134(iParam1); break;

	case 14: func_133(iParam1); break;
	}
}
...
void func_133(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 175); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_135(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 47); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_136(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 63); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_138(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 5); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_139(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 53); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_140(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 12); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_141(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 77); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_143(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 134); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_144(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 117); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_149(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 21); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_150(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 10); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_151(int iParam0, int iParam1) {
	...
	case 14: func_152(iParam1); break;
	}
}
...
void func_152(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 113); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_155(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 45); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_159(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 20); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_160(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 24); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_161(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 14); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_162(int iParam0) {
	...
	default: func_115(iVar10, iParam0, 99); return;
	}
	func_108(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
bool func_170(int iParam0, int iParam1, int iParam2) {
					...
					if (iVar2 == 13) {
						...
						while (iVar3 <= 8) {
							if (!func_170(iParam0, 14, uVar22[iVar3])) {
								iVar4 = 0;
								while (iVar4 <= 19) {
									Global_69523[2 /*14*/] = {func_105(iVar0, 14, iVar4)};
									if (Global_69523[2 /*14*/].f_12 == iVar3) {
										if (func_170(iParam0, 14, iVar4)) {
											if (!func_61(iVar0, iParam2, 14, iVar4, &uVar5, &Global_69523[2 /*14*/])) {
												return false;
											}
										}
									}
						...
						Global_69523[2 /*14*/] = {func_105(iVar0, iVar2, iVar1)};
						if (!func_61(iVar0, iParam2, iVar2, iVar1, &uVar5, &Global_69523[2 /*14*/])) {
							return false;
						}
					}
				}
	...
	else if (Global_69523[1 /*14*/].f_3 == ped::get_ped_drawable_variation(iParam0, func_97(iParam1)) &&
			 Global_69523[1 /*14*/].f_4 == ped::get_ped_texture_variation(iParam0, func_97(iParam1))) {
		return true;
	}
	return false;
}
...
// Position - 0x1F695
bool func_173(int iParam0) { return iParam0 < 3; }
...
void func_176() {
	...
	if (entity::does_entity_exist(player::player_ped_id())) {
		if (func_172(Global_101700.f_2095.f_539.f_3549) != entity::get_entity_model(player::player_ped_id())) {
			iVar0 = func_171(player::player_ped_id());
			if (func_173(iVar0) && (!func_113(14) || Global_100652)) {
...
void func_181(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 != -1) {
		...
		func_182(&sVar32, Var0.f_3, Global_91528, iParam1, iParam2);
	}
}
...
void func_183(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_184(uParam1, "Abigail1", func_177(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				 "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_185(iParam0), 1, 0);
		break;

	case 1:
		func_184(uParam1, "Abigail2", func_177(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				 -1, 4, 1, 0, 2359, func_185(iParam0), 1, 0);
		break;

	case 2:
		func_184(uParam1, "Barry1", func_177(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				 4, 1, 0, 2359, func_185(iParam0), 1, 0);
		break;

	case 3:
		func_184(uParam1, "Barry2", func_177(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				 4, 4, 0, 2359, func_185(iParam0), 1, 1);
		break;

	case 4:
		func_184(uParam1, "Barry3", func_177(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2,
				 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 5:
		func_184(uParam1, "Barry3A", func_177(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0,
				 "", 166, 0, 7, 4, 2, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 6:
		func_184(uParam1, "Barry3C", func_177(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				 7, 4, 2, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 7:
		func_184(uParam1, "Barry4", func_177(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0,
				 "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_185(iParam0), 0, 0);
		break;

	case 8:
		func_184(uParam1, "Dreyfuss1", func_177(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				 0, "", 0, 0, -1, 4, 2, 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 9:
		func_184(uParam1, "Epsilon1", func_177(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1,
				 10, 4, 1, 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 10:
		func_184(uParam1, "Epsilon2", func_177(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0,
				 11, 4, 1, 0, 2359, func_185(iParam0), 1, 0);
		break;

	case 11:
		func_184(uParam1, "Epsilon3", func_177(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				 0, 0, 12, 4, 1, 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 12:
		func_184(uParam1, "Epsilon4", func_177(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				 "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 13:
		func_184(uParam1, "Epsilon5", func_177(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16,
				 "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_185(iParam0), 1, 0);
		break;

	case 14:
		func_184(uParam1, "Epsilon6", func_177(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 15:
		func_184(uParam1, "Epsilon7", func_177(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 16:
		func_184(uParam1, "Epsilon8", func_177(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_185(iParam0), 1, 0);
		break;

	case 17:
		func_184(uParam1, "Extreme1", func_177(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 18:
		func_184(uParam1, "Extreme2", func_177(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 19:
		func_184(uParam1, "Extreme3", func_177(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 20:
		func_184(uParam1, "Extreme4", func_177(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 21:
		func_184(uParam1, "Fanatic1", func_177(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_185(iParam0), 1, 0);
		break;

	case 22:
		func_184(uParam1, "Fanatic2", func_177(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_185(iParam0), 1, 0);
		break;

	case 23:
		func_184(uParam1, "Fanatic3", func_177(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_185(iParam0), 0, 1);
		break;

	case 24:
		func_184(uParam1, "Hao1", func_177(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_185(iParam0), 0, 1);
		break;

	case 25:
		func_184(uParam1, "Hunting1", func_177(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 26:
		func_184(uParam1, "Hunting2", func_177(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 27:
		func_184(uParam1, "Josh1", func_177(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_185(iParam0), 1, 0);
		break;

	case 28:
		func_184(uParam1, "Josh2", func_177(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_185(iParam0), 1, 1);
		break;

	case 29:
		func_184(uParam1, "Josh3", func_177(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_185(iParam0), 1, 1);
		break;

	case 30:
		func_184(uParam1, "Josh4", func_177(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_185(iParam0), 1, 0);
		break;

	case 31:
		func_184(uParam1, "Maude1", func_177(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 32:
		func_184(uParam1, "Minute1", func_177(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 33:
		func_184(uParam1, "Minute2", func_177(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 34:
		func_184(uParam1, "Minute3", func_177(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 35:
		func_184(uParam1, "MrsPhilips1", func_177(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 36:
		func_184(uParam1, "MrsPhilips2", func_177(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_185(iParam0), 0, 0);
		break;

	case 37:
		func_184(uParam1, "Nigel1", func_177(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_185(iParam0), 1, 0);
		break;

	case 38:
		func_184(uParam1, "Nigel1A", func_177(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_185(iParam0), 1, 1);
		break;

	case 39:
		func_184(uParam1, "Nigel1B", func_177(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_185(iParam0), 1, 1);
		break;

	case 40:
		func_184(uParam1, "Nigel1C", func_177(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_185(iParam0), 1, 1);
		break;

	case 41:
		func_184(uParam1, "Nigel1D", func_177(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_185(iParam0), 1, 1);
		break;

	case 42:
		func_184(uParam1, "Nigel2", func_177(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_185(iParam0), 1, 1);
		break;

	case 43:
		func_184(uParam1, "Nigel3", func_177(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_185(iParam0), 1, 1);
		break;

	case 44:
		func_184(uParam1, "Omega1", func_177(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 45:
		func_184(uParam1, "Omega2", func_177(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 46:
		func_184(uParam1, "Paparazzo1", func_177(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 47:
		func_184(uParam1, "Paparazzo2", func_177(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 48:
		func_184(uParam1, "Paparazzo3", func_177(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 49:
		func_184(uParam1, "Paparazzo3A", func_177(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 50:
		func_184(uParam1, "Paparazzo3B", func_177(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 51:
		func_184(uParam1, "Paparazzo4", func_177(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 52:
		func_184(uParam1, "Rampage1", func_177(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 54:
		func_184(uParam1, "Rampage3", func_177(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_185(iParam0), 1, 0);
		break;

	case 55:
		func_184(uParam1, "Rampage4", func_177(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_185(iParam0), 1, 0);
		break;

	case 56:
		func_184(uParam1, "Rampage5", func_177(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_185(iParam0), 0, 0);
		break;

	case 53:
		func_184(uParam1, "Rampage2", func_177(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_185(iParam0), 1, 0);
		break;

	case 57:
		func_184(uParam1, "TheLastOne", func_177(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 58:
		func_184(uParam1, "Tonya1", func_177(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 59:
		func_184(uParam1, "Tonya2", func_177(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_185(iParam0), 0, 1);
		break;

	case 60:
		func_184(uParam1, "Tonya3", func_177(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_185(iParam0), 0, 1);
		break;

	case 61:
		func_184(uParam1, "Tonya4", func_177(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_185(iParam0), 0, 1);
		break;

	case 62:
		func_184(uParam1, "Tonya5", func_177(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_185(iParam0), 0, 1);
		break;
...
// Position - 0x21076
void func_184(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
void func_187() {
	if (Global_89136) {
		func_176();
		graphics::_0xBF59707B3E5ED531(func_188(Global_101700.f_2095.f_539.f_3549));
	}
	else {
...
void func_193(int iParam0, int iParam1) {
	...
	func_208(iParam0, G_TextMessageConfig);
	if (!iParam1) {
...
void func_195(int iParam0) {
	func_197(iParam0, 1);
	Global_101700.f_17533[iParam0 /*6*/].f_3 = func_196();
	Global_101700.f_17533.f_380++;
}

// Position - 0x21AB2
int func_196() { return Global_101700.f_8975.f_21 + Global_101700.f_17533.f_380; }
...
void func_199(int iParam0) {
	switch (iParam0) {
	case 30: func_200(22, 1, 0, 1, 0); break;

	case 15: func_17(37, 0); break;
...
void func_200(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	if (iParam0 != 198) {
		...
		func_203(iParam0, iParam3, iParam4, 0);
...
// Position - 0x21FC7
bool func_203(int iParam0, bool bParam1, int iParam2, int iParam3) {
	bool bVar0;
	int iVar1;
	int iVar2;
	struct<5> Var3;
...
// Position - 0x22932
int func_205() { return Global_25191; }
...
void func_208(int iParam0, bool bParam1) {
	switch (iParam0) {
	case 46: func_209(4, bParam1); break;

	case 16: func_209(6, bParam1); break;

	case 37: func_209(17, bParam1); break;

	case 31: func_209(16, bParam1); break;
	}
}
...
// Position - 0x26329
void func_210(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8) {
	func_211(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

// Position - 0x2634B
void func_211(char *sParam0, char *sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6,
...
// Position - 0x26944
int func_219() { return func_220(script::get_this_script_name(), 0); }
...
// Position - 0x269EC
int func_222(char *sParam0, int iParam1, int iParam2) {
	Global_15746 = 0;
...
bool func_233() {
	if (func_455(vLocal_156.x)) {
		if (vehicle::get_landing_gear_state(vLocal_156.x) == 4) {
...
// Position - 0x270C6
void func_234() {
	if (func_452(Local_174)) {
		if (func_238(Local_174, 0, 1116471296, 1126825984, 1, 0, 0, 0) ||
			gameplay::is_bullet_in_area(entity::get_entity_coords(Local_174, 1), 3f, 1)) {
		...
		else if (func_235(player::player_ped_id(), Local_174, 1) ||
				 gameplay::is_bullet_in_area(entity::get_entity_coords(Local_174, 1), 3f, 0) ||
				 ped::is_ped_being_jacked(Local_174)) {
			if (iLocal_190 != 5 && iLocal_190 != 3) {
				bLocal_233 = true;
			}
			iLocal_264 = 5;
...
bool func_235(int iParam0, int iParam1, int iParam2) {
	if (func_453(iParam0) && ped::is_ped_in_any_vehicle(iParam0, 0)) {
		if (func_453(iParam1)) {
...
// Position - 0x273B6
bool func_238(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6,
			  int iParam7) {
	vector3 vVar0;
	...
	if (func_452(player::player_ped_id()) && func_452(iParam0)) {
		...
		if (func_252(iParam0, iParam1, iParam5, iParam6, iParam7)) {
			return true;
		}
...
// Position - 0x274E7
bool func_240(int iParam0, float fParam1) { return func_241(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_241(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_242(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0x275C0
int func_242(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
...
int func_245(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_247(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
...
// Position - 0x279B5
bool func_252(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_452(player::player_ped_id()) && func_452(iParam0)) {
		...
		if (!iParam2) {
			if (func_256(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_253(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
// Position - 0x27AB0
bool func_253(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
// Position - 0x27C51
bool func_255(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
// Position - 0x27CDF
bool func_256(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
// Position - 0x27D65
void func_259(var uParam0) { uParam0 = uParam0; }

// Position - 0x27D71
bool func_260() {
	if (func_233()) {
		if (gameplay::_0x34318593248C8FB2(entity::get_entity_coords(vLocal_156.x, 0), joaat("weapon_stickybomb"), 10f,
										  0)) {
...
// Position - 0x27E6A
bool func_262() { return gameplay::is_bit_set(Global_91491.f_20, 13); }
...
void func_263() {
	...
	case 0:
		...
		while (!streaming::has_model_loaded(iLocal_762) || !streaming::has_model_loaded(iLocal_761) ||
			   !streaming::has_anim_dict_loaded("rcm_epsilonism4")) {
	...
	case 3:
		...
		func_266(55);
		while (!streaming::has_model_loaded(iLocal_761) || !streaming::has_model_loaded(Local_163.f_1) ||
			   !streaming::has_anim_dict_loaded(Local_174.f_6) || !func_265(55)) {
	...
	case 4:
		...
		func_266(55);
		if (!func_262()) {
			while (!streaming::has_model_loaded(Local_163.f_1) || !cutscene::has_cutscene_loaded() ||
				   !streaming::has_model_loaded(vLocal_156.y) || !streaming::has_anim_dict_loaded(Local_174.f_6) ||
				   !vehicle::has_vehicle_recording_been_loaded(501, "Eps6_Takeoff") || !func_265(55)) {
			...
			while (!streaming::has_model_loaded(Local_163.f_1) || !streaming::has_model_loaded(vLocal_156.y) ||
				   !streaming::has_anim_dict_loaded(Local_174.f_6) ||
				   !vehicle::has_vehicle_recording_been_loaded(501, "Eps6_Takeoff") || !func_265(55)) {
				func_495("WAITING FOR MS_ENDCUTSCENE RESOURCES");
				system::wait(0);
			}
...
void func_264() {
	...
	case 5:
		if (!func_455(Local_163)) {
			Local_163 = vehicle::create_vehicle(Local_163.f_1, Local_163.f_3, Local_163.f_6, 1, 1);
...
int func_265(int iParam0) {
	if (!func_173(iParam0)) {
		return streaming::has_model_loaded(func_496(iParam0));
	}
	else if (iParam0 != 145) {
	}
	return 0;
...
void func_266(int iParam0) {
	if (!func_173(iParam0)) {
		streaming::request_model(func_496(iParam0));
	}
	else if (iParam0 != 145) {
	}
}
...
// Position - 0x28520
void func_267(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	int iVar1;
...
// Position - 0x2858F
void func_268() { Global_17151.f_6 = 1; }
...
void func_274() {
	...
	ped::set_ped_can_be_targetted(Local_182, 0);
	ai::open_sequence_task(&iLocal_261);
	ai::task_go_to_coord_while_aiming_at_coord(0, -2887.95f, 3194.88f, 10.06f, -2887.95f, 3194.88f, 10.06f, 1.2f, 0,
											   0.5f, 4f, 1, 0, 0, -957453492);
	ai::task_play_anim(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	ai::task_go_to_coord_while_aiming_at_coord(0, -2888.92f, 3203.76f, 10.6f, -2888.92f, 3203.76f, 10.6f, 1.2f, 0, 0.5f,
											   4f, 1, 0, 0, -957453492);
	ai::task_play_anim(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	ai::task_go_to_coord_while_aiming_at_coord(0, -2895.37f, 3199.37f, 10.03f, -2895.37f, 3199.37f, 10.03f, 1.2f, 0,
											   0.5f, 4f, 1, 0, 0, -957453492);
	ai::task_play_anim(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	ai::set_sequence_to_repeat(iLocal_261, 1);
	ai::close_sequence_task(iLocal_261);
	ai::task_perform_sequence(Local_182, iLocal_261);
}
...
void func_275() {
	...
	case 0:
		...
		vLocal_156.x = vehicle::create_vehicle(iLocal_761, -2892.93f, 3192.37f, 11.66f, -132.35f, 0, 0);
	...
	case 2:
		if (func_233()) {
			...
			vLocal_156.x = vehicle::create_vehicle(iLocal_761, 595.7562f, 2926.42f, 173.2301f, 283.3833f, 0, 0);
			vehicle::set_vehicle_on_ground_properly(vLocal_156.x, 1084227584);
			vehicle::add_vehicle_upsidedown_check(vLocal_156.x);
			vehicle::set_vehicle_colours(vLocal_156.x, 157, 157);
			vehicle::set_vehicle_extra_colours(vLocal_156.x, 157, 5);
	...
	case 4:
		...
		vLocal_156.x = vehicle::create_vehicle(vLocal_156.y, 1684.78f, 3255.58f, 41.78f, 284.26f, 1, 1);
		if (func_455(vLocal_156.x)) {
			vehicle::set_vehicle_on_ground_properly(vLocal_156.x, 1084227584);
			vehicle::add_vehicle_upsidedown_check(vLocal_156.x);
	...
	case 5:
		...
		if (!bLocal_210) {
			...
			vLocal_156.x = vehicle::create_vehicle(vLocal_156.y, 1674.91f, 3252.47f, 41.69f, 284.26f, 1, 1);
			if (func_455(vLocal_156.x)) {
				vehicle::set_vehicle_on_ground_properly(vLocal_156.x, 1084227584);
				vehicle::add_vehicle_upsidedown_check(vLocal_156.x);
				vehicle::set_vehicle_doors_locked(vLocal_156.x, 3);
...
// Position - 0x28E54
int func_276(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	bool bVar0;
	float fVar1;
...
void func_277() {
	...
	case 4:
		if (!func_452(Local_174)) {
			...
			func_276(Local_174, Local_174.f_2, Local_174.f_5, 0, 1);
			if (func_452(Local_174)) {
				ai::task_play_anim(Local_174, Local_174.f_6, Local_174.f_7, 8f, -8f, -1, 49, 0, 0, 0, 0);
				ped::set_ped_prop_index(Local_174, 1, 0, 0, 0);
			}
		...
		if (!entity::does_entity_exist(iLocal_262)) {
			iLocal_262 =
				object::create_object(joaat("p_amb_phone_01"), entity::get_entity_coords(Local_174, 1), 1, 1, 0);
		}
		if (!entity::is_entity_attached(iLocal_262)) {
			entity::attach_entity_to_entity(iLocal_262, Local_174, ped::get_ped_bone_index(Local_174, 28422), 0f, 0f,
		...
		if (!bLocal_210) {
			if (!func_452(Local_174)) {
				...
				if (!ui::does_blip_exist(Local_174.f_1)) {
					Local_174.f_1 = func_279(Local_174, 1, 1, 9);
				}
				if (func_452(Local_174) && func_233()) {
					ai::open_sequence_task(&iLocal_261);
					ai::task_follow_nav_mesh_to_coord(0, 1682.44f, 3258.81f, 39.81f, 2f, 20000, 7.5f, 1, 1193033728);
					ai::task_enter_vehicle(0, vLocal_156.x, 20000, -1, 2f, 1, 0);
					ai::close_sequence_task(iLocal_261);
					ai::task_perform_sequence(Local_174, iLocal_261);
					ai::clear_sequence_task(&iLocal_261);
				}
				...
				func_276(Local_174, 1683.76f, 3270.74f, 39.78f, 168.3395f, 0, 1);
				if (!ui::does_blip_exist(Local_174.f_1)) {
					Local_174.f_1 = func_279(Local_174, 1, 1, 9);
				}
				if (func_452(Local_174) && func_233()) {
...
void func_280(int iParam0) {
	if (!func_173(iParam0)) {
		streaming::set_model_as_no_longer_needed(func_496(iParam0));
	}
	else if (iParam0 != 145) {
	}
}
...
// Position - 0x2927D
int func_281(int iParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
	if (func_282(iParam0, iParam1, vParam2, fParam5, 1)) {
		if (entity::does_entity_exist(*iParam0)) {
			if (!entity::is_entity_dead(*iParam0, 0)) {
...
// Position - 0x292D9
bool func_282(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	int iVar0;
...
void func_284() {
	...
	case 2:
		if (!func_262()) {
			if (func_452(player::player_ped_id()) && func_455(vLocal_156.x)) {
				if (!ped::is_ped_in_vehicle(player::player_ped_id(), vLocal_156.x, 0)) {
					ped::set_ped_into_vehicle(player::player_ped_id(), vLocal_156.x, -1);
				}
	...
	if (iVar0 == 1) {
		...
		if (iVar1 != -1 && iVar1 != 94) {
			...
			if (iVar5 != -1) {
				...
				iVar10 = func_341(&Global_91491.f_3);
				if (iVar10 > -1) {
...
void func_286(int iParam0, var uParam1, int iParam2, int iParam3) {
	func_287(&Global_96040, script::get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

// Position - 0x2968B
void func_287(var *uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) {
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_228();
	...
	while (iVar1 < 3) {
		...
		if (iVar1 == func_308()) {
			func_304(player::player_ped_id(), &uParam0->f_616[iVar1 /*65*/], 1);
		}
		else {
			iVar0 = 0;
			while (iVar0 < 12) {
...
// Position - 0x2AF0E
bool func_301(int iParam0, var *uParam1, int iParam2, int iParam3) {
	char *sVar0;
...
void func_304(int iParam0, var *uParam1, int iParam2) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		if (func_173(iVar0)) {
			...
			if (func_305(161, -1)) {
				uParam1->f_59 = func_92(2045, Global_69521, 0);
			}
			else {
				uParam1->f_59 = func_92(747, Global_69521, 0);
			}
			uParam1->f_60 = func_92(748, Global_69521, 0);
			uParam1->f_61 = func_92(749, Global_69521, 0);
		}
...
bool func_305(int iParam0, int iParam1) {
	...
	iVar0 = Global_2522581[iParam0 /*3*/][func_91(iParam1)];
...
// Position - 0x2B35D
void func_306(int iParam0, int iParam1, int *iParam2, int *iParam3, int iParam4, int iParam5) {
	int iVar0;
...
// Position - 0x2B8A5
void func_307(int iParam0, int iParam1, int *iParam2, int *iParam3, var *uParam4, int iParam5, int iParam6) {
	int iVar0;
...
void func_309(int iParam0, int iParam1) {
	...
	if (func_173(iVar0) && !ped::is_ped_injured(iParam0)) {
		if (iParam0 == player::player_ped_id()) {
			func_310(iParam0, &Global_101700.f_2095.f_539.f_298[iVar0 /*284*/]);
			iVar2 = 0;
			while (iVar2 <= 8 - 1) {
...
void func_310(int iParam0, var *uParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		while (iVar0 <= 44 - 1) {
			...
			if (iVar3 != 0) {
				vVar4.x = weapon::get_ped_weapontype_in_slot(iParam0, func_314(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		iVar7 = 0;
		while (iVar7 < iVar8) {
			if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_311(Var9.f_1) && iVar70 < 50) {
...
// Position - 0x2D328
bool func_317(vector3 vParam0, char *sParam3, vector3 vParam4) {
	int iVar0;
	int iVar1;
...
// Position - 0x2D36C
bool func_318(int iParam0, var *uParam1, float *fParam2) {
	*uParam1 = {0f, 0f, 0f};
	*fParam2 = 0f;
	switch (iParam0) {
	case 0:
...
bool func_319(int *iParam0) {
	if (!entity::is_entity_dead(player::player_ped_id(), 0) && !ped::is_ped_injured(player::player_ped_id())) {
		if (func_329()) {
			*iParam0 = func_324(entity::get_entity_coords(player::player_ped_id(), 0), 6, -1, 0, 1, -1);
			if (func_323(*iParam0) && !func_320(*iParam0)) {
				return true;
			}
		}
	}
...
// Position - 0x2DA56
int func_320(int iParam0) { return func_321(iParam0, 0, 1); }
...
int func_321(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_31() == 0) {
			return gameplay::is_bit_set(func_92(func_322(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0x2DD8D
int func_323(int iParam0) { return func_321(iParam0, 5, 1); }

// Position - 0x2DD9D
int func_324(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
	...
	while (iVar0 <= 45) {
		if (iParam3 == 6 || iParam3 == func_328(iVar0)) {
			if (!iParam5 || func_327(iVar0)) {
				fVar1 = gameplay::get_distance_between_coords(vParam0, func_325(iVar0, 0), 1);
...
Vector3 func_325(int iParam0, int iParam1) {
	...
	case 45: return func_326(Global_93004);
	}
...
// Position - 0x2E46F
int func_327(int iParam0) { return func_321(iParam0, 0, 0); }
...
// Position - 0x2E6F2
bool func_329() { return Global_91543.f_303 > 0; }

// Position - 0x2E703
var func_330() {
	int *iVar0;

	func_340(&iVar0, time::get_clock_seconds());
	func_339(&iVar0, time::get_clock_minutes());
	func_338(&iVar0, time::get_clock_hours());
	func_333(&iVar0, time::get_clock_day_of_month());
	func_332(&iVar0, time::get_clock_month());
	func_331(&iVar0, time::get_clock_year());
	return iVar0;
}
...
var func_335(int iParam0) {
	return (system::shift_right(iParam0, 26) & 31) * func_336(gameplay::is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
// Position - 0x2E931
int func_337(var uParam0) { return uParam0 & 15; }
...
int func_342(int iParam0) {
	switch (iParam0) {
	case 69:
	case 70: return func_343(Global_101700.f_8044.f_99.f_205[10]);

	case 74:
	case 75: return func_343(Global_101700.f_8044.f_99.f_205[8]);

	case 84:
	case 85: return func_343(Global_101700.f_8044.f_99.f_205[11]);

	case 90: return func_343(Global_101700.f_8044.f_99.f_205[7]);

	case 93: return func_343(Global_101700.f_8044.f_99.f_205[9]);
	}
	return 0;
}
...
void func_347() {
	...
	case 0:
		...
		if (func_373(1, 1093140480, 0)) {
			pathfind::set_roads_in_angled_area(1775.157f, 3373.425f, 37.24686f, 1893.735f, 3203.022f, 48.48723f, 96.5f,
											   0, 0, 1);
			func_16(&vLocal_156.f_2);
			if (func_233()) {
			...
			func_278(&iLocal_262);
			func_365(1679.917f, 3270.735f, 39.34466f, 1697.999f, 3281.172f, 44.14951f, 7.75f, 1530.862f, 3767.051f,
					 33.0489f, 304.28f, func_371(), 1, 1, 1, 0, 0);
	...
	case 2:
		...
		func_276(vLocal_156.x, 1684.78f, 3255.58f, 41.78f, 284.26f, 0, 1);
		if (streaming::_0xBC9823AB80A3DCAC()) {
			streaming::_0x1EE7D8DF4425F053(iLocal_260);
		}
		pathfind::set_roads_back_to_original_in_angled_area(1775.157f, 3373.425f, 37.24686f, 1893.735f, 3203.022f,
															48.48723f, 96.5f, 1);
		func_348(1, 1, 1, 1);
		iLocal_190 = 5;
		iLocal_191 = 0;
...
void func_349(int iParam0, int iParam1, int iParam2, int iParam3) {
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_353(player::player_id()) &&
				!func_351(player::player_id(), 0) && !func_350()) {
				entity::set_entity_invincible(player::player_ped_id(), 0);
			}
		}
		else if (!ped::is_ped_injured(player::player_ped_id()) && !func_353(player::player_id())) {
			entity::set_entity_invincible(player::player_ped_id(), 0);
		}
...
// Position - 0x2F38C
bool func_350() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x2F477
bool func_354() { return gameplay::is_bit_set(Global_2359301, 3); }

// Position - 0x2F488
int func_355(int iParam0, int iParam1, var uParam2, int iParam3) {
	int iVar0;
...
void func_358() {
	if (func_452(Local_174)) {
		if (cutscene::can_set_exit_state_for_registered_entity("Jimmy_Boston", 0)) {
			...
			if (func_452(Local_174) && func_233()) {
				func_276(Local_174, 1682.13f, 3268.65f, 39.75f, 183.3768f, 0, 1);
				ai::open_sequence_task(&iLocal_261);
				ai::task_follow_nav_mesh_to_coord(0, 1682.44f, 3258.81f, 39.81f, 2f, 20000, 7.5f, 1, 1193033728);
				ai::task_enter_vehicle(0, vLocal_156.x, 20000, -1, 2f, 1, 0);
				ai::close_sequence_task(iLocal_261);
...
bool func_359() {
	if (func_452(player::player_ped_id())) {
		if (cutscene::can_set_exit_state_for_registered_entity("Michael", 0)) {
			...
			func_276(Local_163, Local_163.f_3, Local_163.f_6, 1, 1);
			if (func_455(Local_163)) {
				vehicle::set_vehicle_doors_locked(Local_163, 1);
			}
			return true;
...
// Position - 0x2F75A
void func_362(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8,
	...
	if (player::is_player_playing(iVar0)) {
		...
		if (iParam6 == 1) {
			gameplay::clear_area_of_peds(func_363(player::get_player_index()), 50f, 0);
		}
		if (iParam7 == 1) {
...
// Position - 0x2F918
Vector3 func_363(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }
...
// Position - 0x2F967
void func_365(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
			  int iParam14, int iParam15, int iParam16, int iParam17, int iParam18) {
	func_366(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

// Position - 0x2F991
void func_366(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
		...
		if (vehicle::is_vehicle_driveable(iVar0, 0)) {
			...
			if (entity::is_entity_in_angled_area(iVar0, vParam0, vParam3, fParam6, 0, 1, 0)) {
				...
				if (vVar10.z > vParam0.z && vVar10.z < vParam3.z || vVar10.z > vParam3.z && vVar10.z < vParam0.z) {
					if (func_368(iVar0, vParam0, vParam3, fParam6)) {
						bVar1 = true;
					}
				}
			}
...
// Position - 0x2FDAD
bool func_368(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	vector3 vVar9;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (func_369(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_369(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_369(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_369(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_369(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_369(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_369(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_369(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_369(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_369(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_369(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_369(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_369(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_369(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_369(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_369(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x300A4
int func_369(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
// Position - 0x301BD
Vector3 func_371() { return 2.55f, 5.665f, 2.55f; }
...
// Position - 0x30210
bool func_373(int iParam0, float fParam1, int iParam2) {
	int iVar0;
	...
	if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
		if (!ped::is_ped_in_any_heli(player::player_ped_id()) && !ped::is_ped_in_any_boat(player::player_ped_id()) &&
			...
			if (!func_377(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), fParam1, 1, 1056964608, 0, 1, 0)) {
				iVar0 = 0;
			}
			else if (iParam2 == 1) {
				iVar0 = 0;
...
void func_379() {
	...
	case 0:
		...
		vehicle::request_vehicle_recording(501, "Eps6_Takeoff");
		while (!func_265(55) || !streaming::has_anim_dict_loaded(Local_174.f_6) ||
			   !streaming::has_model_loaded(Local_163.f_1) || !streaming::has_model_loaded(joaat("p_amb_phone_01")) ||
			   !vehicle::has_vehicle_recording_been_loaded(501, "Eps6_Takeoff")) {
			system::wait(0);
		}
		if (iLocal_209) {
			func_263();
		...
		if (cutscene::_0xB56BBBCC2955D9CB()) {
			...
			if (func_452(player::player_ped_id())) {
				func_386("Michael", player::player_ped_id(), 0, 2);
			}
			cutscene::set_cutscene_ped_prop_variation("Jimmy_Boston", 1, 0, 0, 0);
		}
		if (iLocal_263 == -1) {
	...
	case 1:
		...
		if (func_233()) {
			...
			if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
				...
				if (func_380(player::player_ped_id(), Local_174, 13f, 1)) {
			...
			else if (func_380(player::player_ped_id(), Local_174, 5f, 1)) {
				if (func_452(player::player_ped_id()) && func_452(Local_174)) {
					vLocal_764 = {entity::get_entity_coords(player::player_ped_id(), 1)};
					vLocal_767 = {entity::get_entity_coords(Local_174, 1)};
					if (vLocal_764.z - vLocal_767.z < 1.5f && !ped::is_ped_falling(player::player_ped_id()) &&
	...
	if (func_232(player::player_ped_id(), Local_174, 1) <= 15f) {
		if (!streaming::_0xBC9823AB80A3DCAC()) {
			if (!streaming::_0x7D41E9D2D17C5B2D(iLocal_260)) {
				...
				iLocal_260 = streaming::_0x1F3F018BC3AFA77C(1684.85f, 3276.16f, 39.93f,
															func_382(-2.1719f, 0f, -78.5672f), 50f, 12, 127);
			}
		}
	}
...
void func_385() {
	...
	if (!func_22() && !ui::is_message_being_displayed()) {
		if (func_452(Local_174) && func_452(player::player_ped_id())) {
			if (func_380(player::player_ped_id(), Local_174, 25f, 1)) {
...
void func_387(int iParam0, var *uParam1, int iParam2) {
	...
	while (iVar0 < 12) {
		if (uParam1->f_13[iVar0] != Var2.f_13[iVar0] || (*uParam1)[iVar0] != Var2[iVar0]) {
			if (func_64(iVar81, func_103(iVar0), func_87(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_103(iVar0)),
						&iVar1)) {
			...
			if (func_71(iVar81, func_103(iVar0), func_87(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_103(iVar0)),
						&iVar1)) {
...
void func_388() {
	...
	case 0:
		...
		gameplay::clear_angled_area_of_vehicles(1727.442f, 3288.315f, 39.406f, 1706.909f, 3280.669f, 45.13256f, 14.25f,
												0, 0, 0, 0, 0);
		if (func_461()) {
			if (func_262()) {
	...
	case 1:
		...
		if (func_233()) {
			if (iLocal_229 == 0) {
				if (func_400(vLocal_156.x, Local_170, 1) < 1100f) {
					func_285(1, "Landing stage", 0, 0, 0, 1);
					iLocal_229 = 1;
			...
			if (iLocal_230 == 0) {
				if (func_400(vLocal_156.x, Local_170, 1) < 350f) {
					streaming::request_model(Local_163.f_1);
					func_266(55);
					streaming::request_anim_dict(Local_174.f_6);
					streaming::request_model(joaat("p_amb_phone_01"));
					func_495("Requesting Jimmy resources...");
					if (streaming::has_model_loaded(Local_163.f_1) && func_265(55) &&
						streaming::has_anim_dict_loaded(Local_174.f_6) &&
						streaming::has_model_loaded(joaat("p_amb_phone_01"))) {
						func_277();
						func_264();
						func_15(&uLocal_595, 3, Local_174, "JIMMYBOSTON", 0, 1);
						func_15(&uLocal_595, 0, player::player_ped_id(), "MICHAEL", 0, 1);
			...
			if (ped::is_ped_in_vehicle(player::player_ped_id(), vLocal_156.x, 0)) {
				...
				if (!ui::does_blip_exist(vLocal_156.z)) {
					vLocal_156.z = func_396(vLocal_156.x, 1, 5);
				...
				if (func_22()) {
					if (func_394("EPS6_ARMY") || func_394("EPS6_LEAVE") || func_394("EPS6_SAFE") ||
						func_394("EPS6_PUSHED") || func_394("EPS6_FLIGHT")) {
						func_20();
					}
				}
				func_16(&Local_170.f_3);
				if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
														  entity::get_entity_coords(vLocal_156.x, 1), 1) > 80f) {
					if (func_400(vLocal_156.x, 1654.72f, 3239.21f, 39.55f, 1) >= 50f) {
						if (!iLocal_214) {
							func_384("EPS6_BACKPL", 7500, 1);
							iLocal_214 = 1;
						}
						else if (gameplay::get_distance_between_coords(
									 entity::get_entity_coords(player::player_ped_id(), 1),
									 entity::get_entity_coords(vLocal_156.x, 1), 1) > 150f) {
							if (func_393()) {
								bLocal_233 = true;
							}
							iLocal_264 = 1;
						...
						iLocal_214 = 1;
								 ...
								 entity::get_entity_coords(player::player_ped_id(), 1),
								 entity::get_entity_coords(vLocal_156.x, 1), 1) > 250f) {
						if (func_393()) {
							bLocal_233 = true;
						}
						iLocal_264 = 1;
	...
	case 2:
		if (func_455(vLocal_156.x)) {
			if (entity::is_entity_in_angled_area(vLocal_156.x, vLocal_253, vLocal_256, 33.25f, 0, 1, 2)) {
				func_16(&vLocal_156.f_2);
				if (vehicle::get_landing_gear_state(vLocal_156.x) == 0 ||
					vehicle::get_landing_gear_state(vLocal_156.x) == 2) {
					if (!ui::does_blip_exist(Local_174.f_1)) {
						Local_174.f_1 = func_279(Local_174, 1, 1, 9);
					}
					func_16(&Local_170.f_3);
					...
					if (func_392() && !ped::is_ped_in_vehicle(player::player_ped_id(), vLocal_156.x, 0)) {
						func_495("*** Finishing Landing cleanup");
						func_391("*** Plane 'entity' health: ", entity::get_entity_health(vLocal_156.x));
						func_390("*** Plane engine health: ", vehicle::get_vehicle_engine_health(vLocal_156.x));
						func_390("*** Plane petrol tank health: ",
								 vehicle::get_vehicle_petrol_tank_health(vLocal_156.x));
						if (entity::get_entity_health(vLocal_156.x) == 1000 &&
							vehicle::get_vehicle_engine_health(vLocal_156.x) == 1000f &&
							vehicle::get_vehicle_petrol_tank_health(vLocal_156.x) == 1000f) {
							func_389(751);
						}
						func_16(&Local_170.f_3);
						iLocal_190 = 3;
				...
				if (vehicle::get_landing_gear_state(vLocal_156.x) == 1 ||
					vehicle::get_landing_gear_state(vLocal_156.x) == 3 ||
					vehicle::get_landing_gear_state(vLocal_156.x) == 4) {
					func_495("In the landing area and landing gear is "
							 "retracting, locked up or broken");
					iLocal_264 = 4;
					iLocal_191 = 0;
					iLocal_190 = 6;
					audio::trigger_music_event("EPS_FAIL");
				...
				func_495("*** Plane out of delivery area, reverting back to "
...
// Position - 0x31886
float func_400(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
...
void func_401() {
	if (func_233()) {
		if (ped::is_ped_in_vehicle(player::player_ped_id(), vLocal_156.x, 0)) {
			if (entity::is_entity_in_angled_area(player::player_ped_id(), -2611.599f, 2953.922f, 10.79497f, -2698.713f,
												 2367.25f, -0.336048f, 3f, 0, 1, 0) ||
				entity::is_entity_in_angled_area(player::player_ped_id(), -1506.538f, 2717.231f, 15.28982f, -1377.953f,
												 2609.015f, 0.028772f, 3f, 0, 1, 0) ||
				entity::is_entity_in_angled_area(player::player_ped_id(), -395.9501f, 2960.714f, 23.47385f, -426.3539f,
												 2966.561f, 14.00403f, 3f, 0, 1, 0)) {
				if (!iLocal_763) {
					iLocal_763 = 1;
				}
				func_389(752);
...
void func_402() {
	...
	if (iLocal_190 < 2) {
		switch (iLocal_193) {
		case 0: func_403(); break;

		case 1: func_403(); break;

		case 2: func_403(); break;

		case 3: func_403(); break;
		}
	}
	if (iLocal_190 >= 1) {
		...
		if (func_22()) {
			if (func_394("EPS6_ARMY") || func_394("EPS6_LEAVE") || func_394("EPS6_SAFE") || func_394("EPS6_PUSHED")) {
				if (func_400(player::player_ped_id(), vVar0, 1) > 35f) {
					if (func_22()) {
						func_495("*** Killing an intro conversation because "
		...
		if (func_400(player::player_ped_id(), vVar0, 1) > 450f) {
			func_7(&Local_182, 1, 0, 1);
		}
	}
}
...
void func_403() {
	...
	case 0:
		if (iLocal_195 == 0) {
			...
			if (func_452(player::player_ped_id()) && func_455(vLocal_156.x)) {
				if (func_232(player::player_ped_id(), Local_182, 1) < 10f ||
					func_232(player::player_ped_id(), vLocal_156.x, 1) < 10f) {
					if (!entity::is_entity_in_angled_area(player::player_ped_id(), -2915.73f, 3195.936f, 7.80361f,
														  -2897.807f, 3171.756f, 12.6042f, 16f, 0, 1, 0)) {
						if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
							func_258(2);
							iLocal_193 = 1;
						}
	...
	case 1:
		if (iLocal_195 == 0) {
			...
			if (func_452(player::player_ped_id()) && func_455(vLocal_156.x) && func_453(Local_182)) {
				if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
					if (func_232(player::player_ped_id(), Local_182, 1) < 15f ||
						func_232(player::player_ped_id(), vLocal_156.x, 1) < 10f) {
						if (!entity::is_entity_in_angled_area(player::player_ped_id(), -2915.73f, 3195.936f, 7.80361f,
															  -2897.807f, 3171.756f, 12.6042f, 16f, 0, 1, 0)) {
							func_258(2);
	...
	case 2:
		if (iLocal_195 == 0) {
			...
			if (iLocal_235 == 1) {
				...
				if (func_394("EPS6_SPOT")) {
					...
					if (audio::get_current_scripted_conversation_line() >= 3) {
						if (func_408(Local_182, player::player_ped_id()) > 10f) {
							func_20();
							bLocal_228 = true;
						}
					}
			...
			if (func_455(vLocal_156.x) && func_452(Local_182)) {
	...
	case 3:
		if (iLocal_195 == 0) {
			...
			if (iLocal_234 == 0) {
				func_406(Local_182, "AIMED_AT_BY_PLAYER", "TOM", 4);
				if (!func_376(Local_182, -1519143300)) {
					ai::clear_ped_tasks(Local_182);
	...
	case 5:
		if (iLocal_195 == 0) {
			...
			if (iLocal_211 == 0) {
				if (!ui::is_message_being_displayed() && !func_22() &&
					!ped::is_ped_in_vehicle(player::player_ped_id(), vLocal_156.x, 1)) {
					unk1::_0x293220DA1B46CEBC(3f, 10f, 1);
	...
	case 4:
		if (iLocal_195 == 0) {
			if (func_453(Local_182)) {
				if (func_400(Local_182, -2884.934f, 3200.156f, 10.7036f, 1) > 2f) {
					ai::clear_ped_tasks(Local_182);
					...
					ai::task_follow_nav_mesh_to_coord(0, -2884.934f, 3200.156f, 10.7036f, 1f, 20000, 1048576000, 0,
													  1193033728);
			...
			if (iLocal_190 == 0) {
				if (iLocal_211 == 0) {
					if (!func_394("EPS6_SPOT") && !ped::is_ped_in_vehicle(player::player_ped_id(), vLocal_156.x, 1) &&
...
void func_406(int iParam0, char *sParam1, char *sParam2, int iParam3) {
	audio::_play_ambient_speech_with_voice(iParam0, sParam1, sParam2, func_407(iParam3), 0);
}
...
// Position - 0x3276B
float func_408(int iParam0, int iParam1) { return func_232(iParam0, iParam1, 1); }
...
// Position - 0x327D0
bool func_410() {
	if (func_233() && func_452(Local_182)) {
		if (!ped::is_ped_in_vehicle(player::player_ped_id(), vLocal_156.x, 1)) {
...
void func_412() {
	if (iLocal_194 == 2) {
		...
		case 1:
			if (func_452(Local_182) && func_452(player::player_ped_id())) {
				ai::clear_ped_tasks(Local_182);
				vLocal_764 = {entity::get_entity_coords(player::player_ped_id(), 1)};
				ai::open_sequence_task(&iLocal_261);
				ai::task_look_at_entity(0, player::player_ped_id(), -1, 0, 2);
		...
		case 2:
			if (func_452(Local_182) && func_452(player::player_ped_id())) {
				if (func_232(Local_182, player::player_ped_id(), 1) < 5f ||
					ai::get_script_task_status(Local_182, 242628503) == 7) {
					ai::clear_ped_tasks(Local_182);
					ai::task_turn_ped_to_face_entity(Local_182, player::player_ped_id(), -1);
					iLocal_196 = 0;
				}
	...
	if (func_452(Local_182)) {
		...
		case 0:
			...
			if (streaming::has_anim_dict_loaded("rcmepsilonism6") &&
				!entity::is_entity_playing_anim(Local_182, "rcmepsilonism6", "cultist_idle_a", 3)) {
		...
		case 1:
			if (!func_376(Local_182, 713668775)) {
				ai::task_follow_nav_mesh_to_coord(Local_182, vLocal_199[iLocal_198 /*3*/], 1f, 20000, 1048576000, 0,
												  1193033728);
		...
		case 2:
			if (func_400(Local_182, vLocal_199[iLocal_198 /*3*/], 1) <= 1.2f) {
				iLocal_197 = 3;
		...
		case 4:
			if (entity::is_entity_playing_anim(Local_182, "rcmepsilonism6", "cultist_idle_a", 3)) {
				if (entity::get_entity_anim_current_time(Local_182, "rcmepsilonism6", "cultist_idle_a") >= 0.98f) {
					...
					ai::task_play_anim(Local_182, "rcmepsilonism6", "cultist_upperstatic", 16f, -8f, -1, 49, 0, 0, 0,
									   0);
					ped::_0x2208438012482A1A(Local_182, 0, 0);
					iLocal_197 = 1;
...
// Position - 0x32BE6
bool func_418() {
	if (func_452(player::player_ped_id()) && func_452(Local_182)) {
...
void func_419() {
	if (func_452(Local_182)) {
		if (func_453(Local_182)) {
			if (!entity::has_entity_been_damaged_by_entity(Local_182, player::player_ped_id(), 1)) {
				func_495("EPSILONIST got scared by player, will never stop "
						 "fleeing...");
				func_258(6);
				iLocal_264 = 10;
				iLocal_191 = 0;
...
// Position - 0x32D53
bool func_420() {
	if (func_238(Local_182, 0, 1116471296, 1126825984, 0, 0, 0, 0) || func_235(player::player_ped_id(), Local_182, 0) ||
		func_410()) {
		...
		if (func_453(Local_182)) {
			...
			func_406(Local_182, "FIGHT_RUN", "TOM", 4);
		}
		return true;
	}
	return false;
...
void func_421() {
	if (iLocal_232 == 0) {
		if (func_453(Local_182) && func_452(player::player_ped_id())) {
			if (iLocal_231 == 0) {
				if (entity::is_entity_touching_entity(player::player_ped_id(), Local_182) &&
					ped::is_ped_ragdoll(Local_182)) {
					func_20();
					func_495("Player knocked Tom over!");
					iLocal_231 = 1;
				}
			}
			else if (func_453(Local_182)) {
...
// Position - 0x32ECD
bool func_423() {
	if (controls::is_control_pressed(0, 59) || controls::is_control_pressed(0, 60) ||
		controls::is_control_pressed(0, 107) || controls::is_control_pressed(0, 110) ||
		controls::is_control_pressed(0, 113) || controls::is_control_pressed(0, 114) ||
		controls::is_control_pressed(0, 88) || controls::is_control_pressed(0, 87) ||
		controls::is_control_pressed(0, 89) || controls::is_control_pressed(0, 90)) {
...
void func_424() {
	...
	case 0:
		...
		pathfind::set_roads_in_angled_area(-36.25134f, -465.8315f, 39.12256f, 25.801f, -287.1716f, 47.75863f, 59.5f, 0,
										   0, 1);
		...
		if (func_233()) {
			func_391("*** Plane 'entity' health: ", entity::get_entity_health(vLocal_156.x));
			func_390("*** Plane engine health: ", vehicle::get_vehicle_engine_health(vLocal_156.x));
			func_390("*** Plane petrol tank health: ", vehicle::get_vehicle_petrol_tank_health(vLocal_156.x));
		}
		if (iLocal_259 == 0) {
			audio::trigger_music_event("EPS6_START");
			iLocal_259 = 1;
	...
	case 1:
		...
		if (func_233()) {
			if (ped::is_ped_in_vehicle(player::player_ped_id(), vLocal_156.x, 0)) {
				...
				ui::set_minimap_component(3, 0, -1);
				if (player::get_player_wanted_level(player::player_id()) == 0) {
					if (func_400(player::player_ped_id(), Local_170, 0) < 2300f) {
						iLocal_191 = 2;
					}
				}
			}
				...
				if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
					...
					if (!iLocal_214) {
						...
						iLocal_214 = 1;
								 ...
								 entity::get_entity_coords(player::player_ped_id(), 1),
								 entity::get_entity_coords(vLocal_156.x, 1), 1) > 120f) {
						if (func_393()) {
							bLocal_233 = true;
						}
						iLocal_264 = 1;
...
// Position - 0x33313
bool func_426(var *uParam0, int iParam1, char *sParam2, char *sParam3, int iParam4, int iParam5, int iParam6,
	...
	Global_2621441 = 0;
	return func_222(sParam3, iParam4, iParam8);
}
...
void func_427() {
	...
	case 0:
		...
		while (!streaming::has_anim_dict_loaded("rcmepsilonism6") ||
		...
		if (func_452(Local_182)) {
			...
			audio::play_sound_from_entity(iLocal_236, "DEVICE", weapon::get_current_ped_weapon_entity_index(Local_182),
										  "EPSILONISM_04_SOUNDSET", 0, 0);
			audio::play_sound_from_entity(iLocal_237, "IDLE_BEEP_NPC",
										  weapon::get_current_ped_weapon_entity_index(Local_182),
										  "EPSILONISM_04_SOUNDSET", 0, 0);
		}
		if (!ui::does_blip_exist(Local_182.f_1)) {
			Local_182.f_1 = func_279(Local_182, 1, 1, 5);
		}
		if (func_233()) {
			func_391("*** Plane 'entity' health: ", entity::get_entity_health(vLocal_156.x));
			func_390("*** Plane engine health: ", vehicle::get_vehicle_engine_health(vLocal_156.x));
	...
	case 1:
		...
		if (!func_455(vLocal_156.x)) {
			...
			audio::trigger_music_event("EPS_FAIL");
													   ...
													   entity::get_entity_coords(vLocal_156.x, 1), 1) > 50f) {
			if (!iLocal_214) {
				if (audio::is_scripted_conversation_ongoing()) {
				...
				if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
														  entity::get_entity_coords(vLocal_156.x, 1), 1) > 100f) {
					iLocal_264 = 1;
					iLocal_191 = 0;
					iLocal_190 = 6;
					audio::trigger_music_event("EPS_FAIL");
			...
			if (iLocal_215) {
				...
				if (func_409(&uLocal_265, "EPS6AUD", &vLocal_218, &cVar0, 8, 0, 0)) {
					iLocal_215 = 0;
					iLocal_214 = 0;
				}
			}
	...
	if (Global_69956 != 6) {
		if (Global_69958 == -1) {
			...
			if (iVar1 < 9000 && !cam::is_screen_faded_out()) {
				...
				Var4 = {func_430(Global_69957, Global_69959, iParam10)};
				if (fVar7 == -0.014f) {
				}
...
struct<2> func_430(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_438(iParam0)}; break;

	case 7: Var0 = {func_177(iParam0)}; break;

	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_437(iParam2)}; break;

		case 8: Var0 = {func_436(iParam2)}; break;

		case 7: Var0 = {func_435(iParam2)}; break;

		case 10: Var0 = {func_434(iParam2)}; break;

		case 5: Var0 = {func_433(iParam2)}; break;

		case 4: Var0 = {func_432(iParam2)}; break;

		default: StringCopy(&Var0, func_431(iVar2), 8); break;
		}
		break;
...
//Position - 0x33DAB
bool func_439(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (!func_441(0) || G_TextMessageConfig || Global_69960 == 1 || !cam::is_screen_faded_in()) {
		return false;
	}
	switch (Global_69956) {
	case 0:
	...
	case 5:
		if (cutscene::is_cutscene_playing() || func_272(0) || func_440(1)) {
		}
		else {
			return true;
		}
...
// Position - 0x33F0F
bool func_442(int iParam0) { return func_443(iParam0, Global_35781); }
...
void func_446(int iParam0, int iParam1) {
	...
	func_362(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, iParam1, 1, 1, 1);
}
...
// Position - 0x3462D
void func_454(int iParam0, int iParam1) { Global_91491.f_22[iParam1] = iParam0; }
...
int func_456(var *uParam0) {
	...
	case 1:
		if (!func_459(&iVar0) || !streaming::has_anim_dict_loaded(sVar5)) {
			return 0;
		}
		iLocal_91 = 2;
		break;
	...
	case 2:
		...
		if (!entity::does_entity_exist(uParam0->f_35[0])) {
			...
			if (func_452(iVar4)) {
				...
				entity::set_entity_as_mission_entity(iVar4, 1, 1);
			}
			else {
				gameplay::clear_area_of_vehicles(-2892.93f, 3192.37f, 11.66f, 11f, 0, 0, 0, 0, 0);
		...
		if (func_452(uParam0->f_28[0]) && func_453(player::player_ped_id())) {
...
// Position - 0x349A8
void func_457(var *uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	func_4(uParam0);
	*uParam0 = ped::create_ped(iParam6, iParam1, vParam2, fParam5, 0, 0);
}

// Position - 0x349C9
void func_458(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_5(uParam0);
...
void func_462() {
	if (func_475()) {
		func_495("...Random Character Script was triggered so additional "
				 "cleanup required");
	}
	func_3(1);
...
void func_465(var *uParam0, int iParam1, int iParam2, int iParam3) {
	...
	func_466(uParam0, iParam3);
}

// Position - 0x34C3F
void func_466(var *uParam0, bool bParam1) { func_467(&uParam0->f_41, bParam1); }
...
// Position - 0x34CCA
void func_469(var *uParam0, bool bParam1) { func_470(&uParam0->f_35, bParam1); }
...
// Position - 0x34D19
void func_471(var *uParam0, int iParam1) { func_472(&uParam0->f_28, iParam1); }
...
bool func_478(char *sParam0, int iParam1, int iParam2) {
	...
	if (func_481()) {
		if (func_480()) {
			...
			iVar33 = func_341(script::get_this_script_name());
			if (iVar33 > -1) {
...
int func_479() {
	...
	iVar0 = func_344(&Global_91491.f_3, 0);
	iVar1 = 0;
	if (iVar0 == 53) {
		iVar1 = 1;
	}
...
bool func_481() {
	...
	if (Global_91491.f_11 == 5) {
		if (func_341(&Global_91491.f_3) > -1) {
			return true;
		}
	}
	return false;
...
// Position - 0x352FC
void func_485() { Global_17151.f_5 = 1; }

// Position - 0x3530A
void func_486() { Global_17151.f_5 = 0; }
...
// Position - 0x355DE
void func_495(char *sParam0) { sParam0 = sParam0; }
