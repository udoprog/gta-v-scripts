...
void __EntryFunction__() {
	...
	if (func_431()) {
		...
		case 1:
			func_429(vLocal_161, 298.7f, 1, 0);
			func_426(1);
			break;
	...
	while (true) {
		...
		if (iLocal_142 == 9) {
			...
			func_347();
			switch (iLocal_142) {
			case 0: func_346(); break;

			case 1: func_345(); break;

			case 2: func_344(); break;

			case 3: func_251(); break;

			case 4: func_248(); break;

			case 5: func_236(); break;

			case 6: func_231(); break;

			case 7: func_214(); break;
...
// Position - 0x25C16
bool func_206(int iParam0, vector3 vParam1, float fParam4) {
	...
	case 1:
		if (entity::is_entity_at_coord(Local_145.f_4, vLocal_161, 10f, 10f, 2f, 0, 1, 0)) {
			if (iLocal_437) {
				...
				func_216();
				if (!func_215(player::player_ped_id(), Local_145.f_4, 55f, 1) &&
					!entity::is_entity_on_screen(Local_145.f_4)) {
					iLocal_143 = 2;
				}
...
// Position - 0x25F6C
bool func_217(var *uParam0, int iParam1, char *sParam2, char *sParam3, int iParam4, int iParam5, int iParam6,
	...
	Global_2621441 = 0;
	return func_218(sParam3, iParam4, iParam8);
}

// Position - 0x25FCB
int func_218(char *sParam0, int iParam1, int iParam2) {
	Global_15746 = 0;
...
// Position - 0x26841
bool func_234(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
void func_236() {
	...
	case 1:
		func_242(&iLocal_450, &uLocal_251, "BAR3AAU", &sLocal_451, &cLocal_457);
...
void func_239() {
	if (iLocal_428 && iLocal_426 < 4) {
		if (!func_211() && ped::is_ped_in_vehicle(player::player_ped_id(), Local_145.f_4, 0)) {
			...
			if (gameplay::get_game_timer() - iLocal_427 > Local_416[iLocal_426 /*2*/].f_1 &&
				(func_241() || iLocal_426 == 0)) {
...
// Position - 0x26C8C
int func_241() {
	if (ped::is_cop_ped_in_area_3d(entity::get_entity_coords(player::player_ped_id(), 1) - Vector(70f, 70f, 70f),
								   entity::get_entity_coords(player::player_ped_id(), 1) + Vector(70f, 70f, 70f))) {
		return 1;
	}
	return 0;
}
...
// Position - 0x26CD2
void func_242(int *iParam0, var *uParam1, char *sParam2, char *sParam3, char *sParam4) {
	switch (*iParam0) {
	case 0: break;
	...
	case 1:
		if (ped::is_ped_in_vehicle(player::player_ped_id(), Local_145.f_4, 0)) {
			if (player::get_player_wanted_level(player::player_id()) > 0) {
				...
				if (ped::is_ped_sitting_in_vehicle(player::player_ped_id(), Local_145.f_4) &&
					entity::is_entity_at_coord(Local_145.f_4, vLocal_161, 6f, 6f, 2f, 1, 1, 0)) {
					iLocal_439 = 0;
					iLocal_143 = 2;
				}
				if (!iLocal_432) {
...
void func_253(int iParam0, var uParam1, int iParam2, int iParam3) {
	func_254(&Global_96040, script::get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_254(var *uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) {
	...
	*uParam0 = func_224();
	...
	while (iVar1 < 3) {
		...
		if (iVar1 == func_275()) {
			func_271(player::player_ped_id(), &uParam0->f_616[iVar1 /*65*/], 1);
		}
		else {
			iVar0 = 0;
			while (iVar0 < 12) {
...
// Position - 0x28DFB
bool func_270(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
// Position - 0x290A9
void func_273(int iParam0, int iParam1, int *iParam2, int *iParam3, int iParam4, int iParam5) {
	int iVar0;
...
// Position - 0x295F1
void func_274(int iParam0, int iParam1, int *iParam2, int *iParam3, var *uParam4, int iParam5, int iParam6) {
	int iVar0;
...
void func_277(int iParam0, var *uParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		while (iVar0 <= 44 - 1) {
			...
			if (iVar3 != 0) {
				vVar4.x = weapon::get_ped_weapontype_in_slot(iParam0, func_281(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		iVar7 = 0;
		while (iVar7 < iVar8) {
			if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_278(Var9.f_1) && iVar70 < 50) {
...
// Position - 0x2B086
bool func_285(int iParam0, var *uParam1, float *fParam2) {
	*uParam1 = {0f, 0f, 0f};
	*fParam2 = 0f;
	switch (iParam0) {
	case 0:
...
// Position - 0x2B715
bool func_286(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
bool func_287(int *iParam0) {
	if (!entity::is_entity_dead(player::player_ped_id(), 0) && !ped::is_ped_injured(player::player_ped_id())) {
		if (func_297()) {
			*iParam0 = func_292(entity::get_entity_coords(player::player_ped_id(), 0), 6, -1, 0, 1, -1);
...
int func_289(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_7() == 0) {
			return gameplay::is_bit_set(func_69(func_290(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0x2BAEE
int func_291(int iParam0) { return func_289(iParam0, 5, 1); }

// Position - 0x2BAFE
int func_292(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
	...
	while (iVar0 <= 45) {
		if (iParam3 == 6 || iParam3 == func_296(iVar0)) {
			if (!iParam5 || func_295(iVar0)) {
				fVar1 = gameplay::get_distance_between_coords(vParam0, func_293(iVar0, 0), 1);
...
Vector3 func_293(int iParam0, int iParam1) {
	...
	case 45: return func_294(Global_93004);
	}
...
// Position - 0x2C1D1
int func_295(int iParam0) { return func_289(iParam0, 0, 0); }
...
// Position - 0x2C454
bool func_297() { return Global_91543.f_303 > 0; }

// Position - 0x2C465
var func_298() {
	int *iVar0;

	func_308(&iVar0, time::get_clock_seconds());
	func_307(&iVar0, time::get_clock_minutes());
	func_306(&iVar0, time::get_clock_hours());
	func_301(&iVar0, time::get_clock_day_of_month());
	func_300(&iVar0, time::get_clock_month());
	func_299(&iVar0, time::get_clock_year());
	return iVar0;
}
...
var func_303(int iParam0) {
	return (system::shift_right(iParam0, 26) & 31) * func_304(gameplay::is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
// Position - 0x2C693
int func_305(var uParam0) { return uParam0 & 15; }
...
int func_310(int iParam0) {
	switch (iParam0) {
	case 69:
	case 70: return func_311(Global_101700.f_8044.f_99.f_205[10]);

	case 74:
	case 75: return func_311(Global_101700.f_8044.f_99.f_205[8]);

	case 84:
	case 85: return func_311(Global_101700.f_8044.f_99.f_205[11]);

	case 90: return func_311(Global_101700.f_8044.f_99.f_205[7]);

	case 93: return func_311(Global_101700.f_8044.f_99.f_205[9]);
	}
	return 0;
}
	...
	if (entity::does_entity_exist(Global_93635.f_4)) {
		if (vehicle::is_vehicle_driveable(Global_93635.f_4, 0)) {
			if (func_343(24) != Global_93635.f_4) {
				if (iParam4 == 1) {
					if (func_340(entity::get_entity_coords(Global_93635.f_4, 1), iParam5, &vVar0, &fVar3)) {
						vParam0 = {vVar0};
						fParam3 = fVar3;
					}
				}
				func_317(Global_93635.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
// Position - 0x2CC5E
void func_317(int iParam0, vector3 vParam1, float *fParam4, int iParam5, int iParam6) {
	struct<60> Var0;
	...
	if (entity::does_entity_exist(iParam0) && vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		func_336(iParam5, &Var0, vParam1, fParam4, func_261(iParam0));
...
int func_320(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_269(iParam0, 0, 0) ||
		func_269(iParam0, 1, 0) || func_269(iParam0, 2, 0) || func_261(iParam0) != 145 || func_334(iParam0) ||
		func_333(iParam0) || func_332(iParam0) || func_331(iParam0) || !func_321(entity::get_entity_model(iParam0))) {
		if (func_333(iParam0)) {
		}
		if (func_333(iParam0)) {
		}
...
// Position - 0x2E2E5
int func_326() { return 0; }

// Position - 0x2E2EE
int func_327() { return 1; }

// Position - 0x2E2F7
int func_328() { return 1; }
...
// Position - 0x2FCB0
void func_336(int iParam0, var *uParam1, vector3 vParam2, var uParam5, int iParam6) {
	if (func_335(&Global_68531.f_555[0 /*21*/], iParam0)) {
...
// Position - 0x2FF1C
bool func_340(vector3 vParam0, int iParam3, var *uParam4, float *fParam5) {
	int iVar0;

	iVar0 = func_341(vParam0, iParam3, 1);
	switch (iVar0) {
	case 0:
...
// Position - 0x30033
int func_341(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
...
// Position - 0x300C2
var func_342(int iParam0) { return gameplay::is_bit_set(Global_101700.f_6188[iParam0], 0); }
...
void func_346() {
	if (ui::has_additional_text_loaded(0)) {
		vehicle::set_all_vehicle_generators_active_in_area(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, 0,
														   1);
		iLocal_144 = func_207(Local_145.f_4, 1, 5);
		iLocal_142 = 1;
		iLocal_143 = 0;
...
void func_348(int iParam0) {
		...
		if (!entity::does_entity_exist(Local_186[iParam0 /*29*/].f_1)) {
			if (func_203(Local_186[iParam0 /*29*/])) {
				if (streaming::has_model_loaded(iLocal_247)) {
					Local_186[iParam0 /*29*/].f_1 =
						ped::create_ped_inside_vehicle(Local_186[iParam0 /*29*/], 6, iLocal_247, -1, 1, 1);
					Local_186[iParam0 /*29*/].f_2 =
						ped::create_ped_inside_vehicle(Local_186[iParam0 /*29*/], 6, iLocal_247, 0, 1, 1);
				}
			}
			else if (streaming::has_model_loaded(iLocal_246)) {
				Local_186[iParam0 /*29*/] = vehicle::create_vehicle(iLocal_246, Local_186[iParam0 /*29*/].f_3,
																	Local_186[iParam0 /*29*/].f_6, 1, 1);
			}
		}
	...
	case 1:
		if (func_206(player::player_ped_id(), Local_186[iParam0 /*29*/].f_3, 275f)) {
			...
			else if (func_366(Local_186[iParam0 /*29*/]) || func_353(Local_186[iParam0 /*29*/].f_1) ||
					 func_353(Local_186[iParam0 /*29*/].f_2)) {
				func_351(iParam0, 0);
			}
			else if (player::get_player_wanted_level(player::player_id()) > 0) {
				func_351(iParam0, 0);
		...
		if (ped::is_ped_on_foot(player::player_ped_id())) {
			if (func_353(Local_186[iParam0 /*29*/].f_1) || func_353(Local_186[iParam0 /*29*/].f_2) ||
	...
	case 2:
		...
		else if (func_353(Local_186[iParam0 /*29*/].f_1) || func_353(Local_186[iParam0 /*29*/].f_2) ||
				 func_366(Local_186[iParam0 /*29*/])) {
			func_351(iParam0, 0);
		}
		break;
...
// Position - 0x308C8
bool func_354(int iParam0, float fParam1) {
	float fVar0;
...
// Position - 0x3093E
bool func_355(int iParam0, float fParam1) { return func_356(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_356(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_357(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0x30A17
int func_357(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
	...
	if (*iParam0 == 0) {
		vVar1 = {func_358(iParam4, iParam7)};
		*iParam0 =
...
int func_360(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	vVar0 = {func_362(entity::get_entity_coords(iParam1, 1) - entity::get_entity_coords(iParam0, 1))};
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_362(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
						  ped::get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_361(vVar3, vVar0);
...
bool func_367(int iParam0) {
	if (entity::is_entity_in_angled_area(Local_145.f_4, Local_186[iParam0 /*29*/].f_7[0 /*8*/][0 /*3*/],
										 Local_186[iParam0 /*29*/].f_7[0 /*8*/][1 /*3*/],
										 Local_186[iParam0 /*29*/].f_7[0 /*8*/].f_7, 0, 1, 0)) {
		return true;
	}
	else if (Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7 != 0f &&
			 entity::is_entity_in_angled_area(Local_145.f_4, Local_186[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/],
											  Local_186[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/],
											  Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7, 0, 1, 0)) {
		return true;
	}
	return false;
}
...
bool func_371() {
	...
	case 1:
		...
		iLocal_440 += gameplay::get_game_timer();
...
// Position - 0x31312
bool func_379() { return Global_91543.f_304 > 0; }
...
void func_380() {
	...
	if (iLocal_442) {
		if (!cutscene::is_cutscene_playing() && !func_384(0) && !func_379()) {
...
// Position - 0x313A4
void func_381(int iParam0, char *sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
// Position - 0x314F2
void func_382(int iParam0, int iParam1) { gameplay::set_bit(&Global_1354542.f_5703[iParam0], iParam1); }

// Position - 0x3150B
int func_383(int iParam0, int iParam1) { return gameplay::is_bit_set(Global_1354542.f_5703[iParam0], iParam1); }
...
struct<2> func_387(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_395(iParam0)}; break;
	...
	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_394(iParam2)}; break;

		case 8: Var0 = {func_393(iParam2)}; break;

		case 7: Var0 = {func_392(iParam2)}; break;

		case 10: Var0 = {func_391(iParam2)}; break;

		case 5: Var0 = {func_390(iParam2)}; break;

		case 4: Var0 = {func_389(iParam2)}; break;

		default: StringCopy(&Var0, func_388(iVar2), 8); break;
		}
		break;
...
//Position - 0x31C44
bool func_396(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (!func_398(0) || G_TextMessageConfig || Global_69960 == 1 || !cam::is_screen_faded_in()) {
		return false;
	}
	switch (Global_69956) {
	case 0:
	...
	case 5:
		if (cutscene::is_cutscene_playing() || func_384(0) || func_397(1)) {
		}
		else {
			return true;
		}
...
// Position - 0x31DA7
bool func_399(int iParam0) { return func_400(iParam0, Global_35781); }
...
// Position - 0x31FE7
void func_402(var uParam0, int iParam1) { Global_91491.f_22[iParam1] = uParam0; }
	...
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_414(player::player_id()) &&
				!func_412(player::player_id(), 0) && !func_411()) {
				entity::set_entity_invincible(player::player_ped_id(), 0);
			}
		}
		else if (!ped::is_ped_injured(player::player_ped_id()) && !func_414(player::player_id())) {
			entity::set_entity_invincible(player::player_ped_id(), 0);
		}
...
// Position - 0x3229A
bool func_411() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x32385
bool func_415() { return gameplay::is_bit_set(Global_2359301, 3); }

// Position - 0x32396
int func_416(int iParam0, int iParam1, var uParam2, int iParam3) {
	int iVar0;
...
// Position - 0x3255A
var func_420() { return gameplay::is_bit_set(Global_91491.f_20, 13); }
...
// Position - 0x32646
void func_423(vector3 vParam0, float fParam3, int iParam4) {
	...
	func_205(&iLocal_155);
	func_202(&Local_145.f_4);
	Local_145.f_4 = vehicle::create_vehicle(Local_145.f_5, vParam0, fParam3, 1, 1);
	vehicle::set_vehicle_colour_combination(Local_145.f_4, 1);
	if (iParam4) {
		func_424(player::player_ped_id(), Local_145.f_4, -1);
	}
	vehicle::_0x51BB2D88D31A914B(Local_145.f_4, 0);
	vehicle::_0x192547247864DFDD(Local_145.f_4, 0);
	vehicle::set_vehicle_strong(Local_145.f_4, 1);
	...
	iLocal_155 = object::create_object(iLocal_159, vParam0, 1, 1, 0);
	entity::attach_entity_to_entity(iLocal_155, Local_145.f_4, 0, vLocal_156, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
	entity::set_entity_collision(iLocal_155, 1, 0);
	iLocal_152 = 1;
	func_402(Local_145.f_4, 0);
...
// Position - 0x3294E
void func_428(int iParam0, int iParam1) { vLocal_167[iParam0 /*3*/].f_1 = iParam1; }

// Position - 0x32960
void func_429(vector3 vParam0, float fParam3, int iParam4, int iParam5) {
	if (func_431()) {
...
// Position - 0x32EF4
void func_436() {
	vLocal_167[0 /*3*/] = {func_437("B3ADELV", 1)};
	vLocal_167[1 /*3*/] = {func_437("B3AGETIN", 1)};
	vLocal_167[2 /*3*/] = {func_437("B3AWAN1", -1)};
	vLocal_167[3 /*3*/] = {func_437("B3ARTV", 1)};
	vLocal_167[4 /*3*/] = {func_437("B3AEXIT", 1)};
	vLocal_167[5 /*3*/] = {func_437("B3ALEAVE", 1)};
}
...
// Position - 0x3301C
void func_440(var *uParam0, int iParam1, int iParam2, int iParam3) {
	func_445(uParam0, iParam1);
	func_443(uParam0, iParam2);
	func_441(uParam0, iParam3);
}

// Position - 0x3303C
void func_441(var *uParam0, bool bParam1) { func_442(&uParam0->f_41, bParam1); }
...
// Position - 0x3308C
void func_443(var *uParam0, bool bParam1) { func_444(&uParam0->f_35, bParam1); }
...
// Position - 0x330DB
void func_445(var *uParam0, int iParam1) { func_446(&uParam0->f_28, iParam1); }
...
// Position - 0x335C7
void func_457() { Global_17151.f_5 = 1; }

// Position - 0x335D5
void func_458() { Global_17151.f_5 = 0; }
