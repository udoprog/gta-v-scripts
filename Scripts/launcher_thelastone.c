...
void __EntryFunction__() {
	...
	if (player::has_force_cleanup_occurred(83)) {
		...
		if (Var0 != -1) {
			if (Global_100787[Var0 /*10*/].f_9 != -1) {
				...
				func_251(&Global_100787[Var0 /*10*/].f_9);
			}
		}
		func_238(&Var0, 1);
	}
	if (!func_235(&iVar64, &Var0, vVar61, 1f)) {
		func_234();
	...
	while (true) {
		...
		func_181(Var0);
		func_174(&iLocal_93, &iLocal_94, &Var0.f_9, vVar61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_167(&Var0, vVar61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_152(&Var0, 0)) {
			if (!func_2(&Var0)) {
				func_238(&Var0, 1);
			}
...
int func_2(var *uParam0) {
	...
	if (!func_151()) {
		while (!func_142(*uParam0)) {
			...
			if (!func_182(uParam0, *uParam0 != 2)) {
				func_252("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() "
						 "[TERMINATING]");
				return 0;
			}
			system::wait(0);
	...
	if (!func_98(uParam0)) {
		func_252("STEP_7_COMMON_LaunchMission - Trying to launch a null script "
				 "string name");
		return 0;
	}
...
int func_98(int iParam0) {
	...
	if (func_128(&uParam0->f_1)) {
		...
		if (cutscene::has_cutscene_loaded()) {
			...
			func_252("Initial cutscene wasn't loaded in time to pass to RC "
					 "mission.");
					...
					if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
						...
						if (func_158(2)) {
							if (func_156(uParam0->f_27)) {
								...
								func_252("ARE_RC_TRIGGER_CONDITIONS_MET: "
		...
		if (*uParam0 == 6) {
			...
			if (ai::get_ped_desired_move_blend_ratio(player::player_ped_id()) >= 2f) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 245.8885f, 371.9034f, 103.9884f,
					...
					if (func_158(2)) {
						if (func_156(uParam0->f_27)) {
							func_155(uParam0->f_27, *uParam0);
							func_252("RC5_IN_ACTIVATION_RANGE: "
			...
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 2728.948f, 4143.44f, 42.29295f, 2722.213f,
				...
				if (func_158(2)) {
					if (func_156(1)) {
						func_155(1, *uParam0);
						func_252("RC_IN_ACTIVATION_RANGE: "
	...
	if (iParam0 == 1) {
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			...
			if (ped::is_ped_in_any_heli(player::player_ped_id()) || ped::is_ped_in_any_plane(player::player_ped_id())) {
				func_252("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for "
						 "plane or helicopter.");
...
// Position - 0xAFCF
int func_167(var *uParam0, vector3 vParam1, char[4] cParam4, char *sParam5, int iParam6, char *sParam7, int iParam8) {
	var *uVar0;

	if (func_158(2)) {
		if (!func_131()) {
			if (func_112(player::player_ped_id()) && func_112(uParam0->f_28[0]) &&
				gameplay::get_game_timer() - uParam0->f_60 > iParam8 &&
				func_173(player::player_ped_id(), vParam1, 1) < 20f) {
				uVar0 = 16;
			...
			if (func_112(player::player_ped_id())) {
				if (func_173(player::player_ped_id(), vParam1, 1) >= 20f) {
					func_129();
				}
			}
		}
...
// Position - 0xB23B
void func_174(int *iParam0, int *iParam1, char *sParam2, vector3 vParam3, vector3 vParam6, vector3 vParam9) {
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (player::is_player_playing(player::player_id())) {
		if (!gameplay::is_string_null_or_empty(sParam2)) {
			if (func_180()) {
				...
				if (func_173(player::player_ped_id(), vParam3, 1) <= 100f) {
					func_177(iParam0, 1);
				}
			}
			else {
				if (func_176(*iParam0) == 2) {
					...
					fVar0 = func_173(player::player_ped_id(), vParam6, 1);
					fVar1 = func_173(player::player_ped_id(), vParam9, 1);
					fVar2 = fVar0 - fVar1;
					if (fVar2 < 0f) {
						fVar2 *= -1f;
					}
				...
				if (func_173(player::player_ped_id(), vParam3, 1) > 120f) {
					func_178(iParam0);
				}
			}
		}
...
// Position - 0xB56B
bool func_180() { return Global_89133; }
...
int func_182(var *uParam0, int iParam1) {
	...
	if (Global_69702) {
		func_252("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer "
				 "[TERMINATING]");
		return 0;
	}
	func_95(*uParam0, &Var0);
	...
	if (func_213(*uParam0)) {
		...
		func_252("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1) {
	...
	if (*uParam0 == 10) {
		if (fire::is_explosion_in_sphere(-1, uParam0->f_17[0 /*3*/], 8f)) {
			func_252("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission "
					 "trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17) {
		if (!gameplay::is_bit_set(Var0.f_26, func_90())) {
			func_252("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player "
		...
		while (iVar0 <= iVar1) {
			if (entity::does_entity_exist(uParam0->f_35[iVar0])) {
				if (entity::is_entity_dead(uParam0->f_35[iVar0], 0)) {
					func_252("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (!ped::is_ped_injured(uParam0->f_28[iVar0])) {
					if (ped::is_ped_sitting_in_any_vehicle(player::player_ped_id())) {
						if (entity::is_entity_touching_entity(player::player_ped_id(), uParam0->f_28[iVar0])) {
							...
							func_252("STEP_5_COMMON_RCfineAndInRange - Random "
					...
					if (func_211(*uParam0)) {
						...
						if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(uParam0->f_28[iVar0], 1), 15f)) {
							...
							func_252("STEP_5_COMMON_RCfineAndInRange - There "
					...
					if (!func_193(*uParam0)) {
						...
						if (player::get_player_wanted_level(player::player_id()) > 0) {
							...
							func_252("STEP_5_COMMON_RCfineAndInRange - Player "
...
int func_221(var *uParam0) {
	...
	case 1:
		if (!func_224(&iVar0) || !streaming::has_anim_dict_loaded("rcmlastone1") ||
...
int func_226(int iParam0) {
	...
	if (Global_69702) {
		func_252("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is "
				 "running [TERMINATING]");
		return 0;
	}
	if (!Global_101700.f_8044 && !func_93(1)) {
		func_252("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not "
				 "active");
		return 0;
	}
	if (!func_227(iParam0)) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_252("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (Global_91491.f_11 == 6) {
		if (Global_91491 < 9) {
			...
			if (gameplay::are_strings_equal(&Global_91491.f_3, sVar0)) {
				func_252("STEP_3_COMMON_CanRCLaunch - Script denied as a "
	...
	if (script::_get_number_of_instances_of_script_with_name_hash(joaat("candidate_controller")) == 0) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_252("STEP_3_COMMON_CanRCLaunch - Script denied as "
...
// Position - 0xD685
int func_235(int iParam0, int iParam1, vector3 vParam2, float fParam5) {
	int iVar0;

	if (*iParam0 == 1) {
		if (func_236((*iParam0)[0], vParam2, fParam5, iParam1)) {
			return 1;
		}
	}
	else {
		iVar0 = 0;
		while (iVar0 < *iParam0) {
			if (func_236((*iParam0)[iVar0], vParam2, fParam5, iParam1)) {
				iVar0 = *iParam0;
				return 1;
			}
			iVar0++;
	...
	func_252("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch "
			 "[TERMINATING]");
	return 0;
}

// Position - 0xD6EA
bool func_236(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	int iVar0;
	struct<7> Var1;

	iVar0 = 0;
	func_95(iParam0, &Var1);
	if (func_237(Var1.f_6, vParam1, fParam4, 0)) {
...
// Position - 0xD768
bool func_237(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
// Position - 0xD88F
void func_241(var *uParam0, bool bParam1) { func_242(&uParam0->f_41, bParam1); }
...
// Position - 0xD91A
void func_244(var *uParam0, bool bParam1) { func_245(&uParam0->f_35, bParam1); }
...
// Position - 0xD9A1
void func_247(var *uParam0, int iParam1) { func_248(&uParam0->f_28, iParam1); }
