...
void func_17(char *sParam0) {
	switch (iLocal_254) {
	case 0: StringCopy(sParam0, "Im_An_Actor", 64); break;

	case 1: StringCopy(sParam0, "I_Wanna_Do_Hamlet", 64); break;

	case 2: StringCopy(sParam0, "Having_About_as_Much", 64); break;

	case 3: StringCopy(sParam0, "Just_Woundering_When", 64); break;

	case 4: StringCopy(sParam0, "Great_I_Wanted_To", 64); break;

	case 5: StringCopy(sParam0, "A_Tourist_Just_Asked", 64); break;
	}
}
...
void func_51(int iParam0, char *sParam1, char *sParam2) {
	...
	switch (iParam0) {
	case 1: StringCopy(sParam2, "Grr_Im_Impotent_Rage", 64); break;

	case 2: StringCopy(sParam2, "Im_Really_Pretty_Mad", 64); break;

	case 3: StringCopy(sParam2, "Im_Completely_Crazy_Here", 64); break;

	case 4: StringCopy(sParam2, "This_Is_Just_Insanity", 64); break;

	case 5: StringCopy(sParam2, "Im_So_Damn_Mad", 64); break;

	case 6: StringCopy(sParam2, "Dont_Get_Me_Excited", 64); break;

	case 7: StringCopy(sParam2, "Ill_Find_The_Doughnut", 64); break;

	case 8: StringCopy(sParam2, "America_Im_The_Hero", 64); break;

	case 9: StringCopy(sParam2, "I_Am_The_Ultimate", 64); break;

	case 10: StringCopy(sParam2, "I_Will_Defeat_The", 64); break;

	case 11: StringCopy(sParam2, "Really_Very_Unhappy", 64); break;

	case 12: StringCopy(sParam2, "You_Cant_Stop_My", 64); break;

	case 13: StringCopy(sParam2, "I_Am_White_Male", 64); break;

	case 14: StringCopy(sParam2, "Youll_Not_Stop_me", 64); break;

	case 15: StringCopy(sParam2, "Newest_Superhero", 64); break;
	}
}
...
// Position - 0x256D
void func_59(char *sParam0) { func_19(iLocal_297, sParam0); }
