...
void __EntryFunction__() {
	...
	while (true) {
		...
		func_233();
		switch (iLocal_28) {
		case 0: func_232(); break;

		case 1: func_227(); break;

		case 2: func_209(); break;

		case 3: func_201(); break;

		case 4: func_116(); break;

		case 5: func_28(); break;
	...
	if (iLocal_28 == 3 || iLocal_28 == 4) {
		if (entity::does_entity_exist(iLocal_48)) {
			if (vehicle::is_vehicle_driveable(iLocal_48, 0)) {
				...
				else if (vehicle::is_vehicle_stuck_timer_up(iLocal_48, 3, 30000) ||
						 vehicle::is_vehicle_stuck_timer_up(iLocal_48, 1, 40000) ||
						 vehicle::is_vehicle_stuck_timer_up(iLocal_48, 0, 7000)) {
					func_3(3);
					return;
				}
			}
...
void func_4() {
	...
	case 0:
		...
		case 1: sLocal_324 = "DP_FAIL1"; break;

		case 2: sLocal_324 = "DP_FAIL2"; break;

		case 3: sLocal_324 = "DP_FAIL3"; break;
		}
		if (iLocal_29 == 0) {
			func_13(0);
		}
...
// Position - 0x362
void func_5(vector3 vParam0, float fParam3) { func_6(&Global_96040.f_2311, vParam0, fParam3); }
...
// Position - 0x3BD
bool func_8(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
void func_15(var *uParam0, int iParam1) {
	...
	while (iVar0 < 3) {
		...
		if (iVar1 == 8 || iVar1 == 9 || iVar1 == 10 || iVar1 == 11 || iVar1 == 34 || iVar1 == 72 || iVar1 == 73)
			...
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_17(Global_101700.f_17492[iVar0], &vVar2, &fVar5)) {
...
// Position - 0x7BD
void func_16(int *iParam0) { *iParam0 = -15; }
...
int func_17(int iParam0, var *uParam1, float *fParam2) {
	...
	case 9: return func_17(8, uParam1, fParam2);

	case 10: return func_17(8, uParam1, fParam2);
...
// Position - 0x183C
bool func_35() { return gameplay::is_bit_set(Global_91491.f_20, 13); }
...
void func_36() {
	...
	case 2:
		...
		func_98(-1720.5f, 2568.4f, 67.1f, -1523.2f, 3002f, -70f, 100f, -1155.06f, 2665.979f, 17.0939f, 219.2079f, 1, 0,
				1, 0, 0);
		...
		while (
			!streaming::has_model_loaded(joaat("cargobob")) || !streaming::has_model_loaded(joaat("s_m_y_marine_01")) ||
			!streaming::has_model_loaded(joaat("s_m_m_pilot_02")) || !streaming::has_model_loaded(joaat("buzzard"))) {
			system::wait(0);
		}
		if (func_244()) {
			if (func_97()) {
				if (!vehicle::is_this_model_a_heli(func_96()) && !vehicle::is_this_model_a_plane(func_96())) {
					func_94();
					while (!func_93()) {
						system::wait(0);
					}
		...
		if (!entity::does_entity_exist(iLocal_48)) {
			...
			iLocal_48 = vehicle::create_vehicle(joaat("cargobob"), vLocal_311, fLocal_323, 1, 1);
			vehicle::set_vehicle_can_be_targetted(iLocal_48, 0);
			entity::freeze_entity_position(iLocal_48, 1);
			entity::set_entity_load_collision_flag(iLocal_48, 1);
		...
		if (!entity::does_entity_exist(uLocal_49[0])) {
			if (streaming::has_model_loaded(joaat("buzzard"))) {
				...
				uLocal_49[0] =
					vehicle::create_vehicle(joaat("buzzard"), -1866.446f, 3071.395f, 31.8104f, 150.2863f, 1, 1);
				entity::set_entity_load_collision_flag(uLocal_49[0], 1);
	...
	case 3:
		...
		streaming::request_model(joaat("s_m_y_marine_01"));
		streaming::request_model(joaat("s_m_m_pilot_02"));
		while (!streaming::has_model_loaded(joaat("cargobob")) || !streaming::has_model_loaded(joaat("buzzard")) ||
			   !streaming::has_model_loaded(joaat("s_m_y_marine_01")) ||
			   !streaming::has_model_loaded(joaat("s_m_m_pilot_02"))) {
			system::wait(0);
		}
		iLocal_201 = 0;
		iLocal_176 = 0;
	...
	case 4:
		...
		if (!entity::does_entity_exist(iLocal_48)) {
			gameplay::clear_area(vLocal_311, 10f, 1, 0, 0, 0);
			iLocal_48 = vehicle::create_vehicle(joaat("cargobob"), -629.1677f, 2871.31f, 385.0313f, 283.1214f, 1, 1);
			entity::set_entity_load_collision_flag(iLocal_48, 1);
			streaming::set_model_as_no_longer_needed(joaat("cargobob"));
			vehicle::set_vehicle_model_is_suppressed(joaat("cargobob"), 1);
			vehicle::set_vehicle_engine_can_degrade(iLocal_48, 0);
	...
	case 5:
		...
		if (!entity::does_entity_exist(iLocal_48)) {
			...
			iLocal_48 = vehicle::create_vehicle(joaat("cargobob"), 1749.61f, 3272.95f, 40.1533f, 51.128f, 1, 1);
			entity::set_entity_load_collision_flag(iLocal_48, 1);
			streaming::set_model_as_no_longer_needed(joaat("cargobob"));
			vehicle::set_vehicle_strong(iLocal_48, 1);
			vehicle::set_vehicle_engine_can_degrade(iLocal_48, 0);
		...
		if (!entity::does_entity_exist(uLocal_51[0])) {
			uLocal_51[0] = vehicle::create_vehicle(joaat("sandking"), 1754.951f, 3290.994f, 40.1176f, 182.397f, 1, 1);
...
// Position - 0x1F21
int func_37(vector3 vParam0, float fParam3) { return func_38(&Global_96040.f_2311, vParam0, fParam3, 0); }
	...
	case joaat("cuban800"):
		...
		while (iVar6 <= iVar5 - 1) {
			if (func_75(iParam0, uVar1[iVar6], 1) &&
				...
				if (!bParam4 || func_8(vParam1, 0f, 0f, 0f, 0) ||
	...
	if (iLocal_201 == 0) {
		if (streaming::has_model_loaded(joaat("s_m_y_marine_01")) &&
			...
			if (!entity::does_entity_exist(uLocal_33[0])) {
				uLocal_33[0] =
					ped::create_ped(26, joaat("s_m_y_marine_01"), -1590.523f, 2796.302f, 15.9184f, 247.0896f, 1, 1);
			}
			if (!entity::does_entity_exist(uLocal_33[1])) {
				uLocal_33[1] =
					ped::create_ped(26, joaat("s_m_y_marine_01"), -2303.8f, 3387.99f, 30.034f, 58.5763f, 1, 1);
			}
			if (!entity::does_entity_exist(uLocal_33[2])) {
				uLocal_33[2] =
					ped::create_ped(26, joaat("s_m_y_marine_01"), -1697.329f, 2909.941f, 31.9506f, 245.656f, 1, 1);
			}
			if (!entity::does_entity_exist(uLocal_33[3])) {
				uLocal_33[3] =
					ped::create_ped(26, joaat("s_m_y_marine_01"), -1696.369f, 2905.772f, 31.9454f, 6.3714f, 1, 1);
			}
			if (!entity::does_entity_exist(uLocal_33[4])) {
				uLocal_33[4] =
					ped::create_ped(26, joaat("s_m_y_marine_01"), -1843.707f, 2821.611f, 31.8528f, 271.6265f, 1, 1);
			}
			if (!entity::does_entity_exist(uLocal_33[5])) {
				uLocal_33[5] =
					ped::create_ped(26, joaat("s_m_y_marine_01"), -2006.877f, 2955.101f, 31.8103f, 332.0101f, 1, 1);
			}
			if (!entity::does_entity_exist(uLocal_33[6])) {
				uLocal_33[6] =
					ped::create_ped(26, joaat("s_m_y_marine_01"), -2010.022f, 2956.805f, 31.8103f, 288.1283f, 1, 1);
			}
			if (iLocal_28 != 3) {
				if (!entity::does_entity_exist(uLocal_33[7])) {
					uLocal_33[7] =
						ped::create_ped(26, joaat("s_m_y_marine_01"), -2140.213f, 3034.609f, 31.81f, 302.4493f, 1, 1);
				}
				if (!entity::does_entity_exist(uLocal_33[8])) {
					uLocal_33[8] =
						ped::create_ped(26, joaat("s_m_y_marine_01"), -2136.053f, 3031.494f, 31.81f, 38.6856f, 1, 1);
				}
			}
			if (!entity::does_entity_exist(uLocal_33[9])) {
				uLocal_33[9] =
					ped::create_ped(26, joaat("s_m_y_marine_01"), -2035.429f, 3058.876f, 31.8103f, 169.8222f, 1, 1);
			}
			if (!entity::does_entity_exist(uLocal_33[10])) {
				uLocal_33[10] =
					ped::create_ped(26, joaat("s_m_y_marine_01"), -2146.467f, 3160.749f, 31.8106f, 356.4766f, 1, 1);
			}
			if (!entity::does_entity_exist(uLocal_33[11])) {
				uLocal_33[11] =
					ped::create_ped(26, joaat("s_m_y_marine_01"), -2280.087f, 3172.423f, 31.8103f, 353.663f, 1, 1);
			}
			if (!entity::does_entity_exist(uLocal_33[12])) {
				uLocal_33[12] =
					ped::create_ped(26, joaat("s_m_y_marine_01"), -2277.376f, 3177.8f, 31.8103f, 175.0685f, 1, 1);
			}
			if (!entity::does_entity_exist(uLocal_31[0])) {
				uLocal_31[0] =
					ped::create_ped(26, joaat("s_m_m_pilot_02"), -1859.831f, 3071.758f, 31.8104f, 139.3607f, 1, 1);
				ped::set_ped_prop_index(uLocal_31[0], 0, 2, 0, 0);
				ped::set_ped_component_variation(uLocal_31[0], 8, 0, 0, 0);
				entity::set_entity_load_collision_flag(uLocal_31[0], 1);
			...
			while (iLocal_176 <= 12) {
				if (iLocal_275[iLocal_176] == 0) {
					if (!ped::is_ped_injured(uLocal_33[iLocal_176])) {
						entity::set_entity_load_collision_flag(uLocal_33[iLocal_176], 1);
...
// Position - 0x7217
void func_92(int iParam0, int iParam1) { Global_91491.f_22[iParam1] = iParam0; }

// Position - 0x722B
int func_93() { return func_87(&Global_96040.f_2311); }

// Position - 0x723E
void func_94() { func_95(&Global_96040.f_2311); }
...
// Position - 0x726F
var func_96() { return Global_96040.f_2311.f_12.f_66; }

// Position - 0x7282
bool func_97() { return func_88(&Global_96040.f_2311); }

// Position - 0x7295
void func_98(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11,
			 int iParam12, int iParam13, int iParam14, int iParam15) {
	func_99(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

// Position - 0x72BE
void func_99(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
		...
		if (vehicle::is_vehicle_driveable(iVar0, 0)) {
			...
			if (entity::is_entity_in_angled_area(iVar0, vParam0, vParam3, fParam6, 0, 1, 0)) {
				...
				if (vVar10.z > vParam0.z && vVar10.z < vParam3.z || vVar10.z > vParam3.z && vVar10.z < vParam0.z) {
					if (func_101(iVar0, vParam0, vParam3, fParam6)) {
						bVar1 = true;
					}
				}
			}
...
// Position - 0x76DA
bool func_101(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	vector3 vVar9;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		vParam1.z = vParam4.z;
		vVar0 = {func_103(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (func_102(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_102(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_102(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_102(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_102(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_102(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_102(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_102(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_102(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_102(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_102(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_102(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_102(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_102(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_102(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_102(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x79D0
int func_102(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
void func_105() {
	...
	if (entity::does_entity_exist(Global_88321[0])) {
		if (!entity::does_entity_belong_to_this_script(Global_88321[0], 1)) {
	...
	if (entity::does_entity_exist(Global_88321[1])) {
		if (!entity::does_entity_belong_to_this_script(Global_88321[1], 1)) {
			entity::set_entity_as_mission_entity(Global_88321[1], 1, 1);
		}
		vehicle::delete_vehicle(&Global_88321[1]);
	}
	if (entity::does_entity_exist(Global_88321[2])) {
		if (!entity::does_entity_belong_to_this_script(Global_88321[2], 1)) {
			entity::set_entity_as_mission_entity(Global_88321[2], 1, 1);
		}
		vehicle::delete_vehicle(&Global_88321[2]);
	}
	if (entity::does_entity_exist(uLocal_51[0])) {
	...
	if (entity::does_entity_exist(iLocal_48)) {
		if (vehicle::is_vehicle_driveable(iLocal_48, 0)) {
			if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_48, 0)) {
				...
				if (iLocal_28 == 4) {
					if (!ui::does_blip_exist(iLocal_62)) {
						iLocal_62 = func_115(vLocal_314, 0);
					}
					if (iLocal_199 == 0) {
						if (!ui::is_message_being_displayed()) {
							if (!func_114() || !ui::is_subtitle_preference_switched_on()) {
				...
				if (iLocal_28 == 3) {
					if (!ui::does_blip_exist(iLocal_63[0])) {
						iLocal_63[0] = func_112(uLocal_31[0], 1, 0);
					}
				}
			}
			else if (iLocal_28 != 5) {
				if (!ui::does_blip_exist(iLocal_61)) {
					iLocal_61 = func_109(iLocal_48, 0, 0);
				}
				if (iLocal_28 == 3 || iLocal_28 == 4) {
					if (iLocal_300 == 0) {
						ui::clear_prints();
...
// Position - 0x7FE9
int func_109(int iParam0, int iParam1, int iParam2) { return func_110(iParam0, !iParam1, iParam2); }
...
int func_110(int iParam0, int iParam1, bool bParam2) {
	...
	if (entity::is_entity_a_vehicle(iParam0)) {
		ui::set_blip_scale(iVar0, func_111(network::network_is_game_in_progress(), 1f, 1f));
		if (!bParam2) {
		...
		ui::set_blip_scale(iVar0, func_111(network::network_is_game_in_progress(), 0.7f, 0.7f));
		ui::set_blip_as_friendly(iVar0, iParam1);
	}
...
// Position - 0x80A4
var func_111(bool bParam0, float fParam1, float fParam2) {
	if (bParam0) {
		return fParam1;
	}
	return fParam2;
...
// Position - 0x80BB
int func_112(int iParam0, int iParam1, int iParam2) { return func_110(iParam0, !iParam1, iParam2); }
...
// Position - 0x8109
int func_115(vector3 vParam0, int iParam3) {
	int iVar0;
					...
					if (entity::is_entity_in_air(iLocal_48)) {
						if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
							...
							if (iLocal_304 == 0 && iLocal_199 == 1) {
								if (!ui::is_message_being_displayed()) {
									if (!func_114() || !ui::is_subtitle_preference_switched_on()) {
										func_133(&uLocal_403, 2, player::player_ped_id(), "TREVOR", 0, 1);
		...
		if (entity::does_entity_exist(iLocal_48)) {
			if (vehicle::is_vehicle_driveable(iLocal_48, 0)) {
				if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_48, 0)) {
					...
					if (entity::is_entity_in_angled_area(player::player_ped_id(), 1721.001f, 3264.248f, 38.40064f,
														 1765.509f, 3276.518f, 46.05385f, 48.25f, 0, 1, 0)) {
...
// Position - 0x85B9
bool func_120(var *uParam0, int iParam1, char *sParam2, char *sParam3, int iParam4, int iParam5, int iParam6,
	...
	Global_2621441 = 0;
	return func_121(sParam3, iParam4, iParam8);
}

// Position - 0x8618
int func_121(char *sParam0, int iParam1, int iParam2) {
	Global_15746 = 0;
...
void func_134(int iParam0, char *sParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	...
	if (iVar0 == 1) {
		...
		iVar1 = func_195(script::get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94) {
			...
			iVar5 = func_188(script::get_this_script_name(), 1);
			if (iVar5 != -1) {
...
void func_135(int iParam0, var uParam1, int iParam2, int iParam3) {
	func_136(&Global_96040, script::get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

// Position - 0x8EF1
void func_136(var *uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) {
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_20();
	...
	if (!ped::is_ped_injured(player::player_ped_id())) {
		...
		func_159(player::player_ped_id());
		func_153(player::player_ped_id(), 0);
	...
	while (iVar1 < 3) {
		...
		if (iVar1 == func_152()) {
			func_145(player::player_ped_id(), &uParam0->f_616[iVar1 /*65*/], 1);
		}
		else {
			iVar0 = 0;
			while (iVar0 < 12) {
		...
		if (entity::does_entity_exist(Global_89155[iVar0])) {
			if (Global_89155[iVar0] == iParam0) {
				if (iParam1 == 145 || iParam1 == Global_89165[iVar0]) {
					if (iParam2 == 0 || entity::get_entity_model(iParam0) == func_70(iParam1, iParam2)) {
						return 1;
					}
				}
			}
...
// Position - 0xA03D
bool func_144(int iParam0, var *uParam1, int iParam2, int iParam3) {
	char *sVar0;
...
// Position - 0xA37A
var func_148() { return Global_1312735; }
...
bool func_149(int iParam0, int iParam1) {
	...
	iVar0 = Global_2522581[iParam0 /*3*/][func_147(iParam1)];
...
// Position - 0xA8FA
void func_151(int iParam0, int iParam1, int *iParam2, int *iParam3, var *uParam4, int iParam5, int iParam6) {
	int iVar0;
...
void func_154(int iParam0, var *uParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		while (iVar0 <= 44 - 1) {
			...
			if (iVar3 != 0) {
				vVar4.x = weapon::get_ped_weapontype_in_slot(iParam0, func_158(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		iVar7 = 0;
		while (iVar7 < iVar8) {
			if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_155(Var9.f_1) && iVar70 < 50) {
...
// Position - 0xC350
bool func_161(vector3 vParam0, char *sParam3, vector3 vParam4) {
	int iVar0;
	int iVar1;
...
// Position - 0xC394
bool func_162(int iParam0, var *uParam1, float *fParam2) {
	*uParam1 = {0f, 0f, 0f};
	*fParam2 = 0f;
	switch (iParam0) {
	case 0:
...
bool func_163(int *iParam0) {
	if (!entity::is_entity_dead(player::player_ped_id(), 0) && !ped::is_ped_injured(player::player_ped_id())) {
		if (func_174()) {
			*iParam0 = func_169(entity::get_entity_coords(player::player_ped_id(), 0), 6, -1, 0, 1, -1);
			if (func_168(*iParam0) && !func_164(*iParam0)) {
				return true;
			}
		}
	}
...
// Position - 0xCA7E
int func_164(int iParam0) { return func_165(iParam0, 0, 1); }
...
int func_165(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_167() == 0) {
			return gameplay::is_bit_set(func_146(func_166(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0xCDB5
int func_167() { return Global_25190; }

// Position - 0xCDC0
int func_168(int iParam0) { return func_165(iParam0, 5, 1); }
...
// Position - 0xD4A2
int func_172(int iParam0) { return func_165(iParam0, 0, 0); }
...
// Position - 0xD725
bool func_174() { return Global_91543.f_303 > 0; }
...
var func_175() {
	...
	func_178(&iVar0, time::get_clock_day_of_month());
	func_177(&iVar0, time::get_clock_month());
	func_176(&iVar0, time::get_clock_year());
	return iVar0;
}
...
var func_180(int iParam0) {
	return (system::shift_right(iParam0, 26) & 31) * func_181(gameplay::is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
// Position - 0xD964
int func_182(var uParam0) { return uParam0 & 15; }
...
void func_189(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_190(uParam1, "Abigail1", func_192(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				 "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
		break;

	case 1:
		func_190(uParam1, "Abigail2", func_192(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				 -1, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
		break;

	case 2:
		func_190(uParam1, "Barry1", func_192(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				 4, 1, 0, 2359, func_191(iParam0), 1, 0);
		break;

	case 3:
		func_190(uParam1, "Barry2", func_192(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				 4, 4, 0, 2359, func_191(iParam0), 1, 1);
		break;

	case 4:
		func_190(uParam1, "Barry3", func_192(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2,
				 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 5:
		func_190(uParam1, "Barry3A", func_192(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0,
				 "", 166, 0, 7, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 6:
		func_190(uParam1, "Barry3C", func_192(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				 7, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 7:
		func_190(uParam1, "Barry4", func_192(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0,
				 "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_191(iParam0), 0, 0);
		break;

	case 8:
		func_190(uParam1, "Dreyfuss1", func_192(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				 0, "", 0, 0, -1, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 9:
		func_190(uParam1, "Epsilon1", func_192(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1,
				 10, 4, 1, 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 10:
		func_190(uParam1, "Epsilon2", func_192(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0,
				 11, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
		break;

	case 11:
		func_190(uParam1, "Epsilon3", func_192(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				 0, 0, 12, 4, 1, 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 12:
		func_190(uParam1, "Epsilon4", func_192(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				 "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 13:
		func_190(uParam1, "Epsilon5", func_192(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16,
				 "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
		break;

	case 14:
		func_190(uParam1, "Epsilon6", func_192(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 15:
		func_190(uParam1, "Epsilon7", func_192(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 16:
		func_190(uParam1, "Epsilon8", func_192(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
		break;

	case 17:
		func_190(uParam1, "Extreme1", func_192(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 18:
		func_190(uParam1, "Extreme2", func_192(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 19:
		func_190(uParam1, "Extreme3", func_192(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 20:
		func_190(uParam1, "Extreme4", func_192(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 21:
		func_190(uParam1, "Fanatic1", func_192(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_191(iParam0), 1, 0);
		break;

	case 22:
		func_190(uParam1, "Fanatic2", func_192(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_191(iParam0), 1, 0);
		break;

	case 23:
		func_190(uParam1, "Fanatic3", func_192(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_191(iParam0), 0, 1);
		break;

	case 24:
		func_190(uParam1, "Hao1", func_192(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_191(iParam0), 0, 1);
		break;

	case 25:
		func_190(uParam1, "Hunting1", func_192(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 26:
		func_190(uParam1, "Hunting2", func_192(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 27:
		func_190(uParam1, "Josh1", func_192(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_191(iParam0), 1, 0);
		break;

	case 28:
		func_190(uParam1, "Josh2", func_192(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
		break;

	case 29:
		func_190(uParam1, "Josh3", func_192(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
		break;

	case 30:
		func_190(uParam1, "Josh4", func_192(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_191(iParam0), 1, 0);
		break;

	case 31:
		func_190(uParam1, "Maude1", func_192(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 32:
		func_190(uParam1, "Minute1", func_192(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 33:
		func_190(uParam1, "Minute2", func_192(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 34:
		func_190(uParam1, "Minute3", func_192(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 35:
		func_190(uParam1, "MrsPhilips1", func_192(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 36:
		func_190(uParam1, "MrsPhilips2", func_192(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_191(iParam0), 0, 0);
		break;

	case 37:
		func_190(uParam1, "Nigel1", func_192(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_191(iParam0), 1, 0);
		break;

	case 38:
		func_190(uParam1, "Nigel1A", func_192(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
		break;

	case 39:
		func_190(uParam1, "Nigel1B", func_192(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_191(iParam0), 1, 1);
		break;

	case 40:
		func_190(uParam1, "Nigel1C", func_192(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_191(iParam0), 1, 1);
		break;

	case 41:
		func_190(uParam1, "Nigel1D", func_192(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_191(iParam0), 1, 1);
		break;

	case 42:
		func_190(uParam1, "Nigel2", func_192(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
		break;

	case 43:
		func_190(uParam1, "Nigel3", func_192(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
		break;

	case 44:
		func_190(uParam1, "Omega1", func_192(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 45:
		func_190(uParam1, "Omega2", func_192(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 46:
		func_190(uParam1, "Paparazzo1", func_192(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 47:
		func_190(uParam1, "Paparazzo2", func_192(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 48:
		func_190(uParam1, "Paparazzo3", func_192(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 49:
		func_190(uParam1, "Paparazzo3A", func_192(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 50:
		func_190(uParam1, "Paparazzo3B", func_192(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 51:
		func_190(uParam1, "Paparazzo4", func_192(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 52:
		func_190(uParam1, "Rampage1", func_192(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 54:
		func_190(uParam1, "Rampage3", func_192(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_191(iParam0), 1, 0);
		break;

	case 55:
		func_190(uParam1, "Rampage4", func_192(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_191(iParam0), 1, 0);
		break;

	case 56:
		func_190(uParam1, "Rampage5", func_192(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_191(iParam0), 0, 0);
		break;

	case 53:
		func_190(uParam1, "Rampage2", func_192(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_191(iParam0), 1, 0);
		break;

	case 57:
		func_190(uParam1, "TheLastOne", func_192(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 58:
		func_190(uParam1, "Tonya1", func_192(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 59:
		func_190(uParam1, "Tonya2", func_192(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
		break;

	case 60:
		func_190(uParam1, "Tonya3", func_192(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_191(iParam0), 0, 1);
		break;

	case 61:
		func_190(uParam1, "Tonya4", func_192(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_191(iParam0), 0, 1);
		break;

	case 62:
		func_190(uParam1, "Tonya5", func_192(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
		break;
...
// Position - 0xF0C2
void func_190(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
int func_193(int iParam0)
{
	switch (iParam0) {
	case 69:
	case 70: return func_194(Global_101700.f_8044.f_99.f_205[10]);

	case 74:
	case 75: return func_194(Global_101700.f_8044.f_99.f_205[8]);

	case 84:
	case 85: return func_194(Global_101700.f_8044.f_99.f_205[11]);

	case 90: return func_194(Global_101700.f_8044.f_99.f_205[7]);

	case 93: return func_194(Global_101700.f_8044.f_99.f_205[9]);
	}
	return 0;
}
...
// Position - 0xF9AF
void func_200() {
	if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_314, 1) <
		500f) {
		if (iLocal_214 == 0) {
			if (!entity::does_entity_exist(uLocal_51[0])) {
				streaming::request_model(joaat("sandking"));
				if (streaming::has_model_loaded(joaat("sandking"))) {
					uLocal_51[0] =
						vehicle::create_vehicle(joaat("sandking"), 1754.951f, 3290.994f, 40.1176f, 182.397f, 1, 1);
					entity::freeze_entity_position(uLocal_51[0], 1);
					streaming::set_model_as_no_longer_needed(joaat("sandking"));
				}
			}
		...
		if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_314,
												  1) > 550f) {
			if (entity::does_entity_exist(uLocal_51[0])) {
				vehicle::delete_vehicle(&uLocal_51[0]);
			}
...
void func_201() {
	...
	if (iLocal_175 == 1) {
		if (iLocal_206[0] == 1) {
			...
			if (entity::does_entity_exist(iLocal_48)) {
				if (vehicle::is_vehicle_driveable(iLocal_48, 0)) {
					if (entity::is_entity_in_angled_area(iLocal_48, 1721.001f, 3264.248f, 38.40064f, 1765.509f,
														 3276.518f, 46.05385f, 48.25f, 0, 1, 0)) {
						if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_48, 0)) {
							player::set_player_wanted_level(player::player_id(), 0, 0);
							player::set_player_wanted_level_now(player::player_id(), 0);
							iLocal_175 = 0;
...
// Position - 0xFDBC
int func_204(int iParam0, var *uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6,
...
void func_205() {
	iLocal_53 =
		vehicle::get_closest_vehicle(entity::get_entity_coords(player::player_ped_id(), 1), 300f, joaat("lazer"), 4);
	iLocal_54 = vehicle::get_closest_vehicle(entity::get_entity_coords(player::player_ped_id(), 1), 300f,
											 joaat("lazer"), 16386);
	if (entity::does_entity_exist(iLocal_53) && entity::is_entity_in_air(iLocal_53)) {
		if (!ui::does_blip_exist(iLocal_65)) {
			iLocal_65 = ui::add_blip_for_entity(iLocal_53);
			ui::set_blip_as_friendly(iLocal_65, 0);
		}
	}
	if (entity::does_entity_exist(iLocal_54) && entity::is_entity_in_air(iLocal_54)) {
		if (!ui::does_blip_exist(iLocal_66)) {
			iLocal_66 = ui::add_blip_for_entity(iLocal_54);
							...
							if (entity::does_entity_exist(uLocal_31[0])) {
								if (!ped::is_ped_injured(uLocal_31[0])) {
									if (func_2(player::player_ped_id(), uLocal_31[0], 1) < 600f) {
										if (gameplay::get_distance_between_coords(vLocal_320, -75.8f, -819.9f, 326f,
																				  1) > 1600f &&
											gameplay::get_distance_between_coords(vLocal_320, -2159f, 3067f, 33f, 1) <
												1000f) {
											if (vLocal_320.z > 70f) {
												if (iLocal_30 != 2) {
													iLocal_215[0] = 1;
												...
												if (iLocal_274 == 0) {
													if (!func_114()) {
														if (!ui::is_message_being_displayed() ||
															...
															func_133(&uLocal_403, 5, 0,
																	 "PilotDispatch"
																	 "2",
																	 0, 1);
															if (func_132(&uLocal_403, "DP2BAUD",
																		 "DP2B_"
																		 "CHAT54",
																		 7, 0, 0, 0)) {
																iLocal_274 = 1;
											...
											if (gameplay::get_distance_between_coords(vLocal_320, -2159f, 3067f, 33f,
																					  1) > 1000f) {
												if (iLocal_30 != 3) {
													iLocal_215[0] = 1;
													iLocal_30 = 3;
				...
				if (vehicle::is_vehicle_driveable(uLocal_49[0], 0)) {
					if (entity::does_entity_exist(uLocal_31[0])) {
						if (!ped::is_ped_injured(uLocal_31[0])) {
							...
							vLocal_317 = {entity::get_entity_coords(uLocal_49[0], 1)};
							ai::clear_ped_tasks(uLocal_31[0]);
							ai::open_sequence_task(&iLocal_572);
							if (!ped::is_ped_in_vehicle(uLocal_31[0], uLocal_49[0], 0)) {
								ai::task_enter_vehicle(0, uLocal_49[0], 20000, -1, 2f, 1, 0);
							}
							ai::task_heli_mission(0, uLocal_49[0], 0, 0, vLocal_317.x, vLocal_317.y, vLocal_317.z + 20f,
												  4, 30f, 10f, -1f, 170, 40, -1f, 0);
							ai::task_heli_mission(0, uLocal_49[0], 0, player::player_ped_id(), 0f, 0f, 0f, 6, 40f, 20f,
												  -1f, 170, 40, -1f, 0);
							ai::close_sequence_task(iLocal_572);
							ai::task_perform_sequence(uLocal_31[0], iLocal_572);
							ai::clear_sequence_task(&iLocal_572);
							iLocal_202[0] = 1;
						}
					}
				}
				...
				if (entity::does_entity_exist(uLocal_31[0])) {
					if (!ped::is_ped_injured(uLocal_31[0])) {
						if (ped::is_ped_in_vehicle(uLocal_31[0], uLocal_49[0], 0)) {
							...
							else if (gameplay::get_game_timer() > iLocal_188 + 10000 &&
									 !ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_48, 0)) {
								if (iLocal_297 == 0) {
									ped::set_ped_accuracy(uLocal_31[0], 100);
									iLocal_296 = 0;
									iLocal_297 = 1;
							...
							if (func_2(uLocal_49[0], player::player_ped_id(), 1) < 300f) {
								if (iLocal_299 == 0) {
									weapon::set_current_ped_vehicle_weapon(uLocal_31[0],
																		   joaat("vehicle_weapon_space_rocket"));
								...
								weapon::set_current_ped_vehicle_weapon(uLocal_31[0],
																	   joaat("vehicle_weapon_player_buzzard"));
			...
			if (iLocal_215[0] == 1) {
				if (entity::does_entity_exist(uLocal_49[0])) {
					if (vehicle::is_vehicle_driveable(uLocal_49[0], 0)) {
						if (entity::does_entity_exist(uLocal_31[0])) {
							if (!ped::is_ped_injured(uLocal_31[0])) {
								ai::task_heli_mission(uLocal_31[0], uLocal_49[0], 0, player::player_ped_id(), 0f, 0f,
													  0f, 6, 20f, 20f, -1f, 15, 10, -1f, 0);
								iLocal_215[0] = 0;
							}
						}
					}
						...
						if (entity::does_entity_exist(uLocal_31[0])) {
							if (!ped::is_ped_injured(uLocal_31[0])) {
								ai::task_heli_mission(
									uLocal_31[0], uLocal_49[0], 0, 0,
									entity::get_offset_from_entity_in_world_coords(uLocal_49[0], 20f, 0f, 0f), 4, 10f,
									10f, entity::get_entity_heading(uLocal_49[0]),
									system::round(entity::get_entity_height(
										uLocal_49[0], entity::get_entity_coords(uLocal_49[0], 1), 1, 1)),
									100, -1f, 0);
								iLocal_215[0] = 0;
							}
						}
				...
				if (gameplay::get_distance_between_coords(vLocal_320, -2159f, 3067f, 33f, 1) > 1000f) {
					if (entity::does_entity_exist(uLocal_49[0])) {
						if (vehicle::is_vehicle_driveable(uLocal_49[0], 0)) {
							if (entity::does_entity_exist(uLocal_31[0])) {
								if (!ped::is_ped_injured(uLocal_31[0])) {
									ai::task_heli_mission(uLocal_31[0], uLocal_49[0], 0, player::player_ped_id(), 0f,
														  0f, 0f, 6, 20f, 20f, -1f, 170, 70, -1f, 0);
									iLocal_295 = 1;
								}
							}
						}
		...
		if (vehicle::is_vehicle_driveable(uLocal_49[0], 0)) {
			if (entity::does_entity_exist(uLocal_31[0])) {
				if (!ped::is_ped_injured(uLocal_31[0])) {
					if (ped::is_ped_in_vehicle(uLocal_31[0], uLocal_49[0], 0)) {
						if (ui::does_blip_exist(iLocal_63[0])) {
							ui::set_blip_scale(iLocal_63[0], 1f);
						}
					}
					if (func_2(player::player_ped_id(), uLocal_31[0], 1) > 600f) {
						if (ui::does_blip_exist(iLocal_63[0])) {
	...
	if (entity::does_entity_exist(uLocal_31[0])) {
		if (!ped::is_ped_injured(uLocal_31[0])) {
			if (entity::is_entity_in_water(uLocal_31[0])) {
				ai::clear_ped_tasks(uLocal_31[0]);
				entity::set_entity_health(uLocal_31[0], 0);
				if (ui::does_blip_exist(iLocal_63[0])) {
					ui::remove_blip(&iLocal_63[0]);
				}
				iLocal_206[0] = 1;
...
void func_207() {
	if (iLocal_210 == 0) {
		if (func_208(entity::get_entity_coords(player::player_ped_id(), 1), 3, 0, 0) ||
			entity::is_entity_in_angled_area(player::player_ped_id(), -1601.514f, 2794.148f, 14.84222f, -1587.692f,
											 2806.101f, 20.29557f, 16f, 0, 1, 0) ||
			entity::is_entity_in_angled_area(player::player_ped_id(), -1598.278f, 2803.98f, 17.01772f, -1665.98f,
											 2895.398f, 34.58953f, 14.5f, 0, 1, 0) ||
			entity::is_entity_in_angled_area(player::player_ped_id(), -1648.554f, 2873.74f, 24.85017f, -1673.864f,
											 2889.698f, 38.18856f, 14.5f, 0, 1, 0) ||
			entity::is_entity_in_angled_area(player::player_ped_id(), -1647.446f, 2873.969f, 24.82373f, -1667.316f,
											 2914.302f, 39.39478f, 14.5f, 0, 1, 0)) {
			iLocal_210 = 1;
		}
	}
	if (iLocal_210 == 1) {
						...
						if (entity::does_entity_exist(iLocal_48)) {
							if (vehicle::is_vehicle_driveable(iLocal_48, 0)) {
								if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_48, 0) || iLocal_212 == 1) {
									if (func_2(player::player_ped_id(), uLocal_33[iLocal_176], 1) < 39f) {
										if (iLocal_217[iLocal_176] == 0) {
											...
											ped::set_ped_sphere_defensive_area(
												uLocal_33[iLocal_176],
												entity::get_entity_coords(uLocal_33[iLocal_176], 1), 50f, 0, 0);
										...
										ai::clear_ped_tasks(uLocal_33[iLocal_176]);
										ai::open_sequence_task(&iLocal_572);
										ai::task_follow_nav_mesh_to_coord(0, entity::get_entity_coords(iLocal_48, 1),
																		  2f, -1, 20f, 0, 1193033728);
										ai::task_combat_ped(0, player::player_ped_id(), 0, 16);
										ai::close_sequence_task(iLocal_572);
										ai::task_perform_sequence(uLocal_33[iLocal_176], iLocal_572);
										ai::clear_sequence_task(&iLocal_572);
										iLocal_245[iLocal_176] = 0;
										iLocal_259[iLocal_176] = 0;
									...
									if (func_2(player::player_ped_id(), uLocal_33[iLocal_176], 1) > 41f &&
										func_2(player::player_ped_id(), uLocal_33[iLocal_176], 1) < 400f) {
										if (iLocal_259[iLocal_176] == 0) {
											...
											ai::open_sequence_task(&iLocal_572);
											if (iLocal_195 == 0) {
												ai::task_go_to_entity(0, player::player_ped_id(), -1, 25f, 2f,
																	  1073741824, 0);
											}
												...
												ai::task_go_to_entity(0, player::player_ped_id(), -1, 25f, 3f,
																	  1073741824, 0);
											}
...
// Position - 0x11188
int func_208(vector3 vParam0, int iParam3, int iParam4, int iParam5) {
	vector3 vVar0[15];
	vector3 vVar46[15];
	float fVar92[15];
	int iVar108;
	...
	if (iLocal_175 == 0) {
		...
		if (entity::does_entity_exist(Global_88321[2])) {
			if (vehicle::is_vehicle_driveable(Global_88321[2], 0)) {
				if (vehicle::is_this_model_a_heli(entity::get_entity_model(Global_88321[2]))) {
					entity::set_entity_as_mission_entity(Global_88321[2], 1, 1);
					func_217(1734.799f, 3234.833f, 40.7041f, 321.0399f, 0, 145);
				}
				if (vehicle::is_this_model_a_car(entity::get_entity_model(Global_88321[2])) ||
					vehicle::is_this_model_a_bike(entity::get_entity_model(Global_88321[2])) ||
					vehicle::is_this_model_a_bicycle(entity::get_entity_model(Global_88321[2])) ||
					vehicle::is_this_model_a_quadbike(entity::get_entity_model(Global_88321[2]))) {
					entity::set_entity_as_mission_entity(Global_88321[2], 1, 1);
		...
		func_216(player::player_ped_id(), -1);
		func_215(73);
		iLocal_197 = 1;
		iLocal_175 = 1;
	}
							...
							if (func_2(player::player_ped_id(), uLocal_33[iLocal_184], 1) < 40f) {
								if (ped::_0x6CD5A433374D4CFB(uLocal_33[iLocal_184], player::player_ped_id())) {
									if (ped::is_ped_jacking(player::player_ped_id())) {
										audio::start_alarm("PORT_OF_LS_HEIST_"
														   "FORT_ZANCUDO_"
														   "ALARMS",
														   0);
										audio::set_ambient_zone_state("AZ_AFB_ALARM_SPEECH", 1, 1);
									...
									if (iLocal_307 == 0) {
										if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0) && !func_214(0)) {
											if (func_213(player::player_ped_id()) != joaat("weapon_unarmed")) {
												iLocal_194 = gameplay::get_game_timer();
												iLocal_307 = 1;
											}
										}
									}
									else if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0) && !func_214(0)) {
										if (func_213(player::player_ped_id()) != joaat("weapon_unarmed")) {
											if (gameplay::get_game_timer() > iLocal_194 + 3000) {
												audio::start_alarm("PORT_OF_LS_HEIST_FORT_"
																   "ZANCUDO_ALARMS",
																   0);
												audio::set_ambient_zone_state("AZ_AFB_ALARM_SPEECH", 1, 1);
												iLocal_211 = 1;
...
// Position - 0x12440
void func_210(int iParam0) { gameplay::clear_bit(&Global_87679, iParam0); }

// Position - 0x12452
void func_211(int iParam0) { gameplay::set_bit(&Global_87679, iParam0); }

// Position - 0x12464
bool func_212(int iParam0) { return gameplay::is_bit_set(Global_87679, iParam0); }
...
// Position - 0x12573
void func_217(vector3 vParam0, float *fParam3, int iParam4, int iParam5) {
	vector3 vVar0;
	float *fVar3;
	...
	if (entity::does_entity_exist(Global_93635.f_4)) {
		if (vehicle::is_vehicle_driveable(Global_93635.f_4, 0)) {
			if (func_226(24) != Global_93635.f_4) {
				if (iParam4 == 1) {
					if (func_223(entity::get_entity_coords(Global_93635.f_4, 1), iParam5, &vVar0, &fVar3)) {
						vParam0 = {vVar0};
						fParam3 = fVar3;
					}
				}
				func_218(Global_93635.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
// Position - 0x125EE
void func_218(int iParam0, vector3 vParam1, float *fParam4, int iParam5, int iParam6) {
	struct<60> Var0;
	...
	if (entity::does_entity_exist(iParam0) && vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		func_220(iParam5, &Var0, vParam1, fParam4, func_59(iParam0));
...
// Position - 0x12834
void func_220(int iParam0, var *uParam1, vector3 vParam2, var uParam5, int iParam6) {
	if (func_69(&Global_68531.f_555[0 /*21*/], iParam0)) {
...
// Position - 0x129D4
bool func_223(vector3 vParam0, int iParam3, var *uParam4, float *fParam5) {
	int iVar0;

	iVar0 = func_224(vParam0, iParam3, 1);
	switch (iVar0) {
	case 0:
...
// Position - 0x12AEA
int func_224(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
...
// Position - 0x12B79
var func_225(int iParam0) { return gameplay::is_bit_set(Global_101700.f_6188[iParam0], 0); }
...
void func_227() {
	if (iLocal_175 == 0) {
		...
		if (func_244()) {
			if (Global_86001 == 1) {
				if (func_230() == 0) {
					func_229(vLocal_311, fLocal_323, 1, 0);
					iLocal_196 = 1;
					iLocal_175 = 0;
					iLocal_28 = 3;
				}
...
void func_228() {
	...
	if (!entity::does_entity_exist(iLocal_48)) {
		...
		iLocal_48 = vehicle::create_vehicle(joaat("cargobob"), 1740.852f, 3263.161f, 40.2743f, 280.3712f, 1, 1);
...
// Position - 0x12E85
void func_229(vector3 vParam0, float fParam3, int iParam4, int iParam5) {
	if (func_244()) {
...
void func_231(int iParam0, int iParam1) {
	gameplay::_0x9B2BD3773123EA2F(iParam0, !iParam1);
	gameplay::enable_dispatch_service(iParam0, iParam1);
}
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_48, 0)) {
					if (ped::is_ped_sitting_in_vehicle(player::player_ped_id(), iLocal_48)) {
						if (func_234(player::player_ped_id(), iLocal_48) == -1) {
...
void func_235() {
	if (!ped::is_ped_injured(player::player_ped_id())) {
		if (iLocal_28 == 2 || iLocal_28 == 3) {
			if (func_208(entity::get_entity_coords(player::player_ped_id(), 1), 3, 200, 0) || iLocal_211 == 1) {
		...
		if (iLocal_28 == 4) {
			if (player::get_player_wanted_level(player::player_id()) != 0 &&
				gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_311,
													  1) > 1000f) {
				player::set_player_wanted_level(player::player_id(), 0, 0);
				player::set_player_wanted_level_now(player::player_id(), 0);
			}
												...
												if (entity::does_entity_exist(uLocal_33[0])) {
													if (!ped::is_ped_injured(uLocal_33[0])) {
														if (func_2(player::player_ped_id(), uLocal_33[0], 1) < 30f) {
															func_133(&uLocal_403, 4, uLocal_33[0], "ARMY_Guard01", 0,
																	 1);
														}
													}
												}
												if (entity::does_entity_exist(uLocal_33[1])) {
													if (!ped::is_ped_injured(uLocal_33[1])) {
														if (func_2(player::player_ped_id(), uLocal_33[1], 1) < 30f) {
															func_133(&uLocal_403, 4, uLocal_33[1], "ARMY_Guard01", 0,
																	 1);
														}
													}
												}
								...
								if (gameplay::get_game_timer() > iLocal_186 + 8000) {
									if (!func_114()) {
										if (!ui::is_message_being_displayed() ||
											!ui::is_subtitle_preference_switched_on()) {
											if (func_2(player::player_ped_id(), uLocal_33[iLocal_192], 1) < 25f) {
												if (ped::_0x6CD5A433374D4CFB(uLocal_33[iLocal_192],
																			 player::player_ped_id())) {
													if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0) &&
														!func_214(0)) {
														if (func_213(player::player_ped_id()) != joaat("weapon_"
																									   "unarmed")) {
															if (entity::does_entity_exist(uLocal_33[0])) {
																if (!ped::is_ped_injured(uLocal_33[0])) {
																	if (func_2(player::player_ped_id(), uLocal_33[0],
																			   1) < 30f) {
																		func_133(&uLocal_403, 4, uLocal_33[0],
																				 "AR"
																				 "MY"
																				 "_G"
																				 "ua"
															...
															if (entity::does_entity_exist(uLocal_33[1])) {
																if (!ped::is_ped_injured(uLocal_33[1])) {
																	if (func_2(player::player_ped_id(), uLocal_33[1],
																			   1) < 30f) {
																		func_133(&uLocal_403, 4, uLocal_33[1],
																				 "AR"
																				 "MY"
																				 "_G"
																				 "ua"
															...
															if (func_132(&uLocal_403, "ARMYAUD",
																		 "ARMY_"
																		 "WRN1a",
																		 7, 0, 0, 0)) {
																iLocal_186 = gameplay::get_game_timer();
											...
											if (ped::_0x6CD5A433374D4CFB(uLocal_33[iLocal_192],
												...
												if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
													if (func_213(player::player_ped_id()) == joaat("weapon_"
														...
														if (entity::does_entity_exist(uLocal_33[0])) {
															if (!ped::is_ped_injured(uLocal_33[0])) {
																if (func_2(player::player_ped_id(), uLocal_33[0], 1) <
																	30f) {
																	func_133(&uLocal_403, 4, uLocal_33[0],
																			 "ARMY_"
																			 "Guard0"
														...
														if (entity::does_entity_exist(uLocal_33[1])) {
															if (!ped::is_ped_injured(uLocal_33[1])) {
																if (func_2(player::player_ped_id(), uLocal_33[1], 1) <
																	30f) {
																	func_133(&uLocal_403, 4, uLocal_33[1],
																			 "ARMY_"
																			 "Guard0"
...
void func_246(int iParam0) {
	...
	case 68: func_211(11); break;

	case 78: func_211(14); break;

	case 79: func_211(3); break;
