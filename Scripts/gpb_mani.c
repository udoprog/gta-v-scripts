...
void func_51(int iParam0, char *sParam1, char *sParam2) {
	...
	switch (iParam0) {
	case 1: StringCopy(sParam2, "NoTengoUnPlan", 64); break;

	case 2: StringCopy(sParam2, "AyeProblem", 64); break;

	case 3: StringCopy(sParam2, "SoyUnMexicanoHumilde", 64); break;

	case 4: StringCopy(sParam2, "SoloSoyUnActorMexicano", 64); break;

	case 5: StringCopy(sParam2, "YaceAquiEstoyNomas", 64); break;

	case 6: StringCopy(sParam2, "NosHablosMisHermanos", 64); break;

	case 7: StringCopy(sParam2, "SoyUnActor", 64); break;

	case 8: StringCopy(sParam2, "MiranmeMiranme", 64); break;
	}
}
