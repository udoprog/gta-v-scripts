			...
			if (!func_93()) {
				...
				case 1:
					...
					if (!func_77() || player::is_player_wanted_level_greater(player::player_id(), 0)) {
						if (!ped::is_ped_injured(iLocal_68) && !ped::is_ped_injured(iLocal_69[0]) &&
							!ped::is_ped_injured(iLocal_69[1])) {
							if (entity::is_entity_at_coord(player::player_ped_id(), 969.2191f, 3608.665f, 41.8758f,
														   100f, 80f, 20f, 0, 1, 0)) {
								iLocal_60 = func_74(iLocal_68, 0, 145);
								ui::set_blip_priority(iLocal_60, 9);
								iLocal_61[0] = func_74(iLocal_69[0], 1, 145);
								iLocal_61[1] = func_74(iLocal_69[1], 1, 145);
								ui::_0x75A16C3DA34F1245(iLocal_60, 0);
								ui::_0x75A16C3DA34F1245(iLocal_61[0], 0);
								ui::_0x75A16C3DA34F1245(iLocal_61[1], 0);
								func_64(1);
							}
						}
					}
						...
						if (!ped::is_ped_injured(iLocal_68)) {
							ai::task_smart_flee_ped(iLocal_68, player::player_ped_id(), 150f, -1, 0, 0);
						}
						func_63();
					}
					break;
				...
				if (!ped::is_ped_injured(iLocal_68)) {
						...
						case 1:
							if (iLocal_48 < 7 && !ped::is_ped_injured(iLocal_68)) {
								if (ped::is_ped_facing_ped(player::player_ped_id(), iLocal_68, 90f)) {
									if (player::is_player_targetting_entity(player::player_id(), iLocal_68) ||
										player::is_player_free_aiming_at_entity(player::player_id(), iLocal_68)) {
										func_58();
									}
								}
							}
					...
					if (!ped::is_ped_injured(iLocal_69[0]) && !ped::is_ped_injured(iLocal_69[1]) &&
						!entity::is_entity_dead(iLocal_77[0], 0) && !entity::is_entity_dead(iLocal_77[1], 0)) {
						func_63();
					}
					iVar1 = 0;
					iVar2 = 0;
					while (iVar2 < iLocal_69) {
						if (!ped::is_ped_injured(iLocal_69[iVar2])) {
							...
							if (!entity::is_entity_at_entity(player::player_ped_id(), iLocal_69[iVar2], 150f, 150f, 50f,
															 0, 1, 0)) {
								func_63();
							}
							iVar1 = 1;
						}
						else if (ui::does_blip_exist(iLocal_61[iVar2])) {
							ui::remove_blip(&iLocal_61[iVar2]);
						}
						iVar2++;
					}
					if (iVar1 == 0) {
...
void func_1() {
	...
	if (iLocal_53 && !iLocal_58) {
		...
		iVar0 = 0;
		while (iVar0 < iLocal_69) {
			if (ui::does_blip_exist(iLocal_61[iVar0])) {
				ui::remove_blip(&iLocal_61[iVar0]);
			}
			if (!ped::is_ped_injured(iLocal_69[iVar0]) && !ped::is_ped_injured(player::player_ped_id())) {
				if (iVar0 < 2) {
					if (!entity::is_entity_dead(iLocal_77[iVar0], 0)) {
						ai::task_vehicle_mission_ped_target(iLocal_69[iVar0], iLocal_77[iVar0], player::player_ped_id(),
															8, 20f, 786469, 150f, 10f, 1);
		...
		pathfind::set_roads_back_to_original_in_angled_area(417.901f, 3578.002f, 31.176f, 1305.897f, 3604.306f,
															40.1064f, 100.0625f, 1);
...
void func_9() {
				...
				if (!ped::is_ped_injured(iLocal_69[iVar0]) && !entity::is_entity_dead(iLocal_77[iVar0], 0)) {
					if (!ui::does_blip_exist(iLocal_61[iVar0])) {
						...
						if (ped::is_ped_in_any_vehicle(iLocal_69[iVar0], 0)) {
							if (!iLocal_55) {
								ai::task_drive_by(iLocal_69[iVar0], player::player_ped_id(), 0, 0f, 0f, 0f, 150f, 100,
												  1, -753768974);
							}
							else {
								...
								ai::task_perform_sequence(iLocal_69[iVar0], iLocal_84);
	...
	case 1:
		...
		while (iVar1 < iLocal_69) {
			if (!ped::is_ped_injured(iLocal_69[iVar1])) {
				if (entity::is_entity_at_coord(iLocal_69[iVar1], 904.3153f, 3631.684f, 31.574f, 7f, 7f, 7f, 0, 1, 0)) {
					...
					if (ped::is_ped_in_any_vehicle(iLocal_69[iVar1], 0)) {
						...
						ai::task_combat_ped(0, player::player_ped_id(), 0, 16);
						ai::close_sequence_task(iLocal_84);
						ai::task_perform_sequence(iLocal_69[iVar1], iLocal_84);
						ai::clear_sequence_task(&iLocal_84);
			...
			if (ped::is_ped_injured(iLocal_69[iVar1])) {
				if (ui::does_blip_exist(iLocal_61[iVar1])) {
					ui::remove_blip(&iLocal_61[iVar1]);
				}
			}
			iVar1++;
		}
		if (ped::is_ped_injured(iLocal_69[2]) && ped::is_ped_injured(iLocal_69[3]) &&
			ped::is_ped_injured(iLocal_69[4]) && ped::is_ped_injured(iLocal_69[5])) {
			audio::stop_audio_scene("RE_COUNTRYSIDE_GANG_FIGHT_SCENE");
			iLocal_48++;
		}
		break;
	...
	case 2:
		...
		if (!ped::is_ped_injured(iLocal_68)) {
			...
			ai::close_sequence_task(iLocal_84);
			ai::task_perform_sequence(iLocal_68, iLocal_84);
			ai::clear_sequence_task(&iLocal_84);
		}
	...
	case 6:
		if (!ped::is_ped_injured(iLocal_68)) {
			if (entity::is_entity_playing_anim(iLocal_68, "veh@drivebystd_ds_grenades", "drop_grenade", 3)) {
				if (entity::get_entity_anim_current_time(iLocal_68, "veh@drivebystd_ds_grenades", "drop_grenade") >
						0.436f &&
					ped::is_ped_in_any_vehicle(iLocal_68, 0)) {
					object::create_money_pickups(entity::get_offset_from_entity_in_world_coords(
													 ped::get_vehicle_ped_is_in(iLocal_68, 0), -1f, 0f, 0f),
												 1000, 1, 0);
					iLocal_48++;
				}
			}
...
// Position - 0xD46
void func_15(int iParam0) { Global_101686 = iParam0; }
...
// Position - 0x1AD8
void func_25(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			 int iParam8) {
	func_26(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

// Position - 0x1AF9
void func_26(char *sParam0, char *sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
// Position - 0x1FF3
void func_35(int iParam0, int iParam1) { gameplay::set_bit(&Global_101700.f_23954.f_8[iParam0], iParam1); }
...
// Position - 0x20DC
int func_38(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5,
...
// Position - 0x233C
int func_42(char *sParam0, int iParam1, int iParam2) {
	Global_15746 = 0;
...
void func_53() {
	...
	case 1:
		if (!ped::is_ped_injured(iLocal_68)) {
			if (entity::is_entity_at_entity(player::player_ped_id(), iLocal_68, 20f, 20f, 20f, 0, 1, 0)) {
				ai::task_look_at_entity(iLocal_68, player::player_ped_id(), -1, 2060, 2);
				...
				if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0) ||
					...
					if (func_56()) {
						...
						if (!ped::is_ped_injured(iLocal_68) && !ped::is_ped_injured(iLocal_69[2]) &&
							!entity::is_entity_dead(iLocal_76, 0)) {
							ai::open_sequence_task(&iLocal_84);
							ai::task_open_vehicle_door(0, iLocal_76, -1, -1, 1f);
	...
	case 7:
		if (!ped::is_ped_injured(iLocal_68) && !entity::is_entity_dead(iLocal_76, 0) &&
			!ped::is_ped_in_vehicle(iLocal_68, iLocal_76, 0) && !ped::is_ped_in_cover(iLocal_68, 0) &&
			!ped::is_ped_going_into_cover(iLocal_68)) {
		}
		iVar0 = 0;
		while (iVar0 < iLocal_69) {
			if (!ped::is_ped_injured(iLocal_69[iVar0]) && !entity::is_entity_dead(iLocal_77[iVar0], 0)) {
				if (ped::is_ped_shooting_in_area(player::player_ped_id(), 916.3351f - 100f, 3602.048f - 100f,
												 31.9209f - 100f, 916.3351f + 100f, 3602.048f + 100f, 31.9209f + 100f,
												 0, 1) ||
					entity::is_entity_at_entity(player::player_ped_id(), iLocal_69[iVar0], 5f, 5f, 5f, 0, 1, 0) ||
					entity::has_entity_been_damaged_by_entity(iLocal_69[iVar0], player::player_ped_id(), 1) ||
					entity::has_entity_been_damaged_by_entity(iLocal_77[iVar0], player::player_ped_id(), 1) ||
					entity::is_entity_touching_entity(player::player_ped_id(), iLocal_69[iVar0]) ||
					entity::is_entity_touching_entity(player::player_ped_id(), iLocal_77[iVar0])) {
					iLocal_55 = 1;
		...
		if (entity::is_entity_at_coord(iLocal_69[2], 970.3641f, 3629.886f, 31.3694f, 5f, 5f, 5f, 0, 1, 0) ||
			system::timerb() > 13000) {
			func_40(2000);
			iVar0 = 0;
			while (iVar0 < iLocal_69) {
				if (!ped::is_ped_injured(iLocal_69[iVar0])) {
					if (!entity::is_entity_dead(iLocal_77[iVar0], 0)) {
						if (ped::is_ped_in_vehicle(iLocal_69[iVar0], iLocal_77[iVar0], 0)) {
							ai::task_vehicle_mission_ped_target(iLocal_69[iVar0], iLocal_77[iVar0],
																player::player_ped_id(), iVar0 - 2 + 10, 60f, 786475,
																5f, 10f, 1);
						}
					}
				}
...
bool func_56() {
	...
	if (!entity::does_entity_exist(iLocal_77[2]) && !entity::does_entity_exist(iLocal_77[3]) &&
		!entity::does_entity_exist(iLocal_77[4]) && !entity::does_entity_exist(iLocal_77[5]) &&
		!entity::does_entity_exist(iLocal_69[2]) && !entity::does_entity_exist(iLocal_69[3]) &&
		!entity::does_entity_exist(iLocal_69[4]) && !entity::does_entity_exist(iLocal_69[5])) {
		...
		if (streaming::has_model_loaded(joaat("hexer"))) {
			iLocal_77[2] = vehicle::create_vehicle(joaat("hexer"), 863.4697f, 3633.5f, 31.9874f, 290.5797f, 1, 1);
			iLocal_77[3] = vehicle::create_vehicle(joaat("hexer"), 866.4073f, 3636.039f, 31.9514f, 270.3649f, 1, 1);
			iLocal_77[4] = vehicle::create_vehicle(joaat("hexer"), 866.3153f, 3631.587f, 31.9545f, 276.6327f, 1, 1);
			iLocal_77[5] = vehicle::create_vehicle(joaat("hexer"), 868.5937f, 3633.523f, 31.9622f, 267.0991f, 1, 1);
		...
		if (streaming::has_model_loaded(joaat("g_m_y_lost_01")) &&
			streaming::has_model_loaded(joaat("g_m_y_lost_02")) &&
			...
			while (iVar0 < iLocal_69) {
				if (!ped::is_ped_injured(iLocal_69[iVar0]) && !entity::is_entity_dead(iLocal_77[iVar0], 0)) {
					...
					ai::open_sequence_task(&iLocal_84);
					ai::task_vehicle_drive_to_coord(0, iLocal_77[2], 966.7098f, 3633.926f, 31.3974f, 10f, 0,
													joaat("hexer"), 786725, 4f, 100f);
					ai::task_look_at_coord(0, vLocal_50, 5000, 0, 2);
					ai::close_sequence_task(iLocal_84);
					ai::task_perform_sequence(iLocal_69[2], iLocal_84);
					ai::clear_sequence_task(&iLocal_84);
					ai::open_sequence_task(&iLocal_84);
					ai::task_vehicle_drive_to_coord(0, iLocal_77[3], 970.6208f, 3636.743f, 31.3666f, 10f, 0,
													joaat("hexer"), 786725, 4f, 100f);
					ai::task_look_at_coord(0, vLocal_50, 5000, 0, 2);
					ai::close_sequence_task(iLocal_84);
					ai::task_perform_sequence(iLocal_69[3], iLocal_84);
					ai::clear_sequence_task(&iLocal_84);
					ped::set_ped_keep_task(iLocal_69[3], 1);
					ai::open_sequence_task(&iLocal_84);
					ai::task_vehicle_drive_to_coord(0, iLocal_77[4], 971.023f, 3631.225f, 31.3807f, 10f, 0,
													joaat("hexer"), 786725, 4f, 100f);
					ai::task_look_at_coord(0, vLocal_50, 5000, 0, 2);
					ai::close_sequence_task(iLocal_84);
					ai::task_perform_sequence(iLocal_69[4], iLocal_84);
					ai::clear_sequence_task(&iLocal_84);
					ai::open_sequence_task(&iLocal_84);
					ai::task_vehicle_drive_to_coord(0, iLocal_77[5], 974.8073f, 3633.771f, 31.3818f, 10f, 0,
													joaat("hexer"), 786725, 4f, 100f);
					ai::task_look_at_coord(0, vLocal_50, 5000, 0, 2);
					ai::close_sequence_task(iLocal_84);
					ai::task_perform_sequence(iLocal_69[5], iLocal_84);
					ai::clear_sequence_task(&iLocal_84);
				}
				iVar0++;
			}
...
void func_58() {
	if (!ped::is_ped_injured(iLocal_68)) {
		...
		if (!entity::is_entity_dead(iLocal_69[0], 0) && !entity::is_entity_dead(iLocal_69[1], 0)) {
			entity::set_entity_health(iLocal_68, 101);
			entity::set_entity_only_damaged_by_player(iLocal_68, 0);
		...
		if (!ped::is_ped_injured(iLocal_68) && !ped::is_ped_injured(iLocal_69[0]) &&
			...
			if (system::timera() < 28000) {
				if (entity::is_entity_at_entity(player::player_ped_id(), iLocal_68, 12f, 12f, 2.5f, 0, 1, 0)) {
					if (ped::_0x6CD5A433374D4CFB(iLocal_69[0], player::player_ped_id()) ||
						ped::_0x6CD5A433374D4CFB(iLocal_69[1], player::player_ped_id()) ||
						entity::has_entity_clear_los_to_entity_in_front(iLocal_69[0], player::player_ped_id()) ||
						entity::has_entity_clear_los_to_entity_in_front(iLocal_69[1], player::player_ped_id())) {
				...
				else if (!entity::is_entity_playing_anim(iLocal_69[0], "random@countryside_gang_fight",
														 "biker_02_stickup_loop", 3)) {
...
void func_62() {
	if (!cam::is_sphere_visible(916.4631f, 3601.261f, 31.9327f, 3f)) {
		if (!entity::is_entity_dead(player::get_players_last_vehicle(), 0)) {
			if (entity::is_entity_at_coord(player::get_players_last_vehicle(), 916.4631f, 3601.261f, 31.9327f, 2f, 2f,
										   2f, 0, 1, 0)) {
				entity::set_entity_coords(player::get_players_last_vehicle(), 915.6531f, 3595.061f, 32.0774f, 1, 0, 0,
										  1);
			}
		}
	}
...
// Position - 0x3DB9
bool func_68() {
	switch (func_69(&Global_25249, 0, 5, 0, script::get_id_of_this_thread())) {
	case 1: return true;
...
// Position - 0x3F75
bool func_71(int iParam0) { return func_72(iParam0, Global_35781); }
...
// Position - 0x42DC
var func_76(bool bParam0, float fParam1, float fParam2) {
	if (bParam0) {
		return fParam1;
	}
	return fParam2;
...
bool func_77() {
	...
	if (!iLocal_55) {
		...
		if (!entity::is_entity_dead(iLocal_69[0], 0) && !entity::is_entity_dead(iLocal_69[1], 0)) {
			if (entity::has_entity_been_damaged_by_entity(iLocal_69[0], player::player_ped_id(), 1) ||
				entity::has_entity_been_damaged_by_entity(iLocal_69[1], player::player_ped_id(), 1)) {
				func_4();
				return true;
			}
			if (!entity::is_entity_dead(player::get_players_last_vehicle(), 0)) {
				if (entity::has_entity_been_damaged_by_entity(iLocal_69[0], player::get_players_last_vehicle(), 1) ||
					entity::has_entity_been_damaged_by_entity(iLocal_69[1], player::get_players_last_vehicle(), 1)) {
					func_4();
					return true;
				}
			}
		...
		if (!entity::is_entity_dead(iLocal_77[0], 0) && !entity::is_entity_dead(iLocal_77[1], 0)) {
			if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_77[0], 0) ||
				ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_77[1], 0) ||
				entity::has_entity_been_damaged_by_entity(iLocal_77[0], player::player_ped_id(), 1) ||
				entity::has_entity_been_damaged_by_entity(iLocal_77[1], player::player_ped_id(), 1)) {
				if (!ped::is_ped_injured(iLocal_69[0]) && !ped::is_ped_injured(iLocal_69[1])) {
					if (func_93()) {
						func_4();
						func_40(0);
		...
		if (!ped::is_ped_injured(iLocal_69[0])) {
			...
			if (gameplay::is_projectile_type_in_area(vVar3, vVar0, joaat("weapon_smokegrenade"), 1) ||
				...
				gameplay::is_projectile_type_in_area(vVar3, vVar0, joaat("weapon_grenadelauncher"), 1) ||
		...
		if (ped::is_ped_shooting_in_area(player::player_ped_id(), 973.053f - 30f, 3616.738f - 30f, 32.6181f - 30f,
										 973.053f + 30f, 3616.738f + 30f, 32.6181f + 30f, 0, 1)) {
			func_4();
			return true;
		}
		if (!ped::is_ped_injured(iLocal_68) && !ped::is_ped_injured(iLocal_69[0]) &&
			!ped::is_ped_injured(iLocal_69[1])) {
			if (iLocal_49 != -1) {
				if (player::is_player_targetting_entity(player::player_id(), iLocal_69[0]) ||
					player::is_player_targetting_entity(player::player_id(), iLocal_69[1]) ||
					player::is_player_free_aiming_at_entity(player::player_id(), iLocal_69[0]) ||
					player::is_player_free_aiming_at_entity(player::player_id(), iLocal_69[1])) {
					func_4();
					return true;
				}
			}
			if (entity::is_entity_at_entity(player::player_ped_id(), iLocal_68, 12f, 12f, 2.5f, 0, 1, 0)) {
				if (ped::_0x6CD5A433374D4CFB(iLocal_69[0], player::player_ped_id()) ||
					...
					if (ui::does_blip_exist(iLocal_60)) {
						ui::_0x75A16C3DA34F1245(iLocal_60, 1);
					}
					if (ui::does_blip_exist(iLocal_61[0])) {
						ui::_0x75A16C3DA34F1245(iLocal_61[0], 1);
					}
					if (ui::does_blip_exist(iLocal_61[1])) {
						ui::_0x75A16C3DA34F1245(iLocal_61[1], 1);
					}
...
void func_78() {
	if (vehicle::is_vehicle_driveable(iLocal_76, 0)) {
		if (!entity::is_entity_at_coord(iLocal_76, 915.7905f, 3603.449f, 31.9111f, 5f, 5f, 5f, 0, 1, 0) &&
				!ped::is_ped_in_vehicle(iLocal_68, iLocal_76, 0) ||
			ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_76, 1)) {
			func_58();
		}
	}
	else {
...
bool func_79() {
	...
	if (!entity::does_entity_exist(iLocal_68) && !entity::does_entity_exist(iLocal_69[0]) &&
		!entity::does_entity_exist(iLocal_69[1]) && !entity::does_entity_exist(iLocal_76) &&
		!entity::does_entity_exist(iLocal_77[0]) && !entity::does_entity_exist(iLocal_77[1])) {
		...
		if (streaming::has_model_loaded(joaat("a_m_m_skidrow_01")) &&
			streaming::has_model_loaded(joaat("g_m_y_lost_01")) &&
			streaming::has_model_loaded(joaat("g_m_y_lost_02")) && streaming::has_model_loaded(joaat("picador")) &&
			streaming::has_model_loaded(joaat("hexer")) &&
			streaming::has_anim_dict_loaded("random@countryside_gang_fight") &&
			streaming::has_anim_dict_loaded("veh@drivebystd_ds_grenades") &&
			streaming::has_anim_set_loaded("move_m@gangster@var_i")) {
			vehicle::set_vehicle_model_is_suppressed(joaat("picador"), 1);
			vehicle::set_vehicle_model_is_suppressed(joaat("hexer"), 1);
			pathfind::set_roads_in_angled_area(417.901f, 3578.002f, 31.176f, 1305.897f, 3604.306f, 40.1064f, 100.0625f,
											   0, 0, 1);
			ped::add_scenario_blocking_area(vLocal_50 - Vector(20f, 50f, 80f), vLocal_50 + Vector(20f, 50f, 70f), 0, 1,
											1, 1);
			...
			ai::task_play_anim(iLocal_68, "random@countryside_gang_fight", "gangmember_stickup_loop", 1000f, -2f, -1, 1,
							   0, 0, 0, 0);
			ped::set_ped_movement_clipset(iLocal_68, "move_m@gangster@var_i", 1048576000);
			iLocal_76 = vehicle::create_vehicle(joaat("picador"), 915.7905f, 3603.449f, 31.9111f, 111.9593f, 1, 1);
			...
			streaming::set_model_as_no_longer_needed(joaat("g_m_y_lost_01"));
			streaming::set_model_as_no_longer_needed(joaat("g_m_y_lost_02"));
			iLocal_77[0] = vehicle::create_vehicle(joaat("hexer"), 968.2626f, 3611.717f, 31.7874f, 296.8978f, 1, 1);
			iLocal_77[1] = vehicle::create_vehicle(joaat("hexer"), 970.8362f, 3625.563f, 31.3415f, 212.3456f, 1, 1);
			streaming::set_model_as_no_longer_needed(joaat("hexer"));
			ai::task_play_anim(iLocal_69[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 1000f, -2f, -1,
							   1, 0, 0, 0, 0);
			ai::task_play_anim(iLocal_69[1], "random@countryside_gang_fight", "biker_01_stickup_loop", 1000f, -2f, -1,
							   1, 0, 0, 0, 0);
			iVar0 = 0;
			while (iVar0 < iLocal_69) {
				if (iVar0 < 2) {
					...
					ped::set_ped_keep_task(iLocal_69[iVar0], 1);
					ped::set_blocking_of_non_temporary_events(iLocal_69[iVar0], 1);
					entity::set_entity_load_collision_flag(iLocal_69[iVar0], 1);
				}
				iVar0++;
			}
			iLocal_59 = gameplay::get_game_timer() + 1500;
...
void func_82(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_83(uParam1, "Abigail1", func_85(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				"ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_84(iParam0), 1, 0);
		break;

	case 1:
		func_83(uParam1, "Abigail2", func_85(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				-1, 4, 1, 0, 2359, func_84(iParam0), 1, 0);
		break;

	case 2:
		func_83(uParam1, "Barry1", func_85(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				4, 1, 0, 2359, func_84(iParam0), 1, 0);
		break;

	case 3:
		func_83(uParam1, "Barry2", func_85(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				4, 4, 0, 2359, func_84(iParam0), 1, 1);
		break;

	case 4:
		func_83(uParam1, "Barry3", func_85(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2, 0,
				2359, func_84(iParam0), 0, 0);
		break;

	case 5:
		func_83(uParam1, "Barry3A", func_85(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0, "",
				166, 0, 7, 4, 2, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 6:
		func_83(uParam1, "Barry3C", func_85(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				7, 4, 2, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 7:
		func_83(uParam1, "Barry4", func_85(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4",
				0, 0, -1, 4, 2, 800, 2000, func_84(iParam0), 0, 0);
		break;

	case 8:
		func_83(uParam1, "Dreyfuss1", func_85(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				0, "", 0, 0, -1, 4, 2, 0, 2359, func_84(iParam0), 0, 0);
		break;

	case 9:
		func_83(uParam1, "Epsilon1", func_85(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1, 10,
				4, 1, 0, 2359, func_84(iParam0), 0, 0);
		break;

	case 10:
		func_83(uParam1, "Epsilon2", func_85(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0, 11,
				4, 1, 0, 2359, func_84(iParam0), 1, 0);
		break;

	case 11:
		func_83(uParam1, "Epsilon3", func_85(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				0, 0, 12, 4, 1, 0, 2359, func_84(iParam0), 0, 0);
		break;

	case 12:
		func_83(uParam1, "Epsilon4", func_85(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				"postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_84(iParam0), 0, 0);
		break;

	case 13:
		func_83(uParam1, "Epsilon5", func_85(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16, "epsRobes",
				0, 0, 14, 4, 1, 0, 2359, func_84(iParam0), 1, 0);
		break;

	case 14:
		func_83(uParam1, "Epsilon6", func_85(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				15, 4, 1, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 15:
		func_83(uParam1, "Epsilon7", func_85(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16, "epsDesert",
				0, 0, 16, 4, 1, 0, 2359, func_84(iParam0), 0, 0);
		break;

	case 16:
		func_83(uParam1, "Epsilon8", func_85(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				"epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_84(iParam0), 1, 0);
		break;

	case 17:
		func_83(uParam1, "Extreme1", func_85(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1, 18,
				4, 2, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 18:
		func_83(uParam1, "Extreme2", func_85(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171, 0,
				19, 4, 2, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 19:
		func_83(uParam1, "Extreme3", func_85(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				4, 2, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 20:
		func_83(uParam1, "Extreme4", func_85(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				-1, 4, 2, 0, 2359, func_84(iParam0), 0, 0);
		break;

	case 21:
		func_83(uParam1, "Fanatic1", func_85(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1,
				-1, 4, 1, 700, 2000, func_84(iParam0), 1, 0);
		break;

	case 22:
		func_83(uParam1, "Fanatic2", func_85(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				-1, 4, 4, 700, 2000, func_84(iParam0), 1, 0);
		break;

	case 23:
		func_83(uParam1, "Fanatic3", func_85(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1, 4,
				2, 700, 2000, func_84(iParam0), 0, 1);
		break;

	case 24:
		func_83(uParam1, "Hao1", func_85(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				"controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_84(iParam0), 0, 1);
		break;

	case 25:
		func_83(uParam1, "Hunting1", func_85(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				26, 4, 4, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 26:
		func_83(uParam1, "Hunting2", func_85(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				-1, 4, 4, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 27:
		func_83(uParam1, "Josh1", func_85(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				0, 1, 28, 4, 4, 0, 2359, func_84(iParam0), 1, 0);
		break;

	case 28:
		func_83(uParam1, "Josh2", func_85(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0, 29,
				4, 4, 0, 2359, func_84(iParam0), 1, 1);
		break;

	case 29:
		func_83(uParam1, "Josh3", func_85(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0, 30,
				4, 4, 0, 2359, func_84(iParam0), 1, 1);
		break;

	case 30:
		func_83(uParam1, "Josh4", func_85(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				4, 4, 0, 2359, func_84(iParam0), 1, 0);
		break;

	case 31:
		func_83(uParam1, "Maude1", func_85(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0, "BailBond_Launcher",
				0, 1, -1, 4, 4, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 32:
		func_83(uParam1, "Minute1", func_85(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				4, 4, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 33:
		func_83(uParam1, "Minute2", func_85(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				0, 2359, func_84(iParam0), 0, 1);
		break;

	case 34:
		func_83(uParam1, "Minute3", func_85(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				-1, 4, 4, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 35:
		func_83(uParam1, "MrsPhilips1", func_85(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				"ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_84(iParam0), 0, 0);
		break;

	case 36:
		func_83(uParam1, "MrsPhilips2", func_85(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				2359, func_84(iParam0), 0, 0);
		break;

	case 37:
		func_83(uParam1, "Nigel1", func_85(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				-1, 1, 4, 0, 2359, func_84(iParam0), 1, 0);
		break;

	case 38:
		func_83(uParam1, "Nigel1A", func_85(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0, "",
				0, 0, 42, 4, 4, 0, 2359, func_84(iParam0), 1, 1);
		break;

	case 39:
		func_83(uParam1, "Nigel1B", func_85(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				42, 4, 4, 700, 2000, func_84(iParam0), 1, 1);
		break;

	case 40:
		func_83(uParam1, "Nigel1C", func_85(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				42, 4, 4, 700, 2000, func_84(iParam0), 1, 1);
		break;

	case 41:
		func_83(uParam1, "Nigel1D", func_85(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				42, 4, 4, 700, 2000, func_84(iParam0), 1, 1);
		break;

	case 42:
		func_83(uParam1, "Nigel2", func_85(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0, 43,
				4, 4, 0, 2359, func_84(iParam0), 1, 1);
		break;

	case 43:
		func_83(uParam1, "Nigel3", func_85(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				"postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_84(iParam0), 1, 1);
		break;

	case 44:
		func_83(uParam1, "Omega1", func_85(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				"spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_84(iParam0), 0, 0);
		break;

	case 45:
		func_83(uParam1, "Omega2", func_85(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				-1, 4, 2, 0, 2359, func_84(iParam0), 0, 0);
		break;

	case 46:
		func_83(uParam1, "Paparazzo1", func_85(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				47, 4, 2, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 47:
		func_83(uParam1, "Paparazzo2", func_85(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0, 0,
				48, 4, 2, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 48:
		func_83(uParam1, "Paparazzo3", func_85(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				1, -1, 2, 2, 0, 2359, func_84(iParam0), 0, 0);
		break;

	case 49:
		func_83(uParam1, "Paparazzo3A", func_85(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102, 0,
				"", 0, 0, 51, 4, 2, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 50:
		func_83(uParam1, "Paparazzo3B", func_85(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "", 0,
				0, 51, 4, 2, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 51:
		func_83(uParam1, "Paparazzo4", func_85(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				-1, 4, 2, 0, 2359, func_84(iParam0), 0, 0);
		break;

	case 52:
		func_83(uParam1, "Rampage1", func_85(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				4, 0, 2359, func_84(iParam0), 0, 0);
		break;

	case 54:
		func_83(uParam1, "Rampage3", func_85(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				4, 4, 0, 2359, func_84(iParam0), 1, 0);
		break;

	case 55:
		func_83(uParam1, "Rampage4", func_85(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				4, 0, 2359, func_84(iParam0), 1, 0);
		break;

	case 56:
		func_83(uParam1, "Rampage5", func_85(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				53, 4, 4, 0, 2359, func_84(iParam0), 0, 0);
		break;

	case 53:
		func_83(uParam1, "Rampage2", func_85(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				"rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_84(iParam0), 1, 0);
		break;

	case 57:
		func_83(uParam1, "TheLastOne", func_85(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0,
				1, -1, 4, 2, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 58:
		func_83(uParam1, "Tonya1", func_85(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				"ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 59:
		func_83(uParam1, "Tonya2", func_85(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				"ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_84(iParam0), 0, 1);
		break;

	case 60:
		func_83(uParam1, "Tonya3", func_85(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0, 2359,
				func_84(iParam0), 0, 1);
		break;

	case 61:
		func_83(uParam1, "Tonya4", func_85(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				func_84(iParam0), 0, 1);
		break;

	case 62:
		func_83(uParam1, "Tonya5", func_85(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				-1, 4, 2, 0, 2359, func_84(iParam0), 0, 1);
		break;
...
// Position - 0x600F
void func_83(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
// Position - 0x689B
bool func_88() { return Global_101418 > 0; }
...
// Position - 0x6963
bool func_93() {
	if (Global_101689 == func_37() && gameplay::get_random_event_flag() && Global_101690) {
		return true;
	}
	return false;
}
...
// Position - 0x6A09
void func_97(int iParam0) { Global_101689 = iParam0; }

// Position - 0x6A17
bool func_98(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6) {
	int iVar0;
	vector3 vVar1;
	int iVar4;
	vector3 vVar5;
...
// Position - 0x6E19
int func_101(int iParam0) { return func_102(iParam0, 1); }
...
int func_102(int iParam0, int iParam1) {
	...
	func_103(iParam0, &iVar0, &iVar1, &iVar2, &iVar3, &iVar4, &iVar5);
...
void func_103(int iParam0, int *iParam1, int *iParam2, int *iParam3, int *iParam4, int *iParam5, int *iParam6) {
	func_104(func_115(), iParam0, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6);
}

// Position - 0x6E99
void func_104(int iParam0, int iParam1, int *iParam2, int *iParam3, int *iParam4, int *iParam5, int *iParam6,
			  int *iParam7) {
	int iVar0;
	int iVar1;
	int iVar2;
...
// Position - 0x717E
int func_107(int iParam0) { return system::shift_right(iParam0, 20) & 63; }

// Position - 0x7191
int func_108(int iParam0) { return system::shift_right(iParam0, 14) & 63; }

// Position - 0x71A4
int func_109(int iParam0) { return system::shift_right(iParam0, 9) & 31; }

// Position - 0x71B7
int func_110(int iParam0) { return system::shift_right(iParam0, 4) & 31; }
...
// Position - 0x7205
int func_113(int iParam0) { return iParam0 & 15; }
...
int func_115() {
	...
	func_121(&iVar0, time::get_clock_seconds());
	func_120(&iVar0, time::get_clock_minutes());
	func_119(&iVar0, time::get_clock_hours());
	func_118(&iVar0, time::get_clock_day_of_month());
	func_117(&iVar0, time::get_clock_month());
	func_116(&iVar0, time::get_clock_year());
	return iVar0;
}
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_132() || Global_100747 ||
						Global_25192 || func_131() || func_50(8, -1) || func_130() || func_129() || func_128() ||
						func_127() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;

				case 1:
					if (player::is_player_being_arrested(player::player_id(), 1) || func_132() || Global_25192 ||
						func_131() || func_50(8, -1) || func_128() || func_130() || func_129() || func_127() ||
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						player::is_player_climbing(player::player_id()) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_132() || Global_100747 ||
						Global_25192 || func_131() || func_50(8, -1) || func_128() || func_130() || func_129() ||
						func_127() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5 || LastDispatchedMessageOrCall != -1) {
						return 0;
					}
					break;
				...
				case 3:
					if (ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_132() || Global_100747 ||
						Global_25192 || func_131() || func_50(8, -1) || func_130() || func_129() || func_127() ||
						G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 4:
					if (func_132() || player::get_player_wanted_level(player::player_id()) > 0 || func_50(8, -1) ||
						func_127() || func_126() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 6:
					if (entity::does_entity_exist(player::player_ped_id())) {
						if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
							...
							player::is_player_being_arrested(player::player_id(), 1) ||
							player::is_player_climbing(player::player_id()) || func_132() || Global_25192 ||
							func_131() || func_50(8, -1) || func_129() || func_128() || func_127() ||
							G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
							return 0;
						}
					}
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						entity::is_entity_in_air(player::player_ped_id()) ||
						ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) || func_132() || func_129() ||
						Global_100747 || Global_25192 || func_131() || Global_36912 || func_50(8, -1) || func_128() ||
						func_126() || func_127() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 8:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						player::is_player_being_arrested(player::player_id(), 1) ||
						player::is_player_climbing(player::player_id()) || func_132() || Global_100747 ||
						Global_25192 || func_131() || func_50(8, -1) || func_128() || func_126() || func_130() ||
						func_129() || func_127()) {
						return 0;
					}
					break;
...
// Position - 0x7D3B
var func_125() { return Global_91530.f_1; }
...
// Position - 0x7DB3
bool func_129() { return Global_91543.f_304 > 0; }

// Position - 0x7DC4
bool func_130() { return Global_91543.f_303 > 0; }

// Position - 0x7DD5
var func_131() { return Global_1315233; }
...
// Position - 0x7E25
int func_134(int iParam0) { return func_114(func_115(), iParam0); }
...
// Position - 0x859D
void func_144(int iParam0) { Global_36332 = gameplay::get_game_timer() + iParam0; }

// Position - 0x85AF
void func_145(int iParam0) { func_146(iParam0, 0, func_151(iParam0)); }
...
void func_146(int iParam0, int iParam1, int iParam2) {
	...
	iVar0 = func_115();
	func_149(&iVar0, 0, 0, iParam2, iParam1, 0, 0);
	func_148(iParam0, &iVar0);
	Var1 = {func_147(&iVar0)};
}

// Position - 0x85F3
struct<16> func_147(int *iParam0) {
	struct<16> Var0;
	int iVar16;

	StringCopy(&Var0, "", 64);
	iVar16 = func_109(*iParam0);
	if (iVar16 < 10) {
		StringIntConCat(&Var0, 0, 64);
	}
	StringIntConCat(&Var0, iVar16, 64);
	StringConCat(&Var0, ":", 64);
	iVar16 = func_108(*iParam0);
	if (iVar16 < 10) {
		StringIntConCat(&Var0, 0, 64);
	}
	StringIntConCat(&Var0, iVar16, 64);
	...
	StringConCat(&Var0, "/", 64);
	StringIntConCat(&Var0, func_111(*iParam0), 64);
	return Var0;
}
