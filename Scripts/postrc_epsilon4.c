...
void __EntryFunction__() {
	...
	while (true) {
		...
		if (func_27(0)) {
			...
			switch (iLocal_37) {
			case 0: func_24(); break;

			case 1: func_1(); break;

			case 2: func_30(); break;
			}
		}
	}
}
...
void func_1() {
	if (func_23(iLocal_205)) {
		if (!func_22() && !ped::is_ped_fleeing(iLocal_205) && !ped::is_ped_ragdoll(iLocal_205) &&
			!ped::is_ped_prone(iLocal_205) && !ped::is_ped_injured(iLocal_205) &&
			!ped::is_ped_in_any_vehicle(iLocal_205, 0)) {
	...
	if (func_23(iLocal_204)) {
		if (!func_22() && !ped::is_ped_fleeing(iLocal_204) && !ped::is_ped_ragdoll(iLocal_204) &&
			!ped::is_ped_prone(iLocal_204) && !ped::is_ped_injured(iLocal_204) &&
			!ped::is_ped_in_any_vehicle(iLocal_204, 0)) {
...
// Position - 0xADA
float func_21(int iParam0, int iParam1, int iParam2) {
	vector3 vVar0;
	vector3 vVar3;
		...
		if (func_23(uVar2[iVar1])) {
			if (entity::get_entity_model(uVar2[iVar1]) == func_26(55)) {
				...
				if (!entity::is_entity_a_mission_entity(iLocal_205)) {
					entity::set_entity_as_mission_entity(iLocal_205, 1, 0);
				}
				ped::set_ped_money(iLocal_205, 0);
				ped::set_ped_can_be_targetted(iLocal_205, 0);
			...
			if (entity::get_entity_model(uVar2[iVar1]) == func_26(60)) {
				...
				if (!entity::is_entity_a_mission_entity(iLocal_204)) {
					entity::set_entity_as_mission_entity(iLocal_204, 1, 0);
				}
				ped::set_ped_money(iLocal_204, 0);
				ped::set_ped_can_be_targetted(iLocal_204, 0);
