...
void func_1() {
		...
		if (!vehicle::is_vehicle_driveable(iLocal_241, 0)) {
			...
			if (!ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_241, 0)) {
				if (!ui::does_blip_exist(iLocal_50)) {
					...
					iLocal_50 = func_132(iLocal_241, 0, 0);
				}
				if (func_131(player::player_ped_id(), iLocal_241, 1) > 300f) {
					func_134();
				}
			}
	...
	if (entity::does_entity_exist(iLocal_241) && ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_241, 0) &&
		entity::is_entity_in_air(iLocal_241) && iLocal_325 && audio::request_script_audio_bank("PLANES", 0, -1)) {
		if (!bLocal_326) {
			if (controls::is_control_just_pressed(0, 114)) {
				if (iLocal_324 == -1 || gameplay::get_game_timer() - iLocal_324 > 2000) {
					if (!graphics::does_particle_fx_looped_exist(iLocal_332)) {
						iLocal_332 = graphics::start_particle_fx_looped_on_entity(
							"scr_property_leaflet_drop", iLocal_241, 0f, -2f, -0.65f, 0f, 0f, 0f, 1f, 0, 0, 0);
						fLocal_330 = 0f;
					}
					if (func_130("LEAFLET")) {
						ui::clear_help(1);
	...
	if (graphics::does_particle_fx_looped_exist(iLocal_332)) {
		...
		fLocal_330 += fVar7 * system::timestep() * 100f;
	...
	case 0:
		...
		if (streaming::has_model_loaded(joaat("stunt"))) {
			iLocal_241 = Global_100412.f_222[0];
			if (!entity::does_entity_exist(iLocal_241)) {
				iLocal_241 = vehicle::create_vehicle(joaat("stunt"), vVar0, 121.2244f, 1, 1);
	...
	case 3:
		if (func_24(&uLocal_51, vLocal_36, -1067.083f, -2922.601f, 12.82418f, -1091.854f, -2965.403f, 23.94564f,
					31.5625f, 1, iLocal_241, "LAND", "", "BK_PLANE", 1, 0, 1, -1) &&
			!entity::is_entity_in_air(iLocal_241)) {
			func_126(&uLocal_51, 1, 0);
			iLocal_47++;
		}
		break;
...
// Position - 0xDE2
bool func_22(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
// Position - 0xF92
int func_24(var *uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, float fParam10, int iParam11, int iParam12,
			char *sParam13, char *sParam14, char *sParam15, int iParam16, int iParam17, int iParam18, int iParam19) {
	return func_25(uParam0, vParam1, func_69(), vParam4, vParam7, iParam11, 5, 0, 0, 0, iParam12, sParam13, func_68(),
				   func_68(), func_68(), func_68(), sParam14, 0, iParam16, sParam15, 1, iParam17, iParam18, iParam19,
				   func_68(), func_68(), func_68(), 1, fParam10);
}

// Position - 0xFE7
int func_25(int *iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, int iParam13,
			...
			int iParam28, int iParam29, bool bParam30, int iParam31, var uParam32, var uParam33, var uParam34,
	...
	func_66(uParam0);
	func_65();
	if (func_48(uParam0, uParam0->f_17[0], uParam0->f_17[1], uParam0->f_17[2], sParam20, sParam21, sParam22, sParam23,
				uParam0->f_8, iParam25, iParam18, 0, 0, uParam32, uParam33, uParam34, iParam14, bParam26)) {
		func_47(sParam20);
		func_47(sParam21);
		func_47(sParam22);
		func_47(sParam23);
...
// Position - 0x1940
int func_26(int iParam0, int iParam1, int iParam2) { return func_27(iParam0, !iParam1, iParam2); }
...
// Position - 0x19F7
var func_28(bool bParam0, float fParam1, float fParam2) {
	if (bParam0) {
		return fParam1;
	}
	return fParam2;
...
// Position - 0x1C4B
int func_35(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
// Position - 0x1F38
void func_40(var *uParam0, char *sParam1, int iParam2) {
	if (!iParam2) {
...
// Position - 0x2102
bool func_48(var *uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char *sParam7,
							...
							while (iVar0 < 3) {
								if (!ped::is_ped_injured(uParam0->f_17[iVar0])) {
									...
									if (ai::get_script_task_status(uParam0->f_17[iVar0], -1794415470) == 7 &&
										!func_64(uParam0->f_17[iVar0], uParam0->f_21)) {
		...
		while (iVar0 < 3) {
			if (entity::does_entity_exist(uParam0->f_17[iVar0])) {
				if (!ped::is_ped_injured(uParam0->f_17[iVar0])) {
					...
					if (!ped::is_ped_group_member(uParam0->f_17[iVar0], func_34()) &&
						!func_55(uParam0->f_17[iVar0], iParam10) && !func_54(uParam0->f_17[iVar0], iParam10)) {
						if (func_62(uParam0, uParam0->f_17[iVar0], fParam8, iParam11)) {
							if (!ped::is_ped_group_member(uParam0->f_17[iVar0], func_34())) {
								if (!ped::is_ped_ragdoll(uParam0->f_17[iVar0]) &&
									!ai::is_ped_getting_up(uParam0->f_17[iVar0]) &&
						...
						if (func_32(uParam0->f_17[iVar0], 1) || func_55(uParam0->f_17[iVar0], iParam10) || iParam12 ||
...
// Position - 0x31BA
void func_50(var *uParam0, char *sParam1, char *sParam2, int iParam3) {
	if (!iParam3) {
		if (!gameplay::is_string_null(sParam1)) {
			if (!gameplay::are_strings_equal(sParam1, "")) {
...
// Position - 0x3623
bool func_62(var *uParam0, int iParam1, float fParam2, int iParam3) {
	int iVar0;
...
// Position - 0x3919
Vector3 func_69() { return 0f, 0f, 2f; }
...
// Position - 0x3A62
int func_71(vector3 vParam0, float fParam3, int iParam4) {
	int iVar0;

	iVar0 = ui::add_blip_for_radius(vParam0, fParam3);
	ui::set_blip_colour(iVar0, 5);
	ui::set_blip_alpha(iVar0, 64);
	ui::set_blip_as_short_range(iVar0, iParam4);
	if (!iParam4) {
...
// Position - 0x3AB3
var func_73(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
...
void func_74(vector3 vParam0, float *fParam3, int iParam4, int iParam5) {
	...
	if (entity::does_entity_exist(Global_93635.f_4)) {
		if (vehicle::is_vehicle_driveable(Global_93635.f_4, 0)) {
			if (func_125(24) != Global_93635.f_4) {
				if (iParam4 == 1) {
					if (func_122(entity::get_entity_coords(Global_93635.f_4, 1), iParam5, &vVar0, &fVar3)) {
						vParam0 = {vVar0};
						fParam3 = fVar3;
					}
				}
				func_75(Global_93635.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_76(int iParam0, int iParam1, int iParam2) {
	...
	if (!func_106(&Global_68531.f_555[0 /*21*/], iParam0)) {
		return;
	}
	...
	if (entity::does_entity_exist(iParam1)) {
		if (vehicle::is_vehicle_driveable(iParam1, 0)) {
			...
			if (iParam0 == 24) {
				Global_101700.f_31389.f_4801 = func_95();
			}
...
void func_77(int iParam0, int iParam1) {
	...
	func_117(iParam0, &Global_101700.f_31389.f_5510);
}

// Position - 0x3FB0
int func_78(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_93(iParam0, 0, 0) ||
		func_93(iParam0, 1, 0) || func_93(iParam0, 2, 0) || func_115(iParam0) != 145 || func_92(iParam0) ||
		func_91(iParam0) || func_90(iParam0) || func_89(iParam0) || !func_79(entity::get_entity_model(iParam0))) {
		if (func_91(iParam0)) {
		}
		if (func_91(iParam0)) {
		}
...
// Position - 0x51F0
int func_84() { return 0; }

// Position - 0x51F9
int func_85() { return 1; }

// Position - 0x5202
int func_86() { return 1; }
...
// Position - 0x5535
bool func_94(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
var func_95() {
	...
	func_105(&iVar0, time::get_clock_seconds());
	func_104(&iVar0, time::get_clock_minutes());
	func_103(&iVar0, time::get_clock_hours());
	func_98(&iVar0, time::get_clock_day_of_month());
	func_97(&iVar0, time::get_clock_month());
	func_96(&iVar0, time::get_clock_year());
	return iVar0;
}
...
// Position - 0x583B
int func_102(var uParam0) { return uParam0 & 15; }
...
bool func_106(var *uParam0, int iParam1) {
	...
	*uParam0 = {0f, 0f, 0f};
	...
	if (gameplay::is_bit_set(uParam0->f_9, 10)) {
		...
		if (!func_116(Global_101700.f_31389.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0)) {
	...
	if (gameplay::is_bit_set(uParam0->f_9, 19)) {
		if (!func_116(Global_101700.f_2095.f_539.f_2816[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)) {
		...
		if (!func_116(Global_101700.f_2095.f_539.f_2816[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)) {
...
void func_109(int iParam0, var *uParam1, vector3 vParam2, var uParam5, int iParam6) {
	if (func_106(&Global_68531.f_555[0 /*21*/], iParam0)) {
		if (gameplay::is_bit_set(Global_68531.f_555[0 /*21*/].f_9, 10)) {
			func_114(iParam0);
			func_113(uParam1, &Global_101700.f_31389.f_69[Global_68531.f_555[0 /*21*/].f_14 /*78*/]);
...
// Position - 0x7B45
bool func_122(vector3 vParam0, int iParam3, var *uParam4, float *fParam5) {
	int iVar0;

	iVar0 = func_123(vParam0, iParam3, 1);
	switch (iVar0) {
	case 0:
...
// Position - 0x7C5B
int func_123(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
...
// Position - 0x7CEA
var func_124(int iParam0) { return gameplay::is_bit_set(Global_101700.f_6188[iParam0], 0); }
...
// Position - 0x7FCA
int func_132(int iParam0, int iParam1, int iParam2) { return func_27(iParam0, !iParam1, iParam2); }
...
void func_136() {
	...
	func_140(2, 1);
	func_139(&uLocal_76, 0, player::player_ped_id(), "MICHAEL", 0, 1);
	...
	while (iVar0 <= 9) {
		if (!func_138(Local_242[iVar0 /*8*/])) {
			fVar1 = 0f;
			gameplay::get_ground_z_for_3d_coord(Local_242[iVar0 /*8*/], &fVar1, 0);
			Local_242[iVar0 /*8*/].f_2 = fVar1;
		}
		iVar0++;
	}
	switch (func_137()) {
	case 6: StringCopy(&cLocal_43, "DT", 16); break;

	case 5: StringCopy(&cLocal_43, "VW", 16); break;

	case 7: StringCopy(&cLocal_43, "MW", 16); break;
	}
...
// Position - 0x8240
int func_137() { return Global_100412.f_20; }
...
// Position - 0x83C3
void func_142(int iParam0) { Global_100412.f_22 = iParam0; }
