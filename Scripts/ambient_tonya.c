...
void __EntryFunction__() {
  ...
  while (true) {
    ...
    if (iVar0 != 1) {
      ...
      switch (iLocal_79) {
      case 0: func_162(); break;

      case 1: func_158(); break;

      case 2: func_143(); break;

      case 3: func_141(); break;

      case 4: func_2(); break;

      case 5: func_1(); break;

      case 6: func_170(); break;
      }
      if (!iLocal_246) {
        system::wait(1000);
      }
...
void func_7(int iParam0) {
  ...
  case 8: func_8(749); return;

  case 12: func_8(750); return;
  ...
  case 20: func_8(762); return;

  case 21: func_8(763); return;
...
// Position - 0x18C8
void func_26(var *uParam0, char *sParam1, int iParam2, char *sParam3,
...
// Position - 0x2772
void func_28(var *uParam0, var *uParam1, int iParam2, int iParam3, int iParam4,
             int iParam5) {
  int iVar0;
    ...
    if (entity::does_entity_exist(Global_89155[iVar0])) {
      if (Global_89155[iVar0] == iParam0) {
        if (iParam1 == 145 || iParam1 == Global_89165[iVar0]) {
          if (iParam2 == 0 ||
              entity::get_entity_model(iParam0) == func_35(iParam1, iParam2)) {
            return 1;
          }
        }
      }
...
void func_47(int iParam0, var *uParam1, int iParam2) {
  ...
  if (!ped::is_ped_injured(iParam0)) {
    ...
    iVar1 = 0;
    while (iVar1 < 12) {
      func_53(iParam0, iVar1, &uParam1->f_13[iVar1], &(*uParam1)[iVar1],
              &uParam1->f_26[iVar1], iParam2, 145);
      iVar1++;
    }
    iVar1 = 0;
    while (iVar1 < 9) {
      func_52(iParam0, iVar1, &uParam1->f_39[iVar1], &uParam1->f_49[iVar1],
              iParam2, 145);
      iVar1++;
    }
    if (func_37(iVar0)) {
...
int func_48(int iParam0, int iParam1, int iParam2) {
  ...
  iVar0 = Global_2503826[iParam0 /*3*/][func_49(iParam1)];
...
bool func_51(int iParam0, int iParam1) {
  ...
  iVar0 = Global_2522581[iParam0 /*3*/][func_49(iParam1)];
...
// Position - 0x3C66
void func_53(int iParam0, int iParam1, int *iParam2, int *iParam3, var *uParam4,
...
// Position - 0x3FBD
bool func_56(int iParam0) { return Global_35781 == iParam0; }
...
void func_58(int iParam0, var *uParam1) {
  ...
  if (!ped::is_ped_injured(iParam0)) {
    ...
    while (iVar0 <= 44 - 1) {
      iVar3 = func_62(iVar0);
      if (iVar3 != 0) {
        vVar4.x = weapon::get_ped_weapontype_in_slot(iParam0, func_62(iVar0));
        vVar4.y = 0;
        vVar4.z = 0;
    ...
    iVar7 = 0;
    while (iVar7 < iVar8) {
      if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_59(Var9.f_1) &&
          iVar70 < 50) {
...
// Position - 0x57C4
bool func_65(vector3 vParam0, char *sParam3, vector3 vParam4) {
  int iVar0;
  int iVar1;
...
// Position - 0x5E97
bool func_67(vector3 vParam0, vector3 vParam3, int iParam6) {
  if (iParam6) {
...
bool func_68(int *iParam0) {
  if (!entity::is_entity_dead(player::player_ped_id(), 0) &&
    ...
    if (func_79()) {
      *iParam0 = func_74(entity::get_entity_coords(player::player_ped_id(), 0),
                         6, -1, 0, 1, -1);
      if (func_73(*iParam0) && !func_69(*iParam0)) {
        return true;
      }
    }
  }
...
// Position - 0x5F39
int func_69(int iParam0) { return func_70(iParam0, 0, 1); }
...
int func_70(int iParam0, int iParam1, int iParam2) {
  if (iParam2) {
    ...
    if (func_72() == 0) {
      return gameplay::is_bit_set(func_48(func_71(iParam0), -1, 0), iParam1);
    }
  }
  else {
...
// Position - 0x6270
int func_72() { return Global_25190; }

// Position - 0x627B
int func_73(int iParam0) { return func_70(iParam0, 5, 1); }

// Position - 0x628B
int func_74(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6,
            int iParam7) {
  int iVar0;
  float fVar1;
  float fVar2;
...
Vector3 func_75(int iParam0, int iParam1) {
  ...
  case 45: return func_76(Global_93004);
  }
...
// Position - 0x695D
int func_77(int iParam0) { return func_70(iParam0, 0, 0); }
...
// Position - 0x6BE0
bool func_79() { return Global_91543.f_303 > 0; }

// Position - 0x6BF1
var func_80() {
  int *iVar0;

  func_90(&iVar0, time::get_clock_seconds());
  func_89(&iVar0, time::get_clock_minutes());
  func_88(&iVar0, time::get_clock_hours());
  func_83(&iVar0, time::get_clock_day_of_month());
  func_82(&iVar0, time::get_clock_month());
  func_81(&iVar0, time::get_clock_year());
  return iVar0;
}
...
var func_85(int iParam0) {
  return (system::shift_right(iParam0, 26) & 31) *
             func_86(gameplay::is_bit_set(iParam0, 31), -1, 1) +
         2011;
}
...
// Position - 0x6E1F
int func_87(var uParam0) { return uParam0 & 15; }
...
void func_93(char *sParam0, int iParam1, int iParam2) {
  ...
  stats::playstats_mission_started(sParam0, iParam1, iParam2, func_169(0));
}
...
void func_95(int iParam0, var* uParam1)
{
  switch (iParam0) {
  case 0:
    func_96(uParam1, "Abigail1", func_10(iParam0), 0, 0, 4, -1604.668f, 5239.1f,
            3.01f, 66, "", 109, 0, "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359,
            func_97(iParam0), 1, 0);
    break;

  case 1:
    func_96(uParam1, "Abigail2", func_10(iParam0), 0, 0, 4, -1592.84f, 5214.04f,
            3.01f, 400, "", 110, 0, "", 0, 0, -1, 4, 1, 0, 2359,
            func_97(iParam0), 1, 0);
    break;

  case 2:
    func_96(uParam1, "Barry1", func_10(iParam0), 0, 1, 4, 190.26f, -956.35f,
            29.63f, 381, "", 74, 0, "", 0, 1, -1, 4, 1, 0, 2359,
            func_97(iParam0), 1, 0);
    break;

  case 3:
    func_96(uParam1, "Barry2", func_10(iParam0), 0, 1, 4, 190.26f, -956.35f,
            29.63f, 381, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359,
            func_97(iParam0), 1, 1);
    break;

  case 4:
    func_96(uParam1, "Barry3", func_10(iParam0), 0, 1, 4, 414f, -761f, 29f, 381,
            "", -1, 0, "", 164, 1, -1, 0, 2, 0, 2359, func_97(iParam0), 0, 0);
    break;

  case 5:
    func_96(uParam1, "Barry3A", func_10(iParam0), 1, 1, 0, 1199.27f, -1255.63f,
            34.23f, 381, "BARSTASH", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 6:
    func_96(uParam1, "Barry3C", func_10(iParam0), 3, 1, 0, -468.9f, -1713.06f,
            18.21f, 381, "", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 7:
    func_96(uParam1, "Barry4", func_10(iParam0), 0, 1, 4, 237.65f, -385.41f,
            44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000,
            func_97(iParam0), 0, 0);
    break;

  case 8:
    func_96(uParam1, "Dreyfuss1", func_10(iParam0), 0, 2, 4, -1458.97f, 485.99f,
            115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, -1, 4, 2, 0, 2359,
            func_97(iParam0), 0, 0);
    break;

  case 9:
    func_96(uParam1, "Epsilon1", func_10(iParam0), 0, 3, 4, -1622.89f, 4204.87f,
            83.3f, 66, "", 86, 0, "", 0, 1, 10, 4, 1, 0, 2359, func_97(iParam0),
            0, 0);
    break;

  case 10:
    func_96(uParam1, "Epsilon2", func_10(iParam0), 0, 3, 4, 242.7f, 362.7f,
            104.74f, 206, "", 87, 16, "", 0, 0, 11, 4, 1, 0, 2359,
            func_97(iParam0), 1, 0);
    break;

  case 11:
    func_96(uParam1, "Epsilon3", func_10(iParam0), 0, 3, 4, 1835.53f, 4705.86f,
            38.1f, 206, "", 88, 16, "epsCars", 0, 0, 12, 4, 1, 0, 2359,
            func_97(iParam0), 0, 0);
    break;

  case 12:
    func_96(uParam1, "Epsilon4", func_10(iParam0), 0, 3, 4, 1826.13f, 4698.88f,
            38.92f, 206, "", 90, 16, "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359,
            func_97(iParam0), 0, 0);
    break;

  case 13:
    func_96(uParam1, "Epsilon5", func_10(iParam0), 0, 3, 4, 637.02f, 119.7093f,
            89.5f, 206, "", 89, 16, "epsRobes", 0, 0, 14, 4, 1, 0, 2359,
            func_97(iParam0), 1, 0);
    break;

  case 14:
    func_96(uParam1, "Epsilon6", func_10(iParam0), 0, 3, 4, -2892.93f, 3192.37f,
            11.66f, 206, "", 93, 0, "", 0, 0, 15, 4, 1, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 15:
    func_96(uParam1, "Epsilon7", func_10(iParam0), 0, 3, 4, 524.43f, 3079.82f,
            39.48f, 206, "", -1, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359,
            func_97(iParam0), 0, 0);
    break;

  case 16:
    func_96(uParam1, "Epsilon8", func_10(iParam0), 0, 3, 4, -697.75f, 45.38f,
            43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, -1, 4, 1, 0, 2359,
            func_97(iParam0), 1, 0);
    break;

  case 17:
    func_96(uParam1, "Extreme1", func_10(iParam0), 0, 4, 4, -188.22f, 1296.1f,
            302.86f, 66, "", -1, 0, "", 4, 1, 18, 4, 2, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 18:
    func_96(uParam1, "Extreme2", func_10(iParam0), 0, 4, 4, -954.19f, -2760.05f,
            14.64f, 382, "", 96, 0, "", 171, 0, 19, 4, 2, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 19:
    func_96(uParam1, "Extreme3", func_10(iParam0), 0, 4, 4, -63.8f, -809.5f,
            321.8f, 382, "", 97, 0, "", 0, 0, 20, 4, 2, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 20:
    func_96(uParam1, "Extreme4", func_10(iParam0), 0, 4, 4, 1731.41f, 96.96f,
            170.39f, 382, "", 98, 16, "", 0, 0, -1, 4, 2, 0, 2359,
            func_97(iParam0), 0, 0);
    break;

  case 21:
    func_96(uParam1, "Fanatic1", func_10(iParam0), 0, 5, 4, -1877.82f,
            -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, -1, 4, 1, 700, 2000,
            func_97(iParam0), 1, 0);
    break;

  case 22:
    func_96(uParam1, "Fanatic2", func_10(iParam0), 0, 5, 4, 809.66f, 1279.76f,
            360.49f, 405, "", -1, 0, "", 0, 1, -1, 4, 4, 700, 2000,
            func_97(iParam0), 1, 0);
    break;

  case 23:
    func_96(uParam1, "Fanatic3", func_10(iParam0), 0, 5, 4, -915.6f, 6139.2f,
            5.5f, 405, "", -1, 0, "", 0, 1, -1, 4, 2, 700, 2000,
            func_97(iParam0), 0, 1);
    break;

  case 24:
    func_96(uParam1, "Hao1", func_10(iParam0), 0, 6, 4, -72.29f, -1260.63f,
            28.14f, 66, "", -1, 0, "controller_Races", 13, 1, -1, 4, 2, 2000,
            500, func_97(iParam0), 0, 1);
    break;

  case 25:
    func_96(uParam1, "Hunting1", func_10(iParam0), 0, 7, 4, 1804.32f, 3931.33f,
            32.82f, 66, "", -1, 0, "", 174, 1, 26, 4, 4, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 26:
    func_96(uParam1, "Hunting2", func_10(iParam0), 0, 7, 4, -684.17f, 5839.16f,
            16.09f, 384, "", 99, 0, "", 7, 0, -1, 4, 4, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 27:
    func_96(uParam1, "Josh1", func_10(iParam0), 0, 8, 4, -1104.93f, 291.25f,
            64.3f, 66, "", -1, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359,
            func_97(iParam0), 1, 0);
    break;

  case 28:
    func_96(uParam1, "Josh2", func_10(iParam0), 0, 8, 4, 565.39f, -1772.88f,
            29.77f, 385, "", 105, 0, "", 0, 0, 29, 4, 4, 0, 2359,
            func_97(iParam0), 1, 1);
    break;

  case 29:
    func_96(uParam1, "Josh3", func_10(iParam0), 0, 8, 4, 565.39f, -1772.88f,
            29.77f, 385, "", -1, 16, "", 0, 0, 30, 4, 4, 0, 2359,
            func_97(iParam0), 1, 1);
    break;

  case 30:
    func_96(uParam1, "Josh4", func_10(iParam0), 0, 8, 4, -1104.93f, 291.25f,
            64.3f, 385, "", -1, 36, "", 0, 0, -1, 4, 4, 0, 2359,
            func_97(iParam0), 1, 0);
    break;

  case 31:
    func_96(uParam1, "Maude1", func_10(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f,
            66, "", -1, 0, "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 32:
    func_96(uParam1, "Minute1", func_10(iParam0), 0, 10, 4, 327.85f, 3405.7f,
            35.73f, 66, "", -1, 0, "", 0, 1, 33, 4, 4, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 33:
    func_96(uParam1, "Minute2", func_10(iParam0), 0, 10, 4, 18f, 4527f, 105f,
            386, "", -1, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_97(iParam0), 0,
            1);
    break;

  case 34:
    func_96(uParam1, "Minute3", func_10(iParam0), 0, 10, 4, -303.82f, 6211.29f,
            31.05f, 386, "", -1, 10, "", 0, 0, -1, 4, 4, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 35:
    func_96(uParam1, "MrsPhilips1", func_10(iParam0), 0, 11, 4, 1972.59f,
            3816.43f, 32.42f, 66, "", -1, 0, "ambient_MrsPhilips", 0, 1, -1, 4,
            4, 0, 2359, func_97(iParam0), 0, 0);
    break;

  case 36:
    func_96(uParam1, "MrsPhilips2", func_10(iParam0), 0, 11, 4, 0f, 0f, 0f, -1,
            "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_97(iParam0), 0, 0);
    break;

  case 37:
    func_96(uParam1, "Nigel1", func_10(iParam0), 0, 12, 4, -1097.16f, 790.01f,
            164.52f, 66, "", -1, 0, "", 177, 1, -1, 1, 4, 0, 2359,
            func_97(iParam0), 1, 0);
    break;

  case 38:
    func_96(uParam1, "Nigel1A", func_10(iParam0), 0, 12, 1, -558.65f, 284.49f,
            90.86f, 149, "NIGITEMS", 100, 0, "", 0, 0, 42, 4, 4, 0, 2359,
            func_97(iParam0), 1, 1);
    break;

  case 39:
    func_96(uParam1, "Nigel1B", func_10(iParam0), 0, 12, 1, -1034.15f, 366.08f,
            80.11f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000,
            func_97(iParam0), 1, 1);
    break;

  case 40:
    func_96(uParam1, "Nigel1C", func_10(iParam0), 0, 12, 1, -623.91f, -266.17f,
            37.76f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000,
            func_97(iParam0), 1, 1);
    break;

  case 41:
    func_96(uParam1, "Nigel1D", func_10(iParam0), 0, 12, 1, -1096.85f, 67.68f,
            52.95f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000,
            func_97(iParam0), 1, 1);
    break;

  case 42:
    func_96(uParam1, "Nigel2", func_10(iParam0), 0, 12, 4, -1310.7f, -640.22f,
            26.54f, 149, "", -1, 8, "", 0, 0, 43, 4, 4, 0, 2359,
            func_97(iParam0), 1, 1);
    break;

  case 43:
    func_96(uParam1, "Nigel3", func_10(iParam0), 0, 12, 4, -44.75f, -1288.67f,
            28.21f, 149, "", -1, 16, "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359,
            func_97(iParam0), 1, 1);
    break;

  case 44:
    func_96(uParam1, "Omega1", func_10(iParam0), 0, 13, 4, 2468.51f, 3437.39f,
            49.9f, 66, "", -1, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359,
            func_97(iParam0), 0, 0);
    break;

  case 45:
    func_96(uParam1, "Omega2", func_10(iParam0), 0, 13, 4, 2319.44f, 2583.58f,
            46.76f, 387, "", 107, 0, "", 0, 0, -1, 4, 2, 0, 2359,
            func_97(iParam0), 0, 0);
    break;

  case 46:
    func_96(uParam1, "Paparazzo1", func_10(iParam0), 0, 14, 4, -149.75f,
            285.81f, 93.67f, 66, "", -1, 0, "", 0, 1, 47, 4, 2, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 47:
    func_96(uParam1, "Paparazzo2", func_10(iParam0), 0, 14, 4, -70.71f, 301.43f,
            106.79f, 389, "", -1, 8, "", 0, 0, 48, 4, 2, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 48:
    func_96(uParam1, "Paparazzo3", func_10(iParam0), 0, 14, 4, -257.22f,
            292.85f, 90.63f, 389, "", -1, 8, "", 183, 1, -1, 2, 2, 0, 2359,
            func_97(iParam0), 0, 0);
    break;

  case 49:
    func_96(uParam1, "Paparazzo3A", func_10(iParam0), 0, 14, 2, 305.52f,
            157.19f, 102.94f, 389, "PAPPHOTO", 102, 0, "", 0, 0, 51, 4, 2, 0,
            2359, func_97(iParam0), 0, 1);
    break;

  case 50:
    func_96(uParam1, "Paparazzo3B", func_10(iParam0), 0, 14, 2, 1040.96f,
            -534.42f, 60.17f, 389, "", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 51:
    func_96(uParam1, "Paparazzo4", func_10(iParam0), 0, 14, 4, -484.2f, 229.68f,
            82.21f, 389, "", -1, 8, "", 0, 1, -1, 4, 2, 0, 2359,
            func_97(iParam0), 0, 0);
    break;

  case 52:
    func_96(uParam1, "Rampage1", func_10(iParam0), 0, 15, 4, 908f, 3643.7f,
            32.2f, 66, "", -1, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_97(iParam0),
            0, 0);
    break;

  case 54:
    func_96(uParam1, "Rampage3", func_10(iParam0), 0, 15, 4, 465.1f, -1849.3f,
            27.8f, 84, "", -1, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_97(iParam0),
            1, 0);
    break;

  case 55:
    func_96(uParam1, "Rampage4", func_10(iParam0), 0, 15, 4, -161f, -1669.7f,
            33f, 84, "", -1, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_97(iParam0),
            1, 0);
    break;

  case 56:
    func_96(uParam1, "Rampage5", func_10(iParam0), 0, 15, 4, -1298.2f, 2504.14f,
            21.09f, 84, "", -1, 0, "", 0, 0, 53, 4, 4, 0, 2359,
            func_97(iParam0), 0, 0);
    break;

  case 53:
    func_96(uParam1, "Rampage2", func_10(iParam0), 0, 15, 4, 1181.5f, -400.1f,
            67.5f, 84, "", -1, 0, "rampage_controller", 0, 0, -1, 4, 4, 0, 2359,
            func_97(iParam0), 1, 0);
    break;

  case 57:
    func_96(uParam1, "TheLastOne", func_10(iParam0), 0, 16, 4, -1298.98f,
            4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, -1, 4, 2, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 58:
    func_96(uParam1, "Tonya1", func_10(iParam0), 0, 17, 4, -14.39f, -1472.69f,
            29.58f, 66, "AM_H_RCFS", -1, 0, "ambient_TonyaCall", 24, 1, 59, 4,
            2, 0, 2359, func_97(iParam0), 0, 1);
    break;

  case 59:
    func_96(uParam1, "Tonya2", func_10(iParam0), 0, 17, 4, -14.39f, -1472.69f,
            29.58f, 388, "", -1, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359,
            func_97(iParam0), 0, 1);
    break;

  case 60:
    func_96(uParam1, "Tonya3", func_10(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "",
            -1, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_97(iParam0), 0, 1);
    break;

  case 61:
    func_96(uParam1, "Tonya4", func_10(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "",
            -1, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_97(iParam0), 0, 1);
    break;

  case 62:
    func_96(uParam1, "Tonya5", func_10(iParam0), 0, 17, 4, -14.39f, -1472.69f,
...
void func_98(int iParam0) {
  ...
  func_99(iParam0);
  iLocal_248 = system::start_new_script(sVar0, 20500);
...
bool func_120(int iParam0) {
  if (func_122() && Global_91491.f_11 == 6 &&
      iParam0 == func_121(&Global_91491.f_3, 0)) {
    return true;
  }
  return false;
}
...
// Position - 0x902D
bool func_123(int iParam0) { return func_124(iParam0, Global_35781); }
...
// Position - 0x9247
int func_126() { return func_121(script::get_this_script_name(), 0); }
      ...
      if (!ped::is_ped_injured(player::player_ped_id())) {
        ...
        case 0:
          if (!player::is_player_ready_for_cutscene(player::player_id()) ||
              ...
              ped::is_ped_in_combat(player::player_ped_id(), 0) || func_140() ||
              Global_100747 || Global_25192 || func_139() || func_138(8, -1) ||
              func_79() || func_137() || func_136() || func_135() ||
        ...
        case 1:
          if (player::is_player_being_arrested(player::player_id(), 1) ||
              func_140() || Global_25192 || func_139() || func_138(8, -1) ||
              func_136() || func_79() || func_137() || func_135() ||
              G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
            return false;
          }
          break;
        ...
        case 4:
          if (func_140() ||
              ...
              func_138(8, -1) || func_135() || func_134() ||
              G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
            return false;
          }
          break;
        ...
        case 5:
          if (func_138(8, -1) || func_79() || func_137() || func_134() ||
              func_133()) {
            return false;
          }
        ...
        case 6:
          if (entity::does_entity_exist(player::player_ped_id())) {
            if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
                ...
                ped::is_ped_falling(player::player_ped_id()) ||
                player::is_player_being_arrested(player::player_id(), 1) ||
                player::is_player_climbing(player::player_id()) || func_140() ||
                Global_25192 || func_139() || func_138(8, -1) || func_137() ||
                func_136() || func_135() ||
                G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
              return false;
            }
        ...
        case 7:
          if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
              ...
              ped::is_ped_falling(player::player_ped_id()) ||
              player::is_player_being_arrested(player::player_id(), 1) ||
              func_140() || func_137() || Global_100747 || Global_25192 ||
              func_139() || Global_36912 || func_138(8, -1) || func_136() ||
              func_134() || func_135() ||
              G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
            return false;
          }
        ...
        case 8:
          if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
              ...
              player::is_player_climbing(player::player_id()) || func_140() ||
              Global_100747 || Global_25192 || func_139() || func_138(8, -1) ||
              func_136() || func_134() || func_79() || func_137() ||
              func_135()) {
            return false;
          }
          break;
...
void func_143() {
  ...
  case 0:
    if (!func_157()) {
      if (func_142(103)) {
        func_156(&uLocal_81, 1, player::player_ped_id(), "FRANKLIN", 0, 1);
...
// Position - 0x9E48
int func_146(var *uParam0, int iParam1, char *sParam2, char *sParam3,
  ...
  Global_2621441 = 0;
  return func_147(sParam3, iParam4, iParam8);
}
...
// Position - 0xA449
void func_155(var *uParam0, var uParam1, char *sParam2, int iParam3,
              int iParam4, int iParam5) {
