		...
		case 0:
			if (func_222(1, 1093140480, 0)) {
				...
				if (!object::_does_door_exist(1736361794)) {
					object::add_door_to_system(1736361794, joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f, 1,
											   1, 0);
				}
				if (object::_does_door_exist(1736361794)) {
...
void func_206(int iParam0, int iParam1, int iParam2, int iParam3) {
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_210(player::player_id()) &&
				!func_208(player::player_id(), 0) && !func_207()) {
...
// Position - 0x25D11
bool func_207() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x25DFC
bool func_211() { return gameplay::is_bit_set(Global_2359301, 3); }
...
// Position - 0x25E8A
int func_215(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	bool bVar0;
	float fVar1;
...
// Position - 0x25EE5
void func_216(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8,
...
// Position - 0x260A3
Vector3 func_217(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }
...
// Position - 0x26167
bool func_222(int iParam0, float fParam1, int iParam2) {
	int iVar0;
...
// Position - 0x2636B
int func_229(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
struct<2> func_234(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_242(iParam0)}; break;
	...
	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_241(iParam2)}; break;

		case 8: Var0 = {func_240(iParam2)}; break;

		case 7: Var0 = {func_239(iParam2)}; break;

		case 10: Var0 = {func_238(iParam2)}; break;

		case 5: Var0 = {func_237(iParam2)}; break;

		case 4: Var0 = {func_236(iParam2)}; break;

		default: StringCopy(&Var0, func_235(iVar2), 8); break;
		}
		break;
...
//Position - 0x26BF7
bool func_243(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (!func_246(0) || G_TextMessageConfig || Global_69960 == 1 || !cam::is_screen_faded_in()) {
		return false;
	}
	switch (Global_69956) {
	case 0:
...
// Position - 0x26DB4
bool func_247(int iParam0) { return func_248(iParam0, Global_35781); }
...
// Position - 0x26FE6
void func_251(var *uParam0, bool bParam1) { func_252(&uParam0->f_41, bParam1); }
...
// Position - 0x2709C
void func_255(var *uParam0, bool bParam1) { func_256(&uParam0->f_35, bParam1); }
...
// Position - 0x271E9
void func_260(var *uParam0, int iParam1) { func_261(&uParam0->f_28, iParam1); }
...
// Position - 0x27464
bool func_267(char *sParam0, int iParam1, int iParam2) {
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
// Position - 0x2781A
void func_277() { Global_17151.f_5 = 1; }

// Position - 0x27828
void func_278() { Global_17151.f_5 = 0; }
