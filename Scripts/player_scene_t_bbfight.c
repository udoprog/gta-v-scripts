...
float fLocal_298 = 0f;
vector3 vLocal_299[2] = {{0f, 0f, 0f}, {0f, 0f, 0f}};
float fLocal_306[2] = {0f, 0f};
vector3 vLocal_309[1] = {{0f, 0f, 0f}};
...
bool func_2() {
			...
			if (!gameplay::is_string_null_or_empty(&Local_493)) {
				if (!iLocal_498) {
					if (fVar0 < fLocal_497) {
						...
						if (!gameplay::is_string_null_or_empty(&Local_485)) {
							func_15(&uLocal_110, func_16(), player::player_ped_id(), &Local_485, 0, 1);
						}
	...
	if (system::vdist(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_295) > 100f) {
		return true;
	}
	return false;
}
		...
		if (!ped::is_ped_injured((*iParam0)[iVar0])) {
			...
			case 100:
				if (ped::is_synchronized_scene_running(Global_89153)) {
					ai::task_synchronized_scene((*iParam0)[iVar0], Global_89153, &cLocal_367, &Local_383[iVar0 /*16*/],
			...
			case 101:
				if (ped::is_synchronized_scene_running(Global_89154)) {
					ai::task_synchronized_scene((*iParam0)[iVar0], Global_89154, &cLocal_367, &Local_416[iVar0 /*16*/],
												8f, -1000f, 0, 0, 1148846080, 0);
					streaming::request_anim_dict(&cLocal_367);
					(*iParam1)[iVar0] = 102;
				}
				break;

			case 102:
				if (streaming::has_anim_dict_loaded(&cLocal_367) &&
					entity::is_entity_playing_anim((*iParam0)[iVar0], &cLocal_367, &Local_416[iVar0 /*16*/], 2)) {
					sVar1 = "victim_fall";
					fVar2 = -1f;
					fVar3 = -1f;
					if (entity::find_anim_event_phase(&cLocal_367, &Local_416[iVar0 /*16*/], sVar1, &fVar2, &fVar3)) {
						if (fVar2 < ped::get_synchronized_scene_phase(Global_89154)) {
							if (!ped::is_ped_running_ragdoll_task((*iParam0)[iVar0])) {
								ai::clear_ped_tasks((*iParam0)[iVar0]);
								ped::set_ped_to_ragdoll_with_fall((*iParam0)[iVar0], 1000, 3000, 4,
																  entity::get_entity_forward_vector((*iParam0)[iVar0]),
					...
					if (iLocal_109 == 165) {
						if (!gameplay::is_string_null_or_empty(&Local_449[iVar0 /*16*/])) {
							sVar4 = "AMB@WORLD_HUMAN_CLIPBOARD@MALE@BASE";
							streaming::request_anim_dict(sVar4);
							if (0.95f < ped::get_synchronized_scene_phase(Global_89154)) {
								if (streaming::has_anim_dict_loaded(sVar4)) {
									ai::task_start_scenario_in_place((*iParam0)[iVar0], &Local_449[iVar0 /*16*/], 0, 0);
					...
					if (iLocal_109 == 259) {
						if (0.95f < ped::get_synchronized_scene_phase(Global_89154)) {
							ai::task_put_ped_directly_into_melee((*iParam0)[iVar0], player::player_ped_id(), 0f, -1f,
																 0f, 0);
							ped::_0x2208438012482A1A((*iParam0)[iVar0], 0, 0);
							system::wait(0);
							(*iParam1)[iVar0] = 10;
					...
					if (iLocal_109 == 246 && iVar0 == 0) {
						if (0.95f < ped::get_synchronized_scene_phase(Global_89154)) {
							...
							system::wait(0);
							if (!ped::is_ped_injured((*iParam0)[iVar0])) {
								ai::task_put_ped_directly_into_melee(player::player_ped_id(), (*iParam0)[iVar0], 0f,
																	 -1f, 0f, 0);
								system::wait(0);
							}
							(*iParam1)[iVar0] = 10;
			...
			case 200:
				if (ped::is_synchronized_scene_running(Global_89153)) {
					ai::task_play_anim((*iParam0)[iVar0], &cLocal_367, &Local_383[iVar0 /*16*/], 8f, -1000f, -1, 0, 0,
									   0, 0, 0);
					(*iParam1)[iVar0] = 201;
				}
				else if (ped::is_synchronized_scene_running(Global_89154)) {
			...
			case 201:
				if (ped::is_synchronized_scene_running(Global_89154)) {
					ai::task_play_anim((*iParam0)[iVar0], &cLocal_367, &Local_416[iVar0 /*16*/], 8f, -1.5f, -1, 32768,
									   0, 0, 0, 0);
			...
			case 202:
				if (streaming::has_anim_dict_loaded(&cLocal_367) &&
					entity::is_entity_playing_anim((*iParam0)[iVar0], &cLocal_367, &Local_416[iVar0 /*16*/], 1)) {
					sVar5 = "victim_fall";
					fVar6 = -1f;
					fVar7 = -1f;
					if (entity::find_anim_event_phase(&cLocal_367, &Local_416[iVar0 /*16*/], sVar5, &fVar6, &fVar7)) {
						if (fVar6 < entity::get_entity_anim_current_time((*iParam0)[iVar0], &cLocal_367,
																		 &Local_416[iVar0 /*16*/])) {
							if (!ped::is_ped_running_ragdoll_task((*iParam0)[iVar0])) {
								ai::clear_ped_tasks((*iParam0)[iVar0]);
								ped::set_ped_to_ragdoll_with_fall((*iParam0)[iVar0], 1000, 3000, 4,
					...
					if (iLocal_109 == 108 || iLocal_109 == 109) {
						if (entity::get_entity_anim_current_time((*iParam0)[iVar0], &cLocal_367,
																 &Local_416[iVar0 /*16*/]) > 0.954f) {
							if (iLocal_109 == 108) {
								vLocal_299[iVar0 /*3*/] = {Vector(224.5948f, 1213.466f, 199.6328f) - vLocal_295};
							}
							else if (iLocal_109 == 109) {
								vLocal_299[iVar0 /*3*/] = {Vector(5.9049f, -717.1404f, -1908.287f) - vLocal_295};
							}
							ai::task_follow_nav_mesh_to_coord((*iParam0)[iVar0], vLocal_295 + vLocal_299[iVar0 /*3*/],
			...
			case 0:
				...
				vVar11 = {vLocal_295 + vLocal_299[iVar0 /*3*/] + Vector(1f, 0f, 0f)};
			...
			case 1:
				...
				vVar21 = {vLocal_295 + vLocal_299[iVar0 /*3*/] + Vector(1f, 0f, 0f)};
				...
				if (ai::get_script_task_status((*iParam0)[iVar0], 713668775) != 1 &&
					ai::get_script_task_status((*iParam0)[iVar0], 713668775) != 0) {
			...
			case 10:
				if (ai::get_script_task_status((*iParam0)[iVar0], -71340211) == 7 ||
					ai::get_script_task_status((*iParam0)[iVar0], -71340211) == 1) {
					iVar25 = 0;
			...
			case 11:
				if (system::vdist(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_295) > 50f &&
					system::vdist(entity::get_entity_coords(player::player_ped_id(), 1),
								  entity::get_entity_coords((*iParam0)[iVar0], 1)) > 50f) {
					ped::set_relationship_between_groups(2, iLocal_285, 1862763509);
					ped::set_relationship_between_groups(2, 1862763509, iLocal_285);
					ai::clear_ped_tasks((*iParam0)[iVar0]);
					ai::task_follow_nav_mesh_to_coord((*iParam0)[iVar0], vLocal_295 + vLocal_299[iVar0 /*3*/], 0.5f, -1,
			...
			case 5:
				if (func_26((*iParam0)[iVar0])) {
					if (entity::does_entity_exist(uLocal_286[iVar0])) {
						object::delete_object(&uLocal_286[iVar0]);
						entity::set_object_as_no_longer_needed(&uLocal_286[iVar0]);
					}
					ai::clear_ped_tasks((*iParam0)[iVar0]);
				...
				if (!ai::ped_has_use_scenario_task((*iParam0)[iVar0])) {
					if (gameplay::are_strings_equal(&Local_449[iVar0 /*16*/], "any")) {
						if (ai::does_scenario_exist_in_area(vLocal_295 + vLocal_299[iVar0 /*3*/], 20f, 1)) {
							ai::task_use_nearest_scenario_to_coord((*iParam0)[iVar0],
																   vLocal_295 + vLocal_299[iVar0 /*3*/], 20f, 0);
							iLocal_482[iVar0] = gameplay::get_game_timer();
						}
					}
					else {
						iVar26 = 1;
						...
						ai::task_start_scenario_in_place((*iParam0)[iVar0], &Local_449[iVar0 /*16*/], 0, iVar26);
						iLocal_482[iVar0] = gameplay::get_game_timer();
					}
				}
				else if (entity::does_entity_exist(uLocal_286[iVar0])) {
					if (iLocal_482[iVar0] > 0) {
						if (gameplay::get_game_timer() > iLocal_482[iVar0] + 1000) {
							object::delete_object(&uLocal_286[iVar0]);
							entity::set_object_as_no_longer_needed(&uLocal_286[iVar0]);
						}
					}
	...
	while (iVar0 < 263) {
		if (gameplay::is_bit_set(Global_25501[iVar0 /*23*/].f_11, 0)) {
			if (Global_25501[iVar0 /*23*/].f_16 == 9) {
				...
				if (gameplay::is_bit_set(Global_25501[iVar0 /*23*/].f_11, 19)) {
					iVar5 = 3;
					iVar4 = 0;
					while (iVar4 < iVar5) {
						vVar6 = {func_25(iVar0, iVar4)};
						if (!func_24(vVar6)) {
							if (system::vdist2(entity::get_entity_coords(iParam0, 1), vVar6) < fParam1 * fParam1) {
								return true;
							}
						}
						iVar4++;
...
bool func_26(int iParam0) {
	...
	iVar1 = 0;
	while (iVar1 < 1) {
		if (!func_28(vLocal_313[iVar1 /*3*/], 0f, 0f, 0f, 0)) {
			if (func_27(player::player_ped_id(), vLocal_295 + vLocal_309[iVar1 /*3*/], vLocal_313[iVar1 /*3*/],
						fLocal_298 + fLocal_317[iVar1], 0, 1, 0)) {
				fVar2 = 50f;
...
// Position - 0x17B3
bool func_27(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10) {
	vector3 vVar0;
	vector3 vVar3;
	...
	if (entity::is_entity_in_angled_area(iParam0, vVar0, vVar3, vParam4.y * 2f, iParam8, iParam9, iParam10)) {
		return true;
	}
	return false;
}
...
// Position - 0x1837
bool func_28(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
bool func_29(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_36(player::player_ped_id()) && func_36(iParam0)) {
		...
		if (!iParam2) {
			if (func_35(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_30(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
// Position - 0x1979
bool func_30(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
// Position - 0x1B1A
bool func_32(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	if (iParam5 == 0) {
		...
		vVar3 = {func_34(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
...
// Position - 0x1C08
bool func_35(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
// Position - 0x1CE6
int func_39(int iParam0) { return Global_101700.f_23863[iParam0 /*4*/]; }
...
// Position - 0x1ECE
int func_43(var uParam0) { return uParam0; }

// Position - 0x1ED8
bool func_44(var uParam0, int iParam1) { return (uParam0 & iParam1) != 0; }
...
// Position - 0x1F6D
void func_47() { func_48(Global_91279 - 1); }

// Position - 0x1F7F
void func_48(int iParam0) { Global_91279 = iParam0; }

// Position - 0x1F8D
void func_49() { func_48(0); }
...
void func_50() {
	...
	while (!iVar2 && iVar1 < 400) {
		...
		while (iVar0 < iLocal_276) {
			if (iLocal_282[iVar0] != 0) {
				streaming::request_model(iLocal_282[iVar0]);
				if (!streaming::has_model_loaded(iLocal_282[iVar0])) {
					iVar2 = 0;
					streaming::request_model(iLocal_282[iVar0]);
				}
			}
			if (iLocal_289[iVar0] != 0) {
				streaming::request_model(iLocal_289[iVar0]);
				if (!streaming::has_model_loaded(iLocal_289[iVar0])) {
					iVar2 = 0;
					streaming::request_model(iLocal_289[iVar0]);
				}
			}
	...
	ped::add_relationship_group("FIGHTERS", &iLocal_285);
	iVar0 = 0;
	while (iVar0 < iLocal_276) {
		if (iLocal_282[iVar0] != 0) {
			iLocal_276[iVar0] = ped::create_ped(26, iLocal_282[iVar0], vLocal_295 + vLocal_299[iVar0 /*3*/], 0f, 1, 1);
			entity::set_entity_heading(iLocal_276[iVar0], fLocal_298 + fLocal_306[iVar0]);
			...
			if (iLocal_109 == 285) {
				...
				entity::set_entity_health(iLocal_276[iVar0], 105);
			}
		}
		if (iLocal_289[iVar0] != 0) {
			uLocal_286[iVar0] = object::create_object(iLocal_289[iVar0], vLocal_295 + vLocal_299[iVar0 /*3*/], 1, 1, 0);
			entity::set_entity_heading(uLocal_286[iVar0], fLocal_298 + fLocal_306[iVar0]);
			entity::attach_entity_to_entity(uLocal_286[iVar0], iLocal_276[iVar0],
											ped::get_ped_bone_index(iLocal_276[iVar0], iLocal_292[iVar0]), 0f, 0f, 0f,
...
void func_51() {
	...
	func_55(iLocal_109, &vLocal_295, &fLocal_298, &cVar0);
	func_53(iLocal_109, &sLocal_319, &cLocal_335, &cLocal_351, &uVar8, &uVar9);
	vLocal_309[0 /*3*/] = {0f, 0f, 0f};
	vLocal_313[0 /*3*/] = {0f, 0f, 0f};
	fLocal_317[0] = 0f;
	switch (iLocal_109) {
	case 108:
		vLocal_299[0 /*3*/] = {-0.88f, 0.8016f, -1f};
		fLocal_306[0] = -150f;
	...
	case 109:
		vLocal_299[0 /*3*/] = {-1.1832f, -0.3745f, -1f};
		fLocal_306[0] = -147f;
	...
	case 157:
		vLocal_299[0 /*3*/] = {-0.8296f, 1.1365f, -0.9999f};
	...
	case 166:
		vLocal_299[0 /*3*/] = {Vector(36.037f, -476.663f, -1050.724f) - vLocal_295};
		fLocal_306[0] = gameplay::get_random_float_in_range(-180f, 180f);
	...
	case 165:
		vLocal_299[0 /*3*/] = {0.1366f, -1.2192f, -1f};
	...
	case 246:
		vLocal_299[0 /*3*/] = {Vector(4.6f, -1570.924f, -1194.77f) - vLocal_295 + Vector(-1f, 0f, 0f)};
		fLocal_306[0] = 0.61f - fLocal_298;
		vLocal_299[1 /*3*/] = {-1.3617f, 6.7273f, -1f};
	...
	case 256:
		vLocal_299[0 /*3*/] = {-4.7f, -0.2f, 0f};
		fLocal_306[0] = 143f;
		iLocal_282[0] = joaat("a_m_m_business_01");
		iLocal_279[0] = 0;
		iLocal_279[1] = 0;
		vLocal_309[0 /*3*/] = {-3.65f, -1.2f, 1.5f};
		vLocal_313[0 /*3*/] = {2.5f, 1.25f, 2f};
		fLocal_317[0] = -12f;
		StringCopy(&Local_449[0 /*16*/], "WORLD_HUMAN_GUARD_STAND", 64);
		break;

	case 257:
		vLocal_299[0 /*3*/] = {Vector(7.1578f, -978.6192f, -1666.374f) - vLocal_295};
		fLocal_306[0] = -149.0587f;
		iLocal_282[0] = joaat("a_m_m_business_01");
		iLocal_279[0] = 0;
		iLocal_279[1] = 0;
		vLocal_309[0 /*3*/] = {0.4f, -4.1f, 1.8f};
		vLocal_313[0 /*3*/] = {2.5f, 1.5f, 2f};
		fLocal_317[0] = 57f;
		StringCopy(&Local_449[0 /*16*/], "WORLD_HUMAN_GUARD_STAND", 64);
		break;

	case 258:
		vLocal_299[0 /*3*/] = {1.5f, 5.7035f, 0f};
		vLocal_299[1 /*3*/] = {4.2393f, 4.1781f, 0f};
		fLocal_306[0] = 145.8f;
		...
		iLocal_279[0] = 0;
		iLocal_279[1] = 0;
		vLocal_309[0 /*3*/] = {2.1f, 4.3f, 2f};
		vLocal_313[0 /*3*/] = {2.5f, 1.75f, 2f};
		fLocal_317[0] = 33f;
		StringCopy(&Local_449[0 /*16*/], "WORLD_HUMAN_GUARD_STAND", 64);
	...
	case 259:
		vLocal_299[0 /*3*/] = {gameplay::get_random_float_in_range(-10f, 10f),
							   gameplay::get_random_float_in_range(-10f, 10f), 0f};
		vLocal_299[1 /*3*/] = {gameplay::get_random_float_in_range(-10f, 10f),
							   gameplay::get_random_float_in_range(-10f, 10f), 0f};
		fLocal_306[0] = gameplay::get_random_float_in_range(-180f, 180f);
		fLocal_306[1] = gameplay::get_random_float_in_range(-180f, 180f);
	...
	case 285:
		vLocal_299[0 /*3*/] = {-3.264f, -3.7895f, 14.1815f};
		fLocal_306[0] = 0f;
	...
	case 260:
		vLocal_299[0 /*3*/] = {0.219f, 5.8091f, 0.6f};
		vLocal_299[1 /*3*/] = {2.4f, 4.6336f, 0.6f};
		...
		iLocal_279[0] = 0;
		iLocal_279[1] = 0;
		vLocal_309[0 /*3*/] = {4f, 8f, 2f};
		vLocal_313[0 /*3*/] = {10.5f, 5.5f, 2f};
		fLocal_317[0] = 0f;
		break;

	case 261:
		vLocal_299[0 /*3*/] = {3.2998f, -1.8338f, 0.1366f};
		vLocal_299[1 /*3*/] = {2.0737f, -3.6041f, 0.1348f};
		...
		vLocal_309[0 /*3*/] = {3f, -3f, 2f};
		vLocal_313[0 /*3*/] = {4.5f, 2.5f, 2f};
		fLocal_317[0] = 9f;
		break;

	case 239:
		vLocal_299[0 /*3*/] = {Vector(113.05f, 354.39f, -52.2f) - vLocal_295 + Vector(-1f, 0f, 0f)};
		vLocal_299[1 /*3*/] = {Vector(113.05f, 354.08f, -53.18f) - vLocal_295 + Vector(-1f, 0f, 0f)};
		fLocal_306[0] = -100f;
		fLocal_306[1] = -100f;
		iLocal_282[0] = joaat("a_m_m_business_01");
		iLocal_282[1] = joaat("a_m_m_business_01");
		vLocal_309[0 /*3*/] = {1.6187f, -0.82f, 1f};
		vLocal_313[0 /*3*/] = {2.5f + 0.5f, 8f, 2f};
		fLocal_317[0] = 6f;
		iLocal_279[0] = 100;
		iLocal_279[1] = 100;
	...
	default:
		...
		vLocal_309[0 /*3*/] = {gameplay::get_random_float_in_range(-10f, 10f),
							   gameplay::get_random_float_in_range(-10f, 10f), 0f};
		vLocal_313[0 /*3*/] = {1f, 1f, 1f};
		fLocal_317[0] = gameplay::get_random_float_in_range(-180f, 180f);
		break;
	}
}
...
int func_53(int iParam0, char* sParam1, char* sParam2, char* sParam3, var* uParam4, var* uParam5)
{
	...
	*uParam5 = 0;
	...
	case 305: func_54(iParam0, sParam1, sParam2, sParam3); return 1;
...
// Position - 0x4603
bool func_57(int iParam0, float *fParam1, char *sParam2) {
	vector3 vVar0;
	int iVar3;
	var *uVar4;
	float fVar7;
	...
	case 11:
		if (func_60(iParam0, &vVar0, fParam1)) {
	...
	case 9: return func_57(8, fParam1, sParam2);

	case 10: return func_57(8, fParam1, sParam2);
	...
	case 23: return func_57(208, fParam1, sParam2);
	...
	case 224: return func_57(222, fParam1, sParam2);
	...
	case 294: return func_57(293, fParam1, sParam2);

	case 295: return func_57(292, fParam1, sParam2);
	...
	case 300: return func_57(303, fParam1, sParam2);

	case 301: return func_57(303, fParam1, sParam2);

	case 302: return func_57(303, fParam1, sParam2);
...
bool func_58(int iParam0, int iParam1, var *uParam2, var *uParam3) {
	...
	case 46: return func_58(iParam0, 26, uParam2, uParam3);
...
// Position - 0x8980
bool func_60(int iParam0, var *uParam1, float *fParam2) {
	switch (iParam0) {
	case 11:
	...
	case 9: return func_60(8, uParam1, fParam2);

	case 10: return func_60(8, uParam1, fParam2);
...
void func_62() {
	...
	while (iVar0 < iLocal_282) {
		if (iLocal_282[iVar0] != 0) {
			streaming::set_model_as_no_longer_needed(iLocal_282[iVar0]);
		}
		iVar0++;
	}
	ped::remove_relationship_group(iLocal_285);
