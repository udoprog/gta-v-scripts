...
bool func_2() {
	...
	if (!ped::is_ped_injured(Global_91277)) {
		if (entity::does_entity_exist(iLocal_267)) {
			if (entity::is_entity_playing_anim(Global_91277, &sLocal_273, &cLocal_305, 3)) {
				if (fire::is_entity_on_fire(Global_91277)) {
					ai::stop_anim_playback(Global_91277, 0, 0);
					ai::clear_ped_tasks(Global_91277);
					return false;
				}
				fVar0 = ped::get_synchronized_scene_phase(iLocal_321);
				if (!iLocal_266) {
				...
				if (fVar0 < 0.2812f) {
					if (iLocal_322 != 0) {
						graphics::stop_particle_fx_looped(iLocal_322, 0);
						iLocal_322 = 0;
					}
				}
				else if (fVar0 < 0.4778f) {
					if (iLocal_322 == 0) {
						iLocal_322 = graphics::start_particle_fx_looped_on_entity(
							"scr_lamgraff_paint_spray", iLocal_267, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
						graphics::set_particle_fx_looped_colour(iLocal_322, fLocal_323, fLocal_324, fLocal_325, 0);
					}
				}
...
bool func_20() {
	...
	if (!ped::is_ped_injured(Global_91277)) {
		if (entity::does_entity_exist(iLocal_267)) {
			if (entity::is_entity_playing_anim(Global_91277, &sLocal_273, &cLocal_289, 3)) {
				if (fire::is_entity_on_fire(Global_91277)) {
					ai::stop_anim_playback(Global_91277, 0, 0);
					ai::clear_ped_tasks(Global_91277);
					return false;
				...
				if (fVar0 < 0.3812f) {
					...
					if (!ped::is_synchronized_scene_running(iLocal_321)) {
						iLocal_321 = ped::create_synchronized_scene(vLocal_269, 0f, 0f, fLocal_272, 2);
						ped::set_synchronized_scene_looped(iLocal_321, 1);
					}
					ai::task_synchronized_scene(Global_91277, iLocal_321, &sLocal_273, &cLocal_305, 8f, -8f, 257, 0, 8f,
												0);
					return true;
				}
			}
				...
				if (func_3(&uLocal_100, "PRSAUD", "FRAS_IG_7x", 3, 0, 0, 0)) {
					ai::clear_ped_tasks(Global_91277);
					ped::_reset_ped_ragdoll_blocking_flags(Global_91277, 16);
					if (!ped::is_synchronized_scene_running(iLocal_321)) {
						iLocal_321 = ped::create_synchronized_scene(vLocal_269, 0f, 0f, fLocal_272, 2);
						ped::set_synchronized_scene_looped(iLocal_321, 1);
					}
...
// Position - 0xE2A
int func_24(var uParam0) { return uParam0; }
...
// Position - 0xEC9
void func_28() { func_29(Global_91279 - 1); }

// Position - 0xEDB
void func_29(int iParam0) { Global_91279 = iParam0; }

// Position - 0xEE9
void func_30() { func_29(0); }

// Position - 0xEF6
void func_31() {
	streaming::request_model(iLocal_268);
	streaming::request_ptfx_asset();
	while (!entity::does_entity_exist(Global_91277) || !streaming::has_model_loaded(iLocal_268)) {
		system::wait(0);
	}
	entity::set_entity_as_mission_entity(Global_91277, 1, 1);
	if (entity::does_entity_exist(Global_91277)) {
		if (!ped::is_ped_injured(Global_91277)) {
			ai::task_stand_still(Global_91277, -1);
		}
		ped::set_ped_relationship_group_hash(Global_91277, 1862763509);
	}
	entity::set_entity_as_mission_entity(Global_91277, 1, 1);
	ped::set_ped_config_flag(Global_91277, 132, 1);
	ped::_set_ped_ragdoll_blocking_flags(Global_91277, 16);
	func_33(&Global_91277, Global_86828);
	func_32(&uLocal_100, 1, player::player_ped_id(), "FRANKLIN", 0, 1);
	iLocal_267 = object::create_object(iLocal_268, entity::get_entity_coords(Global_91277, 1), 1, 1, 0);
	entity::attach_entity_to_entity(iLocal_267, Global_91277, ped::get_ped_bone_index(Global_91277, 28422), 0f, 0f, 0f,
...
void func_34() {
	...
	func_40(iLocal_99, &vLocal_269, &fLocal_272, &cVar0);
...
int func_37(struct<109> Param0, var *uParam109) {
	...
	case 80:
		*uParam109 = {Param0};
		uParam109->f_109 = 1785177548;
		uParam109->f_110 = 1785177548;
		func_38(uParam109, 17, -2017877118, -2017877118,
	...
	case 155:
		*uParam109 = {Param0};
		uParam109->f_109 = 1785177548;
		uParam109->f_110 = 1785177548;
		func_38(uParam109, 17, 1785177548, 1785177548, gameplay::get_random_float_in_range(-5f, 5f),
	...
	case 158:
		*uParam109 = {Param0};
		uParam109->f_109 = 1785177548;
		uParam109->f_110 = 1785177548;
		func_38(uParam109, 144, 1785177548, 1785177548, gameplay::get_random_float_in_range(-5f, 5f),
				gameplay::get_random_float_in_range(-5f, 5f), 0f, gameplay::get_random_float_in_range(-180f, 180f));
		uParam109->f_118 = 1;
		return 1;
	...
	case 196:
		*uParam109 = {Param0};
		uParam109->f_109 = 1785177548;
		uParam109->f_110 = 1785177548;
		func_38(uParam109, 43, 1785177548, 1785177548, gameplay::get_random_float_in_range(-5f, 5f),
				gameplay::get_random_float_in_range(-5f, 5f), 0f, gameplay::get_random_float_in_range(-180f, 180f));
		uParam109->f_118 = 1;
		return 1;
...
// Position - 0x4C77
void func_39(var *uParam0) { func_38(uParam0, 145, 1435919172, 1435919172, 0f, 0f, 0f, 0f); }
...
// Position - 0x4F8A
bool func_43(int iParam0, float *fParam1, char *sParam2) {
	vector3 vVar0;
	int iVar3;
	var *uVar4;
	float fVar7;
	...
	case 11:
		if (func_46(iParam0, &vVar0, fParam1)) {
	...
	case 9: return func_43(8, fParam1, sParam2);

	case 10: return func_43(8, fParam1, sParam2);
	...
	case 23: return func_43(208, fParam1, sParam2);
	...
	case 224: return func_43(222, fParam1, sParam2);
	...
	case 294: return func_43(293, fParam1, sParam2);

	case 295: return func_43(292, fParam1, sParam2);
	...
	case 300: return func_43(303, fParam1, sParam2);

	case 301: return func_43(303, fParam1, sParam2);

	case 302: return func_43(303, fParam1, sParam2);
...
// Position - 0x7491
bool func_44(int iParam0, int iParam1, var *uParam2, var *uParam3) {
	switch (iParam1) {
	case 0:
		switch (iParam0) {
		case 0:
	...
	case 46: return func_44(iParam0, 26, uParam2, uParam3);
...
// Position - 0x93FF
bool func_46(int iParam0, var *uParam1, float *fParam2) {
	switch (iParam0) {
	case 11:
	...
	case 9: return func_46(8, uParam1, fParam2);

	case 10: return func_46(8, uParam1, fParam2);
