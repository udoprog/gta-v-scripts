			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						func_163() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						func_163() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5 || LastDispatchedMessageOrCall != -1) {
						return 0;
					}
					break;
				...
				case 4:
					if (func_168() || player::get_player_wanted_level(player::player_id()) > 0 || func_18(8, -1) ||
						func_163() || func_162() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						func_162() || func_163() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
