...
void __EntryFunction__() {
	...
	if (player::has_force_cleanup_occurred(83)) {
		...
		if (Var0 != -1) {
			if (Global_100787[Var0 /*10*/].f_9 != -1) {
				...
				func_266(&Global_100787[Var0 /*10*/].f_9);
			}
		}
		func_250(&Var0, 1);
	}
	if (!func_247(&iVar64, &Var0, vVar61, 1f)) {
		func_246();
	...
	while (true) {
		...
		func_185(Var0);
		func_178(&iLocal_93, &Var0.f_9, vVar61);
		if (Var0 == 44) {
			func_170(&Var0, vVar61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &iLocal_94);
			func_169();
		}
		else if (Var0 == 45) {
			func_170(&Var0, vVar61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &iLocal_95);
			func_167(&Var0);
		}
		if (func_152(&Var0, 0)) {
			if (!func_2(&Var0)) {
...
int func_2(int iParam0) {
	...
	if (!func_151()) {
		while (!func_142(*iParam0)) {
			...
			if (!func_186(iParam0, *iParam0 != 2)) {
				func_267("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() "
						 "[TERMINATING]");
				return 0;
			}
			system::wait(0);
	...
	if (!func_98(iParam0)) {
		func_267("STEP_7_COMMON_LaunchMission - Trying to launch a null script "
				 "string name");
		return 0;
	}
...
int func_98(int iParam0) {
	...
	if (func_128(&iParam0->f_1)) {
		...
		if (cutscene::has_cutscene_loaded()) {
			...
			func_267("Initial cutscene wasn't loaded in time to pass to RC "
					 "mission.");
					...
					if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
						...
						if (func_158(2)) {
							if (func_156(iParam0->f_27)) {
								...
								func_267("ARE_RC_TRIGGER_CONDITIONS_MET: "
		...
		if (*iParam0 == 6) {
			...
			if (ai::get_ped_desired_move_blend_ratio(player::player_ped_id()) >= 2f) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 245.8885f, 371.9034f, 103.9884f,
					...
					if (func_158(2)) {
						if (func_156(iParam0->f_27)) {
							func_155(iParam0->f_27, *iParam0);
							func_267("RC5_IN_ACTIVATION_RANGE: "
			...
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 2728.948f, 4143.44f, 42.29295f, 2722.213f,
				...
				if (func_158(2)) {
					if (func_156(1)) {
						func_155(1, *iParam0);
						func_267("RC_IN_ACTIVATION_RANGE: "
	...
	if (iParam0 == 1) {
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			...
			if (ped::is_ped_in_any_heli(player::player_ped_id()) || ped::is_ped_in_any_plane(player::player_ped_id())) {
				func_267("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for "
						 "plane or helicopter.");
...
void func_167(int iParam0) {
	...
	if (gameplay::get_game_timer() - iLocal_98 > 1250) {
		if (func_112(iParam0->f_28[0]) && !entity::is_entity_on_screen(iParam0->f_28[0])) {
			if (func_112(player::player_ped_id()) && !func_168(player::player_ped_id(), iParam0->f_28[0], 50f, 1)) {
...
void func_169() {
	...
	graphics::_pop_scaleform_movie_function_void();
	ui::set_text_render_id(iLocal_97);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	if (gameplay::get_game_timer() - iLocal_98 > 1250) {
		audio::play_sound_from_coord(iLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0,
									 0);
		iLocal_98 = gameplay::get_game_timer();
	}
}
...
int func_170(int iParam0, vector3 vParam1, char[4] cParam4, char *sParam5, int iParam6, char *sParam7, int *iParam8) {
	...
	if (*iParam8 != 3) {
		if (func_158(2)) {
			if (!func_131()) {
				if (func_112(player::player_ped_id()) && func_112(iParam0->f_28[0]) &&
					func_177(player::player_ped_id(), vParam1, 1) < 20f) {
				...
				if (*iParam8 != 1) {
					if (func_112(player::player_ped_id())) {
						if (func_177(player::player_ped_id(), vParam1, 1) >= 20f) {
			...
			if (func_177(player::player_ped_id(), vParam1, 1) < 20f && *iParam8 == 1) {
...
// Position - 0xB320
void func_171(int iParam0) { Global_16756 = iParam0; }
...
// Position - 0xB49D
float func_177(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
...
// Position - 0xB4D7
void func_178(int *iParam0, char *sParam1, vector3 vParam2) {
	if (player::is_player_playing(player::player_id())) {
		if (!gameplay::is_string_null_or_empty(sParam1)) {
			if (Global_35781 == 17) {
				...
				if (func_177(player::player_ped_id(), vParam2, 1) <= 100f) {
					func_181(iParam0, 1);
				}
			}
			else {
				...
				if (func_177(player::player_ped_id(), vParam2, 1) > 120f) {
					func_183(iParam0);
				}
			}
		}
...
// Position - 0xB6DB
bool func_182() { return Global_89133; }
...
int func_186(int iParam0, int iParam1) {
	...
	if (Global_69702) {
		func_267("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer "
				 "[TERMINATING]");
		return 0;
	}
	func_95(*iParam0, &Var0);
	...
	if (func_217(*iParam0)) {
		...
		func_267("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (iParam0->f_25 == 1) {
	...
	if (*iParam0 == 10) {
		if (fire::is_explosion_in_sphere(-1, iParam0->f_17[0 /*3*/], 8f)) {
			func_267("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission "
					 "trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17) {
		if (!gameplay::is_bit_set(Var0.f_26, func_90())) {
			func_267("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player "
					 "character to launch mission");
			return 0;
		}
	}
	if (func_190(&iParam0->f_48) && iParam1) {
...
void func_187(int iParam0, var *uParam1, int iParam2) {
	...
	if (func_112(iParam0)) {
		...
		case 2:
			if (!func_189(uParam1) || !entity::is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3)) {
				if (func_188(iParam2) && !ped::is_ped_facing_ped(iParam0, player::player_ped_id(), 25f)) {
					ai::task_turn_ped_to_face_entity(iParam0, player::player_ped_id(), 0);
					uParam1->f_3 = 5;
				}
				else if (func_189(uParam1) && uParam1->f_4 == 0 &&
		...
		case 5:
			if (!func_188(iParam2) || ped::is_ped_facing_ped(iParam0, player::player_ped_id(), 10f)) {
				if (func_66(uParam1->f_5, 0f, 0f, 0f, 0)) {
					ai::task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
				}
				else {
	...
	if (func_112(player::player_ped_id())) {
		...
		while (iVar0 <= uParam0->f_28 - 1) {
			if (func_111(uParam0->f_28[iVar0])) {
				...
				switch (*uParam0) {
				case 19: func_216(uParam0->f_28[iVar0]); break;
		...
		while (iVar0 <= iVar1) {
			if (entity::does_entity_exist(uParam0->f_35[iVar0])) {
				if (entity::is_entity_dead(uParam0->f_35[iVar0], 0)) {
					func_267("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (iParam2) {
					if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
						...
						if (*uParam0 == 16) {
							if (func_195(player::player_ped_id(), uParam0->f_35[iVar0])) {
								func_267("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (!ped::is_ped_injured(uParam0->f_28[iVar0])) {
					if (ped::is_ped_sitting_in_any_vehicle(player::player_ped_id())) {
						if (entity::is_entity_touching_entity(player::player_ped_id(), uParam0->f_28[iVar0])) {
							...
							func_267("STEP_5_COMMON_RCfineAndInRange - Random "
					...
					if (func_215(*uParam0)) {
						...
						if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(uParam0->f_28[iVar0], 1), 15f)) {
							...
							func_267("STEP_5_COMMON_RCfineAndInRange - There "
					...
					if (!func_197(*uParam0)) {
						...
						if (player::get_player_wanted_level(player::player_id()) > 0) {
							...
							func_267("STEP_5_COMMON_RCfineAndInRange - Player "
...
// Position - 0xC73A
bool func_199(int iParam0, float fParam1) { return func_200(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_200(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_201(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0xC813
int func_201(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
	...
	if (*iParam0 == 0) {
		vVar1 = {func_202(iParam4, iParam7)};
		*iParam0 =
...
int func_204(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	vVar0 = {func_206(entity::get_entity_coords(iParam1, 1) - entity::get_entity_coords(iParam0, 1))};
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_206(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
						  ped::get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_205(vVar3, vVar0);
...
bool func_210(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_112(player::player_ped_id()) && func_112(iParam0)) {
		...
		if (!iParam2) {
			if (func_214(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_211(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
// Position - 0xCCBC
bool func_211(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
bool func_212(int iParam0, float fParam1) {
	...
	if (gameplay::_0x82FDE6A57EE4EE44(iParam0, joaat("weapon_grenade"), fParam1, &vVar1, &uVar0, 0) ||
		...
		if (func_213(iParam0, vVar1, 90f, 0)) {
			return true;
		}
	}
	return false;
...
// Position - 0xCE5D
bool func_213(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = {func_206(vParam1 - entity::get_entity_coords(iParam0, 1))};
...
// Position - 0xCEEB
bool func_214(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
// Position - 0xD1CE
void func_224() { iLocal_98 = gameplay::get_game_timer(); }
...
void func_225() {
	...
	if (ui::is_named_rendertarget_registered("digiscanner")) {
		iLocal_97 = ui::get_named_rendertarget_render_id("digiscanner");
	}
...
// Position - 0xD458
void func_228(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_229(uParam0);
...
// Position - 0xD534
int func_230(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
...
int func_238(int iParam0) {
	...
	if (Global_69702) {
		func_267("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is "
				 "running [TERMINATING]");
		return 0;
	}
	if (!Global_101700.f_8044 && !func_93(1)) {
		func_267("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not "
				 "active");
		return 0;
	}
	if (!func_239(iParam0)) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_267("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (Global_91491.f_11 == 6) {
		if (Global_91491 < 9) {
			...
			if (gameplay::are_strings_equal(&Global_91491.f_3, sVar0)) {
				func_267("STEP_3_COMMON_CanRCLaunch - Script denied as a "
	...
	if (script::_get_number_of_instances_of_script_with_name_hash(joaat("candidate_controller")) == 0) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_267("STEP_3_COMMON_CanRCLaunch - Script denied as "
...
// Position - 0xDD8B
int func_247(int iParam0, int iParam1, vector3 vParam2, float fParam5) {
	int iVar0;

	if (*iParam0 == 1) {
		if (func_248((*iParam0)[0], vParam2, fParam5, iParam1)) {
			return 1;
		}
	}
	else {
		iVar0 = 0;
		while (iVar0 < *iParam0) {
			if (func_248((*iParam0)[iVar0], vParam2, fParam5, iParam1)) {
				iVar0 = *iParam0;
				return 1;
			}
			iVar0++;
	...
	func_267("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch "
			 "[TERMINATING]");
	return 0;
}

// Position - 0xDDF0
bool func_248(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	int iVar0;
	struct<7> Var1;

	iVar0 = 0;
	func_95(iParam0, &Var1);
	if (func_249(Var1.f_6, vParam1, fParam4, 0)) {
...
// Position - 0xDE6E
bool func_249(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
void func_250(int iParam0, int iParam1) {
	...
	switch (*iParam0) {
	case 44: sVar0 = "SCRAP_1_AMB"; break;

	case 45: sVar0 = "SCRAP_2_AMB"; break;
	}
	func_251(sVar0);
	if (iParam1) {
		func_185(*iParam0);
