...
// Position - 0x1621
void func_17(char *sParam0) { StringCopy(sParam0, "", 64); }
...
void func_51(int iParam0, char *sParam1, char *sParam2) {
	...
	switch (iParam0) {
	case 1: StringCopy(sParam2, "MyBrotherTaughtMe", 64); break;

	case 2: StringCopy(sParam2, "IAmYourTrueSalvation", 64); break;

	case 3: StringCopy(sParam2, "WhatIsParadise", 64); break;

	case 4: StringCopy(sParam2, "ListenToMe", 64); break;

	case 5: StringCopy(sParam2, "MyBrotherTold", 64); break;

	case 6: StringCopy(sParam2, "YouThinkYourHappy", 64); break;

	case 7: StringCopy(sParam2, "ListenListen", 64); break;

	case 8: StringCopy(sParam2, "IgnoreMeAtYourPeril", 64); break;
	}
}
...
// Position - 0x301E
void func_98() { ped::set_ped_prop_index(iLocal_240, 1, 0, 0, 0); }
