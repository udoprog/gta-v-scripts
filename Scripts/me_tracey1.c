...
int iLocal_339 = 0;
int iLocal_340 = 0;
vector3 vLocal_341[9] = {{0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f},
...
vector3 vLocal_438[9] = {{0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f},
						 {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}};
int iLocal_466 = 0;
int iLocal_467 = 0;
int iLocal_468 = 0;
...
void __EntryFunction__() {
	...
	while (true) {
		...
		if (iLocal_92 == 11) {
			...
			func_402();
			switch (iLocal_92) {
			case 0: func_370(); break;

			case 1: func_367(); break;

			case 2: func_354(); break;

			case 3: func_341(); break;

			case 4: func_335(); break;

			case 5: func_318(); break;

			case 6: func_270(); break;

			case 7: func_181(); break;

			case 8: func_34(); break;

			case 9: func_30(); break;
...
// Position - 0xC44
bool func_20(var *uParam0, int iParam1, char *sParam2, char *sParam3, int iParam4, int iParam5, int iParam6,
			 int iParam7) {
...
bool func_24(int iParam0) {
	...
	if (time::get_clock_day_of_month() != iLocal_301) {
		...
		iVar0 -= iLocal_303 + time::get_clock_minutes();
	}
	else {
...
// Position - 0xDC8
void func_25(int iParam0) { ui::clear_this_print(vLocal_341[iParam0 /*3*/].f_2); }
	...
	case 0:
		...
		if (func_179(iLocal_273, 5f, 5, 1056964608, 0, 1, 0)) {
			if (bLocal_533) {
				...
				ai::task_pause(0, 650);
				ai::task_leave_vehicle(0, iLocal_273, 0);
				ai::task_follow_nav_mesh_to_coord(0, -820.1358f, 176.9053f, 70.6086f, 1f, 20000, 1048576000, 0,
												  1193033728);
				ai::task_follow_nav_mesh_to_coord(0, vLocal_530, 1f, 20000, 1048576000, 0, 1193033728);
				ai::close_sequence_task(iVar0);
			}
			ai::clear_ped_tasks(iLocal_289);
			ai::task_perform_sequence(iLocal_289, iVar0);
			...
			gameplay::clear_area_of_vehicles(vLocal_527, 8f, 1, 0, 0, 0, 0);
			if (!bLocal_533) {
				gameplay::clear_area_of_vehicles(-820.2315f, 176.7027f, 70.6122f, 8f, 1, 0, 0, 0, 0);
			}
			if (bLocal_533) {
				iLocal_474 = gameplay::get_game_timer() + 10000;
				iLocal_473 = cam::create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -1315.612f, 402.8979f, 76.0077f,
														 -26.827f, 0f, 175.0236f, 48.4f, 0, 2);
			}
			else {
				iLocal_474 = gameplay::get_game_timer() + 5000;
				iLocal_473 = cam::create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -840.7f, 185.3f, 78.4f, -14f, 0f,
														 -110.4f, 48.4f, 0, 2);
			}
			cam::set_cam_active(iLocal_473, 1);
...
int func_51(int iParam0) {
	...
	if (entity::does_entity_exist(Global_91277)) {
		if (entity::does_entity_exist(Global_91278)) {
			return 0;
		}
...
// Position - 0x1AED
void func_59(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9,
...
// Position - 0x1CE7
Vector3 func_61(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }

// Position - 0x1CFA
int func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	if (iParam1 == 12) {
				...
				if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0)) {
					if (iVar0 == 13) {
						...
						while (iVar1 <= 8) {
							...
							func_82(iParam0, Global_69523[1 /*14*/].f_12, Global_69523[1 /*14*/].f_3,
						...
						if (iParam4 == -1) {
							ped::set_ped_component_variation(iParam0, func_72(iVar0), Global_69523[1 /*14*/].f_3,
															 Global_69523[1 /*14*/].f_4,
															 ped::get_ped_palette_variation(iParam0, func_72(iVar0)));
						}
						else {
							ped::set_ped_component_variation(iParam0, func_72(iVar0), Global_69523[1 /*14*/].f_3,
		...
		if (iParam4 == -1) {
			ped::set_ped_component_variation(iParam0, func_72(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4,
											 ped::get_ped_palette_variation(iParam0, func_72(iParam1)));
		}
		else {
			ped::set_ped_component_variation(iParam0, func_72(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4, iParam4);
...
bool func_63(int iParam0, int iParam1, int *iParam2) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_63 != -99) {
		if (!func_176(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_64,
...
// Position - 0x275F
bool func_68(int iParam0, int iParam1, int iParam2, int iParam3, var *uParam4, var *uParam5) {
	var uVar0;
	int iVar10;
...
bool func_70(int iParam0, int iParam1, int *iParam2, int iParam3) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_60 != -99) {
		if (!func_176(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_61,
...
// Position - 0x32EA
var func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
...
void func_82(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == -1) {
		...
		if (iParam1 == 0) {
			...
			if (func_83(entity::get_entity_model(iParam0), 14, iVar0,
...
struct<10> func_91(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		switch (iParam1) {
		case 31: func_93(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 0: func_93(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_93(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_93(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_93(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_93(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8); break;

		case 5: func_93(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8); break;

		case 6: func_93(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_93(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_93(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_93(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8); break;

		default: func_92(&Var1, iParam0, iParam1, 10); break;
		}
		break;
	...
	case joaat("player_one"):
		...
		case 1: func_93(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8); break;

		case 2: func_93(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8); break;

		case 3: func_93(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_93(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_93(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_93(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_93(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_93(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_92(&Var1, iParam0, iParam1, 9); break;
		}
		break;
	...
	case joaat("player_two"):
		...
		case 0: func_93(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_93(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_93(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_93(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8); break;

		case 4: func_93(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8); break;

		case 5: func_93(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_93(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_93(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_93(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8); break;
	...
	case joaat("mp_m_freemode_01"):
		...
		case 0: func_93(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_93(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_93(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_93(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_93(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_93(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_93(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_93(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_93(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_93(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_93(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_93(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_93(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_93(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 14: func_93(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_93(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_93(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_93(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_93(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_93(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_93(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_93(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_93(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_93(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 24: func_93(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_92(&Var1, iParam0, iParam1, 25); break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 0: func_93(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_93(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_93(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_93(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_93(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_93(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_93(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_93(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_93(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_93(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_93(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_93(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_93(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_93(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8); break;

		case 14: func_93(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_93(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_93(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_93(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_93(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_93(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_93(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_93(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_93(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_93(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8); break;
...
// Position - 0x6017
void func_93(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
struct<17> func_94(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		...
		case 1: func_97(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0); break;

		case 2: func_97(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8); break;

		case 3: func_97(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31); break;

		case 4: func_97(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2); break;

		case 5:
			func_97(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[0], Global_101700.f_2095.f_539.f_200[0], 6, 3, 0,
					0, 0, -99, 0, 0, 3);
			break;

		case 6: func_97(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_97(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 8: func_97(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 9: func_97(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 10: func_97(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4); break;

		case 11: func_97(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5); break;

		case 12: func_97(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31); break;

		case 13: func_97(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 14: func_97(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6); break;

		case 15: func_97(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31); break;

		case 16: func_97(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31); break;

		case 17: func_97(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 18: func_97(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7); break;

		case 19: func_97(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 20: func_97(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 21: func_97(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_97(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 23: func_97(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31); break;

		case 24: func_97(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31); break;

		case 25: func_97(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 26: func_97(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 27: func_97(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 28: func_97(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 29: func_97(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 30: func_97(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 31: func_97(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31); break;

		case 32: func_97(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 33: func_97(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 34: func_97(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31); break;

		case 35: func_97(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 36: func_97(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 37: func_97(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 38: func_97(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 39: func_97(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 40: func_97(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 41: func_97(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_97(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_97(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_97(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 45: func_97(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 46: func_97(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_97(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 48: func_97(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31); break;

		case 49: func_97(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 50: func_97(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9); break;

		case 51: func_97(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 52: func_97(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		default: func_95(&Var1, iParam0, iParam1, 53); break;
		}
		break;

	case joaat("player_one"):
		switch (iParam1) {
		case 0: func_97(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 1: func_97(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 2:
			func_97(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[1], Global_101700.f_2095.f_539.f_200[1], 17, 2,
					26, 0, 0, -99, 0, 45, 31);
			break;

		case 3: func_97(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1); break;

		case 4: func_97(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2); break;

		case 5: func_97(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 6: func_97(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_97(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3); break;

		case 8: func_97(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5); break;

		case 9: func_97(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 10: func_97(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 11: func_97(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 12: func_97(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 13: func_97(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 14: func_97(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 15: func_97(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 16: func_97(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 17: func_97(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 18: func_97(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31); break;

		case 19: func_97(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 20: func_97(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 21: func_97(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4); break;

		case 22: func_97(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31); break;

		case 23: func_97(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31); break;

		case 24: func_97(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31); break;

		case 25: func_97(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31); break;

		case 26: func_97(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31); break;

		case 27: func_97(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31); break;

		case 28: func_97(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31); break;

		case 29: func_97(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31); break;

		case 30: func_97(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31); break;

		case 31: func_97(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31); break;

		case 32: func_97(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31); break;

		case 33: func_97(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31); break;

		case 34: func_97(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31); break;

		case 35: func_97(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31); break;

		case 36: func_97(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31); break;

		case 37: func_97(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31); break;

		case 38: func_97(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 39: func_97(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 40: func_97(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 41: func_97(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 42: func_97(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31); break;

		case 43: func_97(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6); break;

		case 44: func_97(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 45: func_97(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8); break;

		case 46: func_97(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31); break;

		default: func_95(&Var1, iParam0, iParam1, 47); break;
		}
		break;

	case joaat("player_two"):
		switch (iParam1) {
		case 0: func_97(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 1: func_97(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8); break;

		case 2: func_97(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1); break;

		case 3: func_97(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2); break;

		case 4:
			func_97(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[2], Global_101700.f_2095.f_539.f_200[2], 8, 0, 0,
					0, 0, -99, 0, 0, 31);
			break;

		case 5: func_97(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6); break;

		case 6: func_97(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3); break;

		case 7: func_97(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4); break;

		case 8: func_97(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31); break;

		case 9: func_97(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 10: func_97(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 11: func_97(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5); break;

		case 12: func_97(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 13: func_97(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31); break;

		case 14: func_97(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31); break;

		case 15: func_97(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 16: func_97(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 17: func_97(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 18: func_97(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 19: func_97(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 20: func_97(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 21: func_97(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_97(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 23: func_97(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 24: func_97(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 25: func_97(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 26: func_97(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 27: func_97(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 28: func_97(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 29: func_97(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 30: func_97(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 31: func_97(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 32: func_97(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 33: func_97(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 34: func_97(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 35: func_97(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 36: func_97(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 37: func_97(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 38: func_97(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 39: func_97(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 40: func_97(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 41: func_97(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_97(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_97(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_97(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31); break;

		case 45: func_97(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 46: func_97(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_97(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31); break;

		default: func_95(&Var1, iParam0, iParam1, 48); break;
		}
		break;

	case joaat("mp_m_freemode_01"):
		switch (iParam1) {
		case 0: func_97(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31); break;

		case 1: func_97(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0); break;

		case 2: func_97(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1); break;

		case 3: func_97(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2); break;

		case 4: func_97(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3); break;

		case 5: func_97(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4); break;

		case 6: func_97(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5); break;

		case 7: func_97(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6); break;

		case 8: func_97(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7); break;

		case 9: func_97(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8); break;

		case 10: func_97(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9); break;

		case 11: func_97(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10); break;

		case 12: func_97(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11); break;

		case 13: func_97(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12); break;

		case 14: func_97(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13); break;

		case 15: func_97(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14); break;

		case 16: func_97(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15); break;

		case 17: func_97(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16); break;

		case 18: func_97(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17); break;

		case 19: func_97(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18); break;

		case 20: func_97(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19); break;

		case 21: func_97(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20); break;

		case 22: func_97(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21); break;

		case 23: func_97(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22); break;

		case 24: func_97(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23); break;

		case 25: func_97(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24); break;

		default: func_95(&Var1, iParam0, iParam1, 26); break;
		}
		break;

	case joaat("mp_f_freemode_01"):
		switch (iParam1) {
		case 0: func_97(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31); break;

		case 1: func_97(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31); break;

		case 2: func_97(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0); break;

		case 3: func_97(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1); break;

		case 4: func_97(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2); break;

		case 5: func_97(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3); break;

		case 6: func_97(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4); break;

		case 7: func_97(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5); break;

		case 8: func_97(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6); break;

		case 9: func_97(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7); break;

		case 10: func_97(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8); break;

		case 11: func_97(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9); break;

		case 12: func_97(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10); break;

		case 13: func_97(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31); break;

		case 14: func_97(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11); break;

		case 15: func_97(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12); break;

		case 16: func_97(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13); break;

		case 17: func_97(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14); break;

		case 18: func_97(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15); break;

		case 19: func_97(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16); break;

		case 20: func_97(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17); break;

		case 21: func_97(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31); break;

		case 22: func_97(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18); break;

		case 23: func_97(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19); break;

		case 24: func_97(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20); break;

		case 25: func_97(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21); break;

		case 26: func_97(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22); break;

		case 27: func_97(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23); break;

		default: func_95(&Var1, iParam0, iParam1, 28); break;
		}
		break;
	}
	return Var1;
...
// Position - 0x8144
void func_97(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			 int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) {
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_84(iParam0, iParam2, 14, 3), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_84(iParam0, iParam2, 1, 3), -1842686353, 0);
			}
			break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_84(iParam0, iParam2, 14, 4), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_84(iParam0, iParam2, 1, 4), -1842686353, 0);
			}
			break;
		}
		break;
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_109(iParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3)) {
...
{
	switch (iParam0) {
	case 0: func_137(iParam1); break;

	case 2: func_136(iParam1); break;

	case 3: func_133(iParam1); break;

	case 4: func_132(iParam1); break;

	case 6: func_131(iParam1); break;

	case 5: func_130(iParam1); break;

	case 8: func_129(iParam1); break;

	case 9: func_128(iParam1); break;

	case 10: func_127(iParam1); break;

	case 1: func_126(iParam1); break;

	case 7: func_125(iParam1); break;

	case 11: func_124(iParam1); break;

	case 12: func_123(iParam1); break;

	case 13: func_122(iParam1); break;

	case 14: func_114(iParam1); break;
	}
}
...
void func_114(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 155); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

// Position - 0xC2BE
void func_115(var *uParam0, int iParam1, int iParam2, char *sParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	*uParam0 = iParam9;
	...
	if (iParam10) {
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 ||
			...
			iVar0 = func_108(func_118(iParam1, uParam0->f_2), Global_69521, 0);
...
void func_121(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 == 12) {
		...
		while (iVar38 < iVar40) {
			...
			if (!dlc1::_is_dlc_data_empty(Var20)) {
				if (iVar39 == iParam1 - iParam2) {
					...
					func_115(&Global_69523[0 /*14*/], iParam0, iParam1, &Var20.f_9, Var20.f_3, Var20.f_4, Var20.f_5,
		...
		iVar59 = 0;
		iVar60 = dlc1::_get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_72(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60) {
			...
			if (!dlc1::_is_dlc_data_empty(Var41)) {
				if (iVar59 == iParam1 - iParam2) {
					...
					func_115(&Global_69523[0 /*14*/], iParam0, iParam1, &Var41.f_9, Var41.f_3, Var41.f_4, Var41.f_5,
...
void func_122(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 9); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_123(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 48); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_124(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 1); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_126(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 6); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_127(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 33); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_128(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 17); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_129(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 18); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_130(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 7); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_131(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 84); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_132(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 104); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_138(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_156(iParam1); break;

	case 2: func_155(iParam1); break;

	case 3: func_151(iParam1); break;

	case 4: func_150(iParam1); break;

	case 6: func_149(iParam1); break;

	case 5: func_148(iParam1); break;

	case 8: func_147(iParam1); break;

	case 9: func_146(iParam1); break;

	case 10: func_145(iParam1); break;

	case 1: func_144(iParam1); break;

	case 7: func_143(iParam1); break;

	case 11: func_142(iParam1); break;

	case 12: func_141(iParam1); break;

	case 13: func_140(iParam1); break;

	case 14: func_139(iParam1); break;
	}
}
...
void func_139(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 175); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_141(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 47); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_142(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 63); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_144(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 5); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_145(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 53); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_146(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 12); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_147(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 77); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_149(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 134); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_150(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 117); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_155(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 21); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_156(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 10); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_157(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_174(iParam1); break;

	case 2: func_173(iParam1); break;

	case 3: func_170(iParam1); break;

	case 4: func_169(iParam1); break;

	case 6: func_168(iParam1); break;

	case 5: func_167(iParam1); break;

	case 8: func_166(iParam1); break;

	case 9: func_165(iParam1); break;

	case 10: func_164(iParam1); break;

	case 1: func_163(iParam1); break;

	case 7: func_162(iParam1); break;

	case 11: func_161(iParam1); break;

	case 12: func_160(iParam1); break;

	case 13: func_159(iParam1); break;

	case 14: func_158(iParam1); break;
	}
}
...
void func_158(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 113); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_161(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 45); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_165(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 20); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_166(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 24); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_167(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 14); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_168(int iParam0) {
	...
	default: func_121(iVar10, iParam0, 99); return;
	}
	func_115(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
bool func_176(int iParam0, int iParam1, int iParam2) {
	...
	else if (Global_69523[1 /*14*/].f_3 == ped::get_ped_drawable_variation(iParam0, func_72(iParam1)) &&
			 Global_69523[1 /*14*/].f_4 == ped::get_ped_texture_variation(iParam0, func_72(iParam1))) {
		return true;
	}
	return false;
}
...
// Position - 0x1E84F
bool func_179(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
void func_181() {
	...
	case 0:
		...
		if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_273, 0)) {
			if (player::get_player_wanted_level(player::player_id()) < 0) {
				iLocal_297 = func_269(vLocal_527, 5, 1);
				iLocal_309 = 0;
				iLocal_310 = 0;
			}
			else {
...
bool func_184() {
	...
	else if (entity::is_entity_at_coord(player::player_ped_id(), vLocal_527, 4.5f, 4.5f, 2f, 1, 1, 0) &&
			 (entity::is_entity_in_angled_area(player::player_ped_id(), -828.7069f, 176.6418f, 69.66212f, -824.0747f,
											   184.5666f, 72.91872f, 5.75f, 0, 1, 0) ||
			  entity::is_entity_in_angled_area(player::player_ped_id(), -827.9308f, 182.0454f, 70.08909f, -820.2387f,
											   180.1781f, 72.71543f, 6.5f, 0, 1, 0))) {
		return true;
	}
	return false;
}
...
void func_185() {
	...
	if (player::get_player_wanted_level(player::player_id()) > 0) {
		...
		if (iLocal_466 == 5) {
			...
			if (gameplay::get_game_timer() - iLocal_467 > vLocal_438[3 /*3*/] &&
				!func_56(player::player_ped_id(), vLocal_527, 50f)) {
				if (func_3(&uLocal_96, vLocal_438[3 /*3*/].f_1, vLocal_438[3 /*3*/].f_2, 7, 0, 0, 0)) {
					if (!bLocal_337) {
						...
						ai::clear_ped_tasks(iLocal_289);
						ai::task_perform_sequence(iLocal_289, iVar1);
					}
					iLocal_466++;
				}
			}
		...
		if (iLocal_466 == 8) {
			if (func_26(iLocal_273)) {
				if (entity::get_entity_health(iLocal_273) < 900 ||
					vehicle::get_vehicle_engine_health(iLocal_273) < 900f ||
					vehicle::get_vehicle_petrol_tank_health(iLocal_273) < 900f) {
					iLocal_466++;
					iLocal_467 = gameplay::get_game_timer();
				}
				else {
			...
			if (gameplay::get_game_timer() - iLocal_467 > vLocal_438[4 /*3*/] &&
				!func_56(player::player_ped_id(), vLocal_527, 50f)) {
		...
		if (iLocal_466 == 11) {
			...
			if (gameplay::get_game_timer() - iLocal_467 > vLocal_438[5 /*3*/] &&
				!func_56(player::player_ped_id(), vLocal_527, 50f)) {
		...
		if (iLocal_466 == 14) {
			...
			if (gameplay::get_game_timer() - iLocal_467 > vLocal_438[6 /*3*/] &&
				!func_56(player::player_ped_id(), vLocal_527, 50f)) {
		...
		if (iLocal_466 == 17) {
			...
			if (gameplay::get_game_timer() - iLocal_467 > vLocal_438[7 /*3*/] &&
				!func_56(player::player_ped_id(), vLocal_527, 50f)) {
...
void func_195() {
	if (bLocal_312 == 0) {
		if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_273, 0) &&
			ped::is_ped_in_vehicle(iLocal_289, iLocal_273, 0) && entity::get_entity_speed(iLocal_273) > 30f) {
			fLocal_315 += 1f * system::timestep();
		}
		if (gameplay::get_game_timer() > iLocal_314 &&
...
void func_198(int iParam0, char *sParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	...
	if (iVar0 == 1) {
		...
		iVar1 = func_266(script::get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94) {
			...
			iVar5 = func_259(script::get_this_script_name(), 1);
			if (iVar5 != -1) {
...
void func_199(int iParam0, var uParam1, int iParam2, int iParam3) {
	func_200(&Global_96040, script::get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_200(var *uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) {
	...
	*uParam0 = func_10();
	...
	if (!ped::is_ped_injured(player::player_ped_id())) {
		...
		func_223(player::player_ped_id(), 0);
	...
	while (iVar1 < 3) {
		...
		if (iVar1 == func_222()) {
			func_218(player::player_ped_id(), &uParam0->f_616[iVar1 /*65*/], 1);
		}
		else {
			iVar0 = 0;
			while (iVar0 < 12) {
...
// Position - 0x21347
bool func_215(int iParam0, var *uParam1, int iParam2, int iParam3) {
	char *sVar0;
...
// Position - 0x214E7
bool func_217(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
bool func_219(int iParam0, int iParam1) {
	...
	iVar0 = Global_2522581[iParam0 /*3*/][func_107(iParam1)];
...
// Position - 0x21CDD
void func_221(int iParam0, int iParam1, int *iParam2, int *iParam3, var *uParam4, int iParam5, int iParam6) {
	int iVar0;
...
void func_224(int iParam0, var *uParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		while (iVar0 <= 44 - 1) {
			...
			if (iVar3 != 0) {
				vVar4.x = weapon::get_ped_weapontype_in_slot(iParam0, func_228(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		iVar7 = 0;
		while (iVar7 < iVar8) {
			if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_225(Var9.f_1) && iVar70 < 50) {
...
// Position - 0x2372E
bool func_231(vector3 vParam0, char *sParam3, vector3 vParam4) {
	int iVar0;
	int iVar1;
...
// Position - 0x23772
bool func_232(int iParam0, var *uParam1, float *fParam2) {
	*uParam1 = {0f, 0f, 0f};
	*fParam2 = 0f;
	switch (iParam0) {
	case 0:
...
// Position - 0x23E01
bool func_233(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
bool func_234(int *iParam0) {
	if (!entity::is_entity_dead(player::player_ped_id(), 0) && !ped::is_ped_injured(player::player_ped_id())) {
		if (func_245()) {
			*iParam0 = func_240(entity::get_entity_coords(player::player_ped_id(), 0), 6, -1, 0, 1, -1);
			if (func_239(*iParam0) && !func_235(*iParam0)) {
				return true;
			}
		}
	}
...
// Position - 0x23EA3
int func_235(int iParam0) { return func_236(iParam0, 0, 1); }
...
int func_236(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_238() == 0) {
			return gameplay::is_bit_set(func_108(func_237(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0x242C0
int func_238() { return Global_25190; }

// Position - 0x242CB
int func_239(int iParam0) { return func_236(iParam0, 5, 1); }

// Position - 0x242DB
int func_240(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
	...
	while (iVar0 <= 45) {
		if (iParam3 == 6 || iParam3 == func_244(iVar0)) {
			if (!iParam5 || func_243(iVar0)) {
				fVar1 = gameplay::get_distance_between_coords(vParam0, func_241(iVar0, 0), 1);
...
Vector3 func_241(int iParam0, int iParam1) {
	...
	case 45: return func_242(Global_93004);
	}
...
// Position - 0x249AD
int func_243(int iParam0) { return func_236(iParam0, 0, 0); }
...
// Position - 0x24C30
bool func_245() { return Global_91543.f_303 > 0; }

// Position - 0x24C41
var func_246() {
	int *iVar0;

	func_256(&iVar0, time::get_clock_seconds());
	func_255(&iVar0, time::get_clock_minutes());
	func_254(&iVar0, time::get_clock_hours());
	func_249(&iVar0, time::get_clock_day_of_month());
	func_248(&iVar0, time::get_clock_month());
	func_247(&iVar0, time::get_clock_year());
	return iVar0;
}
...
var func_251(int iParam0) {
	return (system::shift_right(iParam0, 26) & 31) * func_252(gameplay::is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
// Position - 0x24E6F
int func_253(var uParam0) { return uParam0 & 15; }
...
void func_260(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_261(uParam1, "Abigail1", func_263(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				 "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_262(iParam0), 1, 0);
		break;

	case 1:
		func_261(uParam1, "Abigail2", func_263(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				 -1, 4, 1, 0, 2359, func_262(iParam0), 1, 0);
		break;

	case 2:
		func_261(uParam1, "Barry1", func_263(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				 4, 1, 0, 2359, func_262(iParam0), 1, 0);
		break;

	case 3:
		func_261(uParam1, "Barry2", func_263(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				 4, 4, 0, 2359, func_262(iParam0), 1, 1);
		break;

	case 4:
		func_261(uParam1, "Barry3", func_263(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2,
				 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 5:
		func_261(uParam1, "Barry3A", func_263(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0,
				 "", 166, 0, 7, 4, 2, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 6:
		func_261(uParam1, "Barry3C", func_263(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				 7, 4, 2, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 7:
		func_261(uParam1, "Barry4", func_263(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0,
				 "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_262(iParam0), 0, 0);
		break;

	case 8:
		func_261(uParam1, "Dreyfuss1", func_263(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				 0, "", 0, 0, -1, 4, 2, 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 9:
		func_261(uParam1, "Epsilon1", func_263(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1,
				 10, 4, 1, 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 10:
		func_261(uParam1, "Epsilon2", func_263(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0,
				 11, 4, 1, 0, 2359, func_262(iParam0), 1, 0);
		break;

	case 11:
		func_261(uParam1, "Epsilon3", func_263(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				 0, 0, 12, 4, 1, 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 12:
		func_261(uParam1, "Epsilon4", func_263(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				 "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 13:
		func_261(uParam1, "Epsilon5", func_263(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16,
				 "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_262(iParam0), 1, 0);
		break;

	case 14:
		func_261(uParam1, "Epsilon6", func_263(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 15:
		func_261(uParam1, "Epsilon7", func_263(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 16:
		func_261(uParam1, "Epsilon8", func_263(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_262(iParam0), 1, 0);
		break;

	case 17:
		func_261(uParam1, "Extreme1", func_263(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 18:
		func_261(uParam1, "Extreme2", func_263(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 19:
		func_261(uParam1, "Extreme3", func_263(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 20:
		func_261(uParam1, "Extreme4", func_263(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 21:
		func_261(uParam1, "Fanatic1", func_263(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_262(iParam0), 1, 0);
		break;

	case 22:
		func_261(uParam1, "Fanatic2", func_263(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_262(iParam0), 1, 0);
		break;

	case 23:
		func_261(uParam1, "Fanatic3", func_263(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_262(iParam0), 0, 1);
		break;

	case 24:
		func_261(uParam1, "Hao1", func_263(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_262(iParam0), 0, 1);
		break;

	case 25:
		func_261(uParam1, "Hunting1", func_263(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 26:
		func_261(uParam1, "Hunting2", func_263(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 27:
		func_261(uParam1, "Josh1", func_263(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_262(iParam0), 1, 0);
		break;

	case 28:
		func_261(uParam1, "Josh2", func_263(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_262(iParam0), 1, 1);
		break;

	case 29:
		func_261(uParam1, "Josh3", func_263(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_262(iParam0), 1, 1);
		break;

	case 30:
		func_261(uParam1, "Josh4", func_263(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_262(iParam0), 1, 0);
		break;

	case 31:
		func_261(uParam1, "Maude1", func_263(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 32:
		func_261(uParam1, "Minute1", func_263(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 33:
		func_261(uParam1, "Minute2", func_263(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 34:
		func_261(uParam1, "Minute3", func_263(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 35:
		func_261(uParam1, "MrsPhilips1", func_263(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 36:
		func_261(uParam1, "MrsPhilips2", func_263(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_262(iParam0), 0, 0);
		break;

	case 37:
		func_261(uParam1, "Nigel1", func_263(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_262(iParam0), 1, 0);
		break;

	case 38:
		func_261(uParam1, "Nigel1A", func_263(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_262(iParam0), 1, 1);
		break;

	case 39:
		func_261(uParam1, "Nigel1B", func_263(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_262(iParam0), 1, 1);
		break;

	case 40:
		func_261(uParam1, "Nigel1C", func_263(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_262(iParam0), 1, 1);
		break;

	case 41:
		func_261(uParam1, "Nigel1D", func_263(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_262(iParam0), 1, 1);
		break;

	case 42:
		func_261(uParam1, "Nigel2", func_263(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_262(iParam0), 1, 1);
		break;

	case 43:
		func_261(uParam1, "Nigel3", func_263(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_262(iParam0), 1, 1);
		break;

	case 44:
		func_261(uParam1, "Omega1", func_263(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 45:
		func_261(uParam1, "Omega2", func_263(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 46:
		func_261(uParam1, "Paparazzo1", func_263(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 47:
		func_261(uParam1, "Paparazzo2", func_263(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 48:
		func_261(uParam1, "Paparazzo3", func_263(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 49:
		func_261(uParam1, "Paparazzo3A", func_263(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 50:
		func_261(uParam1, "Paparazzo3B", func_263(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 51:
		func_261(uParam1, "Paparazzo4", func_263(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 52:
		func_261(uParam1, "Rampage1", func_263(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 54:
		func_261(uParam1, "Rampage3", func_263(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_262(iParam0), 1, 0);
		break;

	case 55:
		func_261(uParam1, "Rampage4", func_263(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_262(iParam0), 1, 0);
		break;

	case 56:
		func_261(uParam1, "Rampage5", func_263(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_262(iParam0), 0, 0);
		break;

	case 53:
		func_261(uParam1, "Rampage2", func_263(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_262(iParam0), 1, 0);
		break;

	case 57:
		func_261(uParam1, "TheLastOne", func_263(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 58:
		func_261(uParam1, "Tonya1", func_263(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 59:
		func_261(uParam1, "Tonya2", func_263(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_262(iParam0), 0, 1);
		break;

	case 60:
		func_261(uParam1, "Tonya3", func_263(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_262(iParam0), 0, 1);
		break;

	case 61:
		func_261(uParam1, "Tonya4", func_263(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_262(iParam0), 0, 1);
		break;

	case 62:
		func_261(uParam1, "Tonya5", func_263(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_262(iParam0), 0, 1);
		break;
...
// Position - 0x265CD
void func_261(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
int func_264(int iParam0)
{
	switch (iParam0) {
	case 69:
	case 70: return func_265(Global_101700.f_8044.f_99.f_205[10]);

	case 74:
	case 75: return func_265(Global_101700.f_8044.f_99.f_205[8]);

	case 84:
	case 85: return func_265(Global_101700.f_8044.f_99.f_205[11]);

	case 90: return func_265(Global_101700.f_8044.f_99.f_205[7]);

	case 93: return func_265(Global_101700.f_8044.f_99.f_205[9]);
	}
	return 0;
}
...
// Position - 0x26DCD
int func_269(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
...
void func_270() {
	...
	case 0:
		...
		if (func_26(iLocal_290)) {
			...
			if (ped::is_ped_in_any_vehicle(iLocal_290, 0)) {
				...
				ai::close_sequence_task(iVar0);
				ai::task_perform_sequence(iLocal_290, iVar0);
				ai::clear_sequence_task(&iVar0);
			}
			else {
				ai::task_smart_flee_coord(iLocal_290, entity::get_entity_coords(player::player_ped_id(), 1), 2000f, -1,
										  0, 0);
			}
			iLocal_413 = 0;
			iLocal_414 = 0;
			...
			func_316(&iLocal_297, "MET1KSTKRED", "MET1KSTKBLU", &uLocal_299, &iLocal_300, 1, 1);
			entity::set_entity_is_target_priority(iLocal_290, 1, 0);
			func_294(&iLocal_261, iLocal_290, 0, 0, 1, 1, 1);
			func_27(&iLocal_298);
			func_182(5);
			func_293();
			iLocal_93 = 1;
	...
	case 1:
		func_281(&iLocal_297, "MET1KSTKRED", "MET1KSTKBLU", &uLocal_299, iLocal_300, 1);
		if (func_26(iLocal_290)) {
			if (!func_191(iLocal_290, player::player_ped_id(), 80f, 1) && !entity::is_entity_on_screen(iLocal_290)) {
				...
				else if (ped::is_ped_on_foot(iLocal_290) && !ped::is_ped_ragdoll(iLocal_290) &&
						 !ai::is_ped_getting_up(iLocal_290) && !fire::is_entity_on_fire(iLocal_290) &&
						 !entity::is_entity_in_air(iLocal_290)) {
...
void func_273() {
	if (!iLocal_604) {
		if (gameplay::get_game_timer() - iLocal_603 > 3000) {
			func_276(1);
			if (func_275(vLocal_584[0 /*3*/], vLocal_584[2 /*3*/], 1f) && !ped::is_ped_in_melee_combat(iLocal_290) &&
				!ped::is_ped_ragdoll(iLocal_290) && !ai::is_ped_getting_up(iLocal_290)) {
		...
		if (!iLocal_604) {
			if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0) && !ped::is_ped_in_any_vehicle(iLocal_290, 0)) {
				if (gameplay::get_game_timer() > uLocal_606[0] &&
					func_191(player::player_ped_id(), iLocal_290, 20f, 1) && !ped::is_ped_ragdoll(iLocal_290) &&
					!ai::is_ped_getting_up(iLocal_290)) {
					func_274(0, 0);
				}
				else if (gameplay::get_game_timer() > uLocal_606[1]) {
					if (entity::is_entity_in_angled_area(
							player::player_ped_id(),
							entity::get_offset_from_entity_in_world_coords(iLocal_290, 0f, 1f, -2f),
							entity::get_offset_from_entity_in_world_coords(iLocal_290, 0f, 7f, 5f), 5f, 0, 1, 0) &&
						!ped::is_ped_ragdoll(iLocal_290) && !ai::is_ped_getting_up(iLocal_290)) {
						func_274(0, 1);
					}
					else {
			...
			else if (!iLocal_605 && !ped::is_ped_in_any_vehicle(iLocal_290, 0)) {
				func_274(1, 1);
			}
		}
	}
...
// Position - 0x273BA
bool func_275(vector3 vParam0, vector3 vParam3, float fParam6) {
...
void func_277() {
	...
	case 1:
		...
		if (func_26(iLocal_290)) {
			...
			else if (!iLocal_414 && !func_191(player::player_ped_id(), iLocal_290, 80f * 0.5f, 1) &&
					 func_191(player::player_ped_id(), iLocal_289, 15f, 1)) {
				iLocal_417 = 8;
			}
		}
		break;
	...
	case 2:
		if (func_26(iLocal_290)) {
			if (func_191(player::player_ped_id(), iLocal_290, 25f, 1)) {
				if (func_187("MET1KSTKRED", 0, 0) || func_187("MET1KSTKBLU", 0, 0)) {
					if (func_3(&uLocal_96, vLocal_418[iLocal_415 /*3*/].f_1, vLocal_418[iLocal_415 /*3*/].f_2, 7, 1, 0,
							   0)) {
						bLocal_375 = true;
						bLocal_376 = false;
						bLocal_410 = false;
				...
				else if (func_3(&uLocal_96, vLocal_418[iLocal_415 /*3*/].f_1, vLocal_418[iLocal_415 /*3*/].f_2, 7, 0, 0,
								0)) {
					bLocal_375 = true;
					bLocal_376 = false;
					bLocal_410 = false;
	...
	case 10:
		if (!func_23()) {
			...
			if (!ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_273, 1) &&
				!func_191(player::player_ped_id(), iLocal_290, 25f, 1)) {
				func_189();
			}
		}
		break;
...
int func_278() {
	...
	if (Global_15745 == 4) {
		...
		iVar0 += Global_16755;
		if (iVar0 > -1) {
			if (ui::does_text_label_exist(&Global_14613[iVar0 /*6*/])) {
				cVar1 = {Global_15364};
...
// Position - 0x27D8E
void func_281(int *iParam0, char *sParam1, char *sParam2, var *uParam3, int iParam4, int iParam5) {
	if (ui::does_blip_exist(*iParam0)) {
...
int func_282() {
	if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_273, 0) &&
		ped::is_ped_in_vehicle(iLocal_289, iLocal_273, 0)) {
		return 1;
	}
	else if (bLocal_336) {
		...
		else if (func_283(iLocal_289, player::player_ped_id(), 1126825984, 1, 250, 7)) {
			return 1;
		}
...
bool func_283(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_284(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0x28010
int func_284(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
	...
	if (*iParam0 == 0) {
		vVar1 = {func_285(iParam4, iParam7)};
		*iParam0 =
...
int func_287(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	vVar0 = {func_289(entity::get_entity_coords(iParam1, 1) - entity::get_entity_coords(iParam0, 1))};
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_289(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
						  ped::get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_288(vVar3, vVar0);
...
// Position - 0x282DC
float func_288(vector3 vParam0, vector3 vParam3) {
	return vParam0.x * vParam3.x + vParam0.y * vParam3.y + vParam0.z * vParam3.z;
}
...
// Position - 0x283A9
void func_293() {
	func_283(iLocal_289, player::player_ped_id(), 1126825984, 1, 250, 7);
	func_283(iLocal_289, iLocal_290, 1126825984, 1, 250, 7);
}

// Position - 0x283DA
void func_294(int *iParam0, int iParam1, char *sParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	func_295(iParam0, iParam1, sParam2, iParam3, iParam4, iParam5, iParam6);
}

// Position - 0x283F4
void func_295(int *iParam0, int iParam1, char *sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6) {
	func_296(iParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

// Position - 0x28411
void func_296(int *iParam0, int iParam1, vector3 vParam2, char *sParam5, int iParam6, bool bParam7, var uParam8,
			  bool bParam9) {
	if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
		func_271(iParam0, 0, 0);
	}
	iParam0->f_6 = 2;
	func_297(iParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

// Position - 0x28449
void func_297(int *iParam0, int iParam1, vector3 vParam2, char *sParam5, int iParam6, bool bParam7, var uParam8,
			  bool bParam9) {
	int iVar0;
	int iVar1;
	...
	if (func_314(iParam1) && entity::is_entity_visible(iParam1)) {
		...
		if (!cam::is_gameplay_hint_active()) {
			if (func_309(iParam0, bParam7, bParam9, 0)) {
				func_306(iParam0, iParam1, vParam2, iParam6);
			}
			if (*iParam0) {
				*iParam0 = 0;
			}
			...
			if (!func_309(iParam0, bParam7, bParam9, 0)) {
				if (!*iParam0 && !iParam0->f_1 && !func_299(iParam0)) {
					func_298(iParam0);
				}
			}
		}
...
bool func_302(char *sParam0) {
	if (!func_303(1, 1, 0)) {
		if (!gameplay::is_string_null_or_empty(sParam0) && func_272(sParam0) || func_272("CMN_HINT")) {
			ui::clear_help(1);
		}
		return false;
	}
...
// Position - 0x28B20
bool func_304() { return gameplay::get_game_timer() <= Global_17290.f_5745 + 100; }
...
// Position - 0x28B8F
void func_306(int *iParam0, int iParam1, vector3 vParam2, int iParam5) {
	int iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
	...
	if (func_233(vParam2, 0f, 0f, 0f, 0)) {
		if (entity::is_entity_a_ped(iParam1)) {
...
// Position - 0x28C94
int func_307() { return func_308(player::player_id()); }
...
// Position - 0x28CC3
bool func_309(var *uParam0, bool bParam1, bool bParam2, int iParam3) {
	if (uParam0->f_1) {
	...
	case 0:
		...
		if (uParam0->f_6 == 0) {
			if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
				if (func_313(bParam1, bParam2, iParam3)) {
					uParam0->f_4 = gameplay::get_game_timer();
					uParam0->f_5 = 1;
					uParam0->f_7 = 1;
				}
			}
			else if (func_312(bParam1, bParam2, iParam3)) {
				uParam0->f_4 = gameplay::get_game_timer();
				uParam0->f_5 = 1;
				uParam0->f_7 = 1;
			}
			...
			if (func_312(bParam1, bParam2, iParam3)) {
				uParam0->f_4 = gameplay::get_game_timer();
				uParam0->f_5 = 1;
				uParam0->f_7 = 1;
			}
	...
	case 2:
		if (uParam0->f_6 == 0) {
			...
			if (!func_312(bParam1, bParam2, iParam3) || ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
				uParam0->f_5 = 0;
			}
		}
		else if (uParam0->f_6 == 2) {
			...
			else if (!func_313(bParam1, bParam2, iParam3)) {
				uParam0->f_5 = 0;
			}
		}
		break;
	...
	case 3:
		if (gameplay::get_game_timer() - uParam0->f_4 > 500) {
			if (uParam0->f_6 == 0) {
				if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
					if (func_311(bParam1, bParam2, iParam3)) {
						uParam0->f_5 = 0;
					}
				}
				else if (func_310(bParam1, bParam2, iParam3)) {
					uParam0->f_5 = 0;
				}
			}
			else if (uParam0->f_6 == 1) {
				if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 1) || func_310(bParam1, bParam2, iParam3)) {
					uParam0->f_5 = 0;
				}
			}
			else if (uParam0->f_6 == 2) {
				...
				else if (func_311(bParam1, bParam2, iParam3)) {
					uParam0->f_5 = 0;
				}
			}
		}
	...
	if (!func_303(bParam1, bParam2, iParam3)) {
		uParam0->f_5 = 0;
		uParam0->f_7 = 0;
	}
	if (uParam0->f_7) {
...
// Position - 0x2902F
bool func_310(bool bParam0, bool bParam1, bool bParam2) {
...
// Position - 0x291DA
void func_315() { gameplay::set_bit(&G_SleepModeOffOn11, 4); }

// Position - 0x291EA
void func_316(int iParam0, char *sParam1, char *sParam2, var *uParam3, var *uParam4, int iParam5, int iParam6) {
	if (ui::does_blip_exist(*iParam0)) {
		if (iParam5) {
			ui::set_blip_colour(*iParam0, 1);
			ui::set_blip_name_from_text_file(*iParam0, "BLIP_ENEMY");
...
void func_318() {
		...
		if (func_26(iLocal_290)) {
			...
			if (!func_191(player::player_ped_id(), iLocal_290, 220f, 1)) {
				...
				if (!iLocal_333) {
					iLocal_333 = 1;
					ai::clear_ped_tasks(iLocal_290);
					ai::task_vehicle_mission_ped_target(iLocal_290, Local_277, player::player_ped_id(), 8, 25f, 786477,
														100f, 1f, 1);
				}
				iLocal_603 = gameplay::get_game_timer();
				...
				func_334(&bLocal_609, &iLocal_610, &iLocal_611, &fLocal_612);
				iLocal_613 = gameplay::get_game_timer();
				if (ui::does_blip_exist(iLocal_297)) {
					func_333(iLocal_297, iLocal_290, 220f, 0.75f, 0);
				}
				iLocal_93 = 1;
			}
			if (iLocal_305) {
	...
	case 1:
		if (func_26(iLocal_290)) {
			...
			if (ui::does_blip_exist(iLocal_297) && ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_273, 0) &&
				ped::is_ped_in_vehicle(iLocal_289, iLocal_273, 0)) {
				func_333(iLocal_297, iLocal_290, 220f, 0.75f, 0);
			}
			func_294(&iLocal_261, iLocal_290, 0, 0, 1, 1, 1);
...
void func_319() {
	...
	if (iLocal_379 > 0 && iLocal_379 < 250 && (iLocal_380 == 0 || iLocal_380 == 1) &&
		entity::get_entity_speed(iLocal_273) < 1.5f && entity::get_entity_speed(Local_277) > 3f) {
		iLocal_380 = 8;
	}
	if (func_321()) {
	...
	case 1:
		if (func_26(iLocal_290)) {
			...
			else if (func_320() && gameplay::get_game_timer() - iLocal_331 > 6000) {
				iLocal_380 = 7;
			}
...
// Position - 0x29DBB
int func_320() {
	if (func_275(vLocal_320[0 /*3*/], vLocal_320[2 /*3*/], 2f)) {
		return 1;
	}
	iLocal_331 = gameplay::get_game_timer();
	return 0;
...
int func_324() {
	...
	if (func_26(Local_277)) {
		fVar0 = func_325(entity::get_entity_roll(Local_277), 0f, 360f);
...
void func_326() {
	if (func_26(Local_277)) {
		if (gameplay::get_game_timer() - iLocal_603 > 3000) {
			func_276(0);
			if (func_275(vLocal_584[3 /*3*/], vLocal_584[5 /*3*/], 2f) && func_327()) {
				iLocal_92 = 6;
				iLocal_93 = 0;
			}
			else if (func_275(vLocal_584[0 /*3*/], vLocal_584[5 /*3*/], 2f)) {
				iLocal_92 = 6;
				iLocal_93 = 0;
			}
		}
...
// Position - 0x29F9C
int func_327() {
	if (func_56(iLocal_273, entity::get_offset_from_entity_in_world_coords(Local_277, 0f, 3.2f, 0.5f), 3f) ||
		func_56(iLocal_273, entity::get_offset_from_entity_in_world_coords(Local_277, 0f, -3.2f, 0.5f), 3f)) {
		return 1;
	}
	return 0;
}
...
void func_328() {
	if (iLocal_617 == 0) {
		...
		else if (gameplay::get_game_timer() - iLocal_613 > iLocal_616 &&
				 entity::is_entity_in_angled_area(
					 player::player_ped_id(),
					 entity::get_offset_from_entity_in_world_coords(Local_277, 0f, -0.5f, -1.5f),
					 entity::get_offset_from_entity_in_world_coords(Local_277, 0f, 6f, 2f), 12f, 0, 1, 0)) {
			iLocal_613 = gameplay::get_game_timer();
			iLocal_617 = 1;
		}
	}
	if (iLocal_617 == 1) {
		...
		else if (gameplay::get_game_timer() - iLocal_613 < iLocal_614 && func_329(1)) {
	...
	if (iLocal_617 == 2) {
		if (gameplay::get_game_timer() - iLocal_613 < iLocal_614 && func_329(0)) {
...
bool func_330() {
	if (entity::does_entity_exist(Local_277)) {
		...
		if (func_332(Local_277, &bLocal_609, &iLocal_610, &iLocal_611, &fLocal_612, 6, 1082130432)) {
			return true;
		}
		if (bLocal_609) {
			iLocal_377 = 1;
...
bool func_331(int iParam0) {
	if (vehicle::is_vehicle_tyre_burst(iParam0, 0, 0) || vehicle::is_vehicle_tyre_burst(iParam0, 1, 0) ||
		vehicle::is_vehicle_tyre_burst(iParam0, 4, 0) || vehicle::is_vehicle_tyre_burst(iParam0, 5, 0)) {
		return true;
	}
	return false;
}
...
// Position - 0x2A201
bool func_332(int iParam0, int *iParam1, int *iParam2, int *iParam3, float *fParam4, int iParam5, float fParam6) {
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
		...
		vVar1 = {func_289(entity::get_entity_coords(iVar0, 1) - entity::get_entity_coords(iParam0, 1))};
		vVar4 = {entity::get_entity_velocity(iParam0) - entity::get_entity_velocity(iVar0)};
		*fParam4 = func_288(vVar4, vVar1);
	}
	return false;
}
...
void func_335() {
	...
	case 0:
		if (!func_340()) {
			...
			if (func_336(Local_277.f_6, Local_277.f_9, 0)) {
				...
				ai::open_sequence_task(&iVar0);
				ai::task_vehicle_mission_coors_target(0, Local_277, entity::get_entity_coords(iLocal_273, 1), 4, 35f,
													  2883621, 10f, 12f, 1);
				ai::task_vehicle_escort(0, Local_277, iLocal_273, -1, 25f, 2883621, -1f, 20, 20f);
				ai::close_sequence_task(iVar0);
				ai::task_perform_sequence(iLocal_290, iVar0);
				ai::clear_sequence_task(&iVar0);
	...
	case 1:
		...
		if (func_26(iLocal_290)) {
			if (func_26(Local_277)) {
				if (!iLocal_335) {
					if (streaming::has_anim_dict_loaded("missmichael_event@tracy") &&
						func_3(&uLocal_96, "MET1AUD", "MET1_TENDb", 7, 0, 0, 0)) {
						...
						if (!ui::does_blip_exist(iLocal_297)) {
							...
							ui::set_blip_name_from_text_file(iLocal_297, "MET1LBSTALK");
							func_182(4);
						}
						iLocal_335 = 1;
					}
					...
					if (!iLocal_332) {
						if (entity::has_entity_been_damaged_by_entity(Local_277, player::player_ped_id(), 1) ||
							entity::has_entity_been_damaged_by_entity(iLocal_290, player::player_ped_id(), 1)) {
							entity::clear_entity_last_damage_entity(iLocal_290);
						...
						ai::task_vehicle_mission_ped_target(iLocal_290, Local_277, player::player_ped_id(), 8, 25f,
															786477, 100f, 1f, 1);
						iLocal_333 = 1;
						iLocal_93 = 2;
					}
...
// Position - 0x2A80A
bool func_336(vector3 vParam0, float fParam3, int iParam4) {
	...
	if (func_26(Local_277) && func_26(iLocal_290)) {
		...
		if (streaming::has_model_loaded(iLocal_291) && streaming::has_model_loaded(Local_277.f_1)) {
			gameplay::clear_area_of_vehicles(Local_277.f_6, 5f, 0, 0, 0, 0, 0);
			Local_277 = vehicle::create_vehicle(Local_277.f_1, vParam0, fParam3, 1, 1);
			...
			entity::set_entity_load_collision_flag(Local_277, 1);
			vehicle::add_vehicle_upsidedown_check(Local_277);
			func_337(Local_277, 0);
...
// Position - 0x2A9A7
void func_337(int iParam0, int iParam1) { Global_91491.f_22[iParam1] = iParam0; }
		...
		if (!func_340()) {
			...
			if (iLocal_305) {
				if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_273, 0)) {
					...
					if (ped::is_ped_in_vehicle(iLocal_289, iLocal_273, 0)) {
						iLocal_306 = 0;
						if (iLocal_316 == 5 && !func_56(player::player_ped_id(), Local_487[iLocal_520 /*8*/],
														Local_487[iLocal_520 /*8*/].f_3)) {
							iLocal_297 = func_269(Local_487[iLocal_520 /*8*/], 5, 1);
						}
				...
				case 3:
					...
					if (func_56(player::player_ped_id(), Local_487[iLocal_520 /*8*/],
								Local_487[iLocal_520 /*8*/].f_3)) {
						iLocal_316 = 5;
					}
					else if (!func_23()) {
				...
				case 5:
					...
					else if (!ui::does_blip_exist(iLocal_297)) {
						iLocal_297 = func_269(Local_487[iLocal_520 /*8*/], 5, 1);
					}
					else {
						func_342();
...
// Position - 0x2B1A7
void func_342() {
	if (!func_23() && !func_188() && ped::is_ped_in_vehicle(iLocal_289, iLocal_273, 0) &&
		ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_273, 0)) {
		if (func_320() && gameplay::get_game_timer() - iLocal_331 > 18000) {
...
// Position - 0x2B536
bool func_344(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6,
			  int iParam7) {
	vector3 vVar0;
	...
	if (func_26(player::player_ped_id()) && func_26(iParam0)) {
		...
		if (func_349(iParam0, iParam1, iParam5, iParam6, iParam7)) {
			return true;
		}
		if (!weapon::is_ped_armed(player::player_ped_id(), 6)) {
			if (ped::is_ped_in_melee_combat(player::player_ped_id())) {
				...
				if (vVar0.x * vVar0.x + vVar0.y * vVar0.y + vVar0.z * vVar0.z <= 5f) {
					return func_348(player::player_ped_id(), iParam0, fParam2);
				}
			}
		}
		if (iParam4) {
...
bool func_345(int iParam0, float fParam1) {
	...
	if (func_26(player::player_ped_id()) && func_26(iParam0)) {
		if (func_347(iParam0) || player::is_player_targetting_entity(player::player_id(), iParam0)) {
			if (weapon::is_ped_armed(player::player_ped_id(), 6)) {
				fVar0 = 40f;
			}
			else {
...
// Position - 0x2B667
bool func_346(int iParam0, float fParam1) { return func_283(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
// Position - 0x2B6EE
bool func_349(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) {
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_26(player::player_ped_id()) && func_26(iParam0)) {
		...
		if (!bParam2) {
			if (func_353(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
...
// Position - 0x2B7E9
bool func_350(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
bool func_351(int iParam0, float fParam1) {
	...
	if (gameplay::_0x82FDE6A57EE4EE44(iParam0, joaat("weapon_grenade"), fParam1, &vVar1, &uVar0, 0) ||
		...
		if (func_352(iParam0, vVar1, 90f, 0)) {
			return true;
		}
	}
	return false;
...
// Position - 0x2B98A
bool func_352(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = {func_289(vParam1 - entity::get_entity_coords(iParam0, 1))};
...
// Position - 0x2BA18
bool func_353(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
void func_354() {
	...
	case 0:
		...
		if (!func_340()) {
			if (!func_2()) {
				if (func_366(&iLocal_289, vLocal_483, fLocal_486, 1) &&
					func_357(&iLocal_273, 15, vLocal_479, fLocal_482, 1, 0) &&
					streaming::has_anim_dict_loaded(sLocal_296) && func_26(iLocal_273)) {
					iLocal_293 = 1;
					...
					entity::set_entity_load_collision_flag(iLocal_273, 1);
	...
	case 1:
		...
		if (!func_2()) {
			if (!func_340()) {
				switch (iLocal_304) {
				case 0:
					if (entity::is_entity_in_angled_area(player::player_ped_id(), 246.1479f, -39.21085f, 67.89664f,
														 202.6635f, -23.77725f, 72.90416f, 22f, 0, 1, 0) ||
						entity::is_entity_in_angled_area(player::player_ped_id(), 233.7891f, -45.51515f, 67.57388f,
														 229.9916f, -55.96275f, 72.28979f, 12.5f, 0, 1, 0)) {
						if (func_23()) {
							func_54();
						}
						ai::open_sequence_task(&iVar0);
				...
				case 1:
					if (func_3(&uLocal_96, "MET1AUD", "MET1_SEES", 7, 1, 0, 0) ||
						ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_273, 0)) {
				...
				case 2:
					if (!iLocal_311 && !func_23() && !func_187("MET1TCAR", 0, 0) &&
						!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
					...
					if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_273, 0)) {
						...
						if (ped::is_ped_in_vehicle(iLocal_289, iLocal_273, 0)) {
							...
							func_27(&iLocal_297);
							iLocal_297 = func_193(iLocal_289, 1, 1, 5);
							ui::set_blip_name_from_text_file(iLocal_297, "MET1LBTRAC");
							func_28(2);
						}
					}
					ai::task_look_at_entity(iLocal_289, player::player_ped_id(), 2000, 2048, 4);
...
// Position - 0x2C048
int func_357(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7) {
	struct<98> Var0;
	int iVar98;
	int iVar99;
	...
	if (!func_12(iParam1)) {
		...
		if (iParam1 == 17 && Global_101700.f_2095.f_539.f_2846[0 /*197*/][0 /*98*/] == Var0 ||
			iParam1 == 15 && Global_101700.f_2095.f_539.f_2846[0 /*197*/][1 /*98*/] == Var0) {
			if (iParam1 == 17) {
				iVar98 = 0;
			}
			else if (iParam1 == 15) {
			...
			streaming::request_model(Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/]);
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/], vParam2,
												   fParam5, 0, 0);
				...
				Var0.f_3 = 1250;
				vehicle::set_vehicle_colours(*iParam0, Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_5,
											 Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_6);
				vehicle::set_vehicle_extra_colours(*iParam0,
												   Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_7,
												   Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_8);
				vehicle::set_vehicle_dirt_level(*iParam0, Var0.f_2);
				iVar99 = 0;
				while (iVar99 < 12) {
					vehicle::set_vehicle_extra(
						*iParam0, iVar99 + 1,
						!Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_11[iVar99]);
					iVar99++;
				}
				...
				vehicle::set_vehicle_number_plate_text(
					*iParam0, &Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_27);
				if (Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_26 >= 0 &&
					Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_26 <
						vehicle::get_number_of_vehicle_number_plates()) {
					vehicle::set_vehicle_number_plate_text_index(
						*iParam0, Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_26);
				}
				vehicle::set_vehicle_tyre_smoke_color(*iParam0,
													  Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_84,
													  Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_85,
													  Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_86);
				vehicle::set_vehicle_tyres_can_burst(*iParam0,
													 Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_88);
				vehicle::set_vehicle_window_tint(*iParam0,
												 Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_87);
				vehicle::_set_vehicle_neon_lights_colour(
					*iParam0, Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_93,
					Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_94,
					Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_95);
				vehicle::_set_vehicle_neon_light_enabled(
					*iParam0, 2,
					gameplay::is_bit_set(Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_92, 28));
				vehicle::_set_vehicle_neon_light_enabled(
					*iParam0, 3,
					gameplay::is_bit_set(Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_92, 29));
				vehicle::_set_vehicle_neon_light_enabled(
					*iParam0, 0,
					gameplay::is_bit_set(Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_92, 30));
				vehicle::_set_vehicle_neon_light_enabled(
					*iParam0, 1,
					gameplay::is_bit_set(Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_92, 31));
				if (vehicle::get_vehicle_livery_count(*iParam0) > 1 &&
					Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_89 >= 0) {
					vehicle::set_vehicle_livery(*iParam0,
												Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_89);
				}
						...
						if (vehicle::is_this_model_a_bike(entity::get_entity_model(*iParam0))) {
							if (Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_90 == 6) {
								vehicle::set_vehicle_wheel_type(
									*iParam0, Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_90);
							}
						}
						else {
							vehicle::set_vehicle_wheel_type(
				...
				func_361(iParam0, &Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_31,
						 &Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/].f_81);
				vehicle::set_vehicle_enveff_scale(*iParam0, Var0.f_96);
				if (iParam6) {
					streaming::set_model_as_no_longer_needed(
						Global_101700.f_2095.f_539.f_2846[0 /*197*/][iVar98 /*98*/]);
				}
				func_360(*iParam0);
				return 1;
			}
			...
			if (streaming::has_model_loaded(Var0)) {
				*iParam0 = vehicle::create_vehicle(Var0, vParam2, fParam5, 0, 0);
				vehicle::set_vehicle_on_ground_properly(*iParam0, 1084227584);
				vehicle::_0xAB04325045427AAE(*iParam0, 0);
				vehicle::_0x428BACCDF5E26EAD(*iParam0, 0);
				vehicle::set_vehicle_has_strong_axles(*iParam0, 1);
...
void func_358(var *uParam0, struct<98> Param1) {
	...
	if (func_359(&uVar2, &iVar1) && Param1.f_97) {
...
int func_361(int iParam0, var *uParam1, var *uParam2) {
	...
	if (func_364(entity::get_entity_model(*iParam0), 1) &&
		vehicle::get_vehicle_mod(*iParam0, 24) != func_363(*iParam0, (*uParam1)[38] - 1)) {
		vehicle::set_vehicle_mod(*iParam0, 24, func_363(*iParam0, (*uParam1)[38] - 1), 0);
	}
	if (func_362(*iParam0)) {
...
// Position - 0x2D1EC
int func_366(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	int iVar0;
	...
	if (streaming::has_model_loaded(iVar0)) {
		func_33(iParam0);
		*iParam0 = ped::create_ped(26, iVar0, vParam1, fParam4, 0, 0);
...
void func_367() {
	...
	case 0:
		func_28(0);
		if (!ui::does_blip_exist(iLocal_297)) {
			iLocal_297 = func_369(vLocal_483, 1);
			func_368(&iLocal_297, 237.2897f, -60.5704f, 68.4345f, 70.9753f);
		}
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			iLocal_305 = 0;
			func_182(1);
	...
	case 2:
		if (!func_2()) {
			...
			gameplay::clear_area_of_vehicles(vLocal_479, 30f, 0, 0, 0, 0, 0);
			iLocal_93 = 0;
			iLocal_92 = 2;
		}
		break;
...
// Position - 0x2D3BE
void func_368(int iParam0, vector3 vParam1, float fParam4) {
	if (ui::does_blip_exist(*iParam0)) {
	...
	if (entity::does_entity_exist(Global_93635.f_4)) {
		if (vehicle::is_vehicle_driveable(Global_93635.f_4, 0)) {
			if (func_401(24) != Global_93635.f_4) {
				if (iParam4 == 1) {
					if (func_398(entity::get_entity_coords(Global_93635.f_4, 1), iParam5, &vVar0, &fVar3)) {
						vParam0 = {vVar0};
						fParam3 = fVar3;
					}
				}
				func_372(Global_93635.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
// Position - 0x2D4D6
void func_372(int iParam0, vector3 vParam1, float *fParam4, int iParam5, int iParam6) {
	struct<60> Var0;
	...
	if (entity::does_entity_exist(iParam0) && vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (func_233(vParam1, 0f, 0f, 0f, 0)) {
		...
		func_391(iParam5, &Var0, vParam1, fParam4, func_207(iParam0));
...
int func_375(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_216(iParam0, 0, 0) ||
		func_216(iParam0, 1, 0) || func_216(iParam0, 2, 0) || func_207(iParam0) != 145 || func_389(iParam0) ||
		func_388(iParam0) || func_387(iParam0) || func_386(iParam0) || !func_376(entity::get_entity_model(iParam0))) {
		if (func_388(iParam0)) {
		}
		if (func_388(iParam0)) {
		}
...
// Position - 0x2EB5D
int func_381() { return 0; }

// Position - 0x2EB66
int func_382() { return 1; }

// Position - 0x2EB6F
int func_383() { return 1; }
...
// Position - 0x30851
bool func_398(vector3 vParam0, int iParam3, var *uParam4, float *fParam5) {
	int iVar0;
...
// Position - 0x30967
int func_399(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
...
// Position - 0x309F6
var func_400(int iParam0) { return gameplay::is_bit_set(Global_101700.f_6188[iParam0], 0); }
...
void func_414(var *uParam0, int iParam1) {
	...
	while (iVar0 < 3) {
		...
		if (iVar1 == 8 || iVar1 == 9 || iVar1 == 10 || iVar1 == 11 || iVar1 == 34 || iVar1 == 72 || iVar1 == 73)
			...
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_416(Global_101700.f_17492[iVar0], &vVar2, &fVar5)) {
...
// Position - 0x30FB5
void func_415(int *iParam0) { *iParam0 = -15; }
...
int func_416(int iParam0, var *uParam1, float *fParam2) {
	...
	case 9: return func_416(8, uParam1, fParam2);

	case 10: return func_416(8, uParam1, fParam2);
...
void func_419(int iParam0, int iParam1) {
	...
	if (iParam0) {
		vVar0[0 /*3*/] = {func_435()};
		if (pathfind::get_closest_vehicle_node_with_heading(vVar0[0 /*3*/], &vVar0[1 /*3*/], &uVar7, 1, 1077936128,
															0)) {
		}
		else {
			func_434(vVar0[0 /*3*/], &vVar0[1 /*3*/], &uVar7);
		}
		vLocal_618 = {vVar0[1 /*3*/]};
		fLocal_621 = uVar7;
		gameplay::clear_area_of_vehicles(vLocal_618, 10f, 0, 0, 0, 0, 0);
		func_433(vLocal_618, fLocal_621, 1, 0);
		func_431(vLocal_618, fLocal_621, 1);
		if (iParam1) {
			bLocal_336 = false;
		}
		else {
	...
	else if (iLocal_92 == 3 || iLocal_92 == 4 || iLocal_92 == 5)
		&&func_26(iLocal_273) && func_26(iLocal_289) {
			if (func_26(player::player_ped_id())) {
				if (!ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_273, 0)) {
					func_430(player::player_ped_id(), iLocal_273, -1);
	...
	if (iParam0) {
		...
		func_420(vLocal_618, 1112014848, 12, 5000, 0, 0);
	}
}

// Position - 0x31C55
void func_420(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	int iVar1;
...
// Position - 0x31CC4
void func_421() { Global_17151.f_6 = 1; }
...
// Position - 0x31ECB
var func_427() { return gameplay::is_bit_set(Global_91491.f_20, 13); }

// Position - 0x31EDF
void func_428(int iParam0, int iParam1) { vLocal_341[iParam0 /*3*/].f_1 = iParam1; }
...
// Position - 0x31F5A
void func_431(vector3 vParam0, float fParam3, int iParam4) {
	func_432();
	while (!func_357(&iLocal_273, 15, vParam0, fParam3, 1, 0)) {
		system::wait(0);
	}
	if (iParam4) {
		while (!func_366(&iLocal_289, vParam0.x, vParam0.y, vParam0.z + 5f, 0, 1)) {
			system::wait(0);
		}
...
// Position - 0x320D9
void func_433(vector3 vParam0, float fParam3, int iParam4, int iParam5) {
	if (func_483()) {
...
// Position - 0x3216E
void func_434(vector3 vParam0, var *uParam3, var *uParam4) {
	vector3 vVar0[4];
	float fVar13[4];
	int iVar18;
...
// Position - 0x32258
Vector3 func_435() { return Global_96040.f_2305; }
...
void func_437(int iParam0) {
	...
	if (iParam0) {
		...
		if (func_26(player::player_ped_id())) {
			entity::set_entity_coords(player::player_ped_id(), Local_487[3 /*8*/], Local_487[3 /*8*/].f_1,
									  Local_487[3 /*8*/].f_2 + 8f, 1, 0, 0, 1);
			func_431(Local_487[3 /*8*/], 71.4f, 1);
			func_430(player::player_ped_id(), iLocal_273, -1);
		}
		if (func_26(iLocal_273)) {
			gameplay::clear_area_of_vehicles(entity::get_offset_from_entity_in_world_coords(iLocal_273, 0f, -8f, 0f),
											 6f, 0, 0, 0, 0, 0);
		}
	}
	...
	if (func_26(player::player_ped_id())) {
		if (iParam0) {
			if (func_461()) {
				...
				fLocal_621 = 251.1f;
				bLocal_622 = true;
				gameplay::clear_area_of_vehicles(99.6208f, -21.0027f, 67.0114f, 7f, 0, 0, 0, 0, 0);
				func_459();
				while (!func_458()) {
					system::wait(0);
				}
				iLocal_623 = func_440(vLocal_618, fLocal_621);
			}
			else {
...
// Position - 0x3273D
int func_440(vector3 vParam0, float fParam3) { return func_441(&Global_96040.f_2311, vParam0, fParam3, 0); }

// Position - 0x32757
int func_441(var *uParam0, vector3 vParam1, float fParam4, int iParam5) {
	int iVar0;
	vector3 vVar1;
	bool bVar4;
	var uVar5;
	...
	if (func_457(uParam0)) {
		...
		if (func_456(uParam0)) {
			...
			if (entity::does_entity_exist(iVar0)) {
				...
				else if (!func_446(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10 &&
...
void func_442(int iParam0) {
	...
	if (func_390(&Global_68531.f_555[0 /*21*/], iParam0)) {
		...
		Global_68531[iParam0] = 1;
		if (gameplay::is_bit_set(Global_68531.f_555[0 /*21*/].f_9, 13)) {
			if (iParam0 == 24 && func_394(iParam0, 0) && Global_69440.f_66 == 0 &&
				Global_101700.f_31389.f_1958[Global_68531.f_555[0 /*21*/].f_14] != 0 &&
				Global_101700.f_31389.f_1958[Global_68531.f_555[0 /*21*/].f_14] > 3 &&
				(!func_443(0, Global_68531.f_555[0 /*21*/].f_12) || !func_443(1, Global_68531.f_555[0 /*21*/].f_12))) {
...
// Position - 0x32BEC
int func_444(var *uParam0) { return *uParam0; }
...
// Position - 0x32CBA
int func_446(int iParam0, vector3 vParam1, bool bParam4) {
	int iVar0;
	var uVar1[3];
	int iVar5;
	int iVar6;
	...
	case joaat("cuban800"):
		...
		iVar6 = 0;
		while (iVar6 <= iVar5 - 1) {
			if (func_448(iParam0, uVar1[iVar6], 1) &&
				func_447(entity::get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)) {
				if (!bParam4 || func_233(vParam1, 0f, 0f, 0f, 0) ||
...
// Position - 0x32EC2
int func_447(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
	...
	while (iVar0 < 9) {
		if (entity::does_entity_exist(Global_89155[iVar0])) {
			if (iParam0 == 145 || Global_89165[iVar0] == iParam0) {
				if (iParam1 == 0 || entity::get_entity_model(Global_89155[iVar0]) == func_209(iParam0, iParam1)) {
...
// Position - 0x330BE
void func_451(int iParam0, var *uParam1, int iParam2, int iParam3) {
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (gameplay::is_bit_set(uParam1->f_77, 15) || func_454(iParam0) ||
...
// Position - 0x335D1
var func_453() { return dlc2::is_dlc_present(-1691188696); }
...
// Position - 0x3362D
void func_455(vector3 vParam0, float fParam3, int iParam4) {
	int iVar0;
...
// Position - 0x33711
int func_458() { return func_456(&Global_96040.f_2311); }

// Position - 0x33724
void func_459() { func_460(&Global_96040.f_2311); }
...
// Position - 0x33755
bool func_461() { return func_457(&Global_96040.f_2311); }
...
// Position - 0x33866
void func_466(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	vector3 vVar0;
	float fVar3;
	...
	if (func_481() && func_478(iParam1, iParam2, iParam3, 1)) {
		vVar0 = {0f, 0f, 0f};
		fVar3 = 0f;
		func_467(uParam0, vVar0, fVar3, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
...
// Position - 0x338F7
void func_467(var *uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8,
	...
	if (iVar0 == 1) {
		...
		*uParam0 = func_440(vParam1, fParam4);
	}
	else if (iParam9 == 1) {
		if (func_233(vParam1, 0f, 0f, 0f, 0)) {
		...
		if (func_12(iParam12)) {
			func_450(iParam12, 0);
			while (!func_468(uParam0, iParam12, vParam1, fParam4, 1, 0)) {
				system::wait(0);
			}
		}
		else {
...
// Position - 0x33A8A
int func_468(int *iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7) {
	int iVar0;
	var *uVar1;
	struct<97> Var5;
	int iVar103;
		...
		if (Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/] == Var5) {
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/],
				...
				func_361(iParam0, &Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/].f_31,
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/],
				...
				func_361(iParam0, &Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/].f_31,
...
// Position - 0x348C9
void func_469(int iParam0, var *uParam1, int iParam2, int iParam3) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
	...
	if (func_12(iParam0) && entity::does_entity_exist(*uParam1) && vehicle::is_vehicle_driveable(*uParam1, 0)) {
		...
		if (vehicle::get_vehicle_mod_kit(*uParam1) >= 0 && vehicle::get_vehicle_mod_kit(*uParam1) < 255 &&
			func_473(*uParam1, 0, &iVar0)) {
			func_213(uParam1, &Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_31,
			...
			if (iParam3) {
				...
				Global_101700.f_19077[iParam0 /*43*/].f_31 = func_472(*uParam1);
				...
				func_470(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_5,
				...
				func_470(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0,
...
// Position - 0x3555F
bool func_471(int iParam0, char *sParam1, int *iParam2, int *iParam3, int *iParam4) {
	*iParam2 = -1;
	*iParam3 = -1;
	*iParam4 = -1;
	switch (iParam0) {
...
int func_473(int iParam0, int iParam1, int *iParam2) {
	...
	*iParam2 = 0;
	...
	iVar0 = entity::get_entity_model(iParam0);
	if (!func_474(iVar0, iParam1, iParam2)) {
		return 0;
	}
	...
	if (!network::network_is_game_in_progress()) {
		if (func_387(iParam0) && entity::get_entity_model(iParam0) != joaat("sentinel2") &&
...
// Position - 0x3713E
var func_481() { return Global_93635.f_2311.f_8; }
...
// Position - 0x3732F
void func_486(var *uParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	(*uParam0)[0 /*3*/] = {vParam1};
	(*uParam0)[1 /*3*/] = {vParam4};
	uParam0->f_7 = fParam7;
}
...
// Position - 0x378E6
void func_491() {
	vLocal_341[0 /*3*/] = {func_492("MET1INITDRV", 1)};
	vLocal_341[1 /*3*/] = {func_492("MET1TCAR", 1)};
	vLocal_341[2 /*3*/] = {func_492("MET1WAIT", 1)};
	vLocal_341[3 /*3*/] = {func_492("MET1WANT", -1)};
	vLocal_341[4 /*3*/] = {func_492("MET1CHASE", 1)};
	vLocal_341[5 /*3*/] = {func_492("MET1GETBKT", 1)};
	vLocal_341[6 /*3*/] = {func_492("MET1DLT", 1)};
	vLocal_341[7 /*3*/] = {func_492("MET1HOME", 1)};
	vLocal_341[8 /*3*/] = {func_492("MET1HOTEL", 1)};
}
