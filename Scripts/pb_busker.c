...
void func_1() {
	if (system::timerb() > 7000) {
		if (entity::is_entity_at_coord(player::player_ped_id(), vLocal_45, 10f, 10f, 10f, 0, 1, 0) &&
			!entity::is_entity_at_coord(player::player_ped_id(), vLocal_45, 3f, 3f, 3f, 0, 1, 0)) {
			system::settimerb(0);
			...
			if (!entity::is_entity_dead(iLocal_52, 0)) {
				ai::task_perform_sequence(iLocal_52, iLocal_54);
			}
...
void func_2() {
	...
	if (entity::is_entity_at_coord(player::player_ped_id(), vLocal_45, 50f, 50f, 50f, 0, 1, 0)) {
		...
		while (!streaming::has_model_loaded(joaat("a_f_m_bevhills_02")) ||
			   !streaming::has_model_loaded(joaat("g_m_y_mexgoon_02"))) {
			system::wait(0);
		}
		...
		iLocal_52 = ped::create_ped(19, joaat("g_m_y_mexgoon_02"), vLocal_45.x, vLocal_45.y, vLocal_48.z, 0f, 1, 1);
		if (!entity::is_entity_dead(iLocal_52, 0)) {
			ai::open_sequence_task(&iLocal_54);
			ai::task_turn_ped_to_face_coord(0, vLocal_48, 0);
		...
		if (iLocal_51 == 1) {
			...
			iLocal_53 = ped::create_ped(5, joaat("a_f_m_bevhills_02"), vLocal_48, 0f, 1, 1);
			if (!entity::is_entity_dead(iLocal_53, 0)) {
				ai::task_turn_ped_to_face_coord(iLocal_53, vLocal_45, 0);
			}
		}
		iLocal_44 = 1;
	}
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 4:
					if (func_13() || player::get_player_wanted_level(player::player_id()) > 0 || func_11(8, -1) ||
						func_7() || func_6() || Global_101700.f_6647.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						func_6() || func_7() || Global_101700.f_6647.f_919[iVar0] == 5) {
						return false;
					}
					break;
