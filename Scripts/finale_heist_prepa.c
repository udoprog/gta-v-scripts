...
void __EntryFunction__() {
	...
	func_372();
	iLocal_360 =
		ped::add_scenario_blocking_area(402.9022f, -1633.604f, 25.0472f, 315.6288f, -1558.814f, 38.7931f, 0, 1, 1, 1);
	func_371(27, 0);
	if (func_370()) {
	...
	while (true) {
		...
		if (func_368(player::player_ped_id())) {
			...
			switch (iLocal_80) {
			case 0: func_204(); break;

			case 1: func_203(); break;

			case 2: func_97(); break;

			case 3: func_34(); break;

			case 4: func_1(); break;
			}
			if (iLocal_80 != 4) {
				if (iLocal_80 >= 0 && !iLocal_28) {
				}
			}
		}
		system::wait(0);
...
void func_17(var *uParam0, int iParam1) {
	...
	while (iVar0 < 3) {
		...
		if (iVar1 == 8 || iVar1 == 9 || iVar1 == 10 || iVar1 == 11 || iVar1 == 34 || iVar1 == 72 || iVar1 == 73)
			...
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_19(Global_101700.f_17492[iVar0], &vVar2, &fVar5)) {
...
// Position - 0x8F5
void func_18(int *iParam0) { *iParam0 = -15; }
...
int func_19(int iParam0, var *uParam1, float *fParam2) {
	...
	case 9: return func_19(8, uParam1, fParam2);

	case 10: return func_19(8, uParam1, fParam2);
...
void func_34() {
	...
	switch (iLocal_81) {
	case 0:
		if (func_70(iLocal_80, iLocal_28)) {
	...
	case 1:
		...
		if (func_57(Local_456, vLocal_364, &iLocal_356, iLocal_82, iLocal_91, &iLocal_663, &iLocal_385, &iLocal_379,
					&iLocal_380, &iLocal_355, 1090519040)) {
...
// Position - 0x1A62
bool func_44() { return gameplay::is_bit_set(Global_2359301, 3); }
...
// Position - 0x1AF0
int func_48(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	bool bVar0;
	float fVar1;
...
// Position - 0x1DFB
bool func_57(int iParam0, vector3 vParam1, int *iParam4, int iParam5, int iParam6, int *iParam7, int *iParam8,
...
void func_63(int *iParam0, vector3 vParam1, int iParam4) {
	if (!ui::does_blip_exist(*iParam0)) {
		*iParam0 = func_64(vParam1, 5, iParam4);
	}
}

// Position - 0x2138
int func_64(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
...
// Position - 0x21F6
int func_68() { return Global_69964; }

// Position - 0x2202
void func_69(int *iParam0, vector3 vParam1, int *iParam4, int iParam5, int *iParam6, int *iParam7) {
	switch (*iParam4) {
	case 0:
	...
	case 0:
		if (iParam1) {
			...
			if (func_81(2, Local_456.f_1, Local_456.f_4) && func_81(4, vLocal_361, 0) && func_81(3, vLocal_361, 0) &&
				func_81(5, vLocal_361, 0)) {
				iLocal_371 = pathfind::add_navmesh_blocking_object(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f,
																   func_80(229.3746f), 0, 7);
...
void func_71() {
	...
	iLocal_662 = 1;
	func_371(27, 0);
	object::_set_door_acceleration_limit(Global_34904[13 /*31*/], 4, 1, 0);
	iLocal_663 = 0;
}
...
// Position - 0x266D
void func_73(int iParam0, vector3 vParam1, float fParam4) {
	if (func_368(iParam0)) {
...
void func_76() {
	...
	while (iVar0 <= 2) {
		...
		if (!func_77(Local_389[iVar0 /*22*/], -1098463898)) {
			...
			case 0:
			case 1:
				ai::task_start_scenario_at_position(Local_389[iVar0 /*22*/], "WORLD_HUMAN_HANG_OUT_STREET",
													Local_389[iVar0 /*22*/].f_1, Local_389[iVar0 /*22*/].f_4, 0, 0, 1);
				break;

			case 2: ai::task_use_mobile_phone(Local_389[iVar0 /*22*/], 1, 1); break;
			}
		}
...
// Position - 0x2904
float func_80(float fParam0) { return fParam0 * 0.01745329f; }

// Position - 0x2914
bool func_81(int iParam0, vector3 vParam1, float fParam4) {
	int iVar0;
	int iVar1;
	char cVar2[16];
	int iVar6;
	...
	case 3:
		...
		while (iVar0 <= 2) {
			if (entity::does_entity_exist(Global_88321.f_9[iVar0])) {
				if (!ped::is_ped_dead_or_dying(Global_88321.f_9[iVar0], 1)) {
					entity::set_entity_as_mission_entity(Global_88321.f_9[iVar0], 1, 1);
			...
			else if (func_85(&Local_389[iVar0 /*22*/], Local_389[iVar0 /*22*/].f_5, Local_389[iVar0 /*22*/].f_1,
							 Local_389[iVar0 /*22*/].f_4, 0, 0, 0, 1)) {
				func_86(iVar0);
				audio::stop_ped_speaking(Local_389[iVar0 /*22*/], 1);
				ped::set_ped_target_loss_response(Local_389[iVar0 /*22*/], 2);
	...
	case 4:
		...
		while (iVar6 <= 3) {
			if (func_7(Global_88321[iVar6])) {
				entity::set_entity_as_mission_entity(Global_88321[iVar6], 1, 1);
				Local_462[iVar7 /*6*/] = Global_88321[iVar6];
				if (func_7(Local_462[iVar7 /*6*/])) {
					iVar8++;
				}
			}
			else if (func_87(&Local_462[iVar7 /*6*/], Local_462[iVar7 /*6*/].f_5, Local_462[iVar7 /*6*/].f_1,
							 Local_462[iVar7 /*6*/].f_4, 1)) {
				iVar8++;
			}
			iVar7++;
			iVar6++;
	...
	case 5:
		if (func_82(&iLocal_358, joaat("prop_box_guncase_03a"), 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1)) {
			if (func_7(Local_456)) {
				entity::attach_entity_to_entity(iLocal_358, Local_456, 0, 0f, -1.85f, 0.05f,
												entity::get_entity_rotation(Local_456, 2), 0, 0, 0, 0, 2, 1);
...
// Position - 0x2C81
bool func_82(int *iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	if (!entity::does_entity_exist(*iParam0)) {
...
// Position - 0x2D09
bool func_84(int iParam0, char *sParam1, int iParam2) {
...
// Position - 0x2D38
bool func_85(var *uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8,
			 int iParam9) {
		...
		if (func_84(iParam1, "Loading", 0)) {
			*uParam0 = ped::create_ped(26, iParam1, vParam2, fParam5, 1, 1);
			if (func_368(*uParam0)) {
				...
				if (!iParam9) {
					ped::set_ped_can_be_targetted(*uParam0, iParam9);
				}
				if (iParam6) {
					func_83(iParam1, 1);
				}
...
// Position - 0x2E91
bool func_87(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	if (!entity::does_entity_exist(*iParam0)) {
		if (func_84(iParam1, "Loading", 0)) {
...
// Position - 0x2F43
void func_88(int iParam0, int iParam1) { Global_91491.f_22[iParam1] = iParam0; }

// Position - 0x2F57
int func_89(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
// Position - 0x2FD2
void func_90(int *iParam0, var *uParam1, int *iParam2, int *iParam3, int *iParam4, vector3 vParam5, int iParam8,
	...
	if (func_7(*iParam0)) {
		...
		case 0:
			if (ped::is_ped_in_vehicle(player::player_ped_id(), *iParam0, 0)) {
				...
				*iParam2 = 3;
				...
				if (func_65(func_60(func_68(), iParam9), 0, 0)) {
					ui::clear_this_print(func_60(func_68(), iParam9));
				}
				if (func_68() != 33) {
					func_93(iParam0);
				}
		...
		case 2:
		case 1:
			if (!ped::is_ped_in_vehicle(player::player_ped_id(), *iParam0, 0) && !func_96(*iParam0) &&
				!func_95(*iParam0)) {
				func_33(iParam4);
...
int func_95(int iParam0) {
	...
	if (func_368(player::player_ped_id()) && ped::is_ped_in_any_vehicle(player::player_ped_id(), 0) &&
		func_7(iParam0)) {
...
void func_97() {
	...
	case 1:
		...
		if (func_100(Local_456, vLocal_364, &iLocal_356, iLocal_91, iLocal_82, &iLocal_355, &iLocal_385, 0, 0,
					 1086324736)) {
			unk1::_0x293220DA1B46CEBC(5f, 6f, 4);
			iLocal_81 = 2;
		}
...
// Position - 0x363B
bool func_100(int iParam0, vector3 vParam1, int *iParam4, int iParam5, int iParam6, int *iParam7, int *iParam8,
	...
	if (iParam6 == 1 || iParam6 == 2 || iParam6 == 3) {
		if (iParam5 == 0) {
			...
			if (!func_101()) {
				func_66(func_60(func_68(), iParam9), iParam7);
			}
		}
	}
	else if (iParam5 == 0) {
...
int func_106(int iParam0, int iParam1) {
	...
	case 0:
		ai::task_vehicle_mission_coors_target(iParam1, ped::get_vehicle_ped_is_in(iParam1, 0), vLocal_364, 4, 20f,
											  786469, 3.5f, 5f, 1);
		iLocal_83[iParam0] = 3;
		break;
	...
	case 4: iLocal_83[iParam0] = 0; return 1;
	}
	return 0;
}
...
int func_108(int iParam0, int iParam1) {
	...
	case 0:
		if (!gameplay::is_position_occupied(Local_300[iLocal_665 /*4*/], 1.5f, 0, 0, 1, 0, 0, iParam1, 0)) {
			...
			ai::task_follow_nav_mesh_to_coord(iParam1, Local_300[iLocal_665 /*4*/], fVar0, 20000, 0.25f, 0,
											  Local_300[iLocal_665 /*4*/].f_3);
			iLocal_83[iParam0] = 1;
		}
		break;
...
int func_110(int iParam0, int iParam1) {
	if (!func_111()) {
		if (entity::does_entity_exist(Local_456) && vehicle::is_vehicle_driveable(Local_456, 0) &&
			!entity::is_entity_at_coord(Local_456, vLocal_364, 2f, 2f, 2f, 0, 1, 0)) {
			if (!ped::is_ped_injured(player::player_ped_id()) &&
				ped::is_ped_in_vehicle(player::player_ped_id(), Local_456, 0) &&
				player::get_player_wanted_level(player::player_id()) == 0) {
				if (ped::is_ped_in_vehicle(iParam1, Local_456, 0) &&
					vehicle::get_ped_in_vehicle_seat(Local_456, -1, 0) == iParam1) {
					iLocal_87[iParam0] = 2;
					return 1;
				}
			}
...
int func_112(int iParam0, int iParam1) {
	if (!func_111()) {
		if (entity::is_entity_in_angled_area(iParam1, 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f,
											 31.29056f, 3.63f, 0, 1, 0) &&
			entity::is_entity_in_angled_area(player::player_ped_id(), 345.1542f, -1604.173f, 28.29278f, 360.8858f,
											 -1617.23f, 31.29278f, 3.38f, 0, 1, 0)) {
			iLocal_665 = 0;
			iLocal_87[iParam0] = 1;
			return 1;
		}
		else if (entity::is_entity_in_angled_area(iParam1, 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f,
												  31.29278f, 3.63f, 0, 1, 0) &&
				 entity::is_entity_in_angled_area(player::player_ped_id(), 344.9844f, -1604.011f, 28.29278f, 339.7212f,
												  -1599.484f, 31.29056f, 3.38f, 0, 1, 0)) {
			iLocal_665 = 1;
			iLocal_87[iParam0] = 1;
			return 1;
		}
...
void func_118() {
	...
	if (func_368(Local_389[iVar0 /*22*/])) {
		...
		case 1: func_145(iVar0); break;

		case 3: func_119(iVar0); break;
		}
	}
	else {
		if (entity::does_entity_exist(Local_389[iVar0 /*22*/]) && !ped::is_ped_injured(Local_389[iVar0 /*22*/])) {
			if (entity::has_entity_been_damaged_by_entity(Local_389[iVar0 /*22*/], player::player_ped_id(), 1)) {
				...
				if (weapon::is_ped_current_weapon_silenced(player::player_ped_id()) ||
					ped::is_ped_being_stealth_killed(Local_389[iVar0 /*22*/]) ||
					ped::was_ped_killed_by_stealth(Local_389[iVar0 /*22*/]) ||
					ped::was_ped_killed_by_takedown(Local_389[iVar0 /*22*/])) {
					if (!bLocal_374) {
...
void func_119(int iParam0) {
	...
	case 1:
		if (func_143(iParam0) && func_62(Local_389[iParam0 /*22*/], Local_389[iParam0 /*22*/].f_1, 3f)) {
			if (gameplay::get_game_timer() - Local_389[iParam0 /*22*/].f_14 >
				gameplay::get_random_int_in_range(1000, 1500)) {
	...
	case 2:
		if (gameplay::get_game_timer() - Local_389[iParam0 /*22*/].f_14 >
			gameplay::get_random_int_in_range(5000, 6000)) {
	...
	case 3:
		if (gameplay::get_game_timer() - Local_389[iParam0 /*22*/].f_14 >
			gameplay::get_random_int_in_range(2500, 3000)) {
	...
	case 6:
		...
		if (gameplay::get_game_timer() - Local_389[iParam0 /*22*/].f_14 > iVar0) {
			if (!ped::is_ped_being_stunned(Local_389[iParam0 /*22*/], 0) &&
				!ai::is_ped_in_writhe(Local_389[iParam0 /*22*/])) {
				Local_389[iParam0 /*22*/].f_14 = gameplay::get_game_timer();
				func_126(iParam0);
			}
		}
	...
	case 5:
		if (gameplay::get_game_timer() - Local_389[iParam0 /*22*/].f_14 >
			gameplay::get_random_int_in_range(1000, 3000)) {
			func_124();
			return;
		}
		break;
	...
	case 7:
		if (gameplay::get_game_timer() - Local_389[iParam0 /*22*/].f_14 > 350) {
			if (!bLocal_374 && func_123(iParam0, 15)) {
				...
				if (iLocal_660 != -1) {
					if (gameplay::get_game_timer() - iLocal_660 > 12000) {
						...
						if (entity::is_entity_a_ped(iVar1)) {
							...
							if (iVar2 == Local_389[0 /*22*/] || iVar2 == Local_389[1 /*22*/] ||
								iVar2 == Local_389[2 /*22*/]) {
								func_122(2);
							}
						}
					}
				...
				if ((func_77(Local_389[iParam0 /*22*/], -2128726980) ||
					 func_77(Local_389[iParam0 /*22*/], -982327190)) &&
		...
		if (!iLocal_658) {
			if (gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 1) &&
				gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 14)) {
				if (iParam0 == 0) {
					sVar3 = "PRA_COPSHT1";
				}
				else {
...
void func_126(int iParam0) {
	if (Local_389[iParam0 /*22*/].f_20 != 7) {
		if (func_368(Local_389[iParam0 /*22*/])) {
			if (func_77(Local_389[iParam0 /*22*/], 242628503) ||
				ped::is_ped_running_mobile_phone_task(Local_389[iParam0 /*22*/])) {
		...
		if (func_132(iParam0) && func_130(Local_389[iParam0 /*22*/], 30f)) {
			...
			if (gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 3)) {
				iLocal_659 = 1;
					 ...
					 entity::is_entity_in_angled_area(player::player_ped_id(), 362.6359f, -1581.256f, 31.54774f,
													  358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0)) {
				func_128();
				iLocal_656 = 0;
				if (iParam0 == 2) {
					...
					audio::_play_ambient_speech_with_voice(Local_389[iParam0 /*22*/], "ARREST_PLAYER", sVar0,
...
int func_130(int iParam0, float fParam1) {
	...
	if (func_368(player::player_ped_id()) && func_368(iParam0)) {
...
// Position - 0x4845
bool func_132(int iParam0) { return Local_389[iParam0 /*22*/].f_18 > 1; }
	...
	if (Local_389[iParam0 /*22*/].f_18 != 1 && !func_77(Local_389[iParam0 /*22*/], 242628503)) {
		...
		if (iParam0 == 2) {
			...
			if (!func_62(Local_389[iParam0 /*22*/], Local_389[iParam0 /*22*/].f_1, 3f)) {
				ai::task_follow_nav_mesh_to_coord(0, Local_389[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, 0,
												  Local_389[iParam0 /*22*/].f_4);
			}
			else {
			...
			ai::task_perform_sequence(Local_389[iParam0 /*22*/], iVar0);
...
void func_134() {
	if (func_12(&uLocal_92, entity::get_entity_coords(player::player_ped_id(), 1))) {
		if (!func_102()) {
			if (!gameplay::are_strings_equal(&cLocal_666, "NONE") &&
				!gameplay::are_strings_equal(&cLocal_672, "NONE") && !func_65("PR_TAKBACK", 0, 0)) {
...
// Position - 0x4B59
int func_136(char *sParam0, int iParam1, int iParam2) {
	Global_15746 = 0;
...
void func_146(int iParam0) {
	func_168(iParam0);
	if (!func_167(iParam0)) {
		if (func_148(Local_389[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) ||
			fire::is_explosion_in_sphere(-1, entity::get_entity_coords(Local_389[iParam0 /*22*/], 1), 100f)) {
			if (!ped::is_ped_being_stealth_killed(Local_389[iParam0 /*22*/]) &&
				!ped::was_ped_killed_by_stealth(Local_389[iParam0 /*22*/]) &&
				!ped::was_ped_killed_by_takedown(Local_389[iParam0 /*22*/])) {
				func_124();
			}
			else if (!bLocal_374) {
				player::_switch_crime_type(player::player_id(), 41);
...
// Position - 0x529C
int func_148(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6,
			 int iParam7) {
	vector3 vVar0;
	...
	if (func_6(player::player_ped_id()) && func_6(iParam0)) {
		...
		if (func_162(iParam0, iParam1, iParam5, iParam6, iParam7)) {
			return 1;
		}
...
// Position - 0x53CD
bool func_150(int iParam0, float fParam1) { return func_151(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_151(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_152(&Local_38[iVar4 /*4*/], vVar1, iParam1, &Local_38[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_38[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0x54A6
int func_152(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
...
int func_155(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_157(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
...
// Position - 0x589B
bool func_162(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) {
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_6(player::player_ped_id()) && func_6(iParam0)) {
		...
		if (!bParam2) {
			if (func_166(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
...
// Position - 0x5996
bool func_163(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
// Position - 0x5B37
bool func_165(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
// Position - 0x5BC5
bool func_166(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
int func_167(int iParam0) {
	if (entity::is_entity_at_coord(
			...
			entity::get_offset_from_entity_in_world_coords(Local_389[iParam0 /*22*/], 0f, -2f, 0f), 2f, 3f, 2f, 0, 1,
			0) &&
		!weapon::is_ped_armed(player::player_ped_id(), 6)) {
		return 1;
	}
...
void func_168(int iParam0) {
	...
	if (Local_389[iParam0 /*22*/].f_20 != 7 || Local_389[iParam0 /*22*/].f_20 != 6) {
		if (!bLocal_372 && !ped::is_ped_being_stealth_killed(Local_389[iParam0 /*22*/]) &&
			!ped::was_ped_killed_by_stealth(Local_389[iParam0 /*22*/]) &&
			!ped::was_ped_killed_by_takedown(Local_389[iParam0 /*22*/])) {
			func_169(iParam0);
		}
...
void func_169(int iParam0) {
	...
	if (!func_143(iParam0) && Local_389[iParam0 /*22*/].f_20 != 7 && Local_389[iParam0 /*22*/].f_20 != 6 &&
		!bLocal_374 && Local_389[iParam0 /*22*/].f_17) {
		iVar0 = 0;
		while (iVar0 <= 11) {
			if (gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, iVar0)) {
...
void func_170(int iParam0, int iParam1) {
	...
	case 2: func_176(iParam0, 6, 0); break;
	...
	case 6: func_176(iParam0, 2, 0); break;

	case 5: func_176(iParam0, 5, 0); break;
	...
	case 7: func_171(iParam0, 4, 0); break;

	case 10: func_176(iParam0, 1, 0); break;

	case 13: func_176(iParam0, 4, 0); break;

	case 11: func_176(iParam0, 7, 0); break;
	}
}
		...
		if (iParam1 == 2) {
			...
			if (Local_389[func_144(iParam0) /*22*/].f_20 != 5) {
				if (iParam0 == 0) {
					...
					audio::_play_ambient_speech_with_voice(Local_389[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1,
														   "SPEECH_PARAMS_FORCE", 0);
				}
				else if (iParam0 == 1) {
	...
	if (!func_143(iParam0) || iParam2) {
		if (iParam1 == 1) {
			...
			if (Local_389[iParam0 /*22*/].f_19 != 5) {
				...
				audio::_play_ambient_speech_with_voice(Local_389[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE",
													   0);
				func_177(iParam0, iParam1, 0);
			}
		}
...
void func_178(int iParam0) {
	...
	if (!func_143(iParam0) && Local_389[iParam0 /*22*/].f_20 != 6 && Local_389[iParam0 /*22*/].f_20 != 7) {
		...
		if (iParam0 == 0 || iParam0 == 1) {
			if (!iLocal_382) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 340.0758f, -1598.255f, 28.29322f,
													 346.4939f, -1603.684f, 38.29278f, 6.22f, 0, 1, 0)) {
					if (ped::is_ped_falling(player::player_ped_id()) || ped::is_ped_climbing(player::player_ped_id())) {
						...
						if (fVar0 > 16f && !Local_389[iParam0 /*22*/].f_16 &&
							!gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 10) &&
							!entity::is_entity_in_angled_area(player::player_ped_id(), 344.4482f, -1603.473f, 28.29278f,
															  345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0) &&
							entity::is_entity_in_angled_area(Local_389[iParam0 /*22*/], Local_309[1 /*7*/],
															 Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0)) {
							func_180(iParam0, 11);
							return;
						}
					}
				}
				if (entity::is_entity_in_angled_area(player::player_ped_id(), Local_309[1 /*7*/],
													 Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0) &&
					entity::is_entity_in_angled_area(Local_389[iParam0 /*22*/], Local_309[1 /*7*/],
													 Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0) &&
					!gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 10) &&
					!gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 11)) {
					if (fVar0 > 12f && !Local_389[iParam0 /*22*/].f_16 &&
						!entity::is_entity_in_angled_area(player::player_ped_id(), 344.4482f, -1603.473f, 28.29278f,
														  345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0)) {
						func_180(iParam0, 11);
					}
		...
		else if (entity::is_entity_in_angled_area(player::player_ped_id(), Local_309[5 /*7*/], Local_309[5 /*7*/].f_3,
												  Local_309[5 /*7*/].f_6, 0, 1, 0) &&
				 entity::is_entity_in_angled_area(Local_389[iParam0 /*22*/], Local_309[5 /*7*/], Local_309[5 /*7*/].f_3,
												  Local_309[5 /*7*/].f_6, 0, 1, 0)) {
...
void func_181(int iParam0) {
	...
	if (Local_389[iParam0 /*22*/].f_19 != 5 && Local_389[iParam0 /*22*/].f_20 != 6 &&
		Local_389[iParam0 /*22*/].f_20 != 7) {
		bVar0 = false;
		if (func_147(Local_389[iParam0 /*22*/], player::player_ped_id(), 5f, 1) &&
			!ped::is_ped_being_stealth_killed(Local_389[iParam0 /*22*/]) &&
			!ped::was_ped_killed_by_stealth(Local_389[iParam0 /*22*/]) &&
			!ped::was_ped_killed_by_takedown(Local_389[iParam0 /*22*/])) {
...
int func_182(int iParam0) {
	...
	if (Local_389[iParam0 /*22*/].f_20 != 7) {
		if (entity::is_entity_at_coord(
				player::player_ped_id(),
				entity::get_offset_from_entity_in_world_coords(Local_389[iParam0 /*22*/], 1f, -1f, 0f), 1f, 1f, 2f, 0,
				1, 0)) {
			return 1;
		}
	}
...
void func_184(int iParam0) {
	...
	if (Local_389[iParam0 /*22*/].f_20 != 6 && Local_389[iParam0 /*22*/].f_20 != 7) {
		...
		while (iVar0 <= 5) {
			if (Local_389[iParam0 /*22*/].f_16) {
				if (!gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 12)) {
					if (entity::is_entity_in_angled_area(player::player_ped_id(), Local_309[iVar0 /*7*/],
														 Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, 0, 1,
														 0)) {
						iLocal_382 = 1;
						iLocal_381 = gameplay::get_game_timer();
						if (iVar0 == 4) {
			...
			else if (!entity::is_entity_in_angled_area(player::player_ped_id(), Local_309[iVar0 /*7*/],
													   Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, 0, 1,
													   0) ||
					 gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 12)) {
				func_185(iParam0, iVar0);
			}
			iVar0++;
		}
	}
	else if (entity::is_entity_in_angled_area(player::player_ped_id(), Local_309[3 /*7*/], Local_309[3 /*7*/].f_3,
											  Local_309[3 /*7*/].f_6, 0, 1, 0)) {
		func_187(iParam0, 3);
	}
	else {
		func_185(iParam0, 3);
...
void func_185(int iParam0, int iParam1) {
	...
	switch (iParam1) {
	case 1: func_179(iParam0, 10); break;

	case 2: func_179(iParam0, 6); break;
	...
	case 3: func_179(iParam0, 14); break;
	...
	case 4:
		if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			...
			if (func_7(iVar0)) {
				...
				if (!entity::is_entity_in_angled_area(iVar0, Local_309[4 /*7*/], Local_309[4 /*7*/].f_3,
													  Local_309[4 /*7*/].f_6, 0, 1, 0)) {
					func_179(iParam0, 8);
					func_179(iParam0, 7);
				}
	...
	case 5: func_179(iParam0, 4); break;
	}
}
...
void func_187(int iParam0, int iParam1) {
	...
	case 1:
		if (!gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 6) &&
			!gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 1) &&
			!gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 9)) {
		...
		if (func_368(Local_389[iVar0 /*22*/])) {
			...
			if (entity::does_entity_exist(Local_389[iVar0 /*22*/])) {
				if (func_7(player::get_players_last_vehicle())) {
					if (entity::has_entity_been_damaged_by_entity(Local_389[iVar0 /*22*/],
																  player::get_players_last_vehicle(), 1)) {
						entity::clear_entity_last_damage_entity(Local_389[iVar0 /*22*/]);
						func_124();
					}
				}
...
void func_192(int iParam0) {
	...
	case 1:
		if (gameplay::get_game_timer() - Local_389[iParam0 /*22*/].f_14 >
			gameplay::get_random_int_in_range(2500, 3000)) {
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 362.6359f, -1581.256f, 31.54774f, 358.1074f,
												 -1586.615f, 34.29774f, 2f, 0, 1, 0)) {
				func_126(iParam0);
				func_124();
				return;
			}
			if (func_123(iParam0, 12)) {
				...
				if (gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 13) &&
					gameplay::get_game_timer() - iLocal_376 > 2500 && !iLocal_661) {
					if (iParam0 == 0) {
						sVar0 = "PRA_COPST1";
					}
					else if (iParam0 == 1) {
	...
	case 2:
		if (gameplay::get_game_timer() - Local_389[iParam0 /*22*/].f_14 >
			gameplay::get_random_int_in_range(1500, 2000)) {
			if (func_123(iParam0, 12)) {
				func_133(iParam0);
				return;
			}
	...
	case 7:
		if (gameplay::get_game_timer() - Local_389[iParam0 /*22*/].f_14 >
			...
			if (fVar1 < 12f && !Local_389[iParam0 /*22*/].f_16 &&
				!gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 10) &&
				!func_77(Local_389[iParam0 /*22*/], -875674219)) {
		...
		if (!gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 13)) {
			...
			if (bVar0) {
				if (!func_147(player::player_ped_id(), Local_389[iParam0 /*22*/], 10f, 1)) {
					if (!gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 10) &&
						!gameplay::is_bit_set(Local_389[iParam0 /*22*/].f_15, 6)) {
						gameplay::clear_bit(&Local_389[iParam0 /*22*/].f_15, 13);
					}
				}
			}
...
void func_197(int iParam0) {
	if (!func_167(iParam0)) {
		...
		else if (func_148(Local_389[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) ||
				 fire::is_explosion_in_sphere(-1, entity::get_entity_coords(Local_389[iParam0 /*22*/], 1), 100f)) {
			func_124();
		}
...
bool func_198(int iParam0) {
	...
	if (func_368(Local_389[iParam0 /*22*/])) {
		...
		if (entity::is_entity_at_entity(player::player_ped_id(), Local_389[iParam0 /*22*/], fVar0, fVar0, fVar0, 0, 1,
										0)) {
			if (player::is_player_free_aiming_at_entity(player::player_id(), Local_389[iParam0 /*22*/]) ||
				player::is_player_targetting_entity(player::player_id(), Local_389[iParam0 /*22*/])) {
				if (Local_389[iParam0 /*22*/].f_16) {
					return true;
				}
			}
...
void func_199() {
	if (Local_389[0 /*22*/].f_18 == 1 && Local_389[1 /*22*/].f_18 == 1 && Local_389[2 /*22*/].f_18 == 1) {
		if (func_368(Local_389[0 /*22*/]) && func_368(Local_389[1 /*22*/]) &&
			func_12(&uLocal_92, entity::get_entity_coords(player::player_ped_id(), 1)) &&
			func_62(Local_389[0 /*22*/], Local_389[0 /*22*/].f_1, 3f) &&
			func_62(Local_389[1 /*22*/], Local_389[1 /*22*/].f_1, 3f)) {
		...
		else if (func_368(Local_389[2 /*22*/]) &&
				 func_12(&uLocal_144, entity::get_entity_coords(player::player_ped_id(), 1)) &&
				 func_62(Local_389[2 /*22*/], Local_389[2 /*22*/].f_1, 3f)) {
			if (!gameplay::is_bit_set(Local_389[2 /*22*/].f_15, 2) &&
				!gameplay::is_bit_set(Local_389[2 /*22*/].f_15, 4)) {
	...
	if (!*iParam1) {
		if (!func_102() && cam::is_screen_faded_in()) {
			if (func_130(iParam0, fParam3) && !func_65("PR_TAKBACK", 0, 0)) {
				*iParam1 = func_201(&uLocal_483, cLocal_482, sParam2, iParam4, 0, 0, 0);
			}
		}
	}
...
void func_203() {
	...
	case 0:
		if (func_70(iLocal_80, iLocal_28)) {
			...
			if (object::_does_door_exist(Global_34904[13 /*31*/])) {
				audio::_0x06C0023BED16DD6B(Global_34904[13 /*31*/], 1);
			}
			iLocal_678 = 0;
	...
	case 1:
		if (player::get_player_wanted_level(player::player_id()) < 3) {
			if (func_368(Local_389[2 /*22*/])) {
				if (ped::is_ped_in_any_heli(player::player_ped_id())) {
					if (entity::is_entity_in_angled_area(player::player_ped_id(), 371.9393f, -1604.252f, 45.603f,
														 399.8371f, -1627.065f, 31.75287f, 32.73f, 0, 1, 2) ||
		...
		if (ped::is_ped_climbing(player::player_ped_id()) && iLocal_678 == 0 &&
			func_131(Local_456, player::player_ped_id(), 1) < 100f) {
...
void func_204() {
	...
	case 0:
		if (func_70(iLocal_80, 0)) {
			...
			gameplay::clear_area_of_peds(369.0115f, -1609.116f, 28.2928f, 5f, 0);
			gameplay::clear_area_of_peds(Local_389[0 /*22*/].f_1, 5f, 0);
			if (func_264(player::player_ped_id(), 12, 4) || func_264(player::player_ped_id(), 12, 3)) {
				bLocal_372 = true;
			}
			func_216();
			func_214(78);
	...
	case 2: func_98(0); break;
	}
}

// Position - 0x7D62
void func_205(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	int iVar1;
...
// Position - 0x7DD1
void func_206() { Global_17151.f_6 = 1; }
...
// Position - 0x8035
var func_213() { return gameplay::is_bit_set(Global_91491.f_20, 13); }
...
void func_214(int iParam0) {
	...
	case 68: func_215(11); break;

	case 78: func_215(14); break;

	case 79: func_215(3); break;
...
// Position - 0x80D7
void func_215(int iParam0) { gameplay::set_bit(&Global_87679, iParam0); }
...
// Position - 0x8126
void func_217(int iParam0, vector3 vParam1, var uParam4, int iParam5, int iParam6) {
	struct<60> Var0;
	...
	if (entity::does_entity_exist(iParam0) && vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		func_252(iParam5, &Var0, vParam1, uParam4, func_258(iParam0));
...
int func_220(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_235(iParam0, 0, 0) ||
		func_235(iParam0, 1, 0) || func_235(iParam0, 2, 0) || func_258(iParam0) != 145 || func_234(iParam0) ||
		func_233(iParam0) || func_232(iParam0) || func_231(iParam0) || !func_221(entity::get_entity_model(iParam0))) {
		if (func_233(iParam0)) {
		}
		if (func_233(iParam0)) {
		}
...
// Position - 0x97AD
int func_226() { return 0; }

// Position - 0x97B6
int func_227() { return 1; }

// Position - 0x97BF
int func_228() { return 1; }
...
// Position - 0x9AF2
bool func_236(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
var func_238() {
	...
	func_248(&iVar0, time::get_clock_seconds());
	func_247(&iVar0, time::get_clock_minutes());
	func_246(&iVar0, time::get_clock_hours());
	func_241(&iVar0, time::get_clock_day_of_month());
	func_240(&iVar0, time::get_clock_month());
	func_239(&iVar0, time::get_clock_year());
	return iVar0;
}
...
var func_243(int iParam0) {
	return (system::shift_right(iParam0, 26) & 31) * func_244(gameplay::is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
// Position - 0x9E14
int func_245(var uParam0) { return uParam0 & 15; }
...
// Position - 0xB867
void func_252(int iParam0, var *uParam1, vector3 vParam2, var uParam5, int iParam6) {
	if (func_249(&Global_68531.f_555[0 /*21*/], iParam0)) {
...
int func_264(int iParam0, int iParam1, int iParam2) {
	...
	else if (Global_69523[1 /*14*/].f_3 == ped::get_ped_drawable_variation(iParam0, func_265(iParam1)) &&
			 Global_69523[1 /*14*/].f_4 == ped::get_ped_texture_variation(iParam0, func_265(iParam1))) {
		return 1;
	}
	return 0;
}
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_270(iParam0, iParam2, 14, 3), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_270(iParam0, iParam2, 1, 3), -1842686353, 0);
			}
			break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_270(iParam0, iParam2, 14, 4), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_270(iParam0, iParam2, 1, 4), -1842686353, 0);
			}
			break;
		}
		break;
...
int func_270(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == 12) {
		...
		iVar41 = dlc1::_get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_265(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41) {
...
// Position - 0xD2A8
bool func_273(int iParam0, int iParam1, int iParam2, int iParam3) {
	if (iParam0 == joaat("player_zero")) {
		if (iParam1 == 6) {
			if (iParam2 == 10) {
				return true;
...
// Position - 0xD6A9
bool func_274(int iParam0, int iParam1, int iParam2, int iParam3) {
	switch (iParam0) {
	case joaat("player_zero"):
		if (iParam1 == 14) {
...
struct<10> func_276(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		switch (iParam1) {
		case 31: func_279(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 0: func_279(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_279(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_279(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_279(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_279(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8); break;

		case 5: func_279(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8); break;

		case 6: func_279(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_279(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_279(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_279(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8); break;

		default: func_277(&Var1, iParam0, iParam1, 10); break;
		}
		break;
	...
	case joaat("player_one"):
		...
		case 1: func_279(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8); break;

		case 2: func_279(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8); break;

		case 3: func_279(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_279(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_279(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_279(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_279(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_279(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_277(&Var1, iParam0, iParam1, 9); break;
		}
		break;
	...
	case joaat("player_two"):
		...
		case 0: func_279(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_279(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_279(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_279(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8); break;

		case 4: func_279(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8); break;

		case 5: func_279(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_279(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_279(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_279(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8); break;
	...
	case joaat("mp_m_freemode_01"):
		...
		case 0: func_279(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_279(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_279(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_279(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_279(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_279(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_279(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_279(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_279(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_279(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_279(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_279(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_279(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_279(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 14: func_279(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_279(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_279(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_279(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_279(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_279(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_279(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_279(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_279(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_279(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 24: func_279(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_277(&Var1, iParam0, iParam1, 25); break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 0: func_279(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_279(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_279(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_279(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_279(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_279(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_279(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_279(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_279(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_279(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_279(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_279(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_279(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_279(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8); break;

		case 14: func_279(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_279(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_279(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_279(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_279(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_279(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_279(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_279(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_279(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_279(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8); break;
			...
			while (iVar19 < Var1.f_3) {
				if (dlc1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1) {
					if (vVar16.x != 0 && vVar16.x != -1 && vVar16.x != 1849449579) {
						(*iParam0)[vVar16.z] = func_278(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1) {
...
int func_278(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == 12) {
		...
		iVar38 = 0;
		iVar39 = dlc1::_get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_265(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39) {
...
struct<17> func_280(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		...
		case 1: func_283(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0); break;

		case 2: func_283(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8); break;

		case 3: func_283(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31); break;

		case 4: func_283(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2); break;

		case 5:
			func_283(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[0], Global_101700.f_2095.f_539.f_200[0], 6, 3, 0,
					 0, 0, -99, 0, 0, 3);
			break;

		case 6: func_283(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_283(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 8: func_283(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 9: func_283(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 10: func_283(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4); break;

		case 11: func_283(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5); break;

		case 12: func_283(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31); break;

		case 13: func_283(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 14: func_283(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6); break;

		case 15: func_283(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31); break;

		case 16: func_283(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31); break;

		case 17: func_283(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 18: func_283(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7); break;

		case 19: func_283(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 20: func_283(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 21: func_283(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_283(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 23: func_283(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31); break;

		case 24: func_283(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31); break;

		case 25: func_283(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 26: func_283(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 27: func_283(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 28: func_283(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 29: func_283(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 30: func_283(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 31: func_283(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31); break;

		case 32: func_283(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 33: func_283(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 34: func_283(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31); break;

		case 35: func_283(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 36: func_283(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 37: func_283(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 38: func_283(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 39: func_283(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 40: func_283(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 41: func_283(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_283(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_283(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_283(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 45: func_283(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 46: func_283(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_283(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 48: func_283(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31); break;

		case 49: func_283(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 50: func_283(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9); break;

		case 51: func_283(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 52: func_283(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		default: func_281(&Var1, iParam0, iParam1, 53); break;
		}
		break;

	case joaat("player_one"):
		switch (iParam1) {
		case 0: func_283(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 1: func_283(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 2:
			func_283(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[1], Global_101700.f_2095.f_539.f_200[1], 17, 2,
					 26, 0, 0, -99, 0, 45, 31);
			break;

		case 3: func_283(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1); break;

		case 4: func_283(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2); break;

		case 5: func_283(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 6: func_283(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_283(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3); break;

		case 8: func_283(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5); break;

		case 9: func_283(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 10: func_283(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 11: func_283(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 12: func_283(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 13: func_283(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 14: func_283(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 15: func_283(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 16: func_283(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 17: func_283(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 18: func_283(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31); break;

		case 19: func_283(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 20: func_283(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 21: func_283(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4); break;

		case 22: func_283(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31); break;

		case 23: func_283(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31); break;

		case 24: func_283(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31); break;

		case 25: func_283(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31); break;

		case 26: func_283(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31); break;

		case 27: func_283(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31); break;

		case 28: func_283(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31); break;

		case 29: func_283(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31); break;

		case 30: func_283(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31); break;

		case 31: func_283(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31); break;

		case 32: func_283(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31); break;

		case 33: func_283(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31); break;

		case 34: func_283(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31); break;

		case 35: func_283(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31); break;

		case 36: func_283(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31); break;

		case 37: func_283(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31); break;

		case 38: func_283(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 39: func_283(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 40: func_283(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 41: func_283(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 42: func_283(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31); break;

		case 43: func_283(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6); break;

		case 44: func_283(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 45: func_283(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8); break;

		case 46: func_283(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31); break;

		default: func_281(&Var1, iParam0, iParam1, 47); break;
		}
		break;

	case joaat("player_two"):
		switch (iParam1) {
		case 0: func_283(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 1: func_283(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8); break;

		case 2: func_283(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1); break;

		case 3: func_283(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2); break;

		case 4:
			func_283(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[2], Global_101700.f_2095.f_539.f_200[2], 8, 0, 0,
					 0, 0, -99, 0, 0, 31);
			break;

		case 5: func_283(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6); break;

		case 6: func_283(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3); break;

		case 7: func_283(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4); break;

		case 8: func_283(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31); break;

		case 9: func_283(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 10: func_283(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 11: func_283(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5); break;

		case 12: func_283(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 13: func_283(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31); break;

		case 14: func_283(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31); break;

		case 15: func_283(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 16: func_283(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 17: func_283(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 18: func_283(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 19: func_283(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 20: func_283(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 21: func_283(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_283(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 23: func_283(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 24: func_283(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 25: func_283(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 26: func_283(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 27: func_283(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 28: func_283(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 29: func_283(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 30: func_283(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 31: func_283(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 32: func_283(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 33: func_283(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 34: func_283(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 35: func_283(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 36: func_283(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 37: func_283(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 38: func_283(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 39: func_283(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 40: func_283(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 41: func_283(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_283(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_283(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_283(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31); break;

		case 45: func_283(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 46: func_283(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_283(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31); break;

		default: func_281(&Var1, iParam0, iParam1, 48); break;
		}
		break;

	case joaat("mp_m_freemode_01"):
		switch (iParam1) {
		case 0: func_283(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31); break;

		case 1: func_283(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0); break;

		case 2: func_283(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1); break;

		case 3: func_283(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2); break;

		case 4: func_283(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3); break;

		case 5: func_283(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4); break;

		case 6: func_283(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5); break;

		case 7: func_283(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6); break;

		case 8: func_283(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7); break;

		case 9: func_283(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8); break;

		case 10: func_283(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9); break;

		case 11: func_283(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10); break;

		case 12: func_283(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11); break;

		case 13: func_283(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12); break;

		case 14: func_283(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13); break;

		case 15: func_283(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14); break;

		case 16: func_283(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15); break;

		case 17: func_283(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16); break;

		case 18: func_283(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17); break;

		case 19: func_283(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18); break;

		case 20: func_283(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19); break;

		case 21: func_283(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20); break;

		case 22: func_283(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21); break;

		case 23: func_283(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22); break;

		case 24: func_283(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23); break;

		case 25: func_283(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24); break;

		default: func_281(&Var1, iParam0, iParam1, 26); break;
		}
		break;

	case joaat("mp_f_freemode_01"):
		switch (iParam1) {
		case 0: func_283(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31); break;

		case 1: func_283(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31); break;

		case 2: func_283(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0); break;

		case 3: func_283(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1); break;

		case 4: func_283(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2); break;

		case 5: func_283(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3); break;

		case 6: func_283(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4); break;

		case 7: func_283(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5); break;

		case 8: func_283(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6); break;

		case 9: func_283(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7); break;

		case 10: func_283(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8); break;

		case 11: func_283(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9); break;

		case 12: func_283(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10); break;

		case 13: func_283(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31); break;

		case 14: func_283(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11); break;

		case 15: func_283(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12); break;

		case 16: func_283(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13); break;

		case 17: func_283(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14); break;

		case 18: func_283(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15); break;

		case 19: func_283(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16); break;

		case 20: func_283(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17); break;

		case 21: func_283(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31); break;

		case 22: func_283(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18); break;

		case 23: func_283(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19); break;

		case 24: func_283(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20); break;

		case 25: func_283(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21); break;

		case 26: func_283(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22); break;

		case 27: func_283(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23); break;

		default: func_281(&Var1, iParam0, iParam1, 28); break;
		}
		break;
	}
	return Var1;
			...
			if (dlc1::_get_prop_from_outfit(Var1.f_1, iVar36, &vVar16)) {
				if (vVar16.x != 0 && vVar16.x != -1 && vVar16.x != 1849449579) {
					...
					if (vVar16.z == 10 && uParam0->f_16) {
						(*uParam0)[func_282(vVar16.z)] = vVar16.x;
						uParam0->f_16 = 1;
					}
					else {
						(*uParam0)[func_282(vVar16.z)] = func_278(iParam1, vVar16.x, func_282(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1) {
					(*uParam0)[func_282(vVar16.z)] = vVar16.y;
				}
			}
			iVar36++;
		}
...
// Position - 0x106C6
void func_283(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
void func_286(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 155); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

// Position - 0x11AEF
void func_287(var *uParam0, int iParam1, int iParam2, char *sParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	*uParam0 = iParam9;
	...
	if (iParam10) {
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 ||
			...
			iVar0 = func_290(func_292(iParam1, uParam0->f_2), Global_69521, 0);
...
int func_290(int iParam0, int iParam1, int iParam2) {
	...
	iVar0 = Global_2503826[iParam0 /*3*/][func_291(iParam1)];
...
// Position - 0x12AE1
bool func_293(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	if (iParam0 == 0) {
		if (iParam5 == 1) {
...
int func_294(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_295(iParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3)) {
		iVar3 = func_290(iVar2, iVar0, 0);
...
// Position - 0x13A41
bool func_295(int iParam0, int iParam1, int *iParam2, int *iParam3, bool bParam4, bool bParam5) {
	int iVar0;
...
void func_297(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 == 12) {
		...
		while (iVar38 < iVar40) {
			...
			if (!dlc1::_is_dlc_data_empty(Var20)) {
				if (iVar39 == iParam1 - iParam2) {
					...
					func_287(&Global_69523[0 /*14*/], iParam0, iParam1, &Var20.f_9, Var20.f_3, Var20.f_4, Var20.f_5,
		...
		iVar59 = 0;
		iVar60 = dlc1::_get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_265(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60) {
			...
			if (!dlc1::_is_dlc_data_empty(Var41)) {
				if (iVar59 == iParam1 - iParam2) {
					...
					func_287(&Global_69523[0 /*14*/], iParam0, iParam1, &Var41.f_9, Var41.f_3, Var41.f_4, Var41.f_5,
...
void func_298(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 9); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_299(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 48); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_300(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 1); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_302(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 6); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_303(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 33); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_304(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 17); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_305(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 18); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_306(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 7); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_307(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 84); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_308(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 104); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_314(int iParam0, int iParam1) {
	...
	case 3: func_327(iParam1); break;

	case 4: func_326(iParam1); break;

	case 6: func_325(iParam1); break;

	case 5: func_324(iParam1); break;

	case 8: func_323(iParam1); break;

	case 9: func_322(iParam1); break;

	case 10: func_321(iParam1); break;

	case 1: func_320(iParam1); break;

	case 7: func_319(iParam1); break;

	case 11: func_318(iParam1); break;

	case 12: func_317(iParam1); break;

	case 13: func_316(iParam1); break;

	case 14: func_315(iParam1); break;
	}
}
...
void func_315(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 175); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_317(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 47); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_318(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 63); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_320(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 5); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_321(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 53); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_322(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 12); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_323(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 77); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_325(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 134); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_326(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 117); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_331(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 21); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_332(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 10); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_333(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_350(iParam1); break;

	case 2: func_349(iParam1); break;
...
void func_334(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 113); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_337(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 45); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_341(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 20); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_342(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 24); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_343(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 14); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_344(int iParam0) {
	...
	default: func_297(iVar10, iParam0, 99); return;
	}
	func_287(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_355() {
	if (bLocal_374) {
		if (ped::is_cop_ped_in_area_3d(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) ||
			entity::is_entity_in_angled_area(player::player_ped_id(), 390.4927f, -1621.07f, 28.29278f, 406.0266f,
											 -1604.358f, 35.2086f, 15f, 0, 1, 0)) {
			if (func_12(&uLocal_196, entity::get_entity_coords(player::player_ped_id(), 1))) {
		...
		if (entity::is_entity_in_angled_area(player::player_ped_id(), 390.4927f, -1621.07f, 28.29278f, 406.0266f,
											 -1604.358f, 35.2086f, 15f, 0, 1, 0) ||
			ped::is_cop_ped_in_area_3d(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f)) {
			func_357(Global_34904[13 /*31*/], &fLocal_370);
		}
		else {
			func_356(Global_34904[13 /*31*/], &fLocal_370);
...
void func_362() {
	if (iLocal_80 != 2 && iLocal_80 != 3) {
		if (!func_62(player::player_ped_id(), 372.0053f, -1604.076f, 36.7536f, 100f) && !iLocal_387) {
			func_364("PR_AREAWARN", &iLocal_387);
		}
		else if (!func_62(player::player_ped_id(), 372.0053f, -1604.076f, 36.7536f, 170f) && iLocal_387) {
			func_363(3);
		}
	}
}
...
void func_363(int iParam0) {
	...
	case 1: sLocal_353 = "PR_FWRECK"; break;

	case 2: sLocal_353 = "PR_FSTUCK"; break;

	case 3: sLocal_353 = "PR_FLEFT"; break;

	case 4: sLocal_353 = "PR_FLEFTV"; break;
	}
	iLocal_80 = 4;
	iLocal_81 = 0;
}
...
void func_365() {
	if (!func_7(Local_456)) {
		...
		func_366();
		if (iLocal_80 == 2 || iLocal_80 == 3) {
			if (!func_147(player::player_ped_id(), Local_456, 50f, 1) && !iLocal_388) {
				func_364("PR_VANWARN", &iLocal_388);
			}
			else if (!func_147(player::player_ped_id(), Local_456, 100f, 1) && iLocal_388) {
				func_363(4);
			}
		}
	}
...
// Position - 0x268BD
void func_369(vector3 vParam0, float fParam3, int iParam4, int iParam5) {
	if (func_370()) {
...
// Position - 0x26AFD
struct<7> func_374(vector3 vParam0, vector3 vParam3, float fParam6) {
	struct<7> Var0;
...
void func_376() {
	...
	object::_set_door_acceleration_limit(Global_34904[13 /*31*/], 1, 1, 0);
...
// Position - 0x26FE0
struct<22> func_383(vector3 vParam0, float fParam3, int iParam4) {
	struct<22> Var0;
...
// Position - 0x270A5
struct<6> func_385(vector3 vParam0, float fParam3, int iParam4) {
	struct<6> Var0;
...
void func_387() {
	...
	func_398(1);
	if (object::_does_door_exist(Global_34904[13 /*31*/])) {
		audio::_0x06C0023BED16DD6B(Global_34904[13 /*31*/], 0);
	}
	object::_set_door_ajar_angle(Global_34904[13 /*31*/], 0f, 1, 1);
	object::_set_door_acceleration_limit(Global_34904[13 /*31*/], 4, 1, 1);
...
// Position - 0x273B0
void func_397() { Global_87679 = 0; }

// Position - 0x273BD
void func_398(int iParam0) { Global_89130 = iParam0; }
