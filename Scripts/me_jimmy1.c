...
void __EntryFunction__() {
	...
	while (true) {
		...
		switch (iLocal_388) {
		case 0: func_374(); break;

		case 1: func_366(); break;

		case 2: func_320(); break;

		case 3: func_239(); break;

		case 4: func_236(); break;

		case 5: func_215(); break;

		case 6: func_205(); break;

		case 7: func_62(); break;
...
void func_3() {
	...
	if (entity::does_entity_exist(iLocal_392) && ped::is_ped_injured(iLocal_392)) {
		...
		if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(iLocal_392, 1), 2f) &&
			!fire::is_explosion_in_sphere(13, entity::get_entity_coords(iLocal_392, 1), 2f)) {
			ped::set_ped_can_ragdoll(iLocal_392, 1);
			ped::set_ped_to_ragdoll(iLocal_392, 500, 1000, 0, 0, 0, 0);
			entity::set_entity_health(iLocal_392, 99);
			...
			if (weapon::has_ped_been_damaged_by_weapon(iLocal_392, 0, 2) ||
				entity::has_entity_been_damaged_by_any_vehicle(iLocal_392)) {
				...
				ai::task_perform_sequence(iLocal_392, iVar0);
				ai::clear_sequence_task(&iVar0);
				func_2(1);
			}
		}
		else {
			if (func_35(iLocal_403) && (ped::is_ped_in_vehicle(iLocal_392, iLocal_403, 0) ||
										entity::is_entity_playing_anim(iLocal_392, sLocal_272, "back", 2) ||
										entity::is_entity_playing_anim(iLocal_392, sLocal_272, "base", 2) ||
										entity::is_entity_playing_anim(iLocal_392, sLocal_272, "enter_back", 2) ||
										entity::is_entity_playing_anim(iLocal_392, sLocal_272, "enter_backseat", 2) ||
										entity::is_entity_playing_anim(iLocal_392, sLocal_272, "exit_back", 2))) {
				if (fire::is_entity_on_fire(iLocal_403)) {
					func_2(1);
				}
			}
			if (player::is_player_free_aiming(player::player_id()) &&
				func_34(player::player_ped_id(), iLocal_392, 50f, 1) && func_33(iLocal_392, 1126825984) &&
				func_24(player::player_ped_id(), iLocal_392, 90f, 1, 250, 7)) {
...
bool func_24(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_25(&Local_52[iVar4 /*4*/], vVar1, iParam1, &Local_52[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_52[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0xF44
int func_25(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
...
int func_28(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_30(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
...
// Position - 0x12CA
bool func_33(int iParam0, float fParam1) { return func_24(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
void func_37() {
	...
	case 0:
		...
		case 1: sVar0 = "MEJ1_FAIL4"; break;

		case 2: sVar0 = "MEJ1_FAIL1"; break;

		case 3: sVar0 = "MEJ1_FAIL2"; break;

		case 4: sVar0 = "MEJ1_FAIL3"; break;

		case 5: sVar0 = "MEJ1_FAIL5"; break;
		}
		if (iLocal_390 == 0) {
			func_52(0);
		}
...
void func_54(var *uParam0, int iParam1) {
	...
	while (iVar0 < 3) {
		...
		if (iVar1 == 8 || iVar1 == 9 || iVar1 == 10 || iVar1 == 11 || iVar1 == 34 || iVar1 == 72 || iVar1 == 73)
			...
			vVar2 = {0f, 0f, 0f};
			fVar5 = 0f;
			if (!func_56(Global_101700.f_17492[iVar0], &vVar2, &fVar5)) {
...
// Position - 0x1CAA
void func_55(int *iParam0) { *iParam0 = -15; }
...
int func_56(int iParam0, var *uParam1, float *fParam2) {
	...
	case 9: return func_56(8, uParam1, fParam2);

	case 10: return func_56(8, uParam1, fParam2);
	...
	if (func_36(player::player_ped_id()) && func_36(iLocal_392)) {
		...
		case 0:
			...
			if (func_43(iVar0)) {
				...
				ai::task_perform_sequence(iLocal_392, iVar1);
			...
			if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 1) &&
				...
				ped::is_ped_in_any_vehicle(iLocal_392, 1) && !ped::is_ped_sitting_in_any_vehicle(iLocal_392) ||
				ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_ragdoll(iLocal_392)) {
				func_80(500, 1);
				system::wait(1000);
				...
				ai::task_perform_sequence(iLocal_392, iVar2);
		...
		case 1:
			...
			if (!func_21()) {
				if (func_43(iLocal_403) && func_36(iLocal_392) && ped::is_ped_in_vehicle(iLocal_392, iLocal_403, 0) &&
					vehicle::is_vehicle_seat_free(iLocal_403, 0, 0)) {
		...
		case 2:
			if (func_43(iVar0)) {
				...
				if (vehicle::is_vehicle_stopped(iVar0)) {
					...
					ai::task_perform_sequence(iLocal_392, iVar3);
		...
		case 3:
			...
			if (!func_21() && func_76(iLocal_392, vLocal_296, 4f) || bLocal_300 ||
				gameplay::get_game_timer() > iLocal_299) {
				if (bLocal_300) {
					if (func_21()) {
						func_22();
					}
	...
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_72(player::player_id()) &&
				!func_69(player::player_id(), 0) && !func_68()) {
...
// Position - 0x2F35
bool func_68() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x302C
bool func_73() { return gameplay::is_bit_set(Global_2359301, 3); }
...
// Position - 0x31B2
int func_81(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
void func_205() {
	...
	if (func_36(player::player_ped_id()) && func_36(iLocal_392)) {
		...
		case 1:
			...
			if (!func_21()) {
				if (func_34(player::player_ped_id(), iLocal_392, 5f, 1)) {
					if (func_43(iLocal_403) && func_36(iLocal_392) &&
						ped::is_ped_in_vehicle(iLocal_392, iLocal_403, 0) &&
						vehicle::is_vehicle_seat_free(iLocal_403, 0, 0)) {
						if (func_39(&uLocal_107, "MEJ1AUD", "MEJ1_HOME2", 7, 0, 0, 0) || func_38(&iLocal_457, 5000)) {
							iLocal_389 = 2;
						}
		...
		case 3:
			...
			if (!func_21() && (func_76(iLocal_392, vLocal_287, 2f) || func_76(iLocal_392, vLocal_290, 2f)) ||
				bLocal_300 || gameplay::get_game_timer() > iLocal_299) {
				if (bLocal_300) {
					if (func_21()) {
						func_22();
					}
...
// Position - 0x207C0
void func_206(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
			  int iParam14, int iParam15, int iParam16, int iParam17, int iParam18) {
	func_207(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

// Position - 0x207EA
void func_207(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
...
// Position - 0x20C77
bool func_210(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
// Position - 0x20D4F
bool func_211(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	vector3 vVar9;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (func_212(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_212(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_212(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_212(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_212(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_212(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_212(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_212(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_212(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_212(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_212(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_212(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_212(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_212(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_212(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_212(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x21045
int func_212(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
// Position - 0x2115E
Vector3 func_214() { return 2.55f, 5.665f, 2.55f; }

// Position - 0x21175
void func_215() {
	func_235();
	func_230(&iLocal_459, &uLocal_107, "MEJ1AUD", &sLocal_460, &cLocal_466);
	switch (iLocal_389) {
	case 0:
		func_61(&iLocal_391);
...
void func_216() {
	if (func_36(iLocal_392) && func_43(iLocal_403)) {
		...
		case 2:
			...
			ped::set_synchronized_scene_looped(iLocal_273, 0);
			ped::_set_synchronized_scene_occlusion_portal(iLocal_273, 1);
			ped::attach_synchronized_scene_to_entity(iLocal_273, iLocal_403,
													 entity::get_entity_bone_index_by_name(iLocal_403, sLocal_275));
			ai::task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "enter_back", 8f, -8f, 4, iLocal_276,
										1148846080, 0);
			iLocal_322 = 0;
			iLocal_323 = -1;
			iLocal_274 = 12;
		...
		case 3:
			if (ped::is_synchronized_scene_running(iLocal_273)) {
				if (iLocal_277 || !vehicle::is_vehicle_window_intact(iLocal_403, 7)) {
					...
					switch (func_218()) {
					case 0: iLocal_274 = 4; break;

					case 2: iLocal_274 = 8; break;
					}
				}
			}
			break;
		...
		case 4:
			...
			ped::attach_synchronized_scene_to_entity(iLocal_273, iLocal_403,
													 entity::get_entity_bone_index_by_name(iLocal_403, sLocal_275));
			ai::task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "enter_left", 8f, -8f, 4, iLocal_276,
										1148846080, 0);
			iLocal_274 = 5;
			break;
		...
		case 5:
			if (ped::is_synchronized_scene_running(iLocal_273)) {
				if (ped::get_synchronized_scene_phase(iLocal_273) >= 0.9f) {
					iLocal_273 = ped::create_synchronized_scene(0f, 0f, 0f, 0f, 0f, 0f, 2);
					ped::set_synchronized_scene_looped(iLocal_273, 1);
					ped::_set_synchronized_scene_occlusion_portal(iLocal_273, 0);
					ped::attach_synchronized_scene_to_entity(
						iLocal_273, iLocal_403, entity::get_entity_bone_index_by_name(iLocal_403, sLocal_275));
					ai::task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "left", 8f, -8f, 4, iLocal_276,
												1148846080, 0);
					iLocal_274 = 6;
				}
			}
		...
		case 7:
			...
			ped::attach_synchronized_scene_to_entity(iLocal_273, iLocal_403,
													 entity::get_entity_bone_index_by_name(iLocal_403, sLocal_275));
			ai::task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "exit_left", 8f, -8f, 4, iLocal_276,
										1148846080, 0);
		...
		case 8:
			...
			ped::attach_synchronized_scene_to_entity(iLocal_273, iLocal_403,
													 entity::get_entity_bone_index_by_name(iLocal_403, sLocal_275));
			ai::task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "enter_right", 8f, -8f, 4, iLocal_276,
										1148846080, 0);
			iLocal_274 = 9;
			break;
		...
		case 9:
			if (ped::is_synchronized_scene_running(iLocal_273)) {
				if (ped::get_synchronized_scene_phase(iLocal_273) >= 0.9f) {
					...
					ped::attach_synchronized_scene_to_entity(
						iLocal_273, iLocal_403, entity::get_entity_bone_index_by_name(iLocal_403, sLocal_275));
					ai::task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "right", 8f, -8f, 4, iLocal_276,
												1148846080, 0);
					iLocal_274 = 10;
				}
			}
		...
		case 11:
			...
			ped::attach_synchronized_scene_to_entity(iLocal_273, iLocal_403,
													 entity::get_entity_bone_index_by_name(iLocal_403, sLocal_275));
			ai::task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "exit_right", 8f, -8f, 4, iLocal_276,
										1148846080, 0);
			if (iLocal_277 || !vehicle::is_vehicle_window_intact(iLocal_403, 7)) {
				iLocal_274 = 13;
			}
		...
		case 12:
			if (ped::is_synchronized_scene_running(iLocal_273)) {
				if (ped::get_synchronized_scene_phase(iLocal_273) >= 0.9f) {
					...
					ped::attach_synchronized_scene_to_entity(
						iLocal_273, iLocal_403, entity::get_entity_bone_index_by_name(iLocal_403, sLocal_275));
					ai::task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "back", 8f, -8f, 4, iLocal_276,
												1148846080, 0);
					iLocal_274 = 3;
				}
			}
		...
		case 14:
			...
			ped::attach_synchronized_scene_to_entity(iLocal_273, iLocal_403,
													 entity::get_entity_bone_index_by_name(iLocal_403, sLocal_275));
			ai::task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "exit_back", 4f, -8f, 4, iLocal_276,
										1148846080, 0);
			iLocal_274 = 15;
			break;
		...
		case 15:
			if (ped::is_synchronized_scene_running(iLocal_273)) {
				if (ped::get_synchronized_scene_phase(iLocal_273) >= 0.95f) {
					...
					ai::task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "enter_backseat", 8f, -8f, 4,
												iLocal_276, 1148846080, 0);
					iLocal_274 = 16;
				}
			}
			else {
...
int func_218() {
	...
	if (func_43(iLocal_403) && func_34(iLocal_403, player::player_ped_id(), 10f, 1)) {
		vVar0 = {entity::get_offset_from_entity_given_world_coords(
			iLocal_403, entity::get_entity_coords(player::player_ped_id(), 1))};
		if (vVar0.y < -1f) {
			return 1;
		}
		else if (vVar0.x < -1f) {
...
// Position - 0x21A83
float func_219(int iParam0, int iParam1) { return func_220(iParam0, iParam1, 1); }
...
// Position - 0x21D12
var func_227() { return player::get_player_group(player::get_player_index()); }
...
// Position - 0x21D65
void func_230(int *iParam0, var *uParam1, char *sParam2, char *sParam3, char *sParam4) {
	switch (*iParam0) {
	case 0: break;
...
void func_239() {
	...
	case 0:
		func_61(&iLocal_391);
		if (func_317() == 1) {
			iLocal_391 = func_316(vLocal_383, 5, 1);
			vehicle::set_all_vehicle_generators_active_in_area(vLocal_383 - Vector(10f, 10f, 10f),
															   vLocal_383 + Vector(10f, 10f, 10f), 0, 1);
			gameplay::clear_area_of_vehicles(vLocal_383, 10f, 0, 0, 0, 0, 0);
		}
		else {
			iLocal_391 = func_316(vLocal_380, 5, 1);
		}
...
// Position - 0x224B9
void func_243() {
	if (iLocal_372 < 12 && gameplay::get_game_timer() > iLocal_358 && func_36(iLocal_394[0])) {
...
// Position - 0x226E8
void func_246() {
	if (iLocal_375 && entity::does_entity_exist(iLocal_394[0]) && entity::does_entity_exist(iLocal_394[1]) &&
		entity::does_entity_exist(iLocal_394[2]) && func_36(iLocal_392) && !ui::is_message_being_displayed()) {
...
void func_247(int iParam0, char *sParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	...
	if (iVar0 == 1) {
		...
		iVar1 = func_313(script::get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94) {
			...
			iVar5 = func_306(script::get_this_script_name(), 1);
			if (iVar5 != -1) {
...
void func_249(var *uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) {
	...
	*uParam0 = func_11();
	...
	while (iVar1 < 3) {
		...
		if (iVar1 == func_269()) {
			func_265(player::player_ped_id(), &uParam0->f_616[iVar1 /*65*/], 1);
		}
		else {
			iVar0 = 0;
			while (iVar0 < 12) {
...
// Position - 0x24233
bool func_264(int iParam0, var *uParam1, int iParam2, int iParam3) {
	char *sVar0;
...
bool func_266(int iParam0, int iParam1) {
	...
	iVar0 = Global_2522581[iParam0 /*3*/][func_130(iParam1)];
...
// Position - 0x24A80
void func_268(int iParam0, int iParam1, int *iParam2, int *iParam3, var *uParam4, int iParam5, int iParam6) {
	int iVar0;
...
void func_271(int iParam0, var *uParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		while (iVar0 <= 44 - 1) {
			...
			if (iVar3 != 0) {
				vVar4.x = weapon::get_ped_weapontype_in_slot(iParam0, func_275(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		iVar7 = 0;
		while (iVar7 < iVar8) {
			if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_272(Var9.f_1) && iVar70 < 50) {
...
// Position - 0x26515
bool func_279(int iParam0, var *uParam1, float *fParam2) {
	*uParam1 = {0f, 0f, 0f};
	*fParam2 = 0f;
	switch (iParam0) {
	case 0:
...
// Position - 0x26BA4
bool func_280(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
	...
	if (!entity::is_entity_dead(player::player_ped_id(), 0) && !ped::is_ped_injured(player::player_ped_id())) {
		if (func_292()) {
			*iParam0 = func_287(entity::get_entity_coords(player::player_ped_id(), 0), 6, -1, 0, 1, -1);
			if (func_286(*iParam0) && !func_282(*iParam0)) {
				return true;
			}
		}
	}
...
// Position - 0x26C46
int func_282(int iParam0) { return func_283(iParam0, 0, 1); }
...
int func_283(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_285() == 0) {
			return gameplay::is_bit_set(func_131(func_284(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0x26F7D
int func_285() { return Global_25190; }

// Position - 0x26F88
int func_286(int iParam0) { return func_283(iParam0, 5, 1); }
...
// Position - 0x2766A
int func_290(int iParam0) { return func_283(iParam0, 0, 0); }
...
void func_307(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_308(uParam1, "Abigail1", func_310(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				 "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_309(iParam0), 1, 0);
		break;

	case 1:
		func_308(uParam1, "Abigail2", func_310(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				 -1, 4, 1, 0, 2359, func_309(iParam0), 1, 0);
		break;

	case 2:
		func_308(uParam1, "Barry1", func_310(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				 4, 1, 0, 2359, func_309(iParam0), 1, 0);
		break;

	case 3:
		func_308(uParam1, "Barry2", func_310(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				 4, 4, 0, 2359, func_309(iParam0), 1, 1);
		break;

	case 4:
		func_308(uParam1, "Barry3", func_310(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2,
				 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 5:
		func_308(uParam1, "Barry3A", func_310(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0,
				 "", 166, 0, 7, 4, 2, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 6:
		func_308(uParam1, "Barry3C", func_310(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				 7, 4, 2, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 7:
		func_308(uParam1, "Barry4", func_310(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0,
				 "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_309(iParam0), 0, 0);
		break;

	case 8:
		func_308(uParam1, "Dreyfuss1", func_310(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				 0, "", 0, 0, -1, 4, 2, 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 9:
		func_308(uParam1, "Epsilon1", func_310(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1,
				 10, 4, 1, 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 10:
		func_308(uParam1, "Epsilon2", func_310(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0,
				 11, 4, 1, 0, 2359, func_309(iParam0), 1, 0);
		break;

	case 11:
		func_308(uParam1, "Epsilon3", func_310(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				 0, 0, 12, 4, 1, 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 12:
		func_308(uParam1, "Epsilon4", func_310(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				 "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 13:
		func_308(uParam1, "Epsilon5", func_310(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16,
				 "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_309(iParam0), 1, 0);
		break;

	case 14:
		func_308(uParam1, "Epsilon6", func_310(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 15:
		func_308(uParam1, "Epsilon7", func_310(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 16:
		func_308(uParam1, "Epsilon8", func_310(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_309(iParam0), 1, 0);
		break;

	case 17:
		func_308(uParam1, "Extreme1", func_310(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 18:
		func_308(uParam1, "Extreme2", func_310(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 19:
		func_308(uParam1, "Extreme3", func_310(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 20:
		func_308(uParam1, "Extreme4", func_310(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 21:
		func_308(uParam1, "Fanatic1", func_310(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_309(iParam0), 1, 0);
		break;

	case 22:
		func_308(uParam1, "Fanatic2", func_310(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_309(iParam0), 1, 0);
		break;

	case 23:
		func_308(uParam1, "Fanatic3", func_310(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_309(iParam0), 0, 1);
		break;

	case 24:
		func_308(uParam1, "Hao1", func_310(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_309(iParam0), 0, 1);
		break;

	case 25:
		func_308(uParam1, "Hunting1", func_310(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 26:
		func_308(uParam1, "Hunting2", func_310(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 27:
		func_308(uParam1, "Josh1", func_310(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_309(iParam0), 1, 0);
		break;

	case 28:
		func_308(uParam1, "Josh2", func_310(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_309(iParam0), 1, 1);
		break;

	case 29:
		func_308(uParam1, "Josh3", func_310(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_309(iParam0), 1, 1);
		break;

	case 30:
		func_308(uParam1, "Josh4", func_310(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_309(iParam0), 1, 0);
		break;

	case 31:
		func_308(uParam1, "Maude1", func_310(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 32:
		func_308(uParam1, "Minute1", func_310(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 33:
		func_308(uParam1, "Minute2", func_310(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 34:
		func_308(uParam1, "Minute3", func_310(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 35:
		func_308(uParam1, "MrsPhilips1", func_310(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 36:
		func_308(uParam1, "MrsPhilips2", func_310(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_309(iParam0), 0, 0);
		break;

	case 37:
		func_308(uParam1, "Nigel1", func_310(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_309(iParam0), 1, 0);
		break;

	case 38:
		func_308(uParam1, "Nigel1A", func_310(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_309(iParam0), 1, 1);
		break;

	case 39:
		func_308(uParam1, "Nigel1B", func_310(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_309(iParam0), 1, 1);
		break;

	case 40:
		func_308(uParam1, "Nigel1C", func_310(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_309(iParam0), 1, 1);
		break;

	case 41:
		func_308(uParam1, "Nigel1D", func_310(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_309(iParam0), 1, 1);
		break;

	case 42:
		func_308(uParam1, "Nigel2", func_310(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_309(iParam0), 1, 1);
		break;

	case 43:
		func_308(uParam1, "Nigel3", func_310(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_309(iParam0), 1, 1);
		break;

	case 44:
		func_308(uParam1, "Omega1", func_310(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 45:
		func_308(uParam1, "Omega2", func_310(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 46:
		func_308(uParam1, "Paparazzo1", func_310(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 47:
		func_308(uParam1, "Paparazzo2", func_310(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 48:
		func_308(uParam1, "Paparazzo3", func_310(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 49:
		func_308(uParam1, "Paparazzo3A", func_310(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 50:
		func_308(uParam1, "Paparazzo3B", func_310(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 51:
		func_308(uParam1, "Paparazzo4", func_310(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 52:
		func_308(uParam1, "Rampage1", func_310(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 54:
		func_308(uParam1, "Rampage3", func_310(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_309(iParam0), 1, 0);
		break;

	case 55:
		func_308(uParam1, "Rampage4", func_310(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_309(iParam0), 1, 0);
		break;

	case 56:
		func_308(uParam1, "Rampage5", func_310(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_309(iParam0), 0, 0);
		break;

	case 53:
		func_308(uParam1, "Rampage2", func_310(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_309(iParam0), 1, 0);
		break;

	case 57:
		func_308(uParam1, "TheLastOne", func_310(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 58:
		func_308(uParam1, "Tonya1", func_310(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 59:
		func_308(uParam1, "Tonya2", func_310(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_309(iParam0), 0, 1);
		break;

	case 60:
		func_308(uParam1, "Tonya3", func_310(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_309(iParam0), 0, 1);
		break;

	case 61:
		func_308(uParam1, "Tonya4", func_310(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_309(iParam0), 0, 1);
		break;

	case 62:
		func_308(uParam1, "Tonya5", func_310(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_309(iParam0), 0, 1);
		break;
...
// Position - 0x2928C
void func_308(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
int func_311(int iParam0)
{
	switch (iParam0) {
	case 69:
	case 70: return func_312(Global_101700.f_8044.f_99.f_205[10]);

	case 74:
	case 75: return func_312(Global_101700.f_8044.f_99.f_205[8]);

	case 84:
	case 85: return func_312(Global_101700.f_8044.f_99.f_205[11]);

	case 90: return func_312(Global_101700.f_8044.f_99.f_205[7]);

	case 93: return func_312(Global_101700.f_8044.f_99.f_205[9]);
	}
	return 0;
}
...
// Position - 0x29A8C
int func_316(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
...
void func_320() {
	...
	case 0:
		func_22();
		func_61(&iLocal_391);
		if (func_43(iLocal_403) && func_36(iLocal_394[0]) && func_36(iLocal_394[1]) && func_36(iLocal_394[2]) &&
			func_36(iLocal_392)) {
			...
			iVar0 = 0;
			while (iVar0 < 3) {
				entity::set_entity_visible(iLocal_394[iVar0], 1, 0);
				iVar0++;
			}
			...
			ai::task_vehicle_drive_wander(iLocal_394[0], iLocal_403, 12f, 786468);
		...
		iLocal_277 = 0;
		iLocal_317 = 1;
		func_363(&iLocal_454, &iLocal_456, &iLocal_453, &fLocal_455);
		fLocal_386 = 800f;
		fLocal_387 = 100f;
		player::set_wanted_level_multiplier(0.1f);
	...
	case 1:
		...
		if (func_43(iLocal_403) && entity::does_entity_exist(iLocal_394[0])) {
			...
			func_334(&iLocal_40, iLocal_403, 0, 0, 1, 1, 1);
			if (entity::get_entity_health(iLocal_403) < 850 || func_333() || func_331() ||
				func_330(iLocal_403, &iLocal_454, &iLocal_456, &iLocal_453, &fLocal_455, 6, 1082130432) ||
				vehicle::get_vehicle_engine_health(iLocal_403) < 50f ||
				vehicle::get_vehicle_petrol_tank_health(iLocal_403) < 50f ||
				func_36(iLocal_394[0]) && !ped::is_ped_in_vehicle(iLocal_394[0], iLocal_403, 0) ||
				vehicle::is_vehicle_stuck_timer_up(iLocal_403, 2, 5000) ||
				vehicle::is_vehicle_stuck_timer_up(iLocal_403, 3, 5000) ||
				vehicle::is_vehicle_stuck_timer_up(iLocal_403, 0, 5000) ||
				vehicle::is_vehicle_stuck_timer_up(iLocal_403, 1, 5000)) {
				if (audio::is_mobile_phone_call_ongoing()) {
					func_201();
				}
				if (func_36(iLocal_394[0])) {
					ai::task_vehicle_temp_action(iLocal_394[0], iLocal_403, 20, 1000);
				}
			...
			if (vehicle::is_vehicle_stopped(iLocal_403)) {
				...
				while (iVar2 < 3) {
					if (func_36(iLocal_394[iVar2])) {
						...
						ai::task_smart_flee_ped(0, player::player_ped_id(), 500f, -1, 0, 0);
						ai::close_sequence_task(iVar3);
						ai::task_perform_sequence(iLocal_394[iVar2], iVar3);
						ai::clear_sequence_task(&iVar3);
						if (iVar2 == 0 && !func_331()) {
							func_22();
							func_4(&uLocal_107, "MEJ1AUD", "MEJ1_NERD", "MEJ1_NERD_1", 7, 1, 0);
						}
						else if (iVar2 == 1 && !func_36(iLocal_394[0]) ||
								 iVar2 == 2 && !func_36(iLocal_394[0]) && !func_36(iLocal_394[1]))
							&&!func_331() {
								func_329(&uLocal_107, 6, iLocal_394[iVar2], "MEJimmyKidnapper2", 1, 1);
								func_22();
								func_4(&uLocal_107, "MEJ1AUD", "MEJ1_NERD", "MEJ1_NERD_2", 7, 0, 0);
							}
						else if (iVar2 == 1 && func_36(iLocal_394[0]) ||
								 iVar2 == 2 && (func_36(iLocal_394[0]) || func_36(iLocal_394[1]))) {
							func_326(iLocal_394[iVar2], 1);
						}
					}
					iVar2++;
				}
				...
				func_324(&iLocal_40, 0, 0);
				iLocal_372 = 0;
				iLocal_358 = gameplay::get_game_timer() + 9000;
				if (func_36(iLocal_392) && (vehicle::is_vehicle_stuck_timer_up(iLocal_403, 2, 5000) ||
											vehicle::is_vehicle_stuck_timer_up(iLocal_403, 3, 5000) ||
											vehicle::is_vehicle_stuck_timer_up(iLocal_403, 0, 5000) ||
											vehicle::is_vehicle_stuck_timer_up(iLocal_403, 1, 5000))) {
...
void func_327(int iParam0, char *sParam1, char *sParam2, int iParam3) {
	audio::_play_ambient_speech_with_voice(iParam0, sParam1, sParam2, func_328(iParam3), 0);
}
...
// Position - 0x2A82E
int func_330(int iParam0, int *iParam1, int *iParam2, int *iParam3, float *fParam4, int iParam5, float fParam6) {
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
int func_331() {
	...
	if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0) && func_43(iLocal_403)) {
		...
		if (func_43(iVar0)) {
			...
			if (func_332(iVar1) || iVar1 == joaat("police4") || iVar1 == joaat("policeold1") ||
				iVar1 == joaat("policeold2") || iVar1 == joaat("fbi")) {
...
// Position - 0x2AA56
void func_334(int *iParam0, int iParam1, char *sParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	func_335(iParam0, iParam1, sParam2, iParam3, iParam4, iParam5, iParam6);
}

// Position - 0x2AA70
void func_335(int *iParam0, int iParam1, char *sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6) {
	iParam0->f_6 = 0;
	func_336(iParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

// Position - 0x2AA92
void func_336(int *iParam0, int iParam1, vector3 vParam2, char *sParam5, int iParam6, bool bParam7, var uParam8,
			  bool bParam9) {
	int iVar0;
	int iVar1;
	...
	if (func_352(iParam1) && entity::is_entity_visible(iParam1)) {
		...
		if (!cam::is_gameplay_hint_active()) {
			if (func_347(iParam0, bParam7, bParam9, 0)) {
				func_344(iParam0, iParam1, vParam2, iParam6);
			}
			if (*iParam0) {
				*iParam0 = 0;
			}
			...
			if (!func_347(iParam0, bParam7, bParam9, 0)) {
				if (!*iParam0 && !iParam0->f_1 && !func_338(iParam0)) {
					func_337(iParam0);
				}
			}
		}
...
// Position - 0x2B152
bool func_342() { return gameplay::get_game_timer() <= Global_17290.f_5745 + 100; }
...
// Position - 0x2B1C1
void func_344(int *iParam0, int iParam1, vector3 vParam2, int iParam5) {
	int iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
...
// Position - 0x2B2C6
int func_345() { return func_346(player::player_id()); }
...
// Position - 0x2B2F5
bool func_347(var *uParam0, bool bParam1, bool bParam2, int iParam3) {
	if (uParam0->f_1) {
	...
	case 0:
		...
		if (uParam0->f_6 == 0) {
			if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
				if (func_351(bParam1, bParam2, iParam3)) {
					uParam0->f_4 = gameplay::get_game_timer();
					uParam0->f_5 = 1;
					uParam0->f_7 = 1;
				}
			}
			else if (func_350(bParam1, bParam2, iParam3)) {
				uParam0->f_4 = gameplay::get_game_timer();
				uParam0->f_5 = 1;
				uParam0->f_7 = 1;
			}
	...
	case 2:
		if (uParam0->f_6 == 0) {
			...
			if (!func_350(bParam1, bParam2, iParam3) || ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
				uParam0->f_5 = 0;
			}
		}
		else if (uParam0->f_6 == 2) {
			...
			else if (!func_351(bParam1, bParam2, iParam3)) {
				uParam0->f_5 = 0;
			}
		}
		break;
	...
	case 3:
		if (gameplay::get_game_timer() - uParam0->f_4 > 500) {
			if (uParam0->f_6 == 0) {
				if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
					if (func_349(bParam1, bParam2, iParam3)) {
						uParam0->f_5 = 0;
					}
				}
				else if (func_348(bParam1, bParam2, iParam3)) {
					uParam0->f_5 = 0;
				}
			}
			else if (uParam0->f_6 == 1) {
				if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 1) || func_348(bParam1, bParam2, iParam3)) {
					uParam0->f_5 = 0;
				}
			}
			else if (uParam0->f_6 == 2) {
				...
				else if (func_349(bParam1, bParam2, iParam3)) {
					uParam0->f_5 = 0;
				}
			}
		}
...
// Position - 0x2B6B3
bool func_349(bool bParam0, bool bParam1, bool bParam2) {
	if (!func_341(bParam0, bParam1, bParam2)) {
		return false;
	}
	if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
...
// Position - 0x2B75B
bool func_351(bool bParam0, bool bParam1, bool bParam2) {
	if (!func_341(bParam0, bParam1, bParam2)) {
		return false;
	}
	if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
...
// Position - 0x2B80C
void func_353() { gameplay::set_bit(&G_SleepModeOffOn11, 4); }
...
void func_355() {
	if (iLocal_312 > 0 && gameplay::get_game_timer() > iLocal_312) {
		if (func_36(player::player_ped_id()) && func_36(iLocal_392)) {
			if (func_219(player::player_ped_id(), iLocal_392) < 50f && !func_21() && !func_356("MEJ1_02", 0, 0)) {
				if (iLocal_315) {
...
void func_357() {
	...
	if (func_36(player::player_ped_id()) && func_36(iLocal_394[0]) && func_43(iLocal_403)) {
		if (iLocal_310 == -1 && iLocal_311 == -1) {
			if (!iLocal_313) {
				iLocal_313 = entity::is_entity_touching_entity(iLocal_403, player::player_ped_id());
			}
			if (entity::has_entity_been_damaged_by_entity(iLocal_403, player::player_ped_id(), 1) || iLocal_313) {
				func_201();
				func_22();
				if (func_4(&uLocal_107, "MEJ1AUD", "MEJ1_RAM", "MEJ1_RAM_3", 7, 0, 0)) {
					...
					ai::task_vehicle_mission_ped_target(iLocal_394[0], iLocal_403, player::player_ped_id(), 8, 25f,
														786468, 100f, 1f, 1);
					unk1::_0x293220DA1B46CEBC(3f, 0f, 3);
					iLocal_274 = 2;
					fLocal_386 = 200f;
			...
			else if (func_219(player::player_ped_id(), iLocal_394[0]) < 50f &&
					 !entity::is_entity_occluded(iLocal_403)) {
		...
		else if (iLocal_310 < 8 && func_219(player::player_ped_id(), iLocal_394[0]) < 50f && !func_21() &&
				 !func_356("MEJ1_02", 0, 0)) {
...
// Position - 0x2BC89
bool func_358(var *uParam0, int iParam1, char *sParam2, char *sParam3, int iParam4, int iParam5, int iParam6,
			  int iParam7) {
	...
	Global_15799 = 0;
	Global_2621441 = 0;
	return func_5(sParam3, iParam4, iParam7);
}
...
void func_359() {
	...
	if (streaming::has_anim_dict_loaded("missfam3")) {
		if (gameplay::get_game_timer() > iLocal_321) {
			...
			if (func_362(player::player_ped_id(), vVar0, 20f)) {
				iVar3 = gameplay::get_random_int_in_range(1, iLocal_394);
...
// Position - 0x2BEC3
bool func_362(int iParam0, vector3 vParam1, float fParam4) {
...
void func_366() {
	...
	case 0:
		func_61(&iLocal_391);
		iLocal_391 = func_316(vLocal_377, 5, 0);
	...
	case 1:
		if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_377,
												  1) < 1400f) {
			iLocal_389 = 2;
		}
		break;
	...
	case 2:
		...
		if (func_36(iLocal_392) && func_36(iLocal_394[0])) {
			if (func_362(player::player_ped_id(), vLocal_377, 150f) ||
				func_358(&uLocal_107, 14, "MEJ1AUD", "MEJ1_CLOSE", 7, 0, 0, 1)) {
				iLocal_389 = 3;
			}
		}
		break;
...
bool func_367() {
	if (func_43(iLocal_403) && func_36(player::player_ped_id()) && func_36(iLocal_394[0]) && func_36(iLocal_392)) {
		if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_409, vLocal_412, fLocal_433, 0, 1, 0) ||
			entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_415, vLocal_418, fLocal_434, 0, 1, 0)) {
			entity::set_entity_coords(iLocal_403, vLocal_405, 1, 0, 0, 1);
			entity::set_entity_heading(iLocal_403, fLocal_408);
			return true;
		}
		else if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_421, vLocal_424, fLocal_433, 0, 1,
												  0) ||
				 entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_427, vLocal_430, fLocal_434, 0, 1,
												  0)) {
			entity::set_entity_coords(iLocal_403, vLocal_405, 1, 0, 0, 1);
			entity::set_entity_heading(iLocal_403, fLocal_408);
			return true;
	...
	if (func_43(iLocal_403)) {
		...
		while (iVar0 < 3) {
			if (!func_36(iLocal_394[iVar0])) {
				if (streaming::has_model_loaded(iLocal_402)) {
					iLocal_394[iVar0] =
						ped::create_ped_inside_vehicle(iLocal_403, 4, iLocal_402, iLocal_398[iVar0], 1, 1);
		...
		if (!func_36(iLocal_392)) {
			if (streaming::has_model_loaded(func_46(14)) && streaming::has_anim_dict_loaded(sLocal_272)) {
				func_369(&iLocal_392, vLocal_405, fLocal_408, 1);
				...
				ped::attach_synchronized_scene_to_entity(iLocal_273, iLocal_403,
														 entity::get_entity_bone_index_by_name(iLocal_403, sLocal_275));
				ai::task_synchronized_scene(iLocal_392, iLocal_273, sLocal_272, "base", 8f, -8f, 4, iLocal_276,
											1148846080, 0);
				iLocal_274 = 0;
			}
		}
		...
		iLocal_403 = vehicle::create_vehicle(iLocal_404, vLocal_405, fLocal_408, 1, 1);
		...
		entity::set_entity_load_collision_flag(iLocal_403, 1);
...
// Position - 0x2C4B9
int func_369(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	int iVar0;
...
// Position - 0x2C592
void func_373(int iParam0, vector3 vParam1, float fParam4) {
	if (ui::does_blip_exist(*iParam0)) {
...
void func_374() {
	...
	if (ui::has_additional_text_loaded(0)) {
		if (func_36(player::player_ped_id())) {
			func_329(&uLocal_107, 0, player::player_ped_id(), "MICHAEL", 1, 1);
		}
		...
		if (func_60(0) && func_36(player::player_ped_id())) {
			...
			func_408(&uVar0, vVar1, fVar4, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
		}
		if (func_370()) {
			iVar5 = func_407();
			if (Global_86001 == 1) {
			...
			case 3:
				func_375(entity::get_entity_coords(player::player_ped_id(), 1), 1112014848, 12, 5000, 0, 0);
...
// Position - 0x2C939
void func_375(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	int iVar1;
...
// Position - 0x2C9A8
void func_376() { Global_17151.f_6 = 1; }
...
void func_381(int iParam0) {
	...
	if (func_36(player::player_ped_id()) && func_36(iLocal_392)) {
		entity::set_entity_collision(iLocal_392, 1, 0);
		if (iParam0) {
			if (func_43(iLocal_403) && vehicle::is_vehicle_seat_free(iLocal_403, -1, 0) &&
				vehicle::is_vehicle_seat_free(iLocal_403, 0, 0)) {
			...
			vVar2 = {func_383()};
			func_382(&vVar2, &fVar5);
			func_408(&iVar1, vVar2, fVar5, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
...
// Position - 0x2CD7A
Vector3 func_383() { return Global_96040.f_2305; }
...
// Position - 0x2D06C
void func_391(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	vector3 vVar0;
	float fVar3;
	...
	if (func_406() && func_392(iParam1, iParam2, iParam3, 1)) {
		vVar0 = {0f, 0f, 0f};
		fVar3 = 0f;
		func_408(uParam0, vVar0, fVar3, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
...
// Position - 0x2D200
int func_394() { return func_395(&Global_96040.f_2311); }
...
// Position - 0x2D272
int func_396(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
// Position - 0x2E38D
var func_406() { return Global_93635.f_2311.f_8; }
...
// Position - 0x2E3C8
void func_408(var *uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8,
	...
	if (iVar0 == 1) {
		...
		*uParam0 = func_442(vParam1, fParam4);
	}
	else if (iParam9 == 1) {
		...
		if (func_13(iParam12)) {
			func_432(iParam12, 0);
			while (!func_409(uParam0, iParam12, vParam1, fParam4, 1, 0)) {
				system::wait(0);
			}
		}
		else {
...
// Position - 0x2E55B
int func_409(int *iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7) {
	int iVar0;
	var *uVar1;
	struct<97> Var5;
	int iVar103;
		...
		if (Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/] == Var5) {
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/],
				...
				func_427(iParam0, &Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/].f_31,
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/],
				...
				func_427(iParam0, &Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/].f_31,
...
void func_410(int iParam0, var *uParam1, int iParam2, int iParam3) {
	...
	if (func_13(iParam0) && entity::does_entity_exist(*uParam1) && vehicle::is_vehicle_driveable(*uParam1, 0)) {
		...
		if (vehicle::get_vehicle_mod_kit(*uParam1) >= 0 && vehicle::get_vehicle_mod_kit(*uParam1) < 255 &&
			func_414(*uParam1, 0, &iVar0)) {
			func_262(uParam1, &Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_31,
			...
			if (iParam3) {
				...
				Global_101700.f_19077[iParam0 /*43*/].f_31 = func_413(*uParam1);
				...
				func_411(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_5,
				...
				func_411(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0,
...
// Position - 0x2FFBC
int func_411(int iParam0, int iParam1, int iParam2, int iParam3, int *iParam4) {
	int iVar0;
	int iVar1;
	char *sVar2;
	int iVar6;
...
// Position - 0x30030
bool func_412(int iParam0, char *sParam1, int *iParam2, int *iParam3, int *iParam4) {
	*iParam2 = -1;
	*iParam3 = -1;
	*iParam4 = -1;
	switch (iParam0) {
...
int func_414(int iParam0, int iParam1, int *iParam2) {
	...
	*iParam2 = 0;
	...
	iVar0 = entity::get_entity_model(iParam0);
	if (!func_416(iVar0, iParam1, iParam2)) {
		return 0;
	}
	...
	if (!network::network_is_game_in_progress()) {
		if (func_415(iParam0) && entity::get_entity_model(iParam0) != joaat("sentinel2") &&
...
int func_419(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_209(iParam0, 0, 0) ||
		func_209(iParam0, 1, 0) || func_209(iParam0, 2, 0) || func_256(iParam0) != 145 || func_423(iParam0) ||
		func_422(iParam0) || func_415(iParam0) || func_421(iParam0) || !func_420(entity::get_entity_model(iParam0))) {
		if (func_422(iParam0)) {
		}
		if (func_422(iParam0)) {
		}
...
// Position - 0x3219B
bool func_426(int iParam0) { return vehicle::is_vehicle_extra_turned_on(iParam0, 5); }
...
int func_427(int iParam0, var *uParam1, var *uParam2) {
	...
	if (func_430(entity::get_entity_model(*iParam0), 1) &&
		vehicle::get_vehicle_mod(*iParam0, 24) != func_429(*iParam0, (*uParam1)[38] - 1)) {
		vehicle::set_vehicle_mod(*iParam0, 24, func_429(*iParam0, (*uParam1)[38] - 1), 0);
	}
	if (func_428(*iParam0)) {
	...
	while (iVar0 < 9) {
		if (entity::does_entity_exist(Global_89155[iVar0])) {
			if (iParam0 == 145 || Global_89165[iVar0] == iParam0) {
				if (iParam1 == 0 || entity::get_entity_model(Global_89155[iVar0]) == func_258(iParam0, iParam1)) {
...
void func_434(int iParam0) {
	...
	if (func_441(&Global_68531.f_555[0 /*21*/], iParam0)) {
		...
		if (gameplay::is_bit_set(Global_68531.f_555[0 /*21*/].f_9, 13)) {
			if (iParam0 == 24 && func_440(iParam0, 0) && Global_69440.f_66 == 0 &&
				Global_101700.f_31389.f_1958[Global_68531.f_555[0 /*21*/].f_14] != 0 &&
				Global_101700.f_31389.f_1958[Global_68531.f_555[0 /*21*/].f_14] > 3 &&
				(!func_438(0, Global_68531.f_555[0 /*21*/].f_12) || !func_438(1, Global_68531.f_555[0 /*21*/].f_12))) {
...
// Position - 0x32B7F
int func_439(var *uParam0) { return *uParam0; }
...
// Position - 0x342A6
int func_442(vector3 vParam0, float fParam3) { return func_443(&Global_96040.f_2311, vParam0, fParam3, 0); }

// Position - 0x342C0
int func_443(var *uParam0, vector3 vParam1, float fParam4, int iParam5) {
	int iVar0;
	vector3 vVar1;
	bool bVar4;
	var uVar5;
	...
	if (func_395(uParam0)) {
		...
		if (func_451(uParam0)) {
			...
			if (entity::does_entity_exist(iVar0)) {
				...
				else if (!func_445(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10 &&
...
// Position - 0x34634
int func_445(int iParam0, vector3 vParam1, bool bParam4) {
	int iVar0;
	var uVar1[3];
	int iVar5;
	int iVar6;
	...
	case joaat("cuban800"):
		...
		iVar6 = 0;
		while (iVar6 <= iVar5 - 1) {
			if (func_446(iParam0, uVar1[iVar6], 1) &&
				func_396(entity::get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)) {
				if (!bParam4 || func_280(vParam1, 0f, 0f, 0f, 0) ||
...
// Position - 0x3489D
void func_447(int iParam0, var *uParam1, int iParam2, int iParam3) {
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (gameplay::is_bit_set(uParam1->f_77, 15) || func_450(iParam0) ||
...
// Position - 0x34DB0
var func_449() { return dlc2::is_dlc_present(-1691188696); }
...
// Position - 0x34E41
int func_452() { return func_451(&Global_96040.f_2311); }

// Position - 0x34E54
void func_453() { func_454(&Global_96040.f_2311); }
...
void func_456(int iParam0) {
	...
	cam::set_widescreen_borders(0, 0);
	vehicle::set_all_vehicle_generators_active_in_area(vLocal_383 - Vector(10f, 10f, 10f),
													   vLocal_383 + Vector(10f, 10f, 10f), 1, 1);
	func_455(0);
