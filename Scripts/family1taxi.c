...
void func_1() {
	switch (iLocal_48) {
	case 0:
		if (!entity::is_entity_dead(player::player_ped_id(), 0) && !gameplay::is_auto_save_in_progress() && !func_8() &&
			!func_7()) {
	...
	case 2:
		...
		case 2: func_2("AM_H_TAXI1", 2, 0, 1000, 10000, 1, 0, 0, 0); break;

		case 1: iLocal_48 = 3; break;
		}
		break;

	case 3:
		switch (func_5("AM_H_TAXI2")) {
		case 2: func_2("AM_H_TAXI2", 2, 0, 1000, 10000, 1, 0, 0, 0); break;

		case 1: iLocal_48 = 4; break;
		}
		break;

	case 4: func_10(); break;
	}
}

// Position - 0x19C
void func_2(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			int iParam8) {
	func_3(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

// Position - 0x1BD
void func_3(char *sParam0, char *sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
// Position - 0x53C
bool func_8() { return Global_91530.f_1; }
