...
void __EntryFunction__() {
	...
	if (player::has_force_cleanup_occurred(83)) {
		...
		if (Var0 != -1) {
			if (Global_100787[Var0 /*10*/].f_9 != -1) {
				...
				func_262(&Global_100787[Var0 /*10*/].f_9);
			}
		}
		func_247(&Var0, 1);
	}
	...
	iVar61[1] = 59;
	iVar61[2] = 62;
	if (!func_244(&iVar61, &Var0, vLocal_92, 1f)) {
	...
	while (true) {
		system::wait(0);
		if (!func_194(&Var0, 1) || func_235(Var0)) {
			func_247(&Var0, 1);
		}
		if (func_234(43)) {
		...
		func_193(Var0);
		func_185(&iLocal_269, &Var0.f_9, vLocal_92);
		func_167(&Var0);
		if (func_152(&Var0, 0)) {
			if (!func_2(&Var0)) {
				func_247(&Var0, 1);
...
int func_2(var *uParam0) {
	...
	if (!func_151()) {
		while (!func_142(*uParam0)) {
			...
			if (!func_194(uParam0, *uParam0 != 2)) {
				func_263("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() "
						 "[TERMINATING]");
				return 0;
			}
			system::wait(0);
	...
	if (!func_98(uParam0)) {
		func_263("STEP_7_COMMON_LaunchMission - Trying to launch a null script "
				 "string name");
		return 0;
	}
...
int func_98(int iParam0) {
	...
	if (func_128(&iParam0->f_1)) {
		...
		func_99(*iParam0);
		uVar0 = system::start_new_script_with_args(&iParam0->f_1, iParam0, 61, 20500);
		...
		if (cutscene::has_cutscene_loaded()) {
			...
			func_263("Initial cutscene wasn't loaded in time to pass to RC "
					 "mission.");
					...
					if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
						...
						if (func_158(2)) {
							if (func_156(uParam0->f_27)) {
								...
								func_263("ARE_RC_TRIGGER_CONDITIONS_MET: "
		...
		if (*uParam0 == 6) {
			...
			if (ai::get_ped_desired_move_blend_ratio(player::player_ped_id()) >= 2f) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 245.8885f, 371.9034f, 103.9884f,
					...
					if (func_158(2)) {
						if (func_156(uParam0->f_27)) {
							func_155(uParam0->f_27, *uParam0);
							func_263("RC5_IN_ACTIVATION_RANGE: "
			...
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 2728.948f, 4143.44f, 42.29295f, 2722.213f,
				...
				if (func_158(2)) {
					if (func_156(1)) {
						func_155(1, *uParam0);
						func_263("RC_IN_ACTIVATION_RANGE: "
	...
	if (iParam0 == 1) {
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			...
			if (ped::is_ped_in_any_heli(player::player_ped_id()) || ped::is_ped_in_any_plane(player::player_ped_id())) {
				func_263("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for "
						 "plane or helicopter.");
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						Global_25192 || func_165() || func_164(8, -1) || func_78() || func_163() || func_162() ||
						func_161() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 1:
					if (player::is_player_being_arrested(player::player_id(), 1) || func_166() || Global_25192 ||
						func_165() || func_164(8, -1) || func_162() || func_78() || func_163() || func_161() ||
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						player::is_player_climbing(player::player_id()) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_166() || Global_100747 ||
						Global_25192 || func_165() || func_164(8, -1) || func_162() || func_78() || func_163() ||
						func_161() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5 || LastDispatchedMessageOrCall != -1) {
						return false;
					}
					break;
				...
				case 3:
					if (ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_166() || Global_100747 ||
						Global_25192 || func_165() || func_164(8, -1) || func_78() || func_163() || func_161() ||
						G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 4:
					if (func_166() || player::get_player_wanted_level(player::player_id()) > 0 || func_164(8, -1) ||
						func_161() || func_160() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 6:
					if (entity::does_entity_exist(player::player_ped_id())) {
						if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
							...
							func_165() || func_164(8, -1) || func_163() || func_162() || func_161() ||
							G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
							return false;
						}
					}
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						Global_100747 || Global_25192 || func_165() || Global_36912 || func_164(8, -1) || func_162() ||
						func_160() || func_161() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 8:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						Global_25192 || func_165() || func_164(8, -1) || func_162() || func_160() || func_78() ||
						func_163() || func_161()) {
						return false;
					}
					break;
...
void func_167(var *uParam0) {
	...
	if (func_161() || streaming::is_player_switch_in_progress()) {
		audio::stop_scripted_conversation(0);
		return;
	}
	if (!iLocal_98) {
		...
		if (streaming::has_anim_dict_loaded("special_ped@tonya@franklin_1@franklin_1a") &&
			streaming::has_anim_dict_loaded("special_ped@tonya@franklin_1@franklin_1b") &&
			streaming::has_anim_dict_loaded("special_ped@tonya@franklin_1@franklin_1c") &&
			streaming::has_anim_dict_loaded("special_ped@tonya@franklin_2@franklin_2a") &&
			streaming::has_anim_dict_loaded("special_ped@tonya@franklin_2@franklin_2b") &&
			streaming::has_anim_dict_loaded("special_ped@tonya@franklin_2@franklin_2c") &&
			streaming::has_anim_dict_loaded("special_ped@tonya@franklin_3@franklin_3a") &&
			streaming::has_anim_dict_loaded("special_ped@tonya@franklin_3@franklin_3b") &&
			streaming::has_anim_dict_loaded("special_ped@tonya@franklin_4@franklin_4a") &&
			streaming::has_anim_dict_loaded("special_ped@tonya@franklin_4@franklin_4b") &&
			streaming::has_anim_dict_loaded("special_ped@tonya@franklin_4@franklin_4c")) {
			iLocal_98 = 1;
		}
	}
	if (player::is_player_playing(player::player_id())) {
		...
		if (fVar0 < 20f * 20f && iLocal_98) {
				...
				if (!func_131()) {
					...
					if (*uParam0 == 58) {
						...
						if (!entity::is_entity_dead(uParam0->f_28[0], 0)) {
							ai::clear_sequence_task(&iLocal_96);
							ai::open_sequence_task(&iLocal_96);
							ai::task_play_anim(0, "special_ped@tonya@franklin_5@franklin_5a", "hey_franklin_0", 2f, -4f,
											   -1, 262144, 0, 0, 0, 0);
							ai::task_play_anim(0, "special_ped@tonya@franklin_5@franklin_5b", "hey_franklin_1", 4f, -4f,
											   -1, 262144, 0, 0, 0, 0);
							ai::task_play_anim(0, "special_ped@tonya@franklin_5@franklin_5c", "hey_franklin_2", 4f, -4f,
											   -1, 262144, 0, 0, 0, 0);
							ai::task_play_anim(0, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0, 0, 0, 0);
							ai::close_sequence_task(iLocal_96);
							ai::task_perform_sequence(uParam0->f_28[0], iLocal_96);
							ai::clear_sequence_task(&iLocal_96);
						}
					}
					else if (*uParam0 == 59) {
						...
						if (!entity::is_entity_dead(uParam0->f_28[0], 0)) {
							ai::clear_sequence_task(&iLocal_96);
							ai::open_sequence_task(&iLocal_96);
							ai::task_play_anim(0, "special_ped@tonya@franklin_5@franklin_5a", "hey_franklin_0", 4f, -4f,
											   -1, 262144, 0, 0, 0, 0);
							ai::task_play_anim(0, "special_ped@tonya@franklin_5@franklin_5b", "hey_franklin_1", 4f, -4f,
											   -1, 262144, 0, 0, 0, 0);
							ai::task_play_anim(0, "special_ped@tonya@franklin_5@franklin_5c", "hey_franklin_2", 4f, -4f,
			...
			case 1:
				if (!func_131()) {
					if (func_174(&uLocal_265)) {
						if (!entity::is_entity_dead(player::player_ped_id(), 0) &&
							!entity::is_entity_dead(uParam0->f_28[0], 0)) {
			...
			case 2:
				if (func_174(&uLocal_265)) {
					if (func_168(&uLocal_265) > gameplay::get_random_float_in_range(9f, 15f)) {
						iLocal_268++;
						switch (iLocal_268) {
						case 1:
							if (*uParam0 == 58) {
								...
								if (!entity::is_entity_dead(uParam0->f_28[0], 0)) {
									...
									ai::task_play_anim(0,
													   "special_ped@tonya@"
													   "franklin_4@franklin_4a",
													   "whats_wrong_with_you_0", 2f, -4f, -1, 262144, 0, 0, 0, 0);
									ai::task_play_anim(0,
													   "special_ped@tonya@"
													   "franklin_4@franklin_4b",
													   "whats_wrong_with_you_1", 4f, -4f, -1, 262144, 0, 0, 0, 0);
									ai::task_play_anim(0,
													   "special_ped@tonya@"
													   "franklin_4@franklin_4c",
													   "whats_wrong_with_you_2", 4f, -4f, -1, 262144, 0, 0, 0, 0);
									ai::task_play_anim(0, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0, 0,
													   0, 0);
									ai::close_sequence_task(iLocal_96);
									ai::task_perform_sequence(uParam0->f_28[0], iLocal_96);
									ai::clear_sequence_task(&iLocal_96);
								...
								if (!entity::is_entity_dead(uParam0->f_28[0], 0)) {
									...
									ai::task_play_anim(0,
													   "special_ped@tonya@"
													   "franklin_4@franklin_4a",
													   "whats_wrong_with_you_0", 4f, -4f, -1, 262144, 0, 0, 0, 0);
									ai::task_play_anim(0,
													   "special_ped@tonya@"
													   "franklin_4@franklin_4b",
													   "whats_wrong_with_you_1", 4f, -4f, -1, 262144, 0, 0, 0, 0);
									ai::task_play_anim(0,
													   ...
													   "franklin_4@franklin_4c",
													   "whats_wrong_with_you_2", 4f, -4f, -1, 262144, 0, 0, 0, 0);
									ai::task_play_anim(0, "special_ped@tonya@base", "base", 4f, -4f, -1, 262145, 0, 0,
													   0, 0);
									ai::close_sequence_task(iLocal_96);
									ai::task_perform_sequence(uParam0->f_28[0], iLocal_96);
									ai::clear_sequence_task(&iLocal_96);
						...
						case 2:
							if (*uParam0 == 58) {
								...
								if (!entity::is_entity_dead(uParam0->f_28[0], 0)) {
									...
									ai::open_sequence_task(&iLocal_96);
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_1@franklin_"
													   "1a",
													   "seriously_franklin_get_your_fat_0", 2f, -4f, -1, 262144, 0, 0,
													   0, 0);
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_1@franklin_"
													   "1b",
													   "seriously_franklin_get_your_fat_1", 4f, -4f, -1, 262144, 0, 0,
													   0, 0);
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_1@franklin_"
													   "1c",
													   "seriously_franklin_get_your_fat_2", 4f, -4f, -1, 262144, 0, 0,
													   0, 0);
									ai::task_play_anim(0, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0, 0,
													   0, 0);
									ai::close_sequence_task(iLocal_96);
								...
								if (!entity::is_entity_dead(uParam0->f_28[0], 0)) {
									...
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_1@franklin_"
													   "1a",
													   "seriously_franklin_get_your_fat_0", 4f, -4f, -1, 262144, 0, 0,
													   0, 0);
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_1@franklin_"
													   "1b",
						...
						case 3:
							if (*uParam0 == 58) {
								...
								if (!entity::is_entity_dead(uParam0->f_28[0], 0)) {
									...
									ai::open_sequence_task(&iLocal_96);
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_3@franklin_"
													   "3a",
													   "dont_be_actin_like_you_dont_know_me_0", 2f, -4f, -1, 262144, 0,
													   0, 0, 0);
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_3@franklin_"
													   "3b",
													   "dont_be_actin_like_you_dont_know_me_1", 4f, -4f, -1, 262144, 0,
													   0, 0, 0);
									ai::task_play_anim(0, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0, 0,
													   0, 0);
									ai::close_sequence_task(iLocal_96);
								...
								if (!entity::is_entity_dead(uParam0->f_28[0], 0)) {
									...
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_3@franklin_"
													   "3a",
													   "dont_be_actin_like_you_dont_know_me_0", 4f, -4f, -1, 262144, 0,
													   0, 0, 0);
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_3@franklin_"
													   "3b",
						...
						case 4:
							if (*uParam0 == 58) {
								...
								if (!entity::is_entity_dead(uParam0->f_28[0], 0)) {
									...
									ai::open_sequence_task(&iLocal_96);
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_2@franklin_"
													   "2a",
													   "seriously_franklin_im_tonya_0", 2f, -4f, -1, 262144, 0, 0, 0,
													   0);
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_2@franklin_"
													   "2b",
													   "seriously_franklin_im_tonya_1", 4f, -4f, -1, 262144, 0, 0, 0,
													   0);
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_2@franklin_"
													   "2c",
													   "seriously_franklin_im_tonya_2", 4f, -4f, -1, 262144, 0, 0, 0,
													   0);
									ai::task_play_anim(0, "special_ped@tonya@base", "base", 2f, -2f, -1, 262145, 0, 0,
													   0, 0);
									ai::close_sequence_task(iLocal_96);
								...
								if (!entity::is_entity_dead(uParam0->f_28[0], 0)) {
									...
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_2@franklin_"
													   "2a",
													   "seriously_franklin_im_tonya_0", 4f, -4f, -1, 262144, 0, 0, 0,
													   0);
									ai::task_play_anim(0,
													   "special_ped@tonya@franklin_2@franklin_"
													   "2b",
...
float func_168(var *uParam0) {
	if (func_174(uParam0)) {
		if (func_170(uParam0)) {
			...
			return func_169(gameplay::is_bit_set(*uParam0, 4)) - uParam0->f_1;
		}
	}
	return uParam0->f_1;
}
...
// Position - 0xBEAD
bool func_170(var *uParam0) { return gameplay::is_bit_set(*uParam0, 2); }

// Position - 0xBEBD
void func_171(var *uParam0) { func_172(uParam0, 0f); }

// Position - 0xBECC
void func_172(int *iParam0, float fParam1) {
	uParam0->f_1 = func_169(gameplay::is_bit_set(*uParam0, 4)) - fParam1;
...
// Position - 0xBF12
bool func_174(var *uParam0) { return gameplay::is_bit_set(*uParam0, 1); }
...
// Position - 0xC5DC
void func_185(int *iParam0, char *sParam1, vector3 vParam2) {
	if (player::is_player_playing(player::player_id())) {
...
// Position - 0xC7E0
float func_189(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
...
// Position - 0xC81A
bool func_190() { return Global_89133; }
...
int func_194(int iParam0, int iParam1) {
	...
	if (Global_69702) {
		func_263("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer "
				 "[TERMINATING]");
		return 0;
	}
	...
	if (func_225(*iParam0)) {
		...
		func_263("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (iParam0->f_25 == 1) {
	...
	if (*iParam0 == 10) {
		if (fire::is_explosion_in_sphere(-1, iParam0->f_17[0 /*3*/], 8f)) {
			func_263("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission "
					 "trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17) {
		if (!gameplay::is_bit_set(Var0.f_26, func_90())) {
			func_263("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player "
					 "character to launch mission");
			return 0;
		}
	}
	if (func_198(&iParam0->f_48) && iParam1) {
	...
	if (func_112(iParam0)) {
		...
		case 2:
			if (!func_197(uParam1) || !entity::is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3)) {
				...
				else if (func_197(uParam1) && uParam1->f_4 == 0 &&
	...
	if (func_112(player::player_ped_id())) {
		...
		while (iVar0 <= uParam0->f_28 - 1) {
			if (func_111(uParam0->f_28[iVar0])) {
				...
				switch (*uParam0) {
				case 19: func_224(uParam0->f_28[iVar0]); break;
		...
		while (iVar0 <= iVar1) {
			if (entity::does_entity_exist(uParam0->f_35[iVar0])) {
				if (entity::is_entity_dead(uParam0->f_35[iVar0], 0)) {
					func_263("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (!ped::is_ped_injured(uParam0->f_28[iVar0])) {
					if (ped::is_ped_sitting_in_any_vehicle(player::player_ped_id())) {
						if (entity::is_entity_touching_entity(player::player_ped_id(), uParam0->f_28[iVar0])) {
							...
							func_263("STEP_5_COMMON_RCfineAndInRange - Random "
					...
					if (func_223(*uParam0)) {
						...
						if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(uParam0->f_28[iVar0], 1), 15f)) {
							...
							func_263("STEP_5_COMMON_RCfineAndInRange - There "
					...
					if (!func_205(*uParam0)) {
						...
						if (player::get_player_wanted_level(player::player_id()) > 0) {
							...
							func_263("STEP_5_COMMON_RCfineAndInRange - Player "
...
// Position - 0xD878
bool func_207(int iParam0, float fParam1) { return func_208(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_208(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_209(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0xD951
int func_209(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
	...
	if (*iParam0 == 0) {
		vVar1 = {func_210(iParam4, iParam7)};
		*iParam0 =
...
int func_212(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_214(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
						  ped::get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_213(vVar3, vVar0);
...
bool func_218(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_112(player::player_ped_id()) && func_112(iParam0)) {
		...
		if (!iParam2) {
			if (func_222(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_219(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
// Position - 0xDDFA
bool func_219(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
// Position - 0xDF9B
bool func_221(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
// Position - 0xE029
bool func_222(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
int func_232(int iParam0) {
	...
	iLocal_95 = ped::add_scenario_blocking_area(vLocal_92 - Vector(10f, 10f, 10f), vLocal_92 + Vector(10f, 10f, 10f), 0,
												1, 1, 1);
	iLocal_97 = 1;
...
int func_233(var *uParam0) {
	...
	case 1:
		if (!streaming::has_model_loaded(joaat("ig_tonya")) ||
			!streaming::has_anim_dict_loaded("special_ped@tonya@intro") ||
			!streaming::has_anim_dict_loaded("special_ped@tonya@base") ||
			!streaming::has_anim_dict_loaded("special_ped@tonya@franklin_5@franklin_5a") ||
			!streaming::has_anim_dict_loaded("special_ped@tonya@franklin_5@franklin_5b") ||
			!streaming::has_anim_dict_loaded("special_ped@tonya@franklin_5@franklin_5c")) {
			return 0;
		}
		iLocal_91 = 2;
		break;
	...
	case 3:
		if (func_112(uParam0->f_28[0]) && player::is_player_playing(player::player_id())) {
			ai::clear_sequence_task(&iVar1);
			ai::open_sequence_task(&iVar1);
...
int func_236(int iParam0) {
	...
	if (Global_69702) {
		func_263("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is "
				 "running [TERMINATING]");
		return 0;
	}
	if (!Global_101700.f_8044 && !func_93(1)) {
		func_263("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not "
				 "active");
		return 0;
	}
	if (!func_237(iParam0)) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_263("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (Global_91491.f_11 == 6) {
		if (Global_91491 < 9) {
			...
			if (gameplay::are_strings_equal(&Global_91491.f_3, sVar0)) {
				func_263("STEP_3_COMMON_CanRCLaunch - Script denied as a "
	...
	if (script::_get_number_of_instances_of_script_with_name_hash(joaat("candidate_controller")) == 0) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_263("STEP_3_COMMON_CanRCLaunch - Script denied as "
...
// Position - 0xEA71
int func_244(int iParam0, int iParam1, vector3 vParam2, float fParam5) {
	int iVar0;

	if (*iParam0 == 1) {
		if (func_245((*iParam0)[0], vParam2, fParam5, iParam1)) {
			return 1;
		}
	}
	else {
		iVar0 = 0;
		while (iVar0 < *iParam0) {
			if (func_245((*iParam0)[iVar0], vParam2, fParam5, iParam1)) {
				iVar0 = *iParam0;
				return 1;
			}
			iVar0++;
	...
	func_263("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch "
			 "[TERMINATING]");
	return 0;
}

// Position - 0xEAD6
bool func_245(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	int iVar0;
	struct<7> Var1;

	iVar0 = 0;
	func_95(iParam0, &Var1);
	if (func_246(Var1.f_6, vParam1, fParam4, 0)) {
...
// Position - 0xECC3
void func_249(var *uParam0, bool bParam1) { func_250(&uParam0->f_41, bParam1); }
...
// Position - 0xED4E
void func_252(var *uParam0, bool bParam1) { func_253(&uParam0->f_35, bParam1); }
...
// Position - 0xEE71
void func_256(var *uParam0, int iParam1) { func_257(&uParam0->f_28, iParam1); }
