...
void __EntryFunction__() {
	...
	if (player::has_force_cleanup_occurred(83)) {
		...
		if (Var0 != -1) {
			if (Global_100787[Var0 /*10*/].f_9 != -1) {
				...
				func_271(&Global_100787[Var0 /*10*/].f_9);
			}
		}
		func_254(&Var0, 1);
	}
	iVar231[0] = 0;
	iVar231[1] = 1;
	if (!func_251(&iVar231, &Var0, vVar61, 1f)) {
		func_250();
	...
	while (true) {
		...
		func_192(Var0);
		func_185(&iLocal_100, &Var0.f_9, vVar61);
		switch (Var0) {
		case 0: func_176(&Var64, &Var0.f_28[0], "SONAR_PRE"); break;

		case 1: func_171(&Var0, vVar61, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800); break;
		}
		if (func_156(&Var0, 0)) {
			if (func_155(Var0)) {
				func_152(Var0, &iLocal_101);
			}
			if (!func_2(&Var0)) {
				func_254(&Var0, 1);
			}
...
int func_2(int iParam0) {
	...
	if (!func_151()) {
		while (!func_142(*iParam0)) {
			...
			if (!func_193(iParam0, *iParam0 != 2)) {
				func_272("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() "
						 "[TERMINATING]");
				return 0;
			}
			system::wait(0);
	...
	if (!func_98(iParam0)) {
		func_272("STEP_7_COMMON_LaunchMission - Trying to launch a null script "
				 "string name");
		return 0;
	}
...
int func_98(int iParam0) {
	...
	if (func_128(&iParam0->f_1)) {
		...
		if (cutscene::has_cutscene_loaded()) {
			...
			func_272("Initial cutscene wasn't loaded in time to pass to RC "
					 "mission.");
	...
	if (iParam0 == 1) {
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			...
			if (ped::is_ped_in_any_heli(player::player_ped_id()) || ped::is_ped_in_any_plane(player::player_ped_id())) {
				func_272("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for "
						 "plane or helicopter.");
...
// Position - 0xB597
int func_171(var *uParam0, vector3 vParam1, char[4] cParam4, char *sParam5, int iParam6, char *sParam7, int iParam8,
			 float fParam9) {
	var *uVar0;

	if (func_112(player::player_ped_id()) && func_112(uParam0->f_28[0]) && !func_131() &&
...
void func_176(int *iParam0, var *uParam1, char *sParam2) {
	if (func_112(*uParam1) && func_112(player::player_ped_id())) {
		switch (*iParam0) {
		case 0:
		...
		case 1:
			if (gameplay::get_game_timer() > iParam0->f_166) {
				...
				else if (func_184(player::player_ped_id(), *uParam1, 1) < 15f) {
					*iParam0 = 4;
				}
			}
			if (entity::is_entity_playing_anim(*uParam1, cLocal_99, "outro", 3) &&
				entity::get_entity_anim_current_time(*uParam1, cLocal_99, "outro") > 0.99f) {
				ai::task_play_anim(*uParam1, cLocal_99, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
			}
			break;

		case 3:
			if (entity::is_entity_playing_anim(*uParam1, cLocal_99, "intro", 3) &&
				entity::get_entity_anim_current_time(*uParam1, cLocal_99, "intro") > 0.99f) {
				*iParam0 = 4;
			}
			break;
			...
			if (!func_131()) {
				if (entity::is_entity_playing_anim(*uParam1, cLocal_99, "loop_talk", 3)) {
					if (entity::get_entity_anim_current_time(*uParam1, cLocal_99, "loop_talk") > 0.99f) {
						...
						if (!entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_92, vLocal_95, 8f, 0, 1,
															  0)) {
		...
		case 2:
			if (entity::is_entity_playing_anim(*uParam1, cLocal_99, "loop_look", 3) &&
				entity::get_entity_anim_current_time(*uParam1, cLocal_99, "loop_look") > 0.99f) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_92, vLocal_95, 8f, 0, 1, 0)) {
					if (gameplay::get_game_timer() > iParam0->f_166) {
						*iParam0 = 4;
					}
...
int func_193(int iParam0, int iParam1) {
	...
	if (Global_69702) {
		func_272("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer "
				 "[TERMINATING]");
		return 0;
	}
	func_95(*iParam0, &Var0);
	...
	if (func_224(*iParam0)) {
		...
		func_272("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (iParam0->f_25 == 1) {
	...
	if (*iParam0 == 10) {
		if (fire::is_explosion_in_sphere(-1, iParam0->f_17[0 /*3*/], 8f)) {
			func_272("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission "
					 "trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17) {
		if (!gameplay::is_bit_set(Var0.f_26, func_90())) {
			func_272("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player "
					 "character to launch mission");
			return 0;
		}
	}
	if (func_197(&iParam0->f_48) && iParam1) {
		...
		while (iVar0 <= iVar1) {
			if (entity::does_entity_exist(uParam0->f_35[iVar0])) {
				if (entity::is_entity_dead(uParam0->f_35[iVar0], 0)) {
					func_272("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (!ped::is_ped_injured(uParam0->f_28[iVar0])) {
					if (ped::is_ped_sitting_in_any_vehicle(player::player_ped_id())) {
						if (entity::is_entity_touching_entity(player::player_ped_id(), uParam0->f_28[iVar0])) {
							...
							func_272("STEP_5_COMMON_RCfineAndInRange - Random "
					...
					if (func_222(*uParam0)) {
						...
						if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(uParam0->f_28[iVar0], 1), 15f)) {
							...
							func_272("STEP_5_COMMON_RCfineAndInRange - There "
					...
					if (!func_204(*uParam0)) {
						...
						if (player::get_player_wanted_level(player::player_id()) > 0) {
							...
							func_272("STEP_5_COMMON_RCfineAndInRange - Player "
...
int func_232(var *uParam0) {
	...
	case 1:
		if (!func_238(&iVar0) || !streaming::has_anim_dict_loaded(cLocal_99)) {
			return 0;
		}
		iLocal_91 = 2;
		break;
...
// Position - 0xDF3F
void func_233(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_234(uParam0);
...
// Position - 0xE01B
int func_235(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
...
int func_240(var *uParam0) {
	...
	case 3: streaming::set_model_as_no_longer_needed(iVar0); return 1;
	}
	return 0;
}
...
int func_242(int iParam0) {
	...
	if (Global_69702) {
		func_272("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is "
				 "running [TERMINATING]");
		return 0;
	}
	if (!Global_101700.f_8044 && !func_93(1)) {
		func_272("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not "
				 "active");
		return 0;
	}
	if (!func_243(iParam0)) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_272("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (Global_91491.f_11 == 6) {
		if (Global_91491 < 9) {
			...
			if (gameplay::are_strings_equal(&Global_91491.f_3, sVar0)) {
				func_272("STEP_3_COMMON_CanRCLaunch - Script denied as a "
	...
	if (script::_get_number_of_instances_of_script_with_name_hash(joaat("candidate_controller")) == 0) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_272("STEP_3_COMMON_CanRCLaunch - Script denied as "
...
// Position - 0xE6D1
int func_251(int iParam0, int iParam1, vector3 vParam2, float fParam5) {
	int iVar0;
	...
	func_272("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch "
			 "[TERMINATING]");
	return 0;
}

// Position - 0xE736
bool func_252(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	int iVar0;
	struct<7> Var1;
...
// Position - 0xE7B4
bool func_253(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
void func_254(int iParam0, int iParam1) {
	...
	switch (*iParam0) {
	case 0: sVar0 = "SONAR_PRE"; break;

	case 1: sVar0 = "SONAR_CALL"; break;
	}
	func_255(sVar0);
	if (iParam1) {
		func_192(*iParam0);
...
// Position - 0xE96A
void func_261(var *uParam0, bool bParam1) { func_262(&uParam0->f_41, bParam1); }
...
// Position - 0xE9F5
void func_264(var *uParam0, bool bParam1) { func_265(&uParam0->f_35, bParam1); }
...
// Position - 0xEA7C
void func_267(var *uParam0, int iParam1) { func_268(&uParam0->f_28, iParam1); }
