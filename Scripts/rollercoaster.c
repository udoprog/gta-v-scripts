...
void __EntryFunction__() {
	...
	gameplay::set_bit(&Global_69950, 7);
	if (!cam::does_cam_exist(iLocal_930)) {
		iLocal_930 = cam::create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", -1652.227f, -1120.93f, 22.4479f, 9.2388f,
												 0f, -131.6249f, 50.1098f, 1, 2);
	...
	if (cam::does_cam_exist(iLocal_930)) {
		cam::set_cam_params(iLocal_930, -1651.501f, -1118.395f, 23.5181f, 3.435f, 0f, -152.2412f, 50.1098f, 5000, 1, 1,
							2);
	...
	if (func_53(player::get_players_last_vehicle())) {
		if (func_46(player::get_players_last_vehicle(), joaat("bagger"))) {
			func_32(-1633.43f, -1111.998f, 11.02252f, -1661.27f, -1142.66f, 25.51722f, 12f, -1630.952f, -1107.58f,
					12.0215f, 51.9704f, 1, 1, 1, 0, 0);
		}
		else if (func_46(player::get_players_last_vehicle(), joaat("sandking"))) {
			func_32(-1633.43f, -1111.998f, 11.02252f, -1661.27f, -1142.66f, 25.51722f, 12f, -1636.344f, -1106.241f,
					12.0261f, 52.3427f, 1, 1, 1, 0, 0);
		}
	}
	fLocal_939 = 0.5f;
	func_31(1, 0.5f, 2);
	...
	system::wait(0);
	func_15();
	if (func_53(player::player_ped_id()) && func_53(Local_868.f_9)) {
		entity::set_entity_coords(player::player_ped_id(), -1648.4f, -1127.6f, 18.3f, 1, 0, 0, 1);
		entity::attach_entity_to_entity(player::player_ped_id(), Local_868.f_9, 0, 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0,
										2, 1);
		entity::set_entity_visible(player::player_ped_id(), 0, 0);
	}
	...
	if (func_53(player::player_ped_id())) {
		...
		func_14(&Local_893, vVar1, entity::get_entity_rotation(Local_868.f_9, 2), 50f, Local_893.f_20, Local_893.f_21,
				3, 1101004800, 0, 0, -1082130432, 0);
		cam::attach_cam_to_entity(Local_893, player::player_ped_id(), 0f, 0f, 0.5f, 1);
	}
	system::wait(0);
	if (func_53(player::player_ped_id()) && func_53(Local_880.f_9)) {
		func_12(entity::get_entity_coords(player::player_ped_id(), 1), entity::get_entity_coords(Local_880.f_9, 1),
				&fVar10, &fVar11, 1);
	...
	while (true) {
		...
		if (gameplay::get_game_timer() > iLocal_936) {
			if (fLocal_939 > 0.01f) {
				if (fLocal_939 > 0.5f) {
					audio::_play_ambient_speech1(player::player_ped_id(), "ROLLERCOASTER_CHAT_EXCITED",
...
// Position - 0x9AA
void func_9(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6,
			float fParam7) {
	int iVar0[4];
	float fVar5;
	float fVar6;
	...
	if (controls::_is_input_disabled(2) && iParam2 && !iParam0->f_28) {
		...
		iParam0->f_14 += func_7((vVar10.x - iParam0->f_14) * 0.05f * fVar9 * fParam7, -3f, 3f);
		iParam0->f_14.f_1 += func_7((vVar10.y - iParam0->f_14.f_1) * 0.05f * fVar9 * fParam7, -3f, 3f);
		iParam0->f_14.f_2 += func_7((vVar10.z - iParam0->f_14.f_2) * 0.05f * fVar9 * fParam7, -3f, 3f);
	}
	if (iParam0->f_26) {
		iParam0->f_14 = func_7(iParam0->f_14, system::to_float(-iParam0->f_21), system::to_float(iParam0->f_21));
		iParam0->f_14.f_1 =
			func_7(iParam0->f_14.f_1, system::to_float(-iParam0->f_22), system::to_float(iParam0->f_22));
		iParam0->f_14.f_2 =
			func_7(iParam0->f_14.f_2, system::to_float(-iParam0->f_20), system::to_float(iParam0->f_20));
	}
...
// Position - 0xE81
void func_11(var *uParam0, var *uParam1, var *uParam2, int *iParam3, int iParam4, int iParam5) {
...
// Position - 0x104D
void func_14(var *uParam0, vector3 vParam1, vector3 vParam4, float fParam7, var uParam8, var uParam9, int iParam10,
...
void func_17(var *uParam0) {
	...
	fVar0 = uParam0->f_3;
	uParam0->f_3 += fLocal_867 * fLocal_939 * fLocal_938 * system::timestep();
	if (uParam0->f_3 >= 1f) {
		uParam0->f_3--;
		...
		if (uParam0->f_4[3] >= iLocal_865) {
			uParam0->f_4[3] -= iLocal_865;
		}
		if (uParam0->f_4[3] % iLocal_935 == 0) {
			controls::set_pad_shake(0, iLocal_933, iLocal_934);
		}
	}
	*uParam0 = {func_18(&vLocal_159[uParam0->f_4[0] /*3*/], &vLocal_159[uParam0->f_4[1] /*3*/],
						&vLocal_159[uParam0->f_4[2] /*3*/], &vLocal_159[uParam0->f_4[3] /*3*/], uParam0->f_3)};
...
Vector3 func_18(var *uParam0, var *uParam1, var *uParam2, var *uParam3, float fParam4) {
	...
	fVar4 = fVar3 * fParam4;
	vVar0.x = 0.5f * (2f * *uParam1 + (-*uParam0 + *uParam2) * fParam4 +
					  (2f * *uParam0 - 5f * *uParam1 + 4f * *uParam2 - *uParam3) * fVar3 +
					  (-*uParam0 + 3f * *uParam1 - 3f * *uParam2 + *uParam3) * fVar4);
	vVar0.y = 0.5f * (2f * uParam1->f_1 + (-uParam0->f_1 + uParam2->f_1) * fParam4 +
					  (2f * uParam0->f_1 - 5f * uParam1->f_1 + 4f * uParam2->f_1 - uParam3->f_1) * fVar3 +
					  (-uParam0->f_1 + 3f * uParam1->f_1 - 3f * uParam2->f_1 + uParam3->f_1) * fVar4);
	vVar0.z = 0.5f * (2f * uParam1->f_2 + (-uParam0->f_2 + uParam2->f_2) * fParam4 +
					  (2f * uParam0->f_2 - 5f * uParam1->f_2 + 4f * uParam2->f_2 - uParam3->f_2) * fVar3 +
					  (-uParam0->f_2 + 3f * uParam1->f_2 - 3f * uParam2->f_2 + uParam3->f_2) * fVar4);
	return vVar0;
}
...
void func_19() {
	switch (iLocal_892) {
	case 0:
		fLocal_867 += gameplay::get_frame_time() / 2f;
		if (fLocal_867 >= 5f) {
			fLocal_867 = 5f;
			iLocal_892 = 1;
		}
	...
	case 2:
		fLocal_867 -= gameplay::get_frame_time();
		if (fLocal_867 <= 0f) {
			fLocal_867 = 0f;
			iLocal_892 = 3;
		}
...
void func_27() {
	...
	iLocal_925[0] =
		object::get_closest_object_of_type(-1643.524f, -1124.681f, 17.4326f, 2f, joaat("prop_roller_car_01"), 1, 0, 1);
	iLocal_925[1] =
		object::get_closest_object_of_type(-1645.146f, -1126.613f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iLocal_925[2] =
		object::get_closest_object_of_type(-1646.768f, -1128.545f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iLocal_925[3] =
		object::get_closest_object_of_type(-1648.39f, -1130.478f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iVar0 = 0;
...
// Position - 0x2A9A
void func_32(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11,
			 int iParam12, int iParam13, int iParam14, int iParam15) {
	func_33(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14, iParam15);
}

// Position - 0x2AC3
void func_33(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
		...
		if (vehicle::is_vehicle_driveable(iVar0, 0)) {
			...
			if (entity::is_entity_in_angled_area(iVar0, vParam0, vParam3, fParam6, 0, 1, 0)) {
				...
				if (vVar10.z > vParam0.z && vVar10.z < vParam3.z || vVar10.z > vParam3.z && vVar10.z < vParam0.z) {
					if (func_43(iVar0, vParam0, vParam3, fParam6)) {
						bVar1 = true;
					}
				}
			}
...
// Position - 0x2F50
bool func_36(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
// Position - 0x31BB
bool func_43(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	vector3 vVar9;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (func_44(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_44(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_44(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_44(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_44(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_44(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_44(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_44(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_44(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_44(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_44(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_44(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_44(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_44(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_44(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_44(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x34B1
int func_44(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
// Position - 0x3B21
void func_54(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9,
	...
	if (player::is_player_playing(iVar0)) {
		...
		if (iParam6 == 1) {
			gameplay::clear_area_of_peds(func_57(player::get_player_index()), 50f, 0);
		}
		if (iParam7 == 1) {
...
// Position - 0x3D3C
Vector3 func_57(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }

// Position - 0x3D4F
int func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	if (iParam1 == 12) {
				...
				if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0)) {
					if (iVar0 == 13) {
						...
						while (iVar1 <= 8) {
							...
							func_78(iParam0, Global_69523[1 /*14*/].f_12, Global_69523[1 /*14*/].f_3,
						...
						if (iParam4 == -1) {
							ped::set_ped_component_variation(iParam0, func_68(iVar0), Global_69523[1 /*14*/].f_3,
															 Global_69523[1 /*14*/].f_4,
															 ped::get_ped_palette_variation(iParam0, func_68(iVar0)));
						}
						else {
							ped::set_ped_component_variation(iParam0, func_68(iVar0), Global_69523[1 /*14*/].f_3,
		...
		if (iParam4 == -1) {
			ped::set_ped_component_variation(iParam0, func_68(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4,
											 ped::get_ped_palette_variation(iParam0, func_68(iParam1)));
		}
		else {
			ped::set_ped_component_variation(iParam0, func_68(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4, iParam4);
...
bool func_59(int iParam0, int iParam1, int *iParam2) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_63 != -99) {
		if (!func_173(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_64,
...
// Position - 0x47B5
bool func_64(int iParam0, int iParam1, int iParam2, int iParam3, var *uParam4, var *uParam5) {
	var uVar0;
	int iVar10;
...
bool func_66(int iParam0, int iParam1, int *iParam2, int iParam3) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_60 != -99) {
		if (!func_173(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_61,
...
// Position - 0x5340
var func_70(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
...
void func_78(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == -1) {
		...
		if (iParam1 == 0) {
			...
			if (func_79(entity::get_entity_model(iParam0), 14, iVar0,
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == 12) {
		...
		iVar41 = dlc1::_get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_68(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41) {
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == 12) {
		...
		iVar38 = 0;
		iVar39 = dlc1::_get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_68(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39) {
...
struct<10> func_87(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		switch (iParam1) {
		case 31: func_89(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 0: func_89(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_89(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_89(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_89(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_89(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8); break;

		case 5: func_89(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8); break;

		case 6: func_89(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_89(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_89(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_89(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8); break;

		default: func_88(&Var1, iParam0, iParam1, 10); break;
		}
		break;
	...
	case joaat("player_one"):
		...
		case 1: func_89(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8); break;

		case 2: func_89(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8); break;

		case 3: func_89(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_89(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_89(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_89(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_89(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_89(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_88(&Var1, iParam0, iParam1, 9); break;
		}
		break;
	...
	case joaat("player_two"):
		...
		case 0: func_89(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_89(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_89(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_89(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8); break;

		case 4: func_89(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8); break;

		case 5: func_89(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_89(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_89(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_89(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8); break;
	...
	case joaat("mp_m_freemode_01"):
		...
		case 0: func_89(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_89(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_89(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_89(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_89(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_89(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_89(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_89(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_89(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_89(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_89(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_89(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_89(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_89(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 14: func_89(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_89(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_89(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_89(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_89(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_89(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_89(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_89(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_89(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_89(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 24: func_89(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_88(&Var1, iParam0, iParam1, 25); break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 0: func_89(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_89(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_89(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_89(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_89(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_89(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_89(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_89(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_89(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_89(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_89(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_89(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_89(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_89(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8); break;

		case 14: func_89(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_89(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_89(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_89(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_89(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_89(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_89(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_89(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_89(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_89(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8); break;
...
// Position - 0x806E
void func_89(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
struct<17> func_90(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		...
		case 1: func_93(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0); break;

		case 2: func_93(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8); break;

		case 3: func_93(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31); break;

		case 4: func_93(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2); break;

		case 5:
			func_93(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[0], Global_101700.f_2095.f_539.f_200[0], 6, 3, 0,
					0, 0, -99, 0, 0, 3);
			break;

		case 6: func_93(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_93(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 8: func_93(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 9: func_93(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 10: func_93(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4); break;

		case 11: func_93(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5); break;

		case 12: func_93(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31); break;

		case 13: func_93(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 14: func_93(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6); break;

		case 15: func_93(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31); break;

		case 16: func_93(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31); break;

		case 17: func_93(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 18: func_93(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7); break;

		case 19: func_93(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 20: func_93(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 21: func_93(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_93(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 23: func_93(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31); break;

		case 24: func_93(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31); break;

		case 25: func_93(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 26: func_93(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 27: func_93(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 28: func_93(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 29: func_93(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 30: func_93(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 31: func_93(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31); break;

		case 32: func_93(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 33: func_93(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 34: func_93(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31); break;

		case 35: func_93(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 36: func_93(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 37: func_93(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 38: func_93(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 39: func_93(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 40: func_93(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 41: func_93(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_93(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_93(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_93(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 45: func_93(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 46: func_93(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_93(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 48: func_93(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31); break;

		case 49: func_93(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 50: func_93(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9); break;

		case 51: func_93(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 52: func_93(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		default: func_91(&Var1, iParam0, iParam1, 53); break;
		}
		break;

	case joaat("player_one"):
		switch (iParam1) {
		case 0: func_93(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 1: func_93(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 2:
			func_93(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[1], Global_101700.f_2095.f_539.f_200[1], 17, 2,
					26, 0, 0, -99, 0, 45, 31);
			break;

		case 3: func_93(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1); break;

		case 4: func_93(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2); break;

		case 5: func_93(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 6: func_93(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_93(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3); break;

		case 8: func_93(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5); break;

		case 9: func_93(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 10: func_93(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 11: func_93(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 12: func_93(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 13: func_93(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 14: func_93(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 15: func_93(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 16: func_93(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 17: func_93(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 18: func_93(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31); break;

		case 19: func_93(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 20: func_93(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 21: func_93(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4); break;

		case 22: func_93(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31); break;

		case 23: func_93(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31); break;

		case 24: func_93(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31); break;

		case 25: func_93(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31); break;

		case 26: func_93(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31); break;

		case 27: func_93(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31); break;

		case 28: func_93(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31); break;

		case 29: func_93(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31); break;

		case 30: func_93(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31); break;

		case 31: func_93(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31); break;

		case 32: func_93(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31); break;

		case 33: func_93(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31); break;

		case 34: func_93(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31); break;

		case 35: func_93(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31); break;

		case 36: func_93(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31); break;

		case 37: func_93(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31); break;

		case 38: func_93(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 39: func_93(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 40: func_93(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 41: func_93(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 42: func_93(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31); break;

		case 43: func_93(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6); break;

		case 44: func_93(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 45: func_93(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8); break;

		case 46: func_93(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31); break;

		default: func_91(&Var1, iParam0, iParam1, 47); break;
		}
		break;

	case joaat("player_two"):
		switch (iParam1) {
		case 0: func_93(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 1: func_93(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8); break;

		case 2: func_93(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1); break;

		case 3: func_93(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2); break;

		case 4:
			func_93(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[2], Global_101700.f_2095.f_539.f_200[2], 8, 0, 0,
					0, 0, -99, 0, 0, 31);
			break;

		case 5: func_93(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6); break;

		case 6: func_93(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3); break;

		case 7: func_93(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4); break;

		case 8: func_93(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31); break;

		case 9: func_93(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 10: func_93(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 11: func_93(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5); break;

		case 12: func_93(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 13: func_93(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31); break;

		case 14: func_93(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31); break;

		case 15: func_93(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 16: func_93(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 17: func_93(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 18: func_93(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 19: func_93(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 20: func_93(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 21: func_93(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_93(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 23: func_93(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 24: func_93(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 25: func_93(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 26: func_93(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 27: func_93(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 28: func_93(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 29: func_93(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 30: func_93(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 31: func_93(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 32: func_93(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 33: func_93(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 34: func_93(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 35: func_93(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 36: func_93(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 37: func_93(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 38: func_93(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 39: func_93(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 40: func_93(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 41: func_93(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_93(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_93(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_93(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31); break;

		case 45: func_93(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 46: func_93(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_93(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31); break;

		default: func_91(&Var1, iParam0, iParam1, 48); break;
		}
		break;

	case joaat("mp_m_freemode_01"):
		switch (iParam1) {
		case 0: func_93(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31); break;

		case 1: func_93(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0); break;

		case 2: func_93(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1); break;

		case 3: func_93(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2); break;

		case 4: func_93(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3); break;

		case 5: func_93(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4); break;

		case 6: func_93(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5); break;

		case 7: func_93(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6); break;

		case 8: func_93(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7); break;

		case 9: func_93(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8); break;

		case 10: func_93(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9); break;

		case 11: func_93(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10); break;

		case 12: func_93(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11); break;

		case 13: func_93(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12); break;

		case 14: func_93(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13); break;

		case 15: func_93(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14); break;

		case 16: func_93(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15); break;

		case 17: func_93(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16); break;

		case 18: func_93(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17); break;

		case 19: func_93(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18); break;

		case 20: func_93(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19); break;

		case 21: func_93(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20); break;

		case 22: func_93(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21); break;

		case 23: func_93(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22); break;

		case 24: func_93(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23); break;

		case 25: func_93(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24); break;

		default: func_91(&Var1, iParam0, iParam1, 26); break;
		}
		break;

	case joaat("mp_f_freemode_01"):
		switch (iParam1) {
		case 0: func_93(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31); break;

		case 1: func_93(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31); break;

		case 2: func_93(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0); break;

		case 3: func_93(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1); break;

		case 4: func_93(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2); break;

		case 5: func_93(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3); break;

		case 6: func_93(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4); break;

		case 7: func_93(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5); break;

		case 8: func_93(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6); break;

		case 9: func_93(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7); break;

		case 10: func_93(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8); break;

		case 11: func_93(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9); break;

		case 12: func_93(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10); break;

		case 13: func_93(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31); break;

		case 14: func_93(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11); break;

		case 15: func_93(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12); break;

		case 16: func_93(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13); break;

		case 17: func_93(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14); break;

		case 18: func_93(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15); break;

		case 19: func_93(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16); break;

		case 20: func_93(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17); break;

		case 21: func_93(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31); break;

		case 22: func_93(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18); break;

		case 23: func_93(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19); break;

		case 24: func_93(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20); break;

		case 25: func_93(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21); break;

		case 26: func_93(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22); break;

		case 27: func_93(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23); break;

		default: func_91(&Var1, iParam0, iParam1, 28); break;
		}
		break;
	}
	return Var1;
			...
			if (dlc1::_get_prop_from_outfit(Var1.f_1, iVar36, &vVar16)) {
				if (vVar16.x != 0 && vVar16.x != -1 && vVar16.x != 1849449579) {
					...
					if (vVar16.z == 10 && uParam0->f_16) {
						(*uParam0)[func_92(vVar16.z)] = vVar16.x;
						uParam0->f_16 = 1;
					}
					else {
						(*uParam0)[func_92(vVar16.z)] = func_85(iParam1, vVar16.x, func_92(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1) {
					(*uParam0)[func_92(vVar16.z)] = vVar16.y;
				}
			}
			iVar36++;
		}
...
// Position - 0xA198
void func_93(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			 int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) {
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_80(iParam0, iParam2, 14, 3), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_80(iParam0, iParam2, 1, 3), -1842686353, 0);
			}
			break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_80(iParam0, iParam2, 14, 4), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_80(iParam0, iParam2, 1, 4), -1842686353, 0);
			}
			break;
		}
		break;
...
void func_101(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_106(iParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3)) {
...
// Position - 0xAE0A
var func_104() { return Global_1312735; }
...
// Position - 0xAE48
bool func_106(int iParam0, int iParam1, int *iParam2, int *iParam3, bool bParam4, bool bParam5) {
	int iVar0;
...
// Position - 0xC039
bool func_107(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	if (iParam0 == 0) {
		if (iParam5 == 1) {
...
void func_111(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 155); return;
	}
	...
	*uParam0 = iParam9;
	...
	if (iParam10) {
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 ||
			...
			iVar0 = func_105(func_115(iParam1, uParam0->f_2), Global_69521, 0);
			if (gameplay::is_bit_set(iVar0, uParam0->f_1)) {
				gameplay::set_bit(&uParam0->f_6, 1);
			}
			iVar0 = func_105(func_114(iParam1, uParam0->f_2), Global_69521, 0);
			if (gameplay::is_bit_set(iVar0, uParam0->f_1)) {
				gameplay::set_bit(&uParam0->f_6, 2);
			}
			if (func_113(iParam1, uParam0->f_2, &iVar1)) {
				iVar0 = func_105(iVar1, Global_69521, 0);
				if (!gameplay::is_bit_set(iVar0, uParam0->f_1)) {
					gameplay::set_bit(&uParam0->f_6, 4);
				}
			}
...
void func_118(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 == 12) {
		...
		iVar59 = 0;
		iVar60 = dlc1::_get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_68(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60) {
...
void func_119(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 9); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_120(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 48); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_121(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 1); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_123(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 6); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_124(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 33); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_125(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 17); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_126(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 18); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_127(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 7); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_128(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 84); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_129(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 104); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_135(int iParam0, int iParam1) {
	...
	case 14: func_136(iParam1); break;
	}
}
...
void func_136(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 175); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_138(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 47); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_139(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 63); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_141(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 5); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_142(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 53); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_143(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 12); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_144(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 77); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_146(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 134); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_147(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 117); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_152(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 21); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_153(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 10); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_155(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 113); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_158(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 45); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_162(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 20); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_163(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 24); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_164(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 14); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_165(int iParam0) {
	...
	default: func_118(iVar10, iParam0, 99); return;
	}
	func_112(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
bool func_173(int iParam0, int iParam1, int iParam2) {
	...
	else if (Global_69523[1 /*14*/].f_3 == ped::get_ped_drawable_variation(iParam0, func_68(iParam1)) &&
			 Global_69523[1 /*14*/].f_4 == ped::get_ped_texture_variation(iParam0, func_68(iParam1))) {
		return true;
	}
	return false;
}
...
void func_175(int iParam0, int iParam1, int iParam2, int iParam3) {
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_179(player::player_id()) &&
				!func_177(player::player_id(), 0) && !func_176()) {
...
// Position - 0x20C6E
bool func_176() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x20D59
bool func_180() { return gameplay::is_bit_set(Global_2359301, 3); }
...
void func_183(int iParam0) {
	...
	if (iParam0) {
		ui::clear_help(1);
		gameplay::clear_bit(&Global_69950, 7);
		func_1(500, 1);
	}
	func_220(303, 0, 0);
	...
	func_216();
	func_215(player::player_ped_id(), -1631.348f, -1112.651f, 12.0206f);
...
int func_187(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	case 0:
		...
		case 1: func_210(joaat("sp1_money_total_spent"), iParam3); break;

		case 2: func_210(joaat("sp2_money_total_spent"), iParam3); break;
		}
		func_195(0);
		switch (iParam2) {
		case 126:
		...
		case 68:
			switch (iParam0) {
			case 0: func_210(joaat("sp0_money_spent_on_tattoos"), iParam3); break;

			case 1: func_210(joaat("sp1_money_spent_on_tattoos"), iParam3); break;

			case 2: func_210(joaat("sp2_money_spent_on_tattoos"), iParam3); break;
			}
			if (func_194(1)) {
				fVar0 = 0f;
				iVar1 = 1;
		...
		case 21:
			switch (iParam0) {
			case 0: func_210(joaat("sp0_money_spent_on_taxis"), iParam3); break;

			case 1: func_210(joaat("sp1_money_spent_on_taxis"), iParam3); break;

			case 2: func_210(joaat("sp2_money_spent_on_taxis"), iParam3); break;
			}
			break;

		case 25:
			switch (iParam0) {
			case 0: func_210(joaat("sp0_money_spent_in_strip_clubs"), iParam3); break;

			case 1: func_210(joaat("sp1_money_spent_in_strip_clubs"), iParam3); break;

			case 2: func_210(joaat("sp2_money_spent_in_strip_clubs"), iParam3); break;
			}
			break;
		...
		case 112:
			switch (iParam0) {
			case 0: func_210(joaat("sp0_money_spent_property"), iParam3); break;

			case 1: func_210(joaat("sp1_money_spent_property"), iParam3); break;

			case 2: func_210(joaat("sp2_money_spent_property"), iParam3); break;
			}
			break;
		...
		default:
			...
			case joaat("clothes_shop_sp"):
				switch (iParam0) {
				case 0: func_210(joaat("sp0_money_spent_in_clothes"), iParam3); break;

				case 1: func_210(joaat("sp1_money_spent_in_clothes"), iParam3); break;

				case 2: func_210(joaat("sp2_money_spent_in_clothes"), iParam3); break;
				}
				break;

			case joaat("hairdo_shop_sp"):
				switch (iParam0) {
				case 0: func_210(joaat("sp0_money_spent_on_hairdos"), iParam3); break;

				case 1: func_210(joaat("sp1_money_spent_on_hairdos"), iParam3); break;

				case 2: func_210(joaat("sp2_money_spent_on_hairdos"), iParam3); break;
				}
				if (func_194(0)) {
					fVar0 = 0f;
					iVar1 = 0;
			...
			case joaat("gunclub_shop"):
				switch (iParam0) {
				case 0: func_210(joaat("sp0_money_spent_in_buying_guns"), iParam3); break;

				case 1: func_210(joaat("sp1_money_spent_in_buying_guns"), iParam3); break;

				case 2: func_210(joaat("sp2_money_spent_in_buying_guns"), iParam3); break;
				}
				break;

			case joaat("carmod_shop"):
				switch (iParam0) {
				case 0: func_210(joaat("sp0_money_spent_car_mods"), iParam3); break;

				case 1: func_210(joaat("sp1_money_spent_car_mods"), iParam3); break;

				case 2: func_210(joaat("sp2_money_spent_car_mods"), iParam3); break;
				}
				func_193(iParam3);
				break;
			}
	...
	case 1:
		switch (iParam0) {
		case 0: func_211(95, iParam3); break;

		case 1: func_211(97, iParam3); break;

		case 2: func_211(96, iParam3); break;
		}
		func_211(98, iParam3);
		break;
	}
	...
	case 1:
		...
		switch (iParam0) {
		case 0: func_210(joaat("sp0_total_cash_earned"), iParam3); break;

		case 1: func_210(joaat("sp1_total_cash_earned"), iParam3); break;

		case 2: func_210(joaat("sp2_total_cash_earned"), iParam3); break;
		}
		break;
	...
	if (!network::network_is_game_in_progress()) {
		if (gameplay::is_bit_set(Global_101700.f_19523.f_471, iParam0)) {
			...
			gameplay::clear_bit(&Global_101700.f_19523.f_471, iParam0);
			 ...
			 gameplay::is_bit_set(Global_2097152[func_192() /*10758*/].f_7546.f_10, iParam0)) {
		bVar0 = true;
		gameplay::clear_bit(&Global_101700.f_19523.f_471, iParam0);
		gameplay::clear_bit(&Global_2097152[func_192() /*10758*/].f_7546.f_10, iParam0);
	}
	if (bVar0) {
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		ui::_set_notification_text_entry("COUP_RED");
		ui::add_text_component_substring_text_label(func_191(iParam0));
...
bool func_194(int iParam0) {
	...
	return gameplay::is_bit_set(Global_2097152[func_192() /*10758*/].f_7546.f_10, iParam0);
}
...
// Position - 0x21E71
bool func_200(var *uParam0, int iParam1) { return (*uParam0)[iParam1] == 70; }
...
// Position - 0x21EB6
void func_202(var *uParam0, int iParam1) { (*uParam0)[iParam1] = 70; }
...
// Position - 0x21EE3
float func_204(var *uParam0) { return uParam0->f_72; }

// Position - 0x21EEF
bool func_205(var *uParam0, int iParam1) { return func_206(uParam0, iParam1) != -1; }
...
// Position - 0x21F2E
bool func_207(var *uParam0) { return uParam0->f_71 == 1; }
...
// Position - 0x22199
Vector3 func_215(int iParam0, vector3 vParam1) {
	var uVar0;
...
void func_221() {
	...
	if (fVar8 > 0f && system::floor(fVar8) < system::floor(Global_101700.f_9153.f_3853)) {
		func_209(13, system::floor(Global_101700.f_9153.f_3853));
	}
	if (!datafile::datafile_is_save_pending()) {
		if (!Global_69702) {
			if (func_224() == 2 == 0 && !network::network_is_game_in_progress()) {
...
// Position - 0x22A27
int func_224() { return Global_25190; }
