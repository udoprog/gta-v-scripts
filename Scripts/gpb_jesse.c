...
void func_51(int iParam0, char *sParam1, char *sParam2) {
	...
	switch (iParam0) {
	case 1: StringCopy(sParam2, "jessie_ig_1_p1_heydudes", 64); break;

	case 2: StringCopy(sParam2, "jessie_ig_1_p2_gottahavefaith", 64); break;

	case 3: StringCopy(sParam2, "jessie_ig_1_p3_lifeiscoolbutsoisdeath", 64); break;

	case 4: StringCopy(sParam2, "jessie_ig_1_p4_sentheretoclearthingsup", 64); break;

	case 5: StringCopy(sParam2, "jessie_ig_1_p5_heressomthinginteresting", 64); break;

	case 6: StringCopy(sParam2, "jessie_ig_1_p6_haveyoueverwondered", 64); break;

	case 7: StringCopy(sParam2, "jessie_ig_1_p7_importanttomakethingsclear", 64); break;

	case 8: StringCopy(sParam2, "jessie_ig_1_p8_thingsareallreallycool", 64); break;

	case 9: StringCopy(sParam2, "jessie_ig_1_p9_whothehellwalks", 64); break;

	case 10: StringCopy(sParam2, "jessie_ig_1_p10_theresthiskidiknow", 64); break;

	case 11: StringCopy(sParam2, "jessie_ig_1_p11_canyouimagine", 64); break;

	case 12: StringCopy(sParam2, "jessie_ig_1_p12_likeiusedtobe", 64); break;

	case 13: StringCopy(sParam2, "jessie_ig_1_p13_likeispoketomydad", 64); break;

	case 14: StringCopy(sParam2, "if_you_want_to_get_baked", 64); break;

	case 15: StringCopy(sParam2, "i_love_chill_people", 64); break;
	}
}
