...
void __EntryFunction__() {
	...
	if (func_469()) {
		...
		switch (iVar0) {
		case 0:
			func_427(&uLocal_707, 509.6743f, 5532.435f, 776.0009f, 153.1431f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145,
					 1);
			func_426(vLocal_692, fLocal_457, 1, 0);
			iLocal_101 = 2;
			func_415(1, 0);
			break;

		case 1:
			func_427(&uLocal_707, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
			func_426(vLocal_677, 254.9762f, 0, 0);
			func_415(4, 0);
			break;
		...
		if (func_413(player::player_ped_id())) {
			func_412(player::player_ped_id(), vLocal_692, fLocal_457, 0, 0);
	...
	while (true) {
		if (!ped::is_ped_injured(player::player_ped_id())) {
			...
			func_400();
			switch (iLocal_98) {
			case 0: func_393(); break;

			case 1: func_385(); break;

			case 2: func_382(); break;

			case 3: func_378(); break;

			case 6: func_371(); break;

			case 7: func_308(); break;

			case 4: func_125(); break;

			case 5: func_117(1); break;

			case 8: func_115(); break;

			case 9: func_70(); break;
			}
			if (iLocal_443 == 0) {
				func_1(iLocal_99);
			}
...
void func_2() {
	if (func_21(player::player_ped_id())) {
		...
		case 0:
			if (iLocal_100 == 1) {
				if (!func_69()) {
					func_18(player::player_ped_id(), vLocal_695, fLocal_458, 0, 1);
					if (func_21(Local_112.f_9)) {
						func_17(player::player_ped_id(), entity::get_entity_coords(Local_112.f_9, 1));
					}
					cam::set_gameplay_cam_relative_heading(0f);
					cam::set_gameplay_cam_relative_pitch(0f, 1065353216);
					if (iLocal_444 == 0) {
		...
		case 1:
			...
			if (iLocal_100 == 1) {
				if (!func_69()) {
					func_18(player::player_ped_id(), vLocal_698, fLocal_459, 0, 1);
					cam::set_gameplay_cam_relative_heading(0f);
					cam::set_gameplay_cam_relative_pitch(0f, 1065353216);
					if (iLocal_444 == 0) {
						if (iLocal_99 == 2) {
		...
		case 2:
			...
			if (iLocal_100 == 1) {
				...
				func_412(Local_112.f_9, vLocal_686, 153.53f, 0, 0);
				if (!func_69()) {
					ai::clear_ped_tasks_immediately(player::player_ped_id());
					func_412(player::player_ped_id(), vLocal_686 + Vector(0f, -2f, -1f), -27.29f, 0, 0);
					cam::set_gameplay_cam_relative_heading(0f);
					cam::set_gameplay_cam_relative_pitch(0f, 1065353216);
					if (iLocal_444 == 0) {
						if (iLocal_99 == 3) {
		...
		case 3:
			iLocal_437 = 1;
			if (iLocal_100 == 1) {
				func_412(Local_112.f_9, vLocal_677, 0f, 0, 0);
				if (!func_69()) {
					func_412(player::player_ped_id(), vLocal_677, 254.9762f, 0, 0);
					cam::set_gameplay_cam_relative_heading(0f);
					cam::set_gameplay_cam_relative_pitch(0f, 1065353216);
					if (iLocal_444 == 0) {
						if (iLocal_99 == 4) {
...
bool func_4(vector3 vParam0, var *uParam3, float fParam4, int iParam5) {
	...
	vVar1 = {object::_get_object_offset_from_coords(vParam0, gameplay::get_random_float_in_range(0f, 360f), 0f, fParam4,
													0f)};
	if (gameplay::get_ground_z_for_3d_coord(vVar1, &uVar0, 0)) {
		vVar1.z = uVar0;
	}
	*uParam3 = {vVar1};
...
// Position - 0x76E
void func_10(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	int iVar1;
...
// Position - 0x7DD
void func_11() { Global_17151.f_6 = 1; }
...
// Position - 0x9D7
int func_18(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	bool bVar0;
	float fVar1;
...
void func_25(int iParam0, int iParam1, int iParam2, int iParam3) {
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_30(player::player_id()) &&
				!func_27(player::player_id(), 0) && !func_26()) {
...
// Position - 0xCE9
bool func_26() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0xDE0
bool func_31() { return gameplay::is_bit_set(Global_2359301, 3); }
...
// Position - 0xEA3
bool func_35() {
	if (func_57(vLocal_680, Local_385.f_1, 210f)) {
		if (!iLocal_451) {
			if (func_56(2) && func_55(&Local_393, Local_393.f_5, Local_393.f_1, Local_393.f_4, 1) &&
				func_55(&Local_399, Local_399.f_5, Local_399.f_1, Local_399.f_4, 1)) {
		...
		if (!entity::does_entity_exist(Local_405)) {
			if (func_57(vLocal_680, Local_405.f_1, 150f)) {
				if (object::does_object_of_type_exist_at_coords(Local_405.f_1, 10f, func_46(), 0)) {
					Local_405 = object::get_closest_object_of_type(Local_405.f_1, 10f, func_46(), 1, 0, 1);
					if (func_413(Local_405)) {
						entity::set_entity_coords(Local_405, func_45(), 1, 0, 0, 1);
						entity::set_entity_heading(Local_405, func_44());
		...
		if (!entity::does_entity_exist(Local_411)) {
			if (func_57(vLocal_680, Local_411.f_1, 150f)) {
				if (object::does_object_of_type_exist_at_coords(Local_411.f_1, 10f, func_43(), 0)) {
					Local_411 = object::get_closest_object_of_type(Local_411.f_1, 10f, func_43(), 1, 0, 1);
				}
			}
		}
	}
...
// Position - 0x10DB
char *func_39() { return "special_ped@maude@base"; }
...
// Position - 0x1194
int func_43() { return 2057223314; }

// Position - 0x11A1
float func_44() { return -92.17f; }

// Position - 0x11AE
Vector3 func_45() { return 2727.4f, 4145.56f, 43.68f; }

// Position - 0x11C5
int func_46() { return -380698483; }
...
void func_47() {
	...
	if (func_21(Local_385)) {
		if (func_413(Local_393)) {
			if (func_56(2)) {
				...
				ai::task_synchronized_scene(Local_385, iVar0, func_39(), func_49(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				entity::play_synchronized_entity_anim(Local_393, iVar0, func_48(), func_39(), 1000f, -8f, iVar1,
													  1148846080);
...
// Position - 0x12BE
char *func_48() { return "base_chair"; }

// Position - 0x12C9
char *func_49() { return "base"; }

// Position - 0x12D4
Vector3 func_50() { return 0f, 0f, -92.17f; }

// Position - 0x12E3
Vector3 func_51() { return 2727.4f, 4145.56f, 43.68f; }

// Position - 0x12FA
bool func_52(var *uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8) {
...
// Position - 0x13CD
bool func_55(var *uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	if (!entity::does_entity_exist(*uParam0)) {
		if (func_54(iParam1)) {
...
// Position - 0x14A3
bool func_57(vector3 vParam0, vector3 vParam3, float fParam6) {
	return system::vdist2(vParam0, vParam3) <= fParam6 * fParam6;
}

// Position - 0x14BD
bool func_58(int iParam0, float fParam1, int iParam2) {
	int iVar0;
...
// Position - 0x165A
int func_63(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
// Position - 0x1951
bool func_69() { return gameplay::is_bit_set(Global_91491.f_20, 13); }
...
void func_70() {
	...
	case 0:
		...
		if (iLocal_102 == 4) {
			if (func_21(Local_385)) {
				...
				func_109(Local_385, 0);
				if (!audio::is_ambient_speech_playing(Local_385)) {
					if (func_108(Local_385, entity::get_entity_coords(player::player_ped_id(), 0), 35f)) {
						audio::stop_ped_speaking(Local_385, 0);
						func_106(Local_385, "GENERIC_FRIGHTENED_HIGH", "MAUDE", 3);
					}
				}
			}
		...
		case 2: sVar0 = "BBS_F1"; break;

		case 3: sVar0 = "BBS_F3"; break;

		case 4: sVar0 = "BBS_F2"; break;
	...
	case 1:
		if (func_100()) {
			if (entity::get_entity_height_above_ground(player::player_ped_id()) > 4f ||
			...
			if (!iLocal_434) {
				...
				if (iLocal_102 == 4) {
					if (func_21(Local_385)) {
						if (func_108(Local_385, vLocal_680, 35f)) {
							func_89(&uLocal_499, 4, Local_385, "MAUDE", 0, 1);
							if (func_73(&uLocal_499, cLocal_493, &vLocal_665, 4, 0, 0, 0)) {
								iLocal_434 = 1;
							}
						}
					}
				}
				else if (func_73(&uLocal_499, cLocal_493, &vLocal_665, 4, 0, 0, 0)) {
					iLocal_434 = 1;
				}
			}
			if (iLocal_102 == 4) {
				...
				else if (func_21(Local_385)) {
					if (!func_62(Local_385, 1805844857)) {
						if (!ped::is_ped_fleeing(Local_385)) {
							if (!entity::is_entity_playing_anim(Local_385, func_105(), func_72(), 3)) {
								func_71(&Local_385);
...
// Position - 0x1CCE
char *func_72() { return "female_Flee_Table_Left_Maude"; }
...
void func_81() {
	...
	if (entity::does_entity_exist(player::player_ped_id())) {
		if (func_84(Global_101700.f_2095.f_539.f_3549) != entity::get_entity_model(player::player_ped_id())) {
...
// Position - 0x2347
bool func_82(int iParam0) { return iParam0 < 3; }
...
void func_90(int iParam0) {
	...
	if (iLocal_469 > 0) {
		...
		while (iVar0 <= iLocal_469 - 1) {
			func_36(&Local_291[iVar0 /*6*/], iParam0);
			iVar0++;
		}
	}
	if (iLocal_467 > 0) {
		...
		while (iVar0 <= iLocal_467 - 1) {
			func_36(&Local_340[iVar0 /*9*/], iParam0);
			iVar0++;
		}
	}
	if (iLocal_470 > 0) {
	...
	func_36(&Local_393, iParam0);
	func_36(&Local_399, iParam0);
	func_36(&Local_405, 0);
	func_36(&Local_411, 0);
	if (func_21(Local_112.f_9)) {
		if (ped::is_ped_in_group(Local_112.f_9)) {
		...
		entity::set_entity_load_collision_flag(Local_112.f_9, 0);
	...
	func_40(&Local_112.f_9, iParam0);
	if (func_21(Local_385)) {
		ped::set_blocking_of_non_temporary_events(Local_385, 0);
		ped::set_ped_keep_task(Local_385, 1);
	}
	func_40(&Local_385, iParam0);
	if (iLocal_471 > 0) {
		iVar0 = 0;
		while (iVar0 <= iLocal_471 - 1) {
			...
			func_40(&Local_132[iVar0 /*20*/], iParam0);
			iVar0++;
		}
	}
	if (iLocal_468 > 0) {
		...
		while (iVar0 <= iLocal_468 - 1) {
			func_91(&Local_254[iVar0 /*6*/], iParam0);
			iVar0++;
		}
	}
}
...
// Position - 0x2851
void func_96(vector3 vParam0, float fParam3) { func_97(&Global_96040.f_2311, vParam0, fParam3); }

// Position - 0x286A
void func_97(var *uParam0, vector3 vParam1, var uParam4) {
	*uParam0 = {vParam1};
	uParam0->f_6 = uParam4;
}

// Position - 0x2880
void func_98(vector3 vParam0, float fParam3) {
...
// Position - 0x28AC
bool func_99(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
			...
			if (!ped::is_ped_ragdoll(*iParam0) || ai::is_ped_getting_up(*iParam0)) {
				...
				if (streaming::has_anim_dict_loaded(func_105())) {
					*iParam2 = ped::create_synchronized_scene(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					...
					ai::task_synchronized_scene(*iParam0, *iParam2, func_105(), func_72(), 1000f, -4f, 4626, 0,
												1148846080, 0);
					...
					if (func_413(*iParam1)) {
						...
						iVar0 += 512;
						iVar0 += 4096;
						entity::play_synchronized_entity_anim(*iParam1, *iParam2, func_104(), func_105(), 16f, -4f,
															  iVar0, 1148846080);
					}
					return true;
				}
...
// Position - 0x2B26
char *func_104() { return "Female_Flee_Table_Left_Maude_Chair"; }

// Position - 0x2B31
char *func_105() { return "special_ped@maude@exit_flee"; }
...
// Position - 0x2F82
bool func_116(int iParam0, int iParam1) { return gameplay::get_game_timer() - iParam0 > iParam1; }
...
void func_119() {
	...
	if (fVar8 > 0f && system::floor(fVar8) < system::floor(Global_101700.f_9153.f_3853)) {
		func_122(13, system::floor(Global_101700.f_9153.f_3853));
	}
...
int func_124(int iParam0) {
	...
	switch (iParam0) {
	case 0: iVar0 = 149; break;

	case 1: iVar0 = 150; break;

	case 2: iVar0 = 152; break;

	case 3: iVar0 = 151; break;
	}
	return iVar0;
}
...
void func_125() {
	...
	case 0:
		...
		if (func_35()) {
			if (func_58(1, 10.5f, 1)) {
				...
				vVar6 = {func_188()};
				if (func_185(vVar6, 0)) {
					func_178(vVar0, vVar3, fVar9, 2721.02f, 4140.34f, 43.66f, 257.67f, 1, 1, 1, 0, 0);
	...
	case 1:
		if (func_413(Local_393)) {
			if (func_21(Local_385)) {
				if (cutscene::can_set_exit_state_for_registered_entity(sLocal_495, 0) &&
					cutscene::can_set_exit_state_for_registered_entity(sLocal_497, 0)) {
					func_47();
				}
			}
		}
...
// Position - 0x3CE0
void func_127(vector3 vParam0, float *fParam3, int iParam4, int iParam5) {
	vector3 vVar0;
	float *fVar3;
	...
	if (entity::does_entity_exist(Global_93635.f_4)) {
		if (vehicle::is_vehicle_driveable(Global_93635.f_4, 0)) {
			if (func_177(24) != Global_93635.f_4) {
				if (iParam4 == 1) {
					if (func_174(entity::get_entity_coords(Global_93635.f_4, 1), iParam5, &vVar0, &fVar3)) {
						vParam0 = {vVar0};
						fParam3 = fVar3;
					}
				}
				func_128(Global_93635.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
// Position - 0x3D5B
void func_128(int iParam0, vector3 vParam1, float *fParam4, int iParam5, int iParam6) {
	struct<60> Var0;
	...
	if (entity::does_entity_exist(iParam0) && vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		func_162(iParam5, &Var0, vParam1, fParam4, func_168(iParam0));
...
int func_131(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_146(iParam0, 0, 0) ||
		func_146(iParam0, 1, 0) || func_146(iParam0, 2, 0) || func_168(iParam0) != 145 || func_145(iParam0) ||
		func_144(iParam0) || func_143(iParam0) || func_142(iParam0) || !func_132(entity::get_entity_model(iParam0))) {
		if (func_144(iParam0)) {
		}
		if (func_144(iParam0)) {
		}
...
// Position - 0x53E4
int func_137() { return 0; }

// Position - 0x53ED
int func_138() { return 1; }

// Position - 0x53F6
int func_139() { return 1; }
...
// Position - 0x5729
bool func_147(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
var func_148() {
	...
	func_158(&iVar0, time::get_clock_seconds());
	func_157(&iVar0, time::get_clock_minutes());
	func_156(&iVar0, time::get_clock_hours());
	func_151(&iVar0, time::get_clock_day_of_month());
	func_150(&iVar0, time::get_clock_month());
	func_149(&iVar0, time::get_clock_year());
	return iVar0;
}
...
var func_153(int iParam0) {
	return (system::shift_right(iParam0, 26) & 31) * func_154(gameplay::is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
// Position - 0x5A2F
int func_155(var uParam0) { return uParam0 & 15; }
...
// Position - 0x7482
void func_162(int iParam0, var *uParam1, vector3 vParam2, var uParam5, int iParam6) {
	if (func_159(&Global_68531.f_555[0 /*21*/], iParam0)) {
...
// Position - 0x7CF2
bool func_174(vector3 vParam0, int iParam3, var *uParam4, float *fParam5) {
	int iVar0;
...
// Position - 0x7E97
var func_176(int iParam0) { return gameplay::is_bit_set(Global_101700.f_6188[iParam0], 0); }
...
// Position - 0x7ECB
void func_178(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11,
			  int iParam12, int iParam13, int iParam14, int iParam15) {
	func_179(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14,
			 iParam15);
}

// Position - 0x7EF4
void func_179(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
...
// Position - 0x8311
bool func_181(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	vector3 vVar9;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (func_182(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_182(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_182(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_182(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_182(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_182(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_182(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_182(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_182(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_182(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_182(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_182(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_182(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_182(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_182(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_182(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x8607
int func_182(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
// Position - 0x875F
bool func_185(vector3 vParam0, int iParam3) { return func_186(Global_93635.f_2311.f_12.f_66, vParam0, iParam3); }
...
// Position - 0x87E6
Vector3 func_187() { return 2.55f, 5.665f, 2.55f; }

// Position - 0x87FD
Vector3 func_188() { return 3.01f, 11.01f, 6.01f; }
...
// Position - 0x884B
void func_190(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8,
...
// Position - 0x8A09
Vector3 func_191(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }

// Position - 0x8A1C
int func_192(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	if (iParam1 == 12) {
				...
				if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0)) {
					if (iVar0 == 13) {
						...
						while (iVar1 <= 8) {
							...
							func_212(iParam0, Global_69523[1 /*14*/].f_12, Global_69523[1 /*14*/].f_3,
						...
						if (iParam4 == -1) {
							ped::set_ped_component_variation(iParam0, func_202(iVar0), Global_69523[1 /*14*/].f_3,
															 Global_69523[1 /*14*/].f_4,
															 ped::get_ped_palette_variation(iParam0, func_202(iVar0)));
						}
						else {
							ped::set_ped_component_variation(iParam0, func_202(iVar0), Global_69523[1 /*14*/].f_3,
		...
		if (iParam4 == -1) {
			ped::set_ped_component_variation(iParam0, func_202(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4,
											 ped::get_ped_palette_variation(iParam0, func_202(iParam1)));
		}
		else {
			ped::set_ped_component_variation(iParam0, func_202(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4, iParam4);
...
bool func_193(int iParam0, int iParam1, int *iParam2) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_63 != -99) {
		if (!func_306(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_64,
...
// Position - 0x9481
bool func_198(int iParam0, int iParam1, int iParam2, int iParam3, var *uParam4, var *uParam5) {
	var uVar0;
	int iVar10;
...
bool func_200(int iParam0, int iParam1, int *iParam2, int iParam3) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_60 != -99) {
		if (!func_306(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_61,
...
// Position - 0xA00C
var func_204(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
		...
		if (iVar4 != iParam1) {
			...
			while (iVar5 <= iVar6 - 1) {
				if (iVar4 == iParam1 && iVar5 == iParam2) {
					iVar3 += func_218(iParam0, iParam3);
					return iVar3;
				}
				else {
					iVar3++;
...
struct<10> func_221(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		switch (iParam1) {
		case 31: func_223(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 0: func_223(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_223(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_223(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_223(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_223(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8); break;

		case 5: func_223(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8); break;

		case 6: func_223(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_223(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_223(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_223(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8); break;

		default: func_222(&Var1, iParam0, iParam1, 10); break;
		}
		break;
	...
	case joaat("player_one"):
		...
		case 1: func_223(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8); break;

		case 2: func_223(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8); break;

		case 3: func_223(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_223(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_223(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_223(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_223(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_223(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_222(&Var1, iParam0, iParam1, 9); break;
		}
		break;
	...
	case joaat("player_two"):
		...
		case 0: func_223(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_223(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_223(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_223(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8); break;

		case 4: func_223(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8); break;

		case 5: func_223(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_223(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_223(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_223(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8); break;
	...
	case joaat("mp_m_freemode_01"):
		...
		case 0: func_223(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_223(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_223(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_223(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_223(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_223(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_223(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_223(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_223(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_223(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_223(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_223(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_223(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_223(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 14: func_223(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_223(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_223(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_223(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_223(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_223(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_223(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_223(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_223(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_223(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 24: func_223(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_222(&Var1, iParam0, iParam1, 25); break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 0: func_223(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_223(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_223(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_223(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_223(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_223(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_223(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_223(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_223(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_223(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_223(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_223(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_223(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_223(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8); break;

		case 14: func_223(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_223(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_223(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_223(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_223(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_223(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_223(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_223(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_223(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_223(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8); break;
...
// Position - 0xCD3A
void func_223(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
struct<17> func_224(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		...
		case 1: func_227(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0); break;

		case 2: func_227(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8); break;

		case 3: func_227(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31); break;

		case 4: func_227(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2); break;

		case 5:
			func_227(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[0], Global_101700.f_2095.f_539.f_200[0], 6, 3, 0,
					 0, 0, -99, 0, 0, 3);
			break;

		case 6: func_227(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_227(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 8: func_227(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 9: func_227(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 10: func_227(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4); break;

		case 11: func_227(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5); break;

		case 12: func_227(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31); break;

		case 13: func_227(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 14: func_227(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6); break;

		case 15: func_227(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31); break;

		case 16: func_227(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31); break;

		case 17: func_227(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 18: func_227(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7); break;

		case 19: func_227(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 20: func_227(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 21: func_227(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_227(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 23: func_227(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31); break;

		case 24: func_227(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31); break;

		case 25: func_227(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 26: func_227(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 27: func_227(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 28: func_227(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 29: func_227(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 30: func_227(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 31: func_227(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31); break;

		case 32: func_227(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 33: func_227(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 34: func_227(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31); break;

		case 35: func_227(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 36: func_227(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 37: func_227(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 38: func_227(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 39: func_227(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 40: func_227(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 41: func_227(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_227(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_227(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_227(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 45: func_227(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 46: func_227(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_227(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 48: func_227(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31); break;

		case 49: func_227(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 50: func_227(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9); break;

		case 51: func_227(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 52: func_227(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		default: func_225(&Var1, iParam0, iParam1, 53); break;
		}
		break;

	case joaat("player_one"):
		switch (iParam1) {
		case 0: func_227(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 1: func_227(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 2:
			func_227(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[1], Global_101700.f_2095.f_539.f_200[1], 17, 2,
					 26, 0, 0, -99, 0, 45, 31);
			break;

		case 3: func_227(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1); break;

		case 4: func_227(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2); break;

		case 5: func_227(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 6: func_227(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_227(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3); break;

		case 8: func_227(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5); break;

		case 9: func_227(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 10: func_227(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 11: func_227(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 12: func_227(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 13: func_227(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 14: func_227(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 15: func_227(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 16: func_227(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 17: func_227(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 18: func_227(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31); break;

		case 19: func_227(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 20: func_227(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 21: func_227(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4); break;

		case 22: func_227(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31); break;

		case 23: func_227(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31); break;

		case 24: func_227(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31); break;

		case 25: func_227(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31); break;

		case 26: func_227(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31); break;

		case 27: func_227(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31); break;

		case 28: func_227(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31); break;

		case 29: func_227(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31); break;

		case 30: func_227(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31); break;

		case 31: func_227(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31); break;

		case 32: func_227(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31); break;

		case 33: func_227(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31); break;

		case 34: func_227(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31); break;

		case 35: func_227(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31); break;

		case 36: func_227(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31); break;

		case 37: func_227(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31); break;

		case 38: func_227(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 39: func_227(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 40: func_227(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 41: func_227(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 42: func_227(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31); break;

		case 43: func_227(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6); break;

		case 44: func_227(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 45: func_227(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8); break;

		case 46: func_227(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31); break;

		default: func_225(&Var1, iParam0, iParam1, 47); break;
		}
		break;

	case joaat("player_two"):
		switch (iParam1) {
		case 0: func_227(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 1: func_227(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8); break;

		case 2: func_227(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1); break;

		case 3: func_227(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2); break;

		case 4:
			func_227(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[2], Global_101700.f_2095.f_539.f_200[2], 8, 0, 0,
					 0, 0, -99, 0, 0, 31);
			break;

		case 5: func_227(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6); break;

		case 6: func_227(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3); break;

		case 7: func_227(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4); break;

		case 8: func_227(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31); break;

		case 9: func_227(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 10: func_227(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 11: func_227(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5); break;

		case 12: func_227(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 13: func_227(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31); break;

		case 14: func_227(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31); break;

		case 15: func_227(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 16: func_227(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 17: func_227(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 18: func_227(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 19: func_227(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 20: func_227(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 21: func_227(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_227(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 23: func_227(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 24: func_227(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 25: func_227(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 26: func_227(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 27: func_227(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 28: func_227(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 29: func_227(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 30: func_227(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 31: func_227(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 32: func_227(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 33: func_227(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 34: func_227(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 35: func_227(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 36: func_227(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 37: func_227(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 38: func_227(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 39: func_227(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 40: func_227(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 41: func_227(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_227(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_227(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_227(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31); break;

		case 45: func_227(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 46: func_227(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_227(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31); break;

		default: func_225(&Var1, iParam0, iParam1, 48); break;
		}
		break;

	case joaat("mp_m_freemode_01"):
		switch (iParam1) {
		case 0: func_227(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31); break;

		case 1: func_227(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0); break;

		case 2: func_227(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1); break;

		case 3: func_227(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2); break;

		case 4: func_227(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3); break;

		case 5: func_227(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4); break;

		case 6: func_227(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5); break;

		case 7: func_227(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6); break;

		case 8: func_227(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7); break;

		case 9: func_227(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8); break;

		case 10: func_227(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9); break;

		case 11: func_227(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10); break;

		case 12: func_227(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11); break;

		case 13: func_227(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12); break;

		case 14: func_227(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13); break;

		case 15: func_227(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14); break;

		case 16: func_227(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15); break;

		case 17: func_227(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16); break;

		case 18: func_227(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17); break;

		case 19: func_227(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18); break;

		case 20: func_227(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19); break;

		case 21: func_227(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20); break;

		case 22: func_227(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21); break;

		case 23: func_227(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22); break;

		case 24: func_227(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23); break;

		case 25: func_227(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24); break;

		default: func_225(&Var1, iParam0, iParam1, 26); break;
		}
		break;

	case joaat("mp_f_freemode_01"):
		switch (iParam1) {
		case 0: func_227(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31); break;

		case 1: func_227(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31); break;

		case 2: func_227(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0); break;

		case 3: func_227(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1); break;

		case 4: func_227(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2); break;

		case 5: func_227(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3); break;

		case 6: func_227(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4); break;

		case 7: func_227(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5); break;

		case 8: func_227(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6); break;

		case 9: func_227(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7); break;

		case 10: func_227(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8); break;

		case 11: func_227(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9); break;

		case 12: func_227(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10); break;

		case 13: func_227(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31); break;

		case 14: func_227(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11); break;

		case 15: func_227(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12); break;

		case 16: func_227(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13); break;

		case 17: func_227(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14); break;

		case 18: func_227(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15); break;

		case 19: func_227(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16); break;

		case 20: func_227(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17); break;

		case 21: func_227(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31); break;

		case 22: func_227(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18); break;

		case 23: func_227(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19); break;

		case 24: func_227(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20); break;

		case 25: func_227(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21); break;

		case 26: func_227(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22); break;

		case 27: func_227(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23); break;

		default: func_225(&Var1, iParam0, iParam1, 28); break;
		}
		break;
	}
	return Var1;
...
// Position - 0xEE64
void func_227(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) {
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_214(iParam0, iParam2, 14, 3), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_214(iParam0, iParam2, 1, 3), -1842686353, 0);
			}
			break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_214(iParam0, iParam2, 14, 4), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_214(iParam0, iParam2, 1, 4), -1842686353, 0);
			}
			break;
		}
		break;
...
void func_235(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_239(iParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3)) {
...
// Position - 0xFB08
bool func_239(int iParam0, int iParam1, int *iParam2, int *iParam3, bool bParam4, bool bParam5) {
	int iVar0;
...
// Position - 0x10CF9
bool func_240(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	if (iParam0 == 0) {
		if (iParam5 == 1) {
...
{
	switch (iParam0) {
	case 0: func_267(iParam1); break;

	case 2: func_266(iParam1); break;

	case 3: func_263(iParam1); break;

	case 4: func_262(iParam1); break;

	case 6: func_261(iParam1); break;

	case 5: func_260(iParam1); break;

	case 8: func_259(iParam1); break;

	case 9: func_258(iParam1); break;

	case 10: func_257(iParam1); break;

	case 1: func_256(iParam1); break;

	case 7: func_255(iParam1); break;

	case 11: func_254(iParam1); break;

	case 12: func_253(iParam1); break;

	case 13: func_252(iParam1); break;

	case 14: func_244(iParam1); break;
	}
}
...
void func_244(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 155); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

// Position - 0x13020
void func_245(var *uParam0, int iParam1, int iParam2, char *sParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	*uParam0 = iParam9;
	...
	if (iParam10) {
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 ||
			...
			iVar0 = func_238(func_248(iParam1, uParam0->f_2), Global_69521, 0);
...
void func_251(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 == 12) {
		...
		while (iVar38 < iVar40) {
			...
			if (!dlc1::_is_dlc_data_empty(Var20)) {
				if (iVar39 == iParam1 - iParam2) {
					...
					func_245(&Global_69523[0 /*14*/], iParam0, iParam1, &Var20.f_9, Var20.f_3, Var20.f_4, Var20.f_5,
		...
		iVar59 = 0;
		iVar60 = dlc1::_get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_202(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60) {
			...
			if (!dlc1::_is_dlc_data_empty(Var41)) {
				if (iVar59 == iParam1 - iParam2) {
					...
					func_245(&Global_69523[0 /*14*/], iParam0, iParam1, &Var41.f_9, Var41.f_3, Var41.f_4, Var41.f_5,
...
void func_252(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 9); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_253(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 48); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_254(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 1); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_256(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 6); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_257(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 33); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_258(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 17); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_259(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 18); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_260(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 7); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_261(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 84); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_262(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 104); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_268(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_286(iParam1); break;

	case 2: func_285(iParam1); break;

	case 3: func_281(iParam1); break;

	case 4: func_280(iParam1); break;

	case 6: func_279(iParam1); break;

	case 5: func_278(iParam1); break;

	case 8: func_277(iParam1); break;

	case 9: func_276(iParam1); break;

	case 10: func_275(iParam1); break;

	case 1: func_274(iParam1); break;

	case 7: func_273(iParam1); break;

	case 11: func_272(iParam1); break;

	case 12: func_271(iParam1); break;

	case 13: func_270(iParam1); break;

	case 14: func_269(iParam1); break;
	}
}
...
void func_269(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 175); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_271(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 47); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_272(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 63); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_274(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 5); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_275(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 53); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_276(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 12); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_277(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 77); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_279(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 134); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_280(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 117); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_285(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 21); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_286(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 10); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_287(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_304(iParam1); break;

	case 2: func_303(iParam1); break;

	case 3: func_300(iParam1); break;

	case 4: func_299(iParam1); break;

	case 6: func_298(iParam1); break;

	case 5: func_297(iParam1); break;

	case 8: func_296(iParam1); break;

	case 9: func_295(iParam1); break;

	case 10: func_294(iParam1); break;

	case 1: func_293(iParam1); break;

	case 7: func_292(iParam1); break;

	case 11: func_291(iParam1); break;

	case 12: func_290(iParam1); break;

	case 13: func_289(iParam1); break;

	case 14: func_288(iParam1); break;
	}
}
...
void func_288(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 113); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_291(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 45); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_295(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 20); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_296(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 24); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_297(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 14); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_298(int iParam0) {
	...
	default: func_251(iVar10, iParam0, 99); return;
	}
	func_245(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
bool func_306(int iParam0, int iParam1, int iParam2) {
	...
	else if (Global_69523[1 /*14*/].f_3 == ped::get_ped_drawable_variation(iParam0, func_202(iParam1)) &&
			 Global_69523[1 /*14*/].f_4 == ped::get_ped_texture_variation(iParam0, func_202(iParam1))) {
		return true;
	}
	return false;
}
...
void func_308() {
	...
	if (func_21(Local_112.f_9)) {
		...
		case 0:
			...
			func_347(&vLocal_704, vLocal_701);
		...
		case 1:
			if (!iLocal_448) {
				func_344(&Local_112.f_8, "", "", &iLocal_465, iLocal_466, 0);
				func_323(&iLocal_44, Local_112.f_9, 0, 0, 1, 1, 1);
				if (Local_112.f_10 == 22 || Local_112.f_10 == 23) {
					if (iLocal_474 == -1) {
					...
					if (func_320(Local_112.f_9, vLocal_680, iVar0, 0, 1, iLocal_476)) {
						if (func_116(iLocal_474, 5000) || func_99(vLocal_704, 0f, 0f, 0f, 0) ||
							!func_57(vVar1, vLocal_704, 8.5f) && !func_57(vVar1, vLocal_701, 8.5f)) {
							func_319();
							Local_112.f_17 = gameplay::get_game_timer();
							func_317(&iLocal_44, 0, 0);
							iLocal_448 = 1;
						}
					}
					else {
						if (!iLocal_417) {
							if (!func_116(iLocal_462, 2500)) {
								if (!func_60()) {
									if (func_108(Local_112.f_9, vLocal_680, 30f)) {
							...
							if (func_116(iLocal_462, gameplay::get_random_int_in_range(5000, 12000))) {
								if (func_108(Local_112.f_9, vLocal_680, 30f)) {
						...
						func_316(Local_112.f_9, vLocal_680, iLocal_474, 925353388);
					}
				}
				else {
					func_319();
				...
				func_319();
				if (!func_108(Local_112.f_9, vLocal_680, 10f)) {
					if (!iLocal_437) {
...
// Position - 0x25E6B
void func_312(var *uParam0, char *sParam1, char *sParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	if (ui::does_blip_exist(*uParam0)) {
		if (iParam5) {
...
// Position - 0x25F30
bool func_314(char *sParam0, int iParam1) {
	struct<6> Var0;
...
//Position - 0x25F8F
void func_316(int iParam0, vector3 vParam1, int iParam4, float fParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
// Position - 0x2625F
bool func_320(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
...
bool func_321(int iParam0, vector3 vParam1, float fParam4, float fParam5) {
	if (func_108(iParam0, vParam1, fParam4)) {
...
// Position - 0x2640D
bool func_322(int iParam0, vector3 vParam1) {
	if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
		if (player::get_time_since_player_hit_ped(player::player_id()) >= 0 &&
			player::get_time_since_player_hit_ped(player::player_id()) < 500) {
			if (func_108(iParam0, vParam1, 3.5f) ||
				entity::is_entity_touching_entity(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), iParam0)) {
				return true;
			}
		}
	}
...
// Position - 0x2646B
void func_323(int *iParam0, int iParam1, char *sParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	func_324(iParam0, iParam1, sParam2, iParam3, iParam4, iParam5, iParam6);
}

// Position - 0x26485
void func_324(int *iParam0, int iParam1, char *sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6) {
	func_325(iParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

// Position - 0x264A2
void func_325(int *iParam0, int iParam1, vector3 vParam2, char *sParam5, int iParam6, bool bParam7, var uParam8,
			  bool bParam9) {
	if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
		func_317(iParam0, 0, 0);
	}
	iParam0->f_6 = 2;
	func_326(iParam0, iParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

// Position - 0x264DA
void func_326(int *iParam0, int iParam1, vector3 vParam2, char *sParam5, int iParam6, bool bParam7, var uParam8,
			  bool bParam9) {
	int iVar0;
	int iVar1;
	...
	if (func_342(iParam1) && entity::is_entity_visible(iParam1)) {
		iVar1 = 0;
		...
		if (!cam::is_gameplay_hint_active()) {
			if (func_337(iParam0, bParam7, bParam9, 0)) {
				func_334(iParam0, iParam1, vParam2, iParam6);
			}
			if (*iParam0) {
				*iParam0 = 0;
			}
			...
			if (!func_337(iParam0, bParam7, bParam9, 0)) {
				if (!*iParam0 && !iParam0->f_1 && !func_328(iParam0)) {
					func_327(iParam0);
				}
			}
		}
...
// Position - 0x26BB1
bool func_333() { return gameplay::get_game_timer() <= Global_17290.f_5745 + 100; }

// Position - 0x26BC6
void func_334(int *iParam0, int iParam1, vector3 vParam2, int iParam5) {
	int iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
...
// Position - 0x26CCB
int func_335() { return func_336(player::player_id()); }
...
// Position - 0x26CFA
bool func_337(var *uParam0, bool bParam1, bool bParam2, int iParam3) {
	if (uParam0->f_1) {
	...
	case 0:
		...
		if (uParam0->f_6 == 0) {
			if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
				if (func_341(bParam1, bParam2, iParam3)) {
	...
	case 2:
		if (uParam0->f_6 == 0) {
			...
			if (!func_340(bParam1, bParam2, iParam3) || ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
				uParam0->f_5 = 0;
			}
		}
		else if (uParam0->f_6 == 2) {
			...
			else if (!func_341(bParam1, bParam2, iParam3)) {
				uParam0->f_5 = 0;
			}
		}
		break;
	...
	case 3:
		if (gameplay::get_game_timer() - uParam0->f_4 > 500) {
			if (uParam0->f_6 == 0) {
				...
				if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 1) || func_338(bParam1, bParam2, iParam3)) {
					uParam0->f_5 = 0;
				}
			}
			else if (uParam0->f_6 == 2) {
	...
	if (!func_332(bParam1, bParam2, iParam3)) {
		uParam0->f_5 = 0;
		uParam0->f_7 = 0;
	}
	if (uParam0->f_7) {
...
// Position - 0x27211
void func_343() { gameplay::set_bit(&Global_2314, 4); }
...
void func_347(var *uParam0, vector3 vParam1) {
	...
	if (gameplay::is_projectile_in_area(vVar0, vVar3, 0)) {
		if (gameplay::_0x8D7A43EC6A5FEA45(vVar0, vVar3, joaat("weapon_grenade"), uParam0, 0)) {
		}
		else if (gameplay::_0x8D7A43EC6A5FEA45(vVar0, vVar3, joaat("weapon_molotov"), uParam0, 0)) {
		}
		else if (gameplay::_0x8D7A43EC6A5FEA45(vVar0, vVar3, joaat("weapon_smokegrenade"), uParam0, 0)) {
		}
		else if (gameplay::_0x8D7A43EC6A5FEA45(vVar0, vVar3, joaat("weapon_bzgas"), uParam0, 0)) {
		}
		else if (gameplay::_0x8D7A43EC6A5FEA45(vVar0, vVar3, joaat("weapon_stickybomb"), uParam0, 0)) {
		}
		else if (gameplay::_0x8D7A43EC6A5FEA45(vVar0, vVar3, joaat("weapon_flare"), uParam0, 0)) {
		}
		else {
			*uParam0 = {0f, 0f, 0f};
		}
...
void func_348() {
	...
	if (func_21(Local_112.f_9)) {
		if (iLocal_253 == 0) {
			...
			if (func_358()) {
				if (iLocal_448 || iLocal_98 == 7) {
					if (bLocal_454) {
						ped::set_ped_movement_clipset(Local_112.f_9, func_357(), 1048576000);
						iLocal_253 = 2;
					}
					else {
						ped::set_ped_movement_clipset(Local_112.f_9, func_356(), 1048576000);
						iLocal_253 = 1;
					}
				}
			}
		...
		if (!ped::is_ped_performing_stealth_kill(player::player_ped_id())) {
			...
			case 0:
				if (func_108(Local_112.f_9, vLocal_680, 20f)) {
			...
			case 3:
				if (func_116(Local_112.f_18, gameplay::get_random_int_in_range(250, 500))) {
			...
			case 6:
				if (!func_108(Local_112.f_9, vLocal_680, 3.5f)) {
			...
			case 7:
				if (func_116(Local_112.f_18, gameplay::get_random_int_in_range(250, 1000))) {
					if (ped::is_ped_using_any_scenario(Local_112.f_9)) {
						ped::_0xF1C03A5352243A30(Local_112.f_9);
					}
			...
			case 39:
				if (!func_62(Local_112.f_9, 242628503)) {
					...
					ai::open_sequence_task(&iLocal_484);
					ai::task_goto_entity_aiming(0, player::player_ped_id(), fVar3, 30f);
					ai::task_aim_gun_at_entity(0, player::player_ped_id(), 2000, 0);
					ai::close_sequence_task(iLocal_484);
					ai::task_perform_sequence(Local_112.f_9, iLocal_484);
					ai::clear_sequence_task(&iLocal_484);
					ped::set_blocking_of_non_temporary_events(Local_112.f_9, 1);
				}
				break;

			case 40:
				if (func_116(Local_112.f_18, gameplay::get_random_int_in_range(250, 750))) {
			...
			case 13:
				if (!ped::is_ped_falling(Local_112.f_9) && !ped::is_ped_ragdoll(Local_112.f_9) &&
					!ped::is_ped_being_stunned(Local_112.f_9, 0)) {
					if (func_116(Local_112.f_18, gameplay::get_random_int_in_range(250, 500))) {
						...
						ai::task_play_anim(0, "oddjobs@bailbond_mountain", "base_jump_idle", 4f, -8f, -1, 1, 0, 0, 0,
										   0);
						ai::close_sequence_task(iLocal_484);
						ai::task_perform_sequence(Local_112.f_9, iLocal_484);
						ai::clear_sequence_task(&iLocal_484);
			...
			case 14:
				if (!ped::is_ped_being_stunned(Local_112.f_9, 0)) {
					...
					else if (entity::is_entity_playing_anim(Local_112.f_9, "oddjobs@bailbond_mountain",
															"base_jump_idle", 3)) {
			...
			case 16:
				...
				if (!ped::is_ped_falling(Local_112.f_9) && !ped::is_ped_ragdoll(Local_112.f_9) &&
					!ped::is_ped_being_stunned(Local_112.f_9, 0)) {
					if (func_116(Local_112.f_18, gameplay::get_random_int_in_range(250, 500))) {
						entity::set_entity_load_collision_flag(Local_112.f_9, 1);
						entity::set_entity_lod_dist(Local_112.f_9, 800);
						ped::set_ped_reset_flag(Local_112.f_9, 222, 1);
						vLocal_689 = {entity::get_entity_forward_vector(Local_112.f_9)};
						ai::open_sequence_task(&iLocal_484);
						ai::task_play_anim(0, "oddjobs@bailbond_mountain", "base_jump_spot", 8f, -1.5f, -1, 8, 0, 0, 0,
										   0);
			...
			case 17:
				if (!ped::is_ped_being_stunned(Local_112.f_9, 0)) {
					if (entity::is_entity_playing_anim(Local_112.f_9, "oddjobs@bailbond_mountain", "base_jump_spot",
													   3)) {
						entity::set_entity_anim_speed(Local_112.f_9, "oddjobs@bailbond_mountain", "base_jump_spot",
													  1.7f);
						if (entity::get_entity_anim_current_time(Local_112.f_9, "oddjobs@bailbond_mountain",
																 "base_jump_spot") > 0.413f) {
							vLocal_689.z = 0f;
							func_183(vLocal_689);
							fVar7 = 9f;
							vVar4 = {-1f, 0f, 0f};
							...
							entity::apply_force_to_entity(Local_112.f_9, 1, FtoV(fVar7) * vLocal_689, vVar4, 0, 0, 1, 1,
														  0, 1);
							Local_112.f_18 = gameplay::get_game_timer();
							Local_112.f_10 = 19;
						}
			...
			case 18:
				if (!func_108(Local_112.f_9, Local_103, 50f)) {
					entity::set_entity_health(Local_112.f_9, 0);
				}
				if (!ped::is_ped_falling(Local_112.f_9) && !ped::is_ped_ragdoll(Local_112.f_9) &&
					!ped::is_ped_being_stunned(Local_112.f_9, 0)) {
			...
			case 22:
				if (func_116(Local_112.f_18, gameplay::get_random_int_in_range(0, 500))) {
					if (ped::is_ped_using_any_scenario(Local_112.f_9)) {
			...
			case 23:
				if (!func_62(Local_112.f_9, 1805844857) && !ped::is_ped_fleeing(Local_112.f_9)) {
					Local_112.f_18 = gameplay::get_game_timer() - 5000;
					Local_112.f_10 = 22;
				}
				break;
			...
			case 24:
				...
				if (func_94(Local_254[0 /*6*/])) {
					if (!ped::is_ped_in_vehicle(player::player_ped_id(), Local_254[0 /*6*/], 0) &&
						func_108(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f) &&
						func_355(entity::get_entity_heading(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f)) {
						if (ped::is_ped_in_vehicle(Local_112.f_9, Local_254[0 /*6*/], 0) &&
							!ped::is_ped_being_jacked(Local_112.f_9)) {
							Local_112.f_10 = 25;
						}
						else if (func_116(Local_112.f_18, gameplay::get_random_int_in_range(250, 350))) {
							if (ped::is_ped_using_any_scenario(Local_112.f_9)) {
								ped::_0xFE07FF6495D52E2A(Local_112.f_9, vLocal_680);
							}
							else {
			...
			case 25:
				...
				else if (ped::is_ped_in_vehicle(player::player_ped_id(), Local_254[0 /*6*/], 0) ||
						 ped::is_ped_being_jacked(Local_112.f_9) ||
						 !func_108(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f) ||
						 !func_355(entity::get_entity_heading(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f)) {
					Local_112.f_10 = 22;
			...
			case 26:
				if (func_94(Local_254[0 /*6*/]) && ped::is_ped_sitting_in_vehicle(Local_112.f_9, Local_254[0 /*6*/])) {
					ai::task_vehicle_mission_ped_target(Local_112.f_9, Local_254[0 /*6*/], player::player_ped_id(), 8,
														30f, 786468, 350f, 30f, 1);
			...
			case 30:
				if (func_353(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_352()) {
				...
				else if (ped::does_group_exist(func_351())) {
					...
					if (!ped::is_ped_group_member(Local_112.f_9, func_351())) {
						ped::set_ped_as_group_member(Local_112.f_9, func_351());
					}
					ped::set_group_formation(func_351(), 0);
					ped::set_group_formation_spacing(func_351(), 1.5f, 3.5f, -1082130432);
					...
					if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
						if (func_350()) {
							...
							if (!ped::is_ped_in_vehicle(Local_112.f_9, iVar1, 0)) {
								...
								if (fVar8 < 1.75f && func_108(Local_112.f_9, vLocal_680, 8f)) {
									if (!func_62(Local_112.f_9, -1794415470)) {
										iVar2 = -1;
										if (vehicle::are_any_vehicle_seats_free(iVar1)) {
											if (vehicle::is_vehicle_seat_free(iVar1, 0, 0) &&
												vehicle::_0x639431E895B9AA57(Local_112.f_9, iVar1, 0, 1, 0)) {
												iVar2 = 0;
											}
											else {
												iVar2 = -2;
			...
			case 32:
				if (func_353(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_352()) {
					...
					if (!ped::is_ped_ragdoll(Local_112.f_9) && !ped::is_ped_being_stunned(Local_112.f_9, 0) &&
						!ped::is_ped_being_jacked(Local_112.f_9) && !func_62(Local_112.f_9, -828834893)) {
						ai::task_look_at_entity(Local_112.f_9, player::player_ped_id(), -1, 0, 2);
						if (!func_349(Local_112.f_19, 10) && func_108(Local_112.f_9, vLocal_680, 50f) ||
							!func_116(iLocal_481, 2000)) {
							if (ped::is_ped_in_any_vehicle(Local_112.f_9, 0)) {
								ai::task_leave_any_vehicle(Local_112.f_9, 0, 0);
							}
							else if (!weapon::is_ped_armed(player::player_ped_id(), 6) &&
										 !player::is_player_targetting_entity(player::player_id(), Local_112.f_9) &&
										 !func_352() ||
									 entity::is_entity_in_water(Local_112.f_9)) {
								ai::task_turn_ped_to_face_entity(Local_112.f_9, player::player_ped_id(), -1);
							}
			...
			case 33:
				if (func_353(Local_112.f_9, Local_112.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_352()) {
					if (!func_62(Local_112.f_9, -1519143300)) {
						...
						else if (!func_349(Local_112.f_19, 10) && func_108(Local_112.f_9, vLocal_680, 50f)) {
							if (weapon::is_ped_armed(player::player_ped_id(), 6) ||
								player::is_player_targetting_entity(player::player_id(), Local_112.f_9) || func_352()) {
								Local_112.f_10 = 32;
							}
						}
					}
			...
			case 35:
				...
				else if (!ped::is_ped_ragdoll(Local_112.f_9) && !ai::is_ped_getting_up(Local_112.f_9) &&
						 ped::is_ped_on_foot(Local_112.f_9)) {
...
// Position - 0x28A6E
bool func_349(int iParam0, int iParam1) { return gameplay::get_frame_count() - iParam0 > iParam1; }
...
// Position - 0x28B06
var func_351() { return player::get_player_group(player::get_player_index()); }
...
// Position - 0x28B83
bool func_353(int iParam0, int iParam1, float fParam2, int iParam3, float fParam4, float fParam5, int iParam6) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (func_21(iParam0)) {
		...
		if (func_108(iParam0, vLocal_680, fParam2)) {
		...
		if (entity::is_entity_touching_entity(iParam0, player::player_ped_id()) ||
			ped::has_ped_received_event(iParam0, 56)) {
			if (ped::is_ped_ragdoll(iParam0)) {
				return true;
			}
		}
...
// Position - 0x28E4C
char *func_356() { return "move_m@bail_bond_not_tazered"; }

// Position - 0x28E58
char *func_357() { return "move_m@bail_bond_tazered"; }

// Position - 0x28E64
bool func_358() {
	streaming::request_anim_set(func_356());
	streaming::request_anim_set(func_357());
	if (streaming::has_clip_set_loaded(func_356()) && streaming::has_clip_set_loaded(func_357())) {
		return true;
	}
	return false;
}
...
void func_360(int iParam0, var *uParam1, float fParam2, int iParam3) {
	if (func_413(iParam0)) {
		if (func_361(iParam0, player::player_ped_id(), fParam2, 1, 250, iParam3)) {
...
bool func_361(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_362(&Local_56[iVar4 /*4*/], vVar1, iParam1, &Local_56[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_56[iVar4 /*4*/].f_3 < iParam4;
}
...
int func_365(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_183(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
...
void func_368(int iParam0, int iParam1, float fParam2, int iParam3) {
	if (func_413(iParam0)) {
		if (func_361(player::player_ped_id(), iParam0, fParam2, 1, 250, iParam3)) {
...
// Position - 0x292F5
void func_369() {
	if (func_57(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_677, 100f)) {
		if (!func_370()) {
		...
		if (!func_57(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_677, 120f)) {
			if (cutscene::has_cutscene_loaded()) {
				cutscene::remove_cutscene();
				iLocal_452 = 0;
			}
...
// Position - 0x2937F
bool func_370() { return Global_89133; }
	...
	if (func_21(Local_112.f_9)) {
		...
		case 1:
			if (!iLocal_449) {
				...
				func_113(&Local_112.f_8);
				if (!func_108(Local_112.f_9, vLocal_680, 25f)) {
					...
					func_374();
					func_372(&Local_385, vLocal_680, &iLocal_464, 5000, 1101004800);
				}
			}
			else if (func_108(Local_112.f_9, vLocal_680, 8f)) {
...
// Position - 0x2969F
int func_372(int iParam0, vector3 vParam1, int iParam4, int iParam5, float fParam6) {
	vector3 vVar0;
	var *uVar3;
	char[] cVar168[8];
	char *sVar169;
				...
				if (ped::is_ped_in_any_vehicle(Local_112.f_9, 0)) {
					...
					if (func_108(Local_112.f_9, vLocal_680, 25f)) {
						if (!func_314("BB3_J11", 1)) {
							if (func_116(iLocal_463, gameplay::get_random_int_in_range(2500, 5000))) {
								if (func_60()) {
									func_5();
								}
					...
					if (!func_60()) {
						if (func_116(iLocal_462, gameplay::get_random_int_in_range(3000, 6000))) {
							if (!func_108(Local_112.f_9, vLocal_680, 20f)) {
	...
	if (func_21(Local_112.f_9)) {
		...
		case 1:
			if (!iLocal_449) {
				...
				if (!func_108(Local_112.f_9, vLocal_680, 25f)) {
					...
					if (!ui::does_blip_exist(iLocal_455)) {
						if (iLocal_436) {
							iLocal_455 = func_381(vLocal_677, 5, 1);
						}
					}
					if (!iLocal_419) {
						if (!func_314(sLocal_487, 1)) {
					...
					if (entity::is_entity_in_angled_area(player::player_ped_id(), 2732.815f, 4143.618f, 42.02822f,
														 2724.603f, 4144.803f, 46.33084f, 9f, 0, 1, 0)) {
						iLocal_100 = 2;
					}
					if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
						if (func_108(player::player_ped_id(), vLocal_677, 6.5f)) {
							iLocal_100 = 2;
						}
					}
					else if (func_108(player::player_ped_id(), vLocal_677, 2.5f)) {
						iLocal_100 = 2;
					}
				}
			}
				...
				if (func_108(Local_112.f_9, vLocal_680, 8f)) {
					if (Local_112.f_10 == 34 || Local_112.f_10 == 35) {
						Local_112.f_18 = gameplay::get_game_timer();
						Local_112.f_10 = 30;
					}
			...
			if (!iLocal_446) {
				iLocal_446 = func_379(vLocal_680, Local_103, 180f);
			}
			if (func_309(&Local_112.f_9)) {
				iLocal_453 = 1;
				iLocal_100 = 2;
		...
		case 2:
			...
			if (iLocal_453) {
				...
				if (!iLocal_446) {
					iLocal_446 = func_379(vLocal_680, Local_103, 0f);
				}
				func_126(4);
			}
			break;
...
// Position - 0x2A042
int func_379(vector3 vParam0, vector3 vParam3, float fParam6) {
	int iVar0;

	if (!func_380(vParam0, vParam3, fParam6)) {
...
// Position - 0x2A134
bool func_380(vector3 vParam0, vector3 vParam3, float fParam6) {
	vector3 vVar0;
...
// Position - 0x2A15E
int func_381(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
		...
		case 1:
			...
			if (!iLocal_448) {
				...
				if (!iLocal_417) {
					...
					if (!func_60() && func_108(Local_112.f_9, vLocal_680, 35f)) {
				...
				if (Local_112.f_10 == 21) {
					...
					if (func_320(Local_112.f_9, vLocal_680, iVar0, 0, 1, 170)) {
						func_319();
						Local_112.f_17 = gameplay::get_game_timer();
						func_317(&iLocal_44, 0, 0);
						iLocal_448 = 1;
						...
						func_316(Local_112.f_9, vLocal_680, iLocal_473, 925353388);
					}
				}
				if (!func_60()) {
					if (iLocal_417) {
	...
	if (func_21(Local_132[0 /*20*/])) {
		if (Local_132[0 /*20*/].f_14 == 0) {
			...
			if (func_353(Local_132[0 /*20*/], Local_132[0 /*20*/].f_17, 1101004800, 0, 1090519040, 1097859072, 0)) {
				...
				if (!entity::is_entity_attached(Local_340[0 /*9*/])) {
					entity::attach_entity_to_entity(Local_340[0 /*9*/], Local_132[0 /*20*/],
													ped::get_ped_bone_index(Local_132[0 /*20*/], 28422), 0f, 0f, 0f, 0f,
													0f, 0f, 0, 0, 0, 0, 2, 1);
				}
				else {
					if (!entity::is_entity_playing_anim(Local_132[0 /*20*/], "oddjobs@bailbond_mountain", "Idle_Camman",
														3)) {
						ai::task_play_anim(Local_132[0 /*20*/], "oddjobs@bailbond_mountain", "Idle_Camman", 8f, -8f, -1,
										   49, 0, 0, 0, 0);
					}
		...
		case 1:
			...
			case 2:
				if (!iLocal_427) {
					...
					if (func_108(Local_112.f_9, vLocal_680, 25f) && func_392(Local_112.f_9, vLocal_680, 10f)) {
							...
							if (func_391(&Local_112.f_19)) {
								...
								if (Local_112.f_10 != 3 && Local_112.f_10 != 4) {
									...
									Local_112.f_10 = 3;
									 ...
									 entity::is_entity_touching_entity(player::player_ped_id(), Local_112.f_9)) {
								iLocal_101 = 1;
								iLocal_430 = 0;
								if (Local_112.f_10 != 3 && Local_112.f_10 != 4) {
									Local_112.f_18 = gameplay::get_game_timer() - 50000;
						...
						else if (func_108(Local_112.f_9, vLocal_680, 5f)) {
							iLocal_101 = 0;
						}
						else if (func_391(&Local_112.f_19)) {
							if (func_108(Local_112.f_9, vLocal_680, 25f - 1.5f)) {
								iLocal_101 = 1;
								iLocal_430 = 0;
								if (Local_112.f_10 != 3 && Local_112.f_10 != 4) {
									Local_112.f_18 = gameplay::get_game_timer() - 50000;
				...
				if (func_353(Local_112.f_9, Local_112.f_19, 20f, 0, 1090519040, 1097859072, 0) ||
...
void func_389() {
	if (iLocal_478 < 10) {
		if (!iLocal_431) {
			if (!func_60()) {
				if (func_108(Local_112.f_9, vLocal_680, 25f + 5f)) {
					iLocal_456 = 0;
					if (ui::is_message_being_displayed()) {
						iLocal_456 = 1;
					}
			...
			if (func_116(iLocal_479, gameplay::get_random_int_in_range(2500, 4000))) {
				iLocal_431 = 0;
			}
		}
		else {
...
// Position - 0x2AE94
bool func_390(int iParam0, int iParam1, int iParam2, float fParam3, float fParam4) {
	if (func_413(iParam0)) {
		if (!func_349(iParam1, 10)) {
			if (iParam2) {
				if (!func_108(Local_112.f_9, vLocal_680, fParam3)) {
					return false;
				}
				if (!func_392(iParam0, vLocal_680, fParam4)) {
					return false;
				}
			}
...
void func_393() {
	...
	case 1:
		...
		if (func_21(Local_112.f_9)) {
			...
			else if (player::is_player_free_aiming_at_entity(player::player_id(), Local_112.f_9) ||
					 player::is_player_targetting_entity(player::player_id(), Local_112.f_9)) {
				iLocal_101 = 2;
				iLocal_100 = 2;
			}
...
void func_394(var *uParam0, var *uParam1) {
	if (!uParam0->f_7) {
		if (func_397(26, func_399(uParam0->f_4), 0)) {
			if (!ped::is_ped_injured(player::player_ped_id())) {
				if (!func_60() && !audio::is_ambient_speech_playing(player::player_ped_id()) &&
...
char *func_395(int iParam0) {
	switch (iParam0) {
	case 0: return "BB1_TE";

	case 1: return "BB2_TE";

	case 2: return "BB3_TE";

	case 3: return "BB4_TE";
...
char *func_396(int iParam0) {
	switch (iParam0) {
	case 0: return "BB1AUD";

	case 1: return "BB2AUD";

	case 2: return "BB3AUD";

	case 3: return "BB4AUD";
...
bool func_397(int iParam0, int iParam1, int iParam2) {
	...
	iVar3 = 0;
	while (iVar3 < 16) {
		if (Global_45863[iVar1 /*120*/].f_86[iVar3] &&
			Global_45863[iVar1 /*120*/].f_18[iVar3] == Global_46225[iVar0 /*203*/].f_1 &&
			Global_45863[iVar1 /*120*/].f_1[iVar3] == iVar2) {
	...
	if (iLocal_98 == 0) {
		...
		if (!entity::is_entity_dead(Local_112.f_9, 0) && !ped::is_ped_injured(Local_112.f_9)) {
			if (iLocal_98 == 2 || iLocal_98 == 1 || iLocal_98 == 7) {
				fVar0 = 150f;
				if (ped::get_ped_parachute_state(player::player_ped_id()) != -1 ||
					ped::get_ped_parachute_state(Local_112.f_9) != -1) {
					fVar0 += 300f;
				}
				if (!func_108(Local_112.f_9, vLocal_680, fVar0)) {
					if (entity::is_entity_occluded(Local_112.f_9)) {
						iLocal_102 = 2;
						return;
					}
				...
				if (Local_112.f_10 != 19 && Local_112.f_10 != 20) {
					if (!func_108(Local_112.f_9, vLocal_680, 1000f)) {
						iLocal_102 = 2;
						return;
					}
				}
				...
				if (!func_108(Local_112.f_9, vLocal_680, 80f)) {
					if (entity::is_entity_occluded(Local_112.f_9)) {
						iLocal_102 = 2;
						return;
					}
...
bool func_403(int iParam0) {
	if (func_21(Local_385)) {
		if (entity::has_entity_been_damaged_by_any_ped(Local_385) ||
			entity::has_entity_been_damaged_by_any_vehicle(Local_385) ||
			entity::has_entity_been_damaged_by_any_object(Local_385)) {
			return true;
		}
		...
		if (func_409(Local_385, 1126825984)) {
			return true;
		}
		if (func_404(Local_385, 1, 0, 0, 0)) {
			return true;
		}
...
bool func_404(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_413(player::player_ped_id()) && func_413(iParam0)) {
		...
		if (!iParam2) {
			if (func_408(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_405(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
// Position - 0x2B8BD
bool func_405(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
bool func_406(int iParam0, float fParam1) {
	...
	if (gameplay::_0x82FDE6A57EE4EE44(iParam0, joaat("weapon_grenade"), fParam1, &vVar1, &uVar0, 0) ||
		...
		if (func_407(iParam0, vVar1, 90f, 0)) {
			return true;
		}
	}
	return false;
...
// Position - 0x2BA5E
bool func_407(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
// Position - 0x2BAEC
bool func_408(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
bool func_409(int iParam0, float fParam1) {
	...
	if (func_413(player::player_ped_id()) && func_413(iParam0)) {
		if (func_411(iParam0) || player::is_player_targetting_entity(player::player_id(), iParam0)) {
			if (weapon::is_ped_armed(player::player_ped_id(), 6)) {
				fVar0 = 40f;
			}
			else {
...
// Position - 0x2BBAA
bool func_410(int iParam0, float fParam1) { return func_361(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
void func_412(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	func_18(iParam0, vParam1, fParam4, iParam5, 1);
	if (iParam6) {
		if (func_413(iParam0)) {
			ped::_0x2208438012482A1A(iParam0, 0, 0);
		}
...
// Position - 0x2BEA2
void func_419() {
	streaming::remove_anim_set(func_356());
	streaming::remove_anim_set(func_357());
}
...
// Position - 0x2BF19
void func_421(int iParam0) { Global_89130 = iParam0; }
...
void func_425(bool bParam0, int iParam1) {
	...
	func_190(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, iParam1, 1, 1, 1);
}
...
// Position - 0x2C15B
void func_427(var *uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8,
	...
	if (iVar0 == 1) {
		...
		*uParam0 = func_449(vParam1, fParam4);
	}
	else if (iParam9 == 1) {
		if (func_99(vParam1, 0f, 0f, 0f, 0)) {
		...
		if (func_82(iParam12)) {
			func_444(iParam12, 0);
			while (!func_428(uParam0, iParam12, vParam1, fParam4, 1, 0)) {
				system::wait(0);
			}
		}
		else {
...
// Position - 0x2C2EE
int func_428(int *iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7) {
	int iVar0;
	var *uVar1;
	struct<97> Var5;
	int iVar103;
		...
		if (Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/] == Var5) {
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/],
				...
				func_439(iParam0, &Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/].f_31,
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/],
				...
				func_439(iParam0, &Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/].f_31,
...
// Position - 0x2D12C
void func_429(int iParam0, var *uParam1, int iParam2, int iParam3) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
	...
	if (func_82(iParam0) && entity::does_entity_exist(*uParam1) && vehicle::is_vehicle_driveable(*uParam1, 0)) {
		...
		if (vehicle::get_vehicle_mod_kit(*uParam1) >= 0 && vehicle::get_vehicle_mod_kit(*uParam1) < 255 &&
			func_433(*uParam1, 0, &iVar0)) {
			func_171(uParam1, &Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_31,
			...
			if (iParam3) {
				...
				Global_101700.f_19077[iParam0 /*43*/].f_31 = func_432(*uParam1);
				...
				func_430(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_5,
				...
				func_430(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0,
...
// Position - 0x2DD4F
int func_430(int iParam0, int iParam1, int iParam2, int iParam3, int *iParam4) {
	int iVar0;
	int iVar1;
	char *sVar2;
	int iVar6;
...
// Position - 0x2DDC2
bool func_431(int iParam0, char *sParam1, int *iParam2, int *iParam3, int *iParam4) {
	*iParam2 = -1;
	*iParam3 = -1;
	*iParam4 = -1;
	switch (iParam0) {
...
int func_433(int iParam0, int iParam1, int *iParam2) {
	...
	*iParam2 = 0;
	...
	iVar0 = entity::get_entity_model(iParam0);
	if (!func_434(iVar0, iParam1, iParam2)) {
		return 0;
	}
	...
	if (!network::network_is_game_in_progress()) {
		if (func_143(iParam0) && entity::get_entity_model(iParam0) != joaat("sentinel2") &&
...
// Position - 0x2F8B8
bool func_438(int iParam0) { return vehicle::is_vehicle_extra_turned_on(iParam0, 5); }
...
int func_439(int iParam0, var *uParam1, var *uParam2) {
	...
	if (func_442(entity::get_entity_model(*iParam0), 1) &&
		vehicle::get_vehicle_mod(*iParam0, 24) != func_441(*iParam0, (*uParam1)[38] - 1)) {
		vehicle::set_vehicle_mod(*iParam0, 24, func_441(*iParam0, (*uParam1)[38] - 1), 0);
	}
	if (func_440(*iParam0)) {
	...
	while (iVar0 < 9) {
		if (entity::does_entity_exist(Global_89155[iVar0])) {
			if (iParam0 == 145 || Global_89165[iVar0] == iParam0) {
				if (iParam1 == 0 || entity::get_entity_model(Global_89155[iVar0]) == func_160(iParam0, iParam1)) {
...
void func_446(int iParam0) {
	...
	if (func_159(&Global_68531.f_555[0 /*21*/], iParam0)) {
		...
		Global_68531[iParam0] = 1;
		if (gameplay::is_bit_set(Global_68531.f_555[0 /*21*/].f_9, 13)) {
			if (iParam0 == 24 && func_165(iParam0, 0) && Global_69440.f_66 == 0 &&
				Global_101700.f_31389.f_1958[Global_68531.f_555[0 /*21*/].f_14] != 0 &&
				Global_101700.f_31389.f_1958[Global_68531.f_555[0 /*21*/].f_14] > 3 &&
				(!func_447(0, Global_68531.f_555[0 /*21*/].f_12) || !func_447(1, Global_68531.f_555[0 /*21*/].f_12))) {
...
// Position - 0x3013A
int func_448(var *uParam0) { return *uParam0; }

// Position - 0x30145
int func_449(vector3 vParam0, float fParam3) { return func_450(&Global_96040.f_2311, vParam0, fParam3, 0); }

// Position - 0x3015F
int func_450(var *uParam0, vector3 vParam1, float fParam4, int iParam5) {
	int iVar0;
	vector3 vVar1;
	bool bVar4;
	var uVar5;
	...
	if (func_460(uParam0)) {
		...
		if (func_459(uParam0)) {
			...
			if (entity::does_entity_exist(iVar0)) {
				...
				else if (!func_452(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10 &&
...
// Position - 0x304D3
int func_452(int iParam0, vector3 vParam1, bool bParam4) {
	int iVar0;
	var uVar1[3];
	int iVar5;
	int iVar6;
	...
	case joaat("cuban800"):
		...
		iVar6 = 0;
		while (iVar6 <= iVar5 - 1) {
			if (func_454(iParam0, uVar1[iVar6], 1) &&
				func_453(entity::get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)) {
				if (!bParam4 || func_99(vParam1, 0f, 0f, 0f, 0) ||
...
// Position - 0x306DB
int func_453(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
void func_455(int iParam0, var *uParam1, int iParam2, int iParam3) {
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (gameplay::is_bit_set(uParam1->f_77, 15) || func_458(iParam0) ||
...
// Position - 0x30CCA
var func_457() { return dlc2::is_dlc_present(-1691188696); }
...
// Position - 0x30DBA
int func_461() { return func_459(&Global_96040.f_2311); }

// Position - 0x30DCD
void func_462() { func_463(&Global_96040.f_2311); }
...
// Position - 0x30F5A
int func_467() { return func_460(&Global_96040.f_2311); }
...
void func_470() {
	...
	ped::set_relationship_between_groups(5, 1862763509, iLocal_664);
	ped::set_relationship_between_groups(5, iLocal_664, 1862763509);
	vVar0 = {func_477(Local_103)};
	vVar3 = {func_476(Local_103)};
	ped::set_ped_non_creation_area(vVar0, vVar3);
	...
	func_471();
	if (func_21(player::player_ped_id())) {
		func_89(&uLocal_499, 2, player::player_ped_id(), "TREVOR", 0, 1);
...
void func_471() {
	if (func_21(Local_112.f_9)) {
		...
		entity::set_entity_health(Local_112.f_9, 200);
		...
		ai::set_sequence_to_repeat(iLocal_484, 1);
		ai::close_sequence_task(iLocal_484);
		ai::task_perform_sequence(Local_112.f_9, iLocal_484);
		ai::clear_sequence_task(&iLocal_484);
		if (func_21(Local_132[0 /*20*/])) {
			...
			if (entity::does_entity_exist(Local_340[0 /*9*/])) {
				if (!entity::is_entity_attached(Local_340[0 /*9*/])) {
					...
					ai::task_look_at_entity(Local_132[0 /*20*/], Local_112.f_9, -1, 2060, 3);
					ai::task_play_anim(Local_132[0 /*20*/], "oddjobs@bailbond_mountain", "Idle_Camman", 8f, -8f, -1, 49,
									   0, 0, 0, 0);
					ai::task_turn_ped_to_face_entity(Local_132[0 /*20*/], Local_112.f_9, -1);
				}
			}
...
int func_473() {
	...
	if (iLocal_471 > 0) {
		...
		while (iVar2 <= iLocal_471 - 1) {
			if (func_52(&Local_132[iVar2 /*20*/], Local_132[iVar2 /*20*/].f_19, Local_132[iVar2 /*20*/].f_1,
						Local_132[iVar2 /*20*/].f_4, 0, 0, 0)) {
	...
	if (iLocal_468 > 0) {
		...
		while (iVar2 <= iLocal_468 - 1) {
			if (func_475(&Local_254[iVar2 /*6*/], Local_254[iVar2 /*6*/].f_5, Local_254[iVar2 /*6*/].f_1,
						 Local_254[iVar2 /*6*/].f_4, 1)) {
				iVar0++;
			}
			iVar2++;
		}
	...
	if (iLocal_469 > 0) {
		...
		while (iVar2 <= iLocal_469 - 1) {
			if (func_55(&Local_291[iVar2 /*6*/], Local_291[iVar2 /*6*/].f_5, Local_291[iVar2 /*6*/].f_1,
						Local_291[iVar2 /*6*/].f_4, 1)) {
				iVar0++;
			}
			iVar2++;
		}
	...
	if (iLocal_467 > 0) {
		...
		while (iVar2 <= iLocal_467 - 1) {
			if (func_55(&Local_340[iVar2 /*9*/], Local_340[iVar2 /*9*/].f_8, Local_340[iVar2 /*9*/].f_1,
						Local_340[iVar2 /*9*/].f_7, 1)) {
	...
	if (iLocal_470 > 0) {
		...
		while (iVar2 <= iLocal_470 - 1) {
			if (func_474(&Local_377[iVar2 /*7*/], Local_377[iVar2 /*7*/].f_5, Local_377[iVar2 /*7*/].f_2,
						 Local_377[iVar2 /*7*/].f_6, Local_377[iVar2 /*7*/].f_1, 1)) {
				iVar0++;
			}
			iVar2++;
		}
...
// Position - 0x3164C
bool func_474(var *uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, int iParam7) {
	if (!object::does_pickup_exist(*uParam0)) {
		if (func_54(iParam6)) {
...
// Position - 0x316BD
bool func_475(var *uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	if (!entity::does_entity_exist(*uParam0)) {
		if (func_54(iParam1)) {
...
Vector3 func_476(struct<5> Param0, var uParam5, var uParam6, var uParam7) {
	switch (Param0.f_4) {
	case 0: return 2956.785f, 2824.594f, 45.1931f;

	case 1: return 197.6706f, 2333.772f, 105.647f;

	case 2: return 535.9079f, 5518.323f, 772.5947f;

	case 3: return 1446.768f, 6361.93f, 26.9007f;
...
Vector3 func_477(struct<5> Param0, var uParam5, var uParam6, var uParam7) {
	switch (Param0.f_4) {
	case 0: return 2929.665f, 2782.219f, 34.8822f;

	case 1: return 145.6927f, 2266.886f, 70.4983f;

	case 2: return 491.7797f, 5485.706f, 736.4918f;

	case 3: return 1414.211f, 6326.607f, 20.8036f;
...
// Position - 0x31C00
float func_479() { return 75.15f; }

// Position - 0x31C0D
Vector3 func_480() { return 2727.29f, 4145.9f, 44.16f; }

// Position - 0x31C24
float func_481() { return 71f; }

// Position - 0x31C31
Vector3 func_482() { return 2727.686f, 4145.715f, 44.08f; }

// Position - 0x31C48
int func_483() { return 1385417869; }

// Position - 0x31C55
float func_484() { return -91.28f; }

// Position - 0x31C62
Vector3 func_485() { return 2728.35f, 4145.59f, 43.3f; }

// Position - 0x31C79
int func_486() { return -741944541; }

// Position - 0x31C86
float func_487() { return 89.19f; }

// Position - 0x31C93
Vector3 func_488() { return 2728.33f, 4145.6f, 43.89f; }
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_493() || Global_100747 ||
						Global_25192 || func_499() || func_87(8, -1) || func_498() || func_497() || func_491() ||
						func_492() || Global_101700.f_6647.f_919[iVar0] == 5) {
						return 0;
					}
					break;

				case 1:
					if (player::is_player_being_arrested(player::player_id(), 1) || func_493() || Global_25192 ||
						func_499() || func_87(8, -1) || func_491() || func_498() || func_497() || func_492() ||
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						player::is_player_climbing(player::player_id()) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_493() || Global_100747 ||
						Global_25192 || func_499() || func_87(8, -1) || func_491() || func_498() || func_497() ||
						func_492() || Global_101700.f_6647.f_919[iVar0] == 5 || Global_36328 != -1) {
						return 0;
					}
					break;
				...
				case 3:
					if (ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_493() || Global_100747 ||
						Global_25192 || func_499() || func_87(8, -1) || func_498() || func_497() || func_492() ||
						Global_101700.f_6647.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 4:
					if (func_493() || player::get_player_wanted_level(player::player_id()) > 0 || func_87(8, -1) ||
						func_492() || func_496() || Global_101700.f_6647.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 6:
					if (entity::does_entity_exist(player::player_ped_id())) {
						if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
							...
							player::is_player_being_arrested(player::player_id(), 1) ||
							player::is_player_climbing(player::player_id()) || func_493() || Global_25192 ||
							func_499() || func_87(8, -1) || func_497() || func_491() || func_492() ||
							Global_101700.f_6647.f_919[iVar0] == 5) {
							return 0;
						}
					}
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						entity::is_entity_in_air(player::player_ped_id()) ||
						ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) || func_493() || func_497() ||
						Global_100747 || Global_25192 || func_499() || Global_36912 || func_87(8, -1) || func_491() ||
						func_496() || func_492() || Global_101700.f_6647.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 8:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						player::is_player_being_arrested(player::player_id(), 1) ||
						player::is_player_climbing(player::player_id()) || func_493() || Global_100747 ||
						Global_25192 || func_499() || func_87(8, -1) || func_491() || func_496() || func_498() ||
						func_497() || func_492()) {
						return 0;
					}
					break;
...
// Position - 0x3252A
var func_495() { return Global_91530.f_1; }
...
// Position - 0x3255E
bool func_497() { return Global_91543.f_304 > 0; }

// Position - 0x3256F
bool func_498() { return Global_91543.f_303 > 0; }

// Position - 0x32580
var func_499() { return Global_1315233; }

// Position - 0x3258C
int func_500(int iParam0) { return func_501(iParam0, Global_35781); }
...
void func_502(int iParam0) {
	...
	if (!func_526()) {
		...
		func_503(script::get_this_script_name());
	}
}
...
void func_506(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_507(uParam1, "Abigail1", func_509(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				 "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_508(iParam0), 1, 0);
		break;

	case 1:
		func_507(uParam1, "Abigail2", func_509(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				 -1, 4, 1, 0, 2359, func_508(iParam0), 1, 0);
		break;

	case 2:
		func_507(uParam1, "Barry1", func_509(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				 4, 1, 0, 2359, func_508(iParam0), 1, 0);
		break;

	case 3:
		func_507(uParam1, "Barry2", func_509(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				 4, 4, 0, 2359, func_508(iParam0), 1, 1);
		break;

	case 4:
		func_507(uParam1, "Barry3", func_509(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2,
				 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 5:
		func_507(uParam1, "Barry3A", func_509(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0,
				 "", 166, 0, 7, 4, 2, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 6:
		func_507(uParam1, "Barry3C", func_509(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				 7, 4, 2, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 7:
		func_507(uParam1, "Barry4", func_509(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0,
				 "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_508(iParam0), 0, 0);
		break;

	case 8:
		func_507(uParam1, "Dreyfuss1", func_509(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				 0, "", 0, 0, -1, 4, 2, 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 9:
		func_507(uParam1, "Epsilon1", func_509(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1,
				 10, 4, 1, 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 10:
		func_507(uParam1, "Epsilon2", func_509(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0,
				 11, 4, 1, 0, 2359, func_508(iParam0), 1, 0);
		break;

	case 11:
		func_507(uParam1, "Epsilon3", func_509(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				 0, 0, 12, 4, 1, 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 12:
		func_507(uParam1, "Epsilon4", func_509(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				 "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 13:
		func_507(uParam1, "Epsilon5", func_509(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16,
				 "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_508(iParam0), 1, 0);
		break;

	case 14:
		func_507(uParam1, "Epsilon6", func_509(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 15:
		func_507(uParam1, "Epsilon7", func_509(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 16:
		func_507(uParam1, "Epsilon8", func_509(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_508(iParam0), 1, 0);
		break;

	case 17:
		func_507(uParam1, "Extreme1", func_509(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 18:
		func_507(uParam1, "Extreme2", func_509(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 19:
		func_507(uParam1, "Extreme3", func_509(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 20:
		func_507(uParam1, "Extreme4", func_509(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 21:
		func_507(uParam1, "Fanatic1", func_509(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_508(iParam0), 1, 0);
		break;

	case 22:
		func_507(uParam1, "Fanatic2", func_509(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_508(iParam0), 1, 0);
		break;

	case 23:
		func_507(uParam1, "Fanatic3", func_509(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_508(iParam0), 0, 1);
		break;

	case 24:
		func_507(uParam1, "Hao1", func_509(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_508(iParam0), 0, 1);
		break;

	case 25:
		func_507(uParam1, "Hunting1", func_509(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 26:
		func_507(uParam1, "Hunting2", func_509(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 27:
		func_507(uParam1, "Josh1", func_509(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_508(iParam0), 1, 0);
		break;

	case 28:
		func_507(uParam1, "Josh2", func_509(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_508(iParam0), 1, 1);
		break;

	case 29:
		func_507(uParam1, "Josh3", func_509(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_508(iParam0), 1, 1);
		break;

	case 30:
		func_507(uParam1, "Josh4", func_509(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_508(iParam0), 1, 0);
		break;

	case 31:
		func_507(uParam1, "Maude1", func_509(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 32:
		func_507(uParam1, "Minute1", func_509(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 33:
		func_507(uParam1, "Minute2", func_509(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 34:
		func_507(uParam1, "Minute3", func_509(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 35:
		func_507(uParam1, "MrsPhilips1", func_509(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 36:
		func_507(uParam1, "MrsPhilips2", func_509(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_508(iParam0), 0, 0);
		break;

	case 37:
		func_507(uParam1, "Nigel1", func_509(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_508(iParam0), 1, 0);
		break;

	case 38:
		func_507(uParam1, "Nigel1A", func_509(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_508(iParam0), 1, 1);
		break;

	case 39:
		func_507(uParam1, "Nigel1B", func_509(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_508(iParam0), 1, 1);
		break;

	case 40:
		func_507(uParam1, "Nigel1C", func_509(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_508(iParam0), 1, 1);
		break;

	case 41:
		func_507(uParam1, "Nigel1D", func_509(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_508(iParam0), 1, 1);
		break;

	case 42:
		func_507(uParam1, "Nigel2", func_509(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_508(iParam0), 1, 1);
		break;

	case 43:
		func_507(uParam1, "Nigel3", func_509(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_508(iParam0), 1, 1);
		break;

	case 44:
		func_507(uParam1, "Omega1", func_509(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 45:
		func_507(uParam1, "Omega2", func_509(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 46:
		func_507(uParam1, "Paparazzo1", func_509(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 47:
		func_507(uParam1, "Paparazzo2", func_509(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 48:
		func_507(uParam1, "Paparazzo3", func_509(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 49:
		func_507(uParam1, "Paparazzo3A", func_509(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 50:
		func_507(uParam1, "Paparazzo3B", func_509(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 51:
		func_507(uParam1, "Paparazzo4", func_509(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 52:
		func_507(uParam1, "Rampage1", func_509(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 54:
		func_507(uParam1, "Rampage3", func_509(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_508(iParam0), 1, 0);
		break;

	case 55:
		func_507(uParam1, "Rampage4", func_509(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_508(iParam0), 1, 0);
		break;

	case 56:
		func_507(uParam1, "Rampage5", func_509(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_508(iParam0), 0, 0);
		break;

	case 53:
		func_507(uParam1, "Rampage2", func_509(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_508(iParam0), 1, 0);
		break;

	case 57:
		func_507(uParam1, "TheLastOne", func_509(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 58:
		func_507(uParam1, "Tonya1", func_509(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 59:
		func_507(uParam1, "Tonya2", func_509(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_508(iParam0), 0, 1);
		break;

	case 60:
		func_507(uParam1, "Tonya3", func_509(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_508(iParam0), 0, 1);
		break;

	case 61:
		func_507(uParam1, "Tonya4", func_509(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_508(iParam0), 0, 1);
		break;

	case 62:
		func_507(uParam1, "Tonya5", func_509(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_508(iParam0), 0, 1);
		break;
...
// Position - 0x33B83
void func_507(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
// Position - 0x34625
void func_520() { Global_17151.f_5 = 1; }

// Position - 0x34633
void func_521() { Global_17151.f_5 = 0; }
