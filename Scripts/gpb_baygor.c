...
void __EntryFunction__() {
	...
	if (gameplay::get_game_timer() < Global_25450 + 10000 && !func_103()) {
		func_110(0);
	}
	...
	while (iVar0 == 1) {
		...
		if (player::is_player_playing(player::player_id())) {
			if (player::is_player_free_aiming_at_entity(player::player_id(), iLocal_240) ||
				...
				&&fVar43 < 25f && func_85(player::player_ped_id()) != joaat("weapon_unarmed") &&
					func_82(iLocal_240, player::player_ped_id(), 1126825984, 0) {
					if (!func_86()) {
						func_88();
						ai::task_play_anim(iLocal_240, &cLocal_324, &Local_218, 2f, -2f, -1, 0, 0, 0, 0, 0);
						iLocal_250 = 24;
		...
		case 8:
			...
			if (func_57()) {
				...
				if (entity::is_entity_playing_anim(iLocal_240, &Local_372, &Local_356, 3)) {
					func_50(Global_101645[iLocal_251], iLocal_297,
		...
		if ((iLocal_250 == 0 || iLocal_250 == 1 || iLocal_250 == 3 || iLocal_250 == 8 || iLocal_250 == 9 ||
			 iLocal_250 == 7) &&
			func_81(iLocal_240, player::player_ped_id(), 1) < 5f && iLocal_436 == 1 &&
	...
	while (true) {
		...
		if (entity::is_entity_occluded(iLocal_240) && func_81(iLocal_240, player::player_ped_id(), 1) > 50f &&
...
// Position - 0x1BC5
void func_33() { iLocal_254 = gameplay::get_random_int_in_range(0, iLocal_253); }
...
// Position - 0x2388
void func_51() { streaming::remove_anim_dict(&Local_388); }
...
void func_55(int iParam0, char *sParam1, char *sParam2) {
	...
	switch (iParam0) {
	case 1: StringCopy(sParam2, "Ask_You_A_Question", 64); break;

	case 2: StringCopy(sParam2, "You_Can_Ignore_Me", 64); break;

	case 3: StringCopy(sParam2, "Trees_Can_Talk", 64); break;

	case 4: StringCopy(sParam2, "We_Are_All_Related", 64); break;

	case 5: StringCopy(sParam2, "Do_You_Want_To_Be_Happy", 64); break;

	case 6: StringCopy(sParam2, "Salvation_Comes_At_A_Price", 64); break;

	case 7: StringCopy(sParam2, "Do_You_Want_Happiness", 64); break;

	case 8: StringCopy(sParam2, "Im_An_Epsilonist", 64); break;
	}
}
...
// Position - 0x251B
bool func_57() { return Global_91543.f_303 > 0; }
...
// Position - 0x25EF
void func_63(char *sParam0) { func_29(iLocal_297, sParam0); }
...
// Position - 0x26B0
void func_67(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			 int iParam8) {
	func_68(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

// Position - 0x26D0
void func_68(char *sParam0, char *sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
		...
		if (!ui::does_blip_exist(*iParam0)) {
			if (entity::does_entity_exist(*iParam1)) {
				if (!ped::is_ped_injured(*iParam1)) {
					*iParam0 = func_78(*iParam1, iParam2, 145);
					if (iParam2 == 0) {
...
// Position - 0x2D72
var func_80(bool bParam0, float fParam1, float fParam2) {
	if (bParam0) {
		return fParam1;
	}
	return fParam2;
...
int func_82(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_84(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
...
// Position - 0x2F77
var func_93(int iParam0, int iParam1) { return func_81(iParam0, iParam1, 1); }
...
// Position - 0x309D
void func_97(var *uParam0, var uParam1) { *uParam0 |= uParam1; }
...
// Position - 0x3141
void func_100() { func_101(); }

// Position - 0x314D
void func_101() {
	iLocal_448 = object::create_object(joaat("prop_cs_pamphlet_01"), entity::get_entity_coords(iLocal_240, 1), 1, 1, 0);
	entity::attach_entity_to_entity(iLocal_448, iLocal_240, ped::get_ped_bone_index(iLocal_240, 28422), 0f, 0f, 0f, 0f,
									0f, 0f, 0, 0, 0, 0, 2, 1);
...
// Position - 0x32A3
int func_106() { return 1; }

// Position - 0x32AC
bool func_107(int iParam0) { return func_108(Global_101700.f_19076, iParam0); }

// Position - 0x32C1
bool func_108(var uParam0, var uParam1) { return (uParam0 & uParam1) != 0; }
