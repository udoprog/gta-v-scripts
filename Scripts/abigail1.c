...
void func_1() {
	...
	case 0:
		...
		if (func_296(iLocal_149)) {
			if (entity::is_entity_playing_anim(iLocal_149, "rcmabigail", "loop_talk", 3) ||
				entity::is_entity_playing_anim(iLocal_149, "rcmabigail", "loop_look", 3)) {
	...
	case 1:
		func_292();
		if (func_296(iLocal_149) && entity::is_entity_playing_anim(iLocal_149, "rcmabigail", "loop_2_cs", 3) &&
			entity::get_entity_anim_current_time(iLocal_149, "rcmabigail", "loop_2_cs") > 0.99f) {
			iLocal_153++;
		}
		break;
	...
	case 3:
		if (cutscene::is_cutscene_playing()) {
			func_275(-1608.166f, 5246.844f, 1.97751f, -1604.421f, 5238.246f, 4.996789f, 6f, -1596.462f, 5232.455f,
					 2.9794f, 25.5125f, 1, 1, 1, 0, 0);
	...
	case 4:
		if (cutscene::is_cutscene_playing()) {
			if (cutscene::can_set_exit_state_for_camera(0)) {
				iLocal_150 = cam::create_cam("DEFAULT_SCRIPTED_CAMERA", 1);
				cam::set_cam_params(iLocal_150, -1606.249f, 5273.964f, 5.199186f, -1.633685f, 0f, -175.2748f, 30.16609f,
									0, 1, 1, 2);
				cam::set_cam_params(iLocal_150, -1605.681f, 5274.014f, 3.870102f, -2.089875f, 0f, -178.064f, 30.16609f,
									10000, 1, 1, 2);
				cam::render_script_cams(1, 0, 3000, 1, 0, 0);
				cam::shake_cam(iLocal_150, "HAND_SHAKE", 0.3f);
			}
			if (func_296(player::player_ped_id()) && cutscene::can_set_exit_state_for_registered_entity("Michael", 0)) {
				unk1::_0x81CBAE94390F9F89();
				ai::clear_ped_tasks(player::player_ped_id());
				ai::task_follow_nav_mesh_to_coord(player::player_ped_id(), -1606.534f, 5253.981f, 2.9994f, 1f, 20000,
												  1048576000, 0, 1193033728);
				ai::task_look_at_coord(player::player_ped_id(), -1602.62f, 5260.37f, 1.41f, -1, 0, 2);
			}
			if (func_296(iLocal_149) && cutscene::can_set_exit_state_for_registered_entity("Abigail", 0)) {
				ai::clear_ped_tasks(iLocal_149);
				ai::task_follow_nav_mesh_to_coord(iLocal_149, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 1048576000, 0,
												  1193033728);
			}
		}
		else {
	...
	case 5:
		if (iLocal_155 == 0 && cam::get_follow_ped_cam_view_mode() == 4 &&
			gameplay::get_game_timer() > iLocal_152 - 300) {
...
void func_172(int iParam0, int iParam1) {
	...
	func_187(iParam0, G_TextMessageConfig);
	if (!iParam1) {
...
void func_178(int iParam0) {
	switch (iParam0) {
	case 30: func_179(22, 1, 0, 1, 0); break;
...
void func_179(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	if (iParam0 != 198) {
		...
		func_182(iParam0, iParam3, iParam4, 0);
...
// Position - 0x213CD
bool func_182(int iParam0, bool bParam1, int iParam2, int iParam3) {
	bool bVar0;
	int iVar1;
	int iVar2;
	struct<5> Var3;
...
// Position - 0x21D38
int func_184() { return Global_25191; }
...
void func_187(int iParam0, bool bParam1) {
	switch (iParam0) {
	case 46: func_188(4, bParam1); break;

	case 16: func_188(6, bParam1); break;

	case 37: func_188(17, bParam1); break;

	case 31: func_188(16, bParam1); break;
	}
}
...
// Position - 0x2572B
void func_189(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8) {
	func_190(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

// Position - 0x2574D
void func_190(char *sParam0, char *sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6,
...
// Position - 0x25D46
int func_198() { return func_199(script::get_this_script_name(), 0); }
...
void func_208(int iParam0, int iParam1, int iParam2, int iParam3) {
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_212(player::player_id()) &&
				!func_210(player::player_id(), 0) && !func_209()) {
...
// Position - 0x2639B
bool func_209() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x26486
bool func_213() { return gameplay::is_bit_set(Global_2359301, 3); }
...
// Position - 0x266BF
void func_225(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8,
...
// Position - 0x2687D
Vector3 func_226(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }
	...
	if (entity::does_entity_exist(Global_93635.f_4)) {
		if (vehicle::is_vehicle_driveable(Global_93635.f_4, 0)) {
			if (func_274(24) != Global_93635.f_4) {
				if (iParam4 == 1) {
					if (func_271(entity::get_entity_coords(Global_93635.f_4, 1), iParam5, &vVar0, &fVar3)) {
						vParam0 = {vVar0};
						fParam3 = fVar3;
					}
				}
				func_228(Global_93635.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
// Position - 0x2690B
void func_228(int iParam0, vector3 vParam1, float *fParam4, int iParam5, int iParam6) {
	struct<60> Var0;
...
int func_231(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_246(iParam0, 0, 0) ||
		func_246(iParam0, 1, 0) || func_246(iParam0, 2, 0) || func_265(iParam0) != 145 || func_245(iParam0) ||
		func_244(iParam0) || func_243(iParam0) || func_242(iParam0) || !func_232(entity::get_entity_model(iParam0))) {
		if (func_244(iParam0)) {
		}
		if (func_244(iParam0)) {
		}
...
// Position - 0x282D9
bool func_247(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
var func_248() {
	...
	func_258(&iVar0, time::get_clock_seconds());
	func_257(&iVar0, time::get_clock_minutes());
	func_256(&iVar0, time::get_clock_hours());
	func_251(&iVar0, time::get_clock_day_of_month());
	func_250(&iVar0, time::get_clock_month());
	func_249(&iVar0, time::get_clock_year());
	return iVar0;
}
...
// Position - 0x285E0
int func_255(var uParam0) { return uParam0 & 15; }
...
// Position - 0x2A2DC
bool func_266(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
// Position - 0x2A780
bool func_271(vector3 vParam0, int iParam3, var *uParam4, float *fParam5) {
	int iVar0;

	iVar0 = func_272(vParam0, iParam3, 1);
	switch (iVar0) {
	case 0:
...
// Position - 0x2A896
int func_272(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
...
// Position - 0x2A925
var func_273(int iParam0) { return gameplay::is_bit_set(Global_101700.f_6188[iParam0], 0); }
...
// Position - 0x2A959
void func_275(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11,
			  int iParam12, int iParam13, int iParam14, int iParam15) {
	func_276(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14,
			 iParam15);
}

// Position - 0x2A982
void func_276(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
		...
		if (vehicle::is_vehicle_driveable(iVar0, 0)) {
			...
			if (entity::is_entity_in_angled_area(iVar0, vParam0, vParam3, fParam6, 0, 1, 0)) {
				...
				if (vVar10.z > vParam0.z && vVar10.z < vParam3.z || vVar10.z > vParam3.z && vVar10.z < vParam0.z) {
					if (func_278(iVar0, vParam0, vParam3, fParam6)) {
						bVar1 = true;
					}
				}
			}
...
// Position - 0x2AD9E
bool func_278(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	vector3 vVar9;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		vParam1.z = vParam4.z;
		vVar0 = {func_280(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (func_279(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_279(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_279(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_279(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_279(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_279(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_279(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_279(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_279(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_279(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_279(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_279(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_279(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_279(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_279(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_279(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x2B094
int func_279(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
// Position - 0x2B20C
bool func_283(int iParam0, float fParam1, int iParam2) {
	int iVar0;
	...
	if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
		if (!ped::is_ped_in_any_heli(player::player_ped_id()) && !ped::is_ped_in_any_boat(player::player_ped_id()) &&
			...
			if (!func_290(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), fParam1, 1, 1056964608, 0, 1, 0)) {
				...
				iVar0 = 0;
				if (!func_289(player::player_ped_id(), -828834893)) {
...
// Position - 0x2B410
bool func_290(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
void func_292() {
	if (func_296(player::player_ped_id())) {
		...
		if (iLocal_154 == 0) {
			if (func_296(iLocal_149)) {
				if (func_293(player::player_ped_id(), iLocal_149, 1) < 4f ||
					entity::get_entity_speed(player::player_ped_id()) > 2f &&
						func_293(player::player_ped_id(), iLocal_149, 1) < 6f) {
...
struct<2> func_305(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_313(iParam0)}; break;
	...
	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_312(iParam2)}; break;

		case 8: Var0 = {func_311(iParam2)}; break;

		case 7: Var0 = {func_310(iParam2)}; break;

		case 10: Var0 = {func_309(iParam2)}; break;

		case 5: Var0 = {func_308(iParam2)}; break;

		case 4: Var0 = {func_307(iParam2)}; break;

		default: StringCopy(&Var0, func_306(iVar2), 8); break;
		}
		break;
...
//Position - 0x2BFA6
bool func_314(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (!func_316(0) || G_TextMessageConfig || Global_69960 == 1 || !cam::is_screen_faded_in()) {
		return false;
	}
	switch (Global_69956) {
	case 0:
	...
	case 5:
		if (cutscene::is_cutscene_playing() || func_302(0) || func_315(1)) {
		}
		else {
			return true;
		}
...
// Position - 0x2C12C
bool func_317(int iParam0) { return func_318(iParam0, Global_35781); }
...
// Position - 0x2C374
void func_322(var *uParam0, bool bParam1) { func_323(&uParam0->f_41, bParam1); }
...
// Position - 0x2C42A
void func_326(var *uParam0, bool bParam1) { func_327(&uParam0->f_35, bParam1); }
...
// Position - 0x2C577
void func_331(var *uParam0, int iParam1) { func_332(&uParam0->f_28, iParam1); }
...
// Position - 0x2CAC7
void func_346() { Global_17151.f_5 = 1; }

// Position - 0x2CAD5
void func_347() { Global_17151.f_5 = 0; }
