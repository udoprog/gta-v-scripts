...
void __EntryFunction__() {
	...
	while (true) {
		...
		func_9();
		if (!iLocal_195 && !streaming::is_new_load_scene_active() && func_8()) {
			if (!Global_1573904) {
		...
		else if (!streaming::is_new_load_scene_active() && !func_8()) {
			func_1();
			iLocal_197 = 0;
		}
	...
	if (func_7(iParam0)) {
		...
		if (!iParam1) {
			if (Global_2501682.f_81[iParam0]) {
				...
				Global_2501682.f_118 += -1;
			}
		}
		if (Global_2501682.f_118 <= 0 || iParam1) {
			streaming::set_model_as_no_longer_needed(func_4());
			streaming::set_model_as_no_longer_needed(func_3());
			if (!iParam1) {
...
// Position - 0x369
int func_3() { return 1338692320; }

// Position - 0x376
int func_4() { return -1126512153; }

// Position - 0x383
var func_5(int iParam0, int iParam1) { return func_6(&Global_4006219[iParam0 /*45*/].f_15[iParam1 /*8*/]); }

// Position - 0x39D
var func_6(var uParam0) { return uParam0; }
...
// Position - 0x3C5
bool func_8() { return Global_2453925; }
...
void func_9() {
	...
	vVar1 = {func_18(iVar0)};
	if (func_17(iVar0)) {
		if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 0), vVar1, 1) >
			250f) {
			func_16(iVar0, 0);
			func_15(iVar0, 1);
			if (iVar0 == 17) {
	...
	if (func_14(iVar0) && !gameplay::are_strings_equal(&Global_32504, vVar1.f_3)) {
		bVar8 = false;
		if (network::network_is_game_in_progress()) {
			if (player::player_id() > -1) {
				if (gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_139, 8)) {
					bVar8 = true;
				}
			}
		}
...
// Position - 0x20EB
struct<6>
func_19(int iParam0, int iParam1) {
	struct<6> Var0;
...
void func_20()
{
	...
	if (iLocal_81 == iLocal_82) {
		fLocal_83 = gameplay::get_distance_between_coords(Global_34904[iLocal_81 /*31*/].f_2,
														  entity::get_entity_coords(player::player_ped_id(), 0), 1);
	}
	else {
		fVar0 = gameplay::get_distance_between_coords(Global_34904[iLocal_81 /*31*/].f_2,
													  entity::get_entity_coords(player::player_ped_id(), 0), 1);
		if (fVar0 < fLocal_83) {
			fLocal_83 = fVar0;
			iLocal_82 = iLocal_81;
...
void func_21(int iParam0) {
	...
	if (gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 4)) {
		if (player::is_player_playing(player::player_id())) {
			if (player::get_player_wanted_level(player::player_id()) > 0) {
				if (!gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 6)) {
					func_28(iParam0, 1);
				}
			}
			else if (gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 6)) {
				func_28(iParam0, 0);
			}
		}
	}
	...
	if (gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 6) ||
		gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 5) || func_25(iParam0)) {
		func_24(iParam0);
		iLocal_84 = iParam0;
		if (Global_34904[iParam0 /*31*/] == -1735618852 || Global_34904[iParam0 /*31*/] == 213039352 ||
			Global_34904[iParam0 /*31*/] == -1247364148 || Global_34904[iParam0 /*31*/] == 935592315 ||
			Global_34904[iParam0 /*31*/] == 179480401 || Global_34904[iParam0 /*31*/] == -804938986 ||
			Global_34904[iParam0 /*31*/] == -599111730 || Global_34904[iParam0 /*31*/] == 1423193534 ||
			Global_34904[iParam0 /*31*/] == -1958174046) {
			audio::_0x06C0023BED16DD6B(Global_34904[iParam0 /*31*/], 1);
		}
		if (gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 7)) {
			func_23(iParam0, 1);
		}
		if (!gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 2)) {
			if (gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 1)) {
				if (Global_34904[iParam0 /*31*/].f_22 > -1f) {
					Global_34904[iParam0 /*31*/].f_22 -= Global_34904[iParam0 /*31*/].f_23 * system::timestep();
					if (Global_34904[iParam0 /*31*/].f_22 < -1f) {
						Global_34904[iParam0 /*31*/].f_22 = -1f;
					}
					gameplay::clear_bit(&Global_34904[iParam0 /*31*/].f_1, 3);
				}
				else {
					gameplay::set_bit(&Global_34904[iParam0 /*31*/].f_1, 2);
				}
			}
		...
		else if (gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 1)) {
			if (Global_34904[iParam0 /*31*/].f_22 > -1f) {
				gameplay::clear_bit(&Global_34904[iParam0 /*31*/].f_1, 2);
			}
		}
		else if (Global_34904[iParam0 /*31*/].f_22 < 1f) {
			gameplay::clear_bit(&Global_34904[iParam0 /*31*/].f_1, 2);
		...
		if (!gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 3)) {
			iVar2 = 0;
			iVar3 = vehicle::get_closest_vehicle(Global_34904[iParam0 /*31*/].f_2, 15f, 0, 2175);
			if (entity::does_entity_exist(iVar3)) {
				if (vehicle::is_vehicle_driveable(iVar3, 0)) {
					fVar4 = system::vdist2(entity::get_entity_coords(iVar3, 1), Global_34904[iParam0 /*31*/].f_2);
			...
			if (gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 1)) {
				if (Global_34904[iParam0 /*31*/].f_22 < 0f) {
					...
					Global_34904[iParam0 /*31*/].f_22 = 0f;
					gameplay::set_bit(&Global_34904[iParam0 /*31*/].f_1, 3);
				}
			}
			...
			if (Global_34904[iParam0 /*31*/] == -1735618852 || Global_34904[iParam0 /*31*/] == 213039352 ||
				...
				Global_34904[iParam0 /*31*/] == -599111730 || Global_34904[iParam0 /*31*/] == 1423193534 ||
				Global_34904[iParam0 /*31*/] == -1958174046) {
				audio::_0x06C0023BED16DD6B(Global_34904[iParam0 /*31*/], 0);
			}
			func_22(iParam0);
		}
	}
...
void func_23(int iParam0, int iParam1) {
	...
	if (iParam1) {
		if (!gameplay::is_bit_set(Global_34904[iVar0 /*31*/].f_1, 2)) {
			if (gameplay::is_bit_set(Global_34904[iVar0 /*31*/].f_1, 1)) {
				if (Global_34904[iVar0 /*31*/].f_22 > -1f) {
					Global_34904[iVar0 /*31*/].f_22 -= Global_34904[iVar0 /*31*/].f_23 * system::timestep();
					if (Global_34904[iVar0 /*31*/].f_22 < -1f) {
						Global_34904[iVar0 /*31*/].f_22 = -1f;
					}
					gameplay::clear_bit(&Global_34904[iVar0 /*31*/].f_1, 3);
				}
				else {
					gameplay::set_bit(&Global_34904[iVar0 /*31*/].f_1, 2);
				}
			}
			...
			object::_set_door_ajar_angle(Global_34904[iVar0 /*31*/], Global_34904[iVar0 /*31*/].f_22, 0, 0);
			object::_set_door_acceleration_limit(Global_34904[iVar0 /*31*/], 1, 0, 1);
		}
		else if (gameplay::is_bit_set(Global_34904[iVar0 /*31*/].f_1, 1)) {
			if (Global_34904[iVar0 /*31*/].f_22 > -1f) {
				gameplay::clear_bit(&Global_34904[iVar0 /*31*/].f_1, 2);
			}
		}
		else if (Global_34904[iVar0 /*31*/].f_22 < 1f) {
			gameplay::clear_bit(&Global_34904[iVar0 /*31*/].f_1, 2);
	...
	else if (!gameplay::is_bit_set(Global_34904[iVar0 /*31*/].f_1, 3)) {
		iVar1 = 0;
		iVar2 = vehicle::get_closest_vehicle(Global_34904[iVar0 /*31*/].f_2, 15f, 0, 2175);
		if (entity::does_entity_exist(iVar2)) {
			if (vehicle::is_vehicle_driveable(iVar2, 0)) {
				fVar3 = system::vdist2(entity::get_entity_coords(iVar2, 1), Global_34904[iVar0 /*31*/].f_2);
		...
		if (gameplay::is_bit_set(Global_34904[iVar0 /*31*/].f_1, 1)) {
			if (Global_34904[iVar0 /*31*/].f_22 < 0f) {
				...
				Global_34904[iVar0 /*31*/].f_22 = 0f;
				gameplay::set_bit(&Global_34904[iVar0 /*31*/].f_1, 3);
			}
		}
		...
		while (iVar0 < Global_34904[iParam0 /*31*/].f_24) {
			...
			if (entity::does_entity_exist(iVar1)) {
				if (!ped::is_ped_injured(iVar1)) {
					if (system::vdist2(Global_34904[iParam0 /*31*/].f_2, entity::get_entity_coords(iVar1, 1)) <
						Global_34904[iParam0 /*31*/].f_6) {
						if (entity::is_entity_in_angled_area(iVar1, Global_34904[iParam0 /*31*/].f_9,
															 Global_34904[iParam0 /*31*/].f_12,
															 Global_34904[iParam0 /*31*/].f_8, 0, 1, 0)) {
							iLocal_86 = iVar0;
							return 1;
						}
						if (gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 0)) {
							if (entity::is_entity_in_angled_area(iVar1, Global_34904[iParam0 /*31*/].f_16,
																 Global_34904[iParam0 /*31*/].f_19,
																 Global_34904[iParam0 /*31*/].f_15, 0, 1, 0)) {
								iLocal_86 = iVar0;
								return 1;
							}
						}
						if (ped::is_ped_in_any_vehicle(iVar1, 0)) {
							...
							vVar9 = {func_26()};
							vVar12 = {func_26()};
							gameplay::get_model_dimensions(entity::get_entity_model(iVar2), &vVar3, &vVar6);
							vVar6.x = 0f;
							vVar3.x = 0f;
							...
							if (object::is_point_in_angled_area(vVar9, Global_34904[iParam0 /*31*/].f_9,
																Global_34904[iParam0 /*31*/].f_12,
																Global_34904[iParam0 /*31*/].f_8, 0, 1)) {
								iLocal_86 = iVar0;
								return 1;
							}
							if (object::is_point_in_angled_area(vVar12, Global_34904[iParam0 /*31*/].f_9,
																Global_34904[iParam0 /*31*/].f_12,
																Global_34904[iParam0 /*31*/].f_8, 0, 1)) {
								iLocal_86 = iVar0;
								return 1;
							...
							if (gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 0)) {
								if (object::is_point_in_angled_area(vVar9, Global_34904[iParam0 /*31*/].f_16,
																	Global_34904[iParam0 /*31*/].f_19,
																	Global_34904[iParam0 /*31*/].f_15, 0, 1)) {
									iLocal_86 = iVar0;
									return 1;
								}
								if (object::is_point_in_angled_area(vVar12, Global_34904[iParam0 /*31*/].f_16,
																	Global_34904[iParam0 /*31*/].f_19,
																	Global_34904[iParam0 /*31*/].f_15, 0, 1)) {
									iLocal_86 = iVar0;
									return 1;
							...
							if (vehicle::is_vehicle_attached_to_trailer(iVar2)) {
								...
								if (vehicle::get_vehicle_trailer_vehicle(iVar2, &iVar15)) {
									if (entity::is_entity_in_angled_area(iVar15, Global_34904[iParam0 /*31*/].f_9,
																		 Global_34904[iParam0 /*31*/].f_12,
																		 Global_34904[iParam0 /*31*/].f_8, 0, 1, 0)) {
										iLocal_86 = iVar0;
										return 1;
									...
									if (gameplay::is_bit_set(Global_34904[iParam0 /*31*/].f_1, 0)) {
										if (entity::is_entity_in_angled_area(iVar15, Global_34904[iParam0 /*31*/].f_16,
																			 Global_34904[iParam0 /*31*/].f_19,
																			 Global_34904[iParam0 /*31*/].f_15, 0, 1,
																			 0)) {
											iLocal_86 = iVar0;
		...
		if (!entity::is_entity_dead(player::player_ped_id(), 0)) {
			...
			case 13:
				if (ped::is_ped_in_any_police_vehicle(player::player_ped_id())) {
					if (script::_get_number_of_instances_of_script_with_name_hash(Global_82612[78 /*34*/].f_6) == 0) {
						if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 0),
																  Global_34904[13 /*31*/].f_2, 1) <= 100f) {
				...
				else if (script::_get_number_of_instances_of_script_with_name_hash(Global_82612[78 /*34*/].f_6) == 0) {
					if (func_39(13, player::player_ped_id())) {
						func_27(13, player::player_ped_id(), 0);
					}
				}
			...
			case 17:
			case 16:
				if (script::_get_number_of_instances_of_script_with_name_hash(Global_82612[9 /*34*/].f_6) == 0 &&
					script::_get_number_of_instances_of_script_with_name_hash(joaat("extreme2")) == 0) {
					if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 0),
															  Global_34904[17 /*31*/].f_2, 1) <= 100f) {
						switch (func_33()) {
						case 0:
							if (func_32(12, 5)) {
			...
			case 14:
			case 15:
				if (script::_get_number_of_instances_of_script_with_name_hash(Global_82612[27 /*34*/].f_6) == 0) {
			...
			case 24:
				if (system::vdist2(entity::get_entity_coords(player::player_ped_id(), 1), 480.4354f, -1317.91f,
								   29.5957f) < 400f) {
					if (script::_get_number_of_instances_of_script_with_name_hash(Global_82612[8 /*34*/].f_6) == 0 &&
						...
						if (func_39(24, player::player_ped_id())) {
							if (interior::get_interior_from_entity(player::player_ped_id()) !=
									interior::get_interior_at_coords(480.4354f, -1317.91f, 29.5957f) &&
								!entity::is_entity_in_angled_area(player::player_ped_id(), 486.86f, -1316.604f,
																  27.71937f, 484.8906f, -1312.647f, 31.72312f, 4.25f, 0,
																  1, 0)) {
								func_27(24, player::player_ped_id(), 0);
							}
						}
						else if (interior::get_interior_from_entity(player::player_ped_id()) ==
								 interior::get_interior_at_coords_with_type(480.4354f, -1317.91f, 29.5957f,
																			"v_chopshop")) {
			...
			case 4:
				if (!func_39(4, player::player_ped_id())) {
					switch (func_33()) {
					case 0:
						if (system::vdist2(Global_34904[4 /*31*/].f_2,
										   entity::get_entity_coords(player::player_ped_id(), 0)) < 10000f) {
					...
					case 1:
						if (func_31(2)) {
							...
							else if (system::vdist2(Global_34904[4 /*31*/].f_2,
													entity::get_entity_coords(player::player_ped_id(), 0)) < 10000f) {
								func_38(4, player::player_ped_id());
							}
						}
...
void func_41(int iParam0) {
	if (gameplay::is_bit_set(Global_31578[iParam0 / 32], iParam0 % 32) && Global_32041[iParam0] != 2 &&
		!gameplay::is_bit_set(Global_31814[iParam0 / 32], iParam0 % 32)) {
	...
	if (iParam0 == 40 || iParam0 == 49 || iParam0 == 52) {
		if (!ped::is_ped_injured(player::player_ped_id())) {
			if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
				iVar0 = entity::get_entity_model(func_47(ped::get_vehicle_ped_is_in(player::player_ped_id(), 1)));
				switch (iVar0) {
...
// Position - 0x4E82
var func_47(var uParam0) { return uParam0; }
...
// Position - 0x585B
int func_50(int iParam0) { return system::shift_right(iParam0, 9) & 31; }

// Position - 0x586E
var func_51() {
	int *iVar0;

	func_61(&iVar0, time::get_clock_seconds());
	func_60(&iVar0, time::get_clock_minutes());
	func_59(&iVar0, time::get_clock_hours());
	func_54(&iVar0, time::get_clock_day_of_month());
	func_53(&iVar0, time::get_clock_month());
	func_52(&iVar0, time::get_clock_year());
	return iVar0;
}
...
// Position - 0x5A9C
int func_58(var uParam0) { return uParam0 & 15; }
...
void func_68() {
	...
	if (!streaming::is_new_load_scene_active()) {
		iVar0 = 0;
		while (iVar0 < 10) {
			if (!gameplay::is_string_null_or_empty(&Global_34823[iVar0 /*8*/])) {
				if (!streaming::is_ipl_active(&Global_34823[iVar0 /*8*/])) {
					streaming::request_ipl(&Global_34823[iVar0 /*8*/]);
				}
	...
	if (Global_33944) {
		iVar1 = 0;
		while (iVar1 < 198) {
			func_72(&vLocal_99, iVar1);
			func_71(&vLocal_99, iVar1, Global_33147[iVar1]);
			func_69(&vLocal_99, iVar1, Global_33147[iVar1]);
	...
	if (cam::is_screen_faded_out()) {
		iVar3 = 0;
		while (iVar3 < 10) {
			if (!gameplay::is_string_null_or_empty(&Global_34742[iVar3 /*8*/])) {
				if (streaming::is_ipl_active(&Global_34742[iVar3 /*8*/])) {
					streaming::remove_ipl(&Global_34742[iVar3 /*8*/]);
				}
	...
	if (!func_70(uParam0->f_79, 0f, 0f, 0f, 0)) {
		if (iParam2 == 0) {
			if (Global_33945[iParam1]) {
				ped::remove_scenario_blocking_area(Global_34542[iParam1], 0);
				Global_33945[iParam1] = 0;
			}
		}
		else if (iParam2 == 1 || iParam2 == 2) {
			if (!Global_33945[iParam1]) {
				Global_34542[iParam1] = ped::add_scenario_blocking_area(uParam0->f_79, uParam0->f_82, 0, 1, 1, 1);
...
// Position - 0x8A12
bool func_70(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
	...
	if (!func_70(uParam0->f_68, 0f, 0f, 0f, 0)) {
		if (uParam0->f_75[iParam2]) {
			if (!Global_33545[iParam1]) {
				Global_33346[iParam1] =
					pathfind::add_navmesh_blocking_object(uParam0->f_68, uParam0->f_71, uParam0->f_74, 0, 7);
				Global_33545[iParam1] = 1;
			}
		}
		else if (Global_33545[iParam1]) {
			pathfind::remove_navmesh_blocking_object(Global_33346[iParam1]);
...
bool func_73(int iParam0) {
	...
	if (Global_34343[iParam0]) {
		...
		func_71(&vLocal_99, iParam0, Global_33147[iParam0]);
	...
	if (Global_34144[iParam0]) {
		...
		func_69(&vLocal_99, iParam0, Global_33147[iParam0]);
...
void func_78() {
	...
	if (Global_31568) {
		...
		iVar0 = 0;
		while (iVar0 < 27) {
			if (object::_does_door_exist(Global_34904[iVar0 /*31*/])) {
				object::remove_door_from_system(Global_34904[iVar0 /*31*/]);
			}
			iVar0++;
		}
	}
...
// Position - 0xCE5F
void func_79() {
	if (!iLocal_98 && gameplay::is_bit_set(Global_101700.f_8044.f_2[27 /*3*/], 2)) {
		iLocal_98 = 1;
		iLocal_97 = 1;
	}
	if (iLocal_97 && (!streaming::is_new_load_scene_active() ||
					  streaming::is_player_switch_in_progress() && streaming::get_player_switch_state() == 5)) {
...
void func_81(char *sParam0) {
	...
	if (cam::is_screen_faded_out()) {
		...
		iVar0 = 0;
		while (iVar0 < 10) {
			iVar2 = gameplay::get_hash_key(&Global_34742[iVar0 /*8*/]);
			if (iVar2 == 0) {
				iVar4 = iVar0;
			}
			if (iVar2 == iVar1) {
...
void func_82() {
	...
	iVar0 = 0;
	while (iVar0 < 226) {
		gameplay::set_bit(&Global_31569[iVar0 / 32], iVar0 % 32);
		Global_31587[iVar0] = 0;
		gameplay::clear_bit(&Global_31578[iVar0 / 32], iVar0 % 32);
		Global_32041[iVar0] = 0;
		Global_32268[iVar0] = 1;
		gameplay::set_bit(&Global_31814[iVar0 / 32], iVar0 % 32);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 198) {
		...
		if (Global_33545[iVar0]) {
			pathfind::remove_navmesh_blocking_object(Global_33346[iVar0]);
			Global_33545[iVar0] = 0;
		}
		if (Global_33945[iVar0]) {
			ped::remove_scenario_blocking_area(Global_34542[iVar0], 0);
...
// Position - 0xD5C8
bool func_85() { return Global_2443134.f_570; }
...
void func_88() {
	...
	iVar0 = 0;
	while (iVar0 < 27) {
		object::add_door_to_system(Global_34904[iVar0 /*31*/], Global_34904[iVar0 /*31*/].f_5,
								   Global_34904[iVar0 /*31*/].f_2, 1, 1, 0);
		object::_set_door_acceleration_limit(Global_34904[iVar0 /*31*/], 1, 1, 0);
		Global_34904[iVar0 /*31*/].f_22 = object::_0x65499865FCA6E5EC(Global_34904[iVar0 /*31*/]);
		gameplay::clear_bit(&Global_34904[iVar0 /*31*/].f_1, 2);
		gameplay::clear_bit(&Global_34904[iVar0 /*31*/].f_1, 3);
		gameplay::clear_bit(&Global_34904[iVar0 /*31*/].f_1, 5);
		gameplay::clear_bit(&Global_34904[iVar0 /*31*/].f_1, 6);
		iVar0++;
	}
	bLocal_87 = true;
}
...
void func_89() {
	...
	gameplay::set_bit(&Global_34904[iVar0 /*31*/].f_1, 0);
	gameplay::set_bit(&Global_34904[iVar0 /*31*/].f_1, 1);
	gameplay::set_bit(&Global_34904[iVar0 /*31*/].f_1, 3);
	gameplay::set_bit(&Global_34904[iVar0 /*31*/].f_1, 4);
	gameplay::clear_bit(&Global_34904[iVar0 /*31*/].f_1, 7);
	iVar0 = 0;
	...
	gameplay::clear_bit(&Global_34904[iVar0 /*31*/].f_1, 0);
	gameplay::clear_bit(&Global_34904[iVar0 /*31*/].f_1, 1);
	gameplay::set_bit(&Global_34904[iVar0 /*31*/].f_1, 3);
	gameplay::clear_bit(&Global_34904[iVar0 /*31*/].f_1, 7);
	iVar0 = 1;
	...
	Global_34904[iVar0 /*31*/].f_5 = -1184516519;
	Global_34904[iVar0 /*31*/].f_6 = 324f;
	Global_34904[iVar0 /*31*/].f_7 = 9f;
	...
	gameplay::clear_bit(&Global_34904[iVar0 /*31*/].f_1, 1);
	gameplay::set_bit(&Global_34904[iVar0 /*31*/].f_1, 3);
	gameplay::set_bit(&Global_34904[iVar0 /*31*/].f_1, 7);
	iVar0 = 23;
...
// Position - 0xF74E
void func_93(char *sParam0, int iParam1, vector3 vParam2, bool bParam5) {
	int iVar0;
...
// Position - 0xF7A0
bool func_94() { return Global_1315202; }

// Position - 0xF7AC
void func_95() {
	if (func_65()) {
		if (!Global_101700.f_6220.f_426 || gameplay::is_bit_set(iLocal_78, 0) ||
			network::network_is_game_in_progress() || Global_31567) {
			if (!Global_2453924) {
				if (gameplay::is_bit_set(iLocal_78, 0) || Global_31567) {
					iLocal_194 = 1;
				}
				iLocal_96 = 0;
			}
	...
	else if (gameplay::is_bit_set(iLocal_78, 1) ||
			 !network::network_is_game_in_progress() && !func_85() && !func_96() || Global_31567) {
		if (func_67() == 2) {
...
// Position - 0xF8A3
var func_97() { return Global_2443134.f_720; }

// Position - 0xF8B2
var func_98() { return Global_2443134.f_572; }

// Position - 0xF8C1
var func_99() { return Global_2443134.f_585; }

// Position - 0xF8D0
var func_100() { return gameplay::is_bit_set(Global_2443134, 21); }
