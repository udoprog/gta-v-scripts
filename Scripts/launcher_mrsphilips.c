...
void __EntryFunction__() {
	...
	if (player::has_force_cleanup_occurred(83)) {
		...
		if (Var0 != -1) {
			if (Global_100787[Var0 /*10*/].f_9 != -1) {
				...
				func_242(&Global_100787[Var0 /*10*/].f_9);
			}
		}
		func_229(&Var0, 1);
	}
	iVar64[0] = 35;
	if (!func_226(&iVar64, &Var0, vVar61, 1f)) {
		func_225();
	...
	func_214(&Var0);
	iLocal_92 =
		ped::add_scenario_blocking_area(vVar61 - Vector(20f, 20f, 20f), vVar61 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
	...
	while (true) {
		...
		func_175(Var0);
		func_167(&iLocal_91, &Var0.f_9, vVar61);
		if (func_152(&Var0, 0)) {
			if (Var0 == 35) {
				if (iLocal_93 == 0) {
					if (!object::_does_door_exist(1736361794)) {
						object::add_door_to_system(1736361794, joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f,
												   1, 1, 0);
					}
					if (object::_does_door_exist(1736361794)) {
...
int func_2(int iParam0) {
	...
	if (!func_151()) {
		while (!func_142(*iParam0)) {
			...
			if (!func_176(iParam0, *iParam0 != 2)) {
				func_243("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() "
						 "[TERMINATING]");
				return 0;
			}
			system::wait(0);
	...
	if (!func_98(iParam0)) {
		func_243("STEP_7_COMMON_LaunchMission - Trying to launch a null script "
				 "string name");
		return 0;
	}
...
int func_98(int iParam0) {
	...
	if (func_128(&uParam0->f_1)) {
		...
		if (cutscene::has_cutscene_loaded()) {
			...
			func_243("Initial cutscene wasn't loaded in time to pass to RC "
					 "mission.");
					...
					if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
						...
						if (func_158(2)) {
							if (func_156(uParam0->f_27)) {
								...
								func_243("ARE_RC_TRIGGER_CONDITIONS_MET: "
		...
		if (*uParam0 == 6) {
			...
			if (ai::get_ped_desired_move_blend_ratio(player::player_ped_id()) >= 2f) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 245.8885f, 371.9034f, 103.9884f,
					...
					if (func_158(2)) {
						if (func_156(uParam0->f_27)) {
							func_155(uParam0->f_27, *uParam0);
							func_243("RC5_IN_ACTIVATION_RANGE: "
			...
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 2728.948f, 4143.44f, 42.29295f, 2722.213f,
				...
				if (func_158(2)) {
					if (func_156(1)) {
						func_155(1, *uParam0);
						func_243("RC_IN_ACTIVATION_RANGE: "
	...
	if (iParam0 == 1) {
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			...
			if (ped::is_ped_in_any_heli(player::player_ped_id()) || ped::is_ped_in_any_plane(player::player_ped_id())) {
				func_243("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for "
						 "plane or helicopter.");
...
int func_176(var *uParam0, int iParam1) {
	...
	if (Global_69702) {
		func_243("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer "
				 "[TERMINATING]");
		return 0;
	}
	...
	if (func_207(*uParam0)) {
		...
		func_243("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1) {
	...
	if (*uParam0 == 10) {
		if (fire::is_explosion_in_sphere(-1, uParam0->f_17[0 /*3*/], 8f)) {
			func_243("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission "
					 "trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17) {
		if (!gameplay::is_bit_set(Var0.f_26, func_90())) {
			func_243("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player "
...
void func_177(int iParam0, var *uParam1, int iParam2) {
	...
	if (func_112(iParam0)) {
		...
		case 2:
			if (!func_179(uParam1) || !entity::is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3)) {
				if (func_178(iParam2) && !ped::is_ped_facing_ped(iParam0, player::player_ped_id(), 25f)) {
		...
		case 5:
			if (!func_178(iParam2) || ped::is_ped_facing_ped(iParam0, player::player_ped_id(), 10f)) {
				if (func_66(uParam1->f_5, 0f, 0f, 0f, 0)) {
					ai::task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
				}
				else {
		...
		while (iVar0 <= iVar1) {
			if (entity::does_entity_exist(uParam0->f_35[iVar0])) {
				if (entity::is_entity_dead(uParam0->f_35[iVar0], 0)) {
					func_243("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (!ped::is_ped_injured(uParam0->f_28[iVar0])) {
					if (ped::is_ped_sitting_in_any_vehicle(player::player_ped_id())) {
						if (entity::is_entity_touching_entity(player::player_ped_id(), uParam0->f_28[iVar0])) {
							...
							func_243("STEP_5_COMMON_RCfineAndInRange - Random "
					...
					if (func_205(*uParam0)) {
						...
						if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(uParam0->f_28[iVar0], 1), 15f)) {
							...
							func_243("STEP_5_COMMON_RCfineAndInRange - There "
					...
					if (!func_187(*uParam0)) {
						...
						if (player::get_player_wanted_level(player::player_id()) > 0) {
							...
							func_243("STEP_5_COMMON_RCfineAndInRange - Player "
...
// Position - 0xC1FD
bool func_189(int iParam0, float fParam1) { return func_190(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_190(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_191(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0xC2D6
int func_191(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
...
int func_194(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	vVar0 = {func_196(entity::get_entity_coords(iParam1, 1) - entity::get_entity_coords(iParam0, 1))};
...
int func_217(int iParam0) {
	...
	if (Global_69702) {
		func_243("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is "
				 "running [TERMINATING]");
		return 0;
	}
	if (!Global_101700.f_8044 && !func_93(1)) {
		func_243("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not "
				 "active");
		return 0;
	}
	if (!func_218(iParam0)) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_243("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (Global_91491.f_11 == 6) {
		if (Global_91491 < 9) {
			...
			if (gameplay::are_strings_equal(&Global_91491.f_3, sVar0)) {
				func_243("STEP_3_COMMON_CanRCLaunch - Script denied as a "
	...
	if (script::_get_number_of_instances_of_script_with_name_hash(joaat("candidate_controller")) == 0) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_243("STEP_3_COMMON_CanRCLaunch - Script denied as "
...
// Position - 0xD11F
int func_226(int iParam0, int iParam1, vector3 vParam2, float fParam5) {
	int iVar0;

	if (*iParam0 == 1) {
		if (func_227((*iParam0)[0], vParam2, fParam5, iParam1)) {
			return 1;
		}
	}
	else {
		iVar0 = 0;
		while (iVar0 < *iParam0) {
			if (func_227((*iParam0)[iVar0], vParam2, fParam5, iParam1)) {
				iVar0 = *iParam0;
				return 1;
			}
			iVar0++;
	...
	func_243("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch "
			 "[TERMINATING]");
	return 0;
}

// Position - 0xD184
bool func_227(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	int iVar0;
	struct<7> Var1;

	iVar0 = 0;
	func_95(iParam0, &Var1);
	if (func_228(Var1.f_6, vParam1, fParam4, 0)) {
...
// Position - 0xD202
bool func_228(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
// Position - 0xD2F1
void func_231(var *uParam0, bool bParam1) { func_232(&uParam0->f_41, bParam1); }
...
// Position - 0xD37C
void func_234(var *uParam0, bool bParam1) { func_235(&uParam0->f_35, bParam1); }
...
// Position - 0xD49F
void func_238(var *uParam0, int iParam1) { func_239(&uParam0->f_28, iParam1); }
