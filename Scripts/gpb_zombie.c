...
void func_47(int iParam0, int iParam1, float fParam2) {
	if (iParam0 == 3) {
		if (iParam1 == 3 && !iLocal_449 && fParam2 >= 0.773f) {
			iLocal_448 =
				object::create_object(joaat("prop_npc_phone"), entity::get_entity_coords(iLocal_240, 1), 1, 1, 0);
			entity::attach_entity_to_entity(iLocal_448, iLocal_240, ped::get_ped_bone_index(iLocal_240, 28422), 0f, 0f,
...
void func_52(int iParam0, char *sParam1, char *sParam2) {
	...
	switch (iParam0) {
	case 1: StringCopy(sParam2, "IAmUndead", 64); break;

	case 2: StringCopy(sParam2, "DoYouWantAPhotoWithMe", 64); break;

	case 3: StringCopy(sParam2, "Careful", 64); break;

	case 4: StringCopy(sParam2, "IamTheUndead", 64); break;

	case 5: StringCopy(sParam2, "BrainsItsBrains", 64); break;

	case 6: StringCopy(sParam2, "IAmThevinewoodZombie", 64); break;

	case 7: StringCopy(sParam2, "RRRItsBrains", 64); break;

	case 8: StringCopy(sParam2, "WhoSaysCosplayIsA", 64); break;
	}
}
...
// Position - 0x25B3
void func_60(char *sParam0) { func_26(iLocal_297, sParam0); }
...
void func_99() {
	...
	ped::set_ped_config_flag(iLocal_240, 185, 1);
	ped::set_ped_config_flag(iLocal_240, 318, 1);
}
