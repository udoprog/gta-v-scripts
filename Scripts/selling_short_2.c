...
void func_17(int iParam0) {
	switch (iParam0) {
	case 0: func_18(iParam0, 0, 10000); break;

	case 1: func_18(iParam0, 9000, 10000); break;

	case 2: func_18(iParam0, 27000, 32000); break;

	case 3: func_18(iParam0, 32000, 42000); break;

	case 4: func_18(iParam0, 51000, 63000); break;

	case 5: func_18(iParam0, 63600, 69000); break;

	case 6: func_18(iParam0, 66000, 70200); break;

	case 7: func_18(iParam0, 69600, 79200); break;

	case 8: func_18(iParam0, 77400, 84000); break;

	case 12: func_18(iParam0, 81000, 93600); break;

	case 9: func_18(iParam0, -1, -1); break;

	case 11: func_18(iParam0, 90000, 154200); break;

	case 10: func_18(iParam0, 129600, 133200); break;

	case 13: func_18(iParam0, 144600, 154200); break;

	case 14: func_18(iParam0, 152700, 154200); break;

	case 15: func_18(iParam0, 154200, 154200); break;
	}
}
...
// Position - 0x2462
float func_25(float fParam0) { return fParam0 * 57.29578f; }
...
// Position - 0x248F
int func_27(char *sParam0, int iParam1, int iParam2, int iParam3) {
	int iVar0;
...
// Position - 0x2B06
void func_42(char *sParam0) { streaming::remove_anim_dict(sParam0); }
