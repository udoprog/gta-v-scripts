...
void func_1() {
	...
	case 0:
		...
		if (streaming::has_anim_dict_loaded("rcmjosh1leadinout") &&
			...
			if (!entity::does_entity_exist(iLocal_147)) {
				if (object::does_object_of_type_exist_at_coords(-1107.01f, 289.38f, 64.76f, 5f,
																joaat("prop_lrggate_01c_l"), 0)) {
					object::set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f,
															  0, 0f, 0);
				}
				iLocal_147 = object::get_closest_object_of_type(-1107.01f, 289.38f, 64.76f, 5f,
																joaat("prop_lrggate_01c_l"), 1, 0, 1);
			}
			iLocal_145 = 1;
		}
		break;
	...
	case 1:
		...
		if (!iLocal_160) {
			if (func_281(Local_83.f_28[0]) && entity::does_entity_exist(iLocal_147)) {
				iLocal_149 = ped::create_synchronized_scene(vLocal_150, vLocal_153, 2);
				ai::task_synchronized_scene(Local_83.f_28[0], iLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -4f,
											27, 0, 1000f, 16);
				entity::play_synchronized_entity_anim(iLocal_147, iLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f,
													  8f, 0, 1148846080);
			...
			if (entity::is_entity_in_angled_area(player::player_ped_id(), -1107.107f, 290.4275f, 62.9487f, -1102.038f,
												 291.3421f, 66.27895f, 2f, 0, 1, 0)) {
			...
			if (ped::is_ped_injured(Local_83.f_28[0]) || fire::is_entity_on_fire(Local_83.f_28[0]) ||
				fire::is_explosion_in_sphere(-1, entity::get_entity_coords(Local_83.f_28[0], 1), 5f)) {
				if (func_280(Local_83.f_28[0])) {
					entity::stop_synchronized_entity_anim(Local_83.f_28[0], -8f, 1);
					ai::clear_ped_tasks(Local_83.f_28[0]);
				}
	...
	case 2:
		...
		if (func_280(Local_83.f_28[0])) {
			if (iLocal_162 == 1) {
				...
				ai::task_play_anim(0, "rcmjosh1@impatient", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
				ai::task_play_anim(0, "rcmjosh1@impatient", "idle_b", 8f, -8f, -1, 1, 0, 0, 0, 0);
			...
			ai::task_perform_sequence(Local_83.f_28[0], iLocal_146);
			ai::clear_sequence_task(&iLocal_146);
			ped::set_blocking_of_non_temporary_events(Local_83.f_28[0], 0);
			if (iLocal_162 == 0) {
				ped::force_ped_motion_state(Local_83.f_28[0], -668482597, 0, 0, 1);
			}
		}
		if (object::does_object_of_type_exist_at_coords(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"),
														0)) {
			object::set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, 0, 0f,
													  0);
		}
		if (iLocal_162 == 0) {
...
void func_224(int iParam0, int iParam1, int iParam2, int iParam3) {
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_228(player::player_id()) &&
				!func_226(player::player_id(), 0) && !func_225()) {
...
// Position - 0x26DBE
bool func_225() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x26EA9
bool func_229() { return gameplay::is_bit_set(Global_2359301, 3); }
...
// Position - 0x26F10
void func_232(char *sParam0) { sParam0 = sParam0; }
...
void func_233() {
	...
	case 0:
		if (func_249(1, 1093140480, 0)) {
			...
			pathfind::set_roads_in_angled_area(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f,
											   0, 0, 1);
			gameplay::clear_area_of_vehicles(-1146.306f, 295.9831f, 66.13612f, 9f, 0, 0, 0, 0, 0);
			gameplay::clear_area_of_vehicles(-1143.244f, 280.2762f, 65.41892f, 12f, 0, 0, 0, 0, 0);
			gameplay::clear_area_of_vehicles(-1152.426f, 313.6157f, 67.10429f, 12f, 0, 0, 0, 0, 0);
			gameplay::clear_area_of_vehicles(-1165.966f, 332.6786f, 68.81f, 12f, 0, 0, 0, 0, 0);
			gameplay::clear_area_of_vehicles(-1178.729f, 346.4572f, 70.04675f, 12f, 0, 0, 0, 0, 0);
			gameplay::clear_angled_area_of_vehicles(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f,
													43.75f, 0, 0, 0, 0, 0);
			iVar0 = player::get_players_last_vehicle();
			if (func_248(iVar0)) {
				if (entity::is_entity_in_angled_area(iVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f,
													 66.34669f, 33f, 0, 1, 0)) {
			...
			if (object::does_object_of_type_exist_at_coords(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"),
				...
				object::set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, 1,
														  90f, 0);
			}
			func_238(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar4, 3f, 6f, 3f,
					 1, 1, 1, 0, 0);
	...
	case 1:
		...
		if (cutscene::can_set_exit_state_for_registered_entity("Josh", 0)) {
			...
			if (!iLocal_160) {
				...
				if (func_281(Local_83.f_28[0]) && entity::does_entity_exist(iLocal_147)) {
					iLocal_149 = ped::create_synchronized_scene(vLocal_150, vLocal_153, 2);
					ai::task_synchronized_scene(Local_83.f_28[0], iLocal_149, "rcmjosh1leadinout", "leadout_josh",
												1000f, -8f, 25, 0, 1000f, 16);
					entity::play_synchronized_entity_anim(iLocal_147, iLocal_149, "leadout_gate", "rcmjosh1leadinout",
														  8f, 8f, 0, 1148846080);
		...
		if (cutscene::was_cutscene_skipped()) {
			...
			if (object::does_object_of_type_exist_at_coords(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"),
															0)) {
				entity::remove_model_hide(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"), 0);
				object::set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_r"), -1101.62f, 290.36f, 64.76f, 1,
														  0f, 0);
			}
		}
		if (!cutscene::is_cutscene_active()) {
			...
			if (!iLocal_160) {
				...
				if (func_281(Local_83.f_28[0]) && entity::does_entity_exist(iLocal_147)) {
					iLocal_149 = ped::create_synchronized_scene(vLocal_150, vLocal_153, 2);
					ai::task_synchronized_scene(Local_83.f_28[0], iLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f,
												-8f, 25, 0, 1000f, 16);
					entity::play_synchronized_entity_anim(iLocal_147, iLocal_149, "leadout_gate", "rcmjosh1leadinout",
														  8f, 8f, 0, 1148846080);
...
// Position - 0x27597
int func_234(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	bool bVar0;
	float fVar1;
...
// Position - 0x275F2
void func_235(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8,
...
// Position - 0x277B0
Vector3 func_236(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }
...
// Position - 0x277FF
void func_238(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
			  int iParam14, int iParam15, int iParam16, int iParam17, int iParam18) {
	func_239(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

// Position - 0x27829
void func_239(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
...
// Position - 0x27CB6
bool func_242(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
// Position - 0x27D8F
bool func_243(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	vector3 vVar9;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (func_244(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_244(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_244(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_244(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_244(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_244(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_244(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_244(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_244(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_244(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_244(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_244(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_244(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_244(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_244(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_244(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x28086
int func_244(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
// Position - 0x28228
bool func_249(int iParam0, float fParam1, int iParam2) {
	int iVar0;
...
// Position - 0x283D5
bool func_255(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
void func_257() {
	...
	switch (iLocal_145) {
	case 0:
		if (!func_5(0) && entity::is_entity_in_angled_area(player::player_ped_id(), -1115.071f, 279.6581f, 62.42184f,
														   -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, 1, 0)) {
			...
			if (object::does_object_of_type_exist_at_coords(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"),
															0)) {
				object::set_state_of_closest_door_of_type(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, 0,
														  0f, 0);
			}
			iLocal_147 = object::get_closest_object_of_type(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"),
															1, 0, 1);
			iLocal_145 = 1;
		}
		break;
	...
	case 1:
		if (!func_5(0)) {
			if (!iLocal_156) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), -1115.071f, 279.6581f, 62.42184f,
													 -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, 1, 0)) {
					if (func_281(Local_83.f_28[0]) && entity::does_entity_exist(iLocal_147)) {
						iLocal_148 = ped::create_synchronized_scene(vLocal_150, vLocal_153, 2);
						ai::task_synchronized_scene(Local_83.f_28[0], iLocal_148, "rcmjosh1leadinout", "leadin_josh",
													8f, -8f, 25, 0, 1148846080, 0);
						entity::play_synchronized_entity_anim(iLocal_147, iLocal_148, "leadin_gate",
															  "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
					...
					if (!func_5(0) && !iLocal_156) {
						func_232("Cannot play lead-in, re-requesting cutscene "
								 "with new sections");
			...
			if (!func_5(0) && !iLocal_156) {
				func_232("Cannot play lead-in, re-requesting cutscene with new "
						 "sections");
				cutscene::remove_cutscene();
				cutscene::_request_cutscene_ex("JOSH_1_INT_CONCAT", 13, 8);
			}
...
struct<2> func_266(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_274(iParam0)}; break;
	...
	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_273(iParam2)}; break;

		case 8: Var0 = {func_272(iParam2)}; break;

		case 7: Var0 = {func_271(iParam2)}; break;

		case 10: Var0 = {func_270(iParam2)}; break;

		case 5: Var0 = {func_269(iParam2)}; break;

		case 4: Var0 = {func_268(iParam2)}; break;

		default: StringCopy(&Var0, func_267(iVar2), 8); break;
		}
		break;
...
{
	if (!func_277(0) || G_TextMessageConfig || Global_69960 == 1 || !cam::is_screen_faded_in()) {
		return false;
	}
	switch (Global_69956) {
	case 0:
...
// Position - 0x29317
bool func_278(int iParam0) { return func_279(iParam0, Global_35781); }
...
void func_285(var *uParam0, int iParam1) {
	...
	func_286(uParam0, iLocal_81, vVar0, fVar3);
...
// Position - 0x2988E
void func_286(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_287(uParam0);
...
// Position - 0x2996A
int func_288(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
	if (func_289(uParam0, iParam1, vParam2, fParam5, 1)) {
		if (entity::does_entity_exist(*uParam0)) {
...
// Position - 0x299C6
bool func_289(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	int iVar0;
...
void func_296() {
	func_247();
	if (func_309()) {
		func_232("...Random Character Script was triggered so additional "
				 "cleanup required");
	}
...
void func_297(var *uParam0, int iParam1, int iParam2, int iParam3) {
	...
	func_298(uParam0, iParam3);
}

// Position - 0x29C24
void func_298(var *uParam0, bool bParam1) { func_299(&uParam0->f_41, bParam1); }
...
// Position - 0x29CDA
void func_302(var *uParam0, bool bParam1) { func_303(&uParam0->f_35, bParam1); }
...
// Position - 0x29D61
void func_305(var *uParam0, int iParam1) { func_306(&uParam0->f_28, iParam1); }
...
// Position - 0x2A392
void func_322() { Global_17151.f_5 = 1; }

// Position - 0x2A3A0
void func_323() { Global_17151.f_5 = 0; }
