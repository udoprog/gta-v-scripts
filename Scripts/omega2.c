...
void __EntryFunction__() {
	...
	while (true) {
		...
		switch (iLocal_142) {
		case 0: func_241(); break;

		case 1: func_212(); break;

		case 2: func_40(); break;
...
void func_1() {
	...
	case 0:
		...
		case 1: sVar0 = "O2_FAILKILL"; break;

		case 2: sVar0 = "O2_FAILHURT"; break;

		case 3: sVar0 = "O2_FAILSCARE"; break;
		}
		if (iLocal_144 == 0) {
			func_345(1);
		}
...
void func_5() {
	...
	case 1:
		if (func_23(player::player_ped_id())) {
			if (!entity::is_entity_in_angled_area(player::player_ped_id(), 2326.3f, 2564.445f, 40.6678f, 2333.708f,
												  2581.939f, 65.6678f, 9f, 0, 1, 0)) {
				func_275();
				iLocal_143 = 2;
			}
			else if (!iLocal_337) {
				if (func_23(iLocal_171) && ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_171, 1)) {
					iLocal_337 = func_6(&uLocal_172, "SCRAPAU", "SCRAP_DOCK", 7, 0, 0, 0);
				}
			}
		}
		break;
...
// Position - 0xB8E
void func_24(var *uParam0, int iParam1, int iParam2, int iParam3) {
	func_34(uParam0, iParam1);
	func_29(uParam0, iParam2);
	func_25(uParam0, iParam3);
}

// Position - 0xBAE
void func_25(var *uParam0, bool bParam1) { func_26(&uParam0->f_41, bParam1); }
...
// Position - 0xC64
void func_29(var *uParam0, bool bParam1) { func_30(&uParam0->f_35, bParam1); }
...
// Position - 0xDB1
void func_34(var *uParam0, int iParam1) { func_35(&uParam0->f_28, iParam1); }
...
void func_40() {
	...
	case 0:
		...
		if (func_201(1, 1093140480, 0)) {
			...
			system::wait(0);
			func_184(2314.601f, 2592.442f, 43.6477f, 2331.976f, 2571.058f, 50.62959f, 19f, 2313.334f, 2600.843f,
					 45.8162f, 352.0448f, 1, 1, 1, 0, 0);
	...
	case 1:
		...
		if (!entity::does_entity_exist(iLocal_158)) {
			if (entity::does_entity_exist(cutscene::get_entity_index_of_registered_entity(sLocal_157, 0))) {
				iLocal_158 = entity::get_object_index_from_entity_index(
					cutscene::get_entity_index_of_registered_entity(sLocal_157, 0));
			}
		}
		...
		if (cutscene::has_cutscene_finished()) {
			...
			if (!entity::does_entity_exist(iLocal_159) && streaming::has_model_loaded(iLocal_166)) {
				iLocal_159 = object::create_object_no_offset(iLocal_166, vLocal_160, 1, 1, 0);
...
int func_42(int iParam0, int iParam1) {
	if (gameplay::is_bit_set(Global_91491.f_20, 17)) {
		return 0;
	}
...
// Position - 0x13E6
bool func_47(var *uParam0, int iParam1) { return (*uParam0)[iParam1] == 70; }
...
// Position - 0x142B
void func_49(var *uParam0, int iParam1) { (*uParam0)[iParam1] = 70; }
...
// Position - 0x1458
float func_51(var *uParam0) { return uParam0->f_72; }

// Position - 0x1464
bool func_52(var *uParam0, int iParam1) { return func_53(uParam0, iParam1) != -1; }
...
// Position - 0x14A3
bool func_54(var *uParam0) { return uParam0->f_71 == 1; }
...
// Position - 0x1501
void func_56(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9,
...
// Position - 0x16FB
Vector3 func_58(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }

// Position - 0x170E
int func_59(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	if (iParam1 == 12) {
				...
				if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0)) {
					if (iVar0 == 13) {
						...
						while (iVar1 <= 8) {
							...
							func_79(iParam0, Global_69523[1 /*14*/].f_12, Global_69523[1 /*14*/].f_3,
						...
						if (iParam4 == -1) {
							ped::set_ped_component_variation(iParam0, func_69(iVar0), Global_69523[1 /*14*/].f_3,
															 Global_69523[1 /*14*/].f_4,
															 ped::get_ped_palette_variation(iParam0, func_69(iVar0)));
						}
						else {
							ped::set_ped_component_variation(iParam0, func_69(iVar0), Global_69523[1 /*14*/].f_3,
		...
		if (iParam4 == -1) {
			ped::set_ped_component_variation(iParam0, func_69(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4,
											 ped::get_ped_palette_variation(iParam0, func_69(iParam1)));
		}
		else {
			ped::set_ped_component_variation(iParam0, func_69(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4, iParam4);
...
// Position - 0x2CFE
var func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == -1) {
		...
		if (iParam1 == 0) {
			...
			if (func_80(entity::get_entity_model(iParam0), 14, iVar0,
...
struct<10> func_88(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		switch (iParam1) {
		case 31: func_90(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 0: func_90(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_90(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_90(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_90(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_90(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8); break;

		case 5: func_90(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8); break;

		case 6: func_90(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_90(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_90(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_90(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8); break;

		default: func_89(&Var1, iParam0, iParam1, 10); break;
		}
		break;
	...
	case joaat("player_one"):
		...
		case 1: func_90(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8); break;

		case 2: func_90(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8); break;

		case 3: func_90(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_90(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_90(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_90(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_90(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_90(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_89(&Var1, iParam0, iParam1, 9); break;
		}
		break;
	...
	case joaat("player_two"):
		...
		case 0: func_90(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_90(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_90(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_90(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8); break;

		case 4: func_90(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8); break;

		case 5: func_90(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_90(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_90(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_90(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8); break;
	...
	case joaat("mp_m_freemode_01"):
		...
		case 0: func_90(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_90(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_90(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_90(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_90(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_90(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_90(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_90(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_90(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_90(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_90(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_90(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_90(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_90(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 14: func_90(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_90(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_90(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_90(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_90(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_90(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_90(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_90(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_90(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_90(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 24: func_90(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_89(&Var1, iParam0, iParam1, 25); break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 0: func_90(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_90(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_90(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_90(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_90(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_90(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_90(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_90(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_90(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_90(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_90(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_90(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_90(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_90(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8); break;

		case 14: func_90(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_90(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_90(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_90(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_90(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func
iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 15:
		func_197(uParam1, "Epsilon7", func_199(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_198(iParam0), 0, 0);
		break;

	case 16:
		func_197(uParam1, "Epsilon8", func_199(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_198(iParam0), 1, 0);
		break;

	case 17:
		func_197(uParam1, "Extreme1", func_199(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 18:
		func_197(uParam1, "Extreme2", func_199(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 19:
		func_197(uParam1, "Extreme3", func_199(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 20:
		func_197(uParam1, "Extreme4", func_199(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_198(iParam0), 0, 0);
		break;

	case 21:
		func_197(uParam1, "Fanatic1", func_199(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_198(iParam0), 1, 0);
		break;

	case 22:
		func_197(uParam1, "Fanatic2", func_199(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_198(iParam0), 1, 0);
		break;

	case 23:
		func_197(uParam1, "Fanatic3", func_199(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_198(iParam0), 0, 1);
		break;

	case 24:
		func_197(uParam1, "Hao1", func_199(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_198(iParam0), 0, 1);
		break;

	case 25:
		func_197(uParam1, "Hunting1", func_199(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 26:
		func_197(uParam1, "Hunting2", func_199(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 27:
		func_197(uParam1, "Josh1", func_199(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_198(iParam0), 1, 0);
		break;

	case 28:
		func_197(uParam1, "Josh2", func_199(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_198(iParam0), 1, 1);
		break;

	case 29:
		func_197(uParam1, "Josh3", func_199(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_198(iParam0), 1, 1);
		break;

	case 30:
		func_197(uParam1, "Josh4", func_199(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_198(iParam0), 1, 0);
		break;

	case 31:
		func_197(uParam1, "Maude1", func_199(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 32:
		func_197(uParam1, "Minute1", func_199(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 33:
		func_197(uParam1, "Minute2", func_199(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 34:
		func_197(uParam1, "Minute3", func_199(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 35:
		func_197(uParam1, "MrsPhilips1", func_199(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_198(iParam0), 0, 0);
		break;

	case 36:
		func_197(uParam1, "MrsPhilips2", func_199(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_198(iParam0), 0, 0);
		break;

	case 37:
		func_197(uParam1, "Nigel1", func_199(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_198(iParam0), 1, 0);
		break;

	case 38:
		func_197(uParam1, "Nigel1A", func_199(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_198(iParam0), 1, 1);
		break;

	case 39:
		func_197(uParam1, "Nigel1B", func_199(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_198(iParam0), 1, 1);
		break;

	case 40:
		func_197(uParam1, "Nigel1C", func_199(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_198(iParam0), 1, 1);
		break;

	case 41:
		func_197(uParam1, "Nigel1D", func_199(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_198(iParam0), 1, 1);
		break;

	case 42:
		func_197(uParam1, "Nigel2", func_199(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_198(iParam0), 1, 1);
		break;

	case 43:
		func_197(uParam1, "Nigel3", func_199(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_198(iParam0), 1, 1);
		break;

	case 44:
		func_197(uParam1, "Omega1", func_199(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_198(iParam0), 0, 0);
		break;

	case 45:
		func_197(uParam1, "Omega2", func_199(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_198(iParam0), 0, 0);
		break;

	case 46:
		func_197(uParam1, "Paparazzo1", func_199(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 47:
		func_197(uParam1, "Paparazzo2", func_199(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 48:
		func_197(uParam1, "Paparazzo3", func_199(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_198(iParam0), 0, 0);
		break;

	case 49:
		func_197(uParam1, "Paparazzo3A", func_199(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 50:
		func_197(uParam1, "Paparazzo3B", func_199(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 51:
		func_197(uParam1, "Paparazzo4", func_199(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_198(iParam0), 0, 0);
		break;

	case 52:
		func_197(uParam1, "Rampage1", func_199(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_198(iParam0), 0, 0);
		break;

	case 54:
		func_197(uParam1, "Rampage3", func_199(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_198(iParam0), 1, 0);
		break;

	case 55:
		func_197(uParam1, "Rampage4", func_199(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_198(iParam0), 1, 0);
		break;

	case 56:
		func_197(uParam1, "Rampage5", func_199(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_198(iParam0), 0, 0);
		break;

	case 53:
		func_197(uParam1, "Rampage2", func_199(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_198(iParam0), 1, 0);
		break;

	case 57:
		func_197(uParam1, "TheLastOne", func_199(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 58:
		func_197(uParam1, "Tonya1", func_199(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 59:
		func_197(uParam1, "Tonya2", func_199(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_198(iParam0), 0, 1);
		break;

	case 60:
		func_197(uParam1, "Tonya3", func_199(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_198(iParam0), 0, 1);
		break;

	case 61:
		func_197(uParam1, "Tonya4", func_199(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_198(iParam0), 0, 1);
		break;

	case 62:
		func_197(uParam1, "Tonya5", func_199(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_198(iParam0), 0, 1);
		break;
...
// Position - 0x200CA
void func_197(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
//Position - 0x20924
bool func_201(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
...
// Position - 0x20AF1
bool func_208(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
bool func_214() {
	if (!func_23(Local_81.f_28[0])) {
		...
		if (func_216(Local_81.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0) ||
			func_215(player::player_ped_id(), Local_81.f_28[0], 1)) {
...
// Position - 0x20E97
int func_216(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6,
			 int iParam7) {
	vector3 vVar0;
	...
	if (func_23(player::player_ped_id()) && func_23(iParam0)) {
		...
		if (func_229(iParam0, iParam1, iParam5, iParam6, iParam7)) {
			return 1;
		}
...
// Position - 0x20FC8
bool func_218(int iParam0, float fParam1) { return func_219(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_220(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0x210A1
int func_220(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_191(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
...
// Position - 0x21457
bool func_229(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) {
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_23(player::player_ped_id()) && func_23(iParam0)) {
		...
		if (!bParam2) {
			if (func_233(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
...
// Position - 0x21781
bool func_233(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
void func_234() {
	...
	if (!iLocal_167) {
		if (func_23(Local_81.f_35[0])) {
			iLocal_170 = interior::get_interior_at_coords(entity::get_entity_coords(Local_81.f_35[0], 1));
		...
		if (func_23(Local_81.f_35[0])) {
			...
			Local_81.f_35[0] = vehicle::create_vehicle(joaat("dune2"), vVar0, fVar3, 1, 1);
...
void func_242() {
	uLocal_153[0] =
		object::get_closest_object_of_type(2333.23f, 2574.97f, 47.03f, 5f, joaat("prop_ch3_01_trlrdoor_l"), 1, 0, 1);
	uLocal_153[1] =
		object::get_closest_object_of_type(2329.65f, 2576.64f, 47.03f, 5f, joaat("prop_ch3_01_trlrdoor_r"), 1, 0, 1);
...
struct<2> func_246(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_254(iParam0)}; break;

	case 7: Var0 = {func_199(iParam0)}; break;

	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_253(iParam2)}; break;

		case 8: Var0 = {func_252(iParam2)}; break;

		case 7: Var0 = {func_251(iParam2)}; break;

		case 10: Var0 = {func_250(iParam2)}; break;

		case 5: Var0 = {func_249(iParam2)}; break;

		case 4: Var0 = {func_248(iParam2)}; break;

		default: StringCopy(&Var0, func_247(iVar2), 8); break;
		}
		break;
...
//Position - 0x2224B
bool func_255(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (!func_257(0) || G_TextMessageConfig || Global_69960 == 1 || !cam::is_screen_faded_in()) {
		return false;
	}
	switch (Global_69956) {
	case 0:
...
// Position - 0x223AE
bool func_258(int iParam0) { return func_259(iParam0, Global_35781); }
...
int func_262(var *uParam0) {
	...
	case 3:
		vehicle::set_all_vehicle_generators_active_in_area(2314.546f, 2576.33f, 44.7f, 2326.446f, 2579.608f, 47.6645f,
														   0, 1);
		gameplay::clear_area_of_vehicles(2321.252f, 2578.851f, 46.7f, 10f, 0, 0, 0, 0, 0);
		iVar3 = 0;
		while (iVar3 <= iVar0 - 1) {
...
// Position - 0x22908
void func_263(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_32(uParam0);
...
// Position - 0x22948
int func_264(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
	if (func_265(uParam0, iParam1, vParam2, fParam5, 1)) {
		if (entity::does_entity_exist(*uParam0)) {
...
// Position - 0x229A4
bool func_265(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	int iVar0;
...
void func_272() {
	...
	func_31(&iLocal_171);
	vehicle::set_all_vehicle_generators_active_in_area(2314.546f, 2576.33f, 44.7f, 2326.446f, 2579.608f, 47.6645f, 1,
													   1);
...
void func_279() {
	...
	if (fVar8 > 0f && system::floor(fVar8) < system::floor(Global_101700.f_9153.f_3853)) {
		func_281(13, system::floor(Global_101700.f_9153.f_3853));
	}
...
// Position - 0x233D3
int func_280() { return Global_25190; }
...
// Position - 0x23968
void func_292() { func_293(&Global_96040); }
...
// Position - 0x240BA
void func_299(int *iParam0) { *iParam0 = -15; }
...
int func_303(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam1 == 12) {
		...
		if (ped::get_number_of_ped_drawable_variations(iParam0, func_69(iParam1)) > 0 &&
			ped::get_number_of_ped_texture_variations(iParam0, func_69(iParam1), Global_69523[1 /*14*/].f_3) > 0) {
			ped::set_ped_component_variation(iParam0, func_69(iParam1), Global_69523[1 /*14*/].f_3,
...
void func_308(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 != -1) {
		...
		func_309(&sVar32, Var0.f_3, Global_91528, iParam1, iParam2);
	}
}
...
// Position - 0x245E6
void func_310(int iParam0) { Global_36332 = gameplay::get_game_timer() + iParam0; }

// Position - 0x245F8
void func_311() {
	if (Global_89136) {
		func_14();
		graphics::_0xBF59707B3E5ED531(func_312(Global_101700.f_2095.f_539.f_3549));
	}
	else {
...
void func_316(int iParam0, int iParam1) {
	...
	func_334(iParam0, G_TextMessageConfig);
	if (!iParam1) {
...
// Position - 0x24C10
int func_319() { return Global_101700.f_8975.f_21 + Global_101700.f_17533.f_380; }
...
void func_322(int iParam0) {
	switch (iParam0) {
	case 30: func_326(22, 1, 0, 1, 0); break;

	case 15: func_323(37, 0); break;
...
void func_326(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	if (iParam0 != 198) {
		...
		func_329(iParam0, iParam3, iParam4, 0);
...
// Position - 0x251E0
bool func_329(int iParam0, bool bParam1, int iParam2, int iParam3) {
	bool bVar0;
	int iVar1;
	int iVar2;
	struct<5> Var3;
...
// Position - 0x25B35
int func_331() { return Global_25191; }
...
void func_334(int iParam0, bool bParam1) {
	switch (iParam0) {
	case 46: func_335(4, bParam1); break;

	case 16: func_335(6, bParam1); break;

	case 37: func_335(17, bParam1); break;

	case 31: func_335(16, bParam1); break;
	}
}
...
// Position - 0x29484
void func_336(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8) {
	func_337(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

// Position - 0x294A5
void func_337(char *sParam0, char *sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6,
...
// Position - 0x29B94
bool func_347(char *sParam0, int iParam1, int iParam2) {
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
// Position - 0x29F4A
void func_357() { Global_17151.f_5 = 1; }

// Position - 0x29F58
void func_358() { Global_17151.f_5 = 0; }
