...
float fLocal_920 = 0f;
vector3 vLocal_921[8] = {{0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f},
...
void __EntryFunction__() {
	...
	func_489(25);
	func_488();
	func_487(&uLocal_153, 2, player::player_ped_id(), "TREVOR", 0, 1);
	...
	while (true) {
		...
		switch (iLocal_318) {
		case 0: func_421(); break;

		case 1: func_420(); break;

		case 2: func_389(); break;

		case 3: func_388(); break;

		case 4: func_387(); break;

		case 5: func_382(); break;

		case 6: func_375(); break;

		case 7: func_373(); break;

		case 8: func_372(); break;

		case 9: func_369(); break;

		case 10: func_367(); break;

		case 11: func_365(); break;

		case 12: func_360(); break;

		case 13: func_355(); break;

		case 14: func_339(); break;

		case 15: func_336(); break;

		case 16: func_326(); break;

		case 17: func_290(); break;

		case 18: func_219(); break;

		case 19: func_216(); break;

		case 20: func_9(); break;

		case 21: func_1(); break;
		}
		system::wait(0);
	}
}
...
// Position - 0x26083
bool func_211() { return gameplay::is_bit_set(Global_91491.f_20, 13); }
...
// Position - 0x26564
var func_221() { return player::get_player_group(player::get_player_index()); }
...
// Position - 0x265E7
int func_223(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	bool bVar0;
	float fVar1;
...
void func_226(int iParam0, var uParam1, int iParam2, int iParam3) {
	func_227(&Global_96040, script::get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_227(var *uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) {
	...
	*uParam0 = func_215();
	...
	if (!ped::is_ped_injured(player::player_ped_id())) {
		...
		func_255(player::player_ped_id());
		func_249(player::player_ped_id(), 0);
	...
	while (iVar1 < 3) {
		...
		if (iVar1 == func_248()) {
			func_244(player::player_ped_id(), &uParam0->f_616[iVar1 /*65*/], 1);
		}
		else {
			iVar0 = 0;
			while (iVar0 < 12) {
...
// Position - 0x28078
bool func_241(int iParam0, var *uParam1, int iParam2, int iParam3) {
	char *sVar0;
...
// Position - 0x28218
bool func_243(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
bool func_245(int iParam0, int iParam1) {
	...
	iVar0 = Global_2522581[iParam0 /*3*/][func_76(iParam1)];
...
// Position - 0x28A0E
void func_247(int iParam0, int iParam1, int *iParam2, int *iParam3, var *uParam4, int iParam5, int iParam6) {
	int iVar0;
...
void func_250(int iParam0, var *uParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		while (iVar0 <= 44 - 1) {
			...
			if (iVar3 != 0) {
				vVar4.x = weapon::get_ped_weapontype_in_slot(iParam0, func_254(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		iVar7 = 0;
		while (iVar7 < iVar8) {
			if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_251(Var9.f_1) && iVar70 < 50) {
...
// Position - 0x2A45F
bool func_257(vector3 vParam0, char *sParam3, vector3 vParam4) {
	int iVar0;
	int iVar1;
...
// Position - 0x2A4A3
bool func_258(int iParam0, var *uParam1, float *fParam2) {
	*uParam1 = {0f, 0f, 0f};
	*fParam2 = 0f;
	switch (iParam0) {
	case 0:
...
// Position - 0x2AB32
bool func_259(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
bool func_260(int *iParam0) {
	if (!entity::is_entity_dead(player::player_ped_id(), 0) && !ped::is_ped_injured(player::player_ped_id())) {
		if (func_270()) {
			*iParam0 = func_265(entity::get_entity_coords(player::player_ped_id(), 0), 6, -1, 0, 1, -1);
			if (func_264(*iParam0) && !func_261(*iParam0)) {
				return true;
			}
		}
	}
...
// Position - 0x2ABD4
int func_261(int iParam0) { return func_262(iParam0, 0, 1); }
...
int func_262(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_15() == 0) {
			return gameplay::is_bit_set(func_77(func_263(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0x2AF0B
int func_264(int iParam0) { return func_262(iParam0, 5, 1); }

// Position - 0x2AF1B
int func_265(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
	...
	while (iVar0 <= 45) {
		if (iParam3 == 6 || iParam3 == func_269(iVar0)) {
			if (!iParam5 || func_268(iVar0)) {
				fVar1 = gameplay::get_distance_between_coords(vParam0, func_266(iVar0, 0), 1);
...
Vector3 func_266(int iParam0, int iParam1) {
	...
	case 45: return func_267(Global_93004);
	}
...
// Position - 0x2B5ED
int func_268(int iParam0) { return func_262(iParam0, 0, 0); }
...
// Position - 0x2B870
bool func_270() { return Global_91543.f_303 > 0; }

// Position - 0x2B881
var func_271() {
	int *iVar0;

	func_281(&iVar0, time::get_clock_seconds());
	func_280(&iVar0, time::get_clock_minutes());
	func_279(&iVar0, time::get_clock_hours());
	func_274(&iVar0, time::get_clock_day_of_month());
	func_273(&iVar0, time::get_clock_month());
	func_272(&iVar0, time::get_clock_year());
	return iVar0;
}
...
var func_276(int iParam0) {
	return (system::shift_right(iParam0, 26) & 31) * func_277(gameplay::is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
// Position - 0x2BAAF
int func_278(var uParam0) { return uParam0 & 15; }
...
int func_283(int iParam0) {
	switch (iParam0) {
	case 69:
	case 70: return func_284(Global_101700.f_8044.f_99.f_205[10]);

	case 74:
	case 75: return func_284(Global_101700.f_8044.f_99.f_205[8]);

	case 84:
	case 85: return func_284(Global_101700.f_8044.f_99.f_205[11]);

	case 90: return func_284(Global_101700.f_8044.f_99.f_205[7]);

	case 93: return func_284(Global_101700.f_8044.f_99.f_205[9]);
	}
	return 0;
}
...
void func_291() {
	...
	while (iVar23 < 4) {
		if (entity::would_entity_be_occluded(iVar18[iVar23], vVar0[iVar23 /*3*/], 1)) {
			uLocal_975[iVar23] = vehicle::create_vehicle(iVar18[iVar23], vVar0[iVar23 /*3*/], fVar13[iVar23], 1, 1);
		}
		iVar23++;
	}
...
void func_298(int iParam0) {
	...
	func_8(&iLocal_609);
	switch (iParam0) {
	case 3: sLocal_738 = "HH_FAIL1"; break;

	case 1: sLocal_738 = "HH_FAIL2"; break;

	case 2: sLocal_738 = "HH_FAIL3"; break;

	case 4: sLocal_738 = "HH_FAIL4"; break;

	case 5: sLocal_738 = "HH_FAIL5"; break;

	case 6: sLocal_738 = "HT_FAIL6"; break;

	case 8: sLocal_738 = "HT_FAIL7"; break;

	case 7: sLocal_738 = "HT_FAIL8"; break;
...
// Position - 0x2C462
void func_299(char *sParam0) { func_300(sParam0, 7500, 0); }
...
void func_302() {
	...
	while (iVar0 < 2) {
		iVar1 = 0;
		while (iVar1 < 3) {
			if (Local_499[iVar0 /*54*/][iVar1 /*17*/].f_3 != 1 && Local_499[iVar0 /*54*/][iVar1 /*17*/].f_3 != 0 &&
				Local_499[iVar0 /*54*/].f_52 != 4 && Local_499[iVar0 /*54*/].f_52 != 5) {
				...
				else if (gameplay::is_bullet_in_area(
							 entity::get_entity_coords(Local_499[iVar0 /*54*/][iVar1 /*17*/].f_6, 1), 2f, 0)) {
					iLocal_624 = 0;
					iLocal_628 = 1;
					iLocal_716 = 0;
					iLocal_716 = 0;
			...
			case 1: func_303(iVar0, iVar1); break;

			case 4:
				iLocal_716 = 0;
				iLocal_716 = 0;
				while (iLocal_716 < 3) {
					if (entity::does_entity_exist(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6) &&
						!entity::is_entity_dead(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6, 0) &&
						!ped::is_ped_injured(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6)) {
					...
					if (!Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_1) {
						if (entity::does_entity_exist(Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6) &&
							...
							ai::task_go_to_coord_any_means(
								Local_499[iVar0 /*54*/][iLocal_716 /*17*/].f_6, vLocal_959[iVar0 /*3*/],
								gameplay::get_random_float_in_range(1f, 2.5f), 0, 0, 786603, -1082130432);
...
void func_303(int iParam0, int iParam1) {
	...
	case 3:
		if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) &&
			!entity::is_entity_dead(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) {
			Local_499[iParam0 /*54*/][iParam1 /*17*/].f_7 =
				gameplay::get_game_timer() + gameplay::get_random_int_in_range(3000, 8000);
	...
	case 4:
		if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) &&
			!entity::is_entity_dead(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) {
			if (gameplay::get_game_timer() > Local_499[iParam0 /*54*/][iParam1 /*17*/].f_7 &&
				Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0) {
				func_324(iParam0, iParam1);
				iVar0 = 0;
				iVar0 = 0;
				while (iVar0 < 3) {
					if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iVar0 /*17*/].f_6) &&
						!entity::is_entity_dead(Local_499[iParam0 /*54*/][iVar0 /*17*/].f_6, 0)) {
		...
		if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) &&
			...
			if (!iLocal_650[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10]) {
				...
				if (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0) {
					ai::task_follow_nav_mesh_to_coord(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6,
													  vLocal_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/],
													  1f, -1, 0.25f, 512,
													  gameplay::get_random_float_in_range(0f, 359.9f));
				}
				else if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6) &&
						 !entity::is_entity_dead(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6, 0)) {
					ai::task_follow_to_offset_of_entity(
						Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6,
						Local_499[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
				}
	...
	case 6:
		if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) &&
			!entity::is_entity_dead(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) {
			if (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0 &&
				entity::is_entity_at_coord(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6,
										   vLocal_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/],
				...
				while (iVar1 < 3) {
					if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) &&
						...
						ai::task_wander_in_area(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6,
												vLocal_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], 7.5f,
												0f, 1f);
	...
	case 11:
		if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) &&
			...
			if (iLocal_687[iParam0]) {
				ai::task_smart_flee_coord(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_959[iParam0 /*3*/], 50f,
										  -1, 0, 0);
			}
			else {
				ai::task_smart_flee_coord(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6,
										  Local_499[iParam0 /*54*/][iParam1 /*17*/].f_14, 50f, -1, 0, 0);
			}
	...
	case 12:
		if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) &&
			!entity::is_entity_dead(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) {
			if (iLocal_687[iParam0]) {
				if (func_305(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_959[iParam0 /*3*/], 1) >= 45f) {
					ai::task_go_to_coord_any_means(
						Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_959[iParam0 /*3*/],
						gameplay::get_random_float_in_range(1f, 2.5f), 0, 0, 786603, -1082130432);
					Local_499[iParam0 /*54*/][iParam1 /*17*/].f_3 = 10;
				}
			}
			else if (func_305(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6,
							  Local_499[iParam0 /*54*/][iParam1 /*17*/].f_14, 1) >= 45f) {
				if (Local_499[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0) {
	...
	case 10:
		if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) &&
			!entity::is_entity_dead(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) {
			if (func_305(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, vLocal_959[iParam0 /*3*/], 0) < 2f) {
				ai::clear_ped_tasks(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6);
	...
	case 8:
		if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) &&
			!entity::is_entity_dead(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) {
			if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6) &&
				!entity::is_entity_dead(Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6, 0)) {
				ai::task_follow_to_offset_of_entity(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6,
													Local_499[iParam0 /*54*/][iLocal_715 /*17*/].f_6,
													Local_499[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
		...
		if (func_288(player::player_ped_id())) {
			if (entity::has_entity_been_damaged_by_entity(iParam0, player::player_ped_id(), 1)) {
				if (weapon::has_entity_been_damaged_by_weapon(iParam0, joaat("weapon_sniperrifle"), 0) ||
					...
					weapon::has_entity_been_damaged_by_weapon(iParam0, joaat("weapon_marksmanrifle"), 0)) {
					return true;
				}
				else {
					return false;
...
// Position - 0x2D13A
float func_305(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
...
void func_307(int iParam0) {
	...
	if (func_320()) {
		...
		while (iVar1 < func_319()) {
			iVar0 = entity::get_ped_index_from_entity_index(func_318(iVar1));
			iVar2 = 0;
			while (iVar2 < 3) {
...
// Position - 0x2D866
var func_318(int iParam0) { return Global_48073.f_37[iParam0]; }

// Position - 0x2D877
int func_319() { return Global_48073.f_36; }

// Position - 0x2D884
bool func_320() { return Global_48073.f_36 > 0; }

// Position - 0x2D893
void func_321(int iParam0, int iParam1) {
	if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_769, vLocal_772, 20f, 0, 1, 0) &&
		entity::does_entity_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6) &&
		!entity::is_entity_dead(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 0) && iLocal_633 && iLocal_724 < 3) {
		if (!ui::does_blip_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/])) {
			Local_499[iParam0 /*54*/][iParam1 /*17*/] =
				func_295(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1, 0, 5);
			if (ui::does_blip_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/])) {
...
void func_322(int iParam0, int iParam1) {
	...
	if (!func_288(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6)) {
		...
		Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6 =
			ped::create_ped(26, iLocal_727, vVar0, gameplay::get_random_float_in_range(0f, 359.9f), 1, 1);
		if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6)) {
			entity::set_entity_health(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 100);
...
void func_323(int iParam0, int iParam1) {
	if (!func_288(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6)) {
		...
		if (!iLocal_650[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10]) {
			...
			Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6 =
				ped::create_ped(26, iLocal_727, vLocal_921[Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/],
								Local_499[iParam0 /*54*/][iParam1 /*17*/].f_5, 1, 1);
			if (entity::does_entity_exist(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6)) {
				entity::set_entity_health(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 100);
				ped::set_blocking_of_non_temporary_events(Local_499[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
				Local_499[iParam0 /*54*/][iParam1 /*17*/].f_9 = Local_499[iParam0 /*54*/][iParam1 /*17*/].f_10;
...
void func_339() {
	...
	func_340();
	if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_907, vLocal_910, 3.5f, 0, 1, 0) ||
		iLocal_659[16]) {
		func_334();
		func_327();
		iLocal_318 = 15;
...
void func_340() {
	...
	while (iVar0 < 5) {
		if (Local_353[iVar0 /*29*/].f_13 != 0) {
			...
			if (entity::does_entity_exist(Local_353[iVar0 /*29*/].f_28)) {
				if (!entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_763, vLocal_766, 10f, 0, 1, 0)) {
					if (!bLocal_636) {
						if (entity::has_entity_been_damaged_by_entity(Local_353[iVar0 /*29*/].f_28,
		...
		case 2:
			...
			if (!vehicle::is_any_vehicle_near_point(Local_353[Local_353[iVar0 /*29*/].f_7 /*29*/].f_16, 4.5f) &&
				iLocal_705 < 3 &&
				entity::would_entity_be_occluded(Local_353[iVar0 /*29*/].f_9, Local_353[iVar0 /*29*/].f_16, 1)) {
				Local_353[iVar0 /*29*/].f_28 = vehicle::create_vehicle(
					Local_353[iVar0 /*29*/].f_9, Local_353[iVar0 /*29*/].f_16, Local_353[iVar0 /*29*/].f_4, 1, 1);
				if (entity::does_entity_exist(Local_353[iVar0 /*29*/].f_28) &&
					!entity::is_entity_dead(Local_353[iVar0 /*29*/].f_28, 0)) {
					...
					Local_353[iVar0 /*29*/].f_7 = gameplay::get_random_int_in_range(0, 5);
					Local_353[iVar0 /*29*/].f_12 = ped::create_ped_inside_vehicle(
						Local_353[iVar0 /*29*/].f_28, 26, Local_353[Local_353[iVar0 /*29*/].f_7 /*29*/].f_10, -1, 1, 1);
					if (entity::does_entity_exist(Local_353[iVar0 /*29*/].f_12)) {
						Local_353[iVar0 /*29*/].f_11 =
							object::create_object(iLocal_731, Local_353[iVar0 /*29*/].f_16, 1, 1, 0);
						if (entity::does_entity_exist(Local_353[iVar0 /*29*/].f_11)) {
							entity::attach_entity_to_entity(
								Local_353[iVar0 /*29*/].f_11, Local_353[iVar0 /*29*/].f_12,
								ped::get_ped_bone_index(Local_353[iVar0 /*29*/].f_12, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0,
								0, 0, 0, 2, 1);
							entity::set_entity_visible(Local_353[iVar0 /*29*/].f_11, 0, 0);
							entity::set_entity_load_collision_flag(Local_353[iVar0 /*29*/].f_12, 1);
							...
							ai::task_vehicle_drive_to_coord(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28,
															Local_353[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
							iLocal_705++;
		...
		case 4:
			if (func_288(Local_353[iVar0 /*29*/].f_12) && func_353(Local_353[iVar0 /*29*/].f_28)) {
				if (!entity::is_entity_at_coord(Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_19, 10f, 10f,
												10f, 0, 0, 0)) {
					...
					if (entity::has_entity_been_damaged_by_entity(Local_353[iVar0 /*29*/].f_28, player::player_ped_id(),
																  1)) {
						...
						if (gameplay::is_bullet_in_area(entity::get_entity_coords(Local_353[iVar0 /*29*/].f_28, 1), 5f,
														1)) {
							iLocal_629 = 1;
						}
					}
					...
					ai::task_vehicle_drive_wander(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, 8f,
												  786599);
		...
		case 5:
			if (func_288(Local_353[iVar0 /*29*/].f_12) && func_353(Local_353[iVar0 /*29*/].f_28)) {
				ai::clear_ped_tasks(Local_353[iVar0 /*29*/].f_12);
				vVar1 = {func_344(Local_353[iVar0 /*29*/].f_28)};
				if (!func_259(vVar1, 0f, 0f, 0f, 0)) {
					ai::task_vehicle_park(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_28, vVar1,
										  entity::get_entity_heading(Local_353[iVar0 /*29*/].f_28), 3, 270f, 1);
				}
				else if (func_325()) {
		...
		case 6:
			if (func_224(Local_353[iVar0 /*29*/].f_28) && func_288(Local_353[iVar0 /*29*/].f_12) &&
				!entity::has_entity_been_damaged_by_entity(Local_353[iVar0 /*29*/].f_28, player::player_ped_id(), 1)) {
				if (vehicle::is_vehicle_stopped(Local_353[iVar0 /*29*/].f_28)) {
					ai::clear_ped_tasks(Local_353[iVar0 /*29*/].f_12);
					ped::set_blocking_of_non_temporary_events(Local_353[iVar0 /*29*/].f_12, 1);
					if (!entity::has_entity_been_damaged_by_entity(Local_353[iVar0 /*29*/].f_28,
																   player::player_ped_id(), 1) ||
						!Local_353[iVar0 /*29*/].f_2) {
		...
		case 7:
			if (func_288(Local_353[iVar0 /*29*/].f_12) &&
				!entity::has_entity_been_damaged_by_entity(Local_353[iVar0 /*29*/].f_28, player::player_ped_id(), 1)) {
				...
				else if (entity::has_entity_been_damaged_by_entity(Local_353[iVar0 /*29*/].f_28,
																   player::player_ped_id(), 1)) {
					func_345(iVar0);
				}
			}
		...
		case 8:
			if (func_288(Local_353[iVar0 /*29*/].f_12) &&
				...
				if (!ped::is_ped_in_any_vehicle(Local_353[iVar0 /*29*/].f_12, 0)) {
					if (!entity::has_entity_been_damaged_by_entity(Local_353[iVar0 /*29*/].f_28,
																   player::player_ped_id(), 1) &&
						!gameplay::is_bullet_in_area(vVar4, 3f, 1)) {
						Local_353[iVar0 /*29*/].f_25 = {entity::get_offset_from_entity_in_world_coords(
							Local_353[iVar0 /*29*/].f_28, Local_353[iVar0 /*29*/].f_22)};
						Local_353[iVar0 /*29*/].f_6 =
							entity::get_entity_heading(Local_353[iVar0 /*29*/].f_28) + Local_353[iVar0 /*29*/].f_5;
						ai::clear_ped_tasks(Local_353[iVar0 /*29*/].f_12);
						ped::set_blocking_of_non_temporary_events(Local_353[iVar0 /*29*/].f_12, 1);
						ai::task_follow_nav_mesh_to_coord(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_25,
														  1f, -1, 0.25f, 0, Local_353[iVar0 /*29*/].f_6);
		...
		case 9:
			if (func_288(Local_353[iVar0 /*29*/].f_12) &&
				...
				if (!entity::has_entity_been_damaged_by_entity(Local_353[iVar0 /*29*/].f_28, player::player_ped_id(),
															   1) &&
					!gameplay::is_bullet_in_area(vVar4, 3f, 1)) {
					if (entity::is_entity_at_coord(Local_353[iVar0 /*29*/].f_12, Local_353[iVar0 /*29*/].f_25, 1f, 1f,
												   1f, 0, 0, 1)) {
						ai::clear_ped_tasks(Local_353[iVar0 /*29*/].f_12);
						ped::set_blocking_of_non_temporary_events(Local_353[iVar0 /*29*/].f_12, 1);
		...
		case 12:
			if (func_288(Local_353[iVar0 /*29*/].f_12) &&
				...
				if (!entity::has_entity_been_damaged_by_entity(Local_353[iVar0 /*29*/].f_28, player::player_ped_id(),
					...
					else if (entity::is_entity_playing_anim(Local_353[iVar0 /*29*/].f_12, "ODDJOBS@HUNTER",
															"enter_call", 3) &&
							 !entity::is_entity_visible(Local_353[iVar0 /*29*/].f_11)) {
		...
		case 13:
			if (!entity::has_entity_been_damaged_by_entity(Local_353[iVar0 /*29*/].f_28, player::player_ped_id(), 1)) {
				if (gameplay::get_distance_between_coords(entity::get_entity_coords(Local_353[iVar0 /*29*/].f_28, 0),
		...
		if (func_353(Local_353[iVar0 /*29*/].f_28) && func_288(Local_353[iVar0 /*29*/].f_12)) {
			if (gameplay::get_distance_between_coords(
					vLocal_800, entity::get_entity_coords(Local_353[iVar0 /*29*/].f_28, 1), 1) > 450f) {
				Local_353[iVar0 /*29*/].f_13 = 15;
			}
		}
		iVar0++;
	...
	if (func_288(Local_353[iParam0 /*29*/].f_12)) {
		...
		if (func_353(Local_353[iParam0 /*29*/].f_28)) {
			if (ped::is_ped_in_vehicle(Local_353[iParam0 /*29*/].f_12, Local_353[iParam0 /*29*/].f_28, 0)) {
				ai::task_vehicle_drive_to_coord(Local_353[iParam0 /*29*/].f_12, Local_353[iParam0 /*29*/].f_28,
												Local_353[iParam0 /*29*/].f_19, 80f, 1, 0, 786469, 5f, 2f);
...
bool func_348() {
	...
	if (func_288(player::player_ped_id())) {
		...
		if (func_288(iLocal_734)) {
			...
			if (func_349(player::player_ped_id(), iLocal_734, 0) <= 10f && gameplay::absf(vVar0.z - vVar3.z) < 1.5f) {
				return true;
			}
		}
	}
...
bool func_351(int iParam0) {
	if (entity::does_entity_exist(Local_353[iParam0 /*29*/].f_28) &&
		!entity::is_entity_dead(Local_353[iParam0 /*29*/].f_28, 0)) {
...
void func_354(int iParam0) {
	if (entity::does_entity_exist(Local_353[iParam0 /*29*/].f_12)) {
		if (entity::is_entity_dead(Local_353[iParam0 /*29*/].f_12, 0) ||
			!entity::is_entity_dead(Local_353[iParam0 /*29*/].f_12, 0)) {
...
void func_360() {
	...
	case 1:
		if (cam::is_screen_faded_out()) {
			...
			iLocal_319 = 13;
			gameplay::clear_area_of_vehicles(vLocal_800, 50f, 0, 0, 0, 0, 0);
			gameplay::clear_area_of_vehicles(vLocal_794, 50f, 0, 0, 0, 0, 0);
			gameplay::clear_area_of_vehicles(vLocal_797, 50f, 0, 0, 0, 0, 0);
			ai::clear_ped_tasks_immediately(player::player_ped_id());
			func_356();
			func_330();
			func_329();
...
void func_362() {
	...
	while (!streaming::has_model_loaded(Local_353[0 /*29*/].f_9) ||
		   !streaming::has_model_loaded(Local_353[1 /*29*/].f_9) ||
		   !streaming::has_model_loaded(Local_353[2 /*29*/].f_9) ||
		   !streaming::has_model_loaded(Local_353[3 /*29*/].f_9) ||
		   !streaming::has_model_loaded(Local_353[4 /*29*/].f_9) ||
		   !streaming::has_model_loaded(Local_353[0 /*29*/].f_10) ||
		   !streaming::has_model_loaded(Local_353[1 /*29*/].f_10) ||
		   !streaming::has_model_loaded(Local_353[2 /*29*/].f_10) ||
		   !streaming::has_model_loaded(Local_353[3 /*29*/].f_10) ||
		   !streaming::has_model_loaded(Local_353[4 /*29*/].f_10) || !streaming::has_model_loaded(iLocal_731)) {
		system::wait(0);
	}
	iLocal_639 = 1;
}
...
void func_363() {
	Local_353[0 /*29*/] = {
		func_364(joaat("habanero"), 1155.058f, 3533.135f, 33.9186f, 34.9236f, joaat("a_m_y_hippy_01"), vLocal_794)};
	Local_353[1 /*29*/] = {
		func_364(joaat("dubsta"), 1655.803f, 3492.451f, 35.5714f, 105.5303f, joaat("a_m_m_salton_01"), vLocal_797)};
	Local_353[2 /*29*/] = {
		func_364(joaat("patriot"), 1516.076f, 3376.604f, 36.6333f, 359.8644f, joaat("a_m_m_hillbilly_01"), vLocal_797)};
	Local_353[3 /*29*/] = {
		func_364(joaat("rebel"), 1140.058f, 3533.135f, 33.9186f, 269f, joaat("a_m_m_salton_01"), vLocal_794)};
	Local_353[4 /*29*/] = {
		func_364(joaat("sadler"), 1508.076f, 3372.604f, 36.6333f, 359.8644f, joaat("a_m_y_hippy_01"), vLocal_797)};
}

// Position - 0x2FBD3
struct<29> func_364(int iParam0, vector3 vParam1, float fParam4, int iParam5, vector3 vParam6) {
	struct<29> Var0;
...
void func_366() {
	if (!ped::is_ped_injured(iLocal_734) && !ped::is_ped_injured(player::player_ped_id())) {
		...
		else if (entity::is_entity_at_entity(iLocal_734, player::player_ped_id(), vLocal_823, 0, 1, 0) &&
				 interior::get_interior_from_entity(player::player_ped_id()) == 0) {
			if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0) ||
				vehicle::are_any_vehicle_seats_free(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0))) {
				bLocal_630 = false;
			}
		}
	}
...
void func_367() {
	...
	if (!bLocal_630) {
		func_8(&iLocal_610);
		iLocal_609 = func_368(vLocal_745, 5, 1);
		func_299("HT_NXTLOC");
		iLocal_318 = 9;
	}
	if (func_337()) {
...
// Position - 0x2FE2D
int func_368(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
...
void func_369() {
	...
	if (!bLocal_630) {
		if (entity::is_entity_at_coord(player::player_ped_id(), vLocal_745, 5f, 5f, 5f, 0, 1, 0) &&
			func_370(1077936128, 1)) {
...
// Position - 0x2FF4E
int func_370(float fParam0, int iParam1) {
	int iVar0;
...
void func_375() {
	...
	if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_757, vLocal_760, 7f, 0, 1, 0)) {
		...
		if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0) &&
			(entity::is_entity_at_coord(iLocal_734, vLocal_778, 2f, 2f, 2f, 0, 1, 0) || iLocal_724 >= 3)) {
			if (!iLocal_641) {
				if (iLocal_724 >= 3) {
...
// Position - 0x302BD
int func_377(int iParam0) { return func_378(iParam0, 1, 0); }
...
int func_378(int iParam0, int iParam1, int iParam2) {
	...
	if (entity::is_entity_a_vehicle(iParam0)) {
		ui::set_blip_scale(iVar0, func_379(network::network_is_game_in_progress(), 1f, 1f));
		if (!iParam2) {
		...
		ui::set_blip_scale(iVar0, func_379(network::network_is_game_in_progress(), 0.7f, 0.7f));
		ui::set_blip_as_friendly(iVar0, iParam1);
	}
...
// Position - 0x30371
var func_379(bool bParam0, float fParam1, float fParam2) {
	if (bParam0) {
		return fParam1;
	}
	return fParam2;
	...
	if (!iLocal_618) {
		...
		while (iVar0 < 3) {
			...
			if (entity::does_entity_exist(Local_322[iVar0 /*10*/])) {
				...
				entity::set_entity_health(Local_322[iVar0 /*10*/], 100);
		...
		if (entity::does_entity_exist(Local_322[0 /*10*/]) && entity::does_entity_exist(Local_322[1 /*10*/]) &&
			entity::does_entity_exist(Local_322[2 /*10*/]) && func_385()) {
			streaming::set_model_as_no_longer_needed(iLocal_726);
			iLocal_618 = 0;
			return true;
		}
...
void func_388() {
	...
	case 1:
		if (cam::is_screen_faded_out()) {
			...
			func_222(1);
			gameplay::clear_area_of_vehicles(vLocal_807, 2f, 0, 0, 0, 0, 0);
			func_7();
			iLocal_321 = 2;
		}
		break;
	...
	case 1:
		...
		case 0:
			if (func_414(1, 1093140480, 0)) {
				...
				func_404(vLocal_826, vLocal_829, 5f, vLocal_850, fLocal_700, 1, 1, 1, 0, 0);
				func_404(vLocal_832, vLocal_835, 5f, vLocal_850, fLocal_700, 1, 1, 1, 0, 0);
				func_404(vLocal_838, vLocal_841, 5f, vLocal_850, fLocal_700, 1, 1, 1, 0, 0);
				func_404(vLocal_844, vLocal_847, 5f, vLocal_850, fLocal_700, 1, 1, 1, 0, 0);
				...
				func_400(vLocal_807, 1, 0, 1, 1, 1, 1, 1, 1, 1, 1);
				iLocal_706++;
			}
			break;
...
void func_392(int iParam0, int iParam1, int iParam2, int iParam3) {
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_396(player::player_id()) &&
				!func_394(player::player_id(), 0) && !func_393()) {
				entity::set_entity_invincible(player::player_ped_id(), 0);
			}
		}
		else if (!ped::is_ped_injured(player::player_ped_id()) && !func_396(player::player_id())) {
			entity::set_entity_invincible(player::player_ped_id(), 0);
		}
		Global_69700 = 0;
	}
...
// Position - 0x30F07
bool func_393() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x30FF2
bool func_397() { return gameplay::is_bit_set(Global_2359301, 3); }
...
// Position - 0x31059
void func_400(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8,
	...
	if (player::is_player_playing(iVar0)) {
		...
		if (iParam6 == 1) {
			gameplay::clear_area_of_peds(func_402(player::get_player_index()), 50f, 0);
		}
		if (iParam7 == 1) {
...
// Position - 0x31253
Vector3 func_402(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }
...
// Position - 0x312A2
void func_404(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11,
			  int iParam12, int iParam13, int iParam14, int iParam15) {
	func_405(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14,
			 iParam15);
}

// Position - 0x312CB
void func_405(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
		...
		if (vehicle::is_vehicle_driveable(iVar0, 0)) {
			...
			if (entity::is_entity_in_angled_area(iVar0, vParam0, vParam3, fParam6, 0, 1, 0)) {
				...
				if (vVar10.z > vParam0.z && vVar10.z < vParam3.z || vVar10.z > vParam3.z && vVar10.z < vParam0.z) {
					if (func_407(iVar0, vParam0, vParam3, fParam6)) {
						bVar1 = true;
					}
				}
			}
...
// Position - 0x316E7
bool func_407(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	vector3 vVar9;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		vParam1.z = vParam4.z;
		vVar0 = {func_409(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (func_408(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_408(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_408(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_408(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_408(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_408(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_408(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_408(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_408(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_408(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_408(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_408(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_408(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_408(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_408(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_408(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x319DD
int func_408(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
// Position - 0x31B55
int func_412(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			 int iParam8) {
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (func_252(iVar2, iVar8) != 0) {
		if (!entity::is_entity_dead(iParam0, 0)) {
			if (weapon::has_ped_got_weapon_component(iParam0, iVar2, func_252(iVar2, iVar8))) {
				if (func_413(func_252(iVar2, iVar8))) {
					iVar9 = weapon::get_weapon_component_type_model(func_252(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_252(iVar2, iVar8) != 0) {
		if (!entity::is_entity_dead(iParam0, 0)) {
			if (weapon::has_ped_got_weapon_component(iParam0, iVar2, func_252(iVar2, iVar8))) {
				weapon::give_weapon_component_to_weapon_object(iVar1, func_252(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
bool func_414(int iParam0, float fParam1, int iParam2) {
	...
	if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
		if (!ped::is_ped_in_any_heli(player::player_ped_id()) && !ped::is_ped_in_any_boat(player::player_ped_id()) &&
			...
			if (!func_417(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), fParam1, 1, 1056964608, 0, 1, 0)) {
				iVar0 = 0;
			}
			else if (iParam2 == 1) {
				iVar0 = 0;
				if (!func_352(player::player_ped_id(), -828834893)) {
...
// Position - 0x31FCD
int func_417(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
// Position - 0x32193
void func_420() {
	if (!cam::is_gameplay_hint_active() && func_349(player::player_ped_id(), iLocal_734, 1) > 3f) {
	...
	else if (func_288(iLocal_734) && func_288(player::player_ped_id())) {
		if (gameplay::get_game_timer() > iLocal_711 || func_349(player::player_ped_id(), iLocal_734, 1) <= 3f) {
			if (func_349(player::player_ped_id(), iLocal_734, 1) <= 3f) {
			}
			iLocal_706 = 0;
			iLocal_321 = 0;
			iLocal_318 = 2;
...
void func_421() {
	...
	if (func_502()) {
		...
		switch (iVar0) {
		case 0:
			func_422(vLocal_810, fLocal_813, 1, 0);
			iLocal_318 = 3;
			break;

		case 1:
			func_422(vLocal_742, fLocal_690, 1, 0);
			iLocal_318 = 5;
			break;

		case 2:
			func_422(vLocal_748, fLocal_691, 1, 0);
			iLocal_318 = 12;
			break;

		case 3:
			func_422(vLocal_803, fLocal_806, 1, 0);
			iLocal_318 = 16;
			break;

		case 4:
			func_422(vLocal_913, fLocal_916, 1, 0);
			iLocal_318 = 20;
			break;
...
// Position - 0x32434
void func_422(vector3 vParam0, float fParam3, int iParam4, int iParam5) {
	if (func_502()) {
...
void func_430() {
	if (cam::get_follow_ped_cam_view_mode() != 4) {
		if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_859, vLocal_862, 16f, 0, 1, 0) ||
			entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_865, vLocal_868, 19f, 0, 1, 0) ||
			entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_871, vLocal_874, 19f, 0, 1, 0)) {
	...
	if (func_288(player::player_ped_id())) {
		...
		case 2:
			if (func_288(iLocal_734)) {
				if (func_462()) {
					...
					weapon::remove_weapon_from_ped(iLocal_734, joaat("weapon_sniperrifle"));
					ai::task_follow_nav_mesh_to_coord(iLocal_734, vLocal_778, 1f, 60000, 0.25f, 512,
													  Local_322[iLocal_721 /*10*/].f_6);
					ped::set_ped_can_ragdoll_from_player_impact(iLocal_734, 0);
					iLocal_319 = 4;
				}
			}
		...
		case 4:
			if (ai::get_script_task_status(iLocal_734, 713668775) == 7) {
				...
				func_461(&iLocal_995, &uLocal_153, cLocal_739, &sLocal_996, &cLocal_1002);
			}
			break;
		...
		case 6:
			...
			else if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_757, vLocal_760, 7f, 0, 1, 0) &&
					 func_348()) {
				if (func_459()) {
					func_356();
		...
		case 10:
			...
			if (entity::is_entity_at_entity(iLocal_734, player::player_ped_id(), vLocal_820, 0, 1, 0)) {
				if (!iLocal_659[5]) {
					if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_757, vLocal_760, 7f, 0, 1,
														 0)) {
						func_449();
					}
					else {
		...
		case 14:
			if (ai::get_script_task_status(iLocal_734, 713668775) == 7) {
				if (entity::is_entity_at_coord(iLocal_734, vLocal_781, 1.25f, 1.25f, 2.5f, 0, 1, 0) &&
					entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_763, vLocal_766, 10f, 0, 1, 0)) {
					if (func_459()) {
		...
		case 17:
			...
			switch (iLocal_717) {
			case 0:
				if (func_305(iLocal_734, vLocal_946[0 /*3*/], 0) < 2f) {
			...
			case 1:
				if (func_305(iLocal_734, vLocal_946[1 /*3*/], 0) < 2f) {
			...
			case 2:
				if (func_305(iLocal_734, vLocal_946[2 /*3*/], 0) < 2f) {
			...
			case 3:
				if (func_305(iLocal_734, vLocal_946[3 /*3*/], 0) < 2f) {
			...
			case 4:
				if (ai::get_script_task_status(iLocal_734, 713668775) == 7 ||
					entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_907, vLocal_910, 3.5f, 0, 1, 0) &&
						entity::is_entity_in_angled_area(iLocal_734, vLocal_907, vLocal_910, 3.5f, 0, 1, 0)) {
					ped::set_ped_can_ragdoll_from_player_impact(iLocal_734, 0);
					iLocal_319 = 18;
				}
				break;
		...
		case 21:
			if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_769, vLocal_772, 20f, 0, 1, 0)) {
				if (ai::get_script_task_status(iLocal_734, 713668775) == 7) {
					if (func_347(&uLocal_153, cLocal_739, "HUNT1_COARR", 7, 0, 0, 0) || iLocal_724 > 0 ||
						iLocal_714 == 1) {
						unk1::_0x293220DA1B46CEBC(3f, 5f, 4);
						iLocal_714 = 0;
						iLocal_659[17] = 1;
		...
		case 23:
			if (func_451()) {
				if (!func_217() && !func_293(player::player_ped_id())) {
					ai::task_turn_ped_to_face_entity(iLocal_734, player::player_ped_id(), -1);
					iLocal_659[20] = 1;
					iLocal_319 = 25;
				}
			...
			if (!func_217()) {
				if (!iLocal_659[21]) {
					...
					if (func_288(iLocal_734)) {
						...
						ai::task_perform_sequence(iLocal_734, iLocal_737);
						ai::clear_sequence_task(&iLocal_737);
		...
		if (iLocal_318 != 21 && !iLocal_659[20] && iLocal_319 != 25 && iLocal_319 != 0) {
			if (!iLocal_627) {
				...
				if (entity::is_entity_dead(iLocal_734, 0) ||
					entity::has_entity_been_damaged_by_entity(iLocal_734, player::player_ped_id(), 1) ||
					weapon::has_ped_been_damaged_by_weapon(iLocal_734, 0, 2) ||
					fire::is_explosion_in_sphere(-1, entity::get_entity_coords(iLocal_734, 0), 10f)) {
					func_2();
					iLocal_710 = gameplay::get_game_timer() + 2400;
					iLocal_627 = 1;
				}
...
void func_433() {
	...
	if (func_436()) {
		...
		while (iVar1 < func_435()) {
			if (entity::does_entity_exist(func_434(iVar1))) {
				iVar0 = entity::get_ped_index_from_entity_index(func_434(iVar1));
...
// Position - 0x33937
var func_434(int iParam0) { return Global_48073.f_25[iParam0]; }

// Position - 0x33948
int func_435() { return Global_48073.f_24; }

// Position - 0x33955
bool func_436() { return Global_48073.f_24 > 0; }
...
void func_441() {
	...
	if (func_288(player::player_ped_id()) && func_288(iLocal_734)) {
		if (ped::is_ped_in_any_vehicle(iLocal_734, 0) && ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			if (func_224(iLocal_980)) {
				if (ped::get_vehicle_ped_is_in(player::player_ped_id(), 0) == iLocal_980 &&
					ped::get_vehicle_ped_is_in(iLocal_734, 0) == iLocal_980) {
					if (!iLocal_990) {
		...
		if (!iLocal_659[7]) {
			if (!func_217()) {
				if (func_348()) {
					...
					else if (vehicle::are_any_vehicle_seats_free(
...
// Position - 0x33F91
bool func_451() {
	if (!entity::is_entity_playing_anim(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) &&
		!entity::is_entity_playing_anim(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3)) {
		if (!entity::does_entity_exist(iLocal_732)) {
			ai::clear_ped_tasks(iLocal_734);
			return true;
		}
...
void func_452() {
	...
	while (iVar0 < 3) {
		if (gameplay::is_bullet_in_area(Local_322[iVar0 /*10*/].f_1, 10f, 1)) {
			if (!func_217()) {
				if (!func_374("HT_SHDISH", 0, 0) || gameplay::get_profile_setting(203) == 0) {
					if (!Local_322[iVar0 /*10*/].f_7) {
...
void func_454(int iParam0) {
	...
	sVar0 = "NONE";
	switch (iParam0) {
	case 0: sVar0 = "HUNT1_DIIN"; break;

	case 1: sVar0 = "HUNT_TYIN"; break;

	case 2: sVar0 = "HUNT1_COIN"; break;
	}
	...
	if (func_288(iLocal_734)) {
		...
		case 0:
			...
			case 0:
				...
				if (iLocal_616) {
					if (!entity::is_entity_at_coord(iLocal_734, vLocal_778, 1.5f, 1.5f, 1.5f, 0, 1, 0) ||
						!ped::_0xFCF37A457CB96DC0(iLocal_734, Local_322[iLocal_721 /*10*/].f_1, 30f)) {
						if (ai::get_script_task_status(iLocal_734, 713668775) != 1 ||
							ai::get_script_task_status(iLocal_734, 713668775) != 7) {
							iLocal_714 = 1;
						}
					}
				}
			...
			case 1:
				if (!entity::is_entity_at_coord(iLocal_734, vLocal_781, 1.5f, 1.5f, 1.5f, 0, 1, 0) ||
					!func_456(iLocal_734, fLocal_691, 30f)) {
					iLocal_714 = 1;
				}
				break;

			case 2:
				if (!entity::is_entity_at_coord(iLocal_734, vLocal_788, 1.5f, 1.5f, 1.5f, 0, 1, 0) ||
					!func_456(iLocal_734, fLocal_699, 30f)) {
					iLocal_714 = 1;
				}
				break;
			}
	...
	if (!iParam1 || iLocal_616) {
		if (func_462()) {
			...
			if (func_288(iLocal_734)) {
				...
				ai::task_perform_sequence(iLocal_734, iVar0);
...
bool func_459() {
	if (func_288(player::player_ped_id())) {
		if (weapon::get_weapontype_group(func_460(player::player_ped_id())) == -1212426201) {
			return true;
		}
	}
	return false;
...
// Position - 0x3487A
void func_461(int *iParam0, var *uParam1, char *sParam2, char *sParam3, char *sParam4) {
	switch (*iParam0) {
	case 0: break;
	...
	case 4:
		if (!audio::is_scripted_conversation_ongoing() && func_440(uParam1, sParam2, sParam3, sParam4, 8, 0, 0)) {
			*iParam0 = 0;
		}
		break;
	}
...
void func_464(int iParam0) {
	...
	if (func_288(iLocal_734)) {
		if (entity::is_entity_playing_anim(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) ||
			entity::is_entity_playing_anim(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_INTRO", 3)) {
			ped::set_blocking_of_non_temporary_events(iLocal_734, 1);
...
void func_465(int iParam0) {
	...
	iVar1 = 0;
	if (func_288(iLocal_734) && func_288(player::player_ped_id())) {
		if (func_436()) {
			iVar1 = 0;
			while (iVar1 < func_435()) {
				if (entity::does_entity_exist(func_434(iVar1))) {
			...
			while (iVar1 < 5) {
				if (entity::does_entity_exist(Local_353[iVar1 /*29*/].f_12)) {
					if (entity::has_entity_been_damaged_by_entity(Local_353[iVar1 /*29*/].f_12, player::player_ped_id(),
																  1)) {
...
void func_466() {
	if (!ped::is_ped_injured(iLocal_734)) {
		if (gameplay::is_projectile_type_in_area(entity::get_entity_coords(iLocal_734, 0) + Vector(2f, 2f, 2f),
												 entity::get_entity_coords(iLocal_734, 0) - Vector(2f, 2f, 2f),
												 joaat("weapon_grenade"), 0) ||
			gameplay::is_projectile_type_in_area(entity::get_entity_coords(iLocal_734, 0) + Vector(2f, 2f, 2f),
												 entity::get_entity_coords(iLocal_734, 0) - Vector(2f, 2f, 2f),
												 joaat("weapon_stickybomb"), 0) ||
			gameplay::is_projectile_type_in_area(entity::get_entity_coords(iLocal_734, 0) + Vector(2f, 2f, 2f),
												 entity::get_entity_coords(iLocal_734, 0) - Vector(2f, 2f, 2f),
		...
		if (!iLocal_619) {
			if (func_468() || player::is_player_free_aiming_at_entity(player::player_id(), iLocal_734)) {
				if (func_217()) {
					func_296();
				}
	...
	if (func_288(iLocal_734)) {
		if (iLocal_319 != 25) {
			if (!weapon::is_ped_armed(player::player_ped_id(), 6) &&
				...
				func_349(iLocal_734, player::player_ped_id(), 1) <= 3f) {
				return 1;
			}
		}
		else if (!weapon::is_ped_armed(player::player_ped_id(), 6) &&
				 ped::is_ped_in_melee_combat(player::player_ped_id()) &&
				 ped::is_ped_facing_ped(player::player_ped_id(), iLocal_734, 30f) &&
				 func_349(iLocal_734, player::player_ped_id(), 1) <= 2f) {
			return 1;
		}
	}
	return 0;
...
void func_469() {
	if (!ped::is_ped_injured(iLocal_734)) {
		if (entity::is_entity_playing_anim(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3) &&
				entity::get_entity_anim_current_time(iLocal_734, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO") >= 0.68f ||
			iLocal_714 == 1) {
			if (entity::does_entity_exist(iLocal_732)) {
				object::delete_object(&iLocal_732);
			}
		...
		if (!entity::does_entity_exist(iLocal_732)) {
			if (entity::is_entity_playing_anim(iLocal_734, "ODDJOBS@HUNTER", "binoculars_intro", 3) &&
				entity::get_entity_anim_current_time(iLocal_734, "ODDJOBS@HUNTER", "binoculars_intro") >= 0.242f) {
			...
			entity::attach_entity_to_entity(iLocal_732, iLocal_734, ped::get_ped_bone_index(iLocal_734, 28422), 0f, 0f,
...
struct<2> func_472(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_480(iParam0)}; break;
	...
	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_479(iParam2)}; break;

		case 8: Var0 = {func_478(iParam2)}; break;

		case 7: Var0 = {func_477(iParam2)}; break;

		case 10: Var0 = {func_476(iParam2)}; break;

		case 5: Var0 = {func_475(iParam2)}; break;

		case 4: Var0 = {func_474(iParam2)}; break;

		default: StringCopy(&Var0, func_473(iVar2), 8); break;
		}
		break;
...
//Position - 0x3556D
bool func_481(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (!func_484(0) || Global_69971 || Global_69960 == 1 || !cam::is_screen_faded_in()) {
		return false;
	}
	switch (Global_69956) {
	case 0:
	...
	case 5:
		if (cutscene::is_cutscene_playing() || func_483(0) || func_482(1)) {
		}
		else {
			return true;
		}
...
// Position - 0x3572A
bool func_485(int iParam0) { return func_486(iParam0, Global_35781); }
...
int func_491(var *uParam0) {
	...
	case 1:
		if (!func_500(&iVar0) || !func_498(&uParam0->f_48) ||
			!streaming::has_anim_dict_loaded("special_ped@cletus@base")) {
			return 0;
		}
		iLocal_79 = 2;
		break;
	...
	case 2:
		...
		if (!entity::does_entity_exist(uParam0->f_35[0])) {
			...
			gameplay::clear_area_of_vehicles(1804.501f, 3922.917f, 32.8091f, 2f, 0, 0, 0, 0, 0);
		}
		if (bVar4) {
			iLocal_79 = 3;
		}
	...
	case 3:
		if (func_224(uParam0->f_28[0])) {
			weapon::give_weapon_component_to_ped(uParam0->f_28[0], joaat("weapon_sniperrifle"),
												 joaat("component_at_ar_supp_02"));
			...
			if (streaming::has_anim_dict_loaded("special_ped@cletus@base")) {
				ai::task_play_anim(uParam0->f_28[0], "special_ped@cletus@base", "cletus_base", 8f, -8f, -1, 1, 0, 0, 0,
								   0);
			}
		}
...
// Position - 0x35DE5
void func_492(var *uParam0, vector3 vParam1, float fParam4, int iParam5) {
	func_493(uParam0, iLocal_81, vParam1, fParam4);
...
// Position - 0x35E4B
void func_493(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_494(uParam0);
...
// Position - 0x35F27
bool func_495(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
	if (func_496(uParam0, iParam1, vParam2, fParam5, 1)) {
		if (entity::does_entity_exist(*uParam0)) {
...
// Position - 0x36253
void func_505(var *uParam0, bool bParam1) { func_506(&uParam0->f_41, bParam1); }
...
// Position - 0x362DE
void func_508(var *uParam0, bool bParam1) { func_509(&uParam0->f_35, bParam1); }
...
// Position - 0x3632D
void func_510(var *uParam0, int iParam1) { func_511(&uParam0->f_28, iParam1); }
...
// Position - 0x36461
void func_514() { streaming::set_model_as_no_longer_needed(iLocal_727); }
...
bool func_517(char *sParam0, int iParam1, int iParam2) {
	...
	if (func_520()) {
		if (func_519()) {
			...
			iVar33 = func_282(script::get_this_script_name());
			if (iVar33 > -1) {
