...
void __EntryFunction__() {
	...
	if (player::has_force_cleanup_occurred(83)) {
		...
		if (Var0 != -1) {
			if (Global_100787[Var0 /*10*/].f_9 != -1) {
				...
				func_254(&Global_100787[Var0 /*10*/].f_9);
			}
		}
		func_242(&Var0, 1);
	}
	iVar64[0] = 24;
	if (!func_239(&iVar64, &Var0, vVar61, 1f)) {
		func_238();
	...
	iLocal_94 =
		ped::add_scenario_blocking_area(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
	...
	while (true) {
		...
		if (func_183(Var0.f_35[0])) {
			if (!func_182(-72.323f, -1258.643f, 28.648f, entity::get_entity_coords(Var0.f_35[0], 1), 1056964608)) {
		...
		func_178(Var0);
		func_171(&iLocal_93, &Var0.f_9, vVar61);
		func_166(&Var0, vVar61, "HAO1AU", "HAO1_HCO", 3, "HAO", 5000, 1101004800);
		if (func_152(&Var0, 0)) {
			if (!func_2(&Var0)) {
				func_242(&Var0, 1);
			}
...
int func_2(var *uParam0) {
	...
	if (!func_151()) {
		while (!func_142(*uParam0)) {
			...
			if (!func_184(uParam0, *uParam0 != 2)) {
				func_255("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() "
						 "[TERMINATING]");
				return 0;
			}
			system::wait(0);
	...
	if (!func_98(uParam0)) {
		func_255("STEP_7_COMMON_LaunchMission - Trying to launch a null script "
				 "string name");
		return 0;
	}
...
int func_98(int iParam0) {
	...
	if (func_128(&uParam0->f_1)) {
		...
		if (cutscene::has_cutscene_loaded()) {
			...
			func_255("Initial cutscene wasn't loaded in time to pass to RC "
					 "mission.");
					...
					if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
						...
						if (func_157(2)) {
							if (func_156(uParam0->f_27)) {
								...
								func_255("ARE_RC_TRIGGER_CONDITIONS_MET: "
		...
		if (*uParam0 == 6) {
			...
			if (ai::get_ped_desired_move_blend_ratio(player::player_ped_id()) >= 2f) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 245.8885f, 371.9034f, 103.9884f,
					...
					if (func_157(2)) {
						if (func_156(uParam0->f_27)) {
							func_155(uParam0->f_27, *uParam0);
							func_255("RC5_IN_ACTIVATION_RANGE: "
			...
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 2728.948f, 4143.44f, 42.29295f, 2722.213f,
				...
				if (func_157(2)) {
					if (func_156(1)) {
						func_155(1, *uParam0);
						func_255("RC_IN_ACTIVATION_RANGE: "
	...
	if (iParam0 == 1) {
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			...
			if (ped::is_ped_in_any_heli(player::player_ped_id()) || ped::is_ped_in_any_plane(player::player_ped_id())) {
				func_255("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for "
						 "plane or helicopter.");
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_165() || Global_100747 ||
						Global_25192 || func_164() || func_163(8, -1) || func_78() || func_162() || func_161() ||
						func_160() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;

				case 1:
					if (player::is_player_being_arrested(player::player_id(), 1) || func_165() || Global_25192 ||
						func_164() || func_163(8, -1) || func_161() || func_78() || func_162() || func_160() ||
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						player::is_player_climbing(player::player_id()) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_165() || Global_100747 ||
						Global_25192 || func_164() || func_163(8, -1) || func_161() || func_78() || func_162() ||
						func_160() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5 || LastDispatchedMessageOrCall != -1) {
						return false;
					}
					break;
				...
				case 3:
					if (ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_165() || Global_100747 ||
						Global_25192 || func_164() || func_163(8, -1) || func_78() || func_162() || func_160() ||
						G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 4:
					if (func_165() || player::get_player_wanted_level(player::player_id()) > 0 || func_163(8, -1) ||
						func_160() || func_159() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 6:
					if (entity::does_entity_exist(player::player_ped_id())) {
						if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
							...
							player::is_player_being_arrested(player::player_id(), 1) ||
							player::is_player_climbing(player::player_id()) || func_165() || Global_25192 ||
							func_164() || func_163(8, -1) || func_162() || func_161() || func_160() ||
							G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
							return false;
						}
					}
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						entity::is_entity_in_air(player::player_ped_id()) ||
						ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) || func_165() || func_162() ||
						Global_100747 || Global_25192 || func_164() || Global_36912 || func_163(8, -1) || func_161() ||
						func_159() || func_160() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 8:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						player::is_player_being_arrested(player::player_id(), 1) ||
						player::is_player_climbing(player::player_id()) || func_165() || Global_100747 ||
						Global_25192 || func_164() || func_163(8, -1) || func_161() || func_159() || func_78() ||
						func_162() || func_160()) {
						return false;
					}
					break;
...
// Position - 0xAF55
var func_158() { return Global_91530.f_1; }
...
// Position - 0xAFCD
bool func_162() { return Global_91543.f_304 > 0; }
...
// Position - 0xB019
var func_164() { return Global_1315233; }
...
// Position - 0xB041
int func_166(var *uParam0, vector3 vParam1, char[4] cParam4, char *sParam5, int iParam6, char *sParam7, int iParam8,
			 float fParam9) {
	var *uVar0;

	if (func_112(player::player_ped_id()) && func_112(uParam0->f_28[0]) && !func_131() &&
		gameplay::get_game_timer() - uParam0->f_60 > iParam8 &&
		func_170(player::player_ped_id(), vParam1, 1) < fParam9) {
		uVar0 = 16;
...
// Position - 0xB1F5
float func_170(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
	...
	if (player::is_player_playing(player::player_id())) {
		if (!gameplay::is_string_null_or_empty(sParam1)) {
			if (Global_35781 == 17) {
				...
				if (func_170(player::player_ped_id(), vParam2, 1) <= 100f) {
					func_174(iParam0, 1);
				}
			}
			else {
				...
				if (func_170(player::player_ped_id(), vParam2, 1) > 120f) {
					func_176(iParam0);
				}
			}
		}
...
// Position - 0xB433
bool func_175() { return Global_89133; }
	...
	if (func_112(player::player_ped_id())) {
		...
		while (iVar0 <= uParam0->f_28 - 1) {
			if (func_111(uParam0->f_28[iVar0])) {
				...
				switch (*uParam0) {
				case 19: func_180(uParam0->f_28[iVar0]); break;
...
int func_184(var *uParam0, int iParam1) {
	...
	if (Global_69702) {
		func_255("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer "
				 "[TERMINATING]");
		return 0;
	}
	func_95(*uParam0, &Var0);
	...
	if (func_212(*uParam0)) {
		...
		func_255("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1) {
	...
	if (*uParam0 == 10) {
		if (fire::is_explosion_in_sphere(-1, uParam0->f_17[0 /*3*/], 8f)) {
			func_255("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission "
					 "trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17) {
		if (!gameplay::is_bit_set(Var0.f_26, func_90())) {
			func_255("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player "
		...
		while (iVar0 <= iVar1) {
			if (entity::does_entity_exist(uParam0->f_35[iVar0])) {
				if (entity::is_entity_dead(uParam0->f_35[iVar0], 0)) {
					func_255("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (!ped::is_ped_injured(uParam0->f_28[iVar0])) {
					if (ped::is_ped_sitting_in_any_vehicle(player::player_ped_id())) {
						if (entity::is_entity_touching_entity(player::player_ped_id(), uParam0->f_28[iVar0])) {
							...
							func_255("STEP_5_COMMON_RCfineAndInRange - Random "
					...
					if (func_211(*uParam0)) {
						...
						if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(uParam0->f_28[iVar0], 1), 15f)) {
							...
							func_255("STEP_5_COMMON_RCfineAndInRange - There "
					...
					if (!func_193(*uParam0)) {
						...
						if (player::get_player_wanted_level(player::player_id()) > 0) {
							...
							func_255("STEP_5_COMMON_RCfineAndInRange - Player "
...
int func_220(var *uParam0) {
	...
	case 1:
		if (!func_227(&iVar0) || !streaming::has_anim_dict_loaded(sVar7)) {
			return 0;
		}
		iLocal_91 = 2;
		break;
	...
	case 2:
		...
		if (!entity::does_entity_exist(uParam0->f_28[0])) {
			if (!func_224(&uParam0->f_28[0], 53, -71.93684f, -1259.7f, 28.19359f, -177.55f, "HAO LAUNCHER RC - HAO",
						  1)) {
				bVar8 = false;
			}
		}
		...
		if (func_112(uParam0->f_28[0])) {
			...
			entity::attach_entity_to_entity(uParam0->f_41[0], uParam0->f_28[0],
											ped::get_ped_bone_index(uParam0->f_28[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1,
											1, 0, 0, 2, 1);
		}
		if (bVar8) {
			iLocal_91 = 3;
	...
	case 3:
		if (func_111(uParam0->f_28[0]) && func_183(uParam0->f_35[0])) {
			...
			ped::_set_synchronized_scene_occlusion_portal(iVar6, 0);
			ai::task_synchronized_scene(uParam0->f_28[0], iVar6, sVar7, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
...
// Position - 0xD439
void func_222(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_223(uParam0);
...
// Position - 0xD515
int func_224(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
	if (func_225(uParam0, iParam1, vParam2, fParam5, 1)) {
		if (entity::does_entity_exist(*uParam0)) {
...
// Position - 0xD571
bool func_225(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	int iVar0;
...
int func_230(int iParam0) {
	...
	if (Global_69702) {
		func_255("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is "
				 "running [TERMINATING]");
		return 0;
	}
	if (!Global_101700.f_8044 && !func_93(1)) {
		func_255("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not "
				 "active");
		return 0;
	}
	if (!func_231(iParam0)) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_255("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (Global_91491.f_11 == 6) {
		if (Global_91491 < 9) {
			...
			if (gameplay::are_strings_equal(&Global_91491.f_3, sVar0)) {
				func_255("STEP_3_COMMON_CanRCLaunch - Script denied as a "
	...
	if (script::_get_number_of_instances_of_script_with_name_hash(joaat("candidate_controller")) == 0) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_255("STEP_3_COMMON_CanRCLaunch - Script denied as "
...
// Position - 0xDAEC
int func_239(int iParam0, int iParam1, vector3 vParam2, float fParam5) {
	int iVar0;

	if (*iParam0 == 1) {
		if (func_240((*iParam0)[0], vParam2, fParam5, iParam1)) {
			return 1;
		}
	}
	else {
		iVar0 = 0;
		while (iVar0 < *iParam0) {
			if (func_240((*iParam0)[iVar0], vParam2, fParam5, iParam1)) {
				iVar0 = *iParam0;
				return 1;
			}
			iVar0++;
	...
	func_255("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch "
			 "[TERMINATING]");
	return 0;
}

// Position - 0xDB51
bool func_240(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	int iVar0;
	struct<7> Var1;

	iVar0 = 0;
	func_95(iParam0, &Var1);
	if (func_241(Var1.f_6, vParam1, fParam4, 0)) {
...
// Position - 0xDBCF
bool func_241(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
// Position - 0xDCBE
void func_244(var *uParam0, bool bParam1) { func_245(&uParam0->f_41, bParam1); }
...
// Position - 0xDD49
void func_247(var *uParam0, bool bParam1) { func_248(&uParam0->f_35, bParam1); }
...
// Position - 0xDDD0
void func_250(var *uParam0, int iParam1) { func_251(&uParam0->f_28, iParam1); }
