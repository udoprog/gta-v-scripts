...
void __EntryFunction__() {
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	iLocal_80 = func_374(64);
	iLocal_81 = func_374(63);
...
void func_1() {
	...
	case 1:
		if (!iLocal_324) {
			iLocal_324 = func_207(&uLocal_157, "NIG1AAU", "NIG1A_COMM", 7, 0, 0, 0);
		}
		else if (!func_206()) {
			iLocal_323 = 2;
		}
...
// Position - 0x25D6F
int func_208(char *sParam0, int iParam1, int iParam2) {
	Global_15746 = 0;
	...
	case 1:
		...
		case 1:
			if (cutscene::is_cutscene_playing()) {
				func_288(-1103.327f, 786.844f, 157.7133f, -1090.286f, 788.6014f, 168.5228f, 10f, -1107.023f, 788.9111f,
						 163.0734f, 187.0703f, func_295(), 1, 1, 1, 0, 0);
...
// Position - 0x2672F
int func_221(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	bool bVar0;
	float fVar1;
...
void func_228(int iParam0, int iParam1, int iParam2, int iParam3) {
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_232(player::player_id()) &&
				!func_230(player::player_id(), 0) && !func_229()) {
...
// Position - 0x26AFB
bool func_229() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x26BE6
bool func_233() { return gameplay::is_bit_set(Global_2359301, 3); }
...
// Position - 0x26C89
void func_237(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8,
...
// Position - 0x26E47
Vector3 func_238(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }
	...
	if (entity::does_entity_exist(Global_93635.f_4)) {
		if (vehicle::is_vehicle_driveable(Global_93635.f_4, 0)) {
			if (func_287(24) != Global_93635.f_4) {
				if (iParam4 == 1) {
					if (func_284(entity::get_entity_coords(Global_93635.f_4, 1), iParam5, &vVar0, &fVar3)) {
						vParam0 = {vVar0};
						fParam3 = fVar3;
					}
				}
				func_241(Global_93635.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
// Position - 0x26F11
void func_241(int iParam0, vector3 vParam1, float *fParam4, int iParam5, int iParam6) {
	struct<60> Var0;
...
int func_244(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_259(iParam0, 0, 0) ||
		func_259(iParam0, 1, 0) || func_259(iParam0, 2, 0) || func_278(iParam0) != 145 || func_258(iParam0) ||
		func_257(iParam0) || func_256(iParam0) || func_255(iParam0) || !func_245(entity::get_entity_model(iParam0))) {
		if (func_257(iParam0)) {
		}
		if (func_257(iParam0)) {
		}
...
// Position - 0x28599
int func_250() { return 0; }

// Position - 0x285A2
int func_251() { return 1; }

// Position - 0x285AB
int func_252() { return 1; }
...
// Position - 0x288DE
bool func_260(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
var func_261() {
	...
	func_271(&iVar0, time::get_clock_seconds());
	func_270(&iVar0, time::get_clock_minutes());
	func_269(&iVar0, time::get_clock_hours());
	func_264(&iVar0, time::get_clock_day_of_month());
	func_263(&iVar0, time::get_clock_month());
	func_262(&iVar0, time::get_clock_year());
	return iVar0;
}
...
// Position - 0x28BE4
int func_268(var uParam0) { return uParam0 & 15; }
...
// Position - 0x2A8DF
bool func_279(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
// Position - 0x2AD83
bool func_284(vector3 vParam0, int iParam3, var *uParam4, float *fParam5) {
	int iVar0;

	iVar0 = func_285(vParam0, iParam3, 1);
	switch (iVar0) {
	case 0:
...
// Position - 0x2AE99
int func_285(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
...
// Position - 0x2AF28
var func_286(int iParam0) { return gameplay::is_bit_set(Global_101700.f_6188[iParam0], 0); }
...
// Position - 0x2AF5C
void func_288(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
			  int iParam14, int iParam15, int iParam16, int iParam17, int iParam18) {
	func_289(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

// Position - 0x2AF86
void func_289(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
...
// Position - 0x2B3A2
bool func_291(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	vector3 vVar9;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		vParam1.z = vParam4.z;
		vVar0 = {func_293(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (func_292(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_292(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_292(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_292(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_292(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_292(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_292(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_292(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_292(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_292(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_292(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_292(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_292(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_292(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_292(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_292(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x2B698
int func_292(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
// Position - 0x2B7F0
Vector3 func_295() { return 2.55f, 5.665f, 2.55f; }
...
// Position - 0x2B848
bool func_298(int iParam0, float fParam1, int iParam2) {
	int iVar0;
	...
	if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
		if (!ped::is_ped_in_any_heli(player::player_ped_id()) && !ped::is_ped_in_any_boat(player::player_ped_id()) &&
			...
			if (!func_303(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), fParam1, 1, 1056964608, 0, 1, 0)) {
				...
				iVar0 = 0;
				if (!func_302(player::player_ped_id(), -828834893)) {
...
// Position - 0x2B9D3
int func_303(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
struct<2> func_308(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_316(iParam0)}; break;
	...
	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_315(iParam2)}; break;

		case 8: Var0 = {func_314(iParam2)}; break;

		case 7: Var0 = {func_313(iParam2)}; break;

		case 10: Var0 = {func_312(iParam2)}; break;

		case 5: Var0 = {func_311(iParam2)}; break;

		case 4: Var0 = {func_310(iParam2)}; break;

		default: StringCopy(&Var0, func_309(iVar2), 8); break;
		}
		break;
...
//Position - 0x2C260
bool func_317(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
// Position - 0x2C60F
void func_323() { ped::set_ped_non_creation_area(-1112.99f, 774.12f, 151.77f, -1077.99f, 853.65f, 187.66f); }
...
void func_327(int iParam0, int iParam1) {
	...
	case 39:
		if (iParam1) {
			iLocal_95 = ped::add_scenario_blocking_area(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0,
														1, 1, 1);
	...
	case 41:
		if (iParam1) {
			iLocal_95 = ped::add_scenario_blocking_area(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f,
														0, 1, 1, 1);
	...
	case 42:
		if (iParam1) {
			iLocal_95 = ped::add_scenario_blocking_area(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f,
														38.18122f, 0, 1, 1, 1);
...
// Position - 0x2CEA2
int func_329(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
	if (func_330(uParam0, iParam1, vParam2, fParam5, 1)) {
		if (entity::does_entity_exist(*uParam0)) {
...
// Position - 0x2CEFE
bool func_330(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	int iVar0;
...
// Position - 0x2D10A
void func_339(var *uParam0, bool bParam1) { func_340(&uParam0->f_41, bParam1); }
...
// Position - 0x2D1C0
void func_343(var *uParam0, bool bParam1) { func_344(&uParam0->f_35, bParam1); }
...
// Position - 0x2D20F
void func_345(var *uParam0, int iParam1) { func_346(&uParam0->f_28, iParam1); }
...
// Position - 0x2D80E
void func_362() { Global_17151.f_5 = 1; }

// Position - 0x2D81C
void func_363() { Global_17151.f_5 = 0; }
