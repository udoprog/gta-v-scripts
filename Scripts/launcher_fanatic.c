...
void __EntryFunction__() {
	...
	while (true) {
		...
		func_189(Var0);
		func_182(&iLocal_94, &Var0.f_9, vVar61);
		if (iLocal_95 == 0) {
			if (Var0 == 22) {
				if (cutscene::_0xB56BBBCC2955D9CB()) {
					if (func_181(Var0.f_28[1])) {
						func_273("Trying to set Mary Ann boyfriend component "
								 "variation");
		...
		if (Var0 == 21) {
			func_178(&Var0, vVar61, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0 == 22) {
			func_173(&Var0, vVar61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0 == 23) {
			if (iLocal_96 == 0) {
				if (func_178(&Var0, vVar61, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50)) {
					iLocal_96 = 1;
				}
			}
			else {
...
// Position - 0xB607
void func_171(int iParam0, char *sParam1, char *sParam2, int iParam3) {
	audio::_play_ambient_speech_with_voice(iParam0, sParam1, sParam2, func_172(iParam3), 0);
}
...
// Position - 0xB815
int func_173(int iParam0, vector3 vParam1, char[4] cParam4, char *sParam5, int iParam6, char *sParam7, int iParam8,
			 float fParam9) {
	var *uVar0;

	if (func_181(player::player_ped_id()) && func_181(iParam0->f_28[0]) && !func_130() &&
		gameplay::get_game_timer() - iParam0->f_60 > iParam8 &&
		func_177(player::player_ped_id(), vParam1, 1) < fParam9) {
		uVar0 = 16;
...
// Position - 0xBA03
bool func_178(int iParam0, vector3 vParam1, char[4] cParam4, char *sParam5, int iParam6, char *sParam7, int iParam8) {
	var *uVar0;

	if (func_161(2)) {
		if (!func_130()) {
			if (func_181(player::player_ped_id()) && func_181(iParam0->f_28[0]) &&
				gameplay::get_game_timer() - iParam0->f_60 > iParam8 &&
...
// Position - 0xBD2E
bool func_186() { return Global_89133; }
...
int func_190(var *uParam0, int iParam1) {
	...
	if (func_194(&uParam0->f_48) && iParam1) {
	...
	if (func_181(iParam0)) {
		...
		case 2:
			if (!func_193(uParam1) || !entity::is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3)) {
				...
				else if (func_193(uParam1) && uParam1->f_4 == 0 &&
	...
	if (func_181(player::player_ped_id())) {
		...
		while (iVar0 <= uParam0->f_28 - 1) {
			if (func_111(uParam0->f_28[iVar0])) {
				...
				switch (*uParam0) {
				case 19: func_220(uParam0->f_28[iVar0]); break;
...
// Position - 0xCD8F
bool func_203(int iParam0, float fParam1) { return func_204(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_204(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_205(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0xCE68
int func_205(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
	...
	if (*iParam0 == 0) {
		vVar1 = {func_206(iParam4, iParam7)};
		*iParam0 =
...
bool func_214(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_181(player::player_ped_id()) && func_181(iParam0)) {
		...
		if (!iParam2) {
			if (func_218(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_215(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
// Position - 0xD311
bool func_215(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
bool func_216(int iParam0, float fParam1) {
	...
	if (gameplay::_0x82FDE6A57EE4EE44(iParam0, joaat("weapon_grenade"), fParam1, &vVar1, &uVar0, 0) ||
		...
		if (func_217(iParam0, vVar1, 90f, 0)) {
			return true;
		}
	}
	return false;
...
// Position - 0xD4B2
bool func_217(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
// Position - 0xD540
bool func_218(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
// Position - 0xDC95
bool func_231(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
...
// Position - 0xDCF1
bool func_232(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	int iVar0;
...
// Position - 0xE27C
void func_241(var *uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	func_242(uParam0);
...
// Position - 0xE8AA
bool func_255(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	int iVar0;
	struct<7> Var1;
...
// Position - 0xE928
bool func_256(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
void func_257(int iParam0, int iParam1) {
	...
	switch (*iParam0) {
	case 21: sVar0 = "FAN1_AMB"; break;

	case 22: sVar0 = "FAN2_AMB"; break;

	case 23: sVar0 = "FAN3_AMB"; break;
	}
	func_258(sVar0);
	if (iParam1) {
		func_189(*iParam0);
...
// Position - 0xEAED
void func_263(var *uParam0, bool bParam1) { func_264(&uParam0->f_41, bParam1); }
...
// Position - 0xEB78
void func_266(var *uParam0, bool bParam1) { func_267(&uParam0->f_35, bParam1); }
...
// Position - 0xEBFF
void func_269(var *uParam0, int iParam1) { func_270(&uParam0->f_28, iParam1); }
