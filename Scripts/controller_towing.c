	...
	while (true) {
		if (func_133()) {
			...
			if (!entity::is_entity_dead(iVar2, 0)) {
				iLocal_279 = 0;
				func_2(&iLocal_278, iVar2, &iVar0, &iLocal_279, iVar1);
			}
...
void func_2(int *iParam0, int iParam1, int *iParam2, int *iParam3, int iParam4) {
	...
	*iParam3 = 500;
	if (!entity::is_entity_dead(iParam1, 0)) {
		...
		func_130(Global_101700.f_18932.f_3, &vVar3, &fVar7, &uVar0, &fVar6);
		if (Global_101700.f_18932.f_3 >= 5 || uLocal_263) {
			func_129(iParam1, vVar3, fVar7, iParam0);
		...
		case 0:
			...
			func_125(&Global_101700.f_18932.f_1, 2048);
			func_125(&Global_101700.f_18932.f_1, 4096);
			func_125(&Global_101700.f_18932.f_1, 8192);
			func_125(&Global_101700.f_18932.f_1, 16384);
		...
		case 16:
			...
			*iParam3 = 0;
			iVar8 = func_92();
			func_125(&Global_101700.f_18932.f_1, 1073741824);
			if (iVar8 == 1) {
				if (!iParam4) {
		...
		case 17:
			if (!script::is_thread_active(iLocal_249)) {
				if (func_22(Global_100353, 3)) {
					*iParam0 = 18;
				}
				else {
					func_21(&iLocal_45);
					func_3();
					func_125(&Global_100353, 3);
					func_1();
					func_23();
					iLocal_275 = 0;
					iLocal_274 = 0;
					if (func_22(Global_101700.f_18932.f_1, 2048)) {
						iLocal_253 = 0;
					}
					else if (func_22(Global_101700.f_18932.f_1, 4096)) {
						iLocal_253 = 10000;
					}
					else if (func_22(Global_101700.f_18932.f_1, 8192)) {
						iLocal_253 = 60000;
					}
					else if (func_22(Global_101700.f_18932.f_1, 16384)) {
						iLocal_253 = 120000;
					}
					else {
						iLocal_253 = 30000;
					...
					if (ui::does_blip_exist(iLocal_273)) {
						ui::remove_blip(&iLocal_273);
					}
					...
					if (Global_101700.f_18932.f_3 >= 5) {
						if (streaming::has_model_loaded(iLocal_271)) {
							...
							if (!entity::does_entity_exist(iLocal_275)) {
								...
								iLocal_275 = vehicle::create_vehicle(iLocal_271, 408.8376f, -1638.952f, 28.2928f,
																	 230.2387f, 1, 1);
								streaming::set_model_as_no_longer_needed(iLocal_271);
							}
							if (!entity::is_entity_dead(player::player_ped_id(), 0) &&
								!entity::is_entity_dead(iLocal_275, 0)) {
								ped::set_ped_into_vehicle(player::player_ped_id(), iLocal_275, -1);
								ped::set_ped_coords_keep_vehicle(player::player_ped_id(), 408.8376f, -1638.952f,
																 28.2928f);
		...
		case 19:
			if (gameplay::get_game_timer() - *iParam2 > iLocal_253) {
				*iParam2 = 0;
				*iParam0 = 0;
			}
			break;
...
// Position - 0x7F6
void func_12() { func_13(&Global_96040); }
...
// Position - 0xF46
void func_19(int *iParam0) { *iParam0 = -15; }

// Position - 0xF54
void func_20() {
	StringCopy(&Global_93627, "", 32);
	func_13(&Global_93635);
}
...
void func_25(char[4] cParam0, int iParam1, int iParam2) {
	if (Global_91491 != 10 && Global_91491 != 9) {
		...
		func_27(&Global_93635, cParam0, 0, "Start", iParam1, iParam2);
		func_26();
		Global_86002 = 0;
	}
}
...
void func_55() {
	...
	if (entity::does_entity_exist(player::player_ped_id())) {
		if (func_46(Global_101700.f_2095.f_539.f_3549) != entity::get_entity_model(player::player_ped_id())) {
			...
			if (func_38(iVar0) && (!func_56(14) || Global_100652)) {
...
int func_92() {
	...
	if (script::has_script_loaded("Towing")) {
		...
		if (iVar0 == 1) {
			...
			vLocal_53.z = 1;
			iLocal_249 = system::start_new_script_with_args("Towing", &vLocal_53, 9, 20500);
			script::set_script_as_no_longer_needed("Towing");
...
// Position - 0x72FD
void func_93(int *iParam0, int iParam1) { func_94(iParam0, iParam1); }
...
// Position - 0x74A4
bool func_97(int iParam0) { return func_98(iParam0, Global_35781); }
...
// Position - 0x76ED
void func_102() { Global_17151.f_6 = 1; }
...
void func_103() {
	...
	case 1:
		if (!func_123()) {
			if (!ui::is_help_message_being_displayed() && !func_122(&iLocal_62)) {
				audio::set_frontend_radio_active(0);
				func_120(&iLocal_62);
			}
			else if (!ui::is_help_message_being_displayed() && func_122(&iLocal_62)) {
				if (func_117(&iLocal_62) >= 2f) {
					iLocal_74 = 0;
				}
			}
		}
	...
	case 4:
		if (func_117(&iLocal_62) > 30f) {
			if (!func_22(Global_101700.f_18932.f_1, 1024)) {
				func_104("TOW_MISSEDJOB", -1);
				func_93(&Global_101700.f_18932.f_1, 1024);
			}
			iLocal_74 = 5;
		}
		break;
...
float func_117(var *uParam0) {
	if (func_122(uParam0)) {
		if (func_119(uParam0)) {
			...
			return func_118(gameplay::is_bit_set(*uParam0, 4)) - uParam0->f_1;
		}
	}
	return uParam0->f_1;
}
...
// Position - 0x8016
bool func_119(var *uParam0) { return gameplay::is_bit_set(*uParam0, 2); }

// Position - 0x8026
void func_120(var *uParam0) { func_121(uParam0, 0f); }

// Position - 0x8035
void func_121(int *iParam0, float fParam1) {
	uParam0->f_1 = func_118(gameplay::is_bit_set(*uParam0, 4)) - fParam1;
...
// Position - 0x8063
bool func_122(var *uParam0) { return gameplay::is_bit_set(*uParam0, 1); }
...
// Position - 0x8115
void func_125(int *iParam0, int iParam1) { func_126(iParam0, iParam1); }

// Position - 0x8125
void func_126(int *iParam0, var uParam1) { *iParam0 -= (*iParam0 & uParam1); }
...
void func_127(var *uParam0, int iParam1) {
	if (!func_131(uParam0, 0, 1)) {
		if (func_124(iParam1)) {
			if (controls::is_control_just_pressed(0, 86) || controls::is_disabled_control_pressed(0, 86)) {
				if (!func_123() && !ui::is_help_message_being_displayed() && !func_99(0) && !func_56(6) &&
					!func_56(7) && player::get_player_wanted_level(player::player_id()) <= 0 && func_91() == 1) {
					func_116(&uLocal_84, 1, player::player_ped_id(), "FRANKLIN", 0, 1);
					func_116(&uLocal_84, 4, 0, "TOWDISPATCH", 0, 1);
...
// Position - 0x8258
void func_129(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	float fVar0;
	int iVar1;
	int iVar2;
	...
	case 0:
		...
		if (fVar0 < 25f && !func_22(Global_101700.f_18932.f_1, 1073741824)) {
			return;
		}
		if (bLocal_268) {
			return;
		...
		if (ped::is_ped_in_any_vehicle(iParam0, 0)) {
			...
			if (!entity::is_entity_dead(iVar1, 0)) {
				...
				if ((iVar2 == joaat("towtruck") || iVar2 == joaat("towtruck2")) &&
					entity::get_entity_health(iVar1) > 400) {
					return;
				}
			}
		}
	...
	case 2:
		if (streaming::has_model_loaded(joaat("towtruck"))) {
			if (!cam::is_sphere_visible(vLocal_258, fLocal_261) || func_22(Global_101700.f_18932.f_1, 1073741824)) {
				if (!entity::does_entity_exist(iLocal_275)) {
					iLocal_275 = vehicle::create_vehicle(joaat("towtruck"), vParam1, fParam4, 1, 1);
					streaming::set_model_as_no_longer_needed(joaat("towtruck"));
					iLocal_75 = 3;
				}
			}
...
// Position - 0x83F1
void func_130(int iParam0, var *uParam1, float *fParam2, var *uParam3, float *fParam4) {
	switch (iParam0) {
	case 0:
...
// Position - 0x8608
int func_134(int iParam0) { return Global_101700.f_23863[iParam0 /*4*/]; }
