...
void __EntryFunction__() {
	...
	if (player::has_force_cleanup_occurred(83)) {
		...
		if (Var0 != -1) {
			if (Global_100787[Var0 /*10*/].f_9 != -1) {
				...
				func_255(&Global_100787[Var0 /*10*/].f_9);
			}
		}
		func_243(&Var0, 1);
	}
	if (!func_240(&iVar64, &Var0, vVar61, 1f)) {
		func_239();
	...
	while (true) {
		...
		func_179(Var0);
		func_172(&iLocal_101, &Var0.f_9, vVar61);
		if (Var0 == 25) {
			func_167(&Var0, vVar61, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
		...
		if (func_152(&Var0, 0) && gameplay::absf(vVar61.z - vVar67.z) < 2.5f) {
			if (!func_2(&Var0)) {
				func_243(&Var0, 1);
			}
			if (func_1(&Var0)) {
...
int func_2(int iParam0) {
	...
	if (!func_151()) {
		while (!func_142(*iParam0)) {
			...
			if (!func_180(iParam0, *iParam0 != 2)) {
				func_256("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() "
						 "[TERMINATING]");
				return 0;
			}
			system::wait(0);
	...
	if (!func_98(iParam0)) {
		func_256("STEP_7_COMMON_LaunchMission - Trying to launch a null script "
				 "string name");
		return 0;
	}
...
int func_98(int iParam0) {
	...
	if (func_128(&iParam0->f_1)) {
		...
		if (cutscene::has_cutscene_loaded()) {
			...
			func_256("Initial cutscene wasn't loaded in time to pass to RC "
					 "mission.");
					...
					if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
						...
						if (func_158(2)) {
							if (func_156(iParam0->f_27)) {
								...
								func_256("ARE_RC_TRIGGER_CONDITIONS_MET: "
		...
		if (*iParam0 == 6) {
			...
			if (ai::get_ped_desired_move_blend_ratio(player::player_ped_id()) >= 2f) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 245.8885f, 371.9034f, 103.9884f,
					...
					if (func_158(2)) {
						if (func_156(iParam0->f_27)) {
							func_155(iParam0->f_27, *iParam0);
							func_256("RC5_IN_ACTIVATION_RANGE: "
			...
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 2728.948f, 4143.44f, 42.29295f, 2722.213f,
				...
				if (func_158(2)) {
					if (func_156(1)) {
						func_155(1, *iParam0);
						func_256("RC_IN_ACTIVATION_RANGE: "
	...
	if (iParam0 == 1) {
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			...
			if (ped::is_ped_in_any_heli(player::player_ped_id()) || ped::is_ped_in_any_plane(player::player_ped_id())) {
				func_256("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for "
						 "plane or helicopter.");
...
// Position - 0xB072
int func_167(int iParam0, vector3 vParam1, char[4] cParam4, char *sParam5, int iParam6, char *sParam7, int iParam8,
			 float fParam9) {
	var *uVar0;

	if (func_112(player::player_ped_id()) && func_112(iParam0->f_28[0]) && !func_131() &&
		gameplay::get_game_timer() - iParam0->f_60 > iParam8 &&
		func_171(player::player_ped_id(), vParam1, 1) < fParam9) {
		uVar0 = 16;
...
// Position - 0xB260
void func_172(int *iParam0, char *sParam1, vector3 vParam2) {
	if (player::is_player_playing(player::player_id())) {
...
int func_180(int iParam0, int iParam1) {
	...
	if (Global_69702) {
		func_256("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer "
				 "[TERMINATING]");
		return 0;
	}
	func_95(*iParam0, &Var0);
	...
	if (func_211(*iParam0)) {
		...
		func_256("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (iParam0->f_25 == 1) {
	...
	if (*iParam0 == 10) {
		if (fire::is_explosion_in_sphere(-1, iParam0->f_17[0 /*3*/], 8f)) {
			func_256("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission "
					 "trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17) {
		if (!gameplay::is_bit_set(Var0.f_26, func_90())) {
			func_256("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player "
					 "character to launch mission");
			return 0;
		}
	}
	if (func_184(&iParam0->f_48) && iParam1) {
...
void func_181(int iParam0, var *uParam1, int iParam2) {
	...
	if (func_112(iParam0)) {
		...
		case 2:
			if (!func_183(uParam1) || !entity::is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3)) {
				if (func_182(iParam2) && !ped::is_ped_facing_ped(iParam0, player::player_ped_id(), 25f)) {
					ai::task_turn_ped_to_face_entity(iParam0, player::player_ped_id(), 0);
					uParam1->f_3 = 5;
				}
				else if (func_183(uParam1) && uParam1->f_4 == 0 &&
		...
		case 5:
			if (!func_182(iParam2) || ped::is_ped_facing_ped(iParam0, player::player_ped_id(), 10f)) {
				if (func_66(uParam1->f_5, 0f, 0f, 0f, 0)) {
					ai::task_play_anim(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
				}
				else {
	...
	if (func_112(player::player_ped_id())) {
		...
		while (iVar0 <= uParam0->f_28 - 1) {
			if (func_111(uParam0->f_28[iVar0])) {
				...
				switch (*uParam0) {
				case 19: func_210(uParam0->f_28[iVar0]); break;
		...
		while (iVar0 <= iVar1) {
			if (entity::does_entity_exist(uParam0->f_35[iVar0])) {
				if (entity::is_entity_dead(uParam0->f_35[iVar0], 0)) {
					func_256("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (iParam2) {
					if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
						...
						if (*uParam0 == 16) {
							if (func_189(player::player_ped_id(), uParam0->f_35[iVar0])) {
								func_256("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (!ped::is_ped_injured(uParam0->f_28[iVar0])) {
					if (ped::is_ped_sitting_in_any_vehicle(player::player_ped_id())) {
						if (entity::is_entity_touching_entity(player::player_ped_id(), uParam0->f_28[iVar0])) {
							...
							func_256("STEP_5_COMMON_RCfineAndInRange - Random "
					...
					if (func_209(*uParam0)) {
						...
						if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(uParam0->f_28[iVar0], 1), 15f)) {
							...
							func_256("STEP_5_COMMON_RCfineAndInRange - There "
					...
					if (!func_191(*uParam0)) {
						...
						if (player::get_player_wanted_level(player::player_id()) > 0) {
							...
							func_256("STEP_5_COMMON_RCfineAndInRange - Player "
...
bool func_192(int iParam0, float fParam1) {
	...
	if (func_112(player::player_ped_id()) && func_112(iParam0)) {
		if (func_203(iParam0) || player::is_player_targetting_entity(player::player_id(), iParam0)) {
...
// Position - 0xC4C3
bool func_193(int iParam0, float fParam1) { return func_194(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_194(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_195(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0xC59C
int func_195(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
	...
	if (*iParam0 == 0) {
		vVar1 = {func_196(iParam4, iParam7)};
		*iParam0 =
...
int func_198(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	vVar0 = {func_200(entity::get_entity_coords(iParam1, 1) - entity::get_entity_coords(iParam0, 1))};
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_200(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
						  ped::get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_199(vVar3, vVar0);
...
// Position - 0xC889
Vector3 func_200(vector3 vParam0) {
	float fVar0;
	float fVar1;
...
bool func_204(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_112(player::player_ped_id()) && func_112(iParam0)) {
		...
		if (!iParam2) {
			if (func_208(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_205(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
// Position - 0xCA45
bool func_205(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
bool func_206(int iParam0, float fParam1) {
	...
	if (gameplay::_0x82FDE6A57EE4EE44(iParam0, joaat("weapon_grenade"), fParam1, &vVar1, &uVar0, 0) ||
		...
		if (func_207(iParam0, vVar1, 90f, 0)) {
			return true;
		}
	}
	return false;
...
// Position - 0xCBE6
bool func_207(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;

	vVar0 = {func_200(vParam1 - entity::get_entity_coords(iParam0, 1))};
...
// Position - 0xCC74
bool func_208(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
int func_219(var *uParam0) {
	...
	case 1:
		if (!func_226(&iVar0) || !streaming::has_anim_dict_loaded("rcmhunting2")) {
			return 0;
		}
		iLocal_91 = 2;
		break;
	...
	case 2:
		...
		if (!entity::does_entity_exist(iLocal_100)) {
			iLocal_100 =
				weapon::create_weapon_object(joaat("weapon_sniperrifle"), 0, vLocal_97, 0, 1065353216, 0, 0, 1);
...
// Position - 0xD1D3
void func_220(var *uParam0, vector3 vParam1, float fParam4, int iParam5) {
	func_221(uParam0, iLocal_93, vParam1, fParam4);
...
// Position - 0xD239
void func_221(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_222(uParam0);
...
// Position - 0xD315
bool func_223(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
	if (func_224(uParam0, iParam1, vParam2, fParam5, 1)) {
		if (entity::does_entity_exist(*uParam0)) {
...
// Position - 0xD371
bool func_224(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	int iVar0;
...
int func_227(var *uParam0) {
	...
	case 1:
		if (!func_226(&iVar0) || !func_228(&uParam0->f_48) ||
...
int func_231(int iParam0) {
	...
	if (Global_69702) {
		func_256("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is "
				 "running [TERMINATING]");
		return 0;
	}
	if (!Global_101700.f_8044 && !func_93(1)) {
		func_256("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not "
				 "active");
		return 0;
	}
	if (!func_232(iParam0)) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_256("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (Global_91491.f_11 == 6) {
		if (Global_91491 < 9) {
			...
			if (gameplay::are_strings_equal(&Global_91491.f_3, sVar0)) {
				func_256("STEP_3_COMMON_CanRCLaunch - Script denied as a "
	...
	if (script::_get_number_of_instances_of_script_with_name_hash(joaat("candidate_controller")) == 0) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_256("STEP_3_COMMON_CanRCLaunch - Script denied as "
...
// Position - 0xDB9E
int func_240(int iParam0, int iParam1, vector3 vParam2, float fParam5) {
	int iVar0;

	if (*iParam0 == 1) {
		if (func_241((*iParam0)[0], vParam2, fParam5, iParam1)) {
			return 1;
		}
	}
	else {
		iVar0 = 0;
		while (iVar0 < *iParam0) {
			if (func_241((*iParam0)[iVar0], vParam2, fParam5, iParam1)) {
				iVar0 = *iParam0;
				return 1;
			}
			iVar0++;
	...
	func_256("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch "
			 "[TERMINATING]");
	return 0;
}

// Position - 0xDC03
bool func_241(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	int iVar0;
	struct<7> Var1;

	iVar0 = 0;
	func_95(iParam0, &Var1);
	if (func_242(Var1.f_6, vParam1, fParam4, 0)) {
...
// Position - 0xDD69
void func_245(var *uParam0, bool bParam1) { func_246(&uParam0->f_41, bParam1); }
...
// Position - 0xDDF4
void func_248(var *uParam0, bool bParam1) { func_249(&uParam0->f_35, bParam1); }
...
// Position - 0xDE7B
void func_251(var *uParam0, int iParam1) { func_252(&uParam0->f_28, iParam1); }
