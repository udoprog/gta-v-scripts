...
float fLocal_308 = 0f;
vector3 vLocal_309[3] = {{0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}};
vector3 vLocal_319[4] = {{0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}};
...
void __EntryFunction__() {
	...
	while (iLocal_289 && func_119(2, 0)) {
		...
		case 2:
			if (func_115()) {
				func_114(&uLocal_100, 0, player::player_ped_id(), "FRANKLIN", 0, 1);
...
void func_3(int iParam0) {
	...
	if (ped::is_ped_injured(iParam0)) {
		if (!iLocal_545 && entity::has_entity_been_damaged_by_entity(iParam0, player::player_ped_id(), 1)) {
	...
	func_6(iParam0, 138, &uLocal_100, "FMFAUD", &uLocal_265, &uLocal_286, 3);
	fVar4 =
	...
	if (fVar4 > 8f * 8f) {
		...
		if (iLocal_543 > 0) {
			if (iLocal_544 == 0) {
				if (iLocal_543 + 15000 < gameplay::get_game_timer()) {
					func_4(iParam0, "FRIEND_FOLLOWED_BY_PLAYER", 24);
					iLocal_543 = -1;
					iLocal_544++;
				}
			}
			else if (iLocal_543 + 10000 < gameplay::get_game_timer()) {
...
// Position - 0x518
int func_6(int iParam0, int iParam1, var *uParam2, char *sParam3, var *uParam4, var *uParam5, int iParam6) {
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
	int iVar7;
...
// Position - 0x8BD
void func_7(var *uParam0) { func_8(uParam0, 0f); }
...
// Position - 0xA68
void func_11(int iParam0) { Global_16756 = iParam0; }
...
bool func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	...
	if (iParam3 == 0) {
		if (func_89(iVar1, iParam2, -1, &iVar4, &iVar5)) {
			...
			if (func_85(iParam5, iVar4, iVar5, iVar0, iVar2, iParam1, iVar3, 10000, iParam6, iParam4, iVar7, iVar6,
						1)) {
				return true;
			}
			else {
		...
		if (func_69(iParam1, &sVar8, 1, 0, 0, 0, 0, 1, 0, 1)) {
			if (iParam4 != 0) {
				switch (iParam4) {
				case 202: func_68(); break;

				case 203: func_67(); break;

				case 204: func_66(); break;

				case 205: func_65(); break;

				case 206: func_36(); break;
				}
			}
			return true;
		}
...
// Position - 0x1D3E
int func_38(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	float fVar0;
	int iVar1;
	int iVar2;
	int iVar3;
	...
	if (!network::network_is_game_in_progress()) {
		if (gameplay::is_bit_set(Global_101700.f_19523.f_471, iParam0)) {
			...
			gameplay::clear_bit(&Global_101700.f_19523.f_471, iParam0);
			 ...
			 gameplay::is_bit_set(Global_2097152[func_43() /*10758*/].f_7546.f_10, iParam0)) {
		bVar0 = true;
		gameplay::clear_bit(&Global_101700.f_19523.f_471, iParam0);
		gameplay::clear_bit(&Global_2097152[func_43() /*10758*/].f_7546.f_10, iParam0);
	}
	if (bVar0) {
...
bool func_45(int iParam0) {
	...
	return gameplay::is_bit_set(Global_2097152[func_43() /*10758*/].f_7546.f_10, iParam0);
}
...
// Position - 0x2A57
bool func_51(var *uParam0, int iParam1) { return (*uParam0)[iParam1] == 70; }
...
// Position - 0x2A9C
void func_53(var *uParam0, int iParam1) { (*uParam0)[iParam1] = 70; }
...
// Position - 0x2AC9
float func_55(var *uParam0) { return uParam0->f_72; }

// Position - 0x2AD5
bool func_56(var *uParam0, int iParam1) { return func_57(uParam0, iParam1) != -1; }
...
// Position - 0x2B14
bool func_58(var *uParam0) { return uParam0->f_71 == 1; }
...
// Position - 0x2E18
bool func_69(int iParam0, char *sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	sVar6 = "NULL";
	iVar7 = 3;
	if (func_70(iParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, iParam7, iParam8,
...
// Position - 0x2EB0
int func_70(var uParam0, char *sParam1, int iParam2, int iParam3, char *sParam4, char *sParam5, int iParam6,
	...
	if (!Global_14605) {
		if (Global_14443.f_1 == 6) {
			...
			func_71(1);
			func_74(Global_14424, "DISPLAY_VIEW", 1f, system::to_float(Global_14423), -1082130432, -1082130432,
					-1082130432);
		}
	}
	return 1;
				...
				if (iParam0 == Global_2320[iVar1 /*15*/].f_11) {
					if (iVar0 == Global_2320[iVar1 /*15*/].f_4) {
						if (Global_2882[iVar0] == 0) {
							...
							if (Global_2452520) {
								if (iVar1 == 14) {
									func_72(Global_14424, "SET_DATA_SLOT", system::to_float(1), system::to_float(iVar0),
...
// Position - 0x39D2
void func_74(int iParam0, char *sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6) {
	graphics::_push_scaleform_movie_function(iParam0, sParam1);
	graphics::_push_scaleform_movie_function_parameter_int(system::round(fParam2));
	if (fParam3 != -1f) {
		graphics::_push_scaleform_movie_function_parameter_int(system::round(fParam3));
...
// Position - 0x3A35
bool func_75() { return Global_1315233; }
...
// Position - 0x3DFF
bool func_81(int iParam0, int iParam1, int iParam2, var *uParam3) {
	struct<4> Var0;
	struct<4> Var4[2];
	int iVar13;
...
// Position - 0x4317
bool func_89(int iParam0, int iParam1, int iParam2, int *iParam3, int *iParam4) {
	struct<4> Var0[2];
	int iVar9;
	...
	if (iParam1 >= 5) {
		...
		*iParam4 = func_90(iParam1, iParam2);
		return true;
	}
	return false;
}
...
// Position - 0x44FE
void func_92(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	if (iParam0 == iParam5) {
		return;
	}
	if (iParam0 == 76) {
...
int func_93(int iParam0) {
	...
	iVar1 = 0;
	while (iVar1 < G_SomeGlobalState.MessageCallStates.f_136) {
		if (G_SomeGlobalState.MessageCallStates[iVar1 /*15*/] == iParam0) {
			return func_99(iParam0, iVar0);
		}
		iVar1++;
	}
	iVar1 = 0;
	while (iVar1 < G_SomeGlobalState.MessageCallStates.f_764) {
		if (G_SomeGlobalState.MessageCallStates.f_651[iVar1 /*14*/] == iParam0) {
			return func_97(iParam0, iVar0);
		}
		iVar1++;
	}
	iVar1 = 0;
	while (iVar1 < G_SomeGlobalState.MessageCallStates.f_866) {
		if (G_SomeGlobalState.MessageCallStates.f_765[iVar1 /*10*/] == iParam0) {
...
int func_94(int iParam0, int iParam1) {
	...
	if (bVar10) {
		if (Var0.f_3 < G_SomeGlobalState.MessageCallStates.f_919[func_95()]) {
			return 5;
		}
	}
	if (Var0.f_6 != 144) {
...
struct<10> func_96(int iParam0) {
	...
	while (iVar0 < G_SomeGlobalState.MessageCallStates.f_866) {
		if (G_SomeGlobalState.MessageCallStates.f_765[iVar0 /*10*/] == iParam0) {
			return G_SomeGlobalState.MessageCallStates.f_765[iVar0 /*10*/];
		}
		iVar0++;
	}
	return Var1;
...
struct<14> func_98(int iParam0) {
	...
	while (iVar0 < G_SomeGlobalState.MessageCallStates.f_764) {
		if (G_SomeGlobalState.MessageCallStates.f_651[iVar0 /*14*/] == iParam0) {
			return G_SomeGlobalState.MessageCallStates.f_651[iVar0 /*14*/];
		}
		iVar0++;
	}
	return Var1;
...
int func_99(int iParam0, int iParam1)
{
	...
	if (LastDispatchedMessageOrCall != -1) {
		if (G_SomeGlobalState.MessageCallStates[LastDispatchedMessageOrCall /*15*/] == iParam0) {
			return 0;
		}
	}
	bVar15 = false;
...
struct<15> func_100(int iParam0) {
	...
	while (iVar0 < G_SomeGlobalState.MessageCallStates.f_136) {
		if (G_SomeGlobalState.MessageCallStates[iVar0 /*15*/] == iParam0) {
			return G_SomeGlobalState.MessageCallStates[iVar0 /*15*/];
		}
		iVar0++;
	}
	return Var1;
...
int func_107(int iParam0, int iParam1) {
	...
	if (entity::does_entity_exist(*uParam0)) {
		...
		case 0:
			if (entity::is_entity_playing_anim(*iParam0, &cLocal_389, &Local_470[iParam1 /*16*/], 2)) {
				fVar1 = fLocal_542;
				fVar2 = -1f;
				fVar3 = -1f;
				if (entity::find_anim_event_phase(&cLocal_389, &Local_470[iParam1 /*16*/], "WalkInterruptible", &fVar2,
												  &fVar3)) {
					fVar1 = fVar2;
				}
				else {
				...
				if (ped::get_synchronized_scene_phase(Global_89154) > fVar1) {
					if (func_113(vLocal_319[iParam1 /*3*/], 0f, 0f, 0f, 0)) {
						vVar4 = {entity::get_entity_coords(*iParam0, 1)};
						vLocal_319[iParam1 /*3*/] = {vVar4 - vLocal_305 * FtoV(4f)};
						vLocal_319[iParam1 /*3*/].f_2 = 0f;
					}
					system::wait(0);
					if (ped::is_ped_injured(*iParam0)) {
						ai::clear_ped_tasks(*iParam0);
						ai::task_go_straight_to_coord(*iParam0, vLocal_305 + vLocal_319[iParam1 /*3*/] * FtoV(0.1f), 1f,
			...
			if (!ped::is_synchronized_scene_running(Global_89153) &&
				!ped::is_synchronized_scene_running(Global_89154)) {
				system::wait(0);
				if (ped::is_ped_injured(*iParam0)) {
					ai::clear_ped_tasks(*iParam0);
					ai::task_go_straight_to_coord(*iParam0, vLocal_305 + vLocal_319[iParam1 /*3*/] * FtoV(0.1f), 1f, -1,
		...
		case 1:
			if (ai::get_script_task_status(*iParam0, 2106541073) != 1) {
				ai::task_follow_nav_mesh_to_coord(*iParam0, vLocal_305 + vLocal_319[iParam1 /*3*/], 1f, -1, 0.25f,
												  iVar0, 1193033728);
				iLocal_298[iParam1] = 2;
				return 1;
			}
			fVar7 = system::vmag(vLocal_319[iParam1 /*3*/] * FtoV(0.05f));
			if (system::vdist2(entity::get_entity_coords(*iParam0, 1), vLocal_305) >= fVar7) {
				if (!func_112() && !entity::is_entity_on_screen(*iParam0)) {
					ai::task_follow_nav_mesh_to_coord(*iParam0, vLocal_305 + vLocal_319[iParam1 /*3*/], 1f, -1, 0.25f,
													  iVar0, 1193033728);
					iLocal_298[iParam1] = 2;
					return 1;
			...
			if (player::is_player_targetting_entity(player::player_id(), *iParam0) ||
				ped::is_ped_in_combat(*iParam0, 0)) {
		...
		case 2:
			...
			if (ai::get_script_task_status(*iParam0, 713668775) != 1) {
				if (fLocal_336[iParam1] == 0f) {
					fLocal_336[iParam1] = system::vmag(vLocal_319[iParam1 /*3*/]) * 0.75f;
				}
				ai::task_wander_in_area(*iParam0, vLocal_305 + vLocal_319[iParam1 /*3*/], fLocal_336[iParam1],
										1077936128, 1086324736);
		...
		case 3:
			...
			if (ai::is_scenario_type_enabled(sLocal_541)) {
				ai::set_scenario_type_enabled(sLocal_541, 0);
			}
			if (system::vdist2(entity::get_entity_coords(*iParam0, 1), vLocal_305 + vLocal_319[iParam1 /*3*/]) <
				fLocal_336[iParam1] * fLocal_336[iParam1]) {
				if (ai::does_scenario_exist_in_area(vLocal_305 + vLocal_319[iParam1 /*3*/], fLocal_336[iParam1], 1)) {
					ai::task_use_nearest_scenario_to_coord(*iParam0, vLocal_305 + vLocal_319[iParam1 /*3*/],
														   fLocal_336[iParam1], 0);
		...
		case 4:
			if (ai::ped_has_use_scenario_task(*iParam0)) {
				...
				vVar8 = {func_108(vLocal_305 + vLocal_319[iParam1 /*3*/],
								  func_111(fLocal_336[iParam1] * 0.9f, 10f, 100f), 0f)};
				if (ai::get_script_task_status(*iParam0, 1647992574) == 1) {
				}
				else if (pathfind::get_safe_coord_for_ped(vVar8, 0, &vVar11, 14)) {
					if (system::vdist2(entity::get_entity_coords(*iParam0, 1), vVar11) > 100f) {
						ai::task_follow_nav_mesh_to_coord(*iParam0, vVar11, 1f, -1, 0.25f, iVar0, 1193033728);
						iLocal_298[iParam1] = 1;
						return 1;
					}
				}
		...
		case 10:
			...
			ped::set_relationship_between_groups(5, 1862763509, iLocal_303);
			ped::set_relationship_between_groups(5, iLocal_303, Global_86828);
			ped::set_relationship_between_groups(5, Global_86828, iLocal_303);
...
// Position - 0x51DB
Vector3 func_108(vector3 vParam0, float fParam3, float fParam4) {
	vector3 vVar0;
	float fVar3;
	float fVar4;
	int iVar5;
...
// Position - 0x5254
Vector3 func_109(vector3 vParam0, float fParam3, float fParam4) {
	vector3 vVar0;
	float fVar3;

	vVar0 = {gameplay::get_random_float_in_range(-1f, 1f), gameplay::get_random_float_in_range(-1f, 1f), 0f};
	fVar3 = fParam4 / 2f;
	vVar0 = {func_110(vVar0, gameplay::get_random_float_in_range(0f, fParam3))};
	vVar0.z = gameplay::get_random_float_in_range(-fVar3, fVar3);
	return vParam0 + vVar0;
}

// Position - 0x529C
Vector3 func_110(vector3 vParam0, float fParam3) {
	float fVar0;
		...
		if (ped::is_synchronized_scene_running(Global_89154)) {
			...
			while (iVar0 < iLocal_290) {
				if (!ped::is_ped_injured(iLocal_290[iVar0])) {
					ai::task_synchronized_scene(iLocal_290[iVar0], Global_89154, &cLocal_389, &Local_470[iVar0 /*16*/],
												8f, -4f, 3, 0, 1148846080, 0);
					iLocal_298[iVar0] = 0;
				}
				else {
					iLocal_298[iVar0] = -1;
...
bool func_118() {
	...
	if (ped::is_synchronized_scene_running(Global_89153)) {
		...
		while (iVar0 < iLocal_290) {
			if (!ped::is_ped_injured(iLocal_290[iVar0])) {
				ai::task_synchronized_scene(iLocal_290[iVar0], Global_89153, &cLocal_389, &Local_405[iVar0 /*16*/], 8f,
											-1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		if (!ped::is_ped_injured(player::player_ped_id())) {
			func_114(&uLocal_100, 1, player::player_ped_id(), "FRANKLIN", 0, 1);
		}
		if (!ped::is_ped_injured(Global_91277)) {
...
// Position - 0x571E
int func_120(var uParam0) { return uParam0; }
...
// Position - 0x57BD
void func_124() { func_125(Global_91279 - 1); }

// Position - 0x57CF
void func_125(int iParam0) { Global_91279 = iParam0; }

// Position - 0x57DD
void func_126() { func_125(0); }
...
void func_127() {
	...
	while (!iVar2 && iVar1 < 400) {
		...
		while (iVar0 < iLocal_290) {
			if (iLocal_294[iVar0] != 0) {
				streaming::request_model(iLocal_294[iVar0]);
				if (!streaming::has_model_loaded(iLocal_294[iVar0])) {
					iVar2 = 0;
					streaming::request_model(iLocal_294[iVar0]);
				}
			}
		...
		if (!gameplay::is_string_null_or_empty(&cLocal_389)) {
			streaming::request_anim_dict(&cLocal_389);
			if (!streaming::has_anim_dict_loaded(&cLocal_389)) {
				iVar2 = 0;
				streaming::request_anim_dict(&cLocal_389);
			}
		}
	...
	if (entity::does_entity_exist(Global_91277)) {
		if (func_31(19) == entity::get_entity_model(Global_91277)) {
	...
	ped::add_relationship_group("TAUNTERS", &iLocal_303);
	iVar0 = 0;
	while (iVar0 < iLocal_290) {
		if (iLocal_294[iVar0] != 0) {
			iLocal_290[iVar0] =
				ped::create_ped(iLocal_304, iLocal_294[iVar0], vLocal_305 + vLocal_309[iVar0 /*3*/], 0f, 1, 1);
			entity::set_entity_heading(iLocal_290[iVar0], fLocal_308 + fLocal_332[iVar0]);
			ped::set_ped_random_component_variation(iLocal_290[iVar0], 0);
			ped::set_ped_relationship_group_hash(iLocal_290[iVar0], iLocal_303);
			ai::task_play_anim(iLocal_290[iVar0], &cLocal_389, &Local_405[iVar0 /*16*/], 8f, -8f, -1, 9, 0, 0, 0, 0);
			ped::set_ped_config_flag(iLocal_290[iVar0], 317, 1);
			if (iLocal_304 == 6) {
				weapon::give_weapon_to_ped(iLocal_290[iVar0], joaat("weapon_stungun"), 1000, 0, 1);
			}
		}
		iVar0++;
	}
...
void func_129() {
	...
	func_133(iLocal_99, &vLocal_305, &fLocal_308, &cVar0);
	func_131(iLocal_99, &sLocal_341, &cLocal_357, &cLocal_373, &uVar8, &uVar9);
	switch (iLocal_99) {
	case 218:
		vLocal_309[0 /*3*/] = {gameplay::get_random_float_in_range(-10f, 10f),
							   gameplay::get_random_float_in_range(-10f, 10f), 0f};
		vLocal_309[1 /*3*/] = {gameplay::get_random_float_in_range(-10f, 10f),
							   gameplay::get_random_float_in_range(-10f, 10f), 0f};
		vLocal_319[0 /*3*/] = {-77.3f, -4.1f, 1f};
		vLocal_319[1 /*3*/] = {vLocal_319[0 /*3*/]};
		vLocal_319[iLocal_290 /*3*/] = {66.7f, -7.299f, 1f};
		fLocal_332[0] = gameplay::get_random_float_in_range(-180f, 180f);
		fLocal_332[1] = gameplay::get_random_float_in_range(-180f, 180f);
		fLocal_336[0] = 30f;
	...
	case 219:
		vLocal_309[0 /*3*/] = {-0.2331f, 0.0497f, 0.0041f};
		vLocal_309[1 /*3*/] = {0.6908f, -0.4534f, 0.0042f};
		vLocal_319[0 /*3*/] = {-0.6f, -144.3f, 0f};
		vLocal_319[1 /*3*/] = {vLocal_319[0 /*3*/]};
		vLocal_319[iLocal_290 /*3*/] = {112.2308f, 43.129f, 3.188f};
		fLocal_332[0] = 180f;
		fLocal_332[1] = 180f;
		fLocal_336[0] = 40f;
		fLocal_336[1] = fLocal_336[0];
	...
	case 220:
		vLocal_309[0 /*3*/] = {1.7097f, -1.8585f, -0.052f};
		vLocal_309[1 /*3*/] = {2.7011f, -1.5f, -0.052f};
		vLocal_319[0 /*3*/] = {Vector(21.5656f, -1890.595f, 59.4395f) - vLocal_305};
		vLocal_319[1 /*3*/] = {vLocal_319[0 /*3*/]};
		vLocal_319[iLocal_290 /*3*/] = {Vector(-4.6336f, -54.7307f, 67.5391f) * FtoV(-1f)};
	...
	case 225:
		vLocal_309[0 /*3*/] = {3.8209f, 1.0394f, 0f};
		vLocal_309[1 /*3*/] = {4.0994f, -0.0922f, 0f};
		vLocal_319[0 /*3*/] = {Vector(27.9565f, -1650.517f, 278.2831f) - vLocal_305};
		vLocal_319[1 /*3*/] = {vLocal_319[0 /*3*/]};
		vLocal_319[iLocal_290 /*3*/] = {-Vector(0f, 62.7f, 54.673f)};
	...
	default:
		...
		vLocal_309[1 /*3*/] = {gameplay::get_random_float_in_range(-10f, 10f),
							   gameplay::get_random_float_in_range(-10f, 10f), 0f};
		vLocal_319[0 /*3*/] = {0f, 0f, 0f};
		vLocal_319[1 /*3*/] = {0f, 0f, 0f};
		vLocal_319[iLocal_290 /*3*/] = {0f, 0f, 0f};
		fLocal_332[0] = gameplay::get_random_float_in_range(-180f, 180f);
		fLocal_332[1] = gameplay::get_random_float_in_range(-180f, 180f);
		fLocal_336[0] = 0f;
		fLocal_336[1] = 0f;
...
int func_131(int iParam0, char* sParam1, char* sParam2, char* sParam3, var* uParam4, var* uParam5)
{
	...
	*uParam5 = 0;
	...
	case 305: func_132(iParam0, sParam1, sParam2, sParam3); return 1;
...
// Position - 0x7A18
bool func_135(int iParam0, float *fParam1, char *sParam2) {
	vector3 vVar0;
	int iVar3;
	var *uVar4;
	float fVar7;
	...
	case 11:
		if (func_138(iParam0, &vVar0, fParam1)) {
	...
	case 9: return func_135(8, fParam1, sParam2);

	case 10: return func_135(8, fParam1, sParam2);
	...
	case 23: return func_135(208, fParam1, sParam2);
	...
	case 224: return func_135(222, fParam1, sParam2);
	...
	case 294: return func_135(293, fParam1, sParam2);

	case 295: return func_135(292, fParam1, sParam2);
	...
	case 300: return func_135(303, fParam1, sParam2);

	case 301: return func_135(303, fParam1, sParam2);

	case 302: return func_135(303, fParam1, sParam2);
...
// Position - 0x9E25
bool func_136(int iParam0, int iParam1, var *uParam2, var *uParam3) {
	switch (iParam1) {
	case 0:
		switch (iParam0) {
		case 0:
	...
	case 46: return func_136(iParam0, 26, uParam2, uParam3);
...
// Position - 0xBD93
bool func_138(int iParam0, var *uParam1, float *fParam2) {
	switch (iParam0) {
	case 11:
	...
	case 9: return func_138(8, uParam1, fParam2);

	case 10: return func_138(8, uParam1, fParam2);
...
void func_140() {
	...
	while (iVar0 < iLocal_294) {
		if (iLocal_294[iVar0] != 0) {
			streaming::set_model_as_no_longer_needed(iLocal_294[iVar0]);
		}
		iVar0++;
	}
	ped::remove_relationship_group(iLocal_303);
	if (!ai::is_scenario_type_enabled(sLocal_541)) {
		ai::set_scenario_type_enabled(sLocal_541, 1);
	}
