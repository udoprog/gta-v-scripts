...
void __EntryFunction__() {
	...
	func_564(vLocal_169, 200f, &vVar0, &vVar3);
	func_563(iLocal_580);
	func_563(iLocal_583);
	func_563(iLocal_578);
	if (func_562(0)) {
	...
	while (true) {
		...
		iLocal_214 = 0;
		iLocal_810 = 0;
		fLocal_594 += gameplay::get_frame_time();
		func_545();
		...
		func_503();
		switch (iLocal_159) {
		case -1: func_498(&iLocal_161); break;

		case 0: func_446(&iLocal_161); break;

		case 1: func_439(&iLocal_161); break;

		case 2: func_411(&iLocal_161); break;

		case 3: func_409(&iLocal_161); break;

		case 4: func_408(&iLocal_161); break;

		case 5: func_407(&iLocal_161); break;

		case 6: func_406(&iLocal_161); break;

		case 7: func_405(&iLocal_161); break;

		case 8: func_391(&iLocal_161); break;

		case 9: func_365(&iLocal_161); break;

		case 10: func_364(&iLocal_161); break;

		case 11: func_72(&iLocal_161); break;

		case 12: func_32(&iLocal_161); break;
		}
		if (func_31()) {
			if (audio::is_audio_scene_active(sLocal_344)) {
				audio::set_audio_scene_variable(
					sLocal_344, "DrugsEffect",
					system::sin(system::to_float(gameplay::get_game_timer()) / 1000f * 45f % 360f) * 0.25f + 0.25f);
			}
			func_26();
			func_1();
		}
...
void func_26() {
	if (iLocal_210) {
		if (!entity::is_entity_in_angled_area(player::player_ped_id(), Local_186[0 /*3*/], Local_186[1 /*3*/],
											  Local_186.f_7, 0, 1, 0)) {
	...
	else if (entity::is_entity_in_angled_area(player::player_ped_id(), Local_194[0 /*3*/], Local_194[1 /*3*/],
											  Local_194.f_7, 0, 1, 0)) {
		func_30("B2_PRIME", 7500, 1);
		func_29(&iLocal_212);
		iLocal_210 = 1;
	}
	else if (!entity::is_entity_in_angled_area(player::player_ped_id(), Local_178[0 /*3*/], Local_178[1 /*3*/],
											   Local_178.f_7, 0, 1, 0)) {
...
bool func_33(int iParam0) {
	...
	if (cutscene::_0xB56BBBCC2955D9CB()) {
		if (func_53(player::player_ped_id())) {
			cutscene::_0x2A56C06EBEF2B0D9("Trevor", player::player_ped_id(),
	...
	case 1:
		...
		iVar4 = cam::create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", cam::get_gameplay_cam_coord(),
											cam::get_gameplay_cam_rot(2), cam::get_gameplay_cam_fov(), 1, 2);
	...
	case 4:
		if (iParam0 == 1) {
			iVar3 = gameplay::get_game_timer() > iLocal_157;
		}
		else {
			if (gameplay::get_game_timer() < iLocal_157) {
			}
			...
			if (entity::does_entity_exist(iLocal_162)) {
				if (func_41(player::player_ped_id())) {
					entity::attach_entity_to_entity(iLocal_162, player::player_ped_id(),
													ped::get_ped_bone_index(player::player_ped_id(), 28422), 0f, 0f, 0f,
					...
					if (func_41(iLocal_162) && entity::is_entity_attached(iLocal_162)) {
						entity::detach_entity(iLocal_162, 1, 0);
					}
					iVar3 = 1;
				}
	...
	case 5:
		if (gameplay::get_game_timer() > iLocal_157) {
			if (iParam0 == 1) {
				...
				gameplay::clear_area_of_vehicles(vLocal_173, 200f, 0, 0, 0, 0, 0);
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	...
	return func_36(iParam0, iVar0, iParam1, iParam2, iParam3, iParam4, iParam5, 0, 0);
}

// Position - 0x142F
int func_36(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4, var uParam5, var uParam6, int iParam7,
			int iParam8) {
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (func_38(iVar2, iVar8) != 0) {
		if (!entity::is_entity_dead(iParam0, 0)) {
			if (weapon::has_ped_got_weapon_component(iParam0, iVar2, func_38(iVar2, iVar8))) {
				if (func_37(func_38(iVar2, iVar8))) {
					iVar9 = weapon::get_weapon_component_type_model(func_38(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_38(iVar2, iVar8) != 0) {
		if (!entity::is_entity_dead(iParam0, 0)) {
			if (weapon::has_ped_got_weapon_component(iParam0, iVar2, func_38(iVar2, iVar8))) {
				weapon::give_weapon_component_to_weapon_object(iVar1, func_38(iVar2, iVar8));
			}
		}
		iVar8++;
	}
	...
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_49(player::player_id()) &&
				!func_46(player::player_id(), 0) && !func_45()) {
				entity::set_entity_invincible(player::player_ped_id(), 0);
			}
		}
		else if (!ped::is_ped_injured(player::player_ped_id()) && !func_49(player::player_id())) {
			entity::set_entity_invincible(player::player_ped_id(), 0);
		}
		Global_69700 = 0;
	}
...
// Position - 0x244A
bool func_45() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x24F3
var func_48() { return Global_1312735; }
...
// Position - 0x2541
bool func_50() { return gameplay::is_bit_set(Global_2359301, 3); }
...
// Position - 0x2690
void func_56(vector3 vParam0, float *fParam3) { func_57(&Global_96040.f_2311, vParam0, fParam3); }

// Position - 0x26A9
void func_57(var *uParam0, vector3 vParam1, var uParam4) {
	*uParam0 = {vParam1};
	uParam0->f_6 = uParam4;
}
...
// Position - 0x26EB
bool func_59(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
	...
	if (func_53(player::player_ped_id())) {
		...
		while (iVar0 < Local_346) {
			if (func_69(&Local_346[iVar0 /*19*/])) {
				...
				ai::task_smart_flee_coord(Local_346[iVar0 /*19*/].f_3,
										  entity::get_entity_coords(player::player_ped_id(), 1), 400f, -1, 0, 0);
			}
			iVar0++;
		}
	}
...
// Position - 0x296B
void func_71(int iParam0, int iParam1) { func_67(iParam0, iParam1, 1, 1); }
...
void func_72(int *iParam0) {
	...
	case 0:
		func_42("bar_4_rcm", 0);
		func_362(vLocal_173, 1112014848, 12, 5000, 0, 0);
	...
	case 1:
		...
		if (func_295(1, 1093140480, 0) && script::has_script_loaded("postRC_Barry1and2")) {
			if (func_41(player::player_ped_id())) {
				ped::reset_ped_visible_damage(player::player_ped_id());
				ped::clear_ped_blood_damage(player::player_ped_id());
			}
			func_289();
			iLocal_345 = 0;
			gameplay::clear_area_of_vehicles(vLocal_173, 250f, 0, 0, 0, 0, 0);
			gameplay::clear_area_of_peds(vLocal_173, 50f, 0);
			gameplay::clear_area_of_objects(vLocal_173, 30f, 0);
			graphics::remove_decals_in_range(vLocal_173, 500f);
			cutscene::register_entity_for_cutscene(0, sLocal_335, 2, func_620(49), 0);
			...
			streaming::_0xEF39EE20C537E98C(183.434f, -949.1876f, 30.8535f, func_285(-3f, 0f, 72.9999f));
			*iParam0 = 2;
		}
		break;
	...
	case 2:
		...
		if (!cutscene::is_cutscene_playing()) {
			...
			*iParam0 = 4;
			...
			if (iVar0 > 15000) {
				if (func_281(player::player_ped_id(), 10000, 0)) {
				}
			}
			if (!iLocal_345) {
			...
			if (cutscene::can_set_exit_state_for_registered_entity("Trevor", 0)) {
				func_280(player::player_ped_id(), 180.1684f, -948.6075f, 29.0919f);
			...
			if (!func_53(Local_96.f_28[0])) {
				if (entity::does_entity_exist(cutscene::get_entity_index_of_registered_entity(sLocal_335, 0))) {
					Local_96.f_28[0] = entity::get_ped_index_from_entity_index(
						cutscene::get_entity_index_of_registered_entity(sLocal_335, 0));
			...
			if (!func_53(Local_96.f_41[0])) {
				if (entity::does_entity_exist(cutscene::get_entity_index_of_registered_entity(sLocal_337, 0))) {
					Local_96.f_41[0] = entity::get_object_index_from_entity_index(
						cutscene::get_entity_index_of_registered_entity(sLocal_337, 0));
				}
			}
			if (!func_53(Local_96.f_41[1])) {
				if (entity::does_entity_exist(cutscene::get_entity_index_of_registered_entity(sLocal_336, 0))) {
					Local_96.f_41[1] = entity::get_object_index_from_entity_index(
						cutscene::get_entity_index_of_registered_entity(sLocal_336, 0));
				}
			}
			if (cutscene::can_set_enter_state_for_registered_entity(sLocal_337, 0)) {
				if (func_53(Local_96.f_41[0]) && func_53(Local_96.f_41[2])) {
					entity::attach_entity_to_entity(Local_96.f_41[2], Local_96.f_41[0], 0, 0f, -0.25f, 0f, 0f, 0f, 0f,
													0, 0, 0, 0, 2, 1);
				}
			}
		}
	...
	case 3:
		...
		func_54(1, 1, 1, 1);
		func_280(player::player_ped_id(), vLocal_173);
...
void func_73() {
	...
	if (func_53(player::player_ped_id())) {
		func_266(player::player_ped_id(), 1, 0);
	}
...
// Position - 0x3AD2
void func_90() { func_91(&Global_96040); }
...
// Position - 0x4222
void func_97(int *iParam0) { *iParam0 = -15; }
...
int func_101(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam1 == 12) {
		...
		if (ped::get_number_of_ped_drawable_variations(iParam0, func_144(iParam1)) > 0 &&
			ped::get_number_of_ped_texture_variations(iParam0, func_144(iParam1), Global_69523[1 /*14*/].f_3) > 0) {
			ped::set_ped_component_variation(iParam0, func_144(iParam1), Global_69523[1 /*14*/].f_3,
...
// Position - 0x460A
int func_104(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	if (iParam1 == 12) {
				...
				if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0)) {
					if (iVar0 == 13) {
						...
						while (iVar1 <= 8) {
							...
							func_120(iParam0, Global_69523[1 /*14*/].f_12, Global_69523[1 /*14*/].f_3,
						...
						if (iParam4 == -1) {
							ped::set_ped_component_variation(iParam0, func_144(iVar0), Global_69523[1 /*14*/].f_3,
															 Global_69523[1 /*14*/].f_4,
															 ped::get_ped_palette_variation(iParam0, func_144(iVar0)));
						}
						else {
							ped::set_ped_component_variation(iParam0, func_144(iVar0), Global_69523[1 /*14*/].f_3,
		...
		if (iParam4 == -1) {
			ped::set_ped_component_variation(iParam0, func_144(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4,
											 ped::get_ped_palette_variation(iParam0, func_144(iParam1)));
		}
		else {
			ped::set_ped_component_variation(iParam0, func_144(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4, iParam4);
...
// Position - 0x4FA8
bool func_108(int iParam0, int iParam1, int iParam2, int iParam3, var *uParam4, var *uParam5) {
	var uVar0;
	int iVar10;
...
// Position - 0x59ED
var func_112(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
...
void func_120(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == -1) {
		...
		if (iParam1 == 0) {
			...
			if (func_121(entity::get_entity_model(iParam0), 14, iVar0,
...
int func_122(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == 12) {
		...
		iVar41 = dlc1::_get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_144(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41) {
		...
		if (iVar4 != iParam1) {
			...
			while (iVar5 <= iVar6 - 1) {
				if (iVar4 == iParam1 && iVar5 == iParam2) {
					iVar3 += func_126(iParam0, iParam3);
					return iVar3;
				}
				else {
					iVar3++;
...
int func_127(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == 12) {
		...
		iVar38 = 0;
		iVar39 = dlc1::_get_num_props_from_outfit(iParam3, 6, -1, 0, -1, func_144(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39) {
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_122(iParam0, iParam2, 14, 3), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_122(iParam0, iParam2, 1, 3), -1842686353, 0);
			}
			break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_122(iParam0, iParam2, 14, 4), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_122(iParam0, iParam2, 1, 4), -1842686353, 0);
			}
			break;
		}
		break;
...
void func_136(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_140(iParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3)) {
...
struct<10> func_145(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		switch (iParam1) {
		case 31: func_147(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 0: func_147(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_147(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_147(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_147(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_147(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8); break;

		case 5: func_147(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8); break;

		case 6: func_147(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_147(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_147(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_147(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8); break;

		default: func_146(&Var1, iParam0, iParam1, 10); break;
		}
		break;
	...
	case joaat("player_one"):
		...
		case 1: func_147(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8); break;

		case 2: func_147(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8); break;

		case 3: func_147(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_147(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_147(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_147(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_147(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_147(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_146(&Var1, iParam0, iParam1, 9); break;
		}
		break;
	...
	case joaat("player_two"):
		...
		case 0: func_147(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_147(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_147(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_147(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8); break;

		case 4: func_147(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8); break;

		case 5: func_147(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_147(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_147(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_147(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8); break;
	...
	case joaat("mp_m_freemode_01"):
		...
		case 0: func_147(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_147(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_147(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_147(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_147(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_147(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_147(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_147(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_147(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_147(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_147(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_147(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_147(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_147(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 14: func_147(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_147(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_147(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_147(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_147(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_147(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_147(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_147(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_147(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_147(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 24: func_147(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_146(&Var1, iParam0, iParam1, 25); break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 0: func_147(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_147(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_147(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_147(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_147(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_147(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_147(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_147(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_147(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_147(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_147(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_147(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_147(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_147(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8); break;

		case 14: func_147(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_147(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_147(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_147(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_147(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_147(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_147(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_147(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_147(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_147(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8); break;
...
// Position - 0xB5F2
void func_147(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
struct<17> func_148(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		...
		case 1: func_151(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0); break;

		case 2: func_151(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8); break;

		case 3: func_151(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31); break;

		case 4: func_151(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2); break;

		case 5:
			func_151(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[0], Global_101700.f_2095.f_539.f_200[0], 6, 3, 0,
					 0, 0, -99, 0, 0, 3);
			break;

		case 6: func_151(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_151(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 8: func_151(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 9: func_151(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 10: func_151(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4); break;

		case 11: func_151(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5); break;

		case 12: func_151(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31); break;

		case 13: func_151(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 14: func_151(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6); break;

		case 15: func_151(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31); break;

		case 16: func_151(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31); break;

		case 17: func_151(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 18: func_151(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7); break;

		case 19: func_151(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 20: func_151(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 21: func_151(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_151(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 23: func_151(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31); break;

		case 24: func_151(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31); break;

		case 25: func_151(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 26: func_151(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 27: func_151(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 28: func_151(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 29: func_151(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 30: func_151(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 31: func_151(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31); break;

		case 32: func_151(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 33: func_151(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 34: func_151(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31); break;

		case 35: func_151(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 36: func_151(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 37: func_151(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 38: func_151(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 39: func_151(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 40: func_151(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 41: func_151(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_151(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_151(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_151(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 45: func_151(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 46: func_151(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_151(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 48: func_151(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31); break;

		case 49: func_151(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 50: func_151(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9); break;

		case 51: func_151(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 52: func_151(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		default: func_149(&Var1, iParam0, iParam1, 53); break;
		}
		break;

	case joaat("player_one"):
		switch (iParam1) {
		case 0: func_151(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 1: func_151(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 2:
			func_151(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[1], Global_101700.f_2095.f_539.f_200[1], 17, 2,
					 26, 0, 0, -99, 0, 45, 31);
			break;

		case 3: func_151(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1); break;

		case 4: func_151(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2); break;

		case 5: func_151(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 6: func_151(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_151(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3); break;

		case 8: func_151(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5); break;

		case 9: func_151(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 10: func_151(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 11: func_151(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 12: func_151(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 13: func_151(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 14: func_151(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 15: func_151(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 16: func_151(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 17: func_151(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 18: func_151(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31); break;

		case 19: func_151(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 20: func_151(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 21: func_151(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4); break;

		case 22: func_151(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31); break;

		case 23: func_151(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31); break;

		case 24: func_151(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31); break;

		case 25: func_151(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31); break;

		case 26: func_151(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31); break;

		case 27: func_151(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31); break;

		case 28: func_151(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31); break;

		case 29: func_151(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31); break;

		case 30: func_151(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31); break;

		case 31: func_151(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31); break;

		case 32: func_151(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31); break;

		case 33: func_151(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31); break;

		case 34: func_151(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31); break;

		case 35: func_151(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31); break;

		case 36: func_151(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31); break;

		case 37: func_151(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31); break;

		case 38: func_151(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 39: func_151(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 40: func_151(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 41: func_151(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 42: func_151(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31); break;

		case 43: func_151(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6); break;

		case 44: func_151(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 45: func_151(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8); break;

		case 46: func_151(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31); break;

		default: func_149(&Var1, iParam0, iParam1, 47); break;
		}
		break;

	case joaat("player_two"):
		switch (iParam1) {
		case 0: func_151(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 1: func_151(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8); break;

		case 2: func_151(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1); break;

		case 3: func_151(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2); break;

		case 4:
			func_151(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[2], Global_101700.f_2095.f_539.f_200[2], 8, 0, 0,
					 0, 0, -99, 0, 0, 31);
			break;

		case 5: func_151(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6); break;

		case 6: func_151(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3); break;

		case 7: func_151(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4); break;

		case 8: func_151(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31); break;

		case 9: func_151(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 10: func_151(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 11: func_151(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5); break;

		case 12: func_151(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 13: func_151(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31); break;

		case 14: func_151(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31); break;

		case 15: func_151(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 16: func_151(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 17: func_151(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 18: func_151(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 19: func_151(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 20: func_151(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 21: func_151(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_151(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 23: func_151(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 24: func_151(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 25: func_151(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 26: func_151(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 27: func_151(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 28: func_151(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 29: func_151(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 30: func_151(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 31: func_151(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 32: func_151(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 33: func_151(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 34: func_151(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 35: func_151(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 36: func_151(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 37: func_151(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 38: func_151(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 39: func_151(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 40: func_151(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 41: func_151(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_151(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_151(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_151(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31); break;

		case 45: func_151(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 46: func_151(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_151(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31); break;

		default: func_149(&Var1, iParam0, iParam1, 48); break;
		}
		break;

	case joaat("mp_m_freemode_01"):
		switch (iParam1) {
		case 0: func_151(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31); break;

		case 1: func_151(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0); break;

		case 2: func_151(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1); break;

		case 3: func_151(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2); break;

		case 4: func_151(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3); break;

		case 5: func_151(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4); break;

		case 6: func_151(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5); break;

		case 7: func_151(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6); break;

		case 8: func_151(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7); break;

		case 9: func_151(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8); break;

		case 10: func_151(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9); break;

		case 11: func_151(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10); break;

		case 12: func_151(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11); break;

		case 13: func_151(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12); break;

		case 14: func_151(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13); break;

		case 15: func_151(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14); break;

		case 16: func_151(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15); break;

		case 17: func_151(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16); break;

		case 18: func_151(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17); break;

		case 19: func_151(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18); break;

		case 20: func_151(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19); break;

		case 21: func_151(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20); break;

		case 22: func_151(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21); break;

		case 23: func_151(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22); break;

		case 24: func_151(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23); break;

		case 25: func_151(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24); break;

		default: func_149(&Var1, iParam0, iParam1, 26); break;
		}
		break;

	case joaat("mp_f_freemode_01"):
		switch (iParam1) {
		case 0: func_151(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31); break;

		case 1: func_151(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31); break;

		case 2: func_151(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0); break;

		case 3: func_151(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1); break;

		case 4: func_151(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2); break;

		case 5: func_151(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3); break;

		case 6: func_151(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4); break;

		case 7: func_151(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5); break;

		case 8: func_151(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6); break;

		case 9: func_151(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7); break;

		case 10: func_151(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8); break;

		case 11: func_151(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9); break;

		case 12: func_151(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10); break;

		case 13: func_151(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31); break;

		case 14: func_151(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11); break;

		case 15: func_151(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12); break;

		case 16: func_151(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13); break;

		case 17: func_151(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14); break;

		case 18: func_151(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15); break;

		case 19: func_151(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16); break;

		case 20: func_151(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17); break;

		case 21: func_151(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31); break;

		case 22: func_151(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18); break;

		case 23: func_151(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19); break;

		case 24: func_151(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20); break;

		case 25: func_151(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21); break;

		case 26: func_151(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22); break;

		case 27: func_151(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23); break;

		default: func_149(&Var1, iParam0, iParam1, 28); break;
		}
		break;
	}
	return Var1;
			...
			if (dlc1::_get_prop_from_outfit(Var1.f_1, iVar36, &vVar16)) {
				if (vVar16.x != 0 && vVar16.x != -1 && vVar16.x != 1849449579) {
					...
					if (vVar16.z == 10 && uParam0->f_16) {
						(*uParam0)[func_150(vVar16.z)] = vVar16.x;
						uParam0->f_16 = 1;
					}
					else {
						(*uParam0)[func_150(vVar16.z)] = func_127(iParam1, vVar16.x, func_150(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1) {
					(*uParam0)[func_150(vVar16.z)] = vVar16.y;
				}
			}
			iVar36++;
		}
...
// Position - 0xD71D
void func_151(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) {
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
void func_154(int iParam0) {
	...
	func_155(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

// Position - 0xEB46
void func_155(var *uParam0, int iParam1, int iParam2, char *sParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	*uParam0 = iParam9;
	...
	if (iParam10) {
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 ||
			...
			iVar0 = func_139(func_158(iParam1, uParam0->f_2), Global_69521, 0);
...
void func_161(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 == 12) {
		...
		while (iVar38 < iVar40) {
			...
			if (!dlc1::_is_dlc_data_empty(Var20)) {
				if (iVar39 == iParam1 - iParam2) {
					...
					func_155(&Global_69523[0 /*14*/], iParam0, iParam1, &Var20.f_9, Var20.f_3, Var20.f_4, Var20.f_5,
		...
		iVar59 = 0;
		iVar60 = dlc1::_get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_144(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60) {
			...
			if (!dlc1::_is_dlc_data_empty(Var41)) {
				if (iVar59 == iParam1 - iParam2) {
					...
					func_155(&Global_69523[0 /*14*/], iParam0, iParam1, &Var41.f_9, Var41.f_3, Var41.f_4, Var41.f_5,
...
bool func_216(int iParam0, int iParam1, int iParam2) {
	...
	else if (Global_69523[1 /*14*/].f_3 == ped::get_ped_drawable_variation(iParam0, func_144(iParam1)) &&
			 Global_69523[1 /*14*/].f_4 == ped::get_ped_texture_variation(iParam0, func_144(iParam1))) {
		return true;
	}
	return false;
}
...
void func_223(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 != -1) {
		...
		func_224(&sVar32, Var0.f_3, Global_91528, iParam1, iParam2);
	}
}

// Position - 0x2192D
void func_224(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
...
void func_225(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_226(uParam1, "Abigail1", func_219(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				 "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_227(iParam0), 1, 0);
		break;

	case 1:
		func_226(uParam1, "Abigail2", func_219(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				 -1, 4, 1, 0, 2359, func_227(iParam0), 1, 0);
		break;

	case 2:
		func_226(uParam1, "Barry1", func_219(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				 4, 1, 0, 2359, func_227(iParam0), 1, 0);
		break;

	case 3:
		func_226(uParam1, "Barry2", func_219(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				 4, 4, 0, 2359, func_227(iParam0), 1, 1);
		break;

	case 4:
		func_226(uParam1, "Barry3", func_219(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2,
				 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 5:
		func_226(uParam1, "Barry3A", func_219(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0,
				 "", 166, 0, 7, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 6:
		func_226(uParam1, "Barry3C", func_219(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				 7, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 7:
		func_226(uParam1, "Barry4", func_219(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0,
				 "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_227(iParam0), 0, 0);
		break;

	case 8:
		func_226(uParam1, "Dreyfuss1", func_219(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				 0, "", 0, 0, -1, 4, 2, 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 9:
		func_226(uParam1, "Epsilon1", func_219(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1,
				 10, 4, 1, 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 10:
		func_226(uParam1, "Epsilon2", func_219(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0,
				 11, 4, 1, 0, 2359, func_227(iParam0), 1, 0);
		break;

	case 11:
		func_226(uParam1, "Epsilon3", func_219(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				 0, 0, 12, 4, 1, 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 12:
		func_226(uParam1, "Epsilon4", func_219(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				 "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 13:
		func_226(uParam1, "Epsilon5", func_219(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16,
				 "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_227(iParam0), 1, 0);
		break;

	case 14:
		func_226(uParam1, "Epsilon6", func_219(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 15:
		func_226(uParam1, "Epsilon7", func_219(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 16:
		func_226(uParam1, "Epsilon8", func_219(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_227(iParam0), 1, 0);
		break;

	case 17:
		func_226(uParam1, "Extreme1", func_219(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 18:
		func_226(uParam1, "Extreme2", func_219(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 19:
		func_226(uParam1, "Extreme3", func_219(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 20:
		func_226(uParam1, "Extreme4", func_219(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 21:
		func_226(uParam1, "Fanatic1", func_219(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_227(iParam0), 1, 0);
		break;

	case 22:
		func_226(uParam1, "Fanatic2", func_219(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_227(iParam0), 1, 0);
		break;

	case 23:
		func_226(uParam1, "Fanatic3", func_219(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_227(iParam0), 0, 1);
		break;

	case 24:
		func_226(uParam1, "Hao1", func_219(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_227(iParam0), 0, 1);
		break;

	case 25:
		func_226(uParam1, "Hunting1", func_219(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 26:
		func_226(uParam1, "Hunting2", func_219(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 27:
		func_226(uParam1, "Josh1", func_219(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_227(iParam0), 1, 0);
		break;

	case 28:
		func_226(uParam1, "Josh2", func_219(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_227(iParam0), 1, 1);
		break;

	case 29:
		func_226(uParam1, "Josh3", func_219(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_227(iParam0), 1, 1);
		break;

	case 30:
		func_226(uParam1, "Josh4", func_219(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_227(iParam0), 1, 0);
		break;

	case 31:
		func_226(uParam1, "Maude1", func_219(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 32:
		func_226(uParam1, "Minute1", func_219(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 33:
		func_226(uParam1, "Minute2", func_219(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 34:
		func_226(uParam1, "Minute3", func_219(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 35:
		func_226(uParam1, "MrsPhilips1", func_219(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 36:
		func_226(uParam1, "MrsPhilips2", func_219(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_227(iParam0), 0, 0);
		break;

	case 37:
		func_226(uParam1, "Nigel1", func_219(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_227(iParam0), 1, 0);
		break;

	case 38:
		func_226(uParam1, "Nigel1A", func_219(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_227(iParam0), 1, 1);
		break;

	case 39:
		func_226(uParam1, "Nigel1B", func_219(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_227(iParam0), 1, 1);
		break;

	case 40:
		func_226(uParam1, "Nigel1C", func_219(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_227(iParam0), 1, 1);
		break;

	case 41:
		func_226(uParam1, "Nigel1D", func_219(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_227(iParam0), 1, 1);
		break;

	case 42:
		func_226(uParam1, "Nigel2", func_219(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_227(iParam0), 1, 1);
		break;

	case 43:
		func_226(uParam1, "Nigel3", func_219(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_227(iParam0), 1, 1);
		break;

	case 44:
		func_226(uParam1, "Omega1", func_219(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 45:
		func_226(uParam1, "Omega2", func_219(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 46:
		func_226(uParam1, "Paparazzo1", func_219(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 47:
		func_226(uParam1, "Paparazzo2", func_219(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 48:
		func_226(uParam1, "Paparazzo3", func_219(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 49:
		func_226(uParam1, "Paparazzo3A", func_219(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 50:
		func_226(uParam1, "Paparazzo3B", func_219(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 51:
		func_226(uParam1, "Paparazzo4", func_219(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 52:
		func_226(uParam1, "Rampage1", func_219(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 54:
		func_226(uParam1, "Rampage3", func_219(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_227(iParam0), 1, 0);
		break;

	case 55:
		func_226(uParam1, "Rampage4", func_219(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_227(iParam0), 1, 0);
		break;

	case 56:
		func_226(uParam1, "Rampage5", func_219(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_227(iParam0), 0, 0);
		break;

	case 53:
		func_226(uParam1, "Rampage2", func_219(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_227(iParam0), 1, 0);
		break;

	case 57:
		func_226(uParam1, "TheLastOne", func_219(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 58:
		func_226(uParam1, "Tonya1", func_219(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 59:
		func_226(uParam1, "Tonya2", func_219(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
		break;

	case 60:
		func_226(uParam1, "Tonya3", func_219(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_227(iParam0), 0, 1);
		break;

	case 61:
		func_226(uParam1, "Tonya4", func_219(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_227(iParam0), 0, 1);
		break;

	case 62:
		func_226(uParam1, "Tonya5", func_219(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_227(iParam0), 0, 1);
		break;
...
// Position - 0x22AE5
void func_226(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
// Position - 0x22EBC
void func_228(int iParam0) { Global_36332 = gameplay::get_game_timer() + iParam0; }

// Position - 0x22ECE
void func_229() {
	if (Global_89136) {
		func_10();
		graphics::_0xBF59707B3E5ED531(func_230(Global_101700.f_2095.f_539.f_3549));
	}
	else {
...
// Position - 0x2351B
int func_238() { return Global_101700.f_8975.f_21 + Global_101700.f_17533.f_380; }
...
void func_241(int iParam0) {
	switch (iParam0) {
	case 30: func_245(22, 1, 0, 1, 0); break;

	case 15: func_242(37, 0); break;
...
void func_245(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	if (iParam0 != 198) {
		...
		func_248(iParam0, iParam3, iParam4, 0);
...
// Position - 0x23AEB
bool func_248(int iParam0, bool bParam1, int iParam2, int iParam3) {
	bool bVar0;
	int iVar1;
	int iVar2;
	struct<5> Var3;
...
// Position - 0x2442C
int func_250() { return Global_25191; }
...
void func_253(int iParam0, bool bParam1) {
	switch (iParam0) {
	case 46: func_254(4, bParam1); break;

	case 16: func_254(6, bParam1); break;

	case 37: func_254(17, bParam1); break;

	case 31: func_254(16, bParam1); break;
	}
}
...
// Position - 0x27CD6
void func_255(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8) {
	func_256(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

// Position - 0x27CF6
void func_256(char *sParam0, char *sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6,
...
// Position - 0x282EC
int func_264() { return func_265(script::get_this_script_name(), 0); }
...
void func_266(int iParam0, int iParam1, int iParam2) {
	...
	if (func_11(iVar0) && !ped::is_ped_injured(iParam0)) {
		func_267(iParam0, &Global_101700.f_2095.f_539.f_298[iVar0 /*284*/], iParam1);
		iVar1 = 0;
		while (iVar1 <= 8 - 1) {
			ui::_0x72C1056D678BB7D8(Global_101700.f_2095.f_539.f_1151[iVar1 /*4*/][iVar0]);
			if (iParam2) {
				if (iVar1 == Global_101700.f_2095.f_539.f_1184 ||
					Global_101700.f_2095.f_539.f_1184 == -1 && iVar1 == 4) {
					if (Global_101700.f_2095.f_539.f_1151[iVar1 /*4*/][iVar0] != 0 &&
						Global_101700.f_2095.f_539.f_1151[iVar1 /*4*/][iVar0] != joaat("weapon_molotov")) {
						if (weapon::has_ped_got_weapon(iParam0, Global_101700.f_2095.f_539.f_1151[iVar1 /*4*/][iVar0],
													   0)) {
							weapon::set_current_ped_weapon(iParam0,
														   Global_101700.f_2095.f_539.f_1151[iVar1 /*4*/][iVar0], 1);
						}
					}
				}
			}
...
void func_267(int iParam0, var *uParam1, bool bParam2) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		while (iVar7 < 2) {
			...
			iVar8 = 0;
			while (iVar8 < dlc1::get_num_dlc_weapons()) {
				if (dlc1::get_dlc_weapon_data(iVar8, &Var9)) {
					if (!dlc1::_is_dlc_data_empty(Var9) && !func_268(Var9.f_1)) {
						if (iVar7 == 0) {
				...
				if (iVar3 != 0) {
					if (iVar3 != joaat("weapon_unarmed")) {
						...
						while (iVar6 >= 20 && iVar6 < 32 && iVar3 != joaat("weapon_petrolcan")) {
							if (gameplay::is_bit_set((*uParam1)[iVar5 /*3*/].f_2, iVar6) &&
								weapon::has_ped_got_weapon(iParam0, iVar3, 0)) {
				...
				if (!bParam2) {
					if (iVar2 != 0 && iVar2 != joaat("weapon_unarmed")) {
						if (weapon::get_ammo_in_ped_weapon(iParam0, iVar2) < iVar71[iVar5]) {
							weapon::set_ped_ammo(iParam0, iVar2, iVar71[iVar5], 0);
						}
					}
				}
			}
				...
				if (iVar3 != 0) {
					if (iVar3 != joaat("weapon_unarmed")) {
						...
						while (iVar6 >= 20 && iVar6 < 32) {
							if (gameplay::is_bit_set(uParam1->f_133[iVar70 /*3*/].f_2, iVar6) &&
								weapon::has_ped_got_weapon(iParam0, iVar3, 0)) {
								weapon::set_ped_weapon_tint_index(iParam0, iVar3, iVar6 - 20);
								iVar6 = 0;
							}
				...
				if (!bParam2) {
					if (iVar3 != 0 && iVar3 != joaat("weapon_unarmed")) {
						if (weapon::get_ammo_in_ped_weapon(iParam0, iVar3) < iVar116[iVar8]) {
							weapon::set_ped_ammo(iParam0, iVar3, iVar116[iVar8], 0);
						}
					}
				}
			}
		...
		if (weapon::get_current_ped_weapon(iParam0, &iVar2, 1) && iVar2 != 0 && iVar2 != joaat("weapon_unarmed") &&
			iVar2 != joaat("object")) {
...
bool func_269(int iParam0) {
	...
	if (iParam0 == -61829581) {
		if (network::network_is_game_in_progress() && func_272()) {
			return true;
		}
		else {
			return false;
	...
	case joaat("weapon_railgun"):
		if (!func_270() || network::network_is_game_in_progress()) {
			return false;
		}
		break;
	...
	case joaat("weapon_knuckle"):
	case joaat("weapon_marksmanpistol"): break;
	}
	iVar0 = 0;
	while (iVar0 < dlc1::get_num_dlc_weapons()) {
		if (dlc1::get_dlc_weapon_data(iVar0, &Var1)) {
			if (Var1.f_1 == iParam0) {
				if (dlc1::_is_dlc_data_empty(Var1) || func_268(Var1.f_1)) {
					return false;
				}
			}
		}
...
// Position - 0x28E67
var func_272() { return dlc2::is_dlc_present(-1691188696); }
...
void func_274(var *uParam0) {
	...
	while (iVar0 < 3) {
		...
		iVar1 = 0;
		while (iVar1 < 50) {
			Global_101700.f_2095.f_539.f_298[iVar0 /*284*/].f_133[iVar1 /*3*/] = {
				uParam0->f_812[iVar0 /*284*/].f_133[iVar1 /*3*/]};
			iVar1++;
		}
		iVar0++;
	}
...
void func_275(var *uParam0) {
	...
	while (iVar0 < 3) {
		switch (iVar0) {
		case 0:
			stats::stat_set_int(joaat("sp0_weap_purch_0"), uParam0->f_1665[iVar0 /*32*/][0], 1);
			stats::stat_set_int(joaat("sp0_weap_purch_1"), uParam0->f_1665[iVar0 /*32*/][1], 1);
			stats::stat_set_int(joaat("sp0_weap_addon_purch_0"), uParam0->f_1665[iVar0 /*32*/].f_5[0], 1);
			stats::stat_set_int(joaat("sp0_weap_addon_purch_1"), uParam0->f_1665[iVar0 /*32*/].f_5[1], 1);
			stats::stat_set_int(joaat("sp0_weap_addon_purch_2"), uParam0->f_1665[iVar0 /*32*/].f_5[2], 1);
			stats::stat_set_int(joaat("sp0_weap_addon_purch_3"), uParam0->f_1665[iVar0 /*32*/].f_5[3], 1);
			stats::stat_set_int(joaat("sp0_weap_addon_purch_4"), uParam0->f_1665[iVar0 /*32*/].f_5[4], 1);
			stats::stat_set_int(joaat("sp0_weap_tint_purch_0"), uParam0->f_1665[iVar0 /*32*/].f_16[0], 1);
			stats::stat_set_int(joaat("sp0_weap_tint_purch_1"), uParam0->f_1665[iVar0 /*32*/].f_16[1], 1);
			stats::stat_set_int(joaat("sp0_weap_tint_purch_2"), uParam0->f_1665[iVar0 /*32*/].f_16[2], 1);
			stats::stat_set_int(joaat("sp0_weap_tint_purch_3"), uParam0->f_1665[iVar0 /*32*/].f_16[3], 1);
			stats::stat_set_int(joaat("sp0_weap_tint_purch_4"), uParam0->f_1665[iVar0 /*32*/].f_16[4], 1);
			stats::stat_set_int(joaat("sp0_weap_tint_purch_5"), uParam0->f_1665[iVar0 /*32*/].f_16[5], 1);
			stats::stat_set_int(joaat("sp0_weap_tint_purch_6"), uParam0->f_1665[iVar0 /*32*/].f_16[6], 1);
			stats::stat_set_int(joaat("sp0_weap_tint_purch_7"), uParam0->f_1665[iVar0 /*32*/].f_16[7], 1);
			stats::stat_set_int(joaat("sp0_weap_tint_purch_8"), uParam0->f_1665[iVar0 /*32*/].f_16[8], 1);
			stats::stat_set_int(joaat("sp0_weap_tint_purch_9"), uParam0->f_1665[iVar0 /*32*/].f_16[9], 1);
			stats::stat_set_int(joaat("sp0_weap_tint_purch_10"), uParam0->f_1665[iVar0 /*32*/].f_16[10], 1);
			stats::stat_set_int(joaat("sp0_weap_tint_purch_11"), uParam0->f_1665[iVar0 /*32*/].f_16[11], 1);
			break;

		case 1:
			stats::stat_set_int(joaat("sp1_weap_purch_0"), uParam0->f_1665[iVar0 /*32*/][0], 1);
			stats::stat_set_int(joaat("sp1_weap_purch_1"), uParam0->f_1665[iVar0 /*32*/][1], 1);
			stats::stat_set_int(joaat("sp1_weap_addon_purch_0"), uParam0->f_1665[iVar0 /*32*/].f_5[0], 1);
			stats::stat_set_int(joaat("sp1_weap_addon_purch_1"), uParam0->f_1665[iVar0 /*32*/].f_5[1], 1);
			stats::stat_set_int(joaat("sp1_weap_addon_purch_2"), uParam0->f_1665[iVar0 /*32*/].f_5[2], 1);
			stats::stat_set_int(joaat("sp1_weap_addon_purch_3"), uParam0->f_1665[iVar0 /*32*/].f_5[3], 1);
			stats::stat_set_int(joaat("sp1_weap_addon_purch_4"), uParam0->f_1665[iVar0 /*32*/].f_5[4], 1);
			stats::stat_set_int(joaat("sp1_weap_tint_purch_0"), uParam0->f_1665[iVar0 /*32*/].f_16[0], 1);
			stats::stat_set_int(joaat("sp1_weap_tint_purch_1"), uParam0->f_1665[iVar0 /*32*/].f_16[1], 1);
			stats::stat_set_int(joaat("sp1_weap_tint_purch_2"), uParam0->f_1665[iVar0 /*32*/].f_16[2], 1);
			stats::stat_set_int(joaat("sp1_weap_tint_purch_3"), uParam0->f_1665[iVar0 /*32*/].f_16[3], 1);
			stats::stat_set_int(joaat("sp1_weap_tint_purch_4"), uParam0->f_1665[iVar0 /*32*/].f_16[4], 1);
			stats::stat_set_int(joaat("sp1_weap_tint_purch_5"), uParam0->f_1665[iVar0 /*32*/].f_16[5], 1);
			stats::stat_set_int(joaat("sp1_weap_tint_purch_6"), uParam0->f_1665[iVar0 /*32*/].f_16[6], 1);
			stats::stat_set_int(joaat("sp1_weap_tint_purch_7"), uParam0->f_1665[iVar0 /*32*/].f_16[7], 1);
			stats::stat_set_int(joaat("sp1_weap_tint_purch_8"), uParam0->f_1665[iVar0 /*32*/].f_16[8], 1);
			stats::stat_set_int(joaat("sp1_weap_tint_purch_9"), uParam0->f_1665[iVar0 /*32*/].f_16[9], 1);
			stats::stat_set_int(joaat("sp1_weap_tint_purch_10"), uParam0->f_1665[iVar0 /*32*/].f_16[10], 1);
			stats::stat_set_int(joaat("sp1_weap_tint_purch_11"), uParam0->f_1665[iVar0 /*32*/].f_16[11], 1);
			break;

		case 2:
			stats::stat_set_int(joaat("sp2_weap_purch_0"), uParam0->f_1665[iVar0 /*32*/][0], 1);
			stats::stat_set_int(joaat("sp2_weap_purch_1"), uParam0->f_1665[iVar0 /*32*/][1], 1);
			stats::stat_set_int(joaat("sp2_weap_addon_purch_0"), uParam0->f_1665[iVar0 /*32*/].f_5[0], 1);
			stats::stat_set_int(joaat("sp2_weap_addon_purch_1"), uParam0->f_1665[iVar0 /*32*/].f_5[1], 1);
			stats::stat_set_int(joaat("sp2_weap_addon_purch_2"), uParam0->f_1665[iVar0 /*32*/].f_5[2], 1);
			stats::stat_set_int(joaat("sp2_weap_addon_purch_3"), uParam0->f_1665[iVar0 /*32*/].f_5[3], 1);
			stats::stat_set_int(joaat("sp2_weap_addon_purch_4"), uParam0->f_1665[iVar0 /*32*/].f_5[4], 1);
			stats::stat_set_int(joaat("sp2_weap_tint_purch_0"), uParam0->f_1665[iVar0 /*32*/].f_16[0], 1);
			stats::stat_set_int(joaat("sp2_weap_tint_purch_1"), uParam0->f_1665[iVar0 /*32*/].f_16[1], 1);
			stats::stat_set_int(joaat("sp2_weap_tint_purch_2"), uParam0->f_1665[iVar0 /*32*/].f_16[2], 1);
			stats::stat_set_int(joaat("sp2_weap_tint_purch_3"), uParam0->f_1665[iVar0 /*32*/].f_16[3], 1);
			stats::stat_set_int(joaat("sp2_weap_tint_purch_4"), uParam0->f_1665[iVar0 /*32*/].f_16[4], 1);
			stats::stat_set_int(joaat("sp2_weap_tint_purch_5"), uParam0->f_1665[iVar0 /*32*/].f_16[5], 1);
			stats::stat_set_int(joaat("sp2_weap_tint_purch_6"), uParam0->f_1665[iVar0 /*32*/].f_16[6], 1);
			stats::stat_set_int(joaat("sp2_weap_tint_purch_7"), uParam0->f_1665[iVar0 /*32*/].f_16[7], 1);
			stats::stat_set_int(joaat("sp2_weap_tint_purch_8"), uParam0->f_1665[iVar0 /*32*/].f_16[8], 1);
			stats::stat_set_int(joaat("sp2_weap_tint_purch_9"), uParam0->f_1665[iVar0 /*32*/].f_16[9], 1);
			stats::stat_set_int(joaat("sp2_weap_tint_purch_10"), uParam0->f_1665[iVar0 /*32*/].f_16[10], 1);
			stats::stat_set_int(joaat("sp2_weap_tint_purch_11"), uParam0->f_1665[iVar0 /*32*/].f_16[11], 1);
			break;
		}
		iVar0++;
	}
...
void func_278(var *uParam0, int iParam1) {
	...
	fVar3 = 23.45f;
	func_279(uParam0, iParam1, vVar0, fVar3);
}

// Position - 0x2982D
void func_279(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_34(uParam0);
...
// Position - 0x29854
Vector3 func_280(int iParam0, vector3 vParam1) {
	var uVar0;
...
Vector3 func_285(vector3 vParam0) {
	return -system::sin(vParam0.z) * system::cos(vParam0.x), system::cos(vParam0.z) * system::cos(vParam0.x),
		   system::sin(vParam0.x);
}

// Position - 0x29A23
void func_286(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8,
	...
	if (player::is_player_playing(iVar0)) {
		...
		if (iParam6 == 1) {
			gameplay::clear_area_of_peds(func_287(player::get_player_index()), 50f, 0);
		}
		if (iParam7 == 1) {
...
// Position - 0x29BE1
Vector3 func_287(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }
...
void func_290() {
	if (cam::does_cam_exist(iLocal_807)) {
		cam::set_cam_active(iLocal_807, 0);
...
// Position - 0x29DA9
bool func_295(int iParam0, float fParam1, int iParam2) {
	int iVar0;
...
// Position - 0x29F34
bool func_300(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
void func_304(int iParam0, char *sParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	...
	if (iVar0 == 1) {
		...
		if (iVar1 != -1 && iVar1 != 94) {
			...
			iVar5 = func_265(script::get_this_script_name(), 1);
			if (iVar5 != -1) {
...
void func_305(int iParam0, var uParam1, int iParam2, int iParam3) {
	func_306(&Global_96040, script::get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

// Position - 0x2A2DC
void func_306(var *uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) {
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_9();
	...
	if (!ped::is_ped_injured(player::player_ped_id())) {
		...
		func_328(player::player_ped_id(), 0);
	...
	while (iVar1 < 3) {
		...
		if (iVar1 == func_327()) {
			func_323(player::player_ped_id(), &uParam0->f_616[iVar1 /*65*/], 1);
		}
		else {
			iVar0 = 0;
			while (iVar0 < 12) {
		...
		if (entity::does_entity_exist(Global_89155[iVar0])) {
			if (Global_89155[iVar0] == iParam0) {
				if (iParam1 == 145 || iParam1 == Global_89165[iVar0]) {
					if (iParam2 == 0 || entity::get_entity_model(iParam0) == func_315(iParam1, iParam2)) {
						return 1;
					}
				}
			}
...
// Position - 0x2BCFF
bool func_322(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
bool func_324(int iParam0, int iParam1) {
	...
	iVar0 = Global_2522581[iParam0 /*3*/][func_138(iParam1)];
...
// Position - 0x2BFAC
void func_325(int iParam0, int iParam1, int *iParam2, int *iParam3, int iParam4, int iParam5) {
	int iVar0;
...
// Position - 0x2C4F5
void func_326(int iParam0, int iParam1, int *iParam2, int *iParam3, var *uParam4, int iParam5, int iParam6) {
	int iVar0;
...
void func_329(int iParam0, var *uParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		while (iVar0 <= 44 - 1) {
			...
			if (iVar3 != 0) {
				vVar4.x = weapon::get_ped_weapontype_in_slot(iParam0, func_273(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		iVar7 = 0;
		while (iVar7 < iVar8) {
			if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_268(Var9.f_1) && iVar70 < 50) {
...
bool func_334(int *iParam0) {
	if (!entity::is_entity_dead(player::player_ped_id(), 0) && !ped::is_ped_injured(player::player_ped_id())) {
		if (func_344()) {
			*iParam0 = func_339(entity::get_entity_coords(player::player_ped_id(), 0), 6, -1, 0, 1, -1);
			if (func_338(*iParam0) && !func_335(*iParam0)) {
				return true;
			}
		}
	}
...
// Position - 0x2D76B
bool func_335(int iParam0) { return func_336(iParam0, 0, 1); }
...
bool func_336(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_78() == 0) {
			return gameplay::is_bit_set(func_139(func_337(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0x2DAA2
bool func_338(int iParam0) { return func_336(iParam0, 5, 1); }

// Position - 0x2DAB2
int func_339(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
	...
	while (iVar0 <= 45) {
		if (iParam3 == 6 || iParam3 == func_343(iVar0)) {
			if (!iParam5 || func_342(iVar0)) {
				fVar1 = gameplay::get_distance_between_coords(vParam0, func_340(iVar0, 0), 1);
...
Vector3 func_340(int iParam0, int iParam1) {
	...
	case 45: return func_341(Global_93004);
	}
...
// Position - 0x2E184
bool func_342(int iParam0) { return func_336(iParam0, 0, 0); }
...
// Position - 0x2E407
bool func_344() { return Global_91543.f_303 > 0; }

// Position - 0x2E418
var func_345() {
	int *iVar0;

	func_355(&iVar0, time::get_clock_seconds());
	func_354(&iVar0, time::get_clock_minutes());
	func_353(&iVar0, time::get_clock_hours());
	func_348(&iVar0, time::get_clock_day_of_month());
	func_347(&iVar0, time::get_clock_month());
	func_346(&iVar0, time::get_clock_year());
	return iVar0;
}
...
// Position - 0x2E646
int func_352(var uParam0) { return uParam0 & 15; }
...
int func_357(int iParam0) {
	switch (iParam0) {
	case 69:
	case 70: return func_358(Global_101700.f_8044.f_99.f_205[10]);

	case 74:
	case 75: return func_358(Global_101700.f_8044.f_99.f_205[8]);

	case 84:
	case 85: return func_358(Global_101700.f_8044.f_99.f_205[11]);

	case 90: return func_358(Global_101700.f_8044.f_99.f_205[7]);

	case 93: return func_358(Global_101700.f_8044.f_99.f_205[9]);
	}
	return 0;
}
...
// Position - 0x2EB4C
void func_362(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	int iVar1;
...
// Position - 0x2EBBB
void func_363() { Global_17151.f_6 = 1; }
	...
	if (!*iParam0) {
		if (iLocal_582 == 1) {
			...
			if (iVar0 != -1) {
				...
				Local_346[iVar0 /*19*/].f_11 =
					gameplay::get_game_timer() + gameplay::get_random_int_in_range(iLocal_601, iLocal_601 + iLocal_600);
...
void func_367(var *uParam0, int iParam1, int iParam2) {
	...
	if (!iParam2) {
		ped::set_ped_combat_attributes(uParam0->f_3, 24, iParam1);
	}
	else {
		ped::set_ped_combat_attributes(uParam0->f_3, 50, 1);
	}
	ped::set_ped_combat_attributes(uParam0->f_3, 13, iParam1);
	ped::set_ped_combat_attributes(uParam0->f_3, 0, !iParam1);
	if (iParam1) {
		if (!iParam2) {
			...
			ped::set_ped_defensive_sphere_attached_to_ped(uParam0->f_3, player::player_ped_id(), 0f, 0f, 0f,
														  gameplay::get_random_float_in_range(20f, 40f), 0);
		}
...
void func_371() {
	...
	func_378(&iLocal_1108);
	if (!func_373(&iLocal_1108, 1.5f)) {
		return;
	}
	if (func_372()) {
		if (func_21(&uLocal_607, 1)) {
...
float func_374(var *uParam0) {
	if (func_377(uParam0)) {
		if (func_376(uParam0)) {
			...
			return func_375(gameplay::is_bit_set(*uParam0, 4)) - uParam0->f_1;
		}
	}
	return uParam0->f_1;
}
...
// Position - 0x2F061
bool func_376(var *uParam0) { return gameplay::is_bit_set(*uParam0, 2); }

// Position - 0x2F071
bool func_377(var *uParam0) { return gameplay::is_bit_set(*uParam0, 1); }
...
void func_380(int *iParam0, float fParam1) {
	uParam0->f_1 = func_375(gameplay::is_bit_set(*uParam0, 4)) - fParam1;
...
// Position - 0x2F135
bool func_382(var *uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	int iVar0;
	var uVar1;

	if (iLocal_159 != 9) {
		if (gameplay::get_ground_z_for_3d_coord(vParam1, &uVar1, 0)) {
			vParam1.z = uVar1;
		}
		if (vParam1.z < 28f) {
			return false;
	...
	uParam0->f_3 = ped::create_ped(26, iLocal_545, vParam1, fParam4, 1, 1);
	if (!entity::does_entity_exist(uParam0->f_3)) {
		return false;
	}
	uParam0->f_5 = -1;
	...
	iVar0 = gameplay::get_random_int_in_range(0, 3);
	switch (iVar0) {
	case 0: ped::set_ped_combat_movement(uParam0->f_3, 1); break;

	case 1: ped::set_ped_combat_movement(uParam0->f_3, 2); break;

	case 2: ped::set_ped_combat_movement(uParam0->f_3, 3); break;
	}
	*uParam0 = 1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 1;
	...
	ped::set_ped_defensive_sphere_attached_to_ped(uParam0->f_3, player::player_ped_id(), 0f, 0f, 0f,
												  gameplay::get_random_float_in_range(12f, 50f), 0);
	ped::set_blocking_of_non_temporary_events(uParam0->f_3, 1);
...
void func_383(int iParam0, var *uParam1, int iParam2) {
	...
	switch (iVar0) {
	case 0: ped::set_ped_combat_range(iParam0, 0); break;

	case 1: ped::set_ped_combat_range(iParam0, 1); break;

	case 2: ped::set_ped_combat_range(iParam0, 2); break;

	default: ped::set_ped_combat_range(iParam0, 1); break;
	}
	if (uParam1->f_18 != -1) {
		iVar0 = uParam1->f_18;
	}
	...
	switch (iVar0) {
	case 0: ped::set_ped_combat_ability(iParam0, 0); break;

	case 1: ped::set_ped_combat_ability(iParam0, 1); break;

	case 2: ped::set_ped_combat_ability(iParam0, 2); break;

	default: ped::set_ped_combat_ability(iParam0, 1); break;
	}
}
...
// Position - 0x2F5C3
void func_385(int *iParam0, int iParam1) { iParam0->f_14 = iParam1; }

// Position - 0x2F5D1
void func_386(int iParam0) {
	float fVar0;

	fVar0 = func_387(entity::get_entity_coords(iParam0, 1), entity::get_entity_coords(player::player_ped_id(), 1), 1);
...
void func_391(int *iParam0) {
	...
	case 2:
		if (!iLocal_800) {
			if (func_402(&iLocal_1108, fLocal_1111)) {
				func_392(2, 5, 5, 0);
...
void func_392(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (func_398(iParam0, &iVar3, !iParam3)) {
		if (iParam3) {
			if (func_388(&iVar2)) {
				if (func_382(&Local_346[iVar2 /*19*/], Local_1000[iVar3 /*7*/].f_1, Local_1000[iVar3 /*7*/].f_4, 1,
							 1)) {
			...
			func_393(&Local_1000[iVar3 /*7*/], iVar1, !iParam3);
		}
	}
}
...
void func_393(var *uParam0, int iParam1, int iParam2) {
	...
	while (iVar0 < iParam1) {
		if (func_397(&iVar1)) {
			...
			if (iParam2) {
				uVar2 = func_396(uParam0->f_1, vVar3);
			}
			else {
				uVar2 = func_396(vVar3, uParam0->f_1);
			}
			func_395(iVar1, vVar3, uVar2);
			func_394(iVar1);
			if (iLocal_811 == -1 && !iParam2) {
				audio::play_sound_from_entity(iLocal_811, "CROWD_WATCHING", Local_834[iVar1 /*11*/], 0, 0, 0);
			}
			Local_834[iVar1 /*11*/].f_10 = iParam2;
		}
		iVar0++;
	}
}
...
int func_394(int iParam0) {
	...
	if (gameplay::get_ground_z_for_3d_coord(Local_834[iParam0 /*11*/].f_2, &uVar0, 0)) {
		Local_834[iParam0 /*11*/].f_2.f_2 = uVar0;
	}
	if (Local_834[iParam0 /*11*/].f_2.f_2 < 28f) {
		return 0;
	}
	Local_834[iParam0 /*11*/] = ped::create_ped(26, Local_834[iParam0 /*11*/].f_1, Local_834[iParam0 /*11*/].f_2,
												Local_834[iParam0 /*11*/].f_5, 1, 1);
	...
	entity::set_entity_health(Local_834[iParam0 /*11*/], 100);
...
// Position - 0x2FAB1
void func_395(int iParam0, vector3 vParam1, var uParam4) {
	if (func_384()) {
...
// Position - 0x2FB53
bool func_398(int iParam0, var *uParam1, int iParam2) {
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 15) {
		if (Local_894[iVar0 /*7*/] == iParam0) {
			if (Local_894[iVar0 /*7*/].f_6 == iParam2) {
				if (iVar1 < Local_1000) {
...
// Position - 0x2FCE3
bool func_403(var *uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8) {
	float fVar0;

	gameplay::clear_area_of_vehicles(vParam1, 5f, 0, 0, 0, 0, 0);
	if (gameplay::get_ground_z_for_3d_coord(vParam1 + Vector(0.23f, 0f, 0f), &fVar0, 0)) {
		vParam1.z = fVar0;
	}
	uParam0->f_3 = vehicle::create_vehicle(iLocal_546, vParam1, fParam4, 1, 1);
	if (!entity::does_entity_exist(uParam0->f_3)) {
		return false;
	}
...
void func_405(int *iParam0) {
	...
	case 2:
		if (iLocal_582 > 1) {
			if (func_402(&iLocal_1108, gameplay::get_random_float_in_range(9f, 12f))) {
				func_392(1, 5, 5, 0);
			}
		}
		if (func_369()) {
...
void func_411(int *iParam0) {
	...
	case 1:
		ui::clear_prints();
		func_413(player::player_ped_id(), -1);
		if (!audio::is_audio_scene_active(sLocal_344)) {
...
// Position - 0x303FA
void func_414() { uLocal_36 = gameplay::get_game_timer(); }
...
// Position - 0x30428
void func_416(var *uParam0, bool bParam1) { func_417(&uParam0->f_41, bParam1); }
...
// Position - 0x304B3
void func_419(var *uParam0, bool bParam1) { func_420(&uParam0->f_35, bParam1); }
...
// Position - 0x305C8
void func_423(var *uParam0, int iParam1) { func_424(&uParam0->f_28, iParam1); }
...
bool func_427() {
	...
	case 0:
		...
		if (func_434(&Local_346[iLocal_803 /*19*/], "clown_idle_0", 0) &&
			func_434(&Local_346[iLocal_804 /*19*/], "clown_idle_6", 0.1f) &&
			func_434(&Local_346[iLocal_805 /*19*/], "clown_idle_3", 0.1f)) {
			iLocal_890 = 1;
		}
		break;
	...
	case 1:
		...
		if (cam::does_cam_exist(iLocal_807)) {
			if (cam::is_cam_active(iLocal_807)) {
				func_431(player::player_ped_id(), 187.789f, -959.6204f, 29.00801f, 85f, 0, 1);
				func_389(&iLocal_891);
				iLocal_890 = 6;
			}
		}
...
void func_429() {
	...
	if (func_53(player::player_ped_id())) {
		...
		if (weapon::does_weapon_take_weapon_component(iLocal_548, joaat("component_assaultshotgun_clip_02"))) {
			weapon::give_weapon_component_to_ped(player::player_ped_id(), iLocal_548,
...
// Position - 0x30BBC
int func_431(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	bool bVar0;
	float fVar1;
...
void func_432(int iParam0, char *sParam1, char *sParam2, int iParam3) {
	audio::_play_ambient_speech_with_voice(iParam0, sParam1, sParam2, func_433(iParam3), 0);
}
...
int func_438(var *uParam0, int iParam1) {
	...
	switch ((*uParam0)[iParam1 /*7*/]) {
	case 1: ped::request_action_mode_asset((*uParam0)[iParam1 /*7*/].f_3); break;

	case 2: streaming::request_anim_dict((*uParam0)[iParam1 /*7*/].f_3); break;

	case 3: streaming::request_anim_set((*uParam0)[iParam1 /*7*/].f_3); break;

	case 4: audio::request_script_audio_bank((*uParam0)[iParam1 /*7*/].f_3, 0, -1); break;

	case 5: audio::load_stream((*uParam0)[iParam1 /*7*/].f_3, (*uParam0)[iParam1 /*7*/].f_4); break;

	case 6: streaming::request_model((*uParam0)[iParam1 /*7*/].f_1); break;

	case 7: streaming::request_ptfx_asset(); break;

	case 8: ui::request_additional_text((*uParam0)[iParam1 /*7*/].f_3, (*uParam0)[iParam1 /*7*/].f_5); break;

	case 9: graphics::request_streamed_texture_dict((*uParam0)[iParam1 /*7*/].f_3, 0); break;

	case 10: vehicle::request_vehicle_recording((*uParam0)[iParam1 /*7*/].f_5, (*uParam0)[iParam1 /*7*/].f_3); break;

	case 11: ai::request_waypoint_recording((*uParam0)[iParam1 /*7*/].f_3); break;

	case 12: weapon::request_weapon_asset((*uParam0)[iParam1 /*7*/].f_2, 31, 0); break;
	...
	case 1:
		...
		if (func_295(1, 1093140480, 0)) {
			if (func_53(Local_96.f_28[0])) {
				...
				cutscene::register_entity_for_cutscene(Local_96.f_28[0], sLocal_335, 2, func_620(49), 0);
			}
			if (func_53(Local_96.f_41[0])) {
				cutscene::register_entity_for_cutscene(Local_96.f_41[0], sLocal_337, 0, 0, 0);
			}
			else {
				cutscene::register_entity_for_cutscene(Local_96.f_41[0], sLocal_337, 2, joaat("prop_protest_table_01"),
													   0);
			}
			if (func_53(Local_96.f_41[1])) {
			...
			iLocal_807 = cam::create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", 188.1366f, -957.7827f, 30.6514f,
													 -5.5067f, -8f, 92.8053f, 40f, 0, 2);
			func_496();
			cutscene::start_cutscene(0);
			unk1::_0x48621C9FCA3EBD28(1);
			...
			func_495(0, 0, 1, 0);
			func_457();
			func_286(vLocal_173, 1, 0, 1, 1, 1, 1, 1, 1, 1, 1);
			func_456(&iLocal_164, 0);
			func_40();
			func_278(&Local_96.f_41[3], iLocal_547);
			func_288(500, 0);
			func_450();
	...
	case 2:
		if (!cutscene::is_cutscene_playing()) {
			...
			if (cutscene::can_set_exit_state_for_camera(0)) {
				unk1::_0x81CBAE94390F9F89();
				if (cam::does_cam_exist(iLocal_807)) {
					cam::set_cam_active(iLocal_807, 1);
...
// Position - 0x31922
void func_449(float fParam0, float fParam1, char *sParam2, int iParam3, int iParam4) {
...
int func_455(var *uParam0, int iParam1, int iParam2, char *sParam3, int iParam4) {
	...
	switch (iParam2) {
	case 1: ped::request_action_mode_asset(sParam3); break;

	case 2: streaming::request_anim_dict(sParam3); break;

	case 3: streaming::request_anim_set(sParam3); break;

	case 4: audio::request_script_audio_bank(sParam3, 0, -1); break;

	case 5: audio::load_stream(sParam3, iParam4); break;

	case 9: graphics::request_streamed_texture_dict(sParam3, 0); break;

	case 11: ai::request_waypoint_recording(sParam3); break;
...
void func_456(int iParam0, int iParam1) {
	...
	*iParam0 = ped::add_scenario_blocking_area(-7000f, -7000f, -100f, 7000f, 7000f, 315f, 0, 1, 1, 1);
	...
	if (func_41(player::player_ped_id()) && iParam1 == 1) {
...
void func_457() {
	...
	if (vehicle::is_this_model_a_heli(iVar0) || vehicle::is_this_model_a_plane(iVar0)) {
		...
		fLocal_168 = 206.45f;
		func_488(Local_202[0 /*3*/], Local_202[1 /*3*/], Local_202.f_7, vLocal_165, fLocal_168, 0f, 0f, 0f, 1, 0, 1, 0,
				 0);
		func_461(vLocal_165, fLocal_168, 0, 145);
	}
	else {
		func_488(Local_202[0 /*3*/], Local_202[1 /*3*/], Local_202.f_7, vLocal_165, fLocal_168, func_460(), 1, 0, 1, 0,
				 0);
...
// Position - 0x31D7F
bool func_458(vector3 vParam0, int iParam3) { return func_459(Global_93635.f_2311.f_12.f_66, vParam0, iParam3); }

// Position - 0x31D9C
int func_459(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
	vector3 vVar3;
...
// Position - 0x31E06
Vector3 func_460() { return 2.55f, 5.665f, 2.55f; }

// Position - 0x31E1D
void func_461(vector3 vParam0, float *fParam3, int iParam4, int iParam5) {
	vector3 vVar0;
	float *fVar3;
	...
	if (entity::does_entity_exist(Global_93635.f_4)) {
		if (vehicle::is_vehicle_driveable(Global_93635.f_4, 0)) {
			if (func_487(24) != Global_93635.f_4) {
				if (iParam4 == 1) {
					if (func_484(entity::get_entity_coords(Global_93635.f_4, 1), iParam5, &vVar0, &fVar3)) {
						vParam0 = {vVar0};
						fParam3 = fVar3;
					}
				}
				func_462(Global_93635.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
void func_462(int iParam0, vector3 vParam1, float *fParam4, int iParam5, int iParam6) {
	...
	if (entity::does_entity_exist(iParam0) && vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		func_480(iParam5, &Var0, vParam1, fParam4, func_313(iParam0));
...
int func_465(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_321(iParam0, 0, 0) ||
		func_321(iParam0, 1, 0) || func_321(iParam0, 2, 0) || func_313(iParam0) != 145 || func_478(iParam0) ||
		func_477(iParam0) || func_476(iParam0) || func_475(iParam0) || !func_466(entity::get_entity_model(iParam0))) {
		if (func_477(iParam0)) {
		}
		if (func_477(iParam0)) {
		}
...
// Position - 0x33527
int func_471() { return 0; }

// Position - 0x33530
int func_472() { return 1; }

// Position - 0x33539
int func_473() { return 1; }
...
// Position - 0x34E38
void func_480(int iParam0, var *uParam1, vector3 vParam2, var uParam5, int iParam6) {
	if (func_479(&Global_68531.f_555[0 /*21*/], iParam0)) {
...
// Position - 0x350A4
bool func_484(vector3 vParam0, int iParam3, var *uParam4, float *fParam5) {
	int iVar0;

	iVar0 = func_485(vParam0, iParam3, 1);
	switch (iVar0) {
	case 0:
...
// Position - 0x351BA
int func_485(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
...
// Position - 0x35249
var func_486(int iParam0) { return gameplay::is_bit_set(Global_101700.f_6188[iParam0], 0); }
...
// Position - 0x3527D
void func_488(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
			  int iParam14, int iParam15, int iParam16, int iParam17, int iParam18) {
	func_489(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

// Position - 0x352A7
void func_489(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
...
bool func_491(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (func_492(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_492(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_492(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_492(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_492(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_492(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_492(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_492(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_492(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_492(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_492(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_492(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_492(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_492(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_492(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_492(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x359B9
int func_492(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
void func_495(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (func_41(player::player_ped_id())) {
		...
		if (iParam3 == 1) {
			gameplay::clear_area_of_vehicles(entity::get_entity_coords(player::player_ped_id(), 1), 100f, 0, 0, 0, 0,
											 0);
		}
	}
}
...
void func_500() {
	if (func_53(player::player_ped_id())) {
		if (player::is_player_control_on(player::player_id())) {
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 189.1399f, -955.8049f, 29.09192f, 187.5274f,
												 -955.0106f, 31.09192f, 2.5f, 0, 1, 0)) {
...
void func_503() {
	...
	if (iLocal_586) {
		vVar1 = {func_507(vLocal_587, fLocal_584, 2f)};
	}
	else {
		vVar1 = {func_507(vLocal_169, fLocal_584, 2f)};
	}
	if (!func_504(&vVar1)) {
		return;
	}
	if (func_382(&Local_346[iVar0 /*19*/], vVar1, 0, 0, 0)) {
		if (iLocal_159 == 9) {
...
int func_504(var *uParam0) {
	...
	if (!gameplay::get_ground_z_for_3d_coord(vVar0, &uVar3, 0)) {
		return 0;
	}
	vVar0.z = uVar3;
	if (iLocal_159 != 9) {
	...
	if (func_506(player::player_ped_id(), vVar0, 1) < fLocal_575) {
		return 0;
	}
	if (bLocal_596) {
		if (func_505(vVar0, fVar4, player::player_ped_id(), 1)) {
			return 0;
		}
	}
	...
	if (object::is_point_in_angled_area(vVar0, 211.8852f, -931.1685f, 29.6915f, 220.7504f, -918.6229f, 32.44152f, 2f, 0,
										1)) {
		return 0;
	}
	if (vVar0.z < 28.58f) {
...
// Position - 0x36115
bool func_505(vector3 vParam0, float fParam3, int iParam4, int iParam5) {
	return gameplay::is_position_occupied(vParam0, fParam3, 0, 0, 1, 0, 0, iParam4, iParam5);
}

// Position - 0x36130
float func_506(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
...
// Position - 0x3616A
Vector3 func_507(vector3 vParam0, float fParam3, float fParam4) {
	vector3 vVar0;
	float fVar3;

	vVar0 = {gameplay::get_random_float_in_range(-1f, 1f), gameplay::get_random_float_in_range(-1f, 1f), 0f};
	fVar3 = fParam4 / 2f;
	vVar0 = {func_508(vVar0, gameplay::get_random_float_in_range(0f, fParam3))};
	vVar0.z = gameplay::get_random_float_in_range(-fVar3, fVar3);
	return vParam0 + vVar0;
}

// Position - 0x361B2
Vector3 func_508(vector3 vParam0, float fParam3) {
	float fVar0;
...
bool func_510(var *uParam0) {
	...
	iVar6 = iLocal_573 * 2;
	iVar1 = func_522(uParam0->f_3, 1);
	if (uParam0->f_2 < 15) {
		vVar3 = {entity::get_entity_coords(uParam0->f_3, 1)};
		if (vVar3.z < 21f) {
		}
		if (iVar1 || vVar3.z < 21f) {
			uParam0->f_2 = 15;
			if (uParam0->f_8 == 0) {
				if (iLocal_580 < 4) {
					func_521(743, 1, 0);
	...
	if (uParam0->f_9 == 0) {
		if (func_520(uParam0->f_3, player::player_ped_id(), 1) < fLocal_581 ||
			entity::has_entity_been_damaged_by_entity(uParam0->f_3, player::player_ped_id(), 1)) {
	...
	if (bLocal_213) {
		if (uParam0->f_9 == 0) {
			func_519(entity::get_entity_coords(uParam0->f_3, 1), fLocal_581, 255, 0, 0, 255, 32);
		}
		else {
			func_519(entity::get_entity_coords(uParam0->f_3, 1), fLocal_581, 0, 0, 255, 255, 32);
		}
	}
	switch (uParam0->f_2) {
	case 1:
		if (gameplay::get_game_timer() >= uParam0->f_6) {
			graphics::start_particle_fx_non_looped_on_entity("scr_clown_appears", uParam0->f_3, 0f, 0f, 0f, 0f, 0f, 0f,
															 3f, 0, 0, 0);
			uParam0->f_6 = gameplay::get_game_timer() + 250;
			uParam0->f_2 = 2;
			uParam0->f_5 = 0f;
			func_518(uParam0->f_3, system::floor(uParam0->f_5), &iLocal_214);
	...
	case 2:
		uParam0->f_5 += gameplay::get_frame_time() * 1024f;
		if (uParam0->f_5 > 255f) {
			uParam0->f_5 = 255f;
		}
		if (entity::is_entity_on_screen(uParam0->f_3)) {
	...
	case 10:
		...
		if (func_388(&iVar0)) {
			...
			if (func_515(&Local_346[uParam0->f_14 /*19*/], uParam0->f_3, 1)) {
				...
				ai::task_perform_sequence(Local_346[uParam0->f_14 /*19*/].f_3, iVar2);
	...
	case 11:
		if (func_53(Local_346[uParam0->f_14 /*19*/].f_3)) {
			if (ai::get_script_task_status(Local_346[uParam0->f_14 /*19*/].f_3, 242628503) == 7) {
				...
				ai::task_perform_sequence(Local_346[uParam0->f_14 /*19*/].f_3, iVar7);
	...
	case 12:
		if (iLocal_598 == 0 && iLocal_1106) {
			if (gameplay::get_game_timer() > iLocal_599 && entity::is_entity_on_screen(uParam0->f_3)) {
				if (func_520(player::player_ped_id(), uParam0->f_3, 1) < 50f) {
					func_513();
				}
			}
		}
		...
		if (bLocal_213) {
			func_519(vVar8, 1.5f, 255, 0, 0, 255, 32);
		}
		if (func_512(vVar8, 1.5f)) {
			return true;
		}
		if (func_388(&iVar0)) {
			if (func_515(&Local_346[iVar0 /*19*/], uParam0->f_3, 0)) {
				graphics::start_particle_fx_non_looped_on_entity("scr_clown_appears", uParam0->f_3, vLocal_590, 0f, 0f,
																 0f, fLocal_593, 0, 0, 0);
				...
				vVar8 = {entity::get_offset_from_entity_in_world_coords(
					uParam0->f_3, gameplay::get_random_float_in_range(-2.5f, 2.5f),
					gameplay::get_random_float_in_range(-6.5f, -10f), -0.7f)};
				ai::open_sequence_task(&iVar11);
				ai::task_swap_weapon(0, 1);
				ai::task_leave_vehicle(0, uParam0->f_3, 256);
				ai::task_go_to_coord_while_aiming_at_entity(0, vVar8, player::player_ped_id(), 1f, 1, 1.5f, 2f, 1, 0, 0,
															-957453492, 20000);
				ai::close_sequence_task(iVar11);
				ai::task_perform_sequence(Local_346[iVar0 /*19*/].f_3, iVar11);
				ai::clear_sequence_task(&iVar11);
				if (uParam0->f_9 == 0) {
					uParam0->f_6 =
						gameplay::get_game_timer() + gameplay::get_random_int_in_range(iLocal_573 * 4, iLocal_574 * 4);
				}
				else {
					uParam0->f_6 =
						gameplay::get_game_timer() + gameplay::get_random_int_in_range(iLocal_573 + 500, iLocal_574);
				}
				if (uParam0->f_10 > 5) {
					uParam0->f_6 =
						gameplay::get_game_timer() + gameplay::get_random_int_in_range(iLocal_573 * 4, iLocal_574 * 4);
	...
	case 16:
		if (gameplay::get_game_timer() > uParam0->f_6) {
			graphics::start_particle_fx_non_looped_at_coord("scr_clown_death",
															entity::get_entity_coords(uParam0->f_3, 0),
															entity::get_entity_rotation(uParam0->f_3, 2), 3f, 0, 0, 0);
	...
	case 17:
		if (gameplay::get_game_timer() > uParam0->f_6) {
			uParam0->f_5 -= gameplay::get_frame_time() * 512f;
			if (uParam0->f_5 < 0f) {
				uParam0->f_5 = 0f;
			}
			func_41(uParam0->f_3);
...
// Position - 0x369CC
bool func_512(vector3 vParam0, float fParam3) {
	int iVar0;

	iVar0 = 0;
	while (iVar0 < Local_346) {
		if (entity::does_entity_exist(Local_346[iVar0 /*19*/].f_3)) {
			if (func_506(Local_346[iVar0 /*19*/].f_3, vParam0, 1) < fParam3) {
				return true;
			}
		}
		iVar0++;
...
bool func_515(var *uParam0, int iParam1, int iParam2) {
	...
	uParam0->f_3 = ped::create_ped_inside_vehicle(iParam1, 26, iLocal_545, iVar1, 1, 1);
	func_29(&uParam0->f_4);
	...
	*uParam0 = 1;
	...
	func_385(uParam0, 0);
	uParam0->f_11 = gameplay::get_game_timer() +
					gameplay::get_random_int_in_range(system::round(IntToFloat(iLocal_600) * 1.5f), iLocal_601);
	ped::set_ped_can_cower_in_cover(uParam0->f_3, 0);
	ped::set_ped_can_peek_in_cover(uParam0->f_3, 1);
	ped::set_ped_combat_attributes(uParam0->f_3, 1, 0);
	ped::set_ped_as_enemy(uParam0->f_3, 1);
...
// Position - 0x36DAC
void func_519(vector3 vParam0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) {
	int iVar0;
	float fVar1;
	vector3 vVar2;
	vector3 vVar5;
...
void func_525(int *iParam0) {
	...
	func_41(player::player_ped_id());
	if (!func_536(iParam0)) {
		if (entity::is_entity_dead(iParam0->f_3, 0) || ped::is_ped_injured(iParam0->f_3) ||
			ped::is_ped_dead_or_dying(iParam0->f_3, 0)) {
			iVar4 = 500;
			if (iParam0->f_2 == 7 || iParam0->f_2 == 6 || iParam0->f_2 == 8 || iParam0->f_2 == 9) {
				if (iLocal_579 < 6) {
					func_521(744, 1, 0);
				}
				iLocal_579++;
			...
			func_535("CLOWN_DEATH", "CLOWNS", entity::get_entity_coords(iParam0->f_3, 1), 10);
			iParam0->f_2 = 15;
			iParam0->f_12 = gameplay::get_game_timer() + iVar4;
			func_66(&iParam0->f_5);
			if (func_534(iParam0) != 0) {
				func_385(iParam0, 0);
			}
			if (!entity::is_entity_dead(iParam0->f_3, 0)) {
				ped::explode_ped_head(iParam0->f_3, joaat("weapon_sniperrifle"));
			}
			if (entity::has_entity_been_damaged_by_entity(iParam0->f_3, player::player_ped_id(), 1)) {
				func_533();
			}
			if (iLocal_159 == 9) {
				iParam0->f_16 = {entity::get_entity_coords(iParam0->f_3, 1)};
			}
			func_29(&iParam0->f_4);
			iLocal_578++;
		}
	...
	switch (iParam0->f_2) {
	case 1:
		if (gameplay::get_game_timer() >= iParam0->f_12 || iLocal_159 == 9) {
			entity::freeze_entity_position(iParam0->f_3, 1);
			graphics::start_particle_fx_non_looped_on_entity("scr_clown_appears", iParam0->f_3, 0f, 0f, -0.1f, 0f, 0f,
															 0f, 1.5f, 0, 0, 0);
			iParam0->f_12 = gameplay::get_game_timer() + 250;
			vVar0 = {entity::get_entity_coords(iParam0->f_3, 1)};
			iParam0->f_2 = 2;
		}
		break;

	case 2:
		if (gameplay::get_game_timer() > iParam0->f_12) {
			entity::set_entity_visible(iParam0->f_3, 1, 0);
			entity::freeze_entity_position(iParam0->f_3, 0);
			entity::set_entity_invincible(iParam0->f_3, 0);
			func_29(&iParam0->f_4);
			iParam0->f_4 = func_514(iParam0->f_3, 1, 0, 5);
			switch (iParam0->f_14) {
			case 1: iParam0->f_2 = 0; break;

			case 2: iParam0->f_2 = 8; break;

			case 0:
				iParam0->f_2 = 12;
				if (iParam0->f_11 != 0) {
					iParam0->f_11 =
						gameplay::get_game_timer() + gameplay::get_random_int_in_range(iLocal_600, iLocal_601);
				}
				else {
					iParam0->f_2 = 6;
				}
			...
			default: iParam0->f_2 = 12; break;
			}
			if (func_384()) {
				func_432(iParam0->f_3, "CLOWN_LAUGH", "CLOWNS", 10);
			}
		}
		break;
	...
	case 3:
		...
		func_66(&iParam0->f_5);
		entity::freeze_entity_position(iParam0->f_3, 1);
		entity::set_entity_invincible(iParam0->f_3, 1);
		graphics::start_particle_fx_non_looped_at_coord("scr_clown_appears", entity::get_entity_coords(iParam0->f_3, 1),
														entity::get_entity_rotation(iParam0->f_3, 2), 1.5f, 0, 0, 0);
		iParam0->f_12 = gameplay::get_game_timer() + 125;
		iParam0->f_2 = 4;
		break;
	...
	case 12:
		if (func_534(iParam0) == 3) {
			if (func_532(iParam0->f_3, &iParam0->f_15, 22f)) {
				func_367(iParam0, 1, 0);
				iParam0->f_2 = 13;
				return;
			}
		}
		else if (func_532(iParam0->f_3, &iParam0->f_15, 12f)) {
			func_367(iParam0, 1, 0);
			iParam0->f_2 = 13;
			return;
		}
		if (func_534(iParam0) == 4 && ai::get_script_task_status(iParam0->f_3, 242628503) <= 1) {
			return;
		}
		else if (func_534(iParam0) != 0) {
			func_385(iParam0, 0);
		}
		if (ai::get_script_task_status(iParam0->f_3, 780511057) > 1) {
			if (gameplay::get_game_timer() > iParam0->f_13) {
				func_367(iParam0, 1, 1);
			}
			else {
				func_367(iParam0, 0, 0);
			}
			ai::task_combat_ped(iParam0->f_3, player::player_ped_id(), 134217728, 16);
			if (func_384()) {
				func_432(iParam0->f_3, "CLOWN_LAUGH", "CLOWNS", 10);
			}
		}
		if (gameplay::get_game_timer() > iParam0->f_11) {
			if (!ped::is_ped_in_cover(iParam0->f_3, 0)) {
				func_367(iParam0, 0, 0);
				iParam0->f_2 = 6;
			}
			else {
				iParam0->f_11 =
					gameplay::get_game_timer() + gameplay::get_random_int_in_range(iLocal_600, iLocal_601 / 2);
			}
		}
		vVar0 = {entity::get_entity_coords(iParam0->f_3, 1)};
		if (vVar0.z < 27.7f) {
		...
		if (entity::is_entity_in_angled_area(iParam0->f_3, 220.5318f, -918.4567f, 27.53389f, 211.7581f, -931.4215f,
											 39.6918f, 2.5f, 0, 1, 0)) {
			iParam0->f_2 = 4;
			return;
		}
	...
	case 13:
		if (!func_531(iParam0) || func_530(iParam0->f_3, iParam0->f_15) > 22f) {
			iParam0->f_11 = gameplay::get_game_timer() + gameplay::get_random_int_in_range(iLocal_600, iLocal_601);
			iParam0->f_15 = 0;
			iParam0->f_2 = 12;
		}
		else {
	...
	case 7:
		if (!entity::is_entity_playing_anim(iParam0->f_3, sLocal_343, &iParam0->f_7, 3)) {
			iParam0->f_2 = 12;
			iParam0->f_11 = gameplay::get_game_timer() + gameplay::get_random_int_in_range(iLocal_600, iLocal_601);
		}
		break;
	...
	case 9:
		if (gameplay::are_strings_equal(&iParam0->f_7, sLocal_817)) {
			sVar5 = sLocal_816;
			fVar6 = 0.802f;
			fVar7 = 0.815f;
		}
		...
		if (func_527(iParam0, sVar5, fVar6, fVar7, &iLocal_802)) {
	...
	case 14:
		iParam0->f_6 += gameplay::get_frame_time() * 512f;
		if (iParam0->f_6 < 2f) {
			entity::set_entity_visible(iParam0->f_3, 0, 0);
		}
		else {
			entity::set_entity_visible(iParam0->f_3, 1, 0);
			if (iParam0->f_6 > 255f) {
				iParam0->f_6 = 255f;
				entity::reset_entity_alpha(iParam0->f_3);
				iParam0->f_2 = 12;
			}
			else if (entity::is_entity_on_screen(iParam0->f_3)) {
				func_526(iParam0->f_3, system::floor(iParam0->f_6), &iLocal_214);
			}
			else {
				entity::reset_entity_alpha(iParam0->f_3);
			}
	...
	case 15:
		...
		if (gameplay::get_game_timer() > iParam0->f_12) {
			if (entity::is_entity_dead(iParam0->f_3, 0) || ped::is_ped_injured(iParam0->f_3)) {
				func_66(&iParam0->f_5);
				if (!entity::is_entity_in_air(iParam0->f_3)) {
					vVar0 = {entity::get_entity_coords(iParam0->f_3, 1)};
					if (gameplay::get_ground_z_for_3d_coord(vVar0, &uVar3, 0)) {
						vVar0.z = uVar3;
						vVar0.z++;
					...
					graphics::start_particle_fx_non_looped_at_coord(
						"scr_clown_death", vVar0, entity::get_entity_rotation(iParam0->f_3, 2), 2f, 0, 0, 0);
					audio::play_sound_from_coord(-1, "clown_die_wrapper", vVar0, "BARRY_02_SOUNDSET", 0, 0, 0);
					iParam0->f_2 = 17;
					if (iLocal_159 == 9) {
						iParam0->f_12 = gameplay::get_game_timer() + 100;
					}
					else {
						iParam0->f_12 = gameplay::get_game_timer() + 500;
					}
					iParam0->f_6 = 255f;
					func_29(&iParam0->f_4);
				}
	...
	case 17:
		if (gameplay::get_game_timer() > iParam0->f_12) {
			...
			func_526(iParam0->f_3, system::floor(iParam0->f_6), &iLocal_214);
			if (iParam0->f_6 <= 0f || !entity::is_entity_on_screen(iParam0->f_3)) {
				iParam0->f_1 = 1;
				func_66(&iParam0->f_5);
				func_443(iParam0);
				*iParam0 = 0;
...
// Position - 0x377F5
bool func_527(int *iParam0, char *sParam1, float fParam2, float fParam3, int *iParam4) {
	if (entity::is_entity_playing_anim(iParam0->f_3, sParam1, &iParam0->f_7, 3)) {
		if (!*iParam4) {
			if (entity::get_entity_anim_current_time(iParam0->f_3, sParam1, &iParam0->f_7) >= fParam2 &&
				!weapon::has_ped_got_weapon(iParam0->f_3, joaat("weapon_smg"), 0)) {
				graphics::start_particle_fx_non_looped_at_coord(
					"scr_clown_appears", ped::get_ped_bone_coords(iParam0->f_3, 57005, 0f, 0f, 0f), 0f, 0f, 0f, 0.3f, 0,
					0, 0);
				*iParam4 = 1;
			}
		}
		if (entity::get_entity_anim_current_time(iParam0->f_3, sParam1, &iParam0->f_7) >= fParam3) {
			if (!weapon::has_ped_got_weapon(iParam0->f_3, joaat("weapon_smg"), 0)) {
				weapon::give_weapon_to_ped(iParam0->f_3, joaat("weapon_smg"), -1, 1, 1);
			}
			*iParam4 = 0;
			return true;
		}
...
void func_528(int *iParam0, int iParam1) {
	...
	if (iVar0 == 0) {
		StringCopy(&iParam0->f_7, sLocal_817, 16);
		ai::task_play_anim(iParam0->f_3, sLocal_816, &iParam0->f_7, 8f, -4f, -1, 0, 0.625f, 0, 0, 0);
	}
	else {
		StringCopy(&iParam0->f_7, "clown_idle_", 16);
		StringIntConCat(&iParam0->f_7, gameplay::get_random_int_in_range(0, 6), 16);
		ai::task_play_anim(iParam0->f_3, sLocal_343, &iParam0->f_7, 8f, -1f, -1, 0, 0, 0, 0, 0);
	}
}
...
void func_529(int *iParam0) {
	...
	if (ped::is_ped_injured(iParam0->f_3) || ped::is_ped_injured(iParam0->f_15)) {
		return;
	}
	if (ai::get_script_task_status(iParam0->f_3, 242628503) != 1) {
		ai::open_sequence_task(&iVar0);
		if (func_520(iParam0->f_3, iParam0->f_15, 0) <= 5f) {
			ai::task_aim_gun_at_entity(0, iParam0->f_15, gameplay::get_random_int_in_range(250, 500), 0);
			ai::task_shoot_at_entity(0, iParam0->f_15, gameplay::get_random_int_in_range(250, 500), -957453492);
		}
		ai::task_go_to_entity_while_aiming_at_entity(0, iParam0->f_15, iParam0->f_15, 2f, 1, 3f, 4.5f, 1, 0,
													 -957453492);
		ai::task_combat_ped(0, iParam0->f_15, 67108864, 16);
		ai::close_sequence_task(iVar0);
		ai::task_perform_sequence(iParam0->f_3, iVar0);
...
// Position - 0x37A00
float func_530(int iParam0, int iParam1) { return func_520(iParam0, iParam1, 1); }
...
// Position - 0x37A57
bool func_532(int iParam0, int *iParam1, float fParam2) {
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= Local_834 - 1) {
		if (entity::does_entity_exist(Local_834[iVar0 /*11*/])) {
			if (!entity::is_entity_dead(Local_834[iVar0 /*11*/], 0)) {
				if (!ped::is_ped_injured(Local_834[iVar0 /*11*/]) &&
					!ped::is_ped_dead_or_dying(Local_834[iVar0 /*11*/], 1)) {
					fVar1 = func_530(iParam0, Local_834[iVar0 /*11*/]);
					if (fVar1 < fVar2) {
						fVar2 = fVar1;
						*iParam1 = Local_834[iVar0 /*11*/];
					}
				}
			}
		}
...
// Position - 0x37B9A
int func_534(int *iParam0) { return iParam0->f_14; }

// Position - 0x37BA6
void func_535(char *sParam0, char *sParam1, vector3 vParam2, int iParam5) {
	audio::_play_ambient_speech_at_coords(sParam0, sParam1, vParam2, func_433(iParam5));
}

// Position - 0x37BC0
bool func_536(var *uParam0) { return uParam0->f_2 == 15 || uParam0->f_2 == 17; }
...
void func_538(int iParam0) {
	...
	if (entity::is_entity_dead(Local_834[iParam0 /*11*/], 0) ||
		ped::is_ped_dead_or_dying(Local_834[iParam0 /*11*/], 1)) {
	...
	case 0:
		Local_834[iParam0 /*11*/].f_9 += gameplay::get_frame_time() * 512f;
		if (Local_834[iParam0 /*11*/].f_9 < 2f) {
			...
			if (Local_834[iParam0 /*11*/].f_9 > 255f) {
				...
				func_526(Local_834[iParam0 /*11*/], system::floor(Local_834[iParam0 /*11*/].f_9), &iLocal_810);
			}
			else {
				entity::reset_entity_alpha(Local_834[iParam0 /*11*/]);
			}
		...
		if (func_53(player::player_ped_id())) {
			if (func_53(Local_834[iParam0 /*11*/])) {
				...
				ai::task_smart_flee_coord(
					0, entity::get_offset_from_entity_in_world_coords(Local_834[iParam0 /*11*/], vVar0), 200f, -1, 0,
					0);
				ai::close_sequence_task(iVar3);
				ai::clear_ped_tasks(Local_834[iParam0 /*11*/]);
				ai::task_perform_sequence(Local_834[iParam0 /*11*/], iVar3);
	...
	case 3:
		if (!entity::is_entity_in_angled_area(Local_834[iParam0 /*11*/], Local_178[0 /*3*/], Local_178[1 /*3*/],
											  Local_178.f_7, 0, 1, 0)) {
			Local_834[iParam0 /*11*/].f_8 = gameplay::get_game_timer() + 500;
			Local_834[iParam0 /*11*/].f_6 = 4;
		}
	...
	case 4:
		...
		ped::apply_damage_to_ped(Local_834[iParam0 /*11*/], 1000, 1);
		Local_834[iParam0 /*11*/].f_8 = gameplay::get_game_timer() + 500;
		Local_834[iParam0 /*11*/].f_6 = 5;
		break;
	...
	case 5:
		if (gameplay::get_game_timer() > Local_834[iParam0 /*11*/].f_8) {
			if (entity::is_entity_dead(Local_834[iParam0 /*11*/], 0) ||
				ped::is_ped_injured(Local_834[iParam0 /*11*/])) {
				Local_834[iParam0 /*11*/].f_8 = gameplay::get_game_timer() + 500;
				Local_834[iParam0 /*11*/].f_9 = 255f;
	...
	case 6:
		if (gameplay::get_game_timer() > Local_834[iParam0 /*11*/].f_8) {
			Local_834[iParam0 /*11*/].f_9 -= gameplay::get_frame_time() * 1024f;
...
void func_539(int iParam0) {
	if (Local_834[iParam0 /*11*/].f_1 == iLocal_808) {
		if (!entity::is_entity_playing_anim(Local_834[iParam0 /*11*/], sLocal_814, sLocal_815, 3)) {
			ai::task_play_anim(Local_834[iParam0 /*11*/], sLocal_814, sLocal_815, 8f, -8f, -1, 1,
							   gameplay::get_random_float_in_range(0f, 0.5f), 0, 0, 0);
		}
	}
	else if (!entity::is_entity_playing_anim(Local_834[iParam0 /*11*/], sLocal_812, sLocal_813, 3)) {
		ai::task_play_anim(Local_834[iParam0 /*11*/], sLocal_812, sLocal_813, 8f, -8f, -1, 1,
						   gameplay::get_random_float_in_range(0f, 0.5f), 0, 0, 0);
	}
}
	...
	while (iVar3 < Local_834) {
		if (iVar3 != iParam0) {
			if (entity::does_entity_exist(Local_834[iVar3 /*11*/])) {
				if (ped::is_ped_dead_or_dying(Local_834[iVar3 /*11*/], 1) ||
					ped::is_ped_injured(Local_834[iVar3 /*11*/])) {
					if (gameplay::get_distance_between_coords(
							vVar0, entity::get_entity_coords(Local_834[iVar3 /*11*/], 0), 0) < 20f) {
						return true;
					}
				}
			}
...
struct<2> func_548(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_556(iParam0)}; break;

	case 7: Var0 = {func_219(iParam0)}; break;

	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_555(iParam2)}; break;

		case 8: Var0 = {func_554(iParam2)}; break;

		case 7: Var0 = {func_553(iParam2)}; break;

		case 10: Var0 = {func_552(iParam2)}; break;

		case 5: Var0 = {func_551(iParam2)}; break;

		case 4: Var0 = {func_550(iParam2)}; break;

		default: StringCopy(&Var0, func_549(iVar2), 8); break;
		}
		break;
...
bool func_557(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	...
	case 5:
		if (cutscene::is_cutscene_playing() || func_544(0) || func_558(1)) {
		}
		else {
			return true;
		}
...
// Position - 0x38B02
bool func_560(int iParam0) { return func_561(iParam0, Global_35781); }
...
// Position - 0x38D2D
void func_564(vector3 vParam0, float fParam3, var *uParam4, var *uParam5) {
	vector3 vVar0;
...
void func_565() {
	...
	if (func_583() == 1) {
		...
		switch (iVar0) {
		case 0:
			func_572(vLocal_173, fLocal_176, 0, 0);
			func_567(1);
			if (!graphics::_get_screen_effect_is_active(sLocal_340)) {
				graphics::_start_screen_effect(sLocal_340, 0, 1);
			}
...
void func_567(int iParam0) {
	...
	case 1:
		...
		iLocal_807 = cam::create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", 188.1366f, -957.7827f, 30.6514f, -5.5067f,
												 -8f, 92.8053f, 40f, 0, 2);
		if (cam::does_cam_exist(iLocal_807)) {
			cam::set_cam_active(iLocal_807, 1);
			cam::render_script_cams(1, 0, 3000, 1, 0, 0);
	...
	case 3:
		func_280(player::player_ped_id(), 179.1285f, -961.58f, 29.0923f);
		entity::set_entity_heading(player::player_ped_id(), 143.3596f);
		iLocal_163 = 4;
		break;

	case 4:
		func_280(player::player_ped_id(), 176.0677f, -976.4255f, 29.0923f);
		entity::set_entity_heading(player::player_ped_id(), 324.8268f);
		iLocal_163 = 5;
		break;

	case 5:
		func_280(player::player_ped_id(), 188.0644f, -948.7751f, 29.0923f);
	...
	case 6:
		if (!func_570()) {
			func_280(player::player_ped_id(), 188.932f, -952.0983f, 29.0923f);
	...
	case 7:
		func_280(player::player_ped_id(), 213.3817f, -919.8522f, 29.6929f);
		entity::set_entity_heading(player::player_ped_id(), 323.943f);
		iLocal_163 = 8;
		break;

	case 8:
		func_280(player::player_ped_id(), 209.8298f, -912.4507f, 29.6921f);
		entity::set_entity_heading(player::player_ped_id(), 138.4911f);
		iLocal_163 = 9;
		break;

	case 9: iLocal_163 = 10; break;

	case 10: iLocal_163 = 11; break;

	case 11: iLocal_163 = 1; break;
	}
...
// Position - 0x39433
bool func_570() { return gameplay::is_bit_set(Global_91491.f_20, 13); }
...
// Position - 0x3947A
void func_572(vector3 vParam0, float fParam3, int iParam4, int iParam5) {
	if (func_583()) {
...
int func_574(var *uParam0) {
	...
	case 2:
		...
		if (!entity::does_entity_exist(uParam0->f_28[0])) {
			if (func_576(&uParam0->f_28[0], 49, vVar6, fVar9, "RC LAUNCHER: BARRY 2", 1)) {
...
// Position - 0x398DA
float func_575(float fParam0) { return fParam0 * 57.29578f; }

// Position - 0x398EA
bool func_576(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
	if (func_577(uParam0, iParam1, vParam2, fParam5, 1)) {
...
// Position - 0x39946
bool func_577(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	int iVar0;
...
void func_594(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam2) {
		...
		if (func_78() == 0) {
			iVar0 = func_139(func_337(iParam0), -1, 0);
			gameplay::clear_bit(&iVar0, iParam1);
			func_137(func_337(iParam0), iVar0, -1, 1, 0);
		}
	}
	else {
...
struct<8> func_596(struct<8> Param0, float fParam8) {
	...
	Var0 = 2;
	vVar8 = {func_493(Param0[1 /*3*/] - Param0[0 /*3*/]) * FtoV(fParam8)};
...
//Position - 0x3A1A8
void func_597(var* uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	(*uParam0)[0 /*3*/] = {vParam1};
	(*uParam0)[1 /*3*/] = {vParam4};
	uParam0->f_7 = fParam7;
...
int func_601(var *uParam0, int iParam1) {
	...
	case 4: audio::release_script_audio_bank(); break;
...
void func_603(int iParam0) {
	...
	if (!func_615()) {
		...
		if (iParam0) {
			func_223(iVar0, 1, 0);
			func_604(script::get_this_script_name(), iVar0);
		}
		else {
			if (Global_100787[iVar0 /*10*/].f_9 == -1) {
			}
...
// Position - 0x3A6F7
bool func_605(char *sParam0, int iParam1, int iParam2) {
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
// Position - 0x3A9F7
void func_612() { Global_17151.f_5 = 1; }

// Position - 0x3AA05
void func_613() { Global_17151.f_5 = 0; }
