...
void func_51(int iParam0, char *sParam1, char *sParam2) {
	...
	switch (iParam0) {
	case 1: StringCopy(sParam2, "andy_ig_1_p1_andhisnameisdeath", 64); break;

	case 2: StringCopy(sParam2, "andy_ig_1_p2_cantyouseeitman", 64); break;

	case 3: StringCopy(sParam2, "ANDY_IG_1_P3_MeditateMeditateWellIMeditate", 64); break;

	case 4: StringCopy(sParam2, "ANDY_IG_1_P4_GonnaDrownInFire", 64); break;

	case 5: StringCopy(sParam2, "ANDY_IG_1_P5_YouLoveTheEarth", 64); break;

	case 6: StringCopy(sParam2, "ANDY_IG_1_P6_ThisComplacency", 64); break;

	case 7: StringCopy(sParam2, "ANDY_IG_1_P7_TheyAreComing", 64); break;

	case 8: StringCopy(sParam2, "ANDY_IG_1_P8_ThisIsTheDream", 64); break;

	case 9: StringCopy(sParam2, "ANDY_IG_1_P9_drink_your_own_mothers_bood", 64); break;

	case 10: StringCopy(sParam2, "ANDY_IG_1_P10_MadeThemAngryPrayToYour401k", 64); break;

	case 11: StringCopy(sParam2, "ANDY_IG_1_P11_DontWorryWhenTheyRoastYou", 64); break;

	case 12: StringCopy(sParam2, "ANDY_IG_1_P12_WeAreGoingToBeHarvested", 64); break;

	case 13: StringCopy(sParam2, "ANDY_IG_1_P13_DidYouThinkThereWouldntBeAPriceToPay", 64); break;

	case 14: StringCopy(sParam2, "ANDY_IG_1_P14_YouveGotTwoChoices", 64); break;

	case 15: StringCopy(sParam2, "ANDY_IG_1_P15_TheresNothingLeft", 64); break;
	}
}
