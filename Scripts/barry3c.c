...
int iLocal_457 = 0;
vector3 vLocal_458[9] = {{0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f},
...
void __EntryFunction__() {
	...
	if (entity::does_entity_exist(Local_81.f_35[0])) {
		if (!entity::is_entity_dead(Local_81.f_35[0], 0)) {
			...
			entity::set_entity_load_collision_flag(Local_159.f_4, 1);
			func_441(Local_159.f_4, 0);
		}
	}
	func_440(&iLocal_172, &Local_81.f_41[0]);
	func_431();
	...
	if (func_430()) {
		...
		if (func_396(player::player_ped_id())) {
	...
	while (true) {
		...
		if (iLocal_156 == 13) {
			...
			func_358();
			func_353(&iLocal_143, &uLocal_251, "BAR3CAU", &sLocal_144, &cLocal_150);
			switch (iLocal_156) {
			case 0: func_352(); break;

			case 1: func_350(); break;

			case 2: func_349(); break;

			case 3: func_317(); break;

			case 4: func_314(); break;

			case 5: func_312(); break;

			case 6: func_308(); break;

			case 12: func_243(); break;

			case 7: func_45(); break;

			case 11: func_43(); break;

			case 8: func_42(); break;

			case 9: func_19(); break;
...
void func_1() {
	...
	case 1:
		if (entity::is_entity_in_angled_area(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/], Local_439[0 /*7*/][1 /*3*/],
											 fLocal_454[0], 0, 1, 0)) {
			iLocal_157 = 2;
		}
		else {
...
bool func_2() {
	if (func_396(iLocal_188) && func_396(Local_159.f_4)) {
		if (func_3()) {
			if (vehicle::does_cargobob_have_pick_up_rope(iLocal_188) &&
				vehicle::is_vehicle_attached_to_cargobob(iLocal_188, Local_159.f_4)) {
				bLocal_180 = true;
				return true;
			}
		}
...
bool func_4() {
	...
	if (entity::does_entity_exist(iLocal_188) && ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_188, 0)) {
		...
		if (func_396(iVar0)) {
			...
			if (iVar1 == joaat("towtruck") || iVar1 == joaat("towtruck2") || iVar1 == joaat("cargobob") ||
				iVar1 == joaat("cargobob2") || iVar1 == joaat("cargobob3")) {
				iVar2 = 0;
				...
				iLocal_250 = 0;
				while (iLocal_250 <= 7) {
					if (func_396(Local_191[iLocal_250 /*7*/].f_4) &&
						ped::is_ped_in_vehicle(player::player_ped_id(), Local_191[iLocal_250 /*7*/].f_4, 0)) {
						iVar2 = 1;
	...
	if (iParam0) {
		...
		while (iLocal_250 <= 7) {
			if (entity::does_entity_exist(Local_191[iLocal_250 /*7*/].f_4)) {
				if (!func_9(player::player_ped_id(), Local_191[iLocal_250 /*7*/], 175f) &&
					func_8(player::player_ped_id(), Local_191[iLocal_250 /*7*/].f_4, 1) > 175f) {
					func_6(&Local_191[iLocal_250 /*7*/].f_4);
				}
			}
			else if (!Local_191[iLocal_250 /*7*/].f_6 &&
					 func_9(player::player_ped_id(), Local_191[iLocal_250 /*7*/], 100f)) {
				Local_191[iLocal_250 /*7*/].f_4 = vehicle::create_vehicle(
					joaat("towtruck"), Local_191[iLocal_250 /*7*/], Local_191[iLocal_250 /*7*/].f_3, 1, 1);
				if (iLocal_250 == 6) {
...
// Position - 0x83F
void func_11(int iParam0, int iParam1) { vLocal_458[iParam0 /*3*/].f_1 = iParam1; }
		...
		if (!ped::is_ped_in_vehicle(player::player_ped_id(), Local_159.f_4, 0)) {
			...
			case 0:
				if (bLocal_427) {
					...
					if (audio::request_script_audio_bank("BARRY3C_IGNITION_FAIL", 0, -1) &&
						streaming::has_anim_dict_loaded(sLocal_429)) {
			...
			case 2:
				ai::open_sequence_task(&iLocal_430);
				...
				ai::close_sequence_task(iLocal_430);
				ai::clear_ped_tasks(player::player_ped_id());
				ai::task_perform_sequence(player::player_ped_id(), iLocal_430);
				ai::clear_sequence_task(&iLocal_430);
			...
			case 3:
				if (gameplay::get_game_timer() > iLocal_421) {
					audio::play_sound_from_entity(iLocal_426, "IGNITION_FAIL", Local_159.f_4, "BARRY_03_SOUNDSET", 0,
												  0);
...
void func_19() {
	...
	case 1:
		...
		else if (entity::is_entity_in_angled_area(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/],
												  Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 0, 0, 0) &&
				 !entity::is_entity_in_air(Local_159.f_4)) {
			...
			if (func_2()) {
				if (player::get_player_wanted_level(player::player_id()) > 0) {
					iLocal_156 = 11;
														  ...
														  Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 0, 1, 0)) {
					iLocal_156 = 6;
				}
				else {
					iLocal_156 = 5;
...
// Position - 0x185A
void func_44(int iParam0) { ui::clear_this_print(vLocal_458[iParam0 /*3*/].f_2); }
...
void func_45() {
	...
	case 1:
		if (entity::is_entity_in_angled_area(Local_159.f_4, Local_439[1 /*7*/][0 /*3*/], Local_439[1 /*7*/][1 /*3*/],
											 fLocal_454[1], 0, 1, 0)) {
...
void func_50() {
	...
	if (fVar8 > 0f && system::floor(fVar8) < system::floor(Global_101700.f_9153.f_3853)) {
		func_52(13, system::floor(Global_101700.f_9153.f_3853));
	}
...
// Position - 0x20C6
int func_51() { return Global_25190; }
...
// Position - 0x2662
void func_64() { func_65(&Global_96040); }
...
// Position - 0x2DB2
void func_71(int *iParam0) { *iParam0 = -15; }
...
int func_75(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam1 == 12) {
		...
		if (ped::get_number_of_ped_drawable_variations(iParam0, func_118(iParam1)) > 0 &&
			ped::get_number_of_ped_texture_variations(iParam0, func_118(iParam1), Global_69523[1 /*14*/].f_3) > 0) {
			ped::set_ped_component_variation(iParam0, func_118(iParam1), Global_69523[1 /*14*/].f_3,
...
bool func_76(int iParam0, int iParam1, int *iParam2) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_63 != -99) {
		if (!func_190(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_64,
...
// Position - 0x319B
int func_78(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	if (iParam1 == 12) {
			...
			if (uVar11[iVar0] != -99) {
				...
				if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0)) {
					if (iVar0 == 13) {
						...
						if (iParam4 == -1) {
							ped::set_ped_component_variation(iParam0, func_118(iVar0), Global_69523[1 /*14*/].f_3,
															 Global_69523[1 /*14*/].f_4,
															 ped::get_ped_palette_variation(iParam0, func_118(iVar0)));
						}
						else {
							ped::set_ped_component_variation(iParam0, func_118(iVar0), Global_69523[1 /*14*/].f_3,
		...
		if (iParam4 == -1) {
			ped::set_ped_component_variation(iParam0, func_118(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4,
											 ped::get_ped_palette_variation(iParam0, func_118(iParam1)));
		}
		else {
			ped::set_ped_component_variation(iParam0, func_118(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4, iParam4);
...
// Position - 0x3B39
bool func_82(int iParam0, int iParam1, int iParam2, int iParam3, var *uParam4, var *uParam5) {
	var uVar0;
	int iVar10;
...
void func_110(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_114(iParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3)) {
...
int func_113(int iParam0, int iParam1, int iParam2) {
	...
	iVar0 = Global_2503826[iParam0 /*3*/][func_112(iParam1)];
...
// Position - 0x7486
bool func_114(int iParam0, int iParam1, int *iParam2, int *iParam3, bool bParam4, bool bParam5) {
	int iVar0;
...
// Position - 0x8678
bool func_115(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	if (iParam0 == 0) {
		if (iParam5 == 1) {
...
bool func_117(int iParam0, int iParam1, int *iParam2, int iParam3) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_60 != -99) {
		if (!func_190(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_61,
...
struct<10> func_119(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		switch (iParam1) {
		case 31: func_121(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 0: func_121(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_121(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_121(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_121(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_121(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8); break;

		case 5: func_121(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8); break;

		case 6: func_121(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_121(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_121(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_121(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8); break;

		default: func_120(&Var1, iParam0, iParam1, 10); break;
		}
		break;
	...
	case joaat("player_one"):
		...
		case 1: func_121(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8); break;

		case 2: func_121(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8); break;

		case 3: func_121(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_121(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_121(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_121(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_121(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_121(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_120(&Var1, iParam0, iParam1, 9); break;
		}
		break;
	...
	case joaat("player_two"):
		...
		case 0: func_121(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_121(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_121(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_121(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8); break;

		case 4: func_121(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8); break;

		case 5: func_121(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_121(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_121(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_121(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8); break;
	...
	case joaat("mp_m_freemode_01"):
		...
		case 0: func_121(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_121(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_121(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_121(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_121(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_121(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_121(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_121(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_121(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_121(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_121(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_121(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_121(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_121(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 14: func_121(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_121(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_121(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_121(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_121(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_121(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_121(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_121(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_121(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_121(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 24: func_121(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_120(&Var1, iParam0, iParam1, 25); break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 0: func_121(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_121(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_121(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_121(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_121(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_121(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_121(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_121(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_121(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_121(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_121(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_121(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_121(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_121(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8); break;

		case 14: func_121(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_121(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_121(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_121(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_121(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_121(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_121(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_121(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_121(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_121(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8); break;
...
// Position - 0xA186
void func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
struct<17> func_122(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		...
		case 1: func_125(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0); break;

		case 2: func_125(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8); break;

		case 3: func_125(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31); break;

		case 4: func_125(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2); break;

		case 5:
			func_125(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[0], Global_101700.f_2095.f_539.f_200[0], 6, 3, 0,
					 0, 0, -99, 0, 0, 3);
			break;

		case 6: func_125(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_125(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 8: func_125(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 9: func_125(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 10: func_125(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4); break;

		case 11: func_125(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5); break;

		case 12: func_125(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31); break;

		case 13: func_125(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 14: func_125(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6); break;

		case 15: func_125(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31); break;

		case 16: func_125(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31); break;

		case 17: func_125(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 18: func_125(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7); break;

		case 19: func_125(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 20: func_125(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 21: func_125(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_125(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 23: func_125(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31); break;

		case 24: func_125(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31); break;

		case 25: func_125(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 26: func_125(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 27: func_125(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 28: func_125(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 29: func_125(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 30: func_125(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 31: func_125(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31); break;

		case 32: func_125(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 33: func_125(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 34: func_125(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31); break;

		case 35: func_125(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 36: func_125(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 37: func_125(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 38: func_125(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 39: func_125(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 40: func_125(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 41: func_125(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_125(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_125(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_125(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 45: func_125(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 46: func_125(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_125(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 48: func_125(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31); break;

		case 49: func_125(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 50: func_125(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9); break;

		case 51: func_125(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 52: func_125(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		default: func_123(&Var1, iParam0, iParam1, 53); break;
		}
		break;

	case joaat("player_one"):
		switch (iParam1) {
		case 0: func_125(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 1: func_125(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 2:
			func_125(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[1], Global_101700.f_2095.f_539.f_200[1], 17, 2,
					 26, 0, 0, -99, 0, 45, 31);
			break;

		case 3: func_125(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1); break;

		case 4: func_125(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2); break;

		case 5: func_125(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 6: func_125(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_125(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3); break;

		case 8: func_125(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5); break;

		case 9: func_125(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 10: func_125(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 11: func_125(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 12: func_125(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 13: func_125(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 14: func_125(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 15: func_125(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 16: func_125(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 17: func_125(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 18: func_125(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31); break;

		case 19: func_125(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 20: func_125(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 21: func_125(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4); break;

		case 22: func_125(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31); break;

		case 23: func_125(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31); break;

		case 24: func_125(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31); break;

		case 25: func_125(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31); break;

		case 26: func_125(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31); break;

		case 27: func_125(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31); break;

		case 28: func_125(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31); break;

		case 29: func_125(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31); break;

		case 30: func_125(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31); break;

		case 31: func_125(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31); break;

		case 32: func_125(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31); break;

		case 33: func_125(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31); break;

		case 34: func_125(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31); break;

		case 35: func_125(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31); break;

		case 36: func_125(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31); break;

		case 37: func_125(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31); break;

		case 38: func_125(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 39: func_125(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 40: func_125(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 41: func_125(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 42: func_125(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31); break;

		case 43: func_125(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6); break;

		case 44: func_125(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 45: func_125(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8); break;

		case 46: func_125(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31); break;

		default: func_123(&Var1, iParam0, iParam1, 47); break;
		}
		break;

	case joaat("player_two"):
		switch (iParam1) {
		case 0: func_125(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 1: func_125(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8); break;

		case 2: func_125(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1); break;

		case 3: func_125(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2); break;

		case 4:
			func_125(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[2], Global_101700.f_2095.f_539.f_200[2], 8, 0, 0,
					 0, 0, -99, 0, 0, 31);
			break;

		case 5: func_125(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6); break;

		case 6: func_125(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3); break;

		case 7: func_125(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4); break;

		case 8: func_125(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31); break;

		case 9: func_125(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 10: func_125(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 11: func_125(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5); break;

		case 12: func_125(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 13: func_125(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31); break;

		case 14: func_125(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31); break;

		case 15: func_125(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 16: func_125(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 17: func_125(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 18: func_125(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 19: func_125(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 20: func_125(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 21: func_125(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_125(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 23: func_125(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 24: func_125(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 25: func_125(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 26: func_125(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 27: func_125(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 28: func_125(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 29: func_125(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 30: func_125(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 31: func_125(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 32: func_125(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 33: func_125(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 34: func_125(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 35: func_125(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 36: func_125(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 37: func_125(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 38: func_125(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 39: func_125(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 40: func_125(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 41: func_125(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_125(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_125(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_125(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31); break;

		case 45: func_125(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 46: func_125(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_125(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31); break;

		default: func_123(&Var1, iParam0, iParam1, 48); break;
		}
		break;

	case joaat("mp_m_freemode_01"):
		switch (iParam1) {
		case 0: func_125(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31); break;

		case 1: func_125(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0); break;

		case 2: func_125(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1); break;

		case 3: func_125(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2); break;

		case 4: func_125(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3); break;

		case 5: func_125(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4); break;

		case 6: func_125(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5); break;

		case 7: func_125(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6); break;

		case 8: func_125(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7); break;

		case 9: func_125(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8); break;

		case 10: func_125(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9); break;

		case 11: func_125(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10); break;

		case 12: func_125(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11); break;

		case 13: func_125(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12); break;

		case 14: func_125(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13); break;

		case 15: func_125(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14); break;

		case 16: func_125(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15); break;

		case 17: func_125(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16); break;

		case 18: func_125(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17); break;

		case 19: func_125(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18); break;

		case 20: func_125(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19); break;

		case 21: func_125(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20); break;

		case 22: func_125(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21); break;

		case 23: func_125(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22); break;

		case 24: func_125(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23); break;

		case 25: func_125(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24); break;

		default: func_123(&Var1, iParam0, iParam1, 26); break;
		}
		break;

	case joaat("mp_f_freemode_01"):
		switch (iParam1) {
		case 0: func_125(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31); break;

		case 1: func_125(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31); break;

		case 2: func_125(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0); break;

		case 3: func_125(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1); break;

		case 4: func_125(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2); break;

		case 5: func_125(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3); break;

		case 6: func_125(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4); break;

		case 7: func_125(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5); break;

		case 8: func_125(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6); break;

		case 9: func_125(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7); break;

		case 10: func_125(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8); break;

		case 11: func_125(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9); break;

		case 12: func_125(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10); break;

		case 13: func_125(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31); break;

		case 14: func_125(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11); break;

		case 15: func_125(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12); break;

		case 16: func_125(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13); break;

		case 17: func_125(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14); break;

		case 18: func_125(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15); break;

		case 19: func_125(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16); break;

		case 20: func_125(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17); break;

		case 21: func_125(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31); break;

		case 22: func_125(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18); break;

		case 23: func_125(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19); break;

		case 24: func_125(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20); break;

		case 25: func_125(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21); break;

		case 26: func_125(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22); break;

		case 27: func_125(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23); break;

		default: func_123(&Var1, iParam0, iParam1, 28); break;
		}
		break;
	}
	return Var1;
...
// Position - 0xC2B2
void func_125(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) {
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
{
	switch (iParam0) {
	case 0: func_151(iParam1); break;

	case 2: func_150(iParam1); break;

	case 3: func_147(iParam1); break;

	case 4: func_146(iParam1); break;

	case 6: func_145(iParam1); break;

	case 5: func_144(iParam1); break;

	case 8: func_143(iParam1); break;

	case 9: func_142(iParam1); break;

	case 10: func_141(iParam1); break;

	case 1: func_140(iParam1); break;

	case 7: func_139(iParam1); break;

	case 11: func_138(iParam1); break;

	case 12: func_137(iParam1); break;

	case 13: func_136(iParam1); break;
...
void func_128(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 155); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

// Position - 0xD6DB
void func_129(var *uParam0, int iParam1, int iParam2, char *sParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
void func_135(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 == 12) {
		...
		while (iVar38 < iVar40) {
			...
			if (!dlc1::_is_dlc_data_empty(Var20)) {
				if (iVar39 == iParam1 - iParam2) {
					...
					func_129(&Global_69523[0 /*14*/], iParam0, iParam1, &Var20.f_9, Var20.f_3, Var20.f_4, Var20.f_5,
		...
		iVar59 = 0;
		iVar60 = dlc1::_get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_118(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60) {
			...
			if (!dlc1::_is_dlc_data_empty(Var41)) {
				if (iVar59 == iParam1 - iParam2) {
					...
					func_129(&Global_69523[0 /*14*/], iParam0, iParam1, &Var41.f_9, Var41.f_3, Var41.f_4, Var41.f_5,
...
void func_136(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 9); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_137(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 48); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_138(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 1); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_140(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 6); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_141(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 33); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_142(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 17); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_143(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 18); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_144(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 7); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_145(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 84); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_146(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 104); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_152(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_170(iParam1); break;

	case 2: func_169(iParam1); break;

	case 3: func_165(iParam1); break;

	case 4: func_164(iParam1); break;

	case 6: func_163(iParam1); break;

	case 5: func_162(iParam1); break;

	case 8: func_161(iParam1); break;

	case 9: func_160(iParam1); break;

	case 10: func_159(iParam1); break;

	case 1: func_158(iParam1); break;

	case 7: func_157(iParam1); break;

	case 11: func_156(iParam1); break;

	case 12: func_155(iParam1); break;

	case 13: func_154(iParam1); break;
...
void func_153(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 175); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_155(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 47); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_156(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 63); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_158(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 5); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_159(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 53); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_160(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 12); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_161(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 77); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_163(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 134); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_164(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 117); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_169(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 21); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_170(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 10); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_171(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_188(iParam1); break;

	case 2: func_187(iParam1); break;

	case 3: func_184(iParam1); break;

	case 4: func_183(iParam1); break;

	case 6: func_182(iParam1); break;

	case 5: func_181(iParam1); break;

	case 8: func_180(iParam1); break;

	case 9: func_179(iParam1); break;

	case 10: func_178(iParam1); break;

	case 1: func_177(iParam1); break;

	case 7: func_176(iParam1); break;

	case 11: func_175(iParam1); break;

	case 12: func_174(iParam1); break;

	case 13: func_173(iParam1); break;

	case 14: func_172(iParam1); break;
	}
}
...
void func_172(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 113); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_175(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 45); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_179(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 20); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_180(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 24); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_181(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 14); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_182(int iParam0) {
	...
	default: func_135(iVar10, iParam0, 99); return;
	}
	func_129(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
bool func_190(int iParam0, int iParam1, int iParam2) {
	...
	else if (Global_69523[1 /*14*/].f_3 == ped::get_ped_drawable_variation(iParam0, func_118(iParam1)) &&
			 Global_69523[1 /*14*/].f_4 == ped::get_ped_texture_variation(iParam0, func_118(iParam1))) {
		return true;
	}
	return false;
}
...
void func_197(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 != -1) {
		...
		func_198(&sVar32, Var0.f_3, Global_91528, iParam1, iParam2);
	}
}
...
void func_199(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_200(uParam1, "Abigail1", func_193(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				 "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_201(iParam0), 1, 0);
		break;

	case 1:
		func_200(uParam1, "Abigail2", func_193(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				 -1, 4, 1, 0, 2359, func_201(iParam0), 1, 0);
		break;

	case 2:
		func_200(uParam1, "Barry1", func_193(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				 4, 1, 0, 2359, func_201(iParam0), 1, 0);
		break;

	case 3:
		func_200(uParam1, "Barry2", func_193(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				 4, 4, 0, 2359, func_201(iParam0), 1, 1);
		break;

	case 4:
		func_200(uParam1, "Barry3", func_193(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2,
				 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 5:
		func_200(uParam1, "Barry3A", func_193(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0,
				 "", 166, 0, 7, 4, 2, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 6:
		func_200(uParam1, "Barry3C", func_193(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				 7, 4, 2, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 7:
		func_200(uParam1, "Barry4", func_193(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0,
				 "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_201(iParam0), 0, 0);
		break;

	case 8:
		func_200(uParam1, "Dreyfuss1", func_193(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				 0, "", 0, 0, -1, 4, 2, 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 9:
		func_200(uParam1, "Epsilon1", func_193(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1,
				 10, 4, 1, 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 10:
		func_200(uParam1, "Epsilon2", func_193(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0,
				 11, 4, 1, 0, 2359, func_201(iParam0), 1, 0);
		break;

	case 11:
		func_200(uParam1, "Epsilon3", func_193(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				 0, 0, 12, 4, 1, 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 12:
		func_200(uParam1, "Epsilon4", func_193(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				 "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 13:
		func_200(uParam1, "Epsilon5", func_193(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16,
				 "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_201(iParam0), 1, 0);
		break;

	case 14:
		func_200(uParam1, "Epsilon6", func_193(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 15:
		func_200(uParam1, "Epsilon7", func_193(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 16:
		func_200(uParam1, "Epsilon8", func_193(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_201(iParam0), 1, 0);
		break;

	case 17:
		func_200(uParam1, "Extreme1", func_193(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 18:
		func_200(uParam1, "Extreme2", func_193(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 19:
		func_200(uParam1, "Extreme3", func_193(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 20:
		func_200(uParam1, "Extreme4", func_193(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 21:
		func_200(uParam1, "Fanatic1", func_193(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_201(iParam0), 1, 0);
		break;

	case 22:
		func_200(uParam1, "Fanatic2", func_193(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_201(iParam0), 1, 0);
		break;

	case 23:
		func_200(uParam1, "Fanatic3", func_193(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_201(iParam0), 0, 1);
		break;

	case 24:
		func_200(uParam1, "Hao1", func_193(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_201(iParam0), 0, 1);
		break;

	case 25:
		func_200(uParam1, "Hunting1", func_193(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 26:
		func_200(uParam1, "Hunting2", func_193(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 27:
		func_200(uParam1, "Josh1", func_193(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_201(iParam0), 1, 0);
		break;

	case 28:
		func_200(uParam1, "Josh2", func_193(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_201(iParam0), 1, 1);
		break;

	case 29:
		func_200(uParam1, "Josh3", func_193(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_201(iParam0), 1, 1);
		break;

	case 30:
		func_200(uParam1, "Josh4", func_193(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_201(iParam0), 1, 0);
		break;

	case 31:
		func_200(uParam1, "Maude1", func_193(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 32:
		func_200(uParam1, "Minute1", func_193(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 33:
		func_200(uParam1, "Minute2", func_193(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 34:
		func_200(uParam1, "Minute3", func_193(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 35:
		func_200(uParam1, "MrsPhilips1", func_193(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 36:
		func_200(uParam1, "MrsPhilips2", func_193(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_201(iParam0), 0, 0);
		break;

	case 37:
		func_200(uParam1, "Nigel1", func_193(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_201(iParam0), 1, 0);
		break;

	case 38:
		func_200(uParam1, "Nigel1A", func_193(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_201(iParam0), 1, 1);
		break;

	case 39:
		func_200(uParam1, "Nigel1B", func_193(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_201(iParam0), 1, 1);
		break;

	case 40:
		func_200(uParam1, "Nigel1C", func_193(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_201(iParam0), 1, 1);
		break;

	case 41:
		func_200(uParam1, "Nigel1D", func_193(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_201(iParam0), 1, 1);
		break;

	case 42:
		func_200(uParam1, "Nigel2", func_193(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_201(iParam0), 1, 1);
		break;

	case 43:
		func_200(uParam1, "Nigel3", func_193(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_201(iParam0), 1, 1);
		break;

	case 44:
		func_200(uParam1, "Omega1", func_193(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 45:
		func_200(uParam1, "Omega2", func_193(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 46:
		func_200(uParam1, "Paparazzo1", func_193(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 47:
		func_200(uParam1, "Paparazzo2", func_193(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 48:
		func_200(uParam1, "Paparazzo3", func_193(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 49:
		func_200(uParam1, "Paparazzo3A", func_193(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 50:
		func_200(uParam1, "Paparazzo3B", func_193(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 51:
		func_200(uParam1, "Paparazzo4", func_193(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 52:
		func_200(uParam1, "Rampage1", func_193(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 54:
		func_200(uParam1, "Rampage3", func_193(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_201(iParam0), 1, 0);
		break;

	case 55:
		func_200(uParam1, "Rampage4", func_193(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_201(iParam0), 1, 0);
		break;

	case 56:
		func_200(uParam1, "Rampage5", func_193(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_201(iParam0), 0, 0);
		break;

	case 53:
		func_200(uParam1, "Rampage2", func_193(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_201(iParam0), 1, 0);
		break;

	case 57:
		func_200(uParam1, "TheLastOne", func_193(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 58:
		func_200(uParam1, "Tonya1", func_193(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 59:
		func_200(uParam1, "Tonya2", func_193(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_201(iParam0), 0, 1);
		break;

	case 60:
		func_200(uParam1, "Tonya3", func_193(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_201(iParam0), 0, 1);
		break;

	case 61:
		func_200(uParam1, "Tonya4", func_193(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_201(iParam0), 0, 1);
		break;

	case 62:
		func_200(uParam1, "Tonya5", func_193(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_201(iParam0), 0, 1);
		break;
...
// Position - 0x2175D
void func_200(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
// Position - 0x21B34
void func_202(int iParam0) { Global_36332 = gameplay::get_game_timer() + iParam0; }

// Position - 0x21B46
void func_203() {
	if (Global_89136) {
		func_29();
		graphics::_0xBF59707B3E5ED531(func_204(Global_101700.f_2095.f_539.f_3549));
	}
	else {
...
void func_209(int iParam0, int iParam1) {
	...
	func_227(iParam0, G_TextMessageConfig);
	if (!iParam1) {
...
// Position - 0x22196
int func_212() { return Global_101700.f_8975.f_21 + Global_101700.f_17533.f_380; }
...
void func_215(int iParam0) {
	switch (iParam0) {
	case 30: func_219(22, 1, 0, 1, 0); break;

	case 15: func_216(37, 0); break;
...
void func_219(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	if (iParam0 != 198) {
		...
		func_222(iParam0, iParam3, iParam4, 0);
...
// Position - 0x22766
bool func_222(int iParam0, bool bParam1, int iParam2, int iParam3) {
	bool bVar0;
	int iVar1;
	int iVar2;
	struct<5> Var3;
...
// Position - 0x230BB
int func_224() { return Global_25191; }
...
void func_227(int iParam0, bool bParam1) {
	switch (iParam0) {
	case 46: func_228(4, bParam1); break;

	case 16: func_228(6, bParam1); break;

	case 37: func_228(17, bParam1); break;

	case 31: func_228(16, bParam1); break;
	}
}
...
// Position - 0x26A0C
void func_229(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8) {
	func_230(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

// Position - 0x26A2D
void func_230(char *sParam0, char *sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6,
...
// Position - 0x27024
int func_238() { return func_239(script::get_this_script_name(), 0); }
...
void func_244(int iParam0, char *sParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	...
	if (iVar0 == 1) {
		...
		iVar1 = func_304(script::get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94) {
...
void func_245(int iParam0, var uParam1, int iParam2, int iParam3) {
	func_246(&Global_96040, script::get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_246(var *uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) {
	...
	*uParam0 = func_28();
	...
	while (iVar1 < 3) {
		...
		if (iVar1 == func_267()) {
			func_263(player::player_ped_id(), &uParam0->f_616[iVar1 /*65*/], 1);
		}
		else {
			iVar0 = 0;
			while (iVar0 < 12) {
...
// Position - 0x28B59
bool func_260(int iParam0, var *uParam1, int iParam2, int iParam3) {
	char *sVar0;
...
bool func_264(int iParam0, int iParam1) {
	...
	iVar0 = Global_2522581[iParam0 /*3*/][func_112(iParam1)];
...
// Position - 0x28FA7
void func_265(int iParam0, int iParam1, int *iParam2, int *iParam3, int iParam4, int iParam5) {
	int iVar0;
...
// Position - 0x294EF
void func_266(int iParam0, int iParam1, int *iParam2, int *iParam3, var *uParam4, int iParam5, int iParam6) {
	int iVar0;
...
void func_269(int iParam0, var *uParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		iVar7 = 0;
		while (iVar7 < iVar8) {
			if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_270(Var9.f_1) && iVar70 < 50) {
...
// Position - 0x2AF40
bool func_276(vector3 vParam0, char *sParam3, vector3 vParam4) {
	int iVar0;
	int iVar1;
...
// Position - 0x2AF84
bool func_277(int iParam0, var *uParam1, float *fParam2) {
	*uParam1 = {0f, 0f, 0f};
	*fParam2 = 0f;
	switch (iParam0) {
	case 0:
...
// Position - 0x2B613
bool func_278(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
bool func_279(int *iParam0) {
	if (!entity::is_entity_dead(player::player_ped_id(), 0) && !ped::is_ped_injured(player::player_ped_id())) {
		if (func_289()) {
			*iParam0 = func_284(entity::get_entity_coords(player::player_ped_id(), 0), 6, -1, 0, 1, -1);
			if (func_283(*iParam0) && !func_280(*iParam0)) {
				return true;
			}
		}
	}
...
// Position - 0x2B6B5
bool func_280(int iParam0) { return func_281(iParam0, 0, 1); }
...
bool func_281(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_51() == 0) {
			return gameplay::is_bit_set(func_113(func_282(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0x2B9EC
bool func_283(int iParam0) { return func_281(iParam0, 5, 1); }

// Position - 0x2B9FC
int func_284(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
	...
	while (iVar0 <= 45) {
		if (iParam3 == 6 || iParam3 == func_288(iVar0)) {
			if (!iParam5 || func_287(iVar0)) {
				fVar1 = gameplay::get_distance_between_coords(vParam0, func_285(iVar0, 0), 1);
...
Vector3 func_285(int iParam0, int iParam1) {
	...
	case 45: return func_286(Global_93004);
	}
...
// Position - 0x2C0CF
bool func_287(int iParam0) { return func_281(iParam0, 0, 0); }
...
// Position - 0x2C352
bool func_289() { return Global_91543.f_303 > 0; }

// Position - 0x2C363
var func_290() {
	int *iVar0;

	func_300(&iVar0, time::get_clock_seconds());
	func_299(&iVar0, time::get_clock_minutes());
	func_298(&iVar0, time::get_clock_hours());
	func_293(&iVar0, time::get_clock_day_of_month());
	func_292(&iVar0, time::get_clock_month());
	func_291(&iVar0, time::get_clock_year());
	return iVar0;
}
...
var func_295(int iParam0) {
	return (system::shift_right(iParam0, 26) & 31) * func_296(gameplay::is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
// Position - 0x2C591
int func_297(var uParam0) { return uParam0 & 15; }
...
int func_302(int iParam0) {
	switch (iParam0) {
	case 69:
	case 70: return func_303(Global_101700.f_8044.f_99.f_205[10]);

	case 74:
	case 75: return func_303(Global_101700.f_8044.f_99.f_205[8]);

	case 84:
	case 85: return func_303(Global_101700.f_8044.f_99.f_205[11]);

	case 90: return func_303(Global_101700.f_8044.f_99.f_205[7]);

	case 93: return func_303(Global_101700.f_8044.f_99.f_205[9]);
	}
	return 0;
}
...
// Position - 0x2CA97
bool func_307(var *uParam0, int iParam1, char *sParam2, char *sParam3, int iParam4, int iParam5, int iParam6,
...
void func_308() {
	...
	case 1:
		if (player::get_player_wanted_level(player::player_id()) > 0) {
			...
			if (entity::is_entity_in_angled_area(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/],
												 Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 0, 1, 0)) {
				func_41(&iLocal_158);
				if (!iLocal_420) {
			...
			else if (!entity::is_entity_in_angled_area(Local_159.f_4, Local_439[1 /*7*/][0 /*3*/],
													   Local_439[1 /*7*/][1 /*3*/], fLocal_454[1], 0, 1, 0)) {
				iLocal_156 = 10;
				iLocal_157 = 0;
			}
		}
	...
	case 2:
		...
		if (player::get_player_wanted_level(player::player_id()) > 0) {
			...
			if (entity::is_entity_in_angled_area(Local_159.f_4, Local_439[1 /*7*/][0 /*3*/],
												 Local_439[1 /*7*/][1 /*3*/], fLocal_454[1], 0, 1, 0)) {
				func_310(0, -1);
				if (!iLocal_181) {
					func_309(747);
...
void func_312() {
	...
	case 0:
		func_41(&iLocal_158);
		iLocal_158 = func_313(vLocal_182, 5, 1);
	...
	case 1:
		...
		if (!func_4()) {
			...
			if (func_3()) {
				if (entity::is_entity_in_angled_area(Local_159.f_4, Local_439[1 /*7*/][0 /*3*/],
													 Local_439[1 /*7*/][1 /*3*/], fLocal_454[1], 0, 0, 0)) {
			...
			iLocal_157 = 2;
												  ...
												  Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 1, 1, 0)) {
			iLocal_157 = 2;
		}
		else if (iLocal_486) {
			if (!func_15()) {
	...
	case 2:
		...
		if (!func_4()) {
			...
			if (func_3() && entity::is_entity_in_angled_area(Local_159.f_4, Local_439[0 /*7*/][0 /*3*/],
															 Local_439[0 /*7*/][1 /*3*/], fLocal_454[0], 0, 0, 0)) {
				if (!entity::is_entity_in_air(Local_159.f_4)) {
					vVar0 = {entity::get_entity_coords(Local_159.f_4, 1)};
					if (vVar0.z < 6.7f) {
...
void func_314() {
	...
	case 1:
		if (!iLocal_419 &&
			entity::is_entity_in_angled_area(player::player_ped_id(), -458.11f, -1725.3f, 17.67f, -456.71f, -1701.81f,
											 22f, 17.5f, 0, 1, 0) &&
			!func_2() && !func_3()) {
			func_311("B3CTTHB", -1);
			iLocal_419 = 1;
...
void func_317() {
	...
	case 1:
		if (iLocal_248) {
			...
			else if (entity::is_entity_in_angled_area(player::player_ped_id(), -417.58f, -1723.81f, 15.42f, -473.6f,
													  -1705.96f, 26.95f, 49f, 0, 1, 0)) {
				iLocal_157 = 2;
			}
			else if (func_2()) {
				iLocal_157 = 2;
...
// Position - 0x2D457
bool func_318(var *uParam0, int iParam1, char *sParam2, char *sParam3, int iParam4, int iParam5, int iParam6,
			  int iParam7) {
	...
	Global_15799 = 0;
	Global_2621441 = 0;
	return func_22(sParam3, iParam4, iParam7);
}
...
// Position - 0x2D542
void func_321(vector3 vParam0, float *fParam3, int iParam4, int iParam5) {
	vector3 vVar0;
	float *fVar3;
	...
	if (entity::does_entity_exist(Global_93635.f_4)) {
		if (vehicle::is_vehicle_driveable(Global_93635.f_4, 0)) {
			if (func_348(24) != Global_93635.f_4) {
				if (iParam4 == 1) {
					if (func_345(entity::get_entity_coords(Global_93635.f_4, 1), iParam5, &vVar0, &fVar3)) {
						vParam0 = {vVar0};
						fParam3 = fVar3;
					}
				}
				func_322(Global_93635.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
// Position - 0x2D5BD
void func_322(int iParam0, vector3 vParam1, float *fParam4, int iParam5, int iParam6) {
	struct<60> Var0;
	...
	if (entity::does_entity_exist(iParam0) && vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (func_278(vParam1, 0f, 0f, 0f, 0)) {
		...
		func_341(iParam5, &Var0, vParam1, fParam4, func_253(iParam0));
...
int func_325(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_261(iParam0, 0, 0) ||
		func_261(iParam0, 1, 0) || func_261(iParam0, 2, 0) || func_253(iParam0) != 145 || func_339(iParam0) ||
		func_338(iParam0) || func_337(iParam0) || func_336(iParam0) || !func_326(entity::get_entity_model(iParam0))) {
		if (func_338(iParam0)) {
		}
		if (func_338(iParam0)) {
		}
...
// Position - 0x2EC44
int func_331() { return 0; }

// Position - 0x2EC4D
int func_332() { return 1; }

// Position - 0x2EC56
int func_333() { return 1; }
...
// Position - 0x3087C
bool func_345(vector3 vParam0, int iParam3, var *uParam4, float *fParam5) {
	int iVar0;

	iVar0 = func_346(vParam0, iParam3, 1);
	switch (iVar0) {
	case 0:
...
// Position - 0x30992
int func_346(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
...
// Position - 0x30A21
var func_347(int iParam0) { return gameplay::is_bit_set(Global_101700.f_6188[iParam0], 0); }
...
void func_350() {
	...
	case 1:
		if (!bLocal_427 && iLocal_424 != 0 && iLocal_425 > 0 && iLocal_425 < 4 &&
			controls::is_disabled_control_just_pressed(0, 75)) {
			bLocal_427 = true;
		}
		switch (iLocal_424) {
		case 0:
		...
		case 2:
			if (vehicle::get_ped_in_vehicle_seat(Local_159.f_4, -1, 0) == player::player_ped_id() &&
				ped::is_ped_sitting_in_vehicle(player::player_ped_id(), Local_159.f_4)) {
				if (iLocal_425 == 3) {
					ai::open_sequence_task(&iLocal_430);
					ai::task_play_anim(0, sLocal_429, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
					...
					if (func_21(&uLocal_251, "BAR3CAU", "BAR3C_C1", 7, 0, 0, 0)) {
						ai::open_sequence_task(&iLocal_430);
						ai::task_play_anim(0, sLocal_429, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0,
										   0);
						ai::task_play_anim(0, sLocal_429, "franklinfailingtostartcar_loop", 8f, -8f,
										   1200 + iLocal_425 * 250, 9, 0, 0, 0, 0);
						ai::task_play_anim(0, sLocal_429, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0,
										   0);
						ai::close_sequence_task(iLocal_430);
						ai::task_perform_sequence(player::player_ped_id(), iLocal_430);
						ai::clear_sequence_task(&iLocal_430);
		...
		case 3:
			if (gameplay::get_game_timer() > iLocal_421) {
				if (iLocal_425 == 4) {
					...
					audio::play_sound_from_entity(iLocal_426, "IGNITION_FAIL", Local_159.f_4, "BARRY_03_SOUNDSET", 0,
												  0);
					audio::set_variable_on_sound(iLocal_426, "HOLD TIME",
												 system::to_float(1200 + iLocal_425 * 250) / 1000f);
		...
		case 4:
			if (gameplay::get_game_timer() > iLocal_421) {
				if (bLocal_427) {
					...
					iLocal_425++;
					if (iLocal_425 == 4) {
						ai::task_play_anim(player::player_ped_id(), sLocal_429, "franklinfailingtostartcar_slamwheel",
										   1000f, -8f, 3300, 0, 0, 0, 0, 0);
...
// Position - 0x3119A
void func_353(int *iParam0, var *uParam1, char *sParam2, char *sParam3, char *sParam4) {
	switch (*iParam0) {
	case 0: break;
	...
	case 4:
		if (!audio::is_scripted_conversation_ongoing() && func_354(uParam1, sParam2, sParam3, sParam4, 8, 0, 0)) {
			*iParam0 = 0;
		}
		break;
	}
...
void func_360() {
	...
	case 1:
		if (func_376()) {
			if (func_396(Local_159.f_4) && func_396(iLocal_188) &&
				entity::is_entity_attached_to_entity(Local_159.f_4, iLocal_188)) {
...
void func_361() {
	if (func_396(Local_159.f_4)) {
		entity::set_entity_load_collision_flag(Local_159.f_4, 0);
	}
	func_10(&iLocal_188);
...
// Position - 0x3160C
void func_363(var *uParam0, bool bParam1) { func_364(&uParam0->f_41, bParam1); }
...
// Position - 0x31697
void func_366(var *uParam0, bool bParam1) { func_367(&uParam0->f_35, bParam1); }
...
// Position - 0x316E6
void func_368(var *uParam0, int iParam1) { func_369(&uParam0->f_28, iParam1); }
...
void func_374(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam2) {
		...
		if (func_51() == 0) {
			iVar0 = func_113(func_282(iParam0), -1, 0);
			gameplay::clear_bit(&iVar0, iParam1);
			func_111(func_282(iParam0), iVar0, -1, 1, 0);
		}
	}
	else {
...
struct<2> func_381(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_389(iParam0)}; break;

	case 7: Var0 = {func_193(iParam0)}; break;

	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_388(iParam2)}; break;

		case 8: Var0 = {func_387(iParam2)}; break;

		case 7: Var0 = {func_386(iParam2)}; break;

		case 10: Var0 = {func_385(iParam2)}; break;

		case 5: Var0 = {func_384(iParam2)}; break;

		case 4: Var0 = {func_383(iParam2)}; break;

		default: StringCopy(&Var0, func_382(iVar2), 8); break;
		}
		break;
...
//Position - 0x3204F
bool func_390(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (!func_393(0) || G_TextMessageConfig || Global_69960 == 1 || !cam::is_screen_faded_in()) {
		return false;
	}
	switch (Global_69956) {
	case 0:
	...
	case 5:
		if (cutscene::is_cutscene_playing() || func_392(0) || func_391(1)) {
		}
		else {
			return true;
		}
...
// Position - 0x3220C
bool func_394(int iParam0) { return func_395(iParam0, Global_35781); }
...
void func_398(int iParam0) {
	if (iParam0) {
		if (func_413()) {
			iLocal_189 = func_412();
			if (iLocal_189 != joaat("towtruck2") && iLocal_189 != joaat("cargobob") &&
				iLocal_189 != joaat("cargobob2") && iLocal_189 != joaat("cargobob3")) {
				iLocal_189 = joaat("towtruck");
			}
		}
		else {
...
// Position - 0x326DF
var func_400() { return gameplay::is_bit_set(Global_91491.f_20, 13); }
...
void func_401(vector3 vParam0, float fParam3, int iParam4) {
	...
	iLocal_188 = vehicle::create_vehicle(iLocal_189, vParam0, fParam3, 1, 1);
	...
	if (iParam4) {
		func_402(player::player_ped_id(), iLocal_188, -1);
	}
...
// Position - 0x32815
void func_404(vector3 vParam0, float fParam3) {
	...
	func_240(&iLocal_172);
	func_6(&Local_159.f_4);
	Local_159.f_4 = vehicle::create_vehicle(Local_159.f_5, vParam0, fParam3, 1, 1);
	...
	iLocal_172 = object::create_object(iLocal_179, vParam0 + vLocal_173, 1, 1, 0);
...
// Position - 0x32B04
var func_412() { return Global_96040.f_2311.f_12.f_66; }

// Position - 0x32B17
bool func_413() { return func_414(&Global_96040.f_2311); }
...
// Position - 0x32B89
int func_415(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
void func_417(int iParam0) {
	...
	if (iParam0) {
		func_411(vLocal_488, fLocal_491, 1, 0);
	}
	...
	if (iParam0) {
		func_401(vLocal_488, fLocal_491, 0);
		...
		func_401(vLocal_488, fLocal_491, 1);
		if (func_396(iLocal_188) && iLocal_189 == joaat("towtruck")) {
			vehicle::_set_tow_truck_crane_height(iLocal_188, 0f);
		}
	}
...
void func_420(int iParam0, int iParam1, int iParam2, int iParam3) {
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_424(player::player_id()) &&
				!func_422(player::player_id(), 0) && !func_421()) {
				entity::set_entity_invincible(player::player_ped_id(), 0);
			}
		}
		else if (!ped::is_ped_injured(player::player_ped_id()) && !func_424(player::player_id())) {
			entity::set_entity_invincible(player::player_ped_id(), 0);
		}
...
// Position - 0x332BA
bool func_421() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x333A5
bool func_425() { return gameplay::is_bit_set(Global_2359301, 3); }

// Position - 0x333B6
int func_426(int iParam0, int iParam1, var uParam2, int iParam3) {
	int iVar0;
...
void func_431() {
	...
	streaming::request_anim_dict(sLocal_429);
	if (func_396(player::player_ped_id())) {
		func_437(&uLocal_251, 1, player::player_ped_id(), "FRANKLIN", 0, 1);
	}
...
// Position - 0x33ADD
void func_435() {
	vLocal_458[0 /*3*/] = {func_436("B3CENTV", 1)};
	vLocal_458[1 /*3*/] = {func_436("B3CDELV", 1)};
	vLocal_458[2 /*3*/] = {func_436("B3CWAN1", -1)};
	vLocal_458[3 /*3*/] = {func_436("B3CNOGO", 1)};
	vLocal_458[4 /*3*/] = {func_436("B3CREVRS", 1)};
	vLocal_458[5 /*3*/] = {func_436("B3CLEAVE", 1)};
	vLocal_458[6 /*3*/] = {func_436("B3CRTTT", 1)};
	vLocal_458[7 /*3*/] = {func_436("B3CGBTB", 1)};
	vLocal_458[8 /*3*/] = {func_436("B3CRTCB", 1)};
}
...
// Position - 0x33C35
struct<7> func_438(vector3 vParam0, float fParam3) {
	struct<7> Var0;
...
// Position - 0x33C9D
void func_441(var uParam0, int iParam1) { Global_91491.f_22[iParam1] = uParam0; }
...
void func_445(int iParam0) {
	...
	if (!func_459()) {
		...
		if (iParam0) {
			func_197(iVar0, 1, 0);
			func_446(script::get_this_script_name(), iVar0);
		}
		else {
			if (Global_100787[iVar0 /*10*/].f_9 == -1) {
			}
...
// Position - 0x33EAB
bool func_447(char *sParam0, int iParam1, int iParam2) {
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_450()) {
		if (func_449()) {
			...
			iVar33 = func_301(script::get_this_script_name());
			if (iVar33 > -1) {
...
// Position - 0x341AC
void func_454() { Global_17151.f_5 = 1; }

// Position - 0x341BA
void func_455() { Global_17151.f_5 = 0; }
