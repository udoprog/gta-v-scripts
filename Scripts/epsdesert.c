...
void __EntryFunction__() {
	...
	while (true) {
		...
		switch (iLocal_211) {
		case 0: func_161(); break;

		case 1: func_1(); break;

		case 2: func_169(); break;
		}
	}
}
	...
	if (Global_101700.f_9008.f_107 < fLocal_212) {
		...
		if (iLocal_206) {
			if (func_154(iLocal_38)) {
				if (!func_153() && !ped::is_ped_fleeing(iLocal_38) && !ped::is_ped_ragdoll(iLocal_38) &&
					!ped::is_ped_prone(iLocal_38) && !ped::is_ped_injured(iLocal_38)) {
		...
		if (iLocal_207) {
			if (func_154(iLocal_39)) {
				if (!func_153() && !ped::is_ped_fleeing(iLocal_39) && !ped::is_ped_ragdoll(iLocal_39) &&
					!ped::is_ped_prone(iLocal_39) && !ped::is_ped_injured(iLocal_39)) {
		...
		if (iLocal_208) {
			if (func_154(iLocal_40)) {
				if (!func_153() && !ped::is_ped_fleeing(iLocal_40) && !ped::is_ped_ragdoll(iLocal_40) &&
					!ped::is_ped_prone(iLocal_40) && !ped::is_ped_injured(iLocal_40)) {
		...
		if (func_139(0)) {
			if (player::is_player_playing(player::player_id())) {
				...
				if (ped::is_ped_on_foot(player::player_ped_id()) && !ped::is_ped_falling(player::player_ped_id()) &&
					!ped::is_ped_swimming(player::player_ped_id()) &&
					!ped::is_ped_on_vehicle(player::player_ped_id()) && !ped::is_ped_ragdoll(player::player_ped_id()) &&
					!ped::is_ped_prone(player::player_ped_id()) && !ai::is_ped_getting_up(player::player_ped_id())) {
					if (entity::is_entity_in_angled_area(player::player_ped_id(), 3155.104f, 4091.06f, 7.974625f,
														 -322.8309f, 2861.712f, 250.5251f, 2250f, 0, 1, 0)) {
						if (func_137(player::player_ped_id(), 12, iLocal_37)) {
							if (func_136() && !func_159()) {
								...
								if (fVar0 > 0.01f) {
									...
									Global_101700.f_9008.f_107 += fVar0;
									if (func_131()) {
										if (Global_101700.f_9008.f_107 >= 8000f) {
											Global_101700.f_9008.f_107 = fLocal_212;
										}
									}
									if (Global_101700.f_9008.f_107 < 1609f * 5f &&
										1609f * 5f - Global_101700.f_9008.f_107 < fLocal_210 - 160.9f) {
										if (func_131()) {
										...
										if (fLocal_220 >= fVar6) {
											if (!iLocal_227) {
												while (!func_125(-694220424, 6, 1, 51, 6, 10000, 30000, -1, -1, 0, -1,
																 0)) {
													system::wait(0);
												}
												iLocal_227 = 1;
				...
				else if (entity::is_entity_in_angled_area(player::player_ped_id(), 3155.104f, 4091.06f, 7.974625f,
														  -322.8309f, 2861.712f, 250.5251f, 2250f, 0, 1, 0)) {
					if (!func_136()) {
				...
				if (iLocal_216) {
					Global_101700.f_9008.f_107 += 160.9f - 5f;
					iLocal_216 = 0;
				}
			}
			else {
...
void func_4() {
	...
	if (entity::does_entity_exist(player::player_ped_id())) {
		if (func_8(Global_101700.f_2095.f_539.f_3549) != entity::get_entity_model(player::player_ped_id())) {
...
// Position - 0x985
bool func_5(int iParam0) { return Global_35781 == iParam0; }
	...
	if (iParam1 == 12) {
		...
		while (iVar0 <= 14) {
			if (uVar11[iVar0] != -99) {
				...
				if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0)) {
					if (iVar0 == 13) {
						...
						while (iVar1 <= 8) {
							...
							func_30(iParam0, Global_69523[1 /*14*/].f_12, Global_69523[1 /*14*/].f_3,
						...
						if (iParam4 == -1) {
							ped::set_ped_component_variation(iParam0, func_20(iVar0), Global_69523[1 /*14*/].f_3,
															 Global_69523[1 /*14*/].f_4,
															 ped::get_ped_palette_variation(iParam0, func_20(iVar0)));
						}
						else {
							ped::set_ped_component_variation(iParam0, func
int iParam0, int iParam1, int *iParam2, int *iParam3, bool bParam4, bool bParam5) {
	int iVar0;
...
// Position - 0x8D0E
bool func_59(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	if (iParam0 == 0) {
		if (iParam5 == 1) {
...
{
	switch (iParam0) {
	case 0: func_86(iParam1); break;

	case 2: func_85(iParam1); break;

	case 3: func_82(iParam1); break;

	case 4: func_81(iParam1); break;

	case 6: func_80(iParam1); break;

	case 5: func_79(iParam1); break;

	case 8: func_78(iParam1); break;

	case 9: func_77(iParam1); break;

	case 10: func_76(iParam1); break;

	case 1: func_75(iParam1); break;

	case 7: func_74(iParam1); break;

	case 11: func_73(iParam1); break;

	case 12: func_72(iParam1); break;

	case 13: func_71(iParam1); break;

	case 14: func_63(iParam1); break;
	}
}
...
void func_63(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 155); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

// Position - 0xAFF6
void func_64(var *uParam0, int iParam1, int iParam2, char *sParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	*uParam0 = iParam9;
	...
	if (iParam10) {
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 ||
			...
			iVar0 = func_57(func_67(iParam1, uParam0->f_2), Global_69521, 0);
...
void func_70(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 == 12) {
		...
		while (iVar38 < iVar40) {
			...
			if (!dlc1::_is_dlc_data_empty(Var20)) {
				if (iVar39 == iParam1 - iParam2) {
					...
					func_64(&Global_69523[0 /*14*/], iParam0, iParam1, &Var20.f_9, Var20.f_3, Var20.f_4, Var20.f_5,
		...
		iVar59 = 0;
		iVar60 = dlc1::_get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_20(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60) {
			...
			if (!dlc1::_is_dlc_data_empty(Var41)) {
				if (iVar59 == iParam1 - iParam2) {
					...
					func_64(&Global_69523[0 /*14*/], iParam0, iParam1, &Var41.f_9, Var41.f_3, Var41.f_4, Var41.f_5,
...
void func_71(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 9); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_72(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 48); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_73(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 1); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_75(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 6); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_76(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 33); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_77(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 17); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_78(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 18); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_79(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 7); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_80(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 84); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_81(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 104); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_87(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_105(iParam1); break;

	case 2: func_104(iParam1); break;

	case 3: func_100(iParam1); break;

	case 4: func_99(iParam1); break;

	case 6: func_98(iParam1); break;

	case 5: func_97(iParam1); break;

	case 8: func_96(iParam1); break;

	case 9: func_95(iParam1); break;

	case 10: func_94(iParam1); break;

	case 1: func_93(iParam1); break;

	case 7: func_92(iParam1); break;

	case 11: func_91(iParam1); break;

	case 12: func_90(iParam1); break;

	case 13: func_89(iParam1); break;

	case 14: func_88(iParam1); break;
	}
}
...
void func_88(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 175); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_90(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 47); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_91(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 63); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_93(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 5); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_94(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 53); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_95(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 12); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_96(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 77); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_98(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 134); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_99(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 117); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_104(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 21); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_105(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 10); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_107(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 113); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_110(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 45); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_114(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 20); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_115(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 24); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_116(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 14); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_117(int iParam0) {
	...
	default: func_70(iVar10, iParam0, 99); return;
	}
	func_64(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
// Position - 0x1D641
int func_125(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
// Position - 0x1D965
float func_130(float fParam0) { return fParam0 / 1000f; }
...
// Position - 0x1D98A
void func_132() {
	if (!func_135() && !entity::is_entity_dead(player::player_ped_id(), 0) &&
...
int func_136() {
	...
	if (gameplay::are_strings_equal(sLocal_239, "DESRT") || gameplay::are_strings_equal(sLocal_239, "SENORA") ||
		gameplay::are_strings_equal(sLocal_239, "HARMO") || gameplay::are_strings_equal(sLocal_239, "RTRAK") ||
		gameplay::are_strings_equal(sLocal_239, "SANDY") || gameplay::are_strings_equal(sLocal_239, "Zancudo") ||
		gameplay::are_strings_equal(sLocal_239, "Alamo") || gameplay::are_strings_equal(sLocal_239, "Jail") ||
		gameplay::are_strings_equal(sLocal_239, "zQ_UAR") || gameplay::are_strings_equal(sLocal_239, "COSI")) {
		return 1;
	}
	return 0;
}
...
bool func_137(int iParam0, int iParam1, int iParam2) {
	...
	else if (Global_69523[1 /*14*/].f_3 == ped::get_ped_drawable_variation(iParam0, func_20(iParam1)) &&
			 Global_69523[1 /*14*/].f_4 == ped::get_ped_texture_variation(iParam0, func_20(iParam1))) {
		return true;
	}
	return false;
}
...
// Position - 0x1E0D3
int func_142(char *sParam0, int iParam1, int iParam2) {
	Global_15746 = 0;
	...
	while (iVar1 < iVar0) {
		if (func_154(uVar2[iVar1])) {
			if (entity::get_entity_model(uVar2[iVar1]) == func_165(55)) {
				...
				ped::set_ped_can_be_targetted(iLocal_39, 0);
...
void func_171() {
	...
	if (fVar8 > 0f && system::floor(fVar8) < system::floor(Global_101700.f_9153.f_3853)) {
		func_175(13, system::floor(Global_101700.f_9153.f_3853));
	}
