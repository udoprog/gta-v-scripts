...
bool func_2() {
	...
	if (!gameplay::is_string_null_or_empty(&cLocal_86)) {
		if (!graphics::does_particle_fx_looped_exist(iLocal_83)) {
			vVar0 = {Vector(32.856f, 3819.65f, 1971.62f) - vLocal_79};
			iLocal_83 =
				graphics::start_particle_fx_looped_at_coord(&cLocal_86, vLocal_79 + vVar0, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
		}
	}
	if (!ped::is_ped_injured(player::player_ped_id())) {
		if (entity::is_entity_playing_anim(player::player_ped_id(), &sLocal_139, &cLocal_155, 2)) {
			fVar3 = ped::get_synchronized_scene_phase(Global_89154);
			switch (iLocal_220) {
			case 0:
				if (fLocal_137 < 0f) {
					iLocal_220++;
				...
				if (fVar3 > fLocal_137) {
					if (!entity::does_entity_exist(iLocal_68) || iLocal_85 != -1) {
						if (graphics::start_particle_fx_non_looped_on_ped_bone(
								&cLocal_102, player::player_ped_id(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_85, 1f, 0, 0, 0)) {
							if (gameplay::are_strings_equal(&cLocal_102, "scr_meth_pipe_smoke")) {
								func_15(player::player_ped_id(), 0);
							}
							iLocal_219 = audio::get_sound_id();
							audio::play_sound_from_entity(iLocal_219, &cLocal_203, player::player_ped_id(), &cLocal_187,
														  0, 0);
							iLocal_220++;
						}
					}
					else if (graphics::start_particle_fx_non_looped_on_entity(&cLocal_102, iLocal_68, 0f, 0f, -1f, 0f,
																			  0f, 0f, 1065353216, 0, 0, 0)) {
						if (gameplay::are_strings_equal(&cLocal_102, "scr_meth_pipe_smoke")) {
							func_15(player::player_ped_id(), 0);
						}
						iLocal_219 = audio::get_sound_id();
						audio::play_sound_from_entity(iLocal_219, &cLocal_203, player::player_ped_id(), &cLocal_187, 0,
													  0);
						iLocal_220++;
					}
				}
			...
			case 2:
				if (!gameplay::is_string_null_or_empty(&cLocal_118)) {
					if (graphics::start_particle_fx_non_looped_at_coord(&cLocal_118, vLocal_79 + vLocal_134, 0f, 0f, 0f,
																		1f, 0, 0, 0)) {
						iLocal_220++;
					}
				}
			...
			if (iLocal_84 != 0) {
				graphics::stop_particle_fx_looped(iLocal_84, 0);
				iLocal_84 = 0;
				audio::stop_sound(iLocal_219);
				audio::release_sound_id(iLocal_219);
			}
			if (entity::does_entity_exist(iLocal_68)) {
				if (entity::is_entity_attached(iLocal_68)) {
					if (iLocal_78 != -1) {
...
int func_3(int iParam0, int iParam1) {
	...
	case 0:
		...
		if (entity::get_entity_model(*iParam0) != joaat("prop_cs_ironing_board") &&
			entity::get_entity_model(*iParam0) != joaat("prop_iron_01")) {
		...
		if (entity::get_entity_model(*iParam0) == joaat("prop_iron_01")) {
			...
			entity::set_entity_coords(*iParam0, vVar1 + Vector(0.1f, 0f, 0f), 1, 0, 0, 1);
	...
	case 1: object::delete_object(iParam0); return 1;
	...
	case 3:
		...
		if (entity::get_entity_model(*iParam0) != -1593767197 &&
			entity::get_entity_model(*iParam0) != joaat("v_res_tt_flusher") &&
			entity::get_entity_model(*iParam0) != joaat("v_ilev_fh_lampa_on") &&
			entity::get_entity_model(*iParam0) != joaat("prop_cs_remote_01")) {
			entity::stop_synchronized_entity_anim(*iParam0, -8f, 1);
		}
		if (entity::get_entity_model(*iParam0) != joaat("v_ilev_fh_dineeamesa") &&
			entity::get_entity_model(*iParam0) != joaat("v_res_tt_flusher") &&
			entity::get_entity_model(*iParam0) != joaat("v_ilev_fh_lampa_on")) {
			entity::freeze_entity_position(*iParam0, 0);
		}
	...
	case 4:
		...
		case joaat("p_laptop_02_s"): iVar13 = joaat("prop_laptop_02_closed"); break;

		case 451260528: iVar13 = joaat("p_dinechair_01_s"); break;

		case joaat("prop_acc_guitar_01"): iVar13 = joaat("prop_acc_guitar_01_d1"); break;

		case joaat("p_defilied_ragdoll_01_s"): iVar13 = joaat("prop_defilied_ragdoll_01"); break;

		case joaat("p_hand_toilet_s"): iVar13 = joaat("prop_toiletfoot_static"); break;

		case joaat("prop_laptop_02_closed"):
		case joaat("p_dinechair_01_s"):
		case joaat("prop_acc_guitar_01_d1"):
		case joaat("prop_defilied_ragdoll_01"): entity::stop_synchronized_entity_anim(*iParam0, -8f, 1); return 1;

		case joaat("prop_toiletfoot_static"):
			vVar14 = {1971.669f, 3819.449f, 32.766f};
			vVar17 = {0f, 0f, 53.6f};
			entity::set_entity_coords(*iParam0, vVar14, 1, 0, 0, 1);
			entity::set_entity_rotation(*iParam0, vVar17, 2, 1);
			entity::freeze_entity_position(*iParam0, 1);
			return 1;

		default: iVar13 = 0; return 0;
		}
		...
		*iParam0 = object::create_object(iVar13, vVar7, 1, 1, 0);
		entity::set_entity_rotation(*iParam0, vVar10, 2, 1);
		streaming::set_model_as_no_longer_needed(iVar13);
		return 1;

	case 5:
		fire::add_explosion(entity::get_entity_coords(*iParam0, 1), 0, 0.5f, 1, 0, 1f, 0);
		object::delete_object(iParam0);
		return 1;
	...
	case 8:
		...
		sVar26 = "";
		switch (entity::get_entity_model(*iParam0)) {
		case joaat("prop_cs_beer_bot_01"): sVar26 = "scr_pts_glass_bottle"; break;

		case -845035989: sVar26 = "ent_dst_pineapple"; break;

		case joaat("prop_acc_guitar_01"): sVar26 = "scr_pts_guitar_break"; break;

		default: sVar26 = ""; return 0;
		}
	...
	case 9:
		...
		sVar33 = "";
		switch (entity::get_entity_model(*iParam0)) {
		case joaat("prop_cs_beer_bot_01"): sVar33 = "scr_pts_glass_bottle"; break;

		case -845035989: sVar33 = "ent_dst_pineapple"; break;

		case joaat("prop_acc_guitar_01"):
		case joaat("prop_acc_guitar_01_d1"): sVar33 = "scr_pts_guitar_break"; break;

		default: sVar33 = ""; return 0;
		}
		streaming::request_ptfx_asset();
		while (!streaming::has_ptfx_asset_loaded()) {
			ui::hide_hud_and_radar_this_frame();
		...
		iVar34 = 0;
		switch (entity::get_entity_model(*iParam0)) {
		case joaat("prop_acc_guitar_01_d1"): return 0;

		case joaat("p_laptop_02_s"): iVar34 = joaat("prop_laptop_02_closed"); break;

		case 451260528: iVar34 = joaat("p_dinechair_01_s"); break;

		case joaat("prop_acc_guitar_01"): iVar34 = joaat("prop_acc_guitar_01_d1"); break;

		case joaat("p_defilied_ragdoll_01_s"): iVar34 = joaat("prop_defilied_ragdoll_01"); break;

		default: iVar34 = 0; return 0;
		}
		...
		object::delete_object(iParam0);
		*iParam0 = object::create_object(iVar34, vVar27, 1, 1, 0);
		...
		if (func_6(iVar0, &sVar35, &cVar51, &iVar67)) {
			if (func_4(iVar0, &sVar68, &cVar84, &cVar100, &uVar116, &uVar117)) {
				if (!entity::is_entity_playing_anim(*iParam0, &sVar68, &sVar35, 2)) {
					entity::play_synchronized_entity_anim(*iParam0, Global_89154, &sVar35, &sVar68, 1000f, -8f, iVar67,
														  1148846080);
				}
			}
		}
...
bool func_4(int iParam0, char *sParam1, char *sParam2, char *sParam3, var *uParam4, var *uParam5) {
	...
	*uParam5 = 0;
	...
	case 305: func_5(iParam0, sParam1, sParam2, sParam3); return true;
...
bool func_6(int iParam0, char *sParam1, char *sParam2, int *iParam3) {
	*iParam3 = 0;
	StringCopy(sParam2, "", 64);
	switch (iParam0) {
	case 192: StringCopy(sParam1, "002110_04_MAGD_3_WEED_EXCHANGE_WEEDBOTTLE", 64); return true;

	case 156: StringCopy(sParam1, "AROUND_THE_TABLE_SELFISH_Lap_Top", 64); return true;
	...
	case 171: StringCopy(sParam1, "001839_02_MICS3_20_DROPPING_OFF_JMY_EXIT_$", 64); return true;

	case 172: StringCopy(sParam1, "001840_01_MICS3_IG_21_TRACY_EXITS_CAR_CASH", 64); return true;

	case 249: StringCopy(sParam1, "001370_02_TRVS_8_GUITAR_BEATDOWN_EXIT_GUITAR", 64); return true;

	case 296: StringCopy(sParam1, "BEAR_IN_FLOYDS_FACE_EXIT_rasp", 64); return true;

	case 297: StringCopy(sParam1, "BEAR_FLOYDS_FACE_SMELL_EXIT_doll", 64); return true;

	case 298: StringCopy(sParam1, "Pineapple_EXIT_PINEAPPLE", 64); return true;

	case 311: StringCopy(sParam1, "002057_03_TRVS_27_FLUSHES_FOOT_EXIT_Foot", 64); return true;

	case 103: StringCopy(sParam1, "pier_lean_smoke_outro_CIG", 64); return true;

	case 244: StringCopy(sParam1, "EXIT_Taco", 64); return true;
	...
	case 200: StringCopy(sParam1, "THROW_CUP_EXIT_CUP", 64); return true;

	case 201: StringCopy(sParam1, "HIT_CUP_HAND_EXIT_CUP", 64); return true;

	case 236: StringCopy(sParam1, "EXIT_Beer", 64); return true;

	case 164: StringCopy(sParam1, "001404_01_MICS3_16_READS_SCRIPT_EXIT_PROP", 64); return true;

	case 80: StringCopy(sParam1, "EXIT_FORWARD_CHAIR", 64); return true;
	}
	return false;
}
...
// Position - 0x2740
void func_16(int iParam0, int iParam1, int iParam2, int iParam3) { func_17(iParam0, iParam1, iParam2, iParam3, 0); }
...
// Position - 0x28E3
void func_22(int iParam0, int iParam1, int iParam2, int iParam3) { func_17(iParam0, iParam1, iParam2, 0, iParam3); }
...
// Position - 0x299A
void func_26(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5) {
	int iVar0;
	...
	if (iLocal_69 != 0) {
		if (!entity::does_entity_exist(iLocal_68)) {
			...
			if (!streaming::has_model_loaded(iLocal_69)) {
				...
				iLocal_68 = object::create_object(iLocal_69, vLocal_79, 1, 1, 0);
				entity::attach_entity_to_entity(iLocal_68, player::player_ped_id(),
												ped::get_ped_bone_index(player::player_ped_id(), iLocal_76), vLocal_70,
												vLocal_73, 0, 0, 0, 0, 2, 1);
			}
			else {
				iLocal_68 = object::create_object(iLocal_69, vLocal_79 + vLocal_70, 1, 1, 0);
				entity::set_entity_coords(iLocal_68, vLocal_79 + vLocal_70, 1, 0, 0, 1);
		...
		if (entity::does_entity_exist(iLocal_68)) {
			if (iLocal_76 != -1) {
				if (!entity::is_entity_attached_to_entity(iLocal_68, player::player_ped_id())) {
					entity::attach_entity_to_entity(iLocal_68, player::player_ped_id(),
													ped::get_ped_bone_index(player::player_ped_id(), iLocal_76),
													vLocal_70, vLocal_73, 0, 0, 0, 0, 2, 1);
				}
			}
		}
		return true;
...
// Position - 0x2EE0
int func_37(var uParam0) { return uParam0; }

// Position - 0x2EEA
bool func_38(var uParam0, int iParam1) { return (uParam0 & iParam1) != 0; }
...
// Position - 0x30FD
void func_46() { func_47(Global_91279 - 1); }

// Position - 0x310F
void func_47(int iParam0) { Global_91279 = iParam0; }

// Position - 0x311D
void func_48() { func_47(0); }
...
void func_49() {
	...
	while (!iVar1 && iVar0 < 400) {
		iVar1 = 1;
		if (streaming::is_player_switch_in_progress() &&
			(streaming::get_player_switch_state() != 8 || streaming::get_player_switch_state() == 1)) {
			iVar1 = 0;
		}
		streaming::request_ptfx_asset();
		...
		if (!gameplay::is_string_null_or_empty(&cLocal_171)) {
			if (!audio::request_ambient_audio_bank(&cLocal_171, 0, -1)) {
				iVar1 = 0;
			}
		}
		if (iLocal_69 != 0) {
...
void func_50() {
	...
	func_54(iLocal_66, &vLocal_79, &uLocal_82, &cVar0);
	switch (iLocal_66) {
	case 273:
	case 274:
		...
		if (iLocal_66 == 273) {
			vLocal_134 = {Vector(34.97325f + 0.25f, -441.7662f, -118.3218f) - vLocal_79};
		}
		else if (iLocal_66 == 274) {
			vLocal_134 = {0.125f, -1.1486f, 0.0588f + 0.1f};
		}
		else {
			vLocal_134 = {-0.125f, 1.1486f, -0.0588f};
		}
		break;
...
int func_51(struct<109> Param0, var *uParam109) {
	...
	case 80:
		*uParam109 = {Param0};
		uParam109->f_109 = 1785177548;
		uParam109->f_110 = 1785177548;
		func_52(uParam109, 17, -2017877118, -2017877118,
	...
	case 155:
		*uParam109 = {Param0};
		uParam109->f_109 = 1785177548;
		uParam109->f_110 = 1785177548;
		func_52(uParam109, 17, 1785177548, 1785177548, gameplay::get_random_float_in_range(-5f, 5f),
	...
	case 158:
		*uParam109 = {Param0};
		uParam109->f_109 = 1785177548;
		uParam109->f_110 = 1785177548;
		func_52(uParam109, 144, 1785177548, 1785177548, gameplay::get_random_float_in_range(-5f, 5f),
				gameplay::get_random_float_in_range(-5f, 5f), 0f, gameplay::get_random_float_in_range(-180f, 180f));
		uParam109->f_118 = 1;
		return 1;
	...
	case 196:
		*uParam109 = {Param0};
		uParam109->f_109 = 1785177548;
		uParam109->f_110 = 1785177548;
		func_52(uParam109, 43, 1785177548, 1785177548, gameplay::get_random_float_in_range(-5f, 5f),
				gameplay::get_random_float_in_range(-5f, 5f), 0f, gameplay::get_random_float_in_range(-180f, 180f));
		uParam109->f_118 = 1;
		return 1;
...
// Position - 0x698E
void func_52(var *uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam7) {
...
// Position - 0x69B8
void func_53(var *uParam0) { func_52(uParam0, 145, 1435919172, 1435919172, 0f, 0f, 0f, 0f); }
...
// Position - 0x6C84
bool func_56(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
