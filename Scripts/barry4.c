...
// Position - 0x25A32
bool func_203(var *uParam0, int iParam1, char *sParam2, char *sParam3, int iParam4, int iParam5, int iParam6,
	...
	Global_2621441 = 0;
	return func_204(sParam3, iParam4, iParam8);
}
...
// Position - 0x26312
var func_223() { return gameplay::is_bit_set(Global_91491.f_20, 13); }
...
struct<2> func_227(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_235(iParam0)}; break;
	...
	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_234(iParam2)}; break;

		case 8: Var0 = {func_233(iParam2)}; break;

		case 7: Var0 = {func_232(iParam2)}; break;

		case 10: Var0 = {func_231(iParam2)}; break;

		case 5: Var0 = {func_230(iParam2)}; break;

		case 4: Var0 = {func_229(iParam2)}; break;

		default: StringCopy(&Var0, func_228(iVar2), 8); break;
		}
		break;
...
//Position - 0x26A81
bool func_236(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (!func_239(0) || G_TextMessageConfig || Global_69960 == 1 || !cam::is_screen_faded_in()) {
		return false;
	}
	switch (Global_69956) {
	case 0:
...
// Position - 0x26C3E
bool func_240(int iParam0) { return func_241(iParam0, Global_35781); }
...
// Position - 0x26E30
void func_242(var *uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8,
	...
	if (iVar0 == 1) {
		...
		*uParam0 = func_291(vParam1, fParam4);
	}
	else if (iParam9 == 1) {
...
// Position - 0x26FC3
int func_243(int *iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7) {
	int iVar0;
	var *uVar1;
	struct<97> Var5;
	int iVar103;
		...
		if (Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/] == Var5) {
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/],
				...
				func_276(iParam0, &Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/].f_31,
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/],
				...
				func_276(iParam0, &Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/].f_31,
...
void func_244(int iParam0, var *uParam1, int iParam2, int iParam3) {
	...
	if (func_151(iParam0) && entity::does_entity_exist(*uParam1) && vehicle::is_vehicle_driveable(*uParam1, 0)) {
		...
		if (vehicle::get_vehicle_mod_kit(*uParam1) >= 0 && vehicle::get_vehicle_mod_kit(*uParam1) < 255 &&
			func_249(*uParam1, 0, &iVar0)) {
			func_248(uParam1, &Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_31,
			...
			if (iParam3) {
				...
				Global_101700.f_19077[iParam0 /*43*/].f_31 = func_247(*uParam1);
				...
				func_245(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_5,
				...
				func_245(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0,
...
// Position - 0x28A9B
bool func_246(int iParam0, char *sParam1, int *iParam2, int *iParam3, int *iParam4) {
	*iParam2 = -1;
	*iParam3 = -1;
	*iParam4 = -1;
	switch (iParam0) {
...
int func_249(int iParam0, int iParam1, int *iParam2) {
	...
	*iParam2 = 0;
	...
	iVar0 = entity::get_entity_model(iParam0);
	if (!func_251(iVar0, iParam1, iParam2)) {
		return 0;
	}
	...
	if (!network::network_is_game_in_progress()) {
		if (func_250(iParam0) && entity::get_entity_model(iParam0) != joaat("sentinel2") &&
		...
		*uParam1 = vehicle::get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11) {
			if (vehicle::is_vehicle_extra_turned_on(iParam0, iVar0 + 1)) {
				gameplay::set_bit(&uParam1->f_77, func_255(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_256(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_271(iParam0, 0, 0) ||
		func_271(iParam0, 1, 0) || func_271(iParam0, 2, 0) || func_270(iParam0) != 145 || func_269(iParam0) ||
		func_268(iParam0) || func_250(iParam0) || func_267(iParam0) || !func_257(entity::get_entity_model(iParam0))) {
		if (func_268(iParam0)) {
		}
		if (func_268(iParam0)) {
		}
...
// Position - 0x2BD96
int func_262() { return 0; }

// Position - 0x2BD9F
int func_263() { return 1; }

// Position - 0x2BDA8
int func_264() { return 1; }
...
// Position - 0x2C289
bool func_275(int iParam0) { return vehicle::is_vehicle_extra_turned_on(iParam0, 5); }
...
int func_276(int iParam0, var *uParam1, var *uParam2) {
	...
	if (func_279(entity::get_entity_model(*iParam0), 1) &&
		vehicle::get_vehicle_mod(*iParam0, 24) != func_278(*iParam0, (*uParam1)[38] - 1)) {
		vehicle::set_vehicle_mod(*iParam0, 24, func_278(*iParam0, (*uParam1)[38] - 1), 0);
	}
	if (func_277(*iParam0)) {
	...
	while (iVar0 < 9) {
		if (entity::does_entity_exist(Global_89155[iVar0])) {
			if (iParam0 == 145 || Global_89165[iVar0] == iParam0) {
				if (iParam1 == 0 || entity::get_entity_model(Global_89155[iVar0]) == func_283(iParam0, iParam1)) {
...
// Position - 0x2CB73
void func_284(vector3 vParam0, float fParam3, int iParam4) {
	int iVar0;
	...
	if (func_289(&Global_68531.f_555[0 /*21*/], iParam0)) {
		...
		if (gameplay::is_bit_set(Global_68531.f_555[0 /*21*/].f_9, 13)) {
			if (iParam0 == 24 && func_180(iParam0, 0) && Global_69440.f_66 == 0 &&
				...
				(!func_287(0, Global_68531.f_555[0 /*21*/].f_12) || !func_287(1, Global_68531.f_555[0 /*21*/].f_12))) {
...
// Position - 0x2CE73
int func_288(var *uParam0) { return *uParam0; }
...
// Position - 0x2E575
bool func_290(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
// Position - 0x2E5BC
int func_291(vector3 vParam0, float fParam3) { return func_292(&Global_96040.f_2311, vParam0, fParam3, 0); }

// Position - 0x2E5D6
int func_292(var *uParam0, vector3 vParam1, float fParam4, int iParam5) {
	int iVar0;
	vector3 vVar1;
	bool bVar4;
	var uVar5;
	...
	if (func_302(uParam0)) {
		...
		if (func_301(uParam0)) {
			...
			if (entity::does_entity_exist(iVar0)) {
				...
				else if (!func_294(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10 &&
...
// Position - 0x2E94A
int func_294(int iParam0, vector3 vParam1, bool bParam4) {
	int iVar0;
	var uVar1[3];
	int iVar5;
	int iVar6;
	...
	case joaat("cuban800"):
		...
		iVar6 = 0;
		while (iVar6 <= iVar5 - 1) {
			if (func_296(iParam0, uVar1[iVar6], 1) &&
				func_295(entity::get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)) {
				if (!bParam4 || func_290(vParam1, 0f, 0f, 0f, 0) ||
...
// Position - 0x2EB52
int func_295(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
void func_297(int iParam0, var *uParam1, int iParam2, int iParam3) {
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (uParam1->f_66 == joaat("sovereign")) {
			...
			iVar0 = 1;
			if (gameplay::is_bit_set(uParam1->f_77, func_255(iVar0 + 1))) {
			}
			else {
				gameplay::set_bit(&uParam1->f_77, func_255(iVar0 + 1));
			}
			...
			iVar1 = 1;
			if (gameplay::is_bit_set(uParam1->f_77, func_255(iVar1 + 1))) {
			}
			else {
				gameplay::set_bit(&uParam1->f_77, func_255(iVar1 + 1));
			}
		}
		...
		if (gameplay::is_bit_set(uParam1->f_77, 15) || func_300(iParam0) ||
		...
		if (!vehicle::is_this_model_a_heli(uParam1->f_66) && !vehicle::is_this_model_a_boat(uParam1->f_66)) {
			iVar2 = 0;
			while (iVar2 <= 11) {
				if (gameplay::is_bit_set(uParam1->f_77, func_255(iVar2 + 1))) {
...
// Position - 0x2F141
var func_299() { return dlc2::is_dlc_present(-1691188696); }
...
// Position - 0x2F231
int func_303() { return func_301(&Global_96040.f_2311); }

// Position - 0x2F244
void func_304() { func_305(&Global_96040.f_2311); }
...
// Position - 0x2F3D1
int func_309() { return func_302(&Global_96040.f_2311); }
...
// Position - 0x2F46F
void func_314(var *uParam0, bool bParam1) { func_315(&uParam0->f_41, bParam1); }
...
// Position - 0x2F525
void func_318(var *uParam0, bool bParam1) { func_319(&uParam0->f_35, bParam1); }
