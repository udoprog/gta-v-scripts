...
bool func_2() {
	...
	if (!func_3(&uVar0)) {
		...
		fVar4 = system::vdist2(vLocal_172 + vLocal_177, vVar1);
		if (fVar4 < 4.5f * 4.5f) {
			ai::task_vehicle_drive_wander(iLocal_68, iLocal_70, fLocal_175, 786599);
			return true;
		}
	}
	return false;
...
bool func_4() {
	...
	if (!func_3(&uVar0)) {
		if (ped::is_synchronized_scene_running(Global_89153)) {
			...
			if (!func_5(Global_91277, iLocal_70, 2)) {
				if (fVar1 >= 0.9f) {
					ped::set_ped_into_vehicle(Global_91277, iLocal_70, 2);
				}
			}
			if (!iLocal_176) {
				entity::freeze_entity_position(iLocal_68, 0);
				iLocal_176 = 1;
			}
			...
			if (!func_3(&uVar0)) {
				...
				ai::task_vehicle_drive_to_coord(0, iLocal_70, vLocal_172 + vLocal_177, fLocal_175, 0, iLocal_71, 786599,
												4.5f / 2f - 1f, 10f);
...
// Position - 0x451
int func_9(var uParam0) { return uParam0; }

// Position - 0x45B
bool func_10(var uParam0, int iParam1) { return (uParam0 & iParam1) != 0; }
...
// Position - 0x66E
void func_18() { func_19(Global_91279 - 1); }

// Position - 0x680
void func_19(int iParam0) { Global_91279 = iParam0; }

// Position - 0x68E
void func_20() { func_19(0); }
...
void func_21() {
	...
	iLocal_70 = vehicle::get_random_vehicle_in_sphere(vLocal_177 + vLocal_169, 15f, iLocal_71, 2);
	iVar0 = 0;
	while (!entity::does_entity_exist(Global_91277) || !entity::does_entity_exist(iLocal_70) ||
		   !streaming::has_model_loaded(iLocal_69) && iVar0 < 400) {
	...
	if (entity::does_entity_exist(Global_91277)) {
		ped::set_ped_relationship_group_hash(Global_91277, Global_86828);
		audio::set_ambient_voice_name(Global_91277, "A_F_Y_BevHills_01_White_FULL_01");
	}
...
void func_22() {
	...
	func_41(iLocal_66, &vLocal_177, &uLocal_180, &cVar0);
	iLocal_69 = joaat("a_m_m_eastsa_02");
	func_28(1, iLocal_66, &iLocal_71, &vLocal_169, &fVar8, &vLocal_172, &fLocal_175);
	Var9.f_1 = -1;
	Var9.f_17 = 4;
	Var9.f_17.f_8 = 4;
	Var9.f_17.f_13 = 4;
...
int func_25(struct<109> Param0, var *uParam109) {
	...
	case 80:
		*uParam109 = {Param0};
		uParam109->f_109 = 1785177548;
		uParam109->f_110 = 1785177548;
		func_26(uParam109, 17, -2017877118, -2017877118,
	...
	case 155:
		*uParam109 = {Param0};
		uParam109->f_109 = 1785177548;
		uParam109->f_110 = 1785177548;
		func_26(uParam109, 17, 1785177548, 1785177548, gameplay::get_random_float_in_range(-5f, 5f),
	...
	case 158:
		*uParam109 = {Param0};
		uParam109->f_109 = 1785177548;
		uParam109->f_110 = 1785177548;
		func_26(uParam109, 144, 1785177548, 1785177548, gameplay::get_random_float_in_range(-5f, 5f),
				gameplay::get_random_float_in_range(-5f, 5f), 0f, gameplay::get_random_float_in_range(-180f, 180f));
		uParam109->f_118 = 1;
		return 1;
	...
	case 196:
		*uParam109 = {Param0};
		uParam109->f_109 = 1785177548;
		uParam109->f_110 = 1785177548;
		func_26(uParam109, 43, 1785177548, 1785177548, gameplay::get_random_float_in_range(-5f, 5f),
				gameplay::get_random_float_in_range(-5f, 5f), 0f, gameplay::get_random_float_in_range(-180f, 180f));
		uParam109->f_118 = 1;
		return 1;
...
// Position - 0x436D
void func_27(var *uParam0) { func_26(uParam0, 145, 1435919172, 1435919172, 0f, 0f, 0f, 0f); }

// Position - 0x438B
int func_28(int iParam0, int iParam1, int *iParam2, var *uParam3, float *fParam4, var *uParam5, float *fParam6) {
	iParam2->f_3 = 1000;
	iParam2->f_1 = 0;
	iParam2->f_84 = 255;
	iParam2->f_85 = 255;
	...
	case 9: return func_28(iParam0, 8, iParam2, uParam3, fParam4, uParam5, fParam6);

	case 10: return func_28(iParam0, 8, iParam2, uParam3, fParam4, uParam5, fParam6);
	...
	case 23: return func_28(iParam0, 208, iParam2, uParam3, fParam4, uParam5, fParam6);
	...
	case 113:
		if (func_28(iParam0, 112, iParam2, uParam3, fParam4, uParam5, fParam6)) {
			*uParam3 = {gameplay::get_random_float_in_range(-5f, 5f), gameplay::get_random_float_in_range(-5f, 5f), 0f};
			*fParam4 = gameplay::get_random_float_in_range(-180f, 180f);
			return 1;
		}
	...
	case 119:
		if (func_28(iParam0, 118, iParam2, uParam3, fParam4, uParam5, fParam6)) {
			*uParam5 = {5f, 20f, 0f};
			*fParam6 = 5f;
			return 1;
		}
	...
	case 106: return func_28(iParam0, 105, iParam2, uParam3, fParam4, uParam5, fParam6);

	case 107: return func_28(iParam0, 105, iParam2, uParam3, fParam4, uParam5, fParam6);
	...
	case 100: return func_28(iParam0, 99, iParam2, uParam3, fParam4, uParam5, fParam6);

	case 101: return func_28(iParam0, 99, iParam2, uParam3, fParam4, uParam5, fParam6);

	case 102: return func_28(iParam0, 99, iParam2, uParam3, fParam4, uParam5, fParam6);
	...
	case 93:
		if (func_28(iParam0, 91, iParam2, uParam3, fParam4, uParam5, fParam6)) {
	...
	case 136:
		if (func_28(iParam0, 135, iParam2, uParam3, fParam4, uParam5, fParam6)) {
			*uParam3 = {gameplay::get_random_float_in_range(-5f, 5f), gameplay::get_random_float_in_range(-5f, 5f), 0f};
			*fParam4 = gameplay::get_random_float_in_range(-180f, 180f);
			return 1;
		}
	...
	case 140:
		if (func_28(iParam0, 142, iParam2, uParam3, fParam4, uParam5, fParam6)) {
			*uParam5 = {0f, 15f, 0f};
			*fParam6 = 10f;
			return 1;
		}
	...
	case 151:
		if (func_28(iParam0, 94, iParam2, uParam3, fParam4, uParam5, fParam6)) {
	...
	case 162:
		if (func_28(iParam0, 115, iParam2, uParam3, fParam4, uParam5, fParam6)) {
	...
	case 166: return func_28(iParam0, 98, iParam2, uParam3, fParam4, uParam5, fParam6);
	...
	case 171: return func_28(iParam0, 98, iParam2, uParam3, fParam4, uParam5, fParam6);

	case 172: return func_28(iParam0, 98, iParam2, uParam3, fParam4, uParam5, fParam6);
	...
	case 209: return func_28(iParam0, 208, iParam2, uParam3, fParam4, uParam5, fParam6);

	case 210: return func_28(iParam0, 208, iParam2, uParam3, fParam4, uParam5, fParam6);

	case 211:
		func_29(iParam0, iParam2, 2);
		iParam2->f_91 = 2;
	...
	case 213:
		if (func_28(iParam0, 211, iParam2, uParam3, fParam4, uParam5, fParam6)) {
	...
	case 194:
		if (func_28(iParam0, 193, iParam2, uParam3, fParam4, uParam5, fParam6)) {
	...
	case 223:
		if (func_28(iParam0, 222, iParam2, uParam3, fParam4, uParam5, fParam6)) {
	...
	case 224: return func_28(iParam0, 222, iParam2, uParam3, fParam4, uParam5, fParam6);
	...
	case 251:
		if (func_28(iParam0, 250, iParam2, uParam3, fParam4, uParam5, fParam6)) {
	...
	case 282:
		if (func_28(iParam0, 281, iParam2, uParam3, fParam4, uParam5, fParam6)) {
			return 1;
		}
		break;
	...
	case 276: return func_28(iParam0, 275, iParam2, uParam3, fParam4, uParam5, fParam6);

	case 277: return func_28(iParam0, 275, iParam2, uParam3, fParam4, uParam5, fParam6);
...
int func_30(int iParam0, int *iParam1, int iParam2) {
	if (Global_90960[iParam0 /*98*/] == 0) {
		func_29(iParam0, iParam1, iParam2);
...
// Position - 0x8C43
int func_35() { return 0; }

// Position - 0x8C4C
int func_36() { return 1; }

// Position - 0x8C55
int func_37() { return 1; }
...
// Position - 0x92AF
bool func_44(int iParam0, float *fParam1, char *sParam2) {
	vector3 vVar0;
	int iVar3;
	var *uVar4;
	float fVar7;
	...
	case 11:
		if (func_47(iParam0, &vVar0, fParam1)) {
	...
	case 9: return func_44(8, fParam1, sParam2);

	case 10: return func_44(8, fParam1, sParam2);
	...
	case 23: return func_44(208, fParam1, sParam2);
	...
	case 224: return func_44(222, fParam1, sParam2);
	...
	case 294: return func_44(293, fParam1, sParam2);

	case 295: return func_44(292, fParam1, sParam2);
	...
	case 300: return func_44(303, fParam1, sParam2);

	case 301: return func_44(303, fParam1, sParam2);

	case 302: return func_44(303, fParam1, sParam2);
...
bool func_45(int iParam0, int iParam1, var *uParam2, var *uParam3) {
	...
	case 46: return func_45(iParam0, 26, uParam2, uParam3);
...
// Position - 0xD821
bool func_47(int iParam0, var *uParam1, float *fParam2) {
	switch (iParam0) {
	case 11:
	...
	case 9: return func_47(8, uParam1, fParam2);

	case 10: return func_47(8, uParam1, fParam2);
