...
vector3 vLocal_713[2] = {{0f, 0f, 0f}, {0f, 0f, 0f}};
vector3 vLocal_720 = {0f, 0f, 0f};
vector3 vLocal_723 = {0f, 0f, 0f};
vector3 vLocal_726 = {0f, 0f, 0f};
vector3 vLocal_729 = {0f, 0f, 0f};
vector3 vLocal_732[2] = {{0f, 0f, 0f}, {0f, 0f, 0f}};
vector3 vLocal_739[2] = {{0f, 0f, 0f}, {0f, 0f, 0f}};
vector3 vLocal_746[2] = {{0f, 0f, 0f}, {0f, 0f, 0f}};
vector3 vLocal_753 = {0f, 0f, 0f};
vector3 vLocal_756 = {0f, 0f, 0f};
vector3 vLocal_759 = {0f, 0f, 0f};
vector3 vLocal_762 = {0f, 0f, 0f};
vector3 vLocal_765 = {0f, 0f, 0f};
vector3 vLocal_768 = {0f, 0f, 0f};
vector3 vLocal_771 = {0f, 0f, 0f};
vector3 vLocal_774 = {0f, 0f, 0f};
vector3 vLocal_777 = {0f, 0f, 0f};
vector3 vLocal_780 = {0f, 0f, 0f};
vector3 vLocal_783 = {0f, 0f, 0f};
vector3 vLocal_786 = {0f, 0f, 0f};
vector3 vLocal_789 = {0f, 0f, 0f};
vector3 vLocal_792 = {0f, 0f, 0f};
vector3 vLocal_795 = {0f, 0f, 0f};
vector3 vLocal_798 = {0f, 0f, 0f};
...
void __EntryFunction__() {
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	iLocal_80 = func_570(64);
	iLocal_81 = func_570(63);
	...
	StringCopy(&vLocal_686, "", 24);
	StringCopy(&vLocal_692, "", 24);
	...
	if (func_529()) {
		...
		switch (iVar0) {
		case 0:
			func_469(vLocal_801, fLocal_420, 1, 0);
			func_457(0, 0);
			break;
		...
		if (func_455(player::player_ped_id())) {
			func_454(player::player_ped_id(), vLocal_801, fLocal_420, 0, 0);
			cam::set_gameplay_cam_relative_heading(0f);
			cam::set_gameplay_cam_relative_pitch(0f, 1065353216);
		}
	}
	while (true) {
		unk1::_0x208784099002BC30("SF_VST", 0);
		...
		if (!ped::is_ped_injured(player::player_ped_id())) {
			...
			switch (iLocal_96) {
			case 0: func_365(); break;

			case 1: func_364(); break;

			case 2: func_363(); break;

			case 5: func_351(); break;

			case 3: func_270(); break;

			case 4: func_73(); break;

			case 6: func_46(); break;
	...
	if (func_30(player::player_ped_id())) {
		...
		case 0:
			if (iLocal_98 == 1) {
				...
				if (!func_45()) {
					func_454(player::player_ped_id(), -1045.017f, 367.3012f, 68.9128f, 103.701f, 0, 0);
					cam::set_gameplay_cam_relative_heading(0f);
					cam::set_gameplay_cam_relative_pitch(0f, 1065353216);
					if (iLocal_357 == 0) {
						if (iLocal_97 == 1) {
		...
		case 1:
			if (iLocal_98 == 1) {
				func_8();
				if (!func_45()) {
					func_454(player::player_ped_id(), -462.2575f, -156.7884f, 37.0458f, 112.5754f, 0, 0);
					cam::set_gameplay_cam_relative_heading(0f);
					cam::set_gameplay_cam_relative_pitch(0f, 1065353216);
					system::wait(0);
					if (iLocal_357 == 0) {
...
// Position - 0x6FA
void func_9(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	int iVar1;
...
// Position - 0x769
void func_10() { Global_17151.f_6 = 1; }
...
void func_15(int iParam0, int iParam1) {
	...
	if (iParam1) {
		...
		while (iVar0 <= 1) {
			switch (iLocal_538) {
			case 0: Local_435[iVar0 /*14*/].f_9 = 0; break;

			case 1: break;

			case 2: Local_435[iVar0 /*14*/].f_9 = 36; break;

			case 3: Local_435[iVar0 /*14*/].f_9 = 32; break;
			...
			case 6: Local_435[iVar0 /*14*/].f_9 = 48; break;
			}
			iVar0++;
		}
	}
	if (iLocal_538 == 5) {
		...
		if (!iLocal_358) {
			func_18(0);
			func_17(5, object::_0x65499865FCA6E5EC(uLocal_388[5]), 0, 0);
			func_16(5, 0, 1);
			iLocal_362 = 1;
			iLocal_364 = 1;
			iLocal_358 = 1;
...
int func_16(int iParam0, int iParam1, int iParam2) {
	if (object::_does_door_exist(uLocal_388[iParam0])) {
		object::_set_door_acceleration_limit(uLocal_388[iParam0], iParam1, 0, iParam2);
		return 1;
	}
	return 0;
}
...
int func_17(int iParam0, float fParam1, int iParam2, int iParam3) {
	if (object::_does_door_exist(uLocal_388[iParam0])) {
		object::_0xD9B71952F78A2640(uLocal_388[iParam0], iParam2);
		object::_set_door_ajar_angle(uLocal_388[iParam0], fParam1, 0, iParam3);
		return 1;
	}
	return 0;
}
...
void func_18(int iParam0) {
	...
	if (!iLocal_362) {
		func_17(0, object::_0x65499865FCA6E5EC(uLocal_388[0]), 0, 0);
		func_16(0, iVar0, 1);
		func_17(1, object::_0x65499865FCA6E5EC(uLocal_388[1]), 0, 0);
		func_16(1, iVar0, 1);
	}
	if (!iLocal_364) {
		func_17(2, object::_0x65499865FCA6E5EC(uLocal_388[2]), 0, 0);
		func_16(2, iVar0, 1);
		func_17(3, object::_0x65499865FCA6E5EC(uLocal_388[3]), 0, 0);
		func_16(3, iVar0, 1);
	}
}
...
void func_19(int iParam0, int iParam1) {
	...
	if (iParam1) {
		switch (iLocal_535) {
		case 0: Local_421.f_9 = 0; break;

		case 1: Local_421.f_9 = 32; break;

		case 2: Local_421.f_9 = 38; break;
		...
		case 4: Local_421.f_9 = 49; break;

		case 5: Local_421.f_9 = 51; break;
		}
	}
}
	...
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_39(player::player_id()) &&
				!func_36(player::player_id(), 0) && !func_35()) {
...
// Position - 0xEE9
bool func_35() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0xF92
var func_38() { return Global_1312735; }
...
// Position - 0xFE0
bool func_40() { return gameplay::is_bit_set(Global_2359301, 3); }
...
// Position - 0x1134
bool func_45() { return gameplay::is_bit_set(Global_91491.f_20, 13); }
...
void func_46() {
	...
	sVar0 = 0;
	vLocal_729 = {entity::get_entity_coords(player::player_ped_id(), 1)};
	func_63();
	func_61();
	switch (iLocal_98) {
	case 0:
	...
	case 1:
		if (func_55()) {
			func_47(1);
			gameplay::clear_area(vLocal_720, 35f, 1, 0, 0, 0);
			gameplay::clear_area_of_peds(vLocal_720, 35f, 0);
			gameplay::clear_area_of_vehicles(vLocal_720, 35f, 0, 0, 0, 0, 0);
			gameplay::clear_area_of_objects(vLocal_720, 35f, 0);
			func_544();
		}
		break;
	}
...
void func_47(int iParam0) {
	...
	while (iVar0 <= 1) {
		if (func_30(Local_435[iVar0 /*14*/].f_8)) {
			...
			entity::set_entity_load_collision_flag(Local_435[iVar0 /*14*/].f_8, 0);
			if (iVar0 == 0) {
				ped::set_ped_leg_ik_mode(Local_435[iVar0 /*14*/].f_8, 1);
			}
		}
		func_12(&Local_435[iVar0 /*14*/].f_8, iParam0);
		iVar0++;
	}
	if (func_30(Local_421.f_8)) {
		ped::set_ped_keep_task(Local_421.f_8, 1);
		entity::set_entity_load_collision_flag(Local_421.f_8, 0);
	}
	func_12(&Local_421.f_8, iParam0);
	func_20(&Local_464);
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 2) {
		func_52(&Local_512[iVar0 /*9*/], iParam0);
		iVar0++;
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 3) {
		func_52(&Local_484[iVar0 /*9*/], iParam0);
		iVar0++;
	}
	func_49(&iLocal_804, iParam0);
	if (func_48(iLocal_805)) {
		...
		audio::_0x18EB48CFC41F2EA0(iLocal_805, 0);
	}
	func_49(&iLocal_805, iParam0);
	func_49(&iLocal_806, iParam0);
}
...
// Position - 0x1610
bool func_60(char *sParam0, int iParam1) {
	if (iParam1) {
		...
		case 2:
			if (ped::is_ped_sitting_in_any_vehicle(player::player_ped_id())) {
				if (func_60("NIGEL1B_COPS_LOST", 0)) {
					audio::set_audio_flag("AllowScoreAndRadio", 1);
					iLocal_404 = gameplay::get_game_timer();
					iLocal_402 = 3;
				}
			}
...
int func_65(int iParam0) {
	if (object::_does_door_exist(uLocal_388[iParam0])) {
		if (!object::is_door_closed(uLocal_388[iParam0])) {
			return 1;
		}
	}
	return 0;
...
bool func_66(int iParam0, int iParam1) {
	...
	if (func_68(&uLocal_596, vVar0)) {
		if (func_67(vVar0.z, 66.21f, 11f)) {
			return true;
		}
	}
	return false;
...
// Position - 0x1916
bool func_67(float fParam0, float fParam1, float fParam2) {
	float fVar0;
...
bool func_70(int iParam0, int iParam1) {
	...
	vVar0 = {entity::get_entity_coords(iParam0, 1)};
	if (func_71(iParam0, vLocal_762, 5.93f)) {
	...
	if (entity::is_entity_in_area(iParam0, vLocal_765, vLocal_768, 0, 1, 0) ||
		entity::is_entity_in_angled_area(iParam0, vLocal_771, vLocal_774, 2.8f, 0, 1, 0) ||
		entity::is_entity_in_angled_area(iParam0, vLocal_777, vLocal_780, 12.5f, 0, 1, 0) ||
		entity::is_entity_in_angled_area(iParam0, vLocal_783, vLocal_786, 8.5f, 0, 1, 0) ||
		entity::is_entity_in_angled_area(iParam0, vLocal_789, vLocal_792, 4f, 0, 1, 0)) {
		if (func_67(vVar0.z, 66.21f, 11f)) {
			return true;
		}
	}
...
void func_74(int iParam0, int iParam1) {
	...
	func_225(0, 0);
	MemCopy(&sVar1, {func_223(iVar0)}, 4);
...
void func_77() {
	...
	if (fVar8 > 0f && system::floor(fVar8) < system::floor(Global_101700.f_9153.f_3853)) {
		func_79(13, system::floor(Global_101700.f_9153.f_3853));
	}
...
// Position - 0x22D4
int func_78() { return Global_25190; }
...
// Position - 0x2838
void func_89() { func_90(&Global_96040); }
...
// Position - 0x2F86
void func_96(int *iParam0) { *iParam0 = -15; }
...
int func_100(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam1 == 12) {
		...
		if (ped::get_number_of_ped_drawable_variations(iParam0, func_143(iParam1)) > 0 &&
			ped::get_number_of_ped_texture_variations(iParam0, func_143(iParam1), Global_69523[1 /*14*/].f_3) > 0) {
...
bool func_101(int iParam0, int iParam1, int *iParam2) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_63 != -99) {
		if (!func_216(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_64,
...
// Position - 0x336E
int func_103(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
				...
				if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0)) {
					if (iVar0 == 13) {
						...
						while (iVar1 <= 8) {
							...
							func_119(iParam0, Global_69523[1 /*14*/].f_12, Global_69523[1 /*14*/].f_3,
...
// Position - 0x3D0C
bool func_107(int iParam0, int iParam1, int iParam2, int iParam3, var *uParam4, var *uParam5) {
	var uVar0;
	int iVar10;
...
// Position - 0x4753
var func_111(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
...
void func_119(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == -1) {
		...
		if (iParam1 == 0) {
			...
			if (func_120(entity::get_entity_model(iParam0), 14, iVar0,
		...
		if (iVar4 != iParam1) {
			...
			while (iVar5 <= iVar6 - 1) {
				if (iVar4 == iParam1 && iVar5 == iParam2) {
					iVar3 += func_125(iParam0, iParam3);
					return iVar3;
				}
				else {
					iVar3++;
...
void func_135(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_139(iParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3)) {
...
// Position - 0x7659
bool func_139(int iParam0, int iParam1, int *iParam2, int *iParam3, bool bParam4, bool bParam5) {
	int iVar0;
...
// Position - 0x8849
bool func_140(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	if (iParam0 == 0) {
		if (iParam5 == 1) {
...
bool func_142(int iParam0, int iParam1, int *iParam2, int iParam3) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_60 != -99) {
		if (!func_216(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_61,
...
struct<10> func_144(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		switch (iParam1) {
		case 31: func_146(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 0: func_146(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_146(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_146(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_146(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_146(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8); break;

		case 5: func_146(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8); break;

		case 6: func_146(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_146(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_146(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_146(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8); break;

		default: func_145(&Var1, iParam0, iParam1, 10); break;
		}
		break;
	...
	case joaat("player_one"):
		...
		case 1: func_146(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8); break;

		case 2: func_146(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8); break;

		case 3: func_146(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_146(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_146(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_146(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_146(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_146(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_145(&Var1, iParam0, iParam1, 9); break;
		}
		break;
	...
	case joaat("player_two"):
		...
		case 0: func_146(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_146(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_146(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_146(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8); break;

		case 4: func_146(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8); break;

		case 5: func_146(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_146(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_146(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_146(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8); break;
	...
	case joaat("mp_m_freemode_01"):
		...
		case 0: func_146(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_146(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_146(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_146(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_146(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_146(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_146(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_146(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_146(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_146(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_146(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_146(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_146(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_146(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 14: func_146(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_146(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_146(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_146(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_146(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_146(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_146(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_146(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_146(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_146(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 24: func_146(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_145(&Var1, iParam0, iParam1, 25); break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 0: func_146(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_146(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_146(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_146(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_146(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_146(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_146(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_146(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_146(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_146(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_146(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_146(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_146(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_146(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8); break;

		case 14: func_146(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_146(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_146(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_146(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_146(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_146(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_146(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_146(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_146(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_146(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8); break;
			...
			while (iVar19 < Var1.f_3) {
				if (dlc1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1) {
					if (vVar16.x != 0 && vVar16.x != -1 && vVar16.x != 1849449579) {
						(*iParam0)[vVar16.z] = func_126(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1) {
...
// Position - 0xA357
void func_146(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
struct<17> func_147(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		...
		case 1: func_150(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0); break;

		case 2: func_150(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8); break;

		case 3: func_150(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31); break;

		case 4: func_150(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2); break;

		case 5:
			func_150(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[0], Global_101700.f_2095.f_539.f_200[0], 6, 3, 0,
					 0, 0, -99, 0, 0, 3);
			break;

		case 6: func_150(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_150(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 8: func_150(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 9: func_150(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 10: func_150(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4); break;

		case 11: func_150(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5); break;

		case 12: func_150(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31); break;

		case 13: func_150(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 14: func_150(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6); break;

		case 15: func_150(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31); break;

		case 16: func_150(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31); break;

		case 17: func_150(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 18: func_150(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7); break;

		case 19: func_150(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 20: func_150(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 21: func_150(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_150(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 23: func_150(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31); break;

		case 24: func_150(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31); break;

		case 25: func_150(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 26: func_150(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 27: func_150(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 28: func_150(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 29: func_150(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 30: func_150(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 31: func_150(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31); break;

		case 32: func_150(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 33: func_150(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 34: func_150(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31); break;

		case 35: func_150(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 36: func_150(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 37: func_150(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 38: func_150(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 39: func_150(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 40: func_150(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 41: func_150(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_150(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_150(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_150(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 45: func_150(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 46: func_150(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_150(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 48: func_150(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31); break;

		case 49: func_150(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 50: func_150(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9); break;

		case 51: func_150(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 52: func_150(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		default: func_148(&Var1, iParam0, iParam1, 53); break;
		}
		break;

	case joaat("player_one"):
		switch (iParam1) {
		case 0: func_150(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 1: func_150(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 2:
			func_150(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[1], Global_101700.f_2095.f_539.f_200[1], 17, 2,
					 26, 0, 0, -99, 0, 45, 31);
			break;

		case 3: func_150(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1); break;

		case 4: func_150(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2); break;

		case 5: func_150(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 6: func_150(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_150(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3); break;

		case 8: func_150(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5); break;

		case 9: func_150(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 10: func_150(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 11: func_150(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 12: func_150(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 13: func_150(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 14: func_150(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 15: func_150(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 16: func_150(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 17: func_150(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 18: func_150(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31); break;

		case 19: func_150(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 20: func_150(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 21: func_150(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4); break;

		case 22: func_150(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31); break;

		case 23: func_150(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31); break;

		case 24: func_150(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31); break;

		case 25: func_150(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31); break;

		case 26: func_150(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31); break;

		case 27: func_150(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31); break;

		case 28: func_150(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31); break;

		case 29: func_150(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31); break;

		case 30: func_150(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31); break;

		case 31: func_150(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31); break;

		case 32: func_150(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31); break;

		case 33: func_150(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31); break;

		case 34: func_150(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31); break;

		case 35: func_150(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31); break;

		case 36: func_150(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31); break;

		case 37: func_150(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31); break;

		case 38: func_150(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 39: func_150(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 40: func_150(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 41: func_150(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 42: func_150(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31); break;

		case 43: func_150(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6); break;

		case 44: func_150(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 45: func_150(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8); break;

		case 46: func_150(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31); break;

		default: func_148(&Var1, iParam0, iParam1, 47); break;
		}
		break;

	case joaat("player_two"):
		switch (iParam1) {
		case 0: func_150(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 1: func_150(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8); break;

		case 2: func_150(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1); break;

		case 3: func_150(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2); break;

		case 4:
			func_150(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[2], Global_101700.f_2095.f_539.f_200[2], 8, 0, 0,
					 0, 0, -99, 0, 0, 31);
			break;

		case 5: func_150(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6); break;

		case 6: func_150(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3); break;

		case 7: func_150(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4); break;

		case 8: func_150(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31); break;

		case 9: func_150(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 10: func_150(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 11: func_150(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5); break;

		case 12: func_150(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 13: func_150(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31); break;

		case 14: func_150(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31); break;

		case 15: func_150(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 16: func_150(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 17: func_150(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 18: func_150(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 19: func_150(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 20: func_150(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 21: func_150(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_150(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 23: func_150(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 24: func_150(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 25: func_150(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 26: func_150(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 27: func_150(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 28: func_150(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 29: func_150(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 30: func_150(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 31: func_150(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 32: func_150(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 33: func_150(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 34: func_150(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 35: func_150(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 36: func_150(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 37: func_150(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 38: func_150(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 39: func_150(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 40: func_150(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 41: func_150(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_150(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_150(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_150(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31); break;

		case 45: func_150(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 46: func_150(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_150(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31); break;

		default: func_148(&Var1, iParam0, iParam1, 48); break;
		}
		break;

	case joaat("mp_m_freemode_01"):
		switch (iParam1) {
		case 0: func_150(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31); break;

		case 1: func_150(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0); break;

		case 2: func_150(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1); break;

		case 3: func_150(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2); break;

		case 4: func_150(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3); break;

		case 5: func_150(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4); break;

		case 6: func_150(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5); break;

		case 7: func_150(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6); break;

		case 8: func_150(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7); break;

		case 9: func_150(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8); break;

		case 10: func_150(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9); break;

		case 11: func_150(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10); break;

		case 12: func_150(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11); break;

		case 13: func_150(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12); break;

		case 14: func_150(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13); break;

		case 15: func_150(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14); break;

		case 16: func_150(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15); break;

		case 17: func_150(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16); break;

		case 18: func_150(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17); break;

		case 19: func_150(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18); break;

		case 20: func_150(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19); break;

		case 21: func_150(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20); break;

		case 22: func_150(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21); break;

		case 23: func_150(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22); break;

		case 24: func_150(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23); break;

		case 25: func_150(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24); break;

		default: func_148(&Var1, iParam0, iParam1, 26); break;
		}
		break;

	case joaat("mp_f_freemode_01"):
		switch (iParam1) {
		case 0: func_150(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31); break;

		case 1: func_150(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31); break;

		case 2: func_150(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0); break;

		case 3: func_150(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1); break;

		case 4: func_150(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2); break;

		case 5: func_150(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3); break;

		case 6: func_150(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4); break;

		case 7: func_150(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5); break;

		case 8: func_150(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6); break;

		case 9: func_150(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7); break;

		case 10: func_150(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8); break;

		case 11: func_150(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9); break;

		case 12: func_150(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10); break;

		case 13: func_150(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31); break;

		case 14: func_150(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11); break;

		case 15: func_150(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12); break;

		case 16: func_150(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13); break;

		case 17: func_150(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14); break;

		case 18: func_150(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15); break;

		case 19: func_150(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16); break;

		case 20: func_150(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17); break;

		case 21: func_150(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31); break;

		case 22: func_150(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18); break;

		case 23: func_150(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19); break;

		case 24: func_150(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20); break;

		case 25: func_150(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21); break;

		case 26: func_150(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22); break;

		case 27: func_150(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23); break;

		default: func_148(&Var1, iParam0, iParam1, 28); break;
		}
		break;
	}
	return Var1;
			...
			if (dlc1::_get_prop_from_outfit(Var1.f_1, iVar36, &vVar16)) {
				if (vVar16.x != 0 && vVar16.x != -1 && vVar16.x != 1849449579) {
					...
					if (vVar16.z == 10 && uParam0->f_16) {
						(*uParam0)[func_149(vVar16.z)] = vVar16.x;
						uParam0->f_16 = 1;
					}
					else {
						(*uParam0)[func_149(vVar16.z)] = func_126(iParam1, vVar16.x, func_149(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1) {
					(*uParam0)[func_149(vVar16.z)] = vVar16.y;
				}
			}
			iVar36++;
		}
...
// Position - 0xC483
void func_150(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) {
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
{
	switch (iParam0) {
	case 0: func_177(iParam1); break;

	case 2: func_176(iParam1); break;
	...
	case 5: func_170(iParam1); break;

	case 8: func_169(iParam1); break;

	case 9: func_168(iParam1); break;

	case 10: func_167(iParam1); break;

	case 1: func_166(iParam1); break;

	case 7: func_165(iParam1); break;

	case 11: func_164(iParam1); break;

	case 12: func_163(iParam1); break;

	case 13: func_162(iParam1); break;

	case 14: func_153(iParam1); break;
	}
}
...
void func_153(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 155); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

// Position - 0xD8AC
void func_154(var *uParam0, int iParam1, int iParam2, char *sParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	*uParam0 = iParam9;
	...
	if (iParam10) {
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 ||
			...
			iVar0 = func_138(func_157(iParam1, uParam0->f_2), Global_69521, 0);
...
// Position - 0xE87A
bool func_159(int iParam0) { return Global_35781 == iParam0; }
		...
		while (iVar38 < iVar40) {
			...
			if (!dlc1::_is_dlc_data_empty(Var20)) {
				if (iVar39 == iParam1 - iParam2) {
					...
					func_154(&Global_69523[0 /*14*/], iParam0, iParam1, &Var20.f_9, Var20.f_3, Var20.f_4, Var20.f_5,
		...
		while (iVar58 < iVar60) {
			...
			if (!dlc1::_is_dlc_data_empty(Var41)) {
				if (iVar59 == iParam1 - iParam2) {
					...
					func_154(&Global_69523[0 /*14*/], iParam0, iParam1, &Var41.f_9, Var41.f_3, Var41.f_4, Var41.f_5,
...
void func_162(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 9); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_163(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 48); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_164(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 1); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_166(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 6); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_167(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 33); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_168(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 17); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_169(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 18); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_170(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 7); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_171(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 84); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_172(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 104); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_178(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_196(iParam1); break;

	case 2: func_195(iParam1); break;
	...
	case 14: func_179(iParam1); break;
	}
}
...
void func_179(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 175); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_181(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 47); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_182(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 63); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_184(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 5); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_185(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 53); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_186(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 12); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_187(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 77); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_189(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 134); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_190(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 117); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_195(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 21); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_196(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 10); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_197(int iParam0, int iParam1) {
	...
	case 3: func_210(iParam1); break;

	case 4: func_209(iParam1); break;

	case 6: func_208(iParam1); break;

	case 5: func_207(iParam1); break;

	case 8: func_206(iParam1); break;

	case 9: func_205(iParam1); break;

	case 10: func_204(iParam1); break;

	case 1: func_203(iParam1); break;

	case 7: func_202(iParam1); break;

	case 11: func_201(iParam1); break;

	case 12: func_200(iParam1); break;

	case 13: func_199(iParam1); break;

	case 14: func_198(iParam1); break;
	}
}
...
void func_198(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 113); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_201(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 45); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_205(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 20); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_206(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 24); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_207(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 14); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_208(int iParam0) {
	...
	default: func_161(iVar10, iParam0, 99); return;
	}
	func_154(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
bool func_216(int iParam0, int iParam1, int iParam2) {
	...
	else if (Global_69523[1 /*14*/].f_3 == ped::get_ped_drawable_variation(iParam0, func_143(iParam1)) &&
...
// Position - 0x2013C
bool func_219(int iParam0) { return iParam0 < 3; }
...
void func_222() {
	...
	if (entity::does_entity_exist(player::player_ped_id())) {
		if (func_218(Global_101700.f_2095.f_539.f_3549) != entity::get_entity_model(player::player_ped_id())) {
...
void func_227(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 != -1) {
		...
		MemCopy(&sVar32, {func_224(iParam0)}, 4);
		stats::playstats_mission_checkpoint(&sVar32, 0, Global_91528, 0);
		func_228(&sVar32, Var0.f_3, Global_91528, iParam1, iParam2);
	}
}

// Position - 0x2088C
void func_228(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
...
void func_229(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_230(uParam1, "Abigail1", func_223(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				 "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_231(iParam0), 1, 0);
		break;

	case 1:
		func_230(uParam1, "Abigail2", func_223(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				 -1, 4, 1, 0, 2359, func_231(iParam0), 1, 0);
		break;

	case 2:
		func_230(uParam1, "Barry1", func_223(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				 4, 1, 0, 2359, func_231(iParam0), 1, 0);
		break;

	case 3:
		func_230(uParam1, "Barry2", func_223(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				 4, 4, 0, 2359, func_231(iParam0), 1, 1);
		break;

	case 4:
		func_230(uParam1, "Barry3", func_223(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2,
				 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 5:
		func_230(uParam1, "Barry3A", func_223(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0,
				 "", 166, 0, 7, 4, 2, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 6:
		func_230(uParam1, "Barry3C", func_223(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				 7, 4, 2, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 7:
		func_230(uParam1, "Barry4", func_223(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0,
				 "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_231(iParam0), 0, 0);
		break;

	case 8:
		func_230(uParam1, "Dreyfuss1", func_223(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				 0, "", 0, 0, -1, 4, 2, 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 9:
		func_230(uParam1, "Epsilon1", func_223(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1,
				 10, 4, 1, 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 10:
		func_230(uParam1, "Epsilon2", func_223(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0,
				 11, 4, 1, 0, 2359, func_231(iParam0), 1, 0);
		break;

	case 11:
		func_230(uParam1, "Epsilon3", func_223(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				 0, 0, 12, 4, 1, 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 12:
		func_230(uParam1, "Epsilon4", func_223(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				 "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 13:
		func_230(uParam1, "Epsilon5", func_223(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16,
				 "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_231(iParam0), 1, 0);
		break;

	case 14:
		func_230(uParam1, "Epsilon6", func_223(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 15:
		func_230(uParam1, "Epsilon7", func_223(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 16:
		func_230(uParam1, "Epsilon8", func_223(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_231(iParam0), 1, 0);
		break;

	case 17:
		func_230(uParam1, "Extreme1", func_223(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 18:
		func_230(uParam1, "Extreme2", func_223(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 19:
		func_230(uParam1, "Extreme3", func_223(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 20:
		func_230(uParam1, "Extreme4", func_223(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 21:
		func_230(uParam1, "Fanatic1", func_223(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_231(iParam0), 1, 0);
		break;

	case 22:
		func_230(uParam1, "Fanatic2", func_223(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_231(iParam0), 1, 0);
		break;

	case 23:
		func_230(uParam1, "Fanatic3", func_223(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_231(iParam0), 0, 1);
		break;

	case 24:
		func_230(uParam1, "Hao1", func_223(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_231(iParam0), 0, 1);
		break;

	case 25:
		func_230(uParam1, "Hunting1", func_223(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 26:
		func_230(uParam1, "Hunting2", func_223(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 27:
		func_230(uParam1, "Josh1", func_223(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_231(iParam0), 1, 0);
		break;

	case 28:
		func_230(uParam1, "Josh2", func_223(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_231(iParam0), 1, 1);
		break;

	case 29:
		func_230(uParam1, "Josh3", func_223(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_231(iParam0), 1, 1);
		break;

	case 30:
		func_230(uParam1, "Josh4", func_223(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_231(iParam0), 1, 0);
		break;

	case 31:
		func_230(uParam1, "Maude1", func_223(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 32:
		func_230(uParam1, "Minute1", func_223(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 33:
		func_230(uParam1, "Minute2", func_223(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 34:
		func_230(uParam1, "Minute3", func_223(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 35:
		func_230(uParam1, "MrsPhilips1", func_223(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 36:
		func_230(uParam1, "MrsPhilips2", func_223(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_231(iParam0), 0, 0);
		break;

	case 37:
		func_230(uParam1, "Nigel1", func_223(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_231(iParam0), 1, 0);
		break;

	case 38:
		func_230(uParam1, "Nigel1A", func_223(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_231(iParam0), 1, 1);
		break;

	case 39:
		func_230(uParam1, "Nigel1B", func_223(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_231(iParam0), 1, 1);
		break;

	case 40:
		func_230(uParam1, "Nigel1C", func_223(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_231(iParam0), 1, 1);
		break;

	case 41:
		func_230(uParam1, "Nigel1D", func_223(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_231(iParam0), 1, 1);
		break;

	case 42:
		func_230(uParam1, "Nigel2", func_223(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_231(iParam0), 1, 1);
		break;

	case 43:
		func_230(uParam1, "Nigel3", func_223(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_231(iParam0), 1, 1);
		break;

	case 44:
		func_230(uParam1, "Omega1", func_223(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 45:
		func_230(uParam1, "Omega2", func_223(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 46:
		func_230(uParam1, "Paparazzo1", func_223(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 47:
		func_230(uParam1, "Paparazzo2", func_223(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 48:
		func_230(uParam1, "Paparazzo3", func_223(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 49:
		func_230(uParam1, "Paparazzo3A", func_223(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 50:
		func_230(uParam1, "Paparazzo3B", func_223(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 51:
		func_230(uParam1, "Paparazzo4", func_223(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 52:
		func_230(uParam1, "Rampage1", func_223(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 54:
		func_230(uParam1, "Rampage3", func_223(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_231(iParam0), 1, 0);
		break;

	case 55:
		func_230(uParam1, "Rampage4", func_223(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_231(iParam0), 1, 0);
		break;

	case 56:
		func_230(uParam1, "Rampage5", func_223(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_231(iParam0), 0, 0);
		break;

	case 53:
		func_230(uParam1, "Rampage2", func_223(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_231(iParam0), 1, 0);
		break;

	case 57:
		func_230(uParam1, "TheLastOne", func_223(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 58:
		func_230(uParam1, "Tonya1", func_223(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 59:
		func_230(uParam1, "Tonya2", func_223(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_231(iParam0), 0, 1);
		break;

	case 60:
		func_230(uParam1, "Tonya3", func_223(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_231(iParam0), 0, 1);
		break;

	case 61:
		func_230(uParam1, "Tonya4", func_223(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_231(iParam0), 0, 1);
		break;

	case 62:
		func_230(uParam1, "Tonya5", func_223(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_231(iParam0), 0, 1);
		break;
...
// Position - 0x21A44
void func_230(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
// Position - 0x21E1B
void func_232(int iParam0) { Global_36332 = gameplay::get_game_timer() + iParam0; }

// Position - 0x21E2D
void func_233() {
	if (Global_89136) {
		func_222();
		graphics::_0xBF59707B3E5ED531(func_234(Global_101700.f_2095.f_539.f_3549));
	}
	else {
...
void func_239(int iParam0, int iParam1) {
	...
	func_257(iParam0, G_TextMessageConfig);
	if (!iParam1) {
...
// Position - 0x2247A
int func_242() { return Global_101700.f_8975.f_21 + Global_101700.f_17533.f_380; }
...
void func_245(int iParam0) {
	switch (iParam0) {
	case 30: func_249(22, 1, 0, 1, 0); break;

	case 15: func_246(37, 0); break;
...
void func_249(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	if (iParam0 != 198) {
		...
		func_252(iParam0, iParam3, iParam4, 0);
...
// Position - 0x22A4A
bool func_252(int iParam0, bool bParam1, int iParam2, int iParam3) {
	bool bVar0;
	int iVar1;
	int iVar2;
	struct<5> Var3;
...
// Position - 0x23389
int func_254() { return Global_25191; }
...
void func_257(int iParam0, bool bParam1) {
	switch (iParam0) {
	case 46: func_258(4, bParam1); break;

	case 16: func_258(6, bParam1); break;

	case 37: func_258(17, bParam1); break;

	case 31: func_258(16, bParam1); break;
	}
}
...
// Position - 0x27249
int func_268() { return func_269(script::get_this_script_name(), 0); }
...
void func_270() {
	...
	case 0:
		func_22(0, 1);
		if (!ped::is_ped_injured(player::player_ped_id())) {
			func_286(&uLocal_160, 2, player::player_ped_id(), "TREVOR", 0, 1);
		}
...
bool func_273(char *sParam0) {
	if (iLocal_540 == 2 || iLocal_540 == 4) {
		if (gameplay::are_strings_equal(sParam0, "NULL") || gameplay::are_strings_equal(sParam0, "")) {
			return true;
		}
		else if (gameplay::are_strings_equal(sParam0, &sLocal_698)) {
			return true;
		}
	}
	return false;
...
// Position - 0x27434
bool func_275(var *uParam0, int iParam1, char *sParam2, char *sParam3, int iParam4, int iParam5, int iParam6,
	...
	Global_2621441 = 0;
	return func_276(sParam3, iParam4, iParam8);
}

// Position - 0x27493
int func_276(char *sParam0, int iParam1, int iParam2) {
	Global_15746 = 0;
...
// Position - 0x27A5F
bool func_285(int iParam0, int iParam1) { return gameplay::get_game_timer() - iParam0 > iParam1; }
	...
	if (func_30(Local_421.f_8)) {
		...
		case 0:
			if (audio::has_sound_finished(iLocal_396)) {
				if (!ped::is_ped_being_stealth_killed(Local_421.f_8) && !ped::is_ped_ragdoll(Local_421.f_8) &&
					!audio::is_ped_in_current_conversation(Local_421.f_8)) {
					audio::play_sound_from_entity(iLocal_396, "WHISTLING", Local_421.f_8, "NIGEL_1B_SOUNDSET", 0, 0);
				}
			}
			else if (ped::is_ped_being_stealth_killed(Local_421.f_8) || ped::is_ped_ragdoll(Local_421.f_8) ||
					 audio::is_ped_in_current_conversation(Local_421.f_8)) {
				if (!audio::has_sound_finished(iLocal_396)) {
			...
			if (func_322() || func_321(Local_421.f_8, 1101004800, 1084227584, 1097859072)) {
				...
				if (func_319(3) || func_316(0, Local_421.f_13, 0, 0, 1) && iLocal_537 == 3 || func_315()) {
					...
					if (func_71(Local_421.f_8, vLocal_729, 4f)) {
						if (!audio::has_sound_finished(iLocal_396)) {
							audio::stop_sound(iLocal_396);
						}
						func_19(1, 1);
					...
					if (func_71(Local_421.f_8, vLocal_729, 2.5f)) {
						if (!audio::has_sound_finished(iLocal_396)) {
							audio::stop_sound(iLocal_396);
						}
						func_19(1, 1);
				...
				else if (entity::has_entity_been_damaged_by_entity(Local_421.f_8, player::player_ped_id(), 1)) {
					if (!audio::has_sound_finished(iLocal_396)) {
						audio::stop_sound(iLocal_396);
					}
					func_19(1, 1);
					...
					if (!func_3() && !func_273("NULL")) {
						if (func_285(iLocal_405, gameplay::get_random_int_in_range(5000, 12000))) {
		...
		case 1:
			if (!iLocal_332) {
				...
				if (iLocal_538 == 0 || iLocal_538 == 1) {
					if (!func_311("NIG1B_GSP", 1) || func_308(Local_421.f_8, 1082130432) ||
						func_285(iLocal_410, 1250)) {
						func_19(2, 1);
					}
				}
				else if (!iLocal_331) {
		...
		case 3:
			...
			if (!iLocal_333) {
				...
				else if (iLocal_537 == 3 || func_71(Local_421.f_8, vLocal_729, 5f)) {
					func_22(0, 0);
		...
		case 4:
			if (!iLocal_329) {
				if (func_72(Local_421.f_8, 0)) {
					if (iLocal_537 == 3 || func_296(Local_421.f_8, player::player_ped_id(), 1126825984, 1, 250, 7)) {
						if (!func_3() && !func_273("NULL")) {
		...
		if (Local_421.f_9 == 49 || Local_421.f_9 == 50) {
			...
			if (iLocal_537 == 0 && !func_71(Local_421.f_8, vLocal_729, 35f)) {
				func_59(&Local_421);
			}
			else {
				func_289(Local_421.f_8, &Local_421, -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
		...
		if (func_455(Local_484[0 /*9*/]) && entity::is_entity_attached_to_any_ped(Local_484[0 /*9*/])) {
		...
		if (iLocal_535 != 5) {
			if (entity::does_entity_exist(Local_421.f_8)) {
				if (ped::was_ped_killed_by_stealth(Local_421.f_8)) {
					func_288(787);
					unk1::_0x293220DA1B46CEBC(2.5f, 2f, 0);
				}
				else if (entity::has_entity_been_damaged_by_entity(Local_421.f_8, player::player_ped_id(), 1)) {
					func_288(787);
					unk1::_0x293220DA1B46CEBC(2.5f, 2f, 0);
...
// Position - 0x28340
int func_289(int iParam0, var *uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6,
		...
		if (!ped::is_ped_performing_stealth_kill(player::player_ped_id())) {
			...
			case 0:
				if (!entity::is_entity_playing_anim(Local_421.f_8, "rcmnigel1b", "idle_gardener", 3)) {
					ai::task_play_anim(Local_421.f_8, "rcmnigel1b", "idle_gardener", 4f, -8f, -1, 270337, 0, 0, 0, 0);
				}
				break;

			case 32:
				if (func_455(Local_484[0 /*9*/]) &&
					entity::is_entity_attached_to_entity(Local_484[0 /*9*/], Local_421.f_8)) {
					entity::detach_entity(Local_484[0 /*9*/], 1, 1);
				}
				ai::clear_ped_secondary_task(Local_421.f_8);
				if (!ped::is_ped_headtracking_ped(Local_421.f_8, player::player_ped_id())) {
					ai::task_look_at_entity(Local_421.f_8, player::player_ped_id(), -1, 0, 2);
				}
				if (entity::is_entity_playing_anim(Local_421.f_8, "rcmnigel1b", "idle_gardener", 3)) {
					if (!ped::is_ped_ragdoll(Local_421.f_8) && !ai::is_ped_getting_up(Local_421.f_8)) {
						ai::task_play_anim(Local_421.f_8, "rcmnigel1b", "exit_gardener", 8f, -4f, -1, 8192, 0, 0, 0, 0);
					}
				...
				if (!entity::is_entity_playing_anim(Local_421.f_8, "rcmnigel1b", "exit_gardener", 3)) {
					if (!ped::is_ped_facing_ped(Local_421.f_8, player::player_ped_id(), 45f)) {
						if (!func_295(Local_421.f_8, -875674219)) {
							ai::task_turn_ped_to_face_entity(Local_421.f_8, player::player_ped_id(), 0);
						}
					}
				}
				else {
			...
			case 34:
				ai::clear_ped_tasks(Local_421.f_8);
				if (!ped::is_ped_headtracking_ped(Local_421.f_8, player::player_ped_id())) {
					ai::task_look_at_entity(Local_421.f_8, player::player_ped_id(), -1, 0, 2);
				}
				if (!ped::is_ped_facing_ped(Local_421.f_8, player::player_ped_id(), 45f)) {
				...
				ped::set_blocking_of_non_temporary_events(Local_421.f_8, 1);
				Local_421.f_11 = gameplay::get_game_timer();
				Local_421.f_9 = 35;
				break;
			...
			case 35:
				if (!func_295(Local_421.f_8, -2017877118)) {
					...
					else if (func_285(Local_421.f_11, gameplay::get_random_int_in_range(2000, 4000))) {
			...
			case 38:
				if (!entity::is_entity_playing_anim(Local_421.f_8, "rcmnigel1b", "exit_gardener", 3)) {
					ai::open_sequence_task(&iLocal_542);
					if (!func_71(Local_421.f_8, -1050.359f, 354.0594f, 68.9132f, 3f)) {
						ai::task_follow_nav_mesh_to_coord(0, -1050.359f, 354.0594f, 68.9132f, 2f, 20000, 0.25f, 0,
														  38.0338f);
					}
					if (func_455(Local_435[0 /*14*/].f_8)) {
						ai::task_turn_ped_to_face_entity(0, Local_435[0 /*14*/].f_8, -1);
					}
					ai::close_sequence_task(iLocal_542);
					ai::task_perform_sequence(Local_421.f_8, iLocal_542);
					ai::clear_sequence_task(&iLocal_542);
					ped::set_blocking_of_non_temporary_events(Local_421.f_8, 1);
					Local_421.f_9 = 39;
				}
				break;
			...
			case 39:
				if (!func_295(Local_421.f_8, 242628503)) {
					...
					if (!func_295(Local_421.f_8, 150319005)) {
						ai::task_look_at_entity(Local_421.f_8, Local_435[0 /*14*/].f_8, -1, 0, 2);
					}
				}
				break;
			...
			case 43:
				if (!ped::is_ped_ragdoll(Local_421.f_8)) {
					if (!func_295(Local_421.f_8, 474215631) && !func_295(Local_421.f_8, -1519143300)) {
						if (!entity::is_entity_in_water(Local_421.f_8) &&
							!func_71(Local_421.f_8, vLocal_753, fLocal_384) &&
							!entity::is_entity_in_angled_area(Local_421.f_8, vLocal_756, vLocal_759, fLocal_385, 0, 1,
															  0) &&
							!ped::is_ped_climbing(Local_421.f_8)) {
							ped::set_ped_cower_hash(Local_421.f_8, "CODE_HUMAN_STAND_COWER");
							ai::task_cower(Local_421.f_8, -1);
						}
						else if (!func_295(Local_421.f_8, 713668775)) {
							ai::clear_ped_tasks(Local_421.f_8);
							vVar0 = {vLocal_746[0 /*3*/]};
							fVar3 = 201.7237f;
							if (func_293(vLocal_729, vVar0, 1.5f)) {
								vVar0 = {vLocal_746[1 /*3*/]};
								fVar3 = 325.0476f;
							}
							ai::task_follow_nav_mesh_to_coord(Local_421.f_8, vVar0, 1f, 20000, 0.25f, 0, fVar3);
							ped::set_blocking_of_non_temporary_events(Local_421.f_8, 1);
						}
						ped::set_blocking_of_non_temporary_events(Local_421.f_8, 1);
					}
			...
			case 44:
				...
				if (ped::is_ped_using_any_scenario(Local_421.f_8)) {
					ped::_0xFE07FF6495D52E2A(Local_421.f_8, vLocal_729);
				}
				if (entity::is_entity_in_water(Local_421.f_8) &&
					entity::is_entity_in_angled_area(Local_421.f_8, vLocal_756, vLocal_759, fLocal_385, 0, 1, 0)) {
					if (!func_295(Local_421.f_8, 713668775)) {
						if (!ped::is_ped_ragdoll(Local_421.f_8) && !ai::is_ped_getting_up(Local_421.f_8) &&
							!ped::is_ped_climbing(Local_421.f_8)) {
							vVar4 = {vLocal_746[0 /*3*/]};
							fVar7 = 201.7237f;
							if (func_293(vLocal_729, vVar4, 1.5f)) {
								vVar4 = {vLocal_746[1 /*3*/]};
								fVar7 = 325.0476f;
							}
							ai::task_follow_nav_mesh_to_coord(Local_421.f_8, vVar4, 1f, 20000, 0.25f, 0, fVar7);
							ped::set_blocking_of_non_temporary_events(Local_421.f_8, 1);
						}
					}
				}
					...
					if (entity::is_entity_playing_anim(Local_421.f_8, "rcmnigel1b", "idle_gardener", 3)) {
						if (!ped::is_ped_ragdoll(Local_421.f_8) && !ai::is_ped_getting_up(Local_421.f_8) &&
							!ped::is_ped_climbing(Local_421.f_8) && !ped::is_ped_being_stunned(Local_421.f_8, 0)) {
							ai::task_play_anim(Local_421.f_8, "rcmnigel1b", "exit_panic_gardener", 8f, -4f, -1, 8192, 0,
											   0, 0, 0);
							ped::set_blocking_of_non_temporary_events(Local_421.f_8, 1);
						}
						else if (func_295(Local_421.f_8, 1785177548)) {
						...
						ai::task_hands_up(Local_421.f_8, -1, player::player_ped_id(), -1, 0);
						ped::set_blocking_of_non_temporary_events(Local_421.f_8, 1);
					}
					Local_421.f_9 = 45;
				}
			...
			case 46:
				if (entity::is_entity_in_water(Local_421.f_8) || func_71(Local_421.f_8, vLocal_753, fLocal_384) ||
					entity::is_entity_in_angled_area(Local_421.f_8, vLocal_756, vLocal_759, fLocal_385, 0, 1, 0) ||
					ped::is_ped_climbing(Local_421.f_8) || ped::is_ped_ragdoll(Local_421.f_8)) {
					Local_421.f_9 = 44;
				}
				else {
					if (func_455(Local_484[0 /*9*/])) {
			...
			case 47:
				if (!ped::is_ped_ragdoll(Local_421.f_8)) {
					...
					else if (entity::is_entity_in_water(Local_421.f_8)) {
						Local_421.f_9 = 44;
					}
				}
				break;
			...
			case 49:
				if (!entity::is_entity_playing_anim(Local_421.f_8, "rcmnigel1b", "exit_panic_gardener", 3) &&
					!entity::is_entity_playing_anim(Local_421.f_8, "rcmnigel1b", "exit_gardener", 3)) {
					...
					if (entity::is_entity_playing_anim(Local_421.f_8, "rcmnigel1b", "idle_gardener", 3)) {
						ai::task_play_anim(Local_421.f_8, "rcmnigel1b", "exit_panic_gardener", 8f, -4f, -1, 8192, 0, 0,
										   0, 0);
					}
					else {
						if (!ped::is_ped_ragdoll(Local_421.f_8) && !ped::is_ped_swimming(Local_421.f_8) &&
							!ped::is_ped_climbing(Local_421.f_8)) {
							ai::task_react_and_flee_ped(Local_421.f_8, player::player_ped_id());
						}
						else {
							ai::task_smart_flee_ped(Local_421.f_8, player::player_ped_id(), 150f, -1, 1, 0);
						}
						Local_421.f_9 = 50;
					}
				}
...
bool func_291(int iParam0, int iParam1) {
	...
	if (player::is_player_free_aiming_at_entity(player::player_id(), iParam0) ||
		...
		if (func_292(1, 0, 1)) {
			fVar0 = 40f;
			if (func_71(iParam0, vLocal_729, fVar0)) {
	...
	if (gameplay::is_bullet_in_area(entity::get_entity_coords(iParam0, 1), 4f, 1)) {
		return true;
	}
	...
	vVar5.y += fVar1;
	vVar5.z += fVar1;
	if (gameplay::is_projectile_in_area(vVar2, vVar5, 1)) {
		return true;
	}
	return false;
}
...
bool func_292(int iParam0, int iParam1, int iParam2) {
	...
	case joaat("weapon_minigun"): return true;
	...
	if (iParam0) {
		...
		case joaat("weapon_molotov"): return true;
		}
...
// Position - 0x2920D
bool func_293(vector3 vParam0, vector3 vParam3, float fParam6) {
	return system::vdist2(vParam0, vParam3) <= fParam6 * fParam6;
}

// Position - 0x29227
bool func_294(var *uParam0, char *sParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6,
			  int iParam7, int iParam8) {
	int iVar0;
	...
	if (func_30(*uParam0)) {
		...
		if (streaming::has_anim_dict_loaded(&cLocal_654)) {
			if (gameplay::is_string_null_or_empty(sParam1)) {
				...
				switch (iVar0) {
				case 0: sParam1 = "react_small_variations_k"; break;

				case 1: sParam1 = "react_small_variations_m"; break;

				case 2: sParam1 = "react_small_variations_n"; break;

				case 3: sParam1 = "react_small_variations_o"; break;
				}
			}
			ai::task_play_anim(*uParam0, &cLocal_654, sParam1, fParam2, fParam3, iParam4, iParam5, iParam6, iParam7,
							   iParam8, 0);
			return true;
		}
	}
...
bool func_296(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_297(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0x293B2
int func_297(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
	...
	if (*iParam0 == 0) {
		vVar1 = {func_298(iParam4, iParam7)};
		*iParam0 =
...
int func_300(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	vVar0 = {func_302(entity::get_entity_coords(iParam1, 1) - entity::get_entity_coords(iParam0, 1))};
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_302(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
						  ped::get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_301(vVar3, vVar0);
...
// Position - 0x2969F
Vector3 func_302(vector3 vParam0) {
	float fVar0;
	float fVar1;
...
bool func_306(char *sParam0) {
	if (iLocal_540 == 2 || iLocal_540 == 4) {
		if (gameplay::are_strings_equal(sParam0, &sLocal_698)) {
			return true;
		}
	}
	return false;
...
bool func_308(int iParam0, float fParam1)
{
	if (func_30(iParam0)) {
		...
		if (func_310(player::player_ped_id(), iParam0, fParam1, 1)) {
...
// Position - 0x29868
bool func_309(int iParam0, float fParam1) { return func_296(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
// Position - 0x299E7
int func_316(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	int iVar0;
	...
	if (iParam0) {
		if (func_318(Local_421.f_8, 0)) {
			if (ped::_0x6CD5A433374D4CFB(Local_421.f_8, player::player_ped_id())) {
	...
	if (iParam3) {
		if (iLocal_536 == 2 || iLocal_536 == 3) {
			if (func_71(Local_421.f_8, vLocal_729, 7f)) {
				return 1;
			}
		}
	}
	if (iParam2) {
		if (iLocal_536 == 4) {
			if (func_71(Local_421.f_8, vLocal_729, 3.5f)) {
				return 1;
			}
		}
	}
...
// Position - 0x29AE2
bool func_317(int iParam0, int iParam1) { return gameplay::get_frame_count() - iParam0 > iParam1; }
...
// Position - 0x29BB0
int func_320() { return iLocal_536; }

// Position - 0x29BBB
bool func_321(int iParam0, float fParam1, float fParam2, float fParam3) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (func_30(iParam0)) {
		if (func_292(1, 1, 1)) {
			vVar0 = {entity::get_entity_coords(iParam0, 1)};
			if (gameplay::is_bullet_in_area(vVar0, fParam2, 1)) {
				return true;
			}
			if (func_310(player::player_ped_id(), iParam0, fParam1, 1)) {
...
void func_323(int iParam0, var *uParam1) {
	if (func_455(iParam0)) {
		if (func_296(iParam0, player::player_ped_id(), 1126825984, 1, 250, 7)) {
...
void func_324() {
	...
	case 0:
		if (iLocal_535 == 2 && func_30(Local_421.f_8) && func_70(Local_421.f_8, 1)) {
			...
			if (iLocal_537 == 2) {
				if (!iLocal_341) {
					if (Local_435[0 /*14*/].f_9 != 0) {
						if (func_313(&uLocal_160, "NIG1BAU", "NIG1B_P0", 7, 0, 0, 0)) {
							unk1::_0x293220DA1B46CEBC(4f, 4f, 0);
							iLocal_341 = 1;
						}
					}
				}
					...
					if (Local_435[0 /*14*/].f_9 == 17 || Local_435[0 /*14*/].f_9 == 18 ||
						Local_435[0 /*14*/].f_9 == 19) {
						if (!func_3() && !func_273("NULL")) {
							if (iLocal_365) {
				...
				Var1 = {func_312()};
				if (gameplay::are_strings_equal(&Var1, "NIG1B_P0") || gameplay::are_strings_equal(&Var1, "NIG1B_P1") ||
					gameplay::are_strings_equal(&Var1, "NIG1B_P2") || gameplay::are_strings_equal(&Var1, "NIG1B_P3") ||
					gameplay::are_strings_equal(&Var1, "NIG1B_IDLE")) {
					func_22(1, 0);
				}
				else if (gameplay::are_strings_equal(&Var1, "NIG1B_P3")) {
					Var7 = {func_343()};
	...
	case 2:
		...
		else if (gameplay::get_game_timer() - iLocal_400 > 10000) {
			func_15(4, 1);
			bLocal_330 = true;
			return;
		}
	...
	case 4:
		if (!iLocal_335) {
			if (iLocal_326) {
				...
				else if (gameplay::get_game_timer() - iLocal_400 > 4000) {
					iLocal_400 = gameplay::get_game_timer();
					iLocal_335 = 1;
					iLocal_352 = 0;
				}
			...
			if (!bLocal_363) {
				if (!func_311("NIG1B_CC", 1)) {
					...
					if (iLocal_96 == 0 || iLocal_96 == 1) {
						if (gameplay::get_game_timer() - iLocal_400 > 500) {
							if (player::is_player_wanted_level_greater(player::player_id(), 0)) {
								bLocal_363 = true;
							}
							else {
				...
				if (!func_311(&vLocal_692, 1)) {
					if (entity::is_entity_touching_entity(Local_435[0 /*14*/].f_8, player::player_ped_id()) &&
						ped::is_ped_ragdoll(Local_435[0 /*14*/].f_8)) {
						if (func_313(&uLocal_160, "NIG1BAU", "NIG1B_TBUMP", 7, 0, 0, 0)) {
							StringCopy(&vLocal_692, "NIG1B_TBUMP", 24);
						}
					}
					else if (entity::is_entity_touching_entity(Local_435[1 /*14*/].f_8, player::player_ped_id()) &&
							 ped::is_ped_ragdoll(Local_435[1 /*14*/].f_8)) {
						if (func_313(&uLocal_160, "NIG1BAU", "NIG1B_GBUMP", 7, 0, 0, 0)) {
							StringCopy(&vLocal_692, "NIG1B_GBUMP", 24);
						}
					}
				}
				if (func_3()) {
					...
					if (func_285(iLocal_407, 3000)) {
						if (gameplay::get_random_int_in_range(0, 10) < 5) {
	...
	case 5:
		...
		if (iLocal_537 == 2) {
			if (!iLocal_344) {
				func_22(0, 0);
				if (bLocal_366) {
					StringCopy(&vLocal_686, "NIG1B_SCC", 24);
					if (func_313(&uLocal_160, "NIG1BAU", &vLocal_686, 7, 0, 0, 0)) {
						iLocal_344 = 1;
					}
				}
				else if (func_292(1, 0, 0)) {
					StringCopy(&vLocal_686, "NIG1B_SUR", 24);
					if (func_313(&uLocal_160, "NIG1BAU", &vLocal_686, 7, 0, 0, 0)) {
						iLocal_344 = 1;
					}
				}
				else {
					StringCopy(&vLocal_686, "NIG1B_SNL", 24);
					if (func_313(&uLocal_160, "NIG1BAU", &vLocal_686, 7, 0, 0, 0)) {
						iLocal_344 = 1;
					}
				}
			...
			if (!bLocal_363) {
				if (!iLocal_348) {
					...
					else if (func_30(Local_435[1 /*14*/].f_8) && func_71(Local_435[1 /*14*/].f_8, vLocal_729, 50f)) {
					...
					if (iLocal_96 == 0 || iLocal_96 == 1) {
						if (gameplay::get_game_timer() - iLocal_400 > 2000) {
							if (player::is_player_wanted_level_greater(player::player_id(), 0)) {
								bLocal_363 = true;
							}
							else {
		...
		while (iVar0 <= 1) {
			if (func_455(Local_435[iVar0 /*14*/].f_8)) {
				if (entity::has_entity_been_damaged_by_entity(Local_435[iVar0 /*14*/].f_8, player::player_ped_id(),
															  1)) {
					entity::clear_entity_last_damage_entity(Local_435[iVar0 /*14*/].f_8);
					func_22(0, 0);
					if (iVar0 == 0) {
	...
	case 6:
		if (func_3()) {
			...
			if (iLocal_419 == 0) {
				if (system::vdist2(entity::get_entity_coords(Local_435[0 /*14*/].f_8, 0), vLocal_729) < 20f * 20f) {
				...
				if (system::vdist2(entity::get_entity_coords(Local_435[1 /*14*/].f_8, 0), vLocal_729) < 20f * 20f) {
			...
			iVar14 = func_332(vLocal_729, 20f);
			if (iVar14 != -1) {
				if (iVar14 == 0) {
					StringCopy(&vVar15, "NIG1B_CF1", 24);
				}
				else if (iVar14 == 1) {
					StringCopy(&vVar15, "NIG1B_CF2", 24);
				}
				if (func_313(&uLocal_160, "NIG1BAU", &vVar15, 7, 0, 0, 0)) {
					iLocal_406 = gameplay::get_game_timer();
				}
			}
		}
...
void func_325(int iParam0) {
	...
	if (func_30(Local_435[iParam0 /*14*/].f_8)) {
		...
		if (!ped::is_ped_performing_stealth_kill(player::player_ped_id())) {
			...
			case 0:
				if (iParam0 == 0) {
					if (!func_295(Local_435[iParam0 /*14*/].f_8, -982327190)) {
						ai::task_stand_still(Local_435[iParam0 /*14*/].f_8, -1);
					}
				}
				break;
			...
			case 1:
				if (iParam0 == 0) {
					...
					ai::open_sequence_task(&iLocal_542);
					ai::task_go_straight_to_coord(0, vLocal_713[iVar0 /*3*/], 2f, 20000, fLocal_374[iVar0], 1056964608);
					ai::close_sequence_task(iLocal_542);
					ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
					ai::task_perform_sequence(Local_435[iParam0 /*14*/].f_8, iLocal_542);
					ai::clear_sequence_task(&iLocal_542);
			...
			case 3:
				if (iParam0 == 0) {
					...
					ai::open_sequence_task(&iLocal_542);
					ai::task_go_straight_to_coord(0, vLocal_713[iVar1 /*3*/], 2f, 20000, fLocal_374[iVar1], 1056964608);
					ai::close_sequence_task(iLocal_542);
					ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
					ai::task_perform_sequence(Local_435[iParam0 /*14*/].f_8, iLocal_542);
					ai::clear_sequence_task(&iLocal_542);
			...
			case 6:
				if (iParam0 == 0) {
					if (func_455(Local_435[1 /*14*/].f_8)) {
						...
						ai::open_sequence_task(&iLocal_542);
						ai::task_go_straight_to_coord(0, vLocal_713[iVar2 /*3*/], 2f, 20000, 1193033728, 1056964608);
						ai::close_sequence_task(iLocal_542);
						ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
						ai::task_perform_sequence(Local_435[iParam0 /*14*/].f_8, iLocal_542);
						ai::clear_sequence_task(&iLocal_542);
			...
			case 7:
				if (iParam0 == 0) {
					...
					if (func_455(Local_435[1 /*14*/].f_8)) {
						if (!func_295(Local_435[iParam0 /*14*/].f_8, 242628503)) {
							if (func_71(Local_435[iParam0 /*14*/].f_8, vLocal_713[iVar3 /*3*/], 2.5f)) {
			...
			case 8:
				if (iParam0 == 0) {
					...
					ai::open_sequence_task(&iLocal_542);
					ai::task_go_straight_to_coord(0, vLocal_732[iVar4 /*3*/], 1f, 20000, fLocal_380[iVar4], 1056964608);
					ai::task_climb(0, 0);
					ai::close_sequence_task(iLocal_542);
					ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
					ai::task_perform_sequence(Local_435[iParam0 /*14*/].f_8, iLocal_542);
			...
			case 9:
				if (iParam0 == 0) {
					...
					if (func_71(Local_435[iParam0 /*14*/].f_8, vLocal_739[iVar5 /*3*/], fLocal_383)) {
						if (func_295(Local_435[iParam0 /*14*/].f_8, 242628503)) {
							ai::clear_ped_tasks_immediately(Local_435[iParam0 /*14*/].f_8);
						...
						if (!entity::is_entity_in_water(Local_435[iParam0 /*14*/].f_8) &&
							!func_71(Local_435[iParam0 /*14*/].f_8, vLocal_753, fLocal_384) &&
							!entity::is_entity_in_angled_area(Local_435[iParam0 /*14*/].f_8, vLocal_756, vLocal_759,
															  fLocal_385, 0, 1, 0) &&
							!ped::is_ped_climbing(Local_435[iParam0 /*14*/].f_8)) {
							ai::clear_ped_tasks_immediately(Local_435[iParam0 /*14*/].f_8);
							Local_435[iParam0 /*14*/].f_9 = 10;
						}
						else {
			...
			case 11:
				if (iParam0 == 0) {
					ai::open_sequence_task(&iLocal_542);
					ai::task_play_anim(0, &cLocal_670, "that_had_to_be_tyler", 4f, -4f, -1, 0, 0, 0, 0, 0);
					ai::close_sequence_task(iLocal_542);
					ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
					ai::task_perform_sequence(Local_435[iParam0 /*14*/].f_8, iLocal_542);
					ai::clear_sequence_task(&iLocal_542);
			...
			case 14:
				if (iParam0 == 0) {
					...
					vVar7 = {ped::get_anim_initial_offset_position(&cLocal_670, "ENTER", vLocal_795, vLocal_798, 0, 2)};
					vVar10 = {
						ped::get_anim_initial_offset_rotation(&cLocal_670, "ENTER", vLocal_795, vLocal_798, 0, 2)};
					ai::set_ped_path_prefer_to_avoid_water(Local_435[iParam0 /*14*/].f_8, 1);
					ai::set_ped_paths_width_plant(Local_435[iParam0 /*14*/].f_8, 0);
					ped::set_ped_alternate_walk_anim(Local_435[iParam0 /*14*/].f_8, &cLocal_670, "walk_tyler", 8f, 1);
					ai::open_sequence_task(&iLocal_542);
					ai::task_follow_nav_mesh_to_coord(0, vLocal_746[iVar6 /*3*/], 1f, 20000, 0.25f, 1, 1193033728);
					ai::task_follow_nav_mesh_to_coord(0, vVar7, 1f, 20000, 0.25f, 512, vVar10.z);
					ai::close_sequence_task(iLocal_542);
					ai::task_perform_sequence(Local_435[iParam0 /*14*/].f_8, iLocal_542);
					ai::clear_sequence_task(&iLocal_542);
					ped::set_blocking_of_non_temporary_events(Local_435[iParam0 /*14*/].f_8, 1);
			...
			case 15:
				if (iParam0 == 0) {
					if (!func_295(Local_435[iParam0 /*14*/].f_8, 242628503)) {
						vVar13 = {
							ped::get_anim_initial_offset_position(&cLocal_670, "ENTER", vLocal_795, vLocal_798, 0, 2)};
						if (func_71(Local_435[iParam0 /*14*/].f_8, vVar13, 1f)) {
			...
			case 22:
				if (!ped::is_synchronized_scene_running(iLocal_411[3]) &&
					!func_295(Local_435[iParam0 /*14*/].f_8, 1785177548)) {
					ai::open_sequence_task(&iLocal_542);
					ai::task_follow_nav_mesh_to_coord(0, vLocal_746[0 /*3*/], 1f, 20000, 0.25f, 1, 1193033728);
					ai::task_follow_nav_mesh_to_coord(0, vLocal_710, 1f, 20000, 0.25f, 0, 223.4962f);
					ai::task_play_anim(0, "rcmnigel1b", "wipehead", 8f, -8f, -1, 0, 0, 0, 0, 0);
			...
			case 23:
				if (func_71(Local_435[iParam0 /*14*/].f_8, vLocal_710, 1.25f)) {
					iLocal_359 = 1;
				}
				else if (!func_295(Local_435[iParam0 /*14*/].f_8, 242628503)) {
			...
			case 24:
				ai::open_sequence_task(&iLocal_542);
				ai::task_follow_nav_mesh_to_coord(0, -1049.915f, 357.2381f, 68.9132f, 1f, 20000, 0.25f, 0, 71.1227f);
				ai::task_stand_still(0, 1000);
				ai::task_follow_nav_mesh_to_coord(0, -1048.417f, 364.7032f, 68.9129f, 1f, 20000, 0.25f, 0, 6.9753f);
				ai::task_stand_still(0, 2000);
				ai::set_sequence_to_repeat(iLocal_542, 1);
				ai::close_sequence_task(iLocal_542);
				ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
				ai::task_perform_sequence(Local_435[iParam0 /*14*/].f_8, iLocal_542);
				ai::clear_sequence_task(&iLocal_542);
			...
			case 26:
				if (entity::is_entity_in_water(Local_435[iParam0 /*14*/].f_8) ||
					func_71(Local_435[iParam0 /*14*/].f_8, vLocal_753, fLocal_384) ||
					entity::is_entity_in_angled_area(Local_435[iParam0 /*14*/].f_8, vLocal_756, vLocal_759, fLocal_385,
													 0, 1, 0)) {
					ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
					vVar16 = {vLocal_746[0 /*3*/]};
					fVar19 = 201.7237f;
					if (func_293(vLocal_729, vVar16, 2.5f)) {
						vVar16 = {vLocal_746[1 /*3*/]};
						fVar19 = 325.0476f;
					}
					ai::task_look_at_entity(Local_435[iParam0 /*14*/].f_8, player::player_ped_id(), -1, 0, 2);
					ai::task_follow_nav_mesh_to_coord(Local_435[iParam0 /*14*/].f_8, vVar16, 1f, 20000, 0.25f, 0,
													  fVar19);
					ped::set_blocking_of_non_temporary_events(Local_435[iParam0 /*14*/].f_8, 1);
			...
			case 27:
				...
				else if (!entity::is_entity_in_water(Local_435[iParam0 /*14*/].f_8)) {
					if (!func_71(Local_435[iParam0 /*14*/].f_8, vLocal_753, fLocal_384)) {
						if (!entity::is_entity_in_angled_area(Local_435[iParam0 /*14*/].f_8, vLocal_756, vLocal_759,
															  fLocal_385, 0, 1, 0)) {
							if (!ped::is_ped_climbing(Local_435[iParam0 /*14*/].f_8)) {
								if (!func_71(Local_435[iParam0 /*14*/].f_8, -1057.136f, 369.1722f, 69.18319f, 1.25f)) {
									if (!func_71(Local_435[iParam0 /*14*/].f_8, -1057.108f, 354.7688f, 69.19383f,
												 1.25f)) {
										if (!entity::is_entity_in_angled_area(Local_435[iParam0 /*14*/].f_8, -1051.34f,
																			  358.4045f, 66.91455f, -1051.362f,
																			  365.5106f, 71.91416f, 2.25f, 0, 1, 0)) {
											ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
											Local_435[iParam0 /*14*/].f_9 = 28;
										}
									}
			...
			case 28:
				if (!func_455(Local_475)) {
					...
					if (streaming::has_model_loaded(Local_475.f_1)) {
						Local_475 = object::create_object(Local_475.f_1,
					...
					if (!entity::is_entity_attached_to_entity(Local_475, Local_435[iParam0 /*14*/].f_8)) {
						entity::attach_entity_to_entity(Local_475, Local_435[iParam0 /*14*/].f_8,
														ped::get_ped_bone_index(Local_435[iParam0 /*14*/].f_8, 28422),
														Local_475.f_2, Local_475.f_5, 1, 1, 0, 0, 2, 1);
					}
					ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
					ai::task_look_at_entity(Local_435[iParam0 /*14*/].f_8, player::player_ped_id(), -1, 768, 2);
					ai::task_use_mobile_phone(Local_435[iParam0 /*14*/].f_8, 1, 1);
					ped::set_blocking_of_non_temporary_events(Local_435[iParam0 /*14*/].f_8, 1);
			...
			case 29:
				if (ped::is_ped_running_mobile_phone_task(Local_435[iParam0 /*14*/].f_8)) {
					...
					if (gameplay::get_game_timer() - iLocal_398 > 1500) {
						iLocal_326 = 1;
					}
				}
				else {
			...
			case 30:
				if (ped::is_ped_running_mobile_phone_task(Local_435[iParam0 /*14*/].f_8)) {
					ai::task_use_mobile_phone(Local_435[iParam0 /*14*/].f_8, 0, 1);
					ai::task_look_at_entity(Local_435[iParam0 /*14*/].f_8, player::player_ped_id(), -1, 0, 2);
					ped::set_blocking_of_non_temporary_events(Local_435[iParam0 /*14*/].f_8, 1);
				}
				else {
			...
			case 32:
				if (entity::is_entity_playing_anim(Local_435[iParam0 /*14*/].f_8, "rcmnigel1b", "wipehead", 3)) {
					ai::stop_anim_task(Local_435[iParam0 /*14*/].f_8, "rcmnigel1b", "wipehead", -4f);
				}
				if (iParam0 == 0) {
					ped::clear_ped_alternate_walk_anim(Local_435[iParam0 /*14*/].f_8, -1056964608);
					ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
					ai::task_look_at_entity(Local_435[iParam0 /*14*/].f_8, player::player_ped_id(), -1, 0, 2);
					ai::task_turn_ped_to_face_entity(Local_435[iParam0 /*14*/].f_8, player::player_ped_id(), -1);
					ped::set_blocking_of_non_temporary_events(Local_435[iParam0 /*14*/].f_8, 1);
					Local_435[iParam0 /*14*/].f_11 = gameplay::get_game_timer();
			...
			case 33:
				if (!func_295(Local_435[iParam0 /*14*/].f_8, -2017877118)) {
					...
					else if (func_285(Local_435[iParam0 /*14*/].f_11, gameplay::get_random_int_in_range(750, 3000)) &&
							 !entity::is_entity_in_water(Local_435[iParam0 /*14*/].f_8) &&
							 !entity::is_entity_in_angled_area(Local_435[iParam0 /*14*/].f_8, vLocal_756, vLocal_759,
															   fLocal_385, 0, 1, 0)) {
						if (iParam0 == 1) {
							cVar20 = "react_small_variations_k";
						}
						else if (gameplay::get_random_int_in_range(0, 10) > 5) {
				...
				if (iParam0 == 1) {
					if (entity::has_entity_been_damaged_by_entity(Local_435[iParam0 /*14*/].f_8,
			...
			case 36:
				if (func_455(Local_421.f_8) && iLocal_538 == 2) {
					...
					ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
					ai::task_look_at_entity(Local_435[iParam0 /*14*/].f_8, Local_421.f_8, -1, 0, 2);
					ai::task_turn_ped_to_face_entity(Local_435[iParam0 /*14*/].f_8, Local_421.f_8, -1);
					ped::set_blocking_of_non_temporary_events(Local_435[iParam0 /*14*/].f_8, 1);
			...
			case 40:
				ai::open_sequence_task(&iLocal_542);
				if (entity::is_entity_in_water(Local_435[iParam0 /*14*/].f_8)) {
					vVar21 = {entity::get_entity_coords(Local_435[iParam0 /*14*/].f_8, 1)};
					if (pathfind::get_safe_coord_for_ped(vVar21, 1, &vVar21, 0)) {
						ai::task_follow_nav_mesh_to_coord(0, vVar21, 2f, 20000, 1048576000, 0, 1193033728);
					}
				}
			...
			case 42:
				if (iParam0 == 0) {
					if (func_455(Local_475)) {
						if (entity::is_entity_attached_to_entity(Local_475, Local_435[iParam0 /*14*/].f_8)) {
							entity::detach_entity(Local_475, 1, 1);
						}
						func_52(&Local_475, 0);
					}
				}
			...
			case 43:
				if (!ped::is_ped_ragdoll(Local_435[iParam0 /*14*/].f_8)) {
					if (!func_295(Local_435[iParam0 /*14*/].f_8, 474215631) &&
						!func_295(Local_435[iParam0 /*14*/].f_8, -1519143300)) {
						if (entity::is_entity_in_water(Local_435[iParam0 /*14*/].f_8) ||
							func_71(Local_435[iParam0 /*14*/].f_8, vLocal_753, fLocal_384) ||
							entity::is_entity_in_angled_area(Local_435[iParam0 /*14*/].f_8, vLocal_756, vLocal_759,
															 fLocal_385, 0, 1, 0)) {
							if (!func_295(Local_435[iParam0 /*14*/].f_8, 713668775)) {
								ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
								vVar24 = {vLocal_746[0 /*3*/]};
								fVar27 = 201.7237f;
								if (func_293(vLocal_729, vVar24, 1.5f)) {
									vVar24 = {vLocal_746[1 /*3*/]};
									fVar27 = 325.0476f;
								}
								ai::task_follow_nav_mesh_to_coord(Local_435[iParam0 /*14*/].f_8, vVar24, 1f, 20000,
																  0.25f, 0, fVar27);
								ped::set_blocking_of_non_temporary_events(Local_435[iParam0 /*14*/].f_8, 1);
							}
						}
							...
							ai::task_cower(Local_435[iParam0 /*14*/].f_8, -1);
						}
						ped::set_blocking_of_non_temporary_events(Local_435[iParam0 /*14*/].f_8, 1);
					}
				}
			...
			case 44:
				...
				if (func_326(iParam0)) {
					if (!ped::is_ped_ragdoll(Local_435[iParam0 /*14*/].f_8) &&
						!ai::is_ped_getting_up(Local_435[iParam0 /*14*/].f_8) &&
						!ped::is_ped_climbing(Local_435[iParam0 /*14*/].f_8)) {
						if (entity::is_entity_in_water(Local_435[iParam0 /*14*/].f_8) &&
								entity::is_entity_in_angled_area(Local_435[iParam0 /*14*/].f_8, vLocal_756, vLocal_759,
																 fLocal_385, 0, 1, 0) ||
							func_71(Local_435[iParam0 /*14*/].f_8, -1057.136f, 369.1722f, 69.18319f, 1.25f) ||
							func_71(Local_435[iParam0 /*14*/].f_8, -1057.108f, 354.7688f, 69.19383f, 1.25f) ||
							entity::is_entity_in_angled_area(Local_435[iParam0 /*14*/].f_8, -1051.34f, 358.4045f,
															 66.91455f, -1051.362f, 365.5106f, 71.91416f, 2.25f, 0, 1,
															 0)) {
							if (!func_295(Local_435[iParam0 /*14*/].f_8, 713668775)) {
								ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
								vVar28 = {vLocal_746[0 /*3*/]};
								fVar31 = 201.7237f;
								if (func_293(vLocal_729, vVar28, 1.5f)) {
									vVar28 = {vLocal_746[1 /*3*/]};
									fVar31 = 325.0476f;
								}
								ai::task_follow_nav_mesh_to_coord(Local_435[iParam0 /*14*/].f_8, vVar28, 1f, 20000,
																  0.25f, 0, fVar31);
								ped::set_blocking_of_non_temporary_events(Local_435[iParam0 /*14*/].f_8, 1);
							}
						}
							...
							ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
							ai::task_look_at_entity(Local_435[iParam0 /*14*/].f_8, player::player_ped_id(), -1, 0, 2);
							ai::task_hands_up(Local_435[iParam0 /*14*/].f_8, -1, player::player_ped_id(), -1, 0);
							ped::set_blocking_of_non_temporary_events(Local_435[iParam0 /*14*/].f_8, 1);
				...
				if (!func_295(Local_435[iParam0 /*14*/].f_8, 713668775)) {
					...
					if (!func_71(Local_435[iParam0 /*14*/].f_8, -1057.136f, 369.1722f, 69.18319f, 1.25f)) {
						if (!func_71(Local_435[iParam0 /*14*/].f_8, -1057.108f, 354.7688f, 69.19383f, 1.25f)) {
							if (!entity::is_entity_in_angled_area(Local_435[iParam0 /*14*/].f_8, -1051.34f, 358.4045f,
																  66.91455f, -1051.362f, 365.5106f, 71.91416f, 2.25f, 0,
																  1, 0)) {
								Local_435[iParam0 /*14*/].f_9 = 44;
							}
						}
			...
			case 46:
				if (entity::is_entity_in_water(Local_435[iParam0 /*14*/].f_8) ||
					...
					entity::is_entity_in_angled_area(Local_435[iParam0 /*14*/].f_8, vLocal_756, vLocal_759, fLocal_385,
													 0, 1, 0) ||
					ped::is_ped_climbing(Local_435[iParam0 /*14*/].f_8) ||
					ped::is_ped_ragdoll(Local_435[iParam0 /*14*/].f_8)) {
					Local_435[iParam0 /*14*/].f_9 = 44;
				}
				else {
					ai::clear_ped_tasks(Local_435[iParam0 /*14*/].f_8);
			...
			case 48:
				if (func_326(iParam0)) {
					if (!ped::is_ped_ragdoll(Local_435[iParam0 /*14*/].f_8) &&
						!ped::is_ped_swimming(Local_435[iParam0 /*14*/].f_8) &&
						!ped::is_ped_climbing(Local_435[iParam0 /*14*/].f_8)) {
						audio::stop_ped_speaking(Local_435[iParam0 /*14*/].f_8, 0);
						if (iParam0 == 0) {
							ped::clear_ped_alternate_walk_anim(Local_435[iParam0 /*14*/].f_8, -1056964608);
						...
						ai::task_react_and_flee_ped(Local_435[iParam0 /*14*/].f_8, player::player_ped_id());
			...
			case 49:
				...
				ped::set_ped_combat_attributes(Local_435[iParam0 /*14*/].f_8, 17, 1);
				if (func_326(iParam0)) {
					ai::task_smart_flee_ped(Local_435[iParam0 /*14*/].f_8, player::player_ped_id(), 150f, -1, 1, 0);
					Local_435[iParam0 /*14*/].f_9 = 50;
				}
				break;

			case 50:
				if (!func_295(Local_435[iParam0 /*14*/].f_8, 1805844857) &&
					!func_295(Local_435[iParam0 /*14*/].f_8, 2112745624)) {
					Local_435[iParam0 /*14*/].f_9 = 49;
				}
				break;
		...
		if (Local_435[iParam0 /*14*/].f_9 == 49 || Local_435[iParam0 /*14*/].f_9 == 48 ||
			Local_435[iParam0 /*14*/].f_9 == 50) {
			...
			if (iLocal_537 == 0 && !func_71(Local_435[iParam0 /*14*/].f_8, vLocal_729, 35f)) {
				func_59(&Local_435[iParam0 /*14*/]);
			}
			else {
				func_289(Local_435[iParam0 /*14*/].f_8, &Local_435[iParam0 /*14*/], -1, 0, 0, 0, -1082130432, 0, -1, -1,
						 1);
			}
		}
		else {
		...
		if (Local_435[iParam0 /*14*/].f_9 != 51) {
			if (iParam0 == 0) {
				if (!gameplay::is_bit_set(Global_101700.f_17533.f_382, 3)) {
					gameplay::set_bit(&Global_101700.f_17533.f_382, 3);
				}
				unk1::_0x293220DA1B46CEBC(2.5f, 2f, 0);
			}
	...
	if (iParam0 == 0) {
		if (func_30(Local_435[0 /*14*/].f_8)) {
			if (!iLocal_368[0]) {
				...
				else if (ped::is_synchronized_scene_running(iLocal_411[3]) ||
						 ped::is_synchronized_scene_running(iLocal_411[2])) {
					func_328(4);
				}
				iLocal_368[0] = 1;
			}
			else if (!ped::is_synchronized_scene_running(iLocal_411[4])) {
		...
		if (func_30(Local_435[1 /*14*/].f_8)) {
			if (!iLocal_368[1]) {
				...
				if (!ped::is_synchronized_scene_running(iLocal_411[4]) &&
					!ped::is_synchronized_scene_running(iLocal_411[6])) {
					if (!func_295(Local_435[iParam0 /*14*/].f_8, 1785177548)) {
						return true;
					}
				}
...
bool func_327() {
	if (func_30(Local_435[1 /*14*/].f_8)) {
		...
		else if (!ped::is_synchronized_scene_running(iLocal_411[6])) {
			if (!func_295(Local_435[1 /*14*/].f_8, 1785177548)) {
				return true;
			}
		}
...
void func_328(int iParam0) {
	...
	iLocal_411[iParam0] = ped::create_synchronized_scene(vLocal_795, vLocal_798, 2);
	ped::set_synchronized_scene_looped(iLocal_411[iParam0], iVar1);
	ped::_set_synchronized_scene_occlusion_portal(iLocal_411[iParam0], iVar2);
	iVar0 = 0;
	while (iVar0 <= 1) {
...
// Position - 0x2CB8C
void func_329(int iParam0, int iParam1, int iParam2, float fParam3) {
	struct<6> Var0;
	char *sVar6;
	...
	if (func_30(Local_435[iParam0 /*14*/].f_8)) {
		...
		if (entity::is_entity_playing_anim(Local_435[iParam0 /*14*/].f_8, &cLocal_670, sVar6, 3)) {
			...
			ai::task_synchronized_scene(Local_435[iParam0 /*14*/].f_8, iParam1, &cLocal_670, sVar6, fParam3, -8f, 17, 0,
										1148846080, 0);
			if (iLocal_356) {
				ped::_0x2208438012482A1A(Local_435[iParam0 /*14*/].f_8, 0, 0);
			}
		}
	}
}
...
// Position - 0x2CC33
var func_330(var uParam0) { return uParam0; }
...
struct<6> func_331(int iParam0, int iParam1) {
	...
	StringCopy(&Var0, "", 24);
	switch (iParam1) {
	case 0: StringCopy(&Var0, "BASE_", 24); break;

	case 1: StringCopy(&Var0, "ENTER", 24); break;

	case 2: StringCopy(&Var0, "DANCE_INTRO_", 24); break;

	case 3: StringCopy(&Var0, "DANCE_LOOP_", 24); break;

	case 4:
	case 5: StringCopy(&Var0, "REACT_", 24); break;

	case 6: StringCopy(&Var0, "OUTRO_", 24); break;

	default: break;
	}
	StringCopy(&cVar6, "", 24);
	switch (iParam0) {
	case 0: StringCopy(&cVar6, "TYLER", 24); break;

	case 1: StringCopy(&cVar6, "GIRL", 24); break;
...
//Position - 0x2CD0B
int func_332(vector3 vParam0, float fParam3)
{
	int iVar0;
	...
	if (func_30(Local_435[iVar0 /*14*/].f_8)) {
		...
		else if (func_71(Local_435[iVar0 /*14*/].f_8, vParam0, fParam3)) {
			return iVar0;
		}
	}
	iVar0 = 0;
...
void func_333() {
	if (func_30(Local_435[0 /*14*/].f_8) && func_30(Local_435[1 /*14*/].f_8)) {
		if (!func_311(&vLocal_692, 1)) {
			if (ped::is_ped_shooting(player::player_ped_id())) {
				if (gameplay::is_bullet_in_area(entity::get_entity_coords(Local_435[0 /*14*/].f_8, 1), 3f, 1)) {
					if (func_292(0, 0, 1) && (weapon::is_ped_weapon_ready_to_shoot(player::player_ped_id()) ||
											  ped::is_ped_reloading(player::player_ped_id()))) {
						if (func_313(&uLocal_160, "NIG1BAU", "NIG1B_TREACT", 7, 0, 0, 0)) {
							StringCopy(&vLocal_692, "NIG1B_TREACT", 24);
							return;
						}
					}
					else if (func_313(&uLocal_160, "NIG1BAU", "NIG1B_TSHOCK", 7, 0, 0, 0)) {
						StringCopy(&vLocal_692, "NIG1B_TSHOCK", 24);
						return;
					}
				}
				else if (gameplay::is_bullet_in_area(entity::get_entity_coords(Local_435[1 /*14*/].f_8, 1), 3f, 1)) {
					if (func_292(0, 0, 1) || weapon::is_ped_weapon_ready_to_shoot(player::player_ped_id()) &&
												 ped::is_ped_reloading(player::player_ped_id())) {
						if (func_313(&uLocal_160, "NIG1BAU", "NIG1B_GREACT", 7, 0, 0, 0)) {
							StringCopy(&vLocal_692, "NIG1B_GREACT", 24);
							return;
						}
					}
					else if (func_313(&uLocal_160, "NIG1BAU", "NIG1B_GSHOCK", 7, 0, 0, 0)) {
						StringCopy(&vLocal_692, "NIG1B_GSHOCK", 24);
						return;
					}
				}
				else if (ped::_0x6CD5A433374D4CFB(Local_435[0 /*14*/].f_8, player::player_ped_id())) {
					if (func_313(&uLocal_160, "NIG1BAU", "NIG1B_TSHOCK", 7, 0, 0, 0)) {
						StringCopy(&vLocal_692, "NIG1B_TSHOCK", 24);
						return;
					}
				}
				else if (ped::_0x6CD5A433374D4CFB(Local_435[1 /*14*/].f_8, player::player_ped_id())) {
				...
				if (player::is_player_free_aiming_at_entity(player::player_id(), Local_435[0 /*14*/].f_8) ||
					player::is_player_targetting_entity(player::player_id(), Local_435[0 /*14*/].f_8)) {
					if (ped::_0x6CD5A433374D4CFB(Local_435[0 /*14*/].f_8, player::player_ped_id())) {
						if (func_313(&uLocal_160, "NIG1BAU", "NIG1B_TTARG", 7, 0, 0, 0)) {
							StringCopy(&vLocal_692, "NIG1B_TTARG", 24);
							return;
						}
					}
				}
				else if (player::is_player_free_aiming_at_entity(player::player_id(), Local_435[1 /*14*/].f_8) ||
						 player::is_player_targetting_entity(player::player_id(), Local_435[1 /*14*/].f_8)) {
					if (ped::_0x6CD5A433374D4CFB(Local_435[1 /*14*/].f_8, player::player_ped_id())) {
						if (func_313(&uLocal_160, "NIG1BAU", "NIG1B_GTARG", 7, 0, 0, 0)) {
							StringCopy(&vLocal_692, "NIG1B_GTARG", 24);
							return;
						}
					}
				}
			}
			else if (entity::is_entity_touching_entity(Local_435[0 /*14*/].f_8, player::player_ped_id()) &&
					 ped::is_ped_ragdoll(Local_435[0 /*14*/].f_8)) {
				if (func_313(&uLocal_160, "NIG1BAU", "NIG1B_TBUMP", 7, 0, 0, 0)) {
					StringCopy(&vLocal_692, "NIG1B_TBUMP", 24);
					return;
			...
			else if (func_285(iLocal_397, gameplay::get_random_int_in_range(2000, 4000))) {
				if (iLocal_537 == 2) {
					switch (iLocal_386) {
					case 0:
						if (func_292(0, 0, 1) && !ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
	...
	if (iLocal_537 == 2) {
		...
		while (iVar0 <= 1) {
			if (iVar0 == 1) {
				...
				if (Local_435[iVar0 /*14*/].f_9 == 2 || Local_435[iVar0 /*14*/].f_9 == 6 ||
					Local_435[iVar0 /*14*/].f_9 == 7) {
					if (entity::is_entity_in_angled_area(player::player_ped_id(), vLocal_756, vLocal_759, fLocal_385, 0,
														 1, 0)) {
						iLocal_395 = 0;
						return 0;
					}
					uVar1 = ai::get_ped_desired_move_blend_ratio(Local_435[iVar0 /*14*/].f_8);
					if (ai::is_move_blend_ratio_sprinting(uVar1) ||
						ai::is_move_blend_ratio_running(uVar1) && ped::is_ped_swimming(Local_435[iVar0 /*14*/].f_8) &&
							entity::is_entity_in_angled_area(Local_435[iVar0 /*14*/].f_8, vLocal_756, vLocal_759,
															 fLocal_385, 0, 1, 0)) {
					}
					else {
						iLocal_395 = 0;
...
// Position - 0x2D4F5
bool func_342(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	int iVar0;
	...
	if (iParam4) {
		if (iLocal_536 == 2 || iLocal_536 == 3) {
			if (func_71(iParam0, vLocal_729, 7f)) {
				return true;
			}
		}
	}
	if (iParam3) {
		if (iLocal_536 == 4) {
			if (func_71(iParam0, vLocal_729, 3.5f)) {
				return true;
			}
		}
	}
	...
	if (Local_435[0 /*14*/].f_9 == 0) {
		if (func_30(Local_435[0 /*14*/].f_8)) {
			if (func_348(Local_435[0 /*14*/].f_8, 0) && iLocal_537 == 2) {
				...
				vVar0 = {-1056.294f, 383.0128f, 68.68782f};
				fVar3 = 3f;
				if (func_347(vLocal_729, vVar0, fVar3)) {
					iLocal_387 = 0;
					unk1::_0xAF66DCEE6609B148();
					entity::set_entity_coords_no_offset(Local_435[0 /*14*/].f_8, vLocal_713[iLocal_387 /*3*/], 0, 0, 1);
					entity::set_entity_heading(Local_435[0 /*14*/].f_8, fLocal_377[iLocal_387]);
				}
			}
			else if (iLocal_387 == 0) {
				vVar0 = {-1035.078f, 347.5178f, 70.36205f};
				fVar3 = 4f;
				if (func_347(vLocal_729, vVar0, fVar3)) {
					iLocal_387 = 1;
					unk1::_0xAF66DCEE6609B148();
...
// Position - 0x2D83D
bool func_347(vector3 vParam0, vector3 vParam3, float fParam6) {
	vector3 vVar0;
...
bool func_349() {
	...
	while (iVar0 <= 1) {
		if (entity::does_entity_exist(Local_435[iVar0 /*14*/].f_8)) {
			if (entity::is_entity_dead(Local_435[iVar0 /*14*/].f_8, 0) ||
				ped::is_ped_injured(Local_435[iVar0 /*14*/].f_8)) {
				return true;
			}
		}
		iVar0++;
...
void func_351() {
		...
		if (!player::is_player_wanted_level_greater(player::player_id(), 0)) {
			...
			if (!iLocal_346) {
				if (func_285(iLocal_399, 1000)) {
					vVar0 = {vLocal_729 + Vector(-60f, -60f, -60f)};
					vVar3 = {vLocal_729 + Vector(60f, 60f, 60f)};
					if (vehicle::is_cop_vehicle_in_area_3d(vVar0, vVar3)) {
						if (func_358()) {
							iLocal_346 = 1;
						}
						...
						if (func_336()) {
							iLocal_360 = func_357(vLocal_729, -1038090240, 1109393408);
						}
					}
				}
			}
	...
	case 2:
		if (func_356("NIG1B_OBJ_04", 0, 0)) {
			ui::clear_this_print("NIG1B_OBJ_04");
		}
...
void func_352(var *uParam0, char *sParam1, char *sParam2, char *sParam3) {
	...
	case 1:
		if (audio::is_scripted_conversation_ongoing()) {
			*sParam2 = {func_312()};
			*sParam3 = {func_343()};
			if (gameplay::are_strings_equal(sParam3, "") || gameplay::are_strings_equal(sParam3, "NULL")) {
			}
			else {
				func_28();
				iLocal_540 = 2;
	...
	case 4:
		if (!audio::is_scripted_conversation_ongoing() && func_344(uParam0, sParam1, sParam2, sParam3, 8, 0, 0)) {
			iLocal_540 = 0;
		}
		break;
	}
...
// Position - 0x2DC86
void func_354() {
	if (gameplay::get_profile_setting(203) != 0 && iLocal_540 != 1 && func_3()) {
		iLocal_540 = 1;
	}
}
...
// Position - 0x2DCEA
int func_357(vector3 vParam0, float fParam3, float fParam4) {
	bool bVar0;
	vector3 vVar1;
	vector3 vVar4;
	float fVar7;
	...
	vVar1 = {entity::get_offset_from_entity_in_world_coords(player::player_ped_id(), 0f, fParam3, 0f)};
	if (pathfind::get_nth_closest_vehicle_node_favour_direction(vVar1, vParam0, 0, &vVar4, &fVar7, 1, 1077936128, 0)) {
		if (!gameplay::is_point_obscured_by_a_mission_entity(vVar4, 7f, 7f, 7f, 0)) {
			if (entity::would_entity_be_occluded(iLocal_532, vVar4, 1)) {
				bVar0 = true;
			}
			else {
				bVar0 = false;
	...
	if (!bVar0) {
		vVar1 = {entity::get_offset_from_entity_in_world_coords(player::player_ped_id(), 0f, fParam4, 0f)};
		if (pathfind::get_nth_closest_vehicle_node_favour_direction(vVar1, vParam0, 0, &vVar4, &fVar7, 1, 1077936128,
																	0)) {
			if (!gameplay::is_point_obscured_by_a_mission_entity(vVar4, 7f, 7f, 7f, 0)) {
				if (entity::would_entity_be_occluded(iLocal_532, vVar4, 1)) {
					bVar0 = true;
	...
	if (bVar0) {
		if (!entity::does_entity_exist(iVar8)) {
			iVar8 = vehicle::create_vehicle(iLocal_532, vVar4, fVar7, 1, 1);
		}
		if (func_455(iVar8)) {
	...
	if (!iLocal_327) {
		if (func_455(Local_484[0 /*9*/])) {
			if (entity::is_entity_attached(Local_484[0 /*9*/])) {
				...
				else if (!func_360(entity::get_entity_velocity(iLocal_805), 0f, 0f, 0f, 5f, 0)) {
					entity::detach_entity(Local_484[0 /*9*/], 1, 1);
					entity::set_entity_dynamic(Local_484[0 /*9*/], 1);
					entity::set_entity_can_be_damaged(Local_484[0 /*9*/], 1);
...
// Position - 0x2DF59
int func_360(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
// Position - 0x2DFD4
void func_361(int iParam0) { iLocal_536 = func_362(player::player_ped_id(), iParam0); }
...
int func_362(int iParam0, bool bParam1) {
	...
	else if (ai::is_ped_walking(iParam0)) {
		iVar0 = 4;
	}
	else if (ai::is_ped_running(player::player_ped_id())) {
		iVar0 = 2;
	}
...
void func_363() {
	...
	case 1:
		if (!gameplay::are_strings_equal(sLocal_543, "NIG1B_DS")) {
			if (!(gameplay::are_strings_equal(sLocal_543, "NIG1B_DDG") && !func_30(Local_421.f_8))) {
				if (!func_336()) {
					func_335();
				}
			}
	...
	case 2:
		...
		else if (gameplay::are_strings_equal(sLocal_543, "NIG1B_DS") ||
				 gameplay::are_strings_equal(sLocal_543, "NIG1B_DDG") && !func_30(Local_421.f_8)) {
			func_353(&uLocal_160, 4);
			func_274(3);
		}
		else {
...
void func_364() {
	...
	case 1:
		if (!func_293(vLocal_729, vLocal_720, 70f) || player::is_player_wanted_level_greater(player::player_id(), 0)) {
			iLocal_98 = 2;
		}
		break;
	...
	case 2:
		if (func_356("NIG1B_OBJ_03", 0, 0)) {
			ui::clear_this_print("NIG1B_OBJ_03");
		}
		if (player::is_player_wanted_level_greater(player::player_id(), 0)) {
			func_274(5);
		}
...
void func_365() {
	...
	case 2:
		...
		if (func_356("NIG1B_OBJ_01", 0, 0)) {
			ui::clear_this_print("NIG1B_OBJ_01");
		}
		if (!iLocal_372) {
			if (func_455(iLocal_805)) {
				if (entity::is_entity_playing_anim(iLocal_805, "rcmnigel1b", "idle_speedo", 3)) {
...
void func_366(int iParam0, char *sParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	...
	if (iVar0 == 1) {
		...
		if (iVar1 != -1 && iVar1 != 94) {
			...
			iVar5 = func_269(script::get_this_script_name(), 1);
			if (iVar5 != -1) {
...
void func_367(int iParam0, var uParam1, int iParam2, int iParam3) {
	func_368(&Global_96040, script::get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

// Position - 0x2E700
void func_368(var *uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) {
	int iVar0;
	int iVar1;
		...
		*uParam1 = vehicle::get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11) {
			if (vehicle::is_vehicle_extra_turned_on(iParam0, iVar0 + 1)) {
				gameplay::set_bit(&uParam1->f_77, func_380(iVar0 + 1));
			}
			iVar0++;
		}
...
// Position - 0x2FF83
bool func_382(int iParam0, var *uParam1, int iParam2, int iParam3) {
	char *sVar0;
...
// Position - 0x30127
bool func_384(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
bool func_386(int iParam0, int iParam1) {
	...
	iVar0 = Global_2522581[iParam0 /*3*/][func_137(iParam1)];
...
void func_390(int iParam0, int iParam1) {
	...
	iVar0 = func_217(iParam0);
	if (func_219(iVar0) && !ped::is_ped_injured(iParam0)) {
		if (iParam0 == player::player_ped_id()) {
...
int func_403(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_78() == 0) {
			return gameplay::is_bit_set(func_138(func_404(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0x33EC3
void func_429() {
	if (!ui::does_blip_exist(Local_464.f_2)) {
		if (object::does_pickup_exist(Local_464)) {
			Local_464.f_2 = func_430(Local_464);
		}
	}
	if (ui::does_blip_exist(Local_464.f_2)) {
		ui::set_blip_name_from_text_file(Local_464.f_2, "NIG1B_CP_BLIP");
	}
}
...
int func_430(var *uParam0) {
	...
	ui::set_blip_scale(iVar0, func_431(network::network_is_game_in_progress(), 0.7f, 0.7f));
	return iVar0;
}

// Position - 0x33F3F
var func_431(bool bParam0, float fParam1, float fParam2) {
	if (bParam0) {
		return fParam1;
	}
	return fParam2;
...
void func_432() {
	...
	if (!func_7(0) && !player::is_player_wanted_level_greater(player::player_id(), 0)) {
		if (!iLocal_353) {
			if (entity::is_entity_in_angled_area(player::player_ped_id(), -1056.143f, 382.9233f, 67.74586f, -1054.965f,
												 382.899f, 70.98839f, 1.2f, 0, 1, 0)) {
				if (ped::is_ped_on_foot(player::player_ped_id())) {
					if (func_434(5)) {
						if (!ped::is_ped_climbing(player::player_ped_id()) &&
							...
							if (func_433(player::player_ped_id(), 87.9952f, 90f)) {
								if (!gameplay::is_area_occupied(-1056.172f, 382.1909f, 68.08848f, -1054.682f, 383.8394f,
																70.969f, 0, 1, 0, 0, 0, 0, 0)) {
									streaming::request_anim_dict("rcmnigel1b");
									vVar0 = {ped::get_anim_initial_offset_rotation("rcmnigel1b", "lockeddoor_tryopen",
																				   -1056.171f, 383.577f, 68.688f, 0f,
																				   0f, 97.793f, 0, 2)};
									if (streaming::has_anim_dict_loaded("rcmnigel1b")) {
										if (!func_295(player::player_ped_id(), 242628503)) {
											ai::open_sequence_task(&iLocal_542);
											ai::task_go_straight_to_coord(0,
																		  ped::get_anim_initial_offset_position(
																			  "rcmnigel1b", "lockeddoor_tryopen",
																			  -1056.171f, 383.577f, 68.688f, 0f, 0f,
																			  97.793f, 0, 2),
																		  1f, 20000, vVar0.z, 1056964608);
											ai::task_play_anim_advanced(0, "rcmnigel1b", "lockeddoor_tryopen",
																		-1056.171f, 383.577f, 68.688f, 0f, 0f, 97.793f,
																		4f, -4f, -1, 7680, 0, 2, 0);
											ai::close_sequence_task(iLocal_542);
											ai::task_perform_sequence(player::player_ped_id(), iLocal_542);
											ai::clear_sequence_task(&iLocal_542);
											weapon::get_current_ped_weapon(player::player_ped_id(), &iLocal_807, 1);
											weapon::set_current_ped_weapon(player::player_ped_id(),
																		   joaat("weapon_unarmed"), 1);
											unk1::_0x293220DA1B46CEBC(2f, 3f, 0);
											iLocal_353 = 1;
										}
									}
								}
		...
		if (!iLocal_354) {
			if (entity::is_entity_in_angled_area(player::player_ped_id(), -1040.537f, 383.5369f, 67.96313f, -1041.792f,
												 383.5614f, 70.99346f, 1.2f, 0, 1, 0)) {
				if (ped::is_ped_on_foot(player::player_ped_id())) {
					if (func_434(4)) {
						if (!ped::is_ped_climbing(player::player_ped_id()) &&
							!ped::is_ped_jumping(player::player_ped_id()) &&
							!ped::is_ped_ragdoll(player::player_ped_id())) {
							if (func_433(player::player_ped_id(), 277.6446f, 90f)) {
								if (!gameplay::is_area_occupied(-1042.099f, 382.6709f, 68.07068f, -1040.595f, 384.2608f,
																71.07093f, 0, 1, 0, 0, 0, 0, 0)) {
									streaming::request_anim_dict("rcmnigel1b");
									vVar0 = {ped::get_anim_initial_offset_rotation("rcmnigel1b", "lockeddoor_tryopen",
																				   -1040.55f, 382.85f, 68.85f, 0f, 0f,
																				   -90f, 0, 2)};
									if (streaming::has_anim_dict_loaded("rcmnigel1b")) {
										if (!func_295(player::player_ped_id(), 242628503)) {
											ai::open_sequence_task(&iLocal_542);
											ai::task_go_straight_to_coord(0,
																		  ped::get_anim_initial_offset_position(
																			  "rcmnigel1b", "lockeddoor_tryopen",
																			  -1040.55f, 382.85f, 68.85f, 0f, 0f, -90f,
																			  0, 2),
																		  1f, 20000, vVar0.z, 1056964608);
											ai::task_play_anim_advanced(0, "rcmnigel1b", "lockeddoor_tryopen",
																		-1040.55f, 382.85f, 68.85f, 0f, 0f, -90f, 4f,
																		-4f, -1, 7680, 0, 2, 0);
											ai::close_sequence_task(iLocal_542);
											ai::task_perform_sequence(player::player_ped_id(), iLocal_542);
											ai::clear_sequence_task(&iLocal_542);
	...
	if (iLocal_349[0] && iLocal_349[1]) {
		...
		if (entity::get_entity_anim_current_time(player::player_ped_id(), "rcmnigel1b", "lockeddoor_tryopen") >
			0.568f) {
			if (!iLocal_349[0]) {
				if (!func_3() && !func_273("NULL")) {
...
// Position - 0x343D5
bool func_433(int iParam0, float fParam1, float fParam2) {
	float fVar0;
	float fVar1;
...
var func_435(int iParam0) {
	...
	if (object::_does_door_exist(uLocal_388[iParam0])) {
		uVar0 = object::_0x160AA1B32F6139B8(uLocal_388[iParam0]);
	}
	return uVar0;
}
...
struct<2> func_440(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_448(iParam0)}; break;

	case 7: Var0 = {func_223(iParam0)}; break;

	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_447(iParam2)}; break;

		case 8: Var0 = {func_446(iParam2)}; break;

		case 7: Var0 = {func_445(iParam2)}; break;

		case 10: Var0 = {func_444(iParam2)}; break;

		case 5: Var0 = {func_443(iParam2)}; break;

		case 4: Var0 = {func_442(iParam2)}; break;

		default: StringCopy(&Var0, func_441(iVar2), 8); break;
		}
		break;
...
//Position - 0x34BB6
bool func_449(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (!func_451(0) || G_TextMessageConfig || Global_69960 == 1 || !cam::is_screen_faded_in()) {
		return false;
	}
	switch (Global_69956) {
	case 0:
	...
	case 5:
		if (cutscene::is_cutscene_playing() || func_7(0) || func_450(1)) {
		}
		else {
			return true;
		}
...
// Position - 0x34D19
bool func_452(int iParam0) { return func_453(iParam0, Global_35781); }
...
// Position - 0x34F0B
void func_454(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	if (func_455(iParam0)) {
		if (iParam5) {
			vParam1.z = -200f;
		}
...
void func_457(int iParam0, int iParam1) {
	...
	if (!func_45()) {
		if (iLocal_97 == 0) {
			if (func_455(player::player_ped_id())) {
				func_454(player::player_ped_id(), vLocal_801, fLocal_420, 1, 1);
				cam::set_gameplay_cam_relative_heading(0f);
				cam::set_gameplay_cam_relative_pitch(0f, 1065353216);
				func_9(entity::get_entity_coords(player::player_ped_id(), 1), 50f, 13, 5000, 0, 0);
				iLocal_357 = 1;
...
void func_459(int iParam0, int iParam1) {
	...
	ped::remove_scenario_blocking_area(iLocal_541, 0);
	vehicle::set_all_vehicle_generators_active_in_area(vLocal_726, vLocal_723, 1, 1);
	if (func_529() || !iLocal_356) {
		vehicle::remove_vehicles_from_generators_in_area(vLocal_726, vLocal_723, 0);
		gameplay::clear_area(vLocal_720, 35f, 1, 0, 0, 0);
		gameplay::clear_area_of_vehicles(vLocal_720, 27f, 0, 0, 0, 0, 0);
		gameplay::clear_area_of_peds(vLocal_720, 27f, 0);
	}
	iVar0 = 0;
	while (iVar0 <= 6 - 1) {
		if (object::_does_door_exist(uLocal_388[iVar0])) {
			object::remove_door_from_system(uLocal_388[iVar0]);
		}
		iVar0++;
	}
...
void func_465(bool bParam0, int iParam1) {
	...
	func_466(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, iParam1, 1, 1, 1);
}

// Position - 0x35487
void func_466(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8,
	...
	if (player::is_player_playing(iVar0)) {
		...
		if (iParam6 == 1) {
			gameplay::clear_area_of_peds(func_467(player::get_player_index()), 50f, 0);
		}
		if (iParam7 == 1) {
...
// Position - 0x35645
Vector3 func_467(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }
...
// Position - 0x35753
void func_471(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8,
	...
	if (iVar0 == 1) {
		...
		*iParam0 = func_511(vParam1, fParam4);
	}
	else if (iParam9 == 1) {
		...
		if (func_219(iParam12)) {
			func_504(iParam12, 0);
			while (!func_472(iParam0, iParam12, vParam1, fParam4, 1, 0)) {
				system::wait(0);
			}
		}
		else {
...
// Position - 0x358E6
int func_472(int *iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7) {
	int iVar0;
	var *uVar1;
	struct<97> Var5;
	int iVar103;
		...
		if (Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/] == Var5) {
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/],
				...
				func_499(iParam0, &Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/].f_31,
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/],
				...
				func_499(iParam0, &Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/].f_31,
...
// Position - 0x36724
void func_473(int iParam0, var *uParam1, int iParam2, int iParam3) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
	...
	if (func_219(iParam0) && entity::does_entity_exist(*uParam1) && vehicle::is_vehicle_driveable(*uParam1, 0)) {
		...
		if (vehicle::get_vehicle_mod_kit(*uParam1) >= 0 && vehicle::get_vehicle_mod_kit(*uParam1) < 255 &&
			...
			if (iParam3) {
				...
				Global_101700.f_19077[iParam0 /*43*/].f_31 = func_476(*uParam1);
				...
				func_474(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_5,
				...
				func_474(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0,
...
// Position - 0x373BA
bool func_475(int iParam0, char *sParam1, int *iParam2, int *iParam3, int *iParam4) {
	*iParam2 = -1;
	*iParam3 = -1;
	*iParam4 = -1;
	switch (iParam0) {
...
int func_477(int iParam0, int iParam1, int *iParam2) {
	...
	*iParam2 = 0;
	...
	iVar0 = entity::get_entity_model(iParam0);
	if (!func_479(iVar0, iParam1, iParam2)) {
		return 0;
	}
	...
	if (!network::network_is_game_in_progress()) {
		if (func_478(iParam0) && entity::get_entity_model(iParam0) != joaat("sentinel2") &&
...
int func_482(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_383(iParam0, 0, 0) ||
		func_383(iParam0, 1, 0) || func_383(iParam0, 2, 0) || func_375(iParam0) != 145 || func_495(iParam0) ||
		func_494(iParam0) || func_478(iParam0) || func_493(iParam0) || !func_483(entity::get_entity_model(iParam0))) {
		if (func_494(iParam0)) {
		}
		if (func_494(iParam0)) {
		}
...
// Position - 0x3A2E3
int func_488() { return 0; }

// Position - 0x3A2EC
int func_489() { return 1; }

// Position - 0x3A2F5
int func_490() { return 1; }
...
// Position - 0x3A62A
bool func_498(int iParam0) { return vehicle::is_vehicle_extra_turned_on(iParam0, 5); }
...
int func_499(int iParam0, var *uParam1, var *uParam2) {
	...
	if (func_502(entity::get_entity_model(*iParam0), 1) &&
		vehicle::get_vehicle_mod(*iParam0, 24) != func_501(*iParam0, (*uParam1)[38] - 1)) {
		vehicle::set_vehicle_mod(*iParam0, 24, func_501(*iParam0, (*uParam1)[38] - 1), 0);
	}
	if (func_500(*iParam0)) {
	...
	while (iVar0 < 9) {
		if (entity::does_entity_exist(Global_89155[iVar0])) {
			if (iParam0 == 145 || Global_89165[iVar0] == iParam0) {
				if (iParam1 == 0 || entity::get_entity_model(Global_89155[iVar0]) == func_377(iParam0, iParam1)) {
...
void func_506(int iParam0) {
	...
	if (func_510(&Global_68531.f_555[0 /*21*/], iParam0)) {
		...
		if (gameplay::is_bit_set(Global_68531.f_555[0 /*21*/].f_9, 13)) {
			if (iParam0 == 24 && func_248(iParam0, 0) && Global_69440.f_66 == 0 &&
				Global_101700.f_31389.f_1958[Global_68531.f_555[0 /*21*/].f_14] != 0 &&
				Global_101700.f_31389.f_1958[Global_68531.f_555[0 /*21*/].f_14] > 3 &&
				(!func_508(0, Global_68531.f_555[0 /*21*/].f_12) || !func_508(1, Global_68531.f_555[0 /*21*/].f_12))) {
...
// Position - 0x3AF78
int func_509(var *uParam0) { return *uParam0; }
...
// Position - 0x3C67C
int func_511(vector3 vParam0, float fParam3) { return func_512(&Global_96040.f_2311, vParam0, fParam3, 0); }

// Position - 0x3C696
int func_512(var *uParam0, vector3 vParam1, float fParam4, int iParam5) {
	int iVar0;
	vector3 vVar1;
	bool bVar4;
	var uVar5;
	...
	if (func_521(uParam0)) {
		...
		if (func_520(uParam0)) {
			...
			if (entity::does_entity_exist(iVar0)) {
				...
				else if (!func_514(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10 &&
...
// Position - 0x3CA0B
int func_514(int iParam0, vector3 vParam1, bool bParam4) {
	int iVar0;
	var uVar1[3];
	int iVar5;
	int iVar6;
	...
	case joaat("cuban800"):
		...
		iVar6 = 0;
		while (iVar6 <= iVar5 - 1) {
			if (func_515(iParam0, uVar1[iVar6], 1) &&
				func_360(entity::get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)) {
				if (!bParam4 || func_400(vParam1, 0f, 0f, 0f, 0) ||
...
// Position - 0x3CC74
void func_516(int iParam0, var *uParam1, int iParam2, int iParam3) {
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (uParam1->f_66 == joaat("sovereign")) {
			...
			iVar0 = 1;
			if (gameplay::is_bit_set(uParam1->f_77, func_380(iVar0 + 1))) {
			}
			else {
				gameplay::set_bit(&uParam1->f_77, func_380(iVar0 + 1));
			}
			...
			iVar1 = 1;
			if (gameplay::is_bit_set(uParam1->f_77, func_380(iVar1 + 1))) {
			}
			else {
				gameplay::set_bit(&uParam1->f_77, func_380(iVar1 + 1));
			}
		}
		...
		if (gameplay::is_bit_set(uParam1->f_77, 15) || func_519(iParam0) ||
		...
		if (!vehicle::is_this_model_a_heli(uParam1->f_66) && !vehicle::is_this_model_a_boat(uParam1->f_66)) {
			iVar2 = 0;
			while (iVar2 <= 11) {
				if (gameplay::is_bit_set(uParam1->f_77, func_380(iVar2 + 1))) {
...
// Position - 0x3D187
var func_518() { return dlc2::is_dlc_present(-1691188696); }
...
// Position - 0x3D27A
int func_522() { return func_520(&Global_96040.f_2311); }

// Position - 0x3D28D
void func_523() { func_524(&Global_96040.f_2311); }
...
// Position - 0x3D41A
int func_528() { return func_521(&Global_96040.f_2311); }
...
void func_530() {
	...
	ped::set_relationship_between_groups(5, iLocal_539, 1862763509);
	ped::set_relationship_between_groups(5, 1862763509, iLocal_539);
	ped::set_relationship_between_groups(1, iLocal_539, -1533126372);
	ped::set_relationship_between_groups(1, -1533126372, iLocal_539);
	audio::register_script_with_audio(0);
	func_532(64, 2, 0);
	gameplay::clear_bit(&Global_101700.f_17533.f_382, 3);
	func_531();
}
...
void func_531() {
	...
	if (entity::does_entity_exist(Local_99.f_35[0])) {
		...
		if (!entity::does_entity_exist(iLocal_805)) {
			iLocal_805 = vehicle::create_vehicle(iLocal_534, -1010.97f, 359.91f, 70.65f, 331.46f, 1, 1);
		}
		if (func_455(iLocal_805)) {
			...
			vehicle::_set_vehicle_door_can_break(iLocal_805, 2, 0);
			...
			if (!entity::is_entity_playing_anim(iLocal_805, "rcmnigel1b", "idle_speedo", 3)) {
				streaming::request_anim_dict("rcmnigel1b");
				if (streaming::has_anim_dict_loaded("rcmnigel1b")) {
					ai::task_vehicle_play_anim(iLocal_805, "rcmnigel1b", "idle_speedo");
				}
			}
		}
	}
	...
	if (!object::does_pickup_exist(Local_464)) {
		Local_464 = object::create_pickup_rotate(Local_464.f_6, Local_464.f_3, Local_464.f_8, Local_464.f_7, -1, 0, 1,
												 Local_464.f_1);
	}
	if (object::does_pickup_exist(Local_464)) {
	...
	if (entity::does_entity_exist(Local_99.f_28[0])) {
		...
		if (!entity::does_entity_exist(Local_435[0 /*14*/].f_8)) {
			iLocal_387 = 1;
			Local_435[0 /*14*/].f_8 = ped::create_ped(26, Local_435[0 /*14*/].f_10, vLocal_713[iLocal_387 /*3*/],
													  fLocal_377[iLocal_387], 1, 1);
		}
		if (func_30(Local_435[0 /*14*/].f_8)) {
			entity::set_entity_coords_no_offset(Local_435[0 /*14*/].f_8, vLocal_713[iLocal_387 /*3*/], 0, 0, 1);
			entity::set_entity_heading(Local_435[0 /*14*/].f_8, fLocal_377[iLocal_387]);
			ai::task_play_anim(Local_435[0 /*14*/].f_8, "rcmnigel1b", "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
		}
	}
	if (func_30(Local_435[0 /*14*/].f_8)) {
		ped::set_ped_dies_in_water(Local_435[0 /*14*/].f_8, 0);
		ped::set_ped_leg_ik_mode(Local_435[0 /*14*/].f_8, 2);
		ped::set_ped_alternate_walk_anim(Local_435[0 /*14*/].f_8, &cLocal_670, "walk_tyler", 8f, 1);
		ai::task_play_anim(Local_435[0 /*14*/].f_8, "rcmnigel1b", "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
	}
	...
	if (entity::does_entity_exist(Local_99.f_28[1])) {
		...
		if (!entity::does_entity_exist(Local_435[1 /*14*/].f_8)) {
			Local_435[1 /*14*/].f_8 =
				ped::create_ped(26, Local_435[1 /*14*/].f_10, -1058.43f, 362.78f, 69.86f, 130.45f, 1, 1);
		}
		if (func_30(Local_435[1 /*14*/].f_8)) {
	...
	while (iVar0 <= 1) {
		if (func_30(Local_435[iVar0 /*14*/].f_8)) {
			...
			ai::set_ped_path_prefer_to_avoid_water(Local_435[iVar0 /*14*/].f_8, 0);
			entity::set_entity_load_collision_flag(Local_435[iVar0 /*14*/].f_8, 1);
	...
	while (iVar0 <= 1) {
		if (!entity::does_entity_exist(Local_512[iVar0 /*9*/])) {
			Local_512[iVar0 /*9*/] =
				object::create_object(Local_512[iVar0 /*9*/].f_1, Local_512[iVar0 /*9*/].f_2, 1, 1, 0);
		}
		if (func_455(Local_512[iVar0 /*9*/])) {
			...
			rope::activate_physics(Local_512[iVar0 /*9*/]);
		}
		iVar0++;
	}
	iVar0 = 0;
	...
	if (func_455(iLocal_805)) {
		...
		while (iVar0 <= 2) {
			if (!entity::does_entity_exist(Local_484[iVar0 /*9*/])) {
				Local_484[iVar0 /*9*/] =
					object::create_object(Local_484[iVar0 /*9*/].f_1, Local_484[iVar0 /*9*/].f_2, 1, 1, 0);
			}
			if (func_455(Local_484[iVar0 /*9*/])) {
				entity::attach_entity_to_entity(Local_484[iVar0 /*9*/], iLocal_805, iVar1, Local_484[iVar0 /*9*/].f_2,
												Local_484[iVar0 /*9*/].f_5, 1, 1, 0, 0, 2, 1);
				entity::set_entity_can_be_damaged(Local_484[iVar0 /*9*/], 0);
				entity::set_entity_dynamic(Local_484[iVar0 /*9*/], 0);
				entity::_0xE12ABE5E3A389A6C(Local_484[iVar0 /*9*/], 0);
				entity::_0xA80AE305E0A3044F(Local_484[iVar0 /*9*/], 0);
				streaming::set_model_as_no_longer_needed(Local_484[iVar0 /*9*/].f_1);
			}
			iVar0++;
		}
	...
	if (entity::does_entity_exist(Local_99.f_35[1])) {
		...
		if (!entity::does_entity_exist(iLocal_804)) {
			iLocal_804 = vehicle::create_vehicle(iLocal_531, -1018.26f, 357.76f, 70.2f, 339.52f, 1, 1);
		}
	...
	if (entity::does_entity_exist(Local_99.f_28[2])) {
		...
		if (func_30(Local_421.f_8)) {
			...
			entity::set_entity_health(Local_421.f_8, 160);
			...
			streaming::request_anim_dict("rcmnigel1b");
			if (streaming::has_anim_dict_loaded("rcmnigel1b")) {
				ai::task_play_anim(Local_421.f_8, "rcmnigel1b", "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
			}
		}
	}
	streaming::set_model_as_no_longer_needed(Local_421.f_10);
	if (func_30(Local_421.f_8)) {
		...
		entity::set_entity_load_collision_flag(Local_421.f_8, 1);
		...
		ped::_0xE43A13C9E4CCCBCF(Local_421.f_8, 1);
...
void func_534() {
	...
	ui::request_additional_text("NIGEL1B", 0);
	while (!func_536() || !func_535() || !streaming::has_model_loaded(Local_464.f_1) ||
		   !streaming::has_model_loaded(Local_435[0 /*14*/].f_10) ||
		   !streaming::has_model_loaded(Local_435[1 /*14*/].f_10) || !streaming::has_model_loaded(Local_421.f_10) ||
		   !streaming::has_model_loaded(iLocal_531) || !streaming::has_model_loaded(iLocal_534) ||
		   !streaming::has_anim_dict_loaded("rcmnigel1b") || !streaming::has_anim_dict_loaded(&cLocal_670) ||
		   !audio::request_script_audio_bank("NIGEL_1B_WHISTLES", 0, -1) || !ui::has_additional_text_loaded(0)) {
		system::wait(0);
	}
}
...
void func_537() {
	...
	ped::set_ped_non_creation_area(vLocal_726, vLocal_723);
	iLocal_541 = ped::add_scenario_blocking_area(vLocal_726, vLocal_723, 0, 1, 1, 1);
	vehicle::set_all_vehicle_generators_active_in_area(vLocal_726, vLocal_723, 0, 1);
	if (func_529() || func_456(0) || func_45() || !iLocal_356) {
		vehicle::remove_vehicles_from_generators_in_area(vLocal_726, vLocal_723, 0);
		gameplay::clear_area(vLocal_720, 35f, 1, 0, 0, 0);
		gameplay::clear_area_of_vehicles(vLocal_720, 27f, 0, 0, 0, 0, 0);
		gameplay::clear_area_of_peds(vLocal_720, 27f, 0);
...
void func_539() {
	...
	fLocal_420 = 40.9431f;
	sLocal_543 = "NULL";
	vLocal_720 = {-1035.73f, 365.44f, 68.91f};
	vLocal_710 = {-1051.564f, 369.6159f, 68.9137f};
	vLocal_726 = {-1073.19f, 342.05f, 63.32832f};
	vLocal_723 = {-966.24f, 411.05f, 84.82043f};
	vLocal_762 = {-1058.74f, 378.36f, 68.97f};
	vLocal_765 = {-1064.68f, 378.42f, 67f};
	vLocal_768 = {-1039.15f, 351.76f, 75f};
	vLocal_771 = {-1041.712f, 348.0622f, 66.91643f};
	vLocal_774 = {-1036.664f, 347.7731f, 75.36364f};
	vLocal_777 = {-1047.452f, 347.568f, 66.91404f};
	vLocal_780 = {-1046.71f, 353.1779f, 73.91792f};
	vLocal_783 = {-1057.542f, 348.6674f, 66.91409f};
	vLocal_786 = {-1057.282f, 352.6161f, 73.91387f};
	vLocal_789 = {-1063.374f, 350.3959f, 66.91391f};
	vLocal_792 = {-1061.651f, 352.8345f, 73.81593f};
	vLocal_713[0 /*3*/] = {-1054.42f, 368.18f, 68.35f};
	vLocal_713[1 /*3*/] = {-1054.7f, 355.94f, 68.35f};
	vLocal_732[0 /*3*/] = {-1053.947f, 370.4447f, 68.6948f};
	vLocal_732[1 /*3*/] = {-1054.26f, 353.4767f, 68.6948f};
	vLocal_739[0 /*3*/] = {-1054.092f, 373.472f, 68.9138f};
	vLocal_739[1 /*3*/] = {-1054.13f, 350.572f, 68.913f};
	vLocal_753 = {-1059.451f, 361.9821f, 69.78663f};
	vLocal_756 = {-1054.633f, 353.7263f, 67.44479f};
	vLocal_759 = {-1054.807f, 370.0012f, 69.42931f};
	vLocal_746[0 /*3*/] = {-1059.845f, 366.6072f, 69.75161f};
	vLocal_746[1 /*3*/] = {-1059.642f, 357.378f, 69.75161f};
	vLocal_795 = {-1059f, 360.976f, 69f};
	vLocal_798 = {0f, 0f, -1.08f};
	vLocal_801 = {-1011.885f, 346.9502f, 69.2904f};
	...
	Local_464.f_7 = 0;
	gameplay::set_bit(&Local_464.f_7, 3);
	gameplay::set_bit(&Local_464.f_7, 4);
	gameplay::set_bit(&Local_464.f_7, 1);
	gameplay::set_bit(&Local_464.f_7, 8);
	iLocal_531 = joaat("comet2");
	iLocal_534 = joaat("speedo");
	Local_512[0 /*9*/].f_1 = 1677315747;
	Local_512[0 /*9*/].f_2 = {-1047.42f, 370.22f, 69.09f};
	Local_512[0 /*9*/].f_8 = 38.2398f;
	Local_512[0 /*9*/].f_5 = {-0.57f, -0.15f, 92.03f};
	Local_512[1 /*9*/].f_1 = 1574107526;
...
// Position - 0x3EB65
void func_541(var *uParam0, vector3 vParam1) {
	if (uParam0->f_51 == 0) {
	}
	if (uParam0->f_46 >= 15) {
	}
...
// Position - 0x3EBBD
void func_543(int iParam0, int iParam1, vector3 vParam2) {
	vector3 vVar0[24];

	StringCopy(&cVar0, "N1B_", 24);
	StringIntConCat(&cVar0, iParam0, 24);
	uLocal_388[iParam0] = gameplay::get_hash_key(&cVar0);
	if (!object::_does_door_exist(uLocal_388[iParam0])) {
		object::add_door_to_system(uLocal_388[iParam0], iParam1, vParam2, 0, 1, 0);
	}
}
...
void func_545(var *uParam0, int iParam1, int iParam2, int iParam3) {
	...
	func_546(uParam0, iParam3);
}

// Position - 0x3EC46
void func_546(var *uParam0, bool bParam1) { func_547(&uParam0->f_41, bParam1); }
...
// Position - 0x3EC96
void func_548(var *uParam0, bool bParam1) { func_549(&uParam0->f_35, bParam1); }
...
// Position - 0x3ECE5
void func_550(var *uParam0, int iParam1) { func_551(&uParam0->f_28, iParam1); }
...
// Position - 0x3EED1
bool func_555(char *sParam0, int iParam1, int iParam2) {
	int iVar0;
	struct<32> Var1;
	int iVar33;
...
// Position - 0x3F1D1
void func_562() { Global_17151.f_5 = 1; }

// Position - 0x3F1DF
void func_563() { Global_17151.f_5 = 0; }
