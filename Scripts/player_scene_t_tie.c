...
var *uLocal_81 = NULL;
vector3 vLocal_82[4] = {{0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}};
vector3 vLocal_95[4] = {{0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}};
...
vector3 vLocal_169[6] = {{0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}};
#pragma endregion //}
...
bool func_2() {
	...
	fVar0 = system::vdist2(entity::get_entity_coords(player::player_ped_id(), 1), vLocal_78);
	if (fVar0 > 100f * 100f) {
		return true;
	}
	return false;
...
// Position - 0x2FB
int func_7(var uParam0) { return uParam0; }
...
// Position - 0x518
void func_16() { func_17(Global_91279 - 1); }

// Position - 0x52A
void func_17(int iParam0) { Global_91279 = iParam0; }

// Position - 0x538
void func_18() { func_17(0); }
...
void func_19() {
	...
	while (!iVar2 && iVar1 < 400) {
		...
		if (!gameplay::is_string_null_or_empty(&cLocal_113)) {
			streaming::request_anim_dict(&cLocal_113);
			if (!streaming::has_anim_dict_loaded(&cLocal_113)) {
				streaming::request_anim_dict(&cLocal_113);
				iVar2 = 0;
			}
		}
	...
	while (iVar0 < iLocal_68) {
		if (iLocal_73[iVar0] != 0) {
			iLocal_68[iVar0] = ped::create_ped(26, iLocal_73[iVar0], vLocal_78 + vLocal_82[iVar0 /*3*/], 0f, 1, 1);
			...
			ai::task_play_anim_advanced(
				iLocal_68[iVar0], &cLocal_113, &Local_121[iVar0 /*8*/], vLocal_78 + vLocal_82[iVar0 /*3*/],
				Vector(uLocal_81, 0f, 0f) + vLocal_95[iVar0 /*3*/], 1000f, -8f, -1, iLocal_154, 0, 2, 0);
	...
	while (iVar0 < iLocal_155) {
		if (iLocal_162[iVar0] > 0) {
			...
			fVar15 = -1f;
			iLocal_155[iVar0] =
				graphics::add_decal(iLocal_162[iVar0], vLocal_78 + vLocal_169[iVar0 /*3*/], vVar3, vVar6, fVar9, fVar10,
									fVar11, fVar12, fVar13, fVar14, fVar15, 0, 0, 0);
			system::wait(0);
		}
		iVar0++;
	}
...
void func_21() {
	...
	func_25(iLocal_66, &vLocal_78, &uLocal_81, &cVar0);
	Var8.f_1 = -1;
	Var8.f_17 = 4;
	Var8.f_17.f_8 = 4;
	Var8.f_17.f_13 = 4;
	...
	case 280:
		...
		iLocal_162[4] = 1015;
		iLocal_162[5] = 1015;
		vLocal_169[4 /*3*/] = {vLocal_169[0 /*3*/] + vLocal_169[2 /*3*/] / FtoV(2f) +
							   Vector(0f, gameplay::get_random_float_in_range(0.5f, 0.5f),
									  gameplay::get_random_float_in_range(0.5f, 0.5f))};
		vLocal_169[5 /*3*/] = {vLocal_169[1 /*3*/] + vLocal_169[2 /*3*/] / FtoV(2f) +
							   Vector(0f, gameplay::get_random_float_in_range(0.5f, 0.5f),
									  gameplay::get_random_float_in_range(0.5f, 0.5f))};
		break;
...
void func_33() {
	...
	if (!gameplay::is_string_null_or_empty(&cLocal_113)) {
		streaming::remove_anim_dict(&cLocal_113);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_155) {
		if (graphics::is_decal_alive(iLocal_155[iVar0])) {
		}
		iVar0++;
	}
