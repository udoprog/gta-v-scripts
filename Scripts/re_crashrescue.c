	...
	while (true) {
		...
		case 0:
			if (brain::is_world_point_within_brain_activation_range()) {
				...
				case 1: func_236(); break;

				case 2: func_230(); break;
				}
			}
			else {
				func_316();
		...
		case 1:
			switch (iLocal_54) {
			case 0: func_203(); break;

			case 1: func_20(); break;
...
void func_1() {
	...
	case 0:
		if (func_19(iLocal_75)) {
			...
			if (!func_333()) {
				if (ui::does_blip_exist(iLocal_74)) {
					ui::remove_blip(&iLocal_74);
				}
		...
		if (gameplay::get_game_timer() > iLocal_284 && cam::is_screen_faded_in()) {
			if (!ped::is_ped_injured(iLocal_75)) {
				if (ped::is_ped_in_any_vehicle(iLocal_75, 0)) {
					...
					ped::apply_damage_to_ped(iLocal_75, 200, 0);
				}
				else {
					ped::set_ped_to_ragdoll(iLocal_75, 500, 1000, 0, 0, 0, 0);
					entity::set_entity_health(iLocal_75, 0);
				}
	...
	case 4:
		if (gameplay::get_game_timer() > iLocal_284 && func_8(&uLocal_88, "RECRAAU", sLocal_285, 3, 0, 0, 0) ||
			gameplay::get_game_timer() > iLocal_284 + 6000) {
			func_316();
		}
		break;
...
void func_20() {
	...
	case 0:
		if (!ped::is_ped_injured(iLocal_75) && !ped::is_ped_injured(iLocal_76)) {
			if (ped::is_ped_in_group(iLocal_75) ||
				entity::is_entity_at_coord(iLocal_75, vLocal_60, Global_22, 0, 1, 0)) {
				func_202(1, 0, 1, 0);
				if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
					...
					func_191(1722.325f, 3842.08f, 33.5323f, 1741.269f, 3856.862f, 37.1775f, 11f, 1740.917f, 3831.571f,
							 33.8387f, 121.9f, 1, 1, 1, 0, 0);
					iVar0 = 1;
				}
			}
		}
			...
			if (func_70(&uLocal_88, "RECRAAU", "RECRA_ARRIV", "RECRA_ARRIV_1", 3, 0, 0)) {
				...
				if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
					...
					if (func_61(iVar1)) {
						...
						entity::set_entity_coords(iVar1, vLocal_60, 1, 0, 0, 1);
						entity::set_entity_heading(iVar1, 119f);
					}
				...
				ai::task_synchronized_scene(iLocal_75, iLocal_271, sLocal_269, "helping_friend_inside_victim", 1000f,
											-1000f, 0, 0, 1148846080, 0);
				ai::task_synchronized_scene(iLocal_76, iLocal_271, sLocal_269, "helping_friend_inside_friend", 1000f,
											-1000f, 0, 0, 1148846080, 0);
				iLocal_87 = cam::create_cam("DEFAULT_ANIMATED_CAMERA", 0);
				...
				cam::set_cam_active(iLocal_87, 1);
	...
	case 4:
		if (iLocal_288 && ped::is_synchronized_scene_running(iLocal_271) &&
			ped::get_synchronized_scene_phase(iLocal_271) > 0.97f) {
			graphics::_start_screen_effect("CamPushInNeutral", 0, 0);
			audio::play_sound_frontend(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 1);
			iLocal_288 = 0;
		}
		if (ped::is_synchronized_scene_running(iLocal_271) &&
				ped::get_synchronized_scene_phase(iLocal_271) >= fLocal_282 ||
			func_57()) {
			player::clear_player_wanted_level(player::player_id());
			cam::set_cam_active(iLocal_87, 0);
...
// Position - 0x1279
void func_26(int iParam0) { Global_101686 = iParam0; }
...
void func_28() {
	...
	if (fVar8 > 0f && system::floor(fVar8) < system::floor(Global_101700.f_9153.f_3853)) {
		func_30(13, system::floor(Global_101700.f_9153.f_3853));
	}
...
// Position - 0x1830
int func_29() { return Global_25190; }
...
// Position - 0x1C20
var func_32() { return Global_1312735; }
...
// Position - 0x2011
void func_36(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			 int iParam8) {
	func_37(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

// Position - 0x2033
void func_37(char *sParam0, char *sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
// Position - 0x23B0
void func_41(int iParam0, int iParam1) { gameplay::set_bit(&Global_101700.f_23954.f_8[iParam0], iParam1); }
...
// Position - 0x2499
int func_44(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5,
...
// Position - 0x2926
char *func_52(int iParam0) { return func_53(iParam0); }
...
// Position - 0x2A17
int func_54(int iParam0) { return Global_87699[iParam0 /*5*/]; }
...
// Position - 0x2C61
Vector3 func_62() { return 2.55f, 5.665f, 2.55f; }
...
// Position - 0x2E7C
bool func_68() { return gameplay::is_bit_set(Global_2359301, 3); }
...
// Position - 0x2F04
void func_71(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9,
...
// Position - 0x30FE
Vector3 func_73(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	if (iParam1 == 12) {
				...
				if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0)) {
					if (iVar0 == 13) {
						...
						while (iVar1 <= 8) {
							...
							func_94(iParam0, Global_69523[1 /*14*/].f_12, Global_69523[1 /*14*/].f_3,
						...
						if (iParam4 == -1) {
							ped::set_ped_component_variation(iParam0, func_84(iVar0), Global_69523[1 /*14*/].f_3,
															 Global_69523[1 /*14*/].f_4,
															 ped::get_ped_palette_variation(iParam0, func_84(iVar0)));
						}
						else {
							ped::set_ped_component_variation(iParam0, func_84(iVar0), Global_69523[1 /*14*/].f_3,
		...
		if (iParam4 == -1) {
			ped::set_ped_component_variation(iParam0, func_84(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4,
											 ped::get_ped_palette_variation(iParam0, func_84(iParam1)));
		}
		else {
			ped::set_ped_component_variation(iParam0, func_84(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4, iParam4);
...
bool func_75(int iParam0, int iParam1, int *iParam2) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_63 != -99) {
		if (!func_188(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_64,
...
// Position - 0x3B76
bool func_80(int iParam0, int iParam1, int iParam2, int iParam3, var *uParam4, var *uParam5) {
	var uVar0;
	int iVar10;
...
bool func_82(int iParam0, int iParam1, int *iParam2, int iParam3) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_60 != -99) {
		if (!func_188(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_61,
...
// Position - 0x4703
var func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == -1) {
		...
		if (iParam1 == 0) {
			...
			if (func_95(entity::get_entity_model(iParam0), 14, iVar0,
		...
		if (iVar4 != iParam1) {
			...
			while (iVar5 <= iVar6 - 1) {
				if (iVar4 == iParam1 && iVar5 == iParam2) {
					iVar3 += func_100(iParam0, iParam3);
					return iVar3;
				}
				else {
					iVar3++;
...
struct<10> func_103(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		switch (iParam1) {
		case 31: func_105(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 0: func_105(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_105(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_105(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_105(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_105(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8); break;

		case 5: func_105(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8); break;

		case 6: func_105(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_105(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_105(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_105(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8); break;

		default: func_104(&Var1, iParam0, iParam1, 10); break;
		}
		break;
	...
	case joaat("player_one"):
		...
		case 1: func_105(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8); break;

		case 2: func_105(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8); break;

		case 3: func_105(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_105(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_105(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_105(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_105(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_105(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_104(&Var1, iParam0, iParam1, 9); break;
		}
		break;
	...
	case joaat("player_two"):
		...
		case 0: func_105(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_105(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_105(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_105(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8); break;

		case 4: func_105(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8); break;

		case 5: func_105(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_105(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_105(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_105(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8); break;
	...
	case joaat("mp_m_freemode_01"):
		...
		case 0: func_105(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_105(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_105(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_105(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_105(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_105(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_105(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_105(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_105(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_105(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_105(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_105(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_105(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_105(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 14: func_105(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_105(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_105(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_105(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_105(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_105(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_105(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_105(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_105(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_105(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 24: func_105(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_104(&Var1, iParam0, iParam1, 25); break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 0: func_105(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_105(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_105(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_105(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_105(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_105(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_105(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_105(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_105(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_105(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_105(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_105(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_105(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_105(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8); break;

		case 14: func_105(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_105(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_105(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_105(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_105(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_105(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_105(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_105(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_105(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_105(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8); break;
...
// Position - 0x742F
void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
struct<17> func_106(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		...
		case 1: func_109(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0); break;

		case 2: func_109(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8); break;

		case 3: func_109(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31); break;

		case 4: func_109(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2); break;

		case 5:
			func_109(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[0], Global_101700.f_2095.f_539.f_200[0], 6, 3, 0,
					 0, 0, -99, 0, 0, 3);
			break;

		case 6: func_109(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_109(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 8: func_109(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 9: func_109(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 10: func_109(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4); break;

		case 11: func_109(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5); break;

		case 12: func_109(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31); break;

		case 13: func_109(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 14: func_109(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6); break;

		case 15: func_109(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31); break;

		case 16: func_109(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31); break;

		case 17: func_109(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 18: func_109(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7); break;

		case 19: func_109(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 20: func_109(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 21: func_109(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_109(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 23: func_109(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31); break;

		case 24: func_109(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31); break;

		case 25: func_109(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 26: func_109(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 27: func_109(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 28: func_109(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 29: func_109(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 30: func_109(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 31: func_109(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31); break;

		case 32: func_109(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 33: func_109(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 34: func_109(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31); break;

		case 35: func_109(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 36: func_109(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 37: func_109(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 38: func_109(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 39: func_109(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 40: func_109(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 41: func_109(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_109(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_109(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_109(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 45: func_109(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 46: func_109(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_109(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 48: func_109(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31); break;

		case 49: func_109(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 50: func_109(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9); break;

		case 51: func_109(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 52: func_109(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		default: func_107(&Var1, iParam0, iParam1, 53); break;
		}
		break;

	case joaat("player_one"):
		switch (iParam1) {
		case 0: func_109(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 1: func_109(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 2:
			func_109(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[1], Global_101700.f_2095.f_539.f_200[1], 17, 2,
					 26, 0, 0, -99, 0, 45, 31);
			break;

		case 3: func_109(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1); break;

		case 4: func_109(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2); break;

		case 5: func_109(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 6: func_109(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_109(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3); break;

		case 8: func_109(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5); break;

		case 9: func_109(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 10: func_109(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 11: func_109(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 12: func_109(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 13: func_109(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 14: func_109(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 15: func_109(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 16: func_109(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 17: func_109(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 18: func_109(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31); break;

		case 19: func_109(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 20: func_109(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 21: func_109(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4); break;

		case 22: func_109(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31); break;

		case 23: func_109(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31); break;

		case 24: func_109(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31); break;

		case 25: func_109(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31); break;

		case 26: func_109(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31); break;

		case 27: func_109(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31); break;

		case 28: func_109(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31); break;

		case 29: func_109(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31); break;

		case 30: func_109(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31); break;

		case 31: func_109(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31); break;

		case 32: func_109(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31); break;

		case 33: func_109(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31); break;

		case 34: func_109(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31); break;

		case 35: func_109(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31); break;

		case 36: func_109(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31); break;

		case 37: func_109(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31); break;

		case 38: func_109(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 39: func_109(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 40: func_109(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 41: func_109(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 42: func_109(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31); break;

		case 43: func_109(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6); break;

		case 44: func_109(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 45: func_109(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8); break;

		case 46: func_109(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31); break;

		default: func_107(&Var1, iParam0, iParam1, 47); break;
		}
		break;

	case joaat("player_two"):
		switch (iParam1) {
		case 0: func_109(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 1: func_109(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8); break;

		case 2: func_109(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1); break;

		case 3: func_109(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2); break;

		case 4:
			func_109(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[2], Global_101700.f_2095.f_539.f_200[2], 8, 0, 0,
					 0, 0, -99, 0, 0, 31);
			break;

		case 5: func_109(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6); break;

		case 6: func_109(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3); break;

		case 7: func_109(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4); break;

		case 8: func_109(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31); break;

		case 9: func_109(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 10: func_109(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 11: func_109(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5); break;

		case 12: func_109(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 13: func_109(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31); break;

		case 14: func_109(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31); break;

		case 15: func_109(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 16: func_109(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 17: func_109(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 18: func_109(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 19: func_109(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 20: func_109(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 21: func_109(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_109(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 23: func_109(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 24: func_109(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 25: func_109(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 26: func_109(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 27: func_109(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 28: func_109(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 29: func_109(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 30: func_109(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 31: func_109(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 32: func_109(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 33: func_109(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 34: func_109(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 35: func_109(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 36: func_109(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 37: func_109(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 38: func_109(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 39: func_109(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 40: func_109(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 41: func_109(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_109(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_109(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_109(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31); break;

		case 45: func_109(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 46: func_109(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_109(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31); break;

		default: func_107(&Var1, iParam0, iParam1, 48); break;
		}
		break;

	case joaat("mp_m_freemode_01"):
		switch (iParam1) {
		case 0: func_109(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31); break;

		case 1: func_109(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0); break;

		case 2: func_109(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1); break;

		case 3: func_109(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2); break;

		case 4: func_109(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3); break;

		case 5: func_109(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4); break;

		case 6: func_109(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5); break;

		case 7: func_109(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6); break;

		case 8: func_109(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7); break;

		case 9: func_109(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8); break;

		case 10: func_109(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9); break;

		case 11: func_109(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10); break;

		case 12: func_109(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11); break;

		case 13: func_109(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12); break;

		case 14: func_109(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13); break;

		case 15: func_109(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14); break;

		case 16: func_109(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15); break;

		case 17: func_109(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16); break;

		case 18: func_109(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17); break;

		case 19: func_109(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18); break;

		case 20: func_109(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19); break;

		case 21: func_109(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20); break;

		case 22: func_109(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21); break;

		case 23: func_109(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22); break;

		case 24: func_109(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23); break;

		case 25: func_109(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24); break;

		default: func_107(&Var1, iParam0, iParam1, 26); break;
		}
		break;

	case joaat("mp_f_freemode_01"):
		switch (iParam1) {
		case 0: func_109(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31); break;

		case 1: func_109(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31); break;

		case 2: func_109(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0); break;

		case 3: func_109(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1); break;

		case 4: func_109(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2); break;

		case 5: func_109(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3); break;

		case 6: func_109(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4); break;

		case 7: func_109(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5); break;

		case 8: func_109(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6); break;

		case 9: func_109(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7); break;

		case 10: func_109(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8); break;

		case 11: func_109(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9); break;

		case 12: func_109(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10); break;

		case 13: func_109(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31); break;

		case 14: func_109(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11); break;

		case 15: func_109(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12); break;

		case 16: func_109(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13); break;

		case 17: func_109(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14); break;

		case 18: func_109(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15); break;

		case 19: func_109(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16); break;

		case 20: func_109(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17); break;

		case 21: func_109(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31); break;

		case 22: func_109(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18); break;

		case 23: func_109(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19); break;

		case 24: func_109(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20); break;

		case 25: func_109(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21); break;

		case 26: func_109(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22); break;

		case 27: func_109(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23); break;

		default: func_107(&Var1, iParam0, iParam1, 28); break;
		}
		break;
	}
	return Var1;
...
// Position - 0x955A
void func_109(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) {
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_96(iParam0, iParam2, 14, 3), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_96(iParam0, iParam2, 1, 3), -1842686353, 0);
			}
			break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_96(iParam0, iParam2, 14, 4), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_96(iParam0, iParam2, 1, 4), -1842686353, 0);
			}
			break;
		}
		break;
...
void func_117(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_121(iParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3)) {
...
// Position - 0xA1FE
bool func_121(int iParam0, int iParam1, int *iParam2, int *iParam3, bool bParam4, bool bParam5) {
	int iVar0;
...
// Position - 0xB3ED
bool func_122(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	if (iParam0 == 0) {
		if (iParam5 == 1) {
...
{
	switch (iParam0) {
	case 0: func_149(iParam1); break;

	case 2: func_148(iParam1); break;
	...
	case 14: func_126(iParam1); break;
	}
}
...
void func_126(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 155); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

// Position - 0xD715
void func_127(var *uParam0, int iParam1, int iParam2, char *sParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
void func_133(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 == 12) {
		...
		while (iVar38 < iVar40) {
			...
			if (!dlc1::_is_dlc_data_empty(Var20)) {
				if (iVar39 == iParam1 - iParam2) {
					...
					func_127(&Global_69523[0 /*14*/], iParam0, iParam1, &Var20.f_9, Var20.f_3, Var20.f_4, Var20.f_5,
		...
		iVar59 = 0;
		iVar60 = dlc1::_get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_84(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60) {
			...
			if (!dlc1::_is_dlc_data_empty(Var41)) {
				if (iVar59 == iParam1 - iParam2) {
					...
					func_127(&Global_69523[0 /*14*/], iParam0, iParam1, &Var41.f_9, Var41.f_3, Var41.f_4, Var41.f_5,
...
void func_134(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 9); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_135(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 48); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_136(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 1); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_138(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 6); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_139(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 33); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_140(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 17); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_141(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 18); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_142(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 7); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_143(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 84); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_144(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 104); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_150(int iParam0, int iParam1) {
	...
	case 3: func_163(iParam1); break;

	case 4: func_162(iParam1); break;

	case 6: func_161(iParam1); break;

	case 5: func_160(iParam1); break;

	case 8: func_159(iParam1); break;

	case 9: func_158(iParam1); break;

	case 10: func_157(iParam1); break;

	case 1: func_156(iParam1); break;

	case 7: func_155(iParam1); break;

	case 11: func_154(iParam1); break;

	case 12: func_153(iParam1); break;

	case 13: func_152(iParam1); break;

	case 14: func_151(iParam1); break;
	}
}
...
void func_151(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 175); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_153(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 47); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_154(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 63); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_156(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 5); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_157(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 53); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_158(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 12); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_159(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 77); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_161(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 134); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_162(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 117); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_167(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 21); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_168(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 10); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_169(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_186(iParam1); break;

	case 2: func_185(iParam1); break;
...
void func_170(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 113); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_173(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 45); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_177(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 20); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_178(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 24); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_179(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 14); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_180(int iParam0) {
	...
	default: func_133(iVar10, iParam0, 99); return;
	}
	func_127(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
bool func_188(int iParam0, int iParam1, int iParam2) {
	...
	else if (Global_69523[1 /*14*/].f_3 == ped::get_ped_drawable_variation(iParam0, func_84(iParam1)) &&
			 Global_69523[1 /*14*/].f_4 == ped::get_ped_texture_variation(iParam0, func_84(iParam1))) {
		return true;
	}
	return false;
}
...
// Position - 0x1FECB
void func_191(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, int iParam11,
			  int iParam12, int iParam13, int iParam14, int iParam15) {
	func_192(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, iParam11, iParam12, iParam13, iParam14,
			 iParam15);
}

// Position - 0x1FEF4
void func_192(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
...
// Position - 0x20382
bool func_195(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
// Position - 0x2045B
bool func_196(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	vector3 vVar9;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (func_197(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_197(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_197(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_197(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_197(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_197(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_197(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_197(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_197(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_197(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_197(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_197(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_197(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_197(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_197(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_197(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x20751
int func_197(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
// Position - 0x208A9
bool func_200(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
				...
				if (bLocal_256) {
					if (ped::is_ped_injured(iLocal_76)) {
						...
						iLocal_54 = 2;
							 ...
							 func_208(iLocal_76, player::player_ped_id(), 1.25f, 1)) {
					...
					else if (entity::is_entity_at_coord(player::player_ped_id(), vLocal_60, Global_19, 1, 1, 0) ||
							 entity::is_entity_in_angled_area(player::player_ped_id(), 1722.09f, 3843f, 33.6f, 1740.11f,
															  3854.94f, 39.22f, 12f, 0, 1, 0)) {
						iLocal_54 = 1;
						iLocal_55 = 0;
					}
				}
...
bool func_204() {
	...
	if (ped::is_ped_in_any_vehicle(iLocal_75, 0)) {
		...
		if (!entity::is_entity_dead(iVar0, 0)) {
			...
			if (iVar1 == -1965057835 || iVar1 == 919485892 || iVar1 == -1838563680 || iVar1 == 1576485197 ||
				iVar1 == 929009548) {
				return true;
			}
		}
...
bool func_205() {
	...
	if (ped::is_ped_in_any_vehicle(iLocal_75, 0)) {
		...
		if (!entity::is_entity_dead(iVar0, 0)) {
			iVar1 = vehicle::get_vehicle_layout_hash(iVar0);
			if (iVar1 == -2066252141 || iVar1 == 542797648 || iVar1 == 1105669833 || iVar1 == 925191417 ||
				iVar1 == -782720499 || iVar1 == 68566729 || iVar1 == -1887744178 || iVar1 == -1150063973 ||
				iVar1 == 1630950849 || iVar1 == -463340997 || iVar1 == 2033852426) {
				return true;
			}
		}
	}
...
void func_206() {
	if (!bLocal_256 && func_214(player::player_ped_id(), vLocal_60, 150f)) {
		...
		if (streaming::has_model_loaded(iLocal_258) && streaming::has_anim_dict_loaded(sLocal_269) &&
			object::does_object_of_type_exist_at_coords(1728.778f, 3851.287f, 33.7826f, 5f, joaat("prop_skid_chair_01"),
														0)) {
			iLocal_257 = object::get_closest_object_of_type(1728.778f, 3851.287f, 33.7826f, 5f,
															joaat("prop_skid_chair_01"), 1, 0, 1);
			entity::freeze_entity_position(iLocal_257, 1);
			...
			iLocal_271 = ped::create_synchronized_scene(vLocal_80, vLocal_83, 2);
			ai::task_synchronized_scene(iLocal_76, iLocal_271, sLocal_269, "helping_friend_idle_friend", 1000f, -1000f,
										0, 0, 1148846080, 0);
			bLocal_256 = true;
		}
	}
...
// Position - 0x2105A
int func_209(vector3 vParam0, int iParam3) { return func_210(vParam0, iParam3); }

// Position - 0x2106C
int func_210(vector3 vParam0, int iParam3) {
	int iVar0;
...
// Position - 0x21098
var func_211(bool bParam0, float fParam1, float fParam2) {
	if (bParam0) {
		return fParam1;
	}
	return fParam2;
...
// Position - 0x2114C
bool func_214(int iParam0, vector3 vParam1, float fParam4) {
...
bool func_215() {
	...
	if (ped::is_ped_group_member(iLocal_75, player::get_player_group(player::player_id()))) {
		if (ui::does_blip_exist(iLocal_73)) {
			ui::remove_blip(&iLocal_73);
		}
		else if (!entity::is_entity_at_entity(player::player_ped_id(), iLocal_75, 20f, 20f, 20f, 0, 1, 0) ||
				 !func_224()) {
			ped::remove_ped_from_group(iLocal_75);
		}
	...
	else if (ui::does_blip_exist(iLocal_73)) {
...
int func_216(int iParam0, int iParam1, int iParam2) {
	...
	if (entity::does_entity_exist(iParam0)) {
		if (entity::is_entity_a_ped(iParam0)) {
			iVar0 = func_222(entity::get_ped_index_from_entity_index(iParam0), iParam1, 0);
		}
		else if (entity::is_entity_a_vehicle(iParam0)) {
			iVar0 = func_220(entity::get_vehicle_index_from_entity_index(iParam0), iParam1, 0);
		}
		else if (entity::is_entity_an_object(iParam0)) {
			iVar0 = func_217(entity::get_object_index_from_entity_index(iParam0));
		}
	}
	return iVar0;
}
...
// Position - 0x212B0
int func_217(int iParam0) { return func_218(iParam0); }

// Position - 0x212BE
int func_218(int iParam0) { return func_219(iParam0, 1, 0); }
...
// Position - 0x21387
int func_221(int iParam0, bool bParam1, int iParam2) { return func_219(iParam0, !bParam1, iParam2); }
	...
	if (!ped::is_ped_injured(player::player_ped_id())) {
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			if (!ped::is_ped_in_any_heli(player::player_ped_id()) &&
				...
				!ped::is_ped_on_any_bike(player::player_ped_id()) && !func_226()) {
				if (vehicle::is_vehicle_seat_free(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), 0, 0) ||
					vehicle::is_vehicle_seat_free(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), -1, 0) ||
					vehicle::is_vehicle_seat_free(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), 1, 0) ||
					vehicle::is_vehicle_seat_free(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), 2, 0)) {
					iLocal_278 = 0;
					return 1;
				}
			}
...
void func_230() {
	...
	case 1:
		if (!ped::is_ped_injured(iLocal_75)) {
			...
			gameplay::get_ground_z_for_3d_coord(vLocal_80, &vLocal_80.f_2, 0);
			vLocal_83 = {func_235()};
			vLocal_83.z = func_234(fLocal_275 + 180f, 0f, 360f);
			iLocal_270 = ped::create_synchronized_scene(vLocal_80, vLocal_83, 2);
			iLocal_86 = cam::create_cam("DEFAULT_ANIMATED_CAMERA", 0);
			cam::play_synchronized_cam_anim(iLocal_86, iLocal_270, "HELPING_VICTIM_TO_FEET_CAM", sLocal_263);
			cam::set_cam_active(iLocal_86, 1);
			cam::render_script_cams(1, 0, 3000, 1, 0, 0);
			if (func_233()) {
				func_191(1935.59f, 6277.31f, 40.87f, 1930.11f, 6285.06f, 44.4f, 7f, 1936.63f, 6275.5f, 42.59f, -146.8f,
						 1, 1, 1, 0, 0);
			}
			else {
				func_191(1935.59f, 6277.31f, 40.87f, 1930.11f, 6285.06f, 44.4f, 7f, 1933.36f, 6261.681f, 42.2652f, 218f,
						 1, 1, 1, 0, 0);
			}
			...
			iLocal_280 = graphics::add_decal(1110, vLocal_272, 0f, 0f, -1f, func_198(0f, 1f, 0f), 1f, 1f, 0.196f, 0f,
											 0f, 1f, -1f, 0, 0, 0);
			if (ped::get_ped_stealth_movement(player::player_ped_id()) == 1) {
				ped::set_ped_stealth_movement(player::player_ped_id(), 0, 0);
			}
			ai::clear_ped_tasks_immediately(player::player_ped_id());
			ai::task_synchronized_scene(player::player_ped_id(), iLocal_270, sLocal_263,
										"HELPING_VICTIM_TO_FEET_PLAYER", 1000f, -4f, 0, 0, 1148846080, 0);
			ai::task_synchronized_scene(iLocal_75, iLocal_270, sLocal_263, "HELPING_VICTIM_TO_FEET_VICTIM", 1000f, -4f,
										0, 0, 1148846080, 0);
			ped::_set_synchronized_scene_occlusion_portal(iLocal_270, 0);
	...
	case 4:
		...
		if (iLocal_254) {
			...
			ped::_0x2208438012482A1A(player::player_ped_id(), 0, 0);
			ped::_0x2208438012482A1A(iLocal_75, 0, 0);
			vVar0 = {ped::get_anim_initial_offset_position(sLocal_263, "HELPING_VICTIM_TO_FEET_PLAYER", vLocal_80,
														   vLocal_83, 1f, 2)};
			gameplay::get_ground_z_for_3d_coord(vVar0, &vVar0.f_2, 0);
			entity::set_entity_coords(player::player_ped_id(), vVar0, 1, 0, 0, 1);
			vVar0 = {ped::get_anim_initial_offset_rotation(sLocal_263, "HELPING_VICTIM_TO_FEET_PLAYER", vLocal_80,
														   vLocal_83, 1f, 2)};
			entity::set_entity_heading(player::player_ped_id(), vVar0.z);
			vVar0 = {ped::get_anim_initial_offset_position(sLocal_263, "HELPING_VICTIM_TO_FEET_VICTIM", vLocal_80,
														   vLocal_83, 1f, 2)};
			gameplay::get_ground_z_for_3d_coord(vVar0, &vVar0.f_2, 0);
			entity::set_entity_coords(iLocal_75, vVar0, 1, 0, 0, 1);
			vVar0 = {ped::get_anim_initial_offset_rotation(sLocal_263, "HELPING_VICTIM_TO_FEET_VICTIM", vLocal_80,
														   vLocal_83, 1f, 2)};
		...
		iLocal_253 =
			ped::add_scenario_blocking_area(Vector(33.813f, 3847.646f, 1731.052f) + Vector(-5f, -20f, -20f),
											Vector(33.813f, 3847.646f, 1731.052f) + Vector(5f, 25f, 35f), 0, 1, 1, 1);
...
// Position - 0x22547
void func_232(var *uParam0, var *uParam1, var *uParam2, var *uParam3, int iParam4) {
...
// Position - 0x226E2
Vector3 func_235() { return 0f, 0f, 0f; }
...
void func_236() {
	if (!ped::is_ped_injured(iLocal_75) && !func_254()) {
		if (entity::is_entity_at_entity(player::player_ped_id(), iLocal_75, 80f, 80f, 15f, 0, 1, 0)) {
			...
			if (entity::is_entity_at_entity(player::player_ped_id(), iLocal_75, 2.5f, 2.5f, 2.5f, 0, 1, 1) &&
				func_251(1, 0, 1)) {
				ped::set_ped_as_group_member(iLocal_75, player::get_player_group(player::player_id()));
			...
			else if (func_208(player::player_ped_id(), iLocal_75, 15f, 1) &&
				...
				case 1:
					if (!func_333()) {
						if (!ui::does_blip_exist(iLocal_73)) {
							iLocal_73 = func_248(iLocal_75, 1, 1, 5);
							ui::_0x75A16C3DA34F1245(iLocal_73, 0);
						}
...
// Position - 0x22A68
bool func_241() {
	switch (func_242(&Global_25249, 0, 5, 0, script::get_id_of_this_thread())) {
	case 1: return true;
...
// Position - 0x22A9E
int func_242(int *iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	int iVar0;
...
// Position - 0x22C24
bool func_244(int iParam0) { return func_245(iParam0, Global_35781); }
...
// Position - 0x22E38
bool func_247() {
	if (Global_101689 == func_43() && gameplay::get_random_event_flag() && Global_101690) {
		return true;
	}
	return false;
}
...
void func_255() {
	...
	if (streaming::has_model_loaded(iLocal_258) && streaming::has_model_loaded(iLocal_260) &&
		streaming::has_model_loaded(iLocal_259) && streaming::has_anim_dict_loaded(sLocal_261) &&
		streaming::has_clip_set_loaded(sLocal_262) && streaming::has_anim_dict_loaded(sLocal_265) &&
		streaming::has_anim_dict_loaded(sLocal_266) && streaming::has_anim_dict_loaded(sLocal_267) &&
		streaming::has_anim_dict_loaded(sLocal_264) && streaming::has_ptfx_asset_loaded()) {
		bLocal_276 = false;
		iLocal_287 = 0;
		gameplay::enable_dispatch_service(5, 0);
		iLocal_79 = vehicle::create_vehicle(iLocal_260, 1932.98f, 6291.91f, 41.08f, 350.85f, 1, 1);
		...
		iLocal_279 = graphics::start_particle_fx_looped_on_entity("scr_recrash_rescue_fire", iLocal_79, -0.45f, -1.25f,
																  -0.5f, 0f, 0f, 0f, 1f, 0, 0, 1);
		if (bLocal_276) {
			iLocal_75 = ped::create_ped(26, iLocal_259, vLocal_272, fLocal_275 - 180f, 1, 1);
		}
		else {
			iLocal_75 = ped::create_ped(26, iLocal_259, vLocal_272, fLocal_275, 1, 1);
		}
		ped::apply_ped_blood_damage_by_zone(iLocal_75, 0, 0.7f, 0.5f, 2);
		vLocal_63 = {entity::get_entity_coords(iLocal_75, 1)};
		gameplay::shoot_single_bullet_between_coords(vLocal_63.x, vLocal_63.y + 0.1f, vLocal_63.z + 0.1f, vLocal_63.x,
													 vLocal_63.y - 0.1f, vLocal_63.z - 0.1f, 1, 1,
													 joaat("weapon_assaultrifle"), 0, 1, 1, -1f);
		...
		ai::task_play_anim_advanced(iLocal_77, sLocal_264, "dead_ped", 1935.53f, 6291.888f, 41.144f, 0f, 0f, -28.44f,
									1000f, -1000f, -1, 2102272, 0, 2, 0);
		entity::set_entity_health(iLocal_77, 0);
		...
		iLocal_253 =
			ped::add_scenario_blocking_area(Vector(33.7286f, 3850.767f, 1729.311f) - Vector(3f, 25f, 25f),
											Vector(33.7286f, 3850.767f, 1729.311f) + Vector(3f, 25f, 25f), 0, 1, 1, 1);
		iLocal_53 = 1;
	}
}
...
// Position - 0x235B1
int func_257(float fParam0, int iParam1) {
	struct<27> Var0;
	int iVar32;
	int iVar33;
	float fVar34;
...
void func_258(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_259(uParam1, "Abigail1", func_261(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				 "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_260(iParam0), 1, 0);
		break;

	case 1:
		func_259(uParam1, "Abigail2", func_261(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				 -1, 4, 1, 0, 2359, func_260(iParam0), 1, 0);
		break;

	case 2:
		func_259(uParam1, "Barry1", func_261(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				 4, 1, 0, 2359, func_260(iParam0), 1, 0);
		break;

	case 3:
		func_259(uParam1, "Barry2", func_261(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				 4, 4, 0, 2359, func_260(iParam0), 1, 1);
		break;

	case 4:
		func_259(uParam1, "Barry3", func_261(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2,
				 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 5:
		func_259(uParam1, "Barry3A", func_261(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0,
				 "", 166, 0, 7, 4, 2, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 6:
		func_259(uParam1, "Barry3C", func_261(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				 7, 4, 2, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 7:
		func_259(uParam1, "Barry4", func_261(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0,
				 "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_260(iParam0), 0, 0);
		break;

	case 8:
		func_259(uParam1, "Dreyfuss1", func_261(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				 0, "", 0, 0, -1, 4, 2, 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 9:
		func_259(uParam1, "Epsilon1", func_261(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1,
				 10, 4, 1, 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 10:
		func_259(uParam1, "Epsilon2", func_261(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0,
				 11, 4, 1, 0, 2359, func_260(iParam0), 1, 0);
		break;

	case 11:
		func_259(uParam1, "Epsilon3", func_261(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				 0, 0, 12, 4, 1, 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 12:
		func_259(uParam1, "Epsilon4", func_261(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				 "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 13:
		func_259(uParam1, "Epsilon5", func_261(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16,
				 "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_260(iParam0), 1, 0);
		break;

	case 14:
		func_259(uParam1, "Epsilon6", func_261(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 15:
		func_259(uParam1, "Epsilon7", func_261(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 16:
		func_259(uParam1, "Epsilon8", func_261(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_260(iParam0), 1, 0);
		break;

	case 17:
		func_259(uParam1, "Extreme1", func_261(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 18:
		func_259(uParam1, "Extreme2", func_261(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 19:
		func_259(uParam1, "Extreme3", func_261(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 20:
		func_259(uParam1, "Extreme4", func_261(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 21:
		func_259(uParam1, "Fanatic1", func_261(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_260(iParam0), 1, 0);
		break;

	case 22:
		func_259(uParam1, "Fanatic2", func_261(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_260(iParam0), 1, 0);
		break;

	case 23:
		func_259(uParam1, "Fanatic3", func_261(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_260(iParam0), 0, 1);
		break;

	case 24:
		func_259(uParam1, "Hao1", func_261(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_260(iParam0), 0, 1);
		break;

	case 25:
		func_259(uParam1, "Hunting1", func_261(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 26:
		func_259(uParam1, "Hunting2", func_261(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 27:
		func_259(uParam1, "Josh1", func_261(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_260(iParam0), 1, 0);
		break;

	case 28:
		func_259(uParam1, "Josh2", func_261(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_260(iParam0), 1, 1);
		break;

	case 29:
		func_259(uParam1, "Josh3", func_261(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_260(iParam0), 1, 1);
		break;

	case 30:
		func_259(uParam1, "Josh4", func_261(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_260(iParam0), 1, 0);
		break;

	case 31:
		func_259(uParam1, "Maude1", func_261(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 32:
		func_259(uParam1, "Minute1", func_261(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 33:
		func_259(uParam1, "Minute2", func_261(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 34:
		func_259(uParam1, "Minute3", func_261(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 35:
		func_259(uParam1, "MrsPhilips1", func_261(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 36:
		func_259(uParam1, "MrsPhilips2", func_261(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_260(iParam0), 0, 0);
		break;

	case 37:
		func_259(uParam1, "Nigel1", func_261(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_260(iParam0), 1, 0);
		break;

	case 38:
		func_259(uParam1, "Nigel1A", func_261(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_260(iParam0), 1, 1);
		break;

	case 39:
		func_259(uParam1, "Nigel1B", func_261(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_260(iParam0), 1, 1);
		break;

	case 40:
		func_259(uParam1, "Nigel1C", func_261(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_260(iParam0), 1, 1);
		break;

	case 41:
		func_259(uParam1, "Nigel1D", func_261(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_260(iParam0), 1, 1);
		break;

	case 42:
		func_259(uParam1, "Nigel2", func_261(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_260(iParam0), 1, 1);
		break;

	case 43:
		func_259(uParam1, "Nigel3", func_261(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_260(iParam0), 1, 1);
		break;

	case 44:
		func_259(uParam1, "Omega1", func_261(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 45:
		func_259(uParam1, "Omega2", func_261(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 46:
		func_259(uParam1, "Paparazzo1", func_261(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 47:
		func_259(uParam1, "Paparazzo2", func_261(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 48:
		func_259(uParam1, "Paparazzo3", func_261(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 49:
		func_259(uParam1, "Paparazzo3A", func_261(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 50:
		func_259(uParam1, "Paparazzo3B", func_261(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 51:
		func_259(uParam1, "Paparazzo4", func_261(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 52:
		func_259(uParam1, "Rampage1", func_261(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 54:
		func_259(uParam1, "Rampage3", func_261(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_260(iParam0), 1, 0);
		break;

	case 55:
		func_259(uParam1, "Rampage4", func_261(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_260(iParam0), 1, 0);
		break;

	case 56:
		func_259(uParam1, "Rampage5", func_261(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_260(iParam0), 0, 0);
		break;

	case 53:
		func_259(uParam1, "Rampage2", func_261(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_260(iParam0), 1, 0);
		break;

	case 57:
		func_259(uParam1, "TheLastOne", func_261(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 58:
		func_259(uParam1, "Tonya1", func_261(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 59:
		func_259(uParam1, "Tonya2", func_261(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_260(iParam0), 0, 1);
		break;

	case 60:
		func_259(uParam1, "Tonya3", func_261(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_260(iParam0), 0, 1);
		break;

	case 61:
		func_259(uParam1, "Tonya4", func_261(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_260(iParam0), 0, 1);
		break;

	case 62:
		func_259(uParam1, "Tonya5", func_261(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_260(iParam0), 0, 1);
		break;
...
// Position - 0x248B1
void func_259(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
// Position - 0x2515C
bool func_265() { return Global_101418 > 0; }
...
// Position - 0x252A6
void func_272(int iParam0) { Global_101689 = iParam0; }

// Position - 0x252B4
bool func_273(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6) {
	int iVar0;
	vector3 vVar1;
	int iVar4;
	vector3 vVar5;
	...
	if (!iVar0) {
		...
		if (func_297(iParam3, iParam4) && !iParam5) {
			return false;
		}
...
// Position - 0x2564E
bool func_274(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
// Position - 0x256B6
int func_276(int iParam0) { return func_277(iParam0, 1); }
...
int func_277(int iParam0, int iParam1) {
	...
	func_278(iParam0, &iVar0, &iVar1, &iVar2, &iVar3, &iVar4, &iVar5);
...
// Position - 0x25718
void func_278(int iParam0, int *iParam1, int *iParam2, int *iParam3, int *iParam4, int *iParam5, int *iParam6) {
	func_279(func_289(), iParam0, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6);
}
...
// Position - 0x259D9
int func_281(int iParam0) { return system::shift_right(iParam0, 20) & 63; }

// Position - 0x259EC
int func_282(int iParam0) { return system::shift_right(iParam0, 14) & 63; }

// Position - 0x259FF
int func_283(int iParam0) { return system::shift_right(iParam0, 9) & 31; }

// Position - 0x25A12
int func_284(int iParam0) { return system::shift_right(iParam0, 4) & 31; }
...
// Position - 0x25A60
int func_287(int iParam0) { return iParam0 & 15; }
...
int func_289() {
	...
	func_295(&iVar0, time::get_clock_seconds());
	func_294(&iVar0, time::get_clock_minutes());
	func_293(&iVar0, time::get_clock_hours());
	func_292(&iVar0, time::get_clock_day_of_month());
	func_291(&iVar0, time::get_clock_month());
	func_290(&iVar0, time::get_clock_year());
	return iVar0;
}
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_306() || Global_100747 ||
						Global_25192 || func_305() || func_16(8, -1) || func_304() || func_303() || func_302() ||
						func_301() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;

				case 1:
					if (player::is_player_being_arrested(player::player_id(), 1) || func_306() || Global_25192 ||
						func_305() || func_16(8, -1) || func_302() || func_304() || func_303() || func_301() ||
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						player::is_player_climbing(player::player_id()) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_306() || Global_100747 ||
						Global_25192 || func_305() || func_16(8, -1) || func_302() || func_304() || func_303() ||
						func_301() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5 || LastDispatchedMessageOrCall != -1) {
						return 0;
					}
					break;
				...
				case 3:
					if (ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_306() || Global_100747 ||
						Global_25192 || func_305() || func_16(8, -1) || func_304() || func_303() || func_301() ||
						G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 4:
					if (func_306() || player::get_player_wanted_level(player::player_id()) > 0 || func_16(8, -1) ||
						func_301() || func_300() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 6:
					if (entity::does_entity_exist(player::player_ped_id())) {
						if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
							...
							player::is_player_being_arrested(player::player_id(), 1) ||
							player::is_player_climbing(player::player_id()) || func_306() || Global_25192 ||
							func_305() || func_16(8, -1) || func_303() || func_302() || func_301() ||
							G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
							return 0;
						}
					}
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						entity::is_entity_in_air(player::player_ped_id()) ||
						ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) || func_306() || func_303() ||
						Global_100747 || Global_25192 || func_305() || Global_36912 || func_16(8, -1) || func_302() ||
						func_300() || func_301() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 8:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						player::is_player_being_arrested(player::player_id(), 1) ||
						player::is_player_climbing(player::player_id()) || func_306() || Global_100747 ||
						Global_25192 || func_305() || func_16(8, -1) || func_302() || func_300() || func_304() ||
						func_303() || func_301()) {
						return 0;
					}
					break;
...
// Position - 0x26596
var func_299() { return Global_91530.f_1; }
...
// Position - 0x2660E
bool func_303() { return Global_91543.f_304 > 0; }

// Position - 0x2661F
bool func_304() { return Global_91543.f_303 > 0; }

// Position - 0x26630
var func_305() { return Global_1315233; }
...
// Position - 0x26680
int func_308(int iParam0) { return func_288(func_289(), iParam0); }
...
// Position - 0x26D42
void func_320(int iParam0) { Global_36332 = gameplay::get_game_timer() + iParam0; }

// Position - 0x26D54
void func_321(int iParam0) { func_322(iParam0, 0, func_327(iParam0)); }
...
void func_322(int iParam0, int iParam1, int iParam2) {
	...
	iVar0 = func_289();
	func_325(&iVar0, 0, 0, iParam2, iParam1, 0, 0);
...
struct<16> func_323(int *iParam0) {
	...
	StringCopy(&Var0, "", 64);
	iVar16 = func_283(*iParam0);
	if (iVar16 < 10) {
		StringIntConCat(&Var0, 0, 64);
	}
	StringIntConCat(&Var0, iVar16, 64);
	StringConCat(&Var0, ":", 64);
	iVar16 = func_282(*iParam0);
	if (iVar16 < 10) {
		StringIntConCat(&Var0, 0, 64);
	}
	StringIntConCat(&Var0, iVar16, 64);
	StringConCat(&Var0, ":", 64);
	iVar16 = func_281(*iParam0);
	if (iVar16 < 10) {
		StringIntConCat(&Var0, 0, 64);
	}
	StringIntConCat(&Var0, iVar16, 64);
	StringConCat(&Var0, "  ", 64);
	iVar16 = func_284(*iParam0);
	if (iVar16 < 10) {
		StringIntConCat(&Var0, 0, 64);
	}
	StringIntConCat(&Var0, iVar16, 64);
	...
	StringConCat(&Var0, "/", 64);
	StringIntConCat(&Var0, func_285(*iParam0), 64);
	return Var0;
}
...
// Position - 0x26E81
void func_325(int *iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	int iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
	...
	iVar0 += iParam6;
	func_326(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}

// Position - 0x27003
void func_326(int *iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	func_295(iParam0, iParam1);
	func_294(iParam0, iParam2);
	func_293(iParam0, iParam3);
	func_291(iParam0, iParam5);
	func_292(iParam0, iParam4);
	func_290(iParam0, iParam6);
}
