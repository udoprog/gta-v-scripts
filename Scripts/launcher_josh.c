...
void __EntryFunction__() {
	...
	if (player::has_force_cleanup_occurred(83)) {
		...
		if (Var0 != -1) {
			if (Global_100787[Var0 /*10*/].f_9 != -1) {
				...
				func_285(&Global_100787[Var0 /*10*/].f_9);
			}
		}
		func_268(&Var0, 1);
	}
	if (!func_265(&iVar64, &Var0, vVar61, 1f)) {
		func_264();
	...
	while (true) {
		...
		if (!func_197(&Var0, 1)) {
			if (Var0 == 30) {
				if (func_196(player::player_ped_id(), -1102.724f, 290.1463f, 63.23002f, 1) < 200f) {
		...
		func_194(Var0);
		func_187(&iLocal_95, &Var0.f_9, vVar61);
		if (Var0 == 27) {
			func_185(&Var0, vVar61, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (Var0 == 28) {
			func_185(&Var0, vVar61, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (Var0 == 29) {
			func_185(&Var0, vVar61, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (Var0 == 30) {
			if (iLocal_265 == 0) {
...
int func_2(int iParam0) {
	...
	if (!func_150()) {
		while (!func_141(*iParam0)) {
			...
			if (!func_197(iParam0, *iParam0 != 2)) {
				func_286("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() "
						 "[TERMINATING]");
				return 0;
			}
			system::wait(0);
	...
	if (!func_98(iParam0)) {
		func_286("STEP_7_COMMON_LaunchMission - Trying to launch a null script "
				 "string name");
		return 0;
	}
...
int func_98(int iParam0) {
	...
	if (func_127(&uParam0->f_1)) {
		...
		if (cutscene::has_cutscene_loaded()) {
			...
			func_286("Initial cutscene wasn't loaded in time to pass to RC "
					 "mission.");
...
int func_155(var *uParam0) {
	if (*uParam0 == 30) {
		if (func_184(uParam0->f_28[0])) {
			if (bLocal_263) {
				if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
					if (func_156(player::player_ped_id(), uParam0->f_28[0], 1) <= 15f) {
						func_286("Special launching Josh 4 (not in vehicle)");
						return 1;
					}
				}
				else if (func_156(player::player_ped_id(), uParam0->f_28[0], 1) <= 10f) {
...
int func_157(var *uParam0) {
	if (*uParam0 == 29) {
		if (func_196(player::player_ped_id(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f) {
			if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
				func_286("Special launching Josh 3");
				return 1;
			}
			else if (!func_158(player::player_ped_id(), -828834893) &&
					 func_184(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0)) &&
					 func_133(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), 1f, 1, 1056964608, 0, 1, 0)) {
				ai::task_leave_any_vehicle(player::player_ped_id(), 0, 0);
			}
		}
	}
...
int func_159(var *uParam0) {
	if (*uParam0 == 28) {
		if (func_196(player::player_ped_id(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f) {
			if (!ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
				...
				return 1;
					 ...
					 func_184(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0)) &&
					 func_133(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), 4f, 1, 1056964608, 0, 1, 0)) {
				ai::task_leave_any_vehicle(player::player_ped_id(), 0, 0);
			}
		}
	}
...
// Position - 0xAEF5
void func_161() { func_27(&Global_93635.f_2311, &Global_93635, 0, 1, 1, 0); }
	...
	if (iParam0 == 1) {
		...
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			...
			if (ped::is_ped_in_any_heli(player::player_ped_id()) || ped::is_ped_in_any_plane(player::player_ped_id())) {
				func_286("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for "
						 "plane or helicopter.");
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_174() || Global_100747 ||
						Global_25192 || func_173() || func_172(8, -1) || func_78() || func_171() || func_170() ||
						func_169() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;

				case 1:
					if (player::is_player_being_arrested(player::player_id(), 1) || func_174() || Global_25192 ||
						func_173() || func_172(8, -1) || func_170() || func_78() || func_171() || func_169() ||
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						player::is_player_climbing(player::player_id()) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_174() || Global_100747 ||
						Global_25192 || func_173() || func_172(8, -1) || func_170() || func_78() || func_171() ||
						func_169() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5 || LastDispatchedMessageOrCall != -1) {
						return false;
					}
					break;
				...
				case 3:
					if (ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_174() || Global_100747 ||
						Global_25192 || func_173() || func_172(8, -1) || func_78() || func_171() || func_169() ||
						G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 4:
					if (func_174() || player::get_player_wanted_level(player::player_id()) > 0 || func_172(8, -1) ||
						func_169() || func_168() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 6:
					if (entity::does_entity_exist(player::player_ped_id())) {
						if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
							...
							player::is_player_being_arrested(player::player_id(), 1) ||
							player::is_player_climbing(player::player_id()) || func_174() || Global_25192 ||
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						entity::is_entity_in_air(player::player_ped_id()) ||
						ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) || func_174() || func_171() ||
						Global_100747 || Global_25192 || func_173() || Global_36912 || func_172(8, -1) || func_170() ||
						func_168() || func_169() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return false;
					}
					break;
				...
				case 8:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						player::is_player_being_arrested(player::player_id(), 1) ||
						player::is_player_climbing(player::player_id()) || func_174() || Global_100747 ||
						Global_25192 || func_173() || func_172(8, -1) || func_170() || func_168() || func_78() ||
						func_171() || func_169()) {
						return false;
					}
					break;
...
// Position - 0xB7E0
var func_167() { return Global_91530.f_1; }
...
// Position - 0xB858
bool func_171() { return Global_91543.f_304 > 0; }
...
// Position - 0xB8A4
var func_173() { return Global_1315233; }
...
void func_175() {
	...
	case 1:
		if (func_196(player::player_ped_id(), -1103.44f, 290.18f, 63.28f, 1) <= 20f) {
	...
	case 2:
		...
		else if (func_196(player::player_ped_id(), -1103.44f, 290.18f, 63.28f, 1) >= 25f) {
			func_128();
			bLocal_263 = true;
			iLocal_96 = 0;
		}
...
// Position - 0xB9E6
int func_177(char *sParam0, int iParam1, int iParam2) {
	Global_15746 = 0;
...
// Position - 0xBF83
int func_185(int iParam0, vector3 vParam1, char[4] cParam4, char *sParam5, int iParam6, char *sParam7, int iParam8,
			 float fParam9) {
	var *uVar0;

	if (func_184(player::player_ped_id()) && func_184(iParam0->f_28[0]) && !func_130() &&
		gameplay::get_game_timer() - iParam0->f_60 > iParam8 &&
		func_196(player::player_ped_id(), vParam1, 1) < fParam9) {
		uVar0 = 16;
	...
	if (player::is_player_playing(player::player_id())) {
		if (!gameplay::is_string_null_or_empty(sParam1)) {
			if (Global_35781 == 17) {
				...
				if (func_196(player::player_ped_id(), vParam2, 1) <= 100f) {
					func_190(iParam0, 1);
				}
			}
			else {
				...
				if (func_196(player::player_ped_id(), vParam2, 1) > 120f) {
					func_192(iParam0);
				}
			}
		}
...
// Position - 0xC24B
bool func_191() { return Global_89133; }
...
int func_197(var *uParam0, int iParam1) {
	...
	if (Global_69702) {
		func_286("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer "
				 "[TERMINATING]");
		return 0;
	}
	...
	if (func_227(*uParam0)) {
		...
		func_286("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1) {
	...
	if (*uParam0 == 10) {
		if (fire::is_explosion_in_sphere(-1, uParam0->f_17[0 /*3*/], 8f)) {
			func_286("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission "
					 "trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17) {
		if (!gameplay::is_bit_set(Var0.f_26, func_90())) {
			func_286("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player "
					 "character to launch mission");
			return 0;
		}
	}
	if (func_201(&uParam0->f_48) && iParam1) {
	...
	if (func_184(iParam0)) {
		...
		case 2:
			if (!func_200(uParam1) || !entity::is_entity_playing_anim(iParam0, *uParam1, uParam1->f_2, 3)) {
				...
				else if (func_200(uParam1) && uParam1->f_4 == 0 &&
	...
	if (func_184(player::player_ped_id())) {
		...
		while (iVar0 <= uParam0->f_28 - 1) {
			if (func_111(uParam0->f_28[iVar0])) {
				...
				switch (*uParam0) {
				case 19: func_226(uParam0->f_28[iVar0]); break;
		...
		while (iVar0 <= iVar1) {
			if (entity::does_entity_exist(uParam0->f_35[iVar0])) {
				if (entity::is_entity_dead(uParam0->f_35[iVar0], 0)) {
					func_286("STEP_5_COMMON_RCfineAndInRange - "
				...
				if (!ped::is_ped_injured(uParam0->f_28[iVar0])) {
					if (ped::is_ped_sitting_in_any_vehicle(player::player_ped_id())) {
						if (entity::is_entity_touching_entity(player::player_ped_id(), uParam0->f_28[iVar0])) {
							...
							func_286("STEP_5_COMMON_RCfineAndInRange - Random "
					...
					if (func_225(*uParam0)) {
						...
						if (fire::is_explosion_in_sphere(-1, entity::get_entity_coords(uParam0->f_28[iVar0], 1), 15f)) {
							...
							func_286("STEP_5_COMMON_RCfineAndInRange - There "
					...
					if (!func_207(*uParam0)) {
						...
						if (player::get_player_wanted_level(player::player_id()) > 0) {
							...
							func_286("STEP_5_COMMON_RCfineAndInRange - Player "
...
// Position - 0xD2E3
bool func_209(int iParam0, float fParam1) { return func_210(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_210(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_211(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0xD3BC
int func_211(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
	...
	if (*iParam0 == 0) {
		vVar1 = {func_212(iParam4, iParam7)};
		*iParam0 =
...
int func_214(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_216(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
...
// Position - 0xD76A
bool func_220(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_184(player::player_ped_id()) && func_184(iParam0)) {
		...
		if (!iParam2) {
			if (func_224(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_221(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
// Position - 0xD865
bool func_221(int iParam0, float fParam1, bool bParam2, bool bParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
// Position - 0xDA06
bool func_223(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
// Position - 0xDA94
bool func_224(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
void func_237(var *uParam0, int iParam1) {
	...
	func_238(uParam0, iLocal_93, vVar0, fVar3);
...
// Position - 0xE2F0
void func_238(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_239(uParam0);
...
// Position - 0xE3CC
void func_240(var *uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	func_241(uParam0);
...
// Position - 0xE42D
bool func_242(var *uParam0, int iParam1, vector3 vParam2, float fParam5, char *sParam6, int iParam7) {
	if (func_243(uParam0, iParam1, vParam2, fParam5, 1)) {
		if (entity::does_entity_exist(*uParam0)) {
...
// Position - 0xE489
bool func_243(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	int iVar0;
...
int func_250(var *uParam0) {
	...
	case 1:
		if (!func_248(&iVar0) || !streaming::has_anim_dict_loaded("rcmjosh3")) {
			return 0;
		}
		iLocal_91 = 2;
		break;
	...
	case 3:
		if (func_184(uParam0->f_28[0])) {
			...
			ai::task_synchronized_scene(uParam0->f_28[0], uParam0->f_59, "rcmjosh3", "sit_stairs_idle", 8f, -8f, 17, 0,
										1148846080, 0);
...
int func_252(var *uParam0) {
	...
	case 1:
		if (!func_248(&iVar0) || !streaming::has_anim_dict_loaded("rcmjosh2")) {
			return 0;
		}
		iLocal_91 = 2;
		break;
...
int func_256(int iParam0) {
	...
	if (Global_69702) {
		func_286("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is "
				 "running [TERMINATING]");
		return 0;
	}
	if (!Global_101700.f_8044 && !func_93(1)) {
		func_286("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not "
				 "active");
		return 0;
	}
	if (!func_257(iParam0)) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_286("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller "
				 "[TERMINATING]");
		return 0;
	}
	if (Global_91491.f_11 == 6) {
		if (Global_91491 < 9) {
			...
			if (gameplay::are_strings_equal(&Global_91491.f_3, sVar0)) {
				func_286("STEP_3_COMMON_CanRCLaunch - Script denied as a "
	...
	if (script::_get_number_of_instances_of_script_with_name_hash(joaat("candidate_controller")) == 0) {
		Global_100787[iParam0 /*10*/].f_1 = 1;
		func_286("STEP_3_COMMON_CanRCLaunch - Script denied as "
...
int func_265(int iParam0, int iParam1, vector3 vParam2, float fParam5) {
	...
	func_286("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch "
			 "[TERMINATING]");
	return 0;
}

// Position - 0xF1A6
bool func_266(int iParam0, vector3 vParam1, float fParam4, var *uParam5) {
	int iVar0;
	struct<7> Var1;
...
// Position - 0xF224
bool func_267(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
void func_268(int iParam0, int iParam1) {
	...
	switch (*iParam0) {
	case 30: sVar0 = "JOSH4_AMB"; break;
	}
	func_269(sVar0);
	switch (*iParam0) {
	case 30: entity::remove_forced_object(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r")); break;
	}
	if (iParam1) {
		func_194(*iParam0);
	}
...
void func_275(var *uParam0, int iParam1, int iParam2, int iParam3) {
	...
	func_279(uParam0, iParam2);
	func_276(uParam0, iParam3);
}

// Position - 0xF437
void func_276(var *uParam0, bool bParam1) { func_277(&uParam0->f_41, bParam1); }
...
// Position - 0xF4C2
void func_279(var *uParam0, bool bParam1) { func_280(&uParam0->f_35, bParam1); }
...
// Position - 0xF549
void func_282(var *uParam0, int iParam1) { func_283(&uParam0->f_28, iParam1); }
