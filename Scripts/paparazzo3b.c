...
void __EntryFunction__() {
	...
	while (true) {
		system::wait(0);
		unk1::_0x208784099002BC30("SF_TH", 0);
		func_476(Local_214.f_9, 0, 0, 0, 0, 0);
		func_475();
		if (iLocal_275 == 8) {
			func_469();
		}
		else if (func_468(player::player_ped_id())) {
			switch (iLocal_275) {
			case 0: func_385(); break;

			case 1: func_383(); break;

			case 2: func_381(); break;

			case 3: func_379(); break;

			case 4: func_280(); break;
...
void func_3() {
	...
	case 0:
		iLocal_416 = 0;
		iLocal_276 = 1;
		if (func_225(Local_332) && func_224(Local_332, player::player_ped_id(), 150f, 1) && iLocal_433 == 1) {
			iLocal_451 = gameplay::get_game_timer() + 15000;
		}
		else {
			iLocal_451 = gameplay::get_game_timer() + 4001;
		}
		iLocal_434 = 0;
		break;
	...
	case 1:
		func_223();
		if (gameplay::get_game_timer() > iLocal_451 || iLocal_277 == 5) {
			if (player::get_player_wanted_level(player::player_id()) == 0) {
				player::set_player_wanted_level(player::player_id(), 0, 0);
				if (!func_222() && !ped::is_ped_ragdoll(player::player_ped_id()) &&
					...
					if (!iLocal_416) {
						...
						func_221(&uLocal_761, 1, player::player_ped_id(), "FRANKLIN", 0, 1);
						if (bLocal_419) {
							if (func_209(&uLocal_761, 50, "pap3bau", "PAP3_ENDCAL2", 9, 1, 0, 0, 0)) {
								unk1::_0x293220DA1B46CEBC(1f, 4.5f, 0);
								iLocal_416 = 1;
							}
						}
				...
				iLocal_451 = gameplay::get_game_timer() + 3000;
				if (iLocal_434 == 0) {
...
void func_205(int iParam0) {
	if (iParam0) {
		gameplay::set_bit(&Global_2313, 28);
	}
	else {
		gameplay::clear_bit(&Global_2313, 28);
	}
}
...
// Position - 0x25D96
bool func_209(var *uParam0, int iParam1, char *sParam2, char *sParam3, int iParam4, int iParam5, int iParam6,
	...
	Global_2621441 = 0;
	return func_210(sParam3, iParam4, iParam8);
}
...
// Position - 0x26500
void func_223() {
	if (func_225(Local_332) && func_468(Local_378[0 /*6*/])) {
		if (func_225(Local_295[0 /*9*/]) && func_225(Local_332)) {
			if (ped::is_ped_in_vehicle(Local_295[0 /*9*/], Local_378[0 /*6*/], 0)) {
				if (ai::get_script_task_status(Local_295[0 /*9*/], -235832601) != 1 &&
					ai::get_script_task_status(Local_295[0 /*9*/], -235832601) != 0 &&
					ai::get_script_task_status(Local_295[0 /*9*/], -1273030092) != 1 &&
					ai::get_script_task_status(Local_295[0 /*9*/], -1273030092) != 0) {
					if (ped::is_ped_in_vehicle(Local_332, Local_378[0 /*6*/], 0) &&
						ped::is_ped_in_vehicle(Local_295[1 /*9*/], Local_378[0 /*6*/], 0)) {
						ai::task_vehicle_follow_waypoint_recording(Local_295[0 /*9*/], Local_378[0 /*6*/],
																   "PAP3_Security1", 262144, 0, 8, -1, -1f, 0,
																   1073741824);
					}
				}
			}
			else if (ai::get_script_task_status(Local_332, -1794415470) != 1 &&
					 ai::get_script_task_status(Local_332, -1794415470) != 0) {
				ai::task_enter_vehicle(Local_332, Local_378[0 /*6*/], 20000, 1, 1f, 1, 0);
			}
		}
		if (func_225(Local_295[2 /*9*/]) && func_468(Local_378[1 /*6*/])) {
			if (ped::is_ped_in_vehicle(Local_295[2 /*9*/], Local_378[1 /*6*/], 0)) {
				if (ai::get_script_task_status(Local_295[2 /*9*/], -1273030092) != 1 &&
					ai::get_script_task_status(Local_295[2 /*9*/], -1273030092) != 0) {
					if (ped::is_ped_facing_ped(Local_295[2 /*9*/], Local_332, 70f)) {
						if (ai::get_script_task_status(Local_295[2 /*9*/], -235832601) != 1 &&
							ai::get_script_task_status(Local_295[2 /*9*/], -235832601) != 0) {
							ai::task_vehicle_follow_waypoint_recording(Local_295[2 /*9*/], Local_378[1 /*6*/],
																	   "PAP3_Security1", 262144, 0, 8, -1, -1f, 0,
																	   1073741824);
						}
					}
	...
	if (func_225(Local_295[0 /*9*/]) && ped::is_ped_in_any_vehicle(Local_295[0 /*9*/], 0)) {
		if (entity::is_entity_in_angled_area(Local_295[0 /*9*/], 1158.52f, -759.3739f, 56.32278f, 1116.869f, -759.6908f,
											 61.70632f, 13.75f, 0, 1, 0)) {
			if (ai::get_script_task_status(Local_295[0 /*9*/], -1273030092) != 1) {
				ped::set_ped_keep_task(Local_295[0 /*9*/], 1);
				ai::task_vehicle_mission_ped_target(Local_295[0 /*9*/],
													ped::get_vehicle_ped_is_in(Local_295[0 /*9*/], 0),
													player::player_ped_id(), 8, 25f, 786468, 20f, 20f, 1);
			}
		}
		if (func_225(Local_295[2 /*9*/]) && func_468(Local_378[1 /*6*/])) {
			if (entity::is_entity_in_angled_area(Local_295[2 /*9*/], 1158.52f, -759.3739f, 56.32278f, 1116.869f,
												 -759.6908f, 61.70632f, 13.75f, 0, 1, 0)) {
				if (ai::get_script_task_status(Local_295[2 /*9*/], -1273030092) != 1 &&
					ai::get_script_task_status(Local_295[2 /*9*/], -1273030092) != 0) {
					ped::set_ped_keep_task(Local_295[2 /*9*/], 1);
					ai::task_vehicle_mission_ped_target(Local_295[2 /*9*/], Local_378[1 /*6*/], Local_332, 12, 25f,
														786469, 20f, 10f, 1);
					if (iLocal_412 == 0) {
						func_1(1);
					}
...
void func_226() {
	...
	if (iLocal_417 == 0) {
		...
		Var0 = {func_230()};
		if (gameplay::are_strings_equal(&Var0, "PAP3_DEALER")) {
			func_229();
		}
		if (func_225(Local_332)) {
			if (func_228(Local_378[0 /*6*/]) && vehicle::is_vehicle_seat_free(Local_378[0 /*6*/], 1, 0)) {
				if (!ped::is_ped_in_vehicle(Local_332, Local_378[0 /*6*/], 0)) {
					if (!func_227(Local_332, -1794415470)) {
						ai::task_enter_vehicle(Local_332, Local_378[0 /*6*/], 20000, 1, 1f, 1, 0);
						iLocal_277 = 2;
					}
				}
		...
		if (gameplay::get_game_timer() - iLocal_456 > 20) {
			if (func_225(Local_295[0 /*9*/])) {
				if (func_228(Local_378[0 /*6*/]) && vehicle::is_vehicle_seat_free(Local_378[0 /*6*/], -1, 0)) {
					if (!ped::is_ped_in_vehicle(Local_295[0 /*9*/], Local_378[0 /*6*/], 0)) {
						if (!func_227(Local_295[0 /*9*/], -1794415470)) {
							ai::task_enter_vehicle(Local_295[0 /*9*/], Local_378[0 /*6*/], 20000, -1, 1f, 1, 0);
							iLocal_481[0] = 5;
						}
					}
				}
		...
		if (gameplay::get_game_timer() - iLocal_456 > 400) {
			if (func_225(Local_295[1 /*9*/])) {
				if (func_228(Local_378[0 /*6*/]) && vehicle::is_vehicle_seat_free(Local_378[0 /*6*/], 0, 0)) {
					if (!ped::is_ped_in_vehicle(Local_295[1 /*9*/], Local_378[0 /*6*/], 0)) {
						if (!func_227(Local_295[1 /*9*/], -1794415470)) {
							ai::task_enter_vehicle(Local_295[1 /*9*/], Local_378[0 /*6*/], 20000, 0, 1f, 1, 0);
							iLocal_481[1] = 5;
						}
					}
				}
		...
		if (gameplay::get_game_timer() - iLocal_456 > 600) {
			if (func_225(Local_295[2 /*9*/])) {
				if (func_228(Local_378[1 /*6*/]) && vehicle::is_vehicle_seat_free(Local_378[1 /*6*/], -1, 0)) {
					if (!ped::is_ped_in_vehicle(Local_295[2 /*9*/], Local_378[1 /*6*/], 0)) {
						if (!func_227(Local_295[2 /*9*/], -1794415470)) {
							ai::task_enter_vehicle(Local_295[2 /*9*/], Local_378[1 /*6*/], 20000, -1, 1f, 1, 0);
							iLocal_481[2] = 5;
						}
					}
				}
		...
		if (gameplay::get_game_timer() - iLocal_456 > 100) {
			if (func_225(Local_341) && !func_227(Local_341, 63541484)) {
				if (ai::get_script_task_status(Local_341, -1146898486) != 1 &&
					ai::get_script_task_status(Local_341, -1146898486) != 0) {
					ped::force_ped_motion_state(Local_341, -668482597, 0, 1, 0);
					ped::set_ped_min_move_blend_ratio(Local_341, 1f);
					ai::task_wander_standard(Local_341, 1193033728, 0);
				}
				iLocal_278 = 4;
			}
		}
		if (gameplay::get_game_timer() - iLocal_456 > 350) {
			if (func_225(Local_350[0 /*9*/]) && !func_227(Local_350[0 /*9*/], -1146898486)) {
				ai::task_wander_standard(Local_350[0 /*9*/], 1193033728, 0);
				iLocal_486[0] = 4;
			}
		}
		if (gameplay::get_game_timer() - iLocal_456 > 600) {
			if (func_225(Local_350[1 /*9*/]) && !func_227(Local_350[1 /*9*/], -1146898486)) {
				if (ai::get_script_task_status(Local_350[1 /*9*/], -1146898486) != 1 &&
					ai::get_script_task_status(Local_350[1 /*9*/], -1146898486) != 0) {
					ped::force_ped_motion_state(Local_350[1 /*9*/], -668482597, 0, 1, 0);
					ped::set_ped_min_move_blend_ratio(Local_350[1 /*9*/], 1f);
					ai::task_wander_standard(Local_350[1 /*9*/], 1193033728, 0);
				}
				iLocal_486[1] = 4;
			}
		}
		if (gameplay::get_game_timer() - iLocal_456 > 5000) {
			if (iLocal_411 == 0) {
				func_1(1);
			}
			iLocal_417 = 1;
...
void func_231()
{
	...
	Var6 = {func_230()};
	if (func_222()) {
		if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER")) {
			func_246();
		}
	}
	...
	case 0:
		...
		iVar13 = 0;
		while (iVar13 <= 3) {
			if (ui::does_blip_exist(Local_295[iVar13 /*9*/].f_8)) {
			}
		...
		if (func_225(Local_295[2 /*9*/]) && func_468(Local_378[1 /*6*/])) {
			ped::_0xE4723DB6E736CCFF(Local_295[2 /*9*/], Local_378[1 /*6*/], 0f, 0f, 0f, 5f, 0);
		}
		ai::open_sequence_task(&iVar14);
		ai::task_set_blocking_of_non_temporary_events(0, 1);
		if (func_225(Local_350[0 /*9*/])) {
			ai::task_combat_ped(0, Local_350[0 /*9*/], 67108864, 16);
		}
		...
		if (func_225(Local_295[1 /*9*/])) {
			...
			ai::task_perform_sequence(Local_295[1 /*9*/], iVar14);
		}
	...
	case 1:
		if (func_225(Local_295[0 /*9*/])) {
			if (!ped::is_ped_in_combat(Local_295[0 /*9*/], player::player_ped_id())) {
				ai::task_combat_ped(Local_295[0 /*9*/], player::player_ped_id(), 0, 16);
			}
		}
		if (func_225(Local_295[3 /*9*/])) {
			if (!ped::is_ped_in_combat(Local_295[3 /*9*/], player::player_ped_id())) {
				ai::task_combat_ped(Local_295[3 /*9*/], player::player_ped_id(), 0, 16);
			}
		}
		if (!func_225(Local_350[0 /*9*/])) {
			if (func_225(Local_295[1 /*9*/])) {
				if (!ped::is_ped_in_combat(Local_295[1 /*9*/], player::player_ped_id())) {
					ai::task_combat_ped(Local_295[1 /*9*/], player::player_ped_id(), 0, 16);
				}
			}
		}
		if (func_225(Local_295[2 /*9*/])) {
			if (iLocal_468 == 0) {
				if (!entity::is_entity_in_angled_area(player::player_ped_id(), 1114.697f, -787.0848f, 56.64847f,
													  1051.764f, -787.1609f, 64.14056f, 23f, 0, 1, 0)) {
					if (func_468(Local_378[1 /*6*/])) {
						if (!ped::is_ped_in_vehicle(Local_295[2 /*9*/], Local_378[1 /*6*/], 0)) {
							if (ai::get_script_task_status(Local_295[2 /*9*/], -1794415470) != 1 &&
								ai::get_script_task_status(Local_295[2 /*9*/], -1794415470) != 0) {
								ai::task_enter_vehicle(Local_295[2 /*9*/], Local_378[1 /*6*/], 20000, -1, 2f, 1, 0);
							}
						}
						else {
							ai::task_combat_ped(Local_295[2 /*9*/], player::player_ped_id(), 0, 16);
							iLocal_468 = 1;
						}
					}
				}
				...
				if (!func_242(Local_295[2 /*9*/], vLocal_490, 100f)) {
					iLocal_468 = 2;
				}
			}
		}
		if (iLocal_410 == 1) {
			if (!func_468(Local_332)) {
				func_1(4);
			}
			else {
				if (!entity::is_entity_in_angled_area(Local_332, 1083.386f, -793.4014f, 55.295f, 1092.126f, -793.568f,
													  60.51268f, 11f, 0, 1, 0)) {
					if (func_225(Local_295[0 /*9*/])) {
				...
				if (entity::has_entity_been_damaged_by_entity(Local_332, player::player_ped_id(), 1)) {
					func_1(3);
				}
				if (iLocal_480 == 2) {
					func_239();
		...
		if (gameplay::are_strings_equal(&Var0, "PAP3_SECUR2_2")) {
			func_237();
		}
		if (!func_222()) {
			if (iLocal_480 == 1) {
				...
				func_221(&uLocal_761, 6, Local_341, "Paparazzo3BDrugDealer", 0, 1);
		...
		if (func_225(Local_332) && ped::is_ped_in_any_vehicle(Local_332, 0)) {
			if (ai::is_waypoint_playback_going_on_for_vehicle(ped::get_vehicle_ped_is_in(Local_332, 0))) {
				ai::vehicle_waypoint_playback_override_speed(ped::get_vehicle_ped_is_in(Local_332, 0), 20f);
			}
			if (entity::is_entity_in_angled_area(Local_332, 1158.52f, -759.3739f, 56.32278f, 1116.869f, -759.6908f,
												 61.70632f, 13.75f, 0, 1, 0)) {
				if (ai::get_script_task_status(Local_332, -1273030092) != 1) {
					ai::task_vehicle_mission_ped_target(Local_332, ped::get_vehicle_ped_is_in(Local_332, 0),
														player::player_ped_id(), 8, 50f, 786469, 20f, 20f, 1);
				}
			}
		}
		break;
...
bool func_232() {
	...
	while (iVar0 <= 3) {
		if (func_468(Local_295[iVar0 /*9*/])) {
			if (!func_224(player::player_ped_id(), Local_295[iVar0 /*9*/], 200f, 1)) {
				if (ui::does_blip_exist(Local_295[iVar0 /*9*/].f_8)) {
			...
			else if (ui::does_blip_exist(Local_295[iVar0 /*9*/].f_8)) {
				if (ped::is_ped_in_any_vehicle(Local_295[iVar0 /*9*/], 0)) {
					ui::set_blip_scale(Local_295[iVar0 /*9*/].f_8, 1f);
				}
				else {
					ui::set_blip_scale(Local_295[iVar0 /*9*/].f_8, 0.7f);
				}
			}
		}
		else if (ui::does_blip_exist(Local_295[iVar0 /*9*/].f_8)) {
...
void func_239() {
	if (iLocal_471 < 2) {
		if (gameplay::get_game_timer() > iLocal_472 + 10000) {
			if (!func_222()) {
				if (func_241(player::player_ped_id(), Local_332, 1) < 50f) {
					if (func_240(&uLocal_761, "pap3bau", "PAP3_SHOCK", 7, 1, 0, 0)) {
						iLocal_471++;
						iLocal_472 = gameplay::get_game_timer() + gameplay::get_random_int_in_range(0, 4000);
					}
				}
			}
		}
...
void func_249()
{
	...
	case 0:
		...
		iLocal_451 = gameplay::get_game_timer() + 15000;
		iLocal_452 = gameplay::get_game_timer() + 5000;
		iLocal_453 = gameplay::get_game_timer() + 10000;
		bLocal_419 = false;
		func_235(&iLocal_288);
		iLocal_276 = 1;
		break;
	...
	case 1:
		...
		if (iLocal_413 == 0 && iLocal_414 == 0) {
			if (gameplay::get_game_timer() > iLocal_451 && iLocal_417 == 0) {
				func_226();
				iLocal_276 = 2;
			}
		}
		...
		if (gameplay::get_game_timer() > iLocal_452 && func_255() ||
			gameplay::get_game_timer() > iLocal_453 && (func_255() || iLocal_414) || func_253()) {
			if (iLocal_415 == 0) {
				func_221(&uLocal_761, 3, 0, "BEVERLY", 0, 1);
				func_221(&uLocal_761, 1, player::player_ped_id(), "FRANKLIN", 0, 1);
				if (func_255() || iLocal_414 == 1) {
					if (func_209(&uLocal_761, 50, "pap3bau", "PAP3_ENDCAL1", 9, 1, 0, 0, 0)) {
						...
						bLocal_419 = true;
						if (func_225(Local_295[0 /*9*/])) {
							ai::clear_ped_tasks(Local_295[0 /*9*/]);
							audio::_play_ambient_speech_with_voice(
								Local_295[0 /*9*/], "PAP3B_BFAA", "Paparazzo3BBodyGuard1", "SPEECH_PARAMS_STANDARD", 0);
							ai::task_turn_ped_to_face_entity(Local_295[0 /*9*/], player::player_ped_id(), -1);
						}
					}
				}
				...
				func_246();
				func_221(&uLocal_761, 5, Local_332, "PRINCESS", 0, 1);
...
void func_250(int iParam0) {
	...
	if (iLocal_414 == 0) {
		if (iParam0 == 1) {
			if (func_225(Local_295[0 /*9*/])) {
				if (func_225(Local_350[0 /*9*/])) {
					ai::task_aim_gun_at_entity(Local_295[0 /*9*/], player::player_ped_id(), -1, 0);
					iLocal_481[0] = 9;
					iLocal_486[0] = 1;
					uLocal_455 = gameplay::get_game_timer() + 3000;
					uLocal_454 = gameplay::get_game_timer() + 2000;
				}
			}
		}
		else if (func_225(Local_295[0 /*9*/])) {
			if (func_225(Local_350[0 /*9*/])) {
				ai::task_go_straight_to_coord(Local_295[0 /*9*/], vLocal_493, 3f, 20000, 353f, 1056964608);
		...
		if (func_225(Local_295[1 /*9*/])) {
			if (func_225(Local_350[1 /*9*/])) {
				ai::task_turn_ped_to_face_entity(Local_295[1 /*9*/], player::player_ped_id(), -1);
				iLocal_481[1] = 9;
				iLocal_486[1] = 1;
				uLocal_455 = gameplay::get_game_timer() + 3000;
				uLocal_454 = gameplay::get_game_timer() + 2000;
		...
		if (func_225(Local_295[2 /*9*/])) {
			if (func_228(Local_378[1 /*6*/]) && vehicle::is_vehicle_seat_free(Local_378[1 /*6*/], -1, 0)) {
				ai::clear_ped_tasks(Local_295[2 /*9*/]);
				ai::task_enter_vehicle(Local_295[2 /*9*/], Local_378[1 /*6*/], 20000, -1, 3f, 1, 0);
				iLocal_481[2] = 2;
			}
		}
		if (func_225(Local_295[3 /*9*/])) {
			if (func_225(player::player_ped_id())) {
				ai::task_go_to_coord_while_aiming_at_entity(Local_295[3 /*9*/], 1094.245f, -791.3043f, 57.2632f,
															player::player_ped_id(), 3f, 0, 9f, 15f, 1, 0, 0,
															-957453492, 20000);
				iLocal_481[3] = 10;
			}
		}
		if (func_225(Local_332)) {
			...
			if (func_228(Local_378[0 /*6*/]) && vehicle::is_vehicle_seat_free(Local_378[0 /*6*/], -1, 0)) {
				if (!ped::is_ped_in_vehicle(Local_332, Local_378[0 /*6*/], 0)) {
					ai::clear_ped_tasks(Local_332);
					ai::task_enter_vehicle(Local_332, Local_378[0 /*6*/], 20000, -1, 3f, 1, 0);
					iLocal_277 = 2;
				}
			}
			else {
				func_251(Local_332, 0);
				iLocal_277 = 4;
			}
		}
		if (func_225(Local_341)) {
			if (iParam0 == 1) {
				iLocal_278 = 2;
			}
			else {
...
bool func_252() {
	...
	while (iVar0 <= 3) {
		if (func_468(Local_295[iVar0 /*9*/])) {
			...
			if (ped::_0x6CD5A433374D4CFB(Local_295[iVar0 /*9*/], player::player_ped_id())) {
				return true;
			}
		}
		iVar0++;
...
// Position - 0x27D10
int func_253() {
	if (func_254(&uLocal_551, entity::get_entity_coords(player::player_ped_id(), 1))) {
		return 0;
	}
	return 1;
}
...
// Position - 0x27D30
bool func_254(var *uParam0, struct<2> Param1, Vector3 vParam3) {
	int iVar0;
	int iVar1;
	int iVar2;
...
// Position - 0x27DEC
int func_255() {
	if (func_254(&uLocal_655, entity::get_entity_coords(player::player_ped_id(), 1))) {
		return 1;
	}
	return 0;
}
...
// Position - 0x27E0C
void func_256() {
	if (entity::does_entity_exist(Local_369)) {
		if (!entity::is_entity_dead(Local_369, 0)) {
			if (ped::is_ped_injured(Local_369)) {
				func_1(6);
			}
			else if (func_257(Local_369, 1, 1116471296, 1126825984, 0, 0, 0, 0)) {
				ped::set_blocking_of_non_temporary_events(Local_369, 0);
				ped::_0xF1C03A5352243A30(Local_369);
				if (!ped::is_ped_fleeing(Local_369)) {
					ai::task_smart_flee_ped(Local_369, player::player_ped_id(), 500f, -1, 0, 0);
				}
				func_1(5);
			}
			else if (entity::has_entity_been_damaged_by_entity(Local_369, player::player_ped_id(), 1)) {
				ped::set_blocking_of_non_temporary_events(Local_369, 0);
				ped::_0xF1C03A5352243A30(Local_369);
				if (!ped::is_ped_fleeing(Local_369)) {
					ai::task_smart_flee_ped(Local_369, player::player_ped_id(), 500f, -1, 0, 0);
			...
			else if (func_468(player::get_players_last_vehicle()) &&
					 entity::has_entity_been_damaged_by_entity(Local_369, player::get_players_last_vehicle(), 1)) {
				ped::set_blocking_of_non_temporary_events(Local_369, 0);
				ped::_0xF1C03A5352243A30(Local_369);
				if (!ped::is_ped_fleeing(Local_369)) {
					ai::task_smart_flee_ped(Local_369, player::player_ped_id(), 500f, -1, 0, 0);
...
// Position - 0x27F24
bool func_257(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6,
			  int iParam7) {
	vector3 vVar0;
	...
	if (func_468(player::player_ped_id()) && func_468(iParam0)) {
		...
		if (func_271(iParam0, iParam1, iParam5, iParam6, iParam7)) {
			return true;
		}
...
// Position - 0x28055
bool func_259(int iParam0, float fParam1) { return func_260(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
bool func_260(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_261(&Local_37[iVar4 /*4*/], vVar1, iParam1, &Local_37[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_37[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0x2812E
int func_261(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
	...
	if (*iParam0 == 0) {
		vVar1 = {func_262(iParam4, iParam7)};
		*iParam0 =
...
int func_264(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	vVar0 = {func_266(entity::get_entity_coords(iParam1, 1) - entity::get_entity_coords(iParam0, 1))};
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_266(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
						  ped::get_ped_bone_coords(iParam0, 31086, 0f, 0f, 0f))};
	}
	fVar6 = func_265(vVar3, vVar0);
...
// Position - 0x28523
bool func_271(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4) {
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_468(player::player_ped_id()) && func_468(iParam0)) {
		...
		if (!bParam2) {
			if (func_275(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
...
bool func_274(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	...
	vVar0 = {func_266(vParam1 - entity::get_entity_coords(iParam0, 1))};
...
// Position - 0x2884D
bool func_275(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
	...
	if (iLocal_410 == 0) {
		if (func_279(0)) {
			...
			while (iVar0 <= 3) {
				...
				if (iVar0 == 3) {
					ai::task_start_scenario_in_place(Local_295[iVar0 /*9*/], "WORLD_HUMAN_GUARD_STAND", 0, 0);
				...
				if (iVar0 == 0 || iVar0 == 3) {
					...
					weapon::give_weapon_component_to_ped(Local_295[iVar0 /*9*/], joaat("weapon_appistol"),
														 joaat("component_at_pi_flsh"));
					ped::_0xF1C03A5352243A30(Local_295[iVar0 /*9*/]);
				}
				else {
					weapon::give_weapon_to_ped(Local_295[iVar0 /*9*/], joaat("weapon_appistol"), -1, 0, 0);
					if (iVar0 == 1) {
			...
			ped::set_blocking_of_non_temporary_events(Local_332, 1);
			ped::set_ped_relationship_group_hash(Local_332, iLocal_759);
			entity::set_entity_only_damaged_by_player(Local_332, 1);
			ai::task_start_scenario_in_place(Local_332, "WORLD_HUMAN_SMOKING", 0, 0);
			ped::set_ped_prop_index(Local_332, 1, 0, 0, 0);
			func_278(&Local_341, 0);
			entity::set_entity_health(Local_341, 125);
			ped::set_ped_combat_attributes(Local_341, 17, 1);
			ped::set_ped_relationship_group_hash(Local_341, iLocal_760);
			ped::_0xF1C03A5352243A30(Local_341);
			ped::set_ped_component_variation(Local_341, 0, 1, 1, 0);
			ped::set_ped_component_variation(Local_341, 3, 0, 2, 0);
			ped::set_ped_component_variation(Local_341, 4, 0, 1, 0);
			ped::set_blocking_of_non_temporary_events(Local_341, 1);
			iVar0 = 0;
			while (iVar0 <= 1) {
				func_278(&Local_350[iVar0 /*9*/], 0);
				entity::set_entity_health(Local_350[iVar0 /*9*/], 125);
				...
				if (iVar0 == 0) {
					...
					if (func_468(Local_350[iVar0 /*9*/])) {
						ai::task_look_at_entity(Local_350[iVar0 /*9*/], Local_332, -1, 0, 2);
					}
				...
				if (iVar0 == 0) {
					ai::task_start_scenario_in_place(Local_350[iVar0 /*9*/], "WORLD_HUMAN_STAND_IMPATIENT", 0, 0);
				}
				iVar0++;
			}
			func_278(&Local_369, 0);
			ped::set_ped_can_be_targetted(Local_369, 0);
			ped::set_blocking_of_non_temporary_events(Local_369, 1);
			ped::set_ped_flee_attributes(Local_369, 128, 1);
			entity::set_entity_coords_no_offset(Local_369, Local_369.f_1, 0, 0, 1);
			weapon::give_weapon_to_ped(Local_369, joaat("weapon_knife"), -1, 0, 1);
			ai::task_start_scenario_in_place(Local_369, "WORLD_HUMAN_SMOKING", 0, 0);
			ped::set_ped_component_variation(Local_369, 0, 1, 0, 0);
			ped::set_ped_component_variation(Local_369, 3, 0, 0, 0);
			ped::set_ped_component_variation(Local_369, 4, 0, 2, 0);
			ped::set_ped_component_variation(Local_369, 8, 0, 0, 0);
			iVar0 = 0;
			while (iVar0 <= 1) {
			...
			vehicle::set_vehicle_alarm(Local_391, 1);
			vehicle::set_vehicle_model_is_suppressed(Local_391.f_5, 1);
			vehicle::set_vehicle_colour_combination(Local_391, 3);
			func_277(&Local_397, 1);
			vehicle::set_vehicle_model_is_suppressed(Local_397.f_5, 1);
			vehicle::set_vehicle_colour_combination(Local_397, 0);
			iLocal_410 = 1;
			iVar0 = 0;
			while (iVar0 <= 3) {
			...
			ai::task_synchronized_scene(Local_341, iLocal_293, "rcmpaparazzo_3big_1", "_idle_dealer_a", 4f, -4f, 65, 0,
										1148846080, 0);
			ai::task_synchronized_scene(Local_350[1 /*9*/], iLocal_293, "rcmpaparazzo_3big_1", "_idle_dealer_b", 4f,
										-4f, 65, 0, 1148846080, 0);
			ai::task_synchronized_scene(Local_295[0 /*9*/], iLocal_293, "rcmpaparazzo_3big_1", "_idle_guard_a", 4f, -4f,
										65, 0, 1148846080, 0);
			ai::task_synchronized_scene(Local_295[1 /*9*/], iLocal_293, "rcmpaparazzo_3big_1", "_idle_guard_b", 4f, -4f,
										65, 0, 1148846080, 0);
		}
	}
}
...
void func_278(int iParam0, int iParam1) {
	if (streaming::has_model_loaded(iParam0->f_5)) {
		*iParam0 = ped::create_ped(26, iParam0->f_5, iParam0->f_1, iParam0->f_4, 1, 1);
		if (iParam1 == 1) {
...
bool func_279(int iParam0) {
	...
	ai::request_waypoint_recording("PAP3_Security1");
...
void func_280() {
	...
	case 0:
		...
		func_378(50);
		iLocal_451 = gameplay::get_game_timer() + 80000;
		iLocal_421 = 0;
		iLocal_422 = 0;
		iLocal_423 = 1;
		iLocal_424 = 0;
		...
		iLocal_450 = 0;
		func_235(&iLocal_288);
		iLocal_288 = func_243(Local_332, 1, 1, 5);
		if (func_225(Local_332)) {
			iLocal_929 = func_376(player::player_ped_id(), Local_332, 0f);
		}
		...
		if (func_228(Local_391)) {
			entity::freeze_entity_position(Local_391, 0);
		}
	...
	case 1:
		...
		if (func_225(Local_369) && entity::has_entity_been_damaged_by_entity(Local_369, player::player_ped_id(), 1) &&
			!audio::is_any_speech_playing(Local_214.f_28[0])) {
			...
			if (func_225(Local_295[1 /*9*/]) && func_225(Local_350[1 /*9*/])) {
				if (iLocal_474 == 0) {
					if (ped::get_synchronized_scene_phase(iLocal_294) >= 0.259f) {
						iLocal_291 = object::create_object_no_offset(
							joaat("prop_drug_package_02"),
							entity::get_offset_from_entity_in_world_coords(Local_350[1 /*9*/], 0f, 0f, 10f), 1, 1, 0);
						entity::attach_entity_to_entity(iLocal_291, Local_350[1 /*9*/],
														ped::get_ped_bone_index(Local_350[1 /*9*/], 28422), 0.135f, 0f,
														-0.05f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
						entity::set_entity_visible(iLocal_291, 1, 0);
						iLocal_474 = 1;
					}
				}
				else if (iLocal_474 == 1) {
					if (ped::get_synchronized_scene_phase(iLocal_294) >= 0.821f) {
						iLocal_292 = object::create_object_no_offset(
							joaat("prop_cash_pile_02"),
							entity::get_offset_from_entity_in_world_coords(Local_295[1 /*9*/], 0f, 0f, 10f), 1, 1, 0);
						entity::attach_entity_to_entity(iLocal_292, Local_295[1 /*9*/],
														ped::get_ped_bone_index(Local_295[1 /*9*/], 28422), 0.07f, 0f,
														-0.04f, 0f, 0f, -30f, 1, 1, 0, 0, 2, 1);
						iLocal_474 = 2;
					}
				}
					...
					if (ped::get_synchronized_scene_phase(iLocal_294) >= 0.844f) {
						...
						entity::detach_entity(iLocal_291, 1, 1);
						entity::set_entity_visible(iLocal_291, 0, 0);
						entity::attach_entity_to_entity(iLocal_291, Local_295[1 /*9*/],
														ped::get_ped_bone_index(Local_295[1 /*9*/], 60309), 0.1f, 0f,
														0.05f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
						iLocal_474 = 3;
					}
				}
					...
					if (ped::get_synchronized_scene_phase(iLocal_294) >= 0.849f) {
						entity::process_entity_attachments(Local_295[1 /*9*/]);
						entity::process_entity_attachments(Local_350[1 /*9*/]);
						entity::detach_entity(iLocal_292, 1, 1);
						entity::set_entity_visible(iLocal_292, 0, 0);
						entity::attach_entity_to_entity(iLocal_292, Local_350[1 /*9*/],
														ped::get_ped_bone_index(Local_350[1 /*9*/], 28422), 0.07f, 0f,
														0f, 0f, 0f, 90f, 1, 1, 0, 0, 2, 1);
						entity::detach_entity(iLocal_291, 1, 1);
		...
		if (iLocal_439 == 0) {
			if (gameplay::get_game_timer() > iLocal_473 + 1000) {
				iLocal_439 = 1;
			}
		}
		...
		if (bLocal_438) {
			if (iLocal_425 == 0) {
				if (func_240(&uLocal_761, "pap3bau", "PAP3_DEALER", 8, 0, 0, 0)) {
					iLocal_294 =
						ped::create_synchronized_scene(Local_378[0 /*6*/].f_1, 0f, 0f, Local_378[0 /*6*/].f_4, 2);
					if (func_225(Local_341)) {
						ai::task_synchronized_scene(Local_341, iLocal_294, "rcmpaparazzo_3big_1", "_action_dealer_a",
													2f, -2f, 0, 0, 1148846080, 0);
					}
					if (func_225(Local_350[1 /*9*/])) {
						ai::task_synchronized_scene(Local_350[1 /*9*/], iLocal_294, "rcmpaparazzo_3big_1",
													"_action_dealer_b", 2f, -2f, 0, 0, 1148846080, 0);
					}
					if (func_225(Local_295[0 /*9*/])) {
						ai::task_synchronized_scene(Local_295[0 /*9*/], iLocal_294, "rcmpaparazzo_3big_1",
													"_action_guard_a", 2f, -2f, 0, 0, 1148846080, 0);
					}
					if (func_225(Local_295[1 /*9*/])) {
						ai::task_synchronized_scene(Local_295[1 /*9*/], iLocal_294, "rcmpaparazzo_3big_1",
													"_action_guard_b", 2f, -2f, 0, 0, 1148846080, 0);
					}
					iLocal_425 = 1;
				}
			}
				...
				if (!iLocal_450) {
					if (ped::is_synchronized_scene_running(iLocal_294) &&
						ped::get_synchronized_scene_phase(iLocal_294) >= 0.04f) {
						if (func_225(Local_332)) {
							ai::task_synchronized_scene(Local_332, iLocal_294, "rcmpaparazzo_3big_1",
														"_action_princess", 1f, -2f, 0, 0, 1f, 0);
							iLocal_450 = 1;
						}
					}
				}
				if (!ped::is_synchronized_scene_running(iLocal_294) ||
					ped::get_synchronized_scene_phase(iLocal_294) >= 0.893f) {
					iLocal_433 = 1;
					ped::clear_relationship_between_groups(5, iLocal_759, 1862763509);
					func_226();
					func_223();
				}
				if (iLocal_412 && !func_242(player::player_ped_id(), 1087.297f, -791.3091f, 57.2626f, 60f)) {
					iLocal_433 = 1;
					ped::clear_relationship_between_groups(5, iLocal_759, 1862763509);
					func_226();
					func_223();
				...
				Var0 = {func_248()};
				if (gameplay::are_strings_equal(&Var0, "PAP3_DEALER_23")) {
					func_237();
				}
				if (!iLocal_440) {
					if (gameplay::are_strings_equal(&Var0, "PAP3_DEALER_20") &&
						ped::is_synchronized_scene_running(iLocal_294) &&
						ped::get_synchronized_scene_phase(iLocal_294) < 0.758f) {
						if (func_225(Local_332)) {
							ai::task_synchronized_scene(Local_332, iLocal_294, "rcmpaparazzo_3big_1",
														"_action_princess", 1f, -2f, 0, 0, 1148846080, 0);
						}
						if (func_225(Local_341)) {
							ai::task_synchronized_scene(Local_341, iLocal_294, "rcmpaparazzo_3big_1",
														"_action_dealer_a", 1f, -2f, 0, 0, 1148846080, 0);
						}
						if (func_225(Local_350[1 /*9*/])) {
							ai::task_synchronized_scene(Local_350[1 /*9*/], iLocal_294, "rcmpaparazzo_3big_1",
														"_action_dealer_b", 1f, -2f, 0, 0, 1148846080, 0);
						}
						if (func_225(Local_295[0 /*9*/])) {
							ai::task_synchronized_scene(Local_295[0 /*9*/], iLocal_294, "rcmpaparazzo_3big_1",
														"_action_guard_a", 1f, -2f, 0, 0, 1148846080, 0);
						}
						if (func_225(Local_295[1 /*9*/])) {
							ai::task_synchronized_scene(Local_295[1 /*9*/], iLocal_294, "rcmpaparazzo_3big_1",
														"_action_guard_b", 1f, -2f, 0, 0, 1148846080, 0);
						}
		...
		if (iLocal_433 == 0) {
			if (iLocal_411) {
				if (!iLocal_412) {
					if (gameplay::get_game_timer() > iLocal_457 + 15000) {
						if (!iLocal_447) {
							unk1::_0x293220DA1B46CEBC(6f, 6f, 1);
			...
			if (func_468(Local_332) && !entity::is_entity_occluded(Local_332)) {
				func_304();
			}
			if (iLocal_427 == 0) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 1114.694f, -779.025f, 54.92999f, 1104.67f,
													 -779.1714f, 60.32433f, 5f, 0, 1, 0)) {
					if (func_225(Local_295[3 /*9*/])) {
						ai::task_look_at_entity(Local_295[3 /*9*/], player::player_ped_id(), -1, 0, 2);
						audio::_play_ambient_speech_with_voice(Local_295[3 /*9*/], "PAP3B_BCAA",
															   "Paparazzo3BBodyGuard1", "SPEECH_PARAMS_STANDARD", 0);
						iLocal_427 = 1;
					}
				}
			}
			else if (entity::is_entity_in_angled_area(player::player_ped_id(), 1114.694f, -779.025f, 54.92999f,
													  1104.67f, -779.1714f, 60.32433f, 5f, 0, 1, 0)) {
				iLocal_436 = 0;
				iLocal_469++;
				if (iLocal_470 == 0) {
					if (iLocal_469 >= 50) {
						if (func_225(Local_295[3 /*9*/])) {
							...
							weapon::give_weapon_component_to_ped(Local_295[3 /*9*/], joaat("weapon_combatpistol"),
																 joaat("component_at_pi_flsh"));
							ai::task_aim_gun_at_entity(Local_295[3 /*9*/], player::player_ped_id(), 8000, 0);
							iLocal_470 = 1;
						}
					}
				}
					...
					if (iLocal_469 >= 150) {
						...
						if (iLocal_424 == 0) {
							ped::set_relationship_between_groups(5, iLocal_759, 1862763509);
							iLocal_424 = 1;
						}
						iLocal_470 = 2;
					}
				...
				if (func_225(Local_295[3 /*9*/])) {
					if (ai::get_script_task_status(Local_295[3 /*9*/], 1630799643) != 1) {
						ai::task_achieve_heading(Local_295[3 /*9*/], 0f, 0);
						iLocal_470 = 0;
						iLocal_436 = 1;
					}
				}
			}
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 1114.719f, -786.1467f, 57.15265f, 1095.79f,
												 -786.2317f, 60.53243f, 9.75f, 0, 1, 0) &&
				(player::get_player_current_stealth_noise(player::player_id()) > 1f ||
				 ped::is_ped_facing_ped(Local_295[3 /*9*/], player::player_ped_id(), 90f))) {
				if (iLocal_424 == 0) {
					ped::set_relationship_between_groups(5, iLocal_759, 1862763509);
					iLocal_424 = 1;
				}
				if (func_225(Local_295[3 /*9*/])) {
					if (!ped::is_ped_facing_ped(Local_295[3 /*9*/], player::player_ped_id(), 30f)) {
						ai::task_turn_ped_to_face_entity(Local_295[3 /*9*/], player::player_ped_id(), 0);
						vLocal_496 = {entity::get_entity_coords(player::player_ped_id(), 1)};
						iLocal_478 = gameplay::get_game_timer();
						iLocal_479 = 1;
					}
				}
			}
			if (iLocal_479 == 1 && gameplay::get_game_timer() > iLocal_478 + 1000 && func_225(Local_295[3 /*9*/])) {
				ai::task_follow_nav_mesh_to_coord(Local_295[3 /*9*/], vLocal_496, 1f, -1, 0.25f, 0, 1193033728);
				iLocal_479 = 2;
			}
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 1078.845f, -796.3937f, 57.01259f, 1091.735f,
												 -796.5964f, 60.38212f, 6f, 0, 1, 0)) {
				if (func_225(Local_295[0 /*9*/])) {
					if (!ped::is_ped_in_combat(Local_295[0 /*9*/], player::player_ped_id())) {
						ai::task_combat_ped(Local_295[0 /*9*/], player::player_ped_id(), 0, 16);
					}
			...
			if (iLocal_424 == 0) {
				if (fire::is_explosion_in_angled_area(-1, 1114.697f, -787.0848f, 56.64847f, 1051.764f, -787.1609f,
													  64.14056f, 23f)) {
					if (func_225(Local_295[0 /*9*/])) {
						if (!ped::is_ped_in_combat(Local_295[0 /*9*/], player::player_ped_id())) {
							ai::task_combat_ped(Local_295[0 /*9*/], player::player_ped_id(), 0, 16);
				...
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 1071.381f, -793.3854f, 57.05151f,
													 1101.543f, -793.3998f, 61.01268f, 11.75f, 0, 1, 0) ||
					entity::is_entity_in_angled_area(player::player_ped_id(), 1095.905f, -786.5956f, 57.1032f, 1114.59f,
													 -786.7163f, 60.15023f, 15.25f, 0, 1, 0) ||
					entity::does_entity_exist(player::get_players_last_vehicle()) &&
						entity::is_entity_in_angled_area(player::get_players_last_vehicle(), 1071.381f, -793.3854f,
														 57.05151f, 1101.543f, -793.3998f, 61.01268f, 11.75f, 0, 1,
														 0) ||
					entity::does_entity_exist(player::get_players_last_vehicle()) &&
						entity::is_entity_in_angled_area(player::get_players_last_vehicle(), 1095.905f, -786.5956f,
														 57.1032f, 1114.59f, -786.7163f, 60.15023f, 15.25f, 0, 1, 0)) {
					ped::set_relationship_between_groups(5, iLocal_759, 1862763509);
					iLocal_424 = 1;
				}
				if (ped::is_ped_in_any_heli(player::player_ped_id()) ||
					ped::is_ped_in_any_plane(player::player_ped_id())) {
					if (entity::is_entity_in_angled_area(player::player_ped_id(), 1051.458f, -794.5156f, 55.68565f,
														 1117.848f, -794.2987f, 77.44183f, 33.75f, 0, 1, 0)) {
						if (func_225(Local_295[0 /*9*/])) {
							if (!ped::is_ped_in_combat(Local_295[0 /*9*/], player::player_ped_id())) {
								ai::task_combat_ped(Local_295[0 /*9*/], player::player_ped_id(), 0, 16);
							}
			...
			if (func_225(Local_295[0 /*9*/])) {
				if (func_241(player::player_ped_id(), Local_295[0 /*9*/], 1) < 12f &&
					player::get_player_current_stealth_noise(player::player_id()) > 20f) {
					if (!ped::is_ped_in_combat(Local_295[0 /*9*/], player::player_ped_id())) {
						ai::task_combat_ped(Local_295[0 /*9*/], player::player_ped_id(), 0, 16);
					}
					ped::set_relationship_between_groups(5, iLocal_759, 1862763509);
			...
			if (iLocal_428 == 0) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 1051.791f, -793.2307f, 57.1418f,
													 1071.548f, -793.1798f, 60.55063f, 11.75f, 0, 1, 0) ||
					entity::is_entity_in_angled_area(player::player_ped_id(), 1064.095f, -784.5695f, 56.83767f,
													 1061.792f, -789.8588f, 60.01268f, 11.75f, 0, 1, 0) ||
					entity::is_entity_in_angled_area(player::player_ped_id(), 1058.49f, -785.6928f, 53.26268f, 1057.05f,
													 -791.674f, 60.01268f, 9.5f, 0, 1, 0)) {
					...
					if (entity::is_entity_in_angled_area(player::player_ped_id(), 1051.507f, -792.2719f, 60.62209f,
														 1070.429f, -792.2669f, 57.01259f, 9.5f, 0, 1, 0)) {
						iLocal_462 += 2;
					...
					if (iLocal_462 > 1000) {
						if (iLocal_428 == 0) {
							if (func_468(Local_295[0 /*9*/])) {
								ai::task_look_at_entity(Local_295[0 /*9*/], player::player_ped_id(), -1, 0, 2);
				...
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 1067.675f, -788.5863f, 53.27134f,
													 1067.798f, -798.8701f, 60.04082f, 8.25f, 0, 1, 0)) {
						...
						if (iLocal_461 > 70) {
							if (iLocal_428 == 0) {
								if (func_468(Local_295[0 /*9*/])) {
									ai::task_look_at_entity(Local_295[0 /*9*/], player::player_ped_id(), -1, 0, 2);
									if (!ped::is_ped_facing_ped(Local_295[0 /*9*/], player::player_ped_id(), 20f)) {
										ai::task_turn_ped_to_face_entity(Local_295[0 /*9*/], player::player_ped_id(),
																		 -1);
									}
									iLocal_464 = gameplay::get_game_timer();
								}
				...
				if (func_468(Local_391) && vehicle::is_vehicle_alarm_activated(Local_391)) {
					if (iLocal_428 == 0) {
						if (func_468(Local_295[0 /*9*/])) {
							ai::task_look_at_entity(Local_295[0 /*9*/], player::player_ped_id(), -1, 0, 2);
							if (!ped::is_ped_facing_ped(Local_295[0 /*9*/], player::player_ped_id(), 20f)) {
				...
				if (entity::is_entity_in_angled_area(player::player_ped_id(), 1084.465f, -800.1337f, 57.39651f,
													 1081.145f, -800.1677f, 59.99038f, 1.5f, 0, 1, 0) &&
			...
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 1087.937f, -793.1239f, 54.7728f, 1100.255f,
												 -793.1273f, 61.01268f, 12.25f, 0, 1, 0) ||
				entity::does_entity_exist(player::get_players_last_vehicle()) &&
					entity::is_entity_in_angled_area(player::get_players_last_vehicle(), 1087.937f, -793.1239f,
													 54.7728f, 1100.255f, -793.1273f, 61.01268f, 12.25f, 0, 1, 0)) {
				if (func_225(Local_295[1 /*9*/])) {
					if (!ped::is_ped_facing_ped(Local_295[1 /*9*/], player::player_ped_id(), 45f)) {
						ped::set_blocking_of_non_temporary_events(Local_295[1 /*9*/], 0);
						ai::task_look_at_entity(Local_295[1 /*9*/], player::player_ped_id(), -1, 0, 2);
						ai::task_turn_ped_to_face_entity(Local_295[1 /*9*/], player::player_ped_id(), -1);
					}
				}
			}
			if (iLocal_428 == 1) {
				...
				if (gameplay::get_game_timer() > iLocal_464 + 3500) {
					if (func_225(Local_295[0 /*9*/])) {
						if (!ped::is_ped_in_combat(Local_295[0 /*9*/], player::player_ped_id())) {
							ai::task_combat_ped(Local_295[0 /*9*/], player::player_ped_id(), 0, 16);
						}
				...
				else if (gameplay::get_game_timer() > iLocal_464 + 1200) {
					if (func_225(Local_295[0 /*9*/])) {
						if (ped::is_ped_facing_ped(Local_295[0 /*9*/], player::player_ped_id(), 50f)) {
							if (ai::get_script_task_status(Local_295[0 /*9*/], 1630799643) != 1 &&
								ai::get_script_task_status(Local_295[0 /*9*/], 1630799643) != 0) {
								if (func_225(Local_295[1 /*9*/])) {
									ai::clear_ped_tasks(Local_295[1 /*9*/]);
									ai::task_look_at_entity(Local_295[1 /*9*/], player::player_ped_id(), -1, 0, 2);
								}
								weapon::give_weapon_to_ped(Local_295[0 /*9*/], joaat("weapon_combatpistol"), -1, 1, 1);
								weapon::give_weapon_component_to_ped(Local_295[0 /*9*/], joaat("weapon_combatpistol"),
																	 joaat("component_at_pi_flsh"));
								ai::task_aim_gun_at_entity(Local_295[0 /*9*/], player::player_ped_id(), 5000, 0);
								audio::_play_ambient_speech_with_voice(Local_295[0 /*9*/], "PAP3B_BDAA",
																	   "Paparazzo3BBodyGuard1", "SPEECH_PARAMS_FORCE",
																	   0);
							}
						}
					}
				...
				if (ped::is_ped_in_combat(Local_295[iVar12 /*9*/], 0)) {
					if (func_225(Local_332)) {
						if (func_468(Local_378[0 /*6*/])) {
							if (ai::get_script_task_status(Local_332, -235832601) != 1 &&
								ai::get_script_task_status(Local_332, -235832601) != 0) {
								ai::task_look_at_entity(Local_332, player::player_ped_id(), -1, 0, 2);
								ai::task_vehicle_follow_waypoint_recording(Local_332, Local_378[0 /*6*/],
																		   "PAP3_Security1", 262144, 0, 8, -1, -1f, 0,
																		   1073741824);
								if (entity::is_entity_playing_anim(Local_332, "amb@world_human_smoking@female@idle_a",
																   "idle_a", 3)) {
									ai::stop_anim_task(Local_332, "amb@world_human_smoking@female@idle_a", "idle_a",
													   -8f);
								}
								if (entity::is_entity_playing_anim(Local_332, "amb@world_human_smoking@female@idle_a",
																   "idle_b", 3)) {
									ai::stop_anim_task(Local_332, "amb@world_human_smoking@female@idle_a", "idle_b",
													   -8f);
								}
								if (entity::is_entity_playing_anim(Local_332, "amb@world_human_smoking@female@idle_a",
																   "idle_c", 3)) {
									ai::stop_anim_task(Local_332, "amb@world_human_smoking@female@idle_a", "idle_c",
													   -8f);
								}
								if (func_225(Local_295[0 /*9*/])) {
									ped::set_ped_seeing_range(Local_295[0 /*9*/], 150f);
								...
								iLocal_409 = 0;
								if (func_225(Local_295[2 /*9*/])) {
									ai::task_combat_ped(Local_295[2 /*9*/], player::player_ped_id(), 67108864, 16);
								}
								if (iLocal_412 == 1) {
									iLocal_275 = 6;
									iLocal_276 = 0;
		...
		if (iLocal_411 == 1) {
			if (iLocal_412 == 0) {
				...
				if (iLocal_433 == 0) {
					if (iLocal_431 == 0) {
						if (gameplay::get_game_timer() > iLocal_457 + 6000) {
						...
						if (iLocal_435 == 0) {
							if (gameplay::get_game_timer() > iLocal_457 + 4800) {
								iLocal_435 = 1;
							}
						}
						if (!func_224(Local_332, player::player_ped_id(), 60f, 1)) {
							Var6 = {func_230()};
							if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER")) {
								func_237();
							}
				...
				if (iLocal_433 == 0) {
					if (iLocal_431 == 1 && gameplay::get_game_timer() > iLocal_457 + 7500) {
						if (entity::is_entity_in_angled_area(player::player_ped_id(), 1071.562f, -787.9003f, 56.7723f,
															 1071.65f, -793.4357f, 59.30243f, 3.25f, 0, 1, 0) &&
							ped::is_ped_in_cover(player::player_ped_id(), 0)) {
							if (func_468(Local_391)) {
								if (iLocal_426 == 0) {
									vehicle::start_vehicle_alarm(Local_391);
									if (iLocal_428 == 0) {
										if (func_468(Local_295[0 /*9*/])) {
											ai::task_look_at_entity(Local_295[0 /*9*/], player::player_ped_id(), -1, 0,
																	2);
											if (!ped::is_ped_facing_ped(Local_295[0 /*9*/], player::player_ped_id(),
																		20f)) {
												ai::task_turn_ped_to_face_entity(Local_295[0 /*9*/],
						...
						if (entity::is_entity_in_angled_area(player::player_ped_id(), 1095.303f, -789.9751f, 62.40207f,
															 1078.776f, -789.9934f, 64.40999f, 1.5f, 0, 1, 0) ||
							entity::is_entity_in_angled_area(player::player_ped_id(), 1078.399f, -785.0526f, 60.16986f,
															 1071.268f, -785.0859f, 62.19881f, 4.25f, 0, 1, 0)) {
							iLocal_463++;
							if (iLocal_463 > 50) {
								if (iLocal_428 == 0) {
									if (func_468(Local_295[0 /*9*/])) {
				...
				if (func_225(Local_295[0 /*9*/]) && ped::is_ped_in_any_vehicle(Local_295[0 /*9*/], 0)) {
					if (entity::is_entity_in_angled_area(Local_295[0 /*9*/], 1158.52f, -759.3739f, 56.32278f, 1116.869f,
														 -759.6908f, 61.70632f, 13.75f, 0, 1, 0)) {
						if (ai::get_script_task_status(Local_295[0 /*9*/], -1273030092) != 1) {
							ai::task_vehicle_mission_ped_target(Local_295[0 /*9*/],
																ped::get_vehicle_ped_is_in(Local_295[0 /*9*/], 0),
				...
				if (func_468(Local_332) && !func_224(player::player_ped_id(), Local_332, 209f, 1)) {
					iLocal_275 = 7;
					iLocal_276 = 0;
				}
			}
			...
			if (iLocal_429 == 1) {
				if (func_301(50)) {
					...
					else if (gameplay::get_game_timer() > iLocal_457 + 4000) {
						if (iLocal_430 == 0) {
							if (iLocal_466 == 0) {
			...
			if (script::_get_number_of_instances_of_script_with_name_hash(joaat("appcamera")) > 0) {
				if (func_284()) {
					...
					iLocal_429 = 1;
					iLocal_432 = 0;
					if (entity::is_entity_on_screen(Local_332)) {
						if (func_282()) {
							if (func_281()) {
								func_244(805);
		...
		if (iLocal_410 == 1) {
			...
			else if (entity::has_entity_been_damaged_by_entity(Local_332, player::player_ped_id(), 1)) {
				func_1(3);
			}
		}
		break;
...
bool func_281() {
	if (ped::is_synchronized_scene_running(iLocal_294)) {
		if (ped::get_synchronized_scene_phase(iLocal_294) >= 0.803f &&
			ped::get_synchronized_scene_phase(iLocal_294) < 0.871f) {
			return true;
		}
	}
	return false;
...
// Position - 0x2AE5C
bool func_282() {
	if (entity::is_entity_in_angled_area(player::player_ped_id(), 1060.736f, -776.3729f, 56.7626f, 1087.983f,
										 -792.0965f, 59.31259f, 8.25f, 0, 1, 0) ||
		entity::is_entity_in_angled_area(player::player_ped_id(), 1051.626f, -768.4251f, 56.18585f, 1104.971f,
										 -768.8157f, 60.03636f, 28.5f, 0, 1, 0) ||
		entity::is_entity_in_angled_area(player::player_ped_id(), 1057.153f, -785.1578f, 59.00606f, 1057.153f,
										 -782.0903f, 60.70669f, 1.95f, 0, 1, 0)) {
		return false;
	}
	if (func_225(Local_332)) {
		if (!func_283(Local_332)) {
			return false;
		}
		if (func_225(Local_341) && entity::is_entity_on_screen(Local_332) && entity::is_entity_on_screen(Local_341) &&
			cam::is_sphere_visible(entity::get_entity_coords(Local_332, 1), 1f)) {
			if (entity::is_entity_in_angled_area(player::player_ped_id(), 1095.334f, -783.0236f, 61.67838f, 1078.834f,
												 -783.1444f, 64.36657f, 15.75f, 0, 1, 0)) {
				if (entity::has_entity_clear_los_to_entity(player::player_ped_id(), Local_332, 126) &&
					entity::has_entity_clear_los_to_entity(player::player_ped_id(), Local_341, 17)) {
					return true;
				}
				else {
					return false;
			...
			else if (entity::has_entity_clear_los_to_entity(player::player_ped_id(), Local_332, 126) &&
					 entity::has_entity_clear_los_to_entity(player::player_ped_id(), Local_341, 17)) {
				if (!func_224(Local_332, player::player_ped_id(), 50f, 1)) {
					iLocal_430 = 1;
					return false;
				}
				else {
...
bool func_285(int iParam0, char *sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	sVar6 = "NULL";
	iVar7 = 3;
	if (func_286(iParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, iParam7, iParam8,
...
// Position - 0x2B116
int func_286(var uParam0, char *sParam1, int iParam2, int iParam3, char *sParam4, char *sParam5, int iParam6,
	...
	if (!Global_14605) {
		if (Global_14443.f_1 == 6) {
			...
			func_287(1);
			func_290(Global_14424, "DISPLAY_VIEW", 1f, system::to_float(Global_14423), -1082130432, -1082130432,
					 -1082130432);
		}
	}
	return 1;
				...
				if (iParam0 == Global_2320[iVar1 /*15*/].f_11) {
					if (iVar0 == Global_2320[iVar1 /*15*/].f_4) {
						if (Global_2882[iVar0] == 0) {
							...
							if (Global_2452520) {
								if (iVar1 == 14) {
									func_288(Global_14424, "SET_DATA_SLOT", system::to_float(1),
					...
					if (iVar0 == Global_2320[iVar1 /*15*/].f_4) {
						if (Global_2882[iVar0] == 0) {
							...
							if (iVar1 == 1) {
								...
								func_288(Global_14424, "SET_DATA_SLOT", system::to_float(1), system::to_float(iVar0),
...
// Position - 0x2BB73
void func_288(int iParam0, char *sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6,
...
// Position - 0x2BC9B
bool func_291() { return Global_1315233; }
...
int func_296() {
	...
	while (iVar2 < iVar1) {
		if (Global_101700.f_13100[iVar2 /*104*/].f_24 == 0 || Global_101700.f_13100[iVar2 /*104*/].f_24 == 1) {
			if (!func_295(Global_101700.f_13100[iVar2 /*104*/].f_18,
...
// Position - 0x2C067
bool func_297() {
	if (gameplay::is_bit_set(Global_2313, 29)) {
		return true;
	}
	return false;
}
...
void func_302() {
	...
	if (func_254(&uLocal_707, vVar0) && vVar0.z < 61f) {
		if (iLocal_423) {
			if (!ped::get_ped_stealth_movement(player::player_ped_id())) {
...
void func_304() {
	if (iLocal_441 == 0) {
		...
		case 2:
			...
			else if (script::_get_number_of_instances_of_script_with_name_hash(joaat("appcamera")) == 0) {
				iLocal_444 = 0;
				iLocal_445 = 0;
				iLocal_442 = 1;
			}
...
void func_307(int iParam0, char *sParam1, int iParam2) {
	audio::_play_ambient_speech1(iParam0, sParam1, func_308(iParam2), 1);
}
...
// Position - 0x2C645
void func_309(int iParam0) { Global_1318071 = iParam0; }
...
void func_311() {
	...
	if (!gameplay::is_string_null_or_empty(&Var0)) {
		if (gameplay::are_strings_equal(&Var0, "PAP3_DEALER") && audio::get_current_scripted_conversation_line() > 0) {
			if (iLocal_475 == 0) {
				if (func_241(player::player_ped_id(), Local_332, 1) > 40f) {
					iLocal_287 = 1;
					iLocal_475 = 1;
					iLocal_476 = 1;
				}
	...
	if (iLocal_476 == 1) {
		...
		if (!gameplay::is_string_null_or_empty(&Var6)) {
			if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_1")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_2", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_2")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_3", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_3")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_4", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_4")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_5", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_5")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_6", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_6")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_7", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_7")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_8", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_8")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_9", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_9")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_10", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_10")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_11", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_11")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_12", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_12")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_13", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_13")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_14", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_14")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_15", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_15")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_16", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_16")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_17", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_17")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_18", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_18")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_19", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_19")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_20", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_20")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_21", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_21")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_22", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_22")) {
				StringCopy(&vLocal_281, "PAP3_DEALER_23", 24);
			}
			else if (gameplay::are_strings_equal(&Var6, "PAP3_DEALER_23")) {
				iLocal_476 = 4;
			}
			func_237();
			iLocal_476 = 2;
		...
		if (!func_222()) {
			if (!gameplay::is_string_null_or_empty(&vLocal_281)) {
				if (func_312(&uLocal_761, "pap3bau", "PAP3_DEALER", &vLocal_281, 8, iLocal_287, 0)) {
					iLocal_476 = 3;
				}
			}
			else {
...
void func_313(int iParam0, char *sParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	...
	if (iVar0 == 1) {
		...
		iVar1 = func_373(script::get_this_script_name(), 1);
		if (iVar1 != -1 && iVar1 != 94) {
...
void func_314(int iParam0, var uParam1, int iParam2, int iParam3) {
	func_315(&Global_96040, script::get_this_script_name(), iParam0, uParam1, iParam3, iParam2);
}

// Position - 0x2CBA4
void func_315(var *uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5) {
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_216();
	...
	if (!ped::is_ped_injured(player::player_ped_id())) {
		...
		func_343(player::player_ped_id());
		func_337(player::player_ped_id(), 0);
	...
	while (iVar1 < 3) {
		...
		if (iVar1 == func_336()) {
			func_332(player::player_ped_id(), &uParam0->f_616[iVar1 /*65*/], 1);
		}
		else {
			iVar0 = 0;
			while (iVar0 < 12) {
		...
		*uParam1 = vehicle::get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11) {
			if (vehicle::is_vehicle_extra_turned_on(iParam0, iVar0 + 1)) {
				gameplay::set_bit(&uParam1->f_77, func_327(iVar0 + 1));
			}
			iVar0++;
		}
...
// Position - 0x2E42E
bool func_329(int iParam0, var *uParam1, int iParam2, int iParam3) {
	char *sVar0;
...
// Position - 0x2E887
void func_334(int iParam0, int iParam1, int *iParam2, int *iParam3, int iParam4, int iParam5) {
	int iVar0;
...
// Position - 0x2EDCF
void func_335(int iParam0, int iParam1, int *iParam2, int *iParam3, var *uParam4, int iParam5, int iParam6) {
	int iVar0;
...
void func_338(int iParam0, var *uParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		while (iVar0 <= 44 - 1) {
			...
			if (iVar3 != 0) {
				vVar4.x = weapon::get_ped_weapontype_in_slot(iParam0, func_342(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		iVar7 = 0;
		while (iVar7 < iVar8) {
			if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_339(Var9.f_1) && iVar70 < 50) {
...
// Position - 0x30823
bool func_345(vector3 vParam0, char *sParam3, vector3 vParam4) {
	int iVar0;
	int iVar1;
...
// Position - 0x30867
bool func_346(int iParam0, var *uParam1, float *fParam2) {
	*uParam1 = {0f, 0f, 0f};
	*fParam2 = 0f;
	switch (iParam0) {
	case 0:
...
// Position - 0x30EF6
bool func_347(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
bool func_348(int *iParam0) {
	if (!entity::is_entity_dead(player::player_ped_id(), 0) && !ped::is_ped_injured(player::player_ped_id())) {
		if (func_358()) {
			*iParam0 = func_353(entity::get_entity_coords(player::player_ped_id(), 0), 6, -1, 0, 1, -1);
			if (func_352(*iParam0) && !func_349(*iParam0)) {
				return true;
			}
		}
	}
...
// Position - 0x30F98
int func_349(int iParam0) { return func_350(iParam0, 0, 1); }
...
int func_350(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_10() == 0) {
			return gameplay::is_bit_set(func_72(func_351(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0x312CF
int func_352(int iParam0) { return func_350(iParam0, 5, 1); }

// Position - 0x312DF
int func_353(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	float fVar1;
	float fVar2;
	int iVar3;
	...
	while (iVar0 <= 45) {
		if (iParam3 == 6 || iParam3 == func_357(iVar0)) {
			if (!iParam5 || func_356(iVar0)) {
				fVar1 = gameplay::get_distance_between_coords(vParam0, func_354(iVar0, 0), 1);
...
Vector3 func_354(int iParam0, int iParam1) {
	...
	case 45: return func_355(Global_93004);
	}
...
// Position - 0x319B1
int func_356(int iParam0) { return func_350(iParam0, 0, 0); }
...
// Position - 0x31C34
bool func_358() { return Global_91543.f_303 > 0; }

// Position - 0x31C45
var func_359() {
	int *iVar0;

	func_369(&iVar0, time::get_clock_seconds());
	func_368(&iVar0, time::get_clock_minutes());
	func_367(&iVar0, time::get_clock_hours());
	func_362(&iVar0, time::get_clock_day_of_month());
	func_361(&iVar0, time::get_clock_month());
	func_360(&iVar0, time::get_clock_year());
	return iVar0;
}
...
var func_364(int iParam0) {
	return (system::shift_right(iParam0, 26) & 31) * func_365(gameplay::is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
// Position - 0x31E73
int func_366(var uParam0) { return uParam0 & 15; }
...
int func_371(int iParam0) {
	switch (iParam0) {
	case 69:
	case 70: return func_372(Global_101700.f_8044.f_99.f_205[10]);

	case 74:
	case 75: return func_372(Global_101700.f_8044.f_99.f_205[8]);

	case 84:
	case 85: return func_372(Global_101700.f_8044.f_99.f_205[11]);

	case 90: return func_372(Global_101700.f_8044.f_99.f_205[7]);

	case 93: return func_372(Global_101700.f_8044.f_99.f_205[9]);
	}
	return 0;
}
...
void func_379() {
	...
	if (iLocal_410) {
		...
		while (iVar6 <= 3) {
			if (func_225(Local_295[iVar6 /*9*/])) {
				...
				else if (func_224(Local_295[iVar6 /*9*/], player::player_ped_id(), 5f, 1)) {
					ai::task_combat_ped(Local_295[iVar6 /*9*/], player::player_ped_id(), 0, 16);
				}
			}
			else {
				func_1(2);
	...
	if (func_225(Local_369)) {
		if (!ped::is_ped_headtracking_ped(Local_369, player::player_ped_id())) {
			ai::task_look_at_entity(Local_369, player::player_ped_id(), -1, 0, 2);
		}
	}
	switch (iLocal_276) {
	case 0:
		if (!func_380()) {
			if (ui::does_blip_exist(iLocal_288)) {
				ui::set_blip_route(iLocal_288, 0);
			}
			else {
				iLocal_288 = func_243(Local_369, 1, 1, 5);
		...
		func_221(&uLocal_761, 8, Local_369, "Paparazzo3BDealerGoon1", 0, 1);
		iLocal_276 = 1;
		break;
	...
	case 1:
		...
		if (iLocal_410 == 1) {
			...
			if (entity::is_entity_at_coord(player::player_ped_id(), vLocal_490, 5f, 5f, 2f, 0, 1, 0) &&
				func_225(Local_369)) {
				if (!ped::is_ped_ragdoll(player::player_ped_id())) {
					func_221(&uLocal_761, 8, Local_369, "Paparazzo3BDealerGoon1", 0, 1);
					func_221(&uLocal_761, 1, player::player_ped_id(), "FRANKLIN", 0, 1);
					if (func_240(&uLocal_761, "pap3bau", "PAP3_CONTACT", 8, 0, 0, 0)) {
						...
						ai::task_turn_ped_to_face_entity(Local_369, player::player_ped_id(), -1);
						func_235(&iLocal_288);
						iLocal_276 = 2;
					}
				}
			}
			if (entity::is_entity_at_coord(player::player_ped_id(), vLocal_490, 15f, 15f, 2f, 0, 1, 0) &&
				func_225(Local_369) && ai::get_script_task_status(Local_369, 993674639) == 1) {
				ai::clear_ped_tasks(Local_369);
				ai::task_look_at_entity(Local_369, player::player_ped_id(), -1, 0, 2);
			}
		}
		break;
	...
	case 2:
		...
		if (!func_222() || func_241(player::player_ped_id(), Local_369, 1) > 5f * 2f ||
			entity::is_entity_in_angled_area(player::player_ped_id(), 1071.164f, -783.0585f, 53.73021f, 1062.915f,
											 -782.8473f, 59.3433f, 3f, 0, 1, 0)) {
			func_237();
			if (func_225(Local_369) && !ped::is_ped_fleeing(Local_369)) {
				if (ai::get_script_task_status(Local_369, -1146898486) != 1) {
					ped::set_ped_can_be_targetted(Local_369, 1);
					ped::set_blocking_of_non_temporary_events(Local_369, 0);
					ai::task_wander_standard(Local_369, 1193033728, 0);
				}
			}
			func_2(4);
		}
			...
			Var0 = {func_248()};
			if (gameplay::are_strings_equal(&Var0, "PAP3_CONTACT_4") ||
				gameplay::are_strings_equal(&Var0, "PAP3_CONTACT_5")) {
				iLocal_477++;
				if (iLocal_477 > 30) {
					if (func_225(Local_369)) {
						if (ai::get_script_task_status(Local_369, -1146898486) != 1) {
							ped::set_ped_can_be_targetted(Local_369, 1);
							ped::set_blocking_of_non_temporary_events(Local_369, 0);
							ai::task_wander_standard(Local_369, 281.0714f, 0);
						}
					}
				}
			}
...
// Position - 0x327F7
bool func_380() {
	if (func_225(Local_332) && func_224(Local_332, player::player_ped_id(), 55f, 1) &&
		entity::is_entity_on_screen(Local_332) &&
		cam::is_sphere_visible(
			entity::get_world_position_of_entity_bone(Local_332, ped::get_ped_bone_index(Local_332, 31086)), 0.1f) &&
		!entity::is_entity_occluded(Local_332) &&
		!entity::is_entity_in_angled_area(player::player_ped_id(), 1114.024f, -758.6504f, 54.94576f, 1054.396f,
										  -758.6326f, 64.53705f, 47.5f, 0, 1, 0) &&
		!entity::is_entity_in_angled_area(player::player_ped_id(), 1046.05f, -754.8271f, 56.04185f, 1144.92f,
										  -755.2141f, 59.98388f, 20.75f, 0, 1, 0)) {
		return true;
	}
	if (entity::is_entity_in_angled_area(player::player_ped_id(), 1051.438f, -791.6494f, 56.68583f, 1114.935f,
										 -791.4409f, 66.16802f, 15.5f, 0, 1, 0)) {
		return true;
	}
	return false;
}
...
void func_381() {
	...
	if (iLocal_410) {
		...
		while (iVar0 <= 3) {
			if (func_225(Local_295[iVar0 /*9*/])) {
				...
				else if (func_224(Local_295[iVar0 /*9*/], player::player_ped_id(), 5f, 1)) {
					ai::task_combat_ped(Local_295[iVar0 /*9*/], player::player_ped_id(), 0, 16);
				}
			}
			else {
				func_1(2);
	...
	case 0:
		if (!ui::does_blip_exist(iLocal_288)) {
			iLocal_288 = func_243(Local_369, 1, 1, 5);
			ui::set_blip_route(iLocal_288, 1);
		}
		func_207("PAP3_CON", 7500, 1);
		iLocal_276 = 1;
		break;
	...
	case 1:
		...
		if (iLocal_410 == 1) {
			...
			if (entity::is_entity_at_coord(player::player_ped_id(), vLocal_490, 20f, 20f, 2f, 0, 1, 0)) {
				if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
...
// Position - 0x32A4F
void func_382() {
	if (func_228(Local_397)) {
		entity::freeze_entity_position(Local_397, 0);
	}
	if (func_228(Local_391)) {
		entity::freeze_entity_position(Local_391, 0);
	}
...
void func_383() {
	...
	case 1:
		...
		if (!iLocal_415) {
			...
			if (audio::get_current_scripted_conversation_line() > 6 && !ui::does_blip_exist(iLocal_288) &&
				func_225(Local_369)) {
				iLocal_288 = func_243(Local_369, 1, 1, 5);
				if (ui::does_blip_exist(iLocal_288)) {
					ui::set_blip_route(iLocal_288, 1);
...
// Position - 0x32D0F
bool func_384(var *uParam0, int iParam1, char *sParam2, char *sParam3, int iParam4, int iParam5, int iParam6,
			  int iParam7) {
	...
	Global_15799 = 0;
	Global_2621441 = 0;
	return func_210(sParam3, iParam4, iParam7);
}
...
void func_385() {
	...
	if (func_467(0)) {
		iLocal_289 =
			ped::add_scenario_blocking_area(1051.859f, -799.0458f, 53f, 1114.582f, -779.1284f, 60f, 0, 1, 1, 1);
		iLocal_290 =
			ped::add_scenario_blocking_area(Vector(56.7705f, -761.915f, 1090.248f) - Vector(5f, 5f, 5f),
											Vector(56.7705f, -761.915f, 1090.248f) + Vector(5f, 5f, 5f), 0, 1, 1, 1);
		if (func_504()) {
			iVar1 = func_466();
			if (Global_86001 == 1) {
				iVar1++;
			...
			case 0:
				...
				func_276();
				ped::clear_relationship_between_groups(5, iLocal_759, 1862763509);
				func_401(&iVar0, 1027.591f, -550.1744f, 59.2083f, 175.1857f, 1, 0, 0, 1, 1, joaat("asterope"), 0, 145,
						 1);
				func_399(iVar0, -1, 1);
				func_398();
				iLocal_276 = 2;
			...
			case 1:
				gameplay::clear_area_of_objects(1077.067f, -797.3167f, 57.3309f, 150f, 2);
				...
				func_276();
				ped::clear_relationship_between_groups(5, iLocal_759, 1862763509);
				func_401(&iVar0, 1077.736f, -765.1624f, 56.6271f, 271.4277f, 0, 0, 0, 1, 1, joaat("buffalo"), 0, 145,
						 1);
				iLocal_276 = 2;
				iLocal_275 = 3;
				func_399(0, -1, 1);
				func_234(&Local_369);
				func_398();
				gameplay::clear_area(1075.642f, -793.8809f, 57.3145f, 40f, 1, 0, 0, 0);
				weapon::set_current_ped_weapon(player::player_ped_id(), joaat("weapon_unarmed"), 1);
				func_397();
				func_387(1, 1, 1);
				break;
...
// Position - 0x33491
void func_401(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8,
	...
	if (iVar0 == 1) {
		...
		*iParam0 = func_441(vParam1, fParam4);
	}
	else if (iParam9 == 1) {
		if (func_347(vParam1, 0f, 0f, 0f, 0)) {
			vParam1 = {Global_96040.f_2311};
			fParam4 = Global_96040.f_2311.f_6;
		}
		gameplay::clear_area(vParam1, 5f, 1, 0, 0, 0);
		func_435(vParam1, 5f, 0);
		if (func_153(iParam12)) {
			func_434(iParam12, 0);
			while (!func_402(iParam0, iParam12, vParam1, fParam4, 1, 0)) {
				system::wait(0);
			}
		}
		else {
...
// Position - 0x33624
int func_402(int *iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7) {
	int iVar0;
	var *uVar1;
	struct<97> Var5;
	int iVar103;
		...
		if (Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/] == Var5) {
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/],
				...
				func_429(iParam0, &Global_101700.f_2095.f_539.f_1635[0 /*295*/][iParam1 /*98*/].f_31,
			...
			if (streaming::has_model_loaded(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/])) {
				*iParam0 = vehicle::create_vehicle(Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/],
				...
				func_429(iParam0, &Global_101700.f_2095.f_539.f_1635[1 /*295*/][iParam1 /*98*/].f_31,
...
void func_403(int iParam0, var *uParam1, int iParam2, int iParam3) {
	...
	if (func_153(iParam0) && entity::does_entity_exist(*uParam1) && vehicle::is_vehicle_driveable(*uParam1, 0)) {
		...
		if (vehicle::get_vehicle_mod_kit(*uParam1) >= 0 && vehicle::get_vehicle_mod_kit(*uParam1) < 255 &&
			func_407(*uParam1, 0, &iVar0)) {
			func_328(uParam1, &Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_31,
			...
			if (iParam3) {
				...
				Global_101700.f_19077[iParam0 /*43*/].f_31 = func_406(*uParam1);
				...
				func_404(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_5,
				...
				func_404(Global_101700.f_2095.f_539.f_1635[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0,
...
// Position - 0x35088
int func_404(int iParam0, int iParam1, int iParam2, int iParam3, int *iParam4) {
	int iVar0;
	int iVar1;
	char *sVar2;
	int iVar6;
...
// Position - 0x350FB
bool func_405(int iParam0, char *sParam1, int *iParam2, int *iParam3, int *iParam4) {
	*iParam2 = -1;
	*iParam3 = -1;
	*iParam4 = -1;
	switch (iParam0) {
...
int func_407(int iParam0, int iParam1, int *iParam2) {
	...
	*iParam2 = 0;
	...
	iVar0 = entity::get_entity_model(iParam0);
	if (!func_409(iVar0, iParam1, iParam2)) {
		return 0;
	}
	...
	if (!network::network_is_game_in_progress()) {
		if (func_408(iParam0) && entity::get_entity_model(iParam0) != joaat("sentinel2") &&
...
int func_412(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_330(iParam0, 0, 0) ||
		func_330(iParam0, 1, 0) || func_330(iParam0, 2, 0) || func_322(iParam0) != 145 || func_425(iParam0) ||
		func_424(iParam0) || func_408(iParam0) || func_423(iParam0) || !func_413(entity::get_entity_model(iParam0))) {
		if (func_424(iParam0)) {
		}
		if (func_424(iParam0)) {
		}
...
// Position - 0x38079
int func_418() { return 0; }

// Position - 0x38082
int func_419() { return 1; }

// Position - 0x3808B
int func_420() { return 1; }
...
// Position - 0x383C0
bool func_428(int iParam0) { return vehicle::is_vehicle_extra_turned_on(iParam0, 5); }
...
int func_429(int iParam0, var *uParam1, var *uParam2) {
	...
	if (func_432(entity::get_entity_model(*iParam0), 1) &&
		vehicle::get_vehicle_mod(*iParam0, 24) != func_431(*iParam0, (*uParam1)[38] - 1)) {
		vehicle::set_vehicle_mod(*iParam0, 24, func_431(*iParam0, (*uParam1)[38] - 1), 0);
	}
	if (func_430(*iParam0)) {
	...
	while (iVar0 < 9) {
		if (entity::does_entity_exist(Global_89155[iVar0])) {
			if (iParam0 == 145 || Global_89165[iVar0] == iParam0) {
				if (iParam1 == 0 || entity::get_entity_model(Global_89155[iVar0]) == func_324(iParam0, iParam1)) {
...
// Position - 0x3A411
int func_441(vector3 vParam0, float fParam3) { return func_442(&Global_96040.f_2311, vParam0, fParam3, 0); }

// Position - 0x3A42B
int func_442(var *uParam0, vector3 vParam1, float fParam4, int iParam5) {
	int iVar0;
	vector3 vVar1;
	bool bVar4;
	var uVar5;
	...
	if (func_452(uParam0)) {
		...
		if (func_451(uParam0)) {
			...
			if (entity::does_entity_exist(iVar0)) {
				...
				else if (!func_444(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10 &&
...
// Position - 0x3A7A0
int func_444(int iParam0, vector3 vParam1, bool bParam4) {
	int iVar0;
	var uVar1[3];
	int iVar5;
	int iVar6;
	...
	case joaat("cuban800"):
		...
		while (iVar6 <= iVar5 - 1) {
			if (func_446(iParam0, uVar1[iVar6], 1) &&
				func_445(entity::get_entity_coords(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)) {
				if (!bParam4 || func_347(vParam1, 0f, 0f, 0f, 0) ||
...
// Position - 0x3A9A8
int func_445(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
void func_447(int iParam0, var *uParam1, int iParam2, int iParam3) {
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		if (uParam1->f_66 == joaat("sovereign")) {
			...
			iVar0 = 1;
			if (gameplay::is_bit_set(uParam1->f_77, func_327(iVar0 + 1))) {
			}
			else {
				gameplay::set_bit(&uParam1->f_77, func_327(iVar0 + 1));
			}
			...
			iVar1 = 1;
			if (gameplay::is_bit_set(uParam1->f_77, func_327(iVar1 + 1))) {
			}
			else {
				gameplay::set_bit(&uParam1->f_77, func_327(iVar1 + 1));
			}
		}
		...
		if (!vehicle::is_this_model_a_heli(uParam1->f_66) && !vehicle::is_this_model_a_boat(uParam1->f_66)) {
			iVar2 = 0;
			while (iVar2 <= 11) {
				if (gameplay::is_bit_set(uParam1->f_77, func_327(iVar2 + 1))) {
...
// Position - 0x3B08C
int func_453() { return func_451(&Global_96040.f_2311); }

// Position - 0x3B09F
void func_454() { func_455(&Global_96040.f_2311); }
...
// Position - 0x3B22C
int func_459() { return func_452(&Global_96040.f_2311); }
...
void func_460(int iParam0, int iParam1) {
	...
	func_461(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, iParam1, 1, 1, 1);
}

// Position - 0x3B272
void func_461(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8,
	...
	if (player::is_player_playing(iVar0)) {
		...
		if (iParam6 == 1) {
			gameplay::clear_area_of_peds(func_462(player::get_player_index()), 50f, 0);
		}
		if (iParam7 == 1) {
...
// Position - 0x3B430
Vector3 func_462(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }
...
// Position - 0x3B4DE
void func_465(vector3 vParam0, float fParam3, int iParam4, int iParam5) {
	if (func_504()) {
...
bool func_467(int iParam0) {
	...
	else if (ui::has_additional_text_loaded(0) && ui::has_additional_text_loaded(6)) {
		return true;
	}
	return false;
}
...
void func_469() {
	...
	case 0:
		...
		case 1: sVar0 = "PAP3_08"; break;

		case 2: sVar0 = "PAP3_ALERT"; break;

		case 3: sVar0 = "PAP3_INJUR2"; break;

		case 4: sVar0 = "PAP3_KILL1"; break;

		case 6: sVar0 = "PAP3_KILL3"; break;

		case 5: sVar0 = "PAP3_THREAT"; break;
		}
		if (iLocal_489 == 0) {
			func_519(1);
		}
...
void func_475() {
	...
	if (iLocal_424 || iLocal_433) {
		if (!iLocal_449) {
			if (func_468(Local_341)) {
				ped::set_blocking_of_non_temporary_events(Local_341, 0);
			}
			iVar0 = 0;
			while (iVar0 < 2) {
				if (func_468(Local_350[iVar0 /*9*/])) {
...
struct<2> func_478(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_486(iParam0)}; break;
	...
	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_485(iParam2)}; break;

		case 8: Var0 = {func_484(iParam2)}; break;

		case 7: Var0 = {func_483(iParam2)}; break;

		case 10: Var0 = {func_482(iParam2)}; break;

		case 5: Var0 = {func_481(iParam2)}; break;

		case 4: Var0 = {func_480(iParam2)}; break;

		default: StringCopy(&Var0, func_479(iVar2), 8); break;
		}
		break;
...
//Position - 0x3C11C
bool func_487(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (!func_489(0) || Global_69971 || Global_69960 == 1 || !cam::is_screen_faded_in()) {
		return false;
	}
	switch (Global_69956) {
	case 0:
	...
	case 5:
		if (cutscene::is_cutscene_playing() || func_300(0) || func_488(1)) {
		}
		else {
			return true;
		}
...
// Position - 0x3C280
bool func_490(int iParam0) { return func_491(iParam0, Global_35781); }
...
void func_492(int iParam0) {
	if (iParam0 == 1) {
		gameplay::set_bit(&Global_2315, 4);
	}
	else {
		gameplay::clear_bit(&Global_2315, 4);
	}
}
...
void func_495() {
	...
	ui::request_additional_text("PAP3BAU", 6);
...
void func_496(var *uParam0, var *uParam1, float fParam2) {
	...
	while (iVar1 < uParam1->f_46) {
		...
		if (func_254(uParam1, (*uParam1)[iVar1 /*3*/] + vVar9)) {
			vVar9 = {-vVar9};
		}
...
// Position - 0x3C9AD
void func_498(var *uParam0, vector3 vParam1) {
	if (uParam0->f_51 == 0) {
	}
	if (uParam0->f_46 >= 15) {
	}
...
void func_505(int iParam0) {
	...
	if (func_518()) {
		func_204(iParam0);
		ped::remove_scenario_blocking_area(iLocal_289, 0);
		ped::remove_scenario_blocking_area(iLocal_290, 0);
...
// Position - 0x3CFDA
void func_507(var *uParam0, bool bParam1) { func_508(&uParam0->f_41, bParam1); }
...
// Position - 0x3D459
bool func_521(char *sParam0, int iParam1, int iParam2) {
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_524()) {
		if (func_523()) {
			...
			iVar33 = func_370(script::get_this_script_name());
			if (iVar33 > -1) {
...
// Position - 0x3D759
void func_528() { Global_17151.f_5 = 1; }

// Position - 0x3D767
void func_529() { Global_17151.f_5 = 0; }
