...
var uLocal_895 = 0;
var uLocal_896 = 0;
vector3 vLocal_897[9] = {{0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f}, {0f, 0f, 0f},
...
void __EntryFunction__() {
	...
	if (player::has_force_cleanup_occurred(19)) {
		...
		if (func_558(player::player_ped_id())) {
			...
			func_552(player::player_ped_id(), 0);
		}
		else {
			func_551(0);
		}
	...
	func_495(181.3f, -969.1f, 30.3f, 200f, &vVar0, &vVar3);
	func_494(iLocal_876);
	if (func_493(0)) {
	...
	while (true) {
		...
		func_434();
		switch (iLocal_160) {
		case -1: func_429(&iLocal_162); break;

		case 0: func_406(&iLocal_162); break;

		case 1: func_376(&iLocal_162); break;

		case 2: func_365(&iLocal_162); break;

		case 3: func_337(&iLocal_162); break;

		case 4: func_336(&iLocal_162); break;

		case 5: func_75(&iLocal_162); break;

		case 7: func_64(&iLocal_162); break;

		case 6: func_10(&iLocal_162); break;
		}
...
void func_1() {
	...
	iVar0 = func_8(player::player_ped_id(), vLocal_170, 1) < fLocal_173 + 10f;
	if (iLocal_181) {
		...
		if (gameplay::get_game_timer() > iLocal_182 && iLocal_559 == 0) {
			func_2("B1_FAIL");
		}
	}
	else {
...
bool func_13(int iParam0) {
	...
	if (cutscene::_0xB56BBBCC2955D9CB()) {
		if (func_558(player::player_ped_id())) {
			cutscene::_0x2A56C06EBEF2B0D9("Michael", player::player_ped_id(),
	...
	case 1:
		if (iParam0 == 0) {
			...
			ai::task_perform_sequence(player::player_ped_id(), iVar4);
			ai::clear_sequence_task(&iVar4);
		}
		iVar5 = cam::create_cam_with_params("DEFAULT_SCRIPTED_CAMERA", cam::get_gameplay_cam_coord(),
	...
	case 2:
		iVar3 = 0;
		if (iParam0 == 1) {
			if (func_34(&uLocal_390, "BARY1AU", "BARY1_PREOUT", 8, 0, 0, 0) ||
				gameplay::get_game_timer() > iLocal_158) {
		...
		else if (func_17(&uLocal_390, "BARY1AU", "BARY1_PREOUT", "BARY1_PREOUT_2", 8, 0, 0) ||
				 gameplay::get_game_timer() > iLocal_158) {
	...
	case 3:
		if (iParam0 == 1) {
			iVar3 = gameplay::get_game_timer() > iLocal_158;
		}
		else {
			if (gameplay::get_game_timer() < iLocal_158) {
			}
	...
	case 5:
		if (gameplay::get_game_timer() > iLocal_158) {
			if (iParam0 == 1) {
				...
				gameplay::clear_area_of_vehicles(vLocal_174, 200f, 0, 0, 0, 0, 0);
...
int func_15(int iParam0, int iParam1) {
	...
	iVar0 =
		object::create_object_no_offset(weapon::get_weapontype_model(iParam0),
										ped::get_ped_bone_coords(player::player_ped_id(), iVar1, 0f, 0f, 0f), 1, 1, 0);
	if (!entity::does_entity_exist(iVar0)) {
		return 0;
	}
	entity::attach_entity_to_entity(iVar0, player::player_ped_id(),
									ped::get_ped_bone_index(player::player_ped_id(), iVar1), 0f, 0f, 0f, 0f, 0f, 0f, 0,
									0, 0, 0, 2, 1);
	return iVar0;
}
...
// Position - 0xD80
int func_18(char *sParam0, int iParam1, int iParam2) {
	Global_15746 = 0;
...
void func_25() {
	...
	if (entity::does_entity_exist(player::player_ped_id())) {
		if (func_28(Global_101700.f_2095.f_539.f_3549) != entity::get_entity_model(player::player_ped_id())) {
			...
			if (func_26(iVar0) && (!func_29(14) || Global_100652)) {
...
// Position - 0x1389
bool func_26(int iParam0) { return iParam0 < 3; }
	...
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_43(player::player_id()) &&
				!func_40(player::player_id(), 0) && !func_39()) {
...
// Position - 0x179C
bool func_39() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x1845
var func_42() { return Global_1312735; }
...
// Position - 0x1893
int func_44() { return gameplay::is_bit_set(Global_2359301, 3); }
...
// Position - 0x19C1
void func_49(vector3 vParam0, float fParam3) { func_50(&Global_96040.f_2311, vParam0, fParam3); }
...
void func_51(vector3 vParam0, float fParam3) {
	if (func_52(Global_69942, 0f, 0f, 0f, 0)) {
...
void func_55(int *iParam0, int iParam1) {
	...
	func_57(iParam0);
	func_56(&iParam0->f_2, iParam1, 0, 1);
	*iParam0 = 0;
}
...
void func_59(int *iParam0) {
	if (*iParam0 != 0) {
		if (graphics::does_particle_fx_looped_exist(*iParam0)) {
			...
			graphics::remove_particle_fx(*iParam0, 0);
		}
		*iParam0 = 0;
	}
}
...
// Position - 0x1C05
bool func_61(var *uParam0) { return uParam0->f_1 == 10 || uParam0->f_1 == 11; }
...
void func_62() {
	...
	while (iVar0 < Local_586) {
		if (func_4(&Local_586[iVar0 /*33*/])) {
			...
			ai::task_smart_flee_coord(Local_586[iVar0 /*33*/].f_2,
...
void func_64(int *iParam0) {
	...
	case 2:
		if (ai::get_script_task_status(player::player_ped_id(), 242628503) == 7) {
			...
			graphics::start_particle_fx_non_looped_at_coord(
				"scr_alien_teleport", entity::get_entity_coords(player::player_ped_id(), 1),
				entity::get_entity_rotation(player::player_ped_id(), 2), fLocal_573, 0, 0, 0);
	...
	case 4:
		fLocal_208 -= gameplay::get_frame_time() * 512f;
		if (fLocal_208 <= 0f) {
			fLocal_208 = 0f;
...
int func_69(var *uParam0, float fParam1) {
	...
	if (!uParam0->f_15) {
		if (cam::does_cam_exist(uParam0->f_11)) {
			...
			if (!entity::is_entity_dead(iVar11, 0)) {
				fVar2 = gameplay::get_distance_between_coords(entity::get_entity_coords(iVar11, 1),
															  cam::get_cam_coord(uParam0->f_11), 1);
			}
			else {
				fVar2 = gameplay::get_distance_between_coords(entity::get_entity_coords(iVar11, 0),
															  cam::get_cam_coord(uParam0->f_11), 1);
			}
		...
		if (cam::does_cam_exist(uParam0->f_9)) {
			...
			if (!Global_17151.f_111) {
				...
				if (Global_17151.f_109 == -1) {
					Global_17151.f_109 = audio::get_sound_id();
					Global_17151.f_110 = gameplay::get_hash_key(script::get_this_script_name());
				}
				audio::play_sound(Global_17151.f_109, "CHARACTER_CHANGE_SKY_MASTER", 0, 0, 0, 1);
	...
	if (uParam0->f_17) {
		...
		uParam0->f_24 = 0;
		uParam0->f_27 = 0;
		if (Global_17151.f_109 != -1 && Global_17151.f_110 == gameplay::get_hash_key(script::get_this_script_name())) {
			audio::stop_sound(Global_17151.f_109);
			audio::release_sound_id(Global_17151.f_109);
...
// Position - 0x26BB
void func_70(int iParam0) { Global_17149 = iParam0; }
...
// Position - 0x2712
var func_73() { return Global_2359301.f_2; }
...
void func_75(int *iParam0) {
	...
	case 0:
		func_36("bar_2_rcm", 0);
		func_334(vLocal_174, 1112014848, 12, 5000, 0, 0);
	...
	case 1:
		if (func_326(1, 1093140480, 0) && script::has_script_loaded("postRC_Barry1and2")) {
			iLocal_356 = 0;
			if (func_12(player::player_ped_id())) {
				ped::reset_ped_visible_damage(player::player_ped_id());
				ped::clear_ped_blood_damage(player::player_ped_id());
			...
			func_325();
			gameplay::clear_area_of_vehicles(vLocal_174, 250f, 0, 0, 0, 0, 0);
			gameplay::clear_area_of_peds(vLocal_174, 50f, 0);
			gameplay::clear_area_of_objects(vLocal_174, 30f, 0);
			graphics::remove_decals_in_range(vLocal_174, 500f);
			player::clear_player_wanted_level(player::player_id());
			func_277();
			cutscene::register_entity_for_cutscene(0, sLocal_328, 2, func_561(49), 0);
			...
			if (!func_558(Local_96.f_28[0])) {
				if (entity::does_entity_exist(cutscene::get_entity_index_of_registered_entity(sLocal_328, 0))) {
					Local_96.f_28[0] = entity::get_ped_index_from_entity_index(
						cutscene::get_entity_index_of_registered_entity(sLocal_328, 0));
			...
			if (!func_558(Local_96.f_41[0])) {
				if (entity::does_entity_exist(cutscene::get_entity_index_of_registered_entity(sLocal_330, 0))) {
					Local_96.f_41[0] = entity::get_object_index_from_entity_index(
						cutscene::get_entity_index_of_registered_entity(sLocal_330, 0));
				}
			}
			if (!func_558(Local_96.f_41[1])) {
				if (entity::does_entity_exist(cutscene::get_entity_index_of_registered_entity(sLocal_329, 0))) {
					Local_96.f_41[1] = entity::get_object_index_from_entity_index(
						cutscene::get_entity_index_of_registered_entity(sLocal_329, 0));
				}
			}
...
void func_77(int iParam0, int iParam1) {
	...
	if (Global_100787[iVar0 /*10*/].f_9 == -1) {
		...
		func_237(&Global_100787[iVar0 /*10*/].f_9);
	}
	if (iParam1) {
		if (player::is_player_playing(player::player_id())) {
...
void func_80() {
	...
	if (fVar8 > 0f && system::floor(fVar8) < system::floor(Global_101700.f_9153.f_3853)) {
		func_82(13, system::floor(Global_101700.f_9153.f_3853));
	}
...
// Position - 0x329F
int func_81() { return Global_25190; }
...
// Position - 0x3832
void func_93() { func_94(&Global_96040); }
...
// Position - 0x3F80
void func_100(int *iParam0) { *iParam0 = -15; }

// Position - 0x3F8E
void func_101() {
	StringCopy(&Global_93627, "", 32);
	func_94(&Global_93635);
}
...
int func_104(int iParam0, int iParam1, int iParam2) {
	...
	Global_69523[1 /*14*/] = {func_155(iVar0, iParam1, iParam2)};
	...
	if (iParam1 == 12) {
		...
		Global_69523[1 /*14*/] = {func_155(iVar0, iParam1, uVar31[iParam1])};
		if (ped::get_number_of_ped_drawable_variations(iParam0, func_147(iParam1)) > 0 &&
			ped::get_number_of_ped_texture_variations(iParam0, func_147(iParam1), Global_69523[1 /*14*/].f_3) > 0) {
			ped::set_ped_component_variation(iParam0, func_147(iParam1), Global_69523[1 /*14*/].f_3,
...
bool func_105(int iParam0, int iParam1, int *iParam2) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_63 != -99) {
		if (!func_219(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_64,
...
// Position - 0x4369
int func_107(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	if (iParam5 == 0) {
		Global_69523[1 /*14*/] = {func_155(iVar10, iParam1, iParam2)};
		if (!func_145(iParam3)) {
			Global_69522--;
			return 0;
		}
	...
	if (iParam1 == 12) {
		...
		while (iVar0 <= 14) {
			if (uVar11[iVar0] != -99) {
				Global_69523[1 /*14*/] = {func_155(iVar10, iVar0, uVar11[iVar0])};
				if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0)) {
					if (iVar0 == 13) {
						uVar28 = 9;
						if (iParam5 == 1) {
						...
						iVar1 = 0;
						while (iVar1 <= 8) {
							Global_69523[1 /*14*/] = {func_155(iVar10, 14, uVar28[iVar1])};
							func_123(iParam0, Global_69523[1 /*14*/].f_12, Global_69523[1 /*14*/].f_3,
						...
						if (iParam4 == -1) {
							ped::set_ped_component_variation(iParam0, func_147(iVar0), Global_69523[1 /*14*/].f_3,
															 Global_69523[1 /*14*/].f_4,
															 ped::get_ped_palette_variation(iParam0, func_147(iVar0)));
						}
						else {
							ped::set_ped_component_variation(iParam0, func_147(iVar0), Global_69523[1 /*14*/].f_3,
				...
				Global_69523[1 /*14*/] = {func_155(iVar10, iVar0, func_113(iParam0, iVar0, -1))};
		...
		iVar1 = 0;
		while (iVar1 <= 8) {
			Global_69523[1 /*14*/] = {func_155(iVar10, 14, uVar69[iVar1])};
			func_123(iParam0, Global_69523[1 /*14*/].f_12, Global_69523[1 /*14*/].f_3, Global_69523[1 /*14*/].f_4);
			func_138(14);
			if (Global_69522 == 1) {
				iVar2 = 0;
				while (iVar2 < 15) {
		...
		if (iParam4 == -1) {
			ped::set_ped_component_variation(iParam0, func_147(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4,
											 ped::get_ped_palette_variation(iParam0, func_147(iParam1)));
		}
		else {
			ped::set_ped_component_variation(iParam0, func_147(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4, iParam4);
...
bool func_110(int iParam0, int iParam1, int iParam2) {
	Global_69523[1 /*14*/] = {func_155(iParam0, iParam1, iParam2)};
	return gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 2);
}

// Position - 0x4D07
bool func_111(int iParam0, int iParam1, int iParam2, int iParam3, var *uParam4, var *uParam5) {
	var uVar0;
	int iVar10;
...
// Position - 0x574C
var func_115(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == -1) {
		...
		if (iParam1 == 0) {
			...
			if (func_124(entity::get_entity_model(iParam0), 14, iVar0,
		...
		if (iVar4 != iParam1) {
			...
			while (iVar5 <= iVar6 - 1) {
				if (iVar4 == iParam1 && iVar5 == iParam2) {
					iVar3 += func_129(iParam0, iParam3);
					return iVar3;
				}
				else {
					iVar3++;
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_125(iParam0, iParam2, 14, 3), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_125(iParam0, iParam2, 1, 3), -1842686353, 0);
			}
			break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_125(iParam0, iParam2, 14, 4), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_125(iParam0, iParam2, 1, 4), -1842686353, 0);
			}
			break;
		}
		break;
...
void func_138(int iParam0) {
	if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 1) && !gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 6)) {
		func_144(iParam0, Global_69523[1 /*14*/].f_5, Global_69523[1 /*14*/].f_2, 2, Global_69523[1 /*14*/].f_1, 1, 0);
	}
	if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 1) && gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 6)) {
		if (iParam0 == 12) {
...
void func_139(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_143(iParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3)) {
...
void func_140(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	iVar0 = Global_2503826[iParam0 /*3*/][func_141(iParam2)];
	if (iVar0 != 0) {
...
int func_142(int iParam0, int iParam1, int iParam2) {
	...
	iVar0 = Global_2503826[iParam0 /*3*/][func_141(iParam1)];
...
// Position - 0x8653
bool func_143(int iParam0, int iParam1, int *iParam2, int *iParam3, bool bParam4, bool bParam5) {
	int iVar0;
...
// Position - 0x9842
bool func_144(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	if (iParam0 == 0) {
		if (iParam5 == 1) {
...
bool func_146(int iParam0, int iParam1, int *iParam2, int iParam3) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_60 != -99) {
		if (!func_219(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_61,
...
struct<10> func_148(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		switch (iParam1) {
		case 31: func_150(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 0: func_150(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_150(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_150(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_150(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_150(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8); break;

		case 5: func_150(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8); break;

		case 6: func_150(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_150(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_150(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_150(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8); break;

		default: func_149(&Var1, iParam0, iParam1, 10); break;
		}
		break;
	...
	case joaat("player_one"):
		...
		case 1: func_150(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8); break;

		case 2: func_150(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8); break;

		case 3: func_150(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_150(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_150(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_150(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_150(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_150(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_149(&Var1, iParam0, iParam1, 9); break;
		}
		break;
	...
	case joaat("player_two"):
		...
		case 0: func_150(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_150(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_150(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_150(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8); break;

		case 4: func_150(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8); break;

		case 5: func_150(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_150(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_150(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_150(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8); break;
	...
	case joaat("mp_m_freemode_01"):
		...
		case 0: func_150(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_150(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_150(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_150(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_150(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_150(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_150(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_150(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_150(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_150(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_150(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_150(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_150(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_150(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 14: func_150(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_150(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_150(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_150(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_150(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_150(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_150(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_150(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_150(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_150(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 24: func_150(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_149(&Var1, iParam0, iParam1, 25); break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 0: func_150(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_150(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_150(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_150(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_150(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_150(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_150(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_150(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_150(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_150(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_150(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_150(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_150(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_150(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8); break;

		case 14: func_150(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_150(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_150(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_150(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_150(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_150(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_150(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_150(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_150(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_150(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8); break;
...
struct<17> func_151(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		...
		case 1: func_154(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0); break;

		case 2: func_154(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8); break;

		case 3: func_154(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31); break;

		case 4: func_154(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2); break;

		case 5:
			func_154(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[0], Global_101700.f_2095.f_539.f_200[0], 6, 3, 0,
					 0, 0, -99, 0, 0, 3);
			break;

		case 6: func_154(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_154(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 8: func_154(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 9: func_154(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 10: func_154(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4); break;

		case 11: func_154(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5); break;

		case 12: func_154(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31); break;

		case 13: func_154(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 14: func_154(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6); break;

		case 15: func_154(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31); break;

		case 16: func_154(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31); break;

		case 17: func_154(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 18: func_154(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7); break;

		case 19: func_154(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 20: func_154(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 21: func_154(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_154(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 23: func_154(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31); break;

		case 24: func_154(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31); break;

		case 25: func_154(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 26: func_154(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 27: func_154(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 28: func_154(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 29: func_154(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 30: func_154(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 31: func_154(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31); break;

		case 32: func_154(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 33: func_154(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 34: func_154(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31); break;

		case 35: func_154(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 36: func_154(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 37: func_154(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 38: func_154(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 39: func_154(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 40: func_154(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 41: func_154(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_154(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_154(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_154(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 45: func_154(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 46: func_154(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_154(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 48: func_154(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31); break;

		case 49: func_154(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 50: func_154(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9); break;

		case 51: func_154(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 52: func_154(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		default: func_152(&Var1, iParam0, iParam1, 53); break;
		}
		break;

	case joaat("player_one"):
		switch (iParam1) {
		case 0: func_154(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 1: func_154(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 2:
			func_154(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[1], Global_101700.f_2095.f_539.f_200[1], 17, 2,
					 26, 0, 0, -99, 0, 45, 31);
			break;

		case 3: func_154(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1); break;

		case 4: func_154(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2); break;

		case 5: func_154(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 6: func_154(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_154(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3); break;

		case 8: func_154(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5); break;

		case 9: func_154(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 10: func_154(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 11: func_154(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 12: func_154(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 13: func_154(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 14: func_154(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 15: func_154(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 16: func_154(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 17: func_154(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 18: func_154(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31); break;

		case 19: func_154(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 20: func_154(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 21: func_154(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4); break;

		case 22: func_154(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31); break;

		case 23: func_154(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31); break;

		case 24: func_154(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31); break;

		case 25: func_154(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31); break;

		case 26: func_154(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31); break;

		case 27: func_154(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31); break;

		case 28: func_154(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31); break;

		case 29: func_154(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31); break;

		case 30: func_154(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31); break;

		case 31: func_154(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31); break;

		case 32: func_154(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31); break;

		case 33: func_154(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31); break;

		case 34: func_154(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31); break;

		case 35: func_154(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31); break;

		case 36: func_154(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31); break;

		case 37: func_154(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31); break;

		case 38: func_154(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 39: func_154(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 40: func_154(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 41: func_154(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 42: func_154(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31); break;

		case 43: func_154(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6); break;

		case 44: func_154(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 45: func_154(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8); break;

		case 46: func_154(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31); break;

		default: func_152(&Var1, iParam0, iParam1, 47); break;
		}
		break;

	case joaat("player_two"):
		switch (iParam1) {
		case 0: func_154(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 1: func_154(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8); break;

		case 2: func_154(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1); break;

		case 3: func_154(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2); break;

		case 4:
			func_154(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[2], Global_101700.f_2095.f_539.f_200[2], 8, 0, 0,
					 0, 0, -99, 0, 0, 31);
			break;

		case 5: func_154(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6); break;

		case 6: func_154(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3); break;

		case 7: func_154(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4); break;

		case 8: func_154(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31); break;

		case 9: func_154(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 10: func_154(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 11: func_154(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5); break;

		case 12: func_154(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 13: func_154(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31); break;

		case 14: func_154(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31); break;

		case 15: func_154(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 16: func_154(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 17: func_154(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 18: func_154(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 19: func_154(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 20: func_154(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 21: func_154(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_154(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 23: func_154(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 24: func_154(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 25: func_154(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 26: func_154(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 27: func_154(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 28: func_154(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 29: func_154(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 30: func_154(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 31: func_154(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 32: func_154(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 33: func_154(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 34: func_154(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 35: func_154(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 36: func_154(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 37: func_154(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 38: func_154(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 39: func_154(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 40: func_154(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 41: func_154(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_154(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_154(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_154(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31); break;

		case 45: func_154(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 46: func_154(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_154(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31); break;

		default: func_152(&Var1, iParam0, iParam1, 48); break;
		}
		break;

	case joaat("mp_m_freemode_01"):
		switch (iParam1) {
		case 0: func_154(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31); break;

		case 1: func_154(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0); break;

		case 2: func_154(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1); break;

		case 3: func_154(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2); break;

		case 4: func_154(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3); break;

		case 5: func_154(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4); break;

		case 6: func_154(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5); break;

		case 7: func_154(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6); break;

		case 8: func_154(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7); break;

		case 9: func_154(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8); break;

		case 10: func_154(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9); break;

		case 11: func_154(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10); break;

		case 12: func_154(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11); break;

		case 13: func_154(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12); break;

		case 14: func_154(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13); break;

		case 15: func_154(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14); break;

		case 16: func_154(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15); break;

		case 17: func_154(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16); break;

		case 18: func_154(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17); break;

		case 19: func_154(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18); break;

		case 20: func_154(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19); break;

		case 21: func_154(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20); break;

		case 22: func_154(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21); break;

		case 23: func_154(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22); break;

		case 24: func_154(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23); break;

		case 25: func_154(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24); break;

		default: func_152(&Var1, iParam0, iParam1, 26); break;
		}
		break;

	case joaat("mp_f_freemode_01"):
		switch (iParam1) {
		case 0: func_154(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31); break;

		case 1: func_154(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31); break;

		case 2: func_154(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0); break;

		case 3: func_154(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1); break;

		case 4: func_154(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2); break;

		case 5: func_154(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3); break;

		case 6: func_154(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4); break;

		case 7: func_154(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5); break;

		case 8: func_154(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6); break;

		case 9: func_154(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7); break;

		case 10: func_154(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8); break;

		case 11: func_154(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9); break;

		case 12: func_154(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10); break;

		case 13: func_154(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31); break;

		case 14: func_154(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11); break;

		case 15: func_154(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12); break;

		case 16: func_154(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13); break;

		case 17: func_154(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14); break;

		case 18: func_154(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15); break;

		case 19: func_154(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16); break;

		case 20: func_154(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17); break;

		case 21: func_154(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31); break;

		case 22: func_154(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18); break;

		case 23: func_154(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19); break;

		case 24: func_154(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20); break;

		case 25: func_154(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21); break;

		case 26: func_154(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22); break;

		case 27: func_154(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23); break;

		default: func_152(&Var1, iParam0, iParam1, 28); break;
		}
		break;
	}
	return Var1;
...
// Position - 0xD47C
void func_154(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) {
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
void func_156(int iParam0, int iParam1)
{
	...
	case 2: func_179(iParam1); break;

	case 3: func_176(iParam1); break;

	case 4: func_175(iParam1); break;

	case 6: func_174(iParam1); break;

	case 5: func_173(iParam1); break;

	case 8: func_172(iParam1); break;

	case 9: func_171(iParam1); break;

	case 10: func_170(iParam1); break;

	case 1: func_169(iParam1); break;

	case 7: func_168(iParam1); break;

	case 11: func_167(iParam1); break;

	case 12: func_166(iParam1); break;

	case 13: func_165(iParam1); break;

	case 14: func_157(iParam1); break;
	}
}
...
void func_157(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 155); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

// Position - 0xE8A5
void func_158(var *uParam0, int iParam1, int iParam2, char *sParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	*uParam0 = iParam9;
	...
	if (iParam10) {
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 ||
			...
			iVar0 = func_142(func_161(iParam1, uParam0->f_2), Global_69521, 0);
			if (gameplay::is_bit_set(iVar0, uParam0->f_1)) {
				gameplay::set_bit(&uParam0->f_6, 1);
			}
			iVar0 = func_142(func_160(iParam1, uParam0->f_2), Global_69521, 0);
			if (gameplay::is_bit_set(iVar0, uParam0->f_1)) {
				gameplay::set_bit(&uParam0->f_6, 2);
			}
			if (func_159(iParam1, uParam0->f_2, &iVar1)) {
				iVar0 = func_142(iVar1, Global_69521, 0);
				if (!gameplay::is_bit_set(iVar0, uParam0->f_1)) {
					gameplay::set_bit(&uParam0->f_6, 4);
				}
			}
...
void func_164(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 == 12) {
		...
		while (iVar17 < iVar19) {
			...
			if (!dlc1::_is_dlc_data_empty(Var2)) {
				if (iVar18 == iParam1 - iParam2) {
					...
					Global_2621445 = Var2;
					func_158(&Global_69523[0 /*14*/], iParam0, iParam1, &Var2.f_7, 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
		...
		func_158(&Global_69523[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14) {
		...
		while (iVar38 < iVar40) {
			...
			if (!dlc1::_is_dlc_data_empty(Var20)) {
				if (iVar39 == iParam1 - iParam2) {
					...
					func_158(&Global_69523[0 /*14*/], iParam0, iParam1, &Var20.f_9, Var20.f_3, Var20.f_4, Var20.f_5,
		...
		iVar59 = 0;
		iVar60 = dlc1::_get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_147(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60) {
			...
			if (!dlc1::_is_dlc_data_empty(Var41)) {
				if (iVar59 == iParam1 - iParam2) {
					...
					func_158(&Global_69523[0 /*14*/], iParam0, iParam1, &Var41.f_9, Var41.f_3, Var41.f_4, Var41.f_5,
...
void func_165(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 9); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_166(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 48); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_167(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 1); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_169(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 6); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_170(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 33); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_171(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 17); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_172(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 18); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_173(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 7); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_174(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 84); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_175(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 104); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_181(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_199(iParam1); break;

	case 2: func_198(iParam1); break;

	case 3: func_194(iParam1); break;

	case 4: func_193(iParam1); break;

	case 6: func_192(iParam1); break;

	case 5: func_191(iParam1); break;

	case 8: func_190(iParam1); break;

	case 9: func_189(iParam1); break;

	case 10: func_188(iParam1); break;

	case 1: func_187(iParam1); break;

	case 7: func_186(iParam1); break;

	case 11: func_185(iParam1); break;

	case 12: func_184(iParam1); break;

	case 13: func_183(iParam1); break;

	case 14: func_182(iParam1); break;
	}
}
...
void func_182(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 175); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_184(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 47); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_185(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 63); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_187(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 5); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_188(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 53); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_189(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 12); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_190(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 77); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_192(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 134); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_193(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 117); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_198(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 21); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_199(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 10); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_200(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_217(iParam1); break;

	case 2: func_216(iParam1); break;

	case 3: func_213(iParam1); break;

	case 4: func_212(iParam1); break;

	case 6: func_211(iParam1); break;

	case 5: func_210(iParam1); break;

	case 8: func_209(iParam1); break;

	case 9: func_208(iParam1); break;

	case 10: func_207(iParam1); break;

	case 1: func_206(iParam1); break;

	case 7: func_205(iParam1); break;

	case 11: func_204(iParam1); break;

	case 12: func_203(iParam1); break;

	case 13: func_202(iParam1); break;

	case 14: func_201(iParam1); break;
	}
}
...
void func_201(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 113); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_204(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 45); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_208(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 20); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_209(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 24); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_210(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 14); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_211(int iParam0) {
	...
	default: func_164(iVar10, iParam0, 99); return;
	}
	func_158(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
bool func_219(int iParam0, int iParam1, int iParam2) {
					...
					if (iVar2 == 13) {
						...
						while (iVar3 <= 8) {
							if (!func_219(iParam0, 14, uVar22[iVar3])) {
								iVar4 = 0;
								while (iVar4 <= 19) {
									Global_69523[2 /*14*/] = {func_155(iVar0, 14, iVar4)};
									if (Global_69523[2 /*14*/].f_12 == iVar3) {
										if (func_219(iParam0, 14, iVar4)) {
											if (!func_111(iVar0, iParam2, 14, iVar4, &uVar5, &Global_69523[2 /*14*/])) {
												return false;
											}
										}
									}
						...
						Global_69523[2 /*14*/] = {func_155(iVar0, iVar2, iVar1)};
						if (!func_111(iVar0, iParam2, iVar2, iVar1, &uVar5, &Global_69523[2 /*14*/])) {
							return false;
						}
					}
				}
	...
	else if (Global_69523[1 /*14*/].f_3 == ped::get_ped_drawable_variation(iParam0, func_147(iParam1)) &&
			 Global_69523[1 /*14*/].f_4 == ped::get_ped_texture_variation(iParam0, func_147(iParam1))) {
		return true;
	}
	return false;
}
...
void func_226(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 != -1) {
		...
		func_227(&sVar32, Var0.f_3, Global_91528, iParam1, iParam2);
	}
}
...
void func_228(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_229(uParam1, "Abigail1", func_222(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				 "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_230(iParam0), 1, 0);
		break;

	case 1:
		func_229(uParam1, "Abigail2", func_222(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				 -1, 4, 1, 0, 2359, func_230(iParam0), 1, 0);
		break;

	case 2:
		func_229(uParam1, "Barry1", func_222(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				 4, 1, 0, 2359, func_230(iParam0), 1, 0);
		break;

	case 3:
		func_229(uParam1, "Barry2", func_222(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				 4, 4, 0, 2359, func_230(iParam0), 1, 1);
		break;

	case 4:
		func_229(uParam1, "Barry3", func_222(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2,
				 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 5:
		func_229(uParam1, "Barry3A", func_222(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0,
				 "", 166, 0, 7, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 6:
		func_229(uParam1, "Barry3C", func_222(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				 7, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 7:
		func_229(uParam1, "Barry4", func_222(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0,
				 "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_230(iParam0), 0, 0);
		break;

	case 8:
		func_229(uParam1, "Dreyfuss1", func_222(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				 0, "", 0, 0, -1, 4, 2, 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 9:
		func_229(uParam1, "Epsilon1", func_222(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1,
				 10, 4, 1, 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 10:
		func_229(uParam1, "Epsilon2", func_222(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0,
				 11, 4, 1, 0, 2359, func_230(iParam0), 1, 0);
		break;

	case 11:
		func_229(uParam1, "Epsilon3", func_222(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				 0, 0, 12, 4, 1, 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 12:
		func_229(uParam1, "Epsilon4", func_222(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				 "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 13:
		func_229(uParam1, "Epsilon5", func_222(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16,
				 "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_230(iParam0), 1, 0);
		break;

	case 14:
		func_229(uParam1, "Epsilon6", func_222(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				 15, 4, 1, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 15:
		func_229(uParam1, "Epsilon7", func_222(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16,
				 "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 16:
		func_229(uParam1, "Epsilon8", func_222(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				 "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_230(iParam0), 1, 0);
		break;

	case 17:
		func_229(uParam1, "Extreme1", func_222(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1,
				 18, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 18:
		func_229(uParam1, "Extreme2", func_222(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171,
				 0, 19, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 19:
		func_229(uParam1, "Extreme3", func_222(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				 4, 2, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 20:
		func_229(uParam1, "Extreme4", func_222(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 21:
		func_229(uParam1, "Fanatic1", func_222(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0,
				 1, -1, 4, 1, 700, 2000, func_230(iParam0), 1, 0);
		break;

	case 22:
		func_229(uParam1, "Fanatic2", func_222(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				 -1, 4, 4, 700, 2000, func_230(iParam0), 1, 0);
		break;

	case 23:
		func_229(uParam1, "Fanatic3", func_222(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1,
				 4, 2, 700, 2000, func_230(iParam0), 0, 1);
		break;

	case 24:
		func_229(uParam1, "Hao1", func_222(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				 "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_230(iParam0), 0, 1);
		break;

	case 25:
		func_229(uParam1, "Hunting1", func_222(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				 26, 4, 4, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 26:
		func_229(uParam1, "Hunting2", func_222(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				 -1, 4, 4, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 27:
		func_229(uParam1, "Josh1", func_222(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				 0, 1, 28, 4, 4, 0, 2359, func_230(iParam0), 1, 0);
		break;

	case 28:
		func_229(uParam1, "Josh2", func_222(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0,
				 29, 4, 4, 0, 2359, func_230(iParam0), 1, 1);
		break;

	case 29:
		func_229(uParam1, "Josh3", func_222(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0,
				 30, 4, 4, 0, 2359, func_230(iParam0), 1, 1);
		break;

	case 30:
		func_229(uParam1, "Josh4", func_222(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				 4, 4, 0, 2359, func_230(iParam0), 1, 0);
		break;

	case 31:
		func_229(uParam1, "Maude1", func_222(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0,
				 "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 32:
		func_229(uParam1, "Minute1", func_222(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				 4, 4, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 33:
		func_229(uParam1, "Minute2", func_222(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 34:
		func_229(uParam1, "Minute3", func_222(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				 -1, 4, 4, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 35:
		func_229(uParam1, "MrsPhilips1", func_222(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				 "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 36:
		func_229(uParam1, "MrsPhilips2", func_222(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				 2359, func_230(iParam0), 0, 0);
		break;

	case 37:
		func_229(uParam1, "Nigel1", func_222(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				 -1, 1, 4, 0, 2359, func_230(iParam0), 1, 0);
		break;

	case 38:
		func_229(uParam1, "Nigel1A", func_222(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0,
				 "", 0, 0, 42, 4, 4, 0, 2359, func_230(iParam0), 1, 1);
		break;

	case 39:
		func_229(uParam1, "Nigel1B", func_222(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_230(iParam0), 1, 1);
		break;

	case 40:
		func_229(uParam1, "Nigel1C", func_222(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_230(iParam0), 1, 1);
		break;

	case 41:
		func_229(uParam1, "Nigel1D", func_222(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				 42, 4, 4, 700, 2000, func_230(iParam0), 1, 1);
		break;

	case 42:
		func_229(uParam1, "Nigel2", func_222(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0,
				 43, 4, 4, 0, 2359, func_230(iParam0), 1, 1);
		break;

	case 43:
		func_229(uParam1, "Nigel3", func_222(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				 "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_230(iParam0), 1, 1);
		break;

	case 44:
		func_229(uParam1, "Omega1", func_222(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				 "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 45:
		func_229(uParam1, "Omega2", func_222(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 46:
		func_229(uParam1, "Paparazzo1", func_222(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				 47, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 47:
		func_229(uParam1, "Paparazzo2", func_222(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0,
				 0, 48, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 48:
		func_229(uParam1, "Paparazzo3", func_222(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				 1, -1, 2, 2, 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 49:
		func_229(uParam1, "Paparazzo3A", func_222(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102,
				 0, "", 0, 0, 51, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 50:
		func_229(uParam1, "Paparazzo3B", func_222(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "",
				 0, 0, 51, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 51:
		func_229(uParam1, "Paparazzo4", func_222(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				 -1, 4, 2, 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 52:
		func_229(uParam1, "Rampage1", func_222(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				 4, 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 54:
		func_229(uParam1, "Rampage3", func_222(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				 4, 4, 0, 2359, func_230(iParam0), 1, 0);
		break;

	case 55:
		func_229(uParam1, "Rampage4", func_222(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				 4, 0, 2359, func_230(iParam0), 1, 0);
		break;

	case 56:
		func_229(uParam1, "Rampage5", func_222(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				 53, 4, 4, 0, 2359, func_230(iParam0), 0, 0);
		break;

	case 53:
		func_229(uParam1, "Rampage2", func_222(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				 "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_230(iParam0), 1, 0);
		break;

	case 57:
		func_229(uParam1, "TheLastOne", func_222(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "",
				 0, 1, -1, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 58:
		func_229(uParam1, "Tonya1", func_222(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				 "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 59:
		func_229(uParam1, "Tonya2", func_222(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				 "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
		break;

	case 60:
		func_229(uParam1, "Tonya3", func_222(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0,
				 2359, func_230(iParam0), 0, 1);
		break;

	case 61:
		func_229(uParam1, "Tonya4", func_222(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				 func_230(iParam0), 0, 1);
		break;

	case 62:
		func_229(uParam1, "Tonya5", func_222(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				 -1, 4, 2, 0, 2359, func_230(iParam0), 0, 1);
		break;
...
// Position - 0x22803
void func_229(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
// Position - 0x22BDA
void func_231(int iParam0) { Global_36332 = gameplay::get_game_timer() + iParam0; }

// Position - 0x22BEC
void func_232() {
	if (Global_89136) {
		func_25();
		graphics::_0xBF59707B3E5ED531(func_233(Global_101700.f_2095.f_539.f_3549));
	}
	else {
...
void func_238(int iParam0, int iParam1) {
	...
	func_256(iParam0, G_TextMessageConfig);
	if (!iParam1) {
...
void func_240(int iParam0) {
	func_242(iParam0, 1);
	Global_101700.f_17533[iParam0 /*6*/].f_3 = func_241();
	Global_101700.f_17533.f_380++;
}

// Position - 0x23239
int func_241() { return Global_101700.f_8975.f_21 + Global_101700.f_17533.f_380; }
...
void func_244(int iParam0) {
	switch (iParam0) {
	case 30: func_248(22, 1, 0, 1, 0); break;

	case 15: func_245(37, 0); break;
...
void func_248(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	if (iParam0 != 198) {
		...
		func_251(iParam0, iParam3, iParam4, 0);
...
// Position - 0x23809
bool func_251(int iParam0, bool bParam1, int iParam2, int iParam3) {
	bool bVar0;
	int iVar1;
	int iVar2;
	struct<5> Var3;
...
// Position - 0x2414A
int func_253() { return Global_25191; }
...
void func_256(int iParam0, bool bParam1) {
	switch (iParam0) {
	case 46: func_257(4, bParam1); break;

	case 16: func_257(6, bParam1); break;

	case 37: func_257(17, bParam1); break;

	case 31: func_257(16, bParam1); break;
	}
}
...
// Position - 0x279F4
void func_258(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8) {
	func_259(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

// Position - 0x27A14
void func_259(char *sParam0, char *sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6,
...
// Position - 0x2800C
int func_267() { return func_268(script::get_this_script_name(), 0); }
...
// Position - 0x2816C
void func_273(var *uParam0, int iParam1, vector3 vParam2, float fParam5) {
	func_14(uParam0);
...
// Position - 0x28193
void func_274(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8,
...
// Position - 0x28351
Vector3 func_275(int iParam0) { return entity::get_entity_coords(player::get_player_ped(iParam0), 0); }
...
void func_277() {
	...
	if (entity::does_entity_exist(func_324()) && !func_52(vLocal_925, vLocal_166, 0)) {
		gameplay::clear_area(vLocal_925, 3f, 1, 0, 0, 0);
		if (func_558(func_324())) {
			entity::set_entity_coords(func_324(), vLocal_925, 1, 0, 0, 1);
			entity::set_entity_heading(func_324(), fLocal_928);
			vehicle::set_vehicle_on_ground_properly(func_324(), 1084227584);
		}
		if (func_321(func_323(), 1)) {
			func_278(func_324(), vLocal_925, fLocal_928, 24, 0);
		}
	}
	iLocal_929 = 1;
}
...
void func_279(int iParam0, int iParam1, int iParam2) {
	...
	if (!func_310(&Global_68531.f_555[0 /*21*/], iParam0)) {
		return;
	}
	...
	if (entity::does_entity_exist(iParam1)) {
		if (vehicle::is_vehicle_driveable(iParam1, 0)) {
			...
			if (iParam0 == 24) {
				Global_101700.f_31389.f_4801 = func_299();
			}
...
int func_281(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_296(iParam0, 0, 0) ||
		func_296(iParam0, 1, 0) || func_296(iParam0, 2, 0) || func_316(iParam0) != 145 || func_295(iParam0) ||
		func_294(iParam0) || func_293(iParam0) || func_292(iParam0) || !func_282(entity::get_entity_model(iParam0))) {
		if (func_294(iParam0)) {
		}
		if (func_294(iParam0)) {
		}
...
// Position - 0x29ABD
int func_287() { return 0; }

// Position - 0x29AC6
int func_288() { return 1; }

// Position - 0x29ACF
int func_289() { return 1; }
...
var func_299() {
	...
	func_309(&iVar0, time::get_clock_seconds());
	func_308(&iVar0, time::get_clock_minutes());
	func_307(&iVar0, time::get_clock_hours());
	func_302(&iVar0, time::get_clock_day_of_month());
	func_301(&iVar0, time::get_clock_month());
	func_300(&iVar0, time::get_clock_year());
	return iVar0;
}
...
// Position - 0x2A123
int func_306(var uParam0) { return uParam0 & 15; }
...
bool func_310(var *uParam0, int iParam1) {
	...
	*uParam0 = {0f, 0f, 0f};
	...
	if (gameplay::is_bit_set(uParam0->f_9, 10)) {
		...
		if (!func_52(Global_101700.f_31389.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0)) {
	...
	if (gameplay::is_bit_set(uParam0->f_9, 19)) {
		if (!func_52(Global_101700.f_2095.f_539.f_2816[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)) {
		...
		if (!func_52(Global_101700.f_2095.f_539.f_2816[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)) {
...
void func_313(int iParam0, var *uParam1, vector3 vParam2, var uParam5, int iParam6) {
	if (func_310(&Global_68531.f_555[0 /*21*/], iParam0)) {
		if (gameplay::is_bit_set(Global_68531.f_555[0 /*21*/].f_9, 10)) {
			func_315(iParam0);
			func_314(uParam1, &Global_101700.f_31389.f_69[Global_68531.f_555[0 /*21*/].f_14 /*78*/]);
...
// Position - 0x2C27C
bool func_321(vector3 vParam0, int iParam3) { return func_322(Global_93635.f_2311.f_12.f_66, vParam0, iParam3); }

// Position - 0x2C299
int func_322(int iParam0, vector3 vParam1, int iParam4) {
	vector3 vVar0;
	vector3 vVar3;
...
// Position - 0x2C303
Vector3 func_323() { return 2.55f, 5.665f, 2.55f; }

// Position - 0x2C31A
int func_324() { return Global_93635.f_4; }
...
// Position - 0x2C39A
bool func_326(int iParam0, float fParam1, int iParam2) {
	int iVar0;
	...
	if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
		if (!ped::is_ped_in_any_heli(player::player_ped_id()) && !ped::is_ped_in_any_boat(player::player_ped_id()) &&
			...
			if (!func_332(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), fParam1, 1, 1056964608, 0, 1, 0)) {
				iVar0 = 0;
			}
			else if (iParam2 == 1) {
				iVar0 = 0;
				if (!func_331(player::player_ped_id(), -828834893)) {
...
// Position - 0x2C547
bool func_332(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6) {
...
// Position - 0x2C6F7
void func_334(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	int iVar1;
...
// Position - 0x2C766
void func_335() { Global_17151.f_6 = 1; }
...
// Position - 0x2CA17
bool func_343(char *sParam0, int iParam1, char *sParam2) {
...
void func_344() {
	...
	if (gameplay::get_game_timer() > iLocal_582) {
		if (func_360(&iVar1)) {
			if (func_356(&vVar2, 0.4f)) {
				func_352(&Local_586[iVar1 /*33*/], vVar2, 0, 0);
				Local_586[iVar1 /*33*/].f_32 = 1;
				Local_586[iVar1 /*33*/].f_14 = 150f;
				iLocal_582 = gameplay::get_game_timer() + gameplay::get_random_int_in_range(iLocal_583, iLocal_584);
				func_351(&Local_586[iVar1 /*33*/]);
			}
			else if (func_345(&vVar2)) {
				func_352(&Local_586[iVar1 /*33*/], vVar2, 0, 0);
				iLocal_582 = gameplay::get_game_timer() + gameplay::get_random_int_in_range(iLocal_583, iLocal_584);
			}
		}
...
bool func_345(var *uParam0) {
	...
	if (bLocal_575) {
		*uParam0 = {func_349(vLocal_576, fLocal_579, 6f)};
	}
	else {
		*uParam0 = {object::_get_object_offset_from_coords(
			entity::get_entity_coords(player::player_ped_id(), 1), gameplay::get_random_float_in_range(0f, 360f), 0f,
			gameplay::get_random_float_in_range(fLocal_580, fLocal_581), 6f)};
	}
...
int func_346(var *uParam0, int iParam1) {
	...
	if (func_348(player::player_ped_id(), vVar0, fVar3)) {
		return 0;
	}
...
// Position - 0x2CC95
bool func_348(int iParam0, vector3 vParam1, float fParam4) {
	return system::vdist2(entity::get_entity_coords(iParam0, 1), vParam1) <= fParam4 * fParam4;
}

// Position - 0x2CCB2
Vector3 func_349(vector3 vParam0, float fParam3, float fParam4) {
	vector3 vVar0;
	float fVar3;

	vVar0 = {gameplay::get_random_float_in_range(-1f, 1f), gameplay::get_random_float_in_range(-1f, 1f), 0f};
	fVar3 = fParam4 / 2f;
	vVar0 = {func_350(vVar0, gameplay::get_random_float_in_range(0f, fParam3))};
	vVar0.z = gameplay::get_random_float_in_range(-fVar3, fVar3);
	return vParam0 + vVar0;
}

// Position - 0x2CCFA
Vector3 func_350(vector3 vParam0, float fParam3) {
	float fVar0;
...
void func_351(var *uParam0) {
	if (!ped::is_ped_injured(uParam0->f_2)) {
		entity::set_entity_health(uParam0->f_2, iLocal_567 / 4);
...
// Position - 0x2CD64
bool func_352(var *uParam0, vector3 vParam1, int iParam4, int iParam5) {
	if (iParam5) {
		if (!func_346(&vParam1, 0)) {
			return false;
		}
	}
	uParam0->f_2 = ped::create_ped(26, iLocal_357, vParam1, 0f, 1, 1);
	...
	entity::set_entity_health(uParam0->f_2, iLocal_567);
	uParam0->f_4 = object::create_object_no_offset(
		iLocal_358, entity::get_offset_from_entity_in_world_coords(uParam0->f_2, 0f, -5f, 0f), 1, 1, 0);
	...
	uParam0->f_5 = object::create_object_no_offset(
		iLocal_358, entity::get_offset_from_entity_in_world_coords(uParam0->f_2, 0f, -5f, 0f), 1, 1, 0);
	...
	uParam0->f_6 = object::create_object_no_offset(
		iLocal_358, entity::get_offset_from_entity_in_world_coords(uParam0->f_2, 0f, 5f, 0f), 1, 1, 0);
	...
	*uParam0 = 1;
	...
	uParam0->f_10 = func_353(uParam0->f_2, player::player_ped_id(), 1);
...
void func_354(int iParam0) {
	...
	fVar0 = func_355(entity::get_entity_coords(iParam0, 1), entity::get_entity_coords(player::player_ped_id(), 1), 1);
	...
	while (iVar0 < 9) {
		if (iVar1 < vVar2.x) {
			if (!ped::is_any_ped_near_point(vLocal_897[iVar0 /*3*/], 1.5f)) {
				func_358(&vVar2, iVar1, vLocal_897[iVar0 /*3*/]);
				iVar1++;
			}
		}
		else {
...
// Position - 0x2D199
void func_358(int iParam0, int iParam1, vector3 vParam2) { (*iParam0)[iParam1 /*3*/] = {vParam2}; }
...
float func_369(var *uParam0) {
	if (func_372(uParam0)) {
		if (func_371(uParam0)) {
			...
			return func_370(gameplay::is_bit_set(*uParam0, 4)) - uParam0->f_1;
		}
	}
	return uParam0->f_1;
}
...
// Position - 0x2D52E
bool func_371(var *uParam0) { return gameplay::is_bit_set(*uParam0, 2); }

// Position - 0x2D53E
bool func_372(var *uParam0) { return gameplay::is_bit_set(*uParam0, 1); }
...
// Position - 0x2D566
void func_374(var *uParam0) { func_375(uParam0, 0f); }

// Position - 0x2D575
void func_375(int *iParam0, float fParam1) {
	uParam0->f_1 = func_370(gameplay::is_bit_set(*uParam0, 4)) - fParam1;
...
void func_376(int *iParam0) {
	...
	case 1:
		...
		func_276(500, 0);
		func_7("PRIME2", 7500, 1);
		func_380(player::player_ped_id(), -1);
		func_373(&iLocal_890);
		fLocal_893 = 5f;
		*iParam0 = 2;
		break;
	...
	case 2:
		func_379();
		func_377(vLocal_886, fLocal_889, 5, 1);
		if (iLocal_874 != 0 && gameplay::get_game_timer() > iLocal_874) {
			iLocal_874 = 0;
			iLocal_873 = 0;
		}
...
// Position - 0x2D7E8
void func_377(vector3 vParam0, float fParam3, int iParam4, int iParam5) {
	int iVar0;
	vector3 vVar1;

	if (iLocal_879 < iParam4) {
		if (func_366(&iLocal_890, fLocal_893)) {
			if (func_360(&iVar0)) {
				if (func_378(vParam0, fParam3, &vVar1)) {
					if (func_352(&Local_586[iVar0 /*33*/], vVar1, 0, 0)) {
						if (iParam5) {
							func_351(&Local_586[iVar0 /*33*/]);
						}
					}
...
// Position - 0x2D86A
bool func_378(vector3 vParam0, float fParam3, var *uParam4) {
	if (iLocal_181 == 0) {
		return false;
	}
	*uParam4 = {func_349(vParam0, fParam3, 6f)};
...
// Position - 0x2DA02
void func_382() { uLocal_36 = gameplay::get_game_timer(); }
...
// Position - 0x2DA30
void func_384(var *uParam0, bool bParam1) { func_385(&uParam0->f_41, bParam1); }
...
// Position - 0x2DABB
void func_387(var *uParam0, bool bParam1) { func_388(&uParam0->f_35, bParam1); }
...
// Position - 0x2DC08
void func_392(var *uParam0, int iParam1) { func_393(&uParam0->f_28, iParam1); }
	...
	case 1:
		...
		if (func_326(1, 1093140480, 0)) {
			if (func_558(Local_96.f_28[0])) {
				...
				cutscene::register_entity_for_cutscene(Local_96.f_28[0], sLocal_328, 2, func_561(49), 0);
			}
			if (func_558(Local_96.f_41[0])) {
				cutscene::register_entity_for_cutscene(Local_96.f_41[0], sLocal_330, 0, 0, 0);
			}
			else {
				cutscene::register_entity_for_cutscene(Local_96.f_41[0], sLocal_330, 2, joaat("prop_protest_table_01"),
													   0);
			}
			if (func_558(Local_96.f_41[1])) {
			...
			iLocal_884 = func_421(player::player_ped_id(), iLocal_209, 1, 0, 0, 0, 0, 0, 0);
	...
	case 2:
		if (!cutscene::is_cutscene_playing()) {
			...
			if (bLocal_37) {
				...
				func_409(0.1f, 0.1f, "NUMBER", cutscene::get_cutscene_time(), 0);
			}
			if (func_403(&uLocal_210)) {
				if (!iLocal_883) {
...
void func_411() {
	if (func_321(func_323(), 1)) {
		if (func_558(func_324())) {
			vLocal_925 = {entity::get_entity_coords(func_324(), 1)};
			fLocal_928 = entity::get_entity_heading(func_324());
		}
	}
	if (!func_321(func_323(), 1) || func_8(func_324(), vLocal_174, 1) < 10f) {
		vLocal_925 = {vLocal_166};
		fLocal_928 = fLocal_169;
	}
	func_412(Local_192[0 /*3*/], Local_192[1 /*3*/], Local_192.f_7, vLocal_166, fLocal_169, func_323(), 1, 1, 1, 0, 0);
	if (func_321(func_323(), 1)) {
		func_278(func_324(), vLocal_925, fLocal_928, 24, 0);
	}
}
...
// Position - 0x2EB6A
void func_412(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
			  int iParam14, int iParam15, int iParam16, int iParam17, int iParam18) {
	func_413(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, iParam14, iParam15, iParam16, iParam17, iParam18);
}

// Position - 0x2EB94
void func_413(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11,
		...
		if (vehicle::is_vehicle_driveable(iVar0, 0)) {
			...
			if (entity::is_entity_in_angled_area(iVar0, vParam0, vParam3, fParam6, 0, 1, 0)) {
				...
				if (vVar10.z > vParam0.z && vVar10.z < vParam3.z || vVar10.z > vParam3.z && vVar10.z < vParam0.z) {
					if (func_415(iVar0, vParam0, vParam3, fParam6)) {
						bVar1 = true;
					}
				}
			}
...
// Position - 0x2EFB0
bool func_415(int iParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	vector3 vVar9;
	...
	if (vehicle::is_vehicle_driveable(iParam0, 0)) {
		vParam1.z = vParam4.z;
		vVar0 = {func_417(vParam1 - vParam4)};
		vVar3 = {vVar0};
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (func_416(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) ||
			func_416(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15) ||
			func_416(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15) ||
			func_416(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12) ||
			func_416(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9) ||
			func_416(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15) ||
			func_416(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15) ||
			func_416(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12) ||
			func_416(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9) ||
			func_416(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15) ||
			func_416(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15) ||
			func_416(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12) ||
			func_416(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9) ||
			func_416(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15) ||
			func_416(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15) ||
			func_416(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12)) {
			return true;
		}
	}
	return false;
...
// Position - 0x2F2A6
int func_416(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8,
...
// Position - 0x2F4B7
int func_421(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			 int iParam8) {
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (func_423(iVar2, iVar8) != 0) {
		if (!entity::is_entity_dead(iParam0, 0)) {
			if (weapon::has_ped_got_weapon_component(iParam0, iVar2, func_423(iVar2, iVar8))) {
				if (func_422(func_423(iVar2, iVar8))) {
					iVar9 = weapon::get_weapon_component_type_model(func_423(iVar2, iVar8));
				}
			}
		}
		iVar8++;
	...
	while (func_423(iVar2, iVar8) != 0) {
		if (!entity::is_entity_dead(iParam0, 0)) {
			if (weapon::has_ped_got_weapon_component(iParam0, iVar2, func_423(iVar2, iVar8))) {
				weapon::give_weapon_component_to_weapon_object(iVar1, func_423(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
void func_425(int iParam0) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		func_426(iParam0, &Global_101700.f_2095.f_539.f_1185);
		iVar1 = 0;
		while (iVar1 <= 8 - 1) {
			Global_101700.f_2095.f_539.f_1151[iVar1 /*4*/][iVar0] = ui::_0xA13E93403F26C812(iVar1);
			iVar1++;
		}
	}
}
...
void func_426(int iParam0, var *uParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		...
		while (iVar0 <= 44 - 1) {
			...
			if (iVar3 != 0) {
				vVar4.x = weapon::get_ped_weapontype_in_slot(iParam0, func_428(iVar0));
				vVar4.y = 0;
				vVar4.z = 0;
		...
		iVar7 = 0;
		while (iVar7 < iVar8) {
			if (dlc1::get_dlc_weapon_data(iVar7, &Var9) && !func_427(Var9.f_1) && iVar70 < 50) {
...
void func_429(int *iParam0) {
	...
	case 1:
		if (streaming::has_anim_dict_loaded(sLocal_339) && !func_329()) {
			uVar0 = 16;
	...
	case 2:
		if (func_558(Local_96.f_28[0])) {
			if (!func_329() || gameplay::get_game_timer() > iLocal_157) {
				*iParam0 = 4;
			}
		}
		break;
...
void func_433() {
	if (player::is_player_playing(player::player_id())) {
		if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
			if (func_332(ped::get_vehicle_ped_is_in(player::player_ped_id(), 0), 10.5f, 1, 1056964608, 0, 1, 0)) {
...
void func_436(int *iParam0) {
	...
	if (entity::does_entity_exist(iParam0->f_4)) {
		vVar0 = {ped::get_ped_bone_coords(iParam0->f_2, 31086, vLocal_864)};
		entity::set_entity_coords_no_offset(iParam0->f_4, vVar0, 0, 0, 1);
		entity::set_entity_collision(iParam0->f_4, 0, 0);
	}
	if (func_465(iParam0) && iLocal_559 == 1) {
		if (iLocal_184 == 1) {
		}
		ai::task_play_anim(iParam0->f_2, sLocal_338, sLocal_349, 8f, -8f, -1, 1, 0, 0, 0, 0);
		func_58(iParam0);
		func_60(&iParam0->f_17);
		iParam0->f_1 = 13;
		iParam0->f_26 = 0;
	}
	if (!iLocal_181) {
	...
	else if (func_464(iParam0) && iParam0->f_3 == 0) {
		iParam0->f_3 = func_463(iParam0->f_2, 1, 0, 5);
	}
	switch (iParam0->f_1) {
	case 1:
		if (gameplay::get_game_timer() > iParam0->f_7) {
			iParam0->f_31 = 0;
			iParam0->f_26 = 0;
			iParam0->f_1 = 2;
			iParam0->f_15 = 0f;
			entity::set_entity_alpha(iParam0->f_2, system::floor(iParam0->f_15), 0);
		}
		break;
	...
	case 2:
		...
		ped::set_ped_can_be_targetted(iParam0->f_2, 0);
		func_354(iParam0->f_2);
		ai::task_play_anim(iParam0->f_2, sLocal_338, sLocal_350, 8f, -8f, -1, 1, 0, 0, 0, 0);
		graphics::start_particle_fx_non_looped_on_entity("scr_alien_teleport", iParam0->f_2, 0f, 0f, 0f, 0f, 0f, 0f,
														 fLocal_573, 0, 0, 0);
		iParam0->f_7 = gameplay::get_game_timer() + 450;
		iParam0->f_1 = 3;
		ped::set_ped_name_debug(iParam0->f_2, "TELEPORT ST");
		audio::play_sound_from_entity(-1, "SPAWN", iParam0->f_2, "BARRY_01_SOUNDSET", 0, 0);
		func_6(&iParam0->f_3);
		break;

	case 3:
		iParam0->f_15 += gameplay::get_frame_time() * 512f;
		if (iParam0->f_15 >= 255f) {
			iParam0->f_15 = 255f;
		}
		if (gameplay::get_game_timer() > iParam0->f_7) {
			entity::freeze_entity_position(iParam0->f_2, 0);
			entity::set_entity_invincible(iParam0->f_2, 0);
			ped::set_ped_can_be_targetted(iParam0->f_2, 1);
			entity::set_entity_collision(iParam0->f_2, 1, 0);
			entity::set_entity_visible(iParam0->f_2, 1, 0);
			iParam0->f_15 = 255f;
			ped::set_ped_relationship_group_hash(iParam0->f_2, -2065892691);
			ped::set_ped_name_debug(iParam0->f_2, "ACTIVE");
			iParam0->f_1 = 9;
		}
		if (iParam0->f_15 < 255f) {
			func_74(iParam0->f_2, system::floor(iParam0->f_15), &iLocal_186);
		}
		else {
			entity::reset_entity_alpha(iParam0->f_2);
		}
		break;

	case 4:
		entity::freeze_entity_position(iParam0->f_2, 1);
		entity::set_entity_invincible(iParam0->f_2, 1);
		entity::set_entity_collision(iParam0->f_2, 0, 0);
		ped::set_ped_can_be_targetted(iParam0->f_2, 0);
		ai::task_play_anim(iParam0->f_2, sLocal_338, sLocal_350, 8f, -8f, -1, 1, 0, 0, 0, 0);
		func_58(iParam0);
		...
		func_60(&iParam0->f_17);
		graphics::start_particle_fx_non_looped_at_coord(
			"scr_alien_teleport", entity::get_entity_coords(iParam0->f_2, 1),
			entity::get_entity_rotation(iParam0->f_2, 2), fLocal_573, 0, 0, 0);
		audio::play_sound_from_entity(-1, "SPAWN", iParam0->f_2, "BARRY_01_SOUNDSET", 0, 0);
		iParam0->f_7 = gameplay::get_game_timer() + 450;
		iParam0->f_1 = 5;
		ped::set_ped_name_debug(iParam0->f_2, "TPORT OUT");
		break;

	case 5:
		iParam0->f_15 = IntToFloat(iParam0->f_7 - gameplay::get_game_timer() * 255) / system::to_float(450);
		if (iParam0->f_15 < 0f) {
			iParam0->f_15 = 0f;
		}
		func_74(iParam0->f_2, system::floor(iParam0->f_15), &iLocal_186);
		if (gameplay::get_game_timer() > iParam0->f_7 || iParam0->f_15 == 0f) {
			ped::set_ped_name_debug(iParam0->f_2, "RELOCATE");
			iParam0->f_1 = 6;
		}
		break;

	case 6:
		entity::set_entity_visible(iParam0->f_2, 0, 0);
		entity::set_entity_collision(iParam0->f_2, 0, 0);
		ped::set_ped_can_be_targetted(iParam0->f_2, 0);
		if (iLocal_557 == 1) {
			func_67(iParam0);
		...
		if (func_345(&vVar0)) {
			func_269(iParam0->f_2, vVar0);
			iParam0->f_7 = gameplay::get_game_timer() + gameplay::get_random_int_in_range(1250, 2000);
			iParam0->f_14 = fLocal_857 + gameplay::get_random_float_in_range(fLocal_861, fLocal_862) * fLocal_857;
			if (iLocal_184 == 1) {
			}
			iParam0->f_1 = 1;
		}
	...
	case 9:
		ped::set_ped_name_debug(iParam0->f_2, "ACTIVE");
		if (!iParam0->f_32) {
			if (ai::get_script_task_status(iParam0->f_2, 1227113341) != 1) {
				ai::task_go_to_entity(iParam0->f_2, player::player_ped_id(), 20000, 0.5f, 2f, 1073741824, 0);
			}
		}
		if (!func_9()) {
			return;
		...
		if (func_462(iParam0)) {
			ai::set_ped_desired_move_blend_ratio(iParam0->f_2, 3f);
			if (iParam0->f_10 < fLocal_570 + 8f) {
				iParam0->f_1 = 10;
				if (iLocal_184 == 1) {
				}
				iLocal_558 = 1;
		...
		else if (iParam0->f_10 < iParam0->f_14 + 12f) {
			if (iLocal_184 == 1) {
			}
			iParam0->f_1 = 15;
		}
	...
	case 10: func_458(iParam0); break;

	case 11: func_454(iParam0); break;

	case 12:
		ped::set_ped_name_debug(iParam0->f_2, "SUMMON FAIL");
		if (iLocal_561 == iParam0->f_30) {
			iLocal_561 = -1;
		}
		if (entity::is_entity_playing_anim(player::player_ped_id(), sLocal_338, sLocal_346, 3)) {
		}
		else if (gameplay::get_game_timer() > iParam0->f_7) {
			if (iLocal_184 == 1) {
			}
	...
	case 13:
		ped::set_ped_name_debug(iParam0->f_2, "WATCH");
		if (iLocal_559 == 1) {
			if (ai::get_script_task_status(iParam0->f_2, -2017877118) != 1) {
				ai::task_play_anim(iParam0->f_2, sLocal_338, sLocal_349, 4f, -4f, -1, 1, 0, 0, 0, 0);
			}
			return;
		}
		iParam0->f_1 = 14;
		iParam0->f_7 =
			gameplay::get_game_timer() + gameplay::get_random_int_in_range(iLocal_562 - 1500, iLocal_562 - 500);
		break;

	case 14:
		ped::set_ped_name_debug(iParam0->f_2, "WATCH END");
		if (gameplay::get_game_timer() > iParam0->f_7 &&
			!entity::is_entity_playing_anim(player::player_ped_id(), sLocal_338, sLocal_346, 3)) {
			iParam0->f_1 = 9;
		}
		break;
	...
	case 15:
		func_58(iParam0);
		ped::set_ped_reset_flag(iParam0->f_2, 63, 1);
		ped::set_ped_name_debug(iParam0->f_2, "C-RUSH");
		if (!iParam0->f_32) {
			ped::set_ped_move_rate_override(iParam0->f_2, 1.15f);
			ai::set_ped_desired_move_blend_ratio(iParam0->f_2, 3f);
			if (ai::get_script_task_status(iParam0->f_2, 1227113341) != 1) {
				ai::task_go_to_entity(iParam0->f_2, player::player_ped_id(), 20000, 0.5f, 2f, 1073741824, 0);
			}
		}
		if (iParam0->f_10 < iParam0->f_14 && func_9()) {
			func_452(iParam0->f_2, "ALIEN_HOSTILE", "ALIENS", 10);
			iParam0->f_1 = 16;
			iParam0->f_26 = 0;
		}
		else if (iLocal_559) {
	...
	case 17:
		entity::set_entity_coords(iParam0->f_5, entity::get_entity_coords(iParam0->f_4, 1), 1, 0, 0, 1);
		ped::set_ped_name_debug(iParam0->f_2, "CHARGE");
		if (gameplay::get_game_timer() > iParam0->f_7) {
			if (func_9()) {
				func_59(&iParam0->f_21);
				func_59(&iParam0->f_22);
				func_59(&iParam0->f_23);
				func_59(&iParam0->f_24);
				if (iLocal_184 == 1) {
				}
				iParam0->f_1 = 18;
			}
	...
	case 16: func_451(iParam0); break;

	case 18:
		if (!ped::is_ped_running_ragdoll_task(iParam0->f_2)) {
			ped::set_ped_name_debug(iParam0->f_2, "BEAM ST");
			func_354(iParam0->f_2);
			vVar0 = {ped::get_ped_bone_coords(player::player_ped_id(), 31086, 0f, 0f, 0f)};
			func_448(iParam0->f_4, vVar0);
			iParam0->f_7 = gameplay::get_game_timer() + iLocal_856;
			func_59(&iParam0->f_21);
			func_59(&iParam0->f_22);
			func_59(&iParam0->f_23);
			func_59(&iParam0->f_24);
			iParam0->f_12 = 0f;
			iParam0->f_22 = graphics::start_particle_fx_looped_on_entity("scr_alien_impact", iParam0->f_4, 0f, 0f, 0f,
																		 0f, 0f, 0f, fLocal_571 / 3f, 0, 0, 0);
			iParam0->f_23 = graphics::start_particle_fx_looped_on_entity("scr_alien_beam", iParam0->f_4, 0f, 0f, 0f,
																		 vLocal_867, fLocal_858, 0, 0, 0);
			graphics::_set_particle_fx_looped_range(iParam0->f_23, iParam0->f_12);
			ai::task_play_anim(iParam0->f_2, sLocal_338, "MIND_CONTROL_B_Loop", 4f, -8f, -1, 1, 0, 0, 0, 0);
			iParam0->f_1 = 19;
		}
		break;

	case 19: func_439(iParam0); break;

	case 20:
		iParam0->f_12 = 0f;
		if (func_558(iParam0->f_2)) {
			if (ped::is_ped_falling(iParam0->f_2) || ai::is_ped_getting_up(iParam0->f_2) ||
				ped::is_ped_ragdoll(iParam0->f_2) || ped::is_ped_running_ragdoll_task(iParam0->f_2)) {
				return;
			}
		}
		if (ai::get_script_task_status(iParam0->f_2, -2017877118) != 1) {
			ai::task_play_anim(iParam0->f_2, sLocal_338, "MIND_CONTROL_B_LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
		}
		if (ai::get_script_task_status(iParam0->f_2, -2017877118) == 1) {
			entity::set_entity_heading(iParam0->f_4, entity::get_entity_heading(iParam0->f_2));
			if (!graphics::does_particle_fx_looped_exist(iParam0->f_22)) {
				iParam0->f_22 = graphics::start_particle_fx_looped_on_entity("scr_alien_charging", iParam0->f_4, 0f, 0f,
																			 0f, 0f, 0f, 0f, fLocal_572, 0, 0, 0);
			}
			if (iLocal_184 == 1) {
			}
			iParam0->f_1 = 19;
	...
	case 7:
		if (func_437(iParam0) || gameplay::get_game_timer() > iParam0->f_7) {
			vVar0 = {entity::get_entity_coords(iParam0->f_2, 1)};
			if (gameplay::get_ground_z_for_3d_coord(vVar0, &uVar3, 0)) {
				vVar0.z = uVar3;
			}
			graphics::start_particle_fx_non_looped_on_entity("scr_alien_disintegrate", iParam0->f_2, 0f, 0f, 0f, 0f, 0f,
															 0f, fLocal_574, 0, 0, 0);
			audio::play_sound_from_coord(-1, "DESPAWN", vVar0, "BARRY_01_SOUNDSET", 0, 0, 0);
			if (iLocal_184 == 1) {
			}
			iParam0->f_1 = 8;
			ped::set_ped_name_debug(iParam0->f_2, "DEAD");
			iParam0->f_7 = gameplay::get_game_timer() + 1000;
		}
		break;

	case 8:
		iParam0->f_15 = IntToFloat(iParam0->f_7 - gameplay::get_game_timer() * 255) / system::to_float(1000);
		if (iParam0->f_15 < 0f) {
			iParam0->f_15 = 0f;
		}
		if (entity::is_entity_on_screen(iParam0->f_2)) {
			func_74(iParam0->f_2, system::floor(iParam0->f_15), &iLocal_186);
		}
		else {
			entity::reset_entity_alpha(iParam0->f_2);
...
int func_437(var *uParam0) {
	...
	if (!func_438(entity::get_entity_velocity(uParam0->f_2), 0f, 0f, 0f, 0.125f, 0)) {
		if (iLocal_184 == 1) {
		}
		return 0;
	}
...
// Position - 0x31871
int func_438(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
void func_439(var *uParam0) {
	...
	if (func_558(uParam0->f_2)) {
		if (ped::is_ped_falling(uParam0->f_2) || ai::is_ped_getting_up(uParam0->f_2) ||
			ped::is_ped_ragdoll(uParam0->f_2) || ped::is_ped_running_ragdoll_task(uParam0->f_2)) {
			func_58(uParam0);
			func_60(&uParam0->f_17);
			uParam0->f_12 = 0f;
			uParam0->f_1 = 20;
				...
				if (gameplay::get_distance_between_coords(uParam0->f_27, vVar2, 1) <= 0.7f) {
					...
					if (gameplay::absf(uParam0->f_27.f_2 - vVar2.z) < 1f) {
						if (gameplay::get_frame_count() % 20 == 0) {
							gameplay::shoot_single_bullet_between_coords(vVar5, vVar8, 0, 1, joaat("weapon_pistol"), 0,
																		 0, 1, -1f);
						}
						if (iLocal_851 == 1) {
							entity::apply_force_to_entity(player::player_ped_id(), 1,
														  FtoV(fLocal_863) *
															  entity::get_entity_forward_vector(uParam0->f_4),
														  0f, 0f, 0f, 0, 0, 1, 1, 0, 1);
						}
						if (iLocal_852 == 0) {
						...
						if (gameplay::get_game_timer() > uParam0->f_8) {
							...
							case 0:
								ped::apply_ped_blood_specific(player::player_ped_id(), iVar0, 0.657f, 0.566f, 126.36f,
															  0.07f, 1, 0f, "cs_trev1_blood");
								break;

							case 1:
								ped::apply_ped_blood_specific(player::player_ped_id(), iVar0, 0.582f, 0.383f, 111.36f,
															  0.05f, 3, 0f, "cs_trev1_blood");
								break;

							case 2:
								ped::apply_ped_blood_specific(player::player_ped_id(), iVar0, 0.709f, 0.396f, 126.36f,
															  0f, 3, 0f, "cs_trev1_blood");
								break;

							default:
								ped::apply_ped_blood_specific(player::player_ped_id(), iVar0, 0.582f, 0.383f, 200.36f,
															  0.1f, 2, 0f, "cs_trev1_blood");
								break;
							}
							if (entity::get_entity_health(player::player_ped_id()) - iLocal_853 <= 100) {
								func_62();
								func_54(1);
								func_440(vVar5, vVar8, 1);
								return;
							}
							else {
								ped::apply_damage_to_ped(player::player_ped_id(), iLocal_853, 0);
							}
	...
	if (func_558(uParam0->f_5)) {
		entity::set_entity_coords(uParam0->f_5,
								  entity::get_entity_coords(uParam0->f_4, 1) +
									  entity::get_entity_forward_vector(uParam0->f_4) * FtoV(uParam0->f_12),
								  1, 0, 0, 1);
	}
	if (graphics::does_particle_fx_looped_exist(uParam0->f_23)) {
		graphics::_set_particle_fx_looped_range(uParam0->f_23, uParam0->f_12);
	...
	if (!graphics::does_particle_fx_looped_exist(uParam0->f_24)) {
		uParam0->f_24 = graphics::start_particle_fx_looped_on_entity("scr_alien_impact", uParam0->f_5, 0f, 0f, 0f, 0f,
																	 0f, 0f, fLocal_571, 0, 0, 0);
	}
}

// Position - 0x31D45
void func_440(vector3 vParam0, vector3 vParam3, int iParam6) {
	player::set_player_health_recharge_multiplier(player::player_id(), 0f);
	if (!func_414(vParam0) && !func_414(vParam3)) {
	}
	iLocal_163 = func_15(iLocal_209, 0);
...
void func_443(var *uParam0) {
	...
	vVar3 = {func_447(cam::_get_gameplay_cam_rot(2))};
	vVar6 = {vVar0 + vVar3 * FtoV(cam::_0xD0082607100D7193())};
	fVar13 = fLocal_571 * 1.25f;
	if (func_446(&vVar9, entity::get_entity_coords(uParam0->f_4, 1), entity::get_entity_coords(uParam0->f_5, 1), vVar3,
				 vVar6)) {
		if (cam::is_sphere_visible(vVar9, 0.5f)) {
			iVar14 = func_444(vVar3, vVar0, entity::get_entity_coords(uParam0->f_4, 1));
			iVar15 = func_444(vVar3, vVar0, entity::get_entity_coords(uParam0->f_5, 1));
			if (iVar14 > 0 && iVar15 < 0) {
				vVar9 = {vVar9 - entity::get_entity_forward_vector(uParam0->f_4) * FtoV(fLocal_870)};
			}
			...
			if (!graphics::does_particle_fx_looped_exist(uParam0->f_25)) {
				uParam0->f_25 = graphics::start_particle_fx_looped_at_coord("scr_alien_impact", vVar9, 0f, 0f, 0f,
																			fVar13, 0, 0, 0, 0);
			}
...
// Position - 0x31F6E
int func_444(vector3 vParam0, vector3 vParam3, vector3 vParam6) {
	float fVar0;

	fVar0 = func_445(vParam6 - vParam3, vParam0);
	if (fVar0 < 0f) {
		return -1;
	}
	else if (fVar0 > 0f) {
...
// Position - 0x31FC4
bool func_446(var *uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	float fVar7;
	...
	fVar6 = func_445(vParam7, vVar0);
	fVar7 = -func_445(vParam7, vVar3);
	if (gameplay::absf(fVar6) < 1E-08f) {
		return false;
	}
	fVar8 = fVar7 / fVar6;
	*uParam0 = {vParam1 + FtoV(fVar8) * vVar0};
...
// Position - 0x32071
void func_448(int iParam0, vector3 vParam1) {
	float *fVar0;
	float *fVar1;

	func_449(entity::get_entity_coords(iParam0, 1), vParam1, &fVar0, &fVar1, 1);
	entity::set_entity_rotation(iParam0, fVar0, 0f, fVar1, 2, 1);
}

// Position - 0x3209A
void func_449(vector3 vParam0, vector3 vParam3, float *fParam6, float *fParam7, int iParam8) {
	vector3 vVar0;

	vVar0 = {vParam3 - vParam0};
	func_450(vVar0, fParam6, fParam7, iParam8);
}

// Position - 0x320BD
void func_450(vector3 vParam0, float *fParam3, float *fParam4, int iParam5) {
	float fVar0;

	if (vParam0.y != 0f) {
		*fParam4 = gameplay::atan2(vParam0.x, vParam0.y);
	}
	...
	if (fVar0 != 0f) {
		*fParam3 = gameplay::atan2(vParam0.z, fVar0);
	}
...
void func_451(var *uParam0) {
	...
	if (!uParam0->f_32) {
		if (ai::get_script_task_status(uParam0->f_2, 1227113341) != 1) {
			ai::task_go_to_entity(uParam0->f_2, player::player_ped_id(), 20000, 0.5f, 2f, 1073741824, 0);
		}
	}
	...
	if (uParam0->f_26 == 0) {
		...
		if (iVar1 == 2) {
			if (iVar0 == 0 && func_9()) {
				...
				ai::task_perform_sequence(uParam0->f_2, iVar2);
				ai::clear_sequence_task(&iVar2);
				if (!graphics::does_particle_fx_looped_exist(uParam0->f_22)) {
					uParam0->f_22 = graphics::start_particle_fx_looped_on_entity(
						"scr_alien_charging", uParam0->f_4, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_572, 0, 0, 0);
				}
				entity::set_entity_coords(uParam0->f_5, vVar3, 1, 0, 0, 1);
				if (!graphics::does_particle_fx_looped_exist(uParam0->f_24)) {
					uParam0->f_24 = graphics::start_particle_fx_looped_on_entity(
						"scr_alien_impact", uParam0->f_5, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_571, 0, 0, 0);
				}
				uParam0->f_1 = 17;
				if (iLocal_184 == 1) {
				}
...
void func_454(var *uParam0) {
	...
	func_432();
	iVar0 = func_457(controls::get_disabled_control_normal(0, 30));
	if (controls::is_disabled_control_just_pressed(0, 30) || iVar0 != uParam0->f_20) {
		uParam0->f_20 = iVar0;
		uParam0->f_18++;
	}
	if (gameplay::get_game_timer() > uParam0->f_19) {
		graphics::start_particle_fx_non_looped_on_entity("scr_alien_teleport", player::player_ped_id(), 0f, 0f, 0f, 0f,
														 0f, 0f, fLocal_573, 0, 0, 0);
		uParam0->f_19 = gameplay::get_game_timer() + 2000;
	}
	if (uParam0->f_18 > iLocal_565 || ai::get_script_task_status(uParam0->f_2, 242628503) > 1) {
		if (entity::is_entity_playing_anim(uParam0->f_2, sLocal_338, sLocal_343, 3) ||
			entity::is_entity_playing_anim(uParam0->f_2, sLocal_338, sLocal_341, 3)) {
...
void func_458(var *uParam0) {
	...
	if (ped::is_ped_falling(uParam0->f_2) || ai::is_ped_getting_up(uParam0->f_2) || ped::is_ped_ragdoll(uParam0->f_2) ||
		ped::is_ped_running_ragdoll_task(uParam0->f_2)) {
		return;
	}
	if (!func_461(uParam0->f_2, player::player_ped_id(), 1126825984, 0)) {
		return;
	}
	...
	ai::close_sequence_task(iVar0);
	ai::task_perform_sequence(uParam0->f_2, iVar0);
	ai::clear_sequence_task(&iVar0);
	ped::_0x2208438012482A1A(uParam0->f_2, 0, 0);
	func_460(player::player_ped_id(), uParam0->f_2);
	ai::open_sequence_task(&iVar0);
	...
	graphics::start_particle_fx_non_looped_on_entity("scr_alien_teleport", player::player_ped_id(), 0f, 0f, 0f, 0f, 0f,
													 0f, fLocal_573, 0, 0, 0);
	uParam0->f_19 = gameplay::get_game_timer() + 2000;
}
...
void func_460(int iParam0, int iParam1) {
	...
	fVar0 = func_355(entity::get_entity_coords(iParam0, 1), entity::get_entity_coords(iParam1, 1), 1);
	entity::set_entity_heading(iParam0, fVar0);
}
...
int func_461(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	vVar0 = {func_417(entity::get_entity_coords(iParam1, 1) - entity::get_entity_coords(iParam0, 1))};
...
bool func_467(int *iParam0) {
	if (!func_471(iParam0)) {
		iParam0->f_10 = func_353(iParam0->f_2, player::player_ped_id(), 0);
		if (entity::is_entity_dead(iParam0->f_2, 0) || ped::is_ped_injured(iParam0->f_2)) {
			if (func_61(iParam0)) {
				iLocal_558 = 0;
				iLocal_559 = 0;
			}
			...
			func_470("ALIEN_DEATH", "ALIENS", entity::get_entity_coords(iParam0->f_2, 1), 10);
			func_58(iParam0);
			func_60(&iParam0->f_17);
			func_14(&iParam0->f_4);
			func_14(&iParam0->f_5);
			...
			func_469();
			func_6(&iParam0->f_3);
			iParam0->f_7 = gameplay::get_game_timer() + 2500;
			if (iLocal_184 == 1) {
			}
			iLocal_877++;
			if (iLocal_873 == 0) {
...
// Position - 0x32FDB
void func_470(char *sParam0, char *sParam1, vector3 vParam2, int iParam5) {
	audio::_play_ambient_speech_at_coords(sParam0, sParam1, vParam2, func_453(iParam5));
}

// Position - 0x32FF5
bool func_471(var *uParam0) { return uParam0->f_1 == 7 || uParam0->f_1 == 8; }
	...
	if (Global_69956 != 6) {
		if (Global_69958 == -1) {
			...
			if (iVar1 < 9000 && !cam::is_screen_faded_out()) {
				...
				Var4 = {func_479(Global_69957, Global_69959, iParam10)};
				if (fVar7 == -0.014f) {
				}
...
struct<2> func_479(int iParam0, int iParam1, int iParam2) {
	...
	StringCopy(&Var0, "", 8);
	switch (iParam1) {
	case 1: Var0 = {func_487(iParam0)}; break;

	case 7: Var0 = {func_222(iParam0)}; break;

	case 3:
		iVar2 = iParam0;
		switch (iVar2) {
		case 0: Var0 = {func_486(iParam2)}; break;

		case 8: Var0 = {func_485(iParam2)}; break;

		case 7: Var0 = {func_484(iParam2)}; break;

		case 10: Var0 = {func_483(iParam2)}; break;

		case 5: Var0 = {func_482(iParam2)}; break;

		case 4: Var0 = {func_481(iParam2)}; break;

		default: StringCopy(&Var0, func_480(iVar2), 8); break;
		}
		break;
...
//Position - 0x33876
bool func_488(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (!func_490(0) || G_TextMessageConfig || Global_69960 == 1 || !cam::is_screen_faded_in()) {
		return false;
	}
	switch (Global_69956) {
	case 0:
	...
	case 5:
		if (cutscene::is_cutscene_playing() || func_475(0) || func_489(1)) {
		}
		else {
			return true;
		}
...
// Position - 0x339DA
bool func_491(int iParam0) { return func_492(iParam0, Global_35781); }
...
// Position - 0x33C05
void func_495(vector3 vParam0, float fParam3, var *uParam4, var *uParam5) {
	vector3 vVar0;
...
void func_497() {
	...
	if (func_510() == 1) {
		...
		func_500(vLocal_880, 327.2303f, 0, 0);
...
// Position - 0x33F4E
var func_499() { return gameplay::is_bit_set(Global_91491.f_20, 13); }
...
int func_501(var *uParam0) {
	...
	case 2:
		...
		if (!entity::does_entity_exist(uParam0->f_28[0])) {
			if (func_502(&uParam0->f_28[0], 49, vVar8, fVar11, "RC LAUNCHER: BARRY 1", 1)) {
...
// Position - 0x34647
float func_509(float fParam0) { return fParam0 * 57.29578f; }
...
// Position - 0x346C9
void func_513() {
	func_358(&vLocal_897, 0, 175.5842f, -964.2895f, 35.0957f);
	func_358(&vLocal_897, 1, 183.1626f, -970.6071f, 35.0957f);
	func_358(&vLocal_897, 2, 179.9724f, -943.0597f, 34.0921f);
	func_358(&vLocal_897, 3, 185.2821f, -935.3659f, 34.0922f);
	func_358(&vLocal_897, 4, 199.9392f, -951.7982f, 35.0511f);
	func_358(&vLocal_897, 5, 190.3101f, -976.7255f, 35.0916f);
	func_358(&vLocal_897, 6, 205.6451f, -974.7205f, 35.0476f);
	func_358(&vLocal_897, 7, 212.8866f, -936.2545f, 33.7047f);
	func_358(&vLocal_897, 8, 194.1555f, -957.8777f, 33.3463f);
}
...
// Position - 0x34880
void func_516(var *uParam0, vector3 vParam1, vector3 vParam4, float fParam7) {
	(*uParam0)[0 /*3*/] = {vParam1};
	(*uParam0)[1 /*3*/] = {vParam4};
	uParam0->f_7 = fParam7;
}
...
void func_522(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam2) {
		...
		if (func_81() == 0) {
			iVar0 = func_142(func_523(iParam0), -1, 0);
			gameplay::clear_bit(&iVar0, iParam1);
			func_140(func_523(iParam0), iVar0, -1, 1, 0);
		}
	}
	else {
...
bool func_525(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_81() == 0) {
			return gameplay::is_bit_set(func_142(func_523(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0x3534B
bool func_533(char *sParam0, int iParam1, int iParam2) {
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_539()) {
		if (func_538()) {
			...
			iVar33 = func_534(script::get_this_script_name());
			if (iVar33 > -1) {
...
int func_535() {
	...
	iVar0 = func_536(&Global_91491.f_3, 0);
	iVar1 = 0;
	if (iVar0 == 53) {
		iVar1 = 1;
	}
...
bool func_539() {
	...
	if (Global_91491.f_11 == 5) {
		if (func_534(&Global_91491.f_3) > -1) {
			return true;
		}
	}
	return false;
...
// Position - 0x35705
void func_543() { Global_17151.f_5 = 1; }

// Position - 0x35713
void func_544() { Global_17151.f_5 = 0; }
...
void func_551(int iParam0) {
	if (func_26(iParam0)) {
		Global_101700.f_2095.f_539.f_298[iParam0 /*284*/] = {Global_101700.f_2095.f_539.f_1185};
	}
}
...
void func_552(int iParam0, int iParam1) {
	...
	if (func_26(iVar0) && !ped::is_ped_injured(iParam0)) {
		if (iParam0 == player::player_ped_id()) {
			func_426(iParam0, &Global_101700.f_2095.f_539.f_298[iVar0 /*284*/]);
			iVar2 = 0;
			while (iVar2 <= 8 - 1) {
...
void func_553(int iParam0, int iParam1) {
	...
	if (!ped::is_ped_injured(iParam0)) {
		iVar0 = func_27(iParam0);
		func_554(iParam0, &Global_101700.f_2095.f_539.f_1185, iParam1);
		iVar1 = 0;
		while (iVar1 <= 8 - 1) {
		...
		while (iVar7 < 2) {
			...
			while (iVar8 < dlc1::get_num_dlc_weapons()) {
				if (dlc1::get_dlc_weapon_data(iVar8, &Var9)) {
					if (!dlc1::_is_dlc_data_empty(Var9) && !func_427(Var9.f_1)) {
						if (iVar7 == 0) {
...
bool func_555(int iParam0) {
	...
	if (iParam0 == -61829581) {
		if (network::network_is_game_in_progress() && func_557()) {
			return true;
		}
		else {
			return false;
	...
	case joaat("weapon_hatchet"):
		if (!network::network_is_game_in_progress()) {
			if (!func_291() && !Global_262145.f_17809) {
				return false;
			}
		}
		break;
	...
	while (iVar0 < dlc1::get_num_dlc_weapons()) {
		if (dlc1::get_dlc_weapon_data(iVar0, &Var1)) {
			if (Var1.f_1 == iParam0) {
				if (dlc1::_is_dlc_data_empty(Var1) || func_427(Var1.f_1)) {
					return false;
				}
			}
		}
...
// Position - 0x361E5
var func_557() { return dlc2::is_dlc_present(-1691188696); }
