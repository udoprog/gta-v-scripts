...
// Position - 0x242
float func_1(int iParam0, int iParam1, int iParam2) {
	vector3 vVar0;
	vector3 vVar3;
		...
		if (func_2(iLocal_90)) {
			if (func_52()) {
				if (!iLocal_112) {
					...
					if (!iLocal_110) {
						if (!bLocal_111) {
							ai::open_sequence_task(&iLocal_147);
							...
							ai::close_sequence_task(iLocal_147);
						}
						else {
							ai::open_sequence_task(&iLocal_147);
							ai::task_look_at_entity(0, player::player_ped_id(), -1, 0, 2);
						...
						ai::task_perform_sequence(iLocal_90, iLocal_147);
						ai::clear_sequence_task(&iLocal_147);
						iLocal_112 = 1;
					}
					else {
						if (!bLocal_111) {
					...
					if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 0),
															  entity::get_entity_coords(iLocal_90, 0), 1) >= 100f &&
						!cam::is_sphere_visible(entity::get_entity_coords(iLocal_90, 0), 3f)) {
				...
				if (Local_47[0 /*20*/].f_18 >= 5 && Local_47[1 /*20*/].f_18 >= 5) {
					if (!entity::is_entity_in_angled_area(player::player_ped_id(), -69.62395f, -1087.37f, 24.59833f,
														  -11.27861f, -1108.28f, 34.17205f, 47.5f, 0, 1, 0)) {
						func_4();
					}
				}
				if (func_2(iLocal_90)) {
					ped::set_ped_reset_flag(iLocal_90, 60, 1);
				}
			}
		}
		else {
...
// Position - 0x78A
void func_9(int iParam0) { Global_101686 = iParam0; }
...
// Position - 0x151C
void func_19(char *sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			 int iParam8) {
	func_20(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

// Position - 0x153D
void func_20(char *sParam0, char *sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
// Position - 0x1A37
void func_29(int iParam0, int iParam1) { gameplay::set_bit(&Global_101700.f_23954.f_8[iParam0], iParam1); }
...
// Position - 0x1B20
int func_32(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5,
...
bool func_52() {
	if (func_2(iLocal_90)) {
		if (!iLocal_110) {
			if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 0),
													  entity::get_entity_coords(iLocal_90, 0), 1) <= 7f ||
				ai::get_script_task_status(iLocal_90, 242628503) == 7) {
				if (!iLocal_112) {
					if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 0),
															  entity::get_entity_coords(iLocal_90, 0), 1) <= 7f) {
					}
		...
		else if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 0),
													   entity::get_entity_coords(iLocal_90, 0), 1) <= 4.5f ||
				 ai::get_script_task_status(iLocal_90, 242628503) == 7) {
			if (!iLocal_112) {
				if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 0),
														  entity::get_entity_coords(iLocal_90, 0), 1) <= 4.5f) {
				...
				if (func_59()) {
					if (iLocal_119 == 0) {
						if (bLocal_109) {
							...
							ai::task_play_anim(0, "cellphone@", "cellphone_call_out", 8f, -8f, -1, 0, 0, 0, 0, 0);
							ai::close_sequence_task(iLocal_147);
							ai::task_perform_sequence(iLocal_90, iLocal_147);
							ai::clear_sequence_task(&iLocal_147);
						}
...
// Position - 0x2C2E
bool func_57() {
	if (func_58(player::player_ped_id()) != joaat("weapon_unarmed") &&
		func_58(player::player_ped_id()) != joaat("object") &&
		func_58(player::player_ped_id()) != joaat("weapon_knife") &&
		func_58(player::player_ped_id()) != joaat("weapon_nightstick") &&
		func_58(player::player_ped_id()) != joaat("weapon_hammer") &&
		func_58(player::player_ped_id()) != joaat("weapon_bat") &&
		func_58(player::player_ped_id()) != joaat("weapon_crowbar") &&
		func_58(player::player_ped_id()) != joaat("weapon_golfclub") &&
		func_58(player::player_ped_id()) != joaat("weapon_bottle")) {
...
// Position - 0x2D17
bool func_59() {
	if (!ped::is_cop_ped_in_area_3d(vLocal_126, vLocal_129) &&
		!(gameplay::is_position_occupied(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) &&
		  gameplay::is_position_occupied(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0))) {
		if (interior::get_room_key_from_entity(player::player_ped_id()) == gameplay::get_hash_key("rm_showroom")) {
			if (!func_123()) {
				if (entity::is_entity_in_angled_area(player::player_ped_id(), -41.19015f, -1104.137f, 24.42232f,
													 -33.7943f, -1107.183f, 28.67232f, 8.5f, 0, 1, 0)) {
					iLocal_110 = 1;
					func_71(0);
				}
				else {
	...
	else if (ped::is_cop_ped_in_area_3d(vLocal_126, vLocal_129) ||
			 gameplay::is_position_occupied(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) &&
				 gameplay::is_position_occupied(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0)) {
		if (interior::get_room_key_from_entity(player::player_ped_id()) == gameplay::get_hash_key("rm_showroom")) {
...
// Position - 0x303A
bool func_65() {
	switch (func_66(&Global_25249, 0, 5, 0, script::get_id_of_this_thread())) {
	case 1: return true;
...
// Position - 0x31F6
bool func_68(int iParam0) { return func_69(iParam0, Global_35781); }
...
void func_71(int iParam0) {
	if (iParam0) {
		if (func_2(iLocal_92)) {
			entity::set_entity_visible(iLocal_92, 1, 0);
			entity::freeze_entity_position(iLocal_92, 0);
			entity::set_entity_can_be_damaged(iLocal_92, 1);
			iLocal_90 = iLocal_92;
			iLocal_94 = iLocal_96;
			func_60(&iLocal_91);
			func_72(&iLocal_95);
		...
		entity::set_entity_visible(iLocal_91, 1, 0);
		entity::freeze_entity_position(iLocal_91, 0);
		entity::set_entity_can_be_damaged(iLocal_91, 1);
		iLocal_90 = iLocal_91;
		iLocal_94 = iLocal_95;
		func_60(&iLocal_92);
		func_72(&iLocal_96);
...
void func_73() {
	...
	case 0:
		...
		gameplay::clear_angled_area_of_vehicles(-53.57574f, -1095.356f, 24.17232f, -46.52551f, -1094.587f, 27.42232f,
												3.75f, 0, 0, 0, 0, 0);
		break;
	...
	case 1:
		if (!func_2(iLocal_91) || !func_2(iLocal_92)) {
			...
			if (func_2(iLocal_91)) {
				entity::set_entity_visible(iLocal_91, 0, 0);
				entity::set_entity_can_be_damaged(iLocal_91, 0);
				...
				weapon::give_weapon_to_ped(iLocal_91, joaat("weapon_pistol"), 999, 0, 0);
				entity::set_entity_can_be_damaged_by_relationship_group(iLocal_91, 0, iLocal_148);
				ped::set_relationship_between_groups(5, iLocal_148, 1862763509);
				entity::set_entity_load_collision_flag(iLocal_91, 1);
				ped::set_ped_config_flag(iLocal_91, 104, 1);
				iLocal_95 = object::create_object(iLocal_122, entity::get_entity_coords(iLocal_91, 1), 1, 1, 0);
				entity::attach_entity_to_entity(iLocal_95, iLocal_91, ped::get_ped_bone_index(iLocal_91, 28422), 0f, 0f,
												0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
				ai::open_sequence_task(&iLocal_147);
				ai::task_play_anim(0, "cellphone@str", "cellphone_call_listen_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
				ai::task_play_anim(0, "cellphone@str", "cellphone_call_listen_f", 8f, -8f, -1, 0, 0, 0, 0, 0);
				ai::task_play_anim(0, "cellphone@str", "cellphone_call_listen_no_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
				ai::task_play_anim(0, "cellphone@str", "cellphone_call_listen_d", 8f, -8f, -1, 0, 0, 0, 0, 0);
				ai::set_sequence_to_repeat(iLocal_147, 1);
				ai::close_sequence_task(iLocal_147);
				ai::task_perform_sequence(iLocal_91, iLocal_147);
				ai::clear_sequence_task(&iLocal_147);
				entity::freeze_entity_position(iLocal_91, 1);
			}
			func_75(&iLocal_92, 18, vLocal_103, fLocal_106, 1);
			if (func_2(iLocal_92)) {
				entity::set_entity_visible(iLocal_92, 0, 0);
				entity::set_entity_can_be_damaged(iLocal_92, 0);
				...
				weapon::give_weapon_to_ped(iLocal_92, joaat("weapon_pistol"), 999, 0, 0);
				entity::set_entity_can_be_damaged_by_relationship_group(iLocal_92, 0, iLocal_148);
				ped::set_relationship_between_groups(5, iLocal_148, 1862763509);
				entity::set_entity_load_collision_flag(iLocal_92, 1);
				ped::set_ped_config_flag(iLocal_92, 104, 1);
				iLocal_96 = object::create_object(iLocal_122, entity::get_entity_coords(iLocal_92, 1), 1, 1, 0);
				entity::attach_entity_to_entity(iLocal_96, iLocal_92, ped::get_ped_bone_index(iLocal_92, 28422), 0f, 0f,
												0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
				ai::open_sequence_task(&iLocal_147);
				ai::task_play_anim(0, "cellphone@str", "cellphone_call_listen_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
				ai::task_play_anim(0, "cellphone@str", "cellphone_call_listen_f", 8f, -8f, -1, 0, 0, 0, 0, 0);
				...
				ai::set_sequence_to_repeat(iLocal_147, 1);
				ai::close_sequence_task(iLocal_147);
				ai::task_perform_sequence(iLocal_92, iLocal_147);
				ai::clear_sequence_task(&iLocal_147);
				entity::freeze_entity_position(iLocal_91, 1);
			}
		}
			...
			func_74();
			iLocal_123 = vehicle::create_vehicle(joaat("baller2"), -46.2722f, -1097.466f, 25.42f, 112.5363f, 1, 1);
			...
			iLocal_124 = vehicle::create_vehicle(joaat("tailgater"), -41.07354f, -1099.567f, 25.42f, 138.4292f, 1, 1);
			...
			iLocal_125 = vehicle::create_vehicle(joaat("bjxl"), -36.74456f, -1101.583f, 25.42f, 155.1573f, 1, 1);
...
// Position - 0x38C5
int func_75(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	int iVar0;
...
void func_80(int iParam0, var *uParam1) {
	switch (iParam0) {
	case 0:
		func_81(uParam1, "Abigail1", func_83(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0,
				"ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_82(iParam0), 1, 0);
		break;

	case 1:
		func_81(uParam1, "Abigail2", func_83(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0,
				-1, 4, 1, 0, 2359, func_82(iParam0), 1, 0);
		break;

	case 2:
		func_81(uParam1, "Barry1", func_83(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1,
				4, 1, 0, 2359, func_82(iParam0), 1, 0);
		break;

	case 3:
		func_81(uParam1, "Barry2", func_83(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1,
				4, 4, 0, 2359, func_82(iParam0), 1, 1);
		break;

	case 4:
		func_81(uParam1, "Barry3", func_83(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2, 0,
				2359, func_82(iParam0), 0, 0);
		break;

	case 5:
		func_81(uParam1, "Barry3A", func_83(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0, "",
				166, 0, 7, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 6:
		func_81(uParam1, "Barry3C", func_83(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0,
				7, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 7:
		func_81(uParam1, "Barry4", func_83(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4",
				0, 0, -1, 4, 2, 800, 2000, func_82(iParam0), 0, 0);
		break;

	case 8:
		func_81(uParam1, "Dreyfuss1", func_83(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106,
				0, "", 0, 0, -1, 4, 2, 0, 2359, func_82(iParam0), 0, 0);
		break;

	case 9:
		func_81(uParam1, "Epsilon1", func_83(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1, 10,
				4, 1, 0, 2359, func_82(iParam0), 0, 0);
		break;

	case 10:
		func_81(uParam1, "Epsilon2", func_83(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0, 11,
				4, 1, 0, 2359, func_82(iParam0), 1, 0);
		break;

	case 11:
		func_81(uParam1, "Epsilon3", func_83(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars",
				0, 0, 12, 4, 1, 0, 2359, func_82(iParam0), 0, 0);
		break;

	case 12:
		func_81(uParam1, "Epsilon4", func_83(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16,
				"postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_82(iParam0), 0, 0);
		break;

	case 13:
		func_81(uParam1, "Epsilon5", func_83(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16, "epsRobes",
				0, 0, 14, 4, 1, 0, 2359, func_82(iParam0), 1, 0);
		break;

	case 14:
		func_81(uParam1, "Epsilon6", func_83(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0,
				15, 4, 1, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 15:
		func_81(uParam1, "Epsilon7", func_83(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16, "epsDesert",
				0, 0, 16, 4, 1, 0, 2359, func_82(iParam0), 0, 0);
		break;

	case 16:
		func_81(uParam1, "Epsilon8", func_83(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16,
				"epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_82(iParam0), 1, 0);
		break;

	case 17:
		func_81(uParam1, "Extreme1", func_83(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1, 18,
				4, 2, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 18:
		func_81(uParam1, "Extreme2", func_83(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171, 0,
				19, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 19:
		func_81(uParam1, "Extreme3", func_83(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20,
				4, 2, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 20:
		func_81(uParam1, "Extreme4", func_83(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0,
				-1, 4, 2, 0, 2359, func_82(iParam0), 0, 0);
		break;

	case 21:
		func_81(uParam1, "Fanatic1", func_83(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1,
				-1, 4, 1, 700, 2000, func_82(iParam0), 1, 0);
		break;

	case 22:
		func_81(uParam1, "Fanatic2", func_83(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1,
				-1, 4, 4, 700, 2000, func_82(iParam0), 1, 0);
		break;

	case 23:
		func_81(uParam1, "Fanatic3", func_83(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1, 4,
				2, 700, 2000, func_82(iParam0), 0, 1);
		break;

	case 24:
		func_81(uParam1, "Hao1", func_83(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0,
				"controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_82(iParam0), 0, 1);
		break;

	case 25:
		func_81(uParam1, "Hunting1", func_83(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1,
				26, 4, 4, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 26:
		func_81(uParam1, "Hunting2", func_83(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0,
				-1, 4, 4, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 27:
		func_81(uParam1, "Josh1", func_83(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns",
				0, 1, 28, 4, 4, 0, 2359, func_82(iParam0), 1, 0);
		break;

	case 28:
		func_81(uParam1, "Josh2", func_83(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0, 29,
				4, 4, 0, 2359, func_82(iParam0), 1, 1);
		break;

	case 29:
		func_81(uParam1, "Josh3", func_83(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0, 30,
				4, 4, 0, 2359, func_82(iParam0), 1, 1);
		break;

	case 30:
		func_81(uParam1, "Josh4", func_83(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1,
				4, 4, 0, 2359, func_82(iParam0), 1, 0);
		break;

	case 31:
		func_81(uParam1, "Maude1", func_83(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0, "BailBond_Launcher",
				0, 1, -1, 4, 4, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 32:
		func_81(uParam1, "Minute1", func_83(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33,
				4, 4, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 33:
		func_81(uParam1, "Minute2", func_83(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4,
				0, 2359, func_82(iParam0), 0, 1);
		break;

	case 34:
		func_81(uParam1, "Minute3", func_83(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0,
				-1, 4, 4, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 35:
		func_81(uParam1, "MrsPhilips1", func_83(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0,
				"ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_82(iParam0), 0, 0);
		break;

	case 36:
		func_81(uParam1, "MrsPhilips2", func_83(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0,
				2359, func_82(iParam0), 0, 0);
		break;

	case 37:
		func_81(uParam1, "Nigel1", func_83(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1,
				-1, 1, 4, 0, 2359, func_82(iParam0), 1, 0);
		break;

	case 38:
		func_81(uParam1, "Nigel1A", func_83(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0, "",
				0, 0, 42, 4, 4, 0, 2359, func_82(iParam0), 1, 1);
		break;

	case 39:
		func_81(uParam1, "Nigel1B", func_83(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0,
				42, 4, 4, 700, 2000, func_82(iParam0), 1, 1);
		break;

	case 40:
		func_81(uParam1, "Nigel1C", func_83(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0,
				42, 4, 4, 700, 2000, func_82(iParam0), 1, 1);
		break;

	case 41:
		func_81(uParam1, "Nigel1D", func_83(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0,
				42, 4, 4, 700, 2000, func_82(iParam0), 1, 1);
		break;

	case 42:
		func_81(uParam1, "Nigel2", func_83(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0, 43,
				4, 4, 0, 2359, func_82(iParam0), 1, 1);
		break;

	case 43:
		func_81(uParam1, "Nigel3", func_83(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16,
				"postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_82(iParam0), 1, 1);
		break;

	case 44:
		func_81(uParam1, "Omega1", func_83(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0,
				"spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_82(iParam0), 0, 0);
		break;

	case 45:
		func_81(uParam1, "Omega2", func_83(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0,
				-1, 4, 2, 0, 2359, func_82(iParam0), 0, 0);
		break;

	case 46:
		func_81(uParam1, "Paparazzo1", func_83(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1,
				47, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 47:
		func_81(uParam1, "Paparazzo2", func_83(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0, 0,
				48, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 48:
		func_81(uParam1, "Paparazzo3", func_83(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183,
				1, -1, 2, 2, 0, 2359, func_82(iParam0), 0, 0);
		break;

	case 49:
		func_81(uParam1, "Paparazzo3A", func_83(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102, 0,
				"", 0, 0, 51, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 50:
		func_81(uParam1, "Paparazzo3B", func_83(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "", 0,
				0, 51, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 51:
		func_81(uParam1, "Paparazzo4", func_83(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1,
				-1, 4, 2, 0, 2359, func_82(iParam0), 0, 0);
		break;

	case 52:
		func_81(uParam1, "Rampage1", func_83(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4,
				4, 0, 2359, func_82(iParam0), 0, 0);
		break;

	case 54:
		func_81(uParam1, "Rampage3", func_83(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55,
				4, 4, 0, 2359, func_82(iParam0), 1, 0);
		break;

	case 55:
		func_81(uParam1, "Rampage4", func_83(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4,
				4, 0, 2359, func_82(iParam0), 1, 0);
		break;

	case 56:
		func_81(uParam1, "Rampage5", func_83(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0,
				53, 4, 4, 0, 2359, func_82(iParam0), 0, 0);
		break;

	case 53:
		func_81(uParam1, "Rampage2", func_83(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0,
				"rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_82(iParam0), 1, 0);
		break;

	case 57:
		func_81(uParam1, "TheLastOne", func_83(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0,
				1, -1, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 58:
		func_81(uParam1, "Tonya1", func_83(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0,
				"ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 59:
		func_81(uParam1, "Tonya2", func_83(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48,
				"ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
		break;

	case 60:
		func_81(uParam1, "Tonya3", func_83(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0, 2359,
				func_82(iParam0), 0, 1);
		break;

	case 61:
		func_81(uParam1, "Tonya4", func_83(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359,
				func_82(iParam0), 0, 1);
		break;

	case 62:
		func_81(uParam1, "Tonya5", func_83(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0,
				-1, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
		break;
...
// Position - 0x4CBB
void func_81(var *uParam0, char *sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7,
...
// Position - 0x5547
bool func_86() { return Global_101418 > 0; }
...
// Position - 0x55AD
bool func_90() {
	if (streaming::has_model_loaded(Local_47[0 /*20*/]) && streaming::has_model_loaded(Local_47[1 /*20*/]) &&
		weapon::has_weapon_asset_loaded(Local_47[0 /*20*/].f_17) &&
		weapon::has_weapon_asset_loaded(Local_47[1 /*20*/].f_17) && func_54() &&
		streaming::has_anim_dict_loaded("cellphone@") && streaming::has_anim_dict_loaded("cellphone@str") &&
		ai::get_is_waypoint_recording_loaded("reyetarian_simeonoffice") && streaming::has_model_loaded(iLocal_122) &&
...
void func_91(int iParam0) {
	...
	case 1:
		if (!Local_47[iParam0 /*20*/].f_19) {
			if (!func_2(Local_47[iParam0 /*20*/].f_1)) {
				Local_47[iParam0 /*20*/].f_1 = ped::create_ped(
					22, Local_47[iParam0 /*20*/], Local_47[iParam0 /*20*/].f_10, Local_47[iParam0 /*20*/].f_13, 1, 1);
				if (func_2(Local_47[iParam0 /*20*/].f_1)) {
					if (iParam0 == 0) {
						ai::task_start_scenario_at_position(Local_47[iParam0 /*20*/].f_1, "PROP_HUMAN_SEAT_CHAIR",
															vLocal_132[iParam0 /*3*/], fLocal_139[iParam0], 0, 0, 1);
						ped::_0xA3A9299C4F2ADB98(Local_47[iParam0 /*20*/].f_1);
						ped::_0x425AECF167663F48(Local_47[iParam0 /*20*/].f_1, 1);
						ped::set_ped_sphere_defensive_area(Local_47[iParam0 /*20*/].f_1, -37.34785f, -1102.022f,
														   25.42232f, 3f, 0, 0);
					...
					entity::set_entity_can_be_damaged_by_relationship_group(Local_47[iParam0 /*20*/].f_1, 0,
																			iLocal_148);
					...
					if (func_49() == 0) {
						weapon::give_weapon_to_ped(Local_47[iParam0 /*20*/].f_1, Local_47[iParam0 /*20*/].f_17, -1, 1,
												   1);
					}
	...
	case 2:
		if (func_2(Local_47[iParam0 /*20*/].f_1)) {
			if (iLocal_113) {
				...
				ai::close_sequence_task(iLocal_147);
				ai::task_perform_sequence(Local_47[iParam0 /*20*/].f_1, iLocal_147);
				ai::clear_sequence_task(&iLocal_147);
				Local_47[iParam0 /*20*/].f_18 = 3;
			}
			if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 0),
													  entity::get_entity_coords(Local_47[iParam0 /*20*/].f_1, 0),
													  1) >= 250f) {
	...
	case 3:
		if (func_2(Local_47[iParam0 /*20*/].f_1)) {
			func_93(Local_47[iParam0 /*20*/].f_1, &Local_47[iParam0 /*20*/].f_2, -1, 0, 0, 0, -1082130432, 0, -1, -1,
					1);
			if (ai::get_script_task_status(Local_47[iParam0 /*20*/].f_1, 242628503) == 7 ||
...
// Position - 0x5B59
int func_93(int iParam0, var *uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, char *sParam7,
...
void func_94() {
	...
	vehicle::set_all_vehicle_generators_active_in_area(-51.0518f, -1104.685f, 25.2975f, -29.9812f, -1094.079f, 27.5686f,
													   1, 1);
	script::terminate_this_thread();
}
...
// Position - 0x5EAD
void func_96(int iParam0) { Global_101689 = iParam0; }
...
// Position - 0x6104
void func_98(int iParam0) { Global_36332 = gameplay::get_game_timer() + iParam0; }

// Position - 0x6116
void func_99(int iParam0) { func_100(iParam0, 0, func_120(iParam0)); }
...
void func_100(int iParam0, int iParam1, int iParam2) {
	...
	iVar0 = func_119();
	func_110(&iVar0, 0, 0, iParam2, iParam1, 0, 0);
...
// Position - 0x6273
int func_105(int iParam0) { return system::shift_right(iParam0, 4) & 31; }

// Position - 0x6285
int func_106(int iParam0) { return system::shift_right(iParam0, 20) & 63; }

// Position - 0x6298
int func_107(int iParam0) { return system::shift_right(iParam0, 14) & 63; }

// Position - 0x62AB
int func_108(int iParam0) { return system::shift_right(iParam0, 9) & 31; }

// Position - 0x62BE
void func_109(int iParam0, int *iParam1) { Global_101700.f_23954.f_43[iParam0] = *iParam1; }
...
void func_110(int *iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	...
	iVar0 += iParam6;
	func_111(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
int func_119() {
	...
	func_117(&iVar0, time::get_clock_seconds());
	func_116(&iVar0, time::get_clock_minutes());
	func_115(&iVar0, time::get_clock_hours());
	func_113(&iVar0, time::get_clock_day_of_month());
	func_114(&iVar0, time::get_clock_month());
	func_112(&iVar0, time::get_clock_year());
	return iVar0;
}
...
// Position - 0x6975
bool func_123() {
	if (Global_101689 == func_31() && gameplay::get_random_event_flag() && Global_101690) {
		return true;
	}
	return false;
}
...
// Position - 0x75A2
var func_131(var uParam0) { return uParam0; }
...
// Position - 0xAC32
int func_136() { return Global_25191; }
...
// Position - 0xACB0
bool func_139(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6) {
	int iVar0;
	vector3 vVar1;
	int iVar4;
	vector3 vVar5;
...
// Position - 0xB04A
bool func_140(vector3 vParam0, vector3 vParam3, int iParam6) {
	if (iParam6) {
...
// Position - 0xB0B2
int func_142(int iParam0) { return func_143(iParam0, 1); }
...
int func_143(int iParam0, int iParam1) {
	...
	func_144(iParam0, &iVar0, &iVar1, &iVar2, &iVar3, &iVar4, &iVar5);
...
void func_144(int iParam0, int *iParam1, int *iParam2, int *iParam3, int *iParam4, int *iParam5, int *iParam6) {
	func_145(func_119(), iParam0, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6);
}
			...
			if (!ped::is_ped_injured(player::player_ped_id())) {
				...
				case 0:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						Global_25192 || func_157() || func_46(8, -1) || func_156() || func_155() || func_154() ||
						func_153() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 1:
					if (player::is_player_being_arrested(player::player_id(), 1) || func_158() || Global_25192 ||
						func_157() || func_46(8, -1) || func_154() || func_156() || func_155() || func_153() ||
				...
				case 2:
					if (!player::is_player_ready_for_cutscene(player::player_id()) ||
						...
						player::is_player_climbing(player::player_id()) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_158() || Global_100747 ||
						Global_25192 || func_157() || func_46(8, -1) || func_154() || func_156() || func_155() ||
						func_153() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5 || LastDispatchedMessageOrCall != -1) {
						return 0;
					}
					break;
				...
				case 3:
					if (ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) ||
						ped::is_ped_in_combat(player::player_ped_id(), 0) || func_158() || Global_100747 ||
						Global_25192 || func_157() || func_46(8, -1) || func_156() || func_155() || func_153() ||
						G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 4:
					if (func_158() || player::get_player_wanted_level(player::player_id()) > 0 || func_46(8, -1) ||
						func_153() || func_152() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 6:
					if (entity::does_entity_exist(player::player_ped_id())) {
						if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
							...
							func_157() || func_46(8, -1) || func_155() || func_154() || func_153() ||
							G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
							return 0;
						}
					}
				...
				case 7:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						entity::is_entity_in_air(player::player_ped_id()) ||
						ped::is_ped_ragdoll(player::player_ped_id()) || ped::is_ped_falling(player::player_ped_id()) ||
						player::is_player_being_arrested(player::player_id(), 1) || func_158() || func_155() ||
						Global_100747 || Global_25192 || func_157() || Global_36912 || func_46(8, -1) || func_154() ||
						func_152() || func_153() || G_SomeGlobalState.MessageCallStates.f_919[iVar0] == 5) {
						return 0;
					}
					break;
				...
				case 8:
					if (ped::is_ped_in_combat(player::player_ped_id(), 0) ||
						...
						Global_25192 || func_157() || func_46(8, -1) || func_154() || func_152() || func_156() ||
						func_155() || func_153()) {
						return 0;
					}
					break;
...
// Position - 0xBC9D
var func_151() { return Global_91530.f_1; }
...
// Position - 0xBD15
bool func_155() { return Global_91543.f_304 > 0; }

// Position - 0xBD26
bool func_156() { return Global_91543.f_303 > 0; }
...
// Position - 0xBD87
int func_160(int iParam0) { return func_147(func_119(), iParam0); }
