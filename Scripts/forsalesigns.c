...
void func_1() {
	...
	if (iLocal_42) {
		if (func_46(iLocal_44)) {
			if (!func_45() && !ped::is_ped_fleeing(iLocal_44) && !ped::is_ped_ragdoll(iLocal_44) &&
				!ped::is_ped_prone(iLocal_44) && !ped::is_ped_injured(iLocal_44)) {
	...
	while (iVar0 < 15) {
		if (entity::does_entity_exist(Local_210[iVar0 /*11*/])) {
			if (object::has_object_been_broken(Local_210[iVar0 /*11*/]) || func_24(Local_210[iVar0 /*11*/])) {
				gameplay::set_bit(&Global_101700.f_9008.f_108, iVar0);
				func_21(iVar0);
		...
		else if (!gameplay::is_bit_set(Global_101700.f_9008.f_108, iVar0)) {
			func_13(&Local_210[iVar0 /*11*/], iLocal_38, 0, 200f);
		}
		iVar0++;
	}
	func_11();
	if (!iLocal_376 && !iLocal_39) {
		if (func_2(2)) {
			iLocal_37 = 2;
		}
	}
...
bool func_2(int iParam0) {
	...
	if (iParam0 != 2) {
		...
		while (iVar0 < func_4(iParam0)) {
			if (!gameplay::is_bit_set(Global_101700.f_9008.f_108, func_3(func_4(iParam0), iVar0))) {
				return false;
			}
			iVar0++;
		}
...
int func_5(int iParam0) {
	...
	if (iParam0 == 2) {
		...
		while (iVar1 < func_4(iParam0)) {
			if (gameplay::is_bit_set(Global_101700.f_9008.f_108, func_3(func_4(iParam0), iVar1))) {
				iVar0++;
			}
			iVar1++;
		}
		...
		case 0:
			if (!cam::is_screen_faded_out()) {
				...
				if (graphics::has_scaleform_movie_loaded(iLocal_41)) {
					...
					audio::play_sound_frontend(iVar0, "SIGN_DESTROYED", "HUD_AWARDS", 1);
					iLocal_40++;
				}
			}
			break;
...
// Position - 0x9DA
void func_13(var *uParam0, int iParam1, int iParam2, float fParam3) {
...
void func_16(int *iParam0, int *iParam1) {
	if (!ped::is_ped_injured(player::player_ped_id())) {
		if (gameplay::get_distance_between_coords(entity::get_entity_coords(player::player_ped_id(), 1),
												  entity::get_entity_coords(*iParam0, 1), 1) >= 110f &&
			!entity::is_entity_on_screen(*iParam0)) {
			func_17(iParam0);
			*iParam1 = 0;
		}
	}
...
void func_35() {
	...
	if (entity::does_entity_exist(player::player_ped_id())) {
		if (func_38(Global_101700.f_2095.f_539.f_3549) != entity::get_entity_model(player::player_ped_id())) {
			...
			if (func_36(iVar0) && (!func_39(14) || Global_100652)) {
	...
	while (iVar1 < iVar0) {
		if (func_46(uVar2[iVar1])) {
			if (entity::get_entity_model(uVar2[iVar1]) == func_50(58)) {
				...
				ped::set_ped_can_be_targetted(iLocal_44, 0);
...
void func_62() {
	...
	if (fVar8 > 0f && system::floor(fVar8) < system::floor(Global_101700.f_9153.f_3853)) {
		func_64(13, system::floor(Global_101700.f_9153.f_3853));
	}
...
// Position - 0x2888
int func_63() { return Global_25190; }
