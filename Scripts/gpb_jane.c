...
void func_51(int iParam0, char *sParam1, char *sParam2) {
	...
	switch (iParam0) {
	case 1: StringCopy(sParam2, "WereNotACult", 64); break;

	case 2: StringCopy(sParam2, "YesIKnow", 64); break;

	case 3: StringCopy(sParam2, "ItsTimeToUtilise", 64); break;

	case 4: StringCopy(sParam2, "DontBelieveWhatOthers", 64); break;

	case 5: StringCopy(sParam2, "BrotherAdrianHasShown", 64); break;

	case 6: StringCopy(sParam2, "IHearYou", 64); break;

	case 7: StringCopy(sParam2, "ItsTimeTo", 64); break;
	}
}
