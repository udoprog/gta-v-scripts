...
void __EntryFunction__() {
	...
	while (true) {
		...
		if (func_430(player::player_ped_id())) {
			...
			case 1: func_238(); break;

			case 2: func_132(); break;

			case 3: func_90(); break;

			case 4: func_27(); break;

			case 5: func_1(); break;
			}
			if (iLocal_92 != 5) {
				if (iLocal_92 >= 0 && !iLocal_40) {
				}
			}
		}
		system::wait(0);
...
void func_27() {
	...
	case 2:
		...
		if (iVar0 == 0) {
			if (func_55(&iLocal_105, &cLocal_214, &uLocal_293)) {
				func_52();
				func_47();
			}
		}
	...
	if (iParam0) {
		...
		if (network::network_is_game_in_progress()) {
			if (!ped::is_ped_injured(player::player_ped_id()) && !func_36(player::player_id()) &&
				!func_33(player::player_id(), 0) && !func_32()) {
...
// Position - 0x16A9
bool func_32() { return gameplay::is_bit_set(Global_1591201[player::player_id() /*602*/].f_39.f_18, 14); }
...
// Position - 0x1752
var func_35() { return Global_1312735; }
...
// Position - 0x182E
int func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
// Position - 0x1D58
bool func_55(int *iParam0, char *sParam1, var *uParam2) {
	switch (*iParam0) {
	case 0:
		if (func_85()) {
...
// Position - 0x2038
int func_63(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
// Position - 0x22AF
int func_65() { return Global_69964; }
...
//Position - 0x23E9
bool func_70(var* uParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	Global_2621441 = 0;
	return func_71(sParam4, iParam5, iParam9);
}
...
void func_90() {
	...
	switch (iLocal_93) {
	case 0:
		if (func_104(iLocal_92, iLocal_40)) {
	...
	case 1:
		...
		if (func_95(iLocal_268, vLocal_224, &iLocal_218, iLocal_95, iLocal_94, &iLocal_229, &iLocal_241, &uLocal_238,
					&iLocal_237, &iLocal_213, 11f)) {
			if (!func_94()) {
				if (func_55(&iLocal_105, &cLocal_214, &uLocal_293)) {
					if (func_5(vehicle::get_entity_attached_to_tow_truck(iLocal_268))) {
						vehicle::detach_vehicle_from_any_tow_truck(entity::get_vehicle_index_from_entity_index(
							vehicle::get_entity_attached_to_tow_truck(iLocal_268)));
					}
					func_52();
					func_47();
				}
...
// Position - 0x2EE4
int func_91(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6) {
	bool bVar0;
	float fVar1;
...
// Position - 0x2FBC
bool func_95(int iParam0, vector3 vParam1, int *iParam4, int iParam5, int iParam6, int *iParam7, int *iParam8,
			 var *uParam9, int *iParam10, int *iParam11, float fParam12) {
	float fVar0;
...
// Position - 0x3227
bool func_98(float fParam0, int iParam1) {
	int iVar0;
...
// Position - 0x32AB
void func_99(int *iParam0, vector3 vParam1, int iParam4) {
	if (!ui::does_blip_exist(*iParam0)) {
		*iParam0 = func_100(vParam1, 5, iParam4);
	}
}

// Position - 0x32CC
int func_100(vector3 vParam0, int iParam3, int iParam4) {
	int iVar0;
...
// Position - 0x3353
void func_102(int *iParam0, vector3 vParam1, int *iParam4, int iParam5, int *iParam6, int *iParam7) {
	switch (*iParam4) {
	case 0:
		if (player::get_player_wanted_level(player::player_id()) > 0) {
			*iParam4 = 1;
...
bool func_104(int iParam0, int iParam1) {
	...
	case 0:
		if (iParam1) {
			...
			if (!func_443()) {
				...
				else if (func_118(2, Local_282.f_1, Local_282.f_4) && func_118(5, Local_270.f_1, Local_270.f_4) &&
						 func_118(6, Local_276.f_1, Local_276.f_4) && func_118(3, Local_252.f_1, Local_252.f_4) &&
						 func_118(4, vLocal_221, 0)) {
					iLocal_291 = ped::add_scenario_blocking_area(-417.198f, -2155.886f, 8.36266f, -383.4908f,
																 -2188.511f, 12.9213f, 0, 1, 1, 1);
					func_116(34);
					vehicle::set_vehicle_model_is_suppressed(joaat("trash"), 1);
					vehicle::set_vehicle_model_is_suppressed(joaat("towtruck"), 1);
					if (func_430(Local_252)) {
						if (!func_115(Local_252, -2017877118)) {
							ai::task_play_anim_advanced(
								Local_252, "mini@repair", "fixing_a_ped",
								entity::get_offset_from_entity_in_world_coords(Local_270, vLocal_249), 0f, 0f,
								-entity::get_entity_heading(Local_270), 1000f, -1.5f, -1, 1, 0, 2, 0);
	...
	case 1:
		if (iParam1) {
			if (func_118(2, Local_282.f_1, Local_282.f_4) && func_118(5, Local_270.f_1, Local_270.f_4) &&
				func_118(4, vLocal_221, 0) && func_118(6, Local_276.f_1, Local_276.f_4) &&
				func_118(3, entity::get_offset_from_entity_in_world_coords(Local_270, vLocal_249),
						 -entity::get_entity_heading(Local_270))) {
...
// Position - 0x3973
bool func_107() { return gameplay::is_bit_set(Global_91491.f_20, 13); }

// Position - 0x3987
void func_108(int iParam0, vector3 vParam1, float fParam4) {
	if (func_430(iParam0)) {
...
bool func_118(int iParam0, vector3 vParam1, float fParam4) {
	...
	case 4:
		...
		if (streaming::has_anim_dict_loaded("mini@repair") &&
			streaming::has_anim_dict_loaded("amb@code_human_cower@male@enter")) {
			return true;
		}
		break;
...
// Position - 0x3E5D
bool func_119(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8,
			  int iParam9) {
	if (!entity::does_entity_exist(*iParam0)) {
...
// Position - 0x3F0C
bool func_121(int iParam0, char *sParam1, int iParam2) {
...
// Position - 0x3F3B
bool func_122(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6) {
	if (!entity::does_entity_exist(*iParam0)) {
		if (func_121(iParam1, "Loading", 0)) {
...
// Position - 0x3FED
void func_123(int iParam0, int iParam1) { Global_91491.f_22[iParam1] = iParam0; }

// Position - 0x4003
int func_124(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7) {
	if (fParam6 < 0f) {
		fParam6 = 0f;
	}
	if (!iParam7) {
...
// Position - 0x407E
void func_125(int *iParam0, int iParam1, int *iParam2, int *iParam3, int *iParam4, vector3 vParam5, int iParam8,
	...
	if (func_6(*iParam0)) {
		...
		case 0:
			if (ped::is_ped_in_vehicle(player::player_ped_id(), *iParam0, 0)) {
				...
				*iParam2 = 3;
				...
				if (func_88(func_97(func_65(), iParam9), 0, 0)) {
					ui::clear_this_print(func_97(func_65(), iParam9));
				}
				if (func_65() != 33) {
					func_128(iParam0);
				}
		...
		case 2:
		case 1:
			if (!ped::is_ped_in_vehicle(player::player_ped_id(), *iParam0, 0) && !func_131(*iParam0) &&
				!func_130(*iParam0)) {
				func_26(iParam4);
...
int func_130(int iParam0) {
	...
	if (func_430(player::player_ped_id()) && ped::is_ped_in_any_vehicle(player::player_ped_id(), 0) &&
		func_6(iParam0)) {
...
void func_132() {
	...
	case 1:
		...
		func_139();
		if (!iLocal_243) {
			if (func_137(iLocal_268, vLocal_224, &iLocal_218, iLocal_94, iLocal_95, &iLocal_213, &iLocal_241, 0, 0,
						 11f)) {
				iLocal_93 = 2;
			}
		}
...
// Position - 0x4770
bool func_137(int iParam0, vector3 vParam1, int *iParam4, int iParam5, int iParam6, int *iParam7, int *iParam8,
	...
	if (iParam6 == 1 || iParam6 == 2 || iParam6 == 3) {
		if (iParam5 == 0) {
			...
			if (!func_138()) {
				func_103(func_97(func_65(), iParam9), iParam7);
			}
		}
	}
	else if (iParam5 == 0) {
...
bool func_140(int iParam0, int iParam1) {
	...
	case 0:
		...
		if (pathfind::_0xF7B79A50B905A30D(-632.498f, -2424.908f, 1710.123f, -1791.79f)) {
			ai::task_vehicle_mission_coors_target(iParam1, ped::get_vehicle_ped_is_in(iParam1, 0), vLocal_224, 4, 20f,
												  786469, 2f, 10f, 1);
			iLocal_97[iParam0] = 5;
		}
		break;
		...
		case 0:
			...
			if (!gameplay::is_position_occupied(vVar0, 1.5f, 0, 0, 1, 0, 0, Local_252, 0)) {
				if (!iLocal_248) {
					...
					iLocal_248 = func_142(&uLocal_293, cLocal_292, sVar6, 7, 0, 0, 0);
				}
				else {
...
int func_144(int iParam0, int iParam1) {
	if (!func_145()) {
		if (entity::does_entity_exist(iLocal_268) && vehicle::is_vehicle_driveable(iLocal_268, 0) &&
			!entity::is_entity_at_coord(iLocal_268, vLocal_224, 2f, 2f, 2f, 0, 1, 0)) {
			if (ped::is_ped_in_vehicle(player::player_ped_id(), iLocal_268, 0) &&
				player::get_player_wanted_level(player::player_id()) == 0 &&
				vehicle::get_ped_in_vehicle_seat(iLocal_268, -1, 0) != player::player_ped_id()) {
				if (ped::is_ped_in_vehicle(iParam1, iLocal_268, 0) &&
					vehicle::get_ped_in_vehicle_seat(iLocal_268, -1, 0) == iParam1) {
...
int func_146(int iParam0, int iParam1) {
	if (!func_145()) {
		if (func_430(Local_252)) {
			if (entity::is_entity_in_angled_area(iParam1, -408.0286f, -2175.476f, 5.31836f, -394.644f, -2175.297f,
												 15.31835f, 21.52f, 0, 1, 0) &&
				!func_147(iParam0) && !ped::is_ped_in_melee_combat(Local_252) &&
				!ped::is_ped_in_any_vehicle(iParam1, 0)) {
...
void func_150() {
	...
	if (func_430(Local_252)) {
		...
		case 2:
			if (func_6(Local_270)) {
				if (func_89(Local_270, Local_270.f_1, 2f)) {
					if (func_89(Local_252, entity::get_offset_from_entity_in_world_coords(Local_270, -1f, 0.5f, 0f),
								2f)) {
						func_197(4);
						return;
					}
		...
		case 9:
			if (func_196(Local_252, player::player_ped_id(), 20f, 1) &&
			...
			if (gameplay::get_game_timer() - Local_252.f_14 > gameplay::get_random_int_in_range(1500, 2500)) {
				if (!func_115(Local_252, 780511057)) {
					if (!ped::is_ped_sitting_in_any_vehicle(Local_252)) {
						if (func_196(Local_252, player::player_ped_id(), 10f, 1)) {
							func_197(10);
						}
		...
		case 10:
			if (gameplay::get_game_timer() - Local_252.f_14 > gameplay::get_random_int_in_range(1500, 2500)) {
				if (!func_195()) {
					...
					if (!func_196(Local_252, Local_276, 15f, 1) && !ped::is_ped_on_foot(player::player_ped_id())) {
						func_197(8);
					}
				}
				else if (bLocal_227) {
					if (func_6(Local_282)) {
						if (!func_196(Local_252, Local_282, 10f, 1)) {
							func_197(7);
						}
					}
				}
					...
					if (func_6(Local_270)) {
						if (!func_196(Local_252, Local_270, 10f, 1)) {
							func_197(6);
						}
					}
				}
		...
		case 14:
			if (!func_196(Local_252, player::player_ped_id(), 118f, 1)) {
		...
		case 13:
			...
			else if (func_189(Local_252, 1, 0, 0, 0)) {
				func_197(14);
			}
			break;
		...
		case 15:
			if (weapon::is_ped_armed(player::player_ped_id(), 6)) {
				if (func_182(Local_252, player::player_ped_id(), 1126825984, 1, 250, 7)) {
					func_181();
					return;
				}
			}
		...
		case 16:
			if (func_6(Local_282)) {
				if (ped::is_ped_in_vehicle(Local_252, Local_282, 0)) {
					if (func_177(Local_282, &iLocal_230, &iLocal_231, &iLocal_232, &fLocal_233, 3, 2f)) {
						...
						ai::task_perform_sequence(Local_252, iVar0);
						ai::clear_sequence_task(&iVar0);
						func_176(&iLocal_20, 0, 0);
						iLocal_96 = 14;
					}
					else {
						func_154(&iLocal_20, Local_282, 0, 0, 1, 1, 1);
					}
				}
			}
			break;
		...
		case 17:
			if (gameplay::get_game_timer() - Local_252.f_14 > gameplay::get_random_int_in_range(10000, 12000)) {
				if (!entity::is_entity_in_angled_area(player::player_ped_id(), -414.4899f, -2181.967f, 11.93531f,
													  -414.1714f, -2170.252f, 5.64993f, 12.63f, 0, 1, 0)) {
					func_197(5);
				}
				else {
					func_197(17);
		...
		if (func_6(Local_270)) {
			if (!func_89(Local_270, Local_270.f_1, 50f) || !func_196(player::player_ped_id(), Local_270, 250f, 1)) {
				func_127(&Local_270);
			}
		}
...
// Position - 0x574B
int func_152(int iParam0, var *uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6,
...
void func_154(int *iParam0, int iParam1, char *sParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	func_155(iParam0, iParam1, sParam2, iParam3, iParam4, iParam5, iParam6);
}

// Position - 0x5919
void func_155(int *iParam0, int iParam1, char *sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6) {
	iParam0->f_6 = 0;
	func_156(iParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

// Position - 0x593B
void func_156(int *iParam0, int iParam1, vector3 vParam2, char *sParam5, int iParam6, bool bParam7, var uParam8,
			  bool bParam9) {
	int iVar0;
	int iVar1;
	...
	if (func_173(iParam1) && entity::is_entity_visible(iParam1)) {
		...
		if (!cam::is_gameplay_hint_active()) {
			if (func_168(iParam0, bParam7, bParam9, 0)) {
				func_164(iParam0, iParam1, vParam2, iParam6);
			}
			if (*iParam0) {
				*iParam0 = 0;
			}
			...
			if (!func_168(iParam0, bParam7, bParam9, 0)) {
				if (!*iParam0 && !iParam0->f_1 && !func_158(iParam0)) {
					func_157(iParam0);
				}
			}
		}
...
bool func_161(char *sParam0) {
	if (!func_162(1, 1, 0)) {
		if (!gameplay::is_string_null_or_empty(sParam0) && func_175(sParam0) || func_175("CMN_HINT")) {
			ui::clear_help(1);
		}
		return false;
	}
...
// Position - 0x6012
bool func_163() { return gameplay::get_game_timer() <= Global_17290.f_5745 + 100; }

// Position - 0x6027
void func_164(int *iParam0, int iParam1, vector3 vParam2, int iParam5) {
	int iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
...
// Position - 0x612C
int func_165() { return func_166(player::player_id()); }
...
// Position - 0x61A2
bool func_168(var *uParam0, bool bParam1, bool bParam2, int iParam3) {
	if (uParam0->f_1) {
	...
	case 0:
		...
		if (uParam0->f_6 == 0) {
			if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
				if (func_172(bParam1, bParam2, iParam3)) {
					uParam0->f_4 = gameplay::get_game_timer();
					uParam0->f_5 = 1;
					uParam0->f_7 = 1;
				}
			}
			else if (func_171(bParam1, bParam2, iParam3)) {
				uParam0->f_4 = gameplay::get_game_timer();
				uParam0->f_5 = 1;
				uParam0->f_7 = 1;
			}
			...
			if (func_171(bParam1, bParam2, iParam3)) {
				uParam0->f_4 = gameplay::get_game_timer();
				uParam0->f_5 = 1;
				uParam0->f_7 = 1;
			}
	...
	case 2:
		if (uParam0->f_6 == 0) {
			...
			if (!func_171(bParam1, bParam2, iParam3) || ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
				uParam0->f_5 = 0;
			}
		}
		else if (uParam0->f_6 == 2) {
			...
			else if (!func_172(bParam1, bParam2, iParam3)) {
				uParam0->f_5 = 0;
			}
		}
		break;
	...
	case 3:
		if (gameplay::get_game_timer() - uParam0->f_4 > 500) {
			if (uParam0->f_6 == 0) {
				if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 1)) {
					if (func_170(bParam1, bParam2, iParam3)) {
						uParam0->f_5 = 0;
					}
				}
				else if (func_169(bParam1, bParam2, iParam3)) {
					uParam0->f_5 = 0;
				}
			}
			else if (uParam0->f_6 == 1) {
				if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 1) || func_169(bParam1, bParam2, iParam3)) {
					uParam0->f_5 = 0;
				}
			}
			else if (uParam0->f_6 == 2) {
				...
				else if (func_170(bParam1, bParam2, iParam3)) {
					uParam0->f_5 = 0;
				}
			}
		}
	...
	if (!func_162(bParam1, bParam2, iParam3)) {
		uParam0->f_5 = 0;
		uParam0->f_7 = 0;
	}
	if (uParam0->f_7) {
...
// Position - 0x66B9
void func_174() { gameplay::set_bit(&G_SleepModeOffOn11, 4); }
...
// Position - 0x67B9
bool func_177(int iParam0, int *iParam1, int *iParam2, int *iParam3, float *fParam4, int iParam5, float fParam6) {
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
		...
		vVar1 = {func_179(entity::get_entity_coords(iVar0, 1) - entity::get_entity_coords(iParam0, 1))};
		vVar4 = {entity::get_entity_velocity(iParam0) - entity::get_entity_velocity(iVar0)};
		*fParam4 = func_178(vVar4, vVar1);
	}
	return false;
}
			...
			if (!func_89(Local_252, entity::get_offset_from_entity_in_world_coords(Local_270, vLocal_249), 0.5f)) {
				if (!func_115(Local_252, 713668775)) {
					ai::task_follow_nav_mesh_to_coord(
						Local_252, entity::get_offset_from_entity_in_world_coords(Local_270, vLocal_249), 1f, 60000,
						0.3f, 512, -entity::get_entity_heading(Local_270));
				}
			}
...
void func_181() {
	if (weapon::is_ped_armed(player::player_ped_id(), 6)) {
		if (!func_196(player::player_ped_id(), Local_252, 10f, 1)) {
			func_197(14);
		}
		else {
			func_197(13);
	...
	else if (iLocal_96 != 15 && iLocal_96 != 9 && iLocal_96 != 10 && iLocal_96 != 6 && iLocal_96 != 8 &&
			 iLocal_96 != 7) {
		func_197(15);
	}
}
...
bool func_182(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5) {
	...
	iVar0 = func_183(&Local_50[iVar4 /*4*/], vVar1, iParam1, &Local_50[iVar4 /*4*/].f_3, iParam0, iParam5);
	return iVar0 || gameplay::get_game_timer() - Local_50[iVar4 /*4*/].f_3 < iParam4;
}

// Position - 0x6A9F
int func_183(int *iParam0, vector3 vParam1, int iParam4, var *uParam5, int iParam6, int iParam7) {
	var uVar0;
	vector3 vVar1;
	var uVar4;
	int iVar7;
	...
	if (*iParam0 == 0) {
		vVar1 = {func_184(iParam4, iParam7)};
		*iParam0 =
...
int func_186(int iParam0, int iParam1, float fParam2, int iParam3) {
	...
	if (iParam3 == 0) {
		...
		vVar3 = {func_179(ped::get_ped_bone_coords(iParam0, 31086, 0f, 5f, 0f) -
...
// Position - 0x6DC5
bool func_189(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_5(player::player_ped_id()) && func_5(iParam0)) {
		...
		if (!iParam2) {
			if (func_193(iParam0, iParam1, fVar0, fVar1)) {
				return true;
			}
			if (func_190(iParam0, fVar1, iParam3, iParam4)) {
				return true;
			}
		}
		else {
...
// Position - 0x6EC0
bool func_190(int iParam0, float fParam1, int iParam2, int iParam3) {
	vector3 vVar0;
	vector3 vVar3;
...
bool func_191(int iParam0, float fParam1) {
	...
	if (gameplay::_0x82FDE6A57EE4EE44(iParam0, joaat("weapon_grenade"), fParam1, &vVar1, &uVar0, 0) ||
		...
		if (func_192(iParam0, vVar1, 90f, 0)) {
			return true;
		}
	}
	return false;
...
// Position - 0x7061
bool func_192(int iParam0, vector3 vParam1, float fParam4, int iParam5) {
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
// Position - 0x70EF
bool func_193(int iParam0, int iParam1, float fParam2, float fParam3) {
	if (iParam1) {
		if (ped::is_ped_shooting(player::player_ped_id())) {
...
bool func_195() {
	...
	else if (func_196(Local_252, player::player_ped_id(), 10f, 1)) {
...
void func_198(int iParam0) {
	...
	case 2:
		if (!func_115(Local_252, 713668775)) {
			if (func_6(Local_282)) {
				ai::task_follow_nav_mesh_to_coord(
					Local_252, entity::get_offset_from_entity_in_world_coords(Local_270, -1f, 0.5f, 0f), 1f, 30000,
					0.25f, 0, 141.2603f);
			}
		}
		break;

	case 5: func_180(); break;
	...
	case 16:
		if (!func_115(Local_252, 242628503)) {
			if (func_6(Local_282)) {
				...
				ai::task_perform_sequence(Local_252, iVar1);
				ai::clear_sequence_task(&iVar1);
				func_199(&iLocal_230, &iLocal_231, &iLocal_232, &fLocal_233);
			}
		}
		break;
...
void func_201(int iParam0) {
	switch (iParam0) {
	case 1:
		if (func_210(Local_252, 20f)) {
			func_209("FP2_RPAIR", 0, 5000);
		}
		break;

	case 3: func_206("FP2_REACTTOW", iParam0, 1); break;

	case 2: func_206("FP2_REACTCAR", iParam0, 0); break;
	...
	case 7: func_206("FP2_ENTTOW", iParam0, 0); break;

	case 6: func_206("FP2_ENTCAR", iParam0, 0); break;
...
void func_202(char *sParam0) {
	audio::_play_ambient_speech_with_voice(Local_252, sParam0, "S_M_M_TRUCKER_01_BLACK_FULL_02", "SPEECH_PARAMS_FORCE",
										   0);
}
...
void func_206(char *sParam0, int iParam1, int iParam2) {
	...
	if (iLocal_96 != iParam1 && !ui::is_message_being_displayed()) {
		Var0 = {func_208()};
		if (!gameplay::are_strings_equal(&Var0, sParam0) && !ai::is_ped_in_writhe(Local_252) &&
			!ped::is_ped_ragdoll(Local_252) && !ped::is_ped_being_stunned(Local_252, 0) &&
			!ped::is_ped_being_stealth_killed(Local_252)) {
...
bool func_210(int iParam0, float fParam1) {
	...
	if (func_430(player::player_ped_id()) && func_430(iParam0)) {
		if (func_212(player::player_ped_id(), iParam0, 0) <= fParam1 && func_211(iParam0, player::player_ped_id())) {
			return true;
		}
	}
	return false;
...
void func_215() {
	if (iLocal_96 != 14 && iLocal_96 != 13) {
		if (func_223(Local_252, 1090519040, 1097859072)) {
			func_197(14);
			return;
		}
		if (!func_222() || entity::has_entity_been_damaged_by_entity(Local_252, player::player_ped_id(), 1)) {
			if (func_196(player::player_ped_id(), Local_252, 30f, 1)) {
				if (func_217(Local_252, 1, 50f, 150f, 0, 1, 0, 0)) {
					func_216();
					return;
				}
			}
...
void func_216() {
	if (!ped::is_ped_in_any_vehicle(Local_252, 1)) {
		...
		if (func_6(Local_282)) {
			if (ped::is_ped_in_vehicle(Local_252, Local_282, 0)) {
				ai::task_vehicle_mission_ped_target(Local_252, Local_282, player::player_ped_id(), 8, 30f, 786469, 300f,
													2f, 1);
				iLocal_96 = 14;
				return;
			}
		...
		if (func_6(Local_270)) {
			if (ped::is_ped_in_vehicle(Local_252, Local_270, 0)) {
				ai::task_vehicle_mission_ped_target(Local_252, Local_270, player::player_ped_id(), 8, 30f, 786469, 300f,
													2f, 1);
				iLocal_96 = 14;
				return;
			}
		...
		if (func_6(Local_276)) {
			if (ped::is_ped_in_vehicle(Local_252, Local_276, 0)) {
				ai::task_vehicle_mission_ped_target(Local_252, Local_276, player::player_ped_id(), 8, 30f, 786469, 300f,
													2f, 1);
				iLocal_96 = 14;
			}
		}
...
// Position - 0x7E5D
bool func_217(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6,
			  int iParam7) {
	vector3 vVar0;
	...
	if (func_5(player::player_ped_id()) && func_5(iParam0)) {
		...
		if (func_189(iParam0, iParam1, iParam5, iParam6, iParam7)) {
			return true;
		}
		if (!weapon::is_ped_armed(player::player_ped_id(), 6)) {
			if (ped::is_ped_in_melee_combat(player::player_ped_id())) {
				...
				if (vVar0.x * vVar0.x + vVar0.y * vVar0.y + vVar0.z * vVar0.z <= 5f) {
					return func_221(player::player_ped_id(), iParam0, fParam2);
				}
			}
		}
		if (iParam4) {
...
// Position - 0x7F8E
bool func_219(int iParam0, float fParam1) { return func_182(iParam0, player::player_ped_id(), fParam1, 1, 250, 7); }
...
int func_222() {
	if (entity::is_entity_at_coord(player::player_ped_id(),
								   entity::get_offset_from_entity_in_world_coords(Local_252, 0f, -2f, 0f), 2f, 3f, 2f,
								   0, 1, 0) &&
		!weapon::is_ped_armed(player::player_ped_id(), 6)) {
		return 1;
	}
...
// Position - 0x8088
void func_224() {
	if (iLocal_96 != 6 && iLocal_96 != 7 && iLocal_96 != 8 && iLocal_96 != 9 && iLocal_96 != 10 && iLocal_96 != 14 &&
		iLocal_96 != 13) {
		if (bLocal_227 || iLocal_95 == 1) {
			if (!entity::is_entity_in_angled_area(player::player_ped_id(), -419.0416f, -2179.051f, 8.78829f, -389.5436f,
												  -2179.148f, 20.31836f, 25f, 0, 1, 0)) {
				if (!ped::is_ped_sitting_in_any_vehicle(Local_252)) {
					if (func_6(Local_276)) {
						func_197(8);
					}
...
void func_225() {
	if (func_6(Local_282)) {
		if (func_228() && iLocal_96 != 6 && iLocal_96 != 11 && iLocal_96 != 8) {
			...
			if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
				if (func_196(Local_282, player::player_ped_id(), 6f, 1)) {
		...
		if (func_228() && iLocal_96 != 7 && iLocal_96 != 8) {
			if (iLocal_96 != 2) {
				if (iLocal_96 != 4) {
					...
					if (ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
						if (func_196(Local_270, player::player_ped_id(), 6f, 1)) {
	...
	else if (func_228() && iLocal_96 != 7 && iLocal_96 != 6 && iLocal_96 != 8 && iLocal_96 != 11 && iLocal_96 != 16 &&
			 iLocal_96 != 7) {
		func_197(16);
	}
}
...
bool func_226() {
	if (func_227()) {
		if (iLocal_95 == 0 && !bLocal_227) {
			if (iLocal_96 == 11 && func_196(Local_252, player::player_ped_id(), 5f, 1)) {
				return false;
			}
			return true;
		}
...
// Position - 0x833A
bool func_227() {
	if (iLocal_96 == 5 || iLocal_96 == 1 || iLocal_96 == 17 || !func_228() || iLocal_92 == 2 || iLocal_96 == 20 ||
		iLocal_96 == 19) {
		return false;
	}
	return true;
...
// Position - 0x838E
int func_228() {
	if (iLocal_96 != 14 && iLocal_96 != 13 && iLocal_96 != 15 && iLocal_96 != 9 && iLocal_96 != 10 && iLocal_96 != 16 &&
		iLocal_96 != 12) {
		return 1;
	}
	return 0;
...
bool func_230(int *iParam0) {
	if (func_196(Local_252, player::player_ped_id(), 2f, 1) || ped::is_ped_in_any_vehicle(player::player_ped_id(), 0)) {
...
void func_232() {
	if (iLocal_96 != 17 && iLocal_96 != 14 && iLocal_96 != 13 && iLocal_96 != 15) {
		if (fLocal_239 < 20f) {
			if (entity::is_entity_in_angled_area(player::player_ped_id(), -414.4899f, -2181.967f, 11.93531f, -414.1714f,
												 -2170.252f, 5.64993f, 12.63f, 0, 1, 0)) {
				fLocal_239 += gameplay::get_frame_time();
			}
		}
		else {
			func_197(17);
...
void func_233() {
	if (iLocal_96 != 20) {
		if (func_196(player::player_ped_id(), Local_252, 15f, 1)) {
...
// Position - 0x86A9
void func_237() {
	if (func_430(Local_252) && iLocal_96 != 15) {
		if (func_89(Local_252, vLocal_224, 200f)) {
			iLocal_243 = 1;
		}
		if (!func_196(Local_252, player::player_ped_id(), 150f, 1) && !entity::is_entity_on_screen(Local_252)) {
			fLocal_236 += gameplay::get_frame_time();
			if (fLocal_236 > 10f) {
		...
		else if (!func_196(Local_252, player::player_ped_id(), 200f, 1)) {
			if (entity::is_entity_on_screen(Local_252)) {
				func_194(&Local_252, 0, 1, 1);
				func_127(&Local_270);
			}
...
void func_240() {
	...
	case 0:
		if (func_104(iLocal_92, 0)) {
			...
			func_373(34);
			if (func_443()) {
				gameplay::clear_area_of_vehicles(-399.8117f, -2172.942f, 9.3184f, 50f, 0, 0, 1, 1, 0);
	...
	case 2: func_92(0); break;
	}
}

// Position - 0x89A1
void func_241(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) {
	int iVar0;
	int iVar1;
...
// Position - 0x8A10
void func_242() { Global_17151.f_6 = 1; }
...
// Position - 0x8C73
void func_252() { streaming::set_model_as_no_longer_needed(Local_282.f_5); }
...
void func_254(int iParam0, int iParam1) {
	...
	func_255(0f, 0f, 0f, 0, 0, 0, 1, 1, 1, iParam1, 1, 1, 1);
}

// Position - 0x8D16
void func_255(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8,
...
// Position - 0x8EE7
int func_257(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
	...
	if (iParam1 == 12) {
				...
				if (gameplay::is_bit_set(Global_69523[1 /*14*/].f_6, 0)) {
					if (iVar0 == 13) {
						...
						while (iVar1 <= 8) {
							...
							func_277(iParam0, Global_69523[1 /*14*/].f_12, Global_69523[1 /*14*/].f_3,
						...
						if (iParam4 == -1) {
							ped::set_ped_component_variation(iParam0, func_267(iVar0), Global_69523[1 /*14*/].f_3,
															 Global_69523[1 /*14*/].f_4,
															 ped::get_ped_palette_variation(iParam0, func_267(iVar0)));
						}
						else {
							ped::set_ped_component_variation(iParam0, func_267(iVar0), Global_69523[1 /*14*/].f_3,
		...
		if (iParam4 == -1) {
			ped::set_ped_component_variation(iParam0, func_267(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4,
											 ped::get_ped_palette_variation(iParam0, func_267(iParam1)));
		}
		else {
			ped::set_ped_component_variation(iParam0, func_267(iParam1), Global_69523[1 /*14*/].f_3,
											 Global_69523[1 /*14*/].f_4, iParam4);
...
bool func_258(int iParam0, int iParam1, int *iParam2) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_63 != -99) {
		if (!func_371(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_64,
...
// Position - 0x994C
bool func_263(int iParam0, int iParam1, int iParam2, int iParam3, var *uParam4, var *uParam5) {
	var uVar0;
	int iVar10;
...
bool func_265(int iParam0, int iParam1, int *iParam2, int iParam3) {
	...
	if (Global_101700.f_2095.f_539[iVar0 /*65*/].f_60 != -99) {
		if (!func_371(iParam0, Global_101700.f_2095.f_539[iVar0 /*65*/].f_61,
...
// Position - 0xA4D7
var func_269(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) {
	int *iVar0;
	int iVar1;
	int iVar2;
	int iVar3;
...
// Position - 0xB08A
int func_270(int iParam0, int iParam1, int iParam2, int iParam3, int *iParam4) {
	int iVar0;
...
void func_277(int iParam0, int iParam1, int iParam2, int iParam3) {
	...
	if (iParam2 == -1) {
		...
		if (iParam1 == 0) {
			...
			if (func_278(entity::get_entity_model(iParam0), 14, iVar0,
		...
		if (iVar4 != iParam1) {
			...
			while (iVar5 <= iVar6 - 1) {
				if (iVar4 == iParam1 && iVar5 == iParam2) {
					iVar3 += func_283(iParam0, iParam3);
					return iVar3;
				}
				else {
					iVar3++;
...
struct<10> func_286(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		switch (iParam1) {
		case 31: func_288(&Var1, 0, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 0: func_288(&Var1, 10, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_288(&Var1, 19, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_288(&Var1, 14, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_288(&Var1, 18, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_288(&Var1, 0, 59, 112, 3, 4, 5, 6, 7, 8); break;

		case 5: func_288(&Var1, 0, 60, 112, 3, 4, 5, 6, 7, 8); break;

		case 6: func_288(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_288(&Var1, 0, 60, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_288(&Var1, 55, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_288(&Var1, 0, 1, 112, 3, 4, 5, 6, 7, 8); break;

		default: func_287(&Var1, iParam0, iParam1, 10); break;
		}
		break;
	...
	case joaat("player_one"):
		...
		case 1: func_288(&Var1, 0, 82, 158, 3, 4, 5, 6, 7, 8); break;

		case 2: func_288(&Var1, 0, 1, 158, 3, 4, 5, 6, 7, 8); break;

		case 3: func_288(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_288(&Var1, 41, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_288(&Var1, 40, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_288(&Var1, 41, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_288(&Var1, 0, 95, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_288(&Var1, 69, 95, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_287(&Var1, iParam0, iParam1, 9); break;
		}
		break;
	...
	case joaat("player_two"):
		...
		case 0: func_288(&Var1, 11, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_288(&Var1, 17, 90, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_288(&Var1, 15, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_288(&Var1, 0, 88, 154, 3, 4, 5, 6, 7, 8); break;

		case 4: func_288(&Var1, 0, 1, 154, 3, 4, 5, 6, 7, 8); break;

		case 5: func_288(&Var1, 16, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_288(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_288(&Var1, 0, 123, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_288(&Var1, 69, 1, 2, 3, 4, 5, 6, 7, 8); break;
	...
	case joaat("mp_m_freemode_01"):
		...
		case 0: func_288(&Var1, 129, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_288(&Var1, 90, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_288(&Var1, 23, 251, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_288(&Var1, 36, 262, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_288(&Var1, 88, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_288(&Var1, 125, 175, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_288(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_288(&Var1, 44, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_288(&Var1, 52, 189, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_288(&Var1, 0, 261, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_288(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_288(&Var1, 0, 243, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_288(&Var1, 0, 212, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_288(&Var1, 64, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 14: func_288(&Var1, 61, 207, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_288(&Var1, 0, 291, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_288(&Var1, 0, 208, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_288(&Var1, 0, 229, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_288(&Var1, 36, 249, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_288(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_288(&Var1, 0, 174, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_288(&Var1, 35, 180, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_288(&Var1, 36, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_288(&Var1, 0, 259, 2, 3, 4, 5, 6, 7, 8); break;

		case 24: func_288(&Var1, 35, 1, 2, 3, 4, 5, 6, 7, 8); break;

		default: func_287(&Var1, iParam0, iParam1, 25); break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 0: func_288(&Var1, 35, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 1: func_288(&Var1, 36, 178, 2, 3, 4, 5, 6, 7, 8); break;

		case 2: func_288(&Var1, 53, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 3: func_288(&Var1, 38, 170, 2, 3, 4, 5, 6, 7, 8); break;

		case 4: func_288(&Var1, 37, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 5: func_288(&Var1, 113, 203, 2, 3, 4, 5, 6, 7, 8); break;

		case 6: func_288(&Var1, 114, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 7: func_288(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 8: func_288(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 9: func_288(&Var1, 0, 199, 2, 3, 4, 5, 6, 7, 8); break;

		case 10: func_288(&Var1, 0, 182, 2, 3, 4, 5, 6, 7, 8); break;

		case 11: func_288(&Var1, 0, 233, 2, 3, 4, 5, 6, 7, 8); break;

		case 12: func_288(&Var1, 107, 167, 2, 3, 4, 5, 6, 7, 8); break;

		case 13: func_288(&Var1, 109, 170, 2, 3, 4, 5, 323, 7, 8); break;

		case 14: func_288(&Var1, 119, 237, 2, 3, 4, 5, 6, 7, 8); break;

		case 15: func_288(&Var1, 0, 221, 2, 3, 4, 5, 6, 7, 8); break;

		case 16: func_288(&Var1, 114, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 17: func_288(&Var1, 35, 268, 2, 3, 4, 5, 6, 7, 8); break;

		case 18: func_288(&Var1, 0, 266, 2, 3, 4, 5, 6, 7, 8); break;

		case 19: func_288(&Var1, 42, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 20: func_288(&Var1, 76, 1, 2, 3, 4, 5, 6, 7, 8); break;

		case 21: func_288(&Var1, 39, 235, 2, 3, 4, 5, 6, 7, 8); break;

		case 22: func_288(&Var1, 41, 183, 2, 3, 4, 5, 6, 7, 8); break;

		case 23: func_288(&Var1, 111, 194, 2, 3, 4, 5, 6, 7, 8); break;
			...
			while (iVar19 < Var1.f_3) {
				if (dlc1::_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1) {
					if (vVar16.x != 0 && vVar16.x != -1 && vVar16.x != 1849449579) {
						(*iParam0)[vVar16.z] = func_284(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1) {
...
// Position - 0xD204
void func_288(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
...
struct<17> func_289(int iParam0, int iParam1) {
	...
	case joaat("player_zero"):
		...
		case 1: func_292(&Var1, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0); break;

		case 2: func_292(&Var1, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8); break;

		case 3: func_292(&Var1, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31); break;

		case 4: func_292(&Var1, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2); break;

		case 5:
			func_292(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[0], Global_101700.f_2095.f_539.f_200[0], 6, 3, 0,
					 0, 0, -99, 0, 0, 3);
			break;

		case 6: func_292(&Var1, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_292(&Var1, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 8: func_292(&Var1, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 9: func_292(&Var1, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 10: func_292(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4); break;

		case 11: func_292(&Var1, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5); break;

		case 12: func_292(&Var1, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31); break;

		case 13: func_292(&Var1, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 14: func_292(&Var1, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6); break;

		case 15: func_292(&Var1, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31); break;

		case 16: func_292(&Var1, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31); break;

		case 17: func_292(&Var1, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 18: func_292(&Var1, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7); break;

		case 19: func_292(&Var1, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 20: func_292(&Var1, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 21: func_292(&Var1, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_292(&Var1, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 23: func_292(&Var1, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31); break;

		case 24: func_292(&Var1, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31); break;

		case 25: func_292(&Var1, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 26: func_292(&Var1, -99, -99, 3, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 27: func_292(&Var1, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 28: func_292(&Var1, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 29: func_292(&Var1, -99, -99, 2, 2, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 30: func_292(&Var1, -99, -99, 161, 3, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 31: func_292(&Var1, -99, -99, 3, 3, 0, 12, 0, 0, 0, -99, 0, 1, 31); break;

		case 32: func_292(&Var1, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 33: func_292(&Var1, -99, -99, 86, 4, 20, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 34: func_292(&Var1, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31); break;

		case 35: func_292(&Var1, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 36: func_292(&Var1, -99, -99, 4, 4, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 37: func_292(&Var1, -99, -99, 5, 5, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 38: func_292(&Var1, -99, -99, 6, 6, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 39: func_292(&Var1, -99, -99, 7, 7, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 40: func_292(&Var1, -99, -99, 8, 8, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 41: func_292(&Var1, -99, -99, 9, 9, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_292(&Var1, -99, -99, 10, 10, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_292(&Var1, -99, -99, 11, 11, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_292(&Var1, -99, -99, 12, 12, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 45: func_292(&Var1, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 46: func_292(&Var1, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_292(&Var1, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 48: func_292(&Var1, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31); break;

		case 49: func_292(&Var1, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31); break;

		case 50: func_292(&Var1, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9); break;

		case 51: func_292(&Var1, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 52: func_292(&Var1, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31); break;

		default: func_290(&Var1, iParam0, iParam1, 53); break;
		}
		break;

	case joaat("player_one"):
		switch (iParam1) {
		case 0: func_292(&Var1, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 1: func_292(&Var1, -99, -99, 22, 10, 64, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 2:
			func_292(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[1], Global_101700.f_2095.f_539.f_200[1], 17, 2,
					 26, 0, 0, -99, 0, 45, 31);
			break;

		case 3: func_292(&Var1, -99, -99, 23, 11, 13, 5, 2, 4, 0, -99, 0, 0, 1); break;

		case 4: func_292(&Var1, -99, -99, 23, 11, 34, 5, 26, 0, 0, -99, 0, 0, 2); break;

		case 5: func_292(&Var1, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 6: func_292(&Var1, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 7: func_292(&Var1, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3); break;

		case 8: func_292(&Var1, -99, -99, 17, 5, 12, 0, 26, 0, 2, -99, 0, 0, 5); break;

		case 9: func_292(&Var1, -99, -99, 16, 4, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 10: func_292(&Var1, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 11: func_292(&Var1, -99, -99, 259, 10, 35, 0, 24, 0, 0, -99, 0, 43, 31); break;

		case 12: func_292(&Var1, -99, -99, 18, 6, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 13: func_292(&Var1, -99, -99, 19, 7, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 14: func_292(&Var1, -99, -99, 20, 8, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 15: func_292(&Var1, -99, -99, 21, 9, 12, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 16: func_292(&Var1, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 17: func_292(&Var1, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 18: func_292(&Var1, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31); break;

		case 19: func_292(&Var1, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 20: func_292(&Var1, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 21: func_292(&Var1, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4); break;

		case 22: func_292(&Var1, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31); break;

		case 23: func_292(&Var1, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31); break;

		case 24: func_292(&Var1, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31); break;

		case 25: func_292(&Var1, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31); break;

		case 26: func_292(&Var1, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31); break;

		case 27: func_292(&Var1, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31); break;

		case 28: func_292(&Var1, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31); break;

		case 29: func_292(&Var1, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31); break;

		case 30: func_292(&Var1, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31); break;

		case 31: func_292(&Var1, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31); break;

		case 32: func_292(&Var1, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31); break;

		case 33: func_292(&Var1, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31); break;

		case 34: func_292(&Var1, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31); break;

		case 35: func_292(&Var1, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31); break;

		case 36: func_292(&Var1, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31); break;

		case 37: func_292(&Var1, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31); break;

		case 38: func_292(&Var1, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 39: func_292(&Var1, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 40: func_292(&Var1, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31); break;

		case 41: func_292(&Var1, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31); break;

		case 42: func_292(&Var1, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31); break;

		case 43: func_292(&Var1, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6); break;

		case 44: func_292(&Var1, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 45: func_292(&Var1, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8); break;

		case 46: func_292(&Var1, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31); break;

		default: func_290(&Var1, iParam0, iParam1, 47); break;
		}
		break;

	case joaat("player_two"):
		switch (iParam1) {
		case 0: func_292(&Var1, -99, -99, 0, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 1: func_292(&Var1, -99, -99, 17, 5, 8, 2, 3, 0, 0, -99, 0, 0, 8); break;

		case 2: func_292(&Var1, -99, -99, 43, 8, 12, 3, 5, 0, 0, -99, 0, 0, 1); break;

		case 3: func_292(&Var1, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2); break;

		case 4:
			func_292(&Var1, -99, -99, Global_101700.f_2095.f_539.f_196[2], Global_101700.f_2095.f_539.f_200[2], 8, 0, 0,
					 0, 0, -99, 0, 0, 31);
			break;

		case 5: func_292(&Var1, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6); break;

		case 6: func_292(&Var1, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3); break;

		case 7: func_292(&Var1, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4); break;

		case 8: func_292(&Var1, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31); break;

		case 9: func_292(&Var1, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 10: func_292(&Var1, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 11: func_292(&Var1, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5); break;

		case 12: func_292(&Var1, -99, -99, 0, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31); break;

		case 13: func_292(&Var1, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31); break;

		case 14: func_292(&Var1, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31); break;

		case 15: func_292(&Var1, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 16: func_292(&Var1, -99, -99, 44, 9, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 17: func_292(&Var1, -99, -99, 45, 10, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 18: func_292(&Var1, -99, -99, 46, 11, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 19: func_292(&Var1, -99, -99, 47, 12, 12, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 20: func_292(&Var1, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 21: func_292(&Var1, -99, -99, 0, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 22: func_292(&Var1, -99, -99, 98, 0, 28, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 23: func_292(&Var1, -99, -99, 27, 0, 31, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 24: func_292(&Var1, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 25: func_292(&Var1, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 26: func_292(&Var1, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 27: func_292(&Var1, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 28: func_292(&Var1, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 29: func_292(&Var1, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 30: func_292(&Var1, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 31: func_292(&Var1, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 32: func_292(&Var1, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 33: func_292(&Var1, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 34: func_292(&Var1, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 35: func_292(&Var1, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 36: func_292(&Var1, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 37: func_292(&Var1, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 38: func_292(&Var1, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 39: func_292(&Var1, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 40: func_292(&Var1, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31); break;

		case 41: func_292(&Var1, -99, -99, 2, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 42: func_292(&Var1, -99, -99, 55, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 43: func_292(&Var1, -99, -99, 0, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 44: func_292(&Var1, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31); break;

		case 45: func_292(&Var1, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7); break;

		case 46: func_292(&Var1, -99, -99, 0, 0, 28, 0, 0, 0, 0, -99, 0, 0, 31); break;

		case 47: func_292(&Var1, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31); break;

		default: func_290(&Var1, iParam0, iParam1, 48); break;
		}
		break;

	case joaat("mp_m_freemode_01"):
		switch (iParam1) {
		case 0: func_292(&Var1, -99, -99, 0, 0, 10, -99, 0, -99, -99, 0, 0, 0, 31); break;

		case 1: func_292(&Var1, -99, -99, 1, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0); break;

		case 2: func_292(&Var1, -99, -99, 0, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1); break;

		case 3: func_292(&Var1, -99, -99, 4, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2); break;

		case 4: func_292(&Var1, -99, -99, 1, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3); break;

		case 5: func_292(&Var1, -99, -99, 1, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4); break;

		case 6: func_292(&Var1, -99, -99, 1, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5); break;

		case 7: func_292(&Var1, -99, -99, 1, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6); break;

		case 8: func_292(&Var1, -99, -99, 0, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7); break;

		case 9: func_292(&Var1, -99, -99, 4, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8); break;

		case 10: func_292(&Var1, -99, -99, 1, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9); break;

		case 11: func_292(&Var1, -99, -99, 1, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10); break;

		case 12: func_292(&Var1, -99, -99, 1, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11); break;

		case 13: func_292(&Var1, -99, -99, 1, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12); break;

		case 14: func_292(&Var1, -99, -99, 1, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13); break;

		case 15: func_292(&Var1, -99, -99, 1, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14); break;

		case 16: func_292(&Var1, -99, -99, 1, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15); break;

		case 17: func_292(&Var1, -99, -99, 1, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16); break;

		case 18: func_292(&Var1, -99, -99, 5, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17); break;

		case 19: func_292(&Var1, -99, -99, 5, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18); break;

		case 20: func_292(&Var1, -99, -99, 1, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19); break;

		case 21: func_292(&Var1, -99, -99, 0, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20); break;

		case 22: func_292(&Var1, -99, -99, 6, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21); break;

		case 23: func_292(&Var1, -99, -99, 1, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22); break;

		case 24: func_292(&Var1, -99, -99, 1, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23); break;

		case 25: func_292(&Var1, -99, -99, 2, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24); break;

		default: func_290(&Var1, iParam0, iParam1, 26); break;
		}
		break;

	case joaat("mp_f_freemode_01"):
		switch (iParam1) {
		case 0: func_292(&Var1, -99, -99, 0, 0, 0, -99, 0, -99, -99, 0, -99, 0, 31); break;

		case 1: func_292(&Var1, -99, -99, 5, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31); break;

		case 2: func_292(&Var1, -99, -99, 4, 1, 96, -99, 32, 0, 0, 0, 7, 215, 0); break;

		case 3: func_292(&Var1, -99, -99, 1, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1); break;

		case 4: func_292(&Var1, -99, -99, 2, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2); break;

		case 5: func_292(&Var1, -99, -99, 9, 7, 98, -99, 32, 0, 0, 0, 7, 153, 3); break;

		case 6: func_292(&Var1, -99, -99, 1, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4); break;

		case 7: func_292(&Var1, -99, -99, 4, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5); break;

		case 8: func_292(&Var1, -99, -99, 1, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6); break;

		case 9: func_292(&Var1, -99, -99, 5, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7); break;

		case 10: func_292(&Var1, -99, -99, 9, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8); break;

		case 11: func_292(&Var1, -99, -99, 5, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9); break;

		case 12: func_292(&Var1, -99, -99, 6, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10); break;

		case 13: func_292(&Var1, -99, -99, 5, 0, 0, -99, 10, 0, 0, 0, 0, 130, 31); break;

		case 14: func_292(&Var1, -99, -99, 4, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11); break;

		case 15: func_292(&Var1, -99, -99, 9, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12); break;

		case 16: func_292(&Var1, -99, -99, 2, 8, 98, -99, 32, 0, 0, 0, 33, 39, 13); break;

		case 17: func_292(&Var1, -99, -99, 5, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14); break;

		case 18: func_292(&Var1, -99, -99, 6, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15); break;

		case 19: func_292(&Var1, -99, -99, 4, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16); break;

		case 20: func_292(&Var1, -99, -99, 4, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17); break;

		case 21: func_292(&Var1, -99, -99, 4, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31); break;

		case 22: func_292(&Var1, -99, -99, 3, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18); break;

		case 23: func_292(&Var1, -99, -99, 0, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19); break;

		case 24: func_292(&Var1, -99, -99, 5, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20); break;

		case 25: func_292(&Var1, -99, -99, 7, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21); break;

		case 26: func_292(&Var1, -99, -99, 4, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22); break;

		case 27: func_292(&Var1, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23); break;

		default: func_290(&Var1, iParam0, iParam1, 28); break;
		}
		break;
	}
	return Var1;
			...
			if (dlc1::_get_prop_from_outfit(Var1.f_1, iVar36, &vVar16)) {
				if (vVar16.x != 0 && vVar16.x != -1 && vVar16.x != 1849449579) {
					...
					if (vVar16.z == 10 && uParam0->f_16) {
						...
						(*uParam0)[func_291(vVar16.z)] = func_284(iParam1, vVar16.x, func_291(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1) {
...
// Position - 0xF32E
void func_292(var *uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) {
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_279(iParam0, iParam2, 14, 3), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_279(iParam0, iParam2, 1, 3), -1842686353, 0);
			}
			break;
		}
		break;
	...
	case joaat("mp_f_freemode_01"):
		...
		case 14:
			if (iParam2 >= 18 && iParam2 <= 130) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_279(iParam0, iParam2, 14, 4), -1842686353, 1);
			}
			break;
		...
		case 1:
			if (iParam2 >= 26) {
				...
				return dlc1::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) |
					   dlc1::_0x341DE7ED1D2A1BFD(func_279(iParam0, iParam2, 1, 4), -1842686353, 0);
			}
			break;
		}
		break;
...
// Position - 0xFA1D
bool func_295(int iParam0, int iParam1, int iParam2, int iParam3) {
	switch (iParam0) {
	case joaat("player_zero"):
		if (iParam1 == 14) {
...
void func_300(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) {
	...
	if (func_304(iParam0, iParam1, &iVar2, &iVar1, iParam2, iParam3)) {
...
int func_303(int iParam0, int iParam1, int iParam2) {
	...
	iVar0 = Global_2503826[iParam0 /*3*/][func_302(iParam1)];
...
// Position - 0x111C4
bool func_305(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) {
	if (iParam0 == 0) {
		if (iParam5 == 1) {
...
{
	switch (iParam0) {
	case 0: func_332(iParam1); break;

	case 2: func_331(iParam1); break;

	case 3: func_328(iParam1); break;

	case 4: func_327(iParam1); break;

	case 6: func_326(iParam1); break;

	case 5: func_325(iParam1); break;

	case 8: func_324(iParam1); break;

	case 9: func_323(iParam1); break;

	case 10: func_322(iParam1); break;

	case 1: func_321(iParam1); break;

	case 7: func_320(iParam1); break;

	case 11: func_319(iParam1); break;

	case 12: func_318(iParam1); break;

	case 13: func_317(iParam1); break;

	case 14: func_309(iParam1); break;
	}
}
...
void func_309(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 155); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}

// Position - 0x134EB
void func_310(var *uParam0, int iParam1, int iParam2, char *sParam3, int iParam4, int iParam5, int iParam6, int iParam7,
			  int iParam8, int iParam9, int iParam10) {
	int iVar0;
	int iVar1;
...
void func_316(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam0 == 12) {
		...
		while (iVar38 < iVar40) {
			...
			if (!dlc1::_is_dlc_data_empty(Var20)) {
				if (iVar39 == iParam1 - iParam2) {
					...
					func_310(&Global_69523[0 /*14*/], iParam0, iParam1, &Var20.f_9, Var20.f_3, Var20.f_4, Var20.f_5,
		...
		iVar59 = 0;
		iVar60 = dlc1::_get_num_props_from_outfit(iVar1, 6, -1, 0, -1, func_267(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60) {
			...
			if (!dlc1::_is_dlc_data_empty(Var41)) {
				if (iVar59 == iParam1 - iParam2) {
					...
					func_310(&Global_69523[0 /*14*/], iParam0, iParam1, &Var41.f_9, Var41.f_3, Var41.f_4, Var41.f_5,
...
void func_317(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 9); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_318(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 48); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_319(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 1); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_321(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 6); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_322(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 33); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_323(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 17); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_324(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 18); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_325(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 7); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_326(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 84); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_327(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 104); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_333(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_351(iParam1); break;

	case 2: func_350(iParam1); break;

	case 3: func_346(iParam1); break;

	case 4: func_345(iParam1); break;

	case 6: func_344(iParam1); break;

	case 5: func_343(iParam1); break;

	case 8: func_342(iParam1); break;

	case 9: func_341(iParam1); break;

	case 10: func_340(iParam1); break;

	case 1: func_339(iParam1); break;

	case 7: func_338(iParam1); break;

	case 11: func_337(iParam1); break;

	case 12: func_336(iParam1); break;

	case 13: func_335(iParam1); break;

	case 14: func_334(iParam1); break;
	}
}
...
void func_334(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 175); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_336(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 47); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_337(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 63); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_339(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 5); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_340(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 53); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_341(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 12); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_342(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 77); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_344(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 134); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_345(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 117); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_350(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 21); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_351(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 10); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_352(int iParam0, int iParam1) {
	switch (iParam0) {
	case 0: func_369(iParam1); break;

	case 2: func_368(iParam1); break;

	case 3: func_365(iParam1); break;

	case 4: func_364(iParam1); break;

	case 6: func_363(iParam1); break;

	case 5: func_362(iParam1); break;

	case 8: func_361(iParam1); break;

	case 9: func_360(iParam1); break;

	case 10: func_359(iParam1); break;

	case 1: func_358(iParam1); break;

	case 7: func_357(iParam1); break;

	case 11: func_356(iParam1); break;

	case 12: func_355(iParam1); break;

	case 13: func_354(iParam1); break;

	case 14: func_353(iParam1); break;
	}
}
...
void func_353(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 113); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_356(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 45); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_360(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 20); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_361(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 24); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_362(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 14); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
void func_363(int iParam0) {
	...
	default: func_316(iVar10, iParam0, 99); return;
	}
	func_310(&Global_69523[0 /*14*/], iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, iVar0, iVar8, iVar9, 0);
}
...
bool func_371(int iParam0, int iParam1, int iParam2) {
	...
	else if (Global_69523[1 /*14*/].f_3 == ped::get_ped_drawable_variation(iParam0, func_267(iParam1)) &&
			 Global_69523[1 /*14*/].f_4 == ped::get_ped_texture_variation(iParam0, func_267(iParam1))) {
		return true;
	}
	return false;
}
...
void func_373(int iParam0) {
	...
	case 68: func_374(11); break;

	case 78: func_374(14); break;

	case 79: func_374(3); break;
...
// Position - 0x25DCB
void func_374(int iParam0) { gameplay::set_bit(&Global_87679, iParam0); }
...
void func_375() {
	...
	if (entity::does_entity_exist(iVar0)) {
		if (vehicle::is_vehicle_driveable(iVar0, 0)) {
			func_376(iVar0, entity::get_entity_coords(iVar0, 1), entity::get_entity_heading(iVar0), 24, 0);
		}
	}
}

// Position - 0x25E1A
void func_376(int iParam0, vector3 vParam1, var uParam4, int iParam5, int iParam6) {
	struct<60> Var0;
	...
	if (entity::does_entity_exist(iParam0) && vehicle::is_vehicle_driveable(iParam0, 0)) {
		...
		func_411(iParam5, &Var0, vParam1, uParam4, func_417(iParam0));
...
int func_379(int iParam0) {
	if (!entity::does_entity_exist(iParam0) || !vehicle::is_vehicle_driveable(iParam0, 0) || func_394(iParam0, 0, 0) ||
		func_394(iParam0, 1, 0) || func_394(iParam0, 2, 0) || func_417(iParam0) != 145 || func_393(iParam0) ||
		func_392(iParam0) || func_391(iParam0) || func_390(iParam0) || !func_380(entity::get_entity_model(iParam0))) {
		if (func_392(iParam0)) {
		}
		if (func_392(iParam0)) {
		}
...
// Position - 0x274A1
int func_385() { return 0; }

// Position - 0x274AA
int func_386() { return 1; }

// Position - 0x274B3
int func_387() { return 1; }
...
// Position - 0x277E6
bool func_395(int iParam0, int iParam1, char *sParam2, int *iParam3) {
...
var func_397() {
	...
	func_407(&iVar0, time::get_clock_seconds());
	func_406(&iVar0, time::get_clock_minutes());
	func_405(&iVar0, time::get_clock_hours());
	func_400(&iVar0, time::get_clock_day_of_month());
	func_399(&iVar0, time::get_clock_month());
	func_398(&iVar0, time::get_clock_year());
	return iVar0;
}
...
var func_402(int iParam0) {
	return (system::shift_right(iParam0, 26) & 31) * func_403(gameplay::is_bit_set(iParam0, 31), -1, 1) + 2011;
}
...
// Position - 0x27B08
int func_404(var uParam0) { return uParam0 & 15; }
...
// Position - 0x2955D
void func_411(int iParam0, var *uParam1, vector3 vParam2, var uParam5, int iParam6) {
	if (func_408(&Global_68531.f_555[0 /*21*/], iParam0)) {
		...
		*uParam1 = vehicle::get_vehicle_number_plate_text_index(iParam0);
		...
		while (iVar0 <= 11) {
			if (vehicle::is_vehicle_extra_turned_on(iParam0, iVar0 + 1)) {
				gameplay::set_bit(&uParam1->f_77, func_419(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_427() {
	...
	if (!func_6(iLocal_268)) {
		...
		if (func_6(Local_282)) {
			if (!func_196(player::player_ped_id(), Local_282, 500f, 1)) {
				iVar0++;
			}
		}
		else {
		...
		if (func_6(iLocal_269)) {
			if (!func_196(player::player_ped_id(), iLocal_269, 500f, 1)) {
				iVar0++;
			}
		}
		else {
		...
		if (!func_196(player::player_ped_id(), iLocal_268, 500f, 1)) {
			iVar0++;
		}
		if (func_6(iLocal_269)) {
			if (!func_196(player::player_ped_id(), iLocal_269, 500f, 1)) {
...
void func_429(int iParam0) {
	...
	case 1: sLocal_211 = "PRB_FWRECK"; break;

	case 2: sLocal_211 = "PRB_FFAR"; break;

	case 3: sLocal_211 = "PRB_FSTUCK"; break;
	}
	iLocal_92 = 5;
	iLocal_93 = 0;
}
...
void func_434(int iParam0, int iParam1, int iParam2) {
	...
	if (iParam2) {
		...
		if (func_436() == 0) {
			iVar0 = func_303(func_435(iParam0), -1, 0);
			gameplay::clear_bit(&iVar0, iParam1);
			func_301(func_435(iParam0), iVar0, -1, 1, 0);
		}
	}
	else {
...
// Position - 0x2A4D0
int func_436() { return Global_25190; }
...
// Position - 0x2A56B
int func_439(int iParam0) { return func_441(iParam0, 5, 1); }
...
bool func_441(int iParam0, int iParam1, int iParam2) {
	if (iParam2) {
		...
		if (func_436() == 0) {
			return gameplay::is_bit_set(func_303(func_435(iParam0), -1, 0), iParam1);
		}
	}
	else {
...
// Position - 0x2A946
void func_445() { ped::add_relationship_group("ENEMY", &iLocal_288); }
...
void func_448(var *uParam0, var *uParam1, float fParam2) {
	...
	while (iVar1 < uParam1->f_46) {
		...
		if (func_449(uParam1, (*uParam1)[iVar1 /*3*/] + vVar9)) {
			vVar9 = {-vVar9};
		}
...
// Position - 0x2AC89
void func_451(var *uParam0, vector3 vParam1) {
	if (uParam0->f_51 == 0) {
	}
	if (uParam0->f_46 >= 15) {
	}
...
// Position - 0x2ACE1
void func_453() { Local_252 = {func_454(-409.7205f, -2175.858f, 9.31836f, 121.7754f, joaat("s_m_m_trucker_01"))}; }

// Position - 0x2AD0B
struct<16> func_454(vector3 vParam0, float fParam3, int iParam4) {
	struct<16> Var0;
...
// Position - 0x2ADA5
struct<6> func_456(vector3 vParam0, float fParam3, int iParam4) {
	struct<6> Var0;
...
// Position - 0x2AE12
void func_458() { func_432(21, 1, 0); }

// Position - 0x2AE22
void func_459() { Global_87679 = 0; }

// Position - 0x2AE2F
void func_460(int iParam0) { Global_89130 = iParam0; }
