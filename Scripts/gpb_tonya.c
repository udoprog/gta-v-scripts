...
void func_51(int iParam0, char *sParam1, char *sParam2) {
	...
	switch (iParam0) {
	case 1: StringCopy(sParam2, "CMON_LET_OLE_TONYA", 64); break;

	case 2: StringCopy(sParam2, "COME_OVER_HERE", 64); break;

	case 3: StringCopy(sParam2, "HEY_HEY", 64); break;

	case 4: StringCopy(sParam2, "HEY_CRACKA", 64); break;

	case 5: StringCopy(sParam2, "WHAT_CHU_DOIN", 64); break;

	case 6: StringCopy(sParam2, "ANYBODY_WANNA", 64); break;
	}
}
...
// Position - 0x30EB
bool func_100() {
	if (gameplay::is_bit_set(Global_101700.f_17533[58 /*6*/], 0) &&
		!gameplay::is_bit_set(Global_101700.f_17533[58 /*6*/], 3)) {
		return true;
	}
	return false;
}
...
// Position - 0x319A
int func_105() {
	if (gameplay::is_bit_set(Global_101700.f_17533[60 /*6*/], 0) &&
		!gameplay::is_bit_set(Global_101700.f_17533[60 /*6*/], 3)) {
		return 0;
	}
	if (gameplay::is_bit_set(Global_101700.f_17533[61 /*6*/], 0) &&
		!gameplay::is_bit_set(Global_101700.f_17533[61 /*6*/], 3)) {
		return 0;
	}
	if (gameplay::is_bit_set(Global_101700.f_17533[62 /*6*/], 3)) {
		return 0;
	}
	if (gameplay::is_bit_set(Global_101700.f_17533[58 /*6*/], 2) ||
		gameplay::is_bit_set(Global_101700.f_17533[59 /*6*/], 2) ||
		gameplay::is_bit_set(Global_101700.f_17533[62 /*6*/], 2)) {
		return 1;
	}
	return 0;
}
...
// Position - 0x3257
bool func_106(int iParam0) { return func_107(Global_101700.f_19076, iParam0); }

// Position - 0x326C
bool func_107(var uParam0, var uParam1) { return (uParam0 & uParam1) != 0; }
